...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") OPENPPEXPORT UgFace : public UgDisplayableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const Interval askLimitsInU ( ) const;

        // Return the V parameter limits of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const Interval askLimitsInV ( ) const;

        // Return a point on the invoking object.
        // The point is in Absolute Coordinate System coordinates.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const Point3 evaluatePoint
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const Vector3 evaluateNormal
        (
            double u_parameter,             // <I>
                                            // The U parameter at which to evaluate
            double v_parameter              // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const Derivatives evaluateDerivatives
        (
            double u_parameter,             // <I>
                                            // The U parameter at which to evaluate
            double v_parameter              // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") void evaluateClosestPoint
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") UgBody *askBody ( ) const;

        // Return all the features of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < UgBodyFeatureObject * > askFeatures ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < UgFace * > askSplitFaces ( ) const;

        // Return all of the loops of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < Loop > askLoops ( ) const;

        // Return all of the edges of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < UgEdge * > askEdges ( ) const;

        // Compute and return all of the intersection points between the invoking
        // object and the given UgEvaluatableObject object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < CurveFaceIntersectionPoint > computeIntersectionPoints
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < FaceFaceIntersectionPoint > computeIntersectionPoints
        (
            const UgFace              *face,    // <I>
        ...
        // object and the given UgFace object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < UgCurveObject * > computeIntersectionCurves
        (
            const UgFace              *face,    // <I>
                                                // The UgFace object to intersect
                                                // with the invoking object.
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") UgFace *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") UgFace *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const std::vector < UgFace * > askAllOccurrences ( ) const;
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") OPENPPEXPORT Derivatives
{
    ...
    public:
        ...
        // to the zero vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Derivatives ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_du;

        // The first partial derivative vector with respect to the V parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_dv;

        // The second partial derivative vector with respect to the U parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_d2u;

        // The second partial derivative vector with respect to the U and V
        // parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_dudv;

        // The second partial derivative vector with respect to the V parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_d2v;

        // The third partial derivative vector with respect to the U parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_d3u;

        // The first partial derivative vector with respect to the U parameter
        // of the second partial derivative with respect to the U and V parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_d2udv;

        // The first partial derivative vector with respect to the V parameter
        // of the second partial derivative with respect to the U and V parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_dud2v;

        // The third partial derivative vector with respect to the V parameter.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Vector3 m_d3v;
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") OPENPPEXPORT Loop
{

    public:

        // Determine if the invoking object is a peripheral loop.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") bool isPeripheralLoop ( ) const;

        // Determine if the invoking object is a hole loop.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") bool isHoleLoop ( ) const;

        // Determine if the invoking object is some other kind of loop.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") bool isOtherLoop ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") Loop ( );
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") OPENPPEXPORT FaceFaceIntersectionPoint
{

    public:

        // Return the intersection point in Absolute Coordinate System coordinates.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") const Point3 askPoint ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") double askUParameterOnInvoking ( ) const;

        // Return the V parameter of the intersection point with respect to the object
        // that invoked the method computeIntersectionPoints ( ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") double askVParameterOnInvoking ( ) const;

        // Return the U parameter of the intersection point with respect to the object
        // that was passed as an argument to the method computeIntersectionPoints ( ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") double askUParameterOnFace ( ) const;

        // Return the V parameter of the intersection point with respect to the object
        // that was passed as an argument to the method computeIntersectionPoints ( ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") double askVParameterOnFace ( ) const;

        // Construct a FaceFaceIntersectionPoint object.  This default constructor is
        // required to allow for a std::vector of these objects.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Face.") FaceFaceIntersectionPoint ( );
