...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Line.") OPENPPEXPORT Line : public virtual Curve
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Line.") const Point3 getStartPoint ( ) const;

        // Return the end point in Absolute Coordinate System coordinates
        // of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Line.") const Point3 getEndPoint ( ) const;
