...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") OPENPPEXPORT UgObject
{
   
    public:

        // Determine if the tag of the invoking object is NULL_TAG.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") bool isNull ( ) const;
        ...
        // method.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") virtual UgPart *askOwningPart ( ) const = 0;

        // Return the tag of the NX database object that corresponds to the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") tag_t getTag ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") static UgObject *find
        (
            tag_t tag                       // <I>
