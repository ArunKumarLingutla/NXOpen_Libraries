...
// and NX edge objects.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") OPENPPEXPORT UgEvaluatableObject : public UgDisplayableObject
{

    public:

        // Return the Curve object that represents the invoking object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") virtual const Curve *askCurve ( ) const = 0;

        // Return the Evaluator object that represents the invoking object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const Evaluator askEvaluator ( )  const;

        // Compute and return the entire arc length of the invoking object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") double computeArcLength ( ) const;

        // Compute and return a portion of the arc length of the invoking object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") double computeArcLength
        (
        ...
        // object and the given UgEvaluatableObject object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const std::vector < CurveCurveIntersectionPoint > computeIntersectionPoints
        ( 
        ...
        // object and the given UgEvaluatableObject object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const std::vector < CurveCurveCoincidentCurve > computeCoincidentCurves
        ( 
            const UgEvaluatableObject *curve,   // <I>
                                                // The UgEvaluatableObject object to intersect
                                                // with the invoking object.
        ...
        // object and the given UgFace object.
         UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const std::vector < CurveFaceIntersectionPoint > computeIntersectionPoints
        ( 
            const UgFace              *face,    // <I> 
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") OPENPPEXPORT CurveCurveIntersectionPoint
{

    public:

        // Return the intersection point in Absolute Coordinate System coordinates.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const Point3 askPoint ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") double askParameterOnInvoking ( ) const;

        // Return the parameter of the intersection point with respect to the object 
        // that was passed as an argument to the method computeIntersectionPoints ( ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") double askParameterOnCurve ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") CurveCurveIntersectionPoint ( );
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") OPENPPEXPORT CurveCurveCoincidentCurve
{

    public:

        // Return the coincident curve intersection.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") UgCurveObject *askCurve ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const Interval askIntervalOnInvoking ( ) const;

        // Return the Interval object that represents the start and end parameters
        // of the coincident curve with respect to the object that was passed as
        // an argument to the method computeCoincidentCurves ( ). 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") const Interval askIntervalOnCurve ( ) const;
      
        // Construct a CurveCurveCoincidentCurve object.  This default constructor is 
        // required to allow for a std::vector of these objects.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") CurveCurveCoincidentCurve ( );
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") OPENPPEXPORT CurveFaceIntersectionPoint
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") double askUParameterOnFace ( ) const;

        // Return the V parameter of the intersection point with respect to the UgFace object. 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") double askVParameterOnFace ( ) const;

        // Construct a CurveFaceIntersectionPoint object.  This default constructor is 
        // required to allow for a std::vector of these objects.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::Edge.") CurveFaceIntersectionPoint ( );
