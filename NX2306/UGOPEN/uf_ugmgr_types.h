...
* 
* Increased to 900 in NX10 to support MFK, which is now what Part Number is used for.
*/
#define    UF_UGMGR_PARTNO_LIMIT        900  /**< Part (Item) Number length in chars; increased to 900 to support TC Longer ID/Names and MFK */
...
#define    UF_UGMGR_invalid_folder             (UF_UGMGR_error_base + 25)
