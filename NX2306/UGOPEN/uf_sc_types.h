...
//<yugandar.polisetti>DES22Q421: Added new Body SI rules.
...
#define     UF_SC_MAX_BODY                    (UF_SC_MAX_CURVES + 7)
...
//<yugandar.polisetti>DES22Q421: Added new Body SI rules data structures.
