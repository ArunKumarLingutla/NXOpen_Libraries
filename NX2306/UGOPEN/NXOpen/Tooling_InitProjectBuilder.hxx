    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  InitProjectBuilder : public NXOpen::Builder
        {
            ...
            /** Creates clone object with the specified name rule.  @return  A @link NXOpen::Tooling::CloneObject NXOpen::Tooling::CloneObject@endlink  instance 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::CloneObject * CreateCloneObjectWithNameRule
            (
                const NXString & templatePartName /** templatepartname */ ,
            ...
            /** Creates clone object with the specified name rule.  @return  A @link NXOpen::Tooling::CloneObject NXOpen::Tooling::CloneObject@endlink  instance 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            NXOpen::Tooling::CloneObject * CreateCloneObjectWithNameRule
            (
                const char * templatePartName /** templatepartname */ ,
            ...
            /** Set the client data of user defined project template library 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetProjectTemplateClientData
            (
                const NXString & currentCatalogName /** the catalog name of current selected project template in library*/,
                NXOpen::Tooling::StandardPartData * templateClientData /** A @link NXOpen::Tooling::StandardPartData NXOpen::Tooling::StandardPartData@endlink  instance */
            );
            /** Set the client data of user defined project template library 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            void SetProjectTemplateClientData
            (
                const char * currentCatalogName /** the catalog name of current selected project template in library*/,
                NXOpen::Tooling::StandardPartData * templateClientData /** A @link NXOpen::Tooling::StandardPartData NXOpen::Tooling::StandardPartData@endlink  instance */
            );
        };
    }
