        ...
        */
        class AMEOPENCPPEXPORT  QueryResult : public NXOpen::NXObject
        {
            ...
            /** Load engineering objects of selected model IDs
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: std::vector<NXOpen::AME::AMEEngObject *> LoadEngineeringObjectsFromModelIds
            (
                const std::vector<NXString> & selectedModelIDs /** selectedmodelids */ 
            );
            /** Load connections of selected query result objects
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void LoadAndRetrieveConnections
            (
                const std::vector<NXOpen::NXObject *> & selectedResultObjects /** selectedresultobjects */ ,
                std::vector<NXOpen::NXObject *> & connections /** connections */ 
            );
        };
    }
}
