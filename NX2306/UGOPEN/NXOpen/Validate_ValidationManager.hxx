...
#include <NXOpen/Validate_ProfileDefinition.hxx>
        ...
        class NXOPENCPP_VALIDATEEXPORT  ValidationManager
        {
            ...
            /** The display name of the checker.
                    ...
                    displayName = validationManager.GetCheckerDisplayName("classID");    
                     @endcode 
                     @return  The display name of the checker. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_checkmate ("UG Check Mate") */
            public: NXString GetCheckerDisplayName
            (
                const NXString & classID /** The class ID of the checker. */
            );
            /** The display name of the checker.
                        Return empty if the checker is not registered.
                     @code 
             ...
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_checkmate ("UG Check Mate") */
            NXString GetCheckerDisplayName
            (
                const char * classID /** The class ID of the checker. */
            );
            /** Creates a parameter and binding it to the input parameter.  @return  Return defined parameter.
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Validate::Parameter * DefineReferencingParameter
            (
                const NXString & parameterID /** The ID of parameter.*/,
                NXOpen::Validate::Parameter * referencedParameter /** referencedparameter */ 
            );
            /** Creates a parameter and binding it to the input parameter.  @return  Return defined parameter.
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Validate::Parameter * DefineReferencingParameter
            (
                const char * parameterID /** The ID of parameter.*/,
                NXOpen::Validate::Parameter * referencedParameter /** referencedparameter */ 
            );
            /**  @brief 
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Validate::ProfileDefinition * DefineCheckerProfile
            (
                const NXString & classID /** classid */ ,
                const NXString & displayName /** displayname */ ,
                const NXString & category /** category */ ,
            ...
            /**  @brief 
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Validate::ProfileDefinition * DefineCheckerProfile
            (
                const char * classID /** classid */ ,
                const char * displayName /** displayname */ ,
                const char * category /** category */ ,
            ...
            /** Registers a checker profile definition to validation manager. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void RegisterCheckerProfileDefinition
            (
                NXOpen::Validate::ProfileDefinition * profileDefinition /** profiledefinition */ 
            );
            /** Deletes a @link Validate::ProfileDefinition Validate::ProfileDefinition@endlink .
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void DeleteCheckerProfileDefinition
            (
                NXOpen::Validate::ProfileDefinition * profileDefinition /** profiledefinition */ 
            );
