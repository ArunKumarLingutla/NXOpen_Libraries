        ...
        class NXOPENCPP_PREFERENCESEXPORT  SessionVisualizationScreen
        {
            ...
            */
            ...
            /**Returns  whether for a perspective view the Fit operation should not change the
             ...
             <br>  @deprecated Deprecated in NX2206.0.0.  No replacement. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  No replacement.") bool PreserveFieldOfViewAngleForFit
            (
            );
            /**Sets  whether for a perspective view the Fit operation should not change the
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  No replacement.") void SetPreserveFieldOfViewAngleForFit
            (
