    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  FlexBody : public NXOpen::Motion::MotionObject, public virtual NXOpen::Motion::IGraphSource
        {
            ...
            /** Update the flexible body to reset modes, connection id etc. for result update
            ...
            (
                NXOpen::Motion::MotionObject * connectionTag /** connectiontag */ ,
                int connectionPositionId /**action or base connection point*/
            );
