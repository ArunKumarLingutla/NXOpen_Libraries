        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ExpressionBlockBuilder : public NXOpen::Builder
        {
            /**  @brief  Represents the Slot type.  
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link NXOpen::Mechatronics::GenericSignal::SlotTypes NXOpen::Mechatronics::GenericSignal::SlotTypes@endlink  instead. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::Mechatronics::GenericSignal::SlotTypes instead.") SlotType
            {
                SlotTypeNone/** None  */ = -1,
            ...
            */
            public:
            struct NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Mechatronics::GenericSignal instead.") Slot
            {
            ...
            */
            ...
            /**  @brief  Gets all Slots.  
             ...
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link Mechatronics::ExpressionBlockBuilder::GetSlotExpressions Mechatronics::ExpressionBlockBuilder::GetSlotExpressions@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use Mechatronics::ExpressionBlockBuilder::GetSlotExpressions instead.") std::vector<NXOpen::Mechatronics::ExpressionBlockBuilder::Slot> GetSlots
            (
            );
            /**  @brief  Sets all Slots.  

              
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link Mechatronics::ExpressionBlockBuilder::SetSlotExpressions Mechatronics::ExpressionBlockBuilder::SetSlotExpressions@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use Mechatronics::ExpressionBlockBuilder::SetSlotExpressions instead.") void SetSlots
            (
            ...
            /**  @brief  Gets all Slots.  
               ...
               @return  Array of Slots 
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Mechatronics::ExpressionBlockBuilder::GetSlotExpressions NXOpen::Mechatronics::ExpressionBlockBuilder::GetSlotExpressions@endlink  instead. <br>  

             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Mechatronics::ExpressionBlockBuilder::GetSlotExpressions instead.") std::vector<NXOpen::Mechatronics::ExpressionBlockBuilder::SlotV2> GetSlotsV2
            (
            );
            /**  @brief  Gets all Slots.  

               @return  Array of Slots 
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Mechatronics::ExpressionBlockBuilder::GetSlotExpressions Mechatronics::ExpressionBlockBuilder::GetSlotExpressions@endlink  instead. <br>  

             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Mechatronics::ExpressionBlockBuilder::GetSlotExpressions instead.") std::vector<NXOpen::Mechatronics::ExpressionBlockBuilder::SlotV3> GetSlotsV3
            (
            );
            /**  @brief  Sets all Slots.  
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use Mechatronics::ExpressionBlockBuilder::SetSlotExpressions instead.") void SetSlotsV2
            (
            ...
            /**  @brief  Sets all Slots.  
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Mechatronics::ExpressionBlockBuilder::SetSlotExpressions Mechatronics::ExpressionBlockBuilder::SetSlotExpressions@endlink  instead. <br>  

             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Mechatronics::ExpressionBlockBuilder::SetSlotExpressions instead.") void SetSlotsV3
            (
                const std::vector<NXOpen::Mechatronics::ExpressionBlockBuilder::SlotV3> & slots /** Array of Slots */
            );
            /**  @brief  Gets all slot expressions.  

              
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void GetSlotExpressions
            (
                std::vector<NXOpen::Mechatronics::GenericSignal *> & slotExpressions /** slotexpressions */ 
            );
            /**  @brief  Sets all slot expression.  

              
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void SetSlotExpressions
            (
                const std::vector<NXOpen::Mechatronics::GenericSignal *> & slotExpreesions /** slotexpreesions */ 
            );
