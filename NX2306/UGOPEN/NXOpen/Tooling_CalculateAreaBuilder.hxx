...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AngularAccuracy.Value </term> <description> 
         
        1.0 </description> </item> 

        <item><term> 
         
        ApproximationTolerance.Value </term> <description> 
         
        0.1 (millimeters part), 0.004 (inches part) </description> </item> 

        <item><term> 
         
        CreateSheet </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DimTolerance.Value </term> <description> 
         
        0.01 (millimeters part), 0.001 (inches part) </description> </item> 

        <item><term> 
         
        SheetMethod </term> <description> 
         
        Curve </description> </item> 

        <item><term> 
         
        ToggleSideArea </term> <description> 
