    ...
    namespace CAE
    {
        namespace Xyplot
        {
            ...
            enum TextType
            {
                ...
                TextTypeMatrixValueText/** Matrix Value Text */
            };
            ...
            enum PlotType
            {
                PlotTypeUnknown/** unknown plot type */ = -1,
            ...
            */
            enum NX_DEPRECATED("Deprecated in NX2212.0.0.  This functionality is no longer supported.") PanToolSize
            {
            ...
            /** Represents the moving direction in Pan mode 
             <br>  @deprecated Deprecated in NX2212.0.0.  This functionality is no longer supported. <br>  
            */
            enum NX_DEPRECATED("Deprecated in NX2212.0.0.  This functionality is no longer supported.") PanDirection
            {
                PanDirectionUp/** up */ ,
            ...
            enum CalculationFunctionType
            {
                ...
                CalculationFunctionTypeLoudness/** loudness */ 
            };
            ...
            enum TextBoxCornerType
            {
                TextBoxCornerTypeCenter/** center */ ,
                TextBoxCornerTypeLowerLeft/** lower left */ ,
                TextBoxCornerTypeLowerRight/** lower right */ ,
                TextBoxCornerTypeUpperLeft/** upper left */ ,
                TextBoxCornerTypeUpperRight/** upper right */ 
            };

            /** Represents the truncation direction for axis item */
            enum AxisItemTruncationDirection
            {
                AxisItemTruncationDirectionEnd/** If string length exceeds maximum character count, truncating the end of string */,
                AxisItemTruncationDirectionBeginning/** If string length exceeds maximum character count, truncating the beginning of string */
            };
