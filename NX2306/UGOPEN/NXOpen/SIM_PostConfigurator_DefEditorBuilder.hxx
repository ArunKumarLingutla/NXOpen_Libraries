            ...
            */
            class NXOPENCPP_SIMEXPORT  DefEditorBuilder : public NXOpen::Builder
            {
                ...
                public: enum AddressLimitHandleType
                {
                    ...
                    AddressLimitHandleTypeReset/** reset */ 
                };
                ...
                /** Get omit of address   @return  the address omit
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString GetAddressOmit
                (
                    const NXString & addressName /** the address name*/
                );
                /** Get omit of address   @return  the address omit
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                NXString GetAddressOmit
                (
                    const char * addressName /** the address name*/
                );
            };
        }
    }
