    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  FEElement : public NXOpen::TaggedObject, public virtual NXOpen::IFitTo, public virtual NXOpen::CAE::IExportableFEEntity
        {
            ...
            /** Returns an element face @link NXOpen::CAE::FEElemFace NXOpen::CAE::FEElemFace@endlink  given the element and face id  
            ...
            /** Returns an element edge @link NXOpen::CAE::FEElemEdge NXOpen::CAE::FEElemEdge@endlink  given the element and edge id  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
