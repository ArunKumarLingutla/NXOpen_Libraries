    ...
    namespace SIM
    {
        ...
        */
        class NXOPENCPP_SIMEXPORT  SmkMachineKitEditorBuilder : public NXOpen::Builder
        {
            ...
            public: enum ParametersMachineMode
            {
                ParametersMachineModeAll/** all */ ,
                ParametersMachineModeMill/** mill */ ,
                ParametersMachineModeLathe/** lathe */ ,
                ParametersMachineModeDrill/** drill */  = 4,
                ParametersMachineModeWedm/** wedm */  = 8,
                ParametersMachineModeLaser/** laser */  = 16
            };
            ...
            /** Adds parameters machine mode 
             ...
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void AddParametersMachineMode
            (
                const NXString & attributeFullname /** The attribute fullname */,
                NXOpen::SIM::SmkMachineKitEditorBuilder::ParametersMachineMode machineMode /** The machine mode */
            );
            /** Adds parameters machine mode 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void AddParametersMachineMode
            (
                const char * attributeFullname /** The attribute fullname */,
                NXOpen::SIM::SmkMachineKitEditorBuilder::ParametersMachineMode machineMode /** The machine mode */
            );
            /** Clears parameters machine mode 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void ClearParametersMachineMode
            (
                const NXString & attributeFullname /** The attribute fullname */
            );
            /** Clears parameters machine mode 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void ClearParametersMachineMode
            (
                const char * attributeFullname /** The attribute fullname */
            );
            ...
            (
                const NXString & attributeFullname /** The attribute fullname */,
                int machineMode /** The machine mode */
            );
            /** Sets the machine mode 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            ...
            /** Gets the machine mode  @return  The machine mode 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Asks if the attribute exists  @return  The attribute exsitence 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                const NXString & attributeFullname /** The attribute fullname */,
                int eventClassification /** The event classification */
            );
            /** Sets the event classification 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void SetEventClassification
            (
                const char * attributeFullname /** The attribute fullname */,
                int eventClassification /** The event classification */
            );
            /** Gets the event classification   @return  The event classification 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
