...
namespace NXOpen
{
    ...
    namespace Vsa
    {
        class _BallFeatureBuilderBuilder;
        class BallFeatureBuilderImpl;
        /**
        ...
        */
        class NXOPENCPP_VSAEXPORT  BallFeatureBuilder : public NXOpen::Builder
        {
            /**
            ...
            private: BallFeatureBuilderImpl * m_ballfeaturebuilder_impl;
            private: friend class  _BallFeatureBuilderBuilder;
            protected: BallFeatureBuilder();
            public: ~BallFeatureBuilder();
            ...
            /**Returns  the enum size 
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::BallFeatureBuilder::APIEnumSize EnumSize
            (
            );
            /**Sets  the enum size 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::BallFeatureBuilder::APIEnumSize enumSize /** enumsize */ 
            );
            ...
            /**Returns  the enum loc 
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::BallFeatureBuilder::APIEnumLoc EnumLoc
            (
            );
            /**Sets  the enum loc 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::BallFeatureBuilder::APIEnumLoc enumLoc /** enumloc */ 
            );
            ...
            /**Returns  the enum form 
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::BallFeatureBuilder::APIEnumForm EnumForm
            (
            );
            /**Sets  the enum form 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::BallFeatureBuilder::APIEnumForm enumForm /** enumform */ 
            );
