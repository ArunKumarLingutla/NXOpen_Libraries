...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        GuideCurveFitData.CurveJoinMethod </term> <description> 
         
        No </description> </item> 

        <item><term> 
         
        GuideCurveFitData.Degree </term> <description> 
         
        7 </description> </item> 

        <item><term> 
         
        GuideCurveFitData.FitMethod </term> <description> 
         
        DegreeAndSegments </description> </item> 

        <item><term> 
         
        GuideCurveFitData.IsAdvancedFit </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        GuideCurveFitData.IsAlignShape </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        GuideCurveFitData.MaximumDegree </term> <description> 
         
        7 </description> </item> 

        <item><term> 
         
        GuideCurveFitData.MaximumSegments </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        GuideCurveFitData.MinimumDegree </term> <description> 
         
        5 </description> </item> 

        <item><term> 
         
        GuideCurveFitData.Segments </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        LaydownCurve </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        SplitSurfaces </term> <description> 
