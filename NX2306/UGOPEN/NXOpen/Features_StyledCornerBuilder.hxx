...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        BaseCurveFitData.CurveJoinMethod </term> <description> 
         
        No </description> </item> 

        <item><term> 
         
        BaseCurveFitData.Degree </term> <description> 
         
        7 </description> </item> 

        <item><term> 
         
        BaseCurveFitData.FitMethod </term> <description> 
         
        KeepParameterization </description> </item> 

        <item><term> 
         
        BaseCurveFitData.IsAdvancedFit </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        BaseCurveFitData.IsAlignShape </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        BaseCurveFitData.MaximumDegree </term> <description> 
         
        7 </description> </item> 

        <item><term> 
         
        BaseCurveFitData.MaximumSegments </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        BaseCurveFitData.MinimumDegree </term> <description> 
         
        5 </description> </item> 

        <item><term> 
         
        BaseCurveFitData.Segments </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        BottomShapeControlMethods </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        CurveControl </term> <description> 
         
        TopBaseCurve </description> </item> 
        ...
        InteriorCurveType </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        TopShapeControlMethods </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        TrimAndSewMethod </term> <description> 
         
        TrimBlends </description> </item> 

        <item><term> 
         
        TrimCurve1Type </term> <description> 
         
        TangentContinuous </description> </item> 

        <item><term> 
         
        TrimCurve2Type </term> <description> 
         
        TangentContinuous </description> </item> 

        <item><term> 
         
        TrimCurveFitData.FitMethod </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StyledCornerBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the trim curve fit data 
             ...
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::CurveFitData * TrimCurveFitData
            (
            );
            /**Returns  the base curve fit data 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::CurveFitData * BaseCurveFitData
            (
            );
