...
//
//  Source File:
//     PressLineSimulation_SelectLineComponent.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace PressLineSimulation
    {
        class _SelectLineComponentBuilder;
        class SelectLineComponentImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class PRESSLINESIMULOPENCPPEXPORT  SelectLineComponent : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectLineComponentImpl * m_selectlinecomponent_impl;
            private: friend class  _SelectLineComponentBuilder;
            protected: SelectLineComponent();
            public: ~SelectLineComponent();
            ...
            (
                NXOpen::PressLineSimulation::LineComponent * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PressLineSimulation::LineComponent * Value
            (
            );
            ...
            (
                ...
                NXOpen::PressLineSimulation::LineComponent * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::PressLineSimulation::LineComponent * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::PressLineSimulation::LineComponent * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
