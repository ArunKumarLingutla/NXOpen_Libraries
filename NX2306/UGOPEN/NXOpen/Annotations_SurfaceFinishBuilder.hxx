        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SurfaceFinishBuilder : public NXOpen::Annotations::BaseSurfaceFinishBuilder
        {
            ...
            /**Returns  the parantheses. This method is deprecated.
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link NXOpen::Annotations::SurfaceFinishBuilder::Parentheses NXOpen::Annotations::SurfaceFinishBuilder::Parentheses@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::Annotations::SurfaceFinishBuilder::Parentheses instead.") NXOpen::Annotations::BaseSurfaceFinishBuilder::ParanthesesType Parantheses
            (
            );
            /**Sets  the parantheses. This method is deprecated.
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link NXOpen::Annotations::SurfaceFinishBuilder::SetParentheses NXOpen::Annotations::SurfaceFinishBuilder::SetParentheses@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::Annotations::SurfaceFinishBuilder::SetParentheses instead.") void SetParantheses
            (
