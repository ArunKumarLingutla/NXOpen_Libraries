    ...
    */
    class NXOPENCPPEXPORT  InferredConstraintsBuilder : public NXOpen::Builder
    {
        ...
        /**Returns  the point on string infer-constraint setting. If this constraint flag is switched ON, sketcher
                ...
                this command. 
         <br>  @deprecated Deprecated in NX11.0.0.  Please use @link NXOpen::InferredConstraintsBuilder::PreferStringConstraints NXOpen::InferredConstraintsBuilder::PreferStringConstraints@endlink  <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX11.0.0.  Please use NXOpen::InferredConstraintsBuilder::PreferStringConstraints") bool PointOnString
        (
        );
        /**Sets  the point on string infer-constraint setting. If this constraint flag is switched ON, sketcher
                will create this constraint automatically for all points on strings created after
                this command. 
         <br>  @deprecated Deprecated in NX11.0.0.  Please use @link NXOpen::InferredConstraintsBuilder::SetPreferStringConstraints NXOpen::InferredConstraintsBuilder::SetPreferStringConstraints@endlink  <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX11.0.0.  Please use NXOpen::InferredConstraintsBuilder::SetPreferStringConstraints") void SetPointOnString
        (
