...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SaveOptions
    {
        ...
        /**Returns   @brief  the option indicating whether to generate drawing CGM
            files when a part is saved in a managed mode 
        ...
        /**Sets   @brief  the option indicating whether to generate drawing CGM
            files when a part is saved in a managed mode 

         
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetCgmData
        (
            bool option /** option */ 
        );
        /**Returns   @brief  the option indicating whether to generate drawing PDF
            dataset when a part is saved in a managed mode  
        ...
        /**Sets   @brief  the option indicating whether to generate drawing PDF
            dataset when a part is saved in a managed mode  
