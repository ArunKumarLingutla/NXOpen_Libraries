...
namespace NXOpen
{
    ...
    namespace Die
    {
        ...
        /** Represents a Trim Task feature builder.  <br> To create a new instance of this class, use @link NXOpen::Die::DieCollection::TrimTask  NXOpen::Die::DieCollection::TrimTask @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_DIEEXPORT  TrimTaskBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: void CheckAndMovePlanes
            (
                NXOpen::Features::Feature * origTip /** Original Die Tip. */,
                NXOpen::Features::Feature * targetTip /** Die Tip in the target operation. */,
                NXOpen::ISurface * origStartPlaneTag /** Original start plane. */,
                NXOpen::ISurface * origEndPlaneTag /** Original end plane. */,
                NXOpen::ISurface ** targetStartPlaneTag /** Start plane in target operation. */,
                NXOpen::ISurface ** targetEndPlaneTag /** End plane in target operation. */
            );
            ...
            /** Gets the scrap cutters of the trim task  @return  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Gets the associative objects of the trim task  @return  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Gets the camera views of the trim task  @return  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /**Returns  the finish operation of the trim task 
                    True indicates the trim is to be a finish trim. False indicates rough trim. 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            /** Gets the detailed description of the trim task  @return  detail strings 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            ...
            (
                bool newDieFace /** if set to true, trim task performs on new die face, or else it will perform on original die face. */
            );
        };
    }
}
