    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  DynamicMaterialCutterBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the flag for update collision and rigid properties for cutting. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: bool UpdateCollision
            (
            );
            /**Sets  the flag for update collision and rigid properties for cutting. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void SetUpdateCollision
            (
                bool bVal /** bval */ 
            );
            /**Returns   @brief  collision category  
            ...
            (
                int collisionCategory /** collisioncategory */ 
            );
        };
    }
}
