        ...
        */
        class NXOPENUICPPEXPORT  Wizard : public NXOpen::BlockStyler::UIBlock
        {
            ...
            public: enum DialogResponse
            {
                ...
                DialogResponseNext/** Next button was pressed. */,
                DialogResponseFinish/** Finish button was pressed. */,
            ...
            public: void TestCurrentStepChanged
            (
                int currentStep /** currentstep */ 
            );
            /**Tests the subnode action mapped to this block.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: void TestSubnodeAction
            (
                int stepNo /** stepno */ ,
                int subNodeId /** subnodeid */ ,
                NXOpen::BlockStyler::Wizard::SubNodeAction item /** item */ 
            );
            ...
            (
                NXOpen::BlockStyler::Wizard::TaskNavigatorItem item /** item */ ,
                int stepNo /** stepno */ ,
                int subNodeId /** subnodeid */ ,
                int menuItemIndex /** menuitemindex */ 
            );
            ...
            /** Sets the dialog navigation response for testing
             ...
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: void SetDialogNavigationResponse
            (
                NXOpen::BlockStyler::Wizard::DialogResponse response /** response */ 
            );
        };
    }
}
