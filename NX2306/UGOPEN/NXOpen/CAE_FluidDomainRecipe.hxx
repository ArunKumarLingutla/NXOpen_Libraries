    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  FluidDomainRecipe : public NXOpen::NXObject
        {
            ...
            /** Gets the first fluid body associated with the fluid domain recipe  @return  
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::CAEBody * GetFluidBody
            (
            );
            /** Get the list of fluid bodies associated with the fluid domain recipe 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: void GetFluidBodies
            (
                std::vector<NXOpen::CAE::CAEBody *> & fluidBodies /** fluidbodies */ 
            );
