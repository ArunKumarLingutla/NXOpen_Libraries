    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  JointDefine : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the override state of the action spin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ActionSpinVectorOvrCtrl
            (
            );
            /**Sets  the override state of the action spin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetActionSpinVectorOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the spin direction of the Action Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * ActionSpinVector
            (
            );
            /**Sets  the spin direction of the Action Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetActionSpinVector
            (
                NXOpen::Direction * actionSpinVector /** actionspinvector */ 
            );
            /**Returns  the override state of the action cross pin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ActionCrossPinVectorOvrCtrl
            (
            );
            /**Sets  the override state of the action cross pin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetActionCrossPinVectorOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the cross pin direction of the Action Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * ActionCrossPinVector
            (
            );
            /**Sets  the cross pin direction of the Action Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetActionCrossPinVector
            (
                NXOpen::Direction * actionCrossPinVector /** actioncrosspinvector */ 
            );
            /**Returns  the override state of the base spin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState BaseSpinVectorOvrCtrl
            (
            );
            /**Sets  the override state of the base spin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetBaseSpinVectorOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the spin direction of the Base Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * BaseSpinVector
            (
            );
            /**Sets  the spin direction of the Base Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetBaseSpinVector
            (
                NXOpen::Direction * baseSpinVector /** basespinvector */ 
            );
            /**Returns  the override state of the base cross pin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState BaseCrossPinVectorOvrCtrl
            (
            );
            /**Sets  the override state of the base cross pin vector, which should only be used for occurrence 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetBaseCrossPinVectorOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the cross pin direction of the Base Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * BaseCrossPinVector
            (
            );
            /**Sets  the cross pin direction of the Base Motion Body. Used only when joint subtype is 
                    @link  Motion::JointDefine::TypeUniversal   Motion::JointDefine::TypeUniversal @endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetBaseCrossPinVector
            (
                NXOpen::Direction * baseCrossPinVector /** basecrosspinvector */ 
            );
        };
    }
}
