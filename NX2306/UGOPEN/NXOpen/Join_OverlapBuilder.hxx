    ...
    namespace Join
    {
        ...
        */
        class JOINOPENCPPEXPORT  OverlapBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum ReferenceSheetOptionTypes
            {
                ReferenceSheetOptionTypesTopTarget/** Join Reference Sheet feature is created on the top of the target body. */,
                ReferenceSheetOptionTypesBetweenBodies/** Join Reference Sheet feature is created between the target and tool bodies. */
            };

            /** The type to specify if reference sheet edges should be automatially selected. */
            public: enum GuideCurveCreationTypes
            {
                GuideCurveCreationTypesManual/** User must manually specify the edges on the reference sheet. */,
                GuideCurveCreationTypesAutomatic/** Automatically determine edges needed to create a centerline or offset curves on a reference sheet. */
            };
            ...
            /**Returns  the option to control where the overlap sheet will be created. 
             ...
             <br> License requirements : nx_join (" NX Join") */
            public: NXOpen::Join::OverlapBuilder::ReferenceSheetOptionTypes ReferenceSheetOption
            (
            );
            /**Sets  the option to control where the overlap sheet will be created. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetReferenceSheetOption
            (
                NXOpen::Join::OverlapBuilder::ReferenceSheetOptionTypes sheetLocation /** sheetlocation */ 
            );
            /**Returns  the option if sheet edges should be automatically selected. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: NXOpen::Join::OverlapBuilder::GuideCurveCreationTypes GuideCurveCreationType
            (
            );
            /**Sets  the option if sheet edges should be automatically selected. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetGuideCurveCreationType
            (
                NXOpen::Join::OverlapBuilder::GuideCurveCreationTypes guideCurveCreationType /** guidecurvecreationtype */ 
            );
            ...
            /**Returns  the offset distance from edge 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: double OffsetFromEdgeDistance
            (
            );
            /**Sets  the offset distance from edge 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetOffsetFromEdgeDistance
            (
                double offsetFromEdgeDistance /** offsetfromedgedistance */ 
            );
