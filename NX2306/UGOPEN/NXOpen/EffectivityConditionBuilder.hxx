...
namespace NXOpen
{
    ...
    EffectivityType </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  EffectivityConditionBuilder : public NXOpen::Builder
    {
        ...
        /** Registers the @link NXOpen::BasicEffectivityBuilder NXOpen::BasicEffectivityBuilder@endlink  to make sure its effectivity formula 
         ...
         <br>  Created in NX8.5.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::PDM::EffectivityTableBuilder instead.") void RegisterBasicEffectivityBuilder
        (
