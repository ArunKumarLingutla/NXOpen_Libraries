    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimPart : public NXOpen::CAE::CaePart
        {
            ...
            /** Relabels the csys, physical, group, and modeling object labels by the specified offset value
                     
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void RelabelEntitiesByOffsets
            (
                int csysOffset /** csys offset */,
                int physOffset /** physical offset */,
                int groupOffset /** group offset */,
                int ssmoOffset /** modeling object offset */
            );
            /** Compress the labels of csys, physical, and groups 
                     
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void CompressEntityLabels
            (
                ...
                bool compressSsmoLabels /** compress the modeling object labels */
            );
        };
    }
}
