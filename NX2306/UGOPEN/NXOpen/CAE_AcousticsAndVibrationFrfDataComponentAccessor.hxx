        ...
        */
        class NXOPENCPP_CAEEXPORT  AcousticsAndVibrationFrfDataComponentAccessor : public NXOpen::NXObject
        {
            ...
            public: enum QuantityEnum
            {
                ...
                QuantityEnumPressureVolumeDisplacement/** pressure volume displacement */ ,
                QuantityEnumPressureVolumeVelocity/** pressure volume velocity */ ,
                QuantityEnumPressureVolumeAcceleration/** pressure volume acceleration */ 
            };
            ...
            /**Returns  the SVD method 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::AcousticsAndVibrationFrfDataComponentAccessor::SvdFilterTypeEnum SvdFilterType
            (
            );
            /**Sets  the SVD method 
             <br>  Created in NX1926.0.0.  <br>  
            ...
            (
                NXOpen::CAE::AcousticsAndVibrationFrfDataComponentAccessor::SvdFilterTypeEnum quantity /** quantity */ 
            );
        };
    }
}
