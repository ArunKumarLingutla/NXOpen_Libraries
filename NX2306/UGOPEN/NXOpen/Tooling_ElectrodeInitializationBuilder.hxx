        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ElectrodeInitializationBuilder : public NXOpen::Builder
        {
            ...
            public: enum Method
            {
                ...
                MethodOnlyTopPart/** only top part */ ,
                MethodNumber/** number */ 
            };
            ...
            (
                ...
                int cloneMethod /** cloning method */
            );
            /** Sets details of the configuration data. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            ...
            (
                NXOpen::NXObject * rootPartTag /** root part object */
            );
            ...
            /** Remove a selected machine set node. 
             ...
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void RemoveSelectedMsetNode
            (
                NXOpen::TaggedObject * msetPartTag /** msetparttag */ 
            );
            /** Analyse the register data.  @return  Array of index map between action type to initialize method 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: std::vector<int> AnalyseInitProjectRegisterData
            (
                int number /** Number of action type in register spreadsheet */
            );
        };
    }
}
