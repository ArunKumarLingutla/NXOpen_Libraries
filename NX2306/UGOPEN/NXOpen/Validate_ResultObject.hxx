        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  ResultObject : public NXOpen::NXObject
        {
            ...
            /** 
                      ...
                      @return  the value name of check result 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject::AttributeInformation AskAttribute
            (
                const NXString & name /**the attribute name of check result*/
            );
            /** 
                         Ask a single value attribute of check result. 
                         Refer to the VARIABLE table column in the section "Variables Supported by Check-Mate Templates" 
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::NXObject::AttributeInformation AskAttribute
            (
                const char * name /**the attribute name of check result*/
            );
            /** 
