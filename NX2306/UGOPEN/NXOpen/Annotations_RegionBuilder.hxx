...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        ConformToSurface </term> <description> 
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  RegionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the crosshatch color 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Crosshatch.Color</ja_property> instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Crosshatch.Color</ja_property> instead.") NXOpen::NXColor * CrosshatchColor
            (
            );
            /**Sets  the crosshatch color 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Crosshatch.Color</ja_property> instead.") void SetCrosshatchColor
            (
            ...
            /**Returns  the display crosshatch toggle 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Region.DisplayCrosshatch</ja_property> instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Region.DisplayCrosshatch</ja_property> instead.") bool DisplayCrosshatch
            (
            );
            /**Sets  the display crosshatch toggle 
             ...
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Region.DisplayCrosshatch</ja_property> instead.") void SetDisplayCrosshatch
            (
                bool displayCrosshatch /** displaycrosshatch */ 
            );
            /**Returns  the crosshatch settings block 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Crosshatch</ja_property> instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Crosshatch</ja_property> instead.") NXOpen::Annotations::HatchFillSettingsBuilder * CrosshatchSettings
            (
            );
            /**Returns  the boundary curve settings block 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Region.RegionBoundaryCurveCFW</ja_property> instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use <ja_property>NXOpen.RegionBuilder.Settings.Region.RegionBoundaryCurveCFW</ja_property> instead.") NXOpen::LineColorFontWidthBuilder * BoundaryColorFontWidth
            (
            );
            ...
            /** The region is inherited from the given region
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void InheritFrom
            (
                NXOpen::Annotations::Annotation * inheritTag /** inherittag */ 
            );
        };
    }
}
