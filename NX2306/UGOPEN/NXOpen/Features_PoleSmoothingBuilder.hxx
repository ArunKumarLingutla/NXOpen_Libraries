...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ApplyConstraintsToAll </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ModificationPercentage </term> <description> 
         
        100 </description> </item> 

        <item><term> 
         
        MoveOnlySelectedPoles </term> <description> 
        ...
        UseSpecificDirection </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PoleSmoothingBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the selected poles, this is used only when @link MoveOnlySelectedPoles MoveOnlySelectedPoles@endlink  is true 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            ...
            /**Returns   the movement direction vector, this is used only when @link UseSpecificDirection UseSpecificDirection@endlink  is true. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Direction * MovementVector
            (
            );
            /**Sets   the movement direction vector, this is used only when @link UseSpecificDirection UseSpecificDirection@endlink  is true. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") */
