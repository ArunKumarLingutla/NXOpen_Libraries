...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SimpleSketchInPlaceBuilder : public NXOpen::Builder
    {
        ...
        /**Returns  the horizontal reference object (Line, Linear Edge, Datum Axis) for sketch 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::SelectNXObject * HorizontalReference
        (
        );
        /** Flip the direction of sketch horizontal reference.
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") */
