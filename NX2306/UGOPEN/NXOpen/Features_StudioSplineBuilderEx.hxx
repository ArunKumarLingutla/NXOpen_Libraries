    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StudioSplineBuilderEx : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the flag indicating if selected point or pole should be projected on the snapped object 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool ProjectToGeometry
            (
            );
            /**Sets  the flag indicating if selected point or pole should be projected on the snapped object 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") OR insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetProjectToGeometry
            (
                bool canProject /** canproject */ 
            );
        };
    }
}
