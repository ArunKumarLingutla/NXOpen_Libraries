...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        PlaneType </term> <description> 
         
        ModelView </description> </item> 

        <item><term> 
         
        SpaceFactor </term> <description> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  WeldPmiBuilder : public NXOpen::Builder
        {
            ...
            /** This represents the option to group weld symbols. */
            public: enum GroupWeldSymbolsType
            {
                GroupWeldSymbolsTypeNone/** No grouping of weld symbols */,
                GroupWeldSymbolsTypeAll/** Group weld symbols of all selected objects */,
                GroupWeldSymbolsTypeByStructureDesignerObjects/** Group like weld symbols according to objects created by same structure designer objects */
            };
            ...
            /**Returns  the indication whether to combine identical weld symbols. 
             ...
             <br> License requirements : None */
            public: NXOpen::Weld::WeldPmiBuilder::GroupWeldSymbolsType GroupWeldSymbols
            (
            );
            /**Sets  the indication whether to combine identical weld symbols. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") OR structure_weld ("STRUCTURE WELD") */
            public: void SetGroupWeldSymbols
            (
                NXOpen::Weld::WeldPmiBuilder::GroupWeldSymbolsType groupWeldSymbols /** groupweldsymbols */ 
            );
        };
    }
}
