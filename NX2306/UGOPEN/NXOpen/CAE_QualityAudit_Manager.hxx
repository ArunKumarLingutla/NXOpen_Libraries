    ...
    namespace CAE
    {
        namespace QualityAudit
        {
            ...
            */
            ...
            {
                /** Action type to be used in the quality audit process. This is no longer required. 
                 <br>  @deprecated Deprecated in NX1847.0.0.  This type is no longer needed. <br>  
                */
                public: enum NX_DEPRECATED("Deprecated in NX1847.0.0.  This type is no longer needed.") ActionType
                {
                ...
                /**Returns  the current quality audit action type.
                 ...
                 <br>  @deprecated Deprecated in NX1847.0.0.  The action type is no longer relevant. <br>  

                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX1847.0.0.  The action type is no longer relevant.") NXOpen::CAE::QualityAudit::Manager::ActionType CurrentActionType
                (
                );
                ...
                public: NX_DEPRECATED("Deprecated in NX1847.0.0.  The action type is no longer relevant.") void SetCurrentActionType
                (
                ...
                (
                    const std::vector<NXOpen::CAE::QualityAudit::Action *> & actionsToExport /** actionstoexport */ ,
                ...
                /**Returns  the option to use the input list for the connections used in Connection Synthesis check
                 ...
                 <br> License requirements : None */
                public: bool UseInputListForSynthesis
                (
                );
                /**Sets  the option to use the input list for the connections used in Connection Synthesis check
                             
                 <br>  Created in NX1938.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
                public: void SetUseInputListForSynthesis
                (
                    bool useInputList /** useinputlist */ 
                );
