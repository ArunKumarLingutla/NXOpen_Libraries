            ...
            */
            class NXOPENCPP_CAEEXPORT  ElementMaterialOrientationCheckBuilder : public NXOpen::Builder, public virtual NXOpen::CAE::ModelCheck::ISelectionBuilder
            {
                ...
                public: enum MaterialOrientationSolidElementDisplayType
                {
                    ...
                    MaterialOrientationSolidElementDisplayTypeSolidExteriorElements/** exterior solid elements */
                };
                ...
                /** Gets option value which indicates whether to set translucency or not 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: bool GetCheckTranslucency
                (
                );
                /** Sets option value which indicates whether to set translucency or not
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
