...
namespace NXOpen
{
    ...
    */
    class NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::SketchWorkRegionBuilder instead.") NXOPENCPPEXPORT  SketchDefineWorkRegionBuilder : public NXOpen::Builder
    {
        /** Represents the options to specify the work region. 
         <br>  @deprecated Deprecated in NX1980.0.0.  Use @link NXOpen::SketchWorkRegionBuilder NXOpen::SketchWorkRegionBuilder@endlink  instead. <br>  
        */
        public: enum NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::SketchWorkRegionBuilder instead.") ScopeType
        {
        ...
        public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::SketchWorkRegionBuilder instead.") NXOpen::SketchDefineWorkRegionBuilder::ScopeType Scope
        (
        );
        ...
        public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::SketchWorkRegionBuilder instead.") void SetScope
        (
        ...
        /**Returns  the work region objects. The work region defines the curves can be modified. The curves outside the region are 
         ...
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::SketchWorkRegionBuilder instead.") NXOpen::ScCollector * WorkRegionObjects
        (
        );
    };
}
