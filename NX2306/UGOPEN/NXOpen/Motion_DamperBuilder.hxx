    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  DamperBuilder : public NXOpen::Motion::ConnectorBuilder
        {
            ...
            /**Returns  the option of show visualization 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool ShowVisualization
            (
            );
            /**Sets  the option of show visualization 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            /**Returns  the out cylinder radius. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * OuterCylinderRadiusExpression
            (
            );
            /**Returns  the inner cylinder radius. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * InnerCylinderRadiusExpression
            (
            );
        };
    }
