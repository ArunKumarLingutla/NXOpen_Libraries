...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        ...
        {
            /** Represents the type when export to targets or errors to csv file */
            public: enum TargetType
            {
                TargetTypeAll/** Export all the targets or errors to the csv file */,
                TargetTypeFrequencies/** Export all the frequency targets or errors to the csv file*/,
                TargetTypeModeShapes/** Export all the mode shape targets or errors to the csv file */
            };
            ...
            /** Creates the builder object of model update correlation method 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_correl_update ("FE Model Update") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Please use the builder NXOpen::CAE::CorrelModePairingBuilder to set correlation method.") NXOpen::CAE::ModelUpdateCorrelMethodBuilder * CreateCorrelMethodBuilder
            (
            );
