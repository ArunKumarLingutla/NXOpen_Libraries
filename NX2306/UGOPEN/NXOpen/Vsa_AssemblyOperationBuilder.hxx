        ...
        */
        class NXOPENCPP_VSAEXPORT  AssemblyOperationBuilder : public NXOpen::Builder
        {
            ...
            public: enum APIEnumDistributionFloatType
            {
                ...
                APIEnumDistributionFloatTypeDirectionalBias/** directional bias */ ,
                APIEnumDistributionFloatTypeRotationalBias/** rotational bias */ 
            };
            ...
            /** Gets One Object Being Moved 
             ...
             <br> License requirements : None */
            public: NXOpen::NXObject * GetObjectBeingMovedItem
            (
                int index /** index */ 
            );
            /** Sets One Object Being Moved 
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetObjectBeingMovedItem
            (
                int index /** index */ ,
            ...
            /**Returns  the property represents  override defualt distribution float flag. 
             ...
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool OverrideDefaultFloatDist
            (
            );
            /**Sets  the property represents  override defualt distribution float flag. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetOverrideDefaultFloatDist
            (
                bool overrideDefaultFloatDist /** overridedefaultfloatdist */ 
            );
            /**Returns  the enum  Float Type. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::AssemblyOperationBuilder::APIEnumDistributionFloatType DistributionFloatType
            (
            );
            ...
            (
                NXOpen::Vsa::AssemblyOperationBuilder::APIEnumDistributionFloatType distributionFloatType /** distributionfloattype */ 
            );
            /**Returns  the Normal distribution 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double DirectionDistributionI
            (
            );
            /**Sets  the Normal distribution 
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetDirectionDistributionI
            (
                double directionDistributionI /** directiondistributioni */ 
            );
            /**Returns  the  Normal distribution 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double DirectionDistributionJ
            (
            );
            /**Sets  the  Normal distribution 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetDirectionDistributionJ
            (
                double directionDistributionJ /** directiondistributionj */ 
            );
            /**Returns  the  Normal distribution 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double DirectionDistributionK
            (
            );
            /**Sets  the  Normal distribution 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetDirectionDistributionK
            (
                double directionDistributionK /** directiondistributionk */ 
            );
        };
    }
}
