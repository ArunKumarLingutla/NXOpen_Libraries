...
namespace NXOpen
{
    ...
    namespace Fields
    {
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldVariable : public NXOpen::NXObject
        {
            /** Variable Types */
            public: enum Type
            {
            ...
            {
                ValueTypeReal/** real */,
                ValueTypeImaginary/** (Legacy) imaginary */,
                ValueTypeComplexRealImaginary/** (Legacy) complex_real_imaginary */,
                ValueTypeComplexMagnitudePhase/** (Legacy) complex_magnitude_phase */,
                ValueTypeComplex/** Complex */,
