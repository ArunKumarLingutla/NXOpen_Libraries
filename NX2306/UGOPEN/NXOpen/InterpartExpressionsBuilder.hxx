...
namespace NXOpen
{
    ...
    /**
        ...
        You can access all @link NXOpen::Expression NXOpen::Expression@endlink  which are created from the method @link Builder::GetCommittedObjects Builder::GetCommittedObjects@endlink  
        after you execute @link Builder::Commit Builder::Commit@endlink . The @link NXOpen::Expression NXOpen::Expression@endlink  will be
        returned in a stable alphabetic-numerical order.
