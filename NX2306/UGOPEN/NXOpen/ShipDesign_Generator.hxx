        ...
        */
        class NXOPENCPP_SHIPDESIGNEXPORT  Generator
        {
            ...
            /** Check assembly circular references. 
             ...
             <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_mfg_prep ("Ship Manufacturing") */
