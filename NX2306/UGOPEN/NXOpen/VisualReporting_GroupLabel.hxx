    ...
    namespace VisualReporting
    {
        ...
        */
        class NXOPENCPP_VISUALREPORTINGEXPORT  GroupLabel : public NXOpen::NXObject
        {
            ...
            /**Sets  the Error Level of this @link NXOpen::VisualReporting::GroupLabel NXOpen::VisualReporting::GroupLabel@endlink . 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_visual_reporting ("Visual Reporting") */
            public: void SetErrorLevel
            (
                NXOpen::Validation::Result errorLevel /** errorlevel */ 
            );
        };
    }
}
