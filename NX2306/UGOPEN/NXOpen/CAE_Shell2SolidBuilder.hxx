    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  Shell2SolidBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the mesh gradation 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: double MeshGradation
            (
            );
            /**Sets  the mesh gradation 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetMeshGradation
            (
                double dMeshGrdation /** dmeshgrdation */ 
            );
            /**Returns  the max edge length toggle  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool MaxEdgeLengthOption
            (
            );
            /**Sets  the max edge length toggle  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetMaxEdgeLengthOption
            (
                bool fMaxEdgeLengthOption /** fmaxedgelengthoption */ 
            );
            /**Returns  the max edge length value  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::Expression * MaxEdgeLengthValue
            (
            );
            /**Returns  the bouding volume selection objects 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::SelectTaggedObjectList * BoundingVolumeSelectionList
            (
            );
            ...
            /**Returns  the transition with pyramid elements 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool PyramidTransition
            (
            );
            /**Sets  the transition with pyramid elements 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetPyramidTransition
            (
                bool fPyramidTransition /** fpyramidtransition */ 
            );
            /**Returns  the Solid From Shell Mesh property table
