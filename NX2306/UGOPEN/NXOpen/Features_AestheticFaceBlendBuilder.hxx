...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        CenterChordLaw.LawType (deprecated) </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  AestheticFaceBlendBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Tangent Line To Cross Section Relation options */
            public: enum TangentLineToCrossSectionRelationType
            {
                TangentLineToCrossSectionRelationTypeAbsolute/** Absolute */,
                TangentLineToCrossSectionRelationTypeRelative/** Relative */
            };
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::Features::AestheticFaceBlendBuilder::TangentLineToCrossSectionRelationType TangentLineToCrossSectionRelationOption
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetTangentLineToCrossSectionRelationOption
            (
                NXOpen::Features::AestheticFaceBlendBuilder::TangentLineToCrossSectionRelationType relationOption /** relationoption */ 
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: double CenterRadiusRelationFactor
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetCenterRadiusRelationFactor
            (
                double relativeFactor /** relativefactor */ 
            );
            ...
            /**Returns  the center chord law 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use @link Features::AestheticFaceBlendBuilder::CenterRadiusLaw Features::AestheticFaceBlendBuilder::CenterRadiusLaw@endlink  and @link Features::AestheticFaceBlendBuilder::CenterRadiusLaw Features::AestheticFaceBlendBuilder::CenterRadiusLaw@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use Features::AestheticFaceBlendBuilder::CenterRadiusLaw and Features::AestheticFaceBlendBuilder::CenterRadiusLaw instead.") NXOpen::GeometricUtilities::LawBuilder * CenterChordLaw
            (
            );
