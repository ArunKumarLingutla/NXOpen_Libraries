...
namespace NXOpen
{
    ...
    namespace UIStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  IntegerItem : public NXOpen::UIStyler::StylerItem
        {
            public: /**Called when a dialog user enters a valid integer value and presses Return 
             <br>  Created in NX5.0.0.  <br>  
            ...
            (
                const NXString & strLabel /** String to display on the left side of the text field.*/
            );
            /**Specifies descriptive text to display for the dialog item. It should describe the dialog 
                item's intended use. If you specify a bitmap for this dialog item, it uses this text as tooltip text. 
             <br>  Created in NX5.0.0.  <br>  
            ...
            void SetLabel
            (
                const char * strLabel /** String to display on the left side of the text field.*/
            );
