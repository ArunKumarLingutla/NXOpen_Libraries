    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  DPMItpBuilder : public NXOpen::CAM::ParamBuilder
        {
            ...
            public: enum CrossCurveNormalToFlowSideOption
            {
                CrossCurveNormalToFlowSideOptionBoth/** preserve both sides */,
                CrossCurveNormalToFlowSideOptionLeft/** preserve left side */,
                CrossCurveNormalToFlowSideOptionRight/** preserve right side */
            };
            ...
            /**Returns  the tool position 
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmToolPosition::ToolPosition NXOpen::CAM::DmToolPosition::ToolPosition@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmToolPosition::ToolPosition instead.") NXOpen::CAM::DPMItpBuilder::ToolPositionOption ToolPosition
            (
            );
            /**Sets  the tool position 
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmToolPosition::SetToolPosition NXOpen::CAM::DmToolPosition::SetToolPosition@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmToolPosition::SetToolPosition instead.") void SetToolPosition
            (
            ...
            /**Returns  the Cut Step
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::CutStepType NXOpen::CAM::DmStreamlineCutStep::CutStepType@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::CutStepType instead.") NXOpen::CAM::DPMItpBuilder::StepMethodOption StepMethod
            (
            );
            /**Sets  the Cut Step
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::SetCutStepType NXOpen::CAM::DmStreamlineCutStep::SetCutStepType@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::SetCutStepType instead.") void SetStepMethod
            (
                NXOpen::CAM::DPMItpBuilder::StepMethodOption stepMethod /** the value of Cut Step */
            );
            /**Returns  the First Cut
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::FirstCut NXOpen::CAM::DmStreamlineCutStep::FirstCut@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::FirstCut instead.") int CutStepFirstCut
            (
            );
            /**Sets  the First Cut
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::SetFirstCut NXOpen::CAM::DmStreamlineCutStep::SetFirstCut@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::SetFirstCut instead.") void SetCutStepFirstCut
            (
                int firstCut /** the first cut value */
            );
            /**Returns  the  Second Cut
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::SecondCut NXOpen::CAM::DmStreamlineCutStep::SecondCut@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::SecondCut instead.") int CutStepSecondCut
            (
            );
            /**Sets  the  Second Cut
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::SetSecondCut NXOpen::CAM::DmStreamlineCutStep::SetSecondCut@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::SetSecondCut instead.") void SetCutStepSecondCut
            (
                int secondCut /** the second cut value */
            );
            /**Returns  the Third Cut
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::ThirdCut NXOpen::CAM::DmStreamlineCutStep::ThirdCut@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::ThirdCut instead.") int CutStepThirdCut
            (
            );
            /**Sets  the Third Cut
             <br>  @deprecated Deprecated in NX10.0.1.  Use @link NXOpen::CAM::DmStreamlineCutStep::SetThirdCut NXOpen::CAM::DmStreamlineCutStep::SetThirdCut@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.1.  Use NXOpen::CAM::DmStreamlineCutStep::SetThirdCut instead.") void SetCutStepThirdCut
            (
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::DPMItpBuilder::CrossCurveNormalToFlowSideOption CrossCurveNormalToFlowSide
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCrossCurveNormalToFlowSide
            (
                NXOpen::CAM::DPMItpBuilder::CrossCurveNormalToFlowSideOption curveSide /** the cross curve side value */
            );
