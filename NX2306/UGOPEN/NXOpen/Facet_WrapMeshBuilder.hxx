        ...
        */
        class NXOPENCPP_FACETEXPORT  WrapMeshBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the proximity refinement 
             ...
             <br> License requirements : None */
            public: bool ProximityRefinement
            (
            );
            /**Sets  the proximity refinement 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_polygon_modeling (" NX Polygon Modeling") */
            public: void SetProximityRefinement
            (
                bool proximityRefinement /** proximityrefinement */ 
            );
            ...
            /**Returns  the facets in gap 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: int FacetsInGap
            (
            );
            /**Sets  the facets in gap 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_polygon_modeling (" NX Polygon Modeling") */
            public: void SetFacetsInGap
            (
                int facetsInGap /** facetsingap */ 
            );
