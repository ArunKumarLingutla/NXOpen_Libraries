            ...
            class NXOPENCPP_CAEEXPORT  RecombineAndMerge
            {
                ...
                */
                ...
                /** Cyclic Symmetry: Merge the Results 2D-3D 
                 <br>  @deprecated Deprecated in NX1957.0.0.  Use @link NXOpen::CAE::RotorDynamics::RecombineAndMerge::CompleteMerge NXOpen::CAE::RotorDynamics::RecombineAndMerge::CompleteMerge@endlink  to ensure right parameters transfer between cyclic symmetry recombination and merge. <br>  

                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX1957.0.0.  Use NXOpen::CAE::RotorDynamics::RecombineAndMerge::CompleteMerge to ensure right parameters transfer between cyclic symmetry recombination and merge.") NXString Merge
                (
