        ...
        namespace FTK
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  ExportFilesParameter : public NXOpen::TransientObject
            {
                ...
                {
                    HeaderOptionsFileDescription/** file description */ ,
                    HeaderOptionsGeneral/** general */ ,
                    HeaderOptionsAbscissa/** abscissa */ ,
                    HeaderOptionsOrdinate/** ordinate */ ,
                    HeaderOptionsAbscissaZ/** abscissa z */ ,
                    HeaderOptionsApplicationSpecific/** application specific */ 
                };
                ...
                /**Returns  the full header print required. If the setting is true, all header options are required for export. 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                public: bool IsHeaderExportRequired
                (
                );
                /**Sets  the full header print required. If the setting is true, all header options are required for export. 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /** Asks whether to export the specified header option 
                 ...
                 <br> License requirements : None */
                public: bool GetIsCertainHeaderExportRequired
                (
                    NXOpen::CAE::FTK::ExportFilesParameter::HeaderOptions whichHeader /** whichheader */ 
                );
                /** Sets whether or not a specific header is required 
                 <br>  Created in NX1899.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetIsCertainHeaderExportRequired
                (
                    NXOpen::CAE::FTK::ExportFilesParameter::HeaderOptions whichHeader /** whichheader */ ,
