        ...
        */
        class AMEOPENCPPEXPORT  ExtractAttributeBaseBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the context object in source object to extract the attribute from  
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::NXObject * ContextObject
            (
            );
            /**Sets  the context object in source object to extract the attribute from  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetContextObject
            (
                NXOpen::NXObject * contextObject /** contextobject */ 
            );
        };
    }
}
