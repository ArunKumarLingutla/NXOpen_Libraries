        ...
        */
        class NXOPENCPP_CAMEXPORT  DriveMode : public NXOpen::TaggedObject
        {
            ...
            */
            ...
            /**Returns  the Reference Hub Tool Diameter 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: double ReferenceHubToolDiameter
            (
            );
            /**Sets  the Reference Hub Tool Diameter 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: void SetReferenceHubToolDiameter
            (
                double toolDia /** the Reference Hub Tool Diameter */
            );
