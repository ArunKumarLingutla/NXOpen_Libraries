...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Limits.EndLimit.LimitOption </term> <description> 
         
        AtPoint </description> </item> 

        <item><term> 
         
        SupportPlaneData.SupportPlaneLockStatus </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  AssociativeArcBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the zone point is required when arc has multiple solutions in following conditions: 
                        1. Arc is defined with a radius constraint. 
                        2. Arc is defined with two identical point constraints. 
                        3. Arc is defined with the middle constraint as tangent constraint. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point3d ZonePoint
            (
            );
            /**Sets  the zone point is required when arc has multiple solutions in following conditions: 
                        1. Arc is defined with a radius constraint. 
                        2. Arc is defined with two identical point constraints. 
                        3. Arc is defined with the middle constraint as tangent constraint. 
             <br>  Created in NX5.0.0.  <br>  
