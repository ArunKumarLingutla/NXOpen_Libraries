    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioConfigurationVariableCallbackContext : public NXOpen::TransientObject
        {
            ...
            /**Returns  the current @link CAE::PostScenarioSelectionParameters CAE::PostScenarioSelectionParameters@endlink .
                      
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::PostScenarioSelectionParameters * SelectionParameters
            (
            );
