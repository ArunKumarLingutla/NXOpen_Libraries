    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MappedMeshBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the mapped mesh multiblock option 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool AttemptMultiblockDecompositionOption
            (
            );
            /**Sets  the mapped mesh multiblock option 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetAttemptMultiblockDecompositionOption
            (
                bool attemptMultiblockDecompositionOption /** attempt multiblock decomposition option */ 
            );
            /**Returns  the mapped mesh insert blend element option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool InsertBlendElement
            (
            );
            /**Sets  the mapped mesh insert blend element option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetInsertBlendElement
            (
                bool insertBlendElement /** insert blend element */ 
            );
            /**Returns  the mapped mesh control slender option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool ControlSlender
            (
            );
            /**Sets  the mapped mesh control slender option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetControlSlender
            (
                bool controlSlender /** control slender */ 
            );
            /**Returns  the mapped mesh sweep angle 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double SweepAngle
            (
            );
            /**Sets  the mapped mesh sweep angle 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the mapped mesh minimum aspect ratio 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double MinAspectRatio
            (
            );
            /**Sets  the mapped mesh minimum aspect ratio 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetMinAspectRatio
            (
                double minAspectRatio /** min aspect ratio */ 
            );
            /**Returns  the mapped mesh gradation rate 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double GradationRate
            (
            );
            /**Sets  the mapped mesh gradation rate 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetGradationRate
            (
                double gradationRate /** gradation rate */ 
            );
            /**Returns  the mapped mesh smoothing distance factor 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double SmoothingDistanceFactor
            (
            );
            /**Sets  the mapped mesh smoothing distance factor 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetSmoothingDistanceFactor
            (
                double smoothingDistanceFactor /** smoothing distance factor */ 
            );
            /**Returns  the mapped mesh all triangle boundary layer 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool AllTriBoundaryLayer
            (
            );
            /**Sets  the mapped mesh all triangle boundary layer 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetAllTriBoundaryLayer
            (
                bool allTriBoundaryLayer /** all tri boundary layer */ 
            );
        };
    }
}
