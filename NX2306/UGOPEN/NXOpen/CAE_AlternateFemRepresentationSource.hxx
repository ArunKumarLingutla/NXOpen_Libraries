    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AlternateFemRepresentationSource : public NXOpen::TaggedObject
        {
            ...
            /** Creates one @link NXOpen::CAE::SingleLabelSelectionRecipe NXOpen::CAE::SingleLabelSelectionRecipe@endlink  for each node in 
                        the mapping having associated data.
                        The recipe name is the node name from the mapping, where invalid characters have been replaced by the
                        sharp (#) character.
                        The recipe label is the label of the node given by the mapping.
                        The @link NXOpen::CAE::SelRecipeBuilder::InputFilterType NXOpen::CAE::SelRecipeBuilder::InputFilterType@endlink  is "component" 
                        and the componentTag identifies the component.
                        The labels and components of existing @link NXOpen::CAE::SingleLabelSelectionRecipe NXOpen::CAE::SingleLabelSelectionRecipe@endlink  recipes 
                        will be updated only if the updateExistingRecipes Boolean is true. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void CreateSingleLabelSelectionRecipes
            (
                bool updateExistingRecipes /** if true, labels and components of existing recipes will be updated */,
                NXOpen::TaggedObject * componentTag /** the input filter component tag */
            );
            /** Creates one @link NXOpen::CAE::CoordinateSelectionRecipe NXOpen::CAE::CoordinateSelectionRecipe@endlink  for each node in 
                        the mapping having associated data.
                        The recipe name is the node name from the mapping, where invalid characters have been replaced by the
                        sharp (#) character.
                        The coordinates in the recipe are the coordinates of the node in the Alternate Fem Representation Source.
                        The @link NXOpen::CAE::SelRecipeBuilder::InputFilterType NXOpen::CAE::SelRecipeBuilder::InputFilterType@endlink  is "component" 
                        and the componentTag identifies the component.
                        The coordinates, tolerance, resolve preference and component of existing @link NXOpen::CAE::CoordinateSelectionRecipe NXOpen::CAE::CoordinateSelectionRecipe@endlink  
                        will be updated only if the updateExistingRecipes Boolean is true.
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void CreateCoordinateSelectionRecipes
            (
                bool updateExistingRecipes /** if true, coordinates, tolerance, resolve preference and component of existing recipes will be updated */,
                NXOpen::TaggedObject * componentTag /** the input filter component tag */,
                double tolerance /** the search tolerance. */,
                NXOpen::CAE::SelRecipeCoordinateStrategy::Pref resolvePreference /** the resolve coordinate preference */
            );
        };
    }
}
