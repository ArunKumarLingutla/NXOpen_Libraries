...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        */
        ...
        {
            /** Represents the Spine option. This option will be used while editing the lagecy features (Features having profile without section in it). */
            ...
            /**Returns  the spine option of the legacy features.  This will be used only during the edit of Pre NX3 feature Parms 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricUtilities::AlongSpineBuilder::RetainSpineOption SpineOption
            (
            );
            /**Sets  the spine option of the legacy features.  This will be used only during the edit of Pre NX3 feature Parms 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
