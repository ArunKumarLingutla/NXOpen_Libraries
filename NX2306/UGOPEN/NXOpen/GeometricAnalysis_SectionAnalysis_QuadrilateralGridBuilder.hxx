...
namespace NXOpen
{
    ...
    namespace GeometricAnalysis
    {
        namespace SectionAnalysis
        {
            ...
            */
            class NXOPENCPP_GEOMETRICANALYSISEXPORT  QuadrilateralGridBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
