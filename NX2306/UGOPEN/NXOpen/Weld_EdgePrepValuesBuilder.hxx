    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  EdgePrepValuesBuilder : public NXOpen::Builder
        {
            ...
            /** Creates the path curves to be used for @link NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseStartValue NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseStartValue@endlink  and @link NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseEndValue NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseEndValue@endlink . 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : structure_weld ("STRUCTURE WELD") */
            public: void CreatePathCurvesForLeaveLoose
            (
                NXOpen::Curve ** path /** Path curve for @link NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseStartValue NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseStartValue@endlink . */,
                NXOpen::Curve ** reversedPath /** Reversed Path Curve for @link NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseEndValue NXOpen::Weld::EdgePrepValuesBuilder::LeaveLooseEndValue@endlink . */
            );
        };
    }
}
