    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CoolingPatternBuilder : public NXOpen::Builder
        {
            ...
            /** Sets the baffle vector. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetBaffleVector
            (
            );
            /** Reverses the baffle channel vector. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void ReverseBaffleDirection
            (
            );
            /** Removes the parameters of features. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void RemoveFeatureParameter
            (
            );
        };
    }
