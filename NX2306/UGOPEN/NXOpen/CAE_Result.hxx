        ...
        class NXOPENCPP_CAEEXPORT  Result : public NXOpen::NXObject
        {
            ...
            */
            ...
            /** Returns number of sectors for cyclic symmetric solution @return  
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::CAE::Result::GetCyclicSymmetricStages NXOpen::CAE::Result::GetCyclicSymmetricStages@endlink  instead, And use that object for the query. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::CAE::Result::GetCyclicSymmetricStages instead, And use that object for the query.") int AskNumberOfSectors
            (
            );
            ...
            /** Gets the post mesh collector. Pass correct mesh fid. 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostMeshCollector * GetPostMeshCollectorFromMeshfid
            (
                int meshfid /** meshfid */ 
            );
