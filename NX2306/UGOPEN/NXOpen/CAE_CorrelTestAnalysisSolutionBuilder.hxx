    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CorrelTestAnalysisSolutionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the sensor exciter info conflict resolution 
             <br>  @deprecated Deprecated in NX1926.0.0.  This method is no longer supported. Both sensor and exciter information on a shared node will be shown. <br>  

             <br>  Created in NX1903.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  This method is no longer supported. Both sensor and exciter information on a shared node will be shown.") bool ConflictResolutionUsingExciterInfo
            (
            );
            /**Sets  the sensor exciter info conflict resolution 
             <br>  @deprecated Deprecated in NX1926.0.0.  This method is no longer supported. Both sensor and exciter information on a shared node will be shown. <br>  

             <br>  Created in NX1903.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  This method is no longer supported. Both sensor and exciter information on a shared node will be shown.") void SetConflictResolutionUsingExciterInfo
            (
                bool useSensorInfoForNodes /** usesensorinfofornodes */ 
            );
            /**Returns  the add visualization nodes 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool AddUnattachedVisualizationNodes
            (
            );
            /**Sets  the add visualization nodes 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SetAddUnattachedVisualizationNodes
            (
                bool addVisualizationNodes /** addvisualizationnodes */ 
            );
        };
    }
}
