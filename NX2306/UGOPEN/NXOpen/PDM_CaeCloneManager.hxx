...
namespace NXOpen
{
    ...
    namespace PDM
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::PDM::PartOperationCopyBuilder instead.") NXOPENCPP_PDMEXPORT  CaeCloneManager : public NXOpen::TransientObject
        {
