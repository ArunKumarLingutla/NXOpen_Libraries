    ...
    namespace LineDesigner
    {
        ...
        */
        class LINEDESIGNEROPENCPPEXPORT  DisconnectConnectionBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::TaggedObject * selectedComponent /** First selected object. */,
                const std::vector<NXOpen::TaggedObject *> & componentToDisconnect /** All selected objects to disconnect. */
            );
        };
    }
}
