    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PdmSession
        {
            ...
            public: NXOpen::PDM::SearchRecipeFilterBuilder * CreateSearchRecipeFilterBuilder
            (
            ...
            /** Get the NX workflows from Teamcenter  @return  Errors encountered 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::OperationErrors * GetNXWorkflows
            (
                const std::vector<NXOpen::TaggedObject *> & objects /** the array of objects */,
                std::vector<NXString> & nameTypes /** the array of workflows */
            );
            /** Apply given workflow on the given list of objects  @return  Errors encountered 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::OperationErrors * AssignReleaseStatus
            (
                const std::vector<NXOpen::TaggedObject *> & objects /** the array of objects */,
                const NXString & nameType /** nametype */ 
            );
            /** Apply given workflow on the given list of objects  @return  Errors encountered 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
