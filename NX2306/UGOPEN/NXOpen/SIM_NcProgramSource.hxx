        ...
        */
        class NXOPENCPP_SIMEXPORT  NcProgramSource : public NXOpen::TaggedObject
        {
            ...
            /** Create an empty Main program in this source.
                        This is only allowed on the External File Source.
                        This can be requested with @link SIM::NcProgramManagerBuilder::GetExternalFileSource SIM::NcProgramManagerBuilder::GetExternalFileSource@endlink .  @return  The created program. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXOpen::SIM::NcProgram * CreateMainProgram
            (
                const NXString & channel /** The channel name */,
                const NXString & fileName /** The filename of the program */
            );
            /** Create an empty Main program in this source.
                        This is only allowed on the External File Source.
                        This can be requested with @link SIM::NcProgramManagerBuilder::GetExternalFileSource SIM::NcProgramManagerBuilder::GetExternalFileSource@endlink .  @return  The created program. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            NXOpen::SIM::NcProgram * CreateMainProgram
            (
                const char * channel /** The channel name */,
                const char * fileName /** The filename of the program */
            );
            ...
            (
                NXOpen::SIM::NcProgram * program /** The program to delete. */
            );
            /** Get main program for channel.  @return  The returned main program. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXOpen::SIM::NcProgram * GetMainProgram
            (
                const NXString & channel /** The channel name */
            );
            /** Get main program for channel.  @return  The returned main program. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            NXOpen::SIM::NcProgram * GetMainProgram
            (
                const char * channel /** The channel name */
            );
            /** Get subprogram with a given ID.  @return  The returned subprogram. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: NXOpen::SIM::NcProgram * GetSubprogram
            (
                const NXString & programId /** The program ID */
            );
            /** Get subprogram with a given ID.  @return  The returned subprogram. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            NXOpen::SIM::NcProgram * GetSubprogram
            (
                const char * programId /** The program ID */
            );
        };
    }
}
