    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  InsertEditToolsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the value indicating whether it is to update expression without parent change 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool UpdateExpressionWithoutParentChange
            (
            );
            /**Sets  the value indicating whether it is to update expression without parent change 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUpdateExpressionWithoutParentChange
            (
                bool updateExpressionWithoutParentChange /** Indicates whether it is to update expression without parent change */
            );
