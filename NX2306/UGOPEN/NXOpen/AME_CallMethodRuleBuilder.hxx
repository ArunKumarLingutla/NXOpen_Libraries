        ...
        */
        class AMEOPENCPPEXPORT  CallMethodRuleBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the creation type by creating a position
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ObjectConnectionBuilder::Type RuleCreationType
            (
            );
            ...
            /**Returns  the eo any port selection 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::SelectIPort * IterativeSelectedPort
            (
            );
            /**Returns  the iterative object connection block
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ObjectConnectionBuilder * IterativeObjectConnection
            (
            );
            /**Returns  the iterative method selection type
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ObjectConnectionBuilder::Type IterativeMethodSelectionType
            (
            );
            /**Sets  the iterative method selection type
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetIterativeMethodSelectionType
            (
                NXOpen::AME::ObjectConnectionBuilder::Type type /** type */ 
            );
            ...
            (
                NXOpen::AME::PlcCodePosition * anchroPosition /** anchroposition */ ,
                bool insertBefore /** insertbefore */ 
            );
        };
    }
}
