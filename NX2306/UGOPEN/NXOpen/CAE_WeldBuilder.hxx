    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  WeldBuilder : public NXOpen::Builder
        {
            ...
            public: enum WeldConnectionType
            {
                WeldConnectionTypePartpat/** Creates a weld of partpat type*/,
                WeldConnectionTypeElpat/** Creates a weld of elpat type*/,
                WeldConnectionTypeElemid/** Creates a weld of elem id type*/
            };

            /**  Represents the options for location type of weld connection */
            public: enum WeldLocationType
            {
                WeldLocationTypeSingle/** Creates a weld of GS location type*/,
                WeldLocationTypeTwoSide/** Creates a weld of GA/GB location type*/
            };
            ...
            public: ~WeldBuilder();
            /**Returns  the type of the specified weld 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::WeldBuilder::WeldConnectionType WeldType
            (
            );
            /**Sets  the type of the specified weld 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetWeldType
            (
                NXOpen::CAE::WeldBuilder::WeldConnectionType type /** type */ 
            );
            /**Returns  the location type of the specified weld 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::WeldBuilder::WeldLocationType LocationType
            (
            );
            /**Sets  the location type of the specified weld 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetLocationType
            (
                NXOpen::CAE::WeldBuilder::WeldLocationType locationType /** locationtype */ 
            );
            /**Returns  the selected point from side a
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectTaggedObjectList * PointSideA
            (
            );
            /**Returns  the selected elements for side a
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::SelectElementsBuilder * ElementSideASelection
            (
            );
            /**Returns  the pid tag for side a 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::NamedPropertyTable * SideAPid
            (
            );
            /**Sets  the pid tag for side a 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetSideAPid
            (
                NXOpen::CAE::NamedPropertyTable * pid /** pid */ 
            );
            /**Returns  the selected point from side b
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectTaggedObjectList * PointSideB
            (
            );
            /**Returns  the selected elements for side b
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::SelectElementsBuilder * ElementSideBSelection
            (
            );
            /**Returns  the pid tag for side b 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::NamedPropertyTable * SideBPid
            (
            );
            /**Sets  the pid tag for side b 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetSideBPid
            (
                NXOpen::CAE::NamedPropertyTable * pid /** pid */ 
            );
