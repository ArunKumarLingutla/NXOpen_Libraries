...
#include <NXOpen/CAE_AcousticsAndVibrationIntermediateMeshTransformAccessor.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModelAndLoadPreProcessInputFileBuilder : public NXOpen::CAE::ModelAndLoadPreProcessOperationBuilder
        {
            ...
            /** The type of the processing desired for the dataset*/
            public: enum QueryProcessing
            {
                QueryProcessingDoNotProcess/** do not process */ ,
                QueryProcessingCopyToResultsFile/** copy to results file */ ,
                QueryProcessingProcessAllOperations/** process all operations */ 
            };
            ...
            /** Select query. 
             <br>  @deprecated Deprecated in NX2206.0.0.  Use the SetQueryProcessing function. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use the SetQueryProcessing function.") void SetQuerySelected
            (
            ...
            /** Select processing type for a query. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetQueryProcessing
            (
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::Quantity quantity /** quantity */ ,
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::Location location /** location */ ,
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::Sorting sorting /** sorting */ ,
                const NXString & name /** name */ ,
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::QueryProcessing processing /** processing */ 
            );
            /** Select processing type for a query. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            void SetQueryProcessing
            (
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::Quantity quantity /** quantity */ ,
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::Location location /** location */ ,
                NXOpen::CAE::ModelAndLoadPreProcessInputFileBuilder::Sorting sorting /** sorting */ ,
            ...
            /**Returns  the custom coordinate system that is used to translate and rotate the intermediate mesh (on the fly) and input data (during solving)
                    
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::AcousticsAndVibrationIntermediateMeshTransformAccessor * IntermediateMeshTransform
            (
            );
        };
    }
