    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  PrintPagesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the pdf file name.  The pdfFileName field represents the full path  of the
                        pdf which the user wishes to create as output of print.
                    
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString PdfFileName
            (
            );
            /**Sets  the pdf file name.  The pdfFileName field represents the full path  of the
                        pdf which the user wishes to create as output of print.
            ...
            (
                const NXString & pdfFileName /** pdffilename */ 
            );
            /**Sets  the pdf file name.  The pdfFileName field represents the full path  of the
                        pdf which the user wishes to create as output of print.
            ...
            void SetPdfFileName
            (
                const char * pdfFileName /** pdffilename */ 
            );
        };
    }
}
