        ...
        */
        class NXOPENCPP_CAEEXPORT  FluidDomainBuilder : public NXOpen::Builder
        {
            ...
            public: enum OutputOptionsType
            {
                ...
                OutputOptionsTypeMeshOnly/** The output type specified as only mesh generation. */
            };
            ...
            /**Returns  the attempt quad only flag. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool AttemptQuadOnly
            (
            );
            /**Sets  the attempt quad only flag. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
            public: void SetAttemptQuadOnly
            (
                bool attemptQuadOnly /** attemptquadonly */ 
            );
            ...
            /**Returns  the curvature based element size level parameter controls the minimum element size the wrapper engine is allowed to use in curved regions 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: double CurvatureBasedElementSizeLevel
            (
            );
            /**Sets  the curvature based element size level parameter controls the minimum element size the wrapper engine is allowed to use in curved regions 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
            public: void SetCurvatureBasedElementSizeLevel
            (
                double elementSizeLevel /** elementsizelevel */ 
            );
            ...
            /**Returns  the acoustic wrap enabled flag. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: bool AcousticWrapEnabled
            (
            );
            /**Sets  the acoustic wrap enabled flag. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
            public: void SetAcousticWrapEnabled
            (
                bool acousticWrapEnabled /** acousticwrapenabled */ 
            );
            /**Returns  the acoustic wrap alternate algorithm enabled flag. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool AlternateAcousticWrapEnabled
            (
            );
            /**Sets  the acoustic wrap alternate algorithm enabled flag. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
            public: void SetAlternateAcousticWrapEnabled
            (
                bool alternateAcousticWrapEnabled /** alternateacousticwrapenabled */ 
            );
            /**Returns  the closing size 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ClosingSize
            (
            );
            /**Returns  the cutting plane enabled flag 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool CuttingPlaneEnabled
            (
            );
            /**Sets  the cutting plane enabled flag 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
            public: void SetCuttingPlaneEnabled
            (
                bool cuttingPlaneEnabled /** cuttingplaneenabled */ 
            );
            /** Returns the cutting planes of the recipe
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
            public: std::vector<NXOpen::Plane *> GetCuttingPlanes
            (
            );
            /** Sets the cutting planes on the recipe
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_adv_fluid_mod ("NX Advanced Fluid Modeling - Basic") OR sc_acou_meshing (" SC Acoustic Meshing") */
