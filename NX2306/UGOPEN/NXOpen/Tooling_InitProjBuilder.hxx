...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        InsertStripTog </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PartThickReal </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ProjTempOpt </term> <description> 
         
        Default </description> </item> 

        <item><term> 
         
        RenameDiaTog </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        UseSmfeatTog </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  InitProjBuilder : public NXOpen::Builder
        {
            ...
            /** Ask project attributes from database  @return  all project attribute values 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: std::vector<NXString> AskAttributeData
            (
                std::vector<NXString> & attrNameList /** all project attribute names */
            );
            ...
            (
                NXOpen::Part * controlPart /** controlpart */ 
            );
        };
    }
}
