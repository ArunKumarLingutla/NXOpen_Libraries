...
#include <NXOpen/Layout2d_GeneralPreferencesBuilder.hxx>
        ...
        */
        class NXOPENCPP_DRAFTINGEXPORT  PreferencesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the assembly creation from 2d component builder 
             ...
             <br> License requirements : None */
            public: NXOpen::Layout2d::AssemblyCreationSettingsBuilder * AssemblyCreationSettingsBuilder
            (
            );
            /**Returns  the create component from 3d builder 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Layout2d::CreateComponentFrom3DSettingsBuilder * CreateComponentFrom3DSettingsBuilder
            (
            );
            /**Returns  the general layout preferences builder 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Layout2d::GeneralPreferencesBuilder * GeneralLayoutPreferencesBuilder
            (
            );
            ...
            /**Returns  the track drawing changes general settings builder 
             ...
             <br> License requirements : None */
            public: NXOpen::Drawings::TrackDrawingChangesGeneralBuilder * TrackDrawingChangesGeneral
            (
            );
            /**Returns  the track drawing changes report filter builder 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::TrackDrawingChangesReportFilterBuilder * TrackDrawingChangesReportFilter
            (
            );
            /**Returns  the visual drawing compare settings builder 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::VisualDrawingComparePrefsBuilder * VisualDrawingCompare
            (
            );
            ...
            /**Returns  the Part Family table settings builder 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::PartFamilyTableSettingsBuilder * PartFamilyTable
            (
            );
            /** Synchronize fcf symbol sequence 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SynchronizeFCFSymbolSequence
            (
            );
        };
    }
