        ...
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ClosedCornerBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**This enum represents Corner Overlap type
                 <br>  Created in NX1926.0.0.  <br>  
                */
                public: enum OverlapTypeOptions
                {
                    OverlapTypeOptionsNone/** none */ ,
                    OverlapTypeOptionsSide1/** side1 */ ,
                    OverlapTypeOptionsSide2/** side2 */ 
                };

                /**This enum represents Corner Closure type. This is only for legacy feature support, for new features use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptions   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptions @endlink */
                public: enum ClosureTypeOptions
                {
                    ClosureTypeOptionsClose/** Instead of this use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptionsNone   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptionsNone @endlink  */,
                    ClosureTypeOptionsOverlap/** Instead of this use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptionsSide2   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptionsSide2 @endlink  */
                };
                ...
                /**Sets  the closure type. This is only for legacy feature support, for new features use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType @endlink  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the closure type. This is only for legacy feature support, for new features use @link  NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType   NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapType @endlink  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                ...
                /**Returns  the limiting edge on the first side for miter.
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::ScCollector * LimitEdge1
                (
                );
                /**Returns  the limiting edge on the second side for miter.
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::ScCollector * LimitEdge2
                (
                );
                ...
                (
                    NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptions overlapType /** The type of overlap specified for the corner*/
                );
                /**Returns  the overlap type
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::ClosedCornerBuilder::OverlapTypeOptions OverlapType
                (
                );
            };
        }
