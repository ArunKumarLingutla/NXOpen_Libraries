        ...
        */
        class NXOPENCPP_CAMEXPORT  MillingToolBuilder : public NXOpen::CAM::ToolBuilder
        {
            ...
            /**Returns  the tapered shank diameter 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use @link NXOpen::CAM::ShankSectionBuilder NXOpen::CAM::ShankSectionBuilder@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use NXOpen::CAM::ShankSectionBuilder instead.") NXOpen::CAM::InheritableDoubleBuilder * TaperedShankDiameterBuilder
            (
            );
            /**Returns  the tapered shank length 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use NXOpen::CAM::ShankSectionBuilder instead.") NXOpen::CAM::InheritableDoubleBuilder * TaperedShankLengthBuilder
            (
            );
            /**Returns  the tapered shank taper length 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use NXOpen::CAM::ShankSectionBuilder instead.") NXOpen::CAM::InheritableDoubleBuilder * TaperedShankTaperLengthBuilder
            (
            );
            ...
            /**Returns  the shank description
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableTextBuilder * ShankDescription
            (
            );
            /**Returns  the shank library reference
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableTextBuilder * ShankLibraryReference
            (
            );
        };
    }
