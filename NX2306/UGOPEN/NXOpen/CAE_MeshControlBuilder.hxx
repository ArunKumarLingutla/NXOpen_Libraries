        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshControlBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the body selection for boundary layer 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::CAE::MeshControlBuilder::BlTargetSelection NXOpen::CAE::MeshControlBuilder::BlTargetSelection@endlink  instead. <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::CAE::MeshControlBuilder::BlTargetSelection instead.") NXOpen::SelectNXObjectList * BlBodySelection
            (
            );
