    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeDOFSet : public NXOpen::DisplayableObject
        {
            ...
            /** Get the selection recipes in this dofset 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::SelectionRecipe *> GetSelectionRecipes
            (
            );
            /** Get the selection recipes with the given dof value in the DOFSet 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::SelectionRecipe *> GetSelectionRecipesWithDof
            (
                bool dof1 /** DOF1 value  */,
                bool dof2 /** DOF2 value  */,
                bool dof3 /** DOF3 value  */,
