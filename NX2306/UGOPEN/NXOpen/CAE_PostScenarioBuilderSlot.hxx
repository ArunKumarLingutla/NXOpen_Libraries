    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioBuilderSlot : public NXOpen::Builder
        {
            ...
            /** Returns the selected @link CAE::PostScenarioDefinition CAE::PostScenarioDefinition@endlink  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** List @link CAE::DataSource CAE::DataSource@endlink  applicable to the current slot. Data Sources are retrieved from 
                    @link NXOpen::CAE::PostScenarioManager::DataSources NXOpen::CAE::PostScenarioManager::DataSources@endlink  and filtered to only contain data applicable to the current scenario slot.
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Assign data to this slot. This assignment applies to the owning @link NXOpen::CAE::PostScenarioBuilder NXOpen::CAE::PostScenarioBuilder@endlink .
                     The @link NXOpen::CAE::DataSource NXOpen::CAE::DataSource@endlink  and @link NXOpen::CAE::PostScenarioDefinition NXOpen::CAE::PostScenarioDefinition@endlink  have to be consistent and relevant to this scenario.
