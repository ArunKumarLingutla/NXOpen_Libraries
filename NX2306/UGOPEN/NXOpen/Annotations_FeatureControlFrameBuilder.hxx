...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        Text.CustomSymbolScale </term> <description> 
         
        1.0 </description> </item> 

        <item><term> 
         
        Text.SymbolAspectRatio </term> <description> 
         
        1.0 </description> </item> 

        <item><term> 
         
        Text.SymbolHeight </term> <description> 
         
        25.4 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        Text.SymbolLength </term> <description> 
         
        25.4 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        Text.SymbolPreferences </term> <description> 
         
        UseCurrent </description> </item> 

        <item><term> 
         
        Text.SymbolScale </term> <description> 
         
        1.0 </description> </item> 

        <item><term> 
         
        Text.SymbolSizeMethod </term> <description> 
