            ...
            */
            class NXOPENCPP_SIMEXPORT  EncryptPostprocessorFilesBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the SMKS license check. 
                 ...
                 <br> License requirements : None */
                public: NXString SMKSLicensecheck
                (
                );

                /// \cond NX_NO_DOC 
                /**Sets  the SMKS license check. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") */
                public: void SetSMKSLicensecheck
                (
                    const NXString & smksLicensecheck /** the smks license check */
                );
                /**Sets  the SMKS license check. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") */
                void SetSMKSLicensecheck
                (
                    const char * smksLicensecheck /** the smks license check */
                );
