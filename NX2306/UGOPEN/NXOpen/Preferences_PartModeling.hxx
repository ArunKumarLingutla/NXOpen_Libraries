    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  PartModeling
        {
            ...
            {
                GridKnotLineFontTypeSolid/** solid */  = 1,
                ...
                GridKnotLineFontTypeEight/** Long Dashed Double Dotted */ = 11,
                GridKnotLineFontTypeNine/** Long Dashed Dotted for OOTB fonts and Undulating for shipbuilding fonts */,
                GridKnotLineFontTypeTen/** Long Dashed Triplicate Dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
                GridKnotLineFontTypeEleven/** Long Dashed Double Short Dashed for OOTB fonts and Railway for shipbuilding fonts */
            };
            ...
            /**Returns  the optimize curve tolerance factor 
             <br>  @deprecated Deprecated in NX11.0.0.  It was split into two factors. Please use @link PartModeling::OptimizeCurveDistanceToleranceFactor PartModeling::OptimizeCurveDistanceToleranceFactor@endlink  and @link PartModeling::OptimizeCurveAngleToleranceFactor PartModeling::OptimizeCurveAngleToleranceFactor@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  It was split into two factors. Please use PartModeling::OptimizeCurveDistanceToleranceFactor and PartModeling::OptimizeCurveAngleToleranceFactor instead.") double OptimizeCurveToleranceFactor
            (
            );
            /**Sets  the optimize curve tolerance factor 
             <br>  @deprecated Deprecated in NX11.0.0.  It was split into two factors. Please use @link PartModeling::SetOptimizeCurveDistanceToleranceFactor PartModeling::SetOptimizeCurveDistanceToleranceFactor@endlink  and @link PartModeling::SetOptimizeCurveAngleToleranceFactor PartModeling::SetOptimizeCurveAngleToleranceFactor@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  It was split into two factors. Please use PartModeling::SetOptimizeCurveDistanceToleranceFactor and PartModeling::SetOptimizeCurveAngleToleranceFactor instead.") void SetOptimizeCurveToleranceFactor
            (
            ...
            /**Returns  the optimize curve distance tolerance factor 
             ...
             <br> License requirements : None */
            public: double OptimizeCurveDistanceToleranceFactor
            (
            );
            /**Sets  the optimize curve distance tolerance factor 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: void SetOptimizeCurveDistanceToleranceFactor
            (
                double optimieCurveDistanceFactor /** Distance Factor for performing Optimized Curve */
            );
            /**Returns  the optimize curve angle tolerance factor 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: double OptimizeCurveAngleToleranceFactor
            (
            );
            /**Sets  the optimize curve angle tolerance factor 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: void SetOptimizeCurveAngleToleranceFactor
            (
                double optimieCurveAngleFactor /** Angle Factor for performing Optimized Curve */
            );
            /**Returns  the distance tolerance for converting analytic body to Convergent body 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: double ConvertAnalyticToConvergentDistanceTolerance
            (
            );
            /**Sets  the distance tolerance for converting analytic body to Convergent body 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: void SetConvertAnalyticToConvergentDistanceTolerance
            (
            ...
            /**Returns  the angular tolerance for converting analytic body to Convergent body 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: double ConvertAnalyticToConvergentAngularTolerance
            (
            );
            /**Sets  the angular tolerance for converting analytic body to Convergent body 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: void SetConvertAnalyticToConvergentAngularTolerance
            (
            ...
            /**Returns  the maximum facet width option for converting analytic body to convergent body 
             ...
             <br> License requirements : None */
            public: bool MaxFacetWidthOption
            (
            );
            /**Sets  the maximum facet width option for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetMaxFacetWidthOption
            (
                bool maxFacetWidth /** maximum facet width option for converting analytic body to convergent body */
            );
            /**Returns  the maximum chord length option for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool MaxChordLengthOption
            (
            );
            /**Sets  the maximum chord length option for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetMaxChordLengthOption
            (
                bool maxChordLength /** maximum chord length option for converting analytic body to convergent body */
            );
            /**Returns  the maximum facet width for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: double ConvertAnalyticToConvergentMaximumFacetWidth
            (
            );
            /**Sets  the maximum facet width for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetConvertAnalyticToConvergentMaximumFacetWidth
            (
                double dAnalyticToConvergentMaxFacetWidth /** maximum facet width for converting analytic body to convergent body */
            );
            /**Returns  the maximum chord length for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: double ConvertAnalyticToConvergentMaximumChordLength
            (
            );
            /**Sets  the maximum chord length for converting analytic body to convergent body 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetConvertAnalyticToConvergentMaximumChordLength
            (
                double dAnalyticToConvergentMaxChordLength /** maximum chord length for converting analytic body to convergent body */
            );
            /**Returns  the option to treat degree one bspline as polyline 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool TreatOneDegreeBsplineAsPolyline
            (
            );
            /**Sets  the option to treat degree one bspline as polyline 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTreatOneDegreeBsplineAsPolyline
            (
                bool treatOneDegreeBsplineAsPolyline /** Flag if set to true will allow treatment of single degree bspline as polyline */
            );
            /** Returns whether keep NX6-era local feature in the part  @return   
            ...
            /** This will keep NX6-era Local feature when changing to History-free mode.
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetKeepLocalFeatures
            (
                bool keepLocalFeatures /** keeplocalfeatures */ 
            );
            /** Get the flag to indicate if it is saved by web application  @return   
            ...
            /** Set the flag to indicate if it is saved by web application 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetIsSavedByWebApp
            (
                bool isSavedByWebApp /** issavedbywebapp */ 
            );
