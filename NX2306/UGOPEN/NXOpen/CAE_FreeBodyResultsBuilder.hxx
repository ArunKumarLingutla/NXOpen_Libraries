        ...
        */
        class NXOPENCPP_CAEEXPORT  FreeBodyResultsBuilder : public NXOpen::Builder
        {
            ...
            /** The location definition method by coordinate system origin  @return  Ask Coordinate System 
             <br>  @deprecated Deprecated in NX2212.0.0.  Use @link NXOpen::CAE::FreeBodyResultsBuilder::GetLocationResultCsys NXOpen::CAE::FreeBodyResultsBuilder::GetLocationResultCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and @link NXOpen::CAE::FreeBodyResultsBuilder::GetLocationModelCsys NXOpen::CAE::FreeBodyResultsBuilder::GetLocationModelCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model <br>  

             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use NXOpen::CAE::FreeBodyResultsBuilder::GetLocationResultCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and NXOpen::CAE::FreeBodyResultsBuilder::GetLocationModelCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model") int GetLocationCsys
            (
            );
            /** The location definition method by coordinate system origin 
             <br>  @deprecated Deprecated in NX2212.0.0.  Use @link NXOpen::CAE::FreeBodyResultsBuilder::SetLocationResultCsys NXOpen::CAE::FreeBodyResultsBuilder::SetLocationResultCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and @link NXOpen::CAE::FreeBodyResultsBuilder::SetLocationModelCsys NXOpen::CAE::FreeBodyResultsBuilder::SetLocationModelCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model <br>  

             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use NXOpen::CAE::FreeBodyResultsBuilder::SetLocationResultCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and NXOpen::CAE::FreeBodyResultsBuilder::SetLocationModelCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model") void SetLocationCsys
            (
            ...
            /** The source for the location coordinate system 
             <br>  @deprecated Deprecated in NX2212.0.0.  This API is deprecated as it is no longer required to set the coordinate system source. <br>  

             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  This API is deprecated as it is no longer required to set the coordinate system source.") void SetLocationCsysSource
            (
            ...
            /** The selected reference coordinate system  @return  Ask Coordinate System 
             <br>  @deprecated Deprecated in NX2212.0.0.  Use @link NXOpen::CAE::FreeBodyResultsBuilder::GetSelectedReferenceResultCsys NXOpen::CAE::FreeBodyResultsBuilder::GetSelectedReferenceResultCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and @link NXOpen::CAE::FreeBodyResultsBuilder::GetSelectedReferenceModelCsys NXOpen::CAE::FreeBodyResultsBuilder::GetSelectedReferenceModelCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model <br>  

             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use NXOpen::CAE::FreeBodyResultsBuilder::GetSelectedReferenceResultCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and NXOpen::CAE::FreeBodyResultsBuilder::GetSelectedReferenceModelCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model") int GetSelectedReferenceCsys
            (
            );
            /** The selected reference coordinate system 
             <br>  @deprecated Deprecated in NX2212.0.0.  Use @link NXOpen::CAE::FreeBodyResultsBuilder::SetSelectedReferenceResultCsys NXOpen::CAE::FreeBodyResultsBuilder::SetSelectedReferenceResultCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and @link NXOpen::CAE::FreeBodyResultsBuilder::SetSelectedReferenceModelCsys NXOpen::CAE::FreeBodyResultsBuilder::SetSelectedReferenceModelCsys@endlink  for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model <br>  

             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use NXOpen::CAE::FreeBodyResultsBuilder::SetSelectedReferenceResultCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Result and NXOpen::CAE::FreeBodyResultsBuilder::SetSelectedReferenceModelCsys for coordinate system having source as JA_SFRES_CoordinateSystemSource_Model") void SetSelectedReferenceCsys
            (
            ...
            /** The source for the selected reference coordinate system 
             ...
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  This API is deprecated as it is no longer required to set the coordinate system source.") void SetSelectedReferenceCsysSource
            (
                NXOpen::CAE::Result::CoordinateSystemSource source /** Set Source */
            );
            ...
            /** Get the reference coordinate system set on freebody results builder which is having coordinate system source as JA_SFRES_CoordinateSystemSource_Result @return  Ask Coordinate System 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: int GetSelectedReferenceResultCsys
            (
            );
            /** Set the reference coordinate system on freebody results builder which is having coordinate system source as JA_SFRES_CoordinateSystemSource_Result
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetSelectedReferenceResultCsys
            (
                int id /** Set Coordinate System */
            );
            /** Get the reference coordinate system set on freebody results builder which is having coordinate system source as JA_SFRES_CoordinateSystemSource_Model
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CoordinateSystem * GetSelectedReferenceModelCsys
            (
            );
            /** Set the reference coordinate system on freebody results builder which is having coordinate system source as JA_SFRES_CoordinateSystemSource_Model
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetSelectedReferenceModelCsys
            (
                NXOpen::CoordinateSystem * csys /** csys */ 
            );
            /** Get the coordinate system set on freebody results builder which is used for location definition and is having 
                        coordinate system source as JA_SFRES_CoordinateSystemSource_Result  @return  Ask Coordinate System 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: int GetLocationResultCsys
            (
            );
            /** Set the coordinate system on freebody results builder which is used for location definition and is having 
                        coordinate system source as JA_SFRES_CoordinateSystemSource_Result 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetLocationResultCsys
            (
                int id /** Set Node Coordinate System */
            );
            /** Get the coordinate system set on freebody results builder which is used for location definition and is having 
                        coordinate system source as JA_SFRES_CoordinateSystemSource_Model 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CoordinateSystem * GetLocationModelCsys
            (
            );
            /** Set the coordinate system on freebody results builder which is used for location definition and is having 
                        coordinate system source as JA_SFRES_CoordinateSystemSource_Model 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetLocationModelCsys
            (
                NXOpen::CoordinateSystem * csys /** csys */ 
            );
        };
