...
#include <NXOpen/Features_SheetMetal_NonPlanarFlangeBuilder.hxx>
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SheetmetalManager
            {
                ...
                /** This is an internal API and can be changed at any time 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                public: NXOpen::Features::SheetMetal::NonPlanarFlangeBuilder * CreateNonplanarFlangeBuilder
                (
                    NXOpen::Features::Feature * nonPlanarFlange /** nonplanarflange */ 
                );
