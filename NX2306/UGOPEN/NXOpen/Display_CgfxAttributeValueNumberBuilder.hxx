...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX10.0.0.  No alternative provided for this class.") NXOPENCPP_DISPLAYEXPORT  CgfxAttributeValueNumberBuilder : public NXOpen::Builder
        {
