    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  RoutingApplicationView
        {
            ...
            (
                const NXString & fileName /** filename of application view. */
            );
            /**  Loads the preferences from an application view file.  This file may be either
                     a legacy application view file (with a .apv extension) or a new XML style application
                     view file (with a .xml extension).  See the Routing Administrator documentation for the
            ...
            void LoadAppView
            (
                const char * fileName /** filename of application view. */
            );
            ...
            /** Returns the intersection of the required stock characteristics and required
                        part characteristics for the current discipline of the application view.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::CharacteristicList::CharacteristicInformation> GetRequiredCharacteristics
            (
            );
            /** Returns the intersection of the optional stock characteristics and optional
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::CharacteristicList::CharacteristicInformation> GetOptionalCharacteristics
            (
            );
            /** Returns fabrication characteristics. These characteristics
                        must be set for any fabrication created out of a Routing assembly.  @return  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::CharacteristicList::CharacteristicInformation> GetFabricationCharacteristics
            (
            );
            ...
            */
            public: NXOpen::Preferences::RoutingUserPreferences *RoutingUserPreferences();
