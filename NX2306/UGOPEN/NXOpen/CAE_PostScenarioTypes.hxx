...
namespace NXOpen
{
    namespace CAE
    {
        ...
        */
        ...
        /// \endcond 
        /** This enum controls which @link CAE::PostScenarioCoordinateSystemTransformation CAE::PostScenarioCoordinateSystemTransformation@endlink  instance to create 
         <br>  Created in NX2206.0.0.  <br>  
        */
        enum PostScenarioCoordinateSystemTransformationType
        {
            PostScenarioCoordinateSystemTransformationTypeToAbsolute/** Cooresponds to @link CAE::PostScenarioToAbsoluteCoordinateSystem CAE::PostScenarioToAbsoluteCoordinateSystem@endlink  */,
            PostScenarioCoordinateSystemTransformationTypeUserDefined/** Cooresponds to @link CAE::PostScenarioUserDefinedCoordinateSystemTransformation CAE::PostScenarioUserDefinedCoordinateSystemTransformation@endlink  */,
            PostScenarioCoordinateSystemTransformationTypeToFaceNormal/** to face normal */ ,
            PostScenarioCoordinateSystemTransformationTypeResponseFunction/** response function */ ,
            PostScenarioCoordinateSystemTransformationTypeCrossPower/** cross power */ 
        };
