...
rem (starting with NX1847 this has been changed to %MSVCDir%\Auxiliary\Build\vcvars32.bat)
...
rem NX8.0/NX8.5 wntx64 (MSVS 2010)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 10\VC
rem NX8.0/NX8.5 wntx32 (MSVS 2010)
rem set MSVCDir=C:\Program Files (x86)\Microsoft Visual Studio 10\VC
rem NX9.0/NX10 wntx64 (MSVS 2012)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 11.0\VC
rem NX11.0 wntx64 (MSVS 2013)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 12.0\VC
rem NX12.0 wntx64 (MSVS 2015)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 14.0\VC
rem NX1847  wntx64 (MSVS 2017)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 15.0\VC\Auxiliary\Build
rem NX1872  wntx64 (MSVS 2017)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 15.0\VC\Auxiliary\Build
rem NX1899  wntx64 (MSVS 2017)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 15.0\VC\Auxiliary\Build
rem NX2212  wntx64 (MSVS 2019)
rem set MSVCDir=C:\Program Files\Microsoft Visual Studio 16.11\VC\Auxiliary\Build
rem 
rem Usages:
...
rem
if not exist "%MSVCDir%\Auxiliary\Build\vcvars32.bat" goto novcvars32
call "%MSVCDir%\Auxiliary\Build\vcvars32.bat" %processor_architecture%
set base_dir=%base:"=%
...
rem
if not exist "%MSVCDir%\Auxiliary\Build\vcvarsall.bat" goto novcvars32
call "%MSVCDir%\Auxiliary\Build\vcvarsall.bat" AMD64
set base_dir=%base:"=%
set UGII_USERFCN=%base_dir%\ugopen
set UGII_UGOPENPP=%base_dir%\ugopenpp
set PATH=%UGII_USERFCN%;%PATH%
set INCLUDE=%INCLUDE%;%UGII_USERFCN%;%UGII_UGOPENPP%
set CL=-c /GR -nologo -MD -EHsc -D_SECURE_SCL=0
goto setdoskey
:setdoskey
doskey UFCOMP=CL $*
