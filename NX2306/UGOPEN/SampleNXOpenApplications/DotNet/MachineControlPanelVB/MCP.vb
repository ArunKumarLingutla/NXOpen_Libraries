...
Public Class MCP
    ...
    Private Sub MCP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        simStartCallbackId = theIsvControlPanelBuilder.AddSimStart(New NXOpen.SIM.IsvControlPanelBuilder.SimStartCb(AddressOf SimStartCallback))
...
#End Region
    ...
    Private Sub SaveMachineData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveMachineData.Click
        ...
        ' SaveMachineData performed also a Kernel Reset so we have to update the
        ' maximum feed rate and set the volatile settings like cycle time,
        ' skip levels, dry run, single block mode and feed rate override again.
        ' Read data from VNCK.
        UpdateCycleTime()
        UpdateFeedRateOverrideMaximum()
        ' Reestablish data in VNCK.
        FeedRateOverrideEdit_ValueChanged(sender, e)
