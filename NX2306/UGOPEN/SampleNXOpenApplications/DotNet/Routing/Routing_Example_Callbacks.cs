...
namespace Routing
{
    public class Callbacks
    {
        ...
        private static void RegisterCallbacks()
        {
            ...
            customManager.AddCallback( CustomManager.CallbackReason.StockComponentCreated, StockComponentCreatedCallback );
        }
        ...
        //------------------------------------------------------------------------------------------
        public static void StockComponentCreatedCallback
        (
            NXObject[] nxObjects
        )
        {
            Echo( "\n*** C# StockComponentCreatedCallback called with " + nxObjects.Length.ToString() + " objects." );

            foreach (NXObject nxObject in nxObjects)
            {
                if (nxObject.GetType() != typeof( Component ))
                {
                    Echo( "  NX Object (Tag " + nxObject.Tag.ToString() + ") is NOT an Assemblies Component." );
                    continue;
                }

                Component component = (Component)nxObject;
