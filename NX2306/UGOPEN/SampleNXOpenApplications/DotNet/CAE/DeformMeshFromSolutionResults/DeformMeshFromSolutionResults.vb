...
Module DeformMeshFromSolutionResults
    ...
    Sub Doit()
        ...
        Dim physOffset As Integer = 0
        Dim groupOffset As Integer = 0
        Dim plyOffset As Integer = 0
        Dim ssmoOffset As Integer = 0

        femModelOcc.GetCaeOccEntityLabelOffsets(nodeOffset, elemOffset, csysOffset, physOffset, groupOffset, plyOffset, ssmoOffset)
