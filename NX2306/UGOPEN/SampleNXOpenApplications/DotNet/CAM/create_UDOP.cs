...
namespace test1
{
    public class Class1
    {
        ...
        public static int udopcopy(string inString)
        {
            ...
            // THe new User Defined Operation.
            NXOpen.CAM.UserDefinedOpr targetUdop = (NXOpen.CAM.UserDefinedOpr)setup.GetCamExitObject();
            // The User Defined operation from which the copy is happening.
            NXOpen.CAM.UserDefinedOpr sourceUdop = targetUdop.GetSourceUdop();
            lw.Open();
            lw.WriteLine("Target Udop : " + targetUdop.Name + " Source udop : " + sourceUdop.Name);
            return 0;
        }

        public static int udopdelete(string inString)
        {
            NXOpen.Session theSession = Session.GetSession();
            NXOpen.ListingWindow lw = theSession.ListingWindow;
            NXOpen.Part workPart = theSession.Parts.Work;
            ...
            // THe User Defined Operation being deleted
            NXOpen.CAM.UserDefinedOpr targetUdop = (NXOpen.CAM.UserDefinedOpr)setup.GetCamExitObject();
            lw.Open();
            lw.WriteLine("Udop being deleted : " + targetUdop.Name);
