...
namespace MCP_CSharp
{
    public partial class MCP : Form
    {
        ...
        private int simStartCallbackId;
        ...
        private void MCP_Load(object sender, EventArgs e)
        {
            ...
            simStartCallbackId = theIsvControlPanelBuilder.AddSimStart(new NXOpen.SIM.IsvControlPanelBuilder.SimStartCb(SimStartCallback));
        ...
        {
            IsvControlPanelBuilder.VncMode vncMode = theIsvControlPanelBuilder.VncStatus;
            ...
            if (vncMode != IsvControlPanelBuilder.VncMode.Start && vncMode != IsvControlPanelBuilder.VncMode.Run)
        ...
        private void SaveMachineData_Click(object sender, EventArgs e)
        {
            ...
            // SaveMachineData performed also a Kernel Reset so we have to
            // update the maximum feed rate and set the volatile settings like
            // cycle time, skip levels, dry run, single block mode and
            // feed rate override again.
            // Read data from VNCK.
            UpdateCycleTime();
            UpdateFeedRateOverrideMaximum();
            // Reestablish data in VNCK.
            FeedRateOverrideEdit_ValueChanged_1(sender, e);
            ConditionalStopBox_CheckedChanged(sender, e);
            SkipLevel0Box_CheckedChanged(sender, e);
            SkipLevel1Box_CheckedChanged(sender, e);
            SkipLevel2Box_CheckedChanged(sender, e);
            SkipLevel3Box_CheckedChanged(sender, e);
            NCDryRun_CheckedChanged(sender, e);
            NCSingleBlockMode_CheckedChanged(sender, e);
        }
