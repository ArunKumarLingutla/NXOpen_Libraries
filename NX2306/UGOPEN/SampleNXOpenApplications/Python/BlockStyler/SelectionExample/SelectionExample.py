...
class SelectionExample:
    ...
    def Launch(self):
        ...
        try:
            ...
            # ---- Enter your exception handling code here -----
            self.theUI.NXMessageBox.Show("Launch", NXOpen.NXMessageBox.DialogType.Error, str(ex))
    ...
    def addChamfer(self, selectedEdge, angle):
        ...
        try:
            ...
            chamferBuilder1.Tolerance = 0.0100
            ...
            rules1 = []
            rules1.append(edgeTangentRule1)
    ...
    def deleteObject(self, selectedObject):
        ...
        try:
            ...
            nErrs = self.theSession.UpdateManager.AddObjectsToDeleteList(objects)
