...
------------------------------------------------------------------------------------
                        ValidateNXOpenSetup.py Example
------------------------------------------------------------------------------------
...
-----------------------
  ...
  ---------
    ...
    2. Type command %UGII_BASE_DIR%\nxbin\run_journal ValidateNXOpenSetup.py
   ...
   -------	
    ...
    2. Type command $UGII_BASE_DIR/nxbin/run_journal ValidateNXOpenSetup.py  
