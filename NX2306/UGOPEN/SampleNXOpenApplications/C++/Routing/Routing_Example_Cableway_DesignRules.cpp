...
DesignRules* NXOpen::Routing::theDesignRules = nullptr;
...
static NXString segregationCodeName = "Segregation Code";
...
DesignRules::DesignRules()
{
    ...
    m_segregationCodeRuleId = customManager->AddDesignRule( CustomManager::DesignRuleReasonCablewayValidation,
                                                            segregationCodeName, description,
...
)
{
    ...
    customManager->CreateViolationForReason( segregationCodeName, CustomManager::DesignRuleReasonCablewayValidation,
