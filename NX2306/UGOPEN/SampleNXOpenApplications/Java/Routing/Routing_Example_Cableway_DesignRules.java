...
public class Routing_Example_Cableway_DesignRules implements nxopen.routingcommon.CustomManager.DesignRule
{
    ...
    static String designRuleName = "Segregation Code";
    ...
    public Routing_Example_Cableway_DesignRules() throws RemoteException, NXException
    {
        ...
        customManager.addDesignRule(DesignRuleReason.CABLEWAY_VALIDATION, designRuleName, description, this );
    ...
    ) throws RemoteException, NXException
    {
        ...
        theSession.routingCustomManager().createViolationForReason( designRuleName, DesignRuleReason.CABLEWAY_VALIDATION,
