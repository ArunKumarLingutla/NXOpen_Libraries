...
public class Routing_MaximumHeight_DesignRule implements nxopen.routing.CustomManager.DesignRule
{
    static Routing_MaximumHeight_DesignRule theMaxHeightDesignRules = null;
    ...
    {     
        ...
        theMaxHeightDesignRules = new Routing_MaximumHeight_DesignRule();
    ...
    public Routing_MaximumHeight_DesignRule() throws RemoteException, NXException
    {        
        ...
        customManager.addDesignRule(DesignRuleReason.CREATE_PATH,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.HEAL_PATH,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.ASSIGN_CORNER,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.REMOVE_PART,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.AUTO_ROUTE_PIN_LEVEL,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.MANUAL_ROUTE_PIN_LEVEL,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.AUTO_ROUTE_COMPONENT_LEVEL,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.MANUAL_ROUTE_COMPONENT_LEVEL,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.INTERACTIVE,designRuleName,longDescription , this);
        customManager.addDesignRule(DesignRuleReason.TRANSFORM_PATH,designRuleName,longDescription , this);            
        customManager.addDesignRule(DesignRuleReason.EDIT_CHARACTERISTIC,designRuleName,longDescription , this);
     }
