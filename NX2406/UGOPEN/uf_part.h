...
NOTE: If the part is in minimally loaded state, it will be partially loaded into the NX session.
...
/*****************************************************************************
Creates new part family members (i.e. which contain instance of a part family member) in bulk.
The newly created parts are also saved and unloaded in bulk during this operation.

Environment: Internal and  External

History: Released in NX2206
 ******************************************************************************/
extern UFUNEXPORT int UF_PART_create_family_instances_in_bulk(
    tag_t family,                    /* <I>  Object identifier of the family.*/
    int* count,                      /* <I>  Number of members to be created.*/
    int** memberIndexesForCreate,    /* <I>  An allocated array of member indexes corresponding
                                             to the part entries to be created. Use UF_free to
                                             deallocate memory when done.*/
    int** errorCodes                 /* <O,len:count>
                                             An allocated array of error codes corresponding to
                                             the part entries to be created. Use UF_free to
                                             deallocate memory when done.*/
);/* <NON_NXOPEN> */

/*****************************************************************************
Updates new part family members (i.e. which contain instance of a part family member) in bulk.
The newly updated parts are also saved and unloaded in bulk during this operation.

Environment: Internal and  External

History: Released in NX2206
 ******************************************************************************/
extern UFUNEXPORT int UF_PART_update_family_instances_in_bulk(
    tag_t family,                    /* <I>  Object identifier of the family.*/
    int* count,                      /* <I>  Number of members to be updated.*/
    int** memberIndexesForUpdate,    /* <I>  An allocated array of member indexes corresponding
                                             to the part entries to be updated. Use UF_free to
                                             deallocate memory when done.*/
    logical forceUpdate,             /* <I>  Always update instance if found?*/
    int** errorCodes                 /* <O,len:count>
                                             An allocated array of error codes corresponding to
                                             the the part entries to be created. Use UF_free to
                                             deallocate memory when done.*/
);/* <NON_NXOPEN> */
