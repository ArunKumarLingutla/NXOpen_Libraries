...
enum UF_DRF_tolerance_type_e
{
     ...
     UF_DRF_SINGLE_LIMIT_MAX,
     UF_DRF_SINGLE_LIMIT_MIN,
     UF_DRF_MAX_NUM_TOL
} ;
...
typedef UF_DRF_render_text_status_t (*UF_DRF_set_to_position_fn_t)(
    ...
    void *client,           /* <I> client data                            */
    double out_point[3],    /* <O> passed into the next UF_DRF_draw_to_position_fn_t call as the 'last_out_point' input argument.
                                   This argument will only be returned if UF_DRF_RENDER_OK or UF_DRF_RENDER_DRAWN is returned by this function */
    logical *out_status     /* <O> passed into the next UF_DRF_draw_to_position_fn_t call as the 'last_status' input argument.
                                   This argument will only be returned if UF_DRF_RENDER_OK or UF_DRF_RENDER_DRAWN is returned by this function */
);

/* The input parameter 'last_out_point' will be set to the 'out_point' output
   argument of the previous UF_DRF_set_to_position_fn_t or UF_DRF_draw_to_position_fn_t
   call.  It is up to the client to decide what the 'out_point' means to the
   UF_DRF_set_position_fn_t and UF_DRF_draw_to_position_fn_t that they have
   implemented.

   The input parameter 'last_status' will be set to the 'out_status' output
   argument of the previous UF_DRF_set_to_position_fn_t or UF_DRF_draw_to_position_fn_t
   call.  It is up to the client to decide what the 'out_status' means to the
   UF_DRF_set_position_fn_t and UF_DRF_draw_to_position_fn_t that they have
   implemented.
   */
typedef UF_DRF_render_text_status_t (*UF_DRF_draw_to_position_fn_t)(
    double in_point[3],       /* <I> 3d point in coord system of annotation */
    double last_out_point[3], /* <I> 'out_point' from the previous UF_DRF_set_to_position_fn_t
                                     or UF_DRF_draw_to_position_fn_t call */
    logical last_status,      /* <I> 'out_status' from the previous UF_DRF_set_to_position_fn_t
                                     or UF_DRF_draw_to_position_fn_t call */
    void *client,             /* <I> client data                            */
    double out_point[3],      /* <O> passed into the next UF_DRF_draw_to_position_fn_t call as the 'last_out_point' input argument.
                                   This argument will only be returned if UF_DRF_RENDER_OK or UF_DRF_RENDER_DRAWN is returned by this function */
...
enum UF_DRF_weld_contour_types_e
{
    ...
    UF_DRF_WELD_BACKING_REMV,           /* Removable Backing Strip ( applicable
                                          only for ISO and DIN ) */
    UF_DRF_WELD_MELT_THROUGH           /* Removable Melt Through ( applicable
                                          only for ANSI,ISO and JIS ) */
};
