...
#define UF_CAM_ERROR_INVALID_POCKET_NUM_OF_TOOLS  (ERROR_UF_CAM_base + 74)
#define UF_CAM_ERROR_TOOLS_NOT_SAME_SUBTYPE       (ERROR_UF_CAM_base + 75)
#define UF_CAM_ERROR_RESTORE_DEPENDENCIES         (ERROR_UF_CAM_base + 76)
#define UF_CAM_ERROR_UPDATE_GEOMETRY_DEPENDENCIES (ERROR_UF_CAM_base + 77)
#define UF_CAM_ERROR_REMOVE_DEPENDENCIES          (ERROR_UF_CAM_base + 78)
#define UF_CAM_ERROR_NOT_LIBRARY_HOLDER           (ERROR_UF_CAM_base + 79)
#define UF_CAM_ERROR_HOLDER_UPDATE_ONLY           (ERROR_UF_CAM_base + 80)
#define UF_CAM_ERROR_TURNING_BOUNDARY_ONLY_ONE_ALLOWED     (ERROR_UF_CAM_base + 81)
#define UF_CAM_ERROR_LEGACY_OFFSET_NOT_ALLOWED             (ERROR_UF_CAM_base + 82)
#define UF_CAM_ERROR_NO_PATH_EXISTS               (ERROR_UF_CAM_base + 83)
#define UF_CAM_ERROR_PATH_CREATION_FAILED         (ERROR_UF_CAM_base + 84)
#define UF_CAM_ERROR_PATH_EVENT_NOT_CORRECT_TYPE  (ERROR_UF_CAM_base + 85)
#define UF_CAM_ERROR_INVALID_PATH_STRUCTURE       (ERROR_UF_CAM_base + 86)
#define UF_CAM_ERROR_PATH_EVENT_CREATION_FAILED   (ERROR_UF_CAM_base + 87)
#define UF_CAM_ERROR_INVALID_EVENT_INDEX          (ERROR_UF_CAM_base + 88)
#define UF_CAM_ERROR_NO_CAM_SESSION               (ERROR_UF_CAM_base + 89)
#define UF_CAM_ERROR_UI_DIALOG_ERROR              (ERROR_UF_CAM_base + 90)
#define UF_CAM_ERROR_UI_UNKNOWN_ERROR             (ERROR_UF_CAM_base + 91)
#define UF_CAM_ERROR_NO_MULTITOOL_ERROR           (ERROR_UF_CAM_base + 92)
#define UF_CAM_ERROR_INVALID_PARAMETER            (ERROR_UF_CAM_base + 93)
#define UF_CAM_ERROR_UI_CUSTOMIZATION_EXPLORER_FAILURE (ERROR_UF_CAM_base + 94)
#define UF_CAM_ERROR_INVALID_CAM_BASE_DIR         (ERROR_UF_CAM_base + 95)
#define UF_CAM_ERROR_4GD_PART_NOT_SUPPORTED       (ERROR_UF_CAM_base + 96)
#define UF_CAM_ERROR_INVALID_WORKFLOW_CONFIG      (ERROR_UF_CAM_base + 97)
#define UF_CAM_ERROR_INVALID_INSP_BASE_DIR        (ERROR_UF_CAM_base + 98)
#define UF_CAM_ERROR_MRM_DND_LICENSE_REQUIRED     (ERROR_UF_CAM_base + 99)
#define UF_CAM_ERROR_MASTER_TEMPLATE_COMPLEX_MERGE     (ERROR_UF_CAM_base + 100)
#define UF_CAM_ERROR_NO_ROBOT_CHAIN               (ERROR_UF_CAM_base + 101)
#define UF_CAM_ERROR_TYPE_TEMPLATE_OBJECT_INVALID_PARENT   (ERROR_UF_CAM_base + 102)
#define UF_CAM_ERROR_TYPE_TEMPLATE_STRUCTURE_DIFFERENT     (ERROR_UF_CAM_base + 103)
#define UF_CAM_ERROR_TEMPLATE_OBJECT_UI_DIFFERENT          (ERROR_UF_CAM_base + 104)
#define UF_CAM_ERROR_INTERNAL_LICENSE_REQUIRED             (ERROR_UF_CAM_base + 105)
#define UF_CAM_ERROR_TEMPLATE_OBJECT_VALUE_DIFFERENT       (ERROR_UF_CAM_base + 106)
#define UF_CAM_ERROR_SOLID_TOOL_NOT_LOADED                 (ERROR_UF_CAM_base + 107)
#define UF_OPER_ERROR_CUT_AREA_NOT_SUPPORTED               (ERROR_UF_CAM_base + 108)
#define UF_CAM_ERROR_DEVICE_KIM_VERSION_MISMATCH           (ERROR_UF_CAM_base + 109)
#define UF_CAM_ERROR_NO_DEVICE_POCKET_FOUND                (ERROR_UF_CAM_base + 110)
#define UF_CAM_ERROR_MRM_DND_RETRIEVE_AS_DEVICE            (ERROR_UF_CAM_base + 111)
#define UF_CAM_ERROR_NO_TOOL_POCKET_FOUND                  (ERROR_UF_CAM_base + 112)
#define UF_CAM_ERROR_TOOL_GRAPHICS_NOT_FOUND               (ERROR_UF_CAM_base + 113)
#define UF_CAM_ERROR_CANNOT_MOUNT_TOOL                     (ERROR_UF_CAM_base + 114)
#define UF_CAM_ERROR_NATIVE_MODE_NOT_SUPPORTED     (ERROR_UF_CAM_base + 115)
#define UF_CAM_ERROR_NO_DATABASE_PART_EXISTS       (ERROR_UF_CAM_base + 116)
#define UF_CAM_ERROR_NOT_SUPPORTED_PART_TYPE       (ERROR_UF_CAM_base + 117)
#define UF_CAM_ERROR_FILE_NOT_FOUND                (ERROR_UF_CAM_base + 118)
