...
enum UF_SF_element_type_e
{
     ...
     UF_SF_MPC = 39,           /* mpc element with 1 core node (first node) and multiple leg nodes. */
     UF_SF_MATRIX = 40,        /* matrix element with nodes and/or scalar points. */
     UF_SF_1D_JOINT = 41,      /* joint element */
     UF_SF_RSPLINE = 42,       /* rspline element */
     UF_SF_1D_BEARING2 = 43,   /* bearing2, defined for SOL 414*/
     UF_SF_1D_FOU3 = 44,       /* fou3, defined for SOL 414*/
     UF_SF_1D_BUSH2 = 45,       /* bushing2, defined for SOL 414*/
     UF_SF_1D_CLINK = 46,       /* clink, defined for SOL 414*/
     UF_SF_BENDPIPE = 47,            /* Bend element. */
     UF_SF_1D_CGEAR = 48,       /*gear element */
     UF_SF_BEAM3 = 49,          /* Quadratic Beam. */
/*   
*/
     UF_SF_TOTAL_COUNT = 50 /* This last member represents the total
...
enum UF_SF_mesh_dimension_e
{
  ...
  UF_SF_DIMENSION_MATRIX, /* Element dimension is 4 - matrix element with nodes and/or scalar points */
...
enum UF_SF_elm_dimension_type_e
{
    ...
    UF_SF_ELEMENT_SOLID = (int)UF_SF_DIMENSION_3D, /* Element type is solid - tet4,
                                                      tet10. */
    UF_SF_ELEMENT_MATRIX = (int)UF_SF_DIMENSION_MATRIX,/* Element type is matrix element
                                                          with nodes and/or scalar points */
    UF_SF_ELEMENT_ALL    = (int)UF_SF_DIMENSION_ANY /* Element of any of the above types. */
};
...
enum UF_SF_neutral_material_types_e
{
    ...
    UF_SF_MATERIAL_COMPOUNDISOTROPIC=36,        /* Compound Isotropic material                  */
    UF_SF_MATERIAL_LOWDENSITYFOAM=37,           /* Low Density Foam material                    */
    UF_SF_MATERIAL_FABRIC=38,                   /* Fabric material                              */
    UF_SF_MATERIAL_CRUSHABLEFOAM=39,            /* Crushable Foam material                      */
    UF_SF_MATERIAL_RATESENSITIVEFOAM=40,        /* Rate Sensitive Foam material                 */
    UF_SF_MATERIAL_MULTIMECHMICROSTRUCTURE=41,  /* Multimech Microstructure material            */
    UF_SF_MATERIAL_HONEYCOMB=42,                /* Honeycomb material                           */
    UF_SF_MATERIAL_COMPOSITE = 43,              /* Composite Material                           */
    UF_SF_MATERIAL_VISCOTHERMALFLUID = 44,      /* Visco-Thermal Fluid Material                 */
    UF_SF_MATERIAL_LAMINATEDGLASS = 45          /* Laminated Glass Material                     */
};
...
#define UF_SF_LANG_COMPONENTREF_VAL_TYPE         57
#define UF_SF_LANG_COMPONENTREF_ARRAY_VAL_TYPE   58
#define UF_SF_LANG_SOLVER_DRIVEN_STRING_ARRAY_VAL_TYPE         59
#define UF_SF_LANG_IMAGE_VAL_TYPE                60
#define UF_SF_LANG_COMPLEX_VECTOR_FIELD_VAL_TYPE 61
#define UF_SF_LANG_LBCREF_ARRAY_VAL_TYPE         62
#define UF_SF_LANG_MATERIAL_ARRAY_VAL_TYPE       63
#define UF_SF_LANG_REGION_ARRAY_VAL_TYPE         64
...
typedef enum
{
    ...
    UF_SF_FEM_VALUE_REGION_ARRAY       = UF_SF_LANG_REGION_ARRAY_VAL_TYPE,
    ...
    UF_SF_FEM_VALUE_COMPONENTREF       = UF_SF_LANG_COMPONENTREF_VAL_TYPE,
    UF_SF_FEM_VALUE_COMPONENTREF_ARRAY = UF_SF_LANG_COMPONENTREF_ARRAY_VAL_TYPE,
    UF_SF_FEM_VALUE_SOLVER_DRIVEN_STRING_ARRAY       = UF_SF_LANG_SOLVER_DRIVEN_STRING_ARRAY_VAL_TYPE,
    UF_SF_FEM_VALUE_IMAGE_VAL_TYPE       = UF_SF_LANG_IMAGE_VAL_TYPE,
    UF_SF_FEM_VALUE_COMPLEX_VECTOR_FIELD = UF_SF_LANG_COMPLEX_VECTOR_FIELD_VAL_TYPE,
    UF_SF_FEM_VALUE_LBCREF_ARRAY         = UF_SF_LANG_LBCREF_ARRAY_VAL_TYPE,
    UF_SF_FEM_VALUE_MATERIAL_ARRAY       = UF_SF_LANG_MATERIAL_ARRAY_VAL_TYPE
