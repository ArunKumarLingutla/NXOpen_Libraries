...
#define     UF_SC_EDGE_GROUP_FACE_BOUNDARY_EDGES       14
#define     UF_SC_MAX_EDGES                 15
...
#define     UF_SC_FACE_HOLE_FACES             (UF_SC_MAX_EDGES + 15)
#define     UF_SC_FACE_CURVATURE_CROSS_SECTION_FACES    (UF_SC_MAX_EDGES + 16)
#define     UF_SC_FACE_FLOOD_FILL_FACES       (UF_SC_MAX_EDGES + 17)
#define     UF_SC_MAX_FACES            (UF_SC_MAX_EDGES + 18)
...
// 
#define     UF_SC_BODY_TANGENT_BODIES         (UF_SC_MAX_CURVES + 4)
#define     UF_SC_BODY_ADJACENT_BODIES        (UF_SC_MAX_CURVES + 5)
#define     UF_SC_BODY_CONNECTED_BODIES       (UF_SC_MAX_CURVES + 6)
#define     UF_SC_BODY_SHEET_AND_ADJACENT_SHEET_BODIES  (UF_SC_MAX_CURVES + 7)
#define     UF_SC_MAX_BODY                    (UF_SC_MAX_CURVES + 8)

#define     UF_SC_CUSTOM                      (UF_SC_MAX_BODY + 1)
#define     UF_SC_MAX_CUSTOM                  (UF_SC_MAX_BODY + 2)

#define     UF_SC_INVALID_TYPE     (UF_SC_MAX_CUSTOM)
...
struct UF_SC_rule_input_data_option_s
{
    logical is_inactive_window_selection;
};
typedef struct UF_SC_rule_input_data_option_s
               UF_SC_rule_input_data_option_t, *UF_SC_rule_input_data_option_p_t;

struct UF_SC_EDGE_dumb_data_s
{
    int                                   num_edges;
    tag_t                                *edges;
    UF_SC_rule_input_data_option_p_t      rule_options;
};
...
struct  UF_SC_EDGE_group_face_boundary_edges_data_s
{
    tag_t                                 start_edge;
    tag_t                                 end_edge;
    tag_t                                 rootOrGroupFaceFeature;
    logical                               fromStartVertexOfEndEdge;
    int                                   n_negated_entities;
    tag_t*                                negated_entities;
    UF_SC_rule_input_data_option_p_t     rule_options;
};
typedef struct UF_SC_EDGE_group_face_boundary_edges_data_s
UF_SC_EDGE_group_face_boundary_edges_data_t, * UF_SC_EDGE_group_face_boundary_edges_data_p_t;
...
struct UF_SC_FACE_hole_faces_data_s
{
    tag_t           seed;
    int             n_negated_entities;
    tag_t*          negated_entities;
...
typedef struct UF_SC_FACE_hole_faces_data_s UF_SC_FACE_hole_faces_data_t, * UF_SC_FACE_hole_faces_data_p_t;

struct UF_SC_FACE_curvature_cross_section_faces_data_s
{
    tag_t  seed;
    tag_t propagationEdges[2];
    tag_t limitFaces[2];
    int    n_negated_entities;
    tag_t* negated_entities;
    UF_SC_rule_input_data_option_p_t rule_options;
};
typedef struct UF_SC_FACE_curvature_cross_section_faces_data_s UF_SC_FACE_curvature_cross_section_faces_data_t, * UF_SC_FACE_curvature_cross_section_faces_data_p_t;
...
struct UF_SC_CURVE_follow_fillet_data_s
{
    ...
    logical                               optimizeCurves;
    double                                optimizeFactors[2];
    tag_t                                 sourcePart; /* Optional attribute used for inactive window selection */
    UF_SC_rule_input_data_option_p_t      rule_options;
};
...
// 
struct UF_SC_BODY_tangent_bodies_data_s
{
    tag_t                                seedBody;
    double                               distanceTolerance;  /* distance tolerance for tangent bodies*/
    double                               angleTolerance;  /* angle tolerance for tangent bodies*/
    int                                  numNegatedEntities;
    tag_t*                               negatedEntities;
    logical                              chainWithinGroupBodies;
    int                                  numNegatedDomainEntities;
    tag_t*                               negatedDomainEntities;
    int                                  numDomainFeatures;
    tag_t*                               domainFeatures;
    UF_SC_rule_input_data_option_p_t     ruleOptions;
};
typedef struct UF_SC_BODY_tangent_bodies_data_s UF_SC_BODY_tangent_bodies_data_t, *UF_SC_BODY_tangent_bodies_data_p_t;

struct UF_SC_BODY_adjacent_bodies_data_s
{
    tag_t                                seedBody;
    double                               distanceTolerance;  /* distance tolerance for adjacent bodies*/
    int                                  numNegatedEntities;
    tag_t*                               negatedEntities;
    logical                              chainWithinGroupBodies;
    int                                  numNegatedDomainEntities;
...
typedef struct UF_SC_BODY_adjacent_bodies_data_s UF_SC_BODY_adjacent_bodies_data_t, *UF_SC_BODY_adjacent_bodies_data_p_t;

struct UF_SC_BODY_connected_bodies_data_s
{
    tag_t                                seedBody;
    double                               distanceTolerance;  /* distance tolerance for connected bodies*/
    int                                  numNegatedEntities;
    tag_t*                               negatedEntities;
    logical                              chainWithinGroupBodies;
    int                                  numNegatedDomainEntities;
...
typedef struct UF_SC_BODY_connected_bodies_data_s UF_SC_BODY_connected_bodies_data_t, * UF_SC_BODY_connected_bodies_data_p_t;

struct UF_SC_BODY_sheet_and_adjacent_sheet_bodies_data_s
{
    tag_t                                seedBody;
    double                               distanceTolerance;  /* distance tolerance for adjacent bodies*/
    int                                  numNegatedEntities;
...
typedef struct UF_SC_BODY_sheet_and_adjacent_sheet_bodies_data_s UF_SC_BODY_sheet_and_adjacent_sheet_bodies_data_t, * UF_SC_BODY_sheet_and_adjacent_sheet_bodies_data_p_t;

// 
struct UF_SC_CUSTOM_data_s
{
    void* multiple_criteria_processor; //Keeping it as void* to avoid includes and recompiles
    UF_SC_rule_input_data_option_p_t      rule_options;
    int                                   n_negated_entities;
    tag_t                                *negated_entities;
};
typedef struct UF_SC_CUSTOM_data_s
UF_SC_CUSTOM_data_t, * UF_SC_CUSTOM_data_p_t;
...
union UF_SC_input_data_s
{
    ...
    UF_SC_EDGE_group_face_boundary_edges_data_t    edge_group_face_boundary_edges_input;
    ...
    UF_SC_FACE_hole_faces_data_t              face_hole_faces_input;
    UF_SC_FACE_curvature_cross_section_faces_data_t     face_curvature_cross_section_faces_input;
    ...
    //<yugandar.polisetti>DES22Q421: Added new Body SI rules data structures entries to input data.
    UF_SC_BODY_tangent_bodies_data_t    tangentBodiesInput;
    UF_SC_BODY_adjacent_bodies_data_t   adjacentBodiesInput;
    UF_SC_BODY_connected_bodies_data_t  connectedBodiesInput;
    UF_SC_BODY_sheet_and_adjacent_sheet_bodies_data_t  sheetAndAdjacentSheetBodiesInput;
    UF_SC_CUSTOM_data_t                 custom_input;
