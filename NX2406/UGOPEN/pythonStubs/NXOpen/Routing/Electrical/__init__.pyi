...
class CableDevice(ElectricalStockDevice): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="part_name"> (str) Must be fullpath and PART_NAME for a regular part and PART_NAME for
    ##                        part family or part table parts</param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="conduitPartNumber"> (str)  </param>
...
class CablewaysLayoutViewCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## 
    ## <param name="segment"> (@link NXOpen.Curve NXOpen.Curve@endlink)  Segment on which layout view should be created or whose view is asked. </param>
...
class CablewaysLayoutView(NXOpen.NXObject): 
    ...
    ## License requirements: routing_cabling ("Routing Cabling")
    ## <param name="layoutView"> (@link CablewaysLayoutView NXOpen.Routing.Electrical.CablewaysLayoutView@endlink) </param>
    ## <param name="orientation"> (@link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink)  </param>
    ...
    ## License requirements: routing_cabling ("Routing Cabling")
    ## <param name="layoutView"> (@link CablewaysLayoutView NXOpen.Routing.Electrical.CablewaysLayoutView@endlink) </param>
    ## <param name="toOrientation"> (@link NXOpen.Xform NXOpen.Xform@endlink)  </param>
    @overload
...
class Connection(NXOpen.Routing.LogicalConnection): 
    ...
    ## NotRouted</term><description> 
    ## </description> </item><item><term> 
    ## Pin</term><description> 
    ##  Route to the pin on the connector component. </description> </item><item><term> 
    ## Component</term><description> 
    ##  Route to the connector component directly without regard for the pins. </description> </item><item><term> 
    ## Mixed</term><description> 
    ##  Route to the pin, if possible, otherwise route to the component. </description> </item></list>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="intermediate_terminal"> (@link NXOpen.Routing.LogicalTerminal NXOpen.Routing.LogicalTerminal@endlink)  Can not be NULL </param>
    ...
    ## <param name="path"> (@link NXOpen.Routing.Path NXOpen.Routing.Path@endlink)  The path on which to route this connection. </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="intermediate_terminal"> (@link NXOpen.Routing.LogicalTerminal NXOpen.Routing.LogicalTerminal@endlink)  may be NULL </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="intermediate_terminals"> (@link NXOpen.Routing.LogicalTerminal List[NXOpen.Routing.LogicalTerminal]@endlink)  Collection of intermediate @link NXOpen::Routing::LogicalTerminal NXOpen::Routing::LogicalTerminal@endlink  - Use NULL to remove all intermdiate terminals </param>
...
class ConnectorDeviceCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="connectors"> (@link ConnectorDevice List[NXOpen.Routing.Electrical.ConnectorDevice]@endlink)  </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## <param name="object_in_part"> (@link ConnectorDeviceCollection NXOpen.Routing.Electrical.ConnectorDeviceCollection@endlink) </param>
    ## <param name="connector_type"> (@link ConnectorDevice.ComponentType NXOpen.Routing.Electrical.ConnectorDevice.ComponentType@endlink)  </param>
    ## <param name="component_name"> (str)  </param>
    @overload
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## <param name="object_in_part"> (@link ConnectorDeviceCollection NXOpen.Routing.Electrical.ConnectorDeviceCollection@endlink) </param>
    ## <param name="harness_device"> (@link HarnessDevice NXOpen.Routing.Electrical.HarnessDevice@endlink)  can be NULL </param>
    ## <param name="equipment_name"> (str)  can be NULL if connectorName is not NULL </param>
    ## <param name="connector_name"> (str)  can be NULL if equipmentName is not NULL </param>
    ## <param name="connector_type"> (@link ConnectorDevice.ComponentType NXOpen.Routing.Electrical.ConnectorDevice.ComponentType@endlink)  </param>
    @overload
...
class ConnectorDevice(NXOpen.Routing.SingleDevice): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="elec_connector_part_occurrence"> (@link NXOpen.Assemblies.Component NXOpen.Assemblies.Component@endlink)  Component to assign. </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="terminal_name"> (str)  </param>
    ## <param name="create_terminal"> (bool)  TRUE - creates a new terminal if one does not exist with given name</param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="elec_harness_device"> (@link HarnessDevice NXOpen.Routing.Electrical.HarnessDevice@endlink)  </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="elec_connector_group"> (@link NXOpen.Group NXOpen.Group@endlink)  Component to assign. </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="match"> (@link NXOpen.Routing.CharacteristicList NXOpen.Routing.CharacteristicList@endlink)  </param>
    ## <param name="placer"> (@link NXOpen.Routing.Port NXOpen.Routing.Port@endlink)  </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="proxy"> (@link NXOpen.Routing.Port NXOpen.Routing.Port@endlink)  Assigned port. </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="route_terminal_to_remove"> (@link NXOpen.Routing.LogicalTerminal NXOpen.Routing.LogicalTerminal@endlink)  </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="elec_part_definition_shadow"> (@link ElectricalPartDefinitionShadow NXOpen.Routing.Electrical.ElectricalPartDefinitionShadow@endlink)  </param>
...
class ElectricalFormatCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## <param name="type"> (@link ElectricalFormat.Type NXOpen.Routing.Electrical.ElectricalFormat.Type@endlink)  </param>
    ...
    ## 
    ## <param name="type"> (@link ElectricalFormat.Type NXOpen.Routing.Electrical.ElectricalFormat.Type@endlink)  </param>
    ## <param name="format"> (@link ElectricalFormat NXOpen.Routing.Electrical.ElectricalFormat@endlink)  </param>
...
class ElectricalNavigatorFilterCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="name"> (str)  Name of the filter </param>
    ## <param name="clause"> (str)  Clause of the filter </param>
    ...
    ## 
    ## <param name="type"> (@link ElectricalFormat.Type NXOpen.Routing.Electrical.ElectricalFormat.Type@endlink)  </param>
    ## <param name="filter"> (@link ElectricalNavigatorFilter NXOpen.Routing.Electrical.ElectricalNavigatorFilter@endlink)  </param>
...
class ElectricalStockDeviceCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="stock_devices"> (@link ElectricalStockDevice List[NXOpen.Routing.Electrical.ElectricalStockDevice]@endlink)  </param>
    ## <param name="route_type"> (@link ElectricalStockDevice.RouteTypes NXOpen.Routing.Electrical.ElectricalStockDevice.RouteTypes@endlink)  </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="route_level"> (@link ElectricalStockDevice.RouteLevel NXOpen.Routing.Electrical.ElectricalStockDevice.RouteLevel@endlink)  </param>
    ## <param name="route_sel"> (@link ElectricalStockDevice.AutoRouteSel NXOpen.Routing.Electrical.ElectricalStockDevice.AutoRouteSel@endlink)  </param>
...
class ElectricalStockDevice(NXOpen.Routing.StockDevice): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## BundleDiameter</term><description> 
    ##  </description> </item><item><term> 
    ## LeastBundles</term><description> 
    ##  </description> </item><item><term> 
    ## DesignRules</term><description> 
    ##  </description> </item><item><term> 
    ## LeastSegments</term><description> 
    ##  </description> </item><item><term> 
    ## ShortestLength</term><description> 
    ##  </description> </item></list>
    ...
    ## Pin</term><description> 
    ##  </description> </item><item><term> 
    ## Comp</term><description> 
    ##  </description> </item><item><term> 
    ## Mixed</term><description> 
    ##  </description> </item><item><term> 
    ## Partial</term><description> 
    ##  </description> </item></list>
    class RouteLevel(Enum):
        """
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## DefaultRoute</term><description> 
    ##  </description> </item><item><term> 
    ## AutoRoute</term><description> 
    ##  </description> </item><item><term> 
    ## ManualRoute</term><description> 
    ##  </description> </item></list>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="harness_device"> (@link HarnessDevice NXOpen.Routing.Electrical.HarnessDevice@endlink)  </param>
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="route_level"> (@link ElectricalStockDevice.RouteLevel NXOpen.Routing.Electrical.ElectricalStockDevice.RouteLevel@endlink)  Routing type. </param>
    ## <param name="segments"> (@link NXOpen.Routing.ISegment List[NXOpen.Routing.ISegment]@endlink)  </param>
...
class HarnessDeviceCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## <param name="object_in_part"> (@link HarnessDeviceCollection NXOpen.Routing.Electrical.HarnessDeviceCollection@endlink) </param>
    ## <param name="harness_name"> (str)  </param>
    @overload
...
class PathArrangementBuilder(NXOpen.Builder): 
    ...
    ## License requirements: routing_base ("Routing Basic")
    ## 
    ## <param name="port"> (@link NXOpen.Routing.Port NXOpen.Routing.Port@endlink)  Routing port whose associated path arrangement object is used to populate the data in the builder </param>
    ...
    ## License requirements: routing_base ("Routing Basic")
    ## 
    ## <param name="point"> (@link NXOpen.Point3d NXOpen.Point3d@endlink)  Origin of the path arrangement in the context of the root part. </param>
...
class SortConnectionsPluginData(NXOpen.TaggedObject): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## 
    ## <param name="stockDevices"> (@link ElectricalStockDevice List[NXOpen.Routing.Electrical.ElectricalStockDevice]@endlink)  The @link Routing::Electrical::ElectricalStockDevice Routing::Electrical::ElectricalStockDevice@endlink s sorted in the order in which
    ##                     you want to route them. </param>
...
class SystemDeviceCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: routing_advanced ("Routing Advanced"), routing_base ("Routing Basic")
    ## <param name="object_in_part"> (@link SystemDeviceCollection NXOpen.Routing.Electrical.SystemDeviceCollection@endlink) </param>
    ## <param name="system_name"> (str)  The name of the new system.
    ##                                                              (NULL not allowed) </param>
    @overload
