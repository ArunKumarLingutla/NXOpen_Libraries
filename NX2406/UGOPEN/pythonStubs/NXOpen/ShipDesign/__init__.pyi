...
class ApplicationUtils(NXOpen.Object): 
    ...
    ## <param name="appName"> (str)  The name of the application. </param>
    ...
    ## License requirements: nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design")
    ## <param name="appName"> (str)  The name of the master application. </param>
    ## <param name="appsWhereToLive"> (List[str])  The application array whose applications allow the master application to be alive. </param>
    ...
    ## License requirements: nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design")
    ## <param name="appId"> (int)  The id of the application. </param>
    ## <param name="buttonName"> (str)  The name of the button. </param>
...
class GeneralArrangementManager(NXOpen.Object): 
    ...
    ## <param name="sketch"> (@link NXOpen.Sketch NXOpen.Sketch@endlink)  the sketch </param>
    ...
    ## License requirements: nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the container part </param>
...
class Generator(NXOpen.Object): 
    ...
    ##  There is no clash between two bodies. </description> </item><item><term> 
    ## AInB</term><description> 
    ##  Body a is completly in body b, without abut. </description> </item><item><term> 
    ## BInA</term><description> 
    ##  Body b is completly in body a, without abut. </description> </item><item><term> 
    ## Exists</term><description> 
    ## Clash exists; only this is requested. </description> </item><item><term> 
    ## AbutNoClass</term><description> 
    ##  Bounding topologies abut, in/outside unknown. </description> </item><item><term> 
    ## AbutBInA</term><description> 
    ##  Bounding b topology abuts bounding a topology on the inside. </description> </item><item><term> 
    ## AbutBOutA</term><description> 
    ##  Bounding b topology abuts bounding a topology on the outside. </description> </item><item><term> 
    ## Interfere</term><description> 
    ##  Bounding topologies interfere. </description> </item></list>
    ...
    ## License requirements: nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design")
    ## <param name="name"> (str)  The name of the application. </param>
    ## <param name="enterCallback"> (@link Generator.ShipCustomerEnterApplication NXOpen.ShipDesign.Generator.ShipCustomerEnterApplication@endlink)  The method called when entering the application </param>
    ## <param name="exitCallback"> (@link Generator.ShipCustomerExitApplication NXOpen.ShipDesign.Generator.ShipCustomerExitApplication@endlink)  The method called when exiting the application </param>
...
class NavigatorCollection(NXOpen.Object): 
    ...
    ## <param name="index"> (int)  ship navigator id </param>
    ...
    ## License requirements: nx_ship_basic ("Ship Basic Design")
    ## <param name="tgFeat"> (@link NXOpen.Features.Feature NXOpen.Features.Feature@endlink)  @link NXOpen::Features::Feature NXOpen::Features::Feature@endlink  to be edited </param>
    ...
    ## License requirements: nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design")
    ## <param name="sketch_feature"> (@link NXOpen.Features.SketchFeature NXOpen.Features.SketchFeature@endlink)  The Sketch to edit </param>
    ...
    ## <param name="displayPart"> (@link NXOpen.BasePart NXOpen.BasePart@endlink)  part being validated </param>
    ...
    ## <param name="index"> (int)  ship navigator id </param>
    ## <param name="tgTargetNode"> (@link NavigatorNode NXOpen.ShipDesign.NavigatorNode@endlink) </param>
    ## <param name="tgSourceNode"> (@link NavigatorNode NXOpen.ShipDesign.NavigatorNode@endlink) </param>
...
class Navigator(NXOpen.NXObject): 
    ...
    ## License requirements: nx_ship_basic ("Ship Basic Design")
    ## <param name="selfNavigator"> (@link Navigator NXOpen.ShipDesign.Navigator@endlink) </param>
    @overload
    def Hide(self) -> None:
        """
         Hides a navigator. 
...
class PaintParametersData(NXOpen.TransientObject): 
    ...
    ##  User select paint to target in UI </description> </item></list>
    ...
    ## 
    ## <param name="parameterName"> (str)  the parameter name </param>
    ## <param name="parameterStatus"> (int)  the parameter status as defined in @link NXOpen::Tooling::SpreadsheetData::ParameterStatus NXOpen::Tooling::SpreadsheetData::ParameterStatus@endlink . </param>
    ## <param name="isAdd"> (bool)  Specifies whether the parameter status should be added or removed. If true, then the status is added, else it is removed.</param>
...
class ShipNavigatorNodeBuilder(NXOpen.Builder): 
    ...
    ##  The object node type. </description> </item><item><term> 
    ## Part</term><description> 
    ##  The part node type. </description> </item><item><term> 
    ## Container</term><description> 
    ##  The container node type. </description> </item></list>
