...
class ObjectUpdateStateManager(NXOpen.Object): 
    ...
    ## License requirements: stage_model (" Stage Model")
    ## <param name="objects"> (@link NXOpen.TaggedObject List[NXOpen.TaggedObject]@endlink)  The objects to be made up to date </param>
    ## <param name="undoMarkId"> (int)  If any update error occurs, the system will roll back to this
    ##                                                       undo mark. </param>
...
class StockStageDetailsBuilder(NXOpen.Builder): 
    ...
    ## License requirements: stage_model (" Stage Model")
    ## 
    ## <param name="stageDescription"> (List[str])  </param>
