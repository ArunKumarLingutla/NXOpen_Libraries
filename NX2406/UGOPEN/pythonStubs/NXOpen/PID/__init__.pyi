...
class AutomaticTableBuilder(NXOpen.Builder): 
    ...
    ##  Equipment </description> </item><item><term> 
    ## InlineEquipment</term><description> 
    ##  Inline quipment, deprecated from nx1872 and combined with @link NXOpen::PID::AutomaticTableBuilder::ObjectTypeOptionEquipment NXOpen::PID::AutomaticTableBuilder::ObjectTypeOptionEquipment@endlink .</description> </item><item><term> 
    ## Run</term><description> 
    ##  Run </description> </item><item><term> 
    ## PipeStock</term><description> 
    ##  Pipe Stock </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## CurrentSheet</term><description> 
    ##  Lists objects in current sheet </description> </item><item><term> 
    ## OtherSheet</term><description> 
    ##  Lists objects in other sheet </description> </item><item><term> 
    ## System</term><description> 
    ##  Lists objects in specific system </description> </item></list>
    ...
    ## Instrumentation</term><description> 
    ##  Instrumentation Line Stock</description> </item><item><term> 
    ...
    ##  Returns the option to output the inline equipment/valve list.  
    ##    Only applicable when @link NXOpen::PID::AutomaticTableBuilder::ScopeType NXOpen::PID::AutomaticTableBuilder::ScopeType@endlink  is @link NXOpen::PID::AutomaticTableBuilder::ObjectTypeOptionEquipment NXOpen::PID::AutomaticTableBuilder::ObjectTypeOptionEquipment@endlink .   
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    ## 
    ## <param name="index"> (int)  the index of property cell range </param>
    ...
    ## 
    ## <param name="index"> (int)  the index of the first inserted property cell range </param>
    ## <param name="propertyTypes"> (@link PropertyType List[NXOpen.PID.PropertyType]@endlink)  the property types of inserted property cell ranges </param>
    ## <param name="propertyKeys"> (List[str])  the property keys of inserted property cell ranges </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="index"> (int)  the index of the first removed property cell range </param>
    ## <param name="number"> (int)  the number of removed property cell ranges </param>
...
class AutomaticTableCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="sheet"> (@link AutomaticTableCollection NXOpen.PID.AutomaticTableCollection@endlink) </param>
    ## <param name="automaticTable"> (@link AutomaticTable NXOpen.PID.AutomaticTable@endlink)  the @link NXOpen::PID::AutomaticTable NXOpen::PID::AutomaticTable@endlink  </param>
    ## <param name="templatePartName"> (str)  name of the template part </param>
    @overload
    ...
    ## <param name="sheet"> (@link AutomaticTableCollection NXOpen.PID.AutomaticTableCollection@endlink) </param>
    ## <param name="automaticTable"> (@link AutomaticTable NXOpen.PID.AutomaticTable@endlink)  the @link NXOpen::PID::AutomaticTable NXOpen::PID::AutomaticTable@endlink  </param>
    ## <param name="builder"> (@link PartOperationCreateBuilder NXOpen.PDM.PartOperationCreateBuilder@endlink) </param>
    @overload
...
class EquipmentBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="fromPortId"> (str)  the port id of this equipment symbol for the attachment. </param>
    ## <param name="toSymbol"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  @link NXOpen::PID::Equipment NXOpen::PID::Equipment@endlink  or @link NXOpen::PID::NativeEquipment NXOpen::PID::NativeEquipment@endlink </param>
    ## <param name="toSymbolNodeSidId"> (str)  the node id of the toSymbol. </param>
    ## <param name="toSymbolPortId"> (str)  the port id of the toSymbol for the attachment. </param>
...
class InstrumentationBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="fromPortId"> (str) </param>
    ## <param name="toInstrumentSymbol"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  @link NXOpen::PID::InstrumentationSymbol NXOpen::PID::InstrumentationSymbol@endlink  or @link NXOpen::PID::Instrumentation NXOpen::PID::Instrumentation@endlink </param>
    ## <param name="toPortId"> (str) </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="pipe"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  @link NXOpen::PID::NativePipe NXOpen::PID::NativePipe@endlink  or @link NXOpen::PID::Pipe NXOpen::PID::Pipe@endlink </param>
    ## <param name="connectionId"> (str) </param>
    ## <param name="segementId"> (int) </param>
    ## <param name="percent"> (float) </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="reference"> (@link NXOpen.Diagramming.SheetElement NXOpen.Diagramming.SheetElement@endlink) </param>
    ## <param name="point"> (@link NXOpen.Point2d NXOpen.Point2d@endlink)  the instrumentation annotation's leader point. </param>
    ## <param name="connectionSegementId"> (int) </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="location"> (@link NXOpen.Point2d NXOpen.Point2d@endlink)  the instrumentation location. </param>
    def SetLocation(self, location: NXOpen.Point2d) -> None:
        """
         Sets the instrumentation location. 
        """
...
## Comment</description> </listheader><item><term> 
## Id</term><description> 
##  control loop Id. </description> </item><item><term> 
## Name</term><description> 
##  control loop name. </description> </item><item><term> 
## Blank</term><description> 
##  no display. </description> </item></list>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## Unassigned</term><description> 
##  unassigned control loop. </description> </item><item><term> 
## Active</term><description> 
##  active control loop. </description> </item><item><term> 
## Inferred</term><description> 
##  inferred control loop. </description> </item><item><term> 
## Specified</term><description> 
##  specified control loop. </description> </item></list>
...
##  instrumentation symbol. </description> </item><item><term> 
## Annotation</term><description> 
##  instrumentation annotation. </description> </item></list>
...
class LibraryAuthoringBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## 
    ## <param name="symbolObject"> (@link NXOpen.DiagrammingLibraryAuthor.AttributeHolder NXOpen.DiagrammingLibraryAuthor.AttributeHolder@endlink)  the symbol object,
    ##                 only accept the object which is got by @link NXOpen::PID::LibraryAuthoringBuilder::Create3DSymbol NXOpen::PID::LibraryAuthoringBuilder::Create3DSymbol@endlink  </param>
...
class PidManager(NXOpen.Object): 
    ...
    ## <param name="table"> (@link AutomaticTable NXOpen.PID.AutomaticTable@endlink)  @link NXOpen::PID::AutomaticTable NXOpen::PID::AutomaticTable@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part that will own the object </param>
    ## <param name="equipment"> (@link Equipment NXOpen.PID.Equipment@endlink)  @link NXOpen::PID::Equipment NXOpen::PID::Equipment@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink) </param>
    ## <param name="flowDirectionArrow"> (@link FlowDirectionArrow NXOpen.PID.FlowDirectionArrow@endlink)  @link NXOpen::PID::FlowDirectionArrow NXOpen::PID::FlowDirectionArrow@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part that will own the object </param>
    ## <param name="instrumentation"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  @link NXOpen::PID::InstrumentationSymbol NXOpen::PID::InstrumentationSymbol@endlink  or @link NXOpen::PID::Instrumentation NXOpen::PID::Instrumentation@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part that will own the object </param>
    ## <param name="oscObject"> (@link OffSheetConnector NXOpen.PID.OffSheetConnector@endlink)  @link Diagramming::Annotation Diagramming::Annotation@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part that will own the object </param>
    ## <param name="pipe"> (@link Pipe NXOpen.PID.Pipe@endlink)  @link Diagramming::Connection Diagramming::Connection@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part that will own the object </param>
    ## <param name="portEquipment"> (@link PortEquipment NXOpen.PID.PortEquipment@endlink)  @link NXOpen::PID::PortEquipment NXOpen::PID::PortEquipment@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part that will own the object </param>
    ## <param name="sheet"> (@link NXOpen.Diagramming.Sheet NXOpen.Diagramming.Sheet@endlink) </param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="sheetElementsDel"> (@link NXOpen.Diagramming.SheetElement List[NXOpen.Diagramming.SheetElement]@endlink)  Sheet Elements to be checked</param>
    ...
    ## License requirements: nx_pid_design_author ("NX P and ID Design Author")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the sheet part </param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## Piping</term><description> 
##  piping discipline. </description> </item><item><term> 
## Instrumentation</term><description> 
##  instrumentation discipline. </description> </item><item><term> 
## Hvac</term><description> 
##  HVAC discipline. </description> </item></list>
...
## NeedAttribute</term><description> 
##  Need attribute </description> </item><item><term> 
## FulfillmentAttribute</term><description> 
##  Fulfillment attribute </description> </item><item><term> 
## PipeStockAttribute</term><description> 
##  Pipe stock attribute </description> </item><item><term> 
## PidTag</term><description> 
##  The tag of PID object </description> </item><item><term> 
...
## System</term><description> 
##  The system of object </description> </item><item><term> 
## RunAttribute</term><description> 
##  The attibute of run object </description> </item><item><term> 
## EquipmentAttribute</term><description> 
##  The attibute of equipment object </description> </item></list>
...
## LogicalElementRevision</term><description> 
##  from an existing Logical Element Revision. </description> </item></list>
