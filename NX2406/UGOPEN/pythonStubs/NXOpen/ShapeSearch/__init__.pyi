...
class SearchManager(NXOpen.Object): 
    ...
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink)  the part </param>
...
class ShapeSearchBuilder(NXOpen.Builder): 
    ...
    ## NotSetDisplayPart</term><description> 
    ##  Not set the opened part as display part </description> </item><item><term> 
    ## SetDisplayPartOnlyWhenOpen</term><description> 
    ##  Set the opened part as display part only when it doesn't exist in the session </description> </item><item><term> 
    ## AlwaysSetDisplayPart</term><description> 
    ##  Always set the opened part as display part whether it exists in the session </description> </item></list>
    ...
    ##  search by attributes </description> </item><item><term> 
    ## Body</term><description> 
    ##  search by bodies     </description> </item><item><term> 
    ## Part</term><description> 
    ##  search by part       </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## Gradient1</term><description> 
    ##  search with identical condition    </description> </item><item><term> 
    ## Gradient2</term><description> 
    ## </description> </item><item><term> 
    ## Gradient3</term><description> 
    ## </description> </item><item><term> 
    ## Gradient4</term><description> 
    ## </description> </item><item><term> 
    ## Gradient5</term><description> 
    ## </description> </item><item><term> 
    ## Gradient6</term><description> 
    ##  search with very similar condition </description> </item><item><term> 
    ## Gradient7</term><description> 
    ## </description> </item><item><term> 
    ## Gradient8</term><description> 
    ## </description> </item><item><term> 
    ## Gradient9</term><description> 
    ## </description> </item><item><term> 
    ## Gradient10</term><description> 
    ##  search with similar condition      </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## P90P110</term><description> 
    ##  search with shape size 90%-110% condition </description> </item><item><term> 
    ## P80P120</term><description> 
    ##  search with shape size 80%-120% condition </description> </item><item><term> 
    ## P70P130</term><description> 
    ##  search with shape size 70%-130% condition </description> </item><item><term> 
    ## P50P200</term><description> 
    ##  search with shape size 50%-200% condition </description> </item><item><term> 
    ## P25P400</term><description> 
    ##  search with shape size 25%-400% condition </description> </item></list>
    ...
    ## License requirements: shape_search ("Shape Search")
    ## 
    ## <param name="isNew"> (bool)  True is executing new search, False is executing saved search </param>
    ## <param name="searchName"> (str)  Search name </param>
    ...
    ## 
    ## <param name="searchName"> (str)  Search name </param>
    ## <param name="startResultId"> (int)  Start result id </param>
    ## <param name="endResultId"> (int)  End result id </param>
    ...
    ## License requirements: shape_search ("Shape Search")
    ## 
    ## <param name="openPartType"> (@link ShapeSearchBuilder.OpenPartType NXOpen.ShapeSearch.ShapeSearchBuilder.OpenPartType@endlink)  Open part type </param>
    ## <param name="searchName"> (str)  Search name </param>
    ## <param name="resultId"> (int)  Result id </param>
    ...
    ## License requirements: shape_search ("Shape Search")
    ## 
    ## <param name="inputAttributesFilter"> (List[str])  Search attributes filter </param>
    ...
    ## License requirements: shape_search ("Shape Search")
    ## 
    ## <param name="inputAttributesName"> (List[str])  Search attributes Name </param>
