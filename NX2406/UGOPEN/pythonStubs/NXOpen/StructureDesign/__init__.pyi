...
class ContextMenu(NXOpen.Object): 
    ...
    ## ShowStock</term><description> 
    ##  show stock color </description> </item><item><term> 
    ## ShowWeld</term><description> 
    ##  show weld color </description> </item></list>
    ...
    ## <param name="tWeldmentNode"> (@link NXOpen.ShipDesign.NavigatorNode NXOpen.ShipDesign.NavigatorNode@endlink) </param>
    ...
    ## License requirements: nx_structure_design ("Structure Designer")
    ## <param name="index"> (int)  ship navigator id </param>
    ## <param name="tgTargetNode"> (@link NXOpen.ShipDesign.NavigatorNode NXOpen.ShipDesign.NavigatorNode@endlink) </param>
    ## <param name="tgNodes"> (@link NXOpen.ShipDesign.NavigatorNode List[NXOpen.ShipDesign.NavigatorNode]@endlink) </param>
