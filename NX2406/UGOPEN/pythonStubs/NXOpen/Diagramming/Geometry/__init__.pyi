...
class ArcCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## 
    ## <param name="arcGeometry"> (@link Arc NXOpen.Diagramming.Geometry.Arc@endlink)  @link NXOpen::Diagramming::Geometry::Arc NXOpen::Diagramming::Geometry::Arc@endlink  to be edited, if NULL then create a new one </param>
...
class LineCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="lineGeometry"> (@link Line NXOpen.Diagramming.Geometry.Line@endlink)  @link NXOpen::Diagramming::Geometry::Line NXOpen::Diagramming::Geometry::Line@endlink  to be edited, if NULL then create a new one </param>
...
class PointCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="pointGeometry"> (@link Point NXOpen.Diagramming.Geometry.Point@endlink)  @link NXOpen::Diagramming::Geometry::Point NXOpen::Diagramming::Geometry::Point@endlink  to be edited, if NULL then create a new one </param>
...
class RectangleCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="rectangleGeometry"> (@link Rectangle NXOpen.Diagramming.Geometry.Rectangle@endlink)  @link NXOpen::Diagramming::Geometry::Rectangle NXOpen::Diagramming::Geometry::Rectangle@endlink  to be edited, if NULL then create a new one </param>
...
"""
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link SelectBaseGeometryList NXOpen.Diagramming.Geometry.SelectBaseGeometryList@endlink) </param>
    ## <param name="objectValue"> (@link BaseGeometry NXOpen.Diagramming.Geometry.BaseGeometry@endlink)  object to add </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link BaseGeometry List[NXOpen.Diagramming.Geometry.BaseGeometry]@endlink)  objects to add </param>
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link SelectBaseGeometryList NXOpen.Diagramming.Geometry.SelectBaseGeometryList@endlink) </param>
    ## <param name="selection"> (@link BaseGeometry NXOpen.Diagramming.Geometry.BaseGeometry@endlink)  selected object </param>
    ...
    ## <param name="selection1"> (@link BaseGeometry NXOpen.Diagramming.Geometry.BaseGeometry@endlink)  first selected object </param>
    ...
    ## <param name="selection2"> (@link BaseGeometry NXOpen.Diagramming.Geometry.BaseGeometry@endlink)  second selected object </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="objectValue"> (@link BaseGeometry NXOpen.Diagramming.Geometry.BaseGeometry@endlink)  object to check </param>
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link SelectBaseGeometryList NXOpen.Diagramming.Geometry.SelectBaseGeometryList@endlink) </param>
    ## <param name="objectValue"> (@link BaseGeometry NXOpen.Diagramming.Geometry.BaseGeometry@endlink)  Object to remove </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link BaseGeometry List[NXOpen.Diagramming.Geometry.BaseGeometry]@endlink)  Objects to remove </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link BaseGeometry List[NXOpen.Diagramming.Geometry.BaseGeometry]@endlink)  items to put in the list</param>
