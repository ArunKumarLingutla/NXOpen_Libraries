...
class RadialBuilder(NXOpen.TaggedObject): 
    ...
    ##  View direction </description> </item><item><term> 
    ## ArbitraryVector</term><description> 
    ##  A user specified vector </description> </item></list>
...
class SectionAnalysisBuilder(NXOpen.Builder): 
    ...
    ##  Curvature </description> </item><item><term> 
    ## RadiusofCurvature</term><description> 
    ##  Radius of curvature </description> </item></list>
    ...
    ## SectionCurves</term><description> 
    ##  section curves </description> </item><item><term> 
    ## Both</term><description> 
    ##  Both Analysis Object and section curves </description> </item></list>
    ...
    ##  Logarithmic </description> </item></list>
    ...
    ##  Parallel Planes </description> </item><item><term> 
    ## Isoparametric</term><description> 
    ##  Isoparametric </description> </item><item><term> 
    ## AlongCurve</term><description> 
    ##  Along Curve </description> </item><item><term> 
    ## Quadrilateral</term><description> 
    ##  Quadrilateral </description> </item><item><term> 
    ## Triangular</term><description> 
    ##  Triangular </description> </item><item><term> 
    ## Circular</term><description> 
    ##  Circular </description> </item></list>
    class Types(Enum):
        """
...
class SectionAnalysisExBuilder(NXOpen.Builder): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## XYZPlane</term><description> 
    ##  The cutting planes are perpendicular to X, Y or Z plane </description> </item><item><term> 
    ## ParallelPlanes</term><description> 
    ##  The cutting planes are parallel to a specified plane </description> </item><item><term> 
    ## CurveAligned</term><description> 
    ##  The cutting planes are perpendicular to specified curves </description> </item><item><term> 
    ## Isoparametric</term><description> 
    ##  The sections are along isoparametric lines </description> </item><item><term> 
    ## Radial</term><description> 
    ##  The cutting planes are distributed along a circle </description> </item></list>
    ...
    ##  Uniformly distributed </description> </item><item><term> 
    ## ThroughPoints</term><description> 
    ##  Through the specified points </description> </item><item><term> 
    ## BetweenPoints</term><description> 
    ##  Distributed between two specified points</description> </item><item><term> 
    ## Interactive</term><description> 
    ##  Interactively specified </description> </item></list>
    ...
    ##     
    ##  
    ## Setter License requirements: studio_analyze ("STUDIO ANALYZE") OR nx_mcd_core ("Mechatronics Concept Designer")
    ## 
    ##   <br>  Created in NX7.0.0  <br> 
...
class SectionPlaneBuilder(NXOpen.TaggedObject): 
    ...
    ## Comment</description> </listheader><item><term> 
    ## Xc</term><description> 
    ##  XC plane </description> </item><item><term> 
    ## Yc</term><description> 
    ##  YC plane </description> </item><item><term> 
    ## Zc</term><description> 
    ##  ZC plane </description> </item><item><term> 
    ## View</term><description> 
    ##  View plane </description> </item><item><term> 
    ## Plane</term><description> 
    ##  A user specifed plane </description> </item></list>
