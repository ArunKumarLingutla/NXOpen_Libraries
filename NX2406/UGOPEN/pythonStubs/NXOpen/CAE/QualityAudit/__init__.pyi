...
class ActionList(NXOpen.NXObject): 
    ...
    ## 
    ## <param name="pAction"> (@link Action NXOpen.CAE.QualityAudit.Action@endlink)  The action to be deselected </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="id"> (@link Action.Id NXOpen.CAE.QualityAudit.Action.Id@endlink)  Action id. See @link NXOpen::CAE::QualityAudit::Action::Id NXOpen::CAE::QualityAudit::Action::Id@endlink  </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="pAction"> (@link Action NXOpen.CAE.QualityAudit.Action@endlink)  The action to be checked if selected or not </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="pAction"> (@link Action NXOpen.CAE.QualityAudit.Action@endlink)  The action to be selected </param>
...
class Action(NXOpen.NXObject): 
    ...
    ## AllConnectionsList</term><description> 
    ##  the action that lists all connections </description> </item><item><term> 
    ## NonModeledConnectionsList</term><description> 
    ##  the action that list all non modeled connections </description> </item><item><term> 
    ## SubAssemblyComponentCheck</term><description> 
    ##  the action that list groups of connected components before meshing </description> </item><item><term> 
    ## SubAssemblyMeshCheck</term><description> 
    ##  the action that list groups of connected meshes after meshing </description> </item><item><term> 
    ## ObjectLevelProjectionCheck</term><description> 
    ##  the action listing projection errors at object level </description> </item><item><term> 
    ## MeshLevelProjectionCheck</term><description> 
    ##  the action listing projection errors at mesh level </description> </item><item><term> 
    ## DistanceBetweenConnectionPointsCheck</term><description> 
    ##  the action verifying distance between the points of the same connection </description> </item><item><term> 
    ## DistanceBetweenConnectionsCheck</term><description> 
    ##  the action checking the distance between connections </description> </item><item><term> 
    ## FreeEdgeDistanceCheck</term><description> 
    ##  the action checking for near edge connections </description> </item><item><term> 
    ## TargetSequenceCheck</term><description> 
    ##  the action verifying the support order </description> </item><item><term> 
    ## ObjectLevelLengthCheck</term><description> 
    ##  the action checking connections for which the distance is lower or higher than a threshold value </description> </item><item><term> 
    ## MeshLevelLengthCheck</term><description> 
    ##  the action checking connections for which the distance is lower or higher than a threshold value </description> </item><item><term> 
    ## ObjectLevelLengthRatioCheck</term><description> 
    ##  the action checking connections for which the distance between the projection points on the supports divided by the sum of half the support thickness is lower or higher than a threshold value </description> </item><item><term> 
    ## MeshLevelLengthRatioCheck</term><description> 
    ##  the action checking connections for which the distance between the projection points on the supports divided by the sum of half the support thickness is lower or higher than a threshold value </description> </item><item><term> 
    ## ObjectLevelConnectionAngleCheck</term><description> 
    ##  the action checking connections for which the angle is higher than a threshold value </description> </item><item><term> 
    ## MeshLevelConnectionAngleCheck</term><description> 
    ##  the action checking connections for which the angle is higher than a threshold value</description> </item><item><term> 
    ## ObjectLevelFlatnessCheck</term><description> 
    ##  the action checking spot welds for which the height is higher than a threshold value </description> </item><item><term> 
    ## MeshLevelFlatnessCheck</term><description> 
    ##  the action checking spot welds for which the height is higher than a threshold value </description> </item><item><term> 
    ## ConnectionSynthesis</term><description> 
    ##  the action displaying information about the connections grouped by characteristics </description> </item></list>
    class Id(Enum):
        """
...
class Manager(NXOpen.Object): 
    ...
    ## License requirements: nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation")
    ## <param name="inputActions"> (@link Action List[NXOpen.CAE.QualityAudit.Action]@endlink)  The @link CAE::QualityAudit::Action CAE::QualityAudit::Action@endlink  array of actions to be performed. </param>
    ## <param name="pObjects"> (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink)  The objects to be used by the actions. </param>
