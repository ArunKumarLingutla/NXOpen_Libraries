...
##  the normal marker without anchor type </description> </item><item><term> 
## Start</term><description> 
##  the position of start point in a record display </description> </item><item><term> 
## End</term><description> 
##  the position of end point in a record display </description> </item><item><term> 
## MaximumValue</term><description> 
##  the position of the point which has maximum value in a record display </description> </item><item><term> 
## MinimumValue</term><description> 
##  the position of the point which has minimum value in a record display </description> </item><item><term> 
## AbsPercentage</term><description> 
##  the position of the point in the set abscissa percentage </description> </item></list>
...
##  Display angle in degree unit </description> </item><item><term> 
## Radian</term><description> 
##  Display angle in radian unit </description> </item><item><term> 
## Rev</term><description> 
##  Display angle in rev unit </description> </item></list>
...
class ArgumentAxisStyleSetting(BaseDisplayStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="customerIndices"> (List[int])  Customer range </param>
...
##  Db 10 </description> </item><item><term> 
## Twenty</term><description> 
##  Db 20 </description> </item></list>
...
## Y</term><description> 
##  Y-axis </description> </item><item><term> 
## Z</term><description> 
##  Z-axis </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## End</term><description> 
##  If string length exceeds maximum character count, truncating the end of string </description> </item><item><term> 
## Beginning</term><description> 
##  If string length exceeds maximum character count, truncating the beginning of string </description> </item></list>
...
class AxisStyleSetting(BaseDisplayStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="lowerLimit"> (float)   </param>
    ## <param name="upperLimit"> (float)   </param>
...
##  Automatic type </description> </item><item><term> 
## Linear</term><description> 
##  Linear type </description> </item><item><term> 
## Log</term><description> 
##  Log type </description> </item><item><term> 
## Db</term><description> 
##  Db type </description> </item><item><term> 
## Octave</term><description> 
##  Octave type </description> </item><item><term> 
## OneThirdOctave</term><description> 
##  1/3 Octave type </description> </item><item><term> 
## OneTwelfthOctave</term><description> 
##  1/12 Octave type </description> </item></list>
class AxisType(Enum):
    """
...
##  Fill color or contour color with no shading </description> </item><item><term> 
## Hidden</term><description> 
##  Background color as fill </description> </item><item><term> 
## Shaded</term><description> 
##  Fill Color or contour color with shading </description> </item></list>
...
class BasePlotParameters(NXOpen.TransientObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="records"> (@link NXOpen.CAE.FTK.BaseRecord List[NXOpen.CAE.FTK.BaseRecord]@endlink)  Records </param>
...
class BaseTemplateManager(NXOpen.NXObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="template_file"> (str)  Template file name with full path </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="oldTemplateFile"> (str)  old template file with full path </param>
    ## <param name="newTemplateFileName"> (str)  new template file with simple name. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="source_template_file"> (str)  Source template file name with full path </param>
    ## <param name="destination_template_file"> (str)  Destination template file name with full path </param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## MaxAmplitude</term><description> 
##  This function has two calculation results, the first one is Maximum Amplitude value in Y axis, the second is the corresponding X value </description> </item><item><term> 
## MinAmplitude</term><description> 
##  This function has two calculation results, the first one is Minimum Amplitude value in Y axis, the second is the corresponding X value </description> </item><item><term> 
## MaximumRange</term><description> 
## </description> </item><item><term> 
## Rss</term><description> 
## </description> </item><item><term> 
## Rms</term><description> 
## </description> </item><item><term> 
## LinearAveraging</term><description> 
## </description> </item><item><term> 
## IntegratedValue</term><description> 
## </description> </item><item><term> 
## SignalPower</term><description> 
## </description> </item><item><term> 
## Loudness</term><description> 
...
##  Option to display Campbell Plot in Point style </description> </item><item><term> 
## Line</term><description> 
##  Option to display Campbell Plot in Line style </description> </item></list>
...
##  Option to display points with const diameters in Point style</description> </item><item><term> 
## Variable</term><description> 
##  Option to display points with variable diameters correspond to result data in Point style</description> </item></list>
...
class ColorMapGraph(Graph): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="orderValue"> (float)  Order Value </param>
...
class ColorScaleStyle(BaseDisplayStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="overridedValues"> (List[float])  Makes sure overridedValues are in default unit of @link CAE::Xyplot::ColorScaleStyle::MeasureName CAE::Xyplot::ColorScaleStyle::MeasureName@endlink </param>
...
##  Magnitude of the complex data for 2D bar chart plot </description> </item><item><term> 
## Phase</term><description> 
##  Phase of the complex data for 2D bar chart plot </description> </item><item><term> 
## Real</term><description> 
##  Real part of the complex data for 2D bar chart plot </description> </item><item><term> 
## Imaginary</term><description> 
##  Imaginary part of the complex data for 2D bar chart plot </description> </item><item><term> 
## AtPhaseAngle</term><description> 
##  At phase angle for 2D bar chart plot </description> </item><item><term> 
## SignedMagnitude</term><description> 
##  Signed magnitude for 2D bar chart plot </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Magnitude</term><description> 
##  Magnitude of the complex data for 2D color contour plot plot </description> </item><item><term> 
## Phase</term><description> 
##  Phase of the complex data for 2D color contour plot plot </description> </item><item><term> 
## Real</term><description> 
##  Real part of the complex data for 2D color contour plot plot </description> </item><item><term> 
## Imaginary</term><description> 
##  Imaginary part of the complex data for 2D color contour plot plot </description> </item><item><term> 
## AtPhaseAngle</term><description> 
##  At phase angle for 2D color contour plot plot </description> </item><item><term> 
## SignedMagnitude</term><description> 
##  Signed magnitude for 2D color contour plot plot </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Magnitude</term><description> 
##  Magnitude of the complex data for 2D plot </description> </item><item><term> 
## MagnitudePhase</term><description> 
##  Magnitude and phase angle of complex data for 2D plot </description> </item><item><term> 
## Phase</term><description> 
##  Only the phase of the complex data for 2D plot </description> </item><item><term> 
## Real</term><description> 
##  Only the real part of the complex data for 2D plot </description> </item><item><term> 
## RealImaginary</term><description> 
##  Real and imaginary of the complex data for 2D plot </description> </item><item><term> 
## RealImaginaryPhase</term><description> 
##  Real, imaginary and phase angle of the complex data for 2D plot </description> </item><item><term> 
## Polar</term><description> 
##  Polar for 2D plot </description> </item><item><term> 
## Argand</term><description> 
##  Argand for 2D plot </description> </item><item><term> 
## Polar3D</term><description> 
##  Polar for 3D plot </description> </item><item><term> 
## Argand3D</term><description> 
##  Argand for 3D plot which z coordindate come from the x coordinate </description> </item><item><term> 
## PhaseMagnitude</term><description> 
##  Phase angle and Magnitude of complex data for 2D plot </description> </item><item><term> 
## ImaginaryReal</term><description> 
##  Real and imaginary of the complex data for 2D plot </description> </item><item><term> 
## PhaseRealImaginary</term><description> 
##  Phase angle, real and imaginary of the complex data for 2D plot </description> </item><item><term> 
## ImaginaryRealPhase</term><description> 
##  Imaginary, real and phase angle of the complex data for 2D plot </description> </item><item><term> 
## PhaseImaginaryReal</term><description> 
##  Phase angle, imaginary and real of the complex data for 2D plot </description> </item><item><term> 
## Nichols</term><description> 
##  Nichols for 2D plot </description> </item><item><term> 
## AtPhaseAngle</term><description> 
##  At phase angle for 2D plot </description> </item><item><term> 
## SignedMagnitude</term><description> 
##  Signed magnitude for 2D plot </description> </item><item><term> 
## Directivity</term><description> 
##  Directivity for 2D plot </description> </item><item><term> 
## Vector</term><description> 
##  Vector for 2D plot </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Magnitude</term><description> 
##  Magnitude of the complex data for 3D plot </description> </item><item><term> 
## Phase</term><description> 
##  Phase of the complex data for 3D plot </description> </item><item><term> 
## Real</term><description> 
##  Real part of the complex data for 3D plot </description> </item><item><term> 
## Imaginary</term><description> 
##  Imaginary part of the complex data for 3D plot </description> </item><item><term> 
## Argand</term><description> 
##  Argand for 3D plot which use the real z coordindate </description> </item><item><term> 
## Orbit</term><description> 
##  Orbit for 3D plot </description> </item><item><term> 
## Nichols</term><description> 
##  Nichols for 3D plot </description> </item><item><term> 
## AtPhaseAngle</term><description> 
##  At phase angle for 3D plot </description> </item><item><term> 
## SignedMagnitude</term><description> 
##  Signed magnitude for 3D plot </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Magnitude</term><description> 
##  Magnitude of the complex data for matrix 2D plot </description> </item><item><term> 
## Phase</term><description> 
##  Phase of the complex data for matrix 2D plot </description> </item><item><term> 
## Real</term><description> 
##  Real part of the complex data for matrix 2D plot </description> </item><item><term> 
## Imaginary</term><description> 
##  Imaginary part of the complex data for matrix 2D plot </description> </item><item><term> 
## AtPhaseAngle</term><description> 
##  At phase angle for matrix 2D plot </description> </item><item><term> 
## SignedMagnitude</term><description> 
##  Signed magnitude for matrix 2D plot </description> </item></list>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## BorderGrid</term><description> 
##  Option to show contour range on the border of the grid </description> </item><item><term> 
## FullGrid</term><description> 
##  Option to show contour range on the face of the grid </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Xy</term><description> 
##  no swap for 2d </description> </item><item><term> 
## Yx</term><description> 
##  swap x and y </description> </item><item><term> 
## Xyz</term><description> 
##  no swap for 3d</description> </item><item><term> 
## Yxz</term><description> 
##  swap x and y </description> </item><item><term> 
## Zyx</term><description> 
##  swap x and z </description> </item><item><term> 
## Yzx</term><description> 
##  swap x and y firstly and then swap y and z</description> </item><item><term> 
## Xzy</term><description> 
##  swap Z and y </description> </item><item><term> 
## Zxy</term><description> 
##  swap x and y firstly and then swap X and z</description> </item></list>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## Actual</term><description> 
##  Show decimal automatically </description> </item><item><term> 
## X</term><description> 
##  Displays one digit followed by period </description> </item><item><term> 
## Xx</term><description> 
##  Displays two digits followed by period </description> </item><item><term> 
## Xxx</term><description> 
##  Displays three digits followed by period </description> </item><item><term> 
## Xxxx</term><description> 
##  Displays four digits followed by period </description> </item><item><term> 
## Xexx</term><description> 
##  Scientific notation with one digit followed by period,for example: 5.3E+05 </description> </item><item><term> 
## Xxexx</term><description> 
##  Scientific notation with two digits followed by period </description> </item><item><term> 
## Xxxexx</term><description> 
##  Scientific notation with three digits followed by period </description> </item><item><term> 
## Xxxxexx</term><description> 
##  Scientific notation with four digits followed by period </description> </item></list>
...
class DiagramDisplayStyles2DBarChart(DiagramDisplayStyles): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="styleIndex"> (int)  Style index </param>
...
class DiagramDisplayStyles2D(DiagramDisplayStyles): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="styleIndex"> (int)  </param>
...
class DiagramDisplayStyles(BaseDisplayStyleSetting): 
    ...
    ## 
    ## <param name="styleIndex"> (int)  Style index </param>
    ## <param name="graphStyle"> (@link GraphStyle NXOpen.CAE.Xyplot.GraphStyle@endlink)  Graph style </param>
    ...
    ## 
    ## <param name="styleIndex"> (int)  Style index </param>
    ## <param name="graphStyleName"> (str)  Graph style Name</param>
...
## Comment</description> </listheader><item><term> 
## X</term><description> 
##  Option to show plot in the X axis direction </description> </item><item><term> 
## Z</term><description> 
##  Option to show plot in the Z axis direction </description> </item><item><term> 
## Xz</term><description> 
##  Option to show plot in the both X and Z axis direction </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## NotSet</term><description> 
##  Uses the upper or lower color of color limits </description> </item><item><term> 
## Shaded</term><description> 
##  User defined color </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Nx</term><description> 
##  NX Font </description> </item><item><term> 
## Standard</term><description> 
##  Standard Font </description> </item></list>
class Fonttype(Enum):
    """
...
class FormulaExpressionStyle(BaseDisplayStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="variableValues"> (List[float])  Set the variable values </param>
...
##  Mode to follow the synchronization driven by current curve or other curves and axes </description> </item><item><term> 
## UserDefined</term><description> 
##  Mode to change band type of current curve independently </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Octave</term><description> 
##  Octave </description> </item><item><term> 
## OneThirdOctave</term><description> 
##  1/3 Octave </description> </item><item><term> 
## OneTwelfthOctave</term><description> 
##  1/12 Octave </description> </item></list>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## StepLines</term><description> 
##  Step Lines </description> </item><item><term> 
## ConnectCentralFrequencies</term><description> 
##  Connect Central Frequencies </description> </item></list>
...
##  Option to positon name on top left of grid plane     </description> </item><item><term> 
## TopCenter</term><description> 
##  Option to positon name on top center of grid plane   </description> </item><item><term> 
## TopRight</term><description> 
##  Option to positon name on top right of grid plane    </description> </item><item><term> 
## BottomLeft</term><description> 
##  Option to positon name on bottom left of grid plane  </description> </item><item><term> 
## BottomCenter</term><description> 
##  Option to positon name on bottom center of grid plane</description> </item><item><term> 
## BottomRight</term><description> 
##  Option to positon name on bottom right of grid plane </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Line</term><description> 
##  Option to display plot in curve style </description> </item><item><term> 
## Bar</term><description> 
##  Option to display plot in bar style  </description> </item><item><term> 
## Surface</term><description> 
##  Option to display plot in surface style </description> </item><item><term> 
## Scatter</term><description> 
##  Option to display plot in scatter style </description> </item><item><term> 
## ColorBar</term><description> 
##  Option to display plot in ColorBar style </description> </item><item><term> 
## ColorMap</term><description> 
##  Option to display plot in ColorMap style </description> </item><item><term> 
## BarChart</term><description> 
##  Option to display plot in BarChart style </description> </item><item><term> 
## Vector</term><description> 
##  Option to display plot in vector style </description> </item><item><term> 
## Matrix2D</term><description> 
##  Option to display plot in Matrix2D style </description> </item></list>
...
class Graph(BaseModel): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="recordIndex"> (int)  Record index </param>
    ## <param name="attachType"> (@link AnchorType NXOpen.CAE.Xyplot.AnchorType@endlink)  Attachment Type </param>
    ## <param name="absPercentage"> (float)  When attachment type is @link CAE::Xyplot::AnchorTypeAbsPercentage CAE::Xyplot::AnchorTypeAbsPercentage@endlink ,
    ##                                                                          a valid abscissa percentage(between 0 and 1, both 0 and 1 are inclusive) should be given. </param>
    ...
    ## License requirements: None.
    ## <param name="graph"> (@link Graph NXOpen.CAE.Xyplot.Graph@endlink) </param>
    ## <param name="recordIndex"> (int)  Record index </param>
    ## <param name="pointIndex"> (int)  Point index </param>
    @overload
    ...
    ## <param name="graph"> (@link Graph NXOpen.CAE.Xyplot.Graph@endlink) </param>
    ## <param name="recordIndex"> (int)  Record index </param>
    ## <param name="prePointIndex"> (int)  Previous Point index </param>
    ## <param name="nextPointIndex"> (int)  Next Point index </param>
    ## <param name="linearInterpoScale"> (float)  Interpolation Scale </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="startScale"> (float)  the value must be between 0 and 1</param>
    ## <param name="endScale"> (float)  the value must be between 0 and 1</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="xStartScale"> (float)  the value must be between 0 and 1</param>
    ## <param name="xEndScale"> (float)  the value must be between 0 and 1</param>
    ## <param name="yStartScale"> (float)  the value must be between 0 and 1</param>
    ## <param name="yEndScale"> (float)  the value must be between 0 and 1</param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## NoGrid</term><description> 
##  No grid displayed </description> </item><item><term> 
## GridOnly</term><description> 
##  Only display grid </description> </item><item><term> 
## TicksOnly</term><description> 
##  Only display tick </description> </item><item><term> 
## GridAndTicks</term><description> 
##  Display both grid and tick </description> </item><item><term> 
## DenseGrid</term><description> 
##  Display dense grid </description> </item></list>
...
class I3DDataGraph(NXOpen.Object): 
    ...
    ## License requirements: None.
    ## <param name="graph"> (@link I3DDataGraph NXOpen.CAE.Xyplot.I3DDataGraph@endlink) </param>
    ## <param name="recordIndex"> (int)  Record index </param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## Floating</term><description> 
## The position of legend table can be dragged </description> </item><item><term> 
## Docked</term><description> 
##  The position of legend table is fixed  </description> </item></list>
...
class LegendTableStyle(BaseDisplayStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="columnTitles"> (List[str])  column titles</param>
...
class LegendTableTextStyle(TextStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="marginOption"> (@link TextBoxMarginOption NXOpen.CAE.Xyplot.TextBoxMarginOption@endlink) margin option</param>
    ...
    ## 
    ## <param name="marginOption"> (@link TextBoxMarginOption NXOpen.CAE.Xyplot.TextBoxMarginOption@endlink) margin option</param>
    ## <param name="marginValue"> (float)   </param>
...
class LegendTable(BaseModel): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="dataIndex"> (int) the index of record index</param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## FreeLimits</term><description> 
##  Type to use source data limits as axis limits </description> </item><item><term> 
## OptimizedLimits</term><description> 
##  Type to optimize source data limits to natural axis limits </description> </item><item><term> 
## FixedLimits</term><description> 
##  Type to use customized data limits as axis limits </description> </item></list>
...
class MarkerStyleSetting(TextStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="noteTexts"> (List[str])  Note Texts </param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## FillEachCellAsSquare</term><description> 
##  Fill each cell as square </description> </item><item><term> 
## FillAllAvailableDisplayArea</term><description> 
##  Fill all available display area </description> </item></list>
...
##   </description> </item><item><term> 
## Graph</term><description> 
##   </description> </item><item><term> 
## RecordDisplay</term><description> 
##   </description> </item><item><term> 
## Marker</term><description> 
##   </description> </item><item><term> 
## Note</term><description> 
##   </description> </item><item><term> 
## Title</term><description> 
##   </description> </item><item><term> 
## GraphName</term><description> 
##   </description> </item><item><term> 
## FunctionName</term><description> 
##  the lable of a record for @link CAE::Xyplot::PlotTypePlotColorBar CAE::Xyplot::PlotTypePlotColorBar@endlink  </description> </item><item><term> 
## XAxis</term><description> 
##   </description> </item><item><term> 
## XAxisLabel</term><description> 
##   </description> </item><item><term> 
## XAxisNumber</term><description> 
##   </description> </item><item><term> 
## YAxis</term><description> 
##   </description> </item><item><term> 
## YAxisLabel</term><description> 
##   </description> </item><item><term> 
## YAxisNumber</term><description> 
##   </description> </item><item><term> 
## ZAxis</term><description> 
##   </description> </item><item><term> 
## ZAxisLabel</term><description> 
##   </description> </item><item><term> 
## ZAxisNumber</term><description> 
##   </description> </item><item><term> 
## ColorAxis</term><description> 
##  the color indicator for @link CAE::Xyplot::PlotTypePlotColorBar CAE::Xyplot::PlotTypePlotColorBar@endlink  and @link CAE::Xyplot::PlotTypePlotColorMap CAE::Xyplot::PlotTypePlotColorMap@endlink  </description> </item><item><term> 
## ColorAxisLabel</term><description> 
##   </description> </item><item><term> 
## ColorAxisNumber</term><description> 
##   </description> </item><item><term> 
## AngleAxis</term><description> 
##  the axis to display angle divisions on circle grids </description> </item><item><term> 
## AngleAxisNumber</term><description> 
##  the angle axis number </description> </item><item><term> 
## UnknownResult</term><description> 
##  Obsoleted in NX13 </description> </item><item><term> 
## PageNumber</term><description> 
##   </description> </item><item><term> 
## Legend</term><description> 
##   </description> </item><item><term> 
## LegendTable</term><description> 
##   </description> </item><item><term> 
## ResultLegend</term><description> 
##   </description> </item><item><term> 
## FormulaGrid</term><description> 
##   </description> </item><item><term> 
## FormulaGridValueText</term><description> 
##   </description> </item><item><term> 
## CalculationLegendTable</term><description> 
##   </description> </item></list>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## NegativeTwoPiToZero</term><description> 
##  Displays phase between -360 and 0 </description> </item><item><term> 
## ZeroToTwoPi</term><description> 
##  Displays phase between 0 and 360 </description> </item><item><term> 
## NegativePiToPi</term><description> 
##  Displays phase between -180 and 180 </description> </item><item><term> 
## NegativeOneHalfPiToHalfPi</term><description> 
##  Displays phase between -270 and 90 </description> </item><item><term> 
## NegativeHalfPiToOneHalfPi</term><description> 
##  Displays phase between -90 and 270 </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Fill</term><description> 
##  Fill color with no shading </description> </item><item><term> 
## Hidden</term><description> 
##  Background color as fill </description> </item><item><term> 
## Shaded</term><description> 
##  Fill Color with shading </description> </item></list>
...
class PlotGraphTemplate(BaseDisplayStyleSetting): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="strXmlFile"> (str)  Template xml file name </param>
...
##  unknown plot type </description> </item><item><term> 
## Plot2D</term><description> 
##  2D plot </description> </item><item><term> 
## Plot2DInStack</term><description> 
##  2D plot in stacked sequence </description> </item><item><term> 
## Plot3D</term><description> 
##  3D plot </description> </item><item><term> 
## PlotColorBar</term><description> 
##  ColorBar plot </description> </item><item><term> 
## PlotColorMap</term><description> 
##  ColorMap plot </description> </item><item><term> 
## PlotBarChart</term><description> 
##  BarChart plot </description> </item><item><term> 
## PlotMatrix2D</term><description> 
##  Matrix 2D plot </description> </item><item><term> 
## PlotCampbell</term><description> 
##  Campbell plot </description> </item></list>
class PlotType(Enum):
    """
...
class Plot(BaseModel): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="recordIndex"> (int)  The record index starts form 0 to record count -1. Get record count from @link Plot::GetRecordCount Plot::GetRecordCount@endlink  </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="recordIndex"> (int)  the index of specied record </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="recordIndexes"> (List[int])  The index of records to be saved </param>
    ## <param name="recordNames"> (List[str])  The output record names </param>
    ## <param name="outputFileName"> (str)  The destination file with full file name.
    ##                                                                         The file suffix must be ".afu". </param>
    ## <param name="reportError"> (bool) </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="recordIndex"> (List[int])  the indexes of records to be saved </param>
    ## <param name="recordNames"> (List[str]) </param>
    ## <param name="csvFileName"> (str)  the destination CSV file name </param>
    ## <param name="isWriteHeader"> (bool) </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="inputTemplateFile"> (str)  simple name or file name with full path </param>
...
## Comment</description> </listheader><item><term> 
## NotSet</term><description> 
##  No marker </description> </item><item><term> 
## Plus</term><description> 
##  Plus marker </description> </item><item><term> 
## Dot</term><description> 
##  Dot marker </description> </item><item><term> 
## Asterisk</term><description> 
##  Asterisk marker </description> </item><item><term> 
## Circle</term><description> 
##  Circle marker </description> </item><item><term> 
## Poundsign</term><description> 
##  Pound sign marker </description> </item><item><term> 
## Cross</term><description> 
##  Cross marker </description> </item><item><term> 
## Square</term><description> 
##  Square marker </description> </item><item><term> 
## Triangle</term><description> 
##  Triangle marker </description> </item><item><term> 
## Diamond</term><description> 
##  Diamond marker </description> </item><item><term> 
## CenterLine</term><description> 
##  Center line marker </description> </item></list>
...
class Preference(NXOpen.TaggedObject): 
    ...
    ## Comment</description> </listheader><item><term> 
    ## Auto</term><description> 
    ##  Overlay on existing plot, create new plot on non-plot view </description> </item><item><term> 
    ## Plot</term><description> 
    ##  Always create new plot on the dropped view </description> </item><item><term> 
    ## PlotOnNewWindow</term><description> 
    ##  Always create plot on a new grpahics window for all selected data </description> </item><item><term> 
    ## PlotOnMultipleNewWindows</term><description> 
    ##  Create plot on multiple new graphics window, each plot contains a single data </description> </item><item><term> 
    ## MetaKey</term><description> 
    ##  Same to "Auto" if no meta key pressed, Press "ALT" is equivalent to "Plot", 
    ...
    ##  Prompts user to show plot graph on either an existing or a new separate graphic window </description> </item><item><term> 
    ## Always</term><description> 
    ##  Always show plot graph on a new separate graphic window </description> </item></list>
    ...
    ##  Only shows plot graph on main graphic window </description> </item><item><term> 
    ## Separate</term><description> 
    ##  Only shows plot graph on a separate graphic window </description> </item><item><term> 
    ## Both</term><description> 
    ##  Shows plot graph on either main graphic window or a separate graphic window </description> </item></list>
...
class ResultAccessor(NXOpen.TransientObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="graphIndex"> (int)  The graph index starts form 0 to graph count -1. Get graph count from @link ResultAccessor.GraphCount@endlink </param>
    ## <param name="recordIndex"> (int)  The record index starts form 0 to record count -1. Get record count from @link ResultAccessor.RecordCount@endlink </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="graphIndex"> (int)  The graph index starts form 0 to graph count -1. Get graph count from @link ResultAccessor@endlink </param>
    ## <param name="recordIndex"> (int)  The record index starts form 0 to record count -1. Get record count from @link ResultAccessor.RecordCount@endlink </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="graphIdx"> (int)  the index of the graph on this canvas </param>
...
class ResultLegendStyle(BaseDisplayStyleSetting): 
    ...
    ##  Returns the user defined color of overflow result, only available when @link NXOpen::CAE::Xyplot::ResultLegendStyle::OverflowResultColorOption NXOpen::CAE::Xyplot::ResultLegendStyle::OverflowResultColorOption@endlink 
    ...
    ##  Returns the user defined color of overflow result, only available when @link NXOpen::CAE::Xyplot::ResultLegendStyle::UnderflowResultColorOption NXOpen::CAE::Xyplot::ResultLegendStyle::UnderflowResultColorOption@endlink 
    ##             is @link NXOpen::CAE::Xyplot::FlowResultColorShaded NXOpen::CAE::Xyplot::FlowResultColorShaded@endlink   
    ##     
    ##  
    ## Getter License requirements: None.
...
class StackedPlot(Plot): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="plotIndex"> (int)  The plot index starts form 0 to plot count. Get plot count from @link StackedPlot::GetSubplotCount StackedPlot::GetSubplotCount@endlink  </param>
...
## Comment</description> </listheader><item><term> 
## NotSet</term><description> 
##  No shading </description> </item><item><term> 
## Hidden</term><description> 
##  Background color as fill </description> </item><item><term> 
## Shaded</term><description> 
##  Fill Color or contour color with shading </description> </item></list>
...
##  Left align text </description> </item><item><term> 
## Center</term><description> 
##  Center align text </description> </item><item><term> 
## Right</term><description> 
##  Right align text </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## Left</term><description> 
##  The left margin of text box     </description> </item><item><term> 
## Top</term><description> 
##  The top margin of text box     </description> </item><item><term> 
## Right</term><description> 
##  The right margin of text box    </description> </item><item><term> 
## Bottom</term><description> 
##  The bottom margin of text box   </description> </item></list>
...
##  Horizontal text orientation </description> </item><item><term> 
## Upward</term><description> 
##  Upward text orientation </description> </item><item><term> 
## Downward</term><description> 
##  Downward text orientation </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## NotSet</term><description> 
##  Not defined type </description> </item><item><term> 
## Title</term><description> 
##  Title label </description> </item><item><term> 
## Legend</term><description> 
##  Legend label </description> </item><item><term> 
## GraphName</term><description> 
##  Graph name label </description> </item><item><term> 
## PageNumber</term><description> 
##  Page number label </description> </item><item><term> 
## Marker</term><description> 
##  Marker label </description> </item><item><term> 
## Note</term><description> 
##  Note label </description> </item><item><term> 
## ProbingText</term><description> 
##  Probing label </description> </item><item><term> 
## XLabel</term><description> 
##  X Axis name label </description> </item><item><term> 
## YLabel</term><description> 
##  Y Axis name label </description> </item><item><term> 
## ZLabel</term><description> 
##  Z Axis name label </description> </item><item><term> 
## XNumber</term><description> 
##  X Axis number label </description> </item><item><term> 
## YNumber</term><description> 
##  Y Axis number label </description> </item><item><term> 
## ZNumber</term><description> 
##  Z Axis number label </description> </item><item><term> 
## ColorAxisLabel</term><description> 
##  Color Axis name label  </description> </item><item><term> 
## ColorAxisNumber</term><description> 
##  Color Axis name number </description> </item><item><term> 
## UnknownResultText</term><description> 
##  Obsoleted in NX13  </description> </item><item><term> 
## AngleAxisNumber</term><description> 
##  Angle Axis name number </description> </item><item><term> 
## AnnotationText</term><description> 
##  Annotation text in vector plot </description> </item><item><term> 
## ArgumentAxisNumber</term><description> 
##  Argument Axis number label </description> </item><item><term> 
## BarChartValueText</term><description> 
##  Bar Chart Value text </description> </item><item><term> 
## LegendTableText</term><description> 
##  Legend Table text </description> </item><item><term> 
## ResultLegendText</term><description> 
##  Result legend text, including unknown, overflow, underflow result  </description> </item><item><term> 
## FormulaGridValueText</term><description> 
##  Formula Grid Value text </description> </item><item><term> 
## MatrixValueText</term><description> 
##  Matrix Value Text </description> </item></list>
class TextType(Enum):
    """
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## White</term><description> 
##  white </description> </item><item><term> 
## Grey</term><description> 
##  grey </description> </item></list>
...
class VectorStyle2DSetting(BaseLineStyleSetting): 
    ...
    ## 
    ## <param name="index"> (int) </param>
    ## <param name="vectorColors"> (@link NXOpen.NXColor NXOpen.NXColor@endlink)  Set the nth display vector color </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="vectorColors"> (@link NXOpen.NXColor List[NXOpen.NXColor]@endlink)  Set the display vector colors </param>
...
class WallDisplayStyles(NXOpen.TaggedObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="axisDirection"> (@link AxisDirection NXOpen.CAE.Xyplot.AxisDirection@endlink)  Axis direction </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="textType"> (@link TextType NXOpen.CAE.Xyplot.TextType@endlink)  Text type </param>
...
class XYPlotManager(NXOpen.Object): 
    ...
    ## License requirements: None.
    ## <param name="plot"> (@link Plot NXOpen.CAE.Xyplot.Plot@endlink) </param>
    ## <param name="canvasIndex"> (int)  The canvas index whose data you want to access. If unsure, pass 0 </param>
    ...
    ## License requirements: None.
    ## <param name="journalIdentifier"> (str)  Identifier of the @link CAE::Xyplot::Plot CAE::Xyplot::Plot@endlink  to be found </param>
    ...
    ## License requirements: None.
    ## <param name="deviceIndex"> (int)  Device index </param>
    ## <param name="viewIndex"> (int)  View index </param>
    ...
    ## License requirements: None.
    ## <param name="windowDevice"> (int)   Plot index </param>
    ## <param name="view"> (int)   View index </param>
    ...
    ## License requirements: None.
    ## <param name="windowDevice"> (int)   window index  </param>
    ...
    ## License requirements: None.
    ## <param name="overlayParameters"> (@link OverlayParameters NXOpen.CAE.Xyplot.OverlayParameters@endlink)  the overlay parameters </param>
    ...
    ## License requirements: None.
    ## <param name="plotParameters"> (@link PlotParameters NXOpen.CAE.Xyplot.PlotParameters@endlink)  the plot parameters </param>
    ...
    ## <param name="deviceIndex"> (int)  Device index </param>
    ## <param name="viewIndex"> (int)  View index </param>
    ## <param name="isUseWhiteBackGround"> (bool)  </param>
