...
class AlignBeamElementDirectionBuilder(NXOpen.Builder): 
    ...
    ## SeedMesh</term><description> 
    ##  Limits check to only those beam elements in the mesh that contains the Seed Element </description> </item><item><term> 
    ## AllVisible</term><description> 
    ##  Limits check to only those beam elements which are connected to the Seed Element and are currently visible</description> </item><item><term> 
    ## UserSpecified</term><description> 
    ##  Limits check to only those beam elements specified in @link NXOpen::CAE::ModelCheck::AlignBeamElementDirectionBuilder::UserSpecifiedConnectElements NXOpen::CAE::ModelCheck::AlignBeamElementDirectionBuilder::UserSpecifiedConnectElements@endlink  </description> </item></list>
...
class AlignShellElementNormalBuilder(NXOpen.Builder): 
    ...
    ## Comment</description> </listheader><item><term> 
    ## SeedMesh</term><description> 
    ##  Limits check to only those shell elements in the mesh that contains the Seed Element </description> </item><item><term> 
    ## AllVisible</term><description> 
    ##  Limits check to only those shell elements which are connected to the Seed Element and are currently visible</description> </item><item><term> 
    ## UserSpecified</term><description> 
    ##  Limits check to only those shell elements specified in @link NXOpen::CAE::ModelCheck::AlignShellElementNormalBuilder::UserSpecifiedConnectElements NXOpen::CAE::ModelCheck::AlignShellElementNormalBuilder::UserSpecifiedConnectElements@endlink  </description> </item></list>
    class ConnectedElementScope(Enum):
        """
        Members Include: <SeedMesh> <AllVisible> <UserSpecified>
        """
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## Displayed</term><description> 
##  check all displayed elements or nodes </description> </item><item><term> 
## Selected</term><description> 
##  check selected elements or nodes </description> </item></list>
...
class CorrectBeamElementsBuilder(NXOpen.Builder): 
    ...
    ## Comment</description> </listheader><item><term> 
    ## Displayed</term><description> 
    ##  All the displayed elements </description> </item><item><term> 
    ## Selected</term><description> 
    ##  Selected elements </description> </item></list>
    ...
    ## License requirements: nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation")
    ## 
    ## <param name="failedElement"> (@link NXOpen.CAE.FEElement NXOpen.CAE.FEElement@endlink)  element to correct</param>
    ## <param name="nodeToReplace"> (@link NXOpen.CAE.FENode NXOpen.CAE.FENode@endlink) </param>
    ## <param name="replacementNode"> (@link NXOpen.CAE.FENode NXOpen.CAE.FENode@endlink) </param>
    ...
    ## License requirements: nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation")
    ## 
    ## <param name="failedElement"> (@link NXOpen.CAE.FEElement List[NXOpen.CAE.FEElement]@endlink)  elements having dangling nodes</param>
    ...
    ## License requirements: nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation")
    ## 
    ## <param name="failedElement"> (@link NXOpen.CAE.FEElement List[NXOpen.CAE.FEElement]@endlink)  elements to delete</param>
...
class DuplicateElementsCheckBuilder(NXOpen.Builder): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## KeepHighLabel</term><description> 
    ##  Keep the elements with higher labels </description> </item><item><term> 
    ## KeepLowLabel</term><description> 
    ##  Keep the elements with lower labels </description> </item><item><term> 
    ## KeepSelected</term><description> 
    ##  Keep the elements specified in the element list
    ##                                                                                                  @link NXOpen::CAE::ModelCheck::DuplicateElementsCheckBuilder::PreferenceElements NXOpen::CAE::ModelCheck::DuplicateElementsCheckBuilder::PreferenceElements@endlink  </description> </item><item><term> 
    ## RemoveSelected</term><description> 
    ##  Delete the elements specified in the element list
    ##                                                                                                  @link NXOpen::CAE::ModelCheck::DuplicateElementsCheckBuilder::PreferenceElements NXOpen::CAE::ModelCheck::DuplicateElementsCheckBuilder::PreferenceElements@endlink  </description> </item></list>
...
class DuplicateNodesCheckBuilder(NXOpen.Builder): 
    ...
    ##  List all duplicate node pairs found </description> </item><item><term> 
    ## Mergeable</term><description> 
    ##  List the duplicate node pairs mergeable </description> </item><item><term> 
    ## Unmergeable</term><description> 
    ##  List the duplicate node pairs unmergeable </description> </item></list>
    ...
    ##  No preference </description> </item><item><term> 
    ## KeepHighLabel</term><description> 
    ##  Keep the nodes with higher labels </description> </item><item><term> 
    ## KeepLowLabel</term><description> 
    ##  Keep the nodes with lower labels </description> </item><item><term> 
    ## KeepSelected</term><description> 
    ##  Keep the nodes specified in the node list
    ##                                                                                          @link NXOpen::CAE::ModelCheck::DuplicateNodesCheckBuilder::SelectPreferenceNodesList NXOpen::CAE::ModelCheck::DuplicateNodesCheckBuilder::SelectPreferenceNodesList@endlink  </description> </item><item><term> 
    ## RemoveSelected</term><description> 
    ##  Merge the nodes specified in the node list
    ##                                                                                          @link NXOpen::CAE::ModelCheck::DuplicateNodesCheckBuilder::SelectPreferenceNodesList NXOpen::CAE::ModelCheck::DuplicateNodesCheckBuilder::SelectPreferenceNodesList@endlink  </description> </item></list>
...
class ElementEdgeCheckBuilder(NXOpen.Builder): 
    ...
    ##  Takes all elements in the model into account while computing </description> </item><item><term> 
    ## VisibleModel</term><description> 
    ##  Only takes visible elements into account while computing </description> </item><item><term> 
    ## SelectedModels</term><description> 
    ##  Only takes selected elements into account while computing </description> </item></list>
    class Scope(Enum):
        """
...
class ElementMaterialOrientationCheckBuilder(NXOpen.Builder): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## ShowArrowHead</term><description> 
    ##  the arrowheads are shown </description> </item><item><term> 
    ## HideArrowHead</term><description> 
    ##  the arrowheads are hidden </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## SolidAllElements</term><description> 
    ##  all solid elements </description> </item><item><term> 
    ## SolidExteriorElements</term><description> 
    ##  only exterior solid elements </description> </item></list>
    ...
    ##  the material orientation of shell element </description> </item><item><term> 
    ## SolidFirstDirection</term><description> 
    ##  the first  direction of solid element material orientation </description> </item><item><term> 
    ## SolidSecondDirection</term><description> 
    ##  the second direction of solid element material orientation </description> </item><item><term> 
    ## SolidThirdDirection</term><description> 
    ##  the third  direction of solid element material orientation </description> </item></list>
...
class ElementQualityCheckBuilder(NXOpen.Builder): 
    ...
    ## Comment</description> </listheader><item><term> 
    ## NotSet</term><description> 
    ##  Output nothing </description> </item><item><term> 
    ## Failed</term><description> 
    ##  Creates OUTPUT group with failed elements </description> </item><item><term> 
    ## Warning</term><description> 
    ##  Creates OUTPUT group with warning elements </description> </item><item><term> 
    ## FailedAndWarning</term><description> 
    ##  Creates OUTPUT group with both warning and failed elements </description> </item></list>
    ...
    ## Comment</description> </listheader><item><term> 
    ## NotSet</term><description> 
    ##  Does not generate report </description> </item><item><term> 
    ## Worst</term><description> 
    ##  Only lists check results for elements with worst results in the report </description> </item><item><term> 
    ## Failed</term><description> 
    ##  Only lists check results for elements with error results in the report </description> </item><item><term> 
    ## Warning</term><description> 
    ##  Only lists check results for elements with warning results in the report </description> </item><item><term> 
    ## FailedAndWarning</term><description> 
    ##  Lists check results for elements with both error and warning results in the report </description> </item><item><term> 
    ## All</term><description> 
    ##  Lists check results for all elements </description> </item></list>
...
class ElementQualitySettingCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="journalIdentifier"> (str)  </param>
...
class ElementQualitySetting(NXOpen.NXObject): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## WarningAndErrorLimit</term><description> 
    ##  Both warning and error criteria value could be defined  </description> </item><item><term> 
    ## ErrorLimitOnly</term><description> 
    ##  Only error criteria value could be defined </description> </item><item><term> 
    ## ExtendedOptions</term><description> 
    ##  All the criteria values could be defined </description> </item></list>
...
class QualityTestValue(NXOpen.NXObject): 
    ...
    ##  Returns the count of @link NXOpen::CAE::ModelCheck::ElementSpecificTestValue NXOpen::CAE::ModelCheck::ElementSpecificTestValue@endlink  in this test setting   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class TestValueTypes(NXOpen.Object): 
    ...
    ## Comment</description> </listheader><item><term> 
    ## Warning</term><description> 
    ##  reports as warning if the check result failed with the criteria value </description> </item><item><term> 
    ## Error</term><description> 
    ##  reports as error if the check result failed with the criteria value </description> </item><item><term> 
    ## Worst</term><description> 
    ##  reports as worst if the check result failed with the criteria value </description> </item></list>
    ...
    ##  indicates the test value does not violate the criteria values </description> </item><item><term> 
    ## Failed</term><description> 
    ##  indicates the test value violates the error criteria value </description> </item><item><term> 
    ## Exception</term><description> 
    ##  indicates there is an exception thrown during the checking </description> </item><item><term> 
    ## NotApply</term><description> 
    ##  indicates the test is not available or not done for an element  </description> </item><item><term> 
    ## Warned</term><description> 
    ##  indicates the test value violates the warning criteria value </description> </item></list>
    class Result(Enum):
        """
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## JacobianZero</term><description> 
    ##  </description> </item><item><term> 
    ## JacobianRatio</term><description> 
    ##  </description> </item><item><term> 
    ## JacobianSign</term><description> 
    ##  </description> </item><item><term> 
    ## Volume</term><description> 
    ##  </description> </item><item><term> 
    ## AxisymmetricY</term><description> 
    ##  When elements are modeled in XZ plane,
    ##                                                                   check consistent Y.
    ##                                                                   When elements are modeled in XY plane,
    ##                                                                   check consistent Z.</description> </item><item><term> 
    ## AxisymmetricX</term><description> 
    ##  When elements are modeled in XZ plane,
    ##                                                                   check X >= 0.0.
    ##                                                                   When elements are modeled in XY plane,
    ##                                                                   check Y >= 0.0.</description> </item><item><term> 
    ## AspectRatio</term><description> 
    ##  </description> </item><item><term> 
    ## SkewAngle</term><description> 
    ##  </description> </item><item><term> 
    ## InteriorAngleMinimum</term><description> 
    ##  </description> </item><item><term> 
    ## InteriorAngleMaximum</term><description> 
    ##  </description> </item><item><term> 
    ## Taper</term><description> 
    ##  </description> </item><item><term> 
    ## WarpFactor</term><description> 
    ##  </description> </item><item><term> 
    ## FaceWarpCoefficient</term><description> 
    ##  </description> </item><item><term> 
    ## EdgePointLengthRatio</term><description> 
    ##  </description> </item><item><term> 
    ## EdgePointIncludedAngle</term><description> 
    ##  </description> </item><item><term> 
    ## LengthRatioOffset</term><description> 
    ##  </description> </item><item><term> 
    ## ParallelDeviation</term><description> 
    ##  </description> </item><item><term> 
    ## ShapeFactor</term><description> 
    ##  </description> </item><item><term> 
    ## Twist</term><description> 
    ##  </description> </item><item><term> 
    ## LengthMinimum</term><description> 
    ##  </description> </item><item><term> 
    ## LengthMaximum</term><description> 
    ##  </description> </item><item><term> 
    ## TetCollapse</term><description> 
    ##  </description> </item><item><term> 
    ## WarpageAngle</term><description> 
    ##  </description> </item><item><term> 
    ## CohesiveElement</term><description> 
    ##  </description> </item><item><term> 
    ## LaminateTaperRatio</term><description> 
    ##  Ratio of longest edge to shortest edge in
    ##                                                                   stacking direction for the elements
    ##                                                                   that reference PCOMPS entries only.</description> </item><item><term> 
    ## LaminateThicknessRatio</term><description> 
    ##  Ratio of the difference between thickness
    ...
    ## Comment</description> </listheader><item><term> 
    ## NotSet</term><description> 
    ##  indicates no criteria value defined, not necessary to compare the check result with criteria value </description> </item><item><term> 
    ## GreatThan</term><description> 
    ##  the check passes if the check result is great than the criteria value </description> </item><item><term> 
    ## GreatThanOrEqual</term><description> 
    ##  the check passes if the check result is equal or great than the criteria value </description> </item><item><term> 
    ## SmallThan</term><description> 
    ##  the check passes if the check result is small than the criteria value </description> </item><item><term> 
    ## SmallThanOrEqual</term><description> 
    ##  the check passes if the check result is equal or small than the criteria value </description> </item></list>
