...
class AbbContext(NXOpen.NXObject): 
    ...
    ##  ABB call type </description> </item><item><term> 
    ## Method</term><description> 
    ##  Method call type </description> </item></list>
    class CallType(Enum):
        """
    ...
    ## License requirements: None.
    ## 
    ## <param name="indexes"> (List[int])  list of indexes </param>
...
class ABB(NXOpen.Object): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## SimplySupported</term><description> 
    ##  Simply Supported </description> </item><item><term> 
    ## Clamped</term><description> 
    ##  Clamped </description> </item></list>
    ...
    ##  Elastic behaviour </description> </item><item><term> 
    ## ElasticPlastic</term><description> 
    ##  Elastic-plastic behaviour </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## Ssss</term><description> 
    ##  loaded edges: simply supported, unloaded edges: simply supported - simply supported </description> </item><item><term> 
    ## Cscs</term><description> 
    ##  loaded edges: clamped,          unloaded edges: simply supported - simply supported </description> </item><item><term> 
    ## Scsc</term><description> 
    ##  loaded edges: simply supported, unloaded edges: clamped - clamped </description> </item><item><term> 
    ## Cccc</term><description> 
    ##  loaded edges: clamped,          unloaded edges: clamped - clamped </description> </item><item><term> 
    ## Sfss</term><description> 
    ##  loaded edges: simply supported, unloaded edges: free - simply supported </description> </item></list>
    ...
    ##  ABB computation success </description> </item><item><term> 
    ## Failed</term><description> 
    ##  ABB computation failed </description> </item></list>
    class Status(Enum):
        """
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## ClampedClamped</term><description> 
    ##  Clamped-Clamped </description> </item><item><term> 
    ## SimplySupportedClamped</term><description> 
    ##  Simply Supported-Clamped </description> </item><item><term> 
    ## SimplySupportedSimplySupported</term><description> 
    ##  Simply Supported-Simply Supported </description> </item><item><term> 
    ## FreeClamped</term><description> 
    ##  Free-Clamped </description> </item><item><term> 
    ## FreeSimplySupported</term><description> 
    ##  Free-Simply Supported </description> </item></list>
    ...
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="b"> (float)  The shorter panel dimension </param>
    ## <param name="t"> (float)  Panel thickness </param>
    ## <param name="r"> (float)  Panel radius </param>
    ## <param name="nu"> (float)  Material Poisson's ratio </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="a"> (float)  Dimension in longitudinal axis </param>
    ## <param name="b"> (float)  Dimension in radial axis </param>
    ## <param name="t"> (float)  Thickness </param>
    ## <param name="r"> (float)  Radius </param>
    ## <param name="nu"> (float)  Poisson's ratio </param>
    ## <param name="bc"> (@link ABB.EdgeSupportType NXOpen.CAE.AeroStructures.Author.ABB.EdgeSupportType@endlink)  Support along the edges </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iAi"> (List[float])  Areas of sub-sections </param>
    ## <param name="iYcog"> (List[float])  Center of gravity of sub-sections in Y direction </param>
    ## <param name="iEi"> (List[float])  Young's modulus of sub-sections </param>
    ## <param name="iIxxi"> (List[float])  Moments of inertia (Quadratic moments) of sub-sections around XX (expressed at the center of gravity of each sub-section) </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iFcy"> (float)  Compressive yield allowable stress </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="FE"> (int)  Segment's number of free edges </param>
    ## <param name="b"> (float)  Segment's width </param>
    ## <param name="t"> (float)  Segment's thickness </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="a_over_b"> (float)  Panel length ratio </param>
    ## <param name="beta"> (float)  Loading length ratio </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="a"> (float)  Unloaded edge length </param>
    ## <param name="b"> (float)  Loaded edge length </param>
    ## <param name="bc_unloaded"> (@link ABB.UnloadedEdgeSupportType NXOpen.CAE.AeroStructures.Author.ABB.UnloadedEdgeSupportType@endlink)  Support along unloaded edges </param>
    ## <param name="bc_loaded"> (@link ABB.EdgeSupportType NXOpen.CAE.AeroStructures.Author.ABB.EdgeSupportType@endlink)  Support along loaded edges </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="a"> (float)  First plate dimension </param>
    ## <param name="b"> (float)  Second plate dimension </param>
    ## <param name="bc"> (@link ABB.EdgeSupportType NXOpen.CAE.AeroStructures.Author.ABB.EdgeSupportType@endlink)  Support along the edges </param>
    ...
    ## License requirements: None.
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  the ABB context </param>
    ## <param name="load"> (@link NXOpen.GeneralScalarTable NXOpen.GeneralScalarTable@endlink) </param>
    ## <param name="tolerance"> (float) </param>
    ## <param name="nb_loadcases"> (int) </param>
    ...
    ## License requirements: None.
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  the ABB context </param>
    ## <param name="load1"> (@link NXOpen.GeneralScalarTable NXOpen.GeneralScalarTable@endlink)  The first load extraction result</param>
    ## <param name="load2"> (@link NXOpen.GeneralScalarTable NXOpen.GeneralScalarTable@endlink)  The second load extraction result</param>
    ## <param name="tolerance"> (float)  Tolerance</param>
    ## <param name="nb_loadcases"> (int) </param>
    ...
    ## License requirements: None.
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  the ABB context </param>
    ## <param name="inputLoads"> (@link InputLoad List[NXOpen.CAE.AeroStructures.Author.InputLoad]@endlink)  an array of non-aggregated InputLoadParameters </param>
    ...
    ## License requirements: None.
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  the ABB context </param>
    ## <param name="load1"> (@link NXOpen.GeneralScalarTable NXOpen.GeneralScalarTable@endlink) </param>
    ## <param name="load2"> (@link NXOpen.GeneralScalarTable NXOpen.GeneralScalarTable@endlink) </param>
    ## <param name="tolerance_1"> (float) </param>
    ## <param name="tolerance_2"> (float) </param>
    ## <param name="nb_loadcases"> (int) </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="P"> (List[float])  Load acting on fitting (nblc) </param>
    ## <param name="iPsn"> (List[float])  Allowable shear strength of bolt (nbbolt) </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iFtyL"> (float)  Tensile yield stress, longitudinal direction </param>
    ## <param name="iFtyLT"> (float)  Tensile yield stress, long transverse direction </param>
    ## <param name="iFcyL"> (float)  Compressive yield stress, longitudinal direction </param>
    ## <param name="iFcyLT"> (float)  Compressive yield stress, long transverse direction </param>
    ## <param name="iFsu"> (float)  Shear ultimate stress </param>
    ## <param name="iFtuL"> (float)  Tensile ultimate stress, longitudinal direction </param>
    ## <param name="iFtuLT"> (float)  Tensile ultimate stress, long transverse direction </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="X"> (float)  Critical buckling stress (elastic) / secant yield stress F0.7 </param>
    ## <param name="n"> (float)  Ramberg-Osgood parameter </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="allowable"> (float)  Manual input </param>
    ## <param name="value"> (List[float])  Value coming from load extractor </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="D"> (float)  Diameter </param>
    ## <param name="t"> (float)  Thickness </param>
    ## <param name="iFbr"> (float)  Bearing stress allowable </param>
    ## <param name="f"> (float)  Load factor </param>
    ## <param name="P"> (List[float])  Shear load </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="b"> (float)  Arm </param>
    ## <param name="iMba"> (float)  Bending moment allowable of bolt </param>
    ## <param name="f"> (float)  Load factor </param>
    ## <param name="P"> (List[float])  Shear load </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iPtx"> (float)  Tensile load allowable </param>
    ## <param name="iPss"> (float)  Single shear load allowable </param>
    ## <param name="iPx"> (List[float])  Tensile load </param>
    ## <param name="f"> (float)  Load factor </param>
    ## <param name="P"> (List[float])  Shear load </param>
    ...
    ## <param name="iPtx"> (float)  Tensile load allowable </param>
    ## <param name="iPss"> (float)  Single shear load allowable </param>
    ## <param name="fb"> (float)  Bending load factor </param>
    ## <param name="iPb"> (List[float])  Bending load </param>
    ## <param name="iPx"> (List[float])  Tensile load </param>
    ## <param name="fs"> (float)  Shear load factor </param>
    ## <param name="iPs"> (List[float])  Shear load </param>
    ...
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iPss"> (float)  Single shear load allowable </param>
    ## <param name="f"> (float)  Shear load factor </param>
    ## <param name="P"> (List[float])  Shear load </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="A"> (float)  Area of the cross section </param>
    ## <param name="L"> (float)  Column length </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="I"> (float)  Bending inertia of the column </param>
    ## <param name="sigmacr"> (float)  Material stress allowable </param>
    ## <param name="C"> (float)  End fixity coefficient depending on the Boundary Condition given at both extremities </param>
    ## <param name="ecc"> (float)  Eccentricity of the load </param>
    ## <param name="extrmfbrdist"> (float)  Distance from neutral axis to extreme fiber </param>
    ## <param name="sigma"> (List[float])  Applied stress </param>
    ...
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="I"> (float)  Bending inertia of the column </param>
    ## <param name="n"> (float)  Ramberg-Ossgood coefficient </param>
    ## <param name="iFy"> (float)  Yield stress allowable </param>
    ## <param name="C"> (float)  End fixity coefficient depending on the Boundary Condition given at both extremities </param>
    ## <param name="sigma"> (List[float])  Stress </param>
    ...
    ## <param name="I"> (float)  Bending inertia of the column </param>
    ## <param name="C"> (float)  End fixity coefficient depending on the Boundary Condition given at both extremities </param>
    ## <param name="sigma"> (List[float])  Axial compressive stress </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="A"> (float)  Column cross section area </param>
    ## <param name="L"> (float)  Column length </param>
    ## <param name="I"> (float)  Bending inertia of the column </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="C"> (float)  End fixity coefficient depending on the Boundary Condition given at both extremities </param>
    ## <param name="sigma0"> (float)  Column stress allowable for a column slenderness equals to 0 </param>
    ## <param name="sigma"> (List[float])  Axial compressive stress </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="L"> (float)  Column effective length </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="G"> (float)  Shear modulus of elasticity </param>
    ## <param name="J"> (float)  Torsion constant of the section </param>
    ## <param name="gamma"> (float)  Warping constant of the section </param>
    ## <param name="r0"> (float)  Polar radius of gyration of the section about its shear center </param>
    ## <param name="C"> (float)  End fixity coefficient depending on the Boundary Condition given at both extremities </param>
    ## <param name="load"> (List[float])  Axial compressive load </param>
    ...
    ## <param name="b"> (float)  Loaded edge length  </param>
    ## <param name="a"> (float)  Unloaded edge length </param>
    ## <param name="bc"> (@link ABB.PlaneStressBoundaryConditions NXOpen.CAE.AeroStructures.Author.ABB.PlaneStressBoundaryConditions@endlink)  Edges Boundary Conditions </param>
    ## <param name="laminate"> (@link NXOpen.CAE.AeroStructures.Laminate NXOpen.CAE.AeroStructures.Laminate@endlink)  Laminate </param>
    ## <param name="sigma"> (List[float])  Compressive stresses </param>
    ...
    ## <param name="laminate"> (@link NXOpen.CAE.AeroStructures.Laminate NXOpen.CAE.AeroStructures.Laminate@endlink)  Laminate </param>
    ## <param name="sigma"> (List[float])  Compressive stresses </param>
    ## <param name="tau"> (List[float])  Shear stresses </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="b"> (float)  First edge length  </param>
    ## <param name="a"> (float)  Second edge length </param>
    ## <param name="bc"> (@link ABB.PlaneStressBoundaryConditions NXOpen.CAE.AeroStructures.Author.ABB.PlaneStressBoundaryConditions@endlink)  Edges Boundary Conditions </param>
    ## <param name="laminate"> (@link NXOpen.CAE.AeroStructures.Laminate NXOpen.CAE.AeroStructures.Laminate@endlink)  Laminate </param>
    ## <param name="tau"> (List[float])  Shear stresses </param>
    ...
    ## License requirements: nx_masterfem ("Finite Element Modeling")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="t"> (float)  Sheet thickness </param>
    ## <param name="p"> (float)  Rivet spacing </param>
    ## <param name="behaviour"> (@link ABB.MaterialBehaviour NXOpen.CAE.AeroStructures.Author.ABB.MaterialBehaviour@endlink)  Material behaviour </param>
    ## <param name="E"> (float)  Young's Modulus </param>
    ## <param name="iFy"> (float)  Compressive yield stress </param>
    ## <param name="n"> (float)  Ramberg-Osgood coefficient </param>
    ## <param name="C"> (float)  End fixity coefficient </param>
    ## <param name="sigma"> (List[float])  Stress </param>
    ...
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="t"> (float)  Sheet thickness </param>
    ## <param name="p"> (float)  Rivet pitch </param>
    ## <param name="behaviour"> (@link ABB.MaterialBehaviour NXOpen.CAE.AeroStructures.Author.ABB.MaterialBehaviour@endlink)  Material behaviour </param>
    ## <param name="E"> (float)  Young's Modulus </param>
    ## <param name="nu"> (float)  Elastic Poisson's ratio </param>
    ## <param name="n"> (float)  Ramberg-Osgood coefficient </param>
    ## <param name="iFy"> (float)  Yield stress Allowable </param>
    ## <param name="C"> (float)  End fixity coefficient </param>
    ## <param name="sigma"> (List[float])  Stress </param>
    ...
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="D"> (float)  Diameter </param>
    ## <param name="b"> (float)  Width </param>
    ## <param name="t"> (float)  Thickness </param>
    ## <param name="iFx"> (float)  Material stress allowable </param>
    ## <param name="f"> (float)  Load factor </param>
    ## <param name="P"> (List[float])  Axial load </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="b"> (float)  Panel dimension </param>
    ## <param name="t"> (float)  Panel thickness </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="nu"> (float)  Elastic Poisson's ratio </param>
    ## <param name="eta"> (float)  Plasticity reduction factor </param>
    ## <param name="k"> (float)  Buckling coefficient </param>
    ## <param name="sigma"> (List[float])  Compressive stress </param>
    ...
    ## <param name="b"> (float)  Loaded edge length </param>
    ## <param name="a"> (float)  Unloaded edge length </param>
    ## <param name="t"> (float)  Panel's thickness </param>
    ## <param name="r"> (float)  Panel's curvature radius </param>
    ## <param name="behaviour"> (@link ABB.MaterialBehaviour NXOpen.CAE.AeroStructures.Author.ABB.MaterialBehaviour@endlink)  Material behaviour </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="nu"> (float)  Elastic Poisson's ratio </param>
    ## <param name="n"> (float)  Ramberg-Osgood parameter </param>
    ...
    ## <param name="iFy"> (float)  Yield stress Allowable </param>
    ## <param name="sigma"> (List[float])  Compressive stress </param>
    ## <param name="tau"> (List[float])  Shear stress </param>
    ...
    ## <param name="iFy"> (float)  Yield stress Allowable </param>
    ## <param name="beta"> (float)  Loading length ratio </param>
    ## <param name="sigma1"> (List[float])  Compressive stress, side 1 </param>
    ## <param name="sigma2"> (List[float])  Compressive stress, side 2 </param>
    ...
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="D"> (float)  Diameter </param>
    ## <param name="b"> (float)  Edge distance </param>
    ## <param name="t"> (float)  Thickness </param>
    ## <param name="iFs"> (float)  Material shear stress allowable  </param>
    ## <param name="f"> (float)  Load factor </param>
    ## <param name="P"> (List[float])  Axial load </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iSTresca"> (float)  Tresca equivalent stress allowable  </param>
    ## <param name="iFx"> (List[float])  Normal stress, X direction </param>
    ## <param name="iFy"> (List[float])  Normal stress, Y direction </param>
    ## <param name="iFxy"> (List[float])  Shear stress </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="iXt"> (float)  Longitudinal Tensile Strength </param>
    ## <param name="iXc"> (float)  Longitudinal Compressive Strength </param>
    ## <param name="iYt"> (float)  Transverse Tensile Strength </param>
    ## <param name="iYc"> (float)  Transverse Compressive Strength </param>
    ## <param name="S"> (float)  In-plane Shear Strength </param>
    ## <param name="sigma1"> (List[float])  Longitudinal stresses </param>
    ## <param name="sigma2"> (List[float])  Transverse stresses </param>
    ## <param name="tau"> (List[float])  Shear stresses </param>
    ...
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="n"> (float)  Ramberg-Osgood parameter </param>
    ## <param name="fy"> (float)  Yield stress </param>
    ## <param name="sigma"> (float)  Stress </param>
    ...
    ## <param name="iFy"> (float)  Yield stress allowable</param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="n"> (float)  Ramberg-Osgood's parameter </param>
    ...
    ## License requirements: sc_margin_safety ("Simcenter Margin Of Safety")
    ## <param name="abbContext"> (@link AbbContext NXOpen.CAE.AeroStructures.Author.AbbContext@endlink)  The ABB context </param>
    ## <param name="strain"> (float)  Total strain </param>
    ## <param name="E"> (float)  Young's modulus </param>
    ## <param name="iF02ys"> (float)  Yield allowable (typically Fcy) </param>
    ## <param name="n"> (float)  Ramberg-Osgood's parameter </param>
...
class CalculationContext(NXOpen.NXObject): 
    ...
    ##  Metric Unit System </description> </item><item><term> 
    ## English</term><description> 
    ##  SI Unit System </description> </item><item><term> 
    ## Si</term><description> 
    ##  English Unit System </description> </item><item><term> 
    ## Unknown</term><description> 
    ##  Unknown Unit System </description> </item></list>
    ...
    ## License requirements: None.
    ## <param name="context"> (@link CalculationContext NXOpen.CAE.AeroStructures.Author.CalculationContext@endlink) </param>
    ## <param name="message"> (str)  an error message </param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="context"> (@link CalculationContext NXOpen.CAE.AeroStructures.Author.CalculationContext@endlink) </param>
    ## <param name="failureMode"> (str)  a failure mode name (an empty string indicates that the message is not failure mode specific)</param>
    ## <param name="lcIndex"> (int)  load case index corresponding to the load case position in the load case array of the calculation context starting from 0 (-1 means that the message is not load case specific) </param>
    ## <param name="message"> (str)  an error message</param>
    @overload
    ...
    ## <param name="context"> (@link CalculationContext NXOpen.CAE.AeroStructures.Author.CalculationContext@endlink) </param>
    ## <param name="failureMode"> (str)  a failure mode name (an empty string indicates that the message is not failure mode specific)</param>
    ## <param name="loadCase"> (str)  a load case name (an empty string indicates that the message is not load case specific)</param>
    ## <param name="message"> (str)  an error message </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="measure_name"> (str)  the input measure name </param>
    ...
    ## 
    ## <param name="measure_name"> (str)  the input measure name </param>
    ## <param name="unit_symbol"> (str)  the input unit name </param>
    ...
    ## License requirements: None.
    ## <param name="context"> (@link CalculationContext NXOpen.CAE.AeroStructures.Author.CalculationContext@endlink) </param>
    ## <param name="message"> (str)  an info message </param>
    @overload
    ...
    ## 
    ## <param name="lcIndex"> (int)  load case index corresponding to the load case position in the load case array of the calculation context starting from 0 (-1 means that the message is not load case specific) </param>
    ## <param name="selected"> (bool)  boolean for load case selection (or not) </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="lcIndexes"> (List[int])  list of indexes for selected load cases </param>
    ...
    ## License requirements: None.
    ## <param name="context"> (@link CalculationContext NXOpen.CAE.AeroStructures.Author.CalculationContext@endlink) </param>
    ## <param name="message"> (str)  a warning message </param>
    @overload
...
class InputLoad(InputParameter): 
    ...
    ##  Not available (the aggregation has been done at the calculation level, Values/GetValues() will return a vector of aggregated values) </description> </item><item><term> 
    ## Node</term><description> 
    ##  Node (the method has aggregated values that have been extracted per node, Values/GetValues() will return a table of values) </description> </item><item><term> 
    ## Element</term><description> 
    ##  Element (the method has aggregated values that have been extracted per element, Values/GetValues() will return a table of values) </description> </item></list>
    ...
    ## License requirements: None.
    ## <param name="param"> (@link InputLoad NXOpen.CAE.AeroStructures.Author.InputLoad@endlink) </param>
    ## <param name="unit_type"> (@link NXOpen.Unit NXOpen.Unit@endlink)  the unit in which the value must be converted if necessary</param>
    @overload
...
class MethodLibrary(NXOpen.Object): 
    ...
    ## License requirements: None.
    ## <param name="methodID"> (str)  must match 'id' field in method descriptor </param>
    ## <param name="version"> (int)  version number - currently must be 1 </param>
    ## <param name="cb"> (@link MethodLibrary.Callback NXOpen.CAE.AeroStructures.Author.MethodLibrary.Callback@endlink)  routine to register </param>
    ...
    ## <param name="methodID"> (str)  must match 'id' field in method descriptor </param>
    ## <param name="version"> (int)  version number - currently must be 1 </param>
    ## <param name="cb"> (@link MethodLibrary.CallbackMulti NXOpen.CAE.AeroStructures.Author.MethodLibrary.CallbackMulti@endlink)  routine to register </param>
    ...
    ## <param name="methodID"> (str)  must match 'id' field in method descriptor </param>
    ## <param name="version"> (int)  version number - currently must be 1 </param>
    ## <param name="cb"> (@link MethodLibrary.CallbackPost NXOpen.CAE.AeroStructures.Author.MethodLibrary.CallbackPost@endlink)  routine to register </param>
...
class OutputBoolean(OutputParameter): 
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputBoolean NXOpen.CAE.AeroStructures.Author.OutputBoolean@endlink) </param>
    ## <param name="boolVal"> (bool)  </param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputBoolean NXOpen.CAE.AeroStructures.Author.OutputBoolean@endlink) </param>
    ## <param name="fmName"> (str)  failure mode name </param>
    ## <param name="boolVal"> (bool)  </param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputBoolean NXOpen.CAE.AeroStructures.Author.OutputBoolean@endlink) </param>
    ## <param name="fmName"> (str)  failure mode name, if empty the value will be set for any failure mode </param>
    ## <param name="lcIndex"> (int)  load case index corresponding to the load case position in the load case array of the calculation context</param>
    ## <param name="boolVal"> (bool)  </param>
    @overload
...
class OutputFile(OutputParameter): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="pathVal"> (str)  the directory used</param>
...
class OutputInteger(OutputParameter): 
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputInteger NXOpen.CAE.AeroStructures.Author.OutputInteger@endlink) </param>
    ## <param name="intVal"> (int)  </param>
    @overload
...
class OutputScalar(OutputParameter): 
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputScalar NXOpen.CAE.AeroStructures.Author.OutputScalar@endlink) </param>
    ## <param name="doubleVal"> (float)  the double value of the parameter</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputScalar NXOpen.CAE.AeroStructures.Author.OutputScalar@endlink) </param>
    ## <param name="doubleVal"> (float)  the double value of the parameter expressed in the specified unit</param>
    ## <param name="unit_type"> (@link NXOpen.Unit NXOpen.Unit@endlink)  the unit in which the value must be converted if necessary</param>
    @overload
...
class OutputText(OutputParameter): 
    ...
    ## License requirements: None.
    ## <param name="param"> (@link OutputText NXOpen.CAE.AeroStructures.Author.OutputText@endlink) </param>
    ## <param name="textVal"> (str)  </param>
    @overload
