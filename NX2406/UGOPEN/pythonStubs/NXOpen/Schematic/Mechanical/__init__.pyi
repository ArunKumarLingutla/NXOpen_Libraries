...
class RunCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="run"> (@link Run NXOpen.Schematic.Mechanical.Run@endlink)  @link Schematic::Mechanical::Run Schematic::Mechanical::Run@endlink  to be edited, if NULL then create a new one </param>
