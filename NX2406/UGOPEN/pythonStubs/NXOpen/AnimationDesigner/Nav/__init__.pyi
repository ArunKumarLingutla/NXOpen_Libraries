...
class ContainerCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## <param name="name"> (str)  The name of the @link  NXOpen::AnimationDesigner::Nav::Container   NXOpen::AnimationDesigner::Nav::Container @endlink . </param>
...
class SolutionCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_animationdesigner (" NX Animation Designer")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink) </param>
    ## <param name="name"> (str)  The name of the @link  NXOpen::AnimationDesigner::Nav::Solution   NXOpen::AnimationDesigner::Nav::Solution @endlink . </param>
...
class SubFolderCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_animationdesigner (" NX Animation Designer")
    ## <param name="part"> (@link NXOpen.Part NXOpen.Part@endlink) </param>
    ## <param name="name"> (str)  The name of the @link  NXOpen::AnimationDesigner::Nav::SubFolder   NXOpen::AnimationDesigner::Nav::SubFolder @endlink . </param>
