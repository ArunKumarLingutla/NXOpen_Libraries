...
class MeasurementOperationBuilder(NXOpen.Builder): 
    ...
    ## </description> </item><item><term> 
    ## MinimumVirtualClearance</term><description> 
    ## </description> </item><item><term> 
    ## MinimumFeatureClearance</term><description> 
    ## </description> </item><item><term> 
    ## VirtualHoleDiameter</term><description> 
    ## </description> </item></list>
    class APIEnumMeasurementType(Enum):
        """
        Members Include: <Angle> <GapFlush> <PointToPoint> <PointToLine> <Point> <MinimumVirtualClearance> <MinimumFeatureClearance> <VirtualHoleDiameter>
        """
        Angle: int
        GapFlush: int
        PointToPoint: int
