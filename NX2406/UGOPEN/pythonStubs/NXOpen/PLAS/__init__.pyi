...
class PlasManager(NXOpen.Object): 
    ...
    ## 
    ## <param name="run"> (@link Run NXOpen.PLAS.Run@endlink)  @link PLAS::ControlLoop PLAS::ControlLoop@endlink  to be edited, if NULL then create a new one </param>
    ...
    ## 
    ## <param name="run"> (@link Run NXOpen.PLAS.Run@endlink)  @link PLAS::Run PLAS::Run@endlink  to be edited, if NULL then create a new one </param>
