...
class BoltedConnectionBuilder(FeatureParmsBuilder): 
    ...
    ##  The connection sub type of two connected members with bolted plate attached to one member end. </description> </item><item><term> 
    ## LPlate</term><description> 
    ##  The connection sub type of two othogonal connected members with L shape bolted plate attached. </description> </item><item><term> 
    ## FlatPlate</term><description> 
    ##  The connection sub type of two othogonal connected members with flate shape bolted plate attached. </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## Splice</term><description> 
    ##  The splice connection type. </description> </item><item><term> 
    ## BeamColumn</term><description> 
    ##  The beam column connection type. </description> </item><item><term> 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## CornerPlate</term><description> 
    ##  The connection sub type of two othogonal members connect with diagonal member at the corner with bolted plate. </description> </item><item><term> 
    ## FlatPlate</term><description> 
    ##  The connection sub type of one member connect with mulit diagonal members with bolted plate. </description> </item><item><term> 
    ## LappedPlate</term><description> 
    ##  The connection sub type of one member connect with mulit diagonal members with bolted plate lapped. </description> </item></list>
    ...
    ## Comment</description> </listheader><item><term> 
    ## End</term><description> 
    ##  The connection sub type of two splice connected members with bolted plate attached between the two member end. </description> </item><item><term> 
    ## Flange</term><description> 
    ##  The connection sub type of two splice connected members with bolted plate attached to flange faces. </description> </item><item><term> 
    ## Web</term><description> 
    ##  The connection sub type of two splice connected members with bolted plate attached to web faces. </description> </item></list>
...
class EditCornerBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ## <param name="tRefObj"> (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink)  face or plane</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="body"> (@link NXOpen.Body NXOpen.Body@endlink)  Member's body in which to create a corner for, and also for adjacent corners. </param>
    ## <param name="endPoint"> (@link NXOpen.Point3d NXOpen.Point3d@endlink)  Point at end of input body indicated which end to edit the corner. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="corners"> (@link CornerNodeBuilder List[NXOpen.Features.StructureDesign.CornerNodeBuilder]@endlink)  The corners being processed. </param>
    ...
    ## License requirements: nx_structure_design ("Structure Designer")
    ## 
    ## <param name="corner"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  The corner being processed. </param>
...
class EditStockBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ##  The settings to define the align member selection type when rotating the member. 
    ## <list type="table"> 
    ## <listheader><term> 
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ...
    ## </description> </item><item><term> 
    ## CurveEdge</term><description> 
    ## </description> </item></list>
    class AlignMemberSelectionType(Enum):
        """
        Members Include: <FacePlane> <CurveEdge>
        """
        FacePlane: int
        CurveEdge: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) MemberCurveEdge
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) MemberFacePlane
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) ReferenceCurveEdge
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) ReferenceFacePlane
    ...
    ## Getter for property: (@link EditStockBuilder.AlignMemberSelectionType NXOpen.Features.StructureDesign.EditStockBuilder.AlignMemberSelectionType@endlink) SelectionType
    ...
    ## @return EditStockBuilder.AlignMemberSelectionType
    @property
    ...
    ## Setter for property: (@link EditStockBuilder.AlignMemberSelectionType NXOpen.Features.StructureDesign.EditStockBuilder.AlignMemberSelectionType@endlink) SelectionType
...
class ExportDSTVBuilder(NXOpen.Builder): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## CreateNew</term><description> 
    ##  Creating dataset action type. </description> </item><item><term> 
    ## OverwriteExisting</term><description> 
    ##  Overwriting dataset action type. </description> </item><item><term> 
    ## ExportToFolder</term><description> 
    ##  Exporting to folder action type. </description> </item></list>
...
class ExtendMemberBuilder(NXOpen.Features.FeatureBuilder): 
    """
        Represents a <ja_class>Features.StructureDesign.ExtendMember</ja_class> builder
        """
    ...
    ## Getter for property: (@link NXOpen.SelectNXObject NXOpen.SelectNXObject@endlink) SelectBoundary
    ...
    ## Getter for property: (@link NXOpen.SelectNXObjectList NXOpen.SelectNXObjectList@endlink) SelectEndFaces
...
class HandrailBuilder(NXOpen.Features.FeatureBuilder): 
    """
    Represents a <ja_class>Features.StructureDesign.Handrail</ja_class> builder
    """
    ...
    ## Comment</description> </listheader><item><term> 
    ## NotSet</term><description> 
    ##  leave it as it is </description> </item><item><term> 
    ## Bend</term><description> 
    ##  bend the corner </description> </item></list>
    class CornerTypes(Enum):
        """
        Members Include: <NotSet> <Bend>
        """
        NotSet: int
        Bend: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ##  create linear type handrail </description> </item><item><term> 
    ## Curved</term><description> 
    ##  create curved type handrail </description> </item></list>
    class HandrailTypes(Enum):
        """
        Members Include: <Linear> <Curved>
        """
        Linear: int
        Curved: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ##  Place stanchions by stanchion gap </description> </item><item><term> 
    ## Datum</term><description> 
    ##  Place stanchions on the intersection of datum and curve </description> </item></list>
    class StanchionPositionTypes(Enum):
        """
        Members Include: <Gap> <Datum>
        """
        Gap: int
        Datum: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) CornerRadius
    ...
    ## Getter for property: (@link HandrailBuilder.CornerTypes NXOpen.Features.StructureDesign.HandrailBuilder.CornerTypes@endlink) CornerType
    ...
    ## @return HandrailBuilder.CornerTypes
    @property
    ...
    ## Setter for property: (@link HandrailBuilder.CornerTypes NXOpen.Features.StructureDesign.HandrailBuilder.CornerTypes@endlink) CornerType
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) DatumOffset
    ...
    ## Getter for property: (@link HandrailBuilder.HandrailTypes NXOpen.Features.StructureDesign.HandrailBuilder.HandrailTypes@endlink) HandrailType
    ...
    ## @return HandrailBuilder.HandrailTypes
    @property
    ...
    ## Setter for property: (@link HandrailBuilder.HandrailTypes NXOpen.Features.StructureDesign.HandrailBuilder.HandrailTypes@endlink) HandrailType
    ...
    ## Getter for property: (@link NXOpen.SelectTaggedObjectList NXOpen.SelectTaggedObjectList@endlink) PlaceDatums
    ...
    ## Getter for property: (@link NXOpen.Section NXOpen.Section@endlink) SelectedCurves
    ...
    ## Getter for property: (@link HandrailBuilder.StanchionPositionTypes NXOpen.Features.StructureDesign.HandrailBuilder.StanchionPositionTypes@endlink) StanchionPositionType
    ...
    ## @return HandrailBuilder.StanchionPositionTypes
    @property
    ...
    ## Setter for property: (@link HandrailBuilder.StanchionPositionTypes NXOpen.Features.StructureDesign.HandrailBuilder.StanchionPositionTypes@endlink) StanchionPositionType
    ...
    ## Getter for property: (@link NXOpen.Point3d NXOpen.Point3d@endlink) StartPointOnLoop
    ...
    ## Setter for property: (@link NXOpen.Point3d NXOpen.Point3d@endlink) StartPointOnLoop
    ...
    ## Getter for property: (@link NXOpen.GeometricUtilities.OnPathDimensionBuilder NXOpen.GeometricUtilities.OnPathDimensionBuilder@endlink) StartPointOnLoopDim
    ##  Returns the start point on loop.  
    ##      
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link HandrailYOffsetBuilder NXOpen.Features.StructureDesign.HandrailYOffsetBuilder@endlink) YOffset
...
class HandrailYOffsetBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link HandrailYOffsetListItemBuilderList NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilderList@endlink) YOffsetList
    ##  Returns the handrail y offset list   
    ##     
    ##  
    ## Getter License requirements: nx_structure_design ("Structure Designer")
    ## 
    ##   <br>  Created in NX2406.0.0  <br> 

    ## @return HandrailYOffsetListItemBuilderList
    @property
    ...
    ##  @return yOffsetListItemBuilder (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink): .
    ## 
    ##   <br>  Created in NX2406.0.0  <br> 
...
class HandrailYOffsetListItemBuilderList(NXOpen.TaggedObject): 
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link HandrailYOffsetListItemBuilderList NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilderList@endlink) </param>
    ## <param name="objects"> (@link HandrailYOffsetListItemBuilder List[NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder]@endlink)  items to append </param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link HandrailYOffsetListItemBuilderList NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilderList@endlink) </param>
    ## <param name="objectValue"> (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink)  item to append </param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link HandrailYOffsetListItemBuilderList NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilderList@endlink) </param>
    ## <param name="obj"> (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink)  object to be removed from the list </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="obj"> (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink)  Object to find index for </param>
    ...
    ##     
    ##  @return obj (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink):  object found at input index .
    ## 
    ##   <br>  Created in NX4.0.0  <br> 
    ...
    ##  @return objects (@link HandrailYOffsetListItemBuilder List[NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder]@endlink):  The list contents .
    ## 
    ##   <br>  Created in NX5.0.0  <br> 
    ...
    ## <param name="objectValue"> (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink)  object to be inserted </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link HandrailYOffsetListItemBuilder List[NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder]@endlink)  The list contents </param>
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link HandrailYOffsetListItemBuilderList NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilderList@endlink) </param>
    ## <param name="object1"> (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink)  first item </param>
    ## <param name="object2"> (@link HandrailYOffsetListItemBuilder NXOpen.Features.StructureDesign.HandrailYOffsetListItemBuilder@endlink)  second item </param>
    @overload
...
class HandrailYOffsetListItemBuilder(NXOpen.TaggedObject): 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) XOffsetDimension
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) YOffsetDimension
...
import NXOpen.Features
##  Represents a handrail feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::StructureDesign::HandrailBuilder  NXOpen::Features::StructureDesign::HandrailBuilder @endlink  <br> 
## 
##   <br>  Created in NX2406.0.0  <br> 
...
class MemberBuilder(FeatureParmsBuilder): 
    ...
    ## Getter for property: (@link MemberBuilder.AlignMemberSelectionType NXOpen.Features.StructureDesign.MemberBuilder.AlignMemberSelectionType@endlink) SelectionType
    ##  Returns the selection type   
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## @return MemberBuilder.AlignMemberSelectionType
    @property
    ...
    ## Setter for property: (@link MemberBuilder.AlignMemberSelectionType NXOpen.Features.StructureDesign.MemberBuilder.AlignMemberSelectionType@endlink) SelectionType
...
class PadBuilder(NXOpen.Features.FeatureBuilder): 
    """
    Represents a <ja_class>Features.StructureDesign.Pad</ja_class> builder
    """
    ...
    class PositionTypes(Enum):
        """
        Members Include: <Center> <AlignToEdge>
        """
        Center: int
        AlignToEdge: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## AttachToEnd</term><description> 
    ## </description> </item><item><term> 
    ## TrimBack</term><description> 
    ## </description> </item><item><term> 
    ## TrimHalfThickness</term><description> 
    ## </description> </item></list>
    class ThicknessDirections(Enum):
        """
        Members Include: <AttachToEnd> <TrimBack> <TrimHalfThickness>
        """
        AttachToEnd: int
        TrimBack: int
    ...
    ## Getter for property: (@link NXOpen.SelectNXObjectList NXOpen.SelectNXObjectList@endlink) MemberEndFace
    ...
    ## Getter for property: (@link PadBuilder.PositionTypes NXOpen.Features.StructureDesign.PadBuilder.PositionTypes@endlink) PositionType
    ...
    ## @return PadBuilder.PositionTypes
    @property
    ...
    ## Setter for property: (@link PadBuilder.PositionTypes NXOpen.Features.StructureDesign.PadBuilder.PositionTypes@endlink) PositionType
    ...
    ## Getter for property: (@link PadBuilder.ThicknessDirections NXOpen.Features.StructureDesign.PadBuilder.ThicknessDirections@endlink) ThicknessDirection
    ...
    ## @return PadBuilder.ThicknessDirections
    @property
    ...
    ## Setter for property: (@link PadBuilder.ThicknessDirections NXOpen.Features.StructureDesign.PadBuilder.ThicknessDirections@endlink) ThicknessDirection
    ...
    ## License requirements: nx_structure_design ("Structure Designer")
    ## 
    ## <param name="memberType"> (str) </param>
...
class PlatformBuilder(NXOpen.Features.FeatureBuilder): 
    """
     Represents a <ja_class>NXOpen.Features.StructureDesign.Platform</ja_class> builder. This builder is used to
     create and edit structure design platform feature. The platform feature can be created from construction curves.
     """
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## Automatically</term><description> 
    ## </description> </item><item><term> 
    ## Manually</term><description> 
    ## </description> </item></list>
    class PlateDividingOption(Enum):
        """
        Members Include: <Automatically> <Manually>
        """
        Automatically: int
        Manually: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## KeepLongest</term><description> 
    ## </description> </item><item><term> 
    ## KeepShortest</term><description> 
    ## </description> </item></list>
    class SplitMemberKeepOption(Enum):
        """
        Members Include: <KeepLongest> <KeepShortest>
        """
        KeepLongest: int
        KeepShortest: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) BottomFace
    ...
    ## Getter for property: (@link NXOpen.Section NXOpen.Section@endlink) DividingCurve
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) MaxPlateLength
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) MaxPlateWidth
    ...
    ## Getter for property: (@link PlatformBuilder.SplitMemberKeepOption NXOpen.Features.StructureDesign.PlatformBuilder.SplitMemberKeepOption@endlink) MemberSplitOption
    ...
    ## @return PlatformBuilder.SplitMemberKeepOption
    @property
    ...
    ## Setter for property: (@link PlatformBuilder.SplitMemberKeepOption NXOpen.Features.StructureDesign.PlatformBuilder.SplitMemberKeepOption@endlink) MemberSplitOption
    ...
    ## Getter for property: (@link FeatureSpreadsheetBuilder NXOpen.Features.StructureDesign.FeatureSpreadsheetBuilder@endlink) MemberStockDataLeg
    ...
    ## Getter for property: (@link FeatureSpreadsheetBuilder NXOpen.Features.StructureDesign.FeatureSpreadsheetBuilder@endlink) MemberStockDataPrimary
    ...
    ## Getter for property: (@link FeatureSpreadsheetBuilder NXOpen.Features.StructureDesign.FeatureSpreadsheetBuilder@endlink) MemberStockDataSupporting
    ...
    ## Getter for property: (@link PlatformBuilder.PlateDividingOption NXOpen.Features.StructureDesign.PlatformBuilder.PlateDividingOption@endlink) PlateDividingMethod
    ...
    ## @return PlatformBuilder.PlateDividingOption
    @property
    ...
    ## Setter for property: (@link PlatformBuilder.PlateDividingOption NXOpen.Features.StructureDesign.PlatformBuilder.PlateDividingOption@endlink) PlateDividingMethod
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) PlateOffset
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) RotateAngleLeg
    ##  Returns the rotate angle.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) RotateAnglePrimary
    ##  Returns the rotate angle.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) RotateAngleSupporting
    ##  Returns the rotate angle.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) XOffsetLeg
    ##  Returns the x offset.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) XOffsetPrimary
    ##  Returns the x offset.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) XOffsetSupporting
    ##  Returns the x offset.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) YOffsetLeg
    ##  Returns the y offset.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) YOffsetPrimary
    ##  Returns the y offset.  
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) YOffsetSupporting
    ##  Returns the y offset.  
    ##     
    ##  
    ## Getter License requirements: None.
...
import NXOpen.Features
##  Represents a plateforms feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::StructureDesign::PlatformBuilder  NXOpen::Features::StructureDesign::PlatformBuilder @endlink  <br> 
## 
##   <br>  Created in NX2406.0.0  <br> 
...
class RailBuilder(MemberBuilder): 
    """
        Represents a <ja_class>Features.StructureDesign.Rail</ja_class> builder
        """
    pass
...
"""
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link SelectCornerList NXOpen.Features.StructureDesign.SelectCornerList@endlink) </param>
    ## <param name="objectValue"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  object to add </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link Corner List[NXOpen.Features.StructureDesign.Corner]@endlink)  objects to add </param>
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link SelectCornerList NXOpen.Features.StructureDesign.SelectCornerList@endlink) </param>
    ## <param name="selection"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  selected object </param>
    ...
    ## <param name="selection1"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  first selected object </param>
    ...
    ## <param name="selection2"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  second selected object </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="objectValue"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  object to check </param>
    ...
    ## License requirements: None.
    ## <param name="object_list"> (@link SelectCornerList NXOpen.Features.StructureDesign.SelectCornerList@endlink) </param>
    ## <param name="objectValue"> (@link Corner NXOpen.Features.StructureDesign.Corner@endlink)  Object to remove </param>
    @overload
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link Corner List[NXOpen.Features.StructureDesign.Corner]@endlink)  Objects to remove </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="objects"> (@link Corner List[NXOpen.Features.StructureDesign.Corner]@endlink)  items to put in the list</param>
...
class SplitRailBuilder(NXOpen.Builder): 
    """
    Represents a <ja_class>Features.StructureDesign.SplitRailBuilder</ja_class> builder
    """
    ...
    ## Getter for property: (@link NXOpen.SelectTaggedObjectList NXOpen.SelectTaggedObjectList@endlink) SelectRailPart
    ...
    ## Getter for property: (@link NXOpen.SelectTaggedObjectList NXOpen.SelectTaggedObjectList@endlink) SelectStanchionPart
...
##  @link EditStockBuilderAlignMemberSelectionType NXOpen.Features.StructureDesign.EditStockBuilderAlignMemberSelectionType @endlink is an alias for @link EditStockBuilder.AlignMemberSelectionType NXOpen.Features.StructureDesign.EditStockBuilder.AlignMemberSelectionType@endlink
EditStockBuilderAlignMemberSelectionType = EditStockBuilder.AlignMemberSelectionType
...
##  @link HandrailBuilderCornerTypes NXOpen.Features.StructureDesign.HandrailBuilderCornerTypes @endlink is an alias for @link HandrailBuilder.CornerTypes NXOpen.Features.StructureDesign.HandrailBuilder.CornerTypes@endlink
HandrailBuilderCornerTypes = HandrailBuilder.CornerTypes


##  @link HandrailBuilderHandrailTypes NXOpen.Features.StructureDesign.HandrailBuilderHandrailTypes @endlink is an alias for @link HandrailBuilder.HandrailTypes NXOpen.Features.StructureDesign.HandrailBuilder.HandrailTypes@endlink
HandrailBuilderHandrailTypes = HandrailBuilder.HandrailTypes


##  @link HandrailBuilderStanchionPositionTypes NXOpen.Features.StructureDesign.HandrailBuilderStanchionPositionTypes @endlink is an alias for @link HandrailBuilder.StanchionPositionTypes NXOpen.Features.StructureDesign.HandrailBuilder.StanchionPositionTypes@endlink
HandrailBuilderStanchionPositionTypes = HandrailBuilder.StanchionPositionTypes
...
##  @link MemberBuilderAlignMemberSelectionType NXOpen.Features.StructureDesign.MemberBuilderAlignMemberSelectionType @endlink is an alias for @link MemberBuilder.AlignMemberSelectionType NXOpen.Features.StructureDesign.MemberBuilder.AlignMemberSelectionType@endlink
MemberBuilderAlignMemberSelectionType = MemberBuilder.AlignMemberSelectionType
...
##  @link PadBuilderPositionTypes NXOpen.Features.StructureDesign.PadBuilderPositionTypes @endlink is an alias for @link PadBuilder.PositionTypes NXOpen.Features.StructureDesign.PadBuilder.PositionTypes@endlink
PadBuilderPositionTypes = PadBuilder.PositionTypes


##  @link PadBuilderThicknessDirections NXOpen.Features.StructureDesign.PadBuilderThicknessDirections @endlink is an alias for @link PadBuilder.ThicknessDirections NXOpen.Features.StructureDesign.PadBuilder.ThicknessDirections@endlink
PadBuilderThicknessDirections = PadBuilder.ThicknessDirections
...
##  @link PlatformBuilderPlateDividingOption NXOpen.Features.StructureDesign.PlatformBuilderPlateDividingOption @endlink is an alias for @link PlatformBuilder.PlateDividingOption NXOpen.Features.StructureDesign.PlatformBuilder.PlateDividingOption@endlink
PlatformBuilderPlateDividingOption = PlatformBuilder.PlateDividingOption


##  @link PlatformBuilderSplitMemberKeepOption NXOpen.Features.StructureDesign.PlatformBuilderSplitMemberKeepOption @endlink is an alias for @link PlatformBuilder.SplitMemberKeepOption NXOpen.Features.StructureDesign.PlatformBuilder.SplitMemberKeepOption@endlink
PlatformBuilderSplitMemberKeepOption = PlatformBuilder.SplitMemberKeepOption
