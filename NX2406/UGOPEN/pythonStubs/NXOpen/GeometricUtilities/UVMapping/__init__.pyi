...
class MakeSymmetricParameterizationData(NXOpen.Builder): 
    ...
    ## SymmetryInU</term><description> 
    ##  Symmetric about U </description> </item><item><term> 
    ## SymmetryInV</term><description> 
    ##  Symmetric about V </description> </item></list>
    class Types(Enum):
        """
...
class UVMeshManipulatorData(SelectUVMeshObjectData): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="selectionData"> (@link UVMeshManipulatorData.ObjectSelectionData NXOpen.GeometricUtilities.UVMapping.UVMeshManipulatorData.ObjectSelectionData@endlink)  </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="canAlignToUDirection"> (bool)  </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="canAlignToVDirection"> (bool)  </param>
...
class UVParameterizationBuilder(NXOpen.Builder): 
    ...
    ##   No Constraint, UV aligned automatically </description> </item><item><term> 
    ## Edges</term><description> 
    ##  UV Aligned to edges </description> </item></list>
    class ConstraintOptions(Enum):
        """
        Members Include: <NotSet> <Edges>
        """
        NotSet: int
        Edges: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## ShapePreserving</term><description> 
    ##  Preserves shape. Deprecated in NX1899. Use @link  NXOpen::GeometricUtilities::UVMapping::UVParameterizationBuilder::ParameterizationTypesLengthPreserving   NXOpen::GeometricUtilities::UVMapping::UVParameterizationBuilder::ParameterizationTypesLengthPreserving @endlink  instead. </description> </item><item><term> 
    ## LengthPreserving</term><description> 
    ##  Preserves length. Deprecated in NX2406. Use @link  NXOpen::GeometricUtilities::UVMapping::UVParameterizationBuilder::ParameterizationTypesGeneric   NXOpen::GeometricUtilities::UVMapping::UVParameterizationBuilder::ParameterizationTypesGeneric @endlink  instead.</description> </item><item><term> 
    ## Generic</term><description> 
    ##   Generic </description> </item><item><term> 
    ## Cylindrical</term><description> 
    ##  Cylindrical </description> </item></list>
    class ParameterizationTypes(Enum):
        """
        Members Include: <ShapePreserving> <LengthPreserving> <Generic> <Cylindrical>
        """
        ShapePreserving: int
    ...
    ## Getter for property: (@link UVParameterizationBuilder.ConstraintOptions NXOpen.GeometricUtilities.UVMapping.UVParameterizationBuilder.ConstraintOptions@endlink) ConstraintOption
    ...
    ## @return UVParameterizationBuilder.ConstraintOptions
    @property
    ...
    ## Setter for property: (@link UVParameterizationBuilder.ConstraintOptions NXOpen.GeometricUtilities.UVMapping.UVParameterizationBuilder.ConstraintOptions@endlink) ConstraintOption
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) U1Edges
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) U2Edges
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) V1Edges
    ...
    ## Getter for property: (@link NXOpen.ScCollector NXOpen.ScCollector@endlink) V2Edges
...
##  @link UVParameterizationBuilderConstraintOptions NXOpen.GeometricUtilities.UVMapping.UVParameterizationBuilderConstraintOptions @endlink is an alias for @link UVParameterizationBuilder.ConstraintOptions NXOpen.GeometricUtilities.UVMapping.UVParameterizationBuilder.ConstraintOptions@endlink
UVParameterizationBuilderConstraintOptions = UVParameterizationBuilder.ConstraintOptions
