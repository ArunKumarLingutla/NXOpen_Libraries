...
class AnalysisResultCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## MaximumOverhangAngle</term><description> 
    ##  Maximum Overhang Analysis Checker Result </description> </item><item><term> 
    ## PrintTime</term><description> 
    ##  Print Time Analysis Checker Result </description> </item><item><term> 
    ## Overheating</term><description> 
    ##  Overheating Analysis Checker Result </description> </item></list>
    ...
    ## 
    ## <param name="persistent_result"> (@link AnalysisResult NXOpen.Validate.AnalysisResult@endlink)  Analysis Result </param>
    ...
    ## License requirements: nx_additive_design (" NX Additive Design")
    ## 
    ## <param name="persistentResult"> (@link AnalysisResult NXOpen.Validate.AnalysisResult@endlink)  Analysis Result </param>
    ...
    ## License requirements: nx_additive_design (" NX Additive Design")
    ## 
    ## <param name="persistent_result"> (@link PartOrientationAnalysisResult NXOpen.Validate.PartOrientationAnalysisResult@endlink)  Analysis Result </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="sid"> (str)  The identifier of the @link NXOpen::Validate::AnalysisResult NXOpen::Validate::AnalysisResult@endlink  </param>
...
class CheckChannelRatioBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="bodies"> (@link NXOpen.Body List[NXOpen.Body]@endlink)  The objects to apply the attributes to. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="faces"> (@link NXOpen.Face List[NXOpen.Face]@endlink)  The objects to apply the attributes to. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="tableData"> (@link CheckChannelRatioBuilder.TableData List[NXOpen.Validate.CheckChannelRatioBuilder.TableData]@endlink)  TableData type values. </param>
...
class CheckerNode(NXOpen.TransientObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="childCheckerInstance"> (str)  The instance name of child checker in the profile checker </param>
    ...
    ## 
    ## <param name="childCheckerInstance"> (str)  The instance name of child checker in the profile checker </param>
    ## <param name="enableFlag"> (bool)  The enable flag of child checker in the profile checker. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="childCheckerInstances"> (List[str])  The instance names of child checkers in the profile checker </param>
    ## <param name="enableFlags"> (List[bool])  The enable flags of child checkers in the profile checker </param>
...
class CheckMaximumOverhangAngleBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="targets"> (@link NXOpen.Body List[NXOpen.Body]@endlink)  The objects to apply the attributes to. </param>
...
class CheckMinimumRadiusBuilder(NXOpen.Builder): 
    ...
    ##  3D Minimum </description> </item><item><term> 
    ...
    ## License requirements: None.
    ## 
    ## <param name="selectedFace"> (@link NXOpen.Face NXOpen.Face@endlink)  The specified face </param>
    ## <param name="dynamicPnt"> (@link NXOpen.Point3d NXOpen.Point3d@endlink)  The specified point </param>
...
class CheckModelWithinPrintableVolumeBuilder(NXOpen.Builder): 
    ...
    ##  printer volume shape is block </description> </item><item><term> 
    ...
    ##  show type is printer </description> </item><item><term> 
...
class CheckPartOrientationBuilder(NXOpen.Builder): 
    ...
    ##  Represents coarse accuracy. This would be computationaly faster. </description> </item><item><term> 
    ## Low</term><description> 
    ##  Represents low accuracy. This would be computationaly fast </description> </item><item><term> 
    ## Medium</term><description> 
    ##  Represents medium accuracy. This would be resonably computationaly expensive  </description> </item><item><term> 
    ## High</term><description> 
    ##  Represents high accuracy. This would be computationaly expensive </description> </item><item><term> 
    ## VeryHigh</term><description> 
    ##  Represents very high accuracy. This would be computationaly very expensive </description> </item></list>
    ...
    ## License requirements: None.
    ## 
    ## <param name="optimum_orientation_index"> (int)  Index of optimum solution, should be within [0, num_of_optimum_orientations) </param>
    ...
    ## License requirements: nx_additive_design (" NX Additive Design")
    ## 
    ## <param name="orientationIndex"> (int)  The index of optimum solution. Should be with in [0 NumOfOptimumOrientations)</param>
...
class CheckPorosityBuilder(NXOpen.Builder): 
    ...
    ##  Display All </description> </item><item><term> 
    ## WithinLimits</term><description> 
    ## </description> </item><item><term> 
    ## OutsideLimits</term><description> 
    ## </description> </item><item><term> 
    ## AboveTarget</term><description> 
    ## </description> </item><item><term> 
    ## BelowTarget</term><description> 
    ## </description> </item></list>
...
class CheckPrintTimeBuilder(NXOpen.Builder): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## PowderBedFusion</term><description> 
    ##  Powder Bed Fusion(PBF) </description> </item><item><term> 
    ## MultiJetFusion</term><description> 
    ##  Multi Jet Fusion(MJF) </description> </item><item><term> 
    ## FusedDepositionModeling</term><description> 
    ##  Fusion Deposition Modeling(FDM) </description> </item></list>
...
class KeyPerformanceInterfaceCollection(NXOpen.Object): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## Unknow</term><description> 
    ## </description> </item><item><term> 
    ## DimNominalValueDetail</term><description> 
    ## </description> </item><item><term> 
    ## DimUpperToleranceDetail</term><description> 
    ## </description> </item><item><term> 
    ## DimLowerToleranceDetail</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDepthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDepthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDepthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThruValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTipAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTipAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTipAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDepthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDepthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDepthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCboreDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutHoleDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCsunkAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutFormValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutFormUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutFormLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsInternalValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsExternalValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutLeftHandValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutLengthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutLengthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutLengthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMajorDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMethodValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutMinorDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNominalSizeValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIntExtSymbolValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadsPerUnitValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadFormValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutStartChamferDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutEndChamferDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefChamferDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDepthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDepthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDepthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutReliefDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutPitchValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutPitchUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutPitchLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDrillSizeValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDrillSizeUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutDrillSizeLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTapDrillSizeFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumStartsEq1Value</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumStartsEq1UpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumStartsEq1LowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumStartsGt1Value</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumStartsGt1UpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumStartsGt1LowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsNotTaperedValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsNotTaperedUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsNotTaperedLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsTaperedValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsTaperedUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutIsTaperedLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumberOfInstancesValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumberOfInstancesUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNumberOfInstancesLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutBlendRadiusValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutBlendRadiusUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutBlendRadiusLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadStrValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadStrUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadStrLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadCountValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadCountUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadCountLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadFullValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadFullUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadFullLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutXLengthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutXLengthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutXLengthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutYLengthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutYLengthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutYLengthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCenterLengthValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCenterLengthUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCenterLengthLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutXLengthTopValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutXLengthTopUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutXLengthTopLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutYLengthTopValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutYLengthTopUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutYLengthTopLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCenterLengthTopValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCenterLengthTopUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutCenterLengthTopLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTaperAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTaperAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutTaperAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutShaftSizeFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutFitValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutFitUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutFitLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferAngleValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferAngleUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferAngleLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterUpperTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterLowerTolerance</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterFitHoleDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterFitHoleGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterFitShaftDeviation</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutNeckChamferDiameterFitShaftGrade</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadHandednessValue</term><description> 
    ## </description> </item><item><term> 
    ## DimCalloutThreadToleranceValue</term><description> 
    ## </description> </item><item><term> 
    ## FcfTypeDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfShapeDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfToleranceDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfModifierDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfPrimaryDatumDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfPrimaryMcmDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfSecondaryDatumDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfSecondaryMcmDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfTertiaryDatumDetail</term><description> 
    ## </description> </item><item><term> 
    ## FcfTertiaryMcmDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfShapeDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfToleranceDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfModifierDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfPrimaryDatumDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfPrimaryMcmDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfSecondaryDatumDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfSecondaryMcmDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfTertiaryDatumDetail</term><description> 
    ## </description> </item><item><term> 
    ## CompFcfTertiaryMcmDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinStandardDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinSymbolTypeDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinSurfaceRoughnessDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinMethodTreatCoatDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinRoughnessCutoffDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinDirectionOfLayDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinMinMaterialRemovalDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinRoughnessValueDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinToleranceTypeDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinRoughnessToleranceDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinRoughnessLowerToleranceDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinSurfaceRoughnessMaxDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinSurfaceRoughnessMinDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinRoughnessValueF1Detail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinRoughnessValueF2Detail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinSecondaryRoughnessDetail</term><description> 
    ## </description> </item><item><term> 
    ## SurfinTertiaryRoughnessDetail</term><description> 
    ## </description> </item></list>
    class JaPmiObjectDetailType(Enum):
        """
        Members Include: <Unknow> <DimNominalValueDetail> <DimUpperToleranceDetail> <DimLowerToleranceDetail> <DimCalloutDepthValue> <DimCalloutDepthUpperTolerance> <DimCalloutDepthLowerTolerance> <DimCalloutDiameterValue> <DimCalloutDiameterUpperTolerance> <DimCalloutDiameterLowerTolerance> <DimCalloutThruValue> <DimCalloutTipAngleValue> <DimCalloutTipAngleUpperTolerance> <DimCalloutTipAngleLowerTolerance> <DimCalloutCboreDepthValue> <DimCalloutCboreDepthUpperTolerance> <DimCalloutCboreDepthLowerTolerance> <DimCalloutCboreDiameterValue> <DimCalloutCboreDiameterUpperTolerance> <DimCalloutCboreDiameterLowerTolerance> <DimCalloutCboreDiameterFitHoleDeviation> <DimCalloutCboreDiameterFitHoleGrade> <DimCalloutCboreDiameterFitShaftDeviation> <DimCalloutCboreDiameterFitShaftGrade> <DimCalloutHoleDiameterValue> <DimCalloutHoleDiameterUpperTolerance> <DimCalloutHoleDiameterLowerTolerance> <DimCalloutHoleDiameterFitHoleDeviation> <DimCalloutHoleDiameterFitHoleGrade> <DimCalloutHoleDiameterFitShaftDeviation> <DimCalloutHoleDiameterFitShaftGrade> <DimCalloutCsunkDiameterValue> <DimCalloutCsunkDiameterUpperTolerance> <DimCalloutCsunkDiameterLowerTolerance> <DimCalloutCsunkDiameterFitHoleDeviation> <DimCalloutCsunkDiameterFitHoleGrade> <DimCalloutCsunkDiameterFitShaftDeviation> <DimCalloutCsunkDiameterFitShaftGrade> <DimCalloutCsunkAngleValue> <DimCalloutCsunkAngleUpperTolerance> <DimCalloutCsunkAngleLowerTolerance> <DimCalloutAngleValue> <DimCalloutAngleUpperTolerance> <DimCalloutAngleLowerTolerance> <DimCalloutFormValue> <DimCalloutFormUpperTolerance> <DimCalloutFormLowerTolerance> <DimCalloutIsInternalValue> <DimCalloutIsExternalValue> <DimCalloutLeftHandValue> <DimCalloutLengthValue> <DimCalloutLengthUpperTolerance> <DimCalloutLengthLowerTolerance> <DimCalloutMajorDiameterValue> <DimCalloutMajorDiameterUpperTolerance> <DimCalloutMajorDiameterLowerTolerance> <DimCalloutMajorDiameterFitHoleDeviation> <DimCalloutMajorDiameterFitHoleGrade> <DimCalloutMajorDiameterFitShaftDeviation> <DimCalloutMajorDiameterFitShaftGrade> <DimCalloutMethodValue> <DimCalloutMinorDiameterValue> <DimCalloutMinorDiameterUpperTolerance> <DimCalloutMinorDiameterLowerTolerance> <DimCalloutMinorDiameterFitHoleDeviation> <DimCalloutMinorDiameterFitHoleGrade> <DimCalloutMinorDiameterFitShaftDeviation> <DimCalloutMinorDiameterFitShaftGrade> <DimCalloutNominalSizeValue> <DimCalloutIntExtSymbolValue> <DimCalloutThreadsPerUnitValue> <DimCalloutThreadFormValue> <DimCalloutStartChamferDiameterValue> <DimCalloutStartChamferDiameterUpperTolerance> <DimCalloutStartChamferDiameterLowerTolerance> <DimCalloutStartChamferAngleValue> <DimCalloutStartChamferAngleUpperTolerance> <DimCalloutStartChamferAngleLowerTolerance> <DimCalloutStartChamferDiameterFitHoleDeviation> <DimCalloutStartChamferDiameterFitHoleGrade> <DimCalloutStartChamferDiameterFitShaftDeviation> <DimCalloutStartChamferDiameterFitShaftGrade> <DimCalloutEndChamferDiameterValue> <DimCalloutEndChamferDiameterUpperTolerance> <DimCalloutEndChamferDiameterLowerTolerance> <DimCalloutEndChamferAngleValue> <DimCalloutEndChamferAngleUpperTolerance> <DimCalloutEndChamferAngleLowerTolerance> <DimCalloutEndChamferDiameterFitHoleDeviation> <DimCalloutEndChamferDiameterFitHoleGrade> <DimCalloutEndChamferDiameterFitShaftDeviation> <DimCalloutEndChamferDiameterFitShaftGrade> <DimCalloutReliefChamferDiameterValue> <DimCalloutReliefChamferDiameterUpperTolerance> <DimCalloutReliefChamferDiameterLowerTolerance> <DimCalloutReliefChamferAngleValue> <DimCalloutReliefChamferAngleUpperTolerance> <DimCalloutReliefChamferAngleLowerTolerance> <DimCalloutReliefChamferDiameterFitHoleDeviation> <DimCalloutReliefChamferDiameterFitHoleGrade> <DimCalloutReliefChamferDiameterFitShaftDeviation> <DimCalloutReliefChamferDiameterFitShaftGrade> <DimCalloutReliefDepthValue> <DimCalloutReliefDepthUpperTolerance> <DimCalloutReliefDepthLowerTolerance> <DimCalloutReliefDiameterValue> <DimCalloutReliefDiameterLowerTolerance> <DimCalloutReliefDiameterUpperTolerance> <DimCalloutReliefDiameterFitHoleDeviation> <DimCalloutReliefDiameterFitHoleGrade> <DimCalloutReliefDiameterFitShaftDeviation> <DimCalloutReliefDiameterFitShaftGrade> <DimCalloutPitchValue> <DimCalloutPitchUpperTolerance> <DimCalloutPitchLowerTolerance> <DimCalloutDrillSizeValue> <DimCalloutDrillSizeUpperTolerance> <DimCalloutDrillSizeLowerTolerance> <DimCalloutTapDrillSizeValue> <DimCalloutTapDrillSizeUpperTolerance> <DimCalloutTapDrillSizeLowerTolerance> <DimCalloutTapDrillSizeFitHoleDeviation> <DimCalloutTapDrillSizeFitHoleGrade> <DimCalloutTapDrillSizeFitShaftDeviation> <DimCalloutTapDrillSizeFitShaftGrade> <DimCalloutNumStartsEq1Value> <DimCalloutNumStartsEq1UpperTolerance> <DimCalloutNumStartsEq1LowerTolerance> <DimCalloutNumStartsGt1Value> <DimCalloutNumStartsGt1UpperTolerance> <DimCalloutNumStartsGt1LowerTolerance> <DimCalloutIsNotTaperedValue> <DimCalloutIsNotTaperedUpperTolerance> <DimCalloutIsNotTaperedLowerTolerance> <DimCalloutIsTaperedValue> <DimCalloutIsTaperedUpperTolerance> <DimCalloutIsTaperedLowerTolerance> <DimCalloutNumberOfInstancesValue> <DimCalloutNumberOfInstancesUpperTolerance> <DimCalloutNumberOfInstancesLowerTolerance> <DimCalloutBlendRadiusValue> <DimCalloutBlendRadiusUpperTolerance> <DimCalloutBlendRadiusLowerTolerance> <DimCalloutThreadStrValue> <DimCalloutThreadStrUpperTolerance> <DimCalloutThreadStrLowerTolerance> <DimCalloutThreadCountValue> <DimCalloutThreadCountUpperTolerance> <DimCalloutThreadCountLowerTolerance> <DimCalloutThreadFullValue> <DimCalloutThreadFullUpperTolerance> <DimCalloutThreadFullLowerTolerance> <DimCalloutXLengthValue> <DimCalloutXLengthUpperTolerance> <DimCalloutXLengthLowerTolerance> <DimCalloutYLengthValue> <DimCalloutYLengthUpperTolerance> <DimCalloutYLengthLowerTolerance> <DimCalloutCenterLengthValue> <DimCalloutCenterLengthUpperTolerance> <DimCalloutCenterLengthLowerTolerance> <DimCalloutXLengthTopValue> <DimCalloutXLengthTopUpperTolerance> <DimCalloutXLengthTopLowerTolerance> <DimCalloutYLengthTopValue> <DimCalloutYLengthTopUpperTolerance> <DimCalloutYLengthTopLowerTolerance> <DimCalloutCenterLengthTopValue> <DimCalloutCenterLengthTopUpperTolerance> <DimCalloutCenterLengthTopLowerTolerance> <DimCalloutTaperAngleValue> <DimCalloutTaperAngleUpperTolerance> <DimCalloutTaperAngleLowerTolerance> <DimCalloutShaftSizeValue> <DimCalloutShaftSizeUpperTolerance> <DimCalloutShaftSizeLowerTolerance> <DimCalloutShaftSizeFitHoleDeviation> <DimCalloutShaftSizeFitHoleGrade> <DimCalloutShaftSizeFitShaftDeviation> <DimCalloutShaftSizeFitShaftGrade> <DimCalloutFitValue> <DimCalloutFitUpperTolerance> <DimCalloutFitLowerTolerance> <DimCalloutNeckChamferAngleValue> <DimCalloutNeckChamferAngleUpperTolerance> <DimCalloutNeckChamferAngleLowerTolerance> <DimCalloutNeckChamferDiameterValue> <DimCalloutNeckChamferDiameterUpperTolerance> <DimCalloutNeckChamferDiameterLowerTolerance> <DimCalloutNeckChamferDiameterFitHoleDeviation> <DimCalloutNeckChamferDiameterFitHoleGrade> <DimCalloutNeckChamferDiameterFitShaftDeviation> <DimCalloutNeckChamferDiameterFitShaftGrade> <DimCalloutThreadHandednessValue> <DimCalloutThreadToleranceValue> <FcfTypeDetail> <FcfShapeDetail> <FcfToleranceDetail> <FcfModifierDetail> <FcfPrimaryDatumDetail> <FcfPrimaryMcmDetail> <FcfSecondaryDatumDetail> <FcfSecondaryMcmDetail> <FcfTertiaryDatumDetail> <FcfTertiaryMcmDetail> <CompFcfShapeDetail> <CompFcfToleranceDetail> <CompFcfModifierDetail> <CompFcfPrimaryDatumDetail> <CompFcfPrimaryMcmDetail> <CompFcfSecondaryDatumDetail> <CompFcfSecondaryMcmDetail> <CompFcfTertiaryDatumDetail> <CompFcfTertiaryMcmDetail> <SurfinStandardDetail> <SurfinSymbolTypeDetail> <SurfinSurfaceRoughnessDetail> <SurfinMethodTreatCoatDetail> <SurfinRoughnessCutoffDetail> <SurfinDirectionOfLayDetail> <SurfinMinMaterialRemovalDetail> <SurfinRoughnessValueDetail> <SurfinToleranceTypeDetail> <SurfinRoughnessToleranceDetail> <SurfinRoughnessLowerToleranceDetail> <SurfinSurfaceRoughnessMaxDetail> <SurfinSurfaceRoughnessMinDetail> <SurfinRoughnessValueF1Detail> <SurfinRoughnessValueF2Detail> <SurfinSecondaryRoughnessDetail> <SurfinTertiaryRoughnessDetail>
        """
        Unknow: int
    ...
    ## <param name="checkName"> (str)  name of requirement check </param>
    ## <param name="pmiValue"> (str) Value of the requirement check </param>
    ## <param name="pmi"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink)  PMI object to be associate with the key </param>
    ## <param name="detailtype"> (int) </param>
    ...
    ## <param name="pmiValue"> (str) Value of the requirement check </param>
    ## <param name="pmi"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink)  PMI object to be associate with the key </param>
    ## <param name="detailtype"> (int)  Pmi parameter</param>
    ## <param name="useRelativeTol"> (bool) decides which tolerance value to be used for creating check calculated/relative.</param>
    ...
    ## <param name="pmiValue"> (str) Value of the requirement check </param>
    ## <param name="pmi"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink)  PMI object to be associate with the key </param>
    ## <param name="detailtype"> (@link KeyPerformanceInterfaceCollection.JaPmiObjectDetailType NXOpen.Validate.KeyPerformanceInterfaceCollection.JaPmiObjectDetailType@endlink)  Pmi parameter</param>
    ## <param name="useRelativeTol"> (bool) decides which tolerance value to be used for creating check calculated/relative.</param>
...
class Logger(NXOpen.TransientObject): 
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="booleanValue"> (bool)  The Boolean type attribute's value. </param>
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="attrs"> (List[bool])  The Boolean type attribute's array value. </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="childLoggerName"> (str)  The name of the child logger.</param>
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="integerValue"> (int)  The integer number type attribute's value. </param>
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="attrs"> (List[int])  The integer number type attribute's array value. </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="outcome"> (@link NXOpen.Validation.Result NXOpen.Validation.Result@endlink)  The validation outcome.</param>
    ## <param name="message"> (str)  The message describing the validation outcome.</param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## <param name="logger"> (@link Logger NXOpen.Validate.Logger@endlink) </param>
    ## <param name="outcome"> (@link NXOpen.Validation.Result NXOpen.Validation.Result@endlink) The validation outcome.</param>
    ## <param name="anObject"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  The object to be logged as validation outcome detail.</param>
    @overload
    ...
    ## <param name="outcome"> (@link NXOpen.Validation.Result NXOpen.Validation.Result@endlink) The validation outcome.</param>
    ## <param name="anObject"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  The object to be logged as validation outcome detail.</param>
    ## <param name="message"> (str)  The message describing the object as a validation outcome.</param>
    ...
    ## <param name="anObject"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  The object to be logged as validation outcome detail.</param>
    ## <param name="message"> (str)  The message describing the object as a validation outcome.</param>
    ## <param name="objectName"> (str)  The display name of the object. If not specified, the system will assign one.</param>
    ## <param name="referencePoints"> (@link NXOpen.Point3d List[NXOpen.Point3d]@endlink)  The reference points for the object. Useful for geometric validation.</param>
    ## <param name="referenceVectors"> (@link NXOpen.Vector3d List[NXOpen.Vector3d]@endlink)  The reference vectors for the object. Useful for geometric validation.</param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="name"> (str)  The name of the set.</param>
    ## <param name="message"> (str)  The message describing the set.</param>
    ...
    ## <param name="message"> (str)  The message describing the object as a validation outcome.</param>
    ## <param name="objectName"> (str)  The display name of the object. If not specified, the system will assign one.</param>
    ## <param name="referencePoints"> (@link NXOpen.Point3d List[NXOpen.Point3d]@endlink)  The reference points for the object. Each reference point is used as the location of a reference vector.</param>
    ## <param name="referenceVectors"> (@link NXOpen.Vector3d List[NXOpen.Vector3d]@endlink)  The reference vectors for the object. Each reference vector is set by a @link NXOpen::Point3d NXOpen::Point3d@endlink  location (defined in referencePoints) and a @link NXOpen::Vector3d NXOpen::Vector3d@endlink  direction.</param>
    @overload
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="realValue"> (float)  The real number type attribute's value. </param>
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="attrs"> (List[float])  The real number type attribute's array value. </param>
    ...
    ##  Logs reference points for a @link NXObject NXObject@endlink  as validation outcome detail.
    ##         
    ## 
    ##   <br>  Created in NX2406.0.0  <br> 
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="referencePoints"> (@link NXOpen.Point3d List[NXOpen.Point3d]@endlink)  The reference points for the object.</param>
    ...
    ##  Logs reference vectors for a @link NXObject NXObject@endlink  as validation outcome detail. Each reference vector is set by a @link NXOpen::Point3d NXOpen::Point3d@endlink  location and a @link NXOpen::Vector3d NXOpen::Vector3d@endlink  direction.
    ##         
    ## 
    ##   <br>  Created in NX2406.0.0  <br> 
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="locations"> (@link NXOpen.Point3d List[NXOpen.Point3d]@endlink)  The locations of the reference vectors for the object.</param>
    ## <param name="directions"> (@link NXOpen.Vector3d List[NXOpen.Vector3d]@endlink)  The directions of the reference vectors for the object.</param>
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="stringValue"> (str)  The string type attribute's value. </param>
    ...
    ## 
    ## <param name="title"> (str)  The title of attribute. </param>
    ## <param name="attrs"> (List[str])  The string type attribute's array value. </param>
...
class OverrideBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="decisionComments"> (List[str])  </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="detailReason"> (List[str])  </param>
...
class Parameter(NXOpen.TransientObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (bool)  The boolean type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (List[bool])  The boolean type values.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (float)  The real number type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (List[float])  The real number type values.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (int)  The integer number type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (List[int])  The integer number type values.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  The NXObject type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink)  The NXObject type values.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (@link NXOpen.Point3d NXOpen.Point3d@endlink)  Point3d type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (@link NXOpen.Point3d List[NXOpen.Point3d]@endlink)  Point3d type values.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (str)  The string type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (List[str])  The string type values.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink)  Vector3d type value.</param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="data"> (@link NXOpen.Vector3d List[NXOpen.Vector3d]@endlink)  Vector3d type values.</param>
...
class Parser(NXOpen.TaggedObject): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## MostRecentRun</term><description> 
    ##  Result of most recent run </description> </item><item><term> 
    ## ResultFromPart</term><description> 
    ##  Result from part </description> </item><item><term> 
    ## ResultFromTeamcenter</term><description> 
    ##  Result from Teamcenter </description> </item><item><term> 
    ## ResultFromNXChecks</term><description> 
    ##  Result from NX checks</description> </item><item><term> 
    ## ResultFromLogFile</term><description> 
    ##  Result from Log File </description> </item></list>
    ...
    ## License requirements: None.
    ## 
    ## <param name="resultObject"> (@link ResultObject NXOpen.Validate.ResultObject@endlink)   </param>
...
class PartOrientationAnalysisResult(AnalysisResult): 
    ...
    ## </description> </item><item><term> 
    ## SurfaceArea</term><description> 
    ##  Projected Surface Area Checker </description> </item><item><term> 
    ## SupportVolume</term><description> 
    ##  Support Volume Checker </description> </item><item><term> 
    ## PrintTime</term><description> 
    ##  Print Time Checker </description> </item><item><term> 
    ## Overheat</term><description> 
    ##  Index for Overheat Checker </description> </item><item><term> 
    ## Maximum</term><description> 
    ##  Maximum Index of Checkers </description> </item></list>
...
class PersistentResult(NXOpen.NXObject): 
    ...
    ## <param name="objects"> (@link NXOpen.TaggedObject List[NXOpen.TaggedObject]@endlink)  </param>
...
class RequirementBuilder(NXOpen.Builder): 
    ...
    ##  Returns  @brief  the user defined formula.  
    ##    Only effective when 
    ...
    ## License requirements: None.
    ## 
    ## <param name="requirementDescription"> (List[str])  </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="validValues"> (List[str])  </param>
...
class RequirementCheck(NXOpen.Validation): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## DoNotSave</term><description> 
    ##  Do not perform save. </description> </item><item><term> 
    ## SaveIfPassed</term><description> 
    ##  Perform save only if the result is passed. </description> </item><item><term> 
    ## AlwaysSave</term><description> 
    ##  Always perform save </description> </item></list>
...
class RequirementCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="id"> (str)  The identifier of the @link NXOpen::Validate::Requirement NXOpen::Validate::Requirement@endlink  </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="sourceType"> (@link RequirementCollection.SourceTypeOptions NXOpen.Validate.RequirementCollection.SourceTypeOptions@endlink)  Type of the external source </param>
    ## <param name="source"> (str)  File full path if sourceType is LocalFile; Item id if sourceType is Teamcenter or TeamcenterFile. </param>
    ## <param name="revision"> (str)  Only needed if sourceType is Teamcenter or TeamcenterFile. Revision id if source is an item revision. Null if source is an item. </param>
    ## <param name="project"> (str)  Required if sourceType is LocalFile or TeamcenterFile.
    ##                                                                             Project name if the source is a XML file; Sheet name if source is a spreadsheet file. </param>
...
class Requirement(NXOpen.NXObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="name"> (str)  name of requirement check </param>
    ## <param name="formula"> (str)  expression or formula of the requirement check </param>
...
class ResultObject(NXOpen.NXObject): 
    ...
    ##  Part </description> </item><item><term> 
    ## Profile</term><description> 
    ##  Profile </description> </item><item><term> 
    ## Test</term><description> 
    ##  Test </description> </item><item><term> 
    ## Object</term><description> 
    ##  Object </description> </item><item><term> 
    ## ObjectSet</term><description> 
    ##  Object Set </description> </item></list>
    ...
    ## License requirements: None.
    ## 
    ## <param name="name"> (str) the attribute name of check result</param>
...
class RuleBaseSaveBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="folderPath"> (str)  Rule folder path </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="ruleFileName"> (str)  Rule file name </param>
...
class SelectionAndPlacementBuilder(NXOpen.TaggedObject): 
    ...
    ## License requirements: None.
    ## 
    ## <param name="targets"> (@link NXOpen.TaggedObject List[NXOpen.TaggedObject]@endlink)  The targets should be of NXOpen::Body or NXOpen::Part </param>
...
class ValidationManager(NXOpen.Object): 
    ...
    ## License requirements: None.
    ## <param name="name"> (str)  name of the parser </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## <param name="name"> (str)  name of the validator </param>
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  The NXobject type parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink)  The NXobject type parameters.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (int)  The value of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (List[int])  The values of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink)  The value of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (@link NXOpen.Vector3d List[NXOpen.Vector3d]@endlink)  The values of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (bool)  The value of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (List[bool])  The values of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (float)  The value of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (List[float])  The values of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (str)  The value of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (List[str])  The values of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (@link NXOpen.Point3d NXOpen.Point3d@endlink)  The value of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="parameterValue"> (@link NXOpen.Point3d List[NXOpen.Point3d]@endlink)  The values of parameter.</param>
    ## <param name="options"> (@link ValidationManager.ParameterOptions NXOpen.Validate.ValidationManager.ParameterOptions@endlink)  The option of parameter.</param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="parameterID"> (str)  The ID of parameter.</param>
    ## <param name="referencedParameter"> (@link Parameter NXOpen.Validate.Parameter@endlink) </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## <param name="validator"> (@link Validator NXOpen.Validate.Validator@endlink)  </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## <param name="classID"> (str)  The class ID of the checker. </param>
...
class ValidatorOptions(NXOpen.TaggedObject): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## LogPerSession</term><description> 
    ##  Generate log per session </description> </item><item><term> 
    ## LogPerPart</term><description> 
    ##  Generate log per part </description> </item></list>
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## AlwaysDisplay</term><description> 
    ##  Always display results. </description> </item><item><term> 
    ## DisplayIfNotPass</term><description> 
    ##  Display results if the checking is not passed. </description> </item><item><term> 
    ## DoNotDisplay</term><description> 
    ##  Do not display results </description> </item></list>
    ...
    ##  Do not perform save. </description> </item><item><term> 
    ## SaveIfPassed</term><description> 
    ##  Perform save only if the checking is passed. </description> </item><item><term> 
    ## AlwaysSave</term><description> 
    ##  Always perform save </description> </item></list>
...
class Validator(NXOpen.TaggedObject): 
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="className"> (str)  checker class name </param>
    ...
    ## License requirements: ug_checkmate ("UG Check Mate")
    ## 
    ## <param name="classNames"> (List[str])  checkers' class name array </param>
    ...
    ## License requirements: None.
    ## <param name="self"> (@link Validator NXOpen.Validate.Validator@endlink) </param>
    ...
    ## License requirements: None.
    ## <param name="self"> (@link Validator NXOpen.Validate.Validator@endlink) </param>
    ## <param name="partObject"> (@link NXOpen.Part NXOpen.Part@endlink)  </param>
    @overload
    ...
    ## License requirements: None.
    ## <param name="self"> (@link Validator NXOpen.Validate.Validator@endlink) </param>
    ## <param name="partObject"> (@link NXOpen.Part List[NXOpen.Part]@endlink)  </param>
    @overload
...
class XmlComparator(NXOpen.Object): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## Identical</term><description> 
    ##  Represents two xml files are identical </description> </item><item><term> 
    ## Different</term><description> 
    ##  Represents two xml files are different </description> </item></list>
    class Result(Enum):
        """
    ...
    ## License requirements: None.
    ## <param name="workXmlFile"> (str)  The first xml file to be compared </param>
    ## <param name="masterXmlFile"> (str)  The second xml file to be compared against </param>
    ## <param name="compareOptions"> (@link XmlComparator.Options NXOpen.Validate.XmlComparator.Options@endlink)  comparison options </param>
...
##  @link KeyPerformanceInterfaceCollectionJaPmiObjectDetailType NXOpen.Validate.KeyPerformanceInterfaceCollectionJaPmiObjectDetailType @endlink is an alias for @link KeyPerformanceInterfaceCollection.JaPmiObjectDetailType NXOpen.Validate.KeyPerformanceInterfaceCollection.JaPmiObjectDetailType@endlink
KeyPerformanceInterfaceCollectionJaPmiObjectDetailType = KeyPerformanceInterfaceCollection.JaPmiObjectDetailType
