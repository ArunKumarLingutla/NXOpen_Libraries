...
class AlternateComponentManager(NXOpen.Object): 
    ...
    ## <param name="component"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    ## <param name="datasetName"> (str)  UGMaster dataset name or UGAltrep dataset name. </param>
...
class AttributeRemover(NXOpen.Object): 
    ...
    ##  Remove board attributes </description> </item><item><term> 
    ## Components</term><description> 
    ##  Remove components attributes </description> </item><item><term> 
    ## Areas</term><description> 
    ##  Remove areas attributes </description> </item><item><term> 
    ## Holes</term><description> 
    ##  Remove drilled holes attributes </description> </item><item><term> 
    ## Traces</term><description> 
    ##  Remove traces attributes </description> </item><item><term> 
    ## Pads</term><description> 
    ##  Remove pads attributes </description> </item><item><term> 
    ## All</term><description> 
    ##  Remove all pcbx attributes </description> </item></list>
    class Option(Enum):
        """
...
class BoardPropertiesBuilder(NXOpen.Builder): 
    ...
    ##  Defines the generator options. 
    ## <list type="table"> 
    ## <listheader><term> 
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## BoardProperties</term><description> 
    ## </description> </item><item><term> 
    ## EDABridge</term><description> 
    ## </description> </item></list>
    class GeneratorOption(Enum):
        """
        Members Include: <BoardProperties> <EDABridge>
        """
        BoardProperties: int
        EDABridge: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Getter for property: (@link BoardPropertiesBuilder.GeneratorOption NXOpen.PcbExchange.BoardPropertiesBuilder.GeneratorOption@endlink) Generator
    ...
    ## @return BoardPropertiesBuilder.GeneratorOption
    @property
    ...
    ## Setter for property: (@link BoardPropertiesBuilder.GeneratorOption NXOpen.PcbExchange.BoardPropertiesBuilder.GeneratorOption@endlink) Generator
...
## Comment</description> </listheader><item><term> 
## Both</term><description> 
##  Either side. </description> </item><item><term> 
## Top</term><description> 
##  The Top side. </description> </item><item><term> 
## Bottom</term><description> 
##  The Bottom side. </description> </item></list>
...
## Comment</description> </listheader><item><term> 
## All</term><description> 
##  Any layer. </description> </item><item><term> 
## Top</term><description> 
##  The Top layer. </description> </item><item><term> 
## Bottom</term><description> 
##  The Bottom layer. </description> </item><item><term> 
## Outer</term><description> 
##  Either Top or Bottom layer. </description> </item><item><term> 
## Inner</term><description> 
##  Inner layer. </description> </item></list>
...
class DesignRuleBuilder(NXOpen.Builder): 
    ...
    ##  Accept any Pcb Components. </description> </item><item><term> 
    ## ByPackage</term><description> 
    ##  Filter Pcb Components by Package Name. </description> </item><item><term> 
    ## ByOwner</term><description> 
    ##  Filter Pcb Components by Owner. </description> </item><item><term> 
    ## ByRefDes</term><description> 
    ##  Filter Pcb Components by Reference Designator. </description> </item><item><term> 
    ## ByPartNumber</term><description> 
    ##  Filter Pcb Components by Part Number. </description> </item><item><term> 
    ## ByCompType</term><description> 
    ##  Filter Pcb Components by Type. </description> </item><item><term> 
    ## ByPartName</term><description> 
    ##  Filter Mechnanical entity by Part Name. </description> </item><item><term> 
    ## ByAreaName</term><description> 
    ##  Filter Area by Name. </description> </item><item><term> 
    ## ByAreaSubtype</term><description> 
    ##  Filter Area by Subtype. </description> </item><item><term> 
    ## ByAreaOwner</term><description> 
    ##  Filter Area by Owner. </description> </item><item><term> 
    ## ByAreaLayer</term><description> 
    ##  Filter Area by Layer. </description> </item><item><term> 
    ## Specify</term><description> 
    ##  Filter by selection. </description> </item><item><term> 
    ## ByNetName</term><description> 
    ##  Filter Copper by Net Name. </description> </item><item><term> 
    ## ByPackageClearanceType</term><description> 
    ##  Filter Pcb Components by Package Clearance Type. </description> </item><item><term> 
    ## ByWireBondNetName</term><description> 
    ##  Filter Wire Bond by Net Name. </description> </item></list>
    ...
    ## License requirements: None.
    ## 
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="direction"> (@link DesignRuleMargin NXOpen.PcbExchange.DesignRuleMargin@endlink)  The direction. </param>
    ...
    ## 
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ## <param name="side"> (@link BoardSide NXOpen.PcbExchange.BoardSide@endlink) </param>
    ...
    ## 
    ## <param name="direction"> (@link DesignRuleMargin NXOpen.PcbExchange.DesignRuleMargin@endlink)  The direction. </param>
    ## <param name="clearance"> (float)  The clearance value in Part Units. </param>
    ...
    ## 
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ## <param name="componentFilter"> (@link DesignRuleBuilder.ComponentFilter NXOpen.PcbExchange.DesignRuleBuilder.ComponentFilter@endlink) </param>
    ...
    ## 
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ## <param name="side"> (@link ConductiveLayerSide NXOpen.PcbExchange.ConductiveLayerSide@endlink) </param>
    ...
    ## 
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ## <param name="entityType"> (@link EntityCategory NXOpen.PcbExchange.EntityCategory@endlink) </param>
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="builder"> (@link DesignRuleBuilder NXOpen.PcbExchange.DesignRuleBuilder@endlink) </param>
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ## <param name="data"> (str) </param>
    @overload
    ...
    ## 
    ## <param name="filterIndex"> (int)  Index of the filter. </param>
    ## <param name="side"> (@link WireBondSide NXOpen.PcbExchange.WireBondSide@endlink) </param>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## OrthoXY</term><description> 
##  The XY constraint of a @link NXOpen::PcbExchange::DesignRuleTypeOrtho NXOpen::PcbExchange::DesignRuleTypeOrtho@endlink  rule. </description> </item><item><term> 
## OrthoZ</term><description> 
##  The Z constraint of a @link NXOpen::PcbExchange::DesignRuleTypeOrtho NXOpen::PcbExchange::DesignRuleTypeOrtho@endlink  rule. </description> </item><item><term> 
## Xyz</term><description> 
##  The XYZ constraint of a @link NXOpen::PcbExchange::DesignRuleTypeDistance NXOpen::PcbExchange::DesignRuleTypeDistance@endlink  rule. </description> </item><item><term> 
## LongToLong</term><description> 
##  The long side to long side constraint of a @link NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge@endlink  rule. </description> </item><item><term> 
## ShortToShort</term><description> 
##  The short side to short side constraint of a @link NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge@endlink  rule. </description> </item><item><term> 
## LongToShort</term><description> 
##  The long side to short side constraint of a @link NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge@endlink  rule. </description> </item><item><term> 
## ShortToLong</term><description> 
##  The short side to long side constraint of a @link NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge@endlink  rule. </description> </item><item><term> 
## Z</term><description> 
##  The Z constraint of a @link NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge NXOpen::PcbExchange::DesignRuleTypeEdgeToEdge@endlink  rule. </description> </item></list>
...
##  The constraints specifies the minimum threshold. </description> </item><item><term> 
## Optimal</term><description> 
##  The constraints specifies the optimal threshold. </description> </item></list>
...
## Enumerator</term><description> 
## Comment</description> </listheader><item><term> 
## Ortho</term><description> 
##  Orthogonal check. The clearance requirement is expressed independently in the XY plane, and along the Z axis. </description> </item><item><term> 
## Distance</term><description> 
##  Cartesian distance check. The clearance requirement is defined as a 3D distance. </description> </item><item><term> 
## EdgeToEdge</term><description> 
##  Edge to edge distance check. The clearance requirement is defined as the distance between shorter and/or longer sides of the objects. </description> </item></list>
...
class EcadPanelImportBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## 
    ## <param name="outputsNames"> (List[str])  Outputs names list </param>
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## 
    ## <param name="outputsParts"> (List[str])  Outputs parts list </param>
...
##  Entity is a Component. </description> </item><item><term> 
## Board</term><description> 
##  Entity is a Board. </description> </item><item><term> 
## Mechanical</term><description> 
##  Entity is Mechanical. </description> </item><item><term> 
## KeepOut</term><description> 
##  Entity is a Keep-out Area. </description> </item><item><term> 
## Copper</term><description> 
##  Entity is Copper. </description> </item><item><term> 
## WireBond</term><description> 
##  Entity is WireBond. </description> </item><item><term> 
## CopperArea</term><description> 
##  Entity is a Copper Area. </description> </item></list>
...
class ExternalDataImportBuilder(NXOpen.Builder): 
    ...
    ##  Import. </description> </item><item><term> 
    ## DoNotImport</term><description> 
    ##  Do not import. </description> </item></list>
    ...
    ## License requirements: None.
    ## 
    ## <param name="name"> (str)  Layer name. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="name"> (str)  Net name. </param>
    ...
    ## License requirements: None.
    ## 
    ## <param name="name"> (str)  Padstack name. </param>
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## 
    ## <param name="importOption"> (@link ExternalDataImportBuilder.JaPcbExternalDataImportBuilderImportoption NXOpen.PcbExchange.ExternalDataImportBuilder.JaPcbExternalDataImportBuilderImportoption@endlink)  Import option. </param>
    ...
    ## 
    ## <param name="name"> (str)  Padstack name. </param>
    ## <param name="part"> (str)  Part file. </param>
...
class Manager(NXOpen.Object): 
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    ## <param name="areaMapping"> (@link AreaMapping NXOpen.PcbExchange.AreaMapping@endlink)  the area mapping to be edited </param>
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink)  part </param>
    @overload
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="ruleToEdit"> (@link DesignRule NXOpen.PcbExchange.DesignRule@endlink)  rule to edit </param>
    @overload
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    ## <param name="entityFilter"> (@link EntityFilter NXOpen.PcbExchange.EntityFilter@endlink)  the entity filter to be edited </param>
    ...
    ##  Creates an instance of @link PcbExchange::ThermalSolutionBuilder PcbExchange::ThermalSolutionBuilder@endlink . 
    ##  @return builder (@link ThermalSolutionBuilder NXOpen.PcbExchange.ThermalSolutionBuilder@endlink):  created builder. .
    ## 
    ##   <br>  Created in NX2406.0.0  <br> 
...
class NotificationManager(NXOpen.Object): 
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="pendingComponent"> (str)  pending component to be deleted from PCB navigator. </param>
...
class PendingComponentManager(NXOpen.Object): 
    ...
    ## License requirements: nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken")
    ## <param name="pendingComponents"> (List[str])  pending components. </param>
    ## <param name="isNonGeometric"> (bool)  non-Geometric flag. </param>
...
class PreferencesBuilder(NXOpen.Builder): 
    ...
    ##  Returns the defining state for flags of whether to import and/or export flexible printed circuit boards in their bent state instead of their flat state.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##  Returns the flag indicating whether to merge traces and/or pads.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    ## 
    ## <param name="mMailRecipients"> (List[str])  The mail recipient </param>
...
class ThermalSolutionBuilder(NXOpen.Builder): 
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## CreateSolution</term><description> 
    ## </description> </item><item><term> 
    ## UpdateSolution</term><description> 
    ## </description> </item></list>
    class ActionOption(Enum):
        """
        Members Include: <CreateSolution> <UpdateSolution>
        """
        CreateSolution: int
        UpdateSolution: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    class BoundaryConditionOption(Enum):
        """
        Members Include: <NotSet> <Thermal>
        """
        NotSet: int
        Thermal: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Board</term><description> 
    ## </description> </item><item><term> 
    ## BoardComponents</term><description> 
    ## </description> </item></list>
    class MeshOption(Enum):
        """
        Members Include: <Board> <BoardComponents>
        """
        Board: int
        BoardComponents: int
        ## Returns enum member equivalent to the value passed. Useful for bit operations of enum members.
    ...
    ## Thermal</term><description> 
    ## </description> </item><item><term> 
    ## ElectronicSystemsCooling</term><description> 
    ## </description> </item><item><term> 
    ## SpaceSystemsThermal</term><description> 
    ## </description> </item><item><term> 
    ## Floefd</term><description> 
    ## </description> </item></list>
    class SolutionTypeOption(Enum):
        """
        Members Include: <Thermal> <ElectronicSystemsCooling> <SpaceSystemsThermal> <Floefd>
        """
        Thermal: int
    ...
    ## Enumerator</term><description> 
    ## Comment</description> </listheader><item><term> 
    ## UpdateComponents</term><description> 
    ## </description> </item><item><term> 
    ## UpdatePCB</term><description> 
    ## </description> </item></list>
    class UpdateOption(Enum):
        """
        Members Include: <UpdateComponents> <UpdatePCB>
        """
    ...
    ## Getter for property: (@link ThermalSolutionBuilder.ActionOption NXOpen.PcbExchange.ThermalSolutionBuilder.ActionOption@endlink) Action
    ##  Returns the action.  
    ##      
    ##  
    ## Getter License requirements: None.
    ...
    ## @return ThermalSolutionBuilder.ActionOption
    @property
    ...
    ## Setter for property: (@link ThermalSolutionBuilder.ActionOption NXOpen.PcbExchange.ThermalSolutionBuilder.ActionOption@endlink) Action
    ...
    ## Getter for property: (@link ThermalSolutionBuilder.BoundaryConditionOption NXOpen.PcbExchange.ThermalSolutionBuilder.BoundaryConditionOption@endlink) BoundaryConditionType
    ...
    ## @return ThermalSolutionBuilder.BoundaryConditionOption
    @property
    ...
    ## Setter for property: (@link ThermalSolutionBuilder.BoundaryConditionOption NXOpen.PcbExchange.ThermalSolutionBuilder.BoundaryConditionOption@endlink) BoundaryConditionType
    ...
    ## Getter for property: (@link ThermalSolutionBuilder.MeshOption NXOpen.PcbExchange.ThermalSolutionBuilder.MeshOption@endlink) MeshType
    ...
    ## @return ThermalSolutionBuilder.MeshOption
    @property
    ...
    ## Setter for property: (@link ThermalSolutionBuilder.MeshOption NXOpen.PcbExchange.ThermalSolutionBuilder.MeshOption@endlink) MeshType
    ...
    ## Getter for property: (@link ThermalSolutionBuilder.SolutionTypeOption NXOpen.PcbExchange.ThermalSolutionBuilder.SolutionTypeOption@endlink) SolutionType
    ...
    ## @return ThermalSolutionBuilder.SolutionTypeOption
    @property
    ...
    ## Setter for property: (@link ThermalSolutionBuilder.SolutionTypeOption NXOpen.PcbExchange.ThermalSolutionBuilder.SolutionTypeOption@endlink) SolutionType
    ...
    ## Getter for property: (@link ThermalSolutionBuilder.UpdateOption NXOpen.PcbExchange.ThermalSolutionBuilder.UpdateOption@endlink) UpdateType
    ...
    ## @return ThermalSolutionBuilder.UpdateOption
    @property
    ...
    ## Setter for property: (@link ThermalSolutionBuilder.UpdateOption NXOpen.PcbExchange.ThermalSolutionBuilder.UpdateOption@endlink) UpdateType
    ...
    ##  @return A tuple consisting of (simNumber, simRevision, femNumber, femRevision, iPartNumber, iPartRevision). 
    ##  - simNumber is: str.
    ##  - simRevision is: str.
    ##  - femNumber is: str.
    ##  - femRevision is: str.
...
## Comment</description> </listheader><item><term> 
## All</term><description> 
##  Any wire bond. </description> </item><item><term> 
## Top</term><description> 
##  The Top wire bond. </description> </item><item><term> 
## Bottom</term><description> 
##  The Bottom wire bond. </description> </item></list>
...
##  @link BoardPropertiesBuilderGeneratorOption NXOpen.PcbExchange.BoardPropertiesBuilderGeneratorOption @endlink is an alias for @link BoardPropertiesBuilder.GeneratorOption NXOpen.PcbExchange.BoardPropertiesBuilder.GeneratorOption@endlink
BoardPropertiesBuilderGeneratorOption = BoardPropertiesBuilder.GeneratorOption
...
##  @link ThermalSolutionBuilderActionOption NXOpen.PcbExchange.ThermalSolutionBuilderActionOption @endlink is an alias for @link ThermalSolutionBuilder.ActionOption NXOpen.PcbExchange.ThermalSolutionBuilder.ActionOption@endlink
ThermalSolutionBuilderActionOption = ThermalSolutionBuilder.ActionOption


##  @link ThermalSolutionBuilderBoundaryConditionOption NXOpen.PcbExchange.ThermalSolutionBuilderBoundaryConditionOption @endlink is an alias for @link ThermalSolutionBuilder.BoundaryConditionOption NXOpen.PcbExchange.ThermalSolutionBuilder.BoundaryConditionOption@endlink
ThermalSolutionBuilderBoundaryConditionOption = ThermalSolutionBuilder.BoundaryConditionOption


##  @link ThermalSolutionBuilderMeshOption NXOpen.PcbExchange.ThermalSolutionBuilderMeshOption @endlink is an alias for @link ThermalSolutionBuilder.MeshOption NXOpen.PcbExchange.ThermalSolutionBuilder.MeshOption@endlink
ThermalSolutionBuilderMeshOption = ThermalSolutionBuilder.MeshOption


##  @link ThermalSolutionBuilderSolutionTypeOption NXOpen.PcbExchange.ThermalSolutionBuilderSolutionTypeOption @endlink is an alias for @link ThermalSolutionBuilder.SolutionTypeOption NXOpen.PcbExchange.ThermalSolutionBuilder.SolutionTypeOption@endlink
ThermalSolutionBuilderSolutionTypeOption = ThermalSolutionBuilder.SolutionTypeOption


##  @link ThermalSolutionBuilderUpdateOption NXOpen.PcbExchange.ThermalSolutionBuilderUpdateOption @endlink is an alias for @link ThermalSolutionBuilder.UpdateOption NXOpen.PcbExchange.ThermalSolutionBuilder.UpdateOption@endlink
ThermalSolutionBuilderUpdateOption = ThermalSolutionBuilder.UpdateOption
