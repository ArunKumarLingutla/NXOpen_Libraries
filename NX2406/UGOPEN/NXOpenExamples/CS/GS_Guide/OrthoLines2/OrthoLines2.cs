...
namespace OrthoLines2
{
    public class Ortho
    {
        ...
        private NXOpen.BlockStyler.Button thinDashedButton;     // Block type: Button
        private NXOpen.BlockStyler.Button thickSolidButton;     // Block type: Button
        ...
        public int update_cb(NXOpen.BlockStyler.UIBlock block)
        {
            try
            {
                ...
                else if (block == thinDashedButton)
                {
                ...
                else if (block == thickSolidButton)
                {
                    // ---- Enter your code here -----
                    myLine = CreateLine();
