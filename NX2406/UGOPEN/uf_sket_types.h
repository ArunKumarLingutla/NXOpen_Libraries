...
enum UF_SKET_con_type_e
{
    UF_SKET_no_con                      = 0,
    UF_SKET_fixed                       = 1,
    UF_SKET_horizontal                  = 2,
    UF_SKET_vertical                    = 3,
    UF_SKET_parallel                    = 4,
    UF_SKET_perpendicular               = 5,
    UF_SKET_collinear                   = 6,
    UF_SKET_equal_length                = 7,
    UF_SKET_equal_radius                = 8,
    UF_SKET_constant_length             = 9,
    UF_SKET_constant_angle              = 10,
    UF_SKET_coincident                  = 11,
    UF_SKET_concentric                  = 12,
    UF_SKET_mirror                      = 13,
    UF_SKET_point_on_curve              = 14,
    UF_SKET_midpoint                    = 15,
    UF_SKET_tangent                     = 16,
    UF_SKET_radius_dim                  = 17,
    UF_SKET_diameter_dim                = 18,
    UF_SKET_horizontal_dim              = 19,
    UF_SKET_vertical_dim                = 20,
    UF_SKET_parallel_dim                = 21,
    UF_SKET_perpendicular_dim           = 22,
    UF_SKET_angular_dim                 = 23,
    UF_SKET_reserved_con_1              = 24,   /* Do not use */
    UF_SKET_reserved_con_2              = 25,   /* Do not use */
    UF_SKET_reserved_con_3              = 26,   /* Do not use */
    UF_SKET_reserved_con_4              = 27,   /* Do not use */
    UF_SKET_reserved_con_5              = 28,   /* Do not use */
    UF_SKET_reserved_con_6              = 29,   /* Do not use */
    UF_SKET_point_on_string             = 30,
    UF_SKET_slope                       = 31,
    UF_SKET_uniform_scaled              = 32,
    UF_SKET_non_uniform_scaled          = 33,
    UF_SKET_assoc_trim                  = 34,   /* Limited support */
    UF_SKET_assoc_offset                = 35,   /* Limited support */
    UF_SKET_perimeter_dim               = 36,
    UF_SKET_pgm_offset                  = 37,
    UF_SKET_normal                      = 38,
    UF_SKET_point_on_loop               = 39,
    UF_SKET_recipe_trim                 = 40,
    UF_SKET_pattern                     = 41,
    UF_SKET_rigid_set                   = 42,
    UF_SKET_g1                          = 43,
    UF_SKET_g2                          = 44,
    UF_SKET_align                       = 45,
    UF_SKET_tangent_to_string           = 46,
    UF_SKET_perpendicular_to_string     = 47,
    UF_SKET_scalable_set                = 48,
    UF_SKET_reserved_con_9              = 49,   /* Do not use */
    UF_SKET_reserved_con_10              = 50,   /* Do not use */
    UF_SKET_fillet                      = 51,
    UF_SKET_slot                     = 52,
...
#define UF_SKET_MAX_CON_TYPES 53
