    ...
    namespace BlockStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  IntegerTable : public NXOpen::BlockStyler::UIBlock
        {
            ...
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::BlockStyler::IntegerTable::JA_BLOCK_STYLER_INTEGER_TABLE_get_column_titles instead.") NXString ColumnTitles
            (
            );
            /**Sets  the ColumnTitles
             ...
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::BlockStyler::IntegerTable::JA_BLOCK_STYLER_INTEGER_TABLE_set_column_titles instead.") void SetColumnTitles
            (
