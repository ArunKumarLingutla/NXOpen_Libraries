...
//
//  Source File:
//     Annotations_BaseHorizontalDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseHorizontalDimensionBuilder;
        class BaseHorizontalDimensionImpl;
        /** Represents a horizontal dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseHorizontalDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi, public virtual NXOpen::Annotations::ISlotDimension
        {
            private: BaseHorizontalDimensionImpl * m_basehorizontaldimension_impl;
            private: friend class  _BaseHorizontalDimensionBuilder;
            protected: BaseHorizontalDimension();
            public: ~BaseHorizontalDimension();
