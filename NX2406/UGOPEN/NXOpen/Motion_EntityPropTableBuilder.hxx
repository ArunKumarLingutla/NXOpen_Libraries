    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  EntityPropTableBuilder : public NXOpen::Motion::MotionBuilder
        {
            ...
            /** Sets the integer value of the property from expression 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetIntegerExpressionPropertyValue
            (
                const NXString & propertyName /** name of the property */,
                const NXString & propertyValue /** The string value for the integer */
            );
            /** Sets the integer value of the property from expression 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            ...
            (
                const char * propertyName /** name of the property */,
                const char * propertyValue /** The string value for the integer */
            );
            ...
            /** Returns the multiple referenced object values of the property  @return  value of the property 
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::NXObject *> GetMultipleColumnListPropertyValue
            (
                const NXString & propertyName /** name of the property */
            );
            /** Returns the multiple referenced object values of the property  @return  value of the property 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            std::vector<NXOpen::NXObject *> GetMultipleColumnListPropertyValue
            (
                const char * propertyName /** name of the property */
            );
            /** Sets the multiple referenced object values of the property 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMultipleColumnListPropertyValue
            (
                const NXString & propertyName /** name of the property */,
                const std::vector<NXOpen::NXObject *> & propertyValue /** value of the property */
            );
            /** Sets the multiple referenced object values of the property 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            void SetMultipleColumnListPropertyValue
            (
                const char * propertyName /** name of the property */,
                const std::vector<NXOpen::NXObject *> & propertyValue /** value of the property */
            );
