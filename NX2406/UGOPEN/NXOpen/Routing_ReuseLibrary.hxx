        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  ReuseLibrary
        {
            ...
            /** Given a node identifier, this routine will return all parts associated with that node. @return  An array of parts. 
             <br>  @deprecated Deprecated in NX2406.0.0.  Use @link NXOpen::Routing::ReuseLibrary::GetPartInformationAtNode NXOpen::Routing::ReuseLibrary::GetPartInformationAtNode@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::Routing::ReuseLibrary::GetPartInformationAtNode instead.") NXOpen::Routing::CharacteristicList * PartLibraryGetPartsAtNode
            (
                const NXString & nodeIdentifier /** A part library node identifier. */
            );
            /** Given a node identifier, this routine will return all parts associated with that node. @return  An array of parts. 
            ...
            /** Given a node identifier, this routine will return all parts associated with that node. @return  An array of parts. 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::CharacteristicList *> GetPartInformationAtNode
            (
                const NXString & nodeIdentifier /** A part library node identifier. */
            );
            /** Given a node identifier, this routine will return all parts associated with that node. @return  An array of parts. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            std::vector<NXOpen::Routing::CharacteristicList *> GetPartInformationAtNode
            (
                const char * nodeIdentifier /** A part library node identifier. */
            );
