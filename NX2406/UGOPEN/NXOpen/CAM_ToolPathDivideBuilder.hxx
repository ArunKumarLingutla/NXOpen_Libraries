    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ToolPathDivideBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the non-cutting engage retract builder 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NcmEngRetBuilder * NcmEngageRetractBuilder
            (
            );
            /**Returns  the tool path split parameters builder 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
