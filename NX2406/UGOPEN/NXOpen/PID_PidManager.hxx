...
#include <NXOpen/PID_DesignValidationBuilder.hxx>
        ...
        class PIDOPENCPPEXPORT  PidManager
        {
            ...
            */
            ...
            /** Exports @link NXOpen::PDM::ElementGroup NXOpen::PDM::ElementGroup@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            public: void ExportRunManagedWithSpecificName
            (
                const std::vector<NXOpen::NXObject *> & runTags /** The runs to be exported */,
                const std::vector<NXString> & fileNames /** The Output file names */,
                const NXString & destination /** The destination folder */
            ...
            /** Exports @link NXOpen::PDM::ElementGroup NXOpen::PDM::ElementGroup@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            void ExportRunManagedWithSpecificName
            (
                const std::vector<NXOpen::NXObject *> & runTags /** The runs to be exported */,
                const std::vector<NXString> & fileNames /** The Output file names */,
                const char * destination /** The destination folder */
            ...
            /** Gets the @link NXOpen::PID::Sheet NXOpen::PID::Sheet@endlink  from part. 
             ...
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            public: NXOpen::PID::Sheet * GetSheet
            (
                NXOpen::Part * part /** the sheet part */
            );
            ...
            public: void GetSheetsInSystem
            (
                NXOpen::Assemblies::Partition * system /** system */ ,
                std::vector<NXOpen::PID::Sheet *> & sheets /** the sheet objects */
            );
            ...
            /** Creates a @link NXOpen::PID::DesignValidationBuilder NXOpen::PID::DesignValidationBuilder@endlink . 
             ...
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            public: NXOpen::PID::DesignValidationBuilder * CreateDesignValidationBuilder
            (
                NXOpen::Part * part /** the part that will own the object */
            );
