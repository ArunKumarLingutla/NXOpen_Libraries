    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  AnimationControl : public NXOpen::Motion::PostControl
        {
            ...
            /** Reload results and update animation time and steps. Useful in the
                    case of animation during background solve. 
            ...
            /** Get animation motion body transformation  @return  The motion body transformation matrix at the input step 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Matrix4x4 GetLinkTransformation
            (
                NXOpen::Motion::Link * linkTag /** The motion body object */,
                int inputStep /** The step to query the transformation */
            );
            ...
            /** Add additional solutions for animation
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void AddSolutions
            (
                const std::vector<NXOpen::Motion::MotionSolution *> & solutionTags /** Solution tags array */
            );
        };
    }
}
