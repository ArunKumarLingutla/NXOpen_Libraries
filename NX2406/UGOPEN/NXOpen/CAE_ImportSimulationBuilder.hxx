    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ImportSimulationBuilder : public NXOpen::Builder
        {
            ...
            /** Set selected load sets to import
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetLoadSets
            (
                const std::vector<NXOpen::CAE::SimLoadSet *> & loadSets /** Load sets to import @link NXOpen::CAE::SimLoadSet NXOpen::CAE::SimLoadSet@endlink */
            );
            /** Set selected constraint sets to import
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetConstraintSets
            (
                const std::vector<NXOpen::CAE::SimConstraintSet *> & constraintSets /** Load sets to import @link NXOpen::CAE::SimConstraintSet NXOpen::CAE::SimConstraintSet@endlink */
            );
            ...
            (
                const NXString & suffixString /** Suffix string */
            );
            /** Set suffix string 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            (
                const char * suffixString /** Suffix string */
            );
            /** Set expression conflict options 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetExpressionConflictOption
            (
                NXOpen::CAE::ImportSimulationBuilder::ExpressionConflictOption option /** expression conflict option */
            );
        };
    }
}
