...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _DatumBuilder;
        class DatumImpl;
        /** Represents a datum  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiDatumFeatureSymbolBuilder  NXOpen::Annotations::PmiDatumFeatureSymbolBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Datum : public NXOpen::Annotations::DraftingDatum, public virtual NXOpen::Annotations::IPmi
        {
