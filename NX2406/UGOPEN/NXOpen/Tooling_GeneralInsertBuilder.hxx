...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        SideAttributeValue </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  GeneralInsertBuilder : public NXOpen::Builder
        {
            ...
            public: enum SideAttributeValues
            {
                ...
                SideAttributeValuesMiddle/** the MIDDLE value */,
            ...
            /**Returns  the side attribute value for general insert. 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::GeneralInsertBuilder::SideAttributeValues SideAttributeValue
            (
            );
            ...
            (
                NXOpen::Tooling::GeneralInsertBuilder::SideAttributeValues sideAttributeValue /** Indicates the side attribute value for general insert */
            );
            ...
            /**Returns  the insert component. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::TaggedObject * InsertComponent
            (
            );
            /**Sets  the insert component. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetInsertComponent
            (
                NXOpen::TaggedObject * insertComponent /** Specifies the the insert component tag */
            );
