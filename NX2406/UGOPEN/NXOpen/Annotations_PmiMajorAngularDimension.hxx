...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI major angular dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiMajorAngularDimensionBuilder  NXOpen::Annotations::PmiMajorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiMajorAngularDimension : public NXOpen::Annotations::PmiAngularDimension, public virtual NXOpen::Annotations::IPmi
        {
