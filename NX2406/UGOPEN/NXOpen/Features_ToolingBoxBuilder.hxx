...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        OffsetNegativeX.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        OffsetNegativeY.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        OffsetNegativeZ.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        OffsetPositiveX.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        OffsetPositiveY.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        OffsetPositiveZ.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        RadialOffset.Value </term> <description> 
        ...
        SingleOffset </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        XValue.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        YValue.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        ZValue.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ToolingBoxBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** the aligned orientation type of the bounding block*/
            ...
            /** Asks the selected object occurrences. 
             <br>  Created in NX2312.4000.0.  <br>  
             <br> License requirements : None */
            public: void GetSelectedOccurrences
            (
                std::vector<NXOpen::NXObject *> & selectedObjects /** the selected occurrences. */
            );
            ...
            (
                NXOpen::Point * axisPoint /** axispoint */ 
            );
            /**Returns  the value that indicates whether to create reference expressions of bounding body size or not. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool NeedReferenceExpression
            (
            );
            /**Sets  the value that indicates whether to create reference expressions of bounding body size or not. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR studio_free_form ("STUDIO FREE FORM") OR features_modeling ("FEATURES MODELING") OR solid_modeling ("SOLIDS MODELING") */
            public: void SetNeedReferenceExpression
            (
                bool bNeedReferenceExp /** bneedreferenceexp */ 
            );
            /** Asks block bounding box size. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR studio_free_form ("STUDIO FREE FORM") OR features_modeling ("FEATURES MODELING") OR solid_modeling ("SOLIDS MODELING") */
            public: void AskBlockBoundingBoxSize
            (
                double* xLength /** xlength */ ,
                double* yLength /** ylength */ ,
                double* zLength /** zlength */ ,
                NXOpen::Point3d* leftLowerPoint /** leftlowerpoint */ 
            );
            /** Asks cylinder bounding box size. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR studio_free_form ("STUDIO FREE FORM") OR features_modeling ("FEATURES MODELING") OR solid_modeling ("SOLIDS MODELING") */
            public: void AskCylinderBoundingBoxSize
            (
                double* diameter /** diameter */ ,
                double* height /** height */ ,
                NXOpen::Point3d* lowerCenterPoint /** lowercenterpoint */ 
            );
            /** Asks non-aligned minimum bounding box size. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR studio_free_form ("STUDIO FREE FORM") OR features_modeling ("FEATURES MODELING") OR solid_modeling ("SOLIDS MODELING") */
            public: void AskNonAlignedMinimumBoxSize
            (
                double* xLength /** xlength */ ,
                double* yLength /** ylength */ ,
                double* zLength /** zlength */ ,
            ...
            /**Returns  the aligned orientation type of the bounding block 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ToolingBoxBuilder::AlignedBlockType AlignedType
            (
            );
            /**Sets  the aligned orientation type of the bounding block 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR studio_free_form ("STUDIO FREE FORM") OR features_modeling ("FEATURES MODELING") OR solid_modeling ("SOLIDS MODELING") */
            public: void SetAlignedType
            (
                NXOpen::Features::ToolingBoxBuilder::AlignedBlockType alignedType /** alignedtype */ 
            );
        };
    }
}
