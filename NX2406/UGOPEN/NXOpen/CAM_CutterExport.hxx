    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  CutterExport : public NXOpen::TaggedObject
        {
            ...
            /** the holder export status*/
            public: enum ShankExportStatus
            {
                ShankExportStatusOk/** Shank has been export successfully */,
                ShankExportStatusUnchanged/** Shank in library unchanged*/,
                ShankExportStatusUndefined/** Shank is not defined */,
                ShankExportStatusUntried/** Shank export didn't happen */,
                ShankExportStatusFail/** Shank export failed */
            };
            ...
            /** The shank export entry  @return  The shank export status 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CutterExport::ShankExportStatus ExportShank
            (
            );
            /** The flag indicate export status of shank  @return  The shank export status 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CutterExport::ShankExportStatus GetShankExportStatus
            (
            );
            /**Returns  the libref of the export shank
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXString ShankLibref
            (
            );
            /**Sets  the libref of the export shank
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetShankLibref
            (
                const NXString & libref /** The libref */
            );
            /**Sets  the libref of the export shank
            ...
            /**Returns  the shank export type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CutterExport::SaveFlags ShankSaveFlag
            (
            );
            /**Sets  the shank export type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetShankSaveFlag
            (
                NXOpen::CAM::CutterExport::SaveFlags saveFlag /** The shank export type */
            );
        };
    }
}
