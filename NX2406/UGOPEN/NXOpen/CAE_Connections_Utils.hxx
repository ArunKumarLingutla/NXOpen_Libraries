            ...
            */
            class NXOPENCPP_CAEEXPORT  Utils
            {
                ...
                /** Returns the projection points of the connections per geometry faces
                 ...
                 <br> License requirements : None */
                public: void GetProjectionPointsOnFaces
                (
                    const std::vector<NXOpen::CAE::Connections::IConnection *> & iConnections /** The array of input connections */,
                    std::vector<NXOpen::CAE::CAEFace *> & oFaces /** The array of the geometry face objects */,
                    std::vector<NXOpen::Point3d> & oProjectionPoints /** The array of the projection points */,
                    std::vector<int> & oFaceObjectIndexList /** The array of projection point index ranges per faces. The size of the array is number of faces + 1. For the face i the index range is [oFaceObjectIndexList[i], ..., oFaceObjectIndexList[i + 1] - 1]. */
                );
                ...
                /** Print the connection's information file 
                 ...
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void PrintConnectionInformationFile
                (
                ...
                /** Print the connection element's information file 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void PrintConnectionElementInformationFile
                (
                    NXOpen::CAE::Connections::Element * connectionElement /** connectionelement */ 
                );
