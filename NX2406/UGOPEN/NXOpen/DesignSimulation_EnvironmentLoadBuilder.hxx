        ...
        */
        class NXOPENCPP_DESIGNSIMULATIONEXPORT  EnvironmentLoadBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the control to enable / disable use of ambient temperature for thermal analysis 
             ...
             <br> License requirements : None */
            public: bool AmbientTemperatureEnabled
            (
            );
            /**Sets  the control to enable / disable use of ambient temperature for thermal analysis 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") OR nx_perf_predictor (" Performance Predictor") */
            public: void SetAmbientTemperatureEnabled
            (
                bool enable /** enable */ 
            );
            /**Returns  the ambient temperature magnitude 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * AmbientTemperatureMagnitude
            (
            );
        };
    }
