        ...
        */
        class NXOPENCPP_FIELDSEXPORT  ExternalFileProfileBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            public: enum DimensionChoice
            {
                ...
                DimensionChoiceAny/** undefined dimension, which an existing profile can never actually have */
            };
            ...
            /**Returns   @brief 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::XInterpolation instead.") NXOpen::Fields::ExternalFileProfileBuilder::Interpolation XInterpolation
            (
            );
            /**Sets   @brief 
                        the interpolation in x direction.
            ...
            /**Returns   @brief 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::YInterpolation instead.") NXOpen::Fields::ExternalFileProfileBuilder::Interpolation YInterpolation
            (
            );
            /**Sets   @brief 
                        the interpolation in y direction.
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::SetYInterpolation instead.") void SetYInterpolation
            (
                NXOpen::Fields::ExternalFileProfileBuilder::Interpolation interpolation /** interpolation */ 
            );
            /**Returns   @brief 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::XExtrapolation instead.") NXOpen::Fields::ExternalFileProfileBuilder::Extrapolation XExtrapolation
            (
            );
            /**Sets   @brief 
                        the extrapolation in x direction.
            ...
            /**Returns   @brief 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::YExtrapolation instead.") NXOpen::Fields::ExternalFileProfileBuilder::Extrapolation YExtrapolation
            (
            );
            /**Sets   @brief 
                        the extrapolation in y direction.
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::SetYExtrapolation instead.") void SetYExtrapolation
            (
                NXOpen::Fields::ExternalFileProfileBuilder::Extrapolation extrapolation /** extrapolation */ 
            );
            /**Returns   @brief 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Fields::ProfileSolverOptionsBuilder::Cyclic instead.") NXOpen::Fields::ExternalFileProfileBuilder::CyclicType Cyclic
            (
            );
            /**Sets   @brief 
                        the cyclic type.
