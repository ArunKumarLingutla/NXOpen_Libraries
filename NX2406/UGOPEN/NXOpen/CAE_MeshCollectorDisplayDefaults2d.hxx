...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshCollectorDisplayDefaults2d : public NXOpen::CAE::MeshCollectorDisplayDefaults
        {
            ...
            /**Returns  the element plane stress bolt-hole centerline display setting. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool DisplayBoltHoleCenterline
            (
            );
            /**Sets  the element plane stress bolt-hole centerline display setting. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
