        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  PlacePartBuilder : public NXOpen::Builder
        {
            ...
            /** Get the reference set for the loaded part. 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXString GetActiveRefSet
            (
            );
            ...
            /** Gets the count of placed occurrences.   @return  The total number of occs. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: int GetNumberOfPlacedOccurrences
            (
            );
            /** Gets placed occurrences.   @return  The placed occurrence. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::TaggedObject * GetPlacedOccurrence
            (
                int index /** index */ 
            );
            /** Sets a post placed occurrence. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void AddPlacedOccurrence
            (
                NXOpen::TaggedObject * occTag /** The post placed occurrence. */
            );
        };
    }
}
