    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimConditionParam : public NXOpen::TaggedObject
        {
            ...
            /** Plots or overlays graphs of the @link NXOpen::CAE::SimConditionParam NXOpen::CAE::SimConditionParam@endlink           @return  Created plot 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::Xyplot::Plot * XYGraph
            (
