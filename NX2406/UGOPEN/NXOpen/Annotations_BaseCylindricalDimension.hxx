...
//
//  Source File:
//     Annotations_BaseCylindricalDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseCylindricalDimensionBuilder;
        class BaseCylindricalDimensionImpl;
        /** Represents a cylindrical dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseCylindricalDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseCylindricalDimensionImpl * m_basecylindricaldimension_impl;
            private: friend class  _BaseCylindricalDimensionBuilder;
            protected: BaseCylindricalDimension();
            public: ~BaseCylindricalDimension();
