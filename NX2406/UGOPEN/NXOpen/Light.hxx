    ...
    */
    class NXOPENCPPEXPORT  Light : public NXOpen::NXObject
    {
        /**
             ...
             @link Display::LightTypeScene Display::LightTypeScene@endlink .  Except for ambient light, all of the other lights
             are on the same side of the model as the observer.
            */
        public: enum SceneType
        {
            SceneTypeNotASceneLight/** The light is not a scene light */ = -1,
        ...
        /** Whether a light is to be enabled in a given view.  true means
                ...
                of type @link Display::LightTypeScene Display::LightTypeScene@endlink . 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        ...
        (
            NXOpen::Display::LightType* lightType /** the type of light */,
