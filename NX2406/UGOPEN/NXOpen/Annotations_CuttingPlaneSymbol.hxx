...
//
//  Source File:
//     Annotations_CuttingPlaneSymbol.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _CuttingPlaneSymbolBuilder;
        class CuttingPlaneSymbolImpl;
        /** Represents a Cutting Plane Symbol  <br> Created with LightweightSection  <br> 
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  CuttingPlaneSymbol : public NXOpen::Annotations::Annotation, public virtual NXOpen::Annotations::IPmi
        {
            private: CuttingPlaneSymbolImpl * m_cuttingplanesymbol_impl;
            private: friend class  _CuttingPlaneSymbolBuilder;
            protected: CuttingPlaneSymbol();
            public: ~CuttingPlaneSymbol();
            /**Returns  the parent section view
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::View * SectionView
            (
            );
