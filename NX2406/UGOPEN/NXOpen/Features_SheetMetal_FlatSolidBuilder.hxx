...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            TransformComponents </term> <description> 
             
            None </description> </item> 

            <item><term> 
             
            TransformRestrictionAreas </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  FlatSolidBuilder : public NXOpen::Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                */
                ...
                /** The enum defines how layer should be applied to Flat Solid body. 
                 <br>  Created in NX1980.0.0.  <br>  
                */
                public: enum LayerSettingOption
                {
                    LayerSettingOptionDefault/** default */ ,
                    LayerSettingOptionPreference/** preference */ ,
                    LayerSettingOptionSpecify/** specify */ 
                };
                ...
                /**Returns  the flag which decides whether copies of associated objects will remain associated
                 ...
                 <br> License requirements : None */
                public: bool AutoAssociateObjects
                (
                );
                /**Sets  the flag which decides whether copies of associated objects will remain associated
                                to faces of flat solid body during down stream unbend, rebend and bend operations.
                            
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetAutoAssociateObjects
                (
                    bool isAutoAssociate /** True =  Objects will be automatically associated to their faces, False = Objects will not be automatically associated to their faces. */
                );
                /**Returns  the layer setting.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::FlatSolidBuilder::LayerSettingOption LayerSetting
                (
                );
                ...
                (
                    NXOpen::Features::SheetMetal::FlatSolidBuilder::LayerSettingOption layerSetting /** layersetting */ 
                );
                /**Returns the color of flat solid body.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: int FlatBodyColor
                (
                );
                /**Sets the color of flat solid body.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") OR nx_sheet_metal ("NX Sheet Metal") */
                public: void SetFlatBodyColor
                (
                    int color /** color */ 
                );
                /**Returns the layer of flat solid body.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: int FlatBodyLayer
                (
                );
                /**Sets the layer of flat solid body.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") OR nx_sheet_metal ("NX Sheet Metal") */
                public: void SetFlatBodyLayer
                (
                    int layer /** layer */ 
                );
                /**Returns  the setting indicating whether to transform Pins and CCPs in flat solid.
                 ...
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: bool TransformPinAndCCP
                (
                );
                /**Sets  the setting indicating whether to transform Pins and CCPs in flat solid.
                            Only applies to the Flexible Printed Circuit Design application and will have no effect in Sheet Metal. 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetTransformPinAndCCP
                (
                    bool transformPinAndCCP /** transformpinandccp */ 
                );
                /**Returns  the setting indicating whether to associate component layer.
                            Only applies to the Flexible Printed Circuit Design application and will have no effect in Sheet Metal. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: bool AutoAssignComponentLayer
                (
                );
                /**Sets  the setting indicating whether to associate component layer.
                            Only applies to the Flexible Printed Circuit Design application and will have no effect in Sheet Metal. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetAutoAssignComponentLayer
                (
                    bool autoAssignComponentLayer /** autoassigncomponentlayer */ 
                );
            };
        }
    }
