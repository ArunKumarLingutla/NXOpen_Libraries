...
//
//  Source File:
//     Annotations_BaseRadiusDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseRadiusDimensionBuilder;
        class BaseRadiusDimensionImpl;
        /** Represents a radius dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseRadiusDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseRadiusDimensionImpl * m_baseradiusdimension_impl;
            private: friend class  _BaseRadiusDimensionBuilder;
            protected: BaseRadiusDimension();
            public: ~BaseRadiusDimension();
            /** Returns the radius dimension type 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::RadiusDimensionType GetRadiusDimensionType
            (
            );
