    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionMethods
        {
            ...
            /** Check all motion objects 
                        If model exists, use this existing model to avoid duplicate creation; if model doesn't exist, create a new one.
                        This will speedup model check if the model has been already created and there is no change after creation
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void ModelCheckNoRecreateModel
            (
                bool listWarning /** whether to display the checking result if only warnings found without error */
            );
            ...
            /** Clone a motion object
                        Note that not all motion objects support the clone command.
                        For solutions, please use JA_MOTION_SOLUTION_clone_solution. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::MotionObject * CloneObject
            (
                NXOpen::Motion::MotionObject * objectToClone /** objecttoclone */ 
            );
            /** Clone multiple motion objects
                        Note that not all motion objects support the clone command.
                        For solutions, please use JA_MOTION_SOLUTION_clone_solution. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void CloneMultipleObjects
            (
                NXOpen::Motion::MotionObject * objectToClone /** objecttoclone */ ,
                int numClones /** numclones */ ,
                std::vector<NXOpen::Motion::MotionObject *> & clonedObjects /** clonedobjects */ 
            );
