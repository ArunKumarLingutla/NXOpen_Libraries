...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        CreatePartingLinesToggle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CreateRegionsToggle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CreateSheetBoundaryDisplay </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DisplayPartingLines </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TranslucencyOption </term> <description> 
         
        SelectedFaces </description> </item> 

        <item><term> 
         
        TranslucencyValueScale </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MWDefineRegionsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the product bodies for region faces 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectBodyList * ProductBodies
            (
            );
            ...
            /**Returns  the option to create sheet boundary display 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateSheetBoundaryDisplay
            (
            );
            /**Sets  the option to create sheet boundary display 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCreateSheetBoundaryDisplay
            (
                bool createSheetBoundaryDisplay /** createsheetboundarydisplay */ 
            );
            /**Returns  the option to display parting lines 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayPartingLines
            (
            );
            /**Sets  the option to display parting lines 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDisplayPartingLines
            (
                bool displayPartingLines /** displaypartinglines */ 
            );
            ...
            /** Turn on/off the display of Sheet Boundary AOs associated with the region 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void TurnOnOrOffRegionUDOSheetBoundaryAOs
            (
                NXOpen::TaggedObject * regionUDO /** Region UDO associated with the Sheet Boundary analysis objects */,
                bool onOff /** Flag for turning on/off the display of the associated Sheet Boundary AOs */
            );
        };
    }
}
