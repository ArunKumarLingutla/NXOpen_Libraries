        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadSet : public NXOpen::CAE::NamedPropertyTable, public virtual NXOpen::CAE::IExportableFEEntity
        {
            ...
            public: enum Type
            {
                ...
                TypeCyclicFrequency/** Cyclic Symmetry Frequency Excitation Set. */,
                TypeAcousticSource/** Acoustic Source Load Set. */
            };
            ...
            /** Copies a @link CAE::SimLoadSet CAE::SimLoadSet@endlink   @return  copied load set
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SimLoadSet * Copy
            (
            );
