...
namespace NXOpen
{
    ...
    */
    class NXOPENJAMTESTCPPEXPORT  JamNXColor
    {
        ...
        private: explicit JamNXColor(int handle) : m_jamnxcolor_impl(nullptr) , m_handle(handle) {}
        ...
        /// This function should be considered "private" to the NX internal implementation. */
