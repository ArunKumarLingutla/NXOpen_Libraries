...
namespace NXOpen
{
    ...
    InterPartSelectionType </term> <description> 
     
    AssociativeAndNonAssociative </description> </item> 
    ...
    RetainPartLoadStatusForCollector </term> <description> 
     
    0 </description> </item> 

    <item><term> 
     
    RetainPartLoadStatusForSection </term> <description> 
    ...
    */
    ...
    {
        /** This enum specifies selection types */

        /// \cond NX_NO_DOC 
        public: enum InterPartSelectionTypes
        {
            InterPartSelectionTypesSimpleSelection/** simple selection */ ,
            InterPartSelectionTypesNonAssociative/** non associative */ ,
            InterPartSelectionTypesAssociativeAndNonAssociative/** associative and non associative */ ,
            InterPartSelectionTypesAssociative/** associative */ 
        };
        ...
        /**Returns  This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: bool RetainPartLoadStatusForSection
        (
        );
        ...
        /**Sets  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void SetRetainPartLoadStatusForSection
        (
            bool retainPartLoadStatusForSection /** retainpartloadstatusforsection */ 
        );
        ...
        /**Returns  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::SIAutotestPreferencesBuilder::InterPartSelectionTypes InterPartSelectionType
        (
        );
        ...
        /**Sets  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void SetInterPartSelectionType
        (
            NXOpen::SIAutotestPreferencesBuilder::InterPartSelectionTypes interPartSelectionType /** interpartselectiontype */ 
        );
        ...
        /**Returns  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: bool RetainPartLoadStatusForCollector
        (
        );
        ...
        /**Sets  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void SetRetainPartLoadStatusForCollector
        (
            bool retainPartLoadStatusForCollector /** retainpartloadstatusforcollector */ 
        );
