...
//
//  Source File:
//     Annotations_BaseParallelDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseParallelDimensionBuilder;
        class BaseParallelDimensionImpl;
        /** Represents a parallel dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseParallelDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi, public virtual NXOpen::Annotations::ISlotDimension
        {
            private: BaseParallelDimensionImpl * m_baseparalleldimension_impl;
            private: friend class  _BaseParallelDimensionBuilder;
            protected: BaseParallelDimension();
            public: ~BaseParallelDimension();
