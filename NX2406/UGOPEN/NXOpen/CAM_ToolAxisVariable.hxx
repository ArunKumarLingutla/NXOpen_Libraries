        ...
        */
        class NXOPENCPP_CAMEXPORT  ToolAxisVariable : public NXOpen::CAM::ToolAxisBase
        {
            ...
            public: enum Types
            {
                ...
                TypesTiltTowardCurve/** Tilt tool axis toward curve*/,
                TypesTiltAwayFromCurve/** Tilt tool axis away from curve*/,
                TypesFixed/** Fixed tool axis*/,
                TypesInterpolateAroundAxis/** interpolate around axis */,
                TypesParametricInterpolate/** uv interpolation */,
                TypesFourAxisAutoTilt/** 4X+1 auto tilt */
            };
            ...
            /**Returns  the fixed axis builder  
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::ToolAxisFixed * FixedAxisOrientType
            (
            );
            /**Returns  the curve item 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * TiltingDriveCurve
            (
            );
            /**Sets  the curve item 
             <br>  Created in NX1899.0.0.  <br>  
