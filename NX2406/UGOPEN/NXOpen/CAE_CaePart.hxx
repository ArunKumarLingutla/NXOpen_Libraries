...
#include <NXOpen/CAE_ConvertToConvergentBodyBuilder.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaePart : public NXOpen::BasePart
        {
            ...
            public: enum FieldApplicationType
            {
                FieldApplicationTypeSignalProcessing/** Application which allows the user to specify additional attributes (e.g. acoustical weighting) on a field */,
                FieldApplicationTypeAbaqus/** Application which allows the user to specify additional Abaqus-specific attributes on a field */,
                FieldApplicationTypeDyna/** Application which allows the user to specify additional LS-DYNA-specific attributes on a field */
            };
            ...
            /** Creates a @link NXOpen::CAE::ConvertToConvergentBodyBuilder NXOpen::CAE::ConvertToConvergentBodyBuilder@endlink  @return   
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ConvertToConvergentBodyBuilder * CreateConvertToConvergentBodyBuilder
            (
            );
            /** Exports JT file
            ...
            /** Creates a @link  NXOpen::CAE::ThermoOpticalPropMgr   NXOpen::CAE::ThermoOpticalPropMgr @endlink 
                     @return  Thermo-Optical Properties manager
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ThermoOpticalPropMgr * NewThermoOpticalPropMgr
            (
            );
            ...
            /** Get the application which corresponds to the specified type. Such an application allows to extend
                     the functionalities of the Field frameworl with application specific knowledge. If the requested 
                     application does not exist yet, this method will create it and register it with the fields framework.
                     
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::Fields::IApplication * GetApplication
            (
                NXOpen::CAE::CaePart::FieldApplicationType applicationType /** application type */ 
            );
            /** Gets Penetration Check Add Set Builder.
                     @return  penetration check with this identifier 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::PenetrationCheck::AddSetBuilder * CreatePenetrationCheckAddSetBuilder
            (
                NXOpen::NXObject * penetrationAddSet /** @link NXOpen::CAE::PenetrationCheck::AnalysisSet NXOpen::CAE::PenetrationCheck::AnalysisSet@endlink  to be edited,
                                                                                        if NULL  then create a new one */
            );
            /** Gets Penetration Check Automatic Resolve Builder.
                     @return  penetration check with this identifier 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::PenetrationCheck::AutomaticResolveBuilder * CreatePenetrationCheckAutomaticResolveBuilder
            (
                NXOpen::NXObject * penetrationCheck /** @link NXOpen::CAE::PenetrationCheck::AnalysisSet NXOpen::CAE::PenetrationCheck::AnalysisSet@endlink  to be resolved */
            );
            /** Gets Penetration Check Translate Nodes Builder.
                     @return  penetration check with this identifier 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::PenetrationCheck::TranslateNodesBuilder * CreatePenetrationCheckTranslateNodesBuilder
            (
            );
            /** Gets STL import Builder.
                     @return  STL import builder 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::StlImportBuilder * CreateStlImportBuilder
            (
            );
            /** Gets Penetration Check Add Set Builder.
                     @return  penetration check with this identifier 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ContactPreview::SettingsBuilder * CreateContactPreviewSettingsBuilder
            (
            );


            /** Contains a @link NXOpen::CAE::AtvSetCollection NXOpen::CAE::AtvSetCollection@endlink . 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::AtvSetCollection *AtvSets();
            /** Contains a @link NXOpen::CAE::FrfSetCollection NXOpen::CAE::FrfSetCollection@endlink . 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::FrfSetCollection *FrfSets();
            /** Contains a @link NXOpen::CAE::ModeSetCollection NXOpen::CAE::ModeSetCollection@endlink . 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::ModeSetCollection *ModeSets();
            /** Contains a @link NXOpen::CAE::VatvSetCollection NXOpen::CAE::VatvSetCollection@endlink . 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::VatvSetCollection *VatvSets();
            ...
            */
            ...
            /** Returns the Beam Section collection belonging to the part 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::BeamSectionsCollection *BeamSections();
            /** Contains a @link NXOpen::CAE::SelectionRecipeCollection NXOpen::CAE::SelectionRecipeCollection@endlink . 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::SelectionRecipeCollection *SelectionRecipes();
            /** Contains a cae annotation manager. 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::NoteManager *Notes();
            /** Contains a cae note collection. 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::NoteCollection *CaeNoteCollection();
            /** Contains a margin annotation collection. 
             <br>  Created in NX12.0.0.  <br>  
            */
            public: NXOpen::CAE::AeroStructures::MarginAnnotCollection *MarginAnnotationCollection();
            /** Contains a @link NXOpen::CAE::PostEnvironmentsManager NXOpen::CAE::PostEnvironmentsManager@endlink . 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::PostEnvironmentsManager *PostEnvironmentsMgr();
            /** Returns the groups element manager belonging to this IFem 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::SelectGroupsManager *SelectGroupsMgr();
            /** Returns the @link NXOpen::CAE::AcousticModel NXOpen::CAE::AcousticModel@endlink . 
             <br>  Created in NX2206.0.0.  <br>  
            */
            public: NXOpen::CAE::AcousticModel *AcousticModelMgr();
            /** Contains a cae note connection manager. 
             <br>  Created in NX2406.0.0.  <br>  
            */
            public: NXOpen::CAE::NoteConnectionManager *NoteConnnectionMgr();
            /** Contains a cae note connection collection. 
             <br>  Created in NX2406.0.0.  <br>  
            */
            public: NXOpen::CAE::NoteConnectionCollection *NoteConnCollection();
        };
    }
}
