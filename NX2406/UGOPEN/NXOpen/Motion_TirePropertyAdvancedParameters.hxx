    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  TirePropertyAdvancedParameters : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** The block type can be Function when a spline curve is used or
                    Curve or Surface Profile when a profile is used.
                    */
            public: enum CustomizedSolverType
            {
                CustomizedSolverTypeFunction/** function */ ,
                CustomizedSolverTypeProfile2D/** profile2d */ ,
                CustomizedSolverTypeProfile3D/** profile3d */ 
            };
            ...
            /**Returns  the use utility curve.
                        It controls whether or not a utility curve is used for a customized tire solver. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool UseUtilityCurve
            (
            );
            /**Sets  the use utility curve.
                        It controls whether or not a utility curve is used for a customized tire solver. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetUseUtilityCurve
            (
                bool inValue /** invalue */ 
            );
            /**Returns  the curve type to be used by a customized tire solver.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::TirePropertyAdvancedParameters::CustomizedSolverType CustomizedSolverCurveType
            (
            );
            /**Sets  the curve type to be used by a customized tire solver.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetCustomizedSolverCurveType
            (
                NXOpen::Motion::TirePropertyAdvancedParameters::CustomizedSolverType type /** type */ 
            );
            /**Returns  the function to be used by a customized tire solver.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::MotionFunction * CustomizedSolverFunction
            (
            );
            /**Sets  the function to be used by a customized tire solver.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetCustomizedSolverFunction
            (
                NXOpen::Motion::MotionFunction * func /** func */ 
            );
            /**Returns  the Curve Profile to be used by a customized tire solver.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SelectFieldData * CustomizedSolverProfile2D
            (
            );
            /**Returns  the Surface Profile to be used by a customized tire solver.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SelectFieldData * CustomizedSolverProfile3D
            (
            );
