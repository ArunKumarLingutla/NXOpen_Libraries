        ...
        */
        class NXOPENCPP_CAMEXPORT  MillCutParameters : public NXOpen::CAM::CutParameters
        {
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::CutParametersTrimBehaviorTypes TrimBehavior
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTrimBehavior
            (
                NXOpen::CAM::CutParametersTrimBehaviorTypes propValue /** propvalue */ 
            );
            ...
            /**Returns  the prevent undercutting toggle 
                     <br> This property is deprecated. Use @link NXOpen::CAM::MillCutParameters::AllowUndercutting NXOpen::CAM::MillCutParameters::AllowUndercutting@endlink  instead.
                     <br>  
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link NXOpen::CAM::MillCutParameters::AllowUndercutting NXOpen::CAM::MillCutParameters::AllowUndercutting@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::CAM::MillCutParameters::AllowUndercutting instead.") bool PreventUndercutting
            (
            );
            /**Sets  the prevent undercutting toggle 
                     <br> This property is deprecated. Use @link NXOpen::CAM::MillCutParameters::AllowUndercutting NXOpen::CAM::MillCutParameters::AllowUndercutting@endlink  instead.
                     <br>  
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link NXOpen::CAM::MillCutParameters::SetAllowUndercutting NXOpen::CAM::MillCutParameters::SetAllowUndercutting@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::CAM::MillCutParameters::SetAllowUndercutting instead.") void SetPreventUndercutting
            (
