    ...
    */
    class NXOPENCPPEXPORT  DraftingManager
    {
        ...
        /** Converts all older drafting objects (including member views) in the part to the latest version. 
         <br>  @deprecated Deprecated in NX12.0.2.  No replacement method will be provided. <br>  

         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX12.0.2.  No replacement method will be provided.") void VersionUpAllDraftingObjects
        (
        );
        /** Converts selected drafting objects (including member views) in the part to the latest version. 
         ...
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX12.0.2.  No replacement method will be provided.") void VersionUpSelectedDraftingObjects
        (
        ...
        /** Creates a @link NXOpen::Drawings::MarkAsTemplateBuilder NXOpen::Drawings::MarkAsTemplateBuilder@endlink 
