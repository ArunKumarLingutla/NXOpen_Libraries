    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  PlacementSolutionsBuilder : public NXOpen::Builder
        {
            ...
            /** If @link Routing::PlacementSolutionsBuilder::SetConsiderPorts Routing::PlacementSolutionsBuilder::SetConsiderPorts@endlink  is set to true, 
                        returns the port used by the current placement solution. Otherwise returns NULL.  @return  The port used in the current placement solution. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::Port * GetSolutionPort
            (
            );
        };
    }
