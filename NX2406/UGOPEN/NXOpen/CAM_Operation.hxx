...
#include <NXOpen/CAM_PreviewOperation.hxx>
        ...
        */
        class NXOPENCPP_CAMEXPORT  Operation : public NXOpen::CAM::CAMObject
        {
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::PreviewOperation * GetPreview
            (
            );

            /// \endcond 
            /** Returns the removed volume  @return  the removed volume 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: double GetRemovedVolume
            (
            );
            /** Clears the removed volume 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void ClearRemovedVolume
            (
            );
            /** Returns the material removal rate  @return  the material removal rate 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: double GetMaterialRemovalRate
            (
            );
            /** Clears the material removal rate 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NCGroup * ParentProgramOrder
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NCGroup * ParentMachineMethod
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NCGroup * ParentGeometry
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NCGroup * ParentMachineTool
            (
            );

            /// \endcond 
            /** Returns the source operation of a mirror operation  @return  the source operation 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::Operation * GetSourceOfMirrorOperation
            (
            );
