    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PartOperationImportBuilder : public NXOpen::PDM::PartOperationBuilder
        {
            ...
            {
                CheckoutOptionTypeCheckin/** checkin */ ,
                CheckoutOptionTypeCheckout/** checkout */ ,
                CheckoutOptionTypeNoChange/** no change */ 
            };
            ...
            /** This enum is used to specify the treatment to be used for Part Family Members.
                    ...
                    */
            public: enum PartFamilyTreatment
            {
            ...
            /**Returns  the method is used to get the comment added by the user while checking in or checking out 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXString CheckoutComment
            (
            );
            /**Sets  the method gets the status of the 'Notify if Not Checkout' Flag so as to pop an error that the file which
                    user is trying to override is not check-out.
                    
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetNotCheckedoutError
            (
                bool notcheckedoutError /** notcheckedouterror */ 
            );
            /**Returns  the method gets the status of the 'Notify if Not Checkout' Flag so as to pop an error that the file which
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool NotCheckedoutError
            (
            );
            /**Sets  the method gets the status of the 'Notify if Checkout Comment not Match' Flag so as to pop an error that the previous checkout
                    comment of file which user is trying to override does not match with the checkout comment entered through the dialog.
                    
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetCheckedoutCommentNotMatchError
            (
                bool checkedoutCommentNotMatchError /** checkedoutcommentnotmatcherror */ 
            );
            /**Returns  the method gets the status of the 'Notify if Checkout Comment not Match' Flag so as to pop an error that the previous checkout
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool CheckedoutCommentNotMatchError
            (
            );
            ...
            /**Sets  the default change notice for import operation in CLI format. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                NXOpen::PDM::PartOperationImportBuilder::PartFamilyTreatment partFamilyTreatment /** partfamilytreatment */ 
            );
            ...
            /**Sets  the method returns the value indicating whether original folder structure should be created during import or not 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetMaintainOriginalFolderStructure
            (
                bool maintainOriginalFolderStructure /** maintainoriginalfolderstructure */ 
            );
            /**The method updates the destination folder for parts getting imported into Teamcenter  
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateDestinationFolderForParts
            (
            );
            /**Returns  the method returns the value indicating whether original folder structure should be created during import or not 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool IncludeSubfoldersToggle
            (
            );
            /**Sets  the method returns the value indicating whether original folder structure should be created during import or not 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetIncludeSubfoldersToggle
            (
