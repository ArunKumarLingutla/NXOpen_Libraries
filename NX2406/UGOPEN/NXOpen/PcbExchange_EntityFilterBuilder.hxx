        ...
        */
        class NXOPENCPP_PCBEXCHANGEEXPORT  EntityFilterBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the flag indicating whether to remove pads that are not connected to any components. 
             ...
             <br> License requirements : None */
            public: bool RemoveUnconnectedPads
            (
            );
            /**Sets  the flag indicating whether to remove pads that are not connected to any components. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetRemoveUnconnectedPads
            (
                bool removeUnconnectedPads /** removeunconnectedpads */ 
            );
            /**Returns  the string indicating the net names, separated by commas, of the traces and pads to remove. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXString RemoveTracesAndPadsByNetNames
            (
            );
            /**Sets  the string indicating the net names, separated by commas, of the traces and pads to remove. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetRemoveTracesAndPadsByNetNames
            (
                const NXString & removeTracesAndPadsByNetNames /** removetracesandpadsbynetnames */ 
            );
            /**Sets  the string indicating the net names, separated by commas, of the traces and pads to remove. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            void SetRemoveTracesAndPadsByNetNames
            (
                const char * removeTracesAndPadsByNetNames /** removetracesandpadsbynetnames */ 
            );
            /**Returns  the string indicating the padstacks, separated by commas, of the pads to remove. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXString RemovePadsByPadstacks
            (
            );
            /**Sets  the string indicating the padstacks, separated by commas, of the pads to remove. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetRemovePadsByPadstacks
            (
                const NXString & removePadsByPadstacks /** removepadsbypadstacks */ 
            );
            /**Sets  the string indicating the padstacks, separated by commas, of the pads to remove. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            void SetRemovePadsByPadstacks
            (
                const char * removePadsByPadstacks /** removepadsbypadstacks */ 
            );
