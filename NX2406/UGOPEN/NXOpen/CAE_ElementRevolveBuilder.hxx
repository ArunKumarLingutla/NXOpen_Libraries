    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link NXOpen::CAE::ElementRevolveBuilder NXOpen::CAE::ElementRevolveBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::CAE::NodeElementManager::CreateElementRevolveInEditModeBuilder  NXOpen::CAE::NodeElementManager::CreateElementRevolveInEditModeBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ElementRevolveBuilder : public NXOpen::Builder
        {
            /** Type of element revolve*/
            public: enum Type
            {
                TypeAssociative/** Associative Revolve */,
                TypeNonAssociative/** Non-associative Revolve*/
            };
            ...
            /**Returns  the revolve type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ElementRevolveBuilder::Type RevolveType
            (
            );
            /**Sets  the revolve type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetRevolveType
            (
                NXOpen::CAE::ElementRevolveBuilder::Type revolveType /** revolvetype */ 
            );
