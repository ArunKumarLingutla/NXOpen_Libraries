    ...
    namespace PLAS
    {
        ...
        */
        class NXOPENCPP_PLASEXPORT  RunBuilder : public NXOpen::Builder, public virtual NXOpen::IAttributeSourceObjectBuilder
        {
            ...
            /**Sets  the current discipline of this run. Discipline define things such as the default specifications, 
            ...
            /**Returns  the current discipline of this run. Discipline define things such as the default specifications, 
                    starting nodes for parts and stock, synonyms, etc.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
