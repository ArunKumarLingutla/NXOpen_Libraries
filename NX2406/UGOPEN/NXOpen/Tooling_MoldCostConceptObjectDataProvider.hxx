...
//
//  Source File:
//     Tooling_MoldCostConceptObjectDataProvider.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class _MoldCostConceptObjectDataProviderBuilder;
        class MoldCostConceptObjectDataProviderImpl;
        /**
            Provides basic data for mold cost.
            When @link Builder::Commit Builder::Commit@endlink  is called NULL will be returned.
             <br> To create a new instance of this class, use @link NXOpen::Tooling::MoldwizardManager::CreateMoldCostConceptObjectDataProvider  NXOpen::Tooling::MoldwizardManager::CreateMoldCostConceptObjectDataProvider @endlink  <br> 
         <br>  Created in NX2406.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  MoldCostConceptObjectDataProvider : public NXOpen::TaggedObject, public virtual NXOpen::ITableEditorDataProvider
        {
            private: MoldCostConceptObjectDataProviderImpl * m_moldcostconceptobjectdataprovider_impl;
            private: friend class  _MoldCostConceptObjectDataProviderBuilder;
            protected: MoldCostConceptObjectDataProvider();
            public: ~MoldCostConceptObjectDataProvider();
