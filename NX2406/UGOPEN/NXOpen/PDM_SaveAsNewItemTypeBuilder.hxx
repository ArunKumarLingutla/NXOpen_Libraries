        ...
        */
        class NXOPENCPP_PDMEXPORT  SaveAsNewItemTypeBuilder : public NXOpen::PDM::PdmCopyOrEditOperationBuilder
        {
            ...
            /** Sets the Engineering Change Notice for the parts undergoing save-as new item type operation
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetChangeNotice
            (
                const NXString & ecnCliSpec /** CLI specification of the Engineering Change Notice */
            );
            /** Sets the Engineering Change Notice for the parts undergoing save-as new item type operation
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            void SetChangeNotice
            (
                const char * ecnCliSpec /** CLI specification of the Engineering Change Notice */
            );
        };
    }
}
