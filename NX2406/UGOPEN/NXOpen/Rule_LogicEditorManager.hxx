        ...
        class RULEOPENCPPEXPORT  LogicEditorManager
        {
            ...
            */
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : features_modeling ("FEATURES MODELING") OR assemblies ("ASSEMBLIES MODULE") OR nx_mbd (" Model Based Definition") */
            ...
            (
                const std::vector<NXOpen::Diagramming::Node *> & suppressedList /** suppressedlist */ 
            );
