        ...
        */
        class NXOPENCPP_CAMEXPORT  InspectionAlignmentBuilder : public NXOpen::CAM::OperationBuilder
        {
            ...
            public: enum AlignTypes
            {
                ...
                AlignTypesRps/** RPS alignment type */
            };
            ...
            /** Return the Locate features.  @return  Locate features 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetLocateFeatures
            (
            );
            /** Set the Locate features. 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetLocateFeatures
            (
                std::vector<NXString> & locateFeatures /** Locate features */
            );
            /**Returns  the RPS available select 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObject * RPSAvailSelect
            (
            );
            /** Return the RPS features.  @return  RPS features 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetRPSFeatures
            (
            );
            /** Set the RPS features. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetRPSFeatures
            (
                std::vector<NXString> & rpsFeatures /** RPS features */
            );
            /** Return the RPS features controlling the X direction.  @return  RPS X features 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetRPSXFeatures
            (
            );
            /** Set the RPS features controlling the X direction. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetRPSXFeatures
            (
                std::vector<NXString> & rpsXFeatures /** RPS X features */
            );
            /** Return the RPS features controlling the Y direction.  @return  RPS Y features 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetRPSYFeatures
            (
            );
            /** Set the RPS features controlling the Y direction. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetRPSYFeatures
            (
                std::vector<NXString> & rpsYFeatures /** RPS Y features */
            );
            /** Return the RPS features controlling the Z direction.  @return  RPS Z features 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetRPSZFeatures
            (
            );
            /** Set the RPS features controlling the Z direction. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetRPSZFeatures
            (
                std::vector<NXString> & rpsZFeatures /** RPS Z features */
            );
        };
    }
}
