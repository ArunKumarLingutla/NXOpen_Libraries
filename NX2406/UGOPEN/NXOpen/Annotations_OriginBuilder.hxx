        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  OriginBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Sets  the origin point 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") OR solid_modeling ("SOLIDS MODELING") OR nx_2d_edit (" NX 2D Edit") */
            ...
            /** Infers a relative to geometry associative origin from leader
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") OR solid_modeling ("SOLIDS MODELING") */
            public: void SetInferRelativeToGeometryFromLeader
            (
                bool inferFromLeader /** infer relative to geometry from leader flag */
            );
