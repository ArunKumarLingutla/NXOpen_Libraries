...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AngleToleranceValue </term> <description> 
         
        45 </description> </item> 

        <item><term> 
         
        BlankPosition </term> <description> 
         
        PunchPlate </description> </item> 

        <item><term> 
         
        BlankType </term> <description> 
         
        Standard </description> </item> 

        <item><term> 
         
        BottomBackPlateClearance </term> <description> 
        ...
        ExtractWithoutHole </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        HeightValue.Value </term> <description> 
        ...
        SameWithPlate </term> <description> 
        ...
        TangentEdgeAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TraverseInteriorEdges </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        UseBottomBackPlateClearance </term> <description> 
        ...
        UseDiePlateClearance </term> <description> 
        ...
        UseSeedFacesAndBoundaryFaces </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  FormingInsertBuilder : public NXOpen::Builder
        {
            ...
            public: enum BlankTypes
            {
                ...
                BlankTypesEdit/** edit user defined blank. */,
                BlankTypesDelete/** Delete forming insert. */
            };
            ...
            public: enum BlankPositions
            {
                ...
                BlankPositionsBottomBackingPlate/** the blank is on the bottom backing plate*/,
                BlankPositionsTopPunchgPlate/** the blank is on the top punch plate*/,
                BlankPositionsBottomPunchPlate/** the blank is on the bottom punch plate*/
            };
            ...
            public: enum DesignOptions
            {
                ...
                DesignOptionsFormingAll/** design the forming punch and die*/
            };
            ...
            /**Returns  the punch or die to delete 
             ...
             <br> License requirements : None */
            public: NXOpen::Assemblies::SelectComponentList * FormingInsertDelete
            (
            );
            ...
            /**Returns  the option whether ignore holes when extract geometry. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool ExtractWithoutHole
            (
            );
            /**Sets  the option whether ignore holes when extract geometry. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetExtractWithoutHole
            (
                bool extractWithoutHole /** extractwithouthole */ 
            );
            /**Returns  the forming insert part tag. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::TaggedObject * FormingInsertPart
            (
            );
            /**Sets  the forming insert part tag. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetFormingInsertPart
            (
                NXOpen::TaggedObject * formingInsert /** forminginsert */ 
            );
            /**Returns  the added burring template part name string. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXString AddedPartName
            (
            );
            /**Sets  the added burring template part name string. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetAddedPartName
            (
            ...
            /**Sets  the added burring template part name string. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            void SetAddedPartName
            (
                const char * newPartName /** newpartname */ 
            );
            /** The action to craete datum plane for burring die 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CreateUserDefinedDatumPlane
            (
            );
            /** Add inserted new template part into assembly 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the toggle of region selection. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool UseSeedFacesAndBoundaryFaces
            (
            );
            /**Sets  the toggle of region selection. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUseSeedFacesAndBoundaryFaces
            (
                bool useRegion /** useregion */ 
            );
        };
    }
}
