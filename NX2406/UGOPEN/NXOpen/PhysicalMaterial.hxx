...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PhysicalMaterial : public NXOpen::Material, public virtual NXOpen::CAE::IExportableFEEntity
    {
        ...
        public: enum Type
        {
            ...
            TypeDamageinterface/** Damage interface material           */,
            TypeMultiplefluid/** Multiple fluid material             */,
            TypeHartsmith/** Hart-Smith material                 */,
            TypeAlexander/** Alexander material                  */,
            TypeCuring/** Curing material                     */,
            TypePorous/** Porous material                     */ = 35,
            TypeCompoundisotropic/** Compound Isotropic Material         */,
            TypeLowdensityfoam/** Low Density Foam                    */,
            TypeFabric/** Fabric                              */,
            TypeCrushablefoam/** Crushable Foam Material             */,
            TypeRatesensitivefoam/** Rate Sensitive Foam Material        */,
            TypeMultimechmicrostructure/** Multimech Microstructure Material   */,
            TypeHoneycomb/** Honeycomb Material                  */,
            TypeComposite/** Composites Material                 */,
            TypeViscothermalfluid/** Visco-Thermal Fluid Material        */,
            TypeLaminatedglass/** Laminated Glass Material            */
        };

        /** Indicates the underlying issues when trying to assign material */
        public: enum AssignWarning
        {
            AssignWarningNone/** No warning. */,
            AssignWarningInvalidObj/** Invalid objects are not assigned. */
        };
        ...
        /** Sets whether a material can be modified or not. Note: library materials cannot be set to be able to be modified.
            
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
        public: void SetMaterialEditable
        (
        ...
        /** Assigns the material to all solid bodies without a material already assigned. Invalid bodies are skipped and a warning code will be returned.
             @return  Returns a warning code if any 
         <br>  Created in NX7.5.3.  <br>  
         <br> License requirements : None */
        public: NXOpen::PhysicalMaterial::AssignWarning AssignToBodiesWithoutMaterials
        (
        );
        /** Assigns the material to all solid bodies not using the preferred material. Invalid bodies are skipped and a warning code will be returned.
             @return  Returns a warning code if any 
         <br>  Created in NX7.5.3.  <br>  
         <br> License requirements : None */
        public: NXOpen::PhysicalMaterial::AssignWarning AssignToBodiesNotUsingPreferredMaterial
        (
        );
        ...
        /** Replaces all assignments of one material with another material in the part where the material is assigned.
                The part needs to be fully loaded, the new material needs to be in the same part as the original material 
                and the material type needs to be a valid material assignment target. 
            
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
        public: void ReplaceMaterialAssignment
        (
            NXOpen::PhysicalMaterial * newMatl /** the new material tag, NULL is not allowed.*/
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: NXOpen::PhysicalMaterial * CopyAndSetParent
        (
            NXOpen::NXObject * partObject /** object in part where to copy material to */,
            bool setParent /** when true, sets the original material as the parent for the copied material */
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::PhysicalMaterial * CopyLibMatlToPartAndSetParent
        (
            NXOpen::NXObject * partObject /** object in part where to copy material to */,
            bool editable /** when true, creates a local material ready for user editting.  When false, it creates an exact copy of a loaded library material.  
                                                                                    The difference between loading and copying with this set to false is loading will get the latest library version whereas if the 
        ...
        /** Deletes Orphaned User Material (UMAT) Models and Properties from a material.  A model or property
                is considered orphaned if it exists on the material, but doesn't exist in the current environment.
        ...
        /** Returns whether a material property is overridden or not given a material tag and property neutral name. 
             @return  property override status 
         <br>  Created in NX2007.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsPropertyOverridden
        (
        ...
        /** Get the inherited value of an overridden material property given a material tag
               and property neutral name.  If the property is not overridden, get the current value.
             @return  property value string 
         <br>  Created in NX2007.0.0.  <br>  
         <br> License requirements : None */
        public: NXString GetPropertyInheritedValue
        (
            const NXString & propNeutralName /** property neutral name */
        );
        /** Get the inherited value of an overridden material property given a material tag
         ...
         <br>  Created in NX2007.0.0.  <br>  
         <br> License requirements : None */
        NXString GetPropertyInheritedValue
        (
            const char * propNeutralName /** property neutral name */
        );
