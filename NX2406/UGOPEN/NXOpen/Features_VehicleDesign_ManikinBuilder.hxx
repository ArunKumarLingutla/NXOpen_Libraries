...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            MovementPositionReport </term> <description> 
            ...
            PostureMeasurements </term> <description> 
            ...
            ShoulderWidth.Value </term> <description> 
             
            384 (millimeters part), 15.12 (inches part) </description> </item> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ManikinBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                public: enum ClassificationType
                {
                    ...
                    ClassificationTypeClassC/**Class C Classification Type. The type of vehicles includes bus, coach*/,
                    ...
                    ClassificationTypeClassRS/**Class RS Classification Type. The type of rail systems.*/,
                    ClassificationTypeCustom/**Custom Classification Type. The type of User defined.*/
                };
                ...
                public: enum StandardType
                {
                    ...
                    StandardTypeEn161862014/**EN 16186:2014 Standard Type*/
                };
                ...
                /**Returns  the shoulder width. It is only used when type is user defined 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * ShoulderWidth
                (
                );
                ...
                /**Returns  the movement position report 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: bool MovementPositionReport
                (
                );
                /**Sets  the movement position report 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetMovementPositionReport
                (
                    bool movementPositionReport /** movementpositionreport */ 
                );
                /**Returns  the posture measurement 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: bool PostureMeasurements
                (
                );
                /**Sets  the posture measurement 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetPostureMeasurements
                (
                    bool postureMeasurements /** posturemeasurements */ 
                );
                ...
                /**Returns  the state to show the actual class is custom 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: bool RealClassCustom
                (
                );
                /**Sets  the state to show the actual class is custom 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetRealClassCustom
                (
                    bool realClassCustom /** realclasscustom */ 
                );
            };
        }
    }
