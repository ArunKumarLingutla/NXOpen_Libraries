...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        1 (millimeters part), 0.01 (inches part) </description> </item> 
        ...
        StartPercentage.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PointSetBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum CurvePointsType
            {
                ...
                CurvePointsTypeSetOfPointsOnCurve/** A set of points will be created with the giben inputs from User. */
            };
            ...
            /**Returns  the set of points on curve list.
                        Only used when type is @link NXOpen::Features::PointSetBuilder::TypesCurvePoints NXOpen::Features::PointSetBuilder::TypesCurvePoints@endlink ,
                        and when @link NXOpen::Features::PointSetBuilder::CurvePointsBy NXOpen::Features::PointSetBuilder::CurvePointsBy@endlink  is 
                        @link NXOpen::Features::PointSetBuilder::CurvePointsTypeSetOfPointsOnCurve NXOpen::Features::PointSetBuilder::CurvePointsTypeSetOfPointsOnCurve@endlink .
                    
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::PointSetFacePercentageBuilderList * SetOfPointsOnCurveList
            (
            );
            /** Create an entry for the Set Of Points On Curve list. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::SetOfPointsOnCurveBuilder * CreateSetOfPointsOnCurveListItem
            (
            );
        };
    }
