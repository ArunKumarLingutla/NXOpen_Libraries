        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  TrackDrawingChangesReportFilterBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: enum Filter
            {
                ...
                FilterAnnotationEdgeConditionSymbols/** Annotation Edge Condition Symbols Report Filter*/,
                FilterAnnotationEdgeConditionSymbolsRetainedStatus/** Annotation Edge Condition Symbols Retained Status Report Filter*/,
                FilterAnnotationEdgeConditionSymbolsText/** Annotation Edge Condition Symbols Text Report Filter*/,
                FilterAnnotationEdgeConditionSymbolsOrigin/** Annotation Edge Condition Symbols Origin Report Filter*/,
                FilterAnnotationEdgeConditionSymbolsLeaderTerminator/** Annotation Edge Condition Symbols LeaderTerminator Report Filter*/,
