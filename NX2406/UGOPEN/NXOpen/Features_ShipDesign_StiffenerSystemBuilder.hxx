...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            CurvePathOffset.Value </term> <description> 
            ...
            PlanePathOffset.Value </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  StiffenerSystemBuilder : public NXOpen::Features::ShipDesign::ProfileSystemBuilder
            {
                ...
                /** Creates a @link NXOpen::Features::ShipDesign::PlanePairBuilder NXOpen::Features::ShipDesign::PlanePairBuilder@endlink  to add another pair of planes to the list. 
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                ...
                /**Returns  the curve path offset expression 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * CurvePathOffset
                (
                );
                ...
                /**Returns  This is an internal API and can be changed at any time 
                 ...
                 <br> License requirements : None */
                public: NXOpen::Expression * PlanePathOffset
                (
                );
