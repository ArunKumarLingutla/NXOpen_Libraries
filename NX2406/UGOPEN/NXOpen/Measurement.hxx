    ...
    */
    class NXOPENCPPEXPORT  Measurement
    {
        ...
        public: enum AlternateDistance
        {
            ...
            AlternateDistanceMinimumPerpendicular/** Minimum Perpendicular */,
            AlternateDistanceMaximumPerpendicular/** Maximum Perpendicular */,
            AlternateDistanceMinimumDistanceArcExtension/** Minimum distance arc to extension */,
            AlternateDistanceMinimumPerpendicularArcExtension/** Minimum perpendicular arc to extension */
        };
        ...
        /** Indicates alternate extreme area result */
        public: enum AlternateExtremeArea
        {
            AlternateExtremeAreaInscribed/** inscribed circle */,
            AlternateExtremeAreaCircumscribed/** circumscribed circle */
        };
        ...
        (
            const std::vector<NXOpen::ISurface *> & faces /** Set of faces  */,
        ...
        (
            const std::vector<NXOpen::IBody *> & bodys /** Set of bodys  */,
            double accuracy /** accuracy */,
        ...
        (
            ...
            int alternateSolution /** alternate solution: 0-clearance minimum, 1-clearance maximum, 2-minimum contact projected, 3-maximum contact projected, 
                                                                                                        4-orthogonal minimum, 5-orthogonal maximum, 6-legacy clearance minimum, 7-legacy clearance maximum, 8-projected thickness */,
            double* distance /** projected distance */,
            std::vector<NXOpen::Point3d> & points /** points */,
            bool* isApproximate /** is approximate */
        );
        /** 
        ...
        (
            ...
            int alternateSolution /** alternate solution:0-XYZ,1-XZY,2-YXZ,3-YZX,4-ZXY,5-ZYX,6-XYX,7-XZX,8-YXY,9-YZY,10-ZXZ,11-ZYZ  */,
            NXOpen::NXObject * targetUnit /** target unit  */,
        ...
        (
            ...
            NXOpen::NXObject * targetUnit /** Target unit  */,
            bool requireExact /** Require exact */,
            bool* isApproximate /** is approximation */,
        ...
        (
            ...
            NXOpen::NXObject * csys /** coordinate system  */,
        ...
        (
            ...
            NXOpen::NXObject * targetUnit /** target unit  */,
            std::vector<NXOpen::NXObject *> & pvUGCurves /** Multiple Curves */,
            NXOpen::Point3d* startPoint /** start point */,
            NXOpen::Point3d* endPoint /** end point */
        );
        /** 
        ...
        (
            const std::vector<NXOpen::NXObject *> & selList /** Set of list  */,
            int nAltSolution /** alternate solution:0-Axis Aligned, 1-Best Fit */,
        ...
        /** Computes the mass properties of section, convert to proper units, and compute the equivialent rectangle of a hollow section.
            
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: void GetSectionInertia
        (
            const std::vector<NXOpen::NXObject *> & curves /** A set of curves in section */,
            ...
            bool solidFlag /** true: compute solid mass properties, else hollow */,
            double hollowThickness /** setting thickness of hollow ( thickness should be less than 1000000mm and great than 0.0001mm ) */,
            bool useWCS /** determines WCS to use */,
            NXOpen::Point3d* centerGravity /** center of gravity */,
            double* maxPrinMOI /** Max principal moment of inertia */,
            double* minPrinMOI /** Min principal moment of inertia */,
            NXOpen::Vector3d* prinBAxis /** Max principal axis */,
            NXOpen::Vector3d* prinCAxis /** Min principal axis */,
            double* sectionLength /** Section Length*/,
            double* sectionArea /** Section Area */,
            NXOpen::Point2d* rectangleLengths /** Rectangle Lengths, correspond to prinBAxis and prinCAxis */
        );
        /** 
            Calculates and returns circle of the given three points. Returned radius, diameter, center point and normal axis of circle. 
            
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void GetCircle3pts
        (
            const NXOpen::Point3d & point1 /** the 1st point on circle */,
            const NXOpen::Point3d & point2 /** the 2nd point on circle */,
            const NXOpen::Point3d & point3 /** the 3rd point on circle */,
            NXOpen::NXObject * lengthUnit /** target unit for radius and diameter (will use work part base unit if it is null) */,
            NXOpen::NXObject * pointUnit /** target unit for center point of circle (will use work part base unit if it is null) */,
            double* radius /** radius of circle   */,
            double* diameter /** diameter of circle */,
            NXOpen::Point3d* centroid /** center of point    */,
            NXOpen::Vector3d* axis /** normal axis of circel */
        );
        /** 
                Calculates inscribed or circumscribed circle of the given coplanar points, curves or sheetbody. 
                Returned radius or diameter, center point and point on circle. 
            
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void GetExtremeArea
        (
            const std::vector<NXOpen::NXObject *> & selList /** Set of coplanar objects (points, curves or sheet body)  */,
            NXOpen::Measurement::AlternateExtremeArea altSolution /** alternate solution: inscribed or cirumscribed circle    */,
            NXOpen::NXObject * unit /** target unit for radius (will use work part base unit if it is null) */,
            double* radius /** radius of inscribed or cirumscribed circle   */,
            NXOpen::Point3d* centroid /** the workpart coordinate of center of point   */,
            NXOpen::Point3d* pointOnCircle /** the workpart coordinate of point on circle   */,
            NXOpen::Vector3d* axis /** normal axis for the plane of measurement */
        );
