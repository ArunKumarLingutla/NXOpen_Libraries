...
namespace NXOpen
{
    ...
    namespace AME
    {
        ...
        ProductType </term> <description> 
         
        SameEngineeringObjectDefinition </description> </item> 
        ...
        */
        class AMEOPENCPPEXPORT  ProductSelectionBuilder : public NXOpen::AME::MultipleObjectsBuilder
        {
            ...
            /** Remove tia library reference of hwItem
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link JA_PRODUCT_SELECTION_BUILDER_RemoveTiaLibraryReferenceFromEngObject JA_PRODUCT_SELECTION_BUILDER_RemoveTiaLibraryReferenceFromEngObject@endlink  instead. <br>  

             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use JA_PRODUCT_SELECTION_BUILDER_RemoveTiaLibraryReferenceFromEngObject instead.") void RemoveTiaLibraryReference
            (
                NXOpen::AME::AMEPlcHwItem * plcHwItem /** plchwitem */ 
            );
            /** Remove tia library reference of hwItem
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void RemoveTiaLibraryReferenceFromEngObject
            (
