        ...
        class NXOPENCPP_CAMEXPORT  CAMObject : public NXOpen::NXObject
        {
            ...
            */
            ...
            public: enum ValidationType
            {
                ...
                ValidationTypeSuspectPath/** suspect path */ ,
                ValidationTypeFeedsSpeeds/** feeds speeds */ 
            };
            ...
            (
                bool updateAndNotifyMembers /** updateandnotifymembers */ 
            );

            /// \endcond 
            /** Gets the generic motion operation for the specified transition path.  @return  the transition path operation
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::CAMObject * GetTransitionPathOperation
            (
                NXOpen::CAM::CAMObject::TransitionPathTypes transitionPathType /** transitionpathtype */ 
            );
            /** Generates and saves the transition path based on input generic motion control operation. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void GenerateAndSaveTransitionPath
            (
                NXOpen::CAM::CAMObject::TransitionPathTypes transitionPathType /** transitionpathtype */ ,
                NXOpen::CAM::CAMObject * transitionPathOpr /** the transition path operation*/
            );
            /**Returns  the user friendly name of the object.  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXString UserName
            (
            );
            /**Sets  the user friendly name of the object.  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXString BuilderProperties
            (
            );
