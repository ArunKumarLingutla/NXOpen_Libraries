...
namespace NXOpen
{
    namespace Layer
    {
        ...
        enum Constants
        {
            ConstantsFirstLayer/** The number of the first layer.
                                                        Valid layers are numbered from @link Layer::ConstantsFirstLayer Layer::ConstantsFirstLayer@endlink 
                                                        to @link Layer::ConstantsLastLayer Layer::ConstantsLastLayer@endlink  */ = 1,
            ConstantsLastLayer/** The number of the last layer.
                                                        Valid layers are numbered from @link Layer::ConstantsFirstLayer Layer::ConstantsFirstLayer@endlink 
                                                        to @link Layer::ConstantsLastLayer Layer::ConstantsLastLayer@endlink  */ = 256
        };
