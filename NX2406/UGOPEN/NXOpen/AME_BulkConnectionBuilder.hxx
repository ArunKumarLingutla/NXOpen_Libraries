...
namespace NXOpen
{
    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  BulkConnectionBuilder : public NXOpen::AME::AMEBaseBuilder
        {
            ...
            (
                const std::vector<NXOpen::AME::IPort *> & sourcePorts /** The ports tag array*/,
                const std::vector<NXOpen::AME::IPort *> & targetPorts /** The ports tag array*/,
