    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  ContactAnalysisBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the toggle to Show only Ball touching Areas 
             <br>  Created in NX1953.0.0.  <br>  
            ...
            /** Create Section Curves 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: NXOpen::GeometricAnalysis::ContactAnalysisSectionCurveBuilder * CreateSectionCurves
            (
            );
            ...
            /**Returns  the Geometric Constraint Data Manager builder
             ...
             <br> License requirements : None */
            public: NXOpen::Features::GeometricConstraintDataManager * GeometricConstraintDataManager
            (
            );
            /** Add geometric constraint point to checker 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: void AddGCPoint
            (
