...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ConstraintRadius.Value </term> <description> 
         
        1.0 (millimeters part), 0.0625 (inches part) </description> </item> 
        ...
        EndConnectivity.Continuity.ContinuityType </term> <description> 
