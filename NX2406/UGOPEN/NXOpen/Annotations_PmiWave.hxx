...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _PmiWaveBuilder;
        class PmiWaveImpl;
        /** Represents a Wave  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiWaveLinkBuilder  NXOpen::Annotations::PmiWaveLinkBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiWave : public NXOpen::Annotations::Annotation, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiWaveImpl * m_pmiwave_impl;
            private: friend class  _PmiWaveBuilder;
            protected: PmiWave();
            public: ~PmiWave();
