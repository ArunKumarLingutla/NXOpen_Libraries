    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModelAndLoadPreProcessTimeSignalBuilder : public NXOpen::CAE::ModelAndLoadPreProcessOperationBuilder
        {
            ...
            /** Output Subcase Name Pattern */
            public: enum SubcaseNamePatternType
            {
                SubcaseNamePatternTypeSubcaseNameSegmentId/** subcase name segment id */ ,
                SubcaseNamePatternTypeSubcaseNameTimeLimits/** subcase name time limits */ ,
                SubcaseNamePatternTypeSubcaseNameStartTime/** subcase name start time */ 
            };
            ...
            /**Returns  the flag which enables signal repetition 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool EnableSignalRepetition
            (
            );
            /**Sets  the flag which enables signal repetition 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetEnableSignalRepetition
            (
                bool enableSignalRepetition /** enablesignalrepetition */ 
            );
            /**Returns  the number of signal repetitions 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: int NumberOfRepetitions
            (
            );
            /**Sets  the number of signal repetitions 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetNumberOfRepetitions
            (
                int numberOfRepetitions /** numberofrepetitions */ 
            );
            ...
            /**Returns  the flag which enables 0 padding 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool Enable0Padding
            (
            );
            /**Sets  the flag which enables 0 padding 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetEnable0Padding
            (
                bool enable0Padding /** enable0padding */ 
            );
            /**Returns  the frequency resolution, in Hz 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * FrequencyResolution
            (
            );
            /**Returns  the flag which enables pre-padding 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool EnablePrePadding
            (
            );
            /**Sets  the flag which enables pre-padding 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetEnablePrePadding
            (
                bool enablePrePadding /** enableprepadding */ 
            );
            /**Returns  the Output Subcase Name pattern 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ModelAndLoadPreProcessTimeSignalBuilder::SubcaseNamePatternType SubcaseNamePattern
            (
            );
            /**Sets  the Output Subcase Name pattern 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetSubcaseNamePattern
            (
                NXOpen::CAE::ModelAndLoadPreProcessTimeSignalBuilder::SubcaseNamePatternType subcaseNamePattern /** subcasenamepattern */ 
            );
        };
    }
}
