    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshingPreferencesBuilder : public NXOpen::Builder
        {
            ...
            /** the mesh update order types */
            public: enum MeshUpdateOrder
            {
                MeshUpdateOrderTimeStamp/** Creation order */,
                MeshUpdateOrderElementSize/** By element size  */
            };
            ...
            /**Returns  the mesh update order type 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::MeshingPreferencesBuilder::MeshUpdateOrder MeshUpdateOrderType
            (
            );
            /**Sets  the mesh update order type 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetMeshUpdateOrderType
            (
                NXOpen::CAE::MeshingPreferencesBuilder::MeshUpdateOrder orderType /** ordertype */ 
            );
        };
    }
}
