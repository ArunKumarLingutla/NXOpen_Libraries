    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  SymbolNoteBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::AME::AmeSymbolAnnotationTextOverflowMethod type /** type */ 
            );
            ...
            /** Set the note string 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetNoteString
            (
                const NXString & noteString /** notestring */ 
            );
            /** Set the note string 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            void SetNoteString
            (
                const char * noteString /** notestring */ 
            );
        };
    }
}
