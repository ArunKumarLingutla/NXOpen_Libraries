...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  DxfdwgCreator : public NXOpen::BaseCreator
    {
        /** Exprot From option */
        ...
        public: enum AutoCADRevisionOptions
        {
            ...
            AutoCADRevisionOptionsR2018/** output autocad version 2018 */
        };
        ...
        /**Returns the scale value - this Scale is used during Model space data export
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: double ExportScaleValue
        (
        );
        ...
        (
            double exportScaleValue /** exportscalevalue */ 
        );
