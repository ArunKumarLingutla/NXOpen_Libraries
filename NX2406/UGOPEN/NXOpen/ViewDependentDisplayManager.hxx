    ...
    class NXOPENCPPEXPORT  ViewDependentDisplayManager
    {
        ...
        */
        public: enum Font
        {
            ...
            FontObject/** object */ ,
            FontEight/** Long Dashed Double Dotted*/ = 11,
        ...
        */
        ...
        /** Removes erasures from specified objects in a view. 
         <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::ViewDependentDisplayManager::RemoveErasureOnObjectAndSubobjects NXOpen::ViewDependentDisplayManager::RemoveErasureOnObjectAndSubobjects@endlink  instead. <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::ViewDependentDisplayManager::RemoveErasureOnObjectAndSubobjects instead.") void RemoveErasure
        (
            const std::vector<NXOpen::DisplayableObject *> & objects /** objects */ 
        );
        /** Removes erasures from specified objects and optional subobjects in a view. 
         ...
         <br> License requirements : None */
        public: void RemoveErasureOnObjectAndSubobjects
        (
            const std::vector<NXOpen::DisplayableObject *> & objects /** objects */ ,
            bool removeFromSubObjects /** removefromsubobjects */ 
        );
