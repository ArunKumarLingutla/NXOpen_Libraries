    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ToolAxisAdvanced : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the blade swarf extension start angle 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: double BladeSwarfExtensionStartAngle
            (
            );
            /**Sets  the blade swarf extension start angle 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetBladeSwarfExtensionStartAngle
            (
                double startAngle /** the extension start angle */
            );
        };
    }
}
