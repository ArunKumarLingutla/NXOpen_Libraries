...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        ...
        {
            /** Enum for Annotation Preferences This is used by @link NXOpen::Annotations::BaseCustomSymbolBuilder::AnnotationPreference NXOpen::Annotations::BaseCustomSymbolBuilder::AnnotationPreference@endlink  
                    and @link NXOpen::Annotations::BaseCustomSymbolBuilder::SetAnnotationPreference NXOpen::Annotations::BaseCustomSymbolBuilder::SetAnnotationPreference@endlink  
            ...
            /** Enum for Geometric Preferences This is used by @link NXOpen::Annotations::BaseCustomSymbolBuilder::GeometryPreference NXOpen::Annotations::BaseCustomSymbolBuilder::GeometryPreference@endlink  
                    and @link NXOpen::Annotations::BaseCustomSymbolBuilder::SetGeometryPreference NXOpen::Annotations::BaseCustomSymbolBuilder::SetGeometryPreference@endlink  
            ...
            /** Returns the arbitrary note value in an array.  This should be used only after @link NXOpen::Annotations::BaseCustomSymbolBuilder::SelectText NXOpen::Annotations::BaseCustomSymbolBuilder::SelectText@endlink  is used 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetArbitraryNoteTitle
            (
            );
            /** Sets the arbitrary note value.  This should be used only after @link NXOpen::Annotations::BaseCustomSymbolBuilder::SelectText NXOpen::Annotations::BaseCustomSymbolBuilder::SelectText@endlink  is used 
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
