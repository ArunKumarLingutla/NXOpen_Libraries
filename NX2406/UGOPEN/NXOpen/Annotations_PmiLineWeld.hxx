...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _PmiLineWeldBuilder;
        class PmiLineWeldImpl;
        /** Represents a PMI line weld  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiLineWeldBuilder  NXOpen::Annotations::PmiLineWeldBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiLineWeld : public NXOpen::Annotations::LineWeld, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiLineWeldImpl * m_pmilineweld_impl;
            private: friend class  _PmiLineWeldBuilder;
            protected: PmiLineWeld();
            public: ~PmiLineWeld();
