...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace ModelCheck
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  DuplicateElementsCheckBuilder : public NXOpen::Builder, public virtual NXOpen::CAE::ModelCheck::ISelectionBuilder
            {
                ...
                public: enum DeletePreference
                {
                    ...
                    DeletePreferenceKeepSelected/** Keep the elements specified in the element list
                                                                                                                     @link NXOpen::CAE::ModelCheck::DuplicateElementsCheckBuilder::PreferenceElements NXOpen::CAE::ModelCheck::DuplicateElementsCheckBuilder::PreferenceElements@endlink  */,
