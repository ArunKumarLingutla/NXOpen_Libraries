...
#include <NXOpen/CAE_CurveOperationEvaluator.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CurveOperation
        {
            ...
            /** Ask all candidate units names by the given measure or quantity name. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> AskUnitsNamesOfMeasureOrQuantityName
            (
                NXOpen::NXObject * context /** context */ ,
            ...
            /** Ask all candidate units names by the given measure or quantity name. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            std::vector<NXString> AskUnitsNamesOfMeasureOrQuantityName
            (
                NXOpen::NXObject * context /** context */ ,
                const char * measureOrQuantityName /** measureorquantityname */ 
            );
            /** Creates an object @link  NXOpen::CAE::CurveOperationEvaluator   NXOpen::CAE::CurveOperationEvaluator @endlink  to evaluate the formulas. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::CurveOperationEvaluator * CreateEvaluator
            (
            );
