...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class LeaderBuilderImpl;
        /**
            Represents a @link NXOpen::Annotations::LeaderBuilder NXOpen::Annotations::LeaderBuilder@endlink .  This class is
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LeaderBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: LeaderBuilderImpl * m_leaderbuilder_impl;
