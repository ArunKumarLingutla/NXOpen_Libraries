...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class SelectFeatureListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SelectFeatureList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectFeatureListImpl * m_selectfeaturelist_impl;
            private: friend class  _SelectFeatureListBuilder;
            protected: SelectFeatureList();
            public: ~SelectFeatureList();
            ...
            (
                const std::vector<NXOpen::Features::Feature *> & objects /** Objects to remove */
            );
