...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ExpressionGroup : public NXOpen::NXObject
    {
        ...
        public: NX_DEPRECATED("Deprecated in NX2406.0.0.  This functionality is no longer supported.") void SetVisibility
        (
        ...
        /**Returns  an expression group's visibility. 
         ...
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX2406.0.0.  This functionality is no longer supported.") bool Visibility
        (
        );
