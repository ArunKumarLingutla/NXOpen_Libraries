...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**
            ...
            @link NXOpen::CAE::EdgePathMethod::GetSeeds NXOpen::CAE::EdgePathMethod::GetSeeds@endlink  or 
        ...
        */
        class NXOPENCPP_CAEEXPORT  EdgePathMethod : public NXOpen::SelectionMethod
        {
            ...
            /** Add closed seed (edge whose end vertices are teh same) to the path.  
                    If the addition of the seed would result in an invalid path, the seed
                    will not be added and the function will return an error. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void AddClosedSeedEdge
            (
            ...
            /** Flip the path start and end.  This changes the definition of the path
                    such that subsequent calls to @link NXOpen::CAE::EdgePathMethod::GetSeeds NXOpen::CAE::EdgePathMethod::GetSeeds@endlink  or 
                    @link NXOpen::CAE::EdgePathMethod::GetPathEdges NXOpen::CAE::EdgePathMethod::GetPathEdges@endlink  will return seed or path edges in 
                    the new, flipped, order along with correspondingly updated start vertices. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** If the path is closed, returns the closed edge and initial direction which define the closed path.  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void GetClosedPathEdge
            (
                NXOpen::CAE::CAEEdge ** seedEdgeTag /** seed edge tag*/,
                bool* flipEdge /** true if edge is flipped in the path */
            );
