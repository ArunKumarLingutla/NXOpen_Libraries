...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a Pmi 3D centerline  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiCenterline3dBuilder  NXOpen::Annotations::PmiCenterline3dBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiCenterline3d : public NXOpen::Annotations::BaseCenterline3d, public virtual NXOpen::Annotations::IPmi
        {
