        ...
        */
        class NXOPENCPP_VISUALREPORTINGEXPORT  VisualReportBuilder : public NXOpen::Builder
        {
            ...
            /** Gets the tolerance of the active @link NXOpen::VisualReporting::Classifier NXOpen::VisualReporting::Classifier@endlink  in the given @link NXOpen::VisualReporting::Rule NXOpen::VisualReporting::Rule@endlink 
             ...
             <br> License requirements : None */
            public: double GetToleranceOfRule
            (
                NXOpen::VisualReporting::Rule * rule /** The rule */
            );
            /** Sets the tolerance of the active @link NXOpen::VisualReporting::Classifier NXOpen::VisualReporting::Classifier@endlink  in the given @link NXOpen::VisualReporting::Rule NXOpen::VisualReporting::Rule@endlink 
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetToleranceOfRule
            (
                NXOpen::VisualReporting::Rule * rule /** The rule */,
            ...
            public: NXOpen::VisualReporting::Property * CreateProperty
            (
                const NXString & propertyId /** Property Identifier of the @link NXOpen::VisualReporting::Property NXOpen::VisualReporting::Property@endlink  being created */
            );
            /** Creates a new empty @link NXOpen::VisualReporting::Property NXOpen::VisualReporting::Property@endlink , but does not add it to a
                        @link NXOpen::VisualReporting::VisualReport NXOpen::VisualReporting::VisualReport@endlink .
                     @return  The created property 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::VisualReporting::Property * CreateProperty
            (
                const char * propertyId /** Property Identifier of the @link NXOpen::VisualReporting::Property NXOpen::VisualReporting::Property@endlink  being created */
            );
            ...
            /**Returns  the scope name of visual report.
             ...
             <br> License requirements : None */
            public: NXString ScopeNameOfVisualReport
            (
            );
            /**Sets  the scope name of visual report.
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetScopeNameOfVisualReport
            (
                const NXString & scopeName /** scopename */ 
            );
            /**Sets  the scope name of visual report.
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            void SetScopeNameOfVisualReport
            (
                const char * scopeName /** scopename */ 
            );
        };
    }
}
