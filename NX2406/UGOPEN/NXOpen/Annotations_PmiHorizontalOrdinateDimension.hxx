...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class PmiHorizontalOrdinateDimensionImpl;
        /** Represents a PMI horizontal ordinate dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiOrdinateDimensionBuilder  NXOpen::Annotations::PmiOrdinateDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiHorizontalOrdinateDimension : public NXOpen::Annotations::HorizontalOrdinateDimension, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiHorizontalOrdinateDimensionImpl * m_pmihorizontalordinatedimension_impl;
            private: friend class  _PmiHorizontalOrdinateDimensionBuilder;
            protected: PmiHorizontalOrdinateDimension();
            public: ~PmiHorizontalOrdinateDimension();
