...
namespace NXOpen
{
    ...
    UseFileDirectory </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  VirtuallabImporter : public NXOpen::Builder
    {
        ...
        /**Returns  the apply units option - 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: bool ApplyUnits
        (
        );
        /**Sets  the apply units option - 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: void SetApplyUnits
        (
            bool applyUnits /** applyunits */ 
        );
        /**Returns  the apply units option - 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: bool UseEnglishForPartUnits
        (
        );
        /**Sets  the apply units option - 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: void SetUseEnglishForPartUnits
        (
            bool useEnglishForPartUnits /** useenglishforpartunits */ 
        );
    };
}
