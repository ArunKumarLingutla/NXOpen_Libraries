        ...
        class NXOPENCPP_CAMEXPORT  CylinderMillingBuilder : public NXOpen::CAM::CylindricalMillingBuilder
        {
            ...
            */
            public: enum RetractOutputModeType
            {
                ...
                RetractOutputModeTypePostDriven/** canned retract post driven */
            };
            ...
            /**Returns  the motion output  
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CylinderMillingBuilder::MotionOutputTypes MotionOutput
            (
            );
            ...
            (
                NXOpen::CAM::CylinderMillingBuilder::MotionOutputTypes newValue /** the motion output type */
            );
            ...
            /**Returns  the opposite direction  
             <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::CAM::FBM::Feature::FlipDirection NXOpen::CAM::FBM::Feature::FlipDirection@endlink  to change the Z-axis on the in-process feature instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAM::FBM::Feature::FlipDirection to change the Z-axis on the in-process feature instead.") bool OppositeDirection
            (
            );
            /**Sets  the opposite direction  
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAM::FBM::Feature::FlipDirection to change the Z-axis on the in-process feature instead.") void SetOppositeDirection
            (
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CylinderMillingBuilder::RetractOutputModeType RetractOutputMode
            (
            );
            ...
            (
                NXOpen::CAM::CylinderMillingBuilder::RetractOutputModeType currentValue /** currentvalue */ 
            );
