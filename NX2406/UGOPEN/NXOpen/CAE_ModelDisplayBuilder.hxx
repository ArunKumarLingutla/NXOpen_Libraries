...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        ElemMaterialDisplayLaminateColor </term> <description> 
         
        181 </description> </item> 

        <item><term> 
         
        ElemMaterialDisplayNoMaterialColor </term> <description> 
         
        130 </description> </item> 

        <item><term> 
         
        ElemQualFailColor </term> <description> 
         
        186 </description> </item> 

        <item><term> 
         
        ElemQualFailShadedBorderColor </term> <description> 
         
        130 </description> </item> 

        <item><term> 
         
        ElemQualPassColor </term> <description> 
         
        50 </description> </item> 

        <item><term> 
         
        ElemQualPassTranslucency </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ElemQualPassType </term> <description> 
         
        Shaded </description> </item> 

        <item><term> 
         
        ElementColorCycler </term> <description> 
         
        Default </description> </item> 

        <item><term> 
         
        ElementDisplayQuality </term> <description> 
         
        Fine </description> </item> 

        <item><term> 
         
        ElementSelectInternal </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        GeomDisplayFreeEdges </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        GeomDisplayStitchedEdges </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        GeomFreeEdgeColor </term> <description> 
         
        186 </description> </item> 

        <item><term> 
         
        GeomFreeEdgeEndMarker </term> <description> 
         
        Circle </description> </item> 

        <item><term> 
         
        GeomFreeEdgeFont </term> <description> 
         
        Solid </description> </item> 

        <item><term> 
         
        GeomFreeEdgeLineWidth </term> <description> 
         
        Thick </description> </item> 

        <item><term> 
         
        GeomStitchedEdgeColor </term> <description> 
         
        186 </description> </item> 

        <item><term> 
         
        GeomStitchedEdgeEndMarker </term> <description> 
         
        Circle </description> </item> 

        <item><term> 
         
        GeomStitchedEdgeFont </term> <description> 
         
        Solid </description> </item> 

        <item><term> 
         
        GeomStitchedEdgeLineWidth </term> <description> 
         
        Thick </description> </item> 

        <item><term> 
         
        GroupElemFaceMultiGroupColor </term> <description> 
         
        181 </description> </item> 

        <item><term> 
         
        GroupElemFaceNoGroupColor </term> <description> 
         
        130 </description> </item> 

        <item><term> 
         
        GroupElemMultiGroupColor </term> <description> 
         
        181 </description> </item> 

        <item><term> 
         
        GroupElemNoGroupColor </term> <description> 
         
        130 </description> </item> 

        <item><term> 
         
        NodeMarker </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        NodeSelectInternal </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        NodeUnattachedMarker </term> <description> 
         
        Asterisk </description> </item> 

        <item><term> 
         
        RotationAxisColor </term> <description> 
         
        186 </description> </item> 

        <item><term> 
         
        RotationAxisDisplaySwitch </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        RotationAxisFont </term> <description> 
         
        Solid </description> </item> 

        <item><term> 
         
        RotationAxisLineWidth </term> <description> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModelDisplayBuilder : public NXOpen::Builder
        {
            ...
            public: enum ElmClrBasis
            {
                ...
                ElmClrBasisLamZoneElem/** Laminate Zone Element */,
                ElmClrBasisVolumeFraction/** Volume Fraction */,
                ElmClrBasisThermoOpticalProperties/** Thermo-Optical Properties */,
                ElmClrBasisSolverSpecific/** Solver Specific Display */
            };

            /** Indicates group preference*/
            public: enum GroupPreference
            {
                GroupPreferenceGroupOnly/** Consider only groups */,
                GroupPreferenceSelRecipeOnly/** Consider only selection recipes */,
                GroupPreferenceBoth/** Consider both */
            };
            ...
            */
            public: enum FreeEdgeFont
            {
                ...
                FreeEdgeFontEight/** Long dashed double dotted*/,
                FreeEdgeFontNine/** Long dashed dotted for OOTB fonts and Undulating for shipbuilding fonts */,
                FreeEdgeFontTen/** Long dashed triplicate dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
                FreeEdgeFontEleven/** Long dashed double short dashed for OOTB fonts and Railway for shipbuilding fonts */
            };
            ...
            */
            public: enum StitchedEdgeFont
            {
                ...
                StitchedEdgeFontEight/** Represents Long Dashed Double Dotted*/,
                StitchedEdgeFontNine/** Represents Long Dashed Dotted for UG Default Fonts and Undulating for Shipbuilding Fonts */,
                StitchedEdgeFontTen/** Represents Long Dashed Triplicate Dotted for UG Default Fonts and Zigzag for Shipbuilding Fonts */,
                StitchedEdgeFontEleven/** Represents Long Dashed Double Short Dashed for UG Default Fonts and Railway for Shipbuilding Fonts */
            };
            ...
            */
            public: enum RotationAxisLineFont
            {
                ...
                RotationAxisLineFontEight/** Represents Long Dashed Double Dotted*/,
                RotationAxisLineFontNine/** Represents Long Dashed Dotted for UG Default Fonts and Undulating for Shipbuilding Fonts */,
                RotationAxisLineFontTen/** Represents Long Dashed Triplicate Dotted for UG Default Fonts and Zigzag for Shipbuilding Fonts */,
                RotationAxisLineFontEleven/** Represents Long Dashed Double Short Dashed for UG Default Fonts and Railway for Shipbuilding Fonts */
            };

            /** The type of visualization settings for universal connections 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: enum UniversalConnectionVisualizationSettingsType
            {
                UniversalConnectionVisualizationSettingsTypeNone/** No active settings*/,
                UniversalConnectionVisualizationSettingsTypeByType/** Visualization settings by connection type */,
                UniversalConnectionVisualizationSettingsTypeByDiameter/** Visualization settings by diameter*/,
                UniversalConnectionVisualizationSettingsTypeByFlangeCount/** Visualization settings by flange count */,
                UniversalConnectionVisualizationSettingsTypeByStatus/** Visualization settings by status */
            };

            /** Number of flanges of a connection 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: enum ConnectionFlangeCount
            {
                ConnectionFlangeCountTwoFlanges/** Two flanges */ = 2,
                ConnectionFlangeCountThreeFlanges/**  Three flanges */,
                ConnectionFlangeCountFourFlanges/** Four flanges */,
                ConnectionFlangeCountOther/**  Other flange count */
            };
            ...
            */
            ...
            {
                ConnectionStatusRealized/** Realized (connetion is meshed) */ = 1,
                ConnectionStatusNotRealized/**  Not Realized (connetion is not meshed) */,
                ConnectionStatusInvalid/** Invalid (connection is invalid) */
            };

            /** specifies the thermo-optical 2d mesh option 
             <br>  Created in NX2312.0.0.  <br>  
            */
            public: enum ThermoOptical2dMeshOpt
            {
                ThermoOptical2dMeshOptTop/** top */ ,
                ThermoOptical2dMeshOptBottom/** bottom */ ,
                ThermoOptical2dMeshOptBoth/** both */ 
            };

             /**Display parameters of a connection 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public:
            struct ConnectionDisplayParameters
            {
                public: /** color */ NXColor* Color;
                public: /** linefont */ NXOpen::DisplayableObject::ObjectFont LineFont;
                public: /** linewidth */ NXOpen::DisplayableObject::ObjectWidth LineWidth;
                public: ConnectionDisplayParameters() :
                    Color(),
                    LineFont((NXOpen::DisplayableObject::ObjectFont)0),
                    LineWidth((NXOpen::DisplayableObject::ObjectWidth)0)
                {
                }
                /** Constructor for the ConnectionDisplayParameters struct. */ 
                public: ConnectionDisplayParameters(NXColor* colorInitial /** color */ , 
                        NXOpen::DisplayableObject::ObjectFont lineFontInitial /** linefont */ , 
                        NXOpen::DisplayableObject::ObjectWidth lineWidthInitial /** linewidth */ ) :
                    Color(colorInitial),
            ...
            /**Returns  the group selection recipe get options 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::GroupPreference GroupSelRecipeOpts
            (
            );
            /**Sets  the group selection recipe get options 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetGroupSelRecipeOpts
            (
                NXOpen::CAE::ModelDisplayBuilder::GroupPreference groupSelRecipeOpts /** groupselrecipeopts */ 
            );
            /**Returns  the include 2d elements option 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool Include2dElements
            (
            );
            /**Sets  the include 2d elements option 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetInclude2dElements
            (
                bool include2dElements /** include2delements */ 
            );
            /**Returns  the laminate zone element no zone color 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::NXColor * LamZoneElemNoColor
            (
            );
            /**Sets  the laminate zone element no zone color 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetLamZoneElemNoColor
            (
                NXOpen::NXColor * lamZoneElemNoColor /** lamzoneelemnocolor */ 
            );
            ...
            /**Returns  the universal connection visualization type.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::UniversalConnectionVisualizationSettingsType UniversalConnectionVisualizationType
            (
            );
            /**Sets  the universal connection visualization type.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetUniversalConnectionVisualizationType
            (
                NXOpen::CAE::ModelDisplayBuilder::UniversalConnectionVisualizationSettingsType type /** type */ 
            );
            /** Sets display parameters for universal connections based on type.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetDisplayParametersByConnectionType
            (
                NXOpen::CAE::Connections::ConnectionType connectionType /** type of the connection */,
                const NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters & parameters /** connection display parameters */
            );
            /** Gets display parameters for universal connections based on type. @return  connection display parameters 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters GetDisplayParametersByConnectionType
            (
                NXOpen::CAE::Connections::ConnectionType connectionType /** type of the connection */
            );
            /** Sets display parameters for universal connections based on flange count.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetDisplayParametersByFlangeCount
            (
                NXOpen::CAE::ModelDisplayBuilder::ConnectionFlangeCount flangeCount /** number of flanges of the connection */,
                const NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters & parameters /** connection display parameters */
            );
            /** Gets display parameters for universal connections based on flange count. @return  connection display parameters 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters GetDisplayParametersByFlangeCount
            (
                NXOpen::CAE::ModelDisplayBuilder::ConnectionFlangeCount flangeCount /** number of flanges of the connection */
            );
            /** Sets display parameters for universal connections based on status.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetDisplayParametersByStatus
            (
                NXOpen::CAE::ModelDisplayBuilder::ConnectionStatus status /** status of the connection */,
                const NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters & parameters /** connection display parameters */
            );
            /** Gets display parameters for universal connections based on status. @return  connection display parameters 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters GetDisplayParametersByStatus
            (
                NXOpen::CAE::ModelDisplayBuilder::ConnectionStatus status /** status of the connection */
            );
            /** Add display parameters for universal connections based on diameter.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void AddDisplayParametersByDiameter
            (
                NXOpen::Expression * minimum /** minimum diameter expression */,
                NXOpen::Expression * maximum /** maximum diameter expression */,
                const NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters & parameters /** connection display parameters */
            );
            /**Returns  the number of diameter ranges.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: int NumberOfDiameterRanges
            (
            );
            /** Gets display parameters for universal connections based on the index from the diameter range list. @return  connection display parameters 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters GetParametersByDiameterRangeIndex
            (
                int index /** index from the diameter range list */,
                NXOpen::Expression ** minimum /** minimum diameter expression */,
                NXOpen::Expression ** maximum /** maximum diameter expression */
            );
            /** Update display parameters for universal connections based on the index from the diameter range list.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void UpdateParametersByDiameterRangeIndex
            (
                int index /** index from the diameter range list  */,
                const NXOpen::CAE::ModelDisplayBuilder::ConnectionDisplayParameters & parameters /** connection display parameters */
            );
            /** Update display parameters for universal connections based on the index from the diameter range list.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void RemoveDiameterRange
            (
                int index /** index from the diameter range list  */
            );
            /**Returns  the display material colorbar toggle 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool DisplayColorBar
            (
            );
            /**Sets  the display material colorbar toggle 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetDisplayColorBar
            (
                bool displayColorBar /** displaycolorbar */ 
            );
            /**Returns  the color polygon bodies toggle 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool ColorPolygonBodies
            (
            );
            /**Sets  the color polygon bodies toggle 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetColorPolygonBodies
            (
                bool colorBodies /** colorbodies */ 
            );
            /**Returns  the thermo-optical 2d mesh option 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ModelDisplayBuilder::ThermoOptical2dMeshOpt ThermoOptical2dMeshOption
            (
            );
            /**Sets  the thermo-optical 2d mesh option 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetThermoOptical2dMeshOption
            (
                NXOpen::CAE::ModelDisplayBuilder::ThermoOptical2dMeshOpt thermoOptical2dMeshOption /** thermooptical2dmeshoption */ 
            );
            /**Returns  the element thermo-optical black body color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::NXColor * ElemThermoOpticalBlackBodyColor
            (
            );
            /**Sets  the element thermo-optical black body color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetElemThermoOpticalBlackBodyColor
            (
                NXOpen::NXColor * blackBodyColor /** blackbodycolor */ 
            );
            /**Returns  the element thermo-optical no material color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::NXColor * ElemThermoOpticalNoMaterialColor
            (
            );
            /**Sets  the element thermo-optical no material color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetElemThermoOpticalNoMaterialColor
            (
                NXOpen::NXColor * noMaterialColor /** nomaterialcolor */ 
            );
            /**Returns  the no material color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::NXColor * ElemMaterialNoMaterialColor
            (
            );
            /**Sets  the no material color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetElemMaterialNoMaterialColor
            (
                NXOpen::NXColor * noMaterialColor /** nomaterialcolor */ 
            );
            /**Returns  the laminate color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::NXColor * ElemMaterialLaminateColor
            (
            );
            /**Sets  the laminate color 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetElemMaterialLaminateColor
            (
                NXOpen::NXColor * materialLaminateColor /** materiallaminatecolor */ 
            );
        };
    }
}
