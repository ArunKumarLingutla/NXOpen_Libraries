...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        PointArclength.Expression.Value </term> <description> 
         
        0.0 (millimeters part), 0.0 (inches part) </description> </item> 

        <item><term> 
         
        RadiusOption </term> <description> 
         
        PointOnFirstCurve </description> </item> 

        <item><term> 
         
        ShapeControlFirstCurve </term> <description> 
         
        2.0 </description> </item> 

        <item><term> 
         
        ShapeControlSecondCurve </term> <description> 
