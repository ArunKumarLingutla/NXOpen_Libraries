    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistDurWeldBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the custom simulation object 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::DurSpecialistSimulationObjectTable * CustomSimulationObject
            (
            );
            /**Sets  the custom simulation object 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: void SetCustomSimulationObject
            (
                NXOpen::CAE::DurSpecialistSimulationObjectTable * customSimulationObject /** recovery simulation object to assign  */
            );
