        ...
        */
        class JOINOPENCPPEXPORT  PointJoinHardware : public NXOpen::TaggedObject
        {
            ...
            public: enum AttributeDataSourceType
            {
                ...
                AttributeDataSourceTypeReuseLibrarySpecification/** reuse library specification */ 
            };
            ...
            /**Sets  the thread pitch of the point join hardware part.
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetThreadPitch
            (
                double threadPitch /** threadpitch */ 
            );
            ...
            /**Sets  the threaded length of the point join hardware part.
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetThreadedLength
            (
                double threadedLength /** threadedlength */ 
            );
            ...
            /**Returns  the Family Instance Name of the point join hardware part in its family table.
             ...
             <br> License requirements : nx_join (" NX Join") */
            public: NXString FamilyInstance
            (
            );
            /**Sets  the Family Instance Name of the point join hardware part in its family table.
                    It is the cell value of either the DB_PART_NO or OS_PART_NAME column of the instance's row in the part family table.
                    The cell value maybe prefixed with "DB_PART_NO:" or "OS_PART_NAME:" for a precise lookup for instance's values.
                    When not prefixed, both columns are checked for a match.
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetFamilyInstance
            (
                const NXString & familyInstance /** familyinstance */ 
            );
            /**Sets  the Family Instance Name of the point join hardware part in its family table.
                    It is the cell value of either the DB_PART_NO or OS_PART_NAME column of the instance's row in the part family table.
                    The cell value maybe prefixed with "DB_PART_NO:" or "OS_PART_NAME:" for a precise lookup for instance's values.
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            void SetFamilyInstance
            (
                const char * familyInstance /** familyinstance */ 
            );
            /**Returns  the Descriptive Name of the hardware specification in Reuse Library.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: NXString SpecificationDescriptiveName
            (
            );
            /**Sets  the Descriptive Name of the hardware specification in Reuse Library.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: void SetSpecificationDescriptiveName
            (
                const NXString & specDescName /** specdescname */ 
            );
            /**Sets  the Descriptive Name of the hardware specification in Reuse Library.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            void SetSpecificationDescriptiveName
            (
                const char * specDescName /** specdescname */ 
            );
        };
    }
}
