...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace AECDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  Stair : public NXOpen::Features::BodyFeature
            {
                private: StairImpl * m_stair_impl;
                private: friend class  _StairBuilder;
                protected: Stair();
                public: ~Stair();
            };
        }
