...
namespace NXOpen
{
    ...
    public:
        ...
        **/
        ...
        /** Returns the text that was passed into the constructor. This method can return nullptr. */
        const char* GetText() const;

        /** Returns the text in the encoding supported by the current locale. This method can return nullptr. */
        const char* GetLocaleText() const;

        /** Returns the text in UTF_8 encoding. This method can return nullptr. */
