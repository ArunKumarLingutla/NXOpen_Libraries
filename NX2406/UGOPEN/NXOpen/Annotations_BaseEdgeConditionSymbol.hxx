...
//
//  Source File:
//     Annotations_BaseEdgeConditionSymbol.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseEdgeConditionSymbolBuilder;
        class BaseEdgeConditionSymbolImpl;
        /** Represents a base edge condition symbol  <br> This is an abstract class, and cannot be instantiated.  <br> 
         <br>  Created in NX2007.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseEdgeConditionSymbol : public NXOpen::Annotations::DraftingAid, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseEdgeConditionSymbolImpl * m_baseedgeconditionsymbol_impl;
            private: friend class  _BaseEdgeConditionSymbolBuilder;
            protected: BaseEdgeConditionSymbol();
            public: ~BaseEdgeConditionSymbol();
