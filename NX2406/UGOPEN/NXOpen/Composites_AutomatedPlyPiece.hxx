...
//
//  Source File:
//     Composites_AutomatedPlyPiece.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Composites
    {
        class _AutomatedPlyPieceBuilder;
        class AutomatedPlyPieceImpl;
        ...
        */
        class COMPOSITESOPENCPPEXPORT  AutomatedPlyPiece : public NXOpen::Composites::Base, public virtual NXOpen::Composites::IPlyPiece
        {
            private: AutomatedPlyPieceImpl * m_automatedplypiece_impl;
            private: friend class  _AutomatedPlyPieceBuilder;
            protected: AutomatedPlyPiece();
            public: ~AutomatedPlyPiece();
