...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        CreateMaterialInFem </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FkmGuideline </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        OverrideSourceMaterial </term> <description> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistMaterialToolBuilder : public NXOpen::Builder
        {
            ...
            public: enum USlopeMaterialType
            {
                ...
                USlopeMaterialTypeSteelCaseHardeningSteel/** steel case hardening steel */ ,
                USlopeMaterialTypeSteelStainlessSteel/** steel stainless steel */ ,
                USlopeMaterialTypeSteelForgingSteel/** steel forging steel */ ,
                USlopeMaterialTypeSteelOtherTypes/** steel other types */ ,
                USlopeMaterialTypeCastIronDuctileGJSGGG/** cast iron ductile gjsggg */ ,
                USlopeMaterialTypeCastIronMalleableGJMGT/** cast iron malleable gjmgt */ ,
                USlopeMaterialTypeCastIronGrayGJLGG/** cast iron gray gjlgg */ ,
                USlopeMaterialTypeAluminumWroughtAlloy/** aluminum wrought alloy */ ,
                USlopeMaterialTypeAluminumCastAlloy/** aluminum cast alloy */ 
            };
            ...
            /**Returns  the FKM guideline 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool FkmGuideline
            (
            );
            /**Sets  the FKM guideline 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: void SetFkmGuideline
            (
                bool fkmGuideline /** FKM guideline to select the FKM materials */
            );
            ...
            /**Returns  the flag of creating material in FEM 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateMaterialInFem
            (
            );
            /**Sets  the flag of creating material in FEM 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: void SetCreateMaterialInFem
            (
                bool createMaterialInFem /** creatematerialinfem */ 
            );
            /**Returns  the flag of overriding source material 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool OverrideSourceMaterial
            (
            );
            /**Sets  the flag of overriding source material 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: void SetOverrideSourceMaterial
            (
                bool overrideSourceMaterial /** overridesourcematerial */ 
            );
        };
    }
}
