            ...
            */
            class NXOPENCPP_FEATURESEXPORT  DrawCurveData : public NXOpen::Builder
            {
                ...
                /**  Snap options used during curve drawing 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::DrawShapes::DrawCurveData::SnapToOptions NXOpen::DrawShapes::DrawCurveData::SnapToOptions@endlink  instead <br>  
                */
                public: enum NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::DrawShapes::DrawCurveData::SnapToOptions instead") SnappingOption
                {
                ...
                */
                public: enum SnapToOptions
                {
                    SnapToOptionsNone/** No snapping. */,
                    SnapToOptionsCurve/** Snap to point on curve, including curve end points .*/,
                    SnapToOptionsCurveWithTangent/** Snap to point on curve with tangent continuity.*/,
                    SnapToOptionsParallelCurve/** Snap parallel to curve or tangent continuous string of curves.*/,
                    SnapToOptionsIsoparametricGrid/** Snap to isoparametric grid.*/
                };
                ...
                /**Returns  the value indicating snapping option. 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::DrawShapes::DrawCurveData::SnapToOptions SnapToOption
                (
                );
                /**Sets  the value indicating snapping option. 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_draw_shape (" NX Draw Shape Functionality") */
                public: void SetSnapToOption
                (
                    NXOpen::Features::DrawShapes::DrawCurveData::SnapToOptions snapping /** snapping */ 
                );
                /**Returns  the target curves of parallel curve drawing 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::SelectDisplayableObjectList * ParallelCurveTargets
                (
                );
