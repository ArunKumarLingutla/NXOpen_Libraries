...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ParameterTable : public NXOpen::NXObject
    {
        ...
        /** Reorder the table data by expression names. Only the desired data to reorder needs to be identified. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void ReorderDataByExpression
        (
            const std::vector<NXString> & expressionNamesToReorder /** expression names that identify the data slices to reorder */,
            const NXString & targetExpressionName /** identifying expression name to reorder data before */
        );
        /** Reorder the table data by expression names. Only the desired data to reorder needs to be identified. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        void ReorderDataByExpression
        (
            const std::vector<NXString> & expressionNamesToReorder /** expression names that identify the data slices to reorder */,
            const char * targetExpressionName /** identifying expression name to reorder data before */
        );
        /** Get all of the table configuration names. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void GetConfigurations
        (
            std::vector<NXString> & configurations /** configuration names in the design order (can be NULL) */
        );
        /** Reorder the table configurations. The input array must match the existing names and number of table configurations for proper reordering. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void ReorderConfigurations
        (
            const std::vector<NXString> & newConfigurationsOrder /** configuration names in the design order to be saved */
        );
    };
}
