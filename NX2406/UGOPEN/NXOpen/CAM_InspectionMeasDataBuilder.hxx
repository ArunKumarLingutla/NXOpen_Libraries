        ...
        */
        class NXOPENCPP_CAMEXPORT  InspectionMeasDataBuilder : public NXOpen::Builder
        {
            ...
            public: enum InputFormatType
            {
                ...
                InputFormatTypeStl/** STL file (3D Printing) */
            };
            ...
            /** STL File Units */
            public: enum StlFileUnitsType
            {
                StlFileUnitsTypeMillimeters/** millimeters */ ,
                StlFileUnitsTypeInches/** inches */ 
            };
            ...
            /**Returns  the option to specify the point distance tolerance 
             ...
             <br> License requirements : None */
            public: bool SpecifyMinimumPointToPointDistance
            (
            );
            /**Sets  the option to specify the point distance tolerance 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetSpecifyMinimumPointToPointDistance
            (
                bool specifyDistance /** specifydistance */ 
            );
            /**Returns  the distance tolerance when adding points as measured data 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: double MinimumPointToPointDistance
            (
            );
            /**Sets  the distance tolerance when adding points as measured data 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetMinimumPointToPointDistance
            (
                double distanceTolerance /** distancetolerance */ 
            );
            /**Returns  the option to specify the point distance tolerance 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool SpecifyMaximumPointToFaceDistance
            (
            );
            /**Sets  the option to specify the point distance tolerance 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetSpecifyMaximumPointToFaceDistance
            (
                bool specifyDistance /** specifydistance */ 
            );
            /**Returns  the distance tolerance when adding points as measured data 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: double MaximumPointToFaceDistance
            (
            );
            /**Sets  the distance tolerance when adding points as measured data 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetMaximumPointToFaceDistance
            (
                double distanceTolerance /** distancetolerance */ 
            );
            /**Returns  the option to specify the maximum normal angle 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool SpecifyMaximumNormalAngle
            (
            );
            /**Sets  the option to specify the maximum normal angle 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetSpecifyMaximumNormalAngle
            (
                bool specifyMaximumNormalAngle /** specifymaximumnormalangle */ 
            );
            /**Returns  the maximum normal angle when adding stl file as measured data 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: double MaximumNormalAngle
            (
            );
            /**Sets  the maximum normal angle when adding stl file as measured data 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetMaximumNormalAngle
            (
                double maximumNormalAngle /** maximumnormalangle */ 
            );
            /**Returns  the option to require that point project onto the face 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool RequireThatPointsProjectToFace
            (
            );
            /**Sets  the option to require that point project onto the face 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetRequireThatPointsProjectToFace
            (
                bool requireThatPointsProjectToFace /** requirethatpointsprojecttoface */ 
            );
            /**Returns  the STL file units when adding measured data 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InspectionMeasDataBuilder::StlFileUnitsType StlFileUnits
            (
            );
            /**Sets  the STL file units when adding measured data 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetStlFileUnits
            (
                NXOpen::CAM::InspectionMeasDataBuilder::StlFileUnitsType stlFileUnits /** stlfileunits */ 
            );
        };
    }
}
