...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a major angular dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::MajorAngularDimensionBuilder  NXOpen::Annotations::MajorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  MajorAngularDimension : public NXOpen::Annotations::AngularDimension, public virtual NXOpen::Annotations::IPmi
        {
