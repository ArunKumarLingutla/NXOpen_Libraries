...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        AdvancedMethodOption </term> <description> 
         
        AdvancedOff </description> </item> 
        ...
        ExtractMethod </term> <description> 
         
        Original </description> </item> 

        <item><term> 
         
        FaceFinder.CloneEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.CoaxialEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.CoplanarAxesEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.CoplanarEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.EqualDiameterEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.OffsetEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.ParallelEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.PatternEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.PerpendicularEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.RigidBodyFaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.SameEntryEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.SameEntrySurfaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.SameOrbitEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.SymmetricEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.TangentEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.ThicknessChainEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceFinder.UseFaceBrowse </term> <description> 
        ...
        PlanarizeProjectionPlane </term> <description> 
         
        YZ </description> </item> 

        <item><term> 
         
        PrincipalMovementDirection </term> <description> 
         
        Z </description> </item> 

        <item><term> 
         
        PrincipalRotatingAxis </term> <description> 
         
        Z </description> </item> 

        <item><term> 
         
        PrincipalScalingDirection </term> <description> 
        ...
        ProportionalFallOffScale (deprecated) </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StudioXformBuilderEx : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum PlanarizeMethodType
            {
                ...
                PlanarizeMethodTypeView/** planarize at a plane determined by control polyline and view */
            };
            ...
            */
            ...
            /** Represents the planarize project direction option */
            public: enum PlanarizeProjectionDirectionOptions
            {
                PlanarizeProjectionDirectionOptionsAlongPolyline/** Along Polyline */,
                PlanarizeProjectionDirectionOptionsNormalToPlane/** Normal To Plane */
            };
            ...
            /**Returns  the symmetry edit 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool EditSymmetrically
            (
            );
            /**Sets  the symmetry edit 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetEditSymmetrically
            (
                bool editSymmetrically /** editsymmetrically */ 
            );
            ...
            /** Update symmetry edit plane 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void UpdateSymmetryEditPlane
            (
            );
            /** Update geometry symmetrically 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void UpdateSymmetryGeometry
            (
                bool checkPoles /** flag to check if poles cross the symmetry plane. */
            );
            /** Update entity geometry from contol poles positions 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void UpdateGeometryFromControlPolesData
            (
                NXOpen::NXObject * xformObject /** the selected face or curve to get geometry from control pole manager */
            );
            /**Returns  a value indicating whether to display deviation 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayDeviation
            (
            );
            /**Sets  a value indicating whether to display deviation 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetDisplayDeviation
            (
                bool isDisplay /** isdisplay */ 
            );
            /**Returns  the planarize project direction option 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::StudioXformBuilderEx::PlanarizeProjectionDirectionOptions PlanarizeProjectionDirectionOption
            (
            );
            /**Sets  the planarize project direction option 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetPlanarizeProjectionDirectionOption
            (
                NXOpen::Features::StudioXformBuilderEx::PlanarizeProjectionDirectionOptions type /** type */ 
            );
        };
    }
}
