    ...
    namespace PID
    {
        ...
        */
        class PIDOPENCPPEXPORT  PipeBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the line type path ID of the Pipe. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            ...
            /**Returns  the pipe discipline type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PID::PipeDisciplineType Discipline
            (
            );
            /**Sets  the pipe discipline type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            public: void SetDiscipline
            (
                NXOpen::PID::PipeDisciplineType disciplineType /** disciplinetype */ 
            );
            ...
            /**Sets  the option to override line type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            public: void SetOverrideLineType
            (
                bool overrideLineType /** overridelinetype */ 
            );
            /**Returns  the over stock path ID of the pipe. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXString OverStockPathId
            (
            );
            /**Sets  the over stock path ID of the pipe. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            public: void SetOverStockPathId
            (
                const NXString & overStockPathId /** overstockpathid */ 
            );
            /**Sets  the over stock path ID of the pipe. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_pid_design_author ("NX P and ID Design Author") */
            void SetOverStockPathId
            (
                const char * overStockPathId /** overstockpathid */ 
            );
            /**Returns  the owner of pipe stock attributes group.
             <br>  Created in NX1988.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * PipeStockAttributeOwner
            (
            );
            /**Returns  the owner of overstock attributes group.
             <br>  Created in NX1988.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * OverstockAttributeOwner
            (
            );
            /**Returns  the owner of pipe attributes.
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * PipeAttributeOwner
            (
            );
        };
    }
