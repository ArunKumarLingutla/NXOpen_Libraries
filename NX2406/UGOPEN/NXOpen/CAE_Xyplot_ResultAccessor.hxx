        ...
        namespace Xyplot
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  ResultAccessor : public NXOpen::TransientObject
            {
                ...
                (
                    int graphIndex /** The graph index starts form 0 to graph count -1. Get graph count from @link ResultAccessor.GraphCount@endlink */,
                    int recordIndex /** The record index starts form 0 to record count -1. Get record count from @link ResultAccessor.RecordCount@endlink */
                );
                ...
                (
                    int graphIndex /** The graph index starts form 0 to graph count -1. Get graph count from @link ResultAccessor@endlink */,
                    int recordIndex /** The record index starts form 0 to record count -1. Get record count from @link ResultAccessor.RecordCount@endlink */
                );
                ...
                /**Returns  the number of records this object can access. 
                                ...
                                If @link NXOpen.CAE.Xyplot.ResultAccessor.OnCanvas@endlink is true,
