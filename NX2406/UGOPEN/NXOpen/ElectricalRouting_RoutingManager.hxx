        ...
        */
        class NXOPENCPP_ELECTRICALROUTINGEXPORT  RoutingManager
        {
            ...
            */
            ...
            public: void SetActiveWiringComponent
            (
                NXOpen::Part * rootPart /** rootpart */ ,
                NXOpen::Assemblies::Component * activeWiringComp /** activewiringcomp */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Assemblies::Component *> GetWiringComponents
            (
                NXOpen::Assemblies::Component * rootPart /** rootpart */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: void DeleteWiringData
            (
                NXOpen::Part * harenssPart /** harensspart */ 
            );
            ...
            public: void ShowOnlyDerivatives
            (
                const std::vector<NXOpen::Routing::Electrical::DerivativeDevice *> & derivatives /** derivatives */ 
            );
