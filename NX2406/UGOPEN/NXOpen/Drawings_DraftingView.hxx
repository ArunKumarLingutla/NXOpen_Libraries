    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  DraftingView : public NXOpen::View, public virtual NXOpen::IFitTo
        {
            ...
            public: void UpdateAutomaticViewBound
            (
                bool updateDependent /** updatedependent */ 
            );
            /** Returns all drafting @link  NXOpen::Sketch   NXOpen::Sketch @endlink es of the view.  @return  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Sketch *> GetDraftingSketches
            (
            );
            /** Returns the absolute min-max box that contains all the entities in the view. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void CalculateMinMaxBox
            (
                NXOpen::Point3d* minimumPoint /** minimumpoint */ ,
                NXOpen::Point3d* maximumPoint /** maximumpoint */ 
            );
