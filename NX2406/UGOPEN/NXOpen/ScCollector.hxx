...
namespace NXOpen
{
    ...
    enum ScEvaluationFiltertype
    {
        ...
        ScEvaluationFiltertypeMinimumBody/** minimum body */ ,
        ScEvaluationFiltertypeSheetBody/** sheet body */ ,
        ScEvaluationFiltertypeFacetEntity/** facet entity */ 
    };
    ...
    */
    class NXOPENCPPEXPORT  ScCollector : public NXOpen::DisplayableObject
    {
        ...
        /** Get custom rule from collector  @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Features::CustomRule * GetCustomRule
        (
        );
        /** Add Rules to collector 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void AddRules
        (
            const std::vector<NXOpen::SelectionIntentRule *> & rules /** Selection intent rules to be added */
        );
        /** Returns the collector rules and entities collected by rules 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
