...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class ViewStyleAECViewLinesBuilderList;
    }
    namespace Drawings
    {
    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilderList * ViewStyleShipGeneralArrangementViewLinesList
            (
            );
            /** Gets the @link NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilder NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilder@endlink  with the given view plan and display name  @return  Returns the Ship General Arrangement View Lines sub-builders with the given ViewPlan and DisplayName 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") */
            public: NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilder * FindShipGeneralArrangementViewLinesBuilderByName
            (
            ...
            /** Gets the @link NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilder NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilder@endlink  with the given view plan and display name  @return  Returns the Ship General Arrangement View Lines sub-builders with the given ViewPlan and DisplayName 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") */
            NXOpen::Drawings::ShipGeneralArrangementViewLinesBuilder * FindShipGeneralArrangementViewLinesBuilderByName
            (
            ...
            /**Returns  the AEC View lines builder of the view style builder which represents the AEC drafting view lines on the View Style Dialog 
             ...
             <br> License requirements : None */
            public: NXOpen::Drawings::ViewStyleAECViewLinesBuilderList * ViewStyleAecViewLinesList
            (
            );
            /** Gets the @link NXOpen::Drawings::ViewStyleAECViewLinesBuilder NXOpen::Drawings::ViewStyleAECViewLinesBuilder@endlink  with the given view plan and display name  @return  Returns the AEC View Lines sub-builders with the given ObjectName 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::ViewStyleAECViewLinesBuilder * FindAECViewLinesBuilderByName
            (
                const NXString & structureName /** structurename */ 
            );
            /** Gets the @link NXOpen::Drawings::ViewStyleAECViewLinesBuilder NXOpen::Drawings::ViewStyleAECViewLinesBuilder@endlink  with the given view plan and display name  @return  Returns the AEC View Lines sub-builders with the given ObjectName 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Drawings::ViewStyleAECViewLinesBuilder * FindAECViewLinesBuilderByName
            (
                const char * structureName /** structurename */ 
            );
            /** Creates a @link NXOpen::Drawings::ViewStyleAECViewLinesBuilder NXOpen::Drawings::ViewStyleAECViewLinesBuilder@endlink   @return  Returns the empty AEC View Lines sub-builder on View Style 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::ViewStyleAECViewLinesBuilder * CreateAECViewLinesBuilder
            (
            );
