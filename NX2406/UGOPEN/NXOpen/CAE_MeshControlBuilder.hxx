    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshControlBuilder : public NXOpen::Builder
        {
            ...
            /** the imprint shape for mapped hole mesh control*/
            public: enum ShapeImprintType
            {
                ShapeImprintTypeNone/** none */ ,
                ShapeImprintTypeAutomatic/** automatic */ ,
                ShapeImprintTypeBox/** box */ 
            };
            ...
            /**Returns  the target selection for boundary layer 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::SelectNXObjectList * BlTargetSelection
            (
            );
            ...
            /**Returns  the boundary layer Dimension 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: int BlDimension
            (
            );
            /**Sets  the boundary layer Dimension 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetBlDimension
            (
                int blDimension /** bldimension */ 
            );
            ...
            /**Returns  the flag for apply shape imprints for mapped holes 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use @link NXOpen::CAE::MeshControlBuilder::MappedHoleShapeImprintType NXOpen::CAE::MeshControlBuilder::MappedHoleShapeImprintType@endlink  instead. <br>  

             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use NXOpen::CAE::MeshControlBuilder::MappedHoleShapeImprintType instead.") bool MappedApplyShapeImprints
            (
            );
            /**Sets  the flag for apply shape imprints for mapped holes 
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use NXOpen::CAE::MeshControlBuilder::MappedHoleShapeImprintType instead.") void SetMappedApplyShapeImprints
            (
                bool applyShapeImprints /** applyshapeimprints */ 
            );
            /**Returns  the menu option for shape imprints for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::MeshControlBuilder::ShapeImprintType MappedHoleShapeImprintType
            (
            );
            /**Sets  the menu option for shape imprints for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetMappedHoleShapeImprintType
            (
                NXOpen::CAE::MeshControlBuilder::ShapeImprintType eShapeImprintType /** eshapeimprinttype */ 
            );
            /**Returns  the flag for pave layer for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool PaveLayer
            (
            );
            /**Sets  the flag for pave layer for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetPaveLayer
            (
                bool paveLayer /** pavelayer */ 
            );
            /**Returns  the expression for box depth for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * BoxDepth
            (
            );
            /**Returns  the expression for elements through depth for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ElementsThroughDepth
            (
            );
            /**Returns  the flag for lock box boundary for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool LockBoxBoundary
            (
            );
            /**Sets  the flag for lock box boundary for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetLockBoxBoundary
            (
                bool fLockBoxBoundary /** flockboxboundary */ 
            );
            /**Returns  the flag for extend to face boundary for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool ExtendToFaceBoundary
            (
            );
            /**Sets  the flag for extend to face boundary for mapped holes 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetExtendToFaceBoundary
            (
                bool fExtendToBoundary /** fextendtoboundary */ 
            );
        };
    }
}
