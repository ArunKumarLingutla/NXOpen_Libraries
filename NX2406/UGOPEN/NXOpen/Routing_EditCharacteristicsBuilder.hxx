        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  EditCharacteristicsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the Routing Level associated with selected objects. 
             <br>  @deprecated Deprecated in NX2406.0.0.  This call can be safely removed as this is now a no-op. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  This call can be safely removed as this is now a no-op.") NXString RoutingLevel
            (
            );
            /**Sets  the Routing Level associated with selected objects. 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  This call can be safely removed as this is now a no-op.") void SetRoutingLevel
            (
