...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a datum target  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiDatumTargetBuilder  NXOpen::Annotations::PmiDatumTargetBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DatumTarget : public NXOpen::Annotations::DraftingDatumTarget, public virtual NXOpen::Annotations::IPmi
        {
