        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BurringInsertBuilder : public NXOpen::Builder
        {
            ...
            public: enum DesignOptions
            {
                ...
                DesignOptionsBurringAll/** design the burring punch and die together*/
            };
            ...
            {
                BlankTypesStandard/** use standard type*/,
                BlankTypesUserDefined/** use user defined type*/,
                BlankTypesEdit/** edit user defined type*/,
                BlankTypesDelete/** Delete insert*/
            };
            ...
            public: enum BlankPositions
            {
                ...
                BlankPositionsBottomBackingPlate/** the blank is on the bottoming backing plate*/,
                BlankPositionsTopPunchPlate/** the blank is on the top punch plate for reverse die*/,
                BlankPositionsBottomPunchPlate/** the blank is on the bottom punch plate for reverse die*/
            };
            ...
            /**Returns  the punch or die to delete 
             ...
             <br> License requirements : None */
            public: NXOpen::Assemblies::SelectComponentList * BurringInsertDelete
            (
            );
            /**Returns  the blank type. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::BurringInsertBuilder::BlankTypes BlankType
            (
            );
            /**Sets  the blank type. 
             <br>  Created in NX2212.0.0.  <br>  
            ...
            (
                NXOpen::Tooling::BurringInsertBuilder::BlankTypes blankType /** blanktype */ 
            );
            /**Returns  the blank position in punch plate or stripper plate. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::BurringInsertBuilder::BlankPositions BlankPosition
            (
            );
            ...
            (
                NXOpen::Tooling::BurringInsertBuilder::BlankPositions blankPosition /** blankposition */ 
            );
            /**Returns  the burring insert part tag. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::TaggedObject * BurringInsertPart
            (
            );
            /**Sets  the burring insert part tag. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetBurringInsertPart
            (
                NXOpen::TaggedObject * burringInsertPart /** burringinsertpart */ 
            );
            ...
            /** The action to craete datum plane for burring die 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CreateOffsetDatumPlaneForBurringDie
            (
            );
            ...
            /** Suppress or unsuppress some features 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SuppressOrUnsuppressFeatures
            (
                NXOpen::TaggedObject * partTag /** parttag */ ,
                bool isSuppress /** issuppress */ 
            );
        };
    }
}
