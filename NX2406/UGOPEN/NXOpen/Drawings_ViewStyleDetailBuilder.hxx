        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleDetailBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the clip boundary toggle on the DETAIL tab of the View Style Dialog 
             ...
             <br> License requirements : None */
            public: bool ClipViewBoundary
            (
            );
            /**Sets  the clip boundary toggle on the DETAIL tab of the View Style Dialog 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetClipViewBoundary
            (
                bool clipViewBoundaryToggle /** Sets the clip boundary toggle value on the detail sub-builder */
            );
