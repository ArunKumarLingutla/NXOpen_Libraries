...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        EntireComponentPattern </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PreviewFalseBody </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  PocketBuilder : public NXOpen::Builder
        {
            ...
            public: enum RsetType
            {
                ...
                RsetTypeTrue/** true */,
                RsetTypeBoth/** both */,
                RsetTypeAddMaterial/** add material */,
                RsetTypeNoChange/** no change */
            };
            ...
            /**Returns  the option that indicates whether to remove the tool component(s) when deleting pockets 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool RemoveToolComponent
            (
            );
            /**Sets  the option that indicates whether to remove the tool component(s) when deleting pockets 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            public: void SetRemoveToolComponent
            (
                bool removeComponent /** removecomponent */ 
            );
            /**Returns  the name of the tool reference set 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXString ToolReferenceSet
            (
            );
            /**Sets  the name of the tool reference set 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            public: void SetToolReferenceSet
            (
            ...
            /**Sets  the name of the tool reference set 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            void SetToolReferenceSet
            (
                const char * referenceSetName /** referencesetname */ 
            );
            /**Returns  the name of the feature set grouping the pocket features 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GroupSetName
            (
            );
            /**Sets  the name of the feature set grouping the pocket features 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            public: void SetGroupSetName
            (
                const NXString & goupName /** goupname */ 
            );
            /**Sets  the name of the feature set grouping the pocket features 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            void SetGroupSetName
            (
                const char * goupName /** goupname */ 
            );
        };
    }
}
