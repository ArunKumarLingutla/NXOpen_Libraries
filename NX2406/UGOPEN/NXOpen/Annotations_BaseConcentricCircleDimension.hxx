...
//
//  Source File:
//     Annotations_BaseConcentricCircleDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseConcentricCircleDimensionBuilder;
        class BaseConcentricCircleDimensionImpl;
        /** Represents a concentric circle dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseConcentricCircleDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseConcentricCircleDimensionImpl * m_baseconcentriccircledimension_impl;
            private: friend class  _BaseConcentricCircleDimensionBuilder;
            protected: BaseConcentricCircleDimension();
            public: ~BaseConcentricCircleDimension();
