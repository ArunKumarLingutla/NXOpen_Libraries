    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  CurveLengthBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the reverse guide curve direction flag. Indicates whether the guide curve loop direction has been flipped from its initial inferred direction 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool ReverseGuideCurveLoopDirection
            (
            );
            /**Sets  the reverse guide curve direction flag. Indicates whether the guide curve loop direction has been flipped from its initial inferred direction 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SetReverseGuideCurveLoopDirection
            (
                bool reverseGuideCurveLoopDirection /** reverseguidecurveloopdirection */ 
            );
