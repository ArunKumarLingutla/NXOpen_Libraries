    ...
    namespace Join
    {
        ...
        */
        class JOINOPENCPPEXPORT  TransformBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            {
                AssociativityTypesSourceJoin/** Associative to source join. */,
                AssociativityTypesDestinationGeometry/** Associative to Destination geometry. */
            };
            ...
            /**Returns  the associativity type 
             ...
             <br> License requirements : nx_join (" NX Join") */
            public: NXOpen::Join::TransformBuilder::AssociativityTypes AssociativityType
            (
            );
            ...
            (
                NXOpen::Join::TransformBuilder::AssociativityTypes associativityType /** associativitytype */ 
            );
