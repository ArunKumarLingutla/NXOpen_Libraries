        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PostProcess
        {
            ...
            struct EnvelopeTolerance
            {
                ...
                public: /** Indicates if envelopeTolerance is specified as percentage value or absolute value. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */NXOpen::Motion::PostProcess::EnvelopeToleranceTypes ToleranceType;
                public: /** Tolerance value. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */double Tolerance;
                public: /** Indicates if decimation is enabled or not. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink .*/bool DecimationEnabled;
                public: /** Specifies targeted decimation rate which is decimated body/original body. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */double DecimationFactor;
                public: /** Specifies max decimation error: (bigger than 0): percentage, (less than 0): absolute value. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */double DecimationMaxError;
                ...
                public: EnvelopeTolerance(NXOpen::Motion::PostProcess::EnvelopeAccuracyModes accuracyModeInitial /** Accuracy mode. @link Motion::PostProcess::EnvelopeAccuracyModes  Motion::PostProcess::EnvelopeAccuracyModes @endlink .*/, 
                        NXOpen::Motion::PostProcess::EnvelopeToleranceTypes toleranceTypeInitial /** Indicates if envelopeTolerance is specified as percentage value or absolute value. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */, 
                        double toleranceInitial /** Tolerance value. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */, 
                        bool decimationEnabledInitial /** Indicates if decimation is enabled or not. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink .*/, 
                        double decimationFactorInitial /** Specifies targeted decimation rate which is decimated body/original body. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */, 
                        double decimationMaxErrorInitial /** Specifies max decimation error: (bigger than 0): percentage, (less than 0): absolute value. Used only if accuracyMode is @link Motion::PostProcess::EnvelopeAccuracyModesCustom  Motion::PostProcess::EnvelopeAccuracyModesCustom @endlink . */) :
            ...
            /** The modes for post process */
            public: enum PostMode
            {
                PostModeNoPost/** no post */ ,
                PostModeAnimation/** animation */ ,
                PostModeArticulation/** articulation */ ,
                PostModeSpreadsheetRun/** spreadsheet run */ ,
                PostModeLoadTransfer/** load transfer */ ,
                PostModePostTools/** post tools */ ,
                PostModeEigenvectorAnimation/** eigenvector animation */ ,
                PostModeStaticModeAnimation/** static mode animation */ ,
                PostModeUnsupported/** unsupported */ 
            };
            ...
            /** Creates envelopes for the given objects, support window platform only." 
            ...
            /** Export to movie 
             <br>  @deprecated Deprecated in NX2406.0.0.  Use @link NXOpen::Motion::PostProcess::ExportToMovieWithSettings NXOpen::Motion::PostProcess::ExportToMovieWithSettings@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::Motion::PostProcess::ExportToMovieWithSettings instead.") void ExportToMovie
            (
            ...
            /** Export a real-time movie 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::Motion::PostProcess::ExportToMovieWithSettings instead.") void ExportRealTimeMovie
            (
                const NXString & movieName /** Name for movie to export */
            );
            /** Export a real-time movie 
            ...
            /** Get Motion Solver Performance Report  @return  The @link  NXOpen::Motion::SolverPerformanceReport  NXOpen::Motion::SolverPerformanceReport@endlink  object
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SolverPerformanceReport * GetSolverPerformanceReport
            (
                NXOpen::Part * motionPart /** motionpart */ 
            );
            /** Updates the motion function plots. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void RefreshFunctionPlots
            (
                NXOpen::Part * motionPart /** motionpart */ 
            );
            /** Get the post process mode  @return  The post process mode
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::PostProcess::PostMode GetPostMode
            (
                NXOpen::Part * motionPart /** motionpart */ 
            );
            /** Constructs a new @link NXOpen::Motion::AnimationMovieSettings NXOpen::Motion::AnimationMovieSettings@endlink  object. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::AnimationMovieSettings * NewAnimationMovieSettings
            (
            );
            /** Export to movie with settings. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void ExportToMovieWithSettings
            (
                NXOpen::Motion::PostControl * postControl /** Post control for exporting a movie */,
                NXOpen::Motion::AnimationMovieSettings * animationMovieSettings /** Settings for exporting a movie */
            );
