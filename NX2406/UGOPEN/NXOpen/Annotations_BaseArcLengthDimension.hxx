...
//
//  Source File:
//     Annotations_BaseArcLengthDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseArcLengthDimensionBuilder;
        class BaseArcLengthDimensionImpl;
        /** Represents a arc length dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseArcLengthDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseArcLengthDimensionImpl * m_basearclengthdimension_impl;
            private: friend class  _BaseArcLengthDimensionBuilder;
            protected: BaseArcLengthDimension();
            public: ~BaseArcLengthDimension();
