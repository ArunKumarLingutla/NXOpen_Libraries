...
namespace NXOpen
{
    namespace Weld
    {
        ...
        */
        ...
        {
            WeldDatumControlDirectionInvalid/** Invalid direction */ = -1,
        ...
        {
            WeldMeasurementSizeMethodInvalid/** Invalid size method */ = -1,
        ...
        {
            WeldOverlapStatusInvalid/** invalid status */ = -1,
        ...
        enum WeldAttribType
        {
            WeldAttribTypeInteger/** integer */ = 1,
            WeldAttribTypeReal/** real    */,
            WeldAttribTypeNull/** null    */ = 4,
