...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _PmiCenterMarkBuilder;
        class PmiCenterMarkImpl;
        /** Represents a PMI Center Mark class  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiCenterMarkBuilder  NXOpen::Annotations::PmiCenterMarkBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiCenterMark : public NXOpen::Annotations::BaseCenterMark, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiCenterMarkImpl * m_pmicentermark_impl;
            private: friend class  _PmiCenterMarkBuilder;
            protected: PmiCenterMark();
            public: ~PmiCenterMark();
