        ...
        */
        class NXOPENCPP_CAEEXPORT  Acoustics
        {
            ...
            */
            ...
            /** Returns the @link NXOpen::CAE::SimSoundProcessingTools NXOpen::CAE::SimSoundProcessingTools@endlink  
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::CAE::SimSoundProcessingTools *AuralizationTools();

            /// \cond NX_NO_DOC 
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
            */
            public: NXOpen::CAE::AcousticsVerticalsTools *VerticalsTools();
