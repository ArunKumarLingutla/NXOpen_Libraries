    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultProbeBuilder : public NXOpen::Builder
        {
            ...
            /** Options to calculate @link CAE::ResultProbeBuilder::GeometryValueWeightedAverage CAE::ResultProbeBuilder::GeometryValueWeightedAverage@endlink  or 
                        @link CAE::ResultProbeBuilder::GeometryValueIntegral CAE::ResultProbeBuilder::GeometryValueIntegral@endlink  over elements on a face*/
            ...
            /** Options to calculate @link CAE::ResultProbeBuilder::GeometryValueWeightedAverage CAE::ResultProbeBuilder::GeometryValueWeightedAverage@endlink  or 
                        @link CAE::ResultProbeBuilder::GeometryValueIntegral CAE::ResultProbeBuilder::GeometryValueIntegral@endlink  over body*/
            public: enum BodyIntegral
            {
                BodyIntegralVolume/** volume */ 
            };
            ...
            /**Returns  the skip steps 
             <br>  @deprecated Deprecated in NX2406.0.0.  No replacement. <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  No replacement.") int SkipSteps
            (
            );
            /**Sets  the skip steps 
             <br>  @deprecated Deprecated in NX2406.0.0.  No replacement. <br>  
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  No replacement.") void SetSkipSteps
            (
            ...
            /**Returns  the body integral option 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::ResultProbeBuilder::BodyIntegral BodyIntegralOption
            (
            );
            /**Sets  the body integral option 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetBodyIntegralOption
            (
                NXOpen::CAE::ResultProbeBuilder::BodyIntegral bodyIntegral /** bodyintegral */ 
            );
        };
    }
}
