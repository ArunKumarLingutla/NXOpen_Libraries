    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  DriverOperation : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the override state of the type option
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState TypeOptionOvrCtrl
            (
            );
            /**Sets  the override state of the type option
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetTypeOptionOvrCtrl
            (
            ...
            /**Returns  the initial control velocity expression
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * ControlInitialVelocityExpression
            (
            );
            /**Returns  the initial control acceleration expression
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * ControlInitialAccelerationExpression
            (
            );
            ...
            /**Returns  the control velocity port
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SelectControlPort * ControlVelocityPort
            (
            );
            /**Returns  the control acceleration port
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SelectControlPort * ControlAccelerationPort
            (
            );
            /**Returns  the profile
            ...
            /**Returns  the override state of the Port 
             ...
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ControlPortOvrCtrl
            (
            );
            /**Sets  the override state of the Port 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetControlPortOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the override state of the Control Velocity Port 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ControlVelocityPortOvrCtrl
            (
            );
            /**Sets  the override state of the Control Velocity Port 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetControlVelocityPortOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            /**Returns  the override state of the ControlAcceleration Port 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ControlAccelerationPortOvrCtrl
            (
            );
            /**Sets  the override state of the ControlAcceleration Port 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetControlAccelerationPortOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
        };
