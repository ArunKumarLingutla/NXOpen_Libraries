    ...
    namespace UserDefinedObjects
    {
        ...
        */
        class NXOPENCPP_USERDEFINEDOBJECTSEXPORT  UserDefinedClass : public NXOpen::TransientObject
        {
            ...
            {
                AllowOwnedObjectSelectionOff/** You do NOT have permission to select objects owned by this class. */ = 1,
            ...
            {
                AllowQueryClassOff/** You do NOT have permission to query the class from it's name. */ = 1,
            ...
            {
                SelectionOff/** UDO's of this class will NOT be selectable. */ = 1,
            ...
            public: /** Prototype for information, edit, suppress, pre-save, post-load and on-delete callbacks 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Registers the post load callback. 
             ...
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void AddPostLoadHandler
            (
                const NXOpen::UserDefinedObjects::UserDefinedClass::GenericCallback&  udoEvent /** udo event */ 
            );
            /** Registers the on delete callback. 
             ...
             <br> License requirements : None */
            public: void AddOnDeleteHandler
            (
                const NXOpen::UserDefinedObjects::UserDefinedClass::GenericCallback&  udoEvent /** udo event */ 
            );
