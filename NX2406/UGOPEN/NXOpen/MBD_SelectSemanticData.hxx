...
namespace NXOpen
{
    ...
    namespace MBD
    {
        class _SelectSemanticDataBuilder;
        class SelectSemanticDataImpl;
        ...
        */
        class MBDOPENCPPEXPORT  SelectSemanticData : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSemanticDataImpl * m_selectsemanticdata_impl;
            private: friend class  _SelectSemanticDataBuilder;
            protected: SelectSemanticData();
            public: ~SelectSemanticData();
            ...
            (
                NXOpen::MBD::SemanticData * selection /** selected object */
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::MBD::SemanticData * Value
            (
            );
            ...
            (
                ...
                NXOpen::MBD::SemanticData * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::MBD::SemanticData * selection2 /** second selected object */,
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::MBD::SemanticData * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
