...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        CncOption </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CncTemplate </term> <description> 
         
        CncTemplate1 </description> </item> 

        <item><term> 
         
        DraftingMode </term> <description> 
         
        Create </description> </item> 

        <item><term> 
         
        DrawingType </term> <description> 
         
        MasterModel </description> </item> 

        <item><term> 
         
        EdmOption </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        EdmTemplate </term> <description> 
         
        EdmTemplate1 </description> </item> 

        <item><term> 
         
        IncludeOption </term> <description> 
        ...
        OutputPDF </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        OutputSameSheet </term> <description> 
        ...
        SheetName </term> <description> 
         
        Sh1 </description> </item> 

        <item><term> 
         
        UseInstance </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  EWDraftingBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the blank components used to create drafting. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: NXOpen::Assemblies::SelectComponentList * BlankComps
            (
            );
            ...
            /**Returns  the option to gray out edm sheet type drafting or not. 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: bool EdmSensitivity
            (
            );
            /**Sets  the option to gray out edm sheet type drafting or not. 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetEdmSensitivity
            (
                bool edmSensitivity /** edmsensitivity */ 
            );
            ...
            /**Returns  the option to gray out cnc sheet type drafting or not. 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: bool CncSensitivity
            (
            );
            /**Sets  the option to gray out cnc sheet type drafting or not. 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetCncSensitivity
            (
                bool cncSensitivity /** cncsensitivity */ 
            );
            ...
            /** The template name of edm sheet type to create drafting. 
             ...
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetEdmTemplateName
            (
                const NXString & edmTemplateName /** edmtemplatename */ 
            );
            /** The template name of edm sheet type to create drafting. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            void SetEdmTemplateName
            (
                const char * edmTemplateName /** edmtemplatename */ 
            );
            /** The template name of cnc sheet type to create drafting. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetCncTemplateName
            (
                const NXString & cncTemplateName /** cnctemplatename */ 
            );
            /** The template name of cnc sheet type to create drafting. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            void SetCncTemplateName
            (
                const char * cncTemplateName /** cnctemplatename */ 
            );
            /**Returns  the option to hide the datum CSYS in the drawing sheet. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: bool HideCsys
            (
            );
            /**Sets  the option to hide the datum CSYS in the drawing sheet. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetHideCsys
            (
                bool hideCsys /** hidecsys */ 
            );
            /** Get the clone client data.  @return  A @link NXOpen::Tooling::CloneObject NXOpen::Tooling::CloneObject@endlink  instance 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: NXOpen::Tooling::CloneObject * GetCloneObject
            (
                NXOpen::Tooling::EWDraftingBuilder::NameOption sheetType /** sheettype */ 
            );
            ...
            (
                const NXString & masterPartName /** master part name */
            );
            /** The name to create temporary clone object of a master model part. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            ...
            (
                const char * masterPartName /** master part name */
            );
            /**Sets the drawing parts to delete . 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetDeleteDrawingParts
            (
                std::vector<NXString> & partNames /** partnames */ 
            );
            /**Sets the selected blank list . 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetSelectedBlanks
            (
                const std::vector<NXOpen::NXObject *> & blankComponents /** blankcomponents */ 
            );
        };
    }
}
