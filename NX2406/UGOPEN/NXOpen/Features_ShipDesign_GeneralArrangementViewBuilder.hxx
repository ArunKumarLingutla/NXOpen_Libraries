            ...
            */
            class NXOPENCPP_FEATURESEXPORT  GeneralArrangementViewBuilder : public NXOpen::Builder
            {
                ...
                public: enum InheritedPMISourceOption
                {
                    ...
                    InheritedPMISourceOptionFromDeckContainers/** Copy PMI label from General Arrangement Deck Container parts */,
                ...
                /** Gets the selected model view names
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : None */
                public: void GetSelectedModelViewNames
                (
                    std::vector<NXString> & modelViewNames /** modelviewnames */ 
                );
                /** Sets the selected model view names
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") */
                public: void SetSelectedModelViewNames
                (
                    const std::vector<NXString> & modelViewNames /** modelviewnames */ 
                );
            };
        }
    }
