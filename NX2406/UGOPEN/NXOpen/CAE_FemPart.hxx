...
#include <NXOpen/CAE_MeshingPreferencesBuilder.hxx>
        ...
        */
        class NXOPENCPP_CAEEXPORT  FemPart : public NXOpen::CAE::BaseFemPart
        {
            ...
            (
                ...
                int maxNumOfElemOption /** Maximum number of elements Option*/,
                int maxNumOfElem /** Maximum number of elements Value*/,
                int minNumOfElemOption /** Minimum number of elements Option*/,
                int minNumOfElem /** Minimum number of elements Value*/
            );
            ...
            /** Option to print debug meshing information. This is for internal testing purpose only.
                    
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void MeshDebugOption
            (
                bool printFlag /** printflag */ 
            );
            /** Creates a @link NXOpen::CAE::MeshingPreferencesBuilder NXOpen::CAE::MeshingPreferencesBuilder@endlink   @return  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::MeshingPreferencesBuilder * CreateMeshingPreferencesBuilder
            (
            );
