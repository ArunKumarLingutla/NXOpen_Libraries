...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        ...
        {
            /** The PMI type for an PMI object. */
            public: enum PmiType
            {
                PmiTypeNone/** None - Object is not a PMI */,
                PmiTypeBalloonNote/** PMI Balloon Note */,
                PmiTypeBalloonIdSymbol/** PMI Balloon IdSymbol */,
                PmiTypeCenterline/** PMI Centerline */,
                PmiTypeCoordinateNote/** PMI Coordinate Note */,
                PmiTypeCustomSymbol/** PMI Custom Symbol */,
                PmiTypeCuttingPlaneSymbol/** PMI Cutting Plane Symbol */,
                PmiTypeDatum/** PMI Datum  */,
                PmiTypeDatumTarget/** PMI Datum Target */,
                PmiTypeDimension/** PMI Dimension */,
                PmiTypeEdgeCondition/** PMI Edge Condition Symbol */,
                PmiTypeEnterpriseIdentification/** PMI Enterprise Identification */,
                PmiTypeExportControl/** PMI Export Control */,
                PmiTypeFeatureControlFrame/** PMI Feature Control Frame */,
                PmiTypeGovernmentSecurityInformation/** PMI Government Security Information */,
                PmiTypeLineWeld/** PMI Line Weld */,
                PmiTypeLocatorDesignator/** PMI Locator Designator */,
                PmiTypeMaterialSpecification/** PMI Material Specification */,
                PmiTypeNote/** PMI Note */,
                PmiTypePartIdentification/** PMI Part Identification */,
                PmiTypeProcessSpecification/** PMI Process Specification */,
                PmiTypeProprietaryInformation/** PMI Proprietary Information */,
                PmiTypeRegion/** PMI Region */,
                PmiTypeSurfaceFinish/** PMI Surface Finish */,
                PmiTypeTable/** PMI Table */
            };
            ...
            /**Returns  the PMI type
             ...
             <br> License requirements : None */
            public: NXOpen::Annotations::Pmi::PmiType Type
            (
            );
            ...
            /** Sets the associated object.
                        NOTE: This method should not be used to edit a read-only object such as a Mirrored PMI object.
                              If it is, the changes will be overridden when the part is updated. 
                               <br> 
                              An error will be raised if the associated object is not in the same part as the PMI object.
                               <br> 
            ...
            /** Returns a flag indicating whether the PMI has universally unique identifier  @return  universally unique identifier exists for PMI 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: virtual bool HasUniversallyUniqueId
            (
            );
            /**Returns  the universally unique identifier
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: virtual NXString UniversallyUniqueId
            (
            );
            /** Assigns universally unique identifier to PMI.  @return  TRUE, if universally unique identifier was assigned to PMI.
                                                     <br> 
                                                    FALSE, if universally unique identifier was not assigned to PMI.
                                                     <br> 
                                                
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: virtual bool AssignUniversallyUniqueId
            (
            );
            ...
            /** Returns the PMI Edge Condition Symbol semantic data  @return  PMI semantic data 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: virtual NXOpen::Annotations::PmiEdgeConditionSymbolData * GetECSData
            (
            );
            ...
            /** Returns the PMI Balloon IdSymbol semantic data  @return  PMI semantic data 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: virtual NXOpen::Annotations::PmiBalloonIdSymbolData * GetBalloonIdSymbolData
            (
            );
            /** Returns the PMI Surface Finish Symbol semantic data  @return  PMI semantic data 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: virtual NXOpen::Annotations::PmiSfsData * GetSfsData
            (
            );
        };
    }
