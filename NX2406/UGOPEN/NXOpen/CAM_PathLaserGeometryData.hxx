    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  PathLaserGeometryData : public NXOpen::TransientObject
        {
            ...
            /** Get the am feature body, Old as operation may have >1 bodies, so use get_am_feature_bodies 
             <br>  Created in NX9.0.3.  <br>  
             <br> License requirements : None */
            public: NXOpen::TaggedObject * GetAmFeatureBody
            (
            );
            /** Get all am feature bodies 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Body *> GetAmFeatureBodies
            (
            );
            /** Get all merged operations 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::Operation *> GetMergedOperations
            (
            );
