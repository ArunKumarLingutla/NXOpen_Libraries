...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        /** Represents the set of drafting preferences applicable to part  <br> To obtain an instance of this class, refer to @link NXOpen::Preferences::PartPreferences  NXOpen::Preferences::PartPreferences @endlink  <br> 
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  PartDrafting
        {
            ...
            public: enum FontType
            {
                ...
                FontTypeEight/** Long Dashed Double Dotted */ = 12,
            ...
            public: enum WidthType
            {
                ...
                WidthTypeThicknessOne/** Width One */ = 5,
            ...
            /**Returns  the flag indicating whether to retain @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects
                    when the geometry they are attached to is deleted. When false, the @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  
            ...
            /**Sets  the flag indicating whether to retain @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects
                    when the geometry they are attached to is deleted. When false, the @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  
                    objects get deleted with the geometry. 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the color of the retained @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects. 
            ...
            /**Sets  the color of the retained @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects. 
                    The value should be between 1 and 216. 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the line font of the retained @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::PartDrafting::FontType Font
            (
            );
            /**Sets  the line font of the retained @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: void SetFont
            (
            ...
            /**Returns  the line width of the retained @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::PartDrafting::WidthType Width
            (
            );
            /**Sets  the line width of the retained @link NXOpen::Annotations::Annotation NXOpen::Annotations::Annotation@endlink  objects 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
