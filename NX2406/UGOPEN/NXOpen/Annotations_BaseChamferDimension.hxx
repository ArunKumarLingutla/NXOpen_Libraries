...
//
//  Source File:
//     Annotations_BaseChamferDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseChamferDimensionBuilder;
        class BaseChamferDimensionImpl;
        /** Represents a chamfer dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseChamferDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseChamferDimensionImpl * m_basechamferdimension_impl;
            private: friend class  _BaseChamferDimensionBuilder;
            protected: BaseChamferDimension();
            public: ~BaseChamferDimension();
            ...
            public: void SetChamferOrientation
            (
                NXOpen::Annotations::ChamferOrientationType orientation /** orientation */ 
            );
            /**Returns  a value of chamfer dimension linear leader parallel
                     
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::ChamferOrientationType ChamferOrientation
            (
            );
