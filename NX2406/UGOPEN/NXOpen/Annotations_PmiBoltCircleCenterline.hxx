...
//
//  Source File:
//     Annotations_PmiBoltCircleCenterline.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _PmiBoltCircleCenterlineBuilder;
        class PmiBoltCircleCenterlineImpl;
        /** Represents a PMI Bolt Circle Centerline class  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiBoltCircleCenterlineBuilder  NXOpen::Annotations::PmiBoltCircleCenterlineBuilder @endlink  <br> 
         <br>  Created in NX12.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiBoltCircleCenterline : public NXOpen::Annotations::BaseBoltCircleCenterline, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiBoltCircleCenterlineImpl * m_pmiboltcirclecenterline_impl;
            private: friend class  _PmiBoltCircleCenterlineBuilder;
            protected: PmiBoltCircleCenterline();
            public: ~PmiBoltCircleCenterline();
