...
#include <NXOpen/Features_ShipDesign_InteractiveAnnotationDeckBulkheadBuilder.hxx>
#include <NXOpen/Features_ShipDesign_InteractiveAnnotationReferenceLinesBuilder.hxx>
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  InteractiveAnnotationBuilder : public NXOpen::Builder
            {
                ...
                /** Add annotation of bracket 
                 <br>  @deprecated Deprecated in NX1980.0.0.  Use @link JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationOfBracket JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationOfBracket@endlink  instead. <br>  

                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationOfBracket instead.") void AddAnnotationOfBracket
                (
                ...
                /** Creates ship annotations for basic design structures.  @return  The ship entity annotation, entity type can be @link NXOpen::Body NXOpen::Body@endlink  or @link NXOpen::Face NXOpen::Face@endlink 
                 <br>  @deprecated Deprecated in NX1980.0.0.  Use @link JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationsForBasicDesign JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationsForBasicDesign@endlink  instead. <br>  

                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationsForBasicDesign instead.") NXOpen::NXObject * HandleAnnotationForBasicDesign
                (
                ...
                /** Add annotation of collar plate 
                 <br>  @deprecated Deprecated in NX1980.0.0.  Use @link JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationOfCollarPlate JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationOfCollarPlate@endlink  instead. <br>  

                 <br>  Created in NX1892.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use JA_INTERACTIVE_ANNOTATION_BUILDER_HandleAnnotationOfCollarPlate instead.") void AddAnnotationOfCollarPlate
                (
                    bool createCollarPlateSymbol /** createcollarplatesymbol */ ,
                    NXOpen::Drawings::DraftingBody * draftingbody /** draftingbody */ 
                );
                /** Add annotation of CSYS 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void AddCSYSSymbol
                (
                    bool createCSYSSymbol /** createcsyssymbol */ ,
                    NXOpen::Drawings::DraftingView * tgView /** tgview */ 
                );
                /** Update the default grades
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void UpdateDefultGrades
                (
                    const NXString & defaultGrades /** defaultgrades */ 
                );
                /** Update the default grades
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                void UpdateDefultGrades
                (
                    const char * defaultGrades /** defaultgrades */ 
                );
                ...
                /** Handle annotation of bracket 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void HandleAnnotationOfBracket
                (
                    bool bScantling /** bscantling */ ,
                    bool bStructureId /** bstructureid */ ,
                    NXOpen::Drawings::DraftingBody * draftingbody /** draftingbody */ 
                );
                /** Handle annotation of collar plate 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void HandleAnnotationOfCollarPlate
                (
                    bool bScantling /** bscantling */ ,
                    bool bStructureId /** bstructureid */ ,
                    NXOpen::Drawings::DraftingBody * draftingbody /** draftingbody */ 
                );
                /** Handle annotation of section symbol 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void HandleAnnotationOfSectionSymbol
                (
                    bool createSectionSymbol /** Create End Cuts symbols or not*/,
                    NXOpen::Drawings::DraftingBody * draftingBody /** draftingbody */ 
                );
                /** Creates ship annotations for basic design structures.  @return  The ship entity annotation, entity type can be @link NXOpen::Body NXOpen::Body@endlink  or @link NXOpen::Face NXOpen::Face@endlink 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NXOpen::NXObject * HandleAnnotationsForBasicDesign
                (
                    bool createIDAnnotation /** Create Structure ID Annotation or not*/,
                    bool createScantlingAnnotation /** Create Scantling Annotation or not*/,
                    bool createEndCutsAnnotation /** Create EndCuts Annotation or not*/,
                    bool createCrossSectionAnnotation /** Create CrossSection Annotation or not*/,
                    NXOpen::Drawings::DraftingCurve * draftingVDCurve /** Ship drafting curve*/,
                    NXOpen::NXObject * shipEntity /** The ship entity, entity type can be @link NXOpen::Body NXOpen::Body@endlink  or @link NXOpen::Face NXOpen::Face@endlink */,
                    NXOpen::Drawings::DraftingView * view /** Ship drafting section view*/
                );
                /** Handle annotation of ship cooridnate symbol 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void HandleShipCoordinateSymbol
                (
                    bool createSymbol /** createsymbol */ ,
                    NXOpen::Point * tgPoint /** tgpoint */ ,
                    bool bShipGridCoordinate /** bshipgridcoordinate */ 
                );
                /** Get the @link NXOpen::Features::ShipDesign::InteractiveAnnotationReferenceLinesBuilder NXOpen::Features::ShipDesign::InteractiveAnnotationReferenceLinesBuilder@endlink  builder of the  
                        @link NXOpen::Features::ShipDesign::InteractiveAnnotationBuilder NXOpen::Features::ShipDesign::InteractiveAnnotationBuilder@endlink  builder.  @return  Returns the Annotation sub-builder 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NXOpen::Features::ShipDesign::InteractiveAnnotationReferenceLinesBuilder * GetReferenceLines
                (
                );
                /** Get the @link NXOpen::Features::ShipDesign::InteractiveAnnotationDeckBulkheadBuilder NXOpen::Features::ShipDesign::InteractiveAnnotationDeckBulkheadBuilder@endlink  builder of the  
                        @link NXOpen::Features::ShipDesign::InteractiveAnnotationBuilder NXOpen::Features::ShipDesign::InteractiveAnnotationBuilder@endlink  builder.  @return  Returns the Annotation sub-builder 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NXOpen::Features::ShipDesign::InteractiveAnnotationDeckBulkheadBuilder * GetDeckBulkhead
                (
                );
                /** Handle annotation of ship cooridnate symbol with toggles 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void HandleShipCoordinateSymbolWithToggles
                (
                    bool createSymbol /** createsymbol */ ,
                    NXOpen::Point * tgPoint /** tgpoint */ ,
                    bool bShipGridCoordinate /** bshipgridcoordinate */ ,
                    bool bCreateX /** bcreatex */ ,
                    bool bCreateY /** bcreatey */ ,
                    bool bCreateZ /** bcreatez */ 
                );
                /** Handle annotation of ship cooridnate symbol with toggles just for autotest 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void HandleShipCoordinateSymbolWithToggles2
                (
                    bool createSymbol /** createsymbol */ ,
                    NXOpen::Drawings::DraftingView * tgView /** tgview */ ,
                    const NXString & pointIdentityString /** pointidentitystring */ ,
                    bool bShipGridCoordinate /** bshipgridcoordinate */ ,
                    bool bCreateX /** bcreatex */ ,
                    bool bCreateY /** bcreatey */ ,
                    bool bCreateZ /** bcreatez */ 
                ...
                /** Handle annotation of ship cooridnate symbol with toggles just for autotest 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                void HandleShipCoordinateSymbolWithToggles2
                (
                    bool createSymbol /** createsymbol */ ,
                    NXOpen::Drawings::DraftingView * tgView /** tgview */ ,
                    const char * pointIdentityString /** pointidentitystring */ ,
                    bool bShipGridCoordinate /** bshipgridcoordinate */ ,
                    bool bCreateX /** bcreatex */ ,
                    bool bCreateY /** bcreatey */ ,
                    bool bCreateZ /** bcreatez */ 
