        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  BooleanOperation : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Sets   the boolean operation type
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") OR nx_freeform_1 ("basic freeform modeling") */
            public: void SetType
            (
                NXOpen::GeometricUtilities::BooleanOperation::BooleanType type /** boolean type */
            );
            ...
            /**  Get the target bodies collector
                     @return  target bodies collector of boolean 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * GetTargetBodiesCollector
            (
            );
