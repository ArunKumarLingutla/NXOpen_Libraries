        ...
        */
        class NXOPENCPP_CAEEXPORT  QueryCurveUsageOptions : public NXOpen::TaggedObject
        {
            ...
            public: enum CurveUsageType
            {
                ...
                CurveUsageTypeDivideCurveEqually/** divide curve equally */ 
            };
            ...
            /**Returns  the number of segments divided that are only available when @link NXOpen::CAE::QueryCurveUsageOptions::CurveUsageType NXOpen::CAE::QueryCurveUsageOptions::CurveUsageType@endlink  is 
                    @link NXOpen::CAE::QueryCurveUsageOptions::CurveUsageTypeDivideCurveEqually NXOpen::CAE::QueryCurveUsageOptions::CurveUsageTypeDivideCurveEqually@endlink .
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: int NumberOfSegmentsDivided
            (
            );
            /**Sets  the number of segments divided that are only available when @link NXOpen::CAE::QueryCurveUsageOptions::CurveUsageType NXOpen::CAE::QueryCurveUsageOptions::CurveUsageType@endlink  is 
                    @link NXOpen::CAE::QueryCurveUsageOptions::CurveUsageTypeDivideCurveEqually NXOpen::CAE::QueryCurveUsageOptions::CurveUsageTypeDivideCurveEqually@endlink .
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetNumberOfSegmentsDivided
            (
                int numberOfSegmentsDivided /** numberofsegmentsdivided */ 
            );
            /**  @brief 
                        Gets the @link CAE::PostMesh CAE::PostMesh@endlink  used to retrieve values of the entities on the query curve.
                         

             
                        
                        The entities can be shared by multiple elements and can have different values on different elements, the @link CAE::PostMesh CAE::PostMesh@endlink  help to decide which elements are used to retrieve the values.
                        
                    
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::PostMesh *> GetPostMeshesForDuplicateValues
            (
            );
            /**  @brief  
                        Sets the @link CAE::PostMesh CAE::PostMesh@endlink  used to retrieve values of the entities on the query curve.
                         

             
                        
                        A query curve may contain points that are shared by multiple elements and thus relate to multiple @link CAE::PostMesh CAE::PostMesh@endlink .
                        Call @link CAE::QueryCurveUsageOptions::AskPostMeshCandidatesForDuplicateValues CAE::QueryCurveUsageOptions::AskPostMeshCandidatesForDuplicateValues@endlink  to get all @link CAE::PostMesh CAE::PostMesh@endlink  candidates for duplicate values.
                        In this case, You can use this method to set @link CAE::PostMesh CAE::PostMesh@endlink  to decide which elements are used to retrieve the point values.
                        
                    
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetPostMeshesForDuplicateValues
            (
                const std::vector<NXOpen::CAE::PostMesh *> & meshes /** meshes */ 
            );
            /** Gets all of the @link CAE::PostMesh CAE::PostMesh@endlink  candidates, which could be used to decide which elements are used to retrieve the point values 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<NXOpen::CAE::PostMesh *> AskPostMeshCandidatesForDuplicateValues
            (
