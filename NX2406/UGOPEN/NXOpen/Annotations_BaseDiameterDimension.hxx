...
//
//  Source File:
//     Annotations_BaseDiameterDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseDiameterDimensionBuilder;
        class BaseDiameterDimensionImpl;
        /** Represents a diameter dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseDiameterDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseDiameterDimensionImpl * m_basediameterdimension_impl;
            private: friend class  _BaseDiameterDimensionBuilder;
            protected: BaseDiameterDimension();
            public: ~BaseDiameterDimension();
            /**Sets  a value of diameter dimension line angle
                     
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDiameterDimensionLineAngle
            (
                double diamDimLineAngle /** diam dim line angle */ 
            );
            /**Returns  a value of diameter dimension line angle
                     
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: double DiameterDimensionLineAngle
            (
            );
            /**Sets  a value of diameter dimension line angle
                    
             <br>  @deprecated Deprecated in NX6.0.0.  Use @link SetDiameterDimensionLineAngle SetDiameterDimensionLineAngle@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX6.0.0.  Use SetDiameterDimensionLineAngle instead.") void SetDiamDimLineAng
            (
                double diamDimLineAngle /** diam dim line angle */ 
            );
            /**Returns  a value of diameter dimension line angle
                    
             <br>  @deprecated Deprecated in NX6.0.0.  Use @link DiameterDimensionLineAngle DiameterDimensionLineAngle@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX6.0.0.  Use DiameterDimensionLineAngle instead.") double DiamDimLineAng
            (
            );
