...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class BasePerpendicularDimensionImpl;
        /** Represents a perpendicular dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BasePerpendicularDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BasePerpendicularDimensionImpl * m_baseperpendiculardimension_impl;
            private: friend class  _BasePerpendicularDimensionBuilder;
            protected: BasePerpendicularDimension();
            public: ~BasePerpendicularDimension();
