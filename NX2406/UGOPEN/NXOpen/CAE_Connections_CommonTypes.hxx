    ...
    namespace CAE
    {
        namespace Connections
        {
            ...
            enum ElementType
            {
                ...
                ElementTypeEClinkCbear2RigidSpider/** CLINK + CBEAR2 + RBE2 */,
                ElementTypeEClinkCbush2RigidSpider/** Clink + CBUSH2 +RBE2 */,
                ElementTypeEClinkBarRigidSpider/** Clink + CBAR + RBE2 */,
                ElementTypeEClinkBeamRigidSpider/** Clink + CBEAM + RBE2 */,
                ElementTypeEClinkFou3/** Clink + FOU3 */,
                ElementTypeEQuad4InterpolationSpider/** Quad4 + Interpolation Spider */
            };

            /** composer Connection type */
            enum ComposerConnectionType
            {
                ComposerConnectionTypeNone/** None */ = -1,
