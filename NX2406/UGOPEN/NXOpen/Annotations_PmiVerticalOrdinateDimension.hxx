...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class PmiVerticalOrdinateDimensionImpl;
        /** Represents a PMI vertical ordinate dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiOrdinateDimensionBuilder  NXOpen::Annotations::PmiOrdinateDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiVerticalOrdinateDimension : public NXOpen::Annotations::VerticalOrdinateDimension, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiVerticalOrdinateDimensionImpl * m_pmiverticalordinatedimension_impl;
            private: friend class  _PmiVerticalOrdinateDimensionBuilder;
            protected: PmiVerticalOrdinateDimension();
            public: ~PmiVerticalOrdinateDimension();
