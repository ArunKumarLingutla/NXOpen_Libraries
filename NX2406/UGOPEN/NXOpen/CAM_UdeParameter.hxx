        ...
        */
        class NXOPENCPP_CAMEXPORT  UdeParameter : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the string value of the parameter
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAM::UdeParameter::StringText CAM::UdeParameter::StringText@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::UdeParameter::StringText instead.") NXString StringValue
            (
            );
            /**Sets  the string value of the parameter
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAM::UdeParameter::SetStringText CAM::UdeParameter::SetStringText@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::UdeParameter::SetStringText instead.") void SetStringValue
            (
            ...
            /**Returns  the option value of the parameter
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAM::UdeParameter::OptionText CAM::UdeParameter::OptionText@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::UdeParameter::OptionText instead.") NXString OptionValue
            (
            );
            /**Sets  the option value of the parameter
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link CAM::UdeParameter::SetOptionText CAM::UdeParameter::SetOptionText@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use CAM::UdeParameter::SetOptionText instead.") void SetOptionValue
            (
            ...
            /**Returns  the csys of the parameter
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::NXObject * Csys
            (
            );
            /**Sets  the csys of the parameter
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCsys
            (
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::ExpressionDouble * ExpressionDouble
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ExpressionString * ExpressionString
            (
            );
