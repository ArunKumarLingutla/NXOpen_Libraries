        ...
        */
        class NXOPENCPP_PCBEXCHANGEEXPORT  DesignRuleBuilder : public NXOpen::Builder
        {
            ...
            public: enum ComponentFilter
            {
                ...
                ComponentFilterByNetName/** Filter Copper by Net Name. */,
                ComponentFilterByPackageClearanceType/** Filter Pcb Components by Package Clearance Type. */,
                ComponentFilterByWireBondNetName/** Filter Wire Bond by Net Name. */
            };
            ...
            /**Returns  the measurement type. 
             ...
             <br> License requirements : None */
            public: NXOpen::PcbExchange::DesignRuleMeasurement MeasurementType
            (
            );
            ...
            (
                NXOpen::PcbExchange::DesignRuleMeasurement measurementType /** measurementtype */ 
            );
            ...
            /** Gets an optional conductive layer side parameter for the copper filter for a given side of the constraint. 
             ...
             <br> License requirements : None */
            public: NXOpen::PcbExchange::ConductiveLayerSide GetConductiveLayerSide
            (
                int filterIndex /** Index of the filter. */
            );
            /** Sets an optional conductive layer side parameter for the copper filter for a given side of the constraint. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetConductiveLayerSide
            (
                int filterIndex /** Index of the filter. */,
                NXOpen::PcbExchange::ConductiveLayerSide side /** side */ 
            );
            ...
            /** Gets an optional wire bond side parameter for the wire bond filter for a given side of the constraint. 
             ...
             <br> License requirements : None */
            public: NXOpen::PcbExchange::WireBondSide GetWireBondSide
            (
                int filterIndex /** Index of the filter. */
            );
            /** Sets an optional wire bond side parameter for the wire bond filter for a given side of the constraint. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetWireBondSide
            (
                int filterIndex /** Index of the filter. */,
                NXOpen::PcbExchange::WireBondSide side /** side */ 
            );
        };
    }
}
