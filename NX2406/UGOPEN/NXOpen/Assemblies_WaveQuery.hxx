        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  WaveQuery : public NXOpen::TransientObject
        {
            ...
            (
                ...
                const std::vector<int> & partIdentifiers /** the NX part identifiers */,
                bool includeOnlyWithLinks /** true if only parts that own inter-part links are returned */,
                bool forceQuery /** true if we are to force query */
            );
            /**
            ...
            /**
             ...
             <br> License requirements : wave ("WAVE FUNCTIONALITY") */
            public: void SetQueryProductInterfaces
            (
                bool queryProductInterfaces /** whether or not to query product interaces from TC */
            );
            /**
                        Gets whether or not to query product interaces from TC.
                      @return  whether or not to query product interaces from TC 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : wave ("WAVE FUNCTIONALITY") */
            ...
            /**
             ...
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : wave ("WAVE FUNCTIONALITY") */
            public: void SetIncludeTeamcenterRelations
            (
                bool includeTeamcenterRelations /** whether or not to include teamcenter relations */
            );
            /**
                        Gets whether or not to include teamcenter relations.
                      @return  whether or not to include teamcenter relations 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : wave ("WAVE FUNCTIONALITY") */
