...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  View : public NXOpen::NXObject
    {
        ...
        /**  Describes the display style for geometry displayed in the view.  */
        public: enum DisplayStyleType
        {
            DisplayStyleTypeShaded/** shaded */ ,
            DisplayStyleTypeWireframe/** wireframe */ ,
            DisplayStyleTypeStudio/** studio */ ,
            DisplayStyleTypeStaticWireframe/** static wireframe */ 
        };

        /**  Describes the shaded display type for shaded geometry displayed in the view.  */
        public: enum ShadedDisplayModeType
        {
            ShadedDisplayModeTypeFullyShaded/** fully shaded */ ,
            ShadedDisplayModeTypePartiallyShaded/** partially shaded */ ,
            ShadedDisplayModeTypeFaceAnalysis/** face analysis */ 
        };

        /**  Describes the hidden edges state for geometry displayed in the view.  */
        public: enum HiddenEdgesType
        {
            HiddenEdgesTypeInvisible/** invisible */ ,
            HiddenEdgesTypeVisible/** visible */ ,
            HiddenEdgesTypeDashed/** dashed */ ,
            HiddenEdgesTypeGrayThin/** gray thin */ 
        };
        ...
        /** Pans and centers the view to the given objects.
            If the view is displayed, the changes will appear in the display of that view.
             <br>  In batch mode, the center of the view will be changed, but no display occurs.  <br>  
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: void PanToObjects
        (
            const std::vector<NXOpen::INXObject *> & objects /** The objects
                           whose display is to be included in the view for pan */
        );
        /** Fly to the given objects.
            If the view is displayed, the changes will appear in the display of that view.
             <br>  In batch mode, the view will be changed, but no display occurs.  <br>  
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: void FlyToObjects
        (
            const std::vector<NXOpen::INXObject *> & objects /** The objects
                           whose display is to be included in the view for fly to */
        );
        ...
        /**Returns  the view origin.  This is the negation of the position in "untranslated view space",
            ...
            the same space as the origin passed to @link NXOpen::View::SetOrigin NXOpen::View::SetOrigin@endlink , where
        ...
        /**Returns  the view scale.
             <br> 
            Refer to @link NXOpen::View::GetExpandedScale NXOpen::View::GetExpandedScale@endlink  for
            obtaining the scale of an expanded view.
             <br> 
        ...
        /** Returns the view scale, including any expansion factor. 
             <br> 
            This is intended for use with an expanded view where the process of expanding it may apply a multiplier to the
            view's inherent scale value. If the view is not expanded, the result should be the same as that obtained with
            @link NXOpen::View::Scale NXOpen::View::Scale@endlink .
             <br> 
             @return  
        ...
        /** Makes the given view the work view.  The view does not need to be
        ...
        /** Returns an array of objects visible in a view.
             <br>  Objects which are hidden, on invisible layers, completely outside 
            the X, Y clip plane bounds, or otherwise considered invisible are not included 
            in the returned array. 
             <br>  
             <br>  Note there are some exceptions. Objects which are not within the front 
            and back clip planes may be returned as visible. 
            When run in batch mode, solids which are occluded by other solids in a 
            hidden line view may be returned as visible. 
             <br>   @return  The array of visible objects 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Returns  the disclosure status of the view. 
        ...
        (
            const NXString & disclosurePurpose /**  <br>  Disclosure Purpose string  <br>  */
        );
        /**Sets  the Disclosure Purpose. 
         <br>  Created in NX11.0.1.  <br>  
         <br> License requirements : None */
        ...
        (
            const char * disclosurePurpose /**  <br>  Disclosure Purpose string  <br>  */
        );
        ...
        /** Enables Fly-through by virtually placing you as a first-person observer in the view.
                Only works for work view.
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: void EnableNavigationFlyThrough
        (
            bool isEnable /**  <br>  True  - Enable Fly-through  <br> 
                                                   <br>  False - Disable Fly-through  <br>  */
        );
        /** Returns whether or not Fly-through is enabled.  @return   <br>  True  - Fly-through is enabled  <br> 
                                                   <br>  False - Fly-through is not enabled  <br>  
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: bool IsNavigationFlyThroughEnabled
        (
        );
        /** Save the current view as the home view. Only works for work view.
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: void SaveNavigationHomeView
        (
        );
        /** Restore and transitions from the current view to the home view. Only works for work view.
         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: void RestoreNavigationHomeView
        (
        );
        /** In Fly-through, fly from start point and ends at end point. Only works for work view.
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: void NavigationFlyThrough
        (
            const NXOpen::Point3d & startPoint /** The point where fly begins */,
            const NXOpen::Point3d & startEnd /** The point where fly ends*/
        );
        /** In Fly-through, fly use relative scale. Only works for work view.
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: void NavigationFlyThroughWithScale
        (
            double relativeScale /** Relative scale factor */
        );
        /** Increment the name of given view with replacement character. @return  The new view name 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::View * SaveViewWithViewName
        (
            const NXString & replacementChar /** The replacement char */
        );
        /** Increment the name of given view with replacement character. @return  The new view name 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::View * SaveViewWithViewName
        (
            const char * replacementChar /** The replacement char */
        );
        /**Returns  the dynamic hidden edges property of the view. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::View::HiddenEdgesType DynamicHiddenEdges
        (
        );
        /**Sets  the dynamic hidden edges property of the view. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetDynamicHiddenEdges
        (
            NXOpen::View::HiddenEdgesType hiddenEdges /** The desired hidden edges type to apply. */
        );
        /**Returns  the static hidden edges property of the view. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::View::HiddenEdgesType StaticHiddenEdges
        (
        );
        /**Sets  the static hidden edges property of the view. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetStaticHiddenEdges
        (
            NXOpen::View::HiddenEdgesType hiddenEdges /** The desired hidden edges type to apply */
        );
        /**Returns  the display style of the view. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::View::DisplayStyleType DisplayStyle
        (
        );
        /**Sets  the display style of the view. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetDisplayStyle
        (
            NXOpen::View::DisplayStyleType displayStyle /** The desired display style. */
        );
        /**Returns  
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::View::ShadedDisplayModeType ShadedDisplayType
        (
        );
        /**Sets  
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetShadedDisplayType
        (
            NXOpen::View::ShadedDisplayModeType shadedDisplayType /** shaded display type */ 
        );
