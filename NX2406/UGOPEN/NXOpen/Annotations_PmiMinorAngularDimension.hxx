...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a PMI minor angular dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiMinorAngularDimensionBuilder  NXOpen::Annotations::PmiMinorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiMinorAngularDimension : public NXOpen::Annotations::PmiAngularDimension, public virtual NXOpen::Annotations::IPmi
        {
