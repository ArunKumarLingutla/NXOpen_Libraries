            ...
            */
            class NXOPENCPP_FEATURESEXPORT  TabBuilder : public NXOpen::Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                /**Returns  the target body on which the secondary tab is created.
                             <br> 
                               Use @link NXOpen::Features::SheetMetal::TabBuilder::IsSecondary NXOpen::Features::SheetMetal::TabBuilder::IsSecondary@endlink  to determine whether this is a secondary tab.
                             <br> 
                ...
                (
                    NXOpen::Body * targetBody /** A sheet metal body on which secondary tab is to be created. */
                );
                /** This is only applicable for base tab created with bends. This extracts boundary curves of the faces
                            that are attached to the planes specified by  @link NXOpen::Features::SheetMetal::MultiBendBendPropertiesBuilder::Plane NXOpen::Features::SheetMetal::MultiBendBendPropertiesBuilder::Plane @endlink and @link NXOpen::Features::SheetMetal::MultiBendBendPropertiesBuilder::SetPlane NXOpen::Features::SheetMetal::MultiBendBendPropertiesBuilder::SetPlane @endlink .
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Features::Feature * UpdateReferenceCurves
                (
                );
                ...
                public: NXOpen::Features::SheetMetal::FeatureBendPropertiesListBuilder * MultiBendPropertiesList
                (
                );
