...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            AddEndTemplate </term> <description> 
             
            0 </description> </item> 

            <item><term> 
             
            AddStartTemplate </term> <description> 
            ...
            EndMinimumDistance.Value </term> <description> 
             
            100.0 (millimeters part), 6.0 (inches part) </description> </item> 
            ...
            StartMinimumDistance.Value </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ShellTemplateBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                public: enum PlaneLocationTypes
                {
                    ...
                    PlaneLocationTypesNumber/** Define the number of X and Y planes */
                };
                ...
                /** The option for defining the default method for calculation of base plane. */
                public: enum BasePlaneTypes
                {
                    BasePlaneTypesFromPlanes/** Calculate from selected planes. */,
                    BasePlaneTypesFromPlate/** Calculate from surface of plate. */
                };

                /** The option for defining the default method for calculation of template planes. */
                public: enum TemplatePlaneTypes
                {
                    TemplatePlaneTypesInferred/** Calculate from selected planes. */,
                    TemplatePlaneTypesNormalToBasePlane/** Calculate normal to Base Plane. */
                };

                /** The option for creating corner cuts on the templates. */
                public: enum MeasurementSideTypes
                {
                    MeasurementSideTypesStart/** Add corner cuts on the start side of each template. */,
                    MeasurementSideTypesEnd/** Add corner cuts on the end side of each template. */
                };
                ...
                /**Returns  the number of X templates to create if the option is to Specify Number 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: int XNumber
                (
                );
                /**Sets  the number of X templates to create if the option is to Specify Number 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetXNumber
                (
                    int numXTemplates /** numxtemplates */ 
                );
                /**Returns  the number of Y templates to create if the option is to Specify Number 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: int YNumber
                (
                );
                /**Sets  the number of Y templates to create if the option is to Specify Number 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetYNumber
                (
                    int numYTemplates /** numytemplates */ 
                );
                /**Returns  the value that determines if an additional start template will be added in X direction 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: bool AddStartTemplate
                (
                );
                /**Sets  the value that determines if an additional start template will be added in X direction 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetAddStartTemplate
                (
                    bool addStartTemplate /** addstarttemplate */ 
                );
                /**Returns  the expression defining the minimum distance from the start of X direction where a template will be added. 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * StartMinimumDistance
                (
                );
                /**Returns  the value that determines if an additional end template will be added in X direction 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: bool AddEndTemplate
                (
                );
                /**Sets  the value that determines if an additional end template will be added in X direction 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetAddEndTemplate
                (
                    bool addMEndTemplate /** addmendtemplate */ 
                );
                /**Returns  the expression defining the minimum distance from the end of X direction where a template will be added. 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * EndMinimumDistance
                (
                );
                /**Returns  the value that specifies how to calculate the base plane 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ShellTemplateBuilder::BasePlaneTypes BasePlaneType
                (
                );
                /**Sets  the value that specifies how to calculate the base plane 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetBasePlaneType
                (
                    NXOpen::Features::ShipDesign::ShellTemplateBuilder::BasePlaneTypes basePlaneType /** baseplanetype */ 
                );
                /**Returns  the value that specifies how to calculate the template plane 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ShellTemplateBuilder::TemplatePlaneTypes TemplatePlaneType
                (
                );
                /**Sets  the value that specifies how to calculate the template plane 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetTemplatePlaneType
                (
                    NXOpen::Features::ShipDesign::ShellTemplateBuilder::TemplatePlaneTypes templatePlaneType /** templateplanetype */ 
                );
                ...
                (
                    const NXString & materiaGrade /** materiagrade */ 
                );
                /**Sets  the material grade name. 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                ...
                (
                    const char * materiaGrade /** materiagrade */ 
                );
                ...
                /**Returns  the value that specifies which side of the plate to measure distances and angles from 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ShellTemplateBuilder::MeasurementSideTypes MeasurementSide
                (
                );
                /**Sets  the value that specifies which side of the plate to measure distances and angles from 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetMeasurementSide
                (
                    NXOpen::Features::ShipDesign::ShellTemplateBuilder::MeasurementSideTypes measurementSide /** measurementside */ 
                );
            };
        }
    }
