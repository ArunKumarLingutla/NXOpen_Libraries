...
//
//  Source File:
//     Annotations_BaseHoleDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseHoleDimensionBuilder;
        class BaseHoleDimensionImpl;
        /** Represents a hole dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseHoleDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseHoleDimensionImpl * m_baseholedimension_impl;
            private: friend class  _BaseHoleDimensionBuilder;
            protected: BaseHoleDimension();
            public: ~BaseHoleDimension();
