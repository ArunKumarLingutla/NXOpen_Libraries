...
namespace NXOpen
{
    ...
    class SketchHelpedGeometricConstraintImpl;
    /** Represents a geometric sketch constraint that has a help point or help parameter  <br> To obtain an instance of this class, use @link Sketch Sketch@endlink   <br> 
     <br>  Created in NX3.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SketchHelpedGeometricConstraint : public NXOpen::SketchGeometricConstraint, public virtual NXOpen::ISketchHelpedConstraint
    {
        private: SketchHelpedGeometricConstraintImpl * m_sketchhelpedgeometricconstraint_impl;
        private: friend class  _SketchHelpedGeometricConstraintBuilder;
        protected: SketchHelpedGeometricConstraint();
        public: ~SketchHelpedGeometricConstraint();
