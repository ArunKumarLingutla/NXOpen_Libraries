    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SolidEADBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the volume fraction state drives the action upon commit 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::SolidEADBuilder::State VolumeFractionState
            (
            );
            /**Sets  the volume fraction state drives the action upon commit 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetVolumeFractionState
            (
                NXOpen::CAE::SolidEADBuilder::State volumeFractionState /** volumefractionstate */ 
            );
        };
    }
}
