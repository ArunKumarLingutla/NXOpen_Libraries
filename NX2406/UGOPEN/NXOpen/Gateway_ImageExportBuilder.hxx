...
namespace NXOpen
{
    ...
    namespace Gateway
    {
        ...
        */
        class NXOPENCPP_GATEWAYEXPORT  ImageExportBuilder : public NXOpen::Builder
        {
            /**
                     @brief 
            ...
            (
                int deviceWidth /** If zero then the device will use the default width */
            );
            /**Returns 
                     @brief 
            ...
            (
                int deviceHeight /** If zero then the device will use the default height */
            );
        };
    }
}
