...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ListCreator : public NXOpen::Builder
    {
        ...
        /** per lod Type */
        public: enum PerLodType
        {
            PerLodTypeAbsolute/** absolute */,
            PerLodTypeRelative/** relative */,
            PerLodTypeNone/** none */
        };
        ...
        /**Returns  the m_perLODChordal * - Specifies the type for per lod chordal option 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ListCreator::PerLodType PerLODChordal
        (
        );
        /**Sets  the m_perLODChordal * - Specifies the type for per lod chordal option 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetPerLODChordal
        (
            NXOpen::ListCreator::PerLodType perLOD /** perlod */ 
        );
    };
}
