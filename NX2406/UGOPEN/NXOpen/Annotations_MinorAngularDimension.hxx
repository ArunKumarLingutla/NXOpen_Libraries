...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a minor angular dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::MinorAngularDimensionBuilder  NXOpen::Annotations::MinorAngularDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  MinorAngularDimension : public NXOpen::Annotations::AngularDimension, public virtual NXOpen::Annotations::IPmi
        {
