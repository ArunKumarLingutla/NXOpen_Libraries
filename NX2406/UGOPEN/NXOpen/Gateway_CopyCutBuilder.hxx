    ...
    namespace Gateway
    {
        ...
        */
        class NXOPENCPP_GATEWAYEXPORT  CopyCutBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the flag indicating if non-associative copy is being made. Non-associative copy is limited
                    to curve and body features where only geometry is copied without the feature. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool CopyNonAssociative
            (
            );
            /**Sets  the flag indicating if non-associative copy is being made. Non-associative copy is limited
                    to curve and body features where only geometry is copied without the feature. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCopyNonAssociative
            (
                bool isCopyNonAssociative /** iscopynonassociative */ 
            );
