...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        ...
        {
            /** the crosshatch pattern type */
            public: enum CrosshatchPatternBy
            {
                CrosshatchPatternByUser/** Specified by user */,
                CrosshatchPatternByMaterial/** Determined by material */
            };
            ...
            /**Returns  the display crosshatch 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayCrosshatch
            (
            );
            /**Sets  the display crosshatch 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the crosshatch pattern defined by
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::PmiSectionViewViewBuilder::CrosshatchPatternBy CrosshatchPatternDefinedBy
            (
            );
            /**Sets  the crosshatch pattern defined by
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetCrosshatchPatternDefinedBy
            (
                NXOpen::Annotations::PmiSectionViewViewBuilder::CrosshatchPatternBy patternBy /** patternby */ 
            );
