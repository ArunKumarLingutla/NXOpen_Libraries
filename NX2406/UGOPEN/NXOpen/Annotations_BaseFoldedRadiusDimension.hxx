...
//
//  Source File:
//     Annotations_BaseFoldedRadiusDimension.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseFoldedRadiusDimensionBuilder;
        class BaseFoldedRadiusDimensionImpl;
        /** Represents a folded radius dimension  <br> Abstract class  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseFoldedRadiusDimension : public NXOpen::Annotations::Dimension, public virtual NXOpen::Annotations::ILinearTolerance, public virtual NXOpen::Annotations::IPmi
        {
            private: BaseFoldedRadiusDimensionImpl * m_basefoldedradiusdimension_impl;
            private: friend class  _BaseFoldedRadiusDimensionBuilder;
            protected: BaseFoldedRadiusDimension();
            public: ~BaseFoldedRadiusDimension();
