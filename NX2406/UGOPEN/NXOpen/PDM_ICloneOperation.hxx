        ...
        */
        class NXOPENCPP_PDMEXPORT  ICloneOperation : public NXOpen::TaggedObject, public virtual NXOpen::IAttributeSourceObjectBuilder
        {
            ...
            /** This API sets the mixed rule naming conversion type. 
             ...
             <br> License requirements : None */
            public: void SetMixedRuleString
            (
                const NXString & prefixString /** prefixstring */ ,
                const NXString & suffixString /** suffixstring */ ,
                const NXString & stringToReplace /** stringtoreplace */ ,
                const NXString & replacementString /** replacementstring */ 
            );
            /** This API sets the mixed rule naming conversion type. 
                        It enables user to combine the naming rule conversion types prefix, suffix and replace.
                        User must give atleast one of the naming rules input as non-empty value for mixed rule to work. 
             ...
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            void SetMixedRuleString
            (
                const char * prefixString /** prefixstring */ ,
                const char * suffixString /** suffixstring */ ,
                const char * stringToReplace /** stringtoreplace */ ,
                const char * replacementString /** replacementstring */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SetExcludeSuppressed
            (
                bool excludeSuppressed /** excludesuppressed */ 
            );
            ...
            /** This API fetches all the objects that are to be excluded from the export operation due to ExcludeReferenceOnly, ExcludeNGC and ExcludeSuppressed options. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void FetchObjectsToExcludeFromExport
            (
                std::vector<NXOpen::PDM::AssyCloneCompDisp *> & objectsToBeExcluded /** objectstobeexcluded */ 
            );
