...
#include <NXOpen/Tooling_OffsetDatumCsysBuilder.hxx>
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ReusePositioningObjectBuilder : public NXOpen::Builder
        {
            ...
            public: enum DialogOptions
            {
                ...
                DialogOptionsReusableObject/** dialog from reusable object */,
                DialogOptionsCompactDialog/** dialog from compact dialog */
            };
            ...
            public: NXOpen::Expression * OffsetFaceDistance
            (
            );
            /**Returns  the row count 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * RowCount
            (
            );
            /**Returns  the column count 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ColumnCount
            (
            );
            ...
            /**Returns  the start u 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * StartU
            (
            );
            /**Returns  the start v 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * StartV
            (
            );
            /**Returns  the end u 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * EndU
            (
            );
            /**Returns  the end v 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * EndV
            (
            );
            ...
            /**Sets  the u percentage of non planar face pattern
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  This functionality is no longer supported.") void SetUPercentage
            (
            ...
            /**Returns  the u percentage of non planar face pattern
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  This functionality is no longer supported.") NXString UPercentage
            (
            );
            /**Sets  the v percentage of non planar face pattern
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  This functionality is no longer supported.") void SetVPercentage
            (
            ...
            /**Returns  the v percentage of non planar face pattern
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  This functionality is no longer supported.") NXString VPercentage
            (
            );
            /**Sets  the percentage value of curve
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  This functionality is no longer supported.") void SetCurvePercentage
            (
            ...
            /**Returns  the percentage value of curve
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  This functionality is no longer supported.") NXString CurvePercentage
            (
            );
            ...
            /**Returns  the Offset CSYS data 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::OffsetDatumCsysBuilder * OffsetCsysData
            (
            );
            /**Sets  the Offset CSYS data 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetOffsetCsysData
            (
                NXOpen::Tooling::OffsetDatumCsysBuilder * offsetCsysData /** Offset Csys builder data */
            );
            ...
            /** Delete point coordinates from sketch 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void DeletePointCoordinates
            (
                int type /** type */ ,
                const std::vector<NXOpen::Point3d> & pointCoords /** pointcoords */ 
            );
            /** Edit a point coordinates 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void EditPointCoordinates
            (
                int type /** type */ ,
                const NXOpen::Point3d & oldPoint /** old point coordinates */,
                const NXOpen::Point3d & newPoint /** new point coordinates */
            );
            /** Reposition all sketch points  
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void RepositionSketchPoints
            (
                const NXOpen::Point3d & target /** target origin */,
                const NXOpen::Matrix3x3 & orient /** target orient */
            );
            /** Initialize the origin and orientation of WCS 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void InitializeWcsLocation
            (
                bool saveOldCsys /** saveoldcsys */ 
            );
            ...
            /** Deselected the edge or non planar face 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void NonPlanarDeselect
            (
                const std::vector<NXOpen::NXObject *> & delselectedObjs /** Edge or non planar face */
            );
            /**Sets  the flag of updated parameter for non-planar curve
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUpdatedParameter
            (
                bool changed /** changed */ 
            );
            /**Returns  the flag of updated parameter for non-planar curve
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool UpdatedParameter
            (
            );
            /** Sync section data for curve type
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SyncSectionData
            (
                NXOpen::Section * section /** the selected curve section tag */
            );
            /** Update sketch points
             ...
             <br> License requirements : None */
            public: void UpdateSketchPoints
            (
            );
            /** Update csys for non-planar face
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateCsys
            (
            );
            /** Delete slave features when end compact dialog
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void DeleteSlaveFeatures
            (
            );
            /**Returns  the flag of the compact dialog
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CompactDialog
            (
            );
            /**Sets  the flag of the compact dialog
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCompactDialog
            (
                bool isCompactDialog /** iscompactdialog */ 
            );
            /** Creates new sketch on drop face and location 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void CreateSketchForPlanarFace
            (
                NXOpen::NXObject * dropFace /** tag of drop face of point */,
                const NXOpen::Point3d & position /** Work coordinate of point */
            );
        };
    }
}
