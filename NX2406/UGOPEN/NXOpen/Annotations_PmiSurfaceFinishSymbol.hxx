...
//
//  Source File:
//     Annotations_PmiSurfaceFinishSymbol.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _PmiSurfaceFinishSymbolBuilder;
        class PmiSurfaceFinishSymbolImpl;
        /** Represents PMI Surface Finish Symbol  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiSurfaceFinishSymbolBuilder  NXOpen::Annotations::PmiSurfaceFinishSymbolBuilder @endlink  <br> 
         <br>  Created in NX2212.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiSurfaceFinishSymbol : public NXOpen::Annotations::BaseSurfaceFinishSymbol, public virtual NXOpen::Annotations::IPmi
        {
            private: PmiSurfaceFinishSymbolImpl * m_pmisurfacefinishsymbol_impl;
            private: friend class  _PmiSurfaceFinishSymbolBuilder;
            protected: PmiSurfaceFinishSymbol();
            public: ~PmiSurfaceFinishSymbol();
