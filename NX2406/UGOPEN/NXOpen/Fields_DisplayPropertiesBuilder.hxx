        ...
        */
        class NXOPENCPP_FIELDSEXPORT  DisplayPropertiesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the table dependent display type
             ...
             <br> License requirements : None */
            public: NXOpen::Fields::DisplayPropertiesBuilder::DepDispTypeEnum TblDepDispType
            (
            );
            /**Sets  the table dependent display type
             <br>  Created in NX1938.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTblDepDispType
            (
                NXOpen::Fields::DisplayPropertiesBuilder::DepDispTypeEnum tblDepDispType /** tbldepdisptype */ 
            );
            /**Returns  the table dependent surface offset scaling factor
             <br>  Created in NX1938.0.0.  <br>  
             <br> License requirements : None */
            public: double TblSurfaceOffset
            (
            );
            /**Sets  the table dependent surface offset scaling factor
             <br>  Created in NX1938.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTblSurfaceOffset
            (
                double tblDepSurfaceOffset /** tbldepsurfaceoffset */ 
            );
        };
    }
}
