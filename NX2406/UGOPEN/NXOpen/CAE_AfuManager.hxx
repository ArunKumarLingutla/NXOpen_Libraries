    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AfuManager
        {
            ...
            /** Perform Force Limited notching from the input information  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void ForceLimitedNotching
            (
                const NXString & accelAfu /** acceleration function afu name */,
                int accelIndex /** acceleration function record index */,
                const NXString & forcexAfu /** Force X function afu name */,
                int forcexRecord /** Force X function record index */,
                const NXString & forceyAfu /** Force Y function afu name */,
                int forceyIndex /** Force Y function record index */,
                const NXString & forcezAfu /** Force Z function afu name */,
                int forcezRecord /** Force Z function record index */,
                double rollOffFreq /** Roll Off Frequency term */,
                double mass /** Mass term */,
                double cSquared /** C Squared term */,
                int fOutputForceLimitedNotch /** toggle to output Force Limited Notch function */,
                int fOutputForceLimitedBaseAccel /** toggle to output Force Limited Base Acceleration function */,
                int interpolationMethod /** interpolation method if needed */,
                const NXString & notchRecordName /** user specified name for Notch function record */,
                const NXString & limitedAccelRecordName /** user specified name for Limited Base Acceleration function record */,
                const NXString & destinationAfuFileName /** Destination AFU file */
            );
            /** Perform Force Limited notching from the input information  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            void ForceLimitedNotching
            (
                const char * accelAfu /** acceleration function afu name */,
                int accelIndex /** acceleration function record index */,
                const char * forcexAfu /** Force X function afu name */,
                int forcexRecord /** Force X function record index */,
                const char * forceyAfu /** Force Y function afu name */,
                int forceyIndex /** Force Y function record index */,
                const char * forcezAfu /** Force Z function afu name */,
                int forcezRecord /** Force Z function record index */,
                double rollOffFreq /** Roll Off Frequency term */,
                double mass /** Mass term */,
                double cSquared /** C Squared term */,
                ...
                int fOutputForceLimitedBaseAccel /** toggle to output Force Limited Base Acceleration function */,
                int interpolationMethod /** interpolation method if needed */,
                const char * notchRecordName /** user specified name for Notch function record */,
                const char * limitedAccelRecordName /** user specified name for Limited Base Acceleration function record */,
                const char * destinationAfuFileName /** Destination AFU file */
            );
            ...
            /** Calculates the RMS value of an AFU PSD real only record.
                        Error is returned if the input record is not a Power Spectral Density (PSD) record.
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double CalculateRmsOfPsd
            (
                const NXString & afuFileName /** AFU file name */,
                int recordIndex /** Index of the AFU record to be listed */
            );
