...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        FaceToChange.CloneEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.CoaxialEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.CoplanarAxesEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.CoplanarEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.EqualDiameterEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.OffsetEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.ParallelEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.PatternEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.PerpendicularEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.RigidBodyFaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.SameEntryEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.SameEntrySurfaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.SameOrbitEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.SymmetricEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.TangentEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.ThicknessChainEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToChange.UseFaceBrowse </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ResizeHoleBuilder : public NXOpen::Features::AdmBaseBuilder
        {
            ...
            /**Returns  the face to change 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::FaceRecognitionBuilder * FaceToChange
            (
            );
