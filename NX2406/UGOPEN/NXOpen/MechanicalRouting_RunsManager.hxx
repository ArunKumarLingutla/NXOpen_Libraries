    ...
    namespace MechanicalRouting
    {
        ...
        */
        class NXOPENCPP_MECHANICALROUTINGEXPORT  RunsManager
        {
            ...
            /** Removes the passed in components from membership of the passed in run 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic"), routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") */
            public: void RemoveComponentsFromRun
            (
                const std::vector<NXOpen::Assemblies::Component *> & componentsToRemove /** The components to remove from the run. */,
                NXOpen::NXObject * run /** The run to remove the components from. */
            );
            ...
            /** Deletes a RSD 3D authored run or branch object 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic"), routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") */
            ...
            /** Deletes one or more 3D authored runs or branches from the part file 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic"), routing_pipetube ("Routing Piping and Tubing") OR routing_hvac ("Routing HVAC") */
