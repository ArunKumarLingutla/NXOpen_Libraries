    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ProcessPatterning : public NXOpen::CAM::BaseBuilder
        {
            ...
            /** the process patterning output order */
            public: enum OutputOrderTypes
            {
                OutputOrderTypesAllOperations/** output order by all operations */,
                OutputOrderTypesAllInstances/** output order by all instances */
            };
            ...
            /// \endcond 
            /**Returns  the output order type 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ProcessPatterning::OutputOrderTypes OutputOrderType
            (
            );
            /**Sets  the output order type 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetOutputOrderType
            (
                NXOpen::CAM::ProcessPatterning::OutputOrderTypes orderType /** ordertype */ 
            );
        };
    }
}
