        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ProfileCutoutBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /** Updates the scallop parameters if not under user control. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
                public: void UpdateScallopBuilder
                (
                    NXOpen::Features::ShipDesign::SteelFeatureSpreadsheetBuilder * pScallopBuilder /** pscallopbuilder */ ,
                    NXOpen::TaggedObject * tgTargetBody /** tgtargetbody */ ,
                    NXOpen::TaggedObject * tgProfileBody /** tgprofilebody */ 
                );
                /**Returns  the flag that indicates if the molding side scallop is in user control. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool MoldingSideScallopInUserControl
                (
                );
                /**Sets  the flag that indicates if the molding side scallop is in user control. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
                public: void SetMoldingSideScallopInUserControl
                (
                    bool inUserControl /** inusercontrol */ 
                );
                /**Returns  the flag that indicates if the opposing side scallop is in user control. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool OpposingSideScallopInUserControl
                (
                );
                /**Sets  the flag that indicates if the opposing side scallop is in user control. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
                public: void SetOpposingSideScallopInUserControl
                (
                    bool inUserControl /** inusercontrol */ 
                );
            };
