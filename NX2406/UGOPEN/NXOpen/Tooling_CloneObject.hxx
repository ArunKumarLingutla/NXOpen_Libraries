    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CloneObject : public NXOpen::TransientObject
        {
            ...
            public: void BuildAllClonePartItems
            (
                NXOpen::Part * newWorkPart /** The part to be cloned.*/
            );
            ...
            /** Sets whether to use name mapping template to generate part names.
             ...
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUseMappingTemplate
            (
                bool bUseMappingTemplate /** Whether to use name mapping template to generate part names */
            );
            /** Sets the name mapping template file for current use.
                     
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCurrentNameMappingTemplate
            (
                const NXString & mappingTemplate /** last time used mapping file name */
            );
            /** Sets the name mapping template file for current use.
                     
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            void SetCurrentNameMappingTemplate
            (
                const char * mappingTemplate /** last time used mapping file name */
            );
            /** Sets whether to enable version control of the template part in generating part names.
                     
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetEnableVersionControl
            (
                bool bVersionControl /** Whether to enable version control of the template part */
            );
            /** Adds the drawing part read from the file name mapping template to the clone action
                     
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void AddDrawingPart
            (
                const NXString & drawingPart /** the drawing part file name */,
                const NXString & masterPart /** the master model of the drawing part file */,
                bool bDefinedInMap /** Whether the drawing part is defined in the name mapping spreadsheet file */
            );
            /** Adds the drawing part read from the file name mapping template to the clone action
            ...
            void AddDrawingPart
            (
                const char * drawingPart /** the drawing part file name */,
                const char * masterPart /** the master model of the drawing part file */,
                bool bDefinedInMap /** Whether the drawing part is defined in the name mapping spreadsheet file */
            );
            /** Builds the drawing relation between the template parts and their drawings
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void BuildDrawingRelations
            (
                std::vector<NXString> & partNames /** Names of the part */
            );
            /** Sets whether to check that the part name is already used by existing symbols in generating part names.
                     
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCheckSymbolName
            (
                bool checkSymbolName /** Whether to check the symbol names */
            );
            /** Sets whether the teamcenter number is used to construct the part name. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUseImanNumber
            (
                bool useImanNumber /** useimannumber */ 
            );
            /** Sets assembly load options. After the assembly loading is completed, the caller must restore the load options 
                        by calling method JA_TOOLING_CLONE_RestoreAssemblyLoadOptions. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAssemblyLoadOptions
            (
                bool loadWaveData /** loadwavedata */ ,
                const NXString & folderToSearch /** foldertosearch */ 
            );
            /** Sets assembly load options. After the assembly loading is completed, the caller must restore the load options 
                        by calling method JA_TOOLING_CLONE_RestoreAssemblyLoadOptions. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            void SetAssemblyLoadOptions
            (
                bool loadWaveData /** loadwavedata */ ,
                const char * folderToSearch /** foldertosearch */ 
            );
            ...
            /** Sets whether the Rename clone method used to clone part within Teamcenter remains unchanged. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetKeepRenameWithinTCClone
            (
                bool keepMethod /** keepmethod */ 
            );
            /** Gets cloned roots.  @return  the cloned part names 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetClonedRoots
            (
            );
