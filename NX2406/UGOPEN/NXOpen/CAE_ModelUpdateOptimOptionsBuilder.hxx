...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link NXOpen::CAE::ModelUpdateOptimOptionsBuilder NXOpen::CAE::ModelUpdateOptimOptionsBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::CAE::ModelUpdateSolutionSet::CreateOptimOptionsBuilder  NXOpen::CAE::ModelUpdateSolutionSet::CreateOptimOptionsBuilder @endlink  <br> 
