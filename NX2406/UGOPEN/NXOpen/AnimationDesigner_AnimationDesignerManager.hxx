...
namespace NXOpen
{
    ...
    namespace AnimationDesigner
    {
        class ActivityOperatorCollection;
    }
    namespace AnimationDesigner
    {
        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  AnimationDesignerManager
        {
            ...
            public: enum JaAnimationDesignerDisplayColorOption
            {
                ...
                JaAnimationDesignerDisplayColorOptionShowMotor/** show motor color */,
                JaAnimationDesignerDisplayColorOptionClearMotor/** clear motor color */,
                JaAnimationDesignerDisplayColorOptionShowFlexibleObject/** show flexible object color */,
                JaAnimationDesignerDisplayColorOptionClearFlexibleObject/** clear flexible object color */,
                JaAnimationDesignerDisplayColorOptionShowJoint/** show joint color */,
                JaAnimationDesignerDisplayColorOptionClearJoint/** clear joint color */,
                JaAnimationDesignerDisplayColorOptionShowCoupler/** show coupler color */,
                JaAnimationDesignerDisplayColorOptionClearCoupler/** clear coupler color */
            };

            /**  @brief  Represents envelope accuracy mode.  

              */
            public: enum JaAnimationDesignerEnvelopeAccuracyMode
            {
                JaAnimationDesignerEnvelopeAccuracyModeLow/** accuracy low */,
                JaAnimationDesignerEnvelopeAccuracyModeMedium/** accuracy medium */,
                JaAnimationDesignerEnvelopeAccuracyModeHigh/** accuracy high */,
                JaAnimationDesignerEnvelopeAccuracyModeCustom/** accuracy custom */
            };
            ...
            */
            ...
            /** Creates Envelope objects. 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use JA_MOTION_DESIGNER_MANAGER_CreateSingleEnvelope instead.") void CreateEnvelopes
            (
            ...
            /** Creates an envelope object for a signle geometry. 
             ...
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use JA_MOTION_DESIGNER_MANAGER_CreateSingleEnvelope2 instead.") NXOpen::Facet::FacetedBody * CreateSingleEnvelope
            (
                NXOpen::NXObject * geometry /** geometry */ ,
            ...
            (
                ...
                const std::vector<NXOpen::Matrix4x4> & transformMatrixList /** transformmatrixlist */ ,
                NXOpen::NXObject * destinationPart /** destinationpart */ ,
                NXOpen::AnimationDesigner::AnimationDesignerManager::JaAnimationDesignerEnvelopeAccuracyMode accuracyMode /** accuracymode */ ,
                double tolerance /** tolerance */ ,
                int translucency /** translucency */ ,
                int color /** color */ 
            );
            ...
            /** Clones the solution for Animation Designer. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: void DuplicateSolution
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AnimationDesigner::Nav::Solution * originalSolution /** originalsolution */ ,
                NXOpen::AnimationDesigner::Nav::Solution * copiedSolution /** copiedsolution */ ,
                std::vector<NXOpen::NXObject *> & failList /** faillist */ 
            );
            /** Changes motion type. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            ...
            /** Create facet body for flexible cable. 
             ...
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: NXOpen::NXObject * CreateFlexibleCableFacetBody
            (
                NXOpen::NXObject * flexibleCableTag /** flexiblecabletag */ ,
                const std::vector<NXOpen::Point3d> & vertexList /** vertexlist */ ,
                const std::vector<NXOpen::Vector3d> & widthDirectionList /** widthdirectionlist */ ,
            ...
            /** Shows/hides rigid groups. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: void ShowHideRigidGroupGeometry
            (
                const std::vector<NXOpen::NXObject *> & rigidTag /** rigidtag */ ,
            ...
            */
            ...
            /** @brief  Returns the @link NXOpen::AnimationDesigner::BulletCableCollection  NXOpen::AnimationDesigner::BulletCableCollection @endlink  belonging to this part  
             ...
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::AnimationDesigner::BulletCableCollection *BulletCables();
            /** @brief  Returns the @link NXOpen::AnimationDesigner::BulletFlexibleMaterialCollection  NXOpen::AnimationDesigner::BulletFlexibleMaterialCollection @endlink  belonging to this part  
             ...
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::AnimationDesigner::BulletFlexibleMaterialCollection *BulletFlexibleMaterials();
            /** @brief  Returns the @link NXOpen::AnimationDesigner::FlexibleCableCollection  NXOpen::AnimationDesigner::FlexibleCableCollection @endlink  belonging to this part  
             ...
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::AnimationDesigner::FlexibleCableCollection *FlexibleCables();
            /** @brief  Returns the @link NXOpen::AnimationDesigner::FlexibleMaterialCollection  NXOpen::AnimationDesigner::FlexibleMaterialCollection @endlink  belonging to this part  
             ...
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::AnimationDesigner::FlexibleMaterialCollection *FlexibleMaterials();
            /** @brief  Returns the @link NXOpen::AnimationDesigner::PointOnCurveKinematicsChainCollection NXOpen::AnimationDesigner::PointOnCurveKinematicsChainCollection@endlink  belonging to this application.  
             ...
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::AnimationDesigner::PointOnCurveKinematicsChainCollection *PointOnCurveKinematicsChains();
            ...
            */
            public: NXOpen::AnimationDesigner::ActivityOperatorCollection *ActivityOperators();
