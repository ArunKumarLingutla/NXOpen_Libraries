...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        Sbend </description> </item> 

        <item><term> 
         
        BendingDirection </term> <description> 
        ...
        CompositeInsert </term> <description> 
        ...
        Extend.Value </term> <description> 
         
        5 (millimeters part), 1 (inches part) </description> </item> 

        <item><term> 
         
        ExtrudeEnd.Value </term> <description> 
         
        5 (millimeters part), 1 (inches part) </description> </item> 

        <item><term> 
         
        ExtrudeStart.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        ExtrudeTolerance </term> <description> 
         
        0.01 </description> </item> 

        <item><term> 
         
        FalseBody </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BendInsertDesignBuilder : public NXOpen::Builder
        {
            ...
            public: enum InsertTypeOption
            {
                ...
                InsertTypeOptionPunchDie/** punch and die together insert */
            };
            ...
            /**Returns  the extrude tolerance 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: double ExtrudeTolerance
            (
            );
            /**Sets  the extrude tolerance 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetExtrudeTolerance
            (
                double extrudeTolerance /** extrudetolerance */ 
            );
            ...
            /**Returns  the bending insert part tag. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::TaggedObject * BendinsertPart
            (
            );
            /**Sets  the bending insert part tag. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetBendinsertPart
            (
                NXOpen::TaggedObject * insertPart /** insertpart */ 
            );
            /**Returns  the offset thickness mark for selection face. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsOffsetThickness
            (
            );
            /**Sets  the offset thickness mark for selection face. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetOffsetThickness
            (
                bool isOffsetThickness /** isoffsetthickness */ 
            );
        };
    }
}
