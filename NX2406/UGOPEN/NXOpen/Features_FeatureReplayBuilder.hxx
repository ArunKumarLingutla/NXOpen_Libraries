...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ReplayTimestampNumber </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SecondsBetweenSteps </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureReplayBuilder : public NXOpen::Builder
        {
            ...
            /** Starts feature replay. If feature replay is in paused state, it will continue
                     ...
                     @link NXOpen::Features::FeatureReplayBuilder::SetReplayTimestampNumber NXOpen::Features::FeatureReplayBuilder::SetReplayTimestampNumber@endlink . If
                     @link NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber@endlink  is more
                     than the current feature, feature replay will continue to 
                     @link NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber@endlink  - one
                     feature at a time and there will be a delay of
                     @link NXOpen::Features::FeatureReplayBuilder::SecondsBetweenSteps NXOpen::Features::FeatureReplayBuilder::SecondsBetweenSteps@endlink  seconds
                     between replay of each feature. If
                     @link NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber@endlink  is less
                     than the current feature, feature
                     @link NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber NXOpen::Features::FeatureReplayBuilder::ReplayTimestampNumber@endlink  will be
