        ...
        */
        class NXOPENCPP_CAMEXPORT  ManageToolPartBuilder : public NXOpen::Builder
        {
            ...
            /** Sets the geometry objects of the tool's non cutting component 
             ...
             <br> License requirements : None */
            public: void SetToolNonCuttingObjects
            (
                const std::vector<NXOpen::NXObject *> & tagArray /** Array holding the non cutting objects */
            );
            /** Get the geometry objects of the tool's non cutting component 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void GetToolNonCuttingObjects
            (
                std::vector<NXOpen::NXObject *> & tagArray /** Array with the non cutting objects */
            );
            /** Get the number of the tool's  non cutting geometry objects  @return  Number of non cutting objects 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
