    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmSubopBuilder : public NXOpen::CAM::BaseBuilder
        {
            ...
            public: enum TransferUsing
            {
                TransferUsingEngageRetract/** Use engage and retract defined */,
                TransferUsingFollowBoundary/** follow boundary (for future use) */,
                TransferUsingLiftPlunge/** lift and plunge */,
                TransferUsingNone/** none */,
                TransferUsingSmooth/** smooth */
            };
