        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  DrawingAnnotationBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the setting that indicates whether continuity symbol on section bracket will be created for the ship objects 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : None */
                public: bool IsCreateContinuitySymbolForBoundingStructureOfBracket
                (
                );
                /**Sets  the setting that indicates whether continuity symbol on section bracket will be created for the ship objects 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetCreateContinuitySymbolForBoundingStructureOfBracket
                (
                    bool isCreateContinuitySymbolForBoundingStructureOfBracket /** iscreatecontinuitysymbolforboundingstructureofbracket */ 
                );
                /**Returns  the setting that indicates whether to show default grade in scantling table 
                 <br>  @deprecated Deprecated in NX2007.0.0.  Removed with no replacement. <br>  

                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Removed with no replacement.") bool ShowDefaultGradeInScantlingTable
                (
                );
                /**Sets  the setting that indicates whether to show default grade in scantling table 
                 <br>  @deprecated Deprecated in NX2007.0.0.  Removed with no replacement. <br>  

                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Removed with no replacement.") void SetShowDefaultGradeInScantlingTable
                (
                    bool showDefaultGradeInScantlingTable /** showdefaultgradeinscantlingtable */ 
                );
                /** Update the default grades
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void UpdateDefaultGrades
                (
                ...
                /** Update the default grades
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                void UpdateDefaultGrades
                (
                    const char * defaultGrades /** defaultgrades */ 
                );
                /**Returns  the setting that indicates whether reference lines will be created for the view 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool IsCreateReferenceLines
                (
                );
                /**Sets  the setting that indicates whether reference lines will be created for the view 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetCreateReferenceLines
                (
                    bool isCreateReferenceLines /** iscreatereferencelines */ 
                );
                /** Sets the selected excess matrial types
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetSelectedExcessMatrialTypes
                (
                    const NXString & strExcessMaterialTypes /** strexcessmaterialtypes */ 
                );
                /** Sets the selected excess matrial types
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                void SetSelectedExcessMatrialTypes
                (
                    const char * strExcessMaterialTypes /** strexcessmaterialtypes */ 
                );
            };
        }
    }
