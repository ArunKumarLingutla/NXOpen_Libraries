   ...
   { 
    ...
    { 
     ...
     myUDOclass = theSession.userDefinedClassManager().createUserDefinedObjectClass("Sample_Java_UDO", "Sample Java UDO" ); 
      theSession.listingWindow().writeLine("UDU object is created \n");
    ...
    { 
        try 
        {
            ...
            { 
                ...
                theSession.listingWindow().writeLine("Test Completed Successfully.");
            }
        } 
        catch(Exception ex) 
        { 
            ...
            try
            {
                theSession.listingWindow().writeLine(ex.getMessage());
            }
            catch(Exception ex1)
            {
                System.out.println("Caught Exception"); 
    ...
    //------------------------------------------------------------------------------ 
    public static void startup (String [] args) throws NXException, java.rmi.RemoteException, Exception
    { 
        try 
        { 
            theSimpleJavaUDO = new SimpleUDO(); 
