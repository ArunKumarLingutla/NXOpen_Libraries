...
public class CreateExtruded
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
             ...
             nxopen.Tag partData = ufPart.newPart("CreateExtruded", 2);
             if(partData == null)
             {
             ...
             nxopen.Tag lineData1 = ufCurve.createLine(line1);
             nxopen.Tag lineData2 = ufCurve.createLine(line2);
             nxopen.Tag lineData3 = ufCurve.createLine(line3);
             
             UFCsys ufCsys = theUFSession.csys();
             nxopen.Tag wcsData = ufCsys.askWcs();
             nxopen.Tag matrixOfObjectData = ufCsys.askMatrixOfObject(wcsData);
             arc1.matrixTag = matrixOfObjectData;
             arc2.matrixTag = matrixOfObjectData;
             nxopen.Tag arcData1 = ufCurve.createArc(arc1);
             nxopen.Tag arcData2 = ufCurve.createArc(arc2);
             ...
             nxopen.Tag[] extrudedData = ufModl.createExtruded(loopList, taper_angle, limit1,
                 ref_pt, direction, UFModl.FeatureSigns.NULLSIGN);
             theSession.listingWindow().writeLine("Part file is created successfully.\n");
             ufPart.save();
