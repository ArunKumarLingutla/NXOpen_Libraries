    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
            ...
            if(boolFamilyInstances)
            {
                ...
                nxopen.Tag theAskFamilyInstanceData=ufPart1.askFamilyInstance(part1.tag());   
            ...
            nxopen.Tag pointData= ufCurve.createPoint(point_coord1);
            //pointData
            ...
            nxopen.Tag createArcThru3ptsData2=   ufCurve.createArcThru3pts(1,point_coord4,point_coord5,point_coord6);
            //Passing Int(In)           
            nxopen.Tag createArcThru3ptsData1=   ufCurve.createArcThru3pts(1,point_coord1,point_coord2,point_coord3);                    
            nxopen.Tag  tag_Createsimplified[]=new nxopen.Tag[2];
