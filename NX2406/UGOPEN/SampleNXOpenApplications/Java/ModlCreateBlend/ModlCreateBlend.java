...
public class ModlCreateBlend
{
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
            ...
            corner_point[1] = 0.0;
            corner_point[2] = 0.0;
            nxopen.Tag theCreateBlock1Data= theUFSession.modlFeatures().createBlock1(UFModl.FeatureSigns.NULLSIGN,
                                                        corner_point,
                                                        edge_lengths);
            nxopen.Tag theAskFeatBodyData=  theUFSession.modeling().askFeatBody(theCreateBlock1Data);
            ...
            */
            nxopen.Tag[] theAskBodyEdgesData = theUFSession.modeling().askBodyEdges(theAskFeatBodyData);
            ...
            for(int i=0; i < theAskListCountData; i++) 
            {
                ...
                nxopen.Tag theAskListItemData =theUFSession.modlGeneral().askListItem(theAskBodyEdgesData,i);
            ...
            nxopen.Tag[]    list2=new nxopen.Tag[arr_list2.size()];
            for(int i=0;i<arr_list2.size();i++)
            {
                list2[i]=(nxopen.Tag)arr_list2.get(i);
            }
            nxopen.Tag theCreateBlendData=theUFSession.modlFeatures().createBlend("0.199246", list2, allow_smooth,allow_cliff, allow_notch, vrb_tol);
