...
#-----------------------------------------------------------------------------------------------
def stockComponentCreatedCallback( objects ):
    try:
        echo( "\n*** Python stock component created callback called with " + str( len( objects ) ) + " objects." )
...
def startup( argc, args ):
    ...
    customManager.AddCallback( NXOpen.Routing.CustomManager.CallbackReason.StockComponentCreated, stockComponentCreatedCallback )
