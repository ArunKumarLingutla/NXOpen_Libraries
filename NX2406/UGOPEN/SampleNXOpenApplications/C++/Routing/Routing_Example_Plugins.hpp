...
namespace NXOpen
{
    namespace Routing
    {
        ...
        class Plugins
        {
            ...
            public: void StockComponentNamePlugin
            (
                ComponentNamePluginData* dataObject
            );

            //--------------------------------------------------------------------------------------
            // Called when you enter either the Electrical or Mechanical application.
            public: void ApplicationEnterPlugin
            (
                CustomManager::Application application
            );

            //--------------------------------------------------------------------------------------
            // Called when you exit either the Electrical or Mechanical application.
            public: void ApplicationExitPlugin
            (
                CustomManager::Application application
            );
        };
