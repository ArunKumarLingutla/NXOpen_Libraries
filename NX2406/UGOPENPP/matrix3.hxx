...
// the Identity Matrix.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") VMATHPPEXPORT Matrix3 {

    public:

        // Determines the direction vector that is being passed to the 
        // Matrix3 constructor that accepts a single direction vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitMatrix3") enum OneVectorInput
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitMatrix3") enum TwoVectorInput
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") Matrix3 ( );
        
        // Construct a Matrix3 object from an array.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitMatrix3WithArray") explicit Matrix3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitRotationMatrix3") Matrix3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitMatrix3RollPitchYaw") Matrix3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitMatrix3WithVector") Matrix3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitMatrix3WithXYVectors") Matrix3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") virtual ~Matrix3 ( );
        
        // Return a direction vector of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnDirectionVector") const Vector3 operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyMatrix3AndMatrix3") const Matrix3 operator*
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyMatrix3AndMatrix3") Matrix3& operator*=
        (
            const Matrix3 &matrix       // The second matrix in the operation
                                        // ( Matrix3 =* Matrix3 ).
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Matrix3IsEqualUserTolerance") bool isEqual
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Matrix3IsEqual") bool operator==
        (
        ...
        // of the other matrix within the system tolerance.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Matrix3NotEqual") bool operator!=
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AskRollPitchYaw") void askRollPitchYaw
        (
            double *roll,               // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.TransposeMatrix3") const Matrix3 transpose ( ) const;
        
        // Convert the matrix to a 9 element double array
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertMatrix3ToArray") void asArray
        (
            double array [ 9 ]          // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DeterminantOfMatrix3") double askDeterminant ( ) const;
