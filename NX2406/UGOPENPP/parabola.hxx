...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Parabola.") OPENPPEXPORT Parabola : public Conic
{

    public:
       
        // Return the focal length of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Parabola.") double getFocalLength ( ) const;

        // Return the minimum y value of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Parabola.") double getMinimumY ( ) const;

        // Return the maximum y value of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Parabola.") double getMaximumY ( ) const;
