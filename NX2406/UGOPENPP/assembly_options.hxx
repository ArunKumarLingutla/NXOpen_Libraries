...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") OPENPPEXPORT SearchDirectory
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") SearchDirectory ( );

        // Construct a SearchDirectory object from its components.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") explicit SearchDirectory
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") const std::string getDirectoryPath ( ) const;

        // Edit the directory path of the invoking SearchDirectory object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setDirectoryPath
        (
            const std::string  &directory_path     // <I>     
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool getSubDirectoryStatus ( ) const;

        // Edit the subdirectory search status of the invoking
        // SearchDirectory object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setSubDirectoryStatus
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool operator==
        ( 
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") OPENPPEXPORT AssemblyOptions
{
    ...
    public:
        ...
        // can be found.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") enum LoadOption
        {
        ...
        // The parts list options are no longer used since NX 2.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") enum PartsListOption
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") enum ComponentOption
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") enum WaveParentOption
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") AssemblyOptions ( );

        // Destroy an AssemblyOptions object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") virtual ~AssemblyOptions ( );

        // Return the load option of the invoking AssemblyOptions object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") LoadOption getLoadOption ( ) const;
    
        // Edit the load option of the invoking AssemblyOptions object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setLoadOption
        (
        ...
        // The parts list options are no longer used since NX 2.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") PartsListOption getPartsListOption ( ) const;
    
        // Edit the parts list option of the invoking AssemblyOptions object.
        // The parts list options are no longer used since NX 2.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setPartsListOption
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isUpdateReportOn ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void outputUpdateReport
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isWorkPartEmphasized ( ) const;

        // Edit the highlight-work-part status of the invoking AssemblyOptions object to
        // determine if the work part is highlighted.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void emphasizeWorkPart
        ( 
        ...
        // This is no longer used since NX 5.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") UgColor getColor ( ) const;

        // Edit the color that the other component parts of the assembly are displayed in
        // if the work part is highlighted.
        // This is no longer used since NX 5.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setColor
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isAbortOnFailure ( ) const;
        ...
        // be found.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void abortOnFailure
        (
        ...
        // displayed part.
        // This only affects workflows where the displayed part is changed interactively.
        // This is no longer used since NX 12.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isWorkPartMaintained ( ) const;
        ...
        // This is no longer used since NX 12.0 .
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void maintainWorkPart
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isLoadLatestOn ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void loadLatest
        (
            bool load_latest                    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") ComponentOption getComponentOption ( ) const;

        //Edit the component option of the invoking AssemblyOptions object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setComponentOption
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isPartialLoadingOn ( ) const;
        ...
        // is opened.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void loadPartially
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isAllowSubstitutionOn ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void allowSubstitution
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isAllLevelsOn ( ) const;
        ...
        // assembly tree.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void applyAllLevels
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") bool isLoadWaveDataOn ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void loadWaveData
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") WaveParentOption getWaveParentOption ( ) const;
    
        // Edit the WAVE parent option of the invoking AssemblyOptions object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setWaveParentOption
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") const std::vector < std::string > getDefaultReferenceSets ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setDefaultReferenceSets
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") const std::vector < SearchDirectory > getSearchDirectories ( ) const;

        // Edit the list of search directories.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::LoadOptions.") void setSearchDirectories
        (
