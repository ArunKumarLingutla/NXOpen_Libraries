...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Conic.") OPENPPEXPORT UgConicObject : public UgCurveObject,
                                        public UgOrientableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Conic.") virtual void setCenterPoint
        (
