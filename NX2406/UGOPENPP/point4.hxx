...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") VMATHPPEXPORT Point4
{

    public:

        // Construct a Point4 object at ( 0.0, 0.0, 0.0, 1.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") Point4 ( );
        
        // Construct a Point4 object at ( x, y, z, weight ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::InitPoint4") Point4
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::InitPoint4WithArray") Point4
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::InitPoint4WithCoordinates") Point4
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") virtual ~Point4 ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::ReturnPoint4Coordinate") double &operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::ReturnPoint4Coordinate") const double &operator[]
        (
            VectorMathCoordType index   // The specific point coordinate to
                                        // return.  Valid values are: X, Y, Z,
                                        // or W.
        ...
        // tolerance.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::Point4IsEqualUserTolerance") bool isEqual
        ( 
        ...
        // tolerance.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::Point4IsEqual") bool operator==
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::Point4NotEqual") bool operator!=
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::ConvertPoint4ToPoint3") const Point3 asPoint3 ( ) const;
        ...
        // point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils::ConvertPoint4ToArray") void asArray
        (
            double array [ 4 ]          // <O>
