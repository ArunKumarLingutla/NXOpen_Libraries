...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") OPENPPEXPORT UgInPartObject : public virtual UgObject
{
    ...
    public:
        ...
        // method.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") virtual void destroy ( ) = 0;
    ...
    protected:
        ...
        UgInPartObject(const UgInPartObject&) = delete;
        UgInPartObject& operator=(const UgInPartObject&) = delete;
