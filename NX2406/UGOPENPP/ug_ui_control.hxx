...
///////////////////////////////////////////////////////////////////////////////
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") OPENINTPPEXPORT UgUIControl
{
    public:
        // This enum defines the navigation buttons that are available on a
        // dialog.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") enum ControlType
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") int askDialogID ( ) const;

        // Retrieves the control type
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") virtual UgUIControl::ControlType askType ( ) const;

        // Retrieves the associated dialog
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") const UgUIDialog * getDialog ( ) const;

        // Determines if the control is visible
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") virtual bool isVisible ( ) const;

        // Determines if the control is sensitive
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") virtual bool isSensitive ( ) const;

        // Sets the visibility
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") virtual void setVisible
        (
            bool visible    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") virtual void setSensitive
        (
            bool sensitive  // <I>
