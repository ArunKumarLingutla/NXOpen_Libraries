...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector2d.") VMATHPPEXPORT Vector2
{

    public:

        // Construct a vector with coordinates ( 0.0, 0.0 )
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector2d.") Vector2 ( );
        
        // Construct a vector with coordinates ( x, y )
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitVector2") Vector2
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitVector2WithArray") Vector2
        (
            const double array [ 2 ]    // The x and y coordinates of the vector
        );

        // Destruct a vector
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector2d.") virtual ~Vector2 ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnVector2Coordinate") double &operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnVector2Coordinate") const double &operator[]
        (
            VectorMathCoordType index   // The specific vector coordinate to
                                        // return.  Valid values are: X or Y.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AddVector2ToVector2") const Vector2 operator+
        (
        ...
        // vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AddVector2ToVector2") Vector2 &operator+=
        (
            const Vector2 &vector       // The second vector in the operation
                                        // ( Vector2 += Vector2 ).
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractVector2FromVector2") const Vector2 operator-
        (
            const Vector2 &vector       // The second vector in the operation
                                        // ( Vector2 - Vector2 ).
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractVector2FromVector2") Vector2 &operator-=
        (
            const Vector2 &vector       // The second vector in the operation
                                        // ( Vector2 -= Vector2 ).
        );
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyVector2ByDouble") const Vector2 operator*
        (
        ...
        // scale.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyVector2ByDouble") Vector2 &operator*=
        (
            double scale                // The scale factor.
        );
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DivideVector2ByDouble") const Vector2 operator/
        (
            double scale                // The scale factor.
        ) const;
        ...
        // scale.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DivideVector2ByDouble") Vector2 &operator/=
        (
            double scale                // The scale factor.
        );
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.NegateVector2") const Vector2 operator- ( ) const;
        
        // Return the dot product of two vectors.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2DotProduct") double dot
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2CrossProduct") double cross
        (
            const Vector2 &vector       // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MagnitudeOfVector2") double askMagnitude ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2IsEqualUserTolerance") bool isEqual
        ( 
            const Vector2  &vector,     // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2IsEqual") bool operator==
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2NotEqual") bool operator!=
        ( 
        ...
        // a magnitude of ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ParallelVector2") const Vector2 askUnit
        (
        ...
        // the vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertVector2ToPoint2") const Point2 asPoint2 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertVector2ToVector3") const Vector3 asVector3 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertVector2ToArray") void asArray
        (
            double array [ 2 ]          // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2FindAngle") double askAngle
        (
            const Vector2 &vector,      // <I>
        ...
        // ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2IsParallel") bool isParallel
        (
            const Vector2 &vector,      // <I>
        ...
        // ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2IsPerpendicular") bool isPerpendicular
        (
            const Vector2 &vector,      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MakePerpendicular") const Vector2 askPerpendicular ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector2AskComponents") bool askComponents
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.RotateVector2") const Vector2 rotate
        (
            double ang              // <I>
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyVector2ByDouble") VMATHPPEXPORT const Vector2 operator*
(
    double          scale,           // The scale factor
