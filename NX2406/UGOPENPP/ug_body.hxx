...
// NX body objects.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") OPENPPEXPORT UgBody : public UgDisplayableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") enum DensityUnits
        {   
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") bool isSheet ( ) const;
      
        // Determine if the invoking object is a solid body.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") bool isSolid ( ) const;
        
        // Return the density of the invoking object in the requested units.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") double getDensity
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") const std::vector < UgBodyFeatureObject * > askFeatures ( ) const;

        // Return all of the faces of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") const std::vector < UgFace * > askFaces ( ) const;

        // Return all of the edges of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") const std::vector < UgEdge * > askEdges ( ) const;

        // Edit the density of the body
        // Return the density of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") void setDensity
        (
            DensityUnits    units,          // <I>
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") UgBody *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") UgBody *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Body.") const std::vector < UgBody * > askAllOccurrences ( ) const;
