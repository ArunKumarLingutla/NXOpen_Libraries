...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") OPENPPEXPORT UgCoordSys : public UgDisplayableObject,
                                     public UgOrientableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") static UgCoordSys *create
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") const CoordSys getCoordSys ( ) const;
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") UgCoordSys *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") UgCoordSys *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") const std::vector < UgCoordSys * > askAllOccurrences ( ) const;
