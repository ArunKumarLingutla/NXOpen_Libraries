...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") OPENPPEXPORT Curve
{ 
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") bool isEqual
        (
            const Curve *curve          // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") bool isClosed ( ) const;

        // Return the start point in Absolute Coordinate System coordinates
        // of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") const Point3 askStartPoint ( ) const;

        // Return the end point in Absolute Coordinate System coordinates
        // of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") const Point3 askEndPoint ( ) const;
