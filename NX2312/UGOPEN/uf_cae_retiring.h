...
History:  Deprecated in NX2312

Equivalent JA function/property:
Please use PhysicalMaterialCollection::CreatePhysicalMaterialBuilder() instead.
**************************************************************************/
...
Equivalent JA function/property:
Please use PhysicalMaterialCollection::AskMaterialOfObject() instead.
*******************************************************************************/
...
Equivalent JA function/property:
Please use PhysicalMaterial::AssignObjects() instead.
*******************************************************************************/
...
Equivalent JA function/property:
Please use PhysicalMaterialCollection::FindObject() instead.
*******************************************************************************/
...
Equivalent JA function/property:
Please use PhysicalMaterial::UnassignObjects() instead.
*******************************************************************************/
...
History: Originally released in V16.0
         Deprecated in NX2312

Equivalent JA function/property:
Please use PhysicalMaterial::GetMaterialType() instead.
*******************************************************************************/
...
UF_SF_ask_material may create expressions on demand and use those expressions
to store and return material properties. If you are calling UF_SF_ask_material
to get the material name only, you can pass NULL for the second parameter
(material_name) and no expressions will be created.
...
Equivalent JA function/property:
Please use PhysicalMaterialCollection::GetMaterialSpecifiedPropertyNeutralNames()
and PhysicalMaterialCollection::GetMaterialPropertyValueAndDisplayName() or
use PhysicalMaterial::GetPropTable and BasePropertyTable methods to get the
values and units for each property instead.
*******************************************************************************/
...
/******************************************************************************
  ...
  Equivalent JA function/property:
  Please use PhysicalMaterial::GetPropTable and BasePropertyTable methods to
  set values and units for each property instead.
******************************************************************************/
...
/******************************************************************************
  ...
  Equivalent JA function/property:
  Please use PhysicalMaterial::GetPropTable() and BasePropertyTable methods to
  set the values and units for each property instead.
******************************************************************************/
...
This function does not support Site or User material libraries.
...
Equivalent JA function/property:
Please use PhysicalMaterialCollection::GetMaterialsFromLibrary() instead.
*******************************************************************************/
...
This function does not support Site or User libraries.
...
Equivalent JA function/property:
Please use PhysicalMaterialCollection::LoadFromLibrary() or
PhysicalMaterialCollection::LoadFromNxlibrary() or
PhysicalMaterialCollection::LoadFromMatmlLibrary() instead.
*******************************************************************************/
