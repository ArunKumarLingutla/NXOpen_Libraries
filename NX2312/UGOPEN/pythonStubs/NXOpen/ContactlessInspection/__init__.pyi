...
class InspectionGroupBuilder(NXOpen.Builder): 
    ...
    ##   the measurement information for the created\edited @link ContactlessInspection::InspectionGroup ContactlessInspection::InspectionGroup@endlink    
    ##     
    ##  
...
class MeasureConeSurfaceBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link MeasurementInformation NXOpen.ContactlessInspection.MeasurementInformation@endlink) MeasurementInformation
    ##   the measurement information for the created\edited @link ContactlessInspection::ConeMeasurement ContactlessInspection::ConeMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the nominal cone(s) defining the @link ContactlessInspection::ConeMeasurement ContactlessInspection::ConeMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasureCylinderSurfaceBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link MeasurementInformation NXOpen.ContactlessInspection.MeasurementInformation@endlink) MeasurementInformation
    ##   the measurement information for the created\edited @link ContactlessInspection::CylinderMeasurement ContactlessInspection::CylinderMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the nominal cylinder(s) defining the @link ContactlessInspection::CylinderMeasurement ContactlessInspection::CylinderMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasureExtremePointBuilder(NXOpen.Builder): 
    ...
    ##   the measurement direction in which the actual point will be detected  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link MeasurementInformation NXOpen.ContactlessInspection.MeasurementInformation@endlink) MeasurementInformation
    ##   the measurement information related to the measurment like the Measurment's group and label   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the nominal point used for measuring the actual point   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the section plane normal to be used to create the actual section   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasurementInformation(NXOpen.TaggedObject): 
    ...
    ##   the inspection group of the Measurement or Inspecton Group.  
    ...
    ##   the label of the @link ContactlessInspection::Measurement ContactlessInspection::Measurement@endlink   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    @staticmethod
    def GetAllInspectionGroupsNames(measurementInformation: MeasurementInformation) -> List[str]:
        """
         Get all the @link ContactlessInspection::InspectionGroup ContactlessInspection::InspectionGroup@endlink  in part
         @return inspectionGroupNames (List[str]): The array of Inspection Groups Names.
        """
...
class MeasurePlaneSurfaceBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link MeasurementInformation NXOpen.ContactlessInspection.MeasurementInformation@endlink) MeasurementInformation
    ##   the measurement information for the created\edited @link ContactlessInspection::PlaneMeasurement ContactlessInspection::PlaneMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the nominal plane(s) defining the @link ContactlessInspection::PlaneMeasurement ContactlessInspection::PlaneMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasurePrimitiveSurfaceBuilder(NXOpen.Builder): 
    ...
    ## Creates a measurement of type @link ContactlessInspection::PlaneMeasurement ContactlessInspection::PlaneMeasurement@endlink 
    class Types(Enum):
        """
    ...
    ##   the data for creating cone measurement  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the data for creating cylinder measurement  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the data for creating plane measurement  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the data for creating sphere measurement  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the type of @link ContactlessInspection::PrimitiveSurfaceMeasurement ContactlessInspection::PrimitiveSurfaceMeasurement@endlink  desired  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasureSphereSurfaceBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link MeasurementInformation NXOpen.ContactlessInspection.MeasurementInformation@endlink) MeasurementInformation
    ##   the measurement information for the created\edited @link ContactlessInspection::SphereMeasurement ContactlessInspection::SphereMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the nominal sphere(s) defining the @link ContactlessInspection::SphereMeasurement ContactlessInspection::SphereMeasurement@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasureSurfaceBuilder(NXOpen.Builder): 
    ...
    ##   the nominal surface belonging to the nominal body  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeasureSymmetryPointBuilder(NXOpen.Builder): 
    ...
    ##   the first point measurement of type point, arc, circle, or sphere measurement   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the nominal point for second point   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second point measurement of type point, arc, circle, or sphere measurement  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second point measurement type for symmetry point measurement  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
"""
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectPointMeasurement) -> Tuple[PointMeasurement, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the object's view and point.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectPointMeasurement) -> Tuple[NXOpen.InferSnapType.SnapType, PointMeasurement, NXOpen.View, NXOpen.Point3d, PointMeasurement, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the objects view and point and snap information.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectPointMeasurement) -> Tuple[PointMeasurement, NXOpen.CaeObjectType.CaeSubType, int]:
        """
         The object being selected with CAE set object information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectPointMeasurement, selection: PointMeasurement, view: NXOpen.View, point: NXOpen.Point3d) -> None:
        """
         The object being selected with the object's view and object's point
    ...
    ##   snap point type
    @overload
    def SetValue(self, select_object: SelectPointMeasurement, snap_type: NXOpen.InferSnapType.SnapType, selection1: PointMeasurement, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: PointMeasurement, view2: NXOpen.View, point2: NXOpen.Point3d) -> None:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectPointMeasurement, selection: PointMeasurement, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> None:
        """
         The object being selected with CAE set object information.
