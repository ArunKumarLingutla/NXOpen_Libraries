...
class ContinuousDesignVariableBuilder(NXOpen.Builder): 
    ...
    ##   the int value of baseline value expression   
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ##   <br>  Created in NX2212.0.0  <br> 
    ...
    ##     
    ##  
    ## Setter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ##   <br>  Created in NX2007.0.0  <br> 
    ## 
    ##   <br>  @deprecated Deprecated in NX2212.0.0.  Use @link DSE::ContinuousDesignVariableBuilder::IncrementExpression DSE::ContinuousDesignVariableBuilder::IncrementExpression@endlink  instead.  <br> 
    ...
    ##   the int value of increment value expression   
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ...
    ##   the int value of lower limit expression   
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ...
    ##   the int value of upper limit expression   
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
...
class CopyStudyBuilder(NXOpen.Builder): 
    ...
    ##   the constraints toggle to enable copy of design constraints.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the objectives toggle to enable copy of design objectives.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the variables toggle to enable copy of design variables.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class DesignConstraintBuilder(NXOpen.Builder): 
    ...
    ##   the constraint lower limit available only when target type is range  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the constraint upper limit available only when target type is range  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the lower normalization factor available only when target type is range and lower normalization control is opted to specify  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the lower normalization factor control available only when target type is range  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normalization factor available only when target type is not range and normalization control is opted to specify  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normalization factor control available only when target type is not range  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the upper normalization factor available only when target type is range and upper normalization control is opted to specify  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the upper normalization factor control available only when target type is range  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def SetSelectedAppObject(builder: DesignConstraintBuilder, appObject: NXOpen.TaggedObject) -> None:
        """
         Set the selected application object 
        """
        pass
    ...
    def SetSelectedAppOwnerObjectAndLookupKey(builder: DesignConstraintBuilder, appOwnerObject: NXOpen.TaggedObject, appLookupKey: str) -> None:
        """
         Set the selected application owner object and lookup key 
        """
        pass
...
class DesignObjectiveBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (float) NormalizationFactor
    ##   the objective normalization factor   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normalization factor option   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## 
    ## <param name="appObject"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink) </param>
    def SetSelectedAppObject(builder: DesignObjectiveBuilder, appObject: NXOpen.TaggedObject) -> None:
        """
         Set the selected application object 
        """
        pass
    ...
    ## <param name="appOwnerObject"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink) </param>
    ## <param name="appLookupKey"> (str) </param>
    def SetSelectedAppOwnerObjectAndLookupKey(builder: DesignObjectiveBuilder, appOwnerObject: NXOpen.TaggedObject, appLookupKey: str) -> None:
        """
         Set the selected application owner object and lookup key 
        """
        pass
...
class DesignVariableBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetContinuousDesignVariableBuilder(builder: DesignVariableBuilder) -> ContinuousDesignVariableBuilder:
        """
         Get continuous design variable builder 
         @return cdvBuilder (@link ContinuousDesignVariableBuilder NXOpen.DSE.ContinuousDesignVariableBuilder@endlink): .
        """
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetDiscreteDesignVariableBuilder(builder: DesignVariableBuilder) -> DiscreteDesignVariableBuilder:
        """
         Get discrete design variable builder 
         @return ddvBuilder (@link DiscreteDesignVariableBuilder NXOpen.DSE.DiscreteDesignVariableBuilder@endlink): .
        """
    ...
    ## 
    ## <param name="appObject"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink) </param>
    def SetSelectedAppObject(builder: DesignVariableBuilder, appObject: NXOpen.TaggedObject) -> None:
        """
         Set the selected application object 
        """
        pass
    ...
    ## <param name="appOwnerObject"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink) </param>
    ## <param name="appLookupKey"> (str) </param>
    def SetSelectedAppOwnerObjectAndLookupKey(builder: DesignVariableBuilder, appOwnerObject: NXOpen.TaggedObject, appLookupKey: str) -> None:
        """
         Set the selected application owner object and lookup key 
        """
        pass
...
class DiscreteDesignVariableBuilder(NXOpen.Builder): 
    ...
    def AddValuesToSet(builder: DiscreteDesignVariableBuilder, validObjValue: NXOpen.DSEPlatform.ValidObjectValue) -> None:
        """
         Set the object 
        """
        pass
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetValidValuesForSelectedObject(builder: DiscreteDesignVariableBuilder) -> List[NXOpen.DSEPlatform.ValidObjectValue]:
        """
         Get valid values for currently selected application object 
         @return validObjValues (@link NXOpen.DSEPlatform.ValidObjectValue List[NXOpen.DSEPlatform.ValidObjectValue]@endlink): The array of valid values.
        """
    ...
    ## 
    ## <param name="validObjValue"> (@link NXOpen.DSEPlatform.ValidObjectValue NXOpen.DSEPlatform.ValidObjectValue@endlink) </param>
    def RemoveValuesFromSet(builder: DiscreteDesignVariableBuilder, validObjValue: NXOpen.DSEPlatform.ValidObjectValue) -> None:
        """
         Remove the object 
        """
        pass
...
class DiscreteVariableValueBuilderList(NXOpen.TaggedObject): 
    ...
    ##  items to append 
    @overload
    def Append(self, object_list: DiscreteVariableValueBuilderList, objects: List[DiscreteVariableValueBuilder]) -> None:
        """
         Appends a set of objects to the list
    ...
    ##  item to append 
    @overload
    def Append(self, object_list: DiscreteVariableValueBuilderList, objectValue: DiscreteVariableValueBuilder) -> None:
        """
         Appends an object to the list
    ...
    ## License requirements: None.
    @staticmethod
    def Clear(object_list: DiscreteVariableValueBuilderList) -> None:
        """
         Clears the entire list without deleting the objects.  The caller is responsible for 
                accounting for these objects.  If they are not used or deleted by the time the part is 
                closed (in other words, leaked) an error will occur 
    ...
    def ClearIndex(object_list: DiscreteVariableValueBuilderList, delete_idx: int) -> None:
        """
         Deletes the item at the index specified.  The size of the list does
            *   not change, but the item at this index is set to NULL.
    ...
    def Clear(object_list: DiscreteVariableValueBuilderList, delete_option: NXOpen.ObjectList.DeleteOption) -> None:
        """
         Clears the entire list 
        """
        pass
    ...
    @overload
    def Erase(self, object_list: DiscreteVariableValueBuilderList, index: int) -> None:
        """
         Erases the object from the list, but does not delete the object.
                The list is shifted so that there isn't a null where the object used to be. 
        """
    ...
    ##  index of item to be removed from the list 
    @overload
    def Erase(self, object_list: DiscreteVariableValueBuilderList, index: int, delete_option: NXOpen.ObjectList.DeleteOption) -> None:
        """
         Erases the object at the given position from the list.
                The list is shifted so that there isn't a null where the object used to be. 
        """
    ...
    @overload
    def Erase(self, object_list: DiscreteVariableValueBuilderList, obj: DiscreteVariableValueBuilder) -> None:
        """
         Erases the object from the list, but does not delete the object.
                The list is shifted so that there isn't a null where the object used to exist. 
        """
    ...
    ##  object to be removed from the list 
    @overload
    def Erase(self, object_list: DiscreteVariableValueBuilderList, obj: DiscreteVariableValueBuilder, delete_option: NXOpen.ObjectList.DeleteOption) -> None:
        """
         Erases the object from the list.
                The list is shifted so that there isn't a null where the object used to exist. 
        """
    ...
    def FindIndex(object_list: DiscreteVariableValueBuilderList, obj: DiscreteVariableValueBuilder) -> int:
        """
         Finds the index where the input object appears.  If it does not appear,
            *   -1 is returned.
    ...
    def FindItem(object_list: DiscreteVariableValueBuilderList, index: int) -> DiscreteVariableValueBuilder:
        """
         Returns the object at the input index.  May be NULL.
    ...
    ## License requirements: None.
    @staticmethod
    def GetContents(object_list: DiscreteVariableValueBuilderList) -> List[DiscreteVariableValueBuilder]:
        """
         Gets the contents of the entire list 
         @return objects (@link DiscreteVariableValueBuilder List[NXOpen.DSE.DiscreteVariableValueBuilder]@endlink):  The list contents .
        """
    ...
    def Insert(object_list: DiscreteVariableValueBuilderList, location: int, objectValue: DiscreteVariableValueBuilder) -> None:
        """
         Inserts an object at the specified location 
        """
        pass
    ...
    def MoveToBottom(object_list: DiscreteVariableValueBuilderList, index: int) -> None:
        """
         Move object at the specified location to the bottom of the list.
        """
        pass
    ...
    ## License requirements: None.
    ##  location of the item 
    def MoveToTop(object_list: DiscreteVariableValueBuilderList, index: int) -> None:
        """
         Move object at the specified location to the top of the list.
        """
        pass
    ...
    ## License requirements: None.
    ##  The list contents 
    def SetContents(object_list: DiscreteVariableValueBuilderList, objects: List[DiscreteVariableValueBuilder]) -> None:
        """
         Sets the contents of the entire list. This overwrites the previous contents of this list, 
                but does not delete any objects that were originally on the list.
    ...
    @overload
    def Swap(self, object_list: DiscreteVariableValueBuilderList, index1: int, index2: int) -> None:
        """
         Exchanges the position of two objects inside the list.
                The first object is placed where the second used to be,
                and second object where the first used to be. 
    ...
    ##  first item 
    @overload
    def Swap(self, object_list: DiscreteVariableValueBuilderList, object1: DiscreteVariableValueBuilder, object2: DiscreteVariableValueBuilder) -> None:
        """
         Exchanges the position of two objects inside the list.
                The first object is placed where the second used to be,
                and second object where the first used to be. 
...
class OptimizationStudyBuilder(NXOpen.Builder): 
    ...
    ##   the iteration root string for naming iteration parts of Study  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the folder location to save parts   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class OptimizationStudy(NXOpen.DSEPlatform.ExplorationStudy): 
    ...
    def AddDesignConstraint(study: OptimizationStudy, desConstraint: DesignConstraint) -> None:
        """
         Set design constraint on optimization study
        """
        pass
    ...
    def AddDesignObjective(study: OptimizationStudy, dvObj: DesignObjective) -> None:
        """
         Set design objective on optimization study
        """
        pass
    ...
    def AddDesignVariable(study: OptimizationStudy, dvObj: DesignVariable) -> None:
        """
         Set design variable on optimization study
        """
        pass
    ...
    def AddWorkflow(study: OptimizationStudy, workflow: NXOpen.DSEPlatform.OptimizationWorkflow) -> None:
        """
         Set design workflow on optimization study
        """
        pass
    ...
    def ApplyDesign(study: OptimizationStudy, design: Design) -> None:
        """
         Apply the given design
        """
        pass
    ...
    ## 
    ## <param name="desConstraint"> (@link DesignConstraint NXOpen.DSE.DesignConstraint@endlink) </param>
    def DeleteDesignConstraint(study: OptimizationStudy, desConstraint: DesignConstraint) -> None:
        """
         Deletes the design constraint
        """
        pass
    ...
    ## 
    ## <param name="dvObj"> (@link DesignObjective NXOpen.DSE.DesignObjective@endlink) </param>
    def DeleteDesignObjective(study: OptimizationStudy, dvObj: DesignObjective) -> None:
        """
         Deletes the design objective
        """
        pass
    ...
    ## 
    ## <param name="dvObj"> (@link DesignVariable NXOpen.DSE.DesignVariable@endlink) </param>
    def DeleteDesignVariable(study: OptimizationStudy, dvObj: DesignVariable) -> None:
        """
         Deletes the design variable
        """
        pass
    ...
    def DeleteResult(study: OptimizationStudy, runResultObj: RunResult) -> None:
        """
         Deletes the study result
        """
        pass
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def DeleteStudy(study: OptimizationStudy) -> None:
        """
         Deletes the optimization study
        """
        pass
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def DeleteStudyResults(study: OptimizationStudy) -> None:
        """
         Delete Study Results 
        """
        pass
    ...
    ## 
    ## <param name="workflow"> (@link NXOpen.DSEPlatform.OptimizationWorkflow NXOpen.DSEPlatform.OptimizationWorkflow@endlink) </param>
    def DeleteWorkflow(study: OptimizationStudy, workflow: NXOpen.DSEPlatform.OptimizationWorkflow) -> None:
        """
         Deletes the optimization workflow
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetArchiveSize(study: OptimizationStudy) -> int:
        """
         Get Archive Size 
         @return archiveSize (int): .
        """
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetBaselineDesignOption(study: OptimizationStudy) -> OptimizationStudy.BaselineDesignOption:
        """
         Get the baseline design option
         @return baselineDesignOption (@link OptimizationStudy.BaselineDesignOption NXOpen.DSE.OptimizationStudy.BaselineDesignOption@endlink): .
        """
    ...
    def GetDesignConstraintAtIndex(study: OptimizationStudy, index: int) -> DesignConstraint:
        """
         Get the design constraint at index from the study
         @return desConstraint (@link DesignConstraint NXOpen.DSE.DesignConstraint@endlink): .
        """
    ...
    ## 
    ## <param name="index"> (int) </param>
    def GetDesignObjectiveAtIndex(study: OptimizationStudy, index: int) -> DesignObjective:
        """
         Get the design objective at index from the study
         @return dvObj (@link DesignObjective NXOpen.DSE.DesignObjective@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetDesignTableOption(study: OptimizationStudy) -> OptimizationStudy.DesignTableOption:
        """
         Get design table option
         @return designTableOption (@link OptimizationStudy.DesignTableOption NXOpen.DSE.OptimizationStudy.DesignTableOption@endlink): .
        """
    ...
    ## 
    ## <param name="index"> (int) </param>
    def GetDesignVariableAtIndex(study: OptimizationStudy, index: int) -> DesignVariable:
        """
         Get the design variable at index from the study
         @return dvObj (@link DesignVariable NXOpen.DSE.DesignVariable@endlink): .
        """
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetDoDisplayUpdate(study: OptimizationStudy) -> bool:
        """
         Get property to update display 
         @return shouldUpdateDisp (bool): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetIteration(study: OptimizationStudy) -> int:
        """
         Get iteration 
         @return iterations (int): .
        """
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetLatestRunResult(study: OptimizationStudy) -> RunResult:
        """
         Get latest run result
         @return runResult (@link RunResult NXOpen.DSE.RunResult@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfDesignConstraints(study: OptimizationStudy) -> int:
        """
         Get the number of design constraints in the study
         @return numConstraints (int): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfDesignObjectives(study: OptimizationStudy) -> int:
        """
         Get the number of design objective in the study
         @return numVar (int): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfDesignVariables(study: OptimizationStudy) -> int:
        """
         Get the number of design variable in the study
         @return numVar (int): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfRunResults(study: OptimizationStudy) -> int:
        """
         Get the number of run results in the study
         @return numRunResult (int): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfWorkflows(study: OptimizationStudy) -> int:
        """
         Get the number of workflows in the study
         @return numWorkflow (int): .
        """
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def GetRandomSeed(study: OptimizationStudy) -> float:
        """
         Get the random seed 
         @return randomSeed (float): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetResultStorageOption(study: OptimizationStudy) -> OptimizationStudy.ResultStorageOption:
        """
         Get save option
         @return resultStorageOption (@link OptimizationStudy.ResultStorageOption NXOpen.DSE.OptimizationStudy.ResultStorageOption@endlink): .
        """
    ...
    ## 
    ## <param name="index"> (int) </param>
    def GetRunResultAtIndex(study: OptimizationStudy, index: int) -> RunResult:
        """
         Get the run result at index from the study
         @return runResultObj (@link RunResult NXOpen.DSE.RunResult@endlink): .
        """
    ...
    def GetRunResultWithName(study: OptimizationStudy, designTableName: str) -> RunResult:
        """
         Get the run result from the study when name is given
         @return runResultObj (@link RunResult NXOpen.DSE.RunResult@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetSherpaMethodOption(study: OptimizationStudy) -> OptimizationStudy.SherpaMethodOption:
        """
         Get Sherpa Method Option
         @return sherpaMethodOption (@link OptimizationStudy.SherpaMethodOption NXOpen.DSE.OptimizationStudy.SherpaMethodOption@endlink): .
        """
    ...
    ## 
    ## <param name="index"> (int) </param>
    def GetWorkflowAtIndex(study: OptimizationStudy, index: int) -> NXOpen.DSEPlatform.OptimizationWorkflow:
        """
         Get the workflow at index from the study
         @return wfObj (@link NXOpen.DSEPlatform.OptimizationWorkflow NXOpen.DSEPlatform.OptimizationWorkflow@endlink): .
        """
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def RunStudy(study: OptimizationStudy) -> None:
        """
         Run the study 
        """
        pass
    ...
    def SetArchiveSize(study: OptimizationStudy, iterations: int) -> None:
        """
         Set Archive Size 
        """
        pass
    ...
    def SetBaselineDesignOption(study: OptimizationStudy, baselineDesignOption: OptimizationStudy.BaselineDesignOption) -> None:
        """
         Set the baseline design option
        """
        pass
    ...
    def SetDesignTableOption(study: OptimizationStudy, designTableOption: OptimizationStudy.DesignTableOption) -> None:
        """
         Set design table option
        """
        pass
    ...
    def SetDoDisplayUpdate(study: OptimizationStudy, shouldUpdateDisp: bool) -> None:
        """
         Set property to update display 
        """
        pass
    ...
    ## 
    ## <param name="iterations"> (int) </param>
    def SetIteration(study: OptimizationStudy, iterations: int) -> None:
        """
         Set iteration 
        """
        pass
    ...
    def SetNewRunName(study: OptimizationStudy, newRunName: str) -> None:
        """
         Set the new run name, this name is cleared after subseqent call to RunStudy
        """
        pass
    ...
    def SetRandomSeed(study: OptimizationStudy, randomSeed: float) -> None:
        """
         Set the random seed 
        """
        pass
    ...
    def SetResultStorageOption(study: OptimizationStudy, resultStorageOption: OptimizationStudy.ResultStorageOption) -> None:
        """
         Set save option
        """
        pass
    ...
    ## 
    ## <param name="runResultObj"> (@link RunResult NXOpen.DSE.RunResult@endlink) </param>
    def SetRunResultToAppend(study: OptimizationStudy, runResultObj: RunResult) -> None:
        """
         Set given run result as Appending Design Table 
        """
        pass
    ...
    def SetSherpaMethodOption(study: OptimizationStudy, sherpaMethodOption: OptimizationStudy.SherpaMethodOption) -> None:
        """
         Set Sherpa Method Option
        """
        pass
...
class Plot2DData(NXOpen.Builder): 
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def ClearParameters(plot2dData: Plot2DData) -> None:
        """
         Clear parameters 
        """
        pass
    ...
    def RemoveYParameterColumnIndex(plot2dData: Plot2DData, columnID: int) -> None:
        """
         Remove the y parameter column index 
        """
        pass
    ...
    ## 
    ## <param name="columnID"> (int) </param>
    def SetXParameterColumnIndex(plot2dData: Plot2DData, columnID: int) -> None:
        """
         Set the x parameter column index 
        """
        pass
    ...
    ## 
    ## <param name="columnID"> (int) </param>
    def SetYParameterColumnIndex(plot2dData: Plot2DData, columnID: int) -> None:
        """
         Set the y parameter column index 
        """
        pass
...
class Plot3DData(NXOpen.Builder): 
    ...
    ## License requirements: nx_design_explorer (" NX Design Space Exploration")
    @staticmethod
    def ClearParameters(plot3dData: Plot3DData) -> None:
        """
         Clear parameters 
        """
        pass
    ...
    ## 
    ## <param name="columnID"> (int) </param>
    def RemoveZParameterColumnIndex(plot3dData: Plot3DData, columnID: int) -> None:
        """
         Remove the z parameter column index 
        """
        pass
    ...
    ## 
    ## <param name="columnID"> (int) </param>
    def SetXParameterColumnIndex(plot3dData: Plot3DData, columnID: int) -> None:
        """
         Set the x parameter column index 
        """
        pass
    ...
    ## 
    ## <param name="columnID"> (int) </param>
    def SetYParameterColumnIndex(plot3dData: Plot3DData, columnID: int) -> None:
        """
         Set the y parameter column index 
        """
        pass
    ...
    ## 
    ## <param name="columnID"> (int) </param>
    def SetZParameterColumnIndex(plot3dData: Plot3DData, columnID: int) -> None:
        """
         Set the z parameter column index 
        """
        pass
...
class PlotBuilder(NXOpen.Builder): 
    ...
    ##   the constraint violations data  
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ...
    ##   the option to highlight baseline design   
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ...
    ##   the option to show best design   
    ##     
    ##  
    ## Getter License requirements: nx_design_explorer (" NX Design Space Exploration")
    ## 
    ...
    ## 
    ## <param name="runResultObj"> (@link RunResult NXOpen.DSE.RunResult@endlink) </param>
    def SetCurrentRunResult(builder: PlotBuilder, runResultObj: RunResult) -> None:
        """
         Set the run result in plot builder 
        """
        pass
    ...
    def SetPlotNamePrefix(builder: PlotBuilder, plotNamePrefix: str) -> None:
        """
         Set the plot name prefix 
        """
        pass
...
class RunResult(NXOpen.TaggedObject): 
    ...
    def DeletePlot(runResult: RunResult, plotObj: Plot) -> None:
        """
         Delete the plot from run
        """
        pass
    ...
    def GetDesignById(runResult: RunResult, designId: int) -> Design:
        """
         Get design by designId
         @return design (@link Design NXOpen.DSE.Design@endlink): .
        """
    ...
    ## 
    ## <param name="index"> (int) </param>
    def GetPlotAtIndex(runResult: RunResult, index: int) -> Plot:
        """
         Get the plot at index from the run result
         @return plotObj (@link Plot NXOpen.DSE.Plot@endlink): .
        """
