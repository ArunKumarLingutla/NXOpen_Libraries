...
class PreferencesBuilder(NXOpen.Builder): 
    ...
    ##   the boss feature validation base radius to nominal wall thickness ratio   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation base radius to nominal wall thickness ratio limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation height to nominal wall thickness ratio   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation height to nominal wall thickness ratio limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation height to outer diameter ratio   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation height to outer diameter ratio limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation maximum outer to inner diameter thickness   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation maximum outer to inner diameter thickness limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum draft on inner diameter   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum draft on inner diameter limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum draft on outer diameter   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum draft on outer diameter limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum radius at base   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum radius at base limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum radius at top   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum radius at top limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum wall distance   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation minimum wall distance limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation outer to inner diameter ratio   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boss feature validation outer to inner diameter ratio limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation maximum thickness at base   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation maximum thickness at base limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation minimum draft on lifter side faces   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation minimum draft on lifter side faces limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation minimum draft on outer faces   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation minimum draft on outer faces limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation minimum radius on outer edges   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the housing feature validation minimum radius on outer edges limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation negative draft   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation negative draft color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation negative draft limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation positive draft   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation positive draft color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation positive draft limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation height to nominal wall thickness ratio   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation height to nominal wall thickness ratio limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation minimum radius at base   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation minimum radius at base limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation minimum thickness at top   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation minimum thickness at top limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation thickness to nominal wall thickness ratio   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the rib feature validation thickness to nominal wall thickness ratio limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation sharp corners   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation sharp corners color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation sharp corners limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation maximum thickness at base   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation maximum thickness at base limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation minimum draft on outer faces   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation minimum draft on outer faces limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation minimum width at base   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation minimum width at base limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation of permissible deflection   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature validation permissible deflection limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the snap joint feature permissible strain   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation thick walls   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation thick walls color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation thick walls limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation thin walls   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation thin walls color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation thin walls limit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation undercut regions   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation undercut regions color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation vertical walls   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the moldability validation vertical walls color   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class SurfaceIdentifierBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_plastics_base (" NX Plastic Designer Base")
    ##  Label 
    def AddIdentifier(builder: SurfaceIdentifierBuilder, label: str, highlightColor: NXOpen.NXColor, faces: List[NXOpen.Face]) -> IdentifierDataBuilder:
        """
         Creates a @link PlasticDesigner::IdentifierDataBuilder PlasticDesigner::IdentifierDataBuilder@endlink  and append it to the identifier data list. 
                    If @link PlasticDesigner::IdentifierDataBuilder PlasticDesigner::IdentifierDataBuilder@endlink  with same label already exist,
                    then existing instance will be returned by setting remaining input parameters 
    ...
    ## License requirements: nx_plastics_base (" NX Plastic Designer Base")
    ##  Label 
    def DeleteIdentifier(builder: SurfaceIdentifierBuilder, label: str) -> None:
        """
         Remove and delete an identifier corresponding to input label.
        """
        pass
    ...
    ##  Label 
    def GetIdentifier(builder: SurfaceIdentifierBuilder, label: str) -> IdentifierDataBuilder:
        """
         Returns the identifier corresponding to input label. Return NULL if identifier not found
         @return databuilder (@link IdentifierDataBuilder NXOpen.PlasticDesigner.IdentifierDataBuilder@endlink):   @link PlasticDesigner::IdentifierDataBuilder PlasticDesigner::IdentifierDataBuilder@endlink  instance.
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetIdentifiers(builder: SurfaceIdentifierBuilder) -> List[IdentifierDataBuilder]:
        """
         Returns the array of identifiers
         @return identifiers (@link IdentifierDataBuilder List[NXOpen.PlasticDesigner.IdentifierDataBuilder]@endlink):  array of @link PlasticDesigner::IdentifierDataBuilder PlasticDesigner::IdentifierDataBuilder@endlink  instances.
        """
