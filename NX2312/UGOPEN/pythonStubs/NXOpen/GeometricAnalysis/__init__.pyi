...
class AnalysisManager(NXOpen.Object): 
    ...
    def CreateDeviationCheckingObject(part: AnalysisManager) -> DeviationChecking:
        """
         Creates a deviation checking object 
         @return builder (@link DeviationChecking NXOpen.GeometricAnalysis.DeviationChecking@endlink):  DeviationChecking object.
        """
    ...
    ## License requirements: None.
    def CreateExamineGeometryObject(part: AnalysisManager) -> ExamineGeometry:
        """
         Creates an examine geometry object 
         @return builder (@link ExamineGeometry NXOpen.GeometricAnalysis.ExamineGeometry@endlink):  Examine
                                                                                            Geometry object .
    ...
    ## License requirements: None.
    def CreateGeometricPropertiesObject(part: AnalysisManager) -> GeometricProperties:
        """
         Creates a geometric properties object 
         @return builder (@link GeometricProperties NXOpen.GeometricAnalysis.GeometricProperties@endlink): 
                                                                                    Geometric
    ...
    ## License requirements: None.
    def CreateSimpleInterferenceObject(part: AnalysisManager) -> SimpleInterference:
        """
         Creates a simple interference object 
         @return builder (@link SimpleInterference NXOpen.GeometricAnalysis.SimpleInterference@endlink): 
                                                                                     Simple Interference object .
    ...
    ## License requirements: None.
    def CreateSolidDensityObject(part: AnalysisManager) -> SolidDensity:
        """
         Creates a solid density object 
         @return builder (@link SolidDensity NXOpen.GeometricAnalysis.SolidDensity@endlink):  SolidDensity object.
        """
...
class AnalysisObjectCollectionEx(NXOpen.Object): 
    ...
    ##  DistanceAO 
    def CreateDistanceAnalysisBuilder(owningPart: AnalysisObjectCollectionEx, distanceAO: NXOpen.DisplayableObject) -> DistanceAnalysisBuilder:
        """
         Creates a distance analysis builder. 
         @return distanceBuilder (@link DistanceAnalysisBuilder NXOpen.GeometricAnalysis.DistanceAnalysisBuilder@endlink):  distance analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  DistanceAO 
    def CreateDistanceAnalysisBuilder1(owningPart: AnalysisObjectCollectionEx, distanceAO: NXOpen.DisplayableObject) -> DistanceAnalysisBuilder1:
        """
         Creates a distance analysis builder. 
         @return distanceBuilder (@link DistanceAnalysisBuilder1 NXOpen.GeometricAnalysis.DistanceAnalysisBuilder1@endlink):  distance analysis builder .
        """
    ...
    ##  @link NXOpen::GeometricAnalysis::PerformancePredictor NXOpen::GeometricAnalysis::PerformancePredictor@endlink  
    def CreatePerformancePredictorBuilder(owningPart: AnalysisObjectCollectionEx, perfPredictAO: PerformancePredictor) -> PerformancePredictorBuilder:
        """
         Creates a @link GeometricAnalysis::PerformancePredictorBuilder GeometricAnalysis::PerformancePredictorBuilder@endlink   
         @return perfPredictBuilder (@link PerformancePredictorBuilder NXOpen.GeometricAnalysis.PerformancePredictorBuilder@endlink):  @link NXOpen::GeometricAnalysis::PerformancePredictorBuilder NXOpen::GeometricAnalysis::PerformancePredictorBuilder@endlink  with this name. .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  RadiusAO 
    def CreateRadiusAnalysisBuilder(owningPart: AnalysisObjectCollectionEx, radiusAO: NXOpen.DisplayableObject) -> RadiusAnalysisBuilder:
        """
         Creates a radius analysis builder. 
         @return radiusBuilder (@link RadiusAnalysisBuilder NXOpen.GeometricAnalysis.RadiusAnalysisBuilder@endlink):  radius analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  RadiusAO 
    def CreateRadiusAnalysisBuilder1(owningPart: AnalysisObjectCollectionEx, radiusAO: NXOpen.DisplayableObject) -> RadiusAnalysisBuilder1:
        """
         Creates a radius analysis builder. 
         @return radiusBuilder (@link RadiusAnalysisBuilder1 NXOpen.GeometricAnalysis.RadiusAnalysisBuilder1@endlink):  radius analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  ReflectionAO 
    def CreateReflectionAnalysisBuilder(owningPart: AnalysisObjectCollectionEx, reflectionAO: NXOpen.DisplayableObject) -> ReflectionAnalysisBuilder:
        """
         Creates a reflection analysis builder. 
         @return reflectionBuilder (@link ReflectionAnalysisBuilder NXOpen.GeometricAnalysis.ReflectionAnalysisBuilder@endlink):  reflection analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  ReflectionAO 
    def CreateReflectionAnalysisBuilder1(owningPart: AnalysisObjectCollectionEx, reflectionAO: NXOpen.DisplayableObject) -> ReflectionAnalysisBuilder1:
        """
         Creates a reflection analysis builder. 
         @return reflectionBuilder (@link ReflectionAnalysisBuilder1 NXOpen.GeometricAnalysis.ReflectionAnalysisBuilder1@endlink):  reflection analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  @link NXOpen::GeometricAnalysis::SheetBoundaryAnalysis NXOpen::GeometricAnalysis::SheetBoundaryAnalysis@endlink  to be edited 
    def CreateSheetBoundaryAnalysisBuilder(owningPart: AnalysisObjectCollectionEx, sheetBoundaryAnalysisAO: SheetBoundaryAnalysis) -> SheetBoundaryAnalysisBuilder:
        """
         Creates a @link GeometricAnalysis::SheetBoundaryAnalysisBuilder GeometricAnalysis::SheetBoundaryAnalysisBuilder@endlink   
         @return sheetBoundaryBuilder (@link SheetBoundaryAnalysisBuilder NXOpen.GeometricAnalysis.SheetBoundaryAnalysisBuilder@endlink):  sheet boundary analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  SlopeAO 
    def CreateSlopeAnalysisBuilder(owningPart: AnalysisObjectCollectionEx, slopeAO: NXOpen.DisplayableObject) -> SlopeAnalysisBuilder:
        """
         Creates a slope analysis builder. 
         @return slopeBuilder (@link SlopeAnalysisBuilder NXOpen.GeometricAnalysis.SlopeAnalysisBuilder@endlink):  slope analysis builder .
        """
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  SlopeAO 
    def CreateSlopeAnalysisBuilder1(owningPart: AnalysisObjectCollectionEx, slopeAO: NXOpen.DisplayableObject) -> SlopeAnalysisBuilder1:
        """
         Creates a slope analysis builder. 
         @return slopeBuilder (@link SlopeAnalysisBuilder1 NXOpen.GeometricAnalysis.SlopeAnalysisBuilder1@endlink):  slope analysis builder .
        """
...
class AnalysisObjectCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  CCAO 
    def CreateCurveContinuityBuilder(owning_part: AnalysisObjectCollection, ccao_object: NXOpen.DisplayableObject) -> CurveContinuityBuilder:
        """
         Creates a Curve Continuity Builder 
         @return ccao_builder (@link CurveContinuityBuilder NXOpen.GeometricAnalysis.CurveContinuityBuilder@endlink):  Curve Continuity AO builder .
        """
    ...
    def CreateCurveCurvatureAnalysisBuilder(owning_part: AnalysisObjectCollection, caao_object: NXOpen.DisplayableObject) -> CurveCurvatureAnalysisBuilder:
        """
         Creates a curve curvature analysis builder 
         @return caao_builder (@link CurveCurvatureAnalysisBuilder NXOpen.GeometricAnalysis.CurveCurvatureAnalysisBuilder@endlink):  Curve Curvature Analysis builder .
        """
    ...
    ##  DDAO  
    def CreateDeviationGaugeBuilder(owning_part: AnalysisObjectCollection, ddao_object: NXOpen.DisplayableObject) -> DeviationGaugeBuilder:
        """
         Creates a  Deviation Gauge Builder 
         @return devgg_builder (@link DeviationGaugeBuilder NXOpen.GeometricAnalysis.DeviationGaugeBuilder@endlink):  DeviationGauge builder .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  DAO 
    def CreateDraftAnalysisBuilder(owning_part: AnalysisObjectCollection, dao_object: NXOpen.DisplayableObject) -> DraftAnalysisBuilder:
        """
         Creates a draft analysis builder 
         @return dao_builder (@link DraftAnalysisBuilder NXOpen.GeometricAnalysis.DraftAnalysisBuilder@endlink):  draft analysis builder .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  FCAO 
    def CreateFaceCurvatureAnalysisBuilder(owning_part: AnalysisObjectCollection, fcao_object: NXOpen.DisplayableObject) -> FaceCurvatureAnalysisBuilder:
        """
         Creates a face curvature analysis builder 
         @return fcao_builder (@link FaceCurvatureAnalysisBuilder NXOpen.GeometricAnalysis.FaceCurvatureAnalysisBuilder@endlink):  face curvature analysis builder .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Gap and Flushness  
    def CreateGapFlushnessBuilder(owning_part: AnalysisObjectCollection, gfao_object: GapFlushness) -> GapFlushnessBuilder:
        """
         Creates a gap and flushness builder 
         @return gfao_builder (@link GapFlushnessBuilder NXOpen.GeometricAnalysis.GapFlushnessBuilder@endlink):  Gap and Flushness builder .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Highlight Lines Analysis object 
    def CreateHighlightLinesAnalysisBuilder(owning_part: AnalysisObjectCollection, hpao_object: NXOpen.DisplayableObject) -> HighlightLinesAnalysisBuilder:
        """
         Creates a Highlight Lines Analysis builder 
         @return builder (@link HighlightLinesAnalysisBuilder NXOpen.GeometricAnalysis.HighlightLinesAnalysisBuilder@endlink):  Highlight Lines Analysis builder .
        """
    ...
    def CreateLocalRadiusAnalysisBuilder(part: AnalysisObjectCollection, lrao: LocalRadiusAnalysis) -> LocalRadiusAnalysisBuilder:
        """
         Creates a @link NXOpen::GeometricAnalysis::LocalRadiusAnalysisBuilder NXOpen::GeometricAnalysis::LocalRadiusAnalysisBuilder@endlink  
         @return builder (@link LocalRadiusAnalysisBuilder NXOpen.GeometricAnalysis.LocalRadiusAnalysisBuilder@endlink): .
        """
    ...
    def CreateSectionAnalysisBuilder(owning_part: AnalysisObjectCollection, msao_object: SectionAnalysisObject) -> NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisBuilder:
        """
         Creates a Section Analysis object builder 
         @return msao_builder (@link NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisBuilder NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisBuilder@endlink):  Section Analysis builder .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Section Analysis object 
    def CreateSectionAnalysisExBuilder(owning_part: AnalysisObjectCollection, csao_object: NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisExObject) -> NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisExBuilder:
        """
         Creates a Section Analysis builder of a new version
         @return csao_builder (@link NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisExBuilder NXOpen.GeometricAnalysis.SectionAnalysis.SectionAnalysisExBuilder@endlink):  Section Analysis builder .
        """
    ...
    def CreateSurfaceContinuityAnalysisBuilder(owning_part: AnalysisObjectCollection, scao_object: NXOpen.DisplayableObject) -> SurfaceContinuityAnalysisBuilder:
        """
         Creates a surface continuity analysis builder 
         @return scao_builder (@link SurfaceContinuityAnalysisBuilder NXOpen.GeometricAnalysis.SurfaceContinuityAnalysisBuilder@endlink):  Surface Continuity Analysis builder .
        """
    ...
    def CreateSurfaceIntersectionBuilder(owning_part: AnalysisObjectCollection, siao_object: NXOpen.DisplayableObject) -> SurfaceIntersectionBuilder:
        """
         Creates a surface intersection  builder 
         @return siao_builder (@link SurfaceIntersectionBuilder NXOpen.GeometricAnalysis.SurfaceIntersectionBuilder@endlink):  surface intersection builder .
        """
...
class AnalysisResultCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Analysis Result 
    def CreateContactAnalysisBuilder(owningPart: AnalysisResultCollection, persistentResult: NXOpen.Validate.AnalysisResult) -> ContactAnalysisBuilder:
        """
         Creates a contact analysis builder. 
         @return contactBuilder (@link ContactAnalysisBuilder NXOpen.GeometricAnalysis.ContactAnalysisBuilder@endlink): .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Modeling View 
    def CreateContactAnalysisSectionCurveBuilder(owningPart: AnalysisResultCollection, view: NXOpen.ModelingView, contactAnalysisBuilder: ContactAnalysisBuilder) -> ContactAnalysisSectionCurveBuilder:
        """
         Creates a contact analysis Section Curve builder. 
         @return contactAnalysisSectionCurveBuilder (@link ContactAnalysisSectionCurveBuilder NXOpen.GeometricAnalysis.ContactAnalysisSectionCurveBuilder@endlink): .
        """
...
class ContactAnalysisBuilder(NXOpen.Builder): 
    ...
    ##   the Color for Areas Not Touched by Ball of Given Ball Diameter   
    ##     
    ##  
    ...
    ##   the Color for Areas Touched by Ball of Given Ball Diameter   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Ball Diameter for Ball Contact Analysis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the body selection on which the Contact analysis and Radius Analysis will be carried out  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle to Create and label the minimum radius point from all the sharp regions    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle to create equidistant points at given step distance    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle to Display Contour Curves   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the disp resolution will decide the fineness of faceting triangles   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle that enables radius analysis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the External Ball Diameter for Fold Measurement Analysis    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Hemispherical Ball Diameter for Ram Apparatus Analysis     
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Color for Areas Where the Radius is Between Minimum Radius and Maximum Radius    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Internal Ball Diameter for Fold Measurement Analysis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the maximum radius is Threshold for smooth areas
    ...
    ##   the minimum radius is Threshold for smooth areas
    ...
    ##   the protrusion limit is Threshold for Ram Apparatus Analysis and Fold Measurement Analysis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Ram Diameter for Ram Apparatus Analysis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the color for Sharp Areas Where the Radius is Less than Minimum Radius    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle to Show only Ball touching Areas   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle that enables show only sharp areas
    ...
    ##   the Color for Smooth Areas Where the Radius is Less Than Minimum Radius   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the step distance to Create equidistant points on selected bodies   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def AddGCPoint(builder: ContactAnalysisBuilder, face: NXOpen.Face, point: NXOpen.Point) -> None:
        """
         Add geometric constraint point to checker 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def ClearGConstraintPointData(builder: ContactAnalysisBuilder) -> None:
        """
         Clear geometric constraint points from checker 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    def CreateCheckPoints(builder: ContactAnalysisBuilder) -> None:
        """
         Create Check Points 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    def CreateSectionCurves(builder: ContactAnalysisBuilder) -> ContactAnalysisSectionCurveBuilder:
        """
         Create Section Curves 
         @return sectionCurveBuilder (@link ContactAnalysisSectionCurveBuilder NXOpen.GeometricAnalysis.ContactAnalysisSectionCurveBuilder@endlink): .
        """
    ...
    ## 
    ## <param name="point"> (@link NXOpen.Point NXOpen.Point@endlink) </param>
    def DeleteGCPoint(builder: ContactAnalysisBuilder, point: NXOpen.Point) -> None:
        """
         Delete geometric constraint point from checker 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def SaveContourCurves(builder: ContactAnalysisBuilder) -> None:
        """
         Create Save Contour Curves 
        """
        pass
    ...
    ## <param name="face"> (@link NXOpen.Face NXOpen.Face@endlink) </param>
    ## <param name="point"> (@link NXOpen.Point NXOpen.Point@endlink) </param>
    def SetGCPoint(builder: ContactAnalysisBuilder, face: NXOpen.Face, point: NXOpen.Point) -> None:
        """
         Set geometric constraint point to checker 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def Update(builder: ContactAnalysisBuilder) -> None:
        """
         Update the checker 
        """
        pass
...
class ContactAnalysisSectionCurveBuilder(NXOpen.Display.DynamicSectionBuilder): 
    ...
    ##   the Ball diameter of contact Analysis  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the toggle to display section view i.  
    ##   e. slice  
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the range of circle up to which the Section curves will be trimmed   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def OrientToPlane(builder: ContactAnalysisSectionCurveBuilder) -> None:
        """
         Rotate the view to the section plane 
        """
        pass
...
class CurveAnalysisDisplay(NXOpen.Object): 
    ...
    ##  curve 
    def GetAnalysisRecord(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve) -> CurveAnalysisRecord:
        """
         Gets analysis record 
         @return record (@link CurveAnalysisRecord NXOpen.GeometricAnalysis.CurveAnalysisRecord@endlink):  curve analysis record .
        """
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def GetShowEndPoints(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve) -> bool:
        """
         Gets a flag representing end points display state of a curve
         @return show (bool):  .
        """
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def GetShowKnot(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve) -> bool:
        """
         Gets a flag representing knots display state of a b-spline curve
         @return show (bool):  .
        """
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def GetShowPole(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve) -> bool:
        """
         Gets a flag representing poles display state of a b-spline curve
         @return show (bool):  .
        """
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    @staticmethod
    def NewRecord(owning_part: CurveAnalysisDisplay) -> CurveAnalysisRecord:
        """
         Creats a curve analysis record 
         @return record (@link CurveAnalysisRecord NXOpen.GeometricAnalysis.CurveAnalysisRecord@endlink): .
        """
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def SetAnalysisRecord(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve, record: CurveAnalysisRecord) -> None:
        """
         Sets analysis record 
        """
        pass
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def SetShowEndPoints(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve, show: bool) -> None:
        """
         Sets a flag representing end points display state of a curve
        """
        pass
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def SetShowFlag(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve, choice: CurveAnalysisDisplay.ShowFlagType, on: bool) -> None:
        """
         Sets show flags 
        """
        pass
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def SetShowKnot(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve, show: bool) -> None:
        """
         Sets a flag representing knots display state of a b-spline curve
        """
        pass
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  curve 
    def SetShowPole(owning_part: CurveAnalysisDisplay, curve: NXOpen.Curve, show: bool) -> None:
        """
         Sets a flag representing poles display state of a b-spline curve 
        """
        pass
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  
    def ShowCurveEndPoints(owning_part: CurveAnalysisDisplay, curves: List[NXOpen.Curve], show: bool) -> None:
        """
         Shows or hides end points display of curves
        """
        pass
...
class CurveAnalysisRecord(NXOpen.TransientObject): 
    ...
    ##   the start parameter, range from 0 to 100   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag to limit the maximum length of the comb   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def Dispose(record: CurveAnalysisRecord) -> None:
        """
         Free resources associated with the instance. 
        """
        pass
...
class CurveContinuityBuilder(NXOpen.Builder): 
    ...
    ##   the location for dynamic label   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show out of tolerance only   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: gateway ("UG GATEWAY")
    @staticmethod
    def ResetShowDeviation(builder: CurveContinuityBuilder) -> None:
        """
         Prepare to toggle deviation label 
        """
        pass
...
class CurveCurvatureAnalysisBuilder(NXOpen.Builder): 
    ...
    ##   the comb display block options   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the selected curves and/or edges   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    def CreateDumbInflectionPoints(builder: CurveCurvatureAnalysisBuilder) -> List[NXOpen.Point]:
        """
         Create inflection points 
         @return pointArray (@link NXOpen.Point List[NXOpen.Point]@endlink): .
        """
    ...
    ## License requirements: None.
    def CreateDumbPeakPoints(builder: CurveCurvatureAnalysisBuilder) -> List[NXOpen.Point]:
        """
         Create peak points 
         @return pointArray (@link NXOpen.Point List[NXOpen.Point]@endlink): .
        """
    ...
    def GetCurveRange(builder: CurveCurvatureAnalysisBuilder, index: int) -> NXOpen.GeometricUtilities.CurveRangeBuilder:
        """
         Returns the @link NXOpen::GeometricUtilities::CurveRangeBuilder NXOpen::GeometricUtilities::CurveRangeBuilder@endlink  object at a given index from the list 
         @return combRange (@link NXOpen.GeometricUtilities.CurveRangeBuilder NXOpen.GeometricUtilities.CurveRangeBuilder@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetCurveRangeListLength(builder: CurveCurvatureAnalysisBuilder) -> int:
        """
         Get the number of @link NXOpen::GeometricUtilities::CurveRangeBuilder NXOpen::GeometricUtilities::CurveRangeBuilder@endlink  objects in the list
         @return length (int): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateWorkView(builder: CurveCurvatureAnalysisBuilder) -> None:
        """
         Update work view with a given view matrix 
        """
        pass
...
class DeviationChecking(NXOpen.Builder): 
    ...
    ##   the angle tolerance to be used for the deviation checking   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the curve  - required for the deviation checking when
    ...
    ##   the number or type of deviations to be shown for the deviation checking   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the distance tolerance to be used for the deviation checking   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the face associated with the first edge or edge  - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ...
    ##   the face associated with the second edge  - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToEdge NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToEdge@endlink .  
    ##   
    ##             
    ...
    ##   the first curve or edge - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ...
    ##   the first edge or edge  - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToEdge NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToEdge@endlink 
    ##           or
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToFace NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToFace@endlink .  
    ...
    ##   the first face - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ...
    ##   the number of check points to be shown for the deviation checking  -
    ...
    ##   the number of u check points to be shown for the deviation checking
    ##           - required when @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesFaceToFace NXOpen::GeometricAnalysis::DeviationChecking::TypesFaceToFace@endlink 
    ##             
    ##     
    ...
    ##   the number of v check points to be shown for the deviation checking
    ##           - required when @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesFaceToFace NXOpen::GeometricAnalysis::DeviationChecking::TypesFaceToFace@endlink 
    ##             
    ##     
    ...
    ##   the second curve or edge - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesCurveToCurve NXOpen::GeometricAnalysis::DeviationChecking::TypesCurveToCurve@endlink .  
    ##    
    ##             
    ...
    ##   the second edge - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToEdge NXOpen::GeometricAnalysis::DeviationChecking::TypesEdgeToEdge@endlink .  
    ##   
    ##             
    ...
    ##   the second face - required for the deviation checking when
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  is set to
    ##           @link NXOpen::GeometricAnalysis::DeviationChecking::TypesFaceToFace NXOpen::GeometricAnalysis::DeviationChecking::TypesFaceToFace@endlink 
    ...
    ## License requirements: None.
    @staticmethod
    def Check(builder: DeviationChecking) -> None:
        """
         Performs deviation checking.  Before calling this method, set
                    property @link NXOpen::GeometricAnalysis::DeviationChecking::SetType NXOpen::GeometricAnalysis::DeviationChecking::SetType@endlink  to specify the type of 
                    deviation checking, and the two objects (curve/face/edge) to be used the deviation
...
class DeviationGaugeBuilder(NXOpen.Builder): 
    ...
    ##   the number of deviation intervals   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to plot using absolute value     
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to add additional values label   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display cross_curve deviation label   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to enable floating info label   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display inner tolerance label   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display maximum value label   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display minimum value label   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display color map    
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to reverse the direction   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##    a value indicating whether to display label     
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display marker    
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to display needle plot    
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the plane for measurement direction   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   a value indicating whether to use automatic scale factor   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##    a value indicating whether to use defining points.  
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def AddDynamicPoints(builder: DeviationGaugeBuilder) -> None:
        """
         Adds dynamic points to the Deviation Gauge. 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  The face or curve which the PMI label pointed to. 
    def AddPMILabel(deviationBuilder: DeviationGaugeBuilder, snappedObject: NXOpen.NXObject) -> None:
        """
         Add a PMI label in specified position to represent the deviation value. 
        """
        pass
...
class DistanceAnalysisBuilder1(NXOpen.Builder): 
    ...
    ##   the distance analysis data range.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the distance analysis display settings.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the face to apply distance analysis.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Plane NXOpen.Plane@endlink) Plane
    ##   the reference plane for distance analysis.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def StartDistanceAnalysis(builder: DistanceAnalysisBuilder1) -> None:
        """
         Start distance analysis. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateDisplayOnPlaneChange(builder: DistanceAnalysisBuilder1) -> None:
        """
         Update display after plane changes. 
        """
        pass
...
class DistanceAnalysisBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def StartDistanceAnalysis(builder: DistanceAnalysisBuilder) -> None:
        """
         Start distance analysis. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateDisplayOnPlaneChange(builder: DistanceAnalysisBuilder) -> None:
        """
         Update display after plane changes. 
        """
        pass
...
class DraftAnalysisBuilder(NXOpen.Builder): 
    ...
    ##   the toggle to switch display mode   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the negative inside translucency   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the positive inside translucency   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the negative outside tanslucency   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the positive outside translucenty   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def AddDynamicPoints(builder: DraftAnalysisBuilder) -> None:
        """
         Adds dynamic points to the draft analysis object 
        """
        pass
    ...
    def DeleteDynamicLabels(builder: DraftAnalysisBuilder, deletedLabels: List[bool]) -> None:
        """
         Deletes dynamic labels whose corresponding positions are set to true in the array 
        """
        pass
    ...
    def DeselectFaces(builder: DraftAnalysisBuilder, faces: List[NXOpen.DisplayableObject]) -> None:
        """
         Deselects faces 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetColorInsideNegative(builder: DraftAnalysisBuilder) -> List[float]:
        """
         Returns the negative inside color 
         @return colorInsideNeg (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetColorInsidePositive(builder: DraftAnalysisBuilder) -> List[float]:
        """
         Returns the positive inside color 
         @return colorInsidePos (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetColorOutsideNegative(builder: DraftAnalysisBuilder) -> List[float]:
        """
         Returns the negative outside color 
         @return colorOutsideNeg (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetColorOutsidePositive(builder: DraftAnalysisBuilder) -> List[float]:
        """
         Returns the positive outside color 
         @return colorOutsidePos (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    def RemoveLabelParents(builder: DraftAnalysisBuilder, parents: List[NXOpen.DisplayableObject]) -> None:
        """
         Removes dynamic label parents 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def ReverseAllNormals(builder: DraftAnalysisBuilder) -> None:
        """
         Reverses all normals 
        """
        pass
    ...
    def ReverseNormal(builder: DraftAnalysisBuilder, face: NXOpen.DisplayableObject) -> None:
        """
         Reverses individual face normal 
        """
        pass
    ...
    def SetColorInsideNegative(builder: DraftAnalysisBuilder, colorInsideNeg: List[float]) -> None:
        """
         Sets the negative inside color 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetColorInsidePositive(builder: DraftAnalysisBuilder, colorInsidePos: List[float]) -> None:
        """
         Sets the positive inside color 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetColorOutsideNegative(builder: DraftAnalysisBuilder, colorOutsideNeg: List[float]) -> None:
        """
         Sets the negative outside color 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetColorOutsidePositive(builder: DraftAnalysisBuilder, colorOutsidePos: List[float]) -> None:
        """
         Sets the positive outside color 
        """
        pass
    ...
    def SetDynamicNormal(builder: DraftAnalysisBuilder, index: int, normal: NXOpen.Vector3d) -> None:
        """
         Sets dynamic normal 
        """
        pass
    ...
    def SetDynamicParent(builder: DraftAnalysisBuilder, index: int, parent: NXOpen.DisplayableObject) -> None:
        """
         Sets dynamic parent 
        """
        pass
    ...
    def SetTotalDynamicNormals(builder: DraftAnalysisBuilder, total: int) -> None:
        """
         Sets number of dynamic normals 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def UpdateReverseMap(builder: DraftAnalysisBuilder) -> None:
        """
         Updates reverse map 
        """
        pass
...
class DupinBuilder(NXOpen.TaggedObject): 
    ...
    ##   the point location defining where the analysis should be done.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the deviation in degrees from the minimum curvature.  
    ...
    ##   the tolerance that defines at the specified point if an area is flat.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the scale factor to apply to the display of the dupin indicatrix.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def ResetAnalysisPoint(builder: DupinBuilder) -> None:
        """
         Reset the analysis point to accept dynamic input. 
        """
        pass
...
class ExamineGeometry(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def ClearAllChecks(examineGeometryBuilder: ExamineGeometry) -> None:
        """
         Clear or unset all types of checks 
        """
        pass
    ...
    ## License requirements: None.
    ##  Type of Check 
    def ClearCheck(examineGeometryBuilder: ExamineGeometry, check: ExamineGeometry.Check) -> None:
        """
         Clear or unset a specified type of check 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def DisplayResultsAsInfo(examineGeometryBuilder: ExamineGeometry) -> None:
        """
         Displays the results in the information window 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def Examine(examineGeometryBuilder: ExamineGeometry) -> None:
        """
         Examines the geometry.  Before calling this method, use 
                    @link NXOpen::GeometricAnalysis::ExamineGeometry::SetCheck NXOpen::GeometricAnalysis::ExamineGeometry::SetCheck@endlink  and @link NXOpen::GeometricAnalysis::ExamineGeometry::ClearCheck NXOpen::GeometricAnalysis::ExamineGeometry::ClearCheck@endlink  
                    to specify which checks to perform and use @link NXOpen::GeometricAnalysis::ExamineGeometry::ObjectsToExamine NXOpen::GeometricAnalysis::ExamineGeometry::ObjectsToExamine@endlink  
    ...
    ## License requirements: None.
    ##  Type of Check 
    def GetFailedObjects(examineGeometryBuilder: ExamineGeometry, check: ExamineGeometry.Check) -> List[NXOpen.NXObject]:
        """
         Returns the objects that failed a given type of check.  You should 
                call @link NXOpen::GeometricAnalysis::ExamineGeometry::Examine NXOpen::GeometricAnalysis::ExamineGeometry::Examine@endlink  before calling this method.   
         @return objects (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink):  Objects that
    ...
    ## License requirements: None.
    @staticmethod
    def GetResults(examineGeometryBuilder: ExamineGeometry) -> List[int]:
        """
         Returns an array containing the number of objects that failed each check.
                      You should call @link NXOpen::GeometricAnalysis::ExamineGeometry::Examine NXOpen::GeometricAnalysis::ExamineGeometry::Examine@endlink  before calling this 
                      method.    The array contains an entry for each check in the
    ...
    ## License requirements: None.
    ##  Type of Check 
    def HighlightResult(examineGeometryBuilder: ExamineGeometry, check: ExamineGeometry.Check) -> bool:
        """
         Highlights results of a specified type of check. If the
                 highlighting fails for some of the entities, it returns True, otherwise
                 False.  Highlighting can fail when the entities are corrupt or missing
    ...
    ## License requirements: None.
    @staticmethod
    def SetAllChecks(examineGeometryBuilder: ExamineGeometry) -> None:
        """
         Set all types of checks to examine 
        """
        pass
    ...
    ## License requirements: None.
    ##  Type of Check 
    def SetCheck(examineGeometryBuilder: ExamineGeometry, check: ExamineGeometry.Check) -> None:
        """
         Set a specified type of check for examine geometry 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UnhighlightAllResults(examineGeometryBuilder: ExamineGeometry) -> None:
        """
         Unhighlight all results 
        """
        pass
    ...
    ## License requirements: None.
    ##  Type of Check 
    def UnhighlightResult(examineGeometryBuilder: ExamineGeometry, check: ExamineGeometry.Check) -> None:
        """
         Unhighlight results of a specified type of check
        """
        pass
...
class FaceAnalysisDataRangeBuilder(NXOpen.TaggedObject): 
    ...
    ##  System determined colors and intervals. 
    ...
    ##   the value indicating the range is fixed or not.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the middle value scale for data range.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the number of colors when color scale option is set to Automatic.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def ResetData(builder: FaceAnalysisDataRangeBuilder) -> None:
        """
         Resets data range. 
        """
        pass
...
class FaceAnalysisDisplayBuilder(NXOpen.TaggedObject): 
    ...
    ##   the flag indicating if facets should be shown.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class FaceAnalysisNormalsBuilder(NXOpen.TaggedObject): 
    ...
    ## License requirements: None.
    @staticmethod
    def RestoreAll(builder: FaceAnalysisNormalsBuilder) -> None:
        """
         Restores all face normals. 
        """
        pass
...
class FaceCurvatureAnalysisBuilder(NXOpen.Builder): 
    ...
    ##   the contour refinement level, in the range 0-6.  
    ...
    ##   the starting contour shift or bias value, as % of the standard contour interval.  
    ...
    ##   the section curvature plane when sectional curvature values are to be computed and displayed.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the display type for curvature values.  
    ##       
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the center point of the color mapping and contouring, as % of the full range of
    ...
    ##   the color map and contour range, as % of the full range of curvature values present in the data.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normal for the case of normal curvature type.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normal orientation when the normal curvature values are to be computed and displayed.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normal origin when normal curvature values are to be computed and displayed.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the normal vector for the case when normal curvature values are to be computed and displayed.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the number of contour lines to compute and display.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.GeometricUtilities.DisplayResolutionBuilder NXOpen.GeometricUtilities.DisplayResolutionBuilder@endlink) Resolution
    ##   the tesselation resolution to use for curvature color map and contours.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the scaling type of curvature values.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   whether to use a section plane or maninpulator for sectional curvatures.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the section orientation for sectional curvatures.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the section origin for sectional curvatures.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) SelectObject
    ##   the faces on which to perform curvature analysis.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to show zero curvature contour line.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## 
    ## <param name="faces"> (@link NXOpen.DisplayableObject List[NXOpen.DisplayableObject]@endlink) </param>
    def DeselectFaces(builder: FaceCurvatureAnalysisBuilder, faces: List[NXOpen.DisplayableObject]) -> None:
        """
         Deselects faces 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def ReverseAllNormals(builder: FaceCurvatureAnalysisBuilder) -> None:
        """
         Reverses all normals. 
        """
        pass
    ...
    ## 
    ## <param name="face"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    def ReverseIndividualNormal(builder: FaceCurvatureAnalysisBuilder, face: NXOpen.DisplayableObject) -> None:
        """
         Reverses an individual face normal. 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def UpdateReverseMap(builder: FaceCurvatureAnalysisBuilder) -> None:
        """
         Updates reverse map. 
        """
        pass
...
class GapFlushnessBuilder(NXOpen.Builder): 
    ...
    ##   the Base Panel inner contact section   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the Base Panel outer contact section    
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the cross section curve option       
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the Label Display negative tolerance       
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the Label Display positive tolerance      
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the negative tolerance for flushness        
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the negative tolerance for gap       
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the nominal value  for flushness        
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the positive tolerance for flushness    
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the positive tolerance for gap        
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the Second Panel face selection        
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the Second Panel inner contact section    
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
    ...
    ##   the Second Panel outer contact section   
    ##     
    ##  
    ## Getter License requirements: studio_analyze ("STUDIO ANALYZE")
    ## 
...
class GeometricProperties(NXOpen.Builder): 
    ...
    @staticmethod
    def GetCaeCurveProperties(geometricPropertiesBuilder: GeometricProperties, entityTag: NXOpen.NXObject, absPoint: NXOpen.Point3d) -> Tuple[GeometricProperties.Status, GeometricProperties.CaeCurve]:
        """
         Returns CAE curve local properties at the given point 
         @return A tuple consisting of (status, caeCurve). 
         - status is: @link GeometricProperties.Status NXOpen.GeometricAnalysis.GeometricProperties.Status@endlink. Return status .
    ...
    ##                                                              obtain the properties for 
    @staticmethod
    def GetCaeFaceProperties(geometricPropertiesBuilder: GeometricProperties, entityTag: NXOpen.NXObject, absPoint: NXOpen.Point3d) -> Tuple[GeometricProperties.Status, GeometricProperties.CaeFace]:
        """
         Returns CAE face local properties at the given point 
         @return A tuple consisting of (status, caeFace). 
         - status is: @link GeometricProperties.Status NXOpen.GeometricAnalysis.GeometricProperties.Status@endlink. Return status .
    ...
    ##                                                              obtain the properties for 
    @staticmethod
    def GetEdgeProperties(geometricPropertiesBuilder: GeometricProperties, entityTag: NXOpen.NXObject, absPoint: NXOpen.Point3d) -> Tuple[GeometricProperties.Status, GeometricProperties.Edge]:
        """
         Returns edge/curve local properties at the given point 
         @return A tuple consisting of (status, edge). 
         - status is: @link GeometricProperties.Status NXOpen.GeometricAnalysis.GeometricProperties.Status@endlink. Return status .
    ...
    ##                                                              obtain the properties for 
    @staticmethod
    def GetFaceProperties(geometricPropertiesBuilder: GeometricProperties, entityTag: NXOpen.NXObject, absPoint: NXOpen.Point3d) -> Tuple[GeometricProperties.Status, GeometricProperties.Face]:
        """
         Returns face local properties at the given point 
         @return A tuple consisting of (status, face). 
         - status is: @link GeometricProperties.Status NXOpen.GeometricAnalysis.GeometricProperties.Status@endlink. Return status .
    ...
    ##                                                              obtain the properties for 
    @overload
    def ListProperties(self, geometricPropertiesBuilder: GeometricProperties, entityTag: NXOpen.NXObject, absPoint: NXOpen.Point3d) -> GeometricProperties.Status:
        """
         Displays the local properties of the specified object at the
                      given point in the listing window 
         @return status (@link GeometricProperties.Status NXOpen.GeometricAnalysis.GeometricProperties.Status@endlink):  Return status .
    ...
    @overload
    def ListProperties(self, geometricPropertiesBuilder: GeometricProperties, absPoint: NXOpen.Point3d) -> GeometricProperties.Status:
        """
         Displays the local properties of
                       @link ObjectsForAnalysis ObjectsForAnalysis@endlink  at the given point in 
                       the listing window.  
    ...
    ## License requirements: None.
    @staticmethod
    def Reset(geometricPropertiesBuilder: GeometricProperties) -> None:
        """
         Clears all markers showing the local geometric properties in the graphics window 
        """
        pass
...
class HighlightLinesAnalysisBuilder(NXOpen.Builder): 
    ...
    ##   the end angle for isoclines (uniform)   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the vector to define isoclines   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the ratio of blended texels to all light texels.  
    ...
    ##   the light spacing between two adjacent lights.  
    ...
    ##   the ratio of light size to light spacing.  
    ##    It is used by reflection contours   
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the start angle for isoclines (uniform)   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def GetBrightColor(builder: HighlightLinesAnalysisBuilder) -> List[float]:
        """
         Gets the color of the bright (lit) areas of reflection contours 
         @return brightColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetDarkColor(builder: HighlightLinesAnalysisBuilder) -> List[float]:
        """
         Gets the color of the dark (unlit) areas of reflection contours 
         @return darkColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def ReinitializePlane(builder: HighlightLinesAnalysisBuilder) -> None:
        """
         Reinitialize light plane based on the selected faces. If
                more faces are selected, you may need to change
                light plane, so the light plane could be better centered. 
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetBrightColor(builder: HighlightLinesAnalysisBuilder, brightColor: List[float]) -> None:
        """
         Sets the color of the bright (lit) areas of reflection contours 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetDarkColor(builder: HighlightLinesAnalysisBuilder, darkColor: List[float]) -> None:
        """
         Sets the color of the dark (unlit) areas of reflection contours 
        """
        pass
    ...
    def SetLightPlaneOrigin(builder: HighlightLinesAnalysisBuilder, origin: NXOpen.Point3d) -> None:
        """
         Sets the origin of the light plane. 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  x-axis vector 
    def SetLightPlaneXAxis(builder: HighlightLinesAnalysisBuilder, xAxis: NXOpen.Vector3d) -> None:
        """
         Sets the x-axis of the light plane. 
        """
        pass
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    ##  y-axis vector 
    def SetLightPlaneYAxis(builder: HighlightLinesAnalysisBuilder, yAxis: NXOpen.Vector3d) -> None:
        """
         Sets the y-axis of the light plane. 
        """
        pass
...
class LocalRadiusAnalysisBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def ButtonOpenInformationWindow(builder: LocalRadiusAnalysisBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
...
class PerformancePredictor(AnalysisObject): 
    ...
    ##  Analysis will run in the foreground so that the user needs to wait during processing. 
    ...
    ##   the active study of Performance Predictor   
    ##     
    ##  
    ...
    ## License requirements: nx_perf_predictor (" Performance Predictor")
    @staticmethod
    def Activate(perfPredict: PerformancePredictor) -> None:
        """
         Activates Performance Predictor
        """
        pass
    ...
    def Analyze(perfPredict: PerformancePredictor, solveOption: PerformancePredictor.SolveOption) -> None:
        """
         Solves this @link NXOpen::GeometricAnalysis::PerformancePredictor NXOpen::GeometricAnalysis::PerformancePredictor@endlink  if the analysis is fully setup and ready to solve.
    ...
    ## License requirements: nx_perf_predictor (" Performance Predictor")
    @staticmethod
    def CloneSimulation(perfPredict: PerformancePredictor) -> PerformancePredictor:
        """
         Clones (copies) a @link NXOpen::GeometricAnalysis::PerformancePredictor NXOpen::GeometricAnalysis::PerformancePredictor@endlink  object and returns the cloned (copied) object if successful. 
         @return clonedSolution (@link PerformancePredictor NXOpen.GeometricAnalysis.PerformancePredictor@endlink): .
        """
    ...
    ## License requirements: nx_perf_predictor (" Performance Predictor")
    @staticmethod
    def Deactivate(perfPredict: PerformancePredictor) -> None:
        """
         Deactivates Performance Predictor
        """
        pass
    ...
    def FindObject(perfPredict: PerformancePredictor, journalIdentifier: str) -> NXOpen.INXObject:
        """
         Finds the @link NXOpen::DesignSimulation::Study NXOpen::DesignSimulation::Study@endlink  with the given identifier.
                    An exception will be thrown if no object can be found with given name. 
         @return study (@link NXOpen.INXObject NXOpen.INXObject@endlink):  An object matching the journal identifier. .
    ...
    ## License requirements: nx_perf_predictor (" Performance Predictor")
    @staticmethod
    def RemoveResults(perfPredict: PerformancePredictor) -> None:
        """
         Remove results from Performance Predictor
        """
        pass
...
class RadiusAnalysisBuilder1(NXOpen.Builder): 
    ...
    ## Getter for property: (@link FaceAnalysisDataRangeBuilder NXOpen.GeometricAnalysis.FaceAnalysisDataRangeBuilder@endlink) DataRange
    ##   the radius analysis data range.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link FaceAnalysisDisplayBuilder NXOpen.GeometricAnalysis.FaceAnalysisDisplayBuilder@endlink) DisplaySettings
    ##   the radius analysis display settings.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) Faces
    ##   the face to apply radius analysis.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Plane NXOpen.Plane@endlink) Plane
    ##   the reference plane used for @link NXOpen::GeometricAnalysis::RadiusAnalysisBuilder1::TypesSectional NXOpen::GeometricAnalysis::RadiusAnalysisBuilder1::TypesSectional@endlink .  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Direction NXOpen.Direction@endlink) Vector
    ##   the reference vector for @link NXOpen::GeometricAnalysis::RadiusAnalysisBuilder1::TypesNormal NXOpen::GeometricAnalysis::RadiusAnalysisBuilder1::TypesNormal@endlink .  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def StartRadiusAnalysis(builder: RadiusAnalysisBuilder1) -> None:
        """
         Start radius analysis. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateDisplayOnPlaneChange(builder: RadiusAnalysisBuilder1) -> None:
        """
         Update display after plane changes. 
        """
        pass
...
class RadiusAnalysisBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.Plane NXOpen.Plane@endlink) Plane
    ##   the reference plane used for @link NXOpen::GeometricAnalysis::RadiusAnalysisBuilder::TypesSectional NXOpen::GeometricAnalysis::RadiusAnalysisBuilder::TypesSectional@endlink .  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Direction NXOpen.Direction@endlink) Vector
    ##   the reference vector for @link NXOpen::GeometricAnalysis::RadiusAnalysisBuilder::TypesNormal NXOpen::GeometricAnalysis::RadiusAnalysisBuilder::TypesNormal@endlink .  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def StartRadiusAnalysis(builder: RadiusAnalysisBuilder) -> None:
        """
         Start radius analysis. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateDisplayOnPlaneChange(builder: RadiusAnalysisBuilder) -> None:
        """
         Update display after plane changes. 
        """
        pass
...
class ReflectionAnalysisBuilder1(NXOpen.Builder): 
    ...
    ##   the face reflectivity scale from 0 to 100.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) Faces
    ##   the face to apply reflection analysis.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the orientation to move reflection lines.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link FaceAnalysisNormalsBuilder NXOpen.GeometricAnalysis.FaceAnalysisNormalsBuilder@endlink) Normals
    ##   the reflection analysis normals.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating if facet edges should be shown.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def StartReflectionAnalysis(builder: ReflectionAnalysisBuilder1) -> None:
        """
         Start reflection analysis. 
        """
        pass
...
class ReflectionAnalysisBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def StartReflectionAnalysis(builder: ReflectionAnalysisBuilder) -> None:
        """
         Start reflection analysis. 
        """
        pass
...
class SheetBoundaryAnalysisBuilder(NXOpen.Builder): 
    ...
    ##   the option to display boundary vertices   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class SimpleInterference(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def GetInterferenceResults(simpleInterferenceBuilder: SimpleInterference) -> List[NXOpen.NXObject]:
        """
         Returns the pair(s) of interfering faces or solid(s) of interference
                      between the input bodies. nObjects will be 0 if there is no face or
                      solid interference between the input bodies. If the
    ...
    ## License requirements: None.
    @staticmethod
    def HighlightNextPair(simpleInterferenceBuilder: SimpleInterference) -> bool:
        """
         Highlights the pairs of interfering faces after a
                      @link NXOpen::GeometricAnalysis::SimpleInterference::PerformCheck NXOpen::GeometricAnalysis::SimpleInterference::PerformCheck@endlink . This method is applicable only
                      when @link NXOpen::GeometricAnalysis::SimpleInterference::SetInterferenceType NXOpen::GeometricAnalysis::SimpleInterference::SetInterferenceType@endlink  is set to
    ...
    ## License requirements: None.
    @staticmethod
    def PerformCheck(simpleInterferenceBuilder: SimpleInterference) -> SimpleInterference.Result:
        """
         Perform Interference Check. @link NXOpen::GeometricAnalysis::SimpleInterference::PerformCheck NXOpen::GeometricAnalysis::SimpleInterference::PerformCheck@endlink 
                      should be called after specifiying input bodies to be checked, i.e.,
                      @link NXOpen::GeometricAnalysis::SimpleInterference::FirstBody NXOpen::GeometricAnalysis::SimpleInterference::FirstBody@endlink 
    ...
    ## License requirements: None.
    @staticmethod
    def Reset(simpleInterferenceBuilder: SimpleInterference) -> None:
        """
         Frees up resources/results associated with
                     @link NXOpen::GeometricAnalysis::SimpleInterference NXOpen::GeometricAnalysis::SimpleInterference@endlink  object after a
                     call to @link NXOpen::GeometricAnalysis::SimpleInterference::PerformCheck NXOpen::GeometricAnalysis::SimpleInterference::PerformCheck@endlink .
...
class SlopeAnalysisBuilder1(NXOpen.Builder): 
    ...
    ## Getter for property: (@link FaceAnalysisDisplayBuilder NXOpen.GeometricAnalysis.FaceAnalysisDisplayBuilder@endlink) DisplaySettings
    ##   the slope analysis display settings.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) Faces
    ##   the face to apply slope analysis.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Direction NXOpen.Direction@endlink) Vector
    ##   the reference vector used for slope analysis.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    ##  the loction on the face to create a PMI label. 
    def CreatePMILabel(builder: SlopeAnalysisBuilder1, location: NXOpen.Point3d, face: NXOpen.DisplayableObject) -> None:
        """
         Create a PMI label. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def StartSlopeAnalysis(builder: SlopeAnalysisBuilder1) -> None:
        """
         Start slope analysis. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateDisplayOnVectorChange(builder: SlopeAnalysisBuilder1) -> None:
        """
         Update display after vector changes. 
        """
        pass
...
class SlopeAnalysisBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    ##  the loction on the face to create a PMI label. 
    def CreatePMILabel(builder: SlopeAnalysisBuilder, location: NXOpen.Point3d, face: NXOpen.DisplayableObject) -> None:
        """
         Create a PMI label. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def StartSlopeAnalysis(builder: SlopeAnalysisBuilder) -> None:
        """
         Start slope analysis. 
        """
        pass
...
class SolidDensity(NXOpen.Builder): 
    ...
    ##   the density units for @link NXOpen::GeometricAnalysis::SolidDensity NXOpen::GeometricAnalysis::SolidDensity@endlink .  
    ##    
...
class SurfaceAnalysisDisplay(NXOpen.Object): 
    ...
    ## License requirements: solid_modeling ("SOLIDS MODELING")
    ##  surface 
    def SetShowFlag(owning_part: SurfaceAnalysisDisplay, surface: NXOpen.DisplayableObject, choice: SurfaceAnalysisDisplay.ShowFlagType, on: bool) -> None:
        """
         Sets show flags 
        """
        pass
...
class SurfaceContinuityAnalysisBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (bool) ShowOutOfTolerance
    ##   the out of tolerance only flag   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## <param name="face"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    def DeselectFirstEdgeFace(feature_builder: SurfaceContinuityAnalysisBuilder, edge: NXOpen.DisplayableObject, face: NXOpen.DisplayableObject) -> None:
        """
         Deselection of first edge or face 
        """
        pass
    ...
    ## <param name="edge"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    ## <param name="face"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    def DeselectSecondEdgeFace(feature_builder: SurfaceContinuityAnalysisBuilder, edge: NXOpen.DisplayableObject, face: NXOpen.DisplayableObject) -> None:
        """
         Deselection of second edge or face 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetFace1Array(builder: SurfaceContinuityAnalysisBuilder) -> List[NXOpen.Face]:
        """
         Returns the edge1 array not used 
         @return faces (@link NXOpen.Face List[NXOpen.Face]@endlink):  .
        """
    ...
    def GetGxResult(builder: SurfaceContinuityAnalysisBuilder, continuity: int) -> bool:
        """
         Get G0, G1, G2, or G3 result 
         @return isGxGood (bool): .
        """
    ...
    ## <param name="edge"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    ## <param name="face"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    def SelectFirstEdgeFace(feature_builder: SurfaceContinuityAnalysisBuilder, edge: NXOpen.DisplayableObject, face: NXOpen.DisplayableObject) -> None:
        """
          Selection of first edge or face 
        """
        pass
    ...
    ## <param name="edge"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    ## <param name="face"> (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink) </param>
    def SelectSecondEdgeFace(feature_builder: SurfaceContinuityAnalysisBuilder, edge: NXOpen.DisplayableObject, face: NXOpen.DisplayableObject) -> None:
        """
          Selection of second edge or face 
        """
        pass
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  
    def UpdateFace(builder: SurfaceContinuityAnalysisBuilder, face: NXOpen.Face, selection_point: NXOpen.Point3d) -> None:
        """
         User selects or deselects face, update builder m_edge2, m_face2 
        """
        pass
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  the parent of Face or Edge 
    def UpdateFirstEdgeFace(builder: SurfaceContinuityAnalysisBuilder, edge_or_face: NXOpen.DisplayableObject, selection_point: NXOpen.Point3d) -> None:
        """
         The user selects or deselects first edge or face, update builder m_edge1, m_face1 
        """
        pass
    ...
    ## License requirements: gateway ("UG GATEWAY")
    ##  the parent of Face or Edge 
    def UpdateSecondEdgeFace(builder: SurfaceContinuityAnalysisBuilder, edge_or_face: NXOpen.DisplayableObject, selection_point: NXOpen.Point3d) -> None:
        """
         User selects or deselects second edge or face, update builder m_edge2, m_face2 
        """
        pass
...
class SurfaceIntersectionBuilder(NXOpen.Builder): 
    ...
    ## License requirements: studio_analyze ("STUDIO ANALYZE")
    @staticmethod
    def UpdateWorkView(builder: SurfaceIntersectionBuilder) -> None:
        """
         Update work view with a given view matrix 
        """
        pass
