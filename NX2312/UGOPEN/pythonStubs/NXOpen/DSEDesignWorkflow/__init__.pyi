...
class DesignWorkflowBuilder(NXOpen.Builder): 
    ...
    ##   the workflow part selection option type   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class PerformancePredictorWorkflowBuilder(NXOpen.Builder): 
    ...
    ##   the Performance Predictor study  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Performance Predictor study index  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
