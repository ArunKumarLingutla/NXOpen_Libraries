...
class AnalysisParamsBuilder(NXOpen.Builder): 
    ...
    ##  Use the default automatic time step option 
    ...
    ##  Stop after end-type is reached 
    ...
    ##   the end time for a transient simulation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the maximum end time for a temperature target transient simulation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the temperature target for a transient simulation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class CircuitBuilder(NXOpen.Builder): 
    ...
    ##   the cooling circuit section diameter   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cooling circuit roughness height   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cooling circuit wall friction type   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class CircuitCollection(NXOpen.TaggedObjectCollection): 
    ...
    ##  Name of the circuit being looked for. 
...
class CircuitParamsBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (str) Name
    ##   the name of the thermal parameter object   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class CircuitParamsCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_mold_cool_basic (" NX Mold Cooling Application")
    ##  Name of the cooling circuit fluid parameters set being looked for. 
...
class Circuit(NXOpen.NXObject): 
    ...
    def AssignParams(circuit: Circuit, params: CircuitParams) -> None:
        """
         Assigns thermal parameters to the circuit. The circuit actually creates an internal reference
                    to the @link MoldCooling::CircuitParams MoldCooling::CircuitParams@endlink  object and you can assign the same 
                    parameter set to more than one circuit. 
    ...
    ## License requirements: nx_mold_cool_basic (" NX Mold Cooling Application")
    @staticmethod
    def GetAssignedParams(circuit: Circuit) -> CircuitParams:
        """
         Returns the @link MoldCooling::CircuitParams MoldCooling::CircuitParams@endlink  object assigned to that cooling circuit 
         @return params (@link CircuitParams NXOpen.MoldCooling.CircuitParams@endlink): .
        """
...
class FlowCircuitBuilder(NXOpen.Builder): 
    ...
    ##   the cooling circuit channel bodies   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cooling circuit inlet faces   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cooling circuit outlet faces   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class Manager(NXOpen.Object): 
    ...
    ##  The type of thermal simulation 
    ##  Thermal Mold Cooling Analysis Context 
...
class MoldBodyBuilder(NXOpen.Builder): 
    ...
    ##   the selected material for the mold cavity   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the selected material for the mold core   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the selected material for the mold part   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class SolverOptions(NXOpen.NXObject): 
    ...
    ##   the option to keep all analysis generated files   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the number of processors to use for the parallel run   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to run the analysis in parallel   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
