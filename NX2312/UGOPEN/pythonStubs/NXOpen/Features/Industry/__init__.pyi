...
class ProjectStructureNode(NXOpen.TransientObject): 
    ...
    ##   the flag to indicate whether the node is created as the root part.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the node part name used to define the part file name.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the node specialization used to define what template is used to create the part.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    @staticmethod
    def Dispose(node: ProjectStructureNode) -> None:
        """
    ...
    @staticmethod
    def GetChildNodes(node: ProjectStructureNode) -> List[ProjectStructureNode]:
        """
         Gets the child nodes. 
         @return childNodes (@link ProjectStructureNode List[NXOpen.Features.Industry.ProjectStructureNode]@endlink):  The project structure nodes. .
        """
...
class SectionFeatureSpreadsheetBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def CacheSpreadsheetData(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def DeleteImportedSketch(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
    ...
    ## License requirements: None.
    ##  the parameter name 
    def EditParameter(builder: SectionFeatureSpreadsheetBuilder, parameterName: str, parameterValue: str) -> None:
        """
    ...
    ## License requirements: None.
    ##  the parameter name 
    def EditPrimaryParameter(builder: SectionFeatureSpreadsheetBuilder, parameterName: str, parameterValue: str) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetAvailableSectionTypes(builder: SectionFeatureSpreadsheetBuilder) -> List[str]:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetImportedSketches(builder: SectionFeatureSpreadsheetBuilder) -> List[NXOpen.Features.Feature]:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetParameterValues(builder: SectionFeatureSpreadsheetBuilder) -> List[NXOpen.Tooling.SpreadsheetDataParameter]:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetSpreadsheetData(builder: SectionFeatureSpreadsheetBuilder) -> NXOpen.Tooling.SpreadsheetData:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def ImportSketch(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def ResetBuilderData(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def RestoreSpreadsheetData(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
    ...
    def SetContextEntity(builder: SectionFeatureSpreadsheetBuilder, contextEntity: NXOpen.TaggedObject) -> None:
        """
    ...
    ## License requirements: None.
    ##  the index into the possible context attribute array we wish to set 
    def SetPossibleContextAttribute(builder: SectionFeatureSpreadsheetBuilder, possibleContextAttributeIndex: int, possibleContextAttribute: str) -> None:
        """
    ...
    ## License requirements: None.
    ##  the number of possible context attributes (use this before setting each possible context attribute via SetPossibleContextAttribute)  
    def SetPossibleContextAttributeCount(builder: SectionFeatureSpreadsheetBuilder, possibleContextAttributeCount: int) -> None:
        """
    ...
    def SetRuleInputs(builder: SectionFeatureSpreadsheetBuilder, inputNames: List[str], inputValues: List[str]) -> None:
        """
    ...
    def SetSectionSubType1(builder: SectionFeatureSpreadsheetBuilder, strSectionType: str) -> None:
        """
        Sets the section sub type by string value.
        """
        pass
    ...
    ## 
    ## <param name="strSectionType"> (str) </param>
    def SetSectionSubType2(builder: SectionFeatureSpreadsheetBuilder, strSectionType: str) -> None:
        """
         Sets the section sub type2 by string value.
        """
        pass
    ...
    ## <param name="strSectionType"> (str) </param>
    @overload
    def SetSectionType(self, builder: SectionFeatureSpreadsheetBuilder, strSectionType: str) -> None:
        """
    ...
    def SetSpreadsheetData(builder: SectionFeatureSpreadsheetBuilder, pKRUData: NXOpen.Tooling.SpreadsheetData) -> None:
        """
    ...
    def SetSpreadsheetDataStatus(builder: SectionFeatureSpreadsheetBuilder, paramNames: List[str], paramStatus: List[int]) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def SetsDefaultTypesFromContext(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
         Set default section types of the builder when a new context entity is set.
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def UpdateParametersUsingRules(builder: SectionFeatureSpreadsheetBuilder) -> None:
        """
    ...
    def UpdateSpreadsheetData(builder: SectionFeatureSpreadsheetBuilder, paramNames: List[str], paramValues: List[str]) -> None:
        """
...
class SelectProjectLoadFromBuilder(NXOpen.TaggedObject): 
    ...
    ##  load settings from customer default 
    ...
    ##   the user defined xml file Path   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
