...
class AddPMIOccNoteBuilder(NXOpen.Builder): 
    ...
    @staticmethod
    def AddButton(builder: AddPMIOccNoteBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    @staticmethod
    def GetNoteTextFromListBox(builder: AddPMIOccNoteBuilder) -> List[str]:
        """
         Returns the note text 
         @return noteText (List[str]): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetNoteTextFromListBox(builder: AddPMIOccNoteBuilder, noteText: List[str]) -> None:
        """
         Sets the note text 
        """
        pass
...
class AddWorkareaBuilder(NXOpen.Builder): 
    ...
    def GetAllowChildTypeForParent(builder: AddWorkareaBuilder, internalName: str) -> List[str]:
        """
         Returns workareaTypes allow children type 
         @return childrenType (List[str]):  This specifies allow workarea type.
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetDefaultName(builder: AddWorkareaBuilder) -> str:
        """
         Returns unique workarea name for creation 
         @return workareaDefaultName (str): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetWorkAreaTypeByParsingPaxFile(builder: AddWorkareaBuilder) -> List[str]:
        """
         Returns workareaTypes from pax file 
         @return workAreaType (List[str]): .
        """
...
class AlignComponentsBuilder(NXOpen.Builder): 
    ...
    ##   the component origin direction   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class AllowWorkareaTypesBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def AddButton(builder: AllowWorkareaTypesBuilder) -> None:
        """
         This button is for adding entry from preference xml file 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def DeleteButton(builder: AllowWorkareaTypesBuilder) -> None:
        """
         This button is for deleting entry from preference xml file 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def EditButton(builder: AllowWorkareaTypesBuilder) -> None:
        """
         This button is for editing entry from preference xml file 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def RestoreButton(builder: AllowWorkareaTypesBuilder) -> None:
        """
         This button is to restore data from preference xml file 
        """
        pass
...
class ColumnFeatureBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ##   the base depth of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base diameter of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base height of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base lower diameter of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base cross section type of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base upper diameter of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the user define cross section for base of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base width of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column depth of column feature    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column diameter of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column height of column feature    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column origin point is returns where colums is created  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column style of column feature    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column thickness of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the user defined cross section of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column width  of column feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class ColumnGridEquipmentBuilder(NXOpen.Builder): 
    ...
    ##   the value of bubble diameter in column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the value of bubble extension of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the bubble extension offset value of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the bubbles unallowed characters in column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base cross section of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base depth of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base diameter of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base height of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##  the column base lower diameter of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base type of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base upper diameter of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column base width of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column cross section of columns of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) ColumnDepth
    ##   the column depth of column grid    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) ColumnDiameter
    ##  the column diameter of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status of column display ids in column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column elevation of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) ColumnHeight
    ##   the column height of columns of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status of 90 degree column rotation for column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) ColumnThickness
    ##   the column thickness of coulmn grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the column type of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the number of column of columns in column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) ColumnWidth
    ##   the column width of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status to create bottom bubbles of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status to create left bubbles of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status to create right bubbles of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status to create top bubbles in column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the define global size toggle of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the display grid status of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the number of rows of columns in column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the value of row spacing between columns  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the selected grid area of column grid  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status for using column row spacing of column grid   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ModifyColumnsButton(builder: ColumnGridEquipmentBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
...
class ConnectionCreatorBuilder(NXOpen.Builder): 
    ...
    ##   the connection expression RHS string   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the source connector used in connection  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the target connector used in connection   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class ConveyorStationFeatureBuilder(NXOpen.Builder): 
    ...
    def SetSECNode(builder: ConveyorStationFeatureBuilder, secNode: DBConveyorNode) -> None:
        """
...
class CoverFeatureBuilder(NXOpen.Builder): 
    ...
    ##   the cover offset is return, if cover is present over hole   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class CreateFenceBuilder(NXOpen.Builder): 
    ...
    ##   the curve section builder is return   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class CreateSystemBuilder(NXOpen.Builder): 
    ...
    ##   an API that gets arch part path   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API that gets line part path   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def InitPreview(builder: CreateSystemBuilder) -> None:
        """
         An API that preview the system 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def Update(builder: CreateSystemBuilder) -> None:
        """
         An API that updates system 
        """
        pass
...
class DBStairwayEquipmentNode(DBSmartComplexEquipmentNode): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def AddLeftRailing(part: DBStairwayEquipmentNode) -> None:
        """
         An API to add left railing to stairway 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def AddRightRailing(part: DBStairwayEquipmentNode) -> None:
        """
         An API to add right railing to stairway 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def RemoveBothRailing(part: DBStairwayEquipmentNode) -> None:
        """
         An API to remove both railings to stairway 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def RemoveLeftRailing(part: DBStairwayEquipmentNode) -> None:
        """
         An API to remove left railing to stairway 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def RemoveRightRailing(part: DBStairwayEquipmentNode) -> None:
        """
         An API to remove right railing to stairway 
        """
        pass
...
class DefineRobotBuilder(NXOpen.Builder): 
    ...
    ##   the base frame compitable type name   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base frame direction of connector   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base frame parallel to object direction   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the base frame reverse propagation   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the tool frame direction of connector   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the tool frame parallel to object direction   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetBaseFrameCompatibleTypeList(builder: DefineRobotBuilder) -> List[str]:
        """
          The base frame compatible connector types are returns 
         @return baseFrameCompatibleTypeList (List[str]): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetBaseFramePropagatedExpression(builder: DefineRobotBuilder) -> List[NXOpen.Expression]:
        """
         The base frame connector propagated expressions 
         @return baseFramePropagatedExpression (@link NXOpen.Expression List[NXOpen.Expression]@endlink): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetToolFramePropagatedExpression(builder: DefineRobotBuilder) -> List[NXOpen.Expression]:
        """
         The tool frame connector propagated expressions 
         @return toolFramePropagatedExpression (@link NXOpen.Expression List[NXOpen.Expression]@endlink): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetBaseFrameCompatibleTypeList(builder: DefineRobotBuilder, baseFrameCompatibleTypeList: List[str]) -> None:
        """
         The base connector compatible types are set 
        """
        pass
    ...
    def SetBaseFramePropagatedExpression(builder: DefineRobotBuilder, baseFramePropagatedExpression: List[NXOpen.Expression]) -> None:
        """
        The base frame connector propagated expressions are set 
        """
        pass
    ...
    def SetNthBaseFramePropagatedExpression(builder: DefineRobotBuilder, nthBaseFramePropagatedExpression: int, baseFramePropagatedExpression: NXOpen.Expression) -> None:
        """
         The Nth expressions from base frame connector propagated expressions are set
        """
        pass
    ...
    def SetNthToolFramePropagatedExpression(builder: DefineRobotBuilder, nthToolFramePropagatedExpression: int, toolFramePropagatedExpression: NXOpen.Expression) -> None:
        """
         The Nth expressions from tool frame connector propagated expressions are set
        """
        pass
    ...
    def SetToolFramePropagatedExpression(builder: DefineRobotBuilder, toolFramePropagatedExpression: List[NXOpen.Expression]) -> None:
        """
        The tool frame connector propagated expressions are set 
        """
        pass
...
class DefineToolBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetBaseFrameCompatibleTypeList(builder: DefineToolBuilder) -> List[str]:
        """
          The base frame compatible connector types are returns 
         @return baseFrameCompatibleTypeList (List[str]): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetBaseFramePropagatedExpression(builder: DefineToolBuilder) -> List[NXOpen.Expression]:
        """
         The base frame connector propagated expressions 
         @return baseFramePropagatedExpression (@link NXOpen.Expression List[NXOpen.Expression]@endlink): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def RemoveButton(builder: DefineToolBuilder) -> None:
        """
         To remove objects
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetBaseFrameCompatibleTypeList(builder: DefineToolBuilder, baseFrameCompatibleTypeList: List[str]) -> None:
        """
         The base connector compatible types are set 
        """
        pass
    ...
    ## 
    ## <param name="baseFramePropagatedExpression"> (@link NXOpen.Expression List[NXOpen.Expression]@endlink) </param>
    def SetBaseFramePropagatedExpression(builder: DefineToolBuilder, baseFramePropagatedExpression: List[NXOpen.Expression]) -> None:
        """
        The base frame connector propagated expressions are set 
        """
        pass
    ...
    ## <param name="nthBaseFramePropagatedExpression"> (int) </param>
    ## <param name="baseFramePropagatedExpression"> (@link NXOpen.Expression NXOpen.Expression@endlink) </param>
    def SetNthBaseFramePropagatedExpression(builder: DefineToolBuilder, nthBaseFramePropagatedExpression: int, baseFramePropagatedExpression: NXOpen.Expression) -> None:
        """
         The Nth expressions from base frame connector propagated expressions are set
        """
        pass
...
class DisconnectConnectionBuilder(NXOpen.Builder): 
    ...
    def Disconnect(builder: DisconnectConnectionBuilder, selectedComponent: NXOpen.TaggedObject, componentToDisconnect: List[NXOpen.TaggedObject]) -> None:
        """
         This method is to disconnect selected components with current component 
        """
        pass
...
class EnhancedShadowOutLineBuilder(NXOpen.Builder): 
    ...
    ##   the layer setting for elbows to be placed   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class ExportToDWGBuilder(NXOpen.Builder): 
    ...
    ##  the monochrome display is return  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class FactoryCadGeoEquipmentAssemblyBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ReadFcadDatasetFiles(builder: FactoryCadGeoEquipmentAssemblyBuilder) -> None:
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ReadFcadFiles(builder: FactoryCadGeoEquipmentAssemblyBuilder) -> None:
        """
        Read the FactoryCAD files from folder for native mode
        """
        pass
    ...
    def SetStringToObjectMap(builder: FactoryCadGeoEquipmentAssemblyBuilder, key: str, tagObject: NXOpen.TaggedObject) -> None:
        """
    ...
    def UpdateData(builder: FactoryCadGeoEquipmentAssemblyBuilder, updatedControlDatas: List[FactoryCadGeoEquipmentAssemblyBuilder.UpdatedControlData]) -> None:
        """
...
class FloorEquipmentBuilder(NXOpen.Builder): 
    ...
    ##   the outline used for creation of floor is return   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class GateFeatureBuilder(NXOpen.Builder): 
    ...
    ##   the elevation used for creation of gate   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class HoleFeatureBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ##   the presence of cover over hole is checked  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Section NXOpen.Section@endlink) SelectOutline
    ##   the selected outline for creation of hole   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class ImportFactoryCadGeoBuilder(NXOpen.Builder): 
    ...
    ##   the path of dlg file which user wants to import in NX   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the path of geo file which user wants to import in NX   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   an in edit mode when dialog is opening before inserting object   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the path of parameter set file which user wants to import in NX   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    def LoadFactoryCadGeoBuilderToData(builder: ImportFactoryCadGeoBuilder, factoryCadGeoPartTag: NXOpen.Part) -> None:
        """
...
class InsertSheetBuilder(NXOpen.Builder): 
    ...
    ##  Represents the Millimeters type 
    class APIUnits(Enum):
        """
...
class JigOnPlaneBuilder(NXOpen.TaggedObject): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetJigPlaneParams(builder: JigOnPlaneBuilder) -> Tuple[NXOpen.Matrix3x3, NXOpen.Vector3d]:
        """
         Selected jig plane matrix 
         @return A tuple consisting of (rotation, origin). 
         - rotation is: @link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink.
...
class LineDesignerApplicationBuilder(NXOpen.NXObject): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def Enter(builder: LineDesignerApplicationBuilder) -> None:
        """
         To enter lineDesigner application 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def Exit(builder: LineDesignerApplicationBuilder) -> None:
        """
         To exit LineDesigner application this call will destroy the builder
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetGlobalSelectionBuilder(builder: LineDesignerApplicationBuilder) -> GlobalSelectionBuilder:
        """
         To get the global selection builder
         @return selectionBuilder (@link GlobalSelectionBuilder NXOpen.LineDesigner.GlobalSelectionBuilder@endlink): .
        """
...
class LineDesignerManager(NXOpen.Object): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::ColumnFeature LineDesigner::ColumnFeature@endlink  to be edited 
    @overload
    def CreateColumnFeatureBuilder(self, part: NXOpen.Part, column_feature: ColumnFeature) -> ColumnFeatureBuilder:
        """
         Create column feature builder 
         @return builder (@link ColumnFeatureBuilder NXOpen.LineDesigner.ColumnFeatureBuilder@endlink):  .
        """
    ...
    @overload
    def CreateColumnFeatureBuilder(self, part: NXOpen.Part, node: DBNode) -> ColumnFeatureBuilder:
        """
        Create column feature builder inside a node or using node 
         @return builder (@link ColumnFeatureBuilder NXOpen.LineDesigner.ColumnFeatureBuilder@endlink):  .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::ConveyorStationFeature LineDesigner::ConveyorStationFeature@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::CoverFeature LineDesigner::CoverFeature@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::CreateFactoryElement LineDesigner::CreateFactoryElement@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::CreateFence LineDesigner::CreateFence@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::CreateSystem LineDesigner::CreateSystem@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::ExportPlantToDWG LineDesigner::ExportPlantToDWG@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::ExportToDWG LineDesigner::ExportToDWG@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::GateFeature LineDesigner::GateFeature@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::HoleFeature LineDesigner::HoleFeature@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::InsertSheet LineDesigner::InsertSheet@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::RailOpeningFeature LineDesigner::RailOpeningFeature@endlink  to be edited 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::RailingFeature LineDesigner::RailingFeature@endlink  to be edited 
    @overload
    def CreateRailingFeatureBuilder(self, part: NXOpen.Part, railing_feature: RailingFeature) -> RailingFeatureBuilder:
        """
         Create railing feature builder 
         @return builder (@link RailingFeatureBuilder NXOpen.LineDesigner.RailingFeatureBuilder@endlink):  .
        """
    ...
    ## <param name="node"> (@link DBNode NXOpen.LineDesigner.DBNode@endlink) </param>
    @overload
    def CreateRailingFeatureBuilder(self, part: NXOpen.Part, node: DBNode) -> RailingFeatureBuilder:
        """
         Create railing feature builder 
         @return builder (@link RailingFeatureBuilder NXOpen.LineDesigner.RailingFeatureBuilder@endlink):  .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  @link LineDesigner::TypedConnectorFeature LineDesigner::TypedConnectorFeature@endlink  to be edited 
...
class LineDesignerUserCallBackManager(NXOpen.Object): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##   event Id to find the function to be invoke 
...
class ListOfConnectorsBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def AddNewType(builder: ListOfConnectorsBuilder) -> None:
        """
         Add a new Connector type 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def RestoreDefault(builder: ListOfConnectorsBuilder) -> None:
        """
         Restore to defaults 
        """
        pass
...
class ModifyConnectedSystemBuilder(NXOpen.Builder): 
    ...
    def CollectExpressionValues(builder: ModifyConnectedSystemBuilder, expressionTitle: str) -> List[str]:
        """
         Get the Expression Value
         @return exp (List[str]): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def CollectSharedExpression(builder: ModifyConnectedSystemBuilder) -> int:
        """
         Collect shared Expression
         @return numExpresssion (int): .
        """
    ...
    def GetExpressionTitle(builder: ModifyConnectedSystemBuilder, expression: NXOpen.Expression) -> str:
        """
         Get the Expression Title
         @return expTitle (str): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetExpressionsArray(builder: ModifyConnectedSystemBuilder) -> List[NXOpen.Expression]:
        """
         Get the expressions in the attribute
         @return expressions (@link NXOpen.Expression List[NXOpen.Expression]@endlink): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetSelectedComponent(builder: ModifyConnectedSystemBuilder) -> NXOpen.NXObject:
        """
         Set selected component  
         @return selectedCompTag (@link NXOpen.NXObject NXOpen.NXObject@endlink):  .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetToolTipMessage(builder: ModifyConnectedSystemBuilder) -> str:
        """
         Get tooltipMessage component  
         @return toolTipMessage (str):  .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetExpressionValue(builder: ModifyConnectedSystemBuilder, name: str, value: float) -> None:
        """
         Set Expression Value  
        """
        pass
    ...
    def SetExpressionsArray(builder: ModifyConnectedSystemBuilder, expressionValues: List[NXOpen.Expression]) -> None:
        """
         Set the expressions in the attribute 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetSelectedComponent(builder: ModifyConnectedSystemBuilder, selectedCompTag: NXOpen.NXObject) -> None:
        """
         Set selected component  
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetToolTipMessage(builder: ModifyConnectedSystemBuilder, toolTipMessage: str) -> None:
        """
         Set tooltipMessage component  
        """
        pass
...
class MountBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def FlipButton(builder: MountBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
...
class PickRectanglePointsBuilder(NXOpen.TaggedObject): 
    ...
    ##   the points of selection are return   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ResetData(builder: PickRectanglePointsBuilder) -> None:
        """
         To reset rectangle data 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ResetWidthHeight(builder: PickRectanglePointsBuilder) -> None:
        """
         To reset rectangle width and height 
        """
        pass
    ...
    def SetWidthHeight(builder: PickRectanglePointsBuilder, width: float, height: float) -> None:
        """
         To set rectangle width and height 
        """
        pass
    ...
    def UpdateRecAngle(builder: PickRectanglePointsBuilder, angle: float) -> None:
        """
         To update rectangle angle 
        """
        pass
    ...
    ## 
    ## <param name="height"> (float) </param>
    def UpdateRecHeight(builder: PickRectanglePointsBuilder, height: float) -> None:
        """
         To update rectangle height 
        """
        pass
    ...
    ## 
    ## <param name="width"> (float) </param>
    def UpdateRecWidth(builder: PickRectanglePointsBuilder, width: float) -> None:
        """
         To update rectangle width 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def UpdateRectangle(builder: PickRectanglePointsBuilder) -> None:
        """
         To update rectangle points
        """
        pass
...
class PlantProductionUnitCreatorBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def AssignId(builder: PlantProductionUnitCreatorBuilder) -> None:
        """
         The assign ID  of production unit
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetProductionUnitDescription(builder: PlantProductionUnitCreatorBuilder) -> List[str]:
        """
         The production unit description
         @return productionUnitDescription (List[str]): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetProductionUnitDescription(builder: PlantProductionUnitCreatorBuilder, productionUnitDescription: List[str]) -> None:
        """
         The production unit description is set 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetProductionUnitParent(builder: PlantProductionUnitCreatorBuilder, parent: NXOpen.NXObject) -> None:
        """
         The production unit parent is set
        """
        pass
...
class PlanViewManager(NXOpen.TaggedObject): 
    ...
    def SetTwoDPlanningView(manager: PlanViewManager, setView: bool) -> None:
        """
          To set/unset 2D planning view 
        """
        pass
...
class PlatformEquipmentBuilder(NXOpen.Builder): 
    ...
    ##   the railing toggle to check railing is prsent for platform or not  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the Centerlinejig on plane builder   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck ceiling height for centerline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck ceiling height for polyline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck elevation for centerline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck elevation for polyline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck height for centerline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##  the deck height for polyline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck length for centerline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck support type for platform  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck thickness for centerline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck thickness for polyline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the deck width for centerline platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the distance of platform from centerline   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the polyline section for platform   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the platform ceiling height updation status   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the platform elevation updation status   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the platform height updation status   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the platform supportDefaultFromCeilingToggle updation status   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the platform supportOption updation status   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the platform thickness updation status   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the option to check , if supports are from ceiling   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def SupportCrossSectionButton(builder: PlatformEquipmentBuilder) -> None:
        """
...
class ProductionUnitCreatorBuilder(NXOpen.Builder): 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def AssignId(builder: ProductionUnitCreatorBuilder) -> None:
        """
         The assign ID  of production unit
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetProductionUnitDescription(builder: ProductionUnitCreatorBuilder) -> List[str]:
        """
         The production unit description
         @return productionUnitDescription (List[str]): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetProductionUnitDescription(builder: ProductionUnitCreatorBuilder, productionUnitDescription: List[str]) -> None:
        """
         The production unit description is set 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ##  
    def SetProductionUnitParent(builder: ProductionUnitCreatorBuilder, parent: NXOpen.Assemblies.Partition) -> None:
        """
         The production unit parent is set
        """
        pass
...
class RailingFeatureBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ##   an API to get spacing type enum   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## Getter for property: (bool) IsSketchInternal
    ##   an API to check if sketch is internal    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API to get bottom elevation   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post cross dimension of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post cross length  of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post cross thickness  of railing feature    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post cross width  of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post height of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post spacing  of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API to get railing cross diamension   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the railing cross length of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the railing cross width  of railing feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API to get on path dimension span by   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the post offset  of railing feature    
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the selected curves are return   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the selection post cross section   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class RailOpeningFeatureBuilder(NXOpen.Builder): 
    ...
    ##   the opening add gate is return  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the reverse direction of rail opening   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the selected point of rail opening feature   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def GetDirVector(builder: RailOpeningFeatureBuilder) -> NXOpen.Direction:
        """
         Direction of rail opening 
         @return dirVector (@link NXOpen.Direction NXOpen.Direction@endlink): .
        """
    ...
    def SetDirVector(builder: RailOpeningFeatureBuilder, dirVector: NXOpen.Direction) -> None:
        """
    ...
    def SetRailingFeature(builder: RailOpeningFeatureBuilder, railingFrec: NXOpen.Features.Feature) -> None:
        """
...
class RenameDialogeBuilder(NXOpen.Builder): 
    ...
    ##   the item or occurence selection   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class ReuseLibraryDragData(NXOpen.NXObject): 
    ...
    ##   the category name of Drag Data   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API to check if drag data has csys import   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API to check if drag data has sketch to import   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the library name of  Reuse Library Drag data  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the part type of Reuse Library Drag data   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the path in library of drag data  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   an API to check if spare dialog for drag and drop is allowed   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class ReuseLibraryUtilityBuilder(NXOpen.TaggedObject): 
    ...
    ##   the normal drop or cloning Drop   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    def CloneForFCADDataSet(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject, bRenameAssembly: bool) -> None:
        """
          To allows cloning of data set attched to FCAD object 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    def CreateDragData(reuseLibraryUtility: ReuseLibraryUtilityBuilder) -> ReuseLibraryDragData:
        """
         To create drag data 
         @return dragData (@link ReuseLibraryDragData NXOpen.LineDesigner.ReuseLibraryDragData@endlink): .
        """
    ...
    def DropFCADPartInNative(reuseLibraryUtility: ReuseLibraryUtilityBuilder, reuseLibraryDragData: ReuseLibraryDragData, dropPoint: NXOpen.Vector3d) -> NXOpen.NXObject:
        """
          To handle dropping of LD smart part 
         @return droppedPart (@link NXOpen.NXObject NXOpen.NXObject@endlink): .
        """
    ...
    def DropKnowledgeEnabledPart(reuseLibraryUtility: ReuseLibraryUtilityBuilder, reuseLibraryDragData: ReuseLibraryDragData, dropPoint: NXOpen.Vector3d, isSkipAddReusableCompUI: bool) -> NXOpen.NXObject:
        """
          To handle dropping of knowledge enabled part KRU_KE_PART 
         @return droppedPart (@link NXOpen.NXObject NXOpen.NXObject@endlink): .
        """
    ...
    ## <param name="reuseLibraryDragData"> (@link ReuseLibraryDragData NXOpen.LineDesigner.ReuseLibraryDragData@endlink) </param>
    ## <param name="dropPoint"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink) </param>
    def DropLDSmartPart(reuseLibraryUtility: ReuseLibraryUtilityBuilder, reuseLibraryDragData: ReuseLibraryDragData, dropPoint: NXOpen.Vector3d) -> NXOpen.NXObject:
        """
          To handle dropping of LD smart part 
         @return droppedPart (@link NXOpen.NXObject NXOpen.NXObject@endlink): .
        """
    ...
    ## <param name="reuseLibraryDragData"> (@link ReuseLibraryDragData NXOpen.LineDesigner.ReuseLibraryDragData@endlink) </param>
    ## <param name="dropPoint"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink) </param>
    def DropNormalPart(reuseLibraryUtility: ReuseLibraryUtilityBuilder, reuseLibraryDragData: ReuseLibraryDragData, dropPoint: NXOpen.Vector3d) -> NXOpen.NXObject:
        """
          To handle dropping of normal part 
         @return droppedPart (@link NXOpen.NXObject NXOpen.NXObject@endlink): .
        """
    ...
    ## <param name="reuseLibraryDragData"> (@link ReuseLibraryDragData NXOpen.LineDesigner.ReuseLibraryDragData@endlink) </param>
    ## <param name="dropPoint"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink) </param>
    def DropOtherPart(reuseLibraryUtility: ReuseLibraryUtilityBuilder, reuseLibraryDragData: ReuseLibraryDragData, dropPoint: NXOpen.Vector3d) -> None:
        """
          To handle dropping of other part 
        """
        pass
    ...
    ## <param name="reuseLibraryDragData"> (@link ReuseLibraryDragData NXOpen.LineDesigner.ReuseLibraryDragData@endlink) </param>
    ## <param name="dropPoint"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink) </param>
    def DropPTSPart(reuseLibraryUtility: ReuseLibraryUtilityBuilder, reuseLibraryDragData: ReuseLibraryDragData, dropPoint: NXOpen.Vector3d) -> NXOpen.NXObject:
        """
         To handle dropping of PTS part 
         @return droppedPart (@link NXOpen.NXObject NXOpen.NXObject@endlink): .
        """
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ExecuteRenameAssembly(reuseLibraryUtility: ReuseLibraryUtilityBuilder) -> None:
        """
          To executes the renaming of the cloned component when it is added under an assembly 
        """
        pass
    ...
    ## 
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def GetDLGFile(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject) -> str:
        """
         Get dialog file name for object getting inserting  
         @return dlgFilePath (str): .
        """
    ...
    ## 
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def GetGEOFile(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject) -> str:
        """
         Get Geo file name for object getting inserting  
         @return geoFileName (str): .
        """
    ...
    ## 
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def GetParameterSetFile(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject) -> str:
        """
         Get Parameter file name for object getting inserting  
         @return parameterSetFilePath (str): .
        """
    ...
    def KeepSourceLibraryID(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject, keepSourcePath: bool) -> None:
        """
          To keep source library item ID 
        """
        pass
    ...
    ## 
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def LoadFCADGeoFile(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject) -> None:
        """
          To load data set attched to FCAD object 
        """
        pass
    ...
    def MountToolOnRobot(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject, connectorFaceTag: NXOpen.TaggedObject) -> None:
        """
          To mount tool from library on robot 
        """
        pass
    ...
    def MoveComponentToLocation(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject, position: NXOpen.Vector3d) -> None:
        """
         Move component to the location 
        """
        pass
    ...
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    ## <param name="connectorFaceTag"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink) </param>
    def PlacementByConnector(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject, connectorFaceTag: NXOpen.TaggedObject) -> None:
        """
          To place part from library using connector 
        """
        pass
    ...
    ## 
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def PopulateMDOInfo(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject) -> None:
        """
          To populate MDO information 
        """
        pass
    ...
    ## 
    ## <param name="part"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def UpdateClonedPartTag(reuseLibraryUtility: ReuseLibraryUtilityBuilder, part: NXOpen.NXObject) -> None:
        """
          To update cloned part 
        """
        pass
...
class RotateComponentBuilder(NXOpen.Builder): 
    ...
    ##   the angular dimension for rotate component   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class SelectionToolBuilder(NXOpen.Builder): 
    ...
    ##   the selected ref set name string   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def CalculateSelection(builder: SelectionToolBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def InvertSelection(builder: SelectionToolBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ShowAll(builder: SelectionToolBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def ShowOnly(builder: SelectionToolBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
...
class SingleElementConveyorBuilder(NXOpen.Builder): 
    ...
    ##   the first conveying surface corner of conveyor  
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the moving direction of conveyor   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the point on surface of conveyor are return   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the option to check whether conveyor is reversible   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the second conveying surface corner of conveyor   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class StairwayEquipmentBuilder(NXOpen.Builder): 
    ...
    ##   the vertical distance between two steps   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the start elevation of stairway   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
...
class TypedConnectorFeatureBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ##   the connector compatible type name   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the connector parallel to object direction   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status of if reverse propagation is on   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ##   the status of behavior on mismatch property   
    ##     
    ##  
    ## Getter License requirements: ld_line_designer ("FULL LINE DESIGNER")
    ## 
    ...
    ## License requirements: ld_line_designer ("FULL LINE DESIGNER")
    @staticmethod
    def SelectPropagatedExpressions(builder: TypedConnectorFeatureBuilder) -> None:
        """
         The propagated expressions is set during creation of connector 
        """
        pass
...
class UnmountBuilder(NXOpen.Builder): 
    ...
    def SetSelectedUnmountEntity(builder: UnmountBuilder, selectedUnmountEntityTag: NXOpen.TaggedObject) -> None:
        """
         The set selected unmount entity
        """
        pass
