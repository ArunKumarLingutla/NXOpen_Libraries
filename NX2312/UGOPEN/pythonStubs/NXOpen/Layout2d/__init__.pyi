...
class AssemblyCreationSettingsBuilder(NXOpen.TaggedObject): 
    ...
    ##    the settings todetermines whether or not automatically start modeling application  
    ##     
    ##  
    ...
    ##   the settings to determines whether or not transfer 2d component annotation  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the settings to determines whether or not transfer top level sketch annotation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    @staticmethod
    def InheritSettingsFromCustomerDefault(builder: AssemblyCreationSettingsBuilder) -> None:
        """
         Inherit Settings From Customer Default 
        """
        pass
    ...
    ## License requirements: drafting ("DRAFTING")
    @staticmethod
    def InheritSettingsFromPreferences(builder: AssemblyCreationSettingsBuilder) -> None:
        """
         Inherit Settings From Preference 
        """
        pass
...
class AssemblyFromLayout2dBuilder(NXOpen.Builder): 
    ...
    ##   the destination part for the Layout assembly   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the select Layout object to create assembly   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the settings of the assembly creation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class AssemblyRelation(NXOpen.NXObject): 
    ...
    ##   a flag indicating associativity state   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   a flag indicating whether the prototype content will be syncronized   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   a flag indicating whether the prototype structure will be syncronized   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    @staticmethod
    def GetPrototypeInferred(relation: AssemblyRelation) -> bool:
        """
         Returns the flag indicating whether the prototype is inferred from 2D component 
         @return inferred (bool): .
        """
...
class AssociativeAssemblyBuilder(NXOpen.Builder): 
    ...
    @staticmethod
    def GetAssemblyRelations(builder: AssociativeAssemblyBuilder) -> List[AssemblyRelation]:
        """
         Gets the assembly relations 
         @return relations (@link AssemblyRelation List[NXOpen.Layout2d.AssemblyRelation]@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def ResetAssemblyRelations(builder: AssociativeAssemblyBuilder) -> None:
        """
         Resets the assembly relations to initial state 
        """
        pass
...
class ComponentActiveSetBuilder(NXOpen.Builder): 
    ...
    ##   the select members of active set   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def IsValidActiveSetMember(builder: ComponentActiveSetBuilder, objectTag: NXOpen.DisplayableObject) -> bool:
        """
         Verifies whether specified object can be an active member 
         @return isValid (bool): .
        """
...
class ComponentCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateAssemblyFromLayout2dBuilder(owning_part: ComponentCollection) -> AssemblyFromLayout2dBuilder:
        """
         Creates a @link NXOpen::Layout2d::AssemblyFromLayout2dBuilder NXOpen::Layout2d::AssemblyFromLayout2dBuilder@endlink  that can create assembly from  
                 *  the selected layout
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateAssociativeAssemblyBuilder(owning_part: ComponentCollection) -> AssociativeAssemblyBuilder:
        """
         Creates a @link NXOpen::Layout2d::AssociativeAssemblyBuilder NXOpen::Layout2d::AssociativeAssemblyBuilder@endlink  
         @return builder (@link AssociativeAssemblyBuilder NXOpen.Layout2d.AssociativeAssemblyBuilder@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateComponentActiveSetBuilder(owning_part: ComponentCollection) -> ComponentActiveSetBuilder:
        """
         Creates a @link NXOpen::Layout2d::ComponentActiveSetBuilder NXOpen::Layout2d::ComponentActiveSetBuilder@endlink  
         @return builder (@link ComponentActiveSetBuilder NXOpen.Layout2d.ComponentActiveSetBuilder@endlink): .
        """
    ...
    def CreateComponentFrom3dBuilder(owning_part: ComponentCollection, myView: NXOpen.View) -> CreateComponentFrom3DBuilder:
        """
         Creates a @link NXOpen::Layout2d::CreateComponentFrom3DBuilder NXOpen::Layout2d::CreateComponentFrom3DBuilder@endlink  that can create assembly from
                 *  the selected layout
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateDefineComponentAnchorPointBuilder(owning_part: ComponentCollection) -> DefineComponentAnchorPointBuilder:
        """
         Creates a @link NXOpen::Layout2d::DefineComponentAnchorPointBuilder NXOpen::Layout2d::DefineComponentAnchorPointBuilder@endlink  that can define the Anchor Point location of a
                 *  2D Component
    ...
    def CreateDefineComponentBuilder(owning_part: ComponentCollection, component: Component) -> DefineComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::DefineComponentBuilder NXOpen::Layout2d::DefineComponentBuilder@endlink  that can create a fully defined 2D 
                    Component with specified content, anchor point, name and reuse library destination folder.
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateExportComponentHierarchyBuilder(owning_part: ComponentCollection) -> ExportComponentHierarchyBuilder:
        """
         Creates a @link NXOpen::Layout2d::ExportComponentHierarchyBuilder NXOpen::Layout2d::ExportComponentHierarchyBuilder@endlink  
         @return builder (@link ExportComponentHierarchyBuilder NXOpen.Layout2d.ExportComponentHierarchyBuilder@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateInheritDisplayAttributesBuilder(owning_part: ComponentCollection) -> InheritDisplayAttributesBuilder:
        """
         Creates a @link NXOpen::Layout2d::InheritDisplayAttributesBuilder NXOpen::Layout2d::InheritDisplayAttributesBuilder@endlink  
         @return builder (@link InheritDisplayAttributesBuilder NXOpen.Layout2d.InheritDisplayAttributesBuilder@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateInsertComponentBuilder(owning_part: ComponentCollection) -> InsertComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::InsertComponentBuilder NXOpen::Layout2d::InsertComponentBuilder@endlink  that inserts a 2D Component instance in the active
                 *  sketch.
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateMakeComponentUniqueBuilder(owning_part: ComponentCollection) -> MakeComponentUniqueBuilder:
        """
         Creates a @link NXOpen::Layout2d::MakeComponentUniqueBuilder NXOpen::Layout2d::MakeComponentUniqueBuilder@endlink  that can create definition
                 *  for the selected 2D Component instance
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateNewComponentBuilder(owning_part: ComponentCollection) -> NewComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::NewComponentBuilder NXOpen::Layout2d::NewComponentBuilder@endlink  that creates an empty 2D Component instance and stores its
                 *  definition in local 2D Component folder
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreatePublishComponentBuilder(owning_part: ComponentCollection) -> PublishComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::PublishComponentBuilder NXOpen::Layout2d::PublishComponentBuilder@endlink  that can export local definitions into external storage locations
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateReparentComponentBuilder(owning_part: ComponentCollection) -> ReparentComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::ReplaceComponentBuilder NXOpen::Layout2d::ReplaceComponentBuilder@endlink  that can reparent the selected 2D Component
                 *  instance with another 2D Component or sketch 
         @return builder (@link ReparentComponentBuilder NXOpen.Layout2d.ReparentComponentBuilder@endlink): .
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateReplaceComponentBuilder(owning_part: ComponentCollection) -> ReplaceComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::ReplaceComponentBuilder NXOpen::Layout2d::ReplaceComponentBuilder@endlink  that can replace the selected 2D Component
                 *   instance with another 2D Component definition
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateSmashComponentBuilder(owning_part: ComponentCollection) -> SmashComponentBuilder:
        """
         Creates a @link NXOpen::Layout2d::SmashComponentBuilder NXOpen::Layout2d::SmashComponentBuilder@endlink  that can smash the selected 
                 *  2D Component instance
    ...
    def DeleteComponents(owning_part: ComponentCollection, components: List[Component]) -> None:
        """
         Deletes a list of 2D Components
        """
        pass
    ...
    ## License requirements: None.
    ##  Identifier of the 2D Component to be found 
    def FindObject(obj: ComponentCollection, journal_identifier: str) -> Component:
        """
         Finds the @link  NXOpen::Layout2d::Component   NXOpen::Layout2d::Component @endlink  with the given identifier as recorded in a journal.
                An object may not return the same value as its JournalIdentifier in different versions of
                the software. However newer versions of the software should find the same object when
    ...
    def IsComponentMember(owning_part: ComponentCollection, disObject: NXOpen.DisplayableObject) -> bool:
        """
         Verify if the object belong to this component 
         @return isMember (bool):  true if the object is component member .
        """
    ...
    ## 
    ## <param name="components"> (@link Component List[NXOpen.Layout2d.Component]@endlink) </param>
    def UpdateComponentHierarchy(owning_part: ComponentCollection, components: List[Component]) -> None:
        """
         Updates 2D Components and propagates the changes to the hierarchy in given layout 
        """
        pass
    ...
    ## 
    ## <param name="components"> (@link Component List[NXOpen.Layout2d.Component]@endlink) </param>
    def UpdateComponents(owning_part: ComponentCollection, components: List[Component]) -> None:
        """
         Updates 2D Components without propagating the changes to the hierarchy in given layout 
        """
        pass
...
class ComponentDefinitionCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Location of the definition to delete 
    def Delete(part: ComponentDefinitionCollection, location: Layout2dDefinitionLocation, definitionPath: str) -> None:
        """
         Deletes definition
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  The sid of the definition to find 
    def FindObject(part: ComponentDefinitionCollection, sid: str) -> ComponentDefinition:
        """
          Finds the @link  NXOpen::Layout2d::ComponentDefinition   NXOpen::Layout2d::ComponentDefinition @endlink  with the given sid. 
                     An exception will be thrown if no object can be found with the given sid. 
                     This method can only be used to find Local definitions 
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def RefreshAllReferences(part: ComponentDefinitionCollection) -> None:
        """
          Refreshes all definition references in part to obtain the actual out-of-date status of components 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Location of the definition to rename 
    def Rename(part: ComponentDefinitionCollection, location: Layout2dDefinitionLocation, definitionPath: str, newName: str) -> None:
        """
         Renames definition
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Location of the definition to set the preview mode 
    def SetAutomaticPreview(part: ComponentDefinitionCollection, location: Layout2dDefinitionLocation, definitionPath: str, isAutomatic: bool) -> None:
        """
          Sets the automatic preview mode of definition with the given path 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Location of the definition to update 
    def Update(part: ComponentDefinitionCollection, location: Layout2dDefinitionLocation, definitionPath: str) -> None:
        """
          Updates definition with the given path 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Location of the definition to update image 
    def UpdateImage(part: ComponentDefinitionCollection, location: Layout2dDefinitionLocation, definitionPath: str, imagePath: str) -> None:
        """
         Updates definition preview 
        """
        pass
...
class ComponentDefinition(NXOpen.NXObject): 
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Path of the definition to delete 
    def Delete(definition: ComponentDefinition, definitionPath: str) -> None:
        """
         Deletes definition
        """
        pass
    ...
    def GetMembers(definition: ComponentDefinition, memberType: Layout2dComponentMemberType) -> List[NXOpen.DisplayableObject]:
        """
         Returns an array of specified members in this component definition
         @return members (@link NXOpen.DisplayableObject List[NXOpen.DisplayableObject]@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Path of the definition to rename 
    def Rename(definition: ComponentDefinition, definitionPath: str, newName: str) -> None:
        """
         Renames definition
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Path of the definition to rename 
    def UpdateImage(definition: ComponentDefinition, definitionPath: str, imagePath: str) -> None:
        """
         Updates definition preview 
        """
        pass
...
class ComponentNameBuilder(NXOpen.TaggedObject): 
    ...
    ##   the location type of the component indicating local, native or team center    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the JA method support for accessing and setting Component Name value,
    ...
    ##   the JA method support for accessing and setting Component part file mame value,
    ##             NOTE: Client must free the returned TEXT_p_t* with TEXT_free   
    ##     
    ##  
    ## Getter License requirements: None.
    ...
    def SetPartOperationBuilder(builder: ComponentNameBuilder, partOperationBuilder: NXOpen.PDM.PartOperationCreateBuilder) -> None:
        """
         Sets @link NXOpen::PDM::PartOperationCreateBuilder NXOpen::PDM::PartOperationCreateBuilder@endlink  
        """
        pass
...
class ComponentSettingsBlockBuilder(NXOpen.TaggedObject): 
    ...
    ##   the Component settings builder which stores the component settings   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def InheritSettingsFromCustomerDefault(builder: ComponentSettingsBlockBuilder) -> None:
        """
         Inherit Settings From Customer Default 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def InheritSettingsFromPreferences(builder: ComponentSettingsBlockBuilder) -> None:
        """
         Inherit Settings From Preference 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  The selected 2C Component object. 
    ##                                                                         NULL is not allowed. 
    def InheritSettingsFromSelectedObject(builder: ComponentSettingsBlockBuilder, selectedObject: NXOpen.NXObject) -> None:
        """
         Inherit Settings From Selected Objects 
        """
        pass
...
class ComponentSettingsBuilder(NXOpen.TaggedObject): 
    ...
    ##   the flag to do automatic update or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to keep edited parts open or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag to show annotations or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag to show dimensions or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag to show reference geometry or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class Component(NXOpen.DisplayableObject): 
    ...
    ##   the active state of 2D Component.  
    ##      
    ##  
    ...
    ##   the lock update status of 2D Component.  
    ##     
    ##  
    ## Getter License requirements: drafting ("DRAFTING")
    ## 
    ...
    ##   the flag which causes the component to be upgraded upon activation  
    ##     
    ##  
    ## Getter License requirements: nx_layout ("NX Layout")
    ## 
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def Activate(component: Component) -> None:
        """
         Activates the component. 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def ActivateInIsolation(component: Component) -> NXOpen.Sketch:
        """
         Activates the component while in edit in isolation task environment and
                    returns component internal sketch 
         @return internalSketch (@link NXOpen.Sketch NXOpen.Sketch@endlink): .
    ...
    def AddExistingCurves(component: Component, curves: List[NXOpen.DisplayableObject]) -> None:
        """
         Add an array of specified curves from top level sketch to this component 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def Deactivate(component: Component) -> None:
        """
         Deactivates the component. 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def ExitActivate(component: Component) -> None:
        """
         Exits the component active status without committing the changes. 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetAnchorPoint(component: Component) -> Tuple[bool, NXOpen.Point3d]:
        """
         Gets the anchor point of a component if it exist 
         @return A tuple consisting of (isAnchorPointExist, anchorPoint). 
         - isAnchorPointExist is: bool.
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetDefinition(component: Component) -> ComponentDefinition:
        """
         Gets the component definition of a component 
         @return definition (@link ComponentDefinition NXOpen.Layout2d.ComponentDefinition@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetDefinitionLocation(component: Component) -> Layout2dDefinitionLocation:
        """
         Gets the location of the component definition 
         @return location (@link Layout2dDefinitionLocation NXOpen.Layout2d.Layout2dDefinitionLocation@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetDefinitionName(component: Component) -> str:
        """
         Gets the component definition name of a component 
         @return definitionName (str): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetDefinitionPath(component: Component) -> str:
        """
         Gets the path of the component definition 
         @return definitionPath (str): .
        """
    ...
    ## 
    ## <param name="memberType"> (@link Layout2dComponentMemberType NXOpen.Layout2d.Layout2dComponentMemberType@endlink) </param>
    def GetMembers(component: Component, memberType: Layout2dComponentMemberType) -> List[NXOpen.DisplayableObject]:
        """
         Returns an array of specified members in this component 
         @return members (@link NXOpen.DisplayableObject List[NXOpen.DisplayableObject]@endlink): .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetTransform(component: Component) -> Tuple[NXOpen.Matrix3x3, NXOpen.Vector3d]:
        """
         Gets the absolute transform of a component, as a rotation matrix and a translation vector
         @return A tuple consisting of (rotation, translation). 
         - rotation is: @link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink.
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def RenewSketch(component: Component) -> None:
        """
         Renews component sketch to the latest solver version and updates component hierarchy for the changes to take effect. 
        """
        pass
    ...
    def SetTransform(component: Component, rotation: NXOpen.Matrix3x3, translation: NXOpen.Vector3d) -> None:
        """
         Sets the absolute transform on a component, given a rotation matrix and a translation vector
        """
        pass
    ...
    ## <param name="rotation"> (@link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink) </param>
    ## <param name="translation"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink) </param>
    def Transform(component: Component, rotation: NXOpen.Matrix3x3, translation: NXOpen.Vector3d) -> None:
        """
         Transforms the component given a rotation matrix and a translation vector
        """
        pass
...
class ConvertLayoutToSheetBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (str) Name
    ##   the name of the drawing sheet to be created   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the number of the drawing sheet to be created   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the sheet projection angle option   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the revision of the drawing sheet to be created   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the secondary number of the drawing sheet to be created   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the select layout sheet view to convert  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def GetScale(builder: ConvertLayoutToSheetBuilder) -> Tuple[float, float]:
        """
         Gets the sheet scale 
         @return A tuple consisting of (numerator, denominator). 
         - numerator is: float. the scale numerator .
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  the scale numerator 
    def SetScale(builder: ConvertLayoutToSheetBuilder, numerator: float, denominator: float) -> None:
        """
         Sets the sheet scale 
        """
        pass
...
class ConvertSheetToLayoutBuilder(LayoutDrawingSheetBuilder): 
    ...
    ##   the select drawing sheet to convert  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class CreateComponentFrom3DBuilder(NXOpen.Display.DynamicSectionBuilder): 
    ...
    ##   the method to utilize in create Component from 3D  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the selected objects of Solid body or Component type   
    ##     
    ##  
    ## Getter License requirements: nx_layout ("NX Layout")
    ## 
    ...
    ##   the settings of create component from 3D   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetProjectionPlane(builder: CreateComponentFrom3DBuilder) -> Tuple[NXOpen.Point3d, NXOpen.Matrix3x3]:
        """
         Gets the projection plane origin and orientation matrix 
         @return A tuple consisting of (origin, orientation). 
         - origin is: @link NXOpen.Point3d NXOpen.Point3d@endlink.
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def GetSourcePart(builder: CreateComponentFrom3DBuilder) -> NXOpen.Part:
        """
         Returns the current source part 
         @return part (@link NXOpen.Part NXOpen.Part@endlink): .
        """
    ...
    def SetProjectionPlane(builder: CreateComponentFrom3DBuilder, origin: NXOpen.Point3d, yAxis: NXOpen.Vector3d, zAxis: NXOpen.Vector3d) -> None:
        """
         Sets the projection plane specified by origin, y and z vectors, where z is the plane normal and
                    the x vector is computed.
        """
    ...
    def SetSourcePart(builder: CreateComponentFrom3DBuilder, part: NXOpen.Part) -> None:
        """
         Sets the source part to create 2D component from. The part may be the current work part or other part loaded in session. 
        """
        pass
...
class CreateComponentFrom3DSettingsBuilder(NXOpen.TaggedObject): 
    ...
    ## Getter for property: (@link ActiveSetScope NXOpen.Layout2d.ActiveSetScope@endlink) ActiveSetScope
    ##   the option whether each 2D component will be created with no active set or an active set for the entire 2D component.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the settings to determines whether or not automatically start insert 2D component command.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##    the settings to specifies the 2D component curves color.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##    the settings to specifies how the color of the 2D component curves is defined.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the settings to determines whether or not create single 2D component definition.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: drafting ("DRAFTING")
    @staticmethod
    def InheritSettingsFromCustomerDefault(builder: CreateComponentFrom3DSettingsBuilder) -> None:
        """
         Inherit Settings From Customer Default 
        """
        pass
    ...
    ## License requirements: drafting ("DRAFTING")
    @staticmethod
    def InheritSettingsFromPreferences(builder: CreateComponentFrom3DSettingsBuilder) -> None:
        """
         Inherit Settings From Preference 
        """
        pass
...
class DefineComponentAnchorPointBuilder(NXOpen.Builder): 
    ...
    ##   the anchor point of a 2D Component   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class DefineComponentBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.Point NXOpen.Point@endlink) AnchorPoint
    ##   the anchor point to define the 2D Component  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the 2D Component Name defines the name for the new created definition   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the select objects to create a 2D Component definition  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the image capture builder used to create an image for the definition   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the 2D Component image name for the new created definition   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def IsValidActiveSetMember(builder: DefineComponentBuilder, objectValue: NXOpen.DisplayableObject) -> bool:
        """
         Verifies whether specified object can be an active member 
         @return result (bool): .
        """
    ...
    def SetLocation(builder: DefineComponentBuilder, locationType: Layout2dDefinitionLocation) -> None:
        """
         Sets the location type of the component indicating local, native or team center
        """
        pass
    ...
    def SetPath(builder: DefineComponentBuilder, path: str) -> None:
        """
         Sets the path to store the 2D Component 
        """
        pass
...
class EditComponentSettingsBuilder(BaseEditSettingsBuilder): 
    ...
    ##   the 2D Component settings block builder which holds the component settings builder   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def InheritSettingsFromCustomerDefault(builder: EditComponentSettingsBuilder) -> None:
        """
         Inherit Settings From Customer Default 
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    @staticmethod
    def InheritSettingsFromPreferences(builder: EditComponentSettingsBuilder) -> None:
        """
         Inherit Settings From Preference 
        """
        pass
    ...
    ##                                                                         NULL is not allowed. 
    def InheritSettingsFromSelectedObject(builder: EditComponentSettingsBuilder, selectedObject: NXOpen.NXObject) -> None:
        """
         Inherit Settings From Selected Objects 
        """
        pass
...
class ExportComponentHierarchyBuilder(NXOpen.Builder): 
    ...
    ##   the flag indicating whether to export child components for components   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to export child components for definitions   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to export contents for components   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to export definition reference properties for components   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to export definitions for components   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the selected objects which may be of @link NXOpen::Layout2d::Component NXOpen::Layout2d::Component@endlink  or @link NXOpen::Sketch NXOpen::Sketch@endlink  type   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to export software properties for components   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class GeneralPreferencesBuilder(NXOpen.TaggedObject): 
    ...
    ##   the flag controling the visibility of layout origin symbols in the session  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class InheritDisplayAttributesBuilder(NXOpen.Builder): 
    ...
    ##   the selected 2D Components for inherit   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class InsertComponentBuilder(NXOpen.Builder): 
    ...
    ##   the component rotation angle, measured counterclockwise, around the anchor point, from the sketch +X direction to component's X axis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Component settings block builder which holds the component settings builder   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the sketch to insert the 2D Component   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the point specified to put the 2D Component instance  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## 
    ## <param name="locationType"> (@link Layout2dDefinitionLocation NXOpen.Layout2d.Layout2dDefinitionLocation@endlink) </param>
    def SetLocation(builder: InsertComponentBuilder, locationType: Layout2dDefinitionLocation) -> None:
        """
         Sets the location type of the 2D Component indicating local, native or team center
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  the path of the 2D Component 
    def SetPath(builder: InsertComponentBuilder, path: str) -> None:
        """
         Sets the path of the reuse library for the 2D Component 
        """
        pass
...
class LayoutDrawingSheetCollection(NXOpen.TaggedObjectCollection): 
    ...
    ##   the currently opened layout drawing sheet.  
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateConvertLayoutToSheetBuilder(owningPart: LayoutDrawingSheetCollection) -> ConvertLayoutToSheetBuilder:
        """
         Creates a @link NXOpen::Layout2d::ConvertLayoutToSheetBuilder NXOpen::Layout2d::ConvertLayoutToSheetBuilder@endlink  
         @return builder (@link ConvertLayoutToSheetBuilder NXOpen.Layout2d.ConvertLayoutToSheetBuilder@endlink):  the convert layout to sheet builder .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    def CreateConvertSheetToLayoutBuilder(owningPart: LayoutDrawingSheetCollection) -> ConvertSheetToLayoutBuilder:
        """
         Creates a @link NXOpen::Layout2d::ConvertSheetToLayoutBuilder NXOpen::Layout2d::ConvertSheetToLayoutBuilder@endlink  
         @return builder (@link ConvertSheetToLayoutBuilder NXOpen.Layout2d.ConvertSheetToLayoutBuilder@endlink):  the convert sheet to layout builder .
        """
    ...
    def CreateLayoutDrawingSheetBuilder(owningPart: LayoutDrawingSheetCollection, layoutDrawingSheet: LayoutDrawingSheet) -> LayoutDrawingSheetBuilder:
        """
         Creates a @link NXOpen::Layout2d::LayoutDrawingSheetBuilder NXOpen::Layout2d::LayoutDrawingSheetBuilder@endlink  
         @return builder (@link LayoutDrawingSheetBuilder NXOpen.Layout2d.LayoutDrawingSheetBuilder@endlink):  the layout drawing sheet builder .
        """
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Identifier of the Layout drawing sheet you want 
    def FindObject(owningPart: LayoutDrawingSheetCollection, journalIdentifier: str) -> LayoutDrawingSheet:
        """
         Finds the @link NXOpen::Layout2d::LayoutDrawingSheet NXOpen::Layout2d::LayoutDrawingSheet@endlink  with the given identifier 
                as recorded in a journal.  An object may not return the same value as its JournalIdentifier in 
                different versions of  the software. However newer versions of the software should find the same 
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  Layout drawing sheet name 
    def InsertSheet(part: LayoutDrawingSheetCollection, name: str, units: DrawingSheet.Unit, numerator: float, denominator: float, projectionAngle: DrawingSheet.ProjectionAngleType) -> LayoutDrawingSheet:
        """
         Inserts a layout drawing sheet into a part. 
         @return layoutDrawingSheet (@link LayoutDrawingSheet NXOpen.Layout2d.LayoutDrawingSheet@endlink):  the inserted layout drawing sheet .
        """
...
class LocalDefinitionFolderCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  @link NXOpen::Layout2d::LocalDefinitionFolder NXOpen::Layout2d::LocalDefinitionFolder@endlink  to be set as current folder.
    ##                                                                                       If NULL, create a new folder 
    def CreateLocalDefinitionFolderBuilder(part: LocalDefinitionFolderCollection, currentFolder: LocalDefinitionFolder) -> LocalDefinitionFolderBuilder:
        """
         Creates local definition folder builder instance. The builder allows operations such as Creation, Edit and Deletion
                    of local definition folders. These operations are Undo/Redo supported.
    ...
    def FindObject(part: LocalDefinitionFolderCollection, name: str) -> LocalDefinitionFolder:
        """
          Finds the @link  NXOpen::Layout2d::LocalDefinitionFolder   NXOpen::Layout2d::LocalDefinitionFolder @endlink  with the given name. 
                     An exception will be thrown if no object can be found with the given name. 
         @return folder (@link LocalDefinitionFolder NXOpen.Layout2d.LocalDefinitionFolder@endlink): .
...
class MakeComponentUniqueBuilder(NXOpen.Builder): 
    ...
    ##   the select 2D Comoponent instance to create definition   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Gateway.ImageCaptureBuilder NXOpen.Gateway.ImageCaptureBuilder@endlink) ImageCapture
    ##   the image capture builder used to create an image for the new definition   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## 
    ## <param name="locationType"> (@link Layout2dDefinitionLocation NXOpen.Layout2d.Layout2dDefinitionLocation@endlink) </param>
    def SetLocation(builder: MakeComponentUniqueBuilder, locationType: Layout2dDefinitionLocation) -> None:
        """
         Sets the location type of the 2D Component indicating local, native or team center
        """
        pass
    ...
    ## License requirements: nx_layout ("NX Layout")
    ##  location of component 
    def SetPath(builder: MakeComponentUniqueBuilder, path: str) -> None:
        """
         Sets the path to store the 2D Component
        """
        pass
...
class NewComponentBuilder(NXOpen.Builder): 
    ...
    ##   the owner to create the 2D Component, can be either a drawing sheet, a drawing view
...
class PublishComponentBuilder(NXOpen.Builder): 
    ...
    ##   the path of folder to publish into   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link Layout2dDefinitionLocation NXOpen.Layout2d.Layout2dDefinitionLocation@endlink) Location
    ##   the location type of folder to publish into   
    ##     
    ##  
    ## Getter License requirements: nx_layout ("NX Layout")
    ## 
    ...
    ##   the path of folder or definition to publish   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class ReparentComponentBuilder(NXOpen.Builder): 
    ...
    *   the selected 2D Component contents from another 2D Component definition.
    ...
    ## Getter for property: (@link SelectComponentList NXOpen.Layout2d.SelectComponentList@endlink) Components
    ##   the select 2D Components to reparent the definitions   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag to distinguish copy and cut operations   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the target of 2D Components reparent operation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## 
    ## <param name="components"> (@link Component List[NXOpen.Layout2d.Component]@endlink) </param>
    def AddComponents(builder: ReparentComponentBuilder, components: List[Component]) -> None:
        """
         Add a list of 2D Components
        """
        pass
...
class ReplaceComponentBuilder(NXOpen.Builder): 
    ...
    *   the selected 2D Component contents from another 2D Component definition.
    ...
    ## Getter for property: (@link SelectComponentList NXOpen.Layout2d.SelectComponentList@endlink) Components
    ##   the select 2D Components to replace the definitions   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link Layout2dDefinitionLocation NXOpen.Layout2d.Layout2dDefinitionLocation@endlink) Location
    ##   the location type of the 2D Component definition to replace 
    ...
    ##   the path of the 2D Component definition to replace   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating whether to replace all instances of selected components   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
"""
    ...
    ## License requirements: None.
    ##  object to add 
    def Add(object_list: SelectComponentList, objectValue: Component) -> bool:
        """
         Adds an object to the list
    ...
    ## License requirements: None.
    ##  objects to add 
    def AddWithViews(object_list: SelectComponentList, objects: List[Component], views: List[NXOpen.View]) -> bool:
        """
         Adds a set of objects with views to the list
    ...
    ##  objects to add 
    @overload
    def Add(self, object_list: SelectComponentList, objects: List[Component]) -> bool:
        """
         Adds a set of objects to the list
    ...
    @overload
    def Add(self, object_list: SelectComponentList, input_selection_method: NXOpen.SelectionMethod) -> bool:
        """
         Adds the objects from a SelectionMethod to the list
    ...
    ##  selected object 
    @overload
    def Add(self, object_list: SelectComponentList, selection: Component, view: NXOpen.View, point: NXOpen.Point3d) -> bool:
        """
         Adds the object with the objects view and objects point
    ...
    ##   snap point type
    @overload
    def Add(self, object_list: SelectComponentList, snap_type: NXOpen.InferSnapType.SnapType, selection1: Component, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: Component, view2: NXOpen.View, point2: NXOpen.Point3d) -> bool:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def Add(self, object_list: SelectComponentList, selection: Component, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> bool:
        """
         The object being selected with CAE set object information.
    ...
    ## License requirements: None.
    @staticmethod
    def Clear(object_list: SelectComponentList) -> None:
        """
         Removes all items from the list.
    ...
    ## License requirements: None.
    ##  object to check 
    def Contains(object_list: SelectComponentList, objectValue: Component) -> bool:
        """
         Returns whether the specified object is already in the list or not.
    ...
    ## License requirements: None.
    @staticmethod
    def GetArray(object_list: SelectComponentList) -> List[Component]:
        """
         Returns the list of objects in the selection list.
    ...
    ## License requirements: None.
    @staticmethod
    def GetSelectObjectArray(object_list: SelectComponentList) -> List[NXOpen.SelectObject]:
        """
         Returns the list of SelectObjects in the selection list.
    ...
    ## License requirements: None.
    ##  Object to remove 
    def Remove(object_list: SelectComponentList, objectValue: Component) -> bool:
        """
         Remove specified object from list.
    ...
    ## License requirements: None.
    ##  Objects to remove 
    def RemoveArray(object_list: SelectComponentList, objects: List[Component]) -> bool:
        """
         Remove specified objects from list.
    ...
    ##  Object to remove 
    @overload
    def Remove(self, object_list: SelectComponentList, objectValue: Component, view: NXOpen.View) -> bool:
        """
         Remove specified object from list.
    ...
    ##   snap point type
    @overload
    def Remove(self, object_list: SelectComponentList, snap_type: NXOpen.InferSnapType.SnapType, selection1: Component, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: Component, view2: NXOpen.View, point2: NXOpen.Point3d) -> bool:
        """
         Remove specified object from list.
    ...
    ##  selection method containing objects to add 
    @overload
    def Remove(self, object_list: SelectComponentList, input_selection_method: NXOpen.SelectionMethod) -> bool:
        """
         Removes the objects from a SelectionMethod from the list
    ...
    def SetArray(object_list: SelectComponentList, objects: List[Component]) -> None:
        """
         Sets the list of objects in the selection list. This will clear any existing
            items in the list.
...
"""
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectComponent) -> Tuple[Component, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the object's view and point.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectComponent) -> Tuple[NXOpen.InferSnapType.SnapType, Component, NXOpen.View, NXOpen.Point3d, Component, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the objects view and point and snap information.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectComponent) -> Tuple[Component, NXOpen.CaeObjectType.CaeSubType, int]:
        """
         The object being selected with CAE set object information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectComponent, selection: Component, view: NXOpen.View, point: NXOpen.Point3d) -> None:
        """
         The object being selected with the object's view and object's point
    ...
    ##   snap point type
    @overload
    def SetValue(self, select_object: SelectComponent, snap_type: NXOpen.InferSnapType.SnapType, selection1: Component, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: Component, view2: NXOpen.View, point2: NXOpen.Point3d) -> None:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectComponent, selection: Component, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> None:
        """
         The object being selected with CAE set object information.
...
class SmashComponentBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link SelectComponentList NXOpen.Layout2d.SelectComponentList@endlink) Components
    ##   the select 2D Component instances to smash   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
