...
class BaseExplicitOrderBuilder(NXOpen.Builder): 
    ...
    @staticmethod
    def Clear(builder: BaseExplicitOrderBuilder) -> None:
        """
         Clears the current order and restores it to the default order 
        """
        pass
    ...
    def Delete(builder: BaseExplicitOrderBuilder, selectedEntries: List[str], currentOrder: List[str], numOfRemainingEntries: int) -> List[str]:
        """
         Deletes the saved order/orders that has/have been selected by the user from the list of saved orders 
         @return newOrder (List[str]): .
        """
    ...
    ## <param name="selectedEntries"> (List[str]) </param>
    ## <param name="currentOrder"> (List[str]) </param>
    def DownArrow(builder: BaseExplicitOrderBuilder, selectedEntries: List[str], currentOrder: List[str]) -> List[str]:
        """
         Moves down the row/rows selected by the user in the lists 
         @return newOrder (List[str]): .
        """
    ...
    ## <param name="selectedEntries"> (List[str]) </param>
    ## <param name="currentOrder"> (List[str]) </param>
    def Paste(builder: BaseExplicitOrderBuilder, pastePoint: int, selectedEntries: List[str], currentOrder: List[str]) -> List[str]:
        """
         Pastes the rows that have been previously selected using the cut operation 
         @return newOrder (List[str]): .
        """
    ...
    def Save(builder: BaseExplicitOrderBuilder, orderList: List[str], saveName: str) -> None:
        """
         Saves an explicit order defined by the user 
        """
        pass
    ...
    def SaveAsTextFile(builder: BaseExplicitOrderBuilder, savedOrderName: str, saveFileName: str, overwriteFile: bool) -> None:
        """
         Saves the selected saved order in the form of a text file 
        """
        pass
    ...
    ## <param name="selectedEntries"> (List[str]) </param>
    ## <param name="currentOrder"> (List[str]) </param>
    def UpArrow(builder: BaseExplicitOrderBuilder, selectedEntries: List[str], currentOrder: List[str]) -> List[str]:
        """
         Moves up the row/rows selected by the user in the lists 
         @return newOrder (List[str]): .
        """
...
class BookmarkFile(NXOpen.Object): 
    ...
    ## License requirements: None.
    ##  Full path name of existing bookmark file to delete 
    @staticmethod
    ...
    ## License requirements: None.
    ##  Full path name of existing bookmark file. 
    ...
    ## License requirements: None.
    ##  Full path name of bookmark file. 
    ...
    ## License requirements: None.
    ##  Full path name of an existing bookmark file. 
...
"""
    ...
    ##   a flag indicating whether to copy as sketch curves or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating if non-associative copy is being made.  
    ...
    ##   the string of the filename to which to copy or cut the objects to   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the initial copy location mainly used to define default copy location of sketch objects   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   a flag indicating whether it is a copy or cut operation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   a flag indicating whether copy cut to clipboard or copy cut to a file  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def GetCopyCutStatus(builder: CopyCutBuilder) -> CopyCutBuilder.Status:
        """
         Gets the status of copy-cut operation 
         @return copyCutStatus (@link CopyCutBuilder.Status NXOpen.Gateway.CopyCutBuilder.Status@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNonExportableObjects(builder: CopyCutBuilder) -> List[NXOpen.NXObject]:
        """
         Gets all non-exportable objects 
         @return nonExportableObjects (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink):  All the non-exportable objects .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetObjects(builder: CopyCutBuilder) -> List[NXOpen.NXObject]:
        """
         Gets all objects to be copied or to be cut 
         @return objects (@link NXOpen.NXObject List[NXOpen.NXObject]@endlink):  All the objects to be copied or to be cut.
        """
    ...
    ## License requirements: None.
    @staticmethod
    def ResetInitialCopyLocation(builder: CopyCutBuilder) -> None:
        """
         Reset the initial copy location. After this previously set initial copy location will not be used 
        """
        pass
    ...
    def SetObjects(builder: CopyCutBuilder, objects: List[NXOpen.NXObject]) -> None:
        """
         Sets objects to be copied or cut. Note that PMI, feature, drafting view and other drafting objects are not supported by this class. 
        """
        pass
...
class FileNewTemplateNode(NXOpen.NXObject): 
    ...
    def SetDescription(templateNode: FileNewTemplateNode, attrValue: str) -> None:
        """
         SetDescrption 
        """
        pass
    ...
    ## 
    ## <param name="attrValue"> (str) </param>
    def SetItemType(templateNode: FileNewTemplateNode, attrValue: str) -> None:
        """
         SetItemType
        """
        pass
    ...
    ## 
    ## <param name="attrValue"> (str) </param>
    def SetRelationType(templateNode: FileNewTemplateNode, attrValue: str) -> None:
        """
         SetRelationType 
        """
        pass
    ...
    ## 
    ## <param name="attrValue"> (str) </param>
    def SetTemplateApplication(templateNode: FileNewTemplateNode, attrValue: str) -> None:
        """
         SetTemplateApplication 
        """
        pass
    ...
    ## 
    ## <param name="attrValue"> (str) </param>
    def SetTemplatePresentationName(templateNode: FileNewTemplateNode, attrValue: str) -> None:
        """
         SetTemplatePresentationName 
        """
        pass
...
class GenericFileNewBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    def CreateLogicalObjects(builder: GenericFileNewBuilder) -> List[NXOpen.PDM.LogicalObject]:
        """
         Creates the pre-creation objects for the parts 
         @return logicalObjects (@link NXOpen.PDM.LogicalObject List[NXOpen.PDM.LogicalObject]@endlink): .
        """
    ...
    def SetApplicationBuilder(builder: GenericFileNewBuilder, applicationBuilder: IGenericFileNewApplicationBuilder) -> None:
        """
         Sets @link NXOpen::Gateway::IGenericFileNewApplicationBuilder NXOpen::Gateway::IGenericFileNewApplicationBuilder@endlink  
        """
        pass
...
class ImageCaptureBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def GetRegion(builder: ImageCaptureBuilder) -> Tuple[List[int], List[int]]:
        """
         Returns the region 
         @return A tuple consisting of (topLeftCorner, bottomRightCorner). 
         - topLeftCorner is: List[int]. Array of 2 integers for Top Left Corner of Region .
    ...
    ##  Array of 2 integers for Top Left Corner of Region 
    def SetRegion(builder: ImageCaptureBuilder, topLeftCorner: List[int], bottomRightCorner: List[int]) -> None:
        """
         Sets the region 
        """
        pass
...
class ImageCaptureManager(NXOpen.Object): 
    ...
    ## License requirements: None.
    def CreateImageCaptureBuilder(part: ImageCaptureManager) -> ImageCaptureBuilder:
        """
         Creates a @link NXOpen::Gateway::ImageCaptureBuilder NXOpen::Gateway::ImageCaptureBuilder@endlink  
         @return builder (@link ImageCaptureBuilder NXOpen.Gateway.ImageCaptureBuilder@endlink): .
        """
...
class ImageExportBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def GetCustomBackgroundColor(builder: ImageExportBuilder) -> List[float]:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetRegionTopLeftPoint(builder: ImageExportBuilder) -> List[int]:
        """
    ...
    def SetCustomBackgroundColor(builder: ImageExportBuilder, customBackgroundColor: List[float]) -> None:
        """
    ...
    def SetRegionTopLeftPoint(builder: ImageExportBuilder, regionTopLeftPoint: List[int]) -> None:
        """
