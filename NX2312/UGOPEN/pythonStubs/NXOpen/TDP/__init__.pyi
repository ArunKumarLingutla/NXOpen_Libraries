...
class AttributesToExcludeBuilder(NXOpen.TaggedObject): 
    ...
    def GetAttributeState(builder: AttributesToExcludeBuilder, attributeName: str) -> bool:
        """
         Get the modified state of attributes 
         @return attributeState (bool): .
        """
    ...
    def SetAttributeState(builder: AttributesToExcludeBuilder, attributeName: str, attributeState: bool) -> None:
        """
         Set the modified state of attributes 
        """
        pass
...
class Manager(NXOpen.Object): 
    ...
    ## License requirements: nx_tdp (" NX Technical Data Package")
    ##  Origin for the template displayable object 
...
class PublisherBuilder(NXOpen.Builder): 
    ...
    ##   the output filename for the TDP   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag whether to use password or not   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def AddAttachment(builder: PublisherBuilder, filename: str) -> None:
        """
         This method adds the new attachment filename to the end of the attachment list.
        """
        pass
    ...
    def DeleteAttachmentAtIndices(builder: PublisherBuilder, indices: List[int]) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetAttachments(builder: PublisherBuilder) -> List[str]:
        """
         This method returns the list of attachment filenames 
         @return attachments (List[str]): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetTextLabels(builder: PublisherBuilder) -> List[str]:
        """
         This method returns the list of text labels.
         @return labels (List[str]): .
        """
    ...
    @staticmethod
    def GetTextValueOfLabel(builder: PublisherBuilder, label: str) -> Tuple[bool, str]:
        """
         This method returns the value of the text with the given label, if the text exists.
         @return A tuple consisting of (exists, value). 
         - exists is: bool.
    ...
    ## License requirements: None.
    @staticmethod
    def GetViewportLabels(builder: PublisherBuilder) -> List[str]:
        """
         This method returns the list of viewport labels.
         @return labels (List[str]): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetWorkTemplateFilename(builder: PublisherBuilder) -> str:
        """
         This method returns the name of the template file that is being worked on.
         @return templateFilename (str): .
        """
    ...
    ## 
    ## <param name="label"> (str) </param>
    def HasTextOfLabel(builder: PublisherBuilder, label: str) -> bool:
        """
         This method checks to see if a text with the given label exists for the selected template.
         @return exists (bool): .
        """
    ...
    ## 
    ## <param name="label"> (str) </param>
    def HasViewportOfLabel(builder: PublisherBuilder, label: str) -> bool:
        """
         This method checks to see if a viewport with the given label exists for the selected template.
         @return exists (bool): .
        """
    ...
    ## License requirements: nx_tdp (" NX Technical Data Package")
    @staticmethod
    def Publish(builder: PublisherBuilder) -> PublisherBuilder.PublishResult:
        """
         This method publishes the TDP with builder's data.
         @return result (@link PublisherBuilder.PublishResult NXOpen.TDP.PublisherBuilder.PublishResult@endlink): .
        """
    ...
    def SetPassword(builder: PublisherBuilder, password: str) -> None:
        """
         This method sets the password.
        """
        pass
    ...
    def SetTextValueOfLabel(builder: PublisherBuilder, label: str, value: str) -> bool:
        """
         This method sets the value of the text with the given label, if the text exists.
         @return exists (bool): .
        """
    ...
    ## <param name="label"> (str) </param>
    ## <param name="value"> (str) </param>
    def SetViewPortViewValueOfViewPortLabel(builder: PublisherBuilder, label: str, value: str) -> bool:
        """
         This method sets the value of the viewport view with the given label, if the viewport exists.
         @return exists (bool): .
        """
    ...
    def SetWorkTemplateFile(builder: PublisherBuilder, templateFilename: str) -> None:
        """
         This method sets the template to publish TDP and repopulates the text table.
        """
        pass
...
class TemplateAutomaticTableBuilder(TemplateBaseRectangleBuilder): 
    ...
    ##  Assemblies and Sub Assemblies placed in 3D PDF 
    ...
    ##   the maintain bom assembly order toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show checked only result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show passed with information result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show passed with warning result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show physical parameters result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show physical parameters folder result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show product interface toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show suppressed result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show unused check expression toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show unused expression check folder result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show unvalidated requirements folder result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show unvalidated requirements toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the show work part only result toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the font, and width of Automatic table text   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def AddColumn(builder: TemplateAutomaticTableBuilder) -> bool:
        """
         To add the row in the table
         @return exists (bool): .
        """
    ...
    def DeleteColumn(builder: TemplateAutomaticTableBuilder, index: int) -> bool:
        """
         To delete the row in the table
         @return exists (bool): .
        """
    ...
    def SetICDColumnType(builder: TemplateAutomaticTableBuilder, rowIndex: int, colType: TemplateAutomaticTableBuilder.JaTdpTemplateAutomaticTableIcdColumnType) -> bool:
        """
         To modify the ICD column type in the table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def SetKPIColumnType(builder: TemplateAutomaticTableBuilder, rowIndex: int, colType: TemplateAutomaticTableBuilder.JaTdpTemplateAutomaticTableKpiColumnType) -> bool:
        """
         To modify the KPI column type in the table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def SetPADColumnType(builder: TemplateAutomaticTableBuilder, rowIndex: int, colType: TemplateAutomaticTableBuilder.JaTdpTemplateAutomaticTablePadColumnType) -> bool:
        """
         To modify the PAD column type in the table
         @return exists (bool): .
        """
    ...
    def SwapColumns(builder: TemplateAutomaticTableBuilder, index1: int, index2: int, length: int) -> bool:
        """
         To swap the columns in the table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def UpdateAttribute(builder: TemplateAutomaticTableBuilder, rowIndex: int, value: str) -> bool:
        """
         To modify the Attribute name in the table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def UpdateBomColumn(builder: TemplateAutomaticTableBuilder, rowIndex: int, colType: TemplateAutomaticTableBuilder.JaTdpTemplateAutomaticTableBomColumnType) -> bool:
        """
         To modify the Bom column type in the table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def UpdateHeader(builder: TemplateAutomaticTableBuilder, rowIndex: int, value: str) -> bool:
        """
         To modify the header column in table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def UpdatePmiColumn(builder: TemplateAutomaticTableBuilder, rowIndex: int, colType: TemplateAutomaticTableBuilder.JaTdpTemplateAutomaticTablePmiColumnType) -> bool:
        """
         To modify the Pmi column type in the table
         @return exists (bool): .
        """
    ...
    ## License requirements: None.
    ##  index of the column to be updated 
    def UpdateWidth(builder: TemplateAutomaticTableBuilder, rowIndex: int, value: float) -> bool:
        """
         To modify the Width value in the table
         @return exists (bool): .
        """
...
class TemplateAutomaticTablePMIFilterBuilder(NXOpen.TaggedObject): 
    ...
    def GetPmiFilterStatus(builder: TemplateAutomaticTablePMIFilterBuilder, pmiFilterType: TemplateAutomaticTablePMIFilterBuilder.Filter) -> bool:
        """
         Returns PMI filter status 
         @return pmiFilterStatus (bool): .
        """
    ...
    def SetPmiFilterStatus(builder: TemplateAutomaticTablePMIFilterBuilder, pmiFilterType: TemplateAutomaticTablePMIFilterBuilder.Filter, pmiFilterStatus: bool) -> None:
        """
         Sets PMI filter status 
        """
        pass
...
class TemplateFormFieldBuilder(TemplateBaseRectangleBuilder): 
    ...
    ##   the placeholder text used to identify the Form Field in the TDP Template environment  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the color and width of the Form Field lines   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.TextColorFontWidthBuilder NXOpen.TextColorFontWidthBuilder@endlink) TextCfw
    ##   the color, font, and width of the Form Field text   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class TemplateNoteBuilder(NXOpen.Annotations.DraftingNoteBuilder): 
    ...
    ## Getter for property: (str) Label
    ##   the label used to identify the Note in Publish   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class TemplatePageBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (float) Height
    ##   the custom or standard height for the page   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (float) Length
    ##   the custom or standard length to be used for the page to be created or edited.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the standard english size to be used for the page to be created or edited.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the standard metric size to be used for the page to be created or edited.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class TemplatePage(NXOpen.DisplayableObject): 
    ...
    ## License requirements: None.
    @staticmethod
    def Activate(page: TemplatePage) -> bool:
        """
         Activates the page so that it displays in the graphics area. 
                 <br> 
                An update is performed as part of activating page.  <br> 
...
class TemplatePrintViewBuilder(TemplateBaseRectangleBuilder): 
    ...
    ## Getter for property: (@link NXOpen.TextColorFontWidthBuilder NXOpen.TextColorFontWidthBuilder@endlink) TextCfw
    ##   the color, font, and width of the Print View text   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class TemplatePropertiesBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def GetDescription(builder: TemplatePropertiesBuilder) -> List[str]:
        """
         Returns the description 
         @return description (List[str]): .
        """
    ...
    ## License requirements: None.
    ##  
    def SetDescription(builder: TemplatePropertiesBuilder, description: List[str]) -> None:
        """
         Sets the description 
        """
        pass
...
class TemplateTableSectionBuilder(NXOpen.Builder): 
    ...
    ##   the origin, where the table is going to be displayed   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class TemplateViewCarouselBuilder(TemplateBaseRectangleBuilder): 
    ...
    ## Getter for property: (@link NXOpen.TextColorFontWidthBuilder NXOpen.TextColorFontWidthBuilder@endlink) TextCfw
    ##   the font, and width of the View Carousel text   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class TemplateViewListBuilder(TemplateBaseRectangleBuilder): 
    ...
    ## Getter for property: (@link NXOpen.TextColorFontWidthBuilder NXOpen.TextColorFontWidthBuilder@endlink) TextCfw
    ##   the color, font, and width of the View List text   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
