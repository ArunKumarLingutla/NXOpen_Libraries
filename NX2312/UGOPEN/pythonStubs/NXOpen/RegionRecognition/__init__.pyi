...
class RegionLibrary(NXOpen.Builder): 
    ...
    @staticmethod
    def AddRegion(builder: RegionLibrary) -> None:
        """
         Add a region to library 
        """
        pass
    ...
    def DeleteRegion(builder: RegionLibrary, regionName: str) -> None:
        """
         Delete a region from library 
        """
        pass
...
class RegionShapesBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    ##  Region face names 
    def SetFaceNames(builder: RegionShapesBuilder, faceNames: List[str]) -> None:
        """
         Assigns custom names to region faces. Ignored if the number of names differs from the number of faces. 
        """
        pass
    ...
    ## License requirements: None.
    ##  Region faces 
    def SetFaces(builder: RegionShapesBuilder, faces: List[NXOpen.Face]) -> None:
        """
         Sets the region faces.
        """
        pass
...
class SelectSimilarFacesBuilder(NXOpen.Builder): 
    ...
    def AISearchRegion(builder: SelectSimilarFacesBuilder, onnxModelPath: str) -> List[ShapeRegion]:
        """
         Use AI to Search Region
         @return resultRegions (@link ShapeRegion List[NXOpen.RegionRecognition.ShapeRegion]@endlink):   .
        """
    ...
    def FindRibs(builder: SelectSimilarFacesBuilder, body: NXOpen.TaggedObject, direction: NXOpen.Vector3d) -> List[ShapeRegion]:
        """
         Find ribs 
         @return resultRegions (@link ShapeRegion List[NXOpen.RegionRecognition.ShapeRegion]@endlink):   .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    ##  number of regions to be merged 
    def MergeOverlappingRegions(builder: SelectSimilarFacesBuilder, originalReigons: List[ShapeRegion]) -> List[ShapeRegion]:
        """
         Merge overlapping regions 
         @return mergedReigons (@link ShapeRegion List[NXOpen.RegionRecognition.ShapeRegion]@endlink):  number of merged regions .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    @staticmethod
    def PerformSearch(builder: SelectSimilarFacesBuilder) -> List[ShapeRegion]:
        """
         Perform a search 
         @return resultRegions (@link ShapeRegion List[NXOpen.RegionRecognition.ShapeRegion]@endlink):   .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    ##  selected key faces 
    def SetKeyFaces(builder: SelectSimilarFacesBuilder, selected_key_faces: List[NXOpen.TaggedObject]) -> None:
        """
         Set key faces 
        """
        pass
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    ##  number of objects to search in 
    def SetObjectsToSearchIn(builder: SelectSimilarFacesBuilder, objects: List[NXOpen.TaggedObject]) -> bool:
        """
         Set objects (parts, bodies or faces) to search in 
         @return added (bool):  True if succesully added objects to the builder, otherwise return False. .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    ##  number of parts to search in 
    def SetPartsToSearch(builder: SelectSimilarFacesBuilder, parts: List[NXOpen.TaggedObject]) -> bool:
        """
         Set parts to search 
         @return added (bool):  True if succesully added parts to the builder, otherwise return False. .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    ##  number of items for this region 
    def SetSeedRegionFromFaces(builder: SelectSimilarFacesBuilder, objects: List[NXOpen.TaggedObject]) -> bool:
        """
         Set a new seed region to the builder from selected faces, this function will remove all of old regions from the builder 
         @return added (bool):  True if succesully added this region to the builder, otherwise return False. .
        """
    ...
    ## 
    ## <param name="regionName"> (str) </param>
    def SetSeedRegionFromLibrary(builder: SelectSimilarFacesBuilder, regionName: str) -> bool:
        """
         Set a new seed region to the builder from file, this function will remove all of old regions from the builder 
         @return added (bool):  True if succesully added this region to the builder, otherwise return False. .
        """
    ...
    ## <param name="regionName"> (str) </param>
    def SetSeedRegionFromReuseLibrary(builder: SelectSimilarFacesBuilder, regionPath: str, regionName: str) -> bool:
        """
         Set a new seed region to the builder from reuse region file, this function will remove all of old regions from the builder 
         @return added (bool):  True if succesully added this region to the builder, otherwise return False. .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    ##  selected faces 
    def SetSelectedFaces(builder: SelectSimilarFacesBuilder, selected_faces: List[NXOpen.TaggedObject]) -> None:
        """
         Set a selected faces 
        """
        pass
    ...
    ## <param name="direction"> (@link NXOpen.Vector3d NXOpen.Vector3d@endlink) </param>
    def UpdateRib(builder: SelectSimilarFacesBuilder, sideFace1: NXOpen.TaggedObject, sideFace2: NXOpen.TaggedObject, direction: NXOpen.Vector3d) -> ShapeRegion:
        """
         Update rib 
         @return updatedRegions (@link ShapeRegion NXOpen.RegionRecognition.ShapeRegion@endlink):   .
        """
...
class ShapeRegion(NXOpen.TaggedObject): 
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    @staticmethod
    def AskCategory(region: ShapeRegion) -> str:
        """
         Ask a category 
         @return regionCategory (str): .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    @staticmethod
    def AskName(region: ShapeRegion) -> str:
        """
         Ask a name 
         @return regionName (str): .
        """
    ...
    def FindFaceByCustomName(region: ShapeRegion, customName: str) -> NXOpen.Face:
        """
         Find a matching face 
         @return matchingFace (@link NXOpen.Face NXOpen.Face@endlink): .
        """
    ...
    def FindMatchingEdges(region: ShapeRegion, seedEdge: NXOpen.Edge) -> List[NXOpen.Edge]:
        """
         Find a matching edge 
         @return matchingEdges (@link NXOpen.Edge List[NXOpen.Edge]@endlink): .
        """
    ...
    def FindMatchingFace(region: ShapeRegion, seedFace: NXOpen.Face) -> NXOpen.Face:
        """
         Find a matching face 
         @return matchingFace (@link NXOpen.Face NXOpen.Face@endlink): .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    @staticmethod
    def GetEdges(region: ShapeRegion) -> List[NXOpen.Edge]:
        """
         Get a region edges 
         @return edges (@link NXOpen.Edge List[NXOpen.Edge]@endlink): .
        """
    ...
    ## License requirements: nx_ml_region_finder (" Shape Region Recognition")
    @staticmethod
    def GetFaces(region: ShapeRegion) -> List[NXOpen.Face]:
        """
         Get a region faces 
         @return faces (@link NXOpen.Face List[NXOpen.Face]@endlink):   .
        """
...
class ValidationExportBuilder(NXOpen.Builder): 
    ...
    def AssignSidToResultRegions(builder: ValidationExportBuilder, writePartTag: NXOpen.NXObject) -> bool:
        """
         Set a new seed region to the builder from file, this function will remove all of old regions from the builder 
         @return added (bool):  True if succesully added this region to the builder, otherwise return False. .
        """
    ...
    def SetRegionProperty(builder: ValidationExportBuilder, regionName: str, seedRegionName: str, selfFacesSid: List[str], mappingFacesSid: List[str], selfFacesTag: List[NXOpen.TaggedObject], selfFacesTagSid: List[str], regionFacesTag: List[NXOpen.TaggedObject], isSeedRegion: bool) -> bool:
        """
         Set a new seed region to the builder from file, this function will remove all of old regions from the builder 
         @return added (bool):  True if succesully added this region to the builder, otherwise return False. .
        """
