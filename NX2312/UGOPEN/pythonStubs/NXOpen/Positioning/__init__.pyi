...
class ComponentConstraintGroupBuilder(NXOpen.Builder): 
    ...
    ##   the constraint collection types   
    ##     
    ##  
    ...
    ##   the toggle to remember selected component   
    ##     
    ##  
    ## Getter License requirements: assemblies ("ASSEMBLIES MODULE")
    ## 
    ...
    @staticmethod
    def GetContextComponent(builder: ComponentConstraintGroupBuilder) -> NXOpen.Assemblies.Component:
        """
...
class ComponentConstraintGroup(NXOpen.NXObject): 
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetConstraintCollectionType(group: ComponentConstraintGroup) -> ComponentConstraintGroup.ConstraintsCollectionType:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetDefiningComponents(group: ComponentConstraintGroup) -> List[NXOpen.Assemblies.Component]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetDefiningConstraints(group: ComponentConstraintGroup) -> List[ComponentConstraint]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetMemberConstraints(group: ComponentConstraintGroup) -> List[ComponentConstraint]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetRememberComponentState(group: ComponentConstraintGroup) -> bool:
        """
    ...
    def SetConstraintCollectionType(group: ComponentConstraintGroup, constraintCollectionType: ComponentConstraintGroup.ConstraintsCollectionType) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Defining components 
    def SetDefiningComponents(group: ComponentConstraintGroup, constraints: List[NXOpen.Assemblies.Component]) -> None:
        """
    ...
    def SetDefiningConstraints(group: ComponentConstraintGroup, constraints: List[ComponentConstraint]) -> None:
        """
    ...
    def SetRememberComponentState(group: ComponentConstraintGroup, rememberComponentState: bool) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def UpdateMemberConstraints(group: ComponentConstraintGroup) -> bool:
        """
...
"""
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def CopyInheritedToOverride(constraint: ComponentConstraint) -> ComponentConstraint:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def CopyToOverride(constraint: ComponentConstraint) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The component constrained to the specified constraint. 
    def GetDirectionToFixed(constraint: ComponentConstraint, component: NXOpen.Assemblies.Component, arrangement: NXOpen.Assemblies.Arrangement) -> ComponentConstraint.DirectionToFixed:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetInherited(constraint: ComponentConstraint) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetSeparateSuppression(constraint: ComponentConstraint) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetSharedSuppressed(constraint: ComponentConstraint) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##   The @link NXOpen::Assemblies::Arrangement NXOpen::Assemblies::Arrangement@endlink  in which the arrangement specific state is being enquired. 
    def GetSpecificInArrangement(constraint: ComponentConstraint, arrangement: NXOpen.Assemblies.Arrangement) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##   The @link NXOpen::Assemblies::Arrangement NXOpen::Assemblies::Arrangement@endlink  in which the suppression state is being enquired. 
    def GetSuppressedInArrangement(constraint: ComponentConstraint, arrangement: NXOpen.Assemblies.Arrangement) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink  on which the constraint is remembered 
    def RememberOnComponent(constraint: ComponentConstraint, component: NXOpen.Assemblies.Component) -> None:
        """
    ...
    def SetSeparateSuppression(constraint: ComponentConstraint, separate_suppression: bool) -> None:
        """
    ...
    def SetSharedSuppressed(constraint: ComponentConstraint, suppressed: bool) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##   The @link NXOpen::Assemblies::Arrangement NXOpen::Assemblies::Arrangement@endlink  in which the arrangement specific state is being set. 
    def SetSpecificInArrangement(constraint: ComponentConstraint, arrangement: NXOpen.Assemblies.Arrangement, arrangement_specific: bool) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##   The @link NXOpen::Assemblies::Arrangement NXOpen::Assemblies::Arrangement@endlink  in which the suppression state is being set. 
    def SetSuppressedInArrangement(constraint: ComponentConstraint, arrangement: NXOpen.Assemblies.Arrangement, suppressed: bool) -> None:
        """
...
"""
    ...
    ##   the flag that enables the positioner to reposition dumb geometry.  
    ##     Dumb geometry
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def BeginAssemblyConstraints(positioner: ComponentPositioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def BeginMoveComponent(positioner: ComponentPositioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def BeginMoveComponentInWorkset(positioner: ComponentPositioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def EndAssemblyConstraints(positioner: ComponentPositioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def EndMoveComponent(positioner: ComponentPositioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def EndMoveComponentInWorkset(positioner: ComponentPositioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Constraints 
    def LoadConstraintGeometry(positioner: ComponentPositioner, constraints: List[ComponentConstraint]) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def SolvePostponedConstraints(positioner: ComponentPositioner) -> None:
        """
...
"""
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetGeometry(constraint_reference: ConstraintReference) -> NXOpen.NXObject:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetHasPerpendicularVector(constraint_reference: ConstraintReference) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetMovableObject(constraint_reference: ConstraintReference) -> NXOpen.NXObject:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetPrototypeGeometry(constraint_reference: ConstraintReference) -> NXOpen.NXObject:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetPrototypePerpendicularVector(constraint_reference: ConstraintReference) -> NXOpen.Vector3d:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetUsePortRotate(constraint_reference: ConstraintReference) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetUsesGeometryAxis(constraint_reference: ConstraintReference) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Set or unset the hint 
    def SetFixHint(constraint_reference: ConstraintReference, set: bool) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Set or unset the hint 
    def SetFixHintForUpdate(constraint_reference: ConstraintReference, set: bool) -> None:
        """
    ...
    def SetPrototypePerpendicularVector(constraint_reference: ConstraintReference, perpendicular_vector: NXOpen.Vector3d) -> None:
        """
...
"""
    ...
    ##   the flag marking the constraint as an "automatic" constraint.  
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Object to be positioned by constraint 
    @overload
    def CreateConstraintReference(self, constraint: Constraint, movable_object: NXOpen.NXObject, geometry: NXOpen.NXObject, uses_axis: bool, is_indirect: bool) -> ConstraintReference:
        """
    ...
    ##  Object to be positioned by constraint 
    @overload
    def CreateConstraintReference(self, constraint: Constraint, movable_object: NXOpen.NXObject, geometry: NXOpen.NXObject, uses_axis: bool, is_indirect: bool, use_port_rotate: bool) -> ConstraintReference:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link NXOpen::Positioning::Constraint NXOpen::Positioning::Constraint@endlink  to be coupled 
    def CreateCouplerReference(coupler: Constraint, coupledConstraint: NXOpen.NXObject) -> ConstraintReference:
        """
    ...
    def DeleteConstraintReference(constraint: Constraint, constraint_reference: ConstraintReference) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link NXOpen::Positioning::ConstraintReference NXOpen::Positioning::ConstraintReference@endlink  whose properties are to be changed 
    def EditConstraintReference(constraint: Constraint, constraint_reference: ConstraintReference, movable_object: NXOpen.NXObject, geometry: NXOpen.NXObject, uses_axis: bool, is_indirect: bool, use_port_rotate: bool) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link NXOpen::Positioning::ConstraintReference NXOpen::Positioning::ConstraintReference@endlink  whose properties are to be changed
    def EditCouplerReference(coupler: Constraint, couplerReference: ConstraintReference, coupledConstraint: NXOpen.NXObject) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def FlipAlignment(constraint: Constraint) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GenerateConversionReport(constraint: Constraint) -> List[str]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetConstraintStatus(constraint: Constraint) -> Constraint.SolverStatus:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetDisplayedConstraint(constraint: Constraint) -> DisplayedConstraint:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetReferences(constraint: Constraint) -> List[ConstraintReference]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def Renew(constraint: Constraint) -> None:
        """
         Changes the constraint to solve with the latest version of the constraint code. 
        """
        pass
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def ReverseDirection(constraint: Constraint) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The alignment hint 
    def SetAlignmentHint(constraint: Constraint, alignment: Constraint.Alignment) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Name of expression used in the constraint 
    def SetExpression(constraint: Constraint, expression: str) -> None:
        """
...
class DisplayedConstraint(NXOpen.DisplayableObject): 
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetConstraint(displayed_constraint: DisplayedConstraint) -> Constraint:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetConstraintPart(displayed_constraint: DisplayedConstraint) -> NXOpen.Part:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetContextComponent(displayed_constraint: DisplayedConstraint) -> NXOpen.Assemblies.Component:
        """
...
class MatingConverter(NXOpen.TaggedObject): 
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def ConvertMatingConditions(converter: MatingConverter) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def DeleteResults(converter: MatingConverter) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def Destroy(converter: MatingConverter) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetConvertedConstraints(converter: MatingConverter) -> List[Constraint]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def GetConvertedParts(converter: MatingConverter) -> List[Constraint]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Whether to show results for all converted constraints even if no issues arose during their conversion 
    def GetLatestResults(converter: MatingConverter, show_all_results: bool) -> List[str]:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Whether to show results for all converted constraints even if no issues arose during their conversion 
    def GetResults(converter: MatingConverter, show_all_results: bool) -> List[str]:
        """
...
"""
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link Constraint Constraint@endlink  to be added 
    def AddConstraint(network: Network, constraint: Constraint) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  An @link NXObject NXObject@endlink  to be moved 
    def AddMovableObject(network: Network, movable_object: NXOpen.NXObject) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def ApplyToModel(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def BeginDrag(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  A point on the ray 
    def DragByRay(network: Network, point: NXOpen.Point3d, direction: NXOpen.Vector3d) -> None:
        """
    ...
    def DragByTransform(network: Network, translation: NXOpen.Vector3d, rotation: NXOpen.Matrix3x3) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The translation to be applied 
    def DragByTranslation(network: Network, translation: NXOpen.Vector3d) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def EmptyMovingGroup(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def EndDrag(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  An @link NXObject NXObject@endlink  positioned by the network 
    def GetMovableObjectStatus(network: Network, movable_object: NXOpen.NXObject) -> Network.ObjectStatus:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def IsReferencedGeometryLoaded(network: Network) -> bool:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def LoadReferencedGeometry(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def RemoveAllConstraints(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link Constraint Constraint@endlink  to be removed 
    def RemoveConstraint(network: Network, constraint: Constraint) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  An @link NXObject NXObject@endlink  to be removed from the network 
    def RemoveMovableObject(network: Network, movable_object: NXOpen.NXObject) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def ResetDisplay(network: Network) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  The @link NXObject NXObject@endlink s to be moved 
    def SetMovingGroup(network: Network, movable_objects: List[NXOpen.NXObject]) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def Solve(network: Network) -> None:
        """
...
"""
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def ClearNetwork(positioner: Positioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    ##  Persistent state of constraint 
    @overload
    def CreateConstraint(self, positioner: Positioner, persistent: bool) -> Constraint:
        """
    ...
    @overload
    def CreateConstraint(self, positioner: Positioner) -> Constraint:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def DeleteNonPersistentConstraints(positioner: Positioner) -> None:
        """
    ...
    ## License requirements: assemblies ("ASSEMBLIES MODULE")
    @staticmethod
    def EstablishNetwork(positioner: Positioner) -> Network:
        """
