...
class JointJogBuilder(NXOpen.Builder): 
    ...
    def AddJointToMap(builder: JointJogBuilder, nxkJoint: NXOpen.TaggedObject, distance: float) -> None:
        """
         Add JointToMap
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def ApplyJoints(builder: JointJogBuilder) -> None:
        """
         Apply Joints 
        """
        pass
    ...
    ## License requirements: None.
    ##  
    def ApplyPose(builder: JointJogBuilder, selectedPartOccTag: NXOpen.NXObject) -> None:
        """
         Apply Pose 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def ClearJointValuePairVector(builder: JointJogBuilder) -> None:
        """
         Clear m_jointValuePairVector
        """
        pass
    ...
    def DryApplyPoseForPartOcc(builder: JointJogBuilder, partOccTag: NXOpen.TaggedObject) -> None:
        """
         Dry apply pose for part occ
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetLastJoggedDevice(builder: JointJogBuilder) -> NXOpen.NXObject:
        """
         Get the last jogged device in case of multi devices jogging
         @return lastDeviceJoggedDevice (@link NXOpen.NXObject NXOpen.NXObject@endlink):  .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def RemoveAllJointMap(builder: JointJogBuilder) -> None:
        """
         Remove JointToMap
        """
        pass
    ...
    def SetJointJogBehaviour(builder: JointJogBuilder, sDlgTitle: str, eDlgState: int, sPoseName: str, tDeviceTag: NXOpen.NXObject) -> None:
        """
         Set Joint Jog dialog behaviour data 
        """
        pass
    ...
    ## License requirements: None.
    ##  
    def SetLastJoggedDevice(builder: JointJogBuilder, lastDeviceJoggedDevice: NXOpen.NXObject) -> None:
        """
         Set the last jogged device in case of multi devices jogging
        """
        pass
    ...
    def UpdateJointToMap(builder: JointJogBuilder, nxkJoint: NXOpen.TaggedObject, newValue: float) -> None:
        """
         Update JointToMap
        """
        pass
    ...
    ## <param name="nxkJoint"> (@link NXOpen.TaggedObject NXOpen.TaggedObject@endlink) </param>
    ## <param name="newValue"> (float) </param>
    def UpdateJointValuePairVector(builder: JointJogBuilder, nxkJoint: NXOpen.TaggedObject, newValue: float) -> None:
        """
         Update m_jointValuePairVector 
        """
        pass
    ...
    def UpdatePartOccToJointVectorMapPtr(builder: JointJogBuilder, partOccTag: NXOpen.TaggedObject, nxkJointTag: NXOpen.TaggedObject) -> None:
        """
         Update m_partOccToJointVectorMapPtr
        """
        pass
...
class PoseEditorBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def AddPoseButton(builder: PoseEditorBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    ## 
    ## <param name="tDeviceTag"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def CreateHomePose(builder: PoseEditorBuilder, tDeviceTag: NXOpen.NXObject) -> None:
        """
         Create Home Pose 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def DeletePoseButton(builder: PoseEditorBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def EditPoseButton(builder: PoseEditorBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def JumpPoseButton(builder: PoseEditorBuilder) -> None:
        """
         TODO: fill in a description for this 
        """
        pass
    ...
    def LoadInstancePoseInMinimalLoad(builder: PoseEditorBuilder, displayObj: NXOpen.NXObject) -> None:
        """
         Load Instance Poses for selected object or current work part in minimal load
        """
        pass
    ...
    ## 
    ## <param name="tDeviceTag"> (@link NXOpen.NXObject NXOpen.NXObject@endlink) </param>
    def ResetHomePoseValues(builder: PoseEditorBuilder, tDeviceTag: NXOpen.NXObject) -> None:
        """
         Reset Home Pose Values
        """
        pass
