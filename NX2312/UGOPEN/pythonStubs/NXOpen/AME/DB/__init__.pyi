...
class DocumentStructure(NXOpen.TaggedObject): 
    ...
    @staticmethod
    def GetClassificationCode(docStruct: DocumentStructure) -> str:
        """
         Get the Classification Code. 
         @return dccString (str): .
        """
    ...
    ## License requirements: ad_automation_design ("FULL AUTOMATION DESIGNER")
    @staticmethod
    def GetDocumentStructureString(docStruct: DocumentStructure) -> str:
        """
         Get the Document Structure string from Document Structur object. 
         @return docStructString (str): .
        """
    ...
    def SetClassificationCode(docStruct: DocumentStructure, dccString: str) -> None:
        """
         Set the Classification Code. 
        """
        pass
    ...
    @overload
    def SetDocumentStructure(self, docStruct: DocumentStructure, firstAttr: DocumentStructure.Attribute, secondAttr: DocumentStructure.Attribute, thirdAttr: DocumentStructure.Attribute, fourthAttr: DocumentStructure.Attribute) -> None:
        """
         Set all four attributes of Document Structure order in sequence. 
        """
        pass
    ...
    ## <param name="thirdAttr"> (@link DocumentStructure.Attribute NXOpen.AME.DB.DocumentStructure.Attribute@endlink) </param>
    @overload
    def SetDocumentStructure(self, docStruct: DocumentStructure, firstAttr: DocumentStructure.Attribute, secondAttr: DocumentStructure.Attribute, thirdAttr: DocumentStructure.Attribute) -> None:
        """
         Set any three attributes of Document Structure order in sequence 
        """
        pass
    ...
    ## <param name="secondAttr"> (@link DocumentStructure.Attribute NXOpen.AME.DB.DocumentStructure.Attribute@endlink) </param>
    @overload
    def SetDocumentStructure(self, docStruct: DocumentStructure, firstAttr: DocumentStructure.Attribute, secondAttr: DocumentStructure.Attribute) -> None:
        """
         Set any two attributes of Document Structure order in sequence. 
        """
        pass
    ...
    ## <param name="firstAttr"> (@link DocumentStructure.Attribute NXOpen.AME.DB.DocumentStructure.Attribute@endlink) </param>
    @overload
    def SetDocumentStructure(self, docStruct: DocumentStructure, firstAttr: DocumentStructure.Attribute) -> None:
        """
         Set any one attribute of Document Structure order. 
        """
        pass
