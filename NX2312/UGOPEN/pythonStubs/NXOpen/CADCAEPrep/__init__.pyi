...
class BeamSectionBar(IBeamSection): 
    ...
    def Edit(source: BeamSectionBar, width: float, height: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionBox(IBeamSection): 
    ...
    def Edit(source: BeamSectionBox, width: float, height: float, thicknessTopBottom: float, thicknessSides: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionChan(IBeamSection): 
    ...
    def Edit(source: BeamSectionChan, width: float, height: float, webThickness: float, flangeThickness: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionHexa(IBeamSection): 
    ...
    ## <param name="height"> (float) </param>
    def Edit(source: BeamSectionHexa, sideWidth: float, overallWidth: float, height: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionI(IBeamSection): 
    ...
    def Edit(source: BeamSectionI, height: float, widthBottomFlange: float, widthTopFlange: float, thicknessWeb: float, thicknessBottomFlange: float, thicknessTopFlange: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionL(IBeamSection): 
    ...
    def Edit(source: BeamSectionL, lengthVertical: float, lengthHorizontal: float, thicknessHorizontal: float, thicknessVertical: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionRod(IBeamSection): 
    ...
    def Edit(source: BeamSectionRod, radius: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionSketch(IBeamSection): 
    ...
    ##   the offset between the origin and the center of the bounding box   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def Edit(source: BeamSectionSketch, sketch: NXOpen.Sketch) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionTube(IBeamSection): 
    ...
    def Edit(source: BeamSectionTube, radiusOutside: float, radiusInside: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class BeamSectionT(IBeamSection): 
    ...
    ## <param name="flangeThickness"> (float) </param>
    ## <param name="webThickness"> (float) </param>
    def Edit(source: BeamSectionT, width: float, height: float, flangeThickness: float, webThickness: float) -> None:
        """
         Edit the section parameters 
        """
        pass
...
class IdealizedBeamManager(NXOpen.Object): 
    ...
    ## <param name="width"> (float) </param>
    ## <param name="height"> (float) </param>
    def AddBeamSectionBar(part: IdealizedBeamManager, sectionName: str, width: float, height: float) -> BeamSectionBar:
        """
         Add a beam section Bar 
         @return section (@link BeamSectionBar NXOpen.CADCAEPrep.BeamSectionBar@endlink):  the new section .
        """
    ...
    ## <param name="thicknessTopBottom"> (float) </param>
    ## <param name="thicknessSides"> (float) </param>
    def AddBeamSectionBox(part: IdealizedBeamManager, sectionName: str, width: float, height: float, thicknessTopBottom: float, thicknessSides: float) -> BeamSectionBox:
        """
         Add a beam section Box
         @return section (@link BeamSectionBox NXOpen.CADCAEPrep.BeamSectionBox@endlink):  the new section .
        """
    ...
    ## <param name="flangeThickness"> (float) </param>
    ## <param name="webThickness"> (float) </param>
    def AddBeamSectionChan(part: IdealizedBeamManager, sectionName: str, width: float, height: float, flangeThickness: float, webThickness: float) -> BeamSectionChan:
        """
         Add a beam section Chan
         @return section (@link BeamSectionChan NXOpen.CADCAEPrep.BeamSectionChan@endlink):  the new section .
        """
    ...
    ## <param name="overallWidth"> (float) </param>
    ## <param name="height"> (float) </param>
    def AddBeamSectionHexa(part: IdealizedBeamManager, sectionName: str, sideWidth: float, overallWidth: float, height: float) -> BeamSectionHexa:
        """
         Add a beam section Hexa
         @return section (@link BeamSectionHexa NXOpen.CADCAEPrep.BeamSectionHexa@endlink):  the new section .
        """
    ...
    ## <param name="thicknessBottomFlange"> (float) </param>
    ## <param name="thicknessTopFlange"> (float) </param>
    def AddBeamSectionI(part: IdealizedBeamManager, sectionName: str, height: float, widthBottomFlange: float, widthTopFlange: float, thicknessWeb: float, thicknessBottomFlange: float, thicknessTopFlange: float) -> BeamSectionI:
        """
         Add a beam section I 
         @return section (@link BeamSectionI NXOpen.CADCAEPrep.BeamSectionI@endlink):  the new section .
        """
    ...
    ## <param name="thicknessVertical"> (float) </param>
    ## <param name="thicknessHorizontal"> (float) </param>
    def AddBeamSectionL(part: IdealizedBeamManager, sectionName: str, lengthVertical: float, lengthHorizontal: float, thicknessVertical: float, thicknessHorizontal: float) -> BeamSectionL:
        """
         Add a beam section L 
         @return section (@link BeamSectionL NXOpen.CADCAEPrep.BeamSectionL@endlink):  the new section .
        """
    ...
    ## <param name="sectionName"> (str) </param>
    ## <param name="radius"> (float) </param>
    def AddBeamSectionRod(part: IdealizedBeamManager, sectionName: str, radius: float) -> BeamSectionRod:
        """
         Add a beam section Rod
         @return section (@link BeamSectionRod NXOpen.CADCAEPrep.BeamSectionRod@endlink):  the new section .
        """
    ...
    def AddBeamSectionSketch(part: IdealizedBeamManager, sectionName: str, sketchTag: NXOpen.Sketch) -> BeamSectionSketch:
        """
         Add a beam section Sketch 
         @return section (@link BeamSectionSketch NXOpen.CADCAEPrep.BeamSectionSketch@endlink):  the new section .
        """
    ...
    ## <param name="flangeThickness"> (float) </param>
    ## <param name="webThickness"> (float) </param>
    def AddBeamSectionT(part: IdealizedBeamManager, sectionName: str, width: float, height: float, flangeThickness: float, webThickness: float) -> BeamSectionT:
        """
         Add a beam section T
         @return section (@link BeamSectionT NXOpen.CADCAEPrep.BeamSectionT@endlink):  the new section .
        """
    ...
    ## <param name="radiusOutside"> (float) </param>
    ## <param name="radiusInside"> (float) </param>
    def AddBeamSectionTube(part: IdealizedBeamManager, sectionName: str, radiusOutside: float, radiusInside: float) -> BeamSectionTube:
        """
         Add a beam section Tube 
         @return section (@link BeamSectionTube NXOpen.CADCAEPrep.BeamSectionTube@endlink):  the new section .
        """
    ...
    def AddIdealizedBeam(part: IdealizedBeamManager, curve: NXOpen.Curve) -> IdealizedBeam:
        """
         Add an idealized beam 
         @return idealizedBeam (@link IdealizedBeam NXOpen.CADCAEPrep.IdealizedBeam@endlink):  the new idealized beam .
        """
    ...
    ## License requirements: None.
    ##  the curve
    def GetIdealizedBeam(part: IdealizedBeamManager, curve: NXOpen.Curve) -> IdealizedBeam:
        """
         Get idealized beam from curve 
         @return ibeam (@link IdealizedBeam NXOpen.CADCAEPrep.IdealizedBeam@endlink):  the idealized beam .
        """
    ...
    ## 
    ## <param name="sectionName"> (str) </param>
    def GetSection(part: IdealizedBeamManager, sectionName: str) -> IBeamSection:
        """
         Get section by name 
         @return section (@link IBeamSection NXOpen.CADCAEPrep.IBeamSection@endlink):  the section .
        """
...
class IdealizedBeam(NXOpen.NXObject): 
    ...
    ##   the associated body used to infer the material   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def GetOrientationByVector(idealizedBeam: IdealizedBeam) -> Tuple[NXOpen.Vector3d, OrientationByVector.OrientAxis, bool, bool]:
        """
         The orientation by vector:
                         The section orientation is determined by the 3d vector parameter OrienVect that corresponds to either the Y axis or Z axis depending on the OrientAxis parameter.
                         The coordinate system of the section is determined as follows:
    ...
    def SetOrientationByVector(idealizedBeam: IdealizedBeam, orientVect: NXOpen.Vector3d, orientAxis: OrientationByVector.OrientAxis, flipY: bool, flipZ: bool) -> None:
        """
         Set the orientation by vector 
                         The section orientation is determined by the 3d vector parameter OrienVect that corresponds to either the Y axis or Z axis depending on the OrientAxis parameter.
                         The coordinate system of the section is determined as follows:
