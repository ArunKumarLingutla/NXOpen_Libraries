...
class AddPlyPieceBuilder(NXOpen.Builder): 
    ...
    ##   the selected @link Composites::Features::Region Composites::Features::Region@endlink , defining the extents of the @link Composites::PlyPiece Composites::PlyPiece@endlink   
    ##     
    ##  
    ...
    ##   the @link Composites::Ply Composites::Ply@endlink  to be spliced.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class Base(NXOpen.DisplayableObject): 
    ...
    def SetName(baseObj: Base, desiredName: str) -> None:
        """
         Overrides the default function for setting an object's name, respecting the case of the provided name 
        """
        pass
...
class CompositePart(Base): 
    ...
    ##   the center of mass of the @link Composites::CompositePart Composites::CompositePart@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the mass of the @link Composites::CompositePart Composites::CompositePart@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the moment of inertia of the @link Composites::CompositePart Composites::CompositePart@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def GetOrderedCores(compositePart: CompositePart) -> List[CrossSection]:
        """
         The ordered list of cores of the @link Composites::CompositePart Composites::CompositePart@endlink . 
         @return orderedCores (@link CrossSection List[NXOpen.Composites.CrossSection]@endlink): .
        """
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def GetOrderedLaminates(compositePart: CompositePart) -> List[Laminate]:
        """
         The ordered list of laminates of the @link Composites::CompositePart Composites::CompositePart@endlink . 
         @return orderedLaminates (@link Laminate List[NXOpen.Composites.Laminate]@endlink): .
        """
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def GetOrderedLaminatesAndCores(compositePart: CompositePart) -> List[Base]:
        """
         The ordered list of laminates and cores of the @link Composites::CompositePart Composites::CompositePart@endlink . 
         @return orderedLaminatesAndCores (@link Base List[NXOpen.Composites.Base]@endlink): .
        """
    ...
    def ResequenceChildren(compositePart: CompositePart, children_to_resequence: List[Base], target_child: Base, insert_option: CompositePart.ResequenceInsertOption) -> None:
        """
         Resequences the given children before or after the provided target child. 
        """
        pass
...
class CompositesCollectionValidator(NXOpen.TaggedObject): 
    ...
    ##   the flag controlling whether composite parts are included in the composites collection validation  
    ##     
    ##  
    ...
    ##   the flag controlling whether detailed object status is included in the composites collection validation  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag controlling whether to export the Mass Properties  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag controlling whether rosettes are included in the composites collection validation  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class CoreBuilder(NXOpen.Builder): 
    ...
    ##   the solid defining the shape of the @link Composites::Core Composites::Core@endlink   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class Core(Base): 
    ...
    ## Getter for property: (@link NXOpen.Point3d NXOpen.Point3d@endlink) CenterOfMass
    ##   the center of mass of the @link Composites::Core Composites::Core@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the density of the @link Composites::Core Composites::Core@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (float) Mass
    ##   the mass of the @link Composites::Core Composites::Core@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink) MomentOfInertia
    ##   the moment of inertia of the @link Composites::Core Composites::Core@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the volume of the @link Composites::Core Composites::Core@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class CrossSectionBuilder(NXOpen.Builder): 
    ...
    ##   the end limit of the @link Composites::CrossSection Composites::CrossSection@endlink .  
    ...
    ##   the plane to intersect composite objects of the @link Composites::CrossSection Composites::CrossSection@endlink .  
    ...
    ##   the scale for ply height in the @link Composites::CrossSection Composites::CrossSection@endlink .  
    ...
    ##   the start limit of the @link Composites::CrossSection Composites::CrossSection@endlink .  
    ##    Cross section will be trimmed by this limit.  
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class DartBuilder(NXOpen.Builder): 
    ...
    ##   the @link Composites::IPly Composites::IPly@endlink  to be darted.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the section defining the single, open curve to cut into 
...
class DesignStationBuilder(NXOpen.Builder): 
    ...
    ##   the @link Point Point@endlink  specifying where the @link Composites::DesignStation Composites::DesignStation@endlink  is calculated   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class FlatPatternToDxfBuilder(NXOpen.Builder): 
    ...
    ##   the DXF Version of the DXF output.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the file directory of the DXF output.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the file name of the DXF output.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link Composites::IPly Composites::IPly@endlink  to output flat pattern results for.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class IPly(NXOpen.INXObject): 
    ...
    ##   the area of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Point3d NXOpen.Point3d@endlink) CenterOfMass
    ##   the center of mass of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the cured thickness of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (float) Density
    ##   the density of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (float) Mass
    ##   the mass of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink) MomentOfInertia
    ##   the moment of inertia of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the perimeter of the @link Composites::IPly Composites::IPly@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    @staticmethod
    @abstractmethod
    def HideRosetteMappedOrientationDisplay(ply: IPly) -> None:
        """
         Hide the ply's rosette-mapped orientation display 
        """
        pass
    ...
    @staticmethod
    @abstractmethod
    def ShowRosetteMappedOrientationDisplay(ply: IPly) -> None:
        """
         Show the ply's rosette-mapped orientation display 
        """
        pass
...
class LaminateBuilder(NXOpen.Builder): 
    ...
    ##   the @link Composites::Features::LayupSurface Composites::Features::LayupSurface@endlink  forming the surface upon which this laminate is defined    
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link Composites::Rosette Composites::Rosette@endlink  defining the @link Composites::Laminate Composites::Laminate@endlink 's coordinate system, providing an orientation reference for the @link Composites::Laminate Composites::Laminate@endlink 's child objects   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class Laminate(Base): 
    ...
    ## Getter for property: (@link NXOpen.Point3d NXOpen.Point3d@endlink) CenterOfMass
    ##   the center of mass of the @link Composites::Laminate Composites::Laminate@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (float) Mass
    ##   the mass of the @link Composites::Laminate Composites::Laminate@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (@link NXOpen.Matrix3x3 NXOpen.Matrix3x3@endlink) MomentOfInertia
    ##   the moment of inertia of the @link Composites::Laminate Composites::Laminate@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def GetOrderedImmediateChildPlies(laminate: Laminate) -> List[IPly]:
        """
         The ordered list of immediate child plies of the @link Composites::Laminate Composites::Laminate@endlink . These 
                plies may be superceded by other objects in the final design 
         @return orderedPlies (@link IPly List[NXOpen.Composites.IPly]@endlink): .
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def GetOrderedPlies(laminate: Laminate) -> List[IPly]:
        """
         The ordered list of 'final' plies of the @link Composites::Laminate Composites::Laminate@endlink . These plies define the laminate
                as it is intended to be manufactured. 
         @return orderedPlies (@link IPly List[NXOpen.Composites.IPly]@endlink): .
    ...
    def ResequencePlies(laminate: Laminate, plies_to_resequence: List[Ply], target_ply: Ply, insert_option: Laminate.ResequenceInsertOption) -> None:
        """
         Resequences the given plies before or after the provided target ply. 
        """
        pass
...
class LaserProjectionExportBase(NXOpen.Builder): 
    ...
    ## Getter for property: (str) ExportFileName
    ##   the base file name of the output file(s).  
    ##      
    ##  
    ...
    ##   the reference coordinate system for the laser projection system.  
    ##      
    ##  
    ## Getter License requirements: nx_composites_laser (" Export Laser Projection Data")
    ## 
    ...
    ##   the selection list containing reference points to output.  
    ##      
    ##  
    ## Getter License requirements: nx_composites_laser (" Export Laser Projection Data")
    ## 
    ...
    @staticmethod
    def DisableMaximumStepLengthEnforcement(exportObject: LaserProjectionExportBase) -> None:
        """
         Disable inserting additional points for long output boundary segments
        """
        pass
    ...
    def EnableMaximumStepLengthEnforcement(exportObject: LaserProjectionExportBase, maximumStepLength: float) -> None:
        """
         Enforce a maximum step length between consecutive points output for each output boundary
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def UseAlignedVisionOutputFormat(exportObject: LaserProjectionExportBase) -> None:
        """
         Sets the export to use the Aligned Vision format 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def UseFAROOutputFormat(exportObject: LaserProjectionExportBase) -> None:
        """
         Sets the export to use the FARO BuildIT format 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def UseLAPOutputFormat(exportObject: LaserProjectionExportBase) -> None:
        """
         Sets the export to use the LAP format 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def UseSLOutputFormat(exportObject: LaserProjectionExportBase) -> None:
        """
         Sets the export to use the SL (Seiffert Lasertechnik) format 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def UseVirtekPlyFormat(exportObject: LaserProjectionExportBase) -> None:
        """
         Sets the export to use the Virtek .ply format 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def UseXMLOutputFormat(exportObject: LaserProjectionExportBase) -> None:
        """
         Sets the export to use the generic Composites Laser XML format 
        """
        pass
...
class LaserProjectionExport(LaserProjectionExportBase): 
    ...
    ## Getter for property: (str) ExportDirectory
    ##   the file directory to create the output file(s)   
    ##     
    ##  
    ## Getter License requirements: nx_composites_laser (" Export Laser Projection Data")
    ## 
...
class Manager(NXOpen.Object): 
    ...
    ##  Creates a @link Composites::PlyFlatPatternToDxfBuilder Composites::PlyFlatPatternToDxfBuilder@endlink  to to output multiple flat patterns to a DXF file 
...
class PlyBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.Features.Feature NXOpen.Features.Feature@endlink) BoundaryRegion
    ##   the selected @link Composites::Features::Region Composites::Features::Region@endlink , defining the extents of the @link Composites::Ply Composites::Ply@endlink   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link Composites::Ply Composites::Ply@endlink 's orientation.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the list containing the single selected parent @link Composites::Laminate Composites::Laminate@endlink .  
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class PlyFlatPatternToDxfBuilderBase(NXOpen.Builder): 
    ...
    def AddPlies(builder: PlyFlatPatternToDxfBuilderBase, iPlies: List[IPly]) -> None:
        """
         Adds a collection of @link Composites::IPly Composites::IPly@endlink  to output flat pattern results for. 
        """
        pass
...
class Ply(Base): 
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def GetOrderedPlyPieces(ply: Ply) -> List[PlyPiece]:
        """
         The ordered list of @link Composites::PlyPiece Composites::PlyPiece@endlink  objects that  this
                @link Composites::Ply Composites::Ply@endlink  is broken up into 
         @return orderedPlyPieces (@link PlyPiece List[NXOpen.Composites.PlyPiece]@endlink): .
    ...
    def ResequencePlyPieces(ply: Ply, pieces_to_resequence: List[PlyPiece], target_ply_piece: PlyPiece, insert_option: Ply.ResequenceInsertOption) -> None:
        """
         Resequences the given ply pieces before or after the provided target ply piece. 
        """
        pass
...
class PreferencesBuilder(NXOpen.Builder): 
    ...
    ##   the color of the primary direction   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link DisplayableObject::ObjectWidth DisplayableObject::ObjectWidth@endlink  defining line width for Ply   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the color of the positive bias direction   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link DisplayableObject::ObjectWidth DisplayableObject::ObjectWidth@endlink  defining line width for Producibility   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link DisplayableObject::ObjectWidth DisplayableObject::ObjectWidth@endlink  defining line width for Rosette   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the color of the secondary direction   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class ProducibilityBuilder(NXOpen.Builder): 
    ...
    ##   the cell size of the @link Composites::Producibility Composites::Producibility@endlink  simulation.  
    ...
    ##   the starting @link Point Point@endlink  of the @link Composites::Producibility Composites::Producibility@endlink .  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the geometry defining the desired primary fiber direction for the @link Composites::Producibility Composites::Producibility@endlink  simulation.  
    ...
    ## Getter for property: (@link SelectIPly NXOpen.Composites.SelectIPly@endlink) Ply
    ##   the @link Composites::IPly Composites::IPly@endlink  on which the @link Composites::Producibility Composites::Producibility@endlink  is run.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def ClearResults(builder: ProducibilityBuilder) -> None:
        """
         Clears the current producibility simulation results, forcing a resimulation on commit 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def SetConstraintPropagationTypeGeodesic(builder: ProducibilityBuilder) -> None:
        """
         Sets the constraint propagation type to use a geodesic curve 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def SetConstraintPropagationTypeStandard(builder: ProducibilityBuilder) -> None:
        """
         Sets the constraint propagation type to use the standard type. 
        """
        pass
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def SetConstraintPropagationTypeToCurve(builder: ProducibilityBuilder) -> None:
        """
         Sets the constraint propagation type to use a user-specified curve 
        """
        pass
...
class Producibility(Base): 
    ...
    ## License requirements: nx_composites (" Composites")
    @staticmethod
    def PublishFlatPattern(producibility: Producibility) -> None:
        """
         Generate/update the @link Composites::FlatPattern Composites::FlatPattern@endlink  calculated from the draping simulation results
        """
        pass
...
class RosetteBuilder(NXOpen.Builder): 
    ...
    ##   the @link Composites::RosetteBuilder::StandardRosetteInfo Composites::RosetteBuilder::StandardRosetteInfo@endlink  defining the data required for the standard-mapping rosette.  
    ##      
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link CartesianCoordinateSystem CartesianCoordinateSystem@endlink  defining the orientations at a single location   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
"""
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectIPly) -> Tuple[IPly, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the object's view and point.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectIPly) -> Tuple[NXOpen.InferSnapType.SnapType, IPly, NXOpen.View, NXOpen.Point3d, IPly, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the objects view and point and snap information.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectIPly) -> Tuple[IPly, NXOpen.CaeObjectType.CaeSubType, int]:
        """
         The object being selected with CAE set object information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectIPly, selection: IPly, view: NXOpen.View, point: NXOpen.Point3d) -> None:
        """
         The object being selected with the object's view and object's point
    ...
    ##   snap point type
    @overload
    def SetValue(self, select_object: SelectIPly, snap_type: NXOpen.InferSnapType.SnapType, selection1: IPly, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: IPly, view2: NXOpen.View, point2: NXOpen.Point3d) -> None:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectIPly, selection: IPly, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> None:
        """
         The object being selected with CAE set object information.
...
"""
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectLaminate) -> Tuple[Laminate, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the object's view and point.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectLaminate) -> Tuple[NXOpen.InferSnapType.SnapType, Laminate, NXOpen.View, NXOpen.Point3d, Laminate, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the objects view and point and snap information.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectLaminate) -> Tuple[Laminate, NXOpen.CaeObjectType.CaeSubType, int]:
        """
         The object being selected with CAE set object information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectLaminate, selection: Laminate, view: NXOpen.View, point: NXOpen.Point3d) -> None:
        """
         The object being selected with the object's view and object's point
    ...
    ##   snap point type
    @overload
    def SetValue(self, select_object: SelectLaminate, snap_type: NXOpen.InferSnapType.SnapType, selection1: Laminate, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: Laminate, view2: NXOpen.View, point2: NXOpen.Point3d) -> None:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectLaminate, selection: Laminate, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> None:
        """
         The object being selected with CAE set object information.
...
"""
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectPly) -> Tuple[Ply, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the object's view and point.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectPly) -> Tuple[NXOpen.InferSnapType.SnapType, Ply, NXOpen.View, NXOpen.Point3d, Ply, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the objects view and point and snap information.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectPly) -> Tuple[Ply, NXOpen.CaeObjectType.CaeSubType, int]:
        """
         The object being selected with CAE set object information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectPly, selection: Ply, view: NXOpen.View, point: NXOpen.Point3d) -> None:
        """
         The object being selected with the object's view and object's point
    ...
    ##   snap point type
    @overload
    def SetValue(self, select_object: SelectPly, snap_type: NXOpen.InferSnapType.SnapType, selection1: Ply, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: Ply, view2: NXOpen.View, point2: NXOpen.Point3d) -> None:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectPly, selection: Ply, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> None:
        """
         The object being selected with CAE set object information.
