...
class LayupSurfaceBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ##   the boundary objects that define the boundaries of the regions of the @link Composites::Features::LayupSurface Composites::Features::LayupSurface@endlink    
    ##     
    ##  
    ...
    ##   the logical value which defines whether the input sheet body normal should be flipped    
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   whether the input region points will be projected to the sheet body  
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the projection direction object to project boundary objects to the selected sheet body   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the region list that defines the extents of the @link Composites::Features::LayupSurface Composites::Features::LayupSurface@endlink    
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the sheet body that the @link Composites::Features::LayupSurface Composites::Features::LayupSurface@endlink  is defined on   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
...
class RegionBuilder(NXOpen.Features.FeatureBuilder): 
    ...
    ## Getter for property: (@link NXOpen.SelectNXObjectList NXOpen.SelectNXObjectList@endlink) BoundaryObjects
    ##   the boundary objects that define the boundaries of the regions of the @link Composites::Features::Region Composites::Features::Region@endlink    
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ##   the @link Composites::Features::LayupSurface Composites::Features::LayupSurface@endlink  that the @link Composites::Features::Region Composites::Features::Region@endlink  is defined on   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (bool) ProjectRegionPoints
    ##   whether the input region points should be projected to the parent @link Composites::Features::LayupSurface Composites::Features::LayupSurface@endlink   
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
    ...
    ## Getter for property: (@link NXOpen.RegionPointList NXOpen.RegionPointList@endlink) Regions
    ##   the region list that defines the extents of the @link Composites::Features::Region Composites::Features::Region@endlink    
    ##     
    ##  
    ## Getter License requirements: nx_composites (" Composites")
    ## 
