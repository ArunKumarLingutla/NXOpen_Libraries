...
class AdjustMinimumRadiusBuilder(NXOpen.Builder): 
    ...
    ##   the flag indicating if the adjust minimum radius is on the copy of the input facet body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class BestFitAlignBuilder(NXOpen.Builder): 
    ...
    ##   a value indicating whether to do a global search   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class BridgeFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   the distance tolerance used in the bridge facet body feature   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the first NX facet body to be bridged   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second NX facet body to be bridged   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to specify how to deal with the input two facet bodies: keep, delete or hide   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the inserted facet smooth type   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the first vertex used to define the range on the the first facet body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the first vertex used to defind the range on the second facet body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second vertex used to define the range on the first facet body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second vertex used to defind the range on the second facet body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    @staticmethod
    def FlipRange1(builder: BridgeFacetBodyBuilder) -> None:
        """
         Flip the range between the first and second vertex on the first facet body 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def FlipRange2(builder: BridgeFacetBodyBuilder) -> None:
        """
         Flip the range between the first and second vertex on the second facet body 
        """
        pass
...
class CleanupFacetBodyBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (float) DistanceTolerance
    ##   the tolerance value use to detect the faults in facet body and fix the same.  
    ##   
    ##          <br> 
    ...
    ##   the option to identify or repair facets having an angle with adjacent facets less than a specified minimum value   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to identify or repair normals of neighboring facets or vertices that do not have the right orientation   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the input facet bodies to be analyzed or repaired   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to identify or repair thin holes or slits in the mesh caused by facets not being aligned   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to identify or repair facets with a ratio of longest to shortest side exceeding a specified value   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the specified value used to define long facets   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the minimum angle between adjacent facets to define folded facets   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the minimum number of facets per mesh   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option for handling the input facet bodies   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to identify or repair facets of the same mesh intersecting each other   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to identify or repair facets with with one long edge and two edges with more or the less the same length and a ratio of length to width exceeding a specified value   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the tolerance factor use to detect the faults in facet body and fix the same   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def DisplayCleanupReportInListWindow(builder: CleanupFacetBodyBuilder) -> None:
        """
    ...
    @staticmethod
    def SetAllOptionsToAnalyze(builder: CleanupFacetBodyBuilder) -> None:
        """
         Sets all cleanup options to @link Facet::CleanupFacetBodyBuilder::CleanupOptionsAnalyze Facet::CleanupFacetBodyBuilder::CleanupOptionsAnalyze@endlink , which means to identify the defects only for the input bodies 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def SetAllOptionsToNone(builder: CleanupFacetBodyBuilder) -> None:
        """
         Sets all cleanup options to @link Facet::CleanupFacetBodyBuilder::CleanupOptionsNone Facet::CleanupFacetBodyBuilder::CleanupOptionsNone@endlink , which means to do nothing 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def SetAllOptionsToRepair(builder: CleanupFacetBodyBuilder) -> None:
        """
         Sets all cleanup options to @link Facet::CleanupFacetBodyBuilder::CleanupOptionsRepair Facet::CleanupFacetBodyBuilder::CleanupOptionsRepair@endlink , which means to identify as well as repair the defects for the input bodies 
        """
        pass
...
class CleanupFacetBodyWizardBuilder(NXOpen.Builder): 
    ...
    ##   the collector of facets to be remove.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def Analyze(builder: CleanupFacetBodyWizardBuilder) -> None:
        """
         The analyze 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateCopiesToEdit(builder: CleanupFacetBodyWizardBuilder) -> None:
        """
         Create copies of Associative convergent bodies. Return 1 if copies created 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def FillHole(builder: CleanupFacetBodyWizardBuilder) -> None:
        """
         The Fill hole button 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def RemoveFacets(builder: CleanupFacetBodyWizardBuilder) -> None:
        """
         Remove facet 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def Repair(builder: CleanupFacetBodyWizardBuilder) -> None:
        """
         The repair 
        """
        pass
...
class CombineFacetBodiesBuilder(NXOpen.Builder): 
    ...
    ##   the value used to determine if analyzing the quality of the mesh or not.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the parameter used to control the average size of the output triangulation.  
    ##   
    ...
    ##   the option indicating action to be taken for input bodies after combine operation is performed.  
    ##   
...
class ConvertFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   an option for automatically repairing the converted PSM mesh   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the input facet bodies to convert   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the minimum number of facets to create output body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the output type of converted facet body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class CreateTransitionBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the flag indicating if the transition is created on the copy of the input facet body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class CurvatureBuilder(NXOpen.Builder): 
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def DeleteCurvature(builder: CurvatureBuilder) -> None:
        """
         Deletes the curvature data associated with the input facet bodies.
                    Call this method in order to save memory if the curvature data are not needed any more.
        """
...
class DecimateFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   the value indicating maximum angle, where any facets with a larger relative angle are not reduced.  
    ##   
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) Bodies
    ##   the facet bodies to be decimated.  
    ##    Inputs to this command can be convergent objects.  
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.FacetCollector NXOpen.FacetCollector@endlink) FacetCollector
    ##   a collector of facets on the facet bodies to be decimated.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the value indicating if a copy of the facet body to be decimated without altering the original   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating if the open edges of inner and outer loops in the facet bodies are to be kept intact   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating area of the smallest facet that is to be retained.  
    ##    All the facets
    ...
    ##   the value indicating percentage by which facet count is to be reduced.  
    ...
    ##   an optional list of regions on the facet bodies to be decimated.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating maximum chordal deviation from the original facet body.  
    ##    The value is used
...
class DetectPrimitivesBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def AdjustShapeBoundary(builder: DetectPrimitivesBuilder) -> None:
        """
         Adjust shape detection result with selectivity angle 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetBlendColor(builder: DetectPrimitivesBuilder) -> List[float]:
        """
         Returns the blend color 
         @return blendColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetConeColor(builder: DetectPrimitivesBuilder) -> List[float]:
        """
         Returns the cone color 
         @return coneColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetCylinderColor(builder: DetectPrimitivesBuilder) -> List[float]:
        """
         Returns the cylinder color 
         @return cylinderColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetOtherColor(builder: DetectPrimitivesBuilder) -> List[float]:
        """
         Returns Other type of color. All non-primitive shapes are classfied as Other type 
         @return otherColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetPlaneColor(builder: DetectPrimitivesBuilder) -> List[float]:
        """
         Returns the plane color 
         @return planeColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetSphereColor(builder: DetectPrimitivesBuilder) -> List[float]:
        """
         Returns the sphere color 
         @return sphereColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    def SetBlendColor(builder: DetectPrimitivesBuilder, blendColor: List[float]) -> None:
        """
         Sets the blend color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetConeColor(builder: DetectPrimitivesBuilder, coneColor: List[float]) -> None:
        """
         Sets the cone color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetCylinderColor(builder: DetectPrimitivesBuilder, cylinderColor: List[float]) -> None:
        """
         Sets the cylinder color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetOtherColor(builder: DetectPrimitivesBuilder, otherColor: List[float]) -> None:
        """
         Sets the other color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetPlaneColor(builder: DetectPrimitivesBuilder, planeColor: List[float]) -> None:
        """
         Sets the plane color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetSphereColor(builder: DetectPrimitivesBuilder, sphereColor: List[float]) -> None:
        """
         Sets the sphere color 
        """
        pass
...
class DivideFacetFaceBuilder(NXOpen.Builder): 
    ...
    ##   the polynomial degree (one unit less than the order).  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the collector for specifying facet bodies to be divided based on colored regions.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.FacetCollector NXOpen.FacetCollector@endlink) FacetCollector
    ##   the collector for specifying facet regions  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the value indicating if a copy of the facet body to be used for Divide facet face without altering the original   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to add smoothing to the edge of the divided region    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##  the number of segments used for advanced fitting  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the split curve method list data manager   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the type of enum which decides method for dividing facet faces  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class ExtrudeFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##  Specify the limit by direction and distance. Direction and Distance need to be specified. 
    ...
    ## Getter for property: (@link NXOpen.Direction NXOpen.Direction@endlink) Direction
    ##   the direction used when limit type is @link NXOpen::Facet::ExtrudeFacetBodyBuilder::LimitTypeDistance NXOpen::Facet::ExtrudeFacetBodyBuilder::LimitTypeDistance@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) Distance
    ##   the distance used when limit type is @link NXOpen::Facet::ExtrudeFacetBodyBuilder::LimitTypeDistance NXOpen::Facet::ExtrudeFacetBodyBuilder::LimitTypeDistance@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (float) DistanceTolerance
    ##   the distance tolerance used in the extrude facet body feature   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the facet/sheet bodies to be extruded   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the offset value used to offset the extruded body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the plane used when limit type is @link NXOpen::Facet::ExtrudeFacetBodyBuilder::LimitTypeToPlane NXOpen::Facet::ExtrudeFacetBodyBuilder::LimitTypeToPlane@endlink    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class ExtrudeProfileBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) Offset
    ##   the offset used to offset the extruded body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second distance to extrude   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the tolerance used to create the polyline   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class FacetBodyFromBodyBuilder(NXOpen.Builder): 
    ...
    ##   the option that specifies whether the facet body from body operation is associative   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the input non-faceted bodies to convert   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the original body option of enum   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the output of the type of enum   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class FacetedBodyCollection(NXOpen.TaggedObjectCollection): 
    ...
    ## License requirements: None.
    ##  The faceted body to convert 
    def Convert(owningPart: FacetedBodyCollection, fromBody: FacetedBody, toFacetType: FacetedBodyCollection.Type) -> None:
        """
         Converts the internal representation of this faceted body to the specified type. This does not create a new body 
        """
        pass
    ...
    ## License requirements: None.
    ##  The faceted body to copy 
    def Copy(owningPart: FacetedBodyCollection, fromBody: FacetedBody, toPart: NXOpen.Part, toFacetType: FacetedBodyCollection.Type) -> FacetedBody:
        """
         Copies a faceted body and optionally changes the internal representation to the given type
                     (This is only valid for JT to NX copy) 
    ...
    def CreateBestFitAlignBuilder(owning_part: FacetedBodyCollection) -> BestFitAlignBuilder:
        """
         Creates a @link NXOpen::Facet::BestFitAlignBuilder NXOpen::Facet::BestFitAlignBuilder@endlink  
         @return builder (@link BestFitAlignBuilder NXOpen.Facet.BestFitAlignBuilder@endlink): .
        """
    ...
    def CreateBridgeFacetBodyBuilder(part: FacetedBodyCollection) -> BridgeFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::BridgeFacetBodyBuilder NXOpen::Facet::BridgeFacetBodyBuilder@endlink  
         @return builder (@link BridgeFacetBodyBuilder NXOpen.Facet.BridgeFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateDecimateFacetBodyBuilder(part: FacetedBodyCollection) -> DecimateFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::DecimateFacetBodyBuilder NXOpen::Facet::DecimateFacetBodyBuilder@endlink  
         @return builder (@link DecimateFacetBodyBuilder NXOpen.Facet.DecimateFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING")
    def CreateExtrudeFacetBodyBuilder(part: FacetedBodyCollection) -> ExtrudeFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::ExtrudeFacetBodyBuilder NXOpen::Facet::ExtrudeFacetBodyBuilder@endlink  
         @return builder (@link ExtrudeFacetBodyBuilder NXOpen.Facet.ExtrudeFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING")
    def CreateExtrudeProfileBuilder(part: FacetedBodyCollection) -> ExtrudeProfileBuilder:
        """
         Creates a @link NXOpen::Facet::ExtrudeProfileBuilder NXOpen::Facet::ExtrudeProfileBuilder@endlink  
         @return builder (@link ExtrudeProfileBuilder NXOpen.Facet.ExtrudeProfileBuilder@endlink): .
        """
    ...
    def CreateFacetBody(owning_part: FacetedBodyCollection, solidBodies: List[NXOpen.Body]) -> Tuple[List[FacetedBody], List[int]]:
        """
         Creates a JT @link NXOpen::Facet::FacetedBody NXOpen::Facet::FacetedBody@endlink  using the default faceting tolerances. 
                    The output facetBodies and errorTable arrays are the same size as the input nSolidBodies. 
                    The errorTable array provides information about any errors encountered when faceting bodies. 
    ...
    def CreateFacetBodyFromFaces(owning_part: FacetedBodyCollection, solidFaces: List[NXOpen.Face]) -> Tuple[List[FacetedBody], List[int]]:
        """
         Creates a JT @link NXOpen::Facet::FacetedBody NXOpen::Facet::FacetedBody@endlink  using the default faceting tolerances. 
                    The output facetBodies and errorTable arrays are the same size as the input nSolidFaces. 
                    The errorTable array provides information about any errors encountered when faceting bodies. 
    ...
    ## License requirements: None.
    def CreateFacetCurvatureBuilder(owning_part: FacetedBodyCollection) -> CurvatureBuilder:
        """
         Create a @link NXOpen::Facet::CurvatureBuilder NXOpen::Facet::CurvatureBuilder@endlink  object. 
         @return builder (@link CurvatureBuilder NXOpen.Facet.CurvatureBuilder@endlink): .
        """
    ...
    def CreateFacetFeatureExtractionBuilder(owning_part: FacetedBodyCollection) -> FeatureExtractionBuilder:
        """
         Create a @link NXOpen::Facet::FeatureExtractionBuilder NXOpen::Facet::FeatureExtractionBuilder@endlink  object. 
         @return builder (@link FeatureExtractionBuilder NXOpen.Facet.FeatureExtractionBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateFillHoleBuilder(part: FacetedBodyCollection) -> FillHoleBuilder:
        """
         Creates a @link NXOpen::Facet::FillHoleBuilder NXOpen::Facet::FillHoleBuilder@endlink  
         @return builder (@link FillHoleBuilder NXOpen.Facet.FillHoleBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING")
    def CreateMergeFacetBodyBuilder(part: FacetedBodyCollection) -> MergeFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::MergeFacetBodyBuilder NXOpen::Facet::MergeFacetBodyBuilder@endlink  
         @return builder (@link MergeFacetBodyBuilder NXOpen.Facet.MergeFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateMultiPatchAlignmentBuilder(part: FacetedBodyCollection) -> MultiPatchAlignmentBuilder:
        """
         Creates a @link NXOpen::Facet::MultiPatchAlignmentBuilder NXOpen::Facet::MultiPatchAlignmentBuilder@endlink  
         @return builder (@link MultiPatchAlignmentBuilder NXOpen.Facet.MultiPatchAlignmentBuilder@endlink): .
        """
    ...
    def CreateSTLImportBuilder(owning_part: FacetedBodyCollection) -> STLImportBuilder:
        """
         Creates a @link NXOpen::Facet::STLImportBuilder NXOpen::Facet::STLImportBuilder@endlink  
         @return builder (@link STLImportBuilder NXOpen.Facet.STLImportBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING")
    def CreateSewFacetBodyBuilder(part: FacetedBodyCollection) -> SewFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::SewFacetBodyBuilder NXOpen::Facet::SewFacetBodyBuilder@endlink  
         @return builder (@link SewFacetBodyBuilder NXOpen.Facet.SewFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateSmoothFacetBodyBuilder(part: FacetedBodyCollection) -> SmoothFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::SmoothFacetBodyBuilder NXOpen::Facet::SmoothFacetBodyBuilder@endlink  
         @return builder (@link SmoothFacetBodyBuilder NXOpen.Facet.SmoothFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateSnipFacetBodyBuilder(part: FacetedBodyCollection) -> SnipFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::SnipFacetBodyBuilder NXOpen::Facet::SnipFacetBodyBuilder@endlink  
         @return builder (@link SnipFacetBodyBuilder NXOpen.Facet.SnipFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateSubdivideFacetBodyBuilder(part: FacetedBodyCollection) -> SubdivideFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::SubdivideFacetBodyBuilder NXOpen::Facet::SubdivideFacetBodyBuilder@endlink  
         @return builder (@link SubdivideFacetBodyBuilder NXOpen.Facet.SubdivideFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def DeleteTemporaryFacesAndEdges(owningPart: FacetedBodyCollection) -> None:
        """
         Delete any temporary faces and edges on faceted bodies that may have been created 
                    in the specified part.  Please note that this call will invoke an Update operation.
    ...
    ## License requirements: None.
    ##  Identifier of the faceted body you want 
    def FindObject(objectValue: FacetedBodyCollection, journal_identifier: str) -> FacetedBody:
        """
         Finds the @link  NXOpen::Facet::FacetedBody   NXOpen::Facet::FacetedBody @endlink  with the given identifier as recorded in a journal. 
                    An object may not return the same value as its JournalIdentifier in different versions of 
                    the software. However newer versions of the software should find the same object when 
    ...
    ## License requirements: None.
    ##  The body for which to get associated faceted bodies 
    @staticmethod
    def GetAssociatedFacetedBodies(owningPart: FacetedBodyCollection, solidBody: NXOpen.Body) -> Tuple[List[FacetedBody], int]:
        """
         Returns the loaded solid bodies associated with the argument faceted body.
                    Also returns the number of unloaded associated faceted bodies.
...
class FacetedBody(NXOpen.DisplayableObject): 
    ...
    ##   true if the body is a sheet body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   true if the body is a solid body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def DestroyOwnedFacets(body: FacetedBody) -> None:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetEdges(faceted_body: FacetedBody) -> List[FacetedEdge]:
        """
         Returns the edges in the faceted body.
                    This only works for JT Facets.
    ...
    ## License requirements: None.
    @staticmethod
    def GetFaces(faceted_body: FacetedBody) -> List[FacetedFace]:
        """
         Returns the faces in the faceted body.
                    This only works for JT Facets.
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfEdges(faceted_body: FacetedBody) -> int:
        """
         Returns the number of edges in the faceted body.
                    This only works for JT Facets.
    ...
    ## License requirements: None.
    ##  level of detail to query 
    def GetNumberOfFacets(body: FacetedBody, level_of_detail: int) -> int:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetParameters(body: FacetedBody) -> FacetingParameters:
        """
    ...
    ## License requirements: None.
    @staticmethod
    def HasLightWeightAnalytics(faceted_body: FacetedBody) -> bool:
        """
         Returns whether the FACET has analytical information.
                    This only works for JT Facets.
    ...
    ## License requirements: None.
    @staticmethod
    def HasTopologyInformation(faceted_body: FacetedBody) -> bool:
        """
         Returns whether the FACET has topology information.
                    This only works for JT Facets.
    ...
    ## License requirements: None.
    ##  new facetting faceting parameters to set for this body 
    def SetParameters(body: FacetedBody, parameters: FacetingParameters) -> None:
        """
...
class FacetedEdge(NXOpen.DisplayableObject): 
    ...
    ##   the reference state of a curve   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def GetBody(faceted_edge: FacetedEdge) -> FacetedBody:
        """
         Returns the body containing this edge 
         @return faceted_body (@link FacetedBody NXOpen.Facet.FacetedBody@endlink):  .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetCurveData(faceted_edge: FacetedEdge) -> Tuple[NXOpen.Point3d, NXOpen.Point3d, NXOpen.Point3d, float, float]:
        """
         Returns the curve information for the facet edge
    ...
    ## License requirements: None.
    @staticmethod
    def GetFaces(faceted_edge: FacetedEdge) -> List[FacetedFace]:
        """
         Returns the faces connected to the edge 
         @return faces (@link FacetedFace List[NXOpen.Facet.FacetedFace]@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetVertices(faceted_edge: FacetedEdge) -> Tuple[NXOpen.Point3d, NXOpen.Point3d]:
        """
         Returns the vertices of the edge. If the edge is closed, the second vertex is the same as the first. 
         @return A tuple consisting of (vertex1, vertex2). 
         - vertex1 is: @link NXOpen.Point3d NXOpen.Point3d@endlink. First vertex in the edge .
...
class FacetedFace(NXOpen.DisplayableObject): 
    ...
    ## License requirements: None.
    @staticmethod
    def GetBody(faceted_face: FacetedFace) -> FacetedBody:
        """
         Returns the facet body containing this facet face 
         @return faceted_body (@link FacetedBody NXOpen.Facet.FacetedBody@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetEdges(faceted_face: FacetedFace) -> List[FacetedEdge]:
        """
         Returns the edges connected to the face 
         @return faceted_edges (@link FacetedEdge List[NXOpen.Facet.FacetedEdge]@endlink): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfEdges(faceted_face: FacetedFace) -> int:
        """
         Returns the number of edges in the faceted face 
         @return number_of_edges (int): .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetSurfaceData(faceted_face: FacetedFace) -> Tuple[NXOpen.Point3d, NXOpen.Point3d, float, float, bool]:
        """
         Returns the surface information for this face 
...
class FacetModelingCollection(NXOpen.Object): 
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateCleanupFacetBodyBuilder(part: FacetModelingCollection) -> CleanupFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::CleanupFacetBodyBuilder NXOpen::Facet::CleanupFacetBodyBuilder@endlink  
         @return builder (@link CleanupFacetBodyBuilder NXOpen.Facet.CleanupFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateCleanupFacetBodyWizardBuilder(part: FacetModelingCollection) -> CleanupFacetBodyWizardBuilder:
        """
         Creates a @link NXOpen::Facet::CleanupFacetBodyWizardBuilder NXOpen::Facet::CleanupFacetBodyWizardBuilder@endlink  
         @return builder (@link CleanupFacetBodyWizardBuilder NXOpen.Facet.CleanupFacetBodyWizardBuilder@endlink): .
        """
    ...
    def CreateCombineFacetBodiesBuilder(part: FacetModelingCollection) -> CombineFacetBodiesBuilder:
        """
         Creates a @link NXOpen::Facet::CombineFacetBodiesBuilder NXOpen::Facet::CombineFacetBodiesBuilder@endlink  
         @return builder (@link CombineFacetBodiesBuilder NXOpen.Facet.CombineFacetBodiesBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateCombineFacetBodyBuilder(part: FacetModelingCollection) -> CombineFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::CombineFacetBodyBuilder NXOpen::Facet::CombineFacetBodyBuilder@endlink  
         @return builder (@link CombineFacetBodyBuilder NXOpen.Facet.CombineFacetBodyBuilder@endlink): .
        """
    ...
    def CreateConvertFacetBodyBuilder(part: FacetModelingCollection) -> ConvertFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::ConvertFacetBodyBuilder NXOpen::Facet::ConvertFacetBodyBuilder@endlink  
         @return builder (@link ConvertFacetBodyBuilder NXOpen.Facet.ConvertFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateCreateTransitionBuilder(part: FacetModelingCollection) -> CreateTransitionBuilder:
        """
         Creates a @link NXOpen::Facet::CreateTransitionBuilder NXOpen::Facet::CreateTransitionBuilder@endlink  object 
         @return builder (@link CreateTransitionBuilder NXOpen.Facet.CreateTransitionBuilder@endlink): .
        """
    ...
    ## License requirements: None.
    def CreateDetectPrimitivesBuilder(owning_part: FacetModelingCollection) -> DetectPrimitivesBuilder:
        """
         Creates a @link NXOpen::Facet::DetectPrimitivesBuilder NXOpen::Facet::DetectPrimitivesBuilder@endlink  object. 
         @return builder (@link DetectPrimitivesBuilder NXOpen.Facet.DetectPrimitivesBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateDivideFacetFaceBuilder(part: FacetModelingCollection) -> DivideFacetFaceBuilder:
        """
         Creates a @link NXOpen::Facet::DivideFacetFaceBuilder NXOpen::Facet::DivideFacetFaceBuilder@endlink  
         @return builder (@link DivideFacetFaceBuilder NXOpen.Facet.DivideFacetFaceBuilder@endlink): .
        """
    ...
    ## License requirements: None.
    def CreateFacetAdjustMinimumRadiusBuilder(owning_part: FacetModelingCollection) -> AdjustMinimumRadiusBuilder:
        """
         Create a @link NXOpen::Facet::AdjustMinimumRadiusBuilder NXOpen::Facet::AdjustMinimumRadiusBuilder@endlink  object. 
         @return builder (@link AdjustMinimumRadiusBuilder NXOpen.Facet.AdjustMinimumRadiusBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateFacetBodyFromBodyBuilder(part: FacetModelingCollection) -> FacetBodyFromBodyBuilder:
        """
         Creates a @link NXOpen::Facet::FacetBodyFromBodyBuilder NXOpen::Facet::FacetBodyFromBodyBuilder@endlink  
         @return builder (@link FacetBodyFromBodyBuilder NXOpen.Facet.FacetBodyFromBodyBuilder@endlink): .
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    def CreateFillMeshBuilder(part: FacetModelingCollection) -> FillMeshBuilder:
        """
         Creates a @link NXOpen::Facet::FillMeshBuilder NXOpen::Facet::FillMeshBuilder@endlink  
         @return builder (@link FillMeshBuilder NXOpen.Facet.FillMeshBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateLocalOffsetBuilder(part: FacetModelingCollection) -> LocalOffsetBuilder:
        """
         Creates a @link Facet::LocalOffsetBuilder Facet::LocalOffsetBuilder@endlink  
         @return builder (@link LocalOffsetBuilder NXOpen.Facet.LocalOffsetBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateMergeFacetFacesBuilder(part: FacetModelingCollection) -> MergeFacetFacesBuilder:
        """
         Creates a @link NXOpen::Facet::MergeFacetFacesBuilder NXOpen::Facet::MergeFacetFacesBuilder@endlink  
         @return builder (@link MergeFacetFacesBuilder NXOpen.Facet.MergeFacetFacesBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateMeshFromCloudBuilder(part: FacetModelingCollection) -> MeshFromCloudBuilder:
        """
         Creates a @link NXOpen::Facet::MeshFromCloudBuilder NXOpen::Facet::MeshFromCloudBuilder@endlink  
         @return builder (@link MeshFromCloudBuilder NXOpen.Facet.MeshFromCloudBuilder@endlink): .
        """
    ...
    ## License requirements: None.
    def CreatePaintBrushBuilder(owning_part: FacetModelingCollection) -> PaintBrushBuilder:
        """
         Creates a @link NXOpen::Facet::PaintBrushBuilder NXOpen::Facet::PaintBrushBuilder@endlink  object. 
         @return builder (@link PaintBrushBuilder NXOpen.Facet.PaintBrushBuilder@endlink): .
        """
    ...
    ## License requirements: None.
    def CreatePaintFacetBodyBuilder(owning_part: FacetModelingCollection) -> PaintFacetBodyBuilder:
        """
         Creates a @link NXOpen::Facet::PaintFacetBodyBuilder NXOpen::Facet::PaintFacetBodyBuilder@endlink  object. 
         @return builder (@link PaintFacetBodyBuilder NXOpen.Facet.PaintFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreatePlugLeakageBuilder(part: FacetModelingCollection) -> PlugLeakageBuilder:
        """
         Creates a @link NXOpen::Facet::PlugLeakageBuilder NXOpen::Facet::PlugLeakageBuilder@endlink  
         @return builder (@link PlugLeakageBuilder NXOpen.Facet.PlugLeakageBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreatePolygonModelingBuilder(part: FacetModelingCollection) -> PolygonModelingBuilder:
        """
         Creates a @link NXOpen::Facet::PolygonModelingBuilder NXOpen::Facet::PolygonModelingBuilder@endlink  
         @return builder (@link PolygonModelingBuilder NXOpen.Facet.PolygonModelingBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateRemeshFacetBodyBuilder(part: FacetModelingCollection) -> RemeshFacetBodyBuilder:
        """
         Creates a @link Facet::RemeshFacetBodyBuilder Facet::RemeshFacetBodyBuilder@endlink  
         @return builder (@link RemeshFacetBodyBuilder NXOpen.Facet.RemeshFacetBodyBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateReplaceMeshWithFaceBuilder(part: FacetModelingCollection) -> ReplaceMeshWithFaceBuilder:
        """
         Creates a @link Facet::ReplaceMeshWithFaceBuilder Facet::ReplaceMeshWithFaceBuilder@endlink  
         @return builder (@link ReplaceMeshWithFaceBuilder NXOpen.Facet.ReplaceMeshWithFaceBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateSculptMeshBuilder(part: FacetModelingCollection) -> SculptMeshBuilder:
        """
         Creates a @link NXOpen::Facet::SculptMeshBuilder NXOpen::Facet::SculptMeshBuilder@endlink  
         @return builder (@link SculptMeshBuilder NXOpen.Facet.SculptMeshBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateSplitCurveMethodBuilder(part: FacetModelingCollection) -> SplitCurveMethodBuilder:
        """
         Creates a @link NXOpen::Facet::SplitCurveMethodBuilder NXOpen::Facet::SplitCurveMethodBuilder@endlink  
         @return builder (@link SplitCurveMethodBuilder NXOpen.Facet.SplitCurveMethodBuilder@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateSplitCurveMethodListDataManager(part: FacetModelingCollection) -> SplitCurveMethodListDataManager:
        """
         Creates a @link NXOpen::Facet::SplitCurveMethodListDataManager NXOpen::Facet::SplitCurveMethodListDataManager@endlink  
         @return dataManager (@link SplitCurveMethodListDataManager NXOpen.Facet.SplitCurveMethodListDataManager@endlink): .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    ##  @link NXOpen::Features::TubeLattice NXOpen::Features::TubeLattice@endlink  to be edited 
    def CreateTubeLatticeBuilder(part: FacetModelingCollection, tube_lattice: NXOpen.Features.TubeLattice) -> NXOpen.Features.TubeLatticeBuilder:
        """
         Creates a @link Features::TubeLatticeBuilder Features::TubeLatticeBuilder@endlink  
         @return builder (@link NXOpen.Features.TubeLatticeBuilder NXOpen.Features.TubeLatticeBuilder@endlink):  .
        """
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreateWrapMeshBuilder(part: FacetModelingCollection) -> WrapMeshBuilder:
        """
         Creates a @link NXOpen::Facet::WrapMeshBuilder NXOpen::Facet::WrapMeshBuilder@endlink  
         @return builder (@link WrapMeshBuilder NXOpen.Facet.WrapMeshBuilder@endlink): .
        """
...
class FeatureExtractionBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link SelectFacetedBodyList NXOpen.Facet.SelectFacetedBodyList@endlink) FacetBodies
    ##   the input facet body selection list   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def GetExtractedBorders(builder: FeatureExtractionBuilder) -> List[NXOpen.Spline]:
        """
         Gets the extracted curves. Call @link Builder::Commit Builder::Commit@endlink  before calling this method. 
         @return borders (@link NXOpen.Spline List[NXOpen.Spline]@endlink):  The extracted curves.
        """
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def GetExtractedRegions(builder: FeatureExtractionBuilder) -> List[FacetedBody]:
        """
         Gets the extracted facet bodies. Call @link Builder::Commit Builder::Commit@endlink  before calling this method. 
         @return regions (@link FacetedBody List[NXOpen.Facet.FacetedBody]@endlink):  The extracted facet bodies .
        """
...
class FillHoleBuilder(NXOpen.Builder): 
    ...
    ##   the first list of edges when bridging holes.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the second list of edges when bridging holes.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Inner Hole in island filling.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the flag indicating if the hole filling is on the copy of the input facet body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the maximum number of edges that a targeted hole can have.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Outer Hole in island filling.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the facet body we will be filling.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the hole curves using Fill Hole, User Defined.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the hole target type when filling holes.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def ClearHoleFills(builder: FillHoleBuilder) -> None:
        """
         Cleans up local meshes associated with each fill. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def ClearHoles(builder: FillHoleBuilder) -> None:
        """
         Removes all holes, deletes associated hole polylines. 
        """
        pass
    ...
    def FillHoles(builder: FillHoleBuilder, globalUpdate: bool) -> NXOpen.DisplayableObject:
        """
         Fills targeted holes. 
         @return newFacetBody (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink):  updated input facet body .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def FindHoles(builder: FillHoleBuilder) -> None:
        """
         Locates holes in the mesh and creates polylines around them. 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetAllHoles(builder: FillHoleBuilder) -> List[NXOpen.DisplayableObject]:
        """
         Gets a list of all holes (represented by polylines). 
         @return holeCurveTags (@link NXOpen.DisplayableObject List[NXOpen.DisplayableObject]@endlink):  Hole polylines. .
        """
    ...
    ## License requirements: None.
    ##  Index into the list of all holes 
    def GetHoleByIndex(builder: FillHoleBuilder, index: int) -> NXOpen.ICurve:
        """
         Gets a hole given an index into the list of holes. 
         @return holeAtIndex (@link NXOpen.ICurve NXOpen.ICurve@endlink):  Equals NULL if not found .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetHoleFillsOnly(builder: FillHoleBuilder) -> NXOpen.DisplayableObject:
        """
         Builds a facet body that contains only the facets of the filled holes.
         @return facetBodyResult (@link NXOpen.DisplayableObject NXOpen.DisplayableObject@endlink):  the fill facet body .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def GetNumberOfHoles(builder: FillHoleBuilder) -> int:
        """
         Gets the number of holes in the target facet body. 
         @return numberOfHoles (int): .
        """
    ...
    ## License requirements: None.
    ##  Targets polylines that have this many edges or less. 
    def GetTargetHolesByEdgeNumber(builder: FillHoleBuilder, numMaxEdges: int) -> List[NXOpen.DisplayableObject]:
        """
         Gets a list of targeted holes (represented by polylines) based on number of edges. 
         @return holeCurveTags (@link NXOpen.DisplayableObject List[NXOpen.DisplayableObject]@endlink):  Hole polylines. .
        """
    ...
    ## License requirements: None.
    @staticmethod
    def SwitchHoleFillType(builder: FillHoleBuilder) -> None:
        """
         Switches boundary edge mapping based on the filling type (holes, island, bridge)
                    When filling holes or islands, each hole is defined by a polyline.  When bridging holes,
                    each individual open edge has its own polyline.
...
class FillMeshBuilder(NXOpen.Builder): 
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def FlipRangeEnd(builder: FillMeshBuilder) -> None:
        """
         Flips the end edge range 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def FlipRangeStart(builder: FillMeshBuilder) -> None:
        """
         Flips the start edge range 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    ## picked facet vertex info 
    def SetBridgeGapEndEdgeVertex1(builder: FillMeshBuilder, facetVertexData: FillMeshBuilder.FacetVertexData) -> None:
        """
         Sets first end edge vertex to bridge the gap. 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    ## picked facet vertex info 
    def SetBridgeGapEndEdgeVertex2(builder: FillMeshBuilder, facetVertexData: FillMeshBuilder.FacetVertexData) -> None:
        """
         Sets second end edge vertex to bridge the gap. 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    ## picked facet vertex info 
    def SetBridgeGapStartEdgeVertex1(builder: FillMeshBuilder, facetVertexData: FillMeshBuilder.FacetVertexData) -> None:
        """
         Sets first start edge vertex to bridge the gap. 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    ## picked facet vertex info 
    def SetBridgeGapStartEdgeVertex2(builder: FillMeshBuilder, facetVertexData: FillMeshBuilder.FacetVertexData) -> None:
        """
         Sets second start edge vertex to bridge the gap. 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    ## picked facet vertex info 
    def SetCloseNotchVertex1(builder: FillMeshBuilder, facetVertexData: FillMeshBuilder.FacetVertexData) -> None:
        """
         Sets first vertex to close the notch. 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    ## picked facet vertex info 
    def SetCloseNotchVertex2(builder: FillMeshBuilder, facetVertexData: FillMeshBuilder.FacetVertexData) -> None:
        """
         Sets second vertex to close the notch. 
        """
        pass
    ...
    ## License requirements: studio_free_form ("STUDIO FREE FORM")
    @staticmethod
    def UpdateHoles(builder: FillMeshBuilder) -> None:
        """
         Update all the holes of the selected facet bodies. 
        """
        pass
...
class LocalOffsetBuilder(NXOpen.Builder): 
    ...
    ##   the user-selected transition regions   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the option to create a non-associative copy of the selected body and edit that copy   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to rebuild the mesh structure of the offset output   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the method to reverse the direction of the offset.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsSmoothEdge
    ##   the option to add smoothing to the edge of the offset region   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the linear distance of the created local offset, which may be a positive or negative distance   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the distance of the transition region with the constant offset option   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the method to define the shape of the transition region   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MergeFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   the angle tolerance used in the merge facet body feature   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the chord height to control the size of new facets   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (float) DistanceTolerance
    ##   the distance tolerance used in the merge facet body feature   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the edge length to control the size of new facets   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link SelectFacetedBody NXOpen.Facet.SelectFacetedBody@endlink) FacetBodyOne
    ##   the first NX facet body to be merged   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link SelectFacetedBody NXOpen.Facet.SelectFacetedBody@endlink) FacetBodyTwo
    ##   the second NX facet body to be merged   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MergeFacetFacesBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the value indicating if a copy of the facet body to be used for Merge facet faces without altering the original   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class MeshFromCloudBuilder(NXOpen.Builder): 
    ...
    ##   the option controlling distribution of vertices in the output convergent body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value used to determine neighboring points when creating a body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating smoothing factor.  
    ...
    ##   the option indicating the source of point cloud.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating the desired number of vertices in the output body.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value as a percentage ratio of number of output vertices to the number of input points.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    @staticmethod
    def SuggestNeighborhoodSize(builder: MeshFromCloudBuilder) -> None:
        """
         Determines @link NXOpen::Facet::MeshFromCloudBuilder::NeighborhoodSize NXOpen::Facet::MeshFromCloudBuilder::NeighborhoodSize@endlink  for a given point cloud data. 
        """
        pass
...
class MultiPatchAlignmentBuilder(NXOpen.Builder): 
    ...
    ##   the facet bodies to be aligned.  
    ##    Inputs to this command can be convergent objects.   
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating the number of times the alignment algorithm is applied.  
    ##    
    ...
    ##   the distance facets may be from one another in order to be used 
    ##             in the alignment.  
    ...
    ##   an optional reference facet body.  
    ##    Inputs to this command can be convergent objects.   
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   an optional reference facet body with a location and orientation that will 
    ...
    ##   the type indicating number of facets to be used  in the alignment.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class PaintBrushBuilder(NXOpen.Builder): 
    ...
    ## License requirements: None.
    @staticmethod
    def ClearThePaintPath(builder: PaintBrushBuilder) -> None:
        """
         Clears the paint path 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def GetPaintBrushColor(builder: PaintBrushBuilder) -> List[float]:
        """
         Returns the paint brush color 
         @return paintBrushColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    ##  Vertex position 
    def PaintVertexColor(builder: PaintBrushBuilder, position: NXOpen.Point3d) -> None:
        """
         Paints facet body vertex color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Body being painted. 
    def SetBodyBeingPainted(builder: PaintBrushBuilder, body: NXOpen.DisplayableObject) -> None:
        """
         Sets facet body being painted. Inputs to this command can be convergent objects. 
        """
        pass
    ...
    def SetFacetBeingPainted(builder: PaintBrushBuilder, facet: FacetedBody) -> None:
        """
         Sets facet body being painted. 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetPaintBrushColor(builder: PaintBrushBuilder, paintBrushColor: List[float]) -> None:
        """
         Sets the paint brush color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Temporary display flag 
    def SetTemporaryFacetDisplay(builder: PaintBrushBuilder, tempDisplay: bool) -> None:
        """
         Flag to use temporary facet display 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def SetupPaintFacetBody(builder: PaintBrushBuilder) -> None:
        """
         Setup the paint facet body 
        """
        pass
...
class PaintFacetBodyBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.FacetCollector NXOpen.FacetCollector@endlink) FacetCollector
    ##   a collector of facets on the facet bodies to be to be tested.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def GetPaintBrushColor(builder: PaintFacetBodyBuilder) -> List[float]:
        """
         Returns the paint brush color 
         @return paintBrushColor (List[float]):  Array of 3 RGB values, each between 0 and 1 .
        """
    ...
    ## License requirements: None.
    ##  Bodies to be painted with background color 
    def PaintBodiesBackgroundColor(builder: PaintFacetBodyBuilder, bodies: List[NXOpen.DisplayableObject]) -> None:
        """
         Paints facets background color. Inputs to this command can be convergent objects.
        """
        pass
    ...
    ## License requirements: None.
    ##  Facets to be painted with background color 
    def PaintFacetsBackGroundColor(builder: PaintFacetBodyBuilder, facets: List[FacetedBody]) -> None:
        """
         Paints facets background color 
        """
        pass
    ...
    ## License requirements: None.
    @staticmethod
    def PaintSelectedFacets(builder: PaintFacetBodyBuilder) -> None:
        """
         Paints selected facets. 
        """
        pass
    ...
    ## License requirements: None.
    ##  Array of 3 RGB values, each between 0 and 1 
    def SetPaintBrushColor(builder: PaintFacetBodyBuilder, paintBrushColor: List[float]) -> None:
        """
         Sets the paint brush color 
        """
        pass
    ...
    ## License requirements: None.
    ##  Bodies that need color data for edit 
    def SetupBodyColorData(builder: PaintFacetBodyBuilder, bodies: List[NXOpen.DisplayableObject]) -> None:
        """
         Setup color data. Inputs to this command can be convergent objects. 
        """
        pass
    ...
    ## License requirements: None.
    ##  Facets that need color data for edit 
    def SetupColorData(builder: PaintFacetBodyBuilder, facets: List[FacetedBody]) -> None:
        """
         Setup color data 
        """
        pass
...
class PlugLeakageBuilder(NXOpen.Builder): 
    ...
    ##   the minimum size of hole to be detected  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.GeometricUtilities.BoundaryDefinitionBuilderList NXOpen.GeometricUtilities.BoundaryDefinitionBuilderList@endlink) RegionList
    ##  the boundaries that are defined to patch the holes.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    def CreatePatch(builder: PlugLeakageBuilder) -> None:
        """
        Creates a patch defined by the boundary.
        """
        pass
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    @staticmethod
    def FindPath(builder: PlugLeakageBuilder) -> None:
        """
         Finds the path that goes through the holes, starting from 
                @link NXOpen::Facet::PlugLeakageBuilder::InnerPoint NXOpen::Facet::PlugLeakageBuilder::InnerPoint@endlink  and ending at 
                @link NXOpen::Facet::PlugLeakageBuilder::OuterPoint NXOpen::Facet::PlugLeakageBuilder::OuterPoint@endlink .
...
class PolygonModelingBuilder(NXOpen.Builder): 
    ...
    def MergeAllFaces(builder: PolygonModelingBuilder, bodyTag: NXOpen.Body) -> None:
        """
         Merges all faces of the input body
        """
        pass
    ...
    ## 
    ## <param name="bodyTag"> (@link NXOpen.Body NXOpen.Body@endlink) </param>
    def RemoveParameterOfBody(builder: PolygonModelingBuilder, bodyTag: NXOpen.Body) -> None:
        """
         Removes the parameters of the input body
        """
        pass
...
class RemeshFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   the AngularThreshold for remesh  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the ChordalTolerance for remesh  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsLockBoundary
    ##   the option to lock boundary of remesh regions   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option to show deviation plot   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the Option for sharp edges lock type  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class ReplaceMeshWithFaceBuilder(NXOpen.Builder): 
    ...
    ##  Divide facet face to fit the plane 
    class Types(Enum):
        """
    ...
    ##   the cone average constrain to direction toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cone average constrain to direction vector   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cone colinear constraint axis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cone parallel constraint vector   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cylinder average constrain to direction toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cylinder average constrain to direction vector   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cylinder colinear constraint axis   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the cylinder parallel constraint vector   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the orthogonal or coplanar constraint plane   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the plane average constrain to normal toggle   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the plane average constrain to normal vector   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the plane parallel constraint normal   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the sphere concentric constraint point   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class SculptMeshBuilder(NXOpen.Builder): 
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    @staticmethod
    def ResetToMedium(builder: SculptMeshBuilder) -> None:
        """
         Reset falloff factor to medium 
        """
        pass
    ...
    ## License requirements: nx_polygon_modeling (" NX Polygon Modeling")
    @staticmethod
    def SculptMesh(builder: SculptMeshBuilder) -> None:
        """
          Sculpts the mesh based on the sculpting tool parameters and trajectory. 
        """
        pass
...
"""
    ...
    ## License requirements: None.
    ##  object to add 
    def Add(object_list: SelectFacetedBodyList, objectValue: FacetedBody) -> bool:
        """
         Adds an object to the list
    ...
    ## License requirements: None.
    ##  objects to add 
    def AddWithViews(object_list: SelectFacetedBodyList, objects: List[FacetedBody], views: List[NXOpen.View]) -> bool:
        """
         Adds a set of objects with views to the list
    ...
    ##  objects to add 
    @overload
    def Add(self, object_list: SelectFacetedBodyList, objects: List[FacetedBody]) -> bool:
        """
         Adds a set of objects to the list
    ...
    @overload
    def Add(self, object_list: SelectFacetedBodyList, input_selection_method: NXOpen.SelectionMethod) -> bool:
        """
         Adds the objects from a SelectionMethod to the list
    ...
    ##  selected object 
    @overload
    def Add(self, object_list: SelectFacetedBodyList, selection: FacetedBody, view: NXOpen.View, point: NXOpen.Point3d) -> bool:
        """
         Adds the object with the objects view and objects point
    ...
    ##   snap point type
    @overload
    def Add(self, object_list: SelectFacetedBodyList, snap_type: NXOpen.InferSnapType.SnapType, selection1: FacetedBody, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: FacetedBody, view2: NXOpen.View, point2: NXOpen.Point3d) -> bool:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def Add(self, object_list: SelectFacetedBodyList, selection: FacetedBody, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> bool:
        """
         The object being selected with CAE set object information.
    ...
    ## License requirements: None.
    @staticmethod
    def Clear(object_list: SelectFacetedBodyList) -> None:
        """
         Removes all items from the list.
    ...
    ## License requirements: None.
    ##  object to check 
    def Contains(object_list: SelectFacetedBodyList, objectValue: FacetedBody) -> bool:
        """
         Returns whether the specified object is already in the list or not.
    ...
    ## License requirements: None.
    @staticmethod
    def GetArray(object_list: SelectFacetedBodyList) -> List[FacetedBody]:
        """
         Returns the list of objects in the selection list.
    ...
    ## License requirements: None.
    @staticmethod
    def GetSelectObjectArray(object_list: SelectFacetedBodyList) -> List[NXOpen.SelectObject]:
        """
         Returns the list of SelectObjects in the selection list.
    ...
    ## License requirements: None.
    ##  Object to remove 
    def Remove(object_list: SelectFacetedBodyList, objectValue: FacetedBody) -> bool:
        """
         Remove specified object from list.
    ...
    ## License requirements: None.
    ##  Objects to remove 
    def RemoveArray(object_list: SelectFacetedBodyList, objects: List[FacetedBody]) -> bool:
        """
         Remove specified objects from list.
    ...
    ##  Object to remove 
    @overload
    def Remove(self, object_list: SelectFacetedBodyList, objectValue: FacetedBody, view: NXOpen.View) -> bool:
        """
         Remove specified object from list.
    ...
    ##   snap point type
    @overload
    def Remove(self, object_list: SelectFacetedBodyList, snap_type: NXOpen.InferSnapType.SnapType, selection1: FacetedBody, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: FacetedBody, view2: NXOpen.View, point2: NXOpen.Point3d) -> bool:
        """
         Remove specified object from list.
    ...
    ##  selection method containing objects to add 
    @overload
    def Remove(self, object_list: SelectFacetedBodyList, input_selection_method: NXOpen.SelectionMethod) -> bool:
        """
         Removes the objects from a SelectionMethod from the list
    ...
    def SetArray(object_list: SelectFacetedBodyList, objects: List[FacetedBody]) -> None:
        """
         Sets the list of objects in the selection list. This will clear any existing
            items in the list.
...
"""
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectFacetedBody) -> Tuple[FacetedBody, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the object's view and point.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectFacetedBody) -> Tuple[NXOpen.InferSnapType.SnapType, FacetedBody, NXOpen.View, NXOpen.Point3d, FacetedBody, NXOpen.View, NXOpen.Point3d]:
        """
         The object being selected with the objects view and point and snap information.
    ...
    @staticmethod
    @overload
    def GetValue(self, select_object: SelectFacetedBody) -> Tuple[FacetedBody, NXOpen.CaeObjectType.CaeSubType, int]:
        """
         The object being selected with CAE set object information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectFacetedBody, selection: FacetedBody, view: NXOpen.View, point: NXOpen.Point3d) -> None:
        """
         The object being selected with the object's view and object's point
    ...
    ##   snap point type
    @overload
    def SetValue(self, select_object: SelectFacetedBody, snap_type: NXOpen.InferSnapType.SnapType, selection1: FacetedBody, view1: NXOpen.View, point1: NXOpen.Point3d, selection2: FacetedBody, view2: NXOpen.View, point2: NXOpen.Point3d) -> None:
        """
         The object being selected with the objects view and objects point and snap information.
    ...
    ##  selected object 
    @overload
    def SetValue(self, select_object: SelectFacetedBody, selection: FacetedBody, cae_sub_type: NXOpen.CaeObjectType.CaeSubType, cae_sub_id: int) -> None:
        """
         The object being selected with CAE set object information.
...
class SewFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   the distance to control the deform area on the deform body   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (float) DistanceTolerance
    ##   the distance tolerance used in the merge touching facet body feature   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Point NXOpen.Point@endlink) Vertex1
    ##   the first vertex used to define the range   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Point NXOpen.Point@endlink) Vertex2
    ##   the second vertex used to define the range   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def FlipRange(builder: SewFacetBodyBuilder) -> None:
        """
         Flip the range between the first and second vertex 
        """
        pass
...
class SmoothFacetBodyBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) Bodies
    ##   the facet bodies to be smoothed.  
    ##    Inputs to this command can be convergent objects.   
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the option indicating if a copy of the facet body will be smoothed without altering the original   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.FacetCollector NXOpen.FacetCollector@endlink) FacetCollector
    ##   a collector of facets on the facet bodies to be to be smoothed.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsLockBoundary
    ##   the option indicating if the open edges of inner and outer loops in the facet bodies are to be kept intact   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   an option to apply the smooth operator across face edges   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.GeometricUtilities.BoundaryDefinitionBuilderList NXOpen.GeometricUtilities.BoundaryDefinitionBuilderList@endlink) RegionList
    ##   an optional list of regions on the facet bodies to be smoothed   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
...
class SnipFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##   the direction in which snipping profiles are projected on the facet bodies    
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the boundary facet treatment type   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating if facet body is to be divided   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.FacetCollector NXOpen.FacetCollector@endlink) FacetCollector
    ##   the collector of facets to be snipped.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the value indicating if a copy of the facet body to be snipped without altering the original   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating if only facets near to the viewer to be snipped   
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating if project both sides in snip with curves along specified vector.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the point indicating the portion of the facet body with respect to specified region to be snipped.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## License requirements: None.
    @staticmethod
    def SwitchRegion(builder: SnipFacetBodyBuilder) -> None:
        """
         Switch the region to be snipped indicated by the region point. 
        """
        pass
...
class SplitCurveMethodBuilder(NXOpen.Builder): 
   ...
   Split Curve Method Builder is a class to provide a curve to divide the facet faces. """
    ...
    ##   the existing curves to be used to divide facet body  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    def AddCurveOnBodies(builder: SplitCurveMethodBuilder, bodyArray: List[NXOpen.Body]) -> None:
        """
         Set the list of curves on bodies 
        """
        pass
    ...
    ## License requirements: None.
    def CreateSplitCurveWithUseExisting(builder: SplitCurveMethodBuilder) -> List[NXOpen.Spline]:
        """
         Create split curve with use existing method
         @return curves (@link NXOpen.Spline List[NXOpen.Spline]@endlink): .
        """
...
class STLImportBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (bool) CleanUp
    ##   the option to clean up all mesh defects on import   
    ##     
    ##  
    ## Getter License requirements: solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") OR nx_masterfem ("Finite Element Modeling")
    ## 
    ...
    ##   the indicator for whether to hide smooth edges   
    ##     
    ##  
    ## Getter License requirements: solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") OR nx_masterfem ("Finite Element Modeling")
    ## 
    ...
    ## Getter for property: (float) MinimumAngleFoldedFacets
    ##   the value for minimum angle between adjacent facets to define folded facets.  
    ##      
    ##  
    ## Getter License requirements: solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") OR nx_masterfem ("Finite Element Modeling")
    ## 
    ...
    ## Getter for property: (int) MinimumFacetNumber
    ##   the value for minimum number of facets for a STL file to be imported   
    ##     
    ##  
    ## Getter License requirements: solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") OR nx_masterfem ("Finite Element Modeling")
    ## 
    ...
    ##   the indicator for whether to show information window   
    ##     
    ##  
    ## Getter License requirements: solid_modeling ("SOLIDS MODELING") OR studio_free_form ("STUDIO FREE FORM") OR nx_masterfem ("Finite Element Modeling")
    ## 
    ...
    @staticmethod
    def GetTopology(builder: STLImportBuilder) -> List[NXOpen.Part]:
        """
          The imported bodies after STL file import 
         @return topology (@link NXOpen.Part List[NXOpen.Part]@endlink): .
        """
...
class SubdivideFacetBodyBuilder(NXOpen.Builder): 
    ...
    ##  In the linear option the sub-triangles are coplanar to the original triangle. Shape resolution remains untouched. 
    ...
    ##  Subdivision methods 
    ##  Subdivides the polygons into four sub triangles. The original mesh structure remains.
    ...
    ## Getter for property: (float) AngleThreshold
    ##   the angular tolerance to detect sharp edges to be kept.  
    ...
    ## Getter for property: (@link NXOpen.SelectDisplayableObjectList NXOpen.SelectDisplayableObjectList@endlink) Bodies
    ##   the facet bodies to be subdivided.  
    ##    Inputs to this command can be convergent objects.   
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating length of the edge of the polygons to be subdivided.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.FacetCollector NXOpen.FacetCollector@endlink) FacetCollector
    ##   a collector of facets on the facet bodies to be subdivided.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (bool) IsEditCopy
    ##   the value indicating if a copy of the facet body to be subdivided without altering the original.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the value indicating whether to perform a decimation step after the subdivision.  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.GeometricUtilities.BoundaryDefinitionBuilderList NXOpen.GeometricUtilities.BoundaryDefinitionBuilderList@endlink) RegionList
    ##   an optional list of regions on the facet bodies to be subdivided.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
...
class WrapMeshBuilder(NXOpen.Builder): 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) AverageSize
    ##   the average size for wrap mesh  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (float) ChordalTolerance
    ##   the chordal tolerance for wrap mesh  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the input body visibility option.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the flag indicating if sharp edges should be kept.  
    ##      
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ## Getter for property: (@link NXOpen.Expression NXOpen.Expression@endlink) MaximumSize
    ##   the maximum size for wrap mesh  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
    ...
    ##   the method for selected volume  
    ##     
    ##  
    ## Getter License requirements: None.
    ## 
