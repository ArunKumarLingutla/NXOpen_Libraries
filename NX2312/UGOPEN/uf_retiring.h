...
#define UF_ROUTE_str_invalid_route_start  "%s: Invalid object specified for route start %d"
#define UF_ROUTE_str_invalid_route_end    "%s: Invalid object specified for route end %d"
...
#define UF_RLIST_PARENT_ID_NAME               "parent_id"
#define UF_RLIST_PARENT_POSITION_NAME         "parent_position"
...
#define UF_RLIST_OCCUR_PARENT             "MC"
...
#define UF_RLIST_ROUTED_EXTERNAL            "CAPITAL"
#define UF_RLIST_ROUTED_TO_PARENT_COMPONENT "MCC"
#define UF_RLIST_ROUTED_TO_PARENT_PIN       "MCP"
#define UF_RLIST_ROUTED_TO_PARENT_MIXED     "MCM"
...
#define UF_RLIST_LOAD_ALL_LIST_TYPE             ( UF_RLIST_LOAD_CONN_LIST_TYPE | UF_RLIST_LOAD_COMP_LIST_TYPE )
...
#define UF_RLIST_LOAD_ALL_OBJS                  ( UF_RLIST_LOAD_ALL_LIST_TYPE | UF_RLIST_LOAD_LIST_OBJS | UF_RLIST_LOAD_FORMAT_OBJS | UF_RLIST_LOAD_FILTER_OBJS )
...
#define UF_RLIST_err_unsupported_file_format_XML         ERROR_RLIST_base + 78
#define UF_RLIST_err_unsupported_file_format_AP212       ERROR_RLIST_base + 79
#define UF_RLIST_err_max_error                           ERROR_RLIST_base + 79
