...
NOTE: You need to turn on the Harness license before design rule checking will run.
...
SAMPLE FILES:
    ...
    Routing_Example_Bundle_Plugin.cpp
    Routing_Example_Bundle_Plugin.hpp
    Routing_Example_Cableway_DesignRules.cpp
    Routing_Example_Cableway_DesignRules.hpp
    Routing_Example_Cableway_GetSetGUIDs.cpp
    Routing_Example_Cableway_GetSetGUIDs.hpp
    Routing_Example_Cableway_ImportDataset.cpp
    Routing_Example_Cableway_ImportDataset.hpp
    Routing_Example_Cableway_Plugins.cpp
    Routing_Example_Cableway_Plugins.hpp
    Routing_Example_Callbacks.cpp
    Routing_Example_Callbacks.hpp
    Routing_Example_DesignRules.cpp
    Routing_Example_DesignRules.hpp
    Routing_Example_Plugins.cpp
    Routing_Example_Plugins.hpp
    Routing_MaximumHeight_DesignRule.cpp
    Routing_MaximumHeight_DesignRule.hpp
    Routing_Example_Spool_Plugins.cpp
    Routing_Example_Spool_Plugins.hpp

The above listed files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/CPP/Routing.

Each of these cpp/hpp pairs is a self-contained sample and does not require any other file.

----------------------------------------------------------------------------------------------------
BUILD STEPS

See the NX documenation on building NX Open applications.

----------------------------------------------------------------------------------------------------
SETUP BEFORE LAUNCHING NX

The output file built (e.g. .dll, .so, or .dylib) must be placed in one of the following locations:
...
applications. The following steps show how to execute the Create Path Design Rule in the DesignRules.cpp
file.
