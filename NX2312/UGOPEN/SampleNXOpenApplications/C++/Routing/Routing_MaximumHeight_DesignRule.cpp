...
MaxHeightDesignRules* maxHeightDesignRules = nullptr;

static NXString designRuleName = "Maximum Height Violation";
...
)
{
    ...
    if (IS_GREATER(valueToCompare, specifiedMaxHeightValue))
    {
        ...
        customManager->CreateViolationForReason( designRuleName, reason,
...
MaxHeightDesignRules::MaxHeightDesignRules()
{
    ...
    m_maxHeightRuleForCreatePath = customManager->AddDesignRule(CustomManager::DesignRuleReasonCreatePath,
                                                        designRuleName, maxHeightViolationDescription,
