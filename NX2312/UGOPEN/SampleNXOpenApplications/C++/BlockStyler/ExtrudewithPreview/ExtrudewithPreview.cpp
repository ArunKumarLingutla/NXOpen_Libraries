...
//------------------------------------------------------------------------------
NXOpen::BlockStyler::BlockDialog::DialogResponse ExtrudewithPreview::Launch()
{
...
void ExtrudewithPreview::initialize_cb()
{
    try
    {
        ...
        Translucency1 = ExtrudewithPreview::theSession->Preferences()->VisualizationVisualPreferences()->Translucency();
        ExtrudewithPreview::theSession->Preferences()->VisualizationVisualPreferences()->SetTranslucency(true);
