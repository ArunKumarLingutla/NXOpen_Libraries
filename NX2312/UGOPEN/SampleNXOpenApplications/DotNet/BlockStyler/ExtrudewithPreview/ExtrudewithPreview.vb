...
#End Region
    ...
    Public Sub Dispose()
        If theDialog IsNot Nothing Then 
            theDialog.Dispose()
            theDialog = Nothing
            theSession.Preferences.VisualizationVisualPreferences.Translucency = Translucency1
        End If
    End Sub
    ...
    Public Sub initialize_cb()
        Try
            ...
            Translucency1 = theSession.Preferences.VisualizationVisualPreferences.Translucency
            theSession.Preferences.VisualizationVisualPreferences.Translucency = True
