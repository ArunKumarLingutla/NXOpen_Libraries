...
For the Server to be able to log any issues safely, it logs all calls to a file.  As we cannot call NXOpen calls not on the main thread.
See Server example code for more details.
