...
public class NXOpenRemotingClient
{
    ...
    public static void DoLog(String s)
    {
        if (theSession != null)
        {
            theSession.LogFile.WriteLine(s);
        }
    ...
    static void Main(string[] args)
    {
        ...
        theUI = (UI)Activator.GetObject(typeof(UI), "http://localhost:4567/UI");
        ...
        try
        {
            ...
            //needs user inputs
            Selection.Response resp = theUI.SelectionManager.SelectTaggedObject(message, title, Selection.SelectionScope.AnyInAssembly, Selection.SelectionAction.ClearAndEnableSpecific, false, false, mask_arry, out body, out pos);
