...
Module MaxHeightDesignRules
    ...
    Dim designRuleName As String = "Maximum Height Violation"
    ...
    Sub checkForMaximumHeightViolation(ByRef routeManager As RouteManager, ByRef customManager As CustomManager,
        ...
        If largestDiameter > (specifiedMaxHeightValue + 0.00001) Then
            ...
            customManager.CreateViolationForReason(designRuleName, reason, "The segment violates Maximum Height Rule.", description, objects)
        End If
    ...
    Sub RegisterMaximumHeightDesignRules()
        ...
        m_maxHeightRuleForCreatePath = customManager.AddDesignRule(customManager.DesignRuleReason.CreatePath, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForHealPath = customManager.AddDesignRule(customManager.DesignRuleReason.HealPath, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForAssignCorner = customManager.AddDesignRule(customManager.DesignRuleReason.AssignCorner, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForAssignStock = customManager.AddDesignRule(customManager.DesignRuleReason.AssignStock, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForRemovePart = customManager.AddDesignRule(customManager.DesignRuleReason.RemovePart, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForAutoRoutePinLevel = customManager.AddDesignRule(customManager.DesignRuleReason.AutoRoutePinLevel, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForManualRoutePinLevel = customManager.AddDesignRule(customManager.DesignRuleReason.ManualRoutePinLevel, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForAutoRouteComponentLevel = customManager.AddDesignRule(customManager.DesignRuleReason.AutoRouteComponentLevel, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForManualRouteComponentLevel = customManager.AddDesignRule(customManager.DesignRuleReason.ManualRouteComponentLevel, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForInteractive = customManager.AddDesignRule(customManager.DesignRuleReason.Interactive, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForTransformPath = customManager.AddDesignRule(customManager.DesignRuleReason.TransformPath, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
        m_maxHeightRuleForEditCharacteristic = customManager.AddDesignRule(customManager.DesignRuleReason.EditCharacteristic, designRuleName, maxHeightViolationDescription, AddressOf CreateMaximumHeightDesignRule)
