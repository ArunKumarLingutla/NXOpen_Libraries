...
namespace NXOpen
{
    ...
    /** Represents an @link Plane Plane@endlink  class. 
      <br> An instance of this class can be obtained from @link NXOpen::PlaneCollection NXOpen::PlaneCollection@endlink .  <br> 
     <br>  Created in NX4.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  Plane : public NXOpen::SmartObject, public virtual NXOpen::IPlane, public virtual NXOpen::ISurface, public virtual NXOpen::IOrientation, public virtual NXOpen::IPlaneForXformByThreePlanes
    {
