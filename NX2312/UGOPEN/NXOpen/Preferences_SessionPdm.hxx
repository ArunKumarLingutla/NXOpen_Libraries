    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionPdm
        {
            ...
            /** Options for the locking policy to be set*/
            public: enum LockingPolicyType
            {
                LockingPolicyTypeAutocheckinSave/** Automatic Check-out on Modify or Save; Check-in on Save or Close */,
                LockingPolicyTypeAutocheckinClose/** Automatic Check-out on Modify or Save; Check-in on Close */,
                LockingPolicyTypeManual/** Automatic Check-out on Save; Check-in on Save */,
                LockingPolicyTypeManualplusplus/** Manul Check-out required for Save, Manual Check-in */,
                LockingPolicyTypeSupermanualplusplus/** Manul Check-out required for Save, Check-in on Close */
            };
            ...
            /**Returns  the behaviour when part having JT dataset and no NX dataset is loaded 
             ...
             <br> License requirements : None */
            public: NXOpen::Preferences::SessionPdm::UnpopulatedBehaviourType UnpopulatedWithJtBehaviour
            (
            );
            /**Sets  the behaviour when part having JT dataset and no NX dataset is loaded 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUnpopulatedWithJtBehaviour
            (
                NXOpen::Preferences::SessionPdm::UnpopulatedBehaviourType behaviour /** behaviour */ 
            );
            ...
            (
                const NXString & seedName /** Seed Part name in Inch or Metric*/
            );
            /** Sets the default seed part that NX uses for parts without datasets  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            void SetDefaultSeed
            (
                const char * seedName /** Seed Part name in Inch or Metric*/
            );
            /**Returns  the Teamncemter Integration Preferences : Check-Out\Check-In Policy. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::SessionPdm::LockingPolicyType LockingPolicy
            (
            );
            /**Sets  the Teamncemter Integration Preferences : Check-Out\Check-In Policy. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetLockingPolicy
            (
                NXOpen::Preferences::SessionPdm::LockingPolicyType lock /** lock */ 
            );
