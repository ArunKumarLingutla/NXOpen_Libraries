...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Connections
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  Bolt : public NXOpen::CAE::Connections::IConnection, public virtual NXOpen::CAE::Connections::IMaterial, public virtual NXOpen::CAE::Connections::IFlangesContainer, public virtual NXOpen::CAE::Connections::ILocationsContainer, public virtual NXOpen::CAE::Connections::IDiameter, public virtual NXOpen::CAE::Connections::ILocationsWithDirContainer, public virtual NXOpen::CAE::Connections::ILocationsMultiPointContainer, public virtual NXOpen::CAE::Connections::IJoinDataContainer
            {
                ...
                /**Returns  the nut diameter  
                 ...
                 <br> License requirements : None */
                public: NXOpen::Expression * NutDiameter
                (
                );
                /**Returns  the nut diameter coefficient 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * NutDiameterCoefficient
                (
                );
                /**Returns  the nut diameter type 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::CAE::Connections::NutDiameterType NutDiameterType
                (
                );
                /**Sets  the nut diameter type 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void SetNutDiameterType
                (
                    NXOpen::CAE::Connections::NutDiameterType param /** Nut diameter type */
                );
                /**Returns  the define nut diameter 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: bool DefineNutDiameter
                (
                );
                /**Sets  the define nut diameter 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void SetDefineNutDiameter
                (
                    bool param /** Define Nut diameter */
                );
