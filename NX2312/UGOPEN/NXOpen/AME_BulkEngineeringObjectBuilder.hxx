        ...
        */
        class AMEOPENCPPEXPORT  BulkEngineeringObjectBuilder : public NXOpen::AME::MultipleObjectsBuilder
        {
            ...
            /**Returns  the symbol location builder
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link JA_BULK_ENGINEERING_OBJECT_BUILDER_get_SymbolPlacement JA_BULK_ENGINEERING_OBJECT_BUILDER_get_SymbolPlacement@endlink  instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use JA_BULK_ENGINEERING_OBJECT_BUILDER_get_SymbolPlacement instead.") NXOpen::AME::SymbolLocationBuilder * SymbolLocation
            (
            );
