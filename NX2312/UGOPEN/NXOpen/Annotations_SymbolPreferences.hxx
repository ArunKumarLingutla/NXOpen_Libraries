    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SymbolPreferences : public NXOpen::TransientObject
        {
            ...
            (
                bool autoSymbolSize /** auto symbol size */ 
            );
            ...
            /**Returns  the datum target auto size 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool DatumTargetAutoSized
            (
            );
            /**Sets  the datum target auto size 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Returns the datum target symbol color, font, and width  @return  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::LineCfw GetDatumTargetSymbolCfw
            (
            );
            /** Sets the datum target symbol color, font, and width  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDatumTargetSymbolCfw
            (
                const NXOpen::Annotations::LineCfw & datumTargetSymbolCFW /** datumtargetsymbolcfw */ 
            );
