...
#include <NXOpen/AME_ExtractAttributeExternalObjectBuilder.hxx>
        ...
        */
        class AMEOPENCPPEXPORT  ExtractAttributeBuilder : public NXOpen::Builder
        {
            ...
            public: enum Type
            {
                ...
                TypePort/** port */ ,
                TypeExternalObject/** external object */ 
            };
            ...
            /**Returns  the external object attribute builder 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ExtractAttributeExternalObjectBuilder * ExternalObjectAttributeBuilder
            (
            );
        };
    }
