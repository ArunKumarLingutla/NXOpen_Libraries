...
#include <NXOpen/CAE_LaminateCompositeMappingBuilder.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateGlobalLayup : public NXOpen::NXObject
        {
            ...
            /** Creates a @link NXOpen::CAE::LaminateFiberOrientationOptionsBuilder NXOpen::CAE::LaminateFiberOrientationOptionsBuilder@endlink  
            ...
            /** Creates a @link NXOpen::CAE::LaminateLockAngleBuilder NXOpen::CAE::LaminateLockAngleBuilder@endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateLockAngleBuilder * CreateLockAngleBuilder
            (
            );
            /** Creates a @link NXOpen::CAE::LaminateCompositeMappingBuilder NXOpen::CAE::LaminateCompositeMappingBuilder@endlink  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateCompositeMappingBuilder * CreateCompositeMappingBuilder
            (
            );
