...
#include <NXOpen/TDP_AttributesToExcludeBuilder.hxx>
        ...
        */
        class TDPOPENCPPEXPORT  PublisherBuilder : public NXOpen::Builder
        {
            ...
            public: enum ViewSelectionType
            {
                ...
                ViewSelectionTypeAllSectionViews/** all section views */ 
            };
            ...
            /** This method sets the value of the viewport view with the given label, if the viewport exists.
             ...
             <br> License requirements : None */
            public: bool SetViewPortViewValueOfViewPortLabel
            (
                const NXString & label /** label */ ,
                const NXString & value /** value */ 
            );
            /** This method sets the value of the viewport view with the given label, if the viewport exists.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            bool SetViewPortViewValueOfViewPortLabel
            (
                const char * label /** label */ ,
                const char * value /** value */ 
            );
            /** This method checks to see if a viewport with the given label exists for the selected template.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool HasViewportOfLabel
            (
                const NXString & label /** label */ 
            );
            /** This method checks to see if a viewport with the given label exists for the selected template.
            ...
            /**Returns  
             ...
             <br> License requirements : None */
            public: NXOpen::TDP::PublisherBuilder::SaveToOptionType SaveToOption
            (
            );
            /**Sets  
                        the save-to option, if the part to be published is in managed mode
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetSaveToOption
            (
                NXOpen::TDP::PublisherBuilder::SaveToOptionType saveToOption /** savetooption */ 
            );
            ...
            /**Sets  
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAttachSVG
            (
                bool attachSVG /** attachsvg */ 
            );
            ...
            (
                bool overrideColors /** overridecolors */ 
            );
            /**Returns 
            ...
            /**Returns 
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXColor * PmiColor
            (
            );
            /**Sets 
                    the PMI color, if the template to be published is a 3D PDF template
            ...
            /**Returns 
             ...
             <br> License requirements : None */
            public: NXOpen::TDP::AttributesToExcludeBuilder * AttributesToExclude
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: void SetGenerateJt
            (
                bool generateJT /** generatejt */ 
            );
