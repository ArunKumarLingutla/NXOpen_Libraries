    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  OPCClientBuilder : public NXOpen::Builder
        {
            ...
            {
                UpdateMethodAsynchRead/** asynchronous read method */,
                UpdateMethodSubscription/** subscription method */
            };
            ...
            /**  @brief  Gets OPC DA instance servers updateMethod  

               @return  pUpdateMethod of server with progID  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: int GetServerUpdateMethod
            (
                const NXString & progID /** progid */ 
            );
            /**  @brief  Gets OPC DA instance servers updateMethod  
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            int GetServerUpdateMethod
            (
                const char * progID /** progid */ 
            );
            /**  @brief  Sets OPC DA instance servers updateMethod  

              
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetServerUpdateMethod
            (
                const NXString & progID /** progid */ ,
                int updateMethod /** updateMethod of server with progID  */
            );
            /**  @brief  Sets OPC DA instance servers updateMethod  
            ...
            /**  @brief  Gets display name of OPC DA tag defined in array  

               @return  display name of tag defined in array  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: NXString GetTagArrayDisplayName
            (
                const NXString & progID /** progid */ ,
                const NXString & strTagId /** strtagid */ 
            );
            /**  @brief  Gets display name of OPC DA tag defined in array  
             ...
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            NXString GetTagArrayDisplayName
            (
                const char * progID /** progid */ ,
                const char * strTagId /** strtagid */ 
            );
            /**  @brief  Sets display name of OPC DA tag defined in array  

              
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetTagArrayDisplayName
            (
                const NXString & progID /** progid */ ,
                const NXString & strTagId /** strtagid */ ,
                const NXString & pArrayDisplayName /** display name of tag defined in array  */
            );
            /**  @brief  Sets display name of OPC DA tag defined in array  
             ...
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            void SetTagArrayDisplayName
            (
                const char * progID /** progid */ ,
                const char * strTagId /** strtagid */ ,
                const char * pArrayDisplayName /** display name of tag defined in array  */
            );
        };
    }
}
