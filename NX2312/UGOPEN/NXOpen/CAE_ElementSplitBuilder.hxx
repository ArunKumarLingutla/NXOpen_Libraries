        ...
        */
        class NXOPENCPP_CAEEXPORT  ElementSplitBuilder : public NXOpen::Builder
        {
            ...
            public: enum Types
            {
                ...
                TypesQuadTo4Tria/**Quad to 4 Tria */,
                TypesQuadTo2Quad/**Quad to 2 Quad */,
                TypesQuadTo3Quad/**Quad to 3 Quad */,
                TypesQuadTo4Quad/**Quad to 4 Quad */,
                TypesQuadTo4QuadSkew/**Quad to 4 Quad Second Option */,
                TypesQuadToMxN/**Quad to m by n */,
                TypesQuadToQuadAndTria/**Quad to Quad and Tria */,
                TypesQuadTo2QuadAndTria/**Quad to 2 Quad and Tria */,
                TypesTriaTo2Tria/**Tria to 2 Tria */,
                TypesTriaTo4Tria/**Tria to 4 Tria */,
                TypesTriaTo3Quad/**Tria to 3 Quad */,
            ...
            public: enum SplitMethodType
            {
                ...
                SplitMethodTypeShortestDiagonal/**Shortest Dialgonal*/
            };
            ...
            /**Returns  a value indicating whether elements are to be split based on Warp.  If True, elements with warp values that exceeds the value of @link NXOpen::CAE::ElementSplitBuilder::WarpValue NXOpen::CAE::ElementSplitBuilder::WarpValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool WarpToggle
            (
            );
            /**Sets  a value indicating whether elements are to be split based on Warp.  If True, elements with warp values that exceeds the value of @link NXOpen::CAE::ElementSplitBuilder::WarpValue NXOpen::CAE::ElementSplitBuilder::WarpValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  a value indicating whether elements are to be split based on Minimum Angle.  If True, elements having minimum angle values less than the value of @link NXOpen::CAE::ElementSplitBuilder::MinAngleValue NXOpen::CAE::ElementSplitBuilder::MinAngleValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool MinAngleToggle
            (
            );
            /**Sets  a value indicating whether elements are to be split based on Minimum Angle.  If True, elements having minimum angle values less than the value of @link NXOpen::CAE::ElementSplitBuilder::MinAngleValue NXOpen::CAE::ElementSplitBuilder::MinAngleValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  a value indicating whether elements are to be split based on Maximum Angle.  If True, elements with maximum angle values that exceeds the value of @link NXOpen::CAE::ElementSplitBuilder::MaxAngleValue NXOpen::CAE::ElementSplitBuilder::MaxAngleValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool MaxAngleToggle
            (
            );
            /**Sets  a value indicating whether elements are to be split based on Maximum Angle.  If True, elements with maximum angle values that exceeds the value of @link NXOpen::CAE::ElementSplitBuilder::MaxAngleValue NXOpen::CAE::ElementSplitBuilder::MaxAngleValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  a value indicating whether elements are to be split based on Jacobian.  If True, elements with jacobian values that exceeds the value of @link NXOpen::CAE::ElementSplitBuilder::JacobianValue NXOpen::CAE::ElementSplitBuilder::JacobianValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool JacobianToggle
            (
            );
            /**Sets  a value indicating whether elements are to be split based on Jacobian.  If True, elements with jacobian values that exceeds the value of @link NXOpen::CAE::ElementSplitBuilder::JacobianValue NXOpen::CAE::ElementSplitBuilder::JacobianValue@endlink  are split.
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the split type 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ElementSplitBuilder::Types SplitType
            (
            );
            /**Sets  the split type 
             <br>  Created in NX2306.0.0.  <br>  
            ...
            (
                NXOpen::CAE::ElementSplitBuilder::Types splitType /** splittype */ 
            );
        };
    }
}
