        ...
        */
        class NXOPENCPP_PDMEXPORT  DatabaseObjectManager : public NXOpen::TransientObject
        {
            ...
            /** This API finds database object for specified design session search criteria in the Teamcenter database using saved query.
                    ...
                    Note: Search criteria parameter should contain object_name(Required), object_type(optional), UID(optional) etc. @return  Database object 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::DatabaseObject * FindDesignSessionObjects
            (
                std::vector<NXString> & designSessionParamNames /** search criteria titles */,
                std::vector<NXString> & designSessionParamValues /** search criteria values */
            );
