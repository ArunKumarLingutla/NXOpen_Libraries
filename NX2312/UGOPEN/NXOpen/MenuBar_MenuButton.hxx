    ...
    namespace MenuBar
    {
        ...
        */
        class NXOPENUICPPEXPORT  MenuButton : public NXOpen::TransientObject
        {
            ...
            {
                AvailabilityStatusAvailable/** The button is available. */,
                AvailabilityStatusUnavailable/** The button is unavailable. */
            };
            ...
            /**Returns   the availability of the NXOpen button.  
             ...
             <br> License requirements : None */
            public: NXOpen::MenuBar::MenuButton::AvailabilityStatus ButtonAvailability
            (
            );
            /**Sets   the availability of the NXOpen button.  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetButtonAvailability
            (
                NXOpen::MenuBar::MenuButton::AvailabilityStatus availability /** availability */ 
            );
