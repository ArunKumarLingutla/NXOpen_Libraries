...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a Material Specification  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::MaterialSpecificationBuilder  NXOpen::Annotations::MaterialSpecificationBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  MaterialSpecification : public NXOpen::Annotations::PmiAttribute
        {
