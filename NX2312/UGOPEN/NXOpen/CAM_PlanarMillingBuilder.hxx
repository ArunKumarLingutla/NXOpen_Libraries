        ...
        */
        class NXOPENCPP_CAMEXPORT  PlanarMillingBuilder : public NXOpen::CAM::PlanarOperationBuilder
        {
            ...
            /**Returns  the part boundary 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::BoundaryPlanarMill * PartBoundary
            (
            );
            /**Returns  the blank boundary 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BoundaryPlanarMill * BlankBoundary
            (
            );
            /**Returns  the check boundary 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BoundaryPlanarMill * CheckBoundary
            (
            );
            /**Returns  the trim boundary 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BoundaryPlanarMill * TrimBoundary
            (
            );
        };
    }
