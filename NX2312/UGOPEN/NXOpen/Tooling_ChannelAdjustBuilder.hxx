...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        RepositionMethod </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ChannelAdjustBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the boundary objects used to adjust channel length. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * BoundaryObjects
            (
            );
            ...
            /**Returns  the flag to indicate whether to calculate along axial direction or including radial direction
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool AlongAxialDir
            (
            );
            /**Sets  the flag to indicate whether to calculate along axial direction or including radial direction
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetAlongAxialDir
            (
                bool copyOriginal /** copyoriginal */ 
            );
        };
