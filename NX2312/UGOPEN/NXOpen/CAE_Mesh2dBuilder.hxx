        ...
        */
        class NXOPENCPP_CAEEXPORT  Mesh2dBuilder : public NXOpen::Builder
        {
            /** the geometry usage type 
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::CAE::MeshControlBuilder NXOpen::CAE::MeshControlBuilder@endlink  instead. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::CAE::MeshControlBuilder instead.") GeometryType
            {
            ...
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::CAE::MeshControlBuilder instead.") NXOpen::CAE::Mesh2dBuilder::GeometryType GeometryUsageType
            (
            );
            /**Sets  the type of geometry to mesh 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::CAE::MeshControlBuilder instead.") void SetGeometryUsageType
            (
