...
#include <NXOpen/CAM_HoleMakingNcmTransfer.hxx>
#include <NXOpen/CAM_NcmWithinFeature.hxx>
        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmHoleMachining : public NXOpen::CAM::NcmSubopBuilder
        {
            ...
            /**Returns  the start from center 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NcmHoleMachiningEngRet NcmHoleMachiningEngRet@endlink  instead. <br>  

             <br>  Created in NX7.5.5.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NcmHoleMachiningEngRet instead.") bool StartFromCenter
            (
            );
            /**Sets  the start from center 
             ...
             <br>  Created in NX7.5.5.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NcmHoleMachiningEngRet instead.") void SetStartFromCenter
            (
            ...
            /**Returns  the transfer between regions 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::HoleMakingNcmTransfer * TransferBetweenRegions
            (
            );
            ...
            /**Returns  the within feature non cutting moves
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NcmWithinFeature * WithinFeatureNcm
            (
            );
        };
    }
