    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link NXOpen::CAE::ElementRotateBuilder NXOpen::CAE::ElementRotateBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::CAE::NodeElementManager::CreateElementRotateInEditModeBuilder  NXOpen::CAE::NodeElementManager::CreateElementRotateInEditModeBuilder @endlink  <br> 
         <br>  Created in NX12.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ElementRotateBuilder : public NXOpen::Builder
        {
            /** Type of element rotate*/
            public: enum Type
            {
                TypeAssociative/** Associative Rotate */,
                TypeNonAssociative/** Non-associative Rotate*/
            };
            ...
            /**Returns  the rotate type 
             ...
             <br> License requirements : None */
            public: NXOpen::CAE::ElementRotateBuilder::Type RotateType
            (
            );
            ...
            (
                NXOpen::CAE::ElementRotateBuilder::Type rotateType /** rotatetype */ 
            );
