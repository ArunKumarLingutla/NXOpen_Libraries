    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmPlanarEngRetBuilder : public NXOpen::TaggedObject
        {
            ...
            public: enum IfEngageDoesNotFitTypes
            {
                IfEngageDoesNotFitTypesPlunge/** Plunge */,
                IfEngageDoesNotFitTypesSkip/** Skip */
            };
            ...
            (
                NXOpen::Direction * vector /** the engage/retract vector */
            );
            ...
            /**Returns  the type to handle area if engage does not fit 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::NcmPlanarEngRetBuilder::IfEngageDoesNotFitTypes IfEngageDoesNotFit
            (
            );
            /**Sets  the type to handle area if engage does not fit 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetIfEngageDoesNotFit
            (
                NXOpen::CAM::NcmPlanarEngRetBuilder::IfEngageDoesNotFitTypes newValue /** newvalue */ 
            );
        };
    }
}
