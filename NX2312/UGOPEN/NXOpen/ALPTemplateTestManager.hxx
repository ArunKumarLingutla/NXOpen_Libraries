...
namespace NXOpen
{
    ...
    class ALPTemplateTestManagerImpl;
    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  ALPTemplateTestManager
    {
        private: ALPTemplateTestManagerImpl * m_alptemplatetestmanager_impl;
        private: NXOpen::TemplateTestManager* m_owner;
        /// \cond NX_NO_DOC 
        public: explicit ALPTemplateTestManager(NXOpen::TemplateTestManager *owner);
