    ...
    class NXOPENCPPEXPORT  DisplayableObject : public NXOpen::NXObject, public virtual NXOpen::IFitTo
    {
        ...
        */
        public: enum ObjectFont
        {
            ...
            ObjectFontEight/** Long Dashed Double Dotted */ = 11,
            ObjectFontNine/** Long Dashed Dotted for OOTB fonts and Undulating for shipbuilding fonts */,
            ObjectFontTen/** Long Dashed Triplicate Dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
            ObjectFontEleven/** Long Dashed Double Short Dashed for OOTB fonts and Railway for shipbuilding fonts */
        };
        ...
        /**Returns  the color of the object. After setting the color, you must call
                ...
                @link NXOpen::DisplayModification::SetNewColor NXOpen::DisplayModification::SetNewColor@endlink ,
                @link NXOpen::DisplayModification::SetNewWidth NXOpen::DisplayModification::SetNewWidth@endlink ,
                @link NXOpen::DisplayModification::SetNewFont NXOpen::DisplayModification::SetNewFont@endlink 
                and @link NXOpen::DisplayModification::SetNewLayer NXOpen::DisplayModification::SetNewLayer@endlink . Finally call
                @link NXOpen::DisplayModification::Apply NXOpen::DisplayModification::Apply@endlink .
        ...
        /**Returns  the layer that the object is in.  After setting the layer, you must call
                @link RedisplayObject RedisplayObject@endlink  in order for the change to take effect,
                except see the comments for @link NXOpen::DisplayableObject::SetColor NXOpen::DisplayableObject::SetColor@endlink .
