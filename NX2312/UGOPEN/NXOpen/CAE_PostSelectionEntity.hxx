    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostSelectionEntity : public NXOpen::TransientObject
        {
            ...
            /** Get the feature edge selected 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void GetFeatedge
            (
                int* edgeElemId /** edgeelemid */ ,
                int* edgeIdx /** edgeidx */ 
            );
            /** Set feature edge selected 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetFeatedge
            (
                int edgeElemId /** edgeelemid */ ,
                int edgeIdx /** edgeidx */ 
            );
            /** Tells if feature edge is set 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool HasFeatedge
            (
            );
            /**Returns  the feature face selected 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: int Featface
            (
            );
            /**Sets  the feature face selected 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetFeatface
            (
                int faceElemId /** faceelemid */ 
            );
            /** Tells if feature face is set 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
