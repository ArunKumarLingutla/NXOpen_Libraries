        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  GeneralViewStyle: public virtual NXOpen::Preferences::IGeneralViewPreferences
        {
            ...
            /**Returns  the value of angle of a member view.
             ...
             <br> License requirements : None */
            public: NXOpen::Scalar * AssociativeAngle
            (
            );
            /**Sets  the value of angle of a member view.
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetAssociativeAngle
            (
                NXOpen::Scalar * angle /** angle */ 
            );
            ...
            /**Returns  the snapshot toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Drawings::GeneralViewStyle::LockmethodView NXOpen::Drawings::GeneralViewStyle::LockmethodView@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::GeneralViewStyle::LockmethodView instead.") bool SnapshotView
            (
            );
            /**Sets  the snapshot toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Drawings::GeneralViewStyle::SetLockmethodView NXOpen::Drawings::GeneralViewStyle::SetLockmethodView@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::GeneralViewStyle::SetLockmethodView instead.") void SetSnapshotView
            (
