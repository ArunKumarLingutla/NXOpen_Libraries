        ...
        */
        class NXOPENCPP_PDMEXPORT  ConfigurationManager
        {
            ...
            /** Creates a new @link NXOpen::PDM::VariantRulesConfigurationBuilder NXOpen::PDM::VariantRulesConfigurationBuilder@endlink  object. 
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreateVariantRulesConfigurationBuilder instead") NXOpen::PDM::VariantRulesConfigurationBuilder * CreateVariantRulesConfigurationBuilder
            (
                NXOpen::BasePart * part /** The part that owns the builder. The builder owner is not
                                                                    strictly required (that is, it can be NULL), but it is
                                                                    highly suggested to ensure proper cleanup of the builder in
