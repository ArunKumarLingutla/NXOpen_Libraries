...
namespace NXOpen
{
    ...
    namespace PartMfg
    {
        class _SelectOperationBuilder;
        class SelectOperationImpl;
        ...
        */
        class PARTMFGOPENCPPEXPORT  SelectOperation : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectOperationImpl * m_selectoperation_impl;
            private: friend class  _SelectOperationBuilder;
            ...
            (
                NXOpen::PartMfg::Operation * selection /** selected object */
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PartMfg::Operation * Value
            (
            );
            ...
            (
                ...
                NXOpen::PartMfg::Operation * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::PartMfg::Operation * selection2 /** second selected object */,
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::PartMfg::Operation * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
