...
namespace NXOpen
{
    ...
    Width1ScaleFactor </term> <description> 
     
    1.0 </description> </item> 

    <item><term> 
     
    Width2ScaleFactor </term> <description> 
     
    2.0 </description> </item> 

    <item><term> 
     
    Width3ScaleFactor </term> <description> 
     
    3.0 </description> </item> 

    <item><term> 
     
    Width4ScaleFactor </term> <description> 
     
    4.0 </description> </item> 

    <item><term> 
     
    Width5ScaleFactor </term> <description> 
     
    5.0 </description> </item> 

    <item><term> 
     
    Width6ScaleFactor </term> <description> 
     
    6.0 </description> </item> 

    <item><term> 
     
    Width7ScaleFactor </term> <description> 
     
    7.0 </description> </item> 

    <item><term> 
     
    Width8ScaleFactor </term> <description> 
     
    8.0 </description> </item> 

    <item><term> 
     
    Width9ScaleFactor </term> <description> 
     
    9.0 </description> </item> 
    ...
    */
    class NXOPENCPPEXPORT  PrintBuilder : public NXOpen::Builder
    {
        ...
        /**Returns  the Print to File option.
                    Setting this option on will send the output to a device specific .prn file.
                    When this option is off, the output is send to the printer directly. 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: bool PrintToFile
        (
        );
        /**Sets  the Print to File option.
                    Setting this option on will send the output to a device specific .prn file.
                    When this option is off, the output is send to the printer directly. 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
