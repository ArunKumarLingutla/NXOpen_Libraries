        ...
        */
        class NXOPENCPP_CAEEXPORT  StressLinearizationResult : public NXOpen::TransientObject
        {
            ...
            struct StressState
            {
             ...
             /** Stress Linearization contextual results */
            public:
            struct Context
            {
                public: /** Global Coordinates */NXOpen::Point3d Location;
                public: /** Local X Coordinate along SCL */double XLocal;
                public: /** Temperature at location */double Temperature;
                public: /** Temperature Load at location */double TemperatureLoad;
                public: Context() :
                    Location(),
                    XLocal(),
                    Temperature(),
                ...
                /** Constructor for the Context struct. */ 
                public: Context(const NXOpen::Point3d &locationInitial /** Global Coordinates */, 
                        double xLocalInitial /** Local X Coordinate along SCL */, 
                        double temperatureInitial /** Temperature at location */, 
                        double temperatureLoadInitial /** Temperature Load at location */) :
                    Location(locationInitial),
                    XLocal(xLocalInitial),
            ...
            /** Get the additional results 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: std::vector<NXOpen::CAE::StressLinearizationResult::Context> GetContext
            (
            );
            ...
            /**Returns  the average temperature load 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: double AverageTemperatureLoad
            (
            );
