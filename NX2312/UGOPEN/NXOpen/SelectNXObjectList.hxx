...
namespace NXOpen
{
    ...
    class SelectNXObjectListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectNXObjectList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectNXObjectListImpl * m_selectnxobjectlist_impl;
        private: friend class  _SelectNXObjectListBuilder;
        protected: SelectNXObjectList();
        public: ~SelectNXObjectList();
        ...
        (
            const std::vector<NXOpen::NXObject *> & objects /** Objects to remove */
        );
