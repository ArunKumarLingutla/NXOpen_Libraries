    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PdmPart
        {
            ...
            /** Get the related drawings specs of loaded part. Returns part specifications of master and non-master drawings, filtering out the diagrams  @return  Array of part specification names for the related drawings 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetRelatedDrawingSpecs
            (
            );
            /** Given an array of parts, this API will remove the 'Precise Structure on Save' on all the parts 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void ClearPreciseStructureOnSave
            (
                const std::vector<NXOpen::BasePart *> & cancelPreciseOnSave /** Array of parts to cancel precise structure on save */
            );
            /** Get the related geometry representation specs of loaded part. Returns part specifications of the master and altreps, with some error handling  @return  Array of part specification names for the related geometry representation 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetRelatedGeometryRepresentationSpecs
            (
            );
