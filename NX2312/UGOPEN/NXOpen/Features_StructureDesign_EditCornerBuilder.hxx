            ...
            */
            class NXOPENCPP_FEATURESEXPORT  EditCornerBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /** Sets cope member index array
                 ...
                 <br> License requirements : nx_structure_design ("Structure Designer") */
                public: void SetCopeMemberIndexArray
                (
                    int iMemberIndex /** imemberindex */ ,
                    const std::vector<int> & refCopeMemberIndexArray /** refcopememberindexarray */ 
                );
                /** Add butt member reference object
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_structure_design ("Structure Designer") */
                public: void AddMemberReferenceObjects
                (
                    int iMemberIndex /** imemberindex */ ,
                    const std::vector<NXOpen::NXObject *> & tRefObj /** face or plane*/
                );
