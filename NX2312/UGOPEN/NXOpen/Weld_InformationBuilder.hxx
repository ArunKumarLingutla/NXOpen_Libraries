...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        OutputAttributes </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        OutputLengthAndVolume </term> <description> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  InformationBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to specify if the connected to information should be displayed in the output. 
             ...
             <br> License requirements : ugweld ("UG WELD") OR structure_weld ("STRUCTURE WELD") */
            public: bool ConnectedToInformation
            (
            );
            /**Sets  the option to specify if the connected to information should be displayed in the output. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : ugweld ("UG WELD") OR structure_weld ("STRUCTURE WELD") */
            public: void SetConnectedToInformation
            (
                bool connectedToInformation /** connectedtoinformation */ 
            );
