    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  TurnAvoidanceDepartureBuilder : public NXOpen::TaggedObject
        {
            ...
            */
            public: enum DeparturePathReorientToolHolderModes
            {
                DeparturePathReorientToolHolderModesNone/** Reorient tool holder is inactive. */,
                DeparturePathReorientToolHolderModesVariable/** Reorient tool holder is fixed. */
            };
            ...
            /**Returns  the departure path reorient tool holder mode 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::TurnAvoidanceDepartureBuilder::DeparturePathReorientToolHolderModes DeparturePathReorientToolHolderMode
            (
            );
            /**Sets  the departure path reorient tool holder mode 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetDeparturePathReorientToolHolderMode
            (
                NXOpen::CAM::TurnAvoidanceDepartureBuilder::DeparturePathReorientToolHolderModes departurePathReorientToolHolderMode /** the departure path reorient tool holder mode value */
            );
