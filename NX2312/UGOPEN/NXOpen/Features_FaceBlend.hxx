...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class FaceBlendImpl;
        /** Represents a Face Blend feature.  <br> To create or edit an instance of this class, use @link NXOpen::Features::FaceBlendBuilder  NXOpen::Features::FaceBlendBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  FaceBlend : public NXOpen::Features::BodyFeature, public virtual NXOpen::Features::IIsolateToolBodyOperation
        {
