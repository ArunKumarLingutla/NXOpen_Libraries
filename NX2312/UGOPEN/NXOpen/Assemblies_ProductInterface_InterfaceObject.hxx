            ...
            */
            class NXOPENCPP_ASSEMBLIESEXPORT  InterfaceObject : public NXOpen::NXObject
            {
                ...
                /** Relate unvalidated Requirement to the product interface 
                 ...
                 <br> License requirements : None */
                public: void InsertRelatedRequirement
                (
                    NXOpen::Validate::Requirement * relatedReq /** Requirement to relate to the product interface */
                );
                ...
                (
                    NXOpen::Validate::Requirement * relatedReq /** the Requirement to have a relation to product inerface */
                );
                /** Relate pmis to the product interface 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: void InsertRelatedPmis
                (
                    const std::vector<NXOpen::NXObject *> & relatedPmis /** Pmis to relate to the product interface */
                );
                ...
                (
                    NXOpen::NXObject * relatedPmi /** the Pmi to have a relation to product inerface */
                );
                /** Removes all related pmis from the product interface object  @return  number of pmis removed 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: int RemoveAllRelatedPmis
                (
                );
                /** Returns all pmis related to the product interface object  @return  pmis related to the product interface 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
