        ...
        */
        class NXOPENCPP_CAMEXPORT  PreprocessGeometryBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the default tool axis vector 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::Direction * FixedVector
            (
            );
            ...
            (
                NXOpen::Direction * newVector /** new vector */ 
            );
            ...
            /** Create new facet body with a specified angle tolerance 
             ...
             <br> License requirements : None */
            public: void CreateWithAngleTolerance
            (
                NXOpen::DisplayableObject * obj /** the new solid body, it will be converted to facet body in function */,
