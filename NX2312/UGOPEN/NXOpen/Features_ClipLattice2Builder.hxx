...
//
//  Source File:
//     Features_ClipLattice2Builder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class ClipLattice2BuilderImpl;
        /**    Represents a @link Features::ClipLattice2 Features::ClipLattice2@endlink  builder   <br> To create a new instance of this class, use @link NXOpen::Features::LatticeFeatureCollection::CreateClipLattice2Builder  NXOpen::Features::LatticeFeatureCollection::CreateClipLattice2Builder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ClipLattice2Builder : public NXOpen::Features::FeatureBuilder
        {
            ...
            private: ClipLattice2BuilderImpl * m_cliplattice2builder_impl;
            private: friend class  _ClipLattice2BuilderBuilder;
            protected: ClipLattice2Builder();
            public: ~ClipLattice2Builder();
            ...
            /**Returns  the lattice clip 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ClipLattice2Builder::LatticeClipOptions LatticeClip
            (
            );
            ...
            (
                NXOpen::Features::ClipLattice2Builder::LatticeClipOptions latticeClip /** latticeclip */ 
            );
            /**Returns  the boundary type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ClipLattice2Builder::BoundaryOptions BoundaryType
            (
            );
            ...
            (
                NXOpen::Features::ClipLattice2Builder::BoundaryOptions boundaryType /** boundarytype */ 
            );
            ...
            /**Returns  the clipping mode 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::ClipLattice2Builder::Clipping BoundaryClip
            (
            );
            ...
            (
                NXOpen::Features::ClipLattice2Builder::Clipping boundaryClip /** boundaryclip */ 
            );
            /**Returns  the tool bodies to trim the target body(s). The tool bodies are
                      ...
                      * be set on @link NXOpen::Features::ClipLattice2Builder::BooleanTool NXOpen::Features::ClipLattice2Builder::BooleanTool@endlink  are
