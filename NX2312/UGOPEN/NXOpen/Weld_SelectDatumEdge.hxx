...
namespace NXOpen
{
    ...
    namespace Weld
    {
        class _SelectDatumEdgeBuilder;
        class SelectDatumEdgeImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  SelectDatumEdge : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDatumEdgeImpl * m_selectdatumedge_impl;
            private: friend class  _SelectDatumEdgeBuilder;
            protected: SelectDatumEdge();
            public: ~SelectDatumEdge();
            ...
            (
                NXOpen::Weld::DatumEdge * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Weld::DatumEdge * Value
            (
            );
            ...
            (
                ...
                NXOpen::Weld::DatumEdge * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Weld::DatumEdge * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Weld::DatumEdge * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
