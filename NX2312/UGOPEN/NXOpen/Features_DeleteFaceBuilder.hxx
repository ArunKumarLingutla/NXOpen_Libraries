...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Heal </term> <description> 
         
        True </description> </item> 

        <item><term> 
         
        HealPlanar </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        MaxBlendRadius.Value </term> <description> 
         
        5.0 (millimeters part), 0.2 (inches part) </description> </item> 

        <item><term> 
         
        MaxHoleDiameter.Value </term> <description> 
         
        5.0 (millimeters part), 0.2 (inches part) </description> </item> 

        <item><term> 
         
        Setback </term> <description> 
         
        SelectedBlend </description> </item> 

        <item><term> 
         
        SpecifyBlend </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        UseHoleDiameter </term> <description> 
        ...
        class NXOPENCPP_FEATURESEXPORT  DeleteFaceBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            */
            ...
            /**Sets  the preference option indicating wether to delete undetermined blend chain as notch chain or as cliff chain 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_synchronous ("NX Synchronous"), solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") */
            ...
            /**Returns  the faces recognized for deletion. Please refer @link NXOpen::Features::FaceRecognitionBuilder NXOpen::Features::FaceRecognitionBuilder@endlink  for details. 
