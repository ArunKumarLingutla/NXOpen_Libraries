        ...
        */
        class NXOPENCPP_CAMEXPORT  RoughTurningBuilder : public NXOpen::CAM::RoughFinishTurningBuilder
        {
            ...
            */
            ...
            /**Returns  the turning bi-tangent smoothing builder
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::TurnBiTangentSmoothing * BiTangentSmoothingBuilder
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::TurnNcmSmoothing * NcmSmoothingBuilder
            (
            );

            /// \endcond 
            /**Returns  the turning ncm transfer within regions builder
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::TurnNcmTransferWithinRegions * NcmTransferWithinRegionsBuilder
            (
            );
        };
    }
