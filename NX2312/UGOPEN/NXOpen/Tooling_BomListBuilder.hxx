        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BomListBuilder : public NXOpen::Builder
        {
            ...
            public: enum BomListDecimalDelimiter
            {
                ...
                BomListDecimalDelimiterOriginal/** Keep the original format unchanged */
            };
            ...
            /** Checks if the blank was moved manually and then update the corresponding attributes accordingly.
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void CheckBlankAttributes
            (
            );
            /** Exports BOM list to excel @return  Export file full name
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXString ExportBomList
            (
                const std::vector<int> & rowNumber /** Row index*/,
                std::vector<NXString> & partPreviewImages /** Part preview image file name*/,
                std::vector<NXString> & exportFile /** Export file short name*/
            );
            /** Downloads BOM files from teamcenter to native
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void DownloadBomFilesFromTeamcenterToNative
            (
                const NXString & nativeFolder /** Native folder*/,
                NXOpen::Part * partTag /** The specified part from which to download bom file*/
            );
            /** Downloads BOM files from teamcenter to native
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            void DownloadBomFilesFromTeamcenterToNative
            (
                const char * nativeFolder /** Native folder*/,
                NXOpen::Part * partTag /** The specified part from which to download bom file*/
            );
            /** Sets the given rows exported
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetRowsExported
            (
                const std::vector<int> & rowNumber /** Row index*/
            );
        };
