        ...
        */
        class NXOPENUICPPEXPORT  TextColorFontWidth : public NXOpen::BlockStyler::UIBlock
        {
            ...
            /**Returns  the standard font style.
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXString StandardFontStyle
            (
            );
            /**Sets  the standard font style.
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: void SetStandardFontStyle
            (
            ...
            public: void TestColorValueChanged
            (
                const std::vector<int> & colorValueVector /**color values to set for the property. */
            );
            /**Tests font value changed event workflow mapped to this TextColorFontWidth block. Invokes the client notifiers to simulate UI like event.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: void TestFontValueChanged
            (
                const NXString & fontValue /** fontvalue */ 
            );
            /**Tests font value changed event workflow mapped to this TextColorFontWidth block. Invokes the client notifiers to simulate UI like event.
            ...
            /**Tests width value changed event workflow mapped to this TextColorFontWidth block.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: void TestWidthValueChanged
            (
                const NXString & widthValueString /** widthvaluestring */ 
            );
            /**Tests width value changed event workflow mapped to this TextColorFontWidth block.
