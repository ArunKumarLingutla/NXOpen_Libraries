    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ElementTypeBuilder : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the element dimension used to limit the valid @link NXOpen::CAE::ElementTypeBuilder::ElementTypeName NXOpen::CAE::ElementTypeBuilder::ElementTypeName@endlink 
                        values.  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /**Sets  the element dimension used to limit the valid @link NXOpen::CAE::ElementTypeBuilder::ElementTypeName NXOpen::CAE::ElementTypeBuilder::ElementTypeName@endlink 
                        values.  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /**Returns  the element order used to limit the valid @link NXOpen::CAE::ElementTypeBuilder::ElementTypeName NXOpen::CAE::ElementTypeBuilder::ElementTypeName@endlink 
                        values.   
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Sets  the element order used to limit the valid @link NXOpen::CAE::ElementTypeBuilder::ElementTypeName NXOpen::CAE::ElementTypeBuilder::ElementTypeName@endlink 
                        values.   
             <br>  Created in NX6.0.0.  <br>  
            ...
            /**  Returns the element type names that are currently valid for this builder based on the 
                        current setting of @link NXOpen::CAE::ElementTypeBuilder::ElementOrder NXOpen::CAE::ElementTypeBuilder::ElementOrder@endlink  
                        and  @link NXOpen::CAE::ElementTypeBuilder::ElementDimension NXOpen::CAE::ElementTypeBuilder::ElementDimension@endlink           
            ...
            /**Returns  the property table associated with the element type name @link NXOpen::CAE::ElementTypeBuilder::ElementTypeName NXOpen::CAE::ElementTypeBuilder::ElementTypeName@endlink . 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
