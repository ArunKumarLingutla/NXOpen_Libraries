...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link NXOpen::Display::IrayPlusMaterialEditorBuilder NXOpen::Display::IrayPlusMaterialEditorBuilder@endlink  
             ...
             <br> An instance of this class can be obtained from @link ViewCollection::CreateIrayPlusMaterialEditorBuilder ViewCollection::CreateIrayPlusMaterialEditorBuilder@endlink   <br> 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  IrayPlusMaterialEditorBuilder : public NXOpen::Builder
        {
            ...
            /** All the projection type.  */
            public: enum MappingProjections
            {
                MappingProjectionsUv/** uv */ ,
                MappingProjectionsPlanar/** planar */ ,
                MappingProjectionsBox/** box */ ,
                MappingProjectionsSpherical/** spherical */ ,
                MappingProjectionsCylindrical/** cylindrical */ 
            };

            /** Coordinate space types used in iray plus material*/
            public: enum CoordinateSpaceType
            {
                CoordinateSpaceTypeModel/**  Model Coordinate Space*/,
                CoordinateSpaceTypeWorld/**  World Coordinate Space*/
            };
            ...
            /** Exports current material of material editor builder into a MDL file. 
             ...
             <br> License requirements : studio_render ("UG STUDIO RENDER") */
            public: void ExportToMDLFile
            (
                const NXString & exportMdlFileName /** export mdl file name */ 
            );
            /** Exports current material of material editor builder into a MDL file. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : studio_render ("UG STUDIO RENDER") */
            void ExportToMDLFile
            (
                const char * exportMdlFileName /** export mdl file name */ 
            );
