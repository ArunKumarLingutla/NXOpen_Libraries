        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ShipCoordinatesBuilder : public NXOpen::Builder
            {
                ...
                public: NXOpen::Features::ShipDesign::ShipCoordinatesBuilder::Selection Type
                (
                );
                /**Sets  the selection type. 
                 <br>  Created in NX2007.0.0.  <br>  
                ...
                /** Set the current display port 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: void SetCurrentDisplayPort
                (
                ...
                /**Returns  the option of X value PMI Label 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool XValueLabel
                (
                );
                /**Sets  the option of X value PMI Label 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: void SetXValueLabel
                (
                    bool bCreatXValue /** bcreatxvalue */ 
                );
                /**Returns  the option of Y value PMI Label 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool YValueLabel
                (
                );
                /**Sets  the option of Y value PMI Label 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: void SetYValueLabel
                (
                    bool bCreatYValue /** bcreatyvalue */ 
                );
                /**Returns  the option of Z value PMI Label 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool ZValueLabel
                (
                );
                /**Sets  the option of Z value PMI Label 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: void SetZValueLabel
                (
                    bool bCreatZValue /** bcreatzvalue */ 
                );
                /**Returns  the option of create point by coordinates 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CreateByCoordinates
                (
                );
                /**Sets  the option of create point by coordinates 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: void SetCreateByCoordinates
                (
                    bool bCreatByCoordiantes /** bcreatbycoordiantes */ 
                );
                /**Returns  the flag to indicate whether the PMI label is created with leader. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CreatePmiWithLeader
                (
                );
                /**Sets  the flag to indicate whether the PMI label is created with leader. 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: void SetCreatePmiWithLeader
                (
                    bool bCreatePmiWithLeader /** bcreatepmiwithleader */ 
                );
                /** Append Point To Information Window.
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR routing_base ("Routing Basic") */
                public: NXOpen::Annotations::PmiNote * CreatePMILabelInModel
                (
                    NXOpen::Point * pointTag /** pointtag */ ,
                    NXOpen::ModelingView * targetView /** targetview */ ,
                    int labelType /** labeltype */ 
                );
            };
        }
    }
