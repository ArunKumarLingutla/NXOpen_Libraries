...
namespace NXOpen
{
    ...
    */
    enum NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::FileNew::GetApplicationNames that returns all application names.") FileNewApplication
    {
        ...
        FileNewApplicationAecSystem/** Specifies an NX AEC System file new template */,
        FileNewApplicationCaeIdeal/** Specifies a cae ideal dile new template */,
    ...
    enum FileNewTemplateType
    {
        ...
        FileNewTemplateTypeDesignWorkset/** Specifies a file new design workset template */,
        FileNewTemplateTypeDiagrammingDiscipline/** Specifies a template for diagramming item types per discipline*/,
    ...
    */
    class NXOPENCPPEXPORT  FileNew : public NXOpen::Builder
    {
        ...
        /** Sets the flag specifying if the current template customization allows Alternate representation creation using the template. 
                    Note: This function call should be explicitly made in order to create an altrep from the selected template. This is not the PAX file setting.
        ...
        /** Gets the flag specifying if the current template customization allows Alternate representation creation using the template 
                    Note: This reads the flag set on builder by @link NXOpen::FileNew::SetCanCreateAltrep NXOpen::FileNew::SetCanCreateAltrep@endlink  and not from the PAX file. 
        ...
        /** Gets all @link NXOpen::FileNewTemplate NXOpen::FileNewTemplate@endlink  file new templates. @return  Need to free it.
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::FileNewTemplate *> GetTemplates
        (
        );
        /** Returns @link NXOpen::FileNewTemplate NXOpen::FileNewTemplate@endlink  file new templates which match with given properties like File New Application
                    @link NXOpen::FileNewApplication NXOpen::FileNewApplication@endlink  and part units @link NXOpen::Part::Units NXOpen::Part::Units@endlink . If an invalid File New Application 
                    value is supplied as input to this API then it will not return any template. If JA_PART_units_mix is supplied as input to 'units' argument
                    then all unit's templates of given File New Application are returned. @return  Need to free it.
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::FileNewTemplate *> GetMatchingTemplates
        (
            NXOpen::FileNewApplication application /** application */ ,
            NXOpen::Part::Units units /** units */ 
        );
