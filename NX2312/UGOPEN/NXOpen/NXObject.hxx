    ...
    */
    class NXOPENCPPEXPORT  NXObject : public NXOpen::TaggedObject, public virtual NXOpen::INXObject
    {
        ...
        struct AttributeInformation
        {
            ...
            public: /** The attribute references expression but it may not be loaded in some cases, so this flag reflects that and expression value refers to NULL_TAG*/bool ExpressionNotLoaded;
            ...
            public: AttributeInformation(NXOpen::NXObject::AttributeType typeInitial /** Attribute type */, 
                    ...
                    bool expressionNotLoadedInitial /** The attribute references expression but it may not be loaded in some cases, so this flag reflects that and expression value refers to NULL_TAG*/) :
                Type(typeInitial),
                ...
                ExpressionNotLoaded(expressionNotLoadedInitial)
            {
            }
        };
        ...
        /** Determines if an attribute with the given Title, Type and array Index is present on the object
                ...
                NOTE: For mapped attributes in Managed NX, if the attributes have not been loaded, then it will return false.
                To load these mapped attributes, please use @link NXOpen::NXObject::GetUserAttributes NXOpen::NXObject::GetUserAttributes@endlink .
        ...
        /** Deletes the first attribute encountered with the given Type, Title.
                If a candidate attribute is not an array attribute, the Delete Entire Array input is ignored,
                If a candidate attribute is an array attribute and Delete Entire Array input is 'false', then the last element of the array is deleted.
                If a candidate attribute is an array attribute and Delete Entire Array input is 'true', then the entire array is deleted.
                NOTE: This method does not support the use of @link NXOpen::NXObject::AttributeTypeReference NXOpen::NXObject::AttributeTypeReference@endlink . 
         <br>  Created in NX8.0.0.  <br>  
         <br> License requirements : None */
