        ...
        namespace AM
        {
            ...
            */
            class MFGAMOPENCPPEXPORT  SupportBuilder : public NXOpen::Builder
            {
                ...
                public: enum PlatformFilterMode
                {
                    PlatformFilterModeKeepAll/** keep all */ ,
                    PlatformFilterModeFullContactOnly/** full contact only */ ,
                    PlatformFilterModePartitialTouch/** partitial touch */ ,
                    PlatformFilterModeKeepPlatformFraction/** keep platform fraction */ ,
                    PlatformFilterModeAvoidInternal/** avoid internal */ 
                };
                ...
                public: NXOpen::SelectNXObjectList * BodySelection
                (
                );
                ...
                /**Returns  the type of support to create when Mode is set to Manual 
                 ...
                 <br>  Created in NX11.0.2.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use NXOpen::Mfg::AM::SupportBuilder::SetSupportType instead.") NXOpen::Mfg::AM::SupportBuilder::Types Type
                (
                );
                /**Returns  the type of support to create when Mode is set to Manual 
                ...
                /**Sets  the type of support to create when Mode is set to Manual 
                 ...
                 <br>  Created in NX11.0.2.  <br>  
                 <br> License requirements : am_pb_mtls_sg_2 ("Advanced NX Additive Support Geometry") OR am_pb_mtls_sg_1 ("Basic NX Additive Support Geometry") */
                public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use NXOpen::Mfg::AM::SupportBuilder::SetSupportType instead.") void SetType
                (
                ...
                /**Returns  the platform filter 
                 ...
                 <br> License requirements : None */
                public: NXOpen::Mfg::AM::SupportBuilder::PlatformFilterMode PlatformFilter
                (
                );
                ...
                (
                    NXOpen::Mfg::AM::SupportBuilder::PlatformFilterMode platformFilter /** platformfilter */ 
                );
            };
        }
    }
