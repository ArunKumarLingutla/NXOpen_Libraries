    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SHMSignalProviderBuilder : public NXOpen::Builder
        {
             ...
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Mechatronics::SHMSignalProviderBuilder::GenericServerTagInfo NXOpen::Mechatronics::SHMSignalProviderBuilder::GenericServerTagInfo@endlink  instead. <br>  
            */
            public:
            struct NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Mechatronics::SHMSignalProviderBuilder::GenericServerTagInfo instead.") SignalInfo
            {
            ...
            /**  @brief  Get SHMProvider Signals Infomation  
             ...
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Mechatronics::SHMSignalProviderBuilder::GetSHMServerSignals NXOpen::Mechatronics::SHMSignalProviderBuilder::GetSHMServerSignals@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Mechatronics::SHMSignalProviderBuilder::GetSHMServerSignals instead.") std::vector<NXOpen::Mechatronics::SHMSignalProviderBuilder::SignalInfo> GetSHMSignals
            (
            );
            /**  @brief  Get SHMProvider Signals Infomation  
             ...
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: std::vector<NXOpen::Mechatronics::GenericServerTagInfo *> GetSHMServerSignals
            (
            );
            /**  @brief  Set SHMProvider Signals Infomation  

              
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::Mechatronics::SHMSignalProviderBuilder::SetSHMServerSignals NXOpen::Mechatronics::SHMSignalProviderBuilder::SetSHMServerSignals@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::Mechatronics::SHMSignalProviderBuilder::SetSHMServerSignals instead.") void SetSHMSignals
            (
            ...
            /**  @brief  Set SHMProvider Signals Infomation  
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void SetSHMServerSignals
            (
                const std::vector<NXOpen::Mechatronics::GenericServerTagInfo *> & signalInfos /** Array of SignalInfos */
            );
