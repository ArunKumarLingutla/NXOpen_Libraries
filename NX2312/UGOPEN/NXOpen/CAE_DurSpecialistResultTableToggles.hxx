    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistResultTableToggles : public NXOpen::TransientObject
        {
            ...
            /**Returns  the toggle that determines whether or not to show design load factors in the table(s) 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool ToggleDesignLoadFactor
            (
            );
            /**Sets  the toggle that determines whether or not to show design load factors in the table(s) 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetToggleDesignLoadFactor
            (
                bool toggleDesignLoadFactor /** toggledesignloadfactor */ 
            );
