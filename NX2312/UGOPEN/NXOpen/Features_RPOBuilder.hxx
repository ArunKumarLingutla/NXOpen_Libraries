        ...
        */
        class NXOPENCPP_FEATURESEXPORT  RPOBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Sets the expression value in order to constrain the target and tool entities 
                    ...
                    This step is not needed for @link NXOpen::PositioningDimension::SubtypePointOntoPoint NXOpen::PositioningDimension::SubtypePointOntoPoint@endlink , 
                    @link NXOpen::PositioningDimension::SubtypePointOntoLine NXOpen::PositioningDimension::SubtypePointOntoLine@endlink 
                    and @link NXOpen::PositioningDimension::SubtypeLineOntoLine NXOpen::PositioningDimension::SubtypeLineOntoLine@endlink  
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
            ...
            /** Sets a horizontal or vertical reference for the feature. A reference is required to be set
                    before creating a  @link NXOpen::PositioningDimension::SubtypeHorizontal NXOpen::PositioningDimension::SubtypeHorizontal@endlink  or 
                    @link NXOpen::PositioningDimension::SubtypeVertical NXOpen::PositioningDimension::SubtypeVertical@endlink  subtype of positioning dimension. 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : features_modeling ("FEATURES MODELING"), solid_modeling ("SOLIDS MODELING") */
