...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        InputCurvesOption.Associative </term> <description> 
         
        True </description> </item> 

        <item><term> 
         
        NearestPointOption </term> <description> 
         
        false </description> </item> 

        <item><term> 
         
        ProjectionDirectionMethod </term> <description> 
         
        AlongFaceNormal </description> </item> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ProjectCurveBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the maximum bridged gap size. 
                        ...
                        This option is only valid if @link NXOpen::Features::ProjectCurveBuilder::GapOption NXOpen::Features::ProjectCurveBuilder::GapOption@endlink  is true. 
