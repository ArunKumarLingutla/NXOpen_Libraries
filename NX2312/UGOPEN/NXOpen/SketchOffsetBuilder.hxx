...
namespace NXOpen
{
    ...
    CapType </term> <description> 
     
    Extension </description> </item> 

    <item><term> 
     
    ConvertToReference </term> <description> 
    ...
    CreateDimension </term> <description> 
    ...
    5.0 (millimeters part), 2.0 (inches part) </description> </item> 

    <item><term> 
     
    IsSymmetric </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  SketchOffsetBuilder : public NXOpen::Builder
    {
        ...
        /** This function reverses the offset direction of all the chains. For legacy sketches, 
                    @link NXOpen::SketchOffsetBuilder::ReverseOffsetDirectionOfChain NXOpen::SketchOffsetBuilder::ReverseOffsetDirectionOfChain@endlink  should be used on each chain. 
        ...
        /** This function will create or remove offset constraints based on symmetric setting in the builder 
