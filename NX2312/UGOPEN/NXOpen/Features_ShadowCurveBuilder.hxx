...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        WidthAngle.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ShadowCurveBuilder : public NXOpen::Features::ServiceOrientedFeatureCurveBuilder
        {
            ...
            /**Returns  the half angle - to be used only for pre-NX2212 shadow curve features.
                        Use <ja_property>NXOpen.Features.ShadowCurveBuilder.Angle</ja_property> for NX2212 and later. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * HalfAngle
            (
            );
            /**Returns  the angle - to be used only for NX2212 and later shadow curve features.
                        Use <ja_property>NXOpen.Features.ShadowCurveBuilder.HalfAngle</ja_property> for pre-NX2212 features. 
            ...
            /**Returns  the width half angle - to be used only for pre-NX2212 shadow curve features.
                        Use <ja_property>NXOpen.Features.ShadowCurveBuilder.WidthAngle</ja_property> for NX2212 and later.
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * WidthHalfAngle
            (
            );
            /**Returns  the width angle - to be used only for NX2212 and later shadow curve features.
                        Use <ja_property>NXOpen.Features.ShadowCurveBuilder.WidthHalfAngle</ja_property> for pre-NX2212 features. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * WidthAngle
            (
            );
            /**Returns  the vertical half angle  - to be used only for pre-NX2212 shadow curve features.
                        Use <ja_property>NXOpen.Features.ShadowCurveBuilder.VerticalAngle</ja_property> for NX2212 and later.
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * VerticalHalfAngle
            (
            );
            /**Returns  the vertical angle - to be used only for NX2212 and later shadow curve features.
                        Use <ja_property>NXOpen.Features.ShadowCurveBuilder.VerticalHalfAngle</ja_property> for pre-NX2212 features.
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
