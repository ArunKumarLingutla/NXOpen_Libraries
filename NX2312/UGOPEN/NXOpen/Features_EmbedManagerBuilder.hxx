...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        MathWorksheet </description> </item> 

        <item><term> 
         
        Location </term> <description> 
         
        OperatingSystem </description> </item> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  EmbedManagerBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            {
                UsageAreaTypesMathWorksheet/** Used by NX Maple and Maple applications. */,
                UsageAreaTypesTemplates/** Used by Feature Template and Product Template Studio application. */,
                UsageAreaTypesDesignLogic/** Used by Design Logic applications. */,
                UsageAreaTypesGeneral/** Used by Any application (Restricted). */,
                UsageAreaTypesProductTemplateStudio/** Used by Product Template Studio applications (Obsolete, See @link NXOpen::Features::EmbedManagerBuilder::UsageAreaTypesTemplates NXOpen::Features::EmbedManagerBuilder::UsageAreaTypesTemplates@endlink . */
            };
            ...
            public: enum TaskTypes
            {
                ...
                TaskTypesExport/** Export the existing embedded file. */
            };
