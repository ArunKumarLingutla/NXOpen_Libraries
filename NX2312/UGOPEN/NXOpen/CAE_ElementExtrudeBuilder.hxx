    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link NXOpen::CAE::ElementExtrudeBuilder NXOpen::CAE::ElementExtrudeBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::CAE::NodeElementManager::CreateElementExtrudeInEditModeBuilder  NXOpen::CAE::NodeElementManager::CreateElementExtrudeInEditModeBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ElementExtrudeBuilder : public NXOpen::Builder
        {
            /** Type of element extrude*/
            public: enum Type
            {
                TypeAssociative/** Associative Extrude */,
                TypeNonAssociative/** Non-associative Extrude*/
            };
            ...
            public: enum MethodType
            {
                ...
                MethodTypeRadial/** along radial direction*/
            };
            ...
            /**Returns  the flag which decides whether collectors are to be retained or not 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: bool RetainCollector
            (
            );
            /**Sets  the flag which decides whether collectors are to be retained or not 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetRetainCollector
            (
                bool isRetain /** isretain */ 
            );
            ...
            /**Returns  the extrude type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ElementExtrudeBuilder::Type ExtrudeType
            (
            );
            /**Sets  the extrude type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetExtrudeType
            (
                NXOpen::CAE::ElementExtrudeBuilder::Type extrudeType /** extrudetype */ 
            );
