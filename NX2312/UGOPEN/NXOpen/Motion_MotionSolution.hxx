...
#include <NXOpen/Motion_SolutionAppppProxy.hxx>
#include <NXOpen/Motion_SolutionResult.hxx>
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        ...
        {
            /** Format to export Linearizaton Matrices.  */
            public: enum LinearizationMatricesFormat
            {
                LinearizationMatricesFormatMatlab/** matlab */ ,
                LinearizationMatricesFormatText/** text */ 
            };
            ...
            /** Get graphs in the @link NXOpen::Motion::MotionSolution NXOpen::Motion::MotionSolution@endlink  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: std::vector<NXOpen::Motion::Graph *> GetGraphObject
            (
            );
            ...
            (
                NXOpen::Motion::SolutionManagerRunData * simulationRun /** simulation run */ 
            );
            /** Get @link NXOpen::Motion::SolutionAppppProxy NXOpen::Motion::SolutionAppppProxy@endlink  object.  @return  The @link NXOpen::Motion::SolutionAppppProxy NXOpen::Motion::SolutionAppppProxy@endlink  object 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SolutionAppppProxy * GetAppppProxy
            (
            );
            /** Constructs a new @link NXOpen::Motion::SolutionResult NXOpen::Motion::SolutionResult@endlink  object 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SolutionResult * NewSolutionResult
            (
            );
            /** Get all @link NXOpen::Motion::Animation NXOpen::Motion::Animation@endlink  objects  @return  The @link NXOpen::Motion::Animation NXOpen::Motion::Animation@endlink  objects 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: std::vector<NXOpen::Motion::Animation *> GetAnimations
            (
            );
            /** Exports Linearization Matrices to file.
                        The file will be created in the Solution working directory.
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void ExportLinearizationMatrices
            (
                double timeValue /** timevalue */ ,
                NXOpen::Motion::MotionSolution::LinearizationMatricesFormat fromat /** fromat */ 
            );
            /** Exports several Linearization Matrices to several files.
                        The files will be created in the Solution working directory.
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void ExportLinearizationMatricesOverRange
            (
                double startTimeValue /** starttimevalue */ ,
                double endTimeValue /** endtimevalue */ ,
                NXOpen::Motion::MotionSolution::LinearizationMatricesFormat fromat /** fromat */ 
            );
            /** Exports the acoustics loads filter.  
             <br>  Created in NX2312.3000.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void ExportAcousticLoads
            (
                const std::vector<NXString> & listRPMs /** listrpms */ ,
                const std::vector<NXString> & listElementTypes /** listelementtypes */ ,
                const std::vector<NXString> & listBodies /** listbodies */ ,
                const std::vector<NXString> & listMathFunctions /** listmathfunctions */ ,
                const std::vector<NXString> & listTransmissionErrors /** listtransmissionerrors */ ,
                const std::vector<NXString> & listKinematicSensors /** listkinematicsensors */ 
            );
