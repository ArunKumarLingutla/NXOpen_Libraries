    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            enum ShipnameFieldBuilderType
            {
                ...
                ShipnameFieldBuilderTypeDirectionInformation/**Field indicates profile's height direction */,
                ShipnameFieldBuilderTypeSmartFixed/** Field with an unchanging string which depends on value of previous type, if previous value is empty, the value of this type will not be added to the name */,
                ShipnameFieldBuilderTypeTcid/** Teamcenter ID field whose value comes from a parent part's Teamcenter ID */,
                ShipnameFieldBuilderTypeTcidFixed/** Teamcenter ID field with an unchanging string */,
                ShipnameFieldBuilderTypeTcidIndex/** Teamcenter ID field which will have a number generated */,
