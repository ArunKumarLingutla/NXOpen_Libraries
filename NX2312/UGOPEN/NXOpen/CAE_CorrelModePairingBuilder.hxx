        ...
        */
        class NXOPENCPP_CAEEXPORT  CorrelModePairingBuilder : public NXOpen::CAE::CorrelBaseBuilder
        {
            ...
            public: enum Auto
            {
                ...
                AutoXortho/** by X-Ortho metric */
            };

            /** The frequency mode type */
            public: enum Frequency
            {
                FrequencyDelta/** by delta */,
                FrequencyPct/** by percentage */
            };

            /** The shape correlation method type */
            public: enum ShapeCorrelation
            {
                ShapeCorrelationMac/** mac */ ,
                ShapeCorrelationXortho/** xortho */ ,
                ShapeCorrelationNone/** none */ 
            };
            ...
            /**Returns  the minimum X-Ortho allowable for pairing by X-Ortho 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: double XorthoLowerBound
            (
            );
            /**Sets  the minimum X-Ortho allowable for pairing by X-Ortho 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SetXorthoLowerBound
            (
                double xorthoLowerBound /** xortho lower bound */ 
            );
            ...
            /**Sets  the tracking master 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SetTrackingMaster
            (
                bool isTrackingMasterRef /** is tracking master ref */ 
            );
            /**Returns  the frequency mode 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::CorrelModePairingBuilder::Frequency FrequencyMode
            (
            );
            ...
            (
                NXOpen::CAE::CorrelModePairingBuilder::Frequency frequencyMode /** frequency mode */ 
            );
            /**Returns  the frequency tolerance percentage 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: double FrequencyTolerancePct
            (
            );
            /**Sets  the frequency tolerance percentage 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SetFrequencyTolerancePct
            (
                double frequencyTolerancePct /** frequency tolerance pct */ 
            );
            /**Returns  the mode pairs only 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool ModePairsOnly
            (
            );
            /**Sets  the mode pairs only 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SetModePairsOnly
            (
                bool modePairsOnly /** mode pairs only */ 
            );
            /**Returns  the Define Mode Clusters flag 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: bool DefineModeClusters
            (
            );
            /**Sets  the Define Mode Clusters flag 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SetDefineModeClusters
            (
                bool defineModeClusters /** define mode clusters */ 
            );
            ...
            (
                NXOpen::CAE::CorrelModePairingBuilder::ShapeCorrelation method /** method */ 
            );
        };
    }
}
