    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  FemCreationOptions : public NXOpen::TransientObject
        {
            ...
            {
                StrategyOptionManifold/** Manifold body */,
                StrategyOptionNonManifold/** Non-manifold body */
            };
            ...
            /** Set the strategy option 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SetStrategyOption
            (
                NXOpen::CAE::FemCreationOptions::StrategyOption strategyOption /** strategy option */ 
            );
            ...
            (
                NXOpen::Expression * toleranceValue /** tolerance value */ 
            );
