        ...
        */
        class AMEOPENCPPEXPORT  ImportHWXmlBuilder : public NXOpen::Builder
        {
            ...
            /** Reimport a single sw block 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: void ReimportSingleSwBlock
            (
                const NXString & nameOfMainBlockToImport /** nameofmainblocktoimport */ ,
                const std::vector<NXString> & namesOfSubBlocksToImport /** namesofsubblockstoimport */ ,
                NXOpen::AME::PlcBlock * blockToUpdate /** blocktoupdate */ ,
                bool isOnline /** isonline */ 
            );
            /** Reimport a single sw block 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            void ReimportSingleSwBlock
            (
                const char * nameOfMainBlockToImport /** nameofmainblocktoimport */ ,
                const std::vector<NXString> & namesOfSubBlocksToImport /** namesofsubblockstoimport */ ,
                NXOpen::AME::PlcBlock * blockToUpdate /** blocktoupdate */ ,
                bool isOnline /** isonline */ 
            );
            /** Reimport a single sw block from a TIA Portal Global Library 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: void ReimportSingleSwLibraryType
            (
                const NXString & swTypeId /** swtypeid */ ,
                const NXString & swTypeVersionId /** swtypeversionid */ ,
                NXOpen::AME::PlcBlock * blockToUpdate /** blocktoupdate */ 
            );
            /** Reimport a single sw block from a TIA Portal Global Library 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            void ReimportSingleSwLibraryType
            (
                const char * swTypeId /** swtypeid */ ,
                const char * swTypeVersionId /** swtypeversionid */ ,
                NXOpen::AME::PlcBlock * blockToUpdate /** blocktoupdate */ 
            );
            ...
            /** Get System library 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: void GetSystemLibrary
            (
            );
            /** Import master copy from System library 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: void ImportSwSystemLibraryMasterCopies
            (
                const std::vector<NXString> & masterCopyIds /** mastercopyids */ ,
                bool importFolderAsMasterCopy /** importfolderasmastercopy */ 
            );
            ...
            /** Get library list 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: void GetSystemLibraryList
            (
                std::vector<NXString> & systemLibraryList /** systemlibrarylist */ 
            );
        };
    }
}
