...
//
//  Source File:
//     Features_VehicleDesign_SectionViewDataProvider.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            class _SectionViewDataProviderBuilder;
            class SectionViewDataProviderImpl;
            /**
                Provides basic data for section view.
                When @link Builder::Commit Builder::Commit@endlink  is called NULL will be returned.
                 <br> To create a new instance of this class, use @link NXOpen::Features::VehicleDesignCollection::CreateSectionViewDataProvider  NXOpen::Features::VehicleDesignCollection::CreateSectionViewDataProvider @endlink  <br> 
             <br>  Created in NX2312.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  SectionViewDataProvider : public NXOpen::TaggedObject, public virtual NXOpen::ITableEditorDataProvider
            {
                private: SectionViewDataProviderImpl * m_sectionviewdataprovider_impl;
                private: friend class  _SectionViewDataProviderBuilder;
                protected: SectionViewDataProvider();
                public: ~SectionViewDataProvider();
