    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  UnitCellEditorBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  an option to display grid lines on all 6 faces of the working cube 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool ShowGrid
            (
            );
            /**Sets  an option to display grid lines on all 6 faces of the working cube 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lattice_base (" NX Lattice Base") OR nx_lattice_designer (" NX Lattice Designer") */
            ...
            /**Returns  the number of grid lines on the 6 faces of the working cube when show grid is ON 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: int GridLineCount
            (
            );
            /**Sets  the number of grid lines on the 6 faces of the working cube when show grid is ON 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lattice_base (" NX Lattice Base") OR nx_lattice_designer (" NX Lattice Designer") */
            public: void SetGridLineCount
            (
                int gridLineCount /** gridlinecount */ 
            );
