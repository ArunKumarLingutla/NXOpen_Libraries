...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AngleResult </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        AngleResultExp.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        AngleStep </term> <description> 
         
        25 </description> </item> 

        <item><term> 
         
        AngleStepExp.Value </term> <description> 
         
        25 </description> </item> 

        <item><term> 
         
        BlankArea </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        BlankAreaExp.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        BoundarySegment </term> <description> 
         
        200 </description> </item> 

        <item><term> 
         
        HeightStep </term> <description> 
         
        25 </description> </item> 

        <item><term> 
         
        IsReNest </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LayoutType </term> <description> 
        ...
        MinimumDistanceExp.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PitchResult </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PitchResultExp.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        StripWidthResult </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        StripWidthResultExp.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        Utilization </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        WebDistance </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        WebDistanceExp.Value </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  BlankNestingBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the distance between the blank and the strip. 
             ...
             <br> License requirements : None */
            public: NXOpen::Expression * WebDistanceExp
            (
            );
            /**Returns  the minimum distance between the adjacent blanks. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MinimumDistanceExp
            (
            );
            /**Returns  the angle increment to use when rotating the blank during the processing to find the best layout. The angle is specified in degrees. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * AngleStepExp
            (
            );
            ...
            /**Returns  the strip width. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * StripWidthResultExp
            (
            );
            /**Returns  the distance between blanks that was found in the processing. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * PitchResultExp
            (
            );
            /**Returns  the angle between processed blank and original blank. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * AngleResultExp
            (
            );
            /**Returns  the up datum face area that was found in the processing. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * BlankAreaExp
            (
            );
            ...
            /**Returns  the attribute value, which specifies whether to re-nest or not 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsReNest
            (
            );
            /**Sets  the attribute value, which specifies whether to re-nest or not 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetReNest
            (
                bool isReNest /** isrenest */ 
            );
        };
    }
}
