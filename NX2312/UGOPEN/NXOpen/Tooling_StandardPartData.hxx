        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  StandardPartData : public NXOpen::TransientObject
        {
            ...
            /** Sets the initial work part 
             ...
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            public: void SetInitialWorkPart
            (
                NXOpen::Part * initialWorkPart /** initialworkpart */ 
            );
            /** Gets the current concept object in edit  @return  The concept object in edit, it can be a symbol or a point 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * GetCurrentConceptObject
            (
            );
            /** Sets the standard part concept object in edit 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            public: void SetCurrentConceptObject
            (
