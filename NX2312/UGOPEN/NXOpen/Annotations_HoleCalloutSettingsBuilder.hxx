        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  HoleCalloutSettingsBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: enum Parametertype
            {
                ...
                ParametertypeThreadForm/** thread form */ ,
                ParametertypeThreadInternalExternalSymbol/** thread internal external symbol */ ,
                ParametertypeThreadPitch/** thread pitch */ ,
                ParametertypeSymbolicThreadForm/** symbolic thread form */ ,
                ParametertypeSymbolicThreadInternalExternalSymbol/** symbolic thread internal external symbol */ ,
                ParametertypeSymbolicThreadPitch/** symbolic thread pitch */ ,
                ParametertypeDrillSize/** drill size */ ,
                ParametertypeThreadHandedness/** thread handedness */ ,
                ParametertypeReliefDiameter/** relief diameter */ ,
                ParametertypeReliefDepth/** relief depth */ ,
                ParametertypeReliefChamferDiameter/** relief chamfer diameter */ ,
                ParametertypeReliefChamferAngle/** relief chamfer angle */ ,
                ParametertypeStartChamferDiameter/** start chamfer diameter */ ,
                ParametertypeStartChamferAngle/** start chamfer angle */ ,
                ParametertypeEndChamferDiameter/** end chamfer diameter */ ,
                ParametertypeEndChamferAngle/** end chamfer angle */ ,
                ParametertypeNeckChamferDiameter/** neck chamfer diameter */ ,
                ParametertypeNeckChamferAngle/** neck chamfer angle */ ,
                ParametertypeThreadTolerance/** thread tolerance */ ,
            ...
            /** This reprensent the option that specifies if the thread size parameter is displayed as a vertical fraction, as a single line or the same as the callout parameter on the feature.*/
            public: enum Displaytype
            {
                DisplaytypeVertical/** vertical */ ,
                DisplaytypeInline/** inline */ ,
                DisplaytypeCallout/** callout */ ,
            ...
            /** Get Metric Internal Thread Tolerance Value, which defines thread tolerances on metric threads.
                        Only available when feature type is
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread@endlink  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetMetricInternalThreadTolerance
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Featuretype featureType /** ThreadedHole or SymbolicThread*/
            );
            /** Set Metric Internal Thread Tolerance Value, which defines thread tolerances on metric threads.
                        Only available when feature type is
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread@endlink  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetMetricInternalThreadTolerance
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Featuretype featureType /** ThreadedHole or SymbolicThread*/,
                const NXString & internalThreadTolerance /** internalthreadtolerance */ 
            );
            /** Set Metric Internal Thread Tolerance Value, which defines thread tolerances on metric threads.
                        Only available when feature type is
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            void SetMetricInternalThreadTolerance
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Featuretype featureType /** ThreadedHole or SymbolicThread*/,
                const char * internalThreadTolerance /** internalthreadtolerance */ 
            );
            /** Get Metric External Thread Tolerance Value, which defines thread tolerances on metric threads.
                        Only available when feature type is
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread@endlink  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetMetricExternalThreadTolerance
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Featuretype featureType /** ThreadedHole or SymbolicThread*/
            );
            /** Set Metric External Thread Tolerance Value, which defines thread tolerances on metric threads.
                        Only available when feature type is
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread@endlink  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetMetricExternalThreadTolerance
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Featuretype featureType /** ThreadedHole or SymbolicThread*/,
                const NXString & externalThreadTolerance /** externalthreadtolerance */ 
            );
            /** Set Metric External Thread Tolerance Value, which defines thread tolerances on metric threads.
                        Only available when feature type is
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            void SetMetricExternalThreadTolerance
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Featuretype featureType /** ThreadedHole or SymbolicThread*/,
                const char * externalThreadTolerance /** externalthreadtolerance */ 
            );
            /** Get Parameter display type that specifies if the thread size and pitch parameters are displayed as a vertical fraction or as a single line. 
                        Only available when feature types are
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread@endlink 
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::HoleCalloutSettingsBuilder::Displaytype GetDisplayType
            (
            );
            /** Set Parameter display type that specifies if the thread size and pitch parameters are displayed as a vertical fraction or as a single line. 
                        Only available when feature types are
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeThreadedHole@endlink ,
                        @link NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread NXOpen::Annotations::HoleCalloutSettingsBuilder::FeaturetypeSymbolicThread@endlink 
            ...
            (
                NXOpen::Annotations::HoleCalloutSettingsBuilder::Displaytype displayType /** displaytype */ 
            );
