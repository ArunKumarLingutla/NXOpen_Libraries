...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        OrientationOption </term> <description> 
         
        OrientXpress </description> </item> 

        <item><term> 
         
        Value.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  LinearDimensionBuilder : public NXOpen::Features::DimensionBuilder
        {
            ...
            /**Returns  the original distance.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: double OriginalDistance
            (
            );
            /**Sets  the original distance.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_synchronous ("NX Synchronous"), solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetOriginalDistance
            (
