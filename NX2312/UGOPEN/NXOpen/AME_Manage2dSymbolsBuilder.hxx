...
namespace NXOpen
{
    ...
    namespace AME
    {
        ...
        DrawingStandard </term> <description> 
         
        Iec </description> </item> 

        <item><term> 
         
        SymbolRepresentationType </term> <description> 
         
        MultiLineSchematic </description> </item> 
        ...
        */
        class AMEOPENCPPEXPORT  Manage2dSymbolsBuilder : public NXOpen::AME::AMEBaseBuilder
        {
            ...
            public: enum SymbolRepresentationTypes
            {
                ...
                SymbolRepresentationTypesFluidicDiagram/** fluidic diagram */ ,
                SymbolRepresentationTypesCabinet2d/** cabinet2d */ ,
                SymbolRepresentationTypesGenericSchematic/** generic schematic */ 
            };

            /** Symbol drawing standard */
            public: enum SymbolDrawingStandard
            {
                SymbolDrawingStandardIec/** iec */ ,
                SymbolDrawingStandardAnsi/** ansi */ ,
                SymbolDrawingStandardNonStandard/** non standard */ 
            };
            ...
            /**Returns  the representation type which could be of @link NXOpen::AME::Manage2dSymbolsBuilder::DrawingStandard NXOpen::AME::Manage2dSymbolsBuilder::DrawingStandard@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::Manage2dSymbolsBuilder::SymbolDrawingStandard DrawingStandard
            (
            );
            /**Sets  the representation type which could be of @link NXOpen::AME::Manage2dSymbolsBuilder::DrawingStandard NXOpen::AME::Manage2dSymbolsBuilder::DrawingStandard@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetDrawingStandard
            (
                NXOpen::AME::Manage2dSymbolsBuilder::SymbolDrawingStandard drawingStandard /** drawingstandard */ 
            );
            /**Sets  the immediate commit option of manage 2D symbol builder
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetImmediateCommit
            (
                bool immediateCommit /** immediatecommit */ 
            );
            ...
            /**Returns  the symbol selection builder
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::SelectionBaseDefinitionBuilder * SymbolSelection
            (
            );
        };
    }
