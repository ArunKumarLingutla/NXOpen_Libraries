...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        class CurveLimitsDataImpl;
        /** Represents a @link NXOpen::GeometricUtilities::CurveLimitsData NXOpen::GeometricUtilities::CurveLimitsData@endlink  
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  CurveLimitsData : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: CurveLimitsDataImpl * m_curvelimitsdata_impl;
            private: friend class  _CurveLimitsDataBuilder;
            protected: CurveLimitsData();
            public: ~CurveLimitsData();
