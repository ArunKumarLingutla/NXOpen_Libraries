    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link NXOpen::CAE::ElementProjectBuilder NXOpen::CAE::ElementProjectBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::CAE::NodeElementManager::CreateElementProjectInEditModeBuilder  NXOpen::CAE::NodeElementManager::CreateElementProjectInEditModeBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ElementProjectBuilder : public NXOpen::Builder
        {
            /** Type of element project*/
            public: enum Type
            {
                TypeAssociative/** Associative Project */,
                TypeNonAssociative/** Non-associative Project*/
            };
            ...
            /**Returns  the project type 
             ...
             <br> License requirements : None */
            public: NXOpen::CAE::ElementProjectBuilder::Type ProjectType
            (
            );
            ...
            (
                NXOpen::CAE::ElementProjectBuilder::Type projectType /** projecttype */ 
            );
