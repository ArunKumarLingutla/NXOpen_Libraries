    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  PlcMethodBuilder : public NXOpen::Builder
        {
            ...
            {
                ParameterLevelTypeAll/** all */ ,
                ParameterLevelTypeFirst/** first */ ,
                ParameterLevelTypeSecond/** second */ ,
                ParameterLevelTypeThird/** third */ 
            };
            ...
            /** Create a parameter by a given  name 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXOpen::NXObject * CreateParameter
            (
            ...
            /** Create and assigns a parameter. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::NXObject * CreateAndAssignParameter
            (
                int compileUnitIndex /** compileunitindex */ ,
                int statementLineIndex /** statementlineindex */ ,
                int statementLineInnerIndex /** statementlineinnerindex */ 
            );
            /** Creates one ore more parameters by a given external relation port 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void CreateParametersByExternalRelation
            (
                NXOpen::AME::PlcSoftwareGenPort * swGenerationPort /** swgenerationport */ ,
                std::vector<NXOpen::NXObject *> & createdParameters /** createdparameters */ 
            );
            /** To Create Method 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Assign parameter to operand 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: int AssignSoftwareGeneratableObjectToParameter
            (
                int compileUnitIndex /** compileunitindex */ ,
                int statementLineIndex /** statementlineindex */ ,
                int statementLineInnerIndex /** statementlineinnerindex */ ,
            ...
            /**Returns  the automatic insertion setting 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: bool InsertOnCreate
            (
            );
            /**Sets  the automatic insertion setting 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetInsertOnCreate
            (
                bool insertOnCreate /** insertoncreate */ 
            );
            /**Returns  the level of the created or assigned parameter 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::PlcMethodBuilder::ParameterLevelType ParameterLevel
            (
            );
            /**Sets  the level of the created or assigned parameter 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetParameterLevel
            (
                NXOpen::AME::PlcMethodBuilder::ParameterLevelType parameterLevel /** parameterlevel */ 
            );
            /** Change subvariable of method parameter 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ChangeSubVariable
            (
                NXOpen::AME::PlcCodePosition * position /** position */ ,
                std::vector<NXString> & subVariablePath /** subvariablepath */ 
            );
        };
    }
}
