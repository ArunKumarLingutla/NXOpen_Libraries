        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ProfileSystemBuilder : public NXOpen::Features::ShipDesign::FeatureParmsBuilder
            {
                ...
                /** Trim option for profile system at the ends when its connection type is connected. */
                public: enum TrimOption
                {
                    TrimOptionSquareCut/** Profile system will be square trimed at the ends. */,
                    TrimOptionNeatTrim/** It will create an End Cut that trim the profile system to the selected geometry.*/
                };
                ...
                public: NXOpen::Features::ShipDesign::ProfileSystemBuilder::LimitType Limit1Method
                (
                );
                /**Sets  the limit method 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                public: void SetLimit1Method
                (
                    NXOpen::Features::ShipDesign::ProfileSystemBuilder::LimitType limit1Method /** limit1method */ 
                );
                /**Returns  the limit method 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ProfileSystemBuilder::LimitType Limit2Method
                (
                );
                /**Sets  the limit method 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                public: void SetLimit2Method
                (
                    NXOpen::Features::ShipDesign::ProfileSystemBuilder::LimitType limit2Method /** limit2method */ 
                );
                /**Returns  the path limit by the specific value. 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * Limit1Value
                (
                );
                /**Returns  the path limit by the specific value. 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * Limit2Value
                (
                );
