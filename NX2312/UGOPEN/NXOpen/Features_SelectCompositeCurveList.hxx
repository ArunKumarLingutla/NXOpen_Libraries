...
//
//  Source File:
//     Features_SelectCompositeCurveList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _SelectCompositeCurveListBuilder;
        class SelectCompositeCurveListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SelectCompositeCurveList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectCompositeCurveListImpl * m_selectcompositecurvelist_impl;
            private: friend class  _SelectCompositeCurveListBuilder;
            protected: SelectCompositeCurveList();
            public: ~SelectCompositeCurveList();
            ...
            public: bool Add
            (
                NXOpen::Features::CompositeCurve * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Features::CompositeCurve *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Features::CompositeCurve * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Features::CompositeCurve * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Features::CompositeCurve * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Features::CompositeCurve * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Features::CompositeCurve *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Features::CompositeCurve * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Features::CompositeCurve *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::CompositeCurve *> GetArray
            (
            );
