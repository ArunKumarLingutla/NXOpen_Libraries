...
#include <NXOpen/CAE_SimPatternCloneLbcFolderBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        ...
        {
            /** Used to specify the axis symmetric abstraction type during solution creation. */
            public: enum AxisymAbstractionType
            {
                AxisymAbstractionTypeNone/** No axis symmetric elements are allowed */,
                AxisymAbstractionTypeZxPlane/** ZX plane - Z axis symmetric elements are allowed */,
                AxisymAbstractionTypeXyPlane/** XY plane - Y axis symmetric elements are allowed */,
                AxisymAbstractionTypeXxyPlane/** XY plane - X axis symmetric elements are allowed */
            };
            ...
            (
                ...
                const NXString & solutionType /** name of the solution type */,
                const NXString & name /** name of the solution to be created */,
                NXOpen::CAE::SimSimulation::AxisymAbstractionType abstractionType /** the axis symmetric abstraction type. Refer to NX help for more information */
            );
            /** Creates a solution
                      @return  the created @link NXOpen::CAE::SimSolution NXOpen::CAE::SimSolution@endlink  
             <br>  Created in NX11.0.0.  <br>  
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::AttachedResultsBuilder * CreateAttachedResultsBuilder
            (
            ...
            /** Creates a @link CAE::SimPatternCloneLbcBuilder CAE::SimPatternCloneLbcBuilder@endlink    @return  pattern boundary condition clone builder 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SimPatternCloneLbcBuilder * CreatePatternCloneLbcBuilder
            (
            );
            /** Creates a @link CAE::SimPatternCloneLbcFolderBuilder CAE::SimPatternCloneLbcFolderBuilder@endlink    @return  pattern boundary condition folder clone builder 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SimPatternCloneLbcFolderBuilder * CreatePatternCloneLbcFolderBuilder
            (
            );
            ...
            (
                const NXString & pcApplicationCommand /** pcapplicationcommand */ 
            );
            /** Executes an application command 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            (
                const char * pcApplicationCommand /** pcapplicationcommand */ 
            );
            ...
            */
            ...
            /** Returns the Am Materials manager belonging to this sim part 
             <br>  Created in NX2212.0.0.  <br>  
            */
            public: NXOpen::CAE::AmMaterialsManager *AmMaterialsManager();
            ...
            */
            ...
            /** Returns the model and load pre-processing manager belonging to this sim part 
             <br>  Created in NX1847.0.0.  <br>  
            */
            ...
            */
            ...
            /** Returns the parametric study manager belonging to this sim part 
             <br>  Created in NX2312.0.0.  <br>  
            */
            public: NXOpen::CAE::ParametricStudyManager *ParametricStudyManager();
            /** Returns the acoustics manage belonging to this sim part 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::Acoustics *Acoustics();
            /** Returns the smart virtual sensing manager belonging to this sim part 
             <br>  Created in NX2312.0.0.  <br>  
            */
            public: NXOpen::CAE::SmartVirtualSensingManager *SmartVirtualSensingManager();
            /** Returns the test model collection belonging to this sim part 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::TestModelCollection *TestModels();
            /** Returns the function set collection belonging to this sim part 
             <br>  Created in NX2206.0.0.  <br>  
            */
            public: NXOpen::CAE::CorrelFunctionSetCollection *FunctionSets();
