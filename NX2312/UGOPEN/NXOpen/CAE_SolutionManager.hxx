    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SolutionManager : public NXOpen::CAE::LbcAssociationMgr
        {
            ...
            (
                NXOpen::CAE::SimSolution * sol /** solution */,
                NXOpen::CAE::SolutionManager::OverallScaleFactorEnum scaleFactorType /** scalefactortype */ ,
            ...
            /** Get scale factor on bc in a solution
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Get scale factor on bc folder in a solution 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /** Get scale factor on loadset in a solution @return  scale factor 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
