        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MoldFeatureRecognitionBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::Body * productBody /** productbody */ ,
                const NXOpen::Vector3d & drawingVector /** drawingvector */ ,
                bool* bFaceAnalyzed /** bfaceanalyzed */ ,
                bool* bUndercutAnalyzed /** bundercutanalyzed */ ,
                bool* bRibAnalyzed /** bribanalyzed */ ,
                bool* bOpeningAreaAnalyzed /** bopeningareaanalyzed */ ,
                bool* hasDifferentBody /** hasdifferentbody */ ,
                bool* hasDifferentVector /** hasdifferentvector */ 
            );
            /** Create a molding cost feature in cloud application  @return  the created costing feature tag 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::CostDataObject * CreateMoldingFeatureInCloudApp
            (
                NXOpen::Tooling::MoldFeatureRecognitionBuilder::CostFeatureType costFeatureType /** costfeaturetype */ 
            );
            /** Calculate wall thickness for the selected body
             <br>  Created in NX2011.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void CalculateWallThickness
            (
            );
            /** Add all facets of the selected face into the cost feature, and create covergent body for all facets
             <br>  Created in NX2206.4000.0.  <br>  
             <br> License requirements : None */
            public: void AddFacesToFeatureInCloupApp
            (
                const std::vector<NXOpen::Face *> & faces /** faces */ ,
                NXOpen::Tooling::CostDataObject * costFeature /** the costing feature to add the face*/
            );
            /** Asks the cost feature which has the specified convergent body 
             <br>  Created in NX2206.5000.0.  <br>  
             <br> License requirements : None */
            public: void AskCostFeatureFromConvergentBody
            (
                NXOpen::Tooling::MoldFeatureRecognitionBuilder::CostFeatureType moldingFeatureType /** moldingfeaturetype */ ,
                const std::vector<NXOpen::Body *> & convergentBodies /** convergentbodies */ ,
                std::vector<NXOpen::Tooling::CostDataObject *> & costFeatures /** costfeatures */ 
            );
            /** Groups cost objects by selected convergent bodies @return  the grouped cost objects. 
             <br>  Created in NX2206.5000.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::CostDataObject * GroupMoldingFeaturesByConvergentBodies
            (
                NXOpen::Tooling::MoldFeatureRecognitionBuilder::CostFeatureType moldingFeatureType /** moldingfeaturetype */ ,
                const std::vector<NXOpen::Body *> & convergentBodies /** current selected convergent bodies. */
            );
            /** Deletes cost objects by selected convergent bodies
             <br>  Created in NX2206.5000.0.  <br>  
             <br> License requirements : None */
            public: void DeleteMoldingFeaturesByConvergentBodies
            (
                NXOpen::Tooling::MoldFeatureRecognitionBuilder::CostFeatureType moldingFeatureType /** moldingfeaturetype */ ,
                const std::vector<NXOpen::Body *> & convergentBodies /** current selected convergent bodies. */
            );
            /** Creat new molding features and copy data from these selected features
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void DuplicateMoldingFeatureData
            (
                const std::vector<NXOpen::Tooling::CostDataObject *> & moldingFeatureList /** moldingfeaturelist */ ,
                std::vector<NXOpen::Tooling::CostDataObject *> & newMoldingFeatureList /** newmoldingfeaturelist */ 
            );
            /** Populates analysis data from body cost object to builder
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void PopulateDataFromBodyCostObject
            (
            );
            /** Populates analysis data from body UDO to builder
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void PopulateDataFromProductBodyUdo
            (
                NXOpen::Body * selectedBody /** the current selected product body. */
            );
            /** Saves analysis data from builder to cost related object
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SaveDataToBodyCostObject
            (
            );
            /** Clears the analysis data of last selected body in builder after selected product body is changed
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void ClearAnalysisDataOnBodyChange
            (
            );
            /** Edits cost feature data based on the specified convergent body of the feature
             <br>  Created in NX2212.5000.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void EditCostFeatureDataWithConvergentBody
            (
                NXOpen::Tooling::MoldFeatureRecognitionBuilder::CostFeatureType moldingFeatureType /** moldingfeaturetype */ ,
                const std::vector<NXOpen::Body *> & convergentBodyList /** convergent body tag list for those cost features to be edit , 
                                                                                                                one convergent body maps one cost feauture or one cost feature group*/,
                int featureParameterNumber /** number of cost feature paramerters,now it is same as the number in UI */,
                std::vector<NXString> & allStringValueLists /** total parameter string values list for for the input cost features */,
                bool isUpdateGroupData /** whether edit feature group data, false -- not edit group data,
                                                     true-- edit group data only, that means the input string data is the data of the cost feature group */
            );
            /** Ungroups those specified grouped features based on the convergent bodies of the features
             <br>  Created in NX2212.5000.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void UngroupCostFeatureWithConvergentBody
            (
                NXOpen::Tooling::MoldFeatureRecognitionBuilder::CostFeatureType moldingFeatureType /** moldingfeaturetype */ ,
                const std::vector<NXOpen::Body *> & convergentBodyList /** convergent body tag list for those cost features to be ungroup */
            );
            /** Repositions the Mold Coordinate System to the saved mold direction of the analysis
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void RepositionMoldCsys
            (
            );
            /** Asks the mold direction of the existing analysis, and also asks the Mold Coordinate System if it exists
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void AskMoldDirectionFromAnalysisResult
            (
                NXOpen::Matrix3x3* workMatrix /** workmatrix */ ,
                NXOpen::Matrix3x3* moldCsysMatrix /** moldcsysmatrix */ ,
                NXOpen::Point3d* centerPoint /** centerpoint */ ,
                NXOpen::Features::Feature ** moldCsysFeatureTag /** moldcsysfeaturetag */ 
            );
            /**Returns  the existing Mold Coordinate System 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::Feature * MoldCsysFeature
            (
            );
            /**Sets  the existing Mold Coordinate System 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetMoldCsysFeature
            (
                NXOpen::Features::Feature * moldCsysFeatureTag /** moldcsysfeaturetag */ 
            );
            /**Returns  the value indicates whether to create one coordinate system for each undercut costing feature. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool UndercutCsysCreation
            (
            );
            /**Sets  the value indicates whether to create one coordinate system for each undercut costing feature. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetUndercutCsysCreation
            (
                bool bCreate /** bcreate */ 
            );
            /** Frees the cached analysis data. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void FreeCachedAnalysisData
            (
            );
            /** Checks whether current selected cost feature can be edited by selecting/deselecting face/facet
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: bool CanEditBySelectingFaceOrFacet
            (
                NXOpen::Tooling::CostDataObject * costFeature /** the costing feature to be edited*/
            );
        };
    }
}
