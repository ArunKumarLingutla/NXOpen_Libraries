    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  PlcSimAdvClientBuilder : public NXOpen::Builder
        {
            ...
            /**  @brief  Gets instance update extra options.  

              
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void GetInstanceUpdateExtraOptions
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                bool* bIsDataBlockFilterToggledON /** Whether the data block filter is allowed or not */,
                bool* bIshwCNExportFileToggledON /** Whether the HWCNExport-File input is allowed or not */,
                NXString* hwCNExportFile /** HWCNExport-File full path */
            );
            /**  @brief  Gets instance update extra options.  
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            void GetInstanceUpdateExtraOptions
            (
                const char * instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                bool* bIsDataBlockFilterToggledON /** Whether the data block filter is allowed or not */,
            ...
            /**  @brief  Sets instance update options.  
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetInstanceUpdateExtraOptions
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                bool bIsDataBlockFilterToggledON /** Whether the data block filter is allowed or not */,
                bool bIshwCNExportFileToggledON /** Whether the HWCNExport-File input is allowed or not */,
                const NXString & hwCNExportFile /** HWCNExport-File full path */
            );
            /**  @brief  Sets instance update options.  
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            void SetInstanceUpdateExtraOptions
            (
                const char * instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                bool bIsDataBlockFilterToggledON /** Whether the data block filter is allowed or not */,
                bool bIshwCNExportFileToggledON /** Whether the HWCNExport-File input is allowed or not */,
                const char * hwCNExportFile /** HWCNExport-File full path */
            );
            ...
            /**  @brief  Gets PLCSIMAdv instance flag of 'Reset PLC memory when MCD simulation starts'  

              
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: bool GetInstanceFlagOfResetPLCMemory
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ 
            );
            /**  @brief  Gets PLCSIMAdv instance flag of 'Reset PLC memory when MCD simulation starts'  
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            bool GetInstanceFlagOfResetPLCMemory
            (
                const char * instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ 
            );
            /**  @brief  Sets PLCSIMAdv instance flag of 'Reset PLC memory when MCD simulation starts'  

              
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetInstanceFlagOfResetPLCMemory
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                bool bResetPLC /** bresetplc */ 
            );
            /**  @brief  Sets PLCSIMAdv instance flag of 'Reset PLC memory when MCD simulation starts'  
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            void SetInstanceFlagOfResetPLCMemory
            (
                const char * instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                bool bResetPLC /** bresetplc */ 
            );
            /**  @brief  Gets tag address  
            ...
            /**  @brief  Sets tag comment  

              
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetTagAddress
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                const NXString & tagName /** tagname */ ,
            ...
            /**  @brief  Gets tag comment  

              
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: NXString GetTagComment
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                const NXString & tagName /** tagname */ 
