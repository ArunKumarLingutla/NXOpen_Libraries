...
namespace NXOpen
{
    ...
    namespace AME
    {
        ...
        AllAspects </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        AspectOperator </term> <description> 
         
        Under </description> </item> 

        <item><term> 
         
        ClassificationOperator </term> <description> 
         
        As </description> </item> 

        <item><term> 
         
        ClauseOperatorType </term> <description> 
         
        And </description> </item> 

        <item><term> 
         
        ReuseLibraryOperator </term> <description> 
         
        OfType </description> </item> 
        ...
        */
        class AMEOPENCPPEXPORT  EditClauseBuilder : public NXOpen::AME::MultipleObjectsBuilder
        {
            ...
            public: enum Types
            {
                ...
                TypesCableAssignment/** cable assignment */ 
            };
            ...
            /** the cable assignment operator applied to*/
            public: enum CableAssigmentOperator
            {
                CableAssigmentOperatorEqual/** equal */ 
            };

            /** the cable assignment value applied to*/
            public: enum CableAssigmentValue
            {
                CableAssigmentValueTrue/** true */ ,
                CableAssigmentValueFalse/** false */ 
            };
            ...
            /**Sets  the query value number of connected ports 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Set the classification property id 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetClassificationPropertyId
            (
                int classificationPropertyID /** classificationpropertyid */ 
            );
            /** Set the classification property id 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetClassificationPropertyIdAt
            (
                int index /** index */ ,
                int classificationPropertyID /** classificationpropertyid */ 
            );
            ...
            /**Returns  the query operator for cable assignment object 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::EditClauseBuilder::CableAssigmentOperator CableAssignmentOperator
            (
            );
            /**Sets  the query operator for cable assignment object 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetCableAssignmentOperator
            (
                NXOpen::AME::EditClauseBuilder::CableAssigmentOperator cableAssignmentOperator /** cableassignmentoperator */ 
            );
            /**Returns  the query value for cable assignment object 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::EditClauseBuilder::CableAssigmentValue CableAssignmentValue
            (
            );
            /**Sets  the query value for cable assignment object 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetCableAssignmentValue
            (
                NXOpen::AME::EditClauseBuilder::CableAssigmentValue cableAssignmentValue /** cableassignmentvalue */ 
            );
        };
    }
}
