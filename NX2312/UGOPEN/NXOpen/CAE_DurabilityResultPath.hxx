...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link NXOpen::CAE::DurabilityResultPath NXOpen::CAE::DurabilityResultPath@endlink . 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  DurabilityResultPath : public NXOpen::CAE::DurabilityExcitation
        {
