...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            BumperPlaneWidth.Value </term> <description> 
            ...
            CreateBonnetFrontOffset </term> <description> 
            ...
            CreateHeadImpactors </term> <description> 
            ...
            CreateLegImpactors </term> <description> 
            ...
            LegImpactorClearance.Value </term> <description> 
             
            75 (millimeters part), 3 (inches part) </description> </item> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PedestrianProtectionBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                public: enum InternalBumperType
                {
                    ...
                    InternalBumperTypeBumperTopPlaneWidth/** bumper top plane - width input method */,
                    InternalBumperTypeBumperTopPlane/** bumper top plane - trim to corner method */
                };
                ...
                /** Settings for the lower legform impactor type */
                public: enum LowerLegImpactorTypeEnum
                {
                    LowerLegImpactorTypeEnumFlexPLI/** Flex-PLI Legform Impactor */,
                    LowerLegImpactorTypeEnumApli/** aPLI Legform Impactor */,
                    LowerLegImpactorTypeEnumTrl/** TRL Legform Impactor */
                };
                ...
                /**Returns  the analysis type of impact study to perform 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::VehicleDesign::PedestrianProtectionBuilder::Types AnalysisType
                (
                );
                /**Sets  the analysis type of impact study to perform 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetAnalysisType
                (
                    NXOpen::Features::VehicleDesign::PedestrianProtectionBuilder::Types analysisType /** analysistype */ 
                );
                ...
                /**Returns  the collector containing the edge of the windshield
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::SelectDisplayableObjectList * WindshieldEdge
                (
                );
                ...
                /**Returns  the setting to indicate if the wrap around distance lines around A-Pillar should be optimized, 
                                true they will be optimized, false they will not be optimized.  
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: bool OptimizeWadLines
                (
                );
                /**Sets  the setting to indicate if the wrap around distance lines around A-Pillar should be optimized, 
                                true they will be optimized, false they will not be optimized.  
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetOptimizeWadLines
                (
                    bool optimizeWad /** optimizewad */ 
                );
                ...
                /**Returns  the type of impact study to perform 
                 <br>  @deprecated Deprecated in NX2306.0.0.  Use @link JA_PEDESTRIAN_PROTECTION_BUILDER_get_analysis_type JA_PEDESTRIAN_PROTECTION_BUILDER_get_analysis_type@endlink  instead. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use JA_PEDESTRIAN_PROTECTION_BUILDER_get_analysis_type instead.") NXOpen::Features::VehicleDesign::PedestrianProtectionBuilder::Types Type
                (
                );
                /**Sets  the type of impact study to perform 
                 <br>  @deprecated Deprecated in NX2306.0.0.  Use @link JA_PEDESTRIAN_PROTECTION_BUILDER_set_analysis_type JA_PEDESTRIAN_PROTECTION_BUILDER_set_analysis_type@endlink  instead. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use JA_PEDESTRIAN_PROTECTION_BUILDER_set_analysis_type instead.") void SetType
                (
                ...
                /**Returns  the clearance value of the legform impactor above the ground reference plane
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * LegImpactorClearance
                (
                );
                /**Returns  the lower legform impactor that should be used in leg impact analysis 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::VehicleDesign::PedestrianProtectionBuilder::LowerLegImpactorTypeEnum LowerLegImpactorType
                (
                );
                /**Sets  the lower legform impactor that should be used in leg impact analysis 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetLowerLegImpactorType
                (
                    NXOpen::Features::VehicleDesign::PedestrianProtectionBuilder::LowerLegImpactorTypeEnum lowerLegImpactorType /** lowerlegimpactortype */ 
                );
                ...
                /**Returns  the color that will be used for the lower leg impact zone
                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::NXColor * LegZonesOutputColor
                (
                );
                /**Sets  the color that will be used for the lower leg impact zone
                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                ...
                /**Returns  the color that will be used for the upper leg impact zone
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::NXColor * UpperLegZonesOutputColor
                (
                );
                /**Sets  the color that will be used for the upper leg impact zone
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetUpperLegZonesOutputColor
                (
                    NXOpen::NXColor * color /** color */ 
                );
                ...
                /**Returns  the setting to indicate if the head impactors should be created 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CreateHeadImpactors
                (
                );
                /**Sets  the setting to indicate if the head impactors should be created 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetCreateHeadImpactors
                (
                    bool createHeadImpactors /** createheadimpactors */ 
                );
                /**Returns  the setting to indicate if the leg impactors should be created 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CreateLegImpactors
                (
                );
                /**Sets  the setting to indicate if the leg impactors should be created 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetCreateLegImpactors
                (
                    bool createLegImpactors /** createlegimpactors */ 
                );
                /**Returns  the setting to indicate if the bonnet front offset should be created 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CreateBonnetFrontOffset
                (
                );
                /**Sets  the setting to indicate if the bonnet front offset should be created 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetCreateBonnetFrontOffset
                (
                    bool createBonnetFrontOffset /** createbonnetfrontoffset */ 
                );
                ...
                /**Returns  the width of internal bumper reference line
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * BumperPlaneWidth
                (
                );
            };
        }
