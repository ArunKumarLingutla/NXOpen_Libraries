...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** 
              ...
              <br> To create a new instance of this class, use @link NXOpen::Routing::BendCornerCollection::CreateCornerFromAttribute  NXOpen::Routing::BendCornerCollection::CreateCornerFromAttribute @endlink  <br> 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  BendCorner : public NXOpen::Routing::Corner
        {
            ...
            /**Returns  the bend ratio to apply when computing the bend radius 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: double BendRatioToAttribute
            (
            );
            /**Sets  the bend ratio to apply when computing the bend radius 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetBendRatioToAttribute
            (
                double bendRatioToAttribute /** the bend ratio. */
            );
            /**Returns  the bend ratio to apply when computing the bend radius 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXString BendAttributeName
            (
            );
            /**Sets  the bend ratio to apply when computing the bend radius 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetBendAttributeName
            (
                const NXString & bendAttributeName /** the bend ratio. */
            );
            /**Sets  the bend ratio to apply when computing the bend radius 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            void SetBendAttributeName
            (
                const char * bendAttributeName /** the bend ratio. */
            );
