                ...
                */
                class NXOPENCPP_FEATURESEXPORT  EvacuationPlanBuilder : public NXOpen::Builder
                {
                    ...
                    /** Clears the expressions data
                     ...
                     <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") */
                    public: void ClearExpressionsData
                    (
                    );
                    /** Adds expression data
                     <br>  Created in NX1847.0.0.  <br>  
                     <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") */
                    public: void AddExpressionData
                    (
                        const NXString & strTitle /** strtitle */ ,
                        const NXString & strFormular /** strformular */ 
                    );
                    /** Adds expression data
                     <br>  Created in NX1847.0.0.  <br>  
                     <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") */
                    void AddExpressionData
                    (
                        const char * strTitle /** strtitle */ ,
                        const char * strFormular /** strformular */ 
                    );
                };
            }
        }
