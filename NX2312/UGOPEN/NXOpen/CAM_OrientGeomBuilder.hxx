        ...
        class NXOPENCPP_CAMEXPORT  OrientGeomBuilder : public NXOpen::CAM::NCGroupBuilder
        {
            ...
            */
            public: enum SpecialOutputModes
            {
                ...
                SpecialOutputModesUseInheritedMcs/** Special output mode: Use Inherited MCS */
            };
            ...
            /** The mcs location mode options 
             <br>  Created in NX1926.0.0.  <br>  
            */
            public: enum McsLocationModes
            {
                McsLocationModesSpecify/** origin location: specify */,
                McsLocationModesOnBlank/** origin location: on blank */,
                McsLocationModesOnPartBox/** origin location: on part box */
            };

            /** the mcs zero face options */
            public: enum McsZeroFace
            {
                McsZeroFaceBottom/** MCS zero face: bottom */,
                McsZeroFaceMiddle/** MCS zero face: middle */,
                McsZeroFaceTop/** MCS zero face: top */
            };

            /** the mcs zero position options */
            public: enum McsZeroPosition
            {
                McsZeroPositionCenter/** MCS zero position: center */,
                McsZeroPositionNorth/** MCS zero position: north */,
                McsZeroPositionNorthEast/** MCS zero position: northeast */,
                McsZeroPositionEast/** MCS zero position: east */,
                McsZeroPositionSouthEast/** MCS zero position: southeast */,
                McsZeroPositionSouth/** MCS zero position: south */,
                McsZeroPositionSouthWest/** MCS zero position: southwest */,
                McsZeroPositionWest/** MCS zero position: west */,
                McsZeroPositionNorthWest/** MCS zero position: northwest */
            };
            ...
            /**Returns  the tool axis filter builder
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::ToolAxisFilterBuilder * ToolAxisFilterBuilder
            (
            );
            ...
            /**Returns  the mcs location 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::OrientGeomBuilder::McsLocationModes McsLocationMode
            (
            );
            /**Sets  the mcs location 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMcsLocationMode
            (
                NXOpen::CAM::OrientGeomBuilder::McsLocationModes mcsLocationMode /** the mcs location mode */
            );
            /**Returns  the mcs workpiece 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * McsWorkpiece
            (
            );
            /**Sets  the mcs workpiece 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMcsWorkpiece
            (
                NXOpen::NXObject * mcsWorkpiece /** the mcs workpiece */
            );
            /** Sets block mcs origin 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetBlockMcsOrigin
            (
                NXOpen::CAM::OrientGeomBuilder::McsZeroFace zeroFace /** zeroface */ ,
                NXOpen::CAM::OrientGeomBuilder::McsZeroPosition zeroPosition /** zeroposition */ 
            );
            /** Sets cylinder mcs origin 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCylinderMcsOrigin
            (
                NXOpen::CAM::OrientGeomBuilder::McsZeroFace zeroFace /** zeroface */ 
            );
        };
