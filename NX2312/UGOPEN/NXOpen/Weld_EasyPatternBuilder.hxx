...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        BackEdgeOffset </term> <description> 
         
        2 (millimeters part), 0.08 (inches part) </description> </item> 

        <item><term> 
         
        GridAngleTolerance </term> <description> 
         
        15 </description> </item> 

        <item><term> 
         
        GridIncrement </term> <description> 
        ...
        HemMethod </term> <description> 
         
        MidPoint </description> </item> 

        <item><term> 
         
        LengthAndWidth </term> <description> 
         
        5 (millimeters part), 0.02 (inches part) </description> </item> 

        <item><term> 
         
        MaximumSpacing </term> <description> 
        ...
        NumberSurfaceVectors </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PlaneLocation </term> <description> 
        ...
        TrimEdgeOffset </term> <description> 
        ...
        */
        class NXOPENCPP_WELDEXPORT  EasyPatternBuilder : public NXOpen::Builder
        {
            ...
            public: enum Types
            {
                ...
                TypesSurface/** Surface vector. */,
                TypesTrim/** Trim vector. */,
                TypesHem/** Hem vector.  */,
                TypesSurfacePoints/** Surface vectors from existing points */
            };
            ...
            public: enum PlaneMethodTypes
            {
                ...
                PlaneMethodTypesSelectPlanes/** Patterns are on user selected planes. */
            };
            ...
            /** Indicates the number of surface vectors to create. */
            public: enum SurfaceVectorCount
            {
                SurfaceVectorCountOne/** Create one surface vector. */,
                SurfaceVectorCountTwo/** Creates two surface vectors. */
            };
            ...
            /**Returns  the selected planes for the pattern 
             ...
             <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * UserPlanes
            (
            );
            /**Returns  the surface characteristics. Used to specify additional attributes. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Weld::CharacteristicsBuilder * PrimaryCharacteristics
            (
            );
            /**Returns  the trim or hem characteristics. Used to specify additional attributes. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Weld::CharacteristicsBuilder * OtherCharacteristics
            (
            );
            /**Returns  the project along direction flag. This will project any off-surface points to the surface based on the direction toggle. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool ProjectAlongDirection
            (
            );
            /**Sets  the project along direction flag. This will project any off-surface points to the surface based on the direction toggle. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: void SetProjectAlongDirection
            (
                bool projectToSurface /** projecttosurface */ 
            );
            /**Returns  the selected points for the pattern 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * PatternSelPoints
            (
            );
        };
    }
