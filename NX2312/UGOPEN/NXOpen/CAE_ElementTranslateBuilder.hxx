    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link NXOpen::CAE::ElementTranslateBuilder NXOpen::CAE::ElementTranslateBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::CAE::NodeElementManager::CreateElementTranslateInEditModeBuilder  NXOpen::CAE::NodeElementManager::CreateElementTranslateInEditModeBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  ElementTranslateBuilder : public NXOpen::Builder
        {
            /** Type of element translate*/
            public: enum Type
            {
                TypeAssociative/** Associative Translate */,
                TypeNonAssociative/** Non-associative Translate*/
            };
            ...
            /**Returns  the option to specify the start node label and increment for the new nodes OR 
                        specify an offset from the existing node labels 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ElementTranslateBuilder::LabelType NodeLabelOption
            (
            );
            /**Sets  the option to specify the start node label and increment for the new nodes OR 
                        specify an offset from the existing node labels 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetNodeLabelOption
            (
                NXOpen::CAE::ElementTranslateBuilder::LabelType option /** _option */ 
            );
            /**Returns  the start label for the new nodes 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: int NodeLabel
            (
            );
            /**Sets  the start label for the new nodes 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            ...
            /**Returns  the increment in label for each new element 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: int NodeIncrement
            (
            );
            /**Sets  the increment in label for each new element 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetNodeIncrement
            (
                int increment /** increment */ 
            );
            /**Returns  the offset to be used to generate new element labels 
            ...
            /**Returns  the translate type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ElementTranslateBuilder::Type TranslateType
            (
            );
            /**Sets  the translate type 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetTranslateType
            (
                NXOpen::CAE::ElementTranslateBuilder::Type translateType /** translatetype */ 
            );
            /**Returns  the selected geometry 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
