            ...
            */
            class NXOPENCPP_FEATURESEXPORT  HeadImpactFrontHeaderWizardBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                ...
                /**Returns  the windshield upper edge geometry. 
                 <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Features::VehicleDesign::HeadImpactFrontHeaderWizardBuilder::InteriorTrim NXOpen::Features::VehicleDesign::HeadImpactFrontHeaderWizardBuilder::InteriorTrim@endlink  instead. <br>  

                 <br>  Created in NX9.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Features::VehicleDesign::HeadImpactFrontHeaderWizardBuilder::InteriorTrim instead.") NXOpen::ScCollector * WindshieldEdge
                (
                );
