    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MWDesignPartingSurfaceBuilder : public NXOpen::Builder
        {
            ...
            /** Method to assign the Design Guide Lines Builder. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void AssignDesignGuideLinesBuilder
            (
                NXOpen::TaggedObject * designGuideLinesBuilderTag /** Design Guide Lines builder */
            );
            /** Method to switch which face of a shared edge is referenced to extend 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SwitchExtensionSide
            (
            );
            /** Method to calculate the extension direction for extend sheet surface type
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Vector3d> CalculateExtensionDirection
            (
                NXOpen::TaggedObject * partingSegUDO /** the parting segment UDO */
            );
            /**Returns  the option to get reverse extension side value, true - is reversed, false - not be reversed
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool ReverseExtensionSide
            (
            );
            /**Sets  the option to get reverse extension side value, true - is reversed, false - not be reversed
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetReverseExtensionSide
            (
