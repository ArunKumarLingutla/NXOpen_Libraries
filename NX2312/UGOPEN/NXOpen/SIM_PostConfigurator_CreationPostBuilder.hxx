        ...
        namespace PostConfigurator
        {
            ...
            */
            class NXOPENCPP_SIMEXPORT  CreationPostBuilder : public NXOpen::Builder
            {
                ...
                /** Returns the layer value. @return  The layer value 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString GetLayerNameValue
                (
                    const NXString & layerName /** The layer name */
                );
                /** Returns the layer value. @return  The layer value 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                NXString GetLayerNameValue
                (
                    const char * layerName /** The layer name */
                );
                /** Sets the layer value.
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") OR nx_post_config_adv ("NX Post Configurator") */
                public: void SetLayerNameValue
                (
                    const NXString & layerName /** The layer name */,
                    const NXString & value /** The layer value */
                );
                /** Sets the layer value.
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") OR nx_post_config_adv ("NX Post Configurator") */
                void SetLayerNameValue
                (
                    const char * layerName /** The layer name */,
                    const char * value /** The layer value */
                );
                /** Returns the list of layer value in the postprocessor. @return  the list of available layer value 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /** Returns the list of layer value in the postprocessor. @return  the list of available layer value 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                std::vector<NXString> GetLayerNames
                (
                    const char * layerName /** The layer name */
                );
                ...
                /** This is an internal API and can be changed at any time 
                 ...
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") OR nx_post_config_adv ("NX Post Configurator") */
                public: void ToggleNcOptimizer
                (
                    bool toggle /** the NC optimizer toggle */
                );
