...
namespace NXOpen
{
    ...
    class ALPUITemplateTestManagerImpl;
    ...
    */
    class NXOPENDEBUGUICPPEXPORT  ALPUITemplateTestManager
    {
        private: ALPUITemplateTestManagerImpl * m_alpuitemplatetestmanager_impl;
        private: NXOpen::UITemplateTestManager* m_owner;
        /// \cond NX_NO_DOC 
        public: explicit ALPUITemplateTestManager(NXOpen::UITemplateTestManager *owner);
        ...
        tag_t Tag() const; 
        public: ~ALPUITemplateTestManager();
