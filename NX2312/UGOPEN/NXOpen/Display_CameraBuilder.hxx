    ...
    namespace Display
    {
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  CameraBuilder : public NXOpen::Builder
        {
            ...
            /** Predefined aspect_ratio type: graphics window, image-based background, 
                    1:1, 3:2, 4:3, 16:9, user defined*/
            public: enum AspectRatio
            {
                AspectRatioGraphicsWindow/** Aspect ratio of graphics window */,
                AspectRatioImageBasedBackground/** Aspect ratio of image-based background in studio view*/,
                AspectRatioSquareFormat/** Aspect ratio 1:1, square format*/,
                AspectRatioStandardPhotoPrintFormat/** Aspect ratio 3:2, 6x4 standard photo print format*/,
                AspectRatioStandardVideoFormat/** Aspect ratio 4:3, standard video format*/,
                AspectRatioHdtvFormat/** Aspect ratio 16:9, HDTV format*/,
                AspectRatioUserDefined/** Custom aspect ratio by specifying the width and height*/
            };
            ...
            /**Returns  the perspective distance.  Note that the perspective distance should not
            ...
            /**Sets  the perspective distance.  Note that the perspective distance should not
                    set inside of the front clipping plane.  So please check the front clipping
                    distance before set the perspective distance. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the field of view angle.  Note that this property only make sense
            ...
            /**Sets  the field of view angle.  Note that this property only make sense
                    when camera type is JA_DISPLAY_CAMERA_BUILDER_types_perspective.
                    Set field of view angle only works when the lens angle type
                    is JA_DISPLAY_CAMERA_BUILDER_lens_angle_fov. 
             <br>  Created in NX5.0.0.  <br>  
            ...
            /**Returns  the magnification.  Note that set magnification only works when the lens angle type
            ...
            /**Sets  the magnification.  Note that set magnification only works when the lens angle type
                    is JA_DISPLAY_CAMERA_BUILDER_lens_angle_magnification. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the aspect ratio type from camera 
             ...
             <br> License requirements : None */
            public: NXOpen::Display::CameraBuilder::AspectRatio AspectRatioType
            (
            );
            /**Sets  the aspect ratio type from camera 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAspectRatioType
            (
                NXOpen::Display::CameraBuilder::AspectRatio aspectRatioType /** aspectratiotype */ 
            );
            /**Returns  the aspect ratio width from camera. The aspect ratio width range is 0.01 to 100. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: double AspectRatioWidth
            (
            );
            /**Sets  the aspect ratio width from camera. The aspect ratio width range is 0.01 to 100. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAspectRatioWidth
            (
                double aspectRatioWidth /** aspectratiowidth */ 
            );
            /**Returns  the aspect ratio height from camera. The aspect ratio height range is 0.01 to 100. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: double AspectRatioHeight
            (
            );
            /**Sets  the aspect ratio height from camera. The aspect ratio height range is 0.01 to 100. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAspectRatioHeight
            (
                double aspectRatioHeight /** aspectratioheight */ 
            );
        };
    }
}
