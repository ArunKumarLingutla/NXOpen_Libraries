    ...
    namespace Positioning
    {
        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  ConstraintReference : public NXOpen::NXObject
        {
            ...
            {
                GeometryTypeUnknown/** No geometry suitable for solving */ = -1,
                ...
                GeometryTypeCoordinateSystem/** Coordinate system */ = 1001
            };
            ...
            /**Sets 
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetGeometryDirectionReversed
            (
                bool geometryDirectionReversed /** Whether the direction is reversed with respect to the geometry */
            );
            /**Returns 
                    whether the direction is reversed with respect to the direction of the geometry.
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: bool GeometryDirectionReversed
            (
            );
        };
    }
