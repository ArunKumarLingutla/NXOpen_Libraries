            ...
            */
            class NXOPENCPP_CAEEXPORT  RSEventParameters : public NXOpen::TaggedObject
            {
                ...
                /**Returns  the Frequency interpolation method 
                 ...
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXOpen::CAE::ResponseSimulation::RSEvent::InterpolationMethod FrequencyInterpMethod
                (
                );
                /**Sets  the Frequency interpolation method 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void SetFrequencyInterpMethod
                (
                    NXOpen::CAE::ResponseSimulation::RSEvent::InterpolationMethod frequencyInterpolationMethod /** frequency interpolation method */ 
                );
                /**Returns  the Amplitude interpolation method 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXOpen::CAE::ResponseSimulation::RSEvent::InterpolationMethod AmplitudeInterpMethod
                (
                );
                /**Sets  the Amplitude interpolation method 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void SetAmplitudeInterpMethod
                (
                    NXOpen::CAE::ResponseSimulation::RSEvent::InterpolationMethod amplitudeInterpolationMethod /** amplitude interpolation method */ 
                );
            };
        }
    }
