...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX4.0.0.  Use Features::BooleanFeature instead.") NXOPENCPP_FEATURESEXPORT  Intersect : public virtual NXOpen::Features::IBoolean
        {
