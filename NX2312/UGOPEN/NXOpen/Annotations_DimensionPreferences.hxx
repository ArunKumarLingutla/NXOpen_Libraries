...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionPreferences : public NXOpen::TransientObject
        {
            ...
            (
                NXOpen::Annotations::TextPosition textPosition /** New dimension text position */
            );
            /**Returns  the angle if text orientation is 
                        @link NXOpen::Annotations::TextOrientationByAngle NXOpen::Annotations::TextOrientationByAngle@endlink  
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the zero tolerance display style 
             <br>  @deprecated Deprecated in NX7.5.0.  Use @link NXOpen::Annotations::LinearTolerance::ZeroToleranceDisplayStyle NXOpen::Annotations::LinearTolerance::ZeroToleranceDisplayStyle@endlink  for linear dimensions and @link NXOpen::Annotations::AngularTolerance::ZeroToleranceDisplayStyle NXOpen::Annotations::AngularTolerance::ZeroToleranceDisplayStyle@endlink  for angular dimensions instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX7.5.0.  Use NXOpen::Annotations::LinearTolerance::ZeroToleranceDisplayStyle for linear dimensions and NXOpen::Annotations::AngularTolerance::ZeroToleranceDisplayStyle for angular dimensions instead.") NXOpen::Annotations::ZeroToleranceDisplayStyle ZeroToleranceDisplayStyle
            (
            );
            /**Sets  the zero tolerance display style 
             <br>  @deprecated Deprecated in NX7.5.0.  Use @link NXOpen::Annotations::LinearTolerance::SetZeroToleranceDisplayStyle NXOpen::Annotations::LinearTolerance::SetZeroToleranceDisplayStyle@endlink  for linear dimensions and @link NXOpen::Annotations::AngularTolerance::SetZeroToleranceDisplayStyle NXOpen::Annotations::AngularTolerance::SetZeroToleranceDisplayStyle@endlink  for angular dimensions instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX7.5.0.  Use NXOpen::Annotations::LinearTolerance::SetZeroToleranceDisplayStyle for linear dimensions and NXOpen::Annotations::AngularTolerance::SetZeroToleranceDisplayStyle for angular dimensions instead.") void SetZeroToleranceDisplayStyle
            (
            ...
            (
                const NXString & fitShaftDeviation /** New shaft deviation for fit tolerance*/
            );
            /**Sets  the shaft deviation for fit tolerance 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            (
                const char * fitShaftDeviation /** New shaft deviation for fit tolerance*/
            );
            ...
            (
                int fitShaftGrade /** New shaft grade for fit tolerance */
            );
            ...
            /**Returns  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
             ...
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Annotations::DimensionPreferences::LimitFitAssemblyNewDisplayStyle NXOpen::Annotations::DimensionPreferences::LimitFitAssemblyNewDisplayStyle@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Annotations::DimensionPreferences::LimitFitAssemblyNewDisplayStyle instead.") NXOpen::Annotations::FitAssemblyDisplayStyle LimitFitAssemblyDisplayStyle
            (
            );
            /**Sets  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
             ...
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Annotations::DimensionPreferences::SetLimitFitAssemblyNewDisplayStyle NXOpen::Annotations::DimensionPreferences::SetLimitFitAssemblyNewDisplayStyle@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Annotations::DimensionPreferences::SetLimitFitAssemblyNewDisplayStyle instead.") void SetLimitFitAssemblyDisplayStyle
            (
                NXOpen::Annotations::FitAssemblyDisplayStyle fitAssemblyDisplayStyle /** New limit assembly display style */
            );
            ...
            (
                NXOpen::Annotations::FitAssemblyNewDisplayStyle fitAssemblyDisplayStyle /** New limit assembly display style */
            );
            ...
            (
                NXOpen::Annotations::FitDisplaySplitByDimline fitDisplaySplitByDimline /** New limit fit display when split by dimension line */
            );
            ...
            (
                NXOpen::Annotations::FitDisplayAlignment fitDisplayAlignment /** New limit fit display alignment */
            );
            /**Returns  the flag indicating whether to display separator for fit tolerance of assembly dimensions.  When the
                        limit fit type is FIT and the value is true, a line will be drawn to separate the hole and shaft tolerance texts. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayFitSeparator
            (
            );
            /**Sets  the flag indicating whether to display separator for fit tolerance of assembly dimensions.  When the
                        limit fit type is FIT and the value is true, a line will be drawn to separate the hole and shaft tolerance texts. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDisplayFitSeparator
            (
                bool displayFitSeparator /** Flag indicating whether to display assembly tolerance separator */
            );
            /**Returns  the flag indicating whether to display parentheses for fit tolerance.  If the value is true, the tolerance
                        text will have parentheses shown on text render.  Otherwise, a blank space will be used.  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayFitParentheses
            (
            );
            /**Sets  the flag indicating whether to display parentheses for fit tolerance.  If the value is true, the tolerance
                        text will have parentheses shown on text render.  Otherwise, a blank space will be used.  
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDisplayFitParentheses
            (
                bool displayFitParentheses /** Flag indicating whether to display assembly tolerance parentheses */
            );
