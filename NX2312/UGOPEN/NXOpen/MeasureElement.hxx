    ...
    */
    class NXOPENCPPEXPORT  MeasureElement : public NXOpen::TransientObject
    {
        ...
        public: enum Type
        {
            ...
            TypeFace/** face */ ,
            TypeAngle/** angle */ ,
            TypeThreePntAngle/** three pnt angle */ ,
            TypeBody/** body */ ,
            TypeThickness/** thickness */ ,
            TypePoint/** point */ ,
            TypeEulerAngle/** euler angle */ ,
            TypeExtremePoint/** extreme point */ ,
            TypePolarAngle/** polar angle */ ,
            TypePolarArea/** polar area */ ,
            TypePolarRadius/** polar radius */ ,
            TypeSurfaceCenterline/** surface centerline */ ,
            TypeBoundingBox/** bounding box */ ,
            TypeSectionInertia/** section inertia */ ,
            TypeCircleThreePnt/** circle three pnt */ ,
        ...
        /** Clear the cache data of given element. 
        ...
        /** 
            Check if we have a point, and asked for individual X,Y,Z point expressions to be created.This is only done as we create the single measure the first time.
            
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void CreateIndividualPointExpressions
        (
            int expIndex /** exp index */ 
        );
        /** 
         ...
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void CreateSpecialExpressions
        (
            NXOpen::NXObject * expTag1 /** First exp tag */,
            NXOpen::NXObject * expTag2 /** Second exp tag */,
            NXOpen::NXObject * unitTag /** unittag */ 
        );
        /** 
            Get measure type of given element.
            
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement::Type GetMeasureType
        (
        );
