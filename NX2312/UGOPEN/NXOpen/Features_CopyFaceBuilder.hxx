    ...
    namespace Features
    {
        ...
        /**
            Represents a builder for a copy face feature.
             <br> To create a new instance of this class, use @link NXOpen::Features::FeatureCollection::CreateCopyFaceBuilder  NXOpen::Features::FeatureCollection::CreateCopyFaceBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  CopyFaceBuilder : public NXOpen::Features::FeatureBuilder
        {
