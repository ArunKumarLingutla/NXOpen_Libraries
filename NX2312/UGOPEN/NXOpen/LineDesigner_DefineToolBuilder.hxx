        ...
        */
        class LINEDESIGNEROPENCPPEXPORT  DefineToolBuilder : public NXOpen::Builder
        {
            ...
            public: enum ToolType
            {
                ...
                ToolTypeAdhesiveGun/** adhesive gun */ ,
                ToolTypeClinchGun/** clinch gun */ ,
                ToolTypePaintGun/** paint gun */ ,
                ToolTypeRivetGun/** rivet gun */ ,
                ToolTypeSealerGun/** sealer gun */ ,
                ToolTypeWeldGun/** weld gun */ ,
                ToolTypeNutWelder/** nut welder */ ,
                ToolTypeStudWelder/** stud welder */ ,
                ToolTypeFlowDrillScrew/** flow drill screw */ ,
            ...
            public: NXOpen::SelectPart * SelectGunTips
            (
            );
            /** To remove objects
             <br>  Created in NX2312.0.0.  <br>  
            ...
            /**Returns  the define tool type toggle 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool DefineToolTypeToggle
            (
            );
            /**Sets  the define tool type toggle 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void SetDefineToolTypeToggle
            (
                bool defineToolTypeToggle /** definetooltypetoggle */ 
            );
        };
    }
}
