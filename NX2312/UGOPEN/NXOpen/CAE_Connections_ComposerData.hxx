            ...
            */
            class NXOPENCPP_CAEEXPORT  ComposerData : public NXOpen::TaggedObject
            {
                ...
                /**Returns  the component unit system  
                 ...
                 <br> License requirements : None */
                public: NXString ComponentUnitSystem
                (
                );
                /**Sets  the component unit system  
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : sc_nv_comp (" Simcenter NVH Composer") OR sc_gso_comp (" Simcenter NVH Composer") */
                public: void SetComponentUnitSystem
                (
                    const NXString & componentUnitSystem /** componentunitsystem */ 
                );
                /**Sets  the component unit system  
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : sc_nv_comp (" Simcenter NVH Composer") OR sc_gso_comp (" Simcenter NVH Composer") */
                void SetComponentUnitSystem
                (
                    const char * componentUnitSystem /** componentunitsystem */ 
                );
            };
        }
    }
