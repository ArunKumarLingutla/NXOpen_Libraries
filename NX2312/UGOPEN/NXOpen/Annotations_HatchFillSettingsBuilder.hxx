    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  HatchFillSettingsBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** Finds the crosshatch file from pattern. May be blank if not found 
            ...
            /**Returns  the state to set this crosshatch settings to all same component crosshatches.
             ...
             <br> License requirements : None */
            public: bool ApplyToAllFromSameComp
            (
            );
            /**Sets  the state to set this crosshatch settings to all same component crosshatches.
             ...
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetApplyToAllFromSameComp
            (
                bool applyOnAllView /** applyonallview */ 
            );
