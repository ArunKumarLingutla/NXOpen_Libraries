    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModelAndLoadPreProcessInverseFftBuilder : public NXOpen::CAE::ModelAndLoadPreProcessOperationBuilder
        {
            ...
            /**Returns  the option for enabling energy consistent output, which is recommended for IFFT transfer functions for auralization 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool EnergyConsistent
            (
            );
            /**Sets  the option for enabling energy consistent output, which is recommended for IFFT transfer functions for auralization 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetEnergyConsistent
            (
                bool energyConsistent /** energyconsistent */ 
            );
        };
    }
}
