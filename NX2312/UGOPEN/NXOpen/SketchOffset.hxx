...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchOffset : public NXOpen::SketchGeometricConstraint
    {
        ...
        /**Returns  the dimension associated with the offset constraint.  There may not be a dimension. 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Annotations::Dimension * AssociatedDimension
        (
        );
        /**Returns  the expression associated with the offset constraint.  There may not be an expression. 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
