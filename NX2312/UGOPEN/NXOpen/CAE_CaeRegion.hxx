...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeRegion : public NXOpen::CAE::NamedPropTableWithTargetSet, public virtual NXOpen::CAE::IExportableFEEntity
        {
            ...
            /** Prints information for a @link NXOpen::CAE::CaeRegion NXOpen::CAE::CaeRegion@endlink  
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
