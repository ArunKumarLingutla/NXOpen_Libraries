...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AddonOperation </term> <description> 
         
        Overlap </description> </item> 

        <item><term> 
         
        ApplyColor </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CopyDistance.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        CopyMethod </term> <description> 
         
        PointToPoint </description> </item> 

        <item><term> 
         
        DefStationNum </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        DoubleA </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DoubleAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DoubleB </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DoubleH </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DoubleR </term> <description> 
         
        0.2 </description> </item> 

        <item><term> 
         
        DoubleRf </term> <description> 
         
        0.4 </description> </item> 

        <item><term> 
         
        EditMethod </term> <description> 
         
        Split </description> </item> 

        <item><term> 
         
        EditStationNum </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        IncludeOverlapOvercut </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        MinRad </term> <description> 
        ...
        OvercutOperation </term> <description> 
         
        NormalType </description> </item> 

        <item><term> 
         
        OverlapWidth </term> <description> 
         
        0.1 </description> </item> 

        <item><term> 
         
        PierceType </term> <description> 
         
        Piercing </description> </item> 

        <item><term> 
         
        ProcessFive </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ProcessFour </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ProcessOne </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ProcessThree </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ProcessTwo </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        RemoveFilter </term> <description> 
         
        InferScrap </description> </item> 
        ...
        ScrapPosition </term> <description> 
         
        ProjectToStrip </description> </item> 

        <item><term> 
         
        ScrapTol </term> <description> 
         
        0.01 </description> </item> 

        <item><term> 
         
        ScrapTypeEnum </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ScrapDesignBuilder : public NXOpen::Builder
        {
            ...
            public: enum ScrapDefType
            {
                ...
                ScrapDefTypeCopy/** The scrap will be copied to the specified position */
            };

            /** Specifies the copy method options */
            public: enum CopyMethodOptions
            {
                CopyMethodOptionsPointToPoint/** point to point */ ,
                CopyMethodOptionsDistance/** distance */ 
            };
            ...
            public: enum OvercutType
            {
                ...
                OvercutTypeFilletType/** Creates fillet type of overcut */
            };
            ...
            /**Returns  the copy method 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::ScrapDesignBuilder::CopyMethodOptions CopyMethod
            (
            );
            /**Sets  the copy method 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCopyMethod
            (
                NXOpen::Tooling::ScrapDesignBuilder::CopyMethodOptions copyMethod /** copymethod */ 
            );
            /**Returns  the copy from point 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point * CopyFromPoint
            (
            );
            /**Sets  the copy from point 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCopyFromPoint
            (
                NXOpen::Point * copyFromPoint /** copyfrompoint */ 
            );
            /**Returns  the copy to point 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point * CopyToPoint
            (
            );
            /**Sets  the copy to point 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCopyToPoint
            (
                NXOpen::Point * copyToPoint /** copytopoint */ 
            );
            /**Returns  the copy vector 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * CopyVector
            (
            );
            /**Sets  the copy vector 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCopyVector
            (
                NXOpen::Direction * copyVector /** copyvector */ 
            );
            /**Returns  the copy distance 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * CopyDistance
            (
            );
            /**Returns  the rotate axis point 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point * RotateAxisPoint
            (
            );
            /**Sets  the rotate axis point 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetRotateAxisPoint
            (
                NXOpen::Point * rotateAxisPoint /** rotateaxispoint */ 
            );
            ...
            /**Returns  the include overlap overcut 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool IncludeOverlapOvercut
            (
            );
            /**Sets  the include overlap overcut 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetIncludeOverlapOvercut
            (
                bool includeOverlapOvercut /** includeoverlapovercut */ 
            );
            ...
            /**Returns  the double Rf served as the parameter of overcut 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: double DoubleRf
            (
            );
            /**Sets  the double Rf served as the parameter of overcut 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetDoubleRf
            (
                double doubleRf /** doublerf */ 
            );
            ...
            /**Returns  the minimum radius to blend sharp corners for trimming 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: double MinimumRadius
            (
            );
            /**Sets  the minimum radius to blend sharp corners for trimming 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the toggle to determine whether to update or not  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool Update
            (
            );
            /**Sets  the toggle to determine whether to update or not  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUpdate
            (
                bool needToUpdate /** needtoupdate */ 
            );
        };
    }
}
