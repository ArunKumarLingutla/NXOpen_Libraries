...
#include <NXOpen/CAE_LaminateImportedPlyBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represent the laminate global layup manager which manages all the global layups in the laminate ply-based modeling project  <br> To obtain an instance of this class, refer to @link NXOpen::CAE::BaseFEModel  NXOpen::CAE::BaseFEModel @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  LaminateGlobalLayupMgr
        {
            /** Used to specify the butt joint option */
            public: enum ButtjointOption
            {
                ButtjointOptionNone/** None */,
                ButtjointOptionInt/** Compare using the int */,
                ButtjointOptionString/** Compare whole string */
            };

            private: LaminateGlobalLayupMgrImpl * m_laminategloballayupmgr_impl;
            private: NXOpen::CAE::BaseFEModel* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit LaminateGlobalLayupMgr(NXOpen::CAE::BaseFEModel *owner);
            ...
            /** Creates a @link NXOpen::CAE::GlobalLayupImportFromPptBuilder NXOpen::CAE::GlobalLayupImportFromPptBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Creates a @link NXOpen::CAE::LaminateLayupOffsetBuilder NXOpen::CAE::LaminateLayupOffsetBuilder@endlink  
            ...
            /** Creates a @link NXOpen::CAE::LaminateMatOrientationBuilder NXOpen::CAE::LaminateMatOrientationBuilder@endlink  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link NXOpen::CAE::ViewLaminateBuilder NXOpen::CAE::ViewLaminateBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link NXOpen::CAE::FlatPatternsBuilder NXOpen::CAE::FlatPatternsBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates @link NXOpen::CAE::LaminateImportZonesBuilder NXOpen::CAE::LaminateImportZonesBuilder@endlink  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateImportZonesBuilder * CreateLaminateImportZonesBuilder
            (
            );
            /** Creates @link NXOpen::CAE::LaminateRelabelPliesBuilder NXOpen::CAE::LaminateRelabelPliesBuilder@endlink  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            ...
            /** Creates a @link NXOpen::CAE::LaminatePlyMaxThicknessVarBuilder NXOpen::CAE::LaminatePlyMaxThicknessVarBuilder@endlink  
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminatePlyMaxThicknessVarBuilder * CreateLaminatePlyMaxThicknessVarBuilder
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & listOfSelectedPlies /** listofselectedplies */ 
            );
            /** Creates @link NXOpen::CAE::LaminatePlySectionBuilder NXOpen::CAE::LaminatePlySectionBuilder@endlink  
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminatePlySectionBuilder * CreatePlySectionBuilder
            (
                NXOpen::CAE::LaminatePlySection * plySection /** plysection */ 
            );
            /** Display 2D fiber orientations for all the selected plies. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void Display2dFiberOrientations
            (
                const std::vector<NXString> & plyNames /** plynames */ ,
            ...
            (
                const std::vector<NXString> & plyNames /** plynames */ ,
                const std::vector<bool> & displayOptions /** displayoptions */ ,
            ...
            /** Display 3D fiber orientations for all the selected plies. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void Display3dFiberOrientations
            (
                const std::vector<NXString> & plyNames /** plynames */ ,
                const std::vector<bool> & displayOptions /** displayoptions */ ,
                const std::vector<int> & colors /** colors */ ,
            ...
            /** Creates a @link NXOpen::CAE::LaminateDrapingDataBuilder NXOpen::CAE::LaminateDrapingDataBuilder@endlink  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateDrapingDataBuilder * CreateMultipleDrapingDataBuilder
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & plies /** A Set of selected plies*/
            );
            /** Set the butt-joint options 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void SetButtjointCompareOption
            (
                NXOpen::CAE::LaminateGlobalLayupMgr::ButtjointOption buttJointOption /** buttjointoption */ 
            );
            /** Creates a @link NXOpen::CAE::LaminateImportedPlyBuilder NXOpen::CAE::LaminateImportedPlyBuilder@endlink  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateImportedPlyBuilder * CreateLaminateImportedPlyBuilder
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & plies /** A Set of selected plies*/
            );
            /** Reimport all selected plies. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void ReimportPlies
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & plies /** A Set of selected plies*/
            );
            /** Creates @link NXOpen::CAE::LaminateAnnotationBuilder NXOpen::CAE::LaminateAnnotationBuilder@endlink  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateAnnotationBuilder * CreateAnnotationBuilder
            (
            );
            /** Prints information of selected plies. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void InformationPlies
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & plies /** A Set of selected plies*/,
                const std::vector<int> & labels /** Labels of selected plies*/
            );
            /** Prints information of selected layups and laminate physical properties. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void InformationLayups
            (
                const std::vector<NXOpen::CAE::LaminateGlobalLayup *> & layups /** A Set of selected layups*/,
                const std::vector<NXOpen::CAE::Laminate *> & laminates /** A Set of selected laminates*/,
                bool printPlies /** printplies */ 
            );
            /** Exports information of selected plies to csv. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void ExportInformationPlies
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & plies /** A Set of selected plies*/,
                const std::vector<int> & labels /** Labels of selected plies*/,
                const NXString & csvFilename /** csvfilename */ 
            ...
            /** Exports information of selected plies to csv. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void ExportInformationPlies
            (
                const std::vector<NXOpen::CAE::LaminatePly *> & plies /** A Set of selected plies*/,
                const std::vector<int> & labels /** Labels of selected plies*/,
                const char * csvFilename /** csvfilename */ 
            );
            /** Exports information of selected layups and laminate physical properties to csv. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void ExportInformationLayups
            (
                const std::vector<NXOpen::CAE::LaminateGlobalLayup *> & layups /** A Set of selected layups*/,
                const std::vector<NXOpen::CAE::Laminate *> & laminates /** A Set of selected laminates*/,
                bool exportPlies /** exportplies */ ,
                const NXString & csvFilename /** csvfilename */ 
            );
            /** Exports information of selected layups and laminate physical properties to csv. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void ExportInformationLayups
            (
                const std::vector<NXOpen::CAE::LaminateGlobalLayup *> & layups /** A Set of selected layups*/,
                const std::vector<NXOpen::CAE::Laminate *> & laminates /** A Set of selected laminates*/,
                bool exportPlies /** exportplies */ ,
            ...
            */
            ...
            /** Collection of laminate ply section 
             <br>  Created in NX1847.0.0.  <br>  
            */
            public: NXOpen::CAE::LaminatePlySectionCollection *PlySections();
