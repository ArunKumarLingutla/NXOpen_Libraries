...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        AddOffset.Value </term> <description> 
        ...
        CloseGaps </term> <description> 
         
        Sharp </description> </item> 

        <item><term> 
         
        DistTol </term> <description> 
         
        2.54 </description> </item> 

        <item><term> 
         
        IsInterpart </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SplitOffset.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  WrapGeometryBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the geometry to be wrapped (solid, sheet, curve, point, convergent body) 
             <br>  Created in NX6.0.0.  <br>  
