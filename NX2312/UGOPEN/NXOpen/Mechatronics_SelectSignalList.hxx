...
//
//  Source File:
//     Mechatronics_SelectSignalList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectSignalListBuilder;
        class SelectSignalListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectSignalList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSignalListImpl * m_selectsignallist_impl;
            private: friend class  _SelectSignalListBuilder;
            protected: SelectSignalList();
            public: ~SelectSignalList();
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::Signal * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Mechatronics::Signal *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::Signal * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Mechatronics::Signal * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Mechatronics::Signal * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Mechatronics::Signal * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Mechatronics::Signal *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Mechatronics::Signal * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Mechatronics::Signal *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::Signal *> GetArray
            (
            );
