...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        DistanceType </term> <description> 
         
        ByLength </description> </item> 

        <item><term> 
         
        ExtendType </term> <description> 
         
        Tangential </description> </item> 
        ...
        Percent.Value </term> <description> 
         
        10 (millimeters part), 1 (inches part) </description> </item> 

        <item><term> 
         
        PercentU.Value </term> <description> 
         
        10 (millimeters part), 1 (inches part) </description> </item> 

        <item><term> 
         
        PercentV.Value </term> <description> 
