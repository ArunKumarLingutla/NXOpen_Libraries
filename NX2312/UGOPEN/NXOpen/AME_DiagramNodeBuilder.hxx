        ...
        */
        class AMEOPENCPPEXPORT  DiagramNodeBuilder : public NXOpen::Builder
        {
            ...
            /** Method to update the Diagramming Node with given symbol variant 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Diagramming::Node * UpdateDiagramNode
            (
                NXOpen::AME::PageObject * pageObject /** pageobject */ ,
                const NXString & updatedSymbolVariantName /** updatedsymbolvariantname */ 
            );
            /** Method to update the Diagramming Node with given symbol variant 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXOpen::Diagramming::Node * UpdateDiagramNode
            (
                NXOpen::AME::PageObject * pageObject /** pageobject */ ,
                const char * updatedSymbolVariantName /** updatedsymbolvariantname */ 
            );
