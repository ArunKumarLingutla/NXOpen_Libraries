...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class PostResultRangeMethodImpl;
        ...
        */
        class NX_DEPRECATED("Deprecated in NX2306.0.0.  No replacement.") NXOPENCPP_CAEEXPORT  PostResultRangeMethod : public NXOpen::CAE::PostISmartSelectorMethod
        {
            private: PostResultRangeMethodImpl * m_postresultrangemethod_impl;
            /// \cond NX_NO_DOC 
            public: explicit PostResultRangeMethod(void *ptr);
            /// \endcond 
            ...
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  No replacement.") void GetEntities
            (
            ...
            /**Returns  the entities visibility 
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  No replacement.") bool IncludeVisibleEntitiesOnly
            (
            );
            ...
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  No replacement.") void SetIncludeVisibleEntitiesOnly
            (
