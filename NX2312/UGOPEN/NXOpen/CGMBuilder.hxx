...
namespace NXOpen
{
    ...
    Colors </term> <description> 
     
    AsDisplayed </description> </item> 

    <item><term> 
     
    ImageResolution </term> <description> 
     
    Draft </description> </item> 
    ...
    OutputText </term> <description> 
     
    Text </description> </item> 

    <item><term> 
     
    RasterImages </term> <description> 
    ...
    ShadedGeometry </term> <description> 
    ...
    VdcCoordinates </term> <description> 
     
    Real </description> </item> 

    <item><term> 
     
    Widths </term> <description> 
     
    StandardWidths </description> </item> 

    <item><term> 
     
    XDimension </term> <description> 
     
    0 </description> </item> 

    <item><term> 
     
    YDimension </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  CGMBuilder : public NXOpen::Builder
    {
        ...
        /**Returns  the Delete Datasets with Unrelated Drawing Sheets Option. This will determine
                   whether unrelated DrawingSheet datasets will be deleted from database.  
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: bool DeleteDatasets
        (
        );
        /**Sets  the Delete Datasets with Unrelated Drawing Sheets Option. This will determine
                   whether unrelated DrawingSheet datasets will be deleted from database.  
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Returns  the create new UI option even there is one exists in database. This will determine
                   whether a new dataset would be created even there is an existing one in the database.  
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: bool CreateNewFromUi
        (
        );
        /**Sets  the create new UI option even there is one exists in database. This will determine
                   whether a new dataset would be created even there is an existing one in the database.  
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: void SetCreateNewFromUi
        (
            bool fromUI /** fromui */ 
        );
    };
