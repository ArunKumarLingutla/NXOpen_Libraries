        ...
        */
        class AMEOPENCPPEXPORT  PlcRule : public NXOpen::AME::AMEBaseNode
        {
            ...
            public: enum Type
            {
                ...
                TypeIterative/** iterative */ ,
                TypeNetwork/** network */ ,
                TypeParameter/** parameter */ ,
                TypeOperatorNot/** operator not */ ,
                TypeOperatorAdd/** operator add */ ,
                TypeOperatorSubtract/** operator subtract */ ,
                TypeOperatorEqual/** operator equal */ ,
                TypeOperatorLessThan/** operator less than */ ,
                TypeOperatorLessThanEqualTo/** operator less than equal to */ ,
                TypeOperatorGreaterThan/** operator greater than */ ,
                TypeOperatorGreaterThanEqualTo/** operator greater than equal to */ ,
                TypeNone/** none */ ,
                TypeLogicBlock/** logic block */ ,
                TypeHwModuleVariable/** hw module variable */ ,
                TypePlaceholderHwModuleVariable/** placeholder hw module variable */ ,
                TypeSystemGlobalInstance/** system global instance */ ,
                TypeSystemLocalInstance/** system local instance */ 
            };
            ...
            public: enum RefObjectType
            {
                ...
                RefObjectTypeStatementUnit/** statement unit */ ,
