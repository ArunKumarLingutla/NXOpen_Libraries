...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AdjacentFaceMethod : public NXOpen::SelectionMethod
        {
            private: AdjacentFaceMethodImpl * m_adjacentfacemethod_impl;
            /// \cond NX_NO_DOC 
