        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  EditSymbolDisplayBuilder : public NXOpen::Builder
        {
            ...
            public: enum FontTypes
            {
                ...
                FontTypesEight/** Long Dashed Double Dotted */,
                FontTypesNine/** Long Dashed Dotted for OOTB fonts and Undulating for shipbuilding fonts */,
                FontTypesTen/** Long Dashed Triplicate Dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
                FontTypesEleven/** Long Dashed Double Short Dashed for OOTB fonts and Railway for shipbuilding fonts */
            };
