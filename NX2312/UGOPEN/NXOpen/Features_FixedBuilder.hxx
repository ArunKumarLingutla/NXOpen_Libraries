...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        FaceToFix.CloneEnabled </term> <description> 
        ...
        FaceToFix.PatternEnabled </term> <description> 
        ...
        FaceToFix.RigidBodyFaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToFix.SameEntryEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToFix.SameEntrySurfaceEnabled </term> <description> 
