...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        WithCopies </description> </item> 

        <item><term> 
         
        PatchSurface </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  EdgePatchBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to convert to have copies or no copies for all selected sheets. 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::EdgePatchBuilder::ConvertTypeOption ConvertType
            (
            );
            ...
            (
                NXOpen::Tooling::EdgePatchBuilder::ConvertTypeOption convertType /** converttype */ 
            );
            /**Returns  the indication that if to use fast algorithm to create patch hole. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool FastPatch
            (
            );
            /**Sets  the indication that if to use fast algorithm to create patch hole. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetFastPatch
            (
                bool fastPatchOption /** fastpatchoption */ 
            );
            /**Returns  the indication that if to remove paremeters for patched surface. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool RemoveParameters
            (
            );
            /**Sets  the indication that if to remove paremeters for patched surface. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetRemoveParameters
            (
                bool removeParametersOption /** removeparametersoption */ 
            );
