...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") enum UgUnits
{
...
//
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage.") enum UgColor
{
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Fields::DisplayPropertiesBuilder.") enum UgLineFont
{
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Fields::DisplayPropertiesBuilder.") enum UgLineWidth
{
