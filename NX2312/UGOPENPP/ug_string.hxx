...
UGOPENCPP_DEPRECATED("Replacement functionality exists. Consider replacing usage with std::to_string(double value).") OPENPPEXPORT const std::string createString
( 
     double value  // <I>
