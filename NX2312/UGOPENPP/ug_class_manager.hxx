...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") UgLeafClassManager
{

    public:

        // The signature of a function for the creation of objects of leaf Open++ classes.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") typedef UgObject *( *CreateLeafFunction ) ( tag_t tag );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") UgLeafClassManager
        (
        ...
        // Copy constructor
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") UgLeafClassManager ( const UgLeafClassManager & src );

        // Destroy a UgLeafClassManager object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") virtual ~UgLeafClassManager ( );
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") OPENPPEXPORT UgDerivedClassManager
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") typedef UgTypedObject *( *CreateDerivedFunction ) ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") UgDerivedClassManager
        (
        ...
        // Copy constructor
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") UgDerivedClassManager ( const UgDerivedClassManager & src );

        // Destroy a UgDerivedClassManager object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. This class should not be used as a customer internal class.") virtual ~UgDerivedClassManager ( );
