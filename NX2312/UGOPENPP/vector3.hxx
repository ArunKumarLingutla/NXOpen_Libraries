...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") VMATHPPEXPORT Vector3
{

    public:

        // Construct a vector with coordinates ( 0.0, 0.0, 0.0 )
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") Vector3 ( );
        
        // Construct a vector with coordinates ( x, y, z )
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitVector3WithDoubles") Vector3
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitVector3WithArray") Vector3
        (
            const double array [ 3 ]    // The x, y, and z coordinates of the vector
        );

        // Destruct a vector
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") virtual ~Vector3 ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnVector3Coordinate") double &operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnVector3Coordinate") const double &operator[]
        (
            VectorMathCoordType index   // The specific vector coordinate to
                                        // return.  Valid values are: X, Y, or Z.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AddVector3ToVector3") const Vector3 operator+
        (
        ...
        // vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AddVector3ToVector3") Vector3 &operator+=
        (
            const Vector3 &vec3         // The second vector in the operation
                                        // ( Vector3 += Vector3 ).
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AddPoint3ToVector3") const Point3 operator+
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractVector3FromVector3") const Vector3 operator-
        (
            const Vector3 &vec3         // The second vector in the operation
                                        // ( Vector3 - Vector3 ).
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractVector3FromVector3") Vector3 &operator-=
        (
            const Vector3 &vec3         // The second vector in the operation
                                        // ( Vector3 -= Vector3 ).
        );
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyVector3ByDouble") const Vector3 operator*
        (
        ...
        // scale.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyVector3ByDouble") Vector3 &operator*=
        (
            double scale                // The scale factor.
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyMatrixAndVector") const Vector3 operator*
        (
        ...
        // rotates the vector to the orientation defined by the matrix.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyMatrixAndVector") Vector3 &operator*=
        (
            const Matrix3 &matrix       // The matrix used to rotate the vector
        );
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DivideVector3ByDouble") const Vector3 operator/
        (
            double scale                // The scale factor.
        ) const;
        ...
        // scale.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DivideVector3ByDouble") Vector3 &operator/=
        (
            double scale                // The scale factor.
        );
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.NegateVector") const Vector3 operator- ( ) const;
        
        // Return the dot product of two vectors.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3DotProduct") double dot
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3CrossProduct") const Vector3 cross
        (
            const Vector3 &vec3         // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MagnitudeOfVector3") double askMagnitude ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3IsEqualUserTolerance") bool isEqual
        ( 
            const Vector3  &vec3,       // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3IsEqual") bool operator==
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3NotEqual") bool operator!=
        ( 
        ...
        // a magnitude of ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ParallelVector3") const Vector3 askUnit
        (
        ...
        // the vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertVector3ToPoint3") const Point3 asPoint3 ( ) const;
        ...
        // of the 3D vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertVector3ToVector2") const Vector2 asVector2 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertVector3ToArray") void asArray
        (
            double array [ 3 ]          // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3FindAngle") double askAngle
        (
            const Vector3 &vec3,        // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.FindAngleWithOrientation") double askAngle
        (
            const Vector3 &vec3,        // <I>
                                        // The vector whose angular spread from the 
                                        // invoking Vector3 object is to be determined.
        ...
        // ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3IsParallel") bool isParallel
        (
            const Vector3 &vec3,        // <I>
        ...
        // ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3IsPerpendicular") bool isPerpendicular
        (
            const Vector3 &vec3,        // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Vector3MakePerpendicular") const Vector3 askPerpendicular ( ) const;
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyVector3ByDouble") VMATHPPEXPORT const Vector3 operator*
(
    double          scale,           // The scale factor
