...
// NX arc objects.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") OPENPPEXPORT UgArc : public UgConicObject,
                                public Arc
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") static UgArc *create
        ( 
            double           radius,        // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") const Matrix3 getMatrix ( ) const;

        // Edit the radius of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") void setRadius
        (
            double           radius         // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") void setStartAngle
        (
            double           start_angle    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") void setEndAngle
        (
            double           end_angle      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") void setCenterPoint
        (
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") UgArc *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") UgArc *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") const std::vector < UgArc * > askAllOccurrences ( ) const;
    ...
    public:
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Arc.") const Curve *askCurve ( ) const;
