...
// manipulating the child controls.
///////////////////////////////////////////////////////////////////////////////
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") OPENINTPPEXPORT UgUIContainer : public UgUIControl
{
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler.") virtual void setSubitemSensitive
        (
            int  index,     // <I>
