...
// errors.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") OPENPPEXPORT UgException
{

    public:

        // Construct a UgException object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") UgException
        (
            int error_code              // The error code that caused the exception
        );

        // Destroy a UgException object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") virtual ~UgException ( );

        // Return the error code of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") int askErrorCode ( ) const;

        // Return the error text that explains the error code of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") const std::string askErrorText ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") void processError ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXException.") static void throwOnFailure
        (
