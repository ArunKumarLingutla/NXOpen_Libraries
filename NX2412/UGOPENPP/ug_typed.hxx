...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") OPENPPEXPORT UgTypedObject : public UgInPartObject,
                                        public UgAttributableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") bool isAlive ( ) const;

        // Determine if the invoking object is condemned.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") bool isCondemned ( ) const;
 
        // Determine if the invoking object is extended by a UDO.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") bool isExtended ( ) const;

        // Return the Open type ( as defined in uf_object_types.h ) of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") int askType ( ) const;

        // Return the Open subtype ( as defined in uf_object_types.h ) of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") int askSubtype ( ) const;

        // Return the extending UDO of the invoking object.
        // Return 0 if the invoking object is not extended by a UDO.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") UgUDO *askExtendingUDO ( ) const;

        // Return the name of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") virtual const std::string getName ( ) const;

        // Edit the name of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") void setName
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::NXObject.") void destroy ( );
