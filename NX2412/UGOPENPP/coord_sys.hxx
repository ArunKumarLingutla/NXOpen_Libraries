...
// class. )
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") VMATHPPEXPORT CoordSys
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") CoordSys ( );
        
        // Construct a CoordSys object at the specified point with the identity
        // matrix as the orientation. 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") explicit CoordSys
            (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") virtual ~CoordSys ( );
        
        // Return the point in Absolute Coordinate System coordinates that 
        // represents the origin of the Coordinate System
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") const Point3 getOrigin ( ) const;
        
        // Edit the origin of the Coordinate System
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") void setOrigin
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") const Matrix3 getMatrix ( ) const;
        
        // Edit the orientation matrix of the Coordinate System
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") void setMatrix
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") const Point3 map
        (
            const Point3   &point,  // <I>
        ...
        // by the invoking object to the coordinates of another Coordinate System.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") const Vector3 map
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") bool isEqual
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::CoordinateSystem.") bool operator==
        (
