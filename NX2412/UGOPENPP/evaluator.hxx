...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") OPENPPEXPORT Evaluator
{ 

    public:

        // Construct an Evaluator object by copying an existing Evaluator object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") Evaluator
        (
            const Evaluator &evaluator          // The Evaluator object to copy
        );

        // Destroy an Evaluator object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") virtual ~Evaluator ( );
          
        // Return the start and end parameters of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") const Interval askLimits ( ) const;

        // Return a point on the curve of the invoking object.
        // The point is in Absolute Coordinate System coordinates.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") const Point3 evaluatePoint
        (
            double        parameter             // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") const Vector3 evaluateTangent
        (
            double        parameter             // <I>
                                                // The natural curve parameter at which to evaluate.
        ) const;
        ...
        // The vector is in Absolute Coordinate System coordinates.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") const Vector3 evaluateNormal
        (
            double        parameter             // <I>
                                                // The natural curve parameter at which to evaluate.
        ) const;
        ...
        // The vector is in Absolute Coordinate System coordinates.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") const Vector3 evaluateBinormal
        (
            double        parameter             // <I>
                                                // The natural curve parameter at which to evaluate.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") const std::vector < Vector3 > evaluateDerivatives
        (
            double        parameter,            // <I>
                                                // The natural curve parameter at which to evaluate.
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve and NXOpen::CurveCollection.") void evaluateClosestPoint
        ( 
