...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Conic.") OPENPPEXPORT Conic : public virtual Curve
{ 
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Conic.") const Point3 getCenterPoint ( ) const;

        // Return the orientation matrix in Absolute Coordinate System coordinates
        // of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Conic.") virtual const Matrix3 getMatrix ( ) const;
