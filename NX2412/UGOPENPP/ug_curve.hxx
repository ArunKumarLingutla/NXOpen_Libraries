...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") OPENPPEXPORT UgCurveObject : public UgEvaluatableObject,
                                        public UgDisplayableSmartObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") enum TrimExtension
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Curve.") void trim
        ( 
