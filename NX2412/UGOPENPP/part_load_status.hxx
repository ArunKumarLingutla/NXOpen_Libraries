...
// to load.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") OPENPPEXPORT PartLoadFailure
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") PartLoadFailure ( );

        // Destroy a PartLoadFailure object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") ~PartLoadFailure ( );

        // Return the name of the part file that failed to load.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") const std::string askPartFileName ( ) const;

        // Return the status code of the part file that failed to load.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") int  askStatusCode ( ) const;

        // Return the status text of the part file that failed to load.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") const std::string askStatusText ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") bool operator==
        (
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") OPENPPEXPORT PartLoadStatus
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") PartLoadStatus ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") bool isFailure ( ) const;

        // Return the PartLoadFailure objects of all of the part files
        // that failed to load.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::PartLoadStatus.") const std::vector < PartLoadFailure > askPartLoadFailures ( ) const;

    private:

        // Construct a PartLoadStatus object from a UG/Open struct.
        explicit PartLoadStatus
        (
