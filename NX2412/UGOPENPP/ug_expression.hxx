...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") OPENPPEXPORT UgExpression : public UgInPartObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") static UgExpression *create
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") static UgExpression *createUnique
        ( 
            const std::string  &LHS,        // <I>
                                            // The Left Hand Side of the expression
            const std::string  &RHS,        // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") static bool isExpression
        (
            const std::string  &LHS,        // <I>
                                            // The Left Hand Side of the expression
            const UgObject     *part_or_object = UgSession::getWorkPart ( )
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") static UgExpression *askExpression
        (
            const std::string  &LHS,        // <I>
                                            // The Left Hand Side of the expression
            const UgObject     *part_or_object = UgSession::getWorkPart ( )
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") double askValue ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") const std::string askDescriptor ( ) const;

        // Return the Left Hand Side of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") const std::string getLHS ( ) const;
 
        // Return the Right Hand Side of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") const std::string getRHS ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") void setLHS
        (
            const std::string  &LHS         // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") void setRHS
        (
            const std::string  &RHS         // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Expression.") void destroy ( );
