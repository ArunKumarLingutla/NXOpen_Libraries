...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point3d.") VMATHPPEXPORT Point3
{

    public:

        // Construct a Point3 object at ( 0.0, 0.0, 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point3d.") Point3 ( );
        
        // Construct a Point3 object at ( x, y, z ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitPoint3WithDoubles") Point3
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.InitPoint3WithArray") Point3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point3d") virtual ~Point3 ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnPoint3Coordinate") double &operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ReturnPoint3Coordinate") const double &operator[]
        (
            VectorMathCoordType index   // The specific point coordinate to
                                        // return.  Valid values are: X, Y, or Z.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractPoint3FromPoint3") const Vector3 operator-
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.AddPoint3ToVector3") Point3 &operator+=
        (
            const Vector3 &vector       // The vector whose coordinates are 
                                        // added to those of the point.
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractVector3FromPoint3") const Point3 operator-
        (
            const Vector3 &vector       // The vector whose coordinates are 
        ...
        // object to be that point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.SubtractVector3FromPoint3") Point3 &operator-=
        (
            const Vector3 &vector       // The vector whose coordinates are 
                                        // subtracted from those of the point.
        );
        ...
        // the new point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyPoint3ByDouble") const Point3 operator*
        (
        ...
        // scale.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyPoint3ByDouble") Point3 &operator*=
        (
            double scale                // The scale factor.
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyPoint3ByMatrix3") const Point3 operator*
        (
        ...
        // rotates the point to the orientation defined by the matrix.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyPoint3ByMatrix3") Point3 &operator*=
        (
            const Matrix3 &matrix       // The matrix used to rotate the point
        );
        ...
        // the new point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DividePoint3ByDouble") const Point3 operator/
        (
            double scale                // The scale factor.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DividePoint3ByDouble") Point3 &operator/=
        (
            double scale                // The scale factor.
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.DistanceBetweenPoint3") double askDistance
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Point3IsEqualUserTolerance") bool isEqual
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Point3IsEqual") bool operator==
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Point3NotEqual") bool operator!=
        ( 
        ...
        // the point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertPoint3ToVector3") const Vector3 asVector3 ( ) const;
        ...
        // of the 3D point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertPoint3ToPoint2") const Point2 asPoint2 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.ConvertPoint3ToArray") void asArray
        (
            double array [ 3 ]          // <O>
    ...
    private:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.Point3AndVector3DotProduct") double dot
        (
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with MathUtils.MultiplyPoint3ByDouble") VMATHPPEXPORT const Point3 operator*
(
    double         scale,            // The scale factor
