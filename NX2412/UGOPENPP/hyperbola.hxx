...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") OPENPPEXPORT Hyperbola : public Conic
{

    public:

        // Return the length along the semi transverse axis of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") double getSemiTransverseLength ( ) const;

        // Return the length along the semi conjugate axis of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") double getSemiConjugateLength ( ) const;

        // Return the minimum y value of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") double getMinimumY ( ) const;

        // Return the maximum y value of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") double getMaximumY ( ) const;
