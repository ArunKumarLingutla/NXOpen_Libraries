...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") OPENPPEXPORT UgSpline : public UgCurveObject, public Spline
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") static const std::vector < double >  NoParameters;

        // Create a UgSpline object that passes through the given 3D points.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") static UgSpline *create
        ( 
            bool                          is_periodic,   //
                                                    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") void getThruPoints
        ( 
            bool                     *is_periodic,  // <O>
                                                    // The periodicity of the spline.
        ...
        // points through which the spline passes.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") void setThruPoints
        ( 
            bool                          is_periodic,  //
                                                    // <I>
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") UgSpline *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") UgSpline *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") const std::vector < UgSpline * > askAllOccurrences ( ) const;
    ...
    public:
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") const Curve *askCurve ( ) const;
...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") OPENPPEXPORT ThruPoint {
    
    public:

        // This enum specifies how to control the slope of the spline at the through
        // point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") enum SlopeType
        {
        ...
        // point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") enum CurvatureType
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Spline.") ThruPoint
        (
