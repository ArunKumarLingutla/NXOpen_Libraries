...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") OPENPPEXPORT UgHyperbola : public UgConicObject,
                                      public Hyperbola
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") static UgHyperbola *create
        ( 
            double           transverse,    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") const Matrix3 getMatrix ( ) const;
 
        // Edit the length along the semi transverse axis of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") void setSemiTransverseLength
        (
            double           transverse     // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") void setSemiConjugateLength
        (
            double           conjugate      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") void setMinimumY
        (
            double           minimum_y      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") void setMaximumY
        (
            double           maximum_y      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") void setCenterPoint
        (
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") UgHyperbola *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") UgHyperbola *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") const std::vector < UgHyperbola * > askAllOccurrences ( ) const;
    ...
    public:
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") const Curve *askCurve ( ) const;
