...
#define UF_VIEW_MAX_LIGHT_NAME_NCHARS 40
#define UF_VIEW_MAX_LIGHT_NAME_BUFSIZE NX_BUFSIZE(UF_VIEW_MAX_LIGHT_NAME_NCHARS) 

/*  */ 
#define UF_VIEW_MAX_LIGHT_NAME_LENGTH (UF_VIEW_MAX_LIGHT_NAME_BUFSIZE - 1) 
/*  */
...
typedef char UF_VIEW_light_name_t[UF_VIEW_MAX_LIGHT_NAME_BUFSIZE];
...
/* A view name has more than UF_OBJ_NAME_NCHARS characters         */
...
faces and edges because they are not visible.  Also be aware that this function does not return
extracted curves for exact and smart lightweight view types.  If you require the extracted curves for these views, 
then please use UF_VIEW_ask_visible_objects instead. 
...
Modeling views will just contain the name (ViewName).
