...
#define UF_UI_DEFAULT_UNITS   1000
...
enum UF_UI_dialog_filter_id_e{
    ...
    UF_UI_RLIST_HRN_NO_HX2ML_FLTR,     /* */
    UF_UI_RLIST_CMP_FLTR,     /* */
    UF_UI_RLIST_CMP_NO_HX2ML_FLTR,     /* */
    UF_UI_RLIST_HRN_CMP_FLTR,     /* Specifies *.hrn and *.cmp */
    UF_UI_RLIST_HRN_CMP_NO_HX2ML_FLTR,
    UF_UI_RLIST_DRV_FLTR,     /* */
    UF_UI_IMPORT_SE_FLTR,     /* */
    UF_UI_IMPORT_STL_FLTR,    /* Specifies *.stl and *.stl.gz */
    UF_UI_IMPORT_CUST_UNIT_CELL_FLTR, /*Specifies *.xml */
    ...
    UF_UI_CAE_RST_FLTR,             /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil *.unv *.bun *.vldresults and *rs2 */
    UF_UI_CAE_RST_ODB_FLTR,              /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil and *.odb *.vldresults and *rs2*/
    UF_UI_CAE_ODB_FLTR,                  /* Specifies *.odb */
    UF_UI_CAE_SAMCEF_FLTR,               /* Specifies *.des *.ssndb *.op2 *.vdm *.rst *.rth and *.fil */
    UF_UI_CAE_U18_FLTR,               /* Specifies *.u18 */
    UF_UI_CAE_SDB_FLTR,               /* Specifies *.sdb */
    ...
    UF_UI_CAE_WAV_FLTR,                  /* Specifies *.wav */
    ...
    UF_UI_MW_FLTR,                       /* Specifies *.mw and *.maple for Maple Worksheet*/
    ...
    UF_UI_IRAYPLUS_MATERIAL_FLTR,        /* Specifies *.xml, *.mdl */
    UF_UI_IRAYPLUS_MATERIAL_SYSTEM_SAVE_FLTR, /* Specifies *.xml */
    UF_UI_IRAYPLUS_MDL_FLTR,             /* Specifies *.mdl */
    ...
    UF_UI_TRAN_3MF_FLTR,
    UF_UI_TRAN_WAVEFRONT_OBJ_FLTR,
    UF_UI_TRAN_IFC_FLTR,
    UF_UI_TRAN_G3D_FLTR,
    UF_UI_TRAN_REVIT_FLTR,
    UF_UI_TRAN_RHINO_FLTR,
    UF_UI_TRAN_3DXML_FLTR,
    UF_UI_CAE_LAYOUTSTATE_FLTR,         /* For the layout states *.lsx */
    UF_UI_MOTION_LMS_LMSMOTIONRESULTS_FLTR,          /* Specifies *.lmsmotionresults for LMS Motion */
    UF_UI_MOTION_LMS_OFF_FLTR,         /* Specifies *.off tessellation for LMS Motion */
    UF_UI_LIGHT_PROFILE_FILE_FLTR,      /* Specifies light profile files *.ies */
    UF_UI_CAE_APPPP_DATASOURCE_FLTR,          /* For APPPP data sources */
    UF_UI_CAE_RESULTSESSION_FLTR,         /* For the Result Session Files *.rsfx */
    UF_UI_XMCF_FLTR,                      /* For the *.xmcf */
    UF_UI_PART_SAVEAS_WITH_PROTECTION,             /* Specifies *.prt */                
    UF_UI_GIF_FLTR,                      /* Specifies *.gif */
    UF_UI_BMP_FLTR,                      /* Specifies *.bmp */
    UF_UI_XWD_FLTR,                     /* Sepcifies *.xwd */
    UF_UI_FIELD_IMPORT_FLTR,             /* Specifies *.fld, *.* */
    UF_UI_XXML_FLTR,                     /* Speficies extended *.xml */
    UF_UI_CAM_COMPANY_SETUP_IMAGE_FLTR,      /* Specifies *.prt, *.tif, *.png, *.jpg and *.bmp */
    UF_UI_CAE_VL2TL_FLTR,               /* Equivalent to UF_UI_CAE_SC2TL_FLTR. Specifies *.sc2tl */
    UF_UI_FIELD_TABLE_DATA_IMPORT_FLTR, /* Specifies *.csv, *.txt, *.* */
    UF_UI_TRAN_CATIAV5_CATSHAPE_FLTR,   /* Specifies *.CATShape   */
    UF_UI_TRAN_CATIAV5_CGR_FLTR,        /* Specifies *.cgr        */
    UF_UI_CAE_RST_IMP_FLTR,              /*Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil *.unv *.bun and *rs2 */
    UF_UI_CAE_RST_ODB_IMP_FLTR,          /*Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil and *.odb  and *rs2*/
    UF_UI_TRAN_STP242_EXPORT_FLTR,      /* Specifies *.stp, *.stpx, *.stpz, *.stpxz */
    UF_UI_MOTION_AUTOFLEX_IMPORT_NASTRAN_FILE_FLTR, /*Specifies *.fem, *.bdf, *.blk, *.dat and *.nas */
    UF_UI_MOTION_MFLXDB_FLTR,           /*Specifies *.mflxdb */
    UF_UI_PNID_IMAGE_FLTR,               /* Specifies *.jpg and *.png */
    UF_UI_XML_FLTR,                      /* For the *.xml */
    UF_UI_CAE_RESULTSESSION_EXPORT_FLTR, /* For layout state export (*.rsfx, *.lsx) */
    UF_UI_EMBED_GUIDE_FLTR,              /* Specifies *.html and *.pdf files */
    UF_UI_EMBED_DOC_FLTR,                /* Specifies *.doc, *.docx, *.ppt, *.pptx, *.xls, and *.xlsx files */
    UF_UI_EMBED_AUTO_FLTR,               /* Specifies *.cs, *.jar, and *.vb files */
    UF_UI_SAVE_LOAD_OPT_FLTR,            /* Specifies *.def when storing load options to a file */
    UF_UI_IMPORT_JT_FLTR,                /* Specifies *.prt, *.fem, *.sim and *.jt */
    UF_UI_IMPORT_CSV_TSV_FLTR,           /* Specified *.tsv and *.csv for Logic Editor */
    UF_UI_TDP_TEMPLATE_IMAGE_FLTR,       /* Specifies *.jpg, *.jpeg, *.jpe, *.png */
    UF_UI_TCIN_IMPORT_ASSY_FLTR,         /* Specifies *.prt, *.fem, *.sim and *.jt */
    UF_UI_CAE_RST_SCD5_IMP_FLTR,         /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil *.unv *.bun *.rs2 and *.scd5 */
    UF_UI_CAE_RST_ODB_SCD5_IMP_FLTR,     /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil *.odb *.rs2 and *.scd5*/
    UF_UI_CAE_RST_SCD5_FLTR,             /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil *.unv *.bun *.vldresults *.rs2 and *.scd5*/
    UF_UI_CAE_RST_ODB_SCD5_FLTR,         /* Specifies *.op2 *.xdb *.vdm *.rst *.rth *.des *.ssndb *.fil and *.odb *.vldresults *.rs2 and *.scd5*/
    UF_UI_MOTION_LMS_MINF_FLTR,          /* Specifies *.minf */
    UF_UI_CAE_APPPP_DATASOURCE_SCD5_FLTR, /* For APPPP data sources. Specifies *.scd5 extension that is under a feature toogle */
    UF_UI_SVM_FLTR,                      /* Specifies *.svm */
    UF_UI_AXF_FLTR,                      /* Sepcifies *.axf */
    UF_UI_IES_FLTR,                      /* Sepcifies *.ies, *iesna */
    UF_UI_VISIO_STENCIL_FLTR,            /* Add for Visio Stencil */
    UF_UI_SCHEMATIC_LOGICAL_MODEL_FLTR,  /* Add for Schematic Logical Model File */
    UF_UI_NEST_ADDPART_FLTR,             /* Add for Nest Add Part. Specifies *.dxf */
    UF_UI_XLSX_CSV_FLTR,                 /* Specifies *.xlsx,.csv */
    UF_UI_XLSX_FLTR,                     /* Specifies *.xlsx */
    UF_UI_BUN_FLTR,                      /* Specifies *.bun */
    UF_UI_DOC_PART_SAVEAS_FLTR,          /* Specifies *.nxdoc */
    UF_UI_PROC_PART_SAVEAS_FLTR,         /* Specifies *.proc */
    UF_UI_BOP_PART_SAVEAS_FLTR,          /* Specifies *.bop */
    UF_UI_DOC_ATTR_CATALOG_FLTR,        /* Specifies *.xml, *.nxdoc */
    UF_UI_XLSM_CSV_FLTR,                 /* Specifies *.xlsm,.csv */
    UF_UI_XLSX_XLSM_CSV_FLTR,            /* Specifies *.xlsx, .xlsm,.csv */
    UF_UI_MOTION_FLEXBODY_FLTR,          /* SPECIFIES *.op2, *.rst, *.odb*/
...
/*
*   UF_UI_CAE_SC2TL_FLTR was added to NX1899 to replace UF_UI_CAE_VL2TL_FLTR. This was
*   following added the replacement of the VL2TL format with the SC2TL format. 
*/
#define UF_UI_CAE_SC2TL_FLTR UF_UI_CAE_VL2TL_FLTR
...
enum UF_UI_dialog_dir_id_e{
    ...
    UF_UI_CAE_WAV_DIR,                  /* Used by *.wav File */
    ...
    UF_UI_IRAYPLUS_MDL_DIR,            /* Used by Import MDL *.mdl file */
    UF_UI_TRAN_STPXZ_DIR,
    UF_UI_TRAN_STP242_DIR,
    UF_UI_TRAN_3MF_DIR,
    UF_UI_TRAN_WAVEFRONT_OBJ_DIR,
    UF_UI_TRAN_IFC_DIR,
    UF_UI_TRAN_G3D_DIR,
    UF_UI_TRAN_REVIT_DIR,
    UF_UI_TRAN_RHINO_DIR,
    UF_UI_TRAN_3DXML_DIR,
    UF_UI_CAE_LAYOUTSTATE_DIR,
    UF_UI_MOTION_LMS_LMSMOTIONRESULTS_DIR,          /* Used by *.lmsmotionresults for motion result files in LMS */
    UF_UI_CAE_APPPP_DATASOURCE_DIR,          /* Used by CaeUI::APPPP::SelectDataSource */
    UF_UI_LIGHT_PROFILE_FILE_DIR,       /* Used to specify a light profile file */
    UF_UI_XMCF_DIR,               /* Used by Universal connection editor to export to *.xmcf file */
    UF_UI_CAE_RESULTSESSION_DIR,
    UF_UI_GIF_DIR,                      /* Used by *.gif File */
    UF_UI_BMP_DIR,                      /* Used by *.bmp File */
    UF_UI_XWD_DIR,                      /* Used by *.xwd FIle */
    UF_UI_FIELD_IMPORT_DIR,             /* Specifies *.fld, *.* */
    UF_UI_XXML_DIR,                     /* Specifies extended *.xml */
    UF_UI_CAM_COMPANY_SETUP_IMAGE_DIR,  /* Specifies *.prt, *.tif, *.png, *.jpg and *.bmp */
    UF_UI_CAE_VL2TL_DIR,                /* Equivalent to UF_UI_CAE_SC2TL_DIR. Used as *.sc2tl File */
    UF_UI_TRAN_CATIAV5_CATSHAPE_DIR,    /* Used by CATIA V5 under File Open and File Import */
    UF_UI_TRAN_CATIAV5_CGR_DIR,         /* Used by CATIA V5 under File Open and File Import */
    UF_UI_CAE_RST_IMP_DIR,
    UF_UI_CAE_RST_ODB_IMP_DIR,
    UF_UI_MOTION_AUTOFLEX_IMPORT_NASTRAN_FILE_DIR, /* Used by AutoFlex to select import nastran solver file*/
    UF_UI_MOTION_MFLXDB_FILE_DIR,       /* Specifies *.mflxdb, *.LMSFlexibleDatabase */
    UF_UI_PNID_IMAGE_DIR,
    UF_UI_CAE_RESULTSESSION_EXPORT_DIR, /* Used for layout state export */
    UF_UI_EMBED_DIR,                    /* Used by the Embed Manager */
    UF_UI_SVM_DIR,                      /* Used by SVM Visual Material Editor Export *.svm file */ 
    UF_UI_SVM_SYSTEM_SAVE_DIR,          /* Used by SVM Visual Material Editor Save to System Studio Materials *.svm file */ 
    UF_UI_IES_DIR,                      /* Used by SVM Visual Material Editor Photometric Emission File */
    UF_UI_SLM_DIR,                      /* Used for openning Schematic Logical Model file */
    UF_UI_XLSX_CSV_FILE_DIR,
    UF_UI_XLSX_FILE_DIR,
    UF_UI_BUN_FILE_DIR,
    UF_UI_DOC_ATTR_CATALOG_DIR,             /* Used by *.xml, *.nxdoc File*/
    UF_UI_XLSM_CSV_FILE_DIR,                /* Used by *.xlsm, *.csv File*/
    UF_UI_XLSX_XLSM_CSV_FILE_DIR,           /* Used by *.xlsx, *.xlsm, *.csv File*/
...
/*
*   UF_UI_CAE_SC2TL_DIR was added to NX1899 to replace UF_UI_CAE_VL2TL_DIR. This was
*   following added the replacement of the VL2TL format with the SC2TL format.
*/
#define UF_UI_CAE_SC2TL_DIR UF_UI_CAE_VL2TL_DIR
...
/* 11 to 14 are reserved for additional solid_type use */

/*

*/
#define UF_UI_SEL_FEATURE_CONVERGENT_EDGE       15
#define UF_UI_SEL_FEATURE_CONVERGENT_FACE       16
#define UF_UI_SEL_FEATURE_CONVERGENT_SOLID_BODY 17
#define UF_UI_SEL_FEATURE_CONVERGENT_SHEET_BODY 18
...
#define UF_UI_SEL_FEATURE_WELD_DATUM_EDGE       120
#define UF_UI_SEL_FEATURE_WELD_DATUM_CUSTOM1    121
#define UF_UI_SEL_FEATURE_WELD_DATUM_CUSTOM2    122
#define UF_UI_SEL_FEATURE_WELD_DATUM_CUSTOM3    123
/*

*/
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_SURFACE      124
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_HOLE         125
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_STUD         126
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_SLOT         127
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_TRIM         128
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_HEMMED_EDGE  129
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_CUSTOM1      130
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_CUSTOM2      131
#define UF_UI_SEL_FEATURE_WELD_MEASUREMENT_CUSTOM3      132

/*  

*/
#define UF_UI_SEL_FEATURE_JOIN_POINT                    133
#define UF_UI_SEL_FEATURE_JOIN_CURVE                    134
#define UF_UI_SEL_FEATURE_JOIN_FACE                     135
#define UF_UI_SEL_FEATURE_JOIN_HOLE                     136

#define UF_UI_SEL_FEATURE_MAX_SPECIAL_FEATURE   137 /* This should be last of special feature types */


//Hybrid edge
#define UF_UI_SEL_FEATURE_HYBRID_EDGE                   9008
#define UF_UI_SEL_FEATURE_FRAME                         9009
