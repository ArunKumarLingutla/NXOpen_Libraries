 ...
 * given color.
 */
#define UF_DISP_CCM_EUCLIDEAN_DISTANCE  1   /* Euclidean disance in RGB color space */
#define UF_DISP_CCM_HSV_DISTANCE        2   /* Distance in HSV (Hue-Saturation-Value color space) */
...
enum UF_DISP_color_shade_types_e 
{ 
    UF_DISP_C_NONE, UF_DISP_C_BLUE_MARBLE, UF_DISP_C_CHROME,             /* 2  */
    UF_DISP_C_CUBES, UF_DISP_C_SIMPLE_WOOD, UF_DISP_C_SOLID_CLOUDS,       /* 5  */
    UF_DISP_C_SOLID_POLKA, UF_DISP_C_WRAPPED_BRICK, UF_DISP_C_WRAPPED_CHECKER,    /* 8  */
    UF_DISP_C_WRAPPED_DIAGONAL, UF_DISP_C_WRAPPED_GRID, UF_DISP_C_WRAPPED_IMAGE,      /* 11 */
    UF_DISP_C_WRAPPED_POLKA, UF_DISP_C_WRAPPED_S_STRIPE, UF_DISP_C_WRAPPED_T_STRIPE,   /* 14 */
    UF_DISP_C_MARBLE, UF_DISP_C_WRAPPED_T_BRICK, UF_DISP_C_SURFACE_EVAL,       /* 17 */
    UF_DISP_C_SIMPLE_DECAL, UF_DISP_C_WRAPPED_LI_IMAGE, UF_DISP_C_BIRCH,              /* 20 */
    UF_DISP_C_CHERRY, UF_DISP_C_GRANITE, UF_DISP_C_MAPLE,              /* 23 */
    UF_DISP_C_OAK, UF_DISP_C_PINE, UF_DISP_C_WOOD,               /* 26 */
    UF_DISP_C_WRAPPEDBIRCHFLOOR, UF_DISP_C_WRAPPEDBRICKBONDS, UF_DISP_C_WRAPPEDCHERRYFLOOR, /* 29 */
    UF_DISP_C_WRAPPEDMAPLEFLOOR, UF_DISP_C_WRAPPEDOAKFLOOR, UF_DISP_C_WRAPPEDPINE_FLOOR,  /* 32 */
    UF_DISP_C_WRAPPEDWOODFLOORS, UF_DISP_C_WRAPPEDROOFTILES, UF_DISP_C_LOGO_DECAL,            /* 35 */
    UF_DISP_C_GL_PBR_IMAGE, UF_DISP_C_NUM_SHADERS                                    /* 37 */
};
typedef enum UF_DISP_color_shade_types_e UF_DISP_color_shade_types_t;

enum UF_DISP_reflectance_shade_types_e
{
    UF_DISP_R_CONSTANT, UF_DISP_R_MATTE, UF_DISP_R_METAL,
    UF_DISP_R_PHONG, UF_DISP_R_PLASTIC, UF_DISP_R_CHROME_2D,
    UF_DISP_R_CONDUCTOR, UF_DISP_R_DIELECTRIC, UF_DISP_R_ENVIRONMENT,
    UF_DISP_R_GLASS, UF_DISP_R_MIRROR, UF_DISP_R_ANISOTROPIC,
    UF_DISP_R_CIRC_ANISO, UF_DISP_R_T_PLASTIC, UF_DISP_R_MULTILAYER_PAINT,
    UF_DISP_R_NONE,
    UF_DISP_R_SHADOW_CATCHER,
    UF_DISP_R_DECAL,
    UF_DISP_R_CGFX,
    UF_DISP_R_CAR_PAINT,
    UF_DISP_R_SPECULAR_MAP, //this is used for IrayPlus speaker cloth material 
    UF_DISP_R_GL_PBR_VISUAL_MATERIAL, // used for Iray+ SVM base type materials
    UF_DISP_R_NUM_SHADERS
};
typedef enum UF_DISP_reflectance_shade_types_e UF_DISP_reflectance_shade_types_t;

enum UF_DISP_transparency_shade_types_e
{
    UF_DISP_T_NONE, UF_DISP_T_ERODED, UF_DISP_T_WRAPPED_GRID,
    UF_DISP_T_WRAPPED_IMAGE, UF_DISP_T_STENCIL, UF_DISP_T_GLOW,
    UF_DISP_T_WRAPPED_LI_IMAGE,
    UF_DISP_T_GL_PBR_TRANSMISSION, // used for Iray+ SVM base type materials
    UF_DISP_T_NUM_SHADERS
};
typedef enum UF_DISP_transparency_shade_types_e UF_DISP_transparency_shade_types_t;

enum UF_DISP_displacement_shade_types_e
{
    UF_DISP_D_NONE, UF_DISP_D_CASTING, UF_DISP_D_ROUGH,
    UF_DISP_D_WRAPPED_DIMPLE, UF_DISP_D_WRAPPED_ROUGH, UF_DISP_D_WRAPPED_BUMP,
    UF_DISP_D_WRAPPED_KNURL, UF_DISP_D_WRAPPED_TREAD_PLATE,
    UF_DISP_D_LEATHER, UF_DISP_D_WRAPPED_LEATHER, UF_DISP_D_WRAPPED_BUMP_NORMAL,
    UF_DISP_D_GL_PBR_DUAL_NORMAL, // used for Iray+ SVM base type materials
    UF_DISP_D_NUM_SHADERS
};
typedef enum UF_DISP_displacement_shade_types_e UF_DISP_displacement_shade_types_t;

typedef struct UF_DISP_legacy_material_params_s
{

    char name[MAX_FSPEC_BUFSIZE];

    UF_DISP_color_shade_types_t color_shader; // Pattern Shader
    UF_DISP_reflectance_shade_types_t reflectance_shader; // Reflectance Shader
    UF_DISP_transparency_shade_types_t transparency_shader; // Transparency Shader
    UF_DISP_displacement_shade_types_t bump_shader; // Bump Shader

    double translucency; // Translucency value on base material
    double matColor[3]; // Primary material color in RGB form
    double color2[3]; // Secondary color attribute on certain materials
    double bumpScale; // Scale value for bump
    double roughness; // Roughness on reflectance
    double specular; // specular on reflectance
    double amplitude; // amplitude for bump texture
    double c_scale; // pattern shader scale

    char bumpFile[MAX_FSPEC_BUFSIZE]; // Bump texture file
    char patternFile[MAX_FSPEC_BUFSIZE]; // Pattern texture file
    char transparencyFile[MAX_FSPEC_BUFSIZE]; // Transparency texture file

} UF_DISP_legacy_material_params_t, * UF_DISP_legacy_material_params_p_t;
