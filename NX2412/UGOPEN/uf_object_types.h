...
#define    UF_image_texture_image_subtype              1 /* Texture Image (new in NX1847) */
#define    UF_image_tdp_template_image_subtype         2 /* Technical Data Package Template Image (new in 1847) */
...
#define    UF_group_subtype                          0
#define    UF_linked_group_subtype                   1
...
#define    UF_draft_ship_tic_subtype                  46   /* Drafting ship tic */
#define    UF_draft_edge_condition_symbol_subtype     47   /* Edge Condition Symbol*/
#define    UF_draft_surface_finish_symbol_subtype     48   /* Surface Finish Symbol*/
...
#define    UF_sfem_connection_recipe_face_face_subtype          10
#define    UF_sfem_connection_recipe_1dmesh_face_subtype        11  /* 1dmesh to face connection */
#define    UF_sfem_connection_recipe_node_node_subtype          12
...
#define    UF_caemisc_edge_separation_condition_subtype 14 /* Edge Separation Condition*/
#define    UF_caemisc_pre_test_sensor_subtype           15 /* Pre-Test Sensor*/
#define    UF_caemisc_pre_test_exciter_subtype           16 /* Pre-Test Exciter*/
#define    UF_caemisc_crack_face_condition_subtype       17 /* Crack Face Condition*/
#define    UF_caemisc_match_face_mesh_control_subtype    18 /* Face match */
#define    UF_caemisc_match_edge_mesh_control_subtype    19 /* Edge match */
#define    UF_caemisc_note_connection_subtype            20 /*CAE Selection Recipe*/
...
#define    UF_skeleton_uv_mapping_grid_subtype         12 /* new in NX1847 */
#define    UF_skeleton_logic_editor_grid_subtype       13 /* new in NX1926 */
#define    UF_skeleton_diagramming_grid_subtype        14 /* new in NX2007 */
...
#define    UF_parm_sheet_metal_subtype                30  /* Obsolete in NX1926 */
#define    UF_parm_ladder_diagram_subtype             31
#define    UF_parm_calculator_subtype                 32
#define    UF_parm_member_view_subtype                33
#define    UF_parm_sketch_tol_data_subtype            34  /* Obsolete in NX1926 */
...
#define    UF_parm_moldcooling_subtype                88 /* Root object for Mold Cooling application */
#define    UF_parm_cadcaeprep_ib_manager_subtype      89 /* Root object for CADCAEPrep*/
#define    UF_parm_ship_pointref                      90 /* Ship point reference*/
#define    UF_parm_join_subtype                       91 /* Root object for NXJoin preferences */
#define    UF_parm_aecdesign_bodyref_subtype          92 /* AECDesign object reference*/
#define    UF_parm_aecdesign_rootobject_subtype       93 /* AECDesign root object reference*/
#define    UF_parm_composites_subtype                 94 /* Composites preferences */
...
#define    UF_reference_design_simplified_subtype      8
...
#define    UF_solid_frame_subtype                      6 /* Solid frame */
...
#define    UF_mdm_force_form_subtype                   1 /* Define a force form subtype */
...
#define  UF_mechatronics_observer_subtype                     65 /* An observer collects parameters to display in RT-inspector. */
#define  UF_mechatronics_inverse_kinematics_subtype           66 /* An inverse kinematics object to control the mechanism. */
#define  UF_mechatronics_joint_jogger_subtype                 67 /* A joint jogger to control the position of joint. */
#define  UF_mechatronics_pulley_belt_constraint_subtype       68 /* A Pulleys and Belt chains defines the motion of multiple rotary axes with one belt so that they move at a fixed ratio. */
#define  UF_mechatronics_laser_scanner_subtype                69 /* A laser scanner specifies the distances between the sensor and collision body.*/
#define  UF_mechatronics_runtime_button_subtype               70 /* A Runtime Button defines the user interaction during runtime*/
#define  UF_mechatronics_gripper_subtype                      71 /* A Gripper defines a machine unit that can clamp workpiece. */
#define  UF_mechatronics_bond_zone_subtype                    72 /* A Bond Zone defines the zone which will detect rigid bodies and bond them together. */
#define  UF_mechatronics_zone_subtype                         73 /* A Zone object defines the space to detect rigid bodies. */
#define  UF_mechatronics_point_on_curve_kinematics_chain_subtype 74 /* A kinematics chain makes some slave rigid bodies follow the motion of master rigid body which is controlled by point on curve joints with 'Kinematics' motion type. */
#define  UF_mechatronics_light_curtain_subtype                75 /*A light curtain specifies the distances between the sensor and collision body.*/
#define  UF_mechatronics_dynamic_material_subtype             76 /* A Dynamic Material to support variable size simulation. */
#define  UF_mechatronics_dynamic_material_cutter_subtype      77 /* A Material Cutter to support variable size object cut simulation. */
#define  UF_mechatronics_flexible_belt_subtype                78 /* A flexible belt to define a changeable belt in simulation. */
#define  UF_mechatronics_roller_subtype                       79 /* A Roller for flexible belt. */
#define  UF_mechatronics_flexible_body_pressor_subtype        80 /* A pressor object to simulate pressing behavior on a flexible body. */
#define  UF_mechatronics_flexible_body_cutter_subtype         81 /* A cutter object to simulate cutting behavior on a flexible body. */
#define  UF_mechatronics_measure_subtype                      82 /* A measure to monitor distance or angle between geometries*/
#define  UF_mechatronics_flexible_cable_subtype               83 /* A flexible cable object */
#define  UF_mechatronics_kanban_subtype                       84 /* A kanban object to define the runtime parameters in the kanban window during simulation*/
#define  UF_mechatronics_kineo_cable_subtype                  85 /* A kineo cable object */
#define  UF_mechatronics_kineo_belt_subtype                   86 /* A kineo belt object */
#define  UF_mechatronics_animated_camera_subtype              87 /* A animated camera object */
#define  UF_mechatronics_vision_camera_subtype                88 /* A vision camera object */
#define  UF_mechatronics_web_node_subtype                     89 /* A web node object */
#define  UF_mechatronics_web_subtype                          90 /* A web object */
#define  UF_mechatronics_web_cutter_subtype                   91 /* A web cutter object */
#define  UF_mechatronics_tape_zone_subtype                    92 /* A tape zone object */
#define  UF_mechatronics_flicker_subtype                      93 /* A Flicker object */
#define  UF_mechatronics_multiple_layer_webs_subtype          94 /* A multiple layer webs object */
#define  UF_mechatronics_instance_operator_subtype            95 /* An instance operator object */
#define  UF_mechatronics_web_sensor_subtype                   96 /* A web sensor object */
...
#define    UF_mach_turn_gmc_subtype                  990   /* Turning generic motion */
...
#define    UF_mach_device_gmc_subtype               3600  /* Generic motion for devices */
#define    UF_mach_tp_deburring_subtype             3700
#define    UF_mach_tp_framework_operation_subtype   3800
#define    UF_mach_additive_gmc_subtype             3900  /* Additive Generic motion */
#define    UF_mach_omp_subtype                      4000  /* On-Machine Probing */
#define    UF_mach_omp_tool_setting_subtype         4010  /* On-Machine Probing, Tool Setting */
                                                          /* 4020-4090 Reserved for future OMP work. Next available is 4100. */
...
#define    UF_millturn_orient_subtype                 32  /* MillTurn orientation */
...
#define    UF_machining_mach_pm_findings_report_subtype 1029  /* The nc program manager subtype for findings report */
#define    UF_machining_mach_pm_finding_subtype         1030  /* The nc program manager subtype for finding */
...
#define    UF_trim_ext_subop_data_subtype             48
...
#define    UF_mach_process_patterning_subtype         600  /* Pattern task */

#define    UF_machining_master_template_manager_subtype      700
#define    UF_machining_master_template_object_subtype       701
...
#define    UF_mach_mergepath_subtractive_planar_subtype      165    /* Tool path merge task for subtractive planar operations */ 
#define    UF_mach_mcg_task_subtype                  166    /* Machine code group */
...
#define    UF_mach_screen_text_subtype                  0   /* Screen text */
...
#define    UF_mach_dpm_curve_additive_buildup_subtype    1060   /* Curve additive buildup */
#define    UF_mach_dpm_5axis_roughing_subtype            1070   /* 5 Axis Roughing */
#define    UF_mach_dpm_5axis_deburring_subtype           1080   /* 5 Axis Deburring */
#define    UF_mach_dpm_edge_chamfer_subtype              1090   /* Edge Chamfer */
#define    UF_mach_dpm_planar_5xadditive_subtype         1100   /* Planar 5-axis additive with zigzag/zig pattern */
#define    UF_mach_dpm_free_form_track_buildup_additive_subtype   1110   /* Free Form Track Buildup Additive */
#define    UF_mach_dpm_rotary_conical_buildup_additive_subtype    1120   /* Rotary Conical Buildup Additive */
#define    UF_mach_dpm_planar_5xadditive_spiral_subtype           1130   /* Planar 5-axis additive with spiral pattern */
#define    UF_mach_dpm_planar_5xadditive_thinwall_subtype         1140   /* Planar 5-axis additive thinwall */
#define    UF_mach_dpm_rotary_additive_buildup_subtype            1150   /* Rotary Additive Buildup */
#define    UF_mach_dpm_planar_5xadditive_sparse_buildup_subtype   1160   /* Planar 5-axis additive sparse buildup */
#define    UF_mach_dpm_planar_5xadditive_follow_subtype           1170   /* Planar 5-axis additive Follow */
#define    UF_mach_dpm_planar_5xadditive_sparse_shells_subtype    1180   /* Planar 5-axis additive sparse shells */

#define    UF_mach_dpm_zlevel_undercut_subtype           1200   /* Zlevel Undercut */
#define    UF_mach_dpm_swarf_subtype                     1300   /* Swarf */
#define    UF_mach_dpm_rotary_roughing_subtype           1310   /* Rotary Roughing */
#define    UF_mach_dpm_planar_roughing_subtype           1320   /* 3 Axis Roughing */
#define    UF_mach_dpm_facing_subtype                    1330   /* Facing cut area by medial axis path */
#define    UF_mach_dpm_facing_zigzag_subtype             1340   /* Face mill - ZigZag */
#define    UF_mach_dpm_wall_milling_subtype              1350   /* 2D Wall Milling */
#define    UF_mach_dpm_facing_spiral_subtype             1360   /* Face mill - spiral */

#define    UF_mach_dpm_scanner_subtype                   1500   /* Scanner operation */
#define    UF_mach_dpm_additive_preheat_subtype          1510   /* Additive Preheat operation */
#define    UF_mach_dpm_additive_preheat_fixedaxis_subtype  1520   /* Fixed Axis Additive Preheat operation */

#define    UF_mach_dpm_planar_decking_subtype            1600   /* Planar Decking */
...
#define    UF_mach_scanning_laser_mthd_subtype       140   /* Scanning Laser cutting */
...
/*  The following subtypes are only applicable to Synchronous Modeling constraints */
...
#define    UF_same_orbit_constraint_subtype            18
#define    UF_clone_constraint_subtype                 19
#define    UF_rigid_body_face_constraint_subtype       20
...
#define   UF_mechatronics_simulation_record_node_subtype    31 /* Defines an object which stores the simulation record data during a given time period. */
#define   UF_mechatronics_override_speed_motor_subtype      32 /* Defines an override object of speed motor*/
#define   UF_mechatronics_override_position_motor_subtype   33 /* Defines an override object of position motor*/
#define   UF_mechatronics_flexible_material_subtype         34 /* A Flexible Material defines the material property of objects for physics simulation. */
#define   UF_mechatronics_kineo_flexible_material_subtype   35 /* A Kineo Flexible Material defines the material property of objects for kineo simulation. */
...
#define UF_tabular_part_family_table_subtype         44
#define UF_tabular_part_family_table_row_subtype     45
#define UF_tabular_part_family_table_column_subtype  46
...
#define    UF_route_cableway_path_subtype              11  /* Represents a cableway path in a component created using Qualify Part */
...
#define    UF_sheet_boundary_analysis_subtype          17    /* Sheet Boundary Analysis AO*/
#define    UF_modl_sim_subtype                         18    /* Performance Predictor AO */
#define    UF_distance_analysis_subtype                19    /* Distance Analysis AO */
#define    UF_radius_analysis_subtype                  20    /* Radius Analysis AO */
#define    UF_reflection_analysis_subtype              21    /* Reflection Analysis AO */
#define    UF_slope_analysis_subtype                   22    /* Slope Analysis AO */
...
#define    UF_zone_collaboration_notification_subtype                3
#define    UF_zone_collaboration_keep_out_subtype                    4
...
#define    UF_route_capital_bundle_stock_subtype       4  /* Represent a stock on Capital Bundle entity for connection routed in Capital */
...
#define    UF_fam_attr_cofm_subtype                   15
...
#define    UF_sfem_trans_nodes_subtype                 4
...
// <mpw> 23-Aug-2023 Removed obsoleted UF_sfem_mesh_geometry_type
//                   235 is available for future consumption
...
// <jsc> 16-Aug-2023 Removed obsoleted UF_sfem_property_type and UF_sfem_property_name_type
//                   239 and 240 are available for future consumption
