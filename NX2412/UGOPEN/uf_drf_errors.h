...
#define UF_DRF_SYMBOL_INVALID_SYMBOL_PATH       (UF_DRF_ERROR_BASE + 262)
#define UF_DRF_INVALID_USE_OF_API               (UF_DRF_ERROR_BASE + 263)
#define UF_DRF_SYMBOL_OUT_OF_UPDATE             (UF_DRF_ERROR_BASE + 264)
...
/* Image*/
#define UF_DRF_IMAGE_CORRUPT_OBJECT                   (UF_DRF_ERROR_BASE + 468)
