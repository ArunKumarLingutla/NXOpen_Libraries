...
/****************************************************************************
   ...
   Specify data for the 3D tracking point change post command. 

****************************************************************************/ 
struct UF_PATH_tracking_point_change_3D_s 
        {
           double                xoff;
           double                yoff;
           double                zoff;
...
typedef struct UF_PATH_tracking_point_change_3D_s UF_PATH_tracking_point_change_3D_t;
...
(
   ...
   UF_PATH_linear_motion_t *linear_motion_data,  /* <I>
                                              ...
                                              motion
                                              */
   UF_PATH_contact_data_t  *contact_data  /* <I>
                                              Structure specifying the contact 
                                              data
                                              */
);
...
(
   UF_PATH_id_t               path_id,/* <I>
                      Path to perform action on
                      */
   UF_PATH_circular_motion_t *motion_data,  /* <I>
                                              Structure specifying the circular
                                              motion
                                              */
   UF_PATH_contact_data_t    *contact_data  /* <I>
                                              Structure specifying the contact
...
It is useful for 2D tracking points in a lathe tool situation.
The appended text is optional. 
If "text" is NULL then no appended text appears.
...
/*****************************************************************************
This function allows the creation of post command TRACKING POINT CHANGE 3D.
It is useful for 3D tracking points on "L" or star probes in a probing situation.
The appended text is optional. 
If "text" is NULL then no appended text appears.
...
History:
 *****************************************************************************/
extern UFUN_CAMEXPORT int UF_PATH_create_tracking_point_change_3D
(
   UF_PATH_id_t                        path_id,          /* <I> The path id for this event */
   UF_PATH_tracking_point_change_3D_t *tool_change_data  /* <I> Data specifying the tracking point change to make. */
);
...
/*****************************************************************************
This function allows the creation of post command SPINDL/ORIENT. The appended text 
is optional. If "text" is NULL then no appended text appears.
...
History:
 *****************************************************************************/
extern UFUN_CAMEXPORT int UF_PATH_create_spindle_orient(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
double spindle_angle ,/* <I>
...
/*****************************************************************************
This function allows the creation of post command ROTATE_TOOL. The appended text 
is optional. If "text" is NULL then no appended text appears.
...
History:
 *****************************************************************************/
extern UFUN_CAMEXPORT int UF_PATH_create_rotate_tool(
UF_PATH_id_t path_id ,/* <I>
                      The path id for this event
                      */
double tool_angle ,/* <I>
...
/*****************************************************************************
This function allows the creation of an on machine probing cycle start event.
...
History:
 ******************************************************************************/
extern UFUN_CAMEXPORT int UF_PATH_create_omp_cycle_start(
    UF_PATH_id_t path_id,/* <I>
                          The path id for this event
                          */
    const char* text  /* <I>
...
/*****************************************************************************
This function allows the creation of an on machine probing cycle end event.
...
History:
 ******************************************************************************/
extern UFUN_CAMEXPORT int UF_PATH_create_omp_cycle_end(
    UF_PATH_id_t path_id,/* <I>
                          The path id for this event
                          */
    const char* text  /* <I>
                       Extra MOM variables of the form
                       MOM_var_name=value,...
                       */
);
