...
Suppose that you have an Open API program from which you wish
...
UF_UGMGR_tag_t   parentrev_tag , /* <I>
                                    ...
                                    the child revision returned will be based
                                    on revision rule
                                 */
 ...
 *             currently recognized error statuses are:
 *             0  - Success
 *             5  - Invalid File Name
...
/***********************************************************************
Returns an array of all Product Assemblies currently recognized by the
...
/***********************************************************************
Adds a Product Assembly to the list of those recognized by the current
NX Manager session.
...
/***********************************************************************
Removes a Product Assembly from the list of those recognized by the
...
Note : Use the value "EMPTY_DISPLAY_RULE_VALUE" as a valid display rule name 
for resetting the current ID display to the default "Empty (Initial ID Only)".
...
/*****************************************************************************
 ...
 Any other transferable objects upon which  the given objects depend are also moved into the component.
...
extern UFUNEXPORT int UF_UGMGR_resolve_part_file_infos (
    ...
    const UF_UGMGR_part_file_info_t*    partFileInput,         /* <I,len:partFileCount> UF_UGMGR_part_file_info_t's to be resolved*/
