    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  AnalysisObjectCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::GeometricAnalysis::AnalysisObject *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::GeometricAnalysis::AnalysisObject **;
                using reference = NXOpen::GeometricAnalysis::AnalysisObject *&;
            ...
            /** Creates a Section Analysis builder of a new version @return  Section Analysis builder 
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") OR nx_mcd_core ("Mechatronics Concept Designer") */
