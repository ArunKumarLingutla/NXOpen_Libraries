    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistFunctionDefinitionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::DurSpecialistFunctionDefinition *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::DurSpecialistFunctionDefinition **;
                using reference = NXOpen::CAE::DurSpecialistFunctionDefinition *&;
