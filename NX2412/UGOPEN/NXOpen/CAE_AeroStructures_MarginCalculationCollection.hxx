...
#include <NXOpen/CAE_AeroStructures_MultiMarginCalculationBuilder.hxx>
        ...
        namespace AeroStructures
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  MarginCalculationCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::AeroStructures::MarginCalculation *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::AeroStructures::MarginCalculation **;
                    using reference = NXOpen::CAE::AeroStructures::MarginCalculation *&;
                ...
                /** Creates a @link CAE::AeroStructures::MarginCalculationBuilder CAE::AeroStructures::MarginCalculationBuilder@endlink  for duplication @return  Builder object
                 <br>  Created in NX1899.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment") */
                public: NXOpen::CAE::AeroStructures::MarginCalculationBuilder * CreateMarginCalculationBuilderForDuplication
                (
                    NXOpen::CAE::AeroStructures::MarginCalculation * margincalculation /**  the calculation to duplicate */
                );
                /** Creates a @link CAE::AeroStructures::MultiMarginCalculationBuilder CAE::AeroStructures::MultiMarginCalculationBuilder@endlink   @return  Builder object
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment") */
                public: NXOpen::CAE::AeroStructures::MultiMarginCalculationBuilder * CreateMultiMarginCalculationBuilder
                (
                    NXOpen::CAE::AeroStructures::MarginCalculation * margincalculation /** margincalculation */ 
                );
                ...
                /** Makes a copy of the calculation and adds it to the margin solution, adjusting the given name if it is a duplicate  @return The resulting cloned @link NXOpen::CAE::AeroStructures::MarginCalculation NXOpen::CAE::AeroStructures::MarginCalculation@endlink  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment") */
                ...
                (
                    ...
                    const std::vector<NXOpen::CAE::AeroStructures::MarginCalculation *> & calculations /**List of calculations to rename */
                );
                /** Renames calculations in bulk.
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : sc_aero_environment ("Simcenter AeroStructures Environment") */
                ...
                (
                    const std::vector<NXOpen::CAE::AeroStructures::MarginCalculation *> & calculations /**List of calculations to delete */
                );
                ...
                (
                    const std::vector<NXOpen::CAE::AeroStructures::MarginCalculation *> & calculations /**List of calculations to clone */
                );
                ...
                (
                    const std::vector<NXOpen::CAE::AeroStructures::MarginCalculation *> & marginCalculations /** margincalculations */ ,
