...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  BasePart : public NXOpen::NXObject
    {
        ...
        /**
                Closes an open part.
                In contrast to @link NXOpen::BasePart::Close NXOpen::BasePart::Close@endlink , this method will retain the undo mark list.
            
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void CloseRetainUndoMarks
        (
            NXOpen::BasePart::CloseWholeTree wholeTree /** If true, unloads all components of the part.
                        If false, unloads only the top-level part */,
            NXOpen::BasePart::CloseModified closeModified /** Behavior of close if component
        ...
        /** Get the preview image
            ...
            the image width and height and a single array of integer ARGB pixels.  The total number of
            pixels is width * height.  Each 32 bit integer pixel contains 8 bit values for the red,
            green and blue color components and the alpha channel.
            The byte order corresponds to the .NET method System.Drawing.Color.FromArgb, so the order is ARGB.
            For Java the byte order and data corresponds to the BufferedImage type TYPE_INT_ARGB.
            The pixels at an xy location can be found as (y*width+x) where x is from 0 to width-1,
            and y indexes from 0 to height-1. The ARGB pixels can be loaded into an appropriate image
        ...
        (
            ...
            std::vector<int> & pixels /** Array of ARGB pixels  */
        );
        ...
        /** Remove the transient status from the input part before save-as. Should be called when a transient part is being saved-as a NX part file
        ...
        /**Returns  the @link NXOpen::Assemblies::PartitionSchemeManager NXOpen::Assemblies::PartitionSchemeManager@endlink  object associated with this part.        
            
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Assemblies::PartitionSchemeManager * PartitionSchemeManager
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ConfiguredPart *> GetConfiguredParts
        (
        );
        ...
        */
        ...
        /** Returns the UserDefinedTemplate.ConfigurationManager instance belonging to this part 
         <br>  Created in NX2206.0.0.  <br>  
        */
        public: NXOpen::UserDefinedTemplate::ConfigurationManager *ConfigurationManager();
        /** Returns the Post Manager for this part 
         <br>  Created in NX2206.0.0.  <br>  
        */
        public: NXOpen::DesignSimulation::PostManager *PostManager();
        /** Returns the VisualMaterialCollection instance belonging to this part 
         <br>  Created in NX2306.0.0.  <br>  
        */
        public: NXOpen::Display::VisualMaterialCollection *VisualMaterialCollection();
    };
}
