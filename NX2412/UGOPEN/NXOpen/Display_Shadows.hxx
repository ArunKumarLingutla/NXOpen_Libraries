...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /**
            ...
            return NULL. <br> 
             <br> To create a new instance of this class, use @link NXOpen::ViewCollection::CreateShadowsForDisplayStyle  NXOpen::ViewCollection::CreateShadowsForDisplayStyle @endlink  <br> 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  Shadows : public NXOpen::Builder
        {
            ...
            /**Returns  the Ground Shadow in Shaded View 
             ...
             <br> License requirements : None */
            public: bool ShadowsShadedViewsShowGroundShadows
            (
            );
            /**Sets  the Ground Shadow in Shaded View 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetShadowsShadedViewsShowGroundShadows
            (
                bool enableShadows /** enableshadows */ 
            );
            ...
            /**Returns  the display style whose shadows is being modified. Shaded and Studio have independent shadows settings.
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
