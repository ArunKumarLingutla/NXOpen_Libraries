...
#include <NXOpen/CAE_CyclicSymmetricStageProperties.hxx>
#include <NXOpen/CAE_ElementTypes.hxx>
#include <NXOpen/CAE_PointInterpolationData.hxx>
#include <NXOpen/CAE_PostEnvironmentsManager.hxx>
#include <NXOpen/CAE_PostGraph.hxx>
#include <NXOpen/CAE_PostProc_ResultModel.hxx>
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class CyclicSymmetricStageProperties;
    }
    namespace CAE
    {
    ...
    namespace CAE
    {
        ...
        /**
             <br> 
            This class provides interfaces to query analysis results which include spatial results and function results.

            <br/>Function results are divided into function result types. Function result types are obstained by using @link NXOpen::CAE::ResultManager::GetFunctionResultTypes NXOpen::CAE::ResultManager::GetFunctionResultTypes@endlink .

            <br/>To query spatial results you must first understand how the results are structured.  The basic structure is as follows
            <ul>
                <li>Load case</li>
                <ul>
                    <li>Iteration</li>
            ...
            <br/>Spatial results are divided into Load Cases(loadcase). Loadcase is a general term which could representand of the follow based on solution type
            <ul>
            ...
            <ol>
             ...
             <br> 
            A Result type may also be defined on Plies. All the plies would be represented under the Result type and the resul structure would be as follows
            <ul>
                <li>Load case</li>
                <ul>
                    <li>Iteration</li>
            ...
            Plies within a result type can be obtained by using @link NXOpen::CAE::BaseResultType::AskPlies NXOpen::CAE::BaseResultType::AskPlies@endlink .
             <br> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  Result : public NXOpen::NXObject
        {
            ...
            public: enum Quantity
            {
                ...
                QuantitySpringDashpotResultantsLevelCrossingRate/** Deprecated */,
                ...
                QuantitySpringDashpotStrainResultantsLevelCrossingRate/** Deprecated */,
                ...
                QuantityRootMeanSquareSpringDashpotResultant/** Deprecated */,
                ...
                QuantityZeroCrossingsSpringDashpotResultant/** Deprecated */,
                ...
                QuantityPlasticElemResultantStrainSpringDashpot/** Deprecated */,
                ...
                QuantityElasticElemResultantStrainSpringDashpot/** Deprecated */,
                ...
                QuantityThermalElemResultantStrainSpringDashpot/** Deprecated */,
                ...
                QuantityElemResultantStrainCreepSpringDashpot/** Deprecated */,
                ...
                QuantityElemResultantCreepSpringDashpot/** Deprecated */,
                ...
                QuantityRootMeanSquareSpringDashpotStrainResultant/** Deprecated */,
                QuantityZeroCrossingsSpringDashpotStrainResultant/** Deprecated */,
                ...
                QuantityNonLinearSpringDashpotResultant/** Deprecated */,
                QuantityDiffusionResistance/** diffusion resistance */ ,
                QuantityAerea/** aerea */ ,
                QuantityFatigueStrengthCoeff/** fatigue strength coeff */ ,
                QuantityThermalExpansionCoeff/** thermal expansion coeff */ ,
                QuantityMassMomentInertia/** mass moment inertia */ ,
                QuantityFrequency/** frequency */ ,
                QuantityMomentOfInertiaArea/** moment of inertia area */ ,
                QuantityViscousDamping/** viscous damping */ ,
                QuantityEnergy/** energy */ ,
                QuantityMomentum/** momentum */ ,
                QuantityTransmissionLoss/** transmission loss */ ,
                QuantitySpecificHeat/** specific heat */ ,
                QuantityProbability/** probability */ ,
                QuantityDirCos/** dir cos */ ,
                QuantityTotalDamage/** total damage */ ,
                QuantityElementDisplacement/** element displacement */ ,
                QuantityConvectiveAreaFactor/** convective area factor */ ,
                QuantityConvectiveThickness/** convective thickness */ ,
                QuantityMaxPrincipalPeakStress/** max principal peak stress */ ,
                QuantityMinPrincipalPeakStress/** min principal peak stress */ ,
                QuantityMaxPrincipalPeakStrain/** max principal peak strain */ ,
                QuantityMinPrincipalPeakStrain/** min principal peak strain */ ,
                QuantityUserdefined/** userdefined */ ,
                QuantityExpression/** expression */ ,
                QuantitySpecificEnthalpy/** specific enthalpy */ ,
                QuantityXVelocity/** xvelocity */ ,
                QuantityYVelocity/** yvelocity */ ,
                QuantityZVelocity/** zvelocity */ ,
                QuantityLevelCrossingRateXVelocity/** level crossing rate xvelocity */ ,
                QuantityLevelCrossingRateYVelocity/** level crossing rate yvelocity */ ,
                QuantityLevelCrossingRateZVelocity/** level crossing rate zvelocity */ ,
                QuantityLevelCrossingRateXAngularVelocity/** level crossing rate xangular velocity */ ,
                QuantityLevelCrossingRateYAngularVelocity/** level crossing rate yangular velocity */ ,
                QuantityLevelCrossingRateZAngularVelocity/** level crossing rate zangular velocity */ ,
                QuantityHomogYoungModulus/** homog young modulus */ ,
                QuantityHomogPoissonRatio/** homog poisson ratio */ ,
                QuantityHomogShearModulus/** homog shear modulus */ ,
                QuantityHomogTexpCoef/** homog texp coef */ ,
                QuantityHomogChemShrinkage/** homog chem shrinkage */ ,
                QuantityFractionFiberVolume/** fraction fiber volume */ ,
                QuantityPressureCoefficient/** pressure coefficient */ ,
                QuantityForce/** force */ ,
                QuantityMoment/** moment */ ,
                QuantityTotalStrain/** total strain */ ,
                QuantitySolarPressure/** solar pressure */ ,
                QuantitySPCMoment/** spcmoment */ ,
                QuantityEquivalentElasticStrain/** equivalent elastic strain */ ,
                QuantityFraction/** fraction */ ,
                QuantityVolumeAcceleration/** volume acceleration */ ,
                QuantityNodeProximityToCad/** node proximity to cad */ ,
                QuantityTorue/** torue */ ,
                QuantityMagneticFluxFunction/** magnetic flux function */ ,
                QuantityVolumeForceDensity/** volume force density */ ,
                QuantityVolumeLossDensity/** volume loss density */ ,
                QuantityVolumeTorqueDensity/** volume torque density */ ,
                QuantityNodalTroqueDensityLength/** nodal troque density length */ ,
                QuantityNodalTorque/** nodal torque */ ,
                QuantityElectricalConductivity/** electrical conductivity */ ,
                QuantityPermeanceCoefficient/** permeance coefficient */ ,
                QuantityRelativePermeability/** relative permeability */ ,
                QuantityRelativeReluctivity/** relative reluctivity */ ,
                QuantitySkinDepth/** skin depth */ ,
                QuantityDemagnetization/** demagnetization */ ,
                QuantityDemagnetizationPrediction/** demagnetization prediction */ ,
                QuantityContactSlidingDistance/** contact sliding distance */ ,
                QuantityZeroCrossingsVonMisesStress/** zero crossings von mises stress */ ,
                QuantityReverberationTime/** reverberation time */ ,
                QuantityEarlyDecayTime/** early decay time */ ,
                QuantityDirectArrivalTime/** direct arrival time */ ,
                QuantityClarityIndex/** clarity index */ ,
                QuantitySpeechDefinition/** speech definition */ ,
                QuantitySpeechTransmissionIndex/** speech transmission index */ ,
                QuantityInterauralXCorrelation/** interaural xcorrelation */ ,
                QuantityForcePerVolume/** force per volume */ ,
                QuantityDistance/** distance */ ,
                QuantitySpringDashpotResultantForce/** spring dashpot resultant force */ ,
                QuantitySpringDashpotResultantMoment/** spring dashpot resultant moment */ ,
                QuantitySpringDashpotResultantStrain/** spring dashpot resultant strain */ ,
                QuantitySpringDashpotResultantTwist/** spring dashpot resultant twist */ ,
                QuantityConversionTime/** conversion time */ ,
                QuantityConversionStatus/** conversion status */ ,
                QuantityTotalHeatFlow/** total heat flow */ ,
                QuantityStrainRate/** strain rate */ ,
                QuantityStrainMechVonMises/** strain mech von mises */ 
            };
            ...
            public: enum DataType
            {
                ...
                DataTypeElementResultantSpringDashpot/**No longer used by any result */,
            ...
            public: enum Component
            {
                ...
                ComponentSpringDashpotForce/** No longer used; it means @link NXOpen::CAE::Result::ComponentX NXOpen::CAE::Result::ComponentX@endlink  in new format */,
                ComponentSpringDashpotForceX/** No longer used; it means @link NXOpen::CAE::Result::ComponentX NXOpen::CAE::Result::ComponentX@endlink  in new format */,
                ComponentSpringDashpotForceY/** No longer used; it means @link NXOpen::CAE::Result::ComponentY NXOpen::CAE::Result::ComponentY@endlink  in new format */,
                ComponentSpringDashpotForceZ/** No longer used; it means @link NXOpen::CAE::Result::ComponentZ NXOpen::CAE::Result::ComponentZ@endlink  in new format */,
                ComponentSpringDashpotMomentX/** No longer used; it means @link NXOpen::CAE::Result::ComponentX NXOpen::CAE::Result::ComponentX@endlink  in new format */,
                ComponentSpringDashpotMomentY/** No longer used; it means @link NXOpen::CAE::Result::ComponentY NXOpen::CAE::Result::ComponentY@endlink  in new format */,
                ComponentSpringDashpotMomentZ/** No longer used; it means @link NXOpen::CAE::Result::ComponentZ NXOpen::CAE::Result::ComponentZ@endlink  in new format */,
                ...
                ComponentVectorResultantXY/** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants. */,
                ComponentVectorResultantYZ/** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants.*/,
                ComponentVectorResultantXZ/** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants.*/,
                ComponentMinimumPrincipal2D/** The tensor component is restricted for use. Kindly turn on the customer EAF - Enable2DTensorInvariants for using it.*/,
                ComponentMaximumPrincipal2D/** The tensor component is restricted for use. Kindly turn on the customer EAF - Enable2DTensorInvariants for using it.*/,
                ComponentMaximumShear2D/** The tensor component is restricted for use. Kindly turn on the customer EAF - Enable2DTensorInvariants for using it.*/
            };
            ...
            public: enum Complex
            {
                ...
                ComplexMaxOverPhase/** max over phase */ 
            };
            ...
            public: enum CoordinateSystem
            {
                ...
                CoordinateSystemGlobalCyclicAnalysis/** global cyclic analysis */ 
            };
            ...
            public: enum ElementValueCriterion
            {
                ...
                ElementValueCriterionAbsoluteMaximum/** absolute maximum */ ,
                ElementValueCriterionAbsoluteMinimum/** absolute minimum */ ,
                ElementValueCriterionSignedAbsoluteMaximum/** signed absolute maximum */ ,
                ElementValueCriterionSignedAbsoluteMinimum/** signed absolute minimum */ 
            };
            ...
            public: enum ComputationType
            {
                ...
                ComputationTypeSignedAbsoluteMinimum/** Absolute minimum among the set of values */,
                ComputationTypeSignedAbsoluteMaximum/** Absolute maximum among the set of values */
            };
            ...
            {
                ModalResultTypeModalDisplacement/** modal displacement */ ,
                ModalResultTypeModalForce/** modal force */ ,
                ModalResultTypeModalVelocity/** modal velocity */ ,
                ModalResultTypeModalAccelaration/** modal accelaration */ 
            };

            /** Complex format options */
            public: enum ComplexFormat
            {
                ComplexFormatRealOnly/** real only */ ,
                ComplexFormatRealImaginary/** real imaginary */ ,
                ComplexFormatAmplitudePhase/** amplitude phase */ 
            };
            ...
            */
            ...
            public: enum Filetype
            {
                ...
                FiletypeLmsMotionFlexible/** lms motion flexible */ ,
                FiletypeScH5/** sc h5 */ ,
                FiletypeScd5/** scd5 */ ,
                FiletypeMappedOnModel/** mapped on model */ 
            };
            ...
            /** Ply locations - Middle, Top and bottom. Bitwise combination of the enums will give the combination of locations */
            public: enum PlyLocation
            {
                PlyLocationMiddle/** middle */  = 1,
                PlyLocationTop/** top */ ,
                PlyLocationBottom/** bottom */  = 4
            };

            /** Shell sections */
            public: enum ShellSection
            {
                ShellSectionNotApplicable/** not applicable */ ,
                ShellSectionTop/** top */ ,
                ShellSectionBottom/** bottom */ ,
                ShellSectionMiddle/** middle */ ,
                ShellSectionSignedAbsoluteMinimum/**  Signed Absolute minimum */,
                ShellSectionSignedAbsoluteMaximum/**  Signed Absolute maximum */,
                ShellSectionAverage/** average */ ,
                ShellSectionTopBot/** top bot */ ,
                ShellSectionBending/** bending */ ,
                ShellSectionAbsoluteMinimum/**  Absolute minimum */,
                ShellSectionAbsoluteMaximum/**  Absolute maximum */,
                ShellSectionTrueMinimum/**  Minimum */,
                ShellSectionTrueMaximum/**  Maximum */,
                ShellSectionMinimum/**  for legacy use only */,
                ShellSectionMaximum/**  for legacy use only */
            };

            /** Beam sections */
            public: enum BeamSection
            {
                BeamSectionNotApplicable/** not applicable */ ,
                BeamSectionStressRecoveryPointC/** stress recovery point c */ ,
                BeamSectionStressRecoveryPointD/** stress recovery point d */ ,
                BeamSectionStressRecoveryPointE/** stress recovery point e */ ,
                BeamSectionStressRecoveryPointF/** stress recovery point f */ ,
                BeamSectionMinimum/** minimum */ ,
                BeamSectionMaximum/** maximum */ 
            };

            /** The enum for result component of cyclic results. */
            public: enum CyclicResultComponent
            {
                CyclicResultComponentNone/** none */ ,
                CyclicResultComponentCosine/** cosine */ ,
                CyclicResultComponentSine/** sine */ 
            };
            ...
            /** Asks for the elements connected to given node
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void AskNodeElements
            (
                int nodeIndex /** nodeindex */ ,
                std::vector<int> & elementIndices /** elementindices */ 
            );
            ...
            /** Ask node indices of given node user labels   @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            ...
            /** Ask element indices of given element user labels   @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<int> AskElementIndices
            (
                const std::vector<int> & elementLabels /** elementlabels */ 
            );
            ...
            /** Ask node user labels of given node indices   @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<int> AskNodeLabels
            (
                const std::vector<int> & nodeIndices /** node index ranges from 1 to N (number of nodes) */
            );
            ...
            /** Ask element user labels of given element indices   @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<int> AskElementLabels
            (
                const std::vector<int> & elementIndices /** element index ranges from 1 to N (number of elements) */
            );
            ...
            /** Returns all the plies for the result (in the model) 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void AskAllPliesInModel
            (
                std::vector<int> & plyIDs /** plyids */ 
            );
            /** Returns manager of cache result types objects. @return  
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::CacheResultRecipeManager * GetCacheResultRecipeManager
            (
            );
            /** Gets the environment definition to the result, infer or user-defined  @return   
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostEnvironmentsManager::DefinitionType GetEnvironmentDefinition
            (
            );
            /** Sets the environment definition to the result, infer or user-defined 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetEnvironmentDefinition
            (
                NXOpen::CAE::PostEnvironmentsManager::DefinitionType definition /** definition */ 
            );
            /** Gets the environment type of the current result.  @return   
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostEnvironmentsManager::PostEnvironment GetEnvironmentType
            (
            );
            /** Sets the environment type to the result, standard or acoustic 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetEnvironmentType
            (
                NXOpen::CAE::PostEnvironmentsManager::PostEnvironment environmentType /** environmenttype */ 
            );
            /** Gets the post mesh collector. This method gives top level mesh collector object.
                        Iterate recursively over this object to get the post mesh collectors in hierarchy
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostMeshCollector * GetPostMeshCollector
            (
            );
            /** Get Cyclic Symmetric Stages 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void GetCyclicSymmetricStages
            (
                std::vector<NXOpen::CAE::CyclicSymmetricStageProperties *> & stages /** stages */ 
            );
            /** Gets the post mesh collector. Pass correct mesh fid. 
                        This method gives top level mesh collector object.
                        Iterate recursively over this object to get the post mesh collectors in hierarchy
                        Get result type from to get file ids.
                        
             <br>  @deprecated Deprecated in NX2312.0.0.  There is no replacement for this method, We are not using meshfid. <br>  

             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  There is no replacement for this method, We are not using meshfid.") NXOpen::CAE::PostMeshCollector * GetPostMeshCollectorFromMeshfid
            (
                int meshfid /** meshfid */ 
            );
            /** Name of groups available in the result file.  @return  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<NXString> AskUserGroups
            (
            );
            /** Ask list of @link NXOpen::CAE::PointInterpolationData NXOpen::CAE::PointInterpolationData@endlink  from list of @link NXOpen::Point3d NXOpen::Point3d@endlink  which can be used in @link NXOpen::CAE::ResultAccess NXOpen::CAE::ResultAccess@endlink  to get interpolated result value
                     <br/>Order of list of @link NXOpen::CAE::PointInterpolationData NXOpen::CAE::PointInterpolationData@endlink  will be same as input list of @link NXOpen::Point3d NXOpen::Point3d@endlink  @return  Out list of @link NXOpen::CAE::PointInterpolationData NXOpen::CAE::PointInterpolationData@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<NXOpen::CAE::PointInterpolationData *> AskElementAtLocations
            (
                const std::vector<NXOpen::Point3d> & locations /** Input List of @link NXOpen::Point3d NXOpen::Point3d@endlink */,
                const std::vector<int> & inputElements /** Optional, input list of element index which will be used to find element index around point, if empty list is provided all elements will be considered */
            );
            /** Get the graph from its name
             <br>  Created in NX2206.4000.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::PostGraph * GetGraph
            (
            ...
            /** Get the graph from its name
             <br>  Created in NX2206.4000.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            NXOpen::CAE::PostGraph * GetGraph
            (
                const char * resultName /** resultname */ 
            );
            /** Ask number and objects of Result Models available in the result file @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<NXOpen::CAE::PostProc::ResultModel *> AskResultModels
            (
            );
            /** Ask basic units of result, the units are returned in the order: mass, length, time, temperature and angle  @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<NXOpen::Unit *> AskBasicUnits
            (
            );
        };
    }
