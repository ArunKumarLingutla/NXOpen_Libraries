        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmTransfer : public NXOpen::TaggedObject
        {
            ...
            public: enum TransferTypes
            {
                ...
                TransferTypesRelativePlane/** Relative Plane */
            };
            ...
            /**Returns  the kinematics based transition 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: bool KinematicsBasedTransition
            (
            );

            /// \cond NX_NO_DOC 
            /**Sets  the kinematics based transition 
             <br>  Created in NX9.0.3.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetKinematicsBasedTransition
            (
                bool kinematicsBasedTransition /** kinematicsbasedtransition */ 
            );
