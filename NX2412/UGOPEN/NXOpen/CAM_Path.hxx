    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  Path : public NXOpen::TaggedObject
        {
            ...
            /** Robot rules status states. */
            public: enum RobotRulesStatusStates
            {
                RobotRulesStatusStatesUnchanged/** unchanged */ ,
                RobotRulesStatusStatesChanged/** changed */ ,
                RobotRulesStatusStatesRegenerate/** regenerate */ ,
                RobotRulesStatusStatesRegenerated/** regenerated */ 
            };
            ...
            /** Returns an array of finding types in the path
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void GetAllFindingTypes
            (
                std::vector<NXOpen::CAM::Path::FindingTypes> & findingTypes /** findingtypes */ 
            );
            /** Returns arrays of the finding start and the finding end events for a given finding type in the path 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void GetFindingStartEndEvents
            (
                NXOpen::CAM::Path::FindingTypes type /** type */ ,
                std::vector<NXOpen::CAM::PathEvent *> & startEvents /** Returns the array of Finding Start Events */,
                std::vector<NXOpen::CAM::PathEvent *> & endEvents /** Returns the array of Finding End Events */
            );
            /**Returns the robot rules status 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::Path::RobotRulesStatusStates RobotRulesStatus
            (
            );
            /**Sets the robot rules status 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetRobotRulesStatus
            (
                NXOpen::CAM::Path::RobotRulesStatusStates status /** status */ 
            );
            ...
            /** Copy an event and place it as specified
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::PathEvent * CopyEvent
            (
                NXOpen::CAM::PathEvent * eventToCopy /** eventtocopy */ ,
                NXOpen::CAM::CamPathToolpathEventLocation location /** location */ ,
                NXOpen::CAM::PathEvent * referenceEvent /** referenceevent */ 
            );
            /** Get reference data
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::PathOwnerData * GetReferenceData
            (
            );
            /** Has subpath
             <br>  Created in NX2007.0.0.  <br>  
            ...
            /** Get subpath data
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::PathOwnerData * GetSubPathData
            (
                NXOpen::CAM::PathEvent * forEvent /** forevent */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: std::vector<NXString> GetMotionColors
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetEvaluatorData
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetEvaluatorDataWithRange
            (
