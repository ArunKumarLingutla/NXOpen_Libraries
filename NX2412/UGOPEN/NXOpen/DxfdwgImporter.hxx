...
namespace NXOpen
{
    ...
    ImportPolylineTo </term> <description> 
     
    Splines </description> </item> 
    ...
    ModelScaleFactor </term> <description> 
    ...
    ProcessingOrder </term> <description> 
     
    Alphabetical </description> </item> 
    ...
    SameAsTemplate </description> </item> 

    </list> 

     <br>  Created in NX6.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  DxfdwgImporter : public NXOpen::BaseImporter
    {
        /** Import To option */
        ...
        public: enum UnitsEnum
        {
            ...
            UnitsEnumMicrometer/** units micrometers */,
            UnitsEnumMeter/** units meters */
        };
        ...
        public: enum SendModelDataAs
        {
            ...
            SendModelDataAsNewDrawingSheet/** send model data to New drawing sheet, specific for Import to Work part*/,
            SendModelDataAsSelectedDrawingSheet/** send model data to Selected drawing sheet, specific for Import to Work part */
        };
        ...
        public: enum ImportBlocksAs
        {
            ...
            ImportBlocksAsDisplayInstance/** Convert blocks as Display Instance */
        };
        ...
        public: enum FacetImportAs
        {
            FacetImportAsJt/** JT facets */,
            FacetImportAsConvergent/** Convergent bodies */
        };
        ...
        /**Returns  the DXFDWG Facet Import  Option - set import Face3D entities option as either JT facets or Convergent bodies
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::DxfdwgImporter::FacetImportAs FacetImport
        (
        );
        /**Sets  the DXFDWG Facet Import  Option - set import Face3D entities option as either JT facets or Convergent bodies
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        public: void SetFacetImport
        (
            NXOpen::DxfdwgImporter::FacetImportAs workflow /** workflow */ 
        );
        /**Returns  the Drawing Sheet Name to Import Model Data - sets the drawing sheet name for import of DXF/DWG Model Data to work part 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: NXString DrawingSheetNametoImportModelData
        (
        );
        /**Sets  the Drawing Sheet Name to Import Model Data - sets the drawing sheet name for import of DXF/DWG Model Data to work part 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: void SetDrawingSheetNametoImportModelData
        (
        ...
        /**Sets  the Drawing Sheet Name to Import Model Data - sets the drawing sheet name for import of DXF/DWG Model Data to work part 
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        void SetDrawingSheetNametoImportModelData
        (
