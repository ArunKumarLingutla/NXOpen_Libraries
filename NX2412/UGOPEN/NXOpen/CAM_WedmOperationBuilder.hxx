...
#include <NXOpen/CAM_BoundaryInnerWireEDM.hxx>
#include <NXOpen/CAM_BoundaryWireEDM.hxx>
        ...
        */
        class NXOPENCPP_CAMEXPORT  WedmOperationBuilder : public NXOpen::CAM::OperationBuilder
        {
            ...
            */
            ...
            {
                InPathUdeSetTypesStart/** in path ude set at start */ = 1,
            ...
            /**Returns  the wedm boundary  
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::BoundaryWireEDM * Boundary
            (
            );
            /**Returns  the inner wedm boundary 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::BoundaryInnerWireEDM * InnerBoundary
            (
            );
        };
    }
