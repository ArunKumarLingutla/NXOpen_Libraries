...
namespace NXOpen
{
    ...
    */
    class NXOPENUICPPEXPORT  UI : public NXOpen::TaggedObject
    {
        ...
        /** Gets the singleton for @link NXOpen::UI NXOpen::UI@endlink */
        ...
        /** Creates a @link NXOpen::Gateway::ImageExportBuilder NXOpen::Gateway::ImageExportBuilder@endlink  
         <br>  @deprecated Deprecated in NX2007.0.0.  Use @link NXOpen::ViewCollection::CreateImageExportBuilder  NXOpen::ViewCollection::CreateImageExportBuilder @endlink  instead. <br>  

         <br>  Created in NX12.0.1.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use NXOpen::ViewCollection::CreateImageExportBuilder  instead.") NXOpen::Gateway::ImageExportBuilder * CreateImageExportBuilder
        (
        );
        ...
        /** the NXMessageBox for the current session. 
         <br>  Created in NX3.0.0.  <br>  
        */
        ...
        */
        ...
        /// \endcond 
        /** Returns a @link BlockStyler::DialogTester BlockStyler::DialogTester@endlink  object useful for testing Block UI Styler dialogs and it's events. 
         <br>  Created in NX2206.0.0.  <br>  
        */
        public: NXOpen::BlockStyler::DialogTester *DialogTester();
    };
}
