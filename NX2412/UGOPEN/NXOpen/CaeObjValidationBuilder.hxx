...
namespace NXOpen
{
    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  CaeObjValidationBuilder : public NXOpen::Builder
    {
        ...
        {
            ValidationTypeAutoLbcRecipes/** Auto Lbc Recipes */,
            ValidationTypeConstraintSet/** Constraint Sets */,
            ValidationTypeConstraints/** Constraints */,
            ValidationTypeCoordinateSystems/** Coordinate Systems */,
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void ValidateCoordinateSystem
        (
            NXOpen::CoordinateSystem * csysTag /**Coordinate System*/
        );
