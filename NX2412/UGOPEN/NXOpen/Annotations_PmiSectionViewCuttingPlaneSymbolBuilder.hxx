        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiSectionViewCuttingPlaneSymbolBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the name view from symbol 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::PmiSectionViewCuttingPlaneSymbolBuilder::ViewNameFormatOption ViewNameFormat
            (
            );
            ...
            (
                NXOpen::Annotations::PmiSectionViewCuttingPlaneSymbolBuilder::ViewNameFormatOption viewNameFormat /** viewnameformat */ 
            );
            ...
            /**Returns  the size based on section cut for cutting plane symbol 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool SizeBasedOnSectionCut
            (
            );
            /**Sets  the size based on section cut for cutting plane symbol 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            /**Returns  the margin percentage for cutting plane symbol 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: double MarginPercentage
            (
            );
            /**Sets  the margin percentage for cutting plane symbol 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
