    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  ShipDebugSession
    {
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void MaterialEstimation
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: void StructureXmlimport
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: NXOpen::ShipBaseValidator * CreateShipAssociativeMirrorValidator
        (
            NXOpen::BasePart * rootPart /**  root part */,
            const std::vector<NXOpen::BasePart *> & parts /** parts to be validate*/
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void SerializeConfigurableReportInfo
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ShipBaseValidator * CreateShipCompartmentValidator
        (
            NXOpen::BasePart * displayPart /** part being validated */
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: void PopulateCompartmentValidators
        (
            NXOpen::ShipBaseValidator * mainValidator /** main ship validator */,
            std::vector<NXOpen::ShipBaseValidator *> & validators /** created validators */
        );
