    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LayoutStateApplicator : public NXOpen::Builder
        {
            ...
            /** Sets the refresh data flag. If true, the data referenced by layout state is refreshed during the commit method.
                    Otherwise, the layout state display is simply restored (reusing the existing display). 
            ...
            /** Gets the refresh data flag. If true, the data referenced by layout state is refreshed during the commit method.
                    Otherwise, the layout state display is simply restored (reusing the existing display). 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Returns true is restoring of the display is considered as successful.
                    Should be called after the call of commit
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool IsSuccessfullyApplied
            (
            );
