...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  LayoutCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::Layout *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Layout **;
            using reference = NXOpen::Layout *&;
        ...
        /**Returns  the current layout of the part.
                When in the drafting application and a drawing sheet is not displayed,
                this will return a layout that has limited operations that can be 
                performed on it.
