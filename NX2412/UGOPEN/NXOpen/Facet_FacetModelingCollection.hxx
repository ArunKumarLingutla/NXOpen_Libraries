        ...
        */
        class NXOPENCPP_FACETEXPORT  FacetModelingCollection
        {
            ...
            /** Creates a @link NXOpen::Facet::ConvertFacetBodyBuilder NXOpen::Facet::ConvertFacetBodyBuilder@endlink  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR nx_masterfem ("Finite Element Modeling") OR nx_polygon_modeling (" NX Polygon Modeling") */
            ...
            /** Creates a @link NXOpen::Facet::CleanupFacetBodyWizardBuilder NXOpen::Facet::CleanupFacetBodyWizardBuilder@endlink  
             ...
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR nx_polygon_modeling (" NX Polygon Modeling") */
            public: NXOpen::Facet::CleanupFacetBodyWizardBuilder * CreateCleanupFacetBodyWizardBuilder
            (
            );
            /** Creates a @link NXOpen::Facet::SculptMeshBuilder NXOpen::Facet::SculptMeshBuilder@endlink  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_polygon_modeling (" NX Polygon Modeling") */
            public: NXOpen::Facet::SculptMeshBuilder * CreateSculptMeshBuilder
            (
            );
