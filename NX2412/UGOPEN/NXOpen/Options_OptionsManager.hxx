...
namespace NXOpen
{
    ...
    namespace Options
    {
        ...
        enum OptionsScope
        {
            OptionsScopePart/** Option scope is part */,
            OptionsScopeSession/** Option scope is session */
        };
        ...
        */
        class NXOPENCPP_OPTIONSEXPORT  OptionsManager
        {
            ...
            /** Returns scope of an option.
             ...
             <br> License requirements : None */
            public: NXOpen::Options::OptionsScope GetScope
            (
                const NXString & name /** Option name */
            );
            /** Returns scope of an option.
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Options::OptionsScope GetScope
            (
                const char * name /** Option name */
            );
