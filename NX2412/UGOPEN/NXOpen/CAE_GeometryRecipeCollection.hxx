    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  GeometryRecipeCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::GeometryRecipe *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::GeometryRecipe **;
                using reference = NXOpen::CAE::GeometryRecipe *&;
            ...
            /** Creates a @link NXOpen::CAE::GeometryRecipeCollection NXOpen::CAE::GeometryRecipeCollection@endlink  instance.
             <br>  Created in NX10.0.0.  <br>  
