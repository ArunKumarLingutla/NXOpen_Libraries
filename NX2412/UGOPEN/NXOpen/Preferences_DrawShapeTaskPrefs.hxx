        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  DrawShapeTaskPrefs
        {
            ...
            /**Returns  the option to trim at symmetry plane. 
             ...
             <br> License requirements : None */
            public: bool TrimAtSymmetryPlane
            (
            );
            /**Sets  the option to trim at symmetry plane. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_draw_shape (" NX Draw Shape Functionality") */
            public: void SetTrimAtSymmetryPlane
            (
                bool isTrimAtSymmetryPlane /** istrimatsymmetryplane */ 
            );
            /**Returns  the option to be tangent at symmetry plane. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool TangentAtSymmetryPlane
            (
            );
            /**Sets  the option to be tangent at symmetry plane. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_draw_shape (" NX Draw Shape Functionality") */
            public: void SetTangentAtSymmetryPlane
            (
                bool isTangentAtSymmetryPlane /** istangentatsymmetryplane */ 
            );
