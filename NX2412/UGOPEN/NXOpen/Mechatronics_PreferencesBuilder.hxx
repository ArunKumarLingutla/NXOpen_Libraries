    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  PreferencesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option determines whether to create a ground to prevent collision bodies from falling indefinitely due to gravity 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool EnableGroundSupport
            (
            );
            /**Sets  the option determines whether to create a ground to prevent collision bodies from falling indefinitely due to gravity 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetEnableGroundSupport
            (
                bool enableGroundSupport /** enablegroundsupport */ 
            );
            /**Returns  the offset of the ground from the origin along the direction of gravity. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: NXOpen::Expression * GroundOffsetExpression
            (
            );
            ...
            /**Returns  the disable relative breaking offset option 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool UseRelativeBreakingOffset
            (
            );
            /**Sets  the disable relative breaking offset option 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetUseRelativeBreakingOffset
            (
                bool useRelOffset /** usereloffset */ 
            );
            ...
            /**Returns  the web sensor highlight.
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: bool WebSensorHighlight
            (
            );
            /**Sets  the web sensor highlight.
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void SetWebSensorHighlight
            (
                bool show /** show */ 
            );
            /**Returns  the instance operator highlight.
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool InstanceOperatorHighlight
            (
            );
            /**Sets  the instance operator highlight.
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetInstanceOperatorHighlight
            (
                bool show /** show */ 
            );
