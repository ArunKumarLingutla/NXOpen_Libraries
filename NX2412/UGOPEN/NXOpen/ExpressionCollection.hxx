...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ExpressionCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::Expression *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Expression **;
            using reference = NXOpen::Expression *&;
        ...
        /** Create an expression of a given type  @return  The newly created expression 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Expression * NewExpression
        (
            const NXString & dataType /** The data type of the expression 
                                                                Must be one of "Number", "String", "Boolean", "Integer", "Point", "Vector" or "List"). */,
            const NXString & expressionString /** The expression as a string.
                                                                This string must have the following format: "name = formula".
                                                                The value of this formula, when calculated, must be of the given data type.
                                                                The units of this formula, when calculated, but be compatible with the given units (if applicable) */,
            NXOpen::Unit * units /** The display units. May be NULL.
                                                                Used only for Number, Point, Vector and List expressions. Otherwise ignored. */,
            bool trulyUnitless /** The values of this expression are truly unitless.
                                                                Used only for Number, Point, Vector and List expression. Otherwise ignored.
                                                                Used then only when the expression's units are set to NULL. Otherwise ignored.
                                                                The formula's value, when calculated, must be unitless.
                                                                Generally, unitless values are compatible with values of any dimension. This is not true for
                                                                truly unitless values, which:
                                                                  a. Cannot be used in other expressions to be added to values that have non-vanishing dimensionality.
                                                                  b. Cannot be used in other expressions to be subtracted from values that have non-vanishing dimensionality.
                                                                  c. Cannot be referenced by non-expression objects which expect to reference a expression with non-vanishing dimensionality.
                                                                  d. Greatly increases robustness of workflows which require unit conversion.
                                                                Recommended whenever possible. */,
            bool systemExpression /** The expression is a system expression.
                                                                If true, the expression should be referenced by an object, such as a sketch. 
                                                                System expressions are deleted when the referencing object is deleted. */
        );
        /** Create an expression of a given type  @return  The newly created expression 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Expression * NewExpression
        (
            const char * dataType /** The data type of the expression 
                                                                Must be one of "Number", "String", "Boolean", "Integer", "Point", "Vector" or "List"). */,
        ...
        /** Creates an expression, specifying the type.
                The calculated units of the formula must be compatible
                with the given units for the expression. A unitless expression may be created
                by setting the units to NULL. In that case, the formula should also be a unitless number.

                Point and Vector expressions can be specified with units. See expression dialog for available units.
             @return  the new expression 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Expression * CreateExpressionWithUnit
        (
            const NXString & expressionType /** The type of the expression, such as "Number", "String", "Boolean", "Integer", "Point" and "Vector" */,
            const NXString & expressionString /** The expression as a string.  Must be in the format: "name = formula".
                                               For example, "x = 1.2 * y + z". */,
        ...
        /** Creates an expression, specifying the type.
         ...
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Expression * CreateExpressionWithUnit
        (
            const char * expressionType /** The type of the expression, such as "Number", "String", "Boolean", "Integer", "Point" and "Vector" */,
            const char * expressionString /** The expression as a string.  Must be in the format: "name = formula".
                                               For example, "x = 1.2 * y + z". */,
        ...
        /** Creates a system expression, specifying the type.
                The calculated units of the formula must be compatible
                with the given units for the expression. A unitless expression may be created
                by setting the units to NULL. In that case, the formula should also be a unitless number.

                Point and Vector expressions can be specified with Length units.
             @return  the new expression 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Expression * CreateSystemExpressionWithUnit
        (
            const NXString & expressionType /** The type of the expression, such as "Number", "String", "Boolean", "Integer", "Point" and "Vector" */,
            const NXString & expressionString /** The expression as a string.  Must be in the format: "name = formula".
                                               For example, "x = 1.2 * y + z". */,
            NXOpen::Unit * unitType /** units for the expression, if the expression type supports it */
        );
        /** Creates a system expression, specifying the type.
                The calculated units of the formula must be compatible
                with the given units for the expression. A unitless expression may be created
         ...
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Expression * CreateSystemExpressionWithUnit
        (
            const char * expressionType /** The type of the expression, such as "Number", "String", "Boolean", "Integer", "Point" and "Vector" */,
            const char * expressionString /** The expression as a string.  Must be in the format: "name = formula".
                                               For example, "x = 1.2 * y + z". */,
        ...
        /** Edits an expression.
                ...
                editing the expression via  @link NXOpen::Expression::SetFormula NXOpen::Expression::SetFormula@endlink 
        ...
        /** Edits an expression with units. 
                ...
                editing the expression via @link NXOpen::Expression::SetSetFormula NXOpen::Expression::SetSetFormula@endlink 
                if the ExpressionCollection is owned by the part that owns the expression.  <br> 
        ...
        (
            ...
            bool visibleOnly /** Filter to get only visible expressions. */
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void UpdateForLimitedExternalChange
        (
            NXOpen::Part * updateScope /** updatescope */ 
        );

        /// \endcond 
        /** Create a new system expression name. Use this when creating new compound names such as "pNNN_x" which will
                then be used in a call such as @link NXOpen::ExpressionCollection::CreateSystemExpressionWithUnits NXOpen::ExpressionCollection::CreateSystemExpressionWithUnits@endlink .
                For example, idSuffix="cae", nameSuffix="_turn" might create "pcaeNNN_turn".
                This call is not needed if the default name is desired.  @return  the new name 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXString CreateSystemName
        (
            const NXString & idSuffix /** the suffix as a string to be added after the system identifier (default "p"). */,
            const NXString & nameSuffix /** the suffix as a string to be added after the default name. */
        );
        /** Create a new system expression name. Use this when creating new compound names such as "pNNN_x" which will
                then be used in a call such as @link NXOpen::ExpressionCollection::CreateSystemExpressionWithUnits NXOpen::ExpressionCollection::CreateSystemExpressionWithUnits@endlink .
                For example, idSuffix="cae", nameSuffix="_turn" might create "pcaeNNN_turn".
         ...
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        NXString CreateSystemName
        (
            const char * idSuffix /** the suffix as a string to be added after the system identifier (default "p"). */,
            const char * nameSuffix /** the suffix as a string to be added after the default name. */
        );
        /** Creates a number expression with units.
                ...
                this function will assume that its units match the units of the expression.
                 ...
                 <br> 
                 <br> 
                To properly create an expression, use instead @link NXOpen::ExpressionCollection::NewExpression NXOpen::ExpressionCollection::NewExpression@endlink 
        ...
        /** Creates a system number expression with units.
                ...
                is assumed to be in the units of the expression.
                 ...
                 <br> 
                 <br> 
                To properly create an expression, use instead @link NXOpen::ExpressionCollection::CreateSystemNumberExpression NXOpen::ExpressionCollection::CreateSystemNumberExpression@endlink 
                with a formula as follows:
                 <br> 
                 <br> 
                          arcLength = arcRadius * arcAngle
        ...
        /** Edits an expression. Note, there is no difference between this method and
                ...
                is assumed to be in the units of the expression.
                 ...
                 <br> 
                 <br> 
                To properly edit an expression, use instead @link NXOpen::ExpressionCollection::EditExpression NXOpen::ExpressionCollection::EditExpression@endlink 
                with a formula as follows:
                 <br> 
                 <br> 
                          arcLength = arcRadius * arcAngle
