...
namespace NXOpen
{
    ...
    PatternService.AxialDefinition.AngularSpacing.NCopies.Value </term> <description> 
     
    12 </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.AngularSpacing.PitchAngle.Value </term> <description> 
     
    30 </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.AngularSpacing.PitchDistance.Value </term> <description> 
     
    10 (millimeters part), 1 (inches part) </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.AngularSpacing.SpaceType </term> <description> 
     
    Offset </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.AngularSpacing.SpanAngle.Value </term> <description> 
     
    360 (millimeters part), 360 (inches part) </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.AngularSpacing.UsePitchOption </term> <description> 
     
    Angle </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.AxialSpacing.NCopies.Value </term> <description> 
     
    1 </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.CreateLastStaggered </term> <description> 
     
    true </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.HorizontalRef.RotationAngle.Value </term> <description> 
     
    0 (millimeters part), 0 (inches part) </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.MeasureDistanceType </term> <description> 
     
    AlongAxis </description> </item> 

    <item><term> 
     
    PatternService.AxialDefinition.StaggerType </term> <description> 
    ...
    PatternService.PatternOrientation.AxialOrientationOption </term> <description> 
    ...
    RelationScope </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  SketchPatternBuilder : public NXOpen::Builder
    {
        ...
        /**Returns  the relation scope option that specifies which curves participate in relation finding 
         ...
         <br> License requirements : None */
        public: NXOpen::SketchPattern::RelationScope RelationScope
        (
        );
        ...
        (
            NXOpen::SketchPattern::RelationScope scope /** scope */ 
        );
        /** This function helps to turn on or off relation finding on a particular instance. Index of 0,0 corresponds to the base/input 
                    to the pattern. Y-index for non-rectangular patterns should be 0. This function can be called for any relation scope.  But if 
                    the scope is not set to @link NXOpen::SketchPattern::RelationScopeSpecified NXOpen::SketchPattern::RelationScopeSpecified@endlink  at the time of commit, 
                    the indices set here would be ignored. 
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: void SetRelationFinding
        (
            int instanceXIndex /** Instance x-index */,
            int instanceYIndex /** Instance y-index */,
            bool findRelations /** True to find relations from the instance, false to exclude the instance from relation finding */
        );
        /** This function queries the find setting on an instance. If the return value is true, then the relations will be
                    found on that instance. Index of 0, 0 corresponds to the base/input to the pattern. Y-index for non-rectangular patterns should be 0.
                    If this function is called for any scope other than @link NXOpen::SketchPattern::RelationScopeSpecified NXOpen::SketchPattern::RelationScopeSpecified@endlink , 
                    the result will always be set to false.  @return  True if relations are found from the instance, false if excluded from relation finding 
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: bool GetRelationFinding
        (
            int instanceXIndex /** Instance x-index */,
            int instanceYIndex /** Instance y-index */
        );
