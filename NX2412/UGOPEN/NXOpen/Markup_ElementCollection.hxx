    ...
    namespace Markup
    {
        ...
        */
        class NXOPENCPP_MARKUPEXPORT  ElementCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Markup::Element *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Markup::Element **;
                using reference = NXOpen::Markup::Element *&;
            ...
            /** Creates copies of input @link NXOpen::Markup::Element NXOpen::Markup::Element@endlink  objects into the markup. 
                        ...
                        this method.  <br>   @return  Copies of Markup Elements 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Markup::Element *> CopyObjects
            (
                const std::vector<NXOpen::Markup::Element *> & inputObjects /** Markup Elements to be copied */
            );
            /** Cuts the input @link NXOpen::Markup::Element NXOpen::Markup::Element@endlink  objects into the markup. 
                         <br> 
                        Client must perform update @link NXOpen::Update::DoUpdate NXOpen::Update::DoUpdate@endlink  after calling 
                        this method.  <br>   @return  Markup Elements moved to new Markup 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Markup::Element *> CutObjects
            (
                const std::vector<NXOpen::Markup::Element *> & inputObjects /** Markup Elements to be cut */
            );
