        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  Constraint : public NXOpen::NXObject
        {
            ...
            public: enum Type
            {
                ...
                TypeGear/** Defines the relative motion between two joints with angular values */,
                TypeRackPinion/** Defines the relative motion between a joint with an angular value and a joint with a linear value */,
                TypeCable/** Defines the relative motion between two joints with linear values */
            };
            ...
            /**Sets  
                    the suppression state for the constraint. In a @link NXOpen::Positioning::ComponentConstraint NXOpen::Positioning::ComponentConstraint@endlink  this is the state in the @link NXOpen::Positioning::ComponentPositioner::PrimaryArrangement NXOpen::Positioning::ComponentPositioner::PrimaryArrangement@endlink ."
            ...
            /** 
                 ...
                 @return  The creation data of the constraint 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::DateItemBuilder * GetCreationDate
            (
            );
            /** 
                    ...
                    The timestamp is recorded in the timezone of the machine where the operation is done.
                    The user is required to delete the returned object.
                 @return  The constraint most recent modification date 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::DateItemBuilder * GetModifiedDate
            (
            );
        };
    }
