    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  RegionTracker : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  a flag indicating if the region is added/selected by the user 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool Added
            (
            );
            /**Sets  a flag indicating if the region is added/selected by the user 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  a flag indicating if the region is removed/deselected by the user 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool Removed
            (
            );
            /**Sets  a flag indicating if the region is removed/deselected by the user 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** The owning body where the region is located onto  @return  region owning entity 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Body * GetOwningBody
            (
            );
            /** The owning body where the region is located onto 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetOwningBody
            (
                NXOpen::Body * owningBodyEid /** region owning body */
            );
            /** Append one new region boundary body to the region tracker 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void AppendOneBoundaryBody
            (
                NXOpen::Body * boundaryBodyEid /** region boundary body */,
                bool sideness /** region boundary sideness */
            );
