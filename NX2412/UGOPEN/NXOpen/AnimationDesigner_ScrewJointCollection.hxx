    ...
    namespace AnimationDesigner
    {
        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  ScrewJointCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::AnimationDesigner::ScrewJoint *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::AnimationDesigner::ScrewJoint **;
                using reference = NXOpen::AnimationDesigner::ScrewJoint *&;
