    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SelectionRecipe : public NXOpen::DisplayableObject
        {
            ...
            /** Returns the Nth Strategy for the Selection Recipe  @return  
            ...
            /** Sets the toggle share selection recipe with AFEM and SIM 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Gets the toggle share selection recipe with AFEM and SIM 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool GetAllowOccurrence
            (
            );
            /** Get owning component for SelectionRecipeOcc, SelectionRecipeAltrep and SelectionRecipeAltrepOcc.
                      It is not applicable for Selection Recipe and will return null
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::Assemblies::Component * GetComponent
            (
            );
            /** Gets the complete name of the selection recipe  @return  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetCompleteName
            (
            );
