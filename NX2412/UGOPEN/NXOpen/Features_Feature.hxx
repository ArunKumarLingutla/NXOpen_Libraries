        ...
        */
        class NXOPENCPP_FEATURESEXPORT  Feature : public NXOpen::NXObject, public virtual NXOpen::IProfile, public virtual NXOpen::IFitTo
        {
            ...
            public: enum BooleanType
            {
                ...
                BooleanTypeTransferVoids/** transfer voids */ 
            };
            ...
            protected: Feature();
            public: ~Feature();
            /** Returns the expressions created by the feature. The order in which expressions are returned is not significant and may change.
                    Use @link NXOpen::Expression::Description NXOpen::Expression::Description@endlink  for a description of how an expression is used  @return  
             <br>  Created in NX3.0.0.  <br>  
            ...
            /** Returns the immediate child features. The order in which children are returned is not significant and may change. 
                    When used with features involving boolean operations or body modifying features, the API has limitations such 
                    that it may not return all the expected child features. 
                    This API is superseded by @link NXOpen::Features::Feature::GetAllChildren NXOpen::Features::Feature::GetAllChildren@endlink  
                 @return  
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") OR insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Returns the entities created by a feature that are not Bodies, Faces or Edges. The order in which entities are returned is not significant and may change.
                    To get the bodies, faces or edges of a feature use @link NXOpen::Features::Feature::GetBodies NXOpen::Features::Feature::GetBodies@endlink , @link NXOpen::Features::Feature::GetFaces NXOpen::Features::Feature::GetFaces@endlink 
                    and @link NXOpen::Features::Feature::GetEdges NXOpen::Features::Feature::GetEdges@endlink  respectively.
                 @return  
            ...
            /** Returns the feature error messages. error_messages can be NULL. The order in which error messages are returned is not significant and may change  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetFeatureErrorMessages
            (
            );
            /** Returns the feature informational messages. info_messages can be NULL. The order in which informational messages are returned is not significant and may change @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Returns the feature warning messages. warning_messages can be NULL. The order in which warning messages are returned is not significant and may change  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetFeatureWarningMessages
            (
            );
            /** Returns the feature clue messages. clue_messages can be NULL. The order in which clue messages are returned is not significant and may change  @return  
            ...
            /** Returns both clue and hint messages of the feature. num_clueHint can be NULL. The order in which clue and hint messages are returned is not significant and may change  @return  
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetFeatureClueHintMessages
            (
            );
            /** Returns the feature hint messages. hint_messages can be NULL. The order in which hint messages are returned is not significant and may change  @return  
             <br>  Created in NX8.0.1.  <br>  
             <br> License requirements : None */
            ...
            /** Loads parent part for linked feature 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void LoadParentPart
            (
            );
            /** Returns true if a feature is browsable. A browsable feature is typically visible in the Part Navigator.  @return  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** This is an internal API and can be changed at any time 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use JA_FEATURE_generate_feature_selection_data_string. <br>  

             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use JA_FEATURE_generate_feature_selection_data_string.") bool GenerateFeatureSelectionData
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXString GenerateFeatureSelectionDataString
            (
            );

            /// \endcond 
            /** Returns true if a feature is out of date. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: bool IsOutOfDate
            (
            );
            /** Loads parent part for linked feature with the part load status 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::PartLoadStatus * LoadParentPartWithStatus
            (
            );
            /** The API is to show slave features of a master feauture. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void ShowSlaveFeatures
            (
                std::vector<NXOpen::Features::Feature *> & slaveFeatures /** Show slave features if necessary  */
            );
            /** The API is to hide slave features of a master feauture. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void HideSlaveFeatures
            (
                const std::vector<NXOpen::Features::Feature *> & slaveFeatures /** Hide slave features if necessary  */
            );
            /** Returns the feature error codes and messages. error_codes, error_messages can be NULL. The order in which error codes, messages are returned is not significant and may change 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void GetFeatureErrorCodesAndMessages
            (
                std::vector<int> & errorCodes /** Error codes */,
                std::vector<NXString> & errorMessages /** Error messages */
            );
            /** Returns true if a feature is associative.  @return  Returns true if a feature is associative 
             <br>  Created in NX2406.4000.0.  <br>  
             <br> License requirements : None */
