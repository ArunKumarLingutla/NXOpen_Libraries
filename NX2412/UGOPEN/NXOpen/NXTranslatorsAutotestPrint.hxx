    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  NXTranslatorsAutotestPrint
    {
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void JtCompareInteropTranslators
        (
            const NXString & exeName /** exename */ ,
            const NXString & inputPart /** inputpart */ ,
            const NXString & configFile /** config file */ 
        );
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        void JtCompareInteropTranslators
        (
            const char * exeName /** exename */ ,
            const char * inputPart /** inputpart */ ,
            const char * configFile /** config file */ 
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void RunInteropTranslatorsOnly
        (
            const NXString & exeName /** exename */ ,
            const NXString & inputPart /** inputpart */ ,
            const NXString & structureOptions /** structure options */ ,
            const NXString & configFile /** config file */ ,
            bool compareFlag /** compareflag */ 
        );
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        void RunInteropTranslatorsOnly
        (
            const char * exeName /** exename */ ,
            const char * inputPart /** inputpart */ ,
            const char * structureOptions /** structure options */ ,
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void RunBidirectionalInteropTranslators
        (
            const NXString & exeName /** exename */ ,
            const NXString & inputPart /** inputpart */ ,
            const NXString & structureOptions /** structure options */ ,
            const NXString & configFile /** config file */ ,
            const NXString & configFile1 /** config file1 */ ,
            const NXString & extensionType /** extension type */ 
        );
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        void RunBidirectionalInteropTranslators
        (
            const char * exeName /** exename */ ,
            const char * inputPart /** inputpart */ ,
            const char * structureOptions /** structure options */ ,
            const char * configFile /** config file */ ,
            const char * configFile1 /** config file1 */ ,
            const char * extensionType /** extension type */ 
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void RunInteropTranslatorsJtCompareOnly
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void RunInteropTranslatorsLogCompareOnly
        (
            const NXString & logFileName /** logfilename */ ,
            const NXString & exeName /** exename */ ,
            const NXString & relativeTolerance /** relativetolerance */ 
        );
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        void RunInteropTranslatorsLogCompareOnly
        (
            const char * logFileName /** logfilename */ ,
            const char * exeName /** exename */ ,
            const char * relativeTolerance /** relativetolerance */ 
        );
