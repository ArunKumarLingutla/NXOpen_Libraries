...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        LinearBackstopOffset.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        MotionDistance </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PredefinedHydraulicOption </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        PressStartAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PressStopAngle </term> <description> 
         
        90 </description> </item> 

        <item><term> 
         
        ReturnStartAngle </term> <description> 
         
        180 </description> </item> 

        <item><term> 
         
        ReturnStopAngle </term> <description> 
         
        270 </description> </item> 

        <item><term> 
         
        RockerAxisBackstopOffset.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        RotaryBackstopOffset.Value </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DefineCamBuilder : public NXOpen::Builder
        {
            ...
            public: enum Types
            {
                ...
                TypesTrackMotion/** Track Motion cam type */
            };
            ...
            /**Returns  the parent slide body 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * ParentSlideBodies
            (
            );
            /**Returns  the motion slide body 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * MotionSlideBodies
            (
            );
            /**Returns  the connector body 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * ConnectorBodies
            (
            );
            /**Returns  the guide lines for motion. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the constraint vector 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * ConstraintVector
            (
            );
            /**Sets  the constraint vector 
             <br>  Created in NX2312.0.0.  <br>  
            ...
            public: void SetConstraintVector
            (
                NXOpen::Direction * constraintVector /** constraintvector */ 
            );
            ...
            /** Delete the curve motion 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void DeleteCurveMotion
            (
                const NXString & motionName /** motionname */ 
            );
            /** Delete the curve motion 
