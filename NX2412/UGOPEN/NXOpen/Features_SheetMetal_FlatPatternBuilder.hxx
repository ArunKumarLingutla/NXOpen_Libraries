            ...
            */
            class NXOPENCPP_FEATURESEXPORT  FlatPatternBuilder : public NXOpen::Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                /**Returns  the value indicating whether or not to keep the flat solid external while creating the flat pattern.
                 ...
                 <br> License requirements : None */
                public: bool KeepFlatSolidExternal
                (
                );
                /**Sets  the value indicating whether or not to keep the flat solid external while creating the flat pattern.
                                This is applicable only during flat pattern creation and not during edit mode.
                            
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: void SetKeepFlatSolidExternal
                (
                    bool isKeepExternal /** iskeepexternal */ 
                );
                /**Returns  the bend direction up texts in flat pattern PMIs
                 ...
                 <br> License requirements : None */
                public: NXString BendDirectionUpText
                (
                );
                /**Sets  the bend direction up texts in flat pattern PMIs
                            ** This is applicable during creation of flat pattern feature.
                            
                 <br>  Created in NX2306.8000.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetBendDirectionUpText
                (
                    const NXString & bendDirectionUp /** benddirectionup */ 
                );
                /**Sets  the bend direction up texts in flat pattern PMIs
                            ** This is applicable during creation of flat pattern feature.
                 ...
                 <br>  Created in NX2306.8000.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                void SetBendDirectionUpText
                (
                    const char * bendDirectionUp /** benddirectionup */ 
                );
                /**Returns  the bend direction down texts in flat pattern PMIs
                 ...
                 <br>  Created in NX2306.8000.0.  <br>  
                 <br> License requirements : None */
                public: NXString BendDirectionDownText
                (
                );
                /**Sets  the bend direction down texts in flat pattern PMIs
                            ** This is applicable during creation of flat pattern feature.
                            
                 <br>  Created in NX2306.8000.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetBendDirectionDownText
                (
                    const NXString & bendDirectionDown /** benddirectiondown */ 
                );
                /**Sets  the bend direction down texts in flat pattern PMIs
                            ** This is applicable during creation of flat pattern feature.
                 ...
                 <br>  Created in NX2306.8000.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                void SetBendDirectionDownText
                (
                    const char * bendDirectionDown /** benddirectiondown */ 
                );
            };
        }
    }
