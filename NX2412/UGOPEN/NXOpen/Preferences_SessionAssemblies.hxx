    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionAssemblies
        {
            ...
            /** Specifies the arrangement target option to use when creating Assembly Constraints */
            public: enum PositioningArrangementTargetOption
            {
                PositioningArrangementTargetOptionAllArrangements/** all arrangements */ ,
                PositioningArrangementTargetOptionActiveArrangement/** active arrangement */ 
            };
            ...
            /**Returns  the option to specify where to add Design Elements selected whilst working in the Assembly Constraints Dialog.
             ...
             <br>  @deprecated Deprecated in NX2212.0.0.  No replacement. <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  No replacement.") NXOpen::Preferences::SessionAssemblies::PositioningTaskCollectionOptionForDesignElements PositioningTaskCollectionForDesignElements
            (
            );
            /**Sets  the option to specify where to add Design Elements selected whilst working in the Assembly Constraints Dialog.
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  No replacement.") void SetPositioningTaskCollectionForDesignElements
            (
            ...
            /**Returns  the option to populate the Assembly Simplify dialog with visible solids on entry 
             ...
             <br> License requirements : None */
            public: bool SimplifyPrepopulate
            (
            );
            /**Sets  the option to populate the Assembly Simplify dialog with visible solids on entry 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetSimplifyPrepopulate
            (
                bool prepopulate /** prepopulate */ 
            );
            /**Returns  the option that determines if assembly constraints are created persistent or not 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreatePersistentConstraints
            (
            );
            /**Sets  the option that determines if assembly constraints are created persistent or not 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCreatePersistentConstraints
            (
                bool shouldCreatePersistentConstraints /** shouldcreatepersistentconstraints */ 
            );
            /**Returns  the option that determines the arrangement target when creating new assembly constraints 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::SessionAssemblies::PositioningArrangementTargetOption PositioningArrangementTargetPreference
            (
            );
            /**Sets  the option that determines the arrangement target when creating new assembly constraints 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetPositioningArrangementTargetPreference
            (
                NXOpen::Preferences::SessionAssemblies::PositioningArrangementTargetOption arrangementTarget /** arrangementtarget */ 
            );
