...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Expression : public NXOpen::NXObject
    {
        ...
        {
            AttributeSourceTypeObject/** @link NXOpen::NXObject NXOpen::NXObject@endlink  attribute.  */,
            AttributeSourceTypePart/** @link NXOpen::Part NXOpen::Part@endlink  attribute. */
        };
        ...
        /**Returns  the value of a number expression in base units (except for angle-related expressions - see below).
                NOTE: Avoid this function in new application code.
        ...
        /**Sets  the value of a number expression in base units (except for angle-related expressions - see below).
                NOTE: Avoid this function in new application code.
                 <br>  If the expression has an angular dimension, then the value is assumed to be
                based on degrees, which will not be the base unit value.
                 <br> 
        ...
        /** Set the expression's persistently locked state. 
         ...
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetPersistentlyLocked
        (
            bool isLocked /** is locked */ 
        );
        /** Changes the comment. 
        ...
        /**Returns  whether the expression is a truly unitless expression.
                Such expressions enforce dimensionality consistency and cannot be
                changed during unit conversion (due to references)
                NOTE: These properties apply only to number expressions which are already unitless.
            
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsTrulyUnitless
        (
        );
        /**Sets  whether the expression is a truly unitless expression.
                Such expressions enforce dimensionality consistency and cannot be
                changed during unit conversion (due to references)
                NOTE: These properties apply only to number expressions which are already unitless.
         ...
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: void SetTrulyUnitless
        (
            bool isTrulyUnitless /** is truly unitless */ 
        );
        ...
        /**Returns  whether the expression is identified to be displayed as a user expression.
                This affects such things as whether the expression will be displayed
                as a user expression in the part navigator. System, product interface and
                interpart expressions cannot be marked as user specified.
        ...
        /**Sets  whether the expression is identified to be displayed as a user expression.
                This affects such things as whether the expression will be displayed
                as a user expression in the part navigator. System, product interface and
                interpart expressions cannot be marked as user specified.
         ...
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: void SetUserSpecified
        (
            bool isUserSpecified /** is user specified */ 
        );
        /**Returns  whether the expression is created by mass management. 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsMassManagementExp
        (
        );
        /**Sets  whether the expression is created by mass management. 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: void SetMassManagementExp
        (
            bool isMassManagementExp /** is mass management exp */ 
        );
        /** Does the expression reference an attribute?  @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: bool HasReferencedAttribute
        (
        );
        /** Get the referenced @link NXOpen::NXObject::AttributeInformation NXOpen::NXObject::AttributeInformation@endlink  for the expression.  @return  Free allocated elements in structure. 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject::AttributeInformation GetReferencedAttribute
        (
        );
        /** Does a part attribute reference an expression?  @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: bool HasReferencingPartAttribute
        (
        );
        /** Does an object attribute reference an expression?  @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: bool HasReferencingObjectAttribute
        (
        );
        /** Get the referencing object @link NXOpen::NXObject::AttributeInformation NXOpen::NXObject::AttributeInformation@endlink  for the expression.  @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: bool GetReferencingAttribute
        (
            NXOpen::Expression::AttributeSourceType attributeSourceType /** See @link NXOpen::Expression::AttributeSourceType NXOpen::Expression::AttributeSourceType@endlink  */,
            NXOpen::NXObject::AttributeInformation* info /** Free allocated elements in structure. */
        );
        /** Get the referencing object @link NXOpen::NXObject::AttributeInformation NXOpen::NXObject::AttributeInformation@endlink  for the expression.  @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: bool GetReferencingPartOrObjectAttribute
        (
            NXOpen::Expression::AttributeSourceType* attributeSourceType /** See @link NXOpen::Expression::AttributeSourceType NXOpen::Expression::AttributeSourceType@endlink  */,
            NXOpen::NXObject::AttributeInformation* info /** Free allocated elements in structure. */
        );
