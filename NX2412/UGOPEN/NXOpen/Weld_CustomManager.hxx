    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  CustomManager : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Weld::EdgePrep *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Weld::EdgePrep **;
                using reference = NXOpen::Weld::EdgePrep *&;
            ...
            /** Returns @link  NXOpen::ScCollector   NXOpen::ScCollector @endlink  contained in master @link NXOpen::Weld::WeldJoint NXOpen::Weld::WeldJoint@endlink .  @return  A collector in master joint 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * GetMasterJointCollectorOfSplitFeature
            (
                NXOpen::Features::Feature * feature /** The weld joint feature */
            );
            /** Converts legacy welding joints to split joints. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void ConvertLegacyJoint
            (
                NXOpen::Features::Feature * feature /** The weld joint feature */
            );
