        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  Stock : public NXOpen::NXObject, public virtual NXOpen::Routing::ICharacteristic
        {
            ...
            /** If the stock has cross section invalidities this function corrects those. If the invalidity is fixed, the stock needs needs to be logged for update and update should 
                        be triggered.  @return  Return true if the invalidity was found and fixed. 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Tests whether two stock objects are equivalent.  Two stock objects are
                        ...
                        all characteristic values are equal.  @return  Is this stock the same as the given stock? 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: bool IsStockEqual
            (
                NXOpen::Routing::Stock * otherStock /** The other stock to compare against this stock. */
            );
            /** Returns the electrical connections this stock represents, if any.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::Electrical::Connection *> GetConnections
            (
            );
            /** Returns the electrical wires this stock represents, if any.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::Wire *> GetWires
            (
            );
