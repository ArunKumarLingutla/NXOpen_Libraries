...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        AnnoLayer </term> <description> 
         
        101 </description> </item> 

        <item><term> 
         
        CenterOfGravity </term> <description> 
         
        True </description> </item> 

        <item><term> 
         
        DatumPlaneLayer </term> <description> 
         
        101 </description> </item> 

        <item><term> 
         
        DatumPlanes </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        NSection </term> <description> 
         
        5 </description> </item> 

        <item><term> 
         
        PrincipalAxes </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        RectangleLayer </term> <description> 
         
        101 </description> </item> 

        <item><term> 
         
        RectangularSection </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        SecondPrincipleMi </term> <description> 
         
        True </description> </item> 

        <item><term> 
         
        SectionArea </term> <description> 
        ...
        SectionLength </term> <description> 
         
        True </description> </item> 

        <item><term> 
         
        Sections </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        ShearCenter </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  SectionInertiaAnalysisBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the units for calculations 
             <br>  @deprecated Deprecated in NX2306.0.0.  Section Analysis Builder no longer supports a units setting. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Section Analysis Builder no longer supports a units setting.") int Units
            (
            );
            /**Sets  the units for calculations 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Section Analysis Builder no longer supports a units setting.") void SetUnits
            (
                int units /** units */ 
            );
