...
#include <NXOpen/Composites_CrossSectionPMIBuilder.hxx>
...
#include <NXOpen/Composites_DesignStationPMIBuilder.hxx>
...
#include <NXOpen/Composites_HDF5ExportBuilder.hxx>
#include <NXOpen/Composites_Laminate.hxx>
        ...
        */
        class COMPOSITESOPENCPPEXPORT  Manager
        {
            ...
            */
            ...
            /** Creates a @link Composites::HDF5ExportBuilder Composites::HDF5ExportBuilder@endlink  to output composite object data to an HDF5 file for communication with CAE
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_composites_cae (" Export HDF5") */
            public: NXOpen::Composites::HDF5ExportBuilder * CreateHDF5ExportBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_composites (" Composites") */
            public: NXOpen::Composites::DesignStationPMIBuilder * CreateDesignStationPMIBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::Annotations::SimpleDraftingAid * annotation /** annotation */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_composites (" Composites") */
            public: NXOpen::Body * CreateLaminateOffsetSurfaceFromFacetBody
            (
                NXOpen::Composites::Laminate * laminate /** laminate */ ,
                NXOpen::Body * convergentBody /** convergentbody */ ,
                double rampRatio /** rampratio */ ,
                double gridControlFactor /** gridcontrolfactor */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_composites (" Composites") */
            public: NXOpen::Body * CreateLaminateOffsetSurfaceFromLaminateMesh
            (
                NXOpen::Composites::Laminate * laminate /** laminate */ ,
                double facetMaxSize /** facetmaxsize */ ,
                double chordTolerance /** chordtolerance */ ,
                double rampRatio /** rampratio */ ,
                double gridControlFactor /** gridcontrolfactor */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_composites (" Composites") */
            public: NXOpen::Composites::CrossSectionPMIBuilder * CreateCrossSectionPMIBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::Annotations::SimpleDraftingAid * annotation /** annotation */ 
            );
