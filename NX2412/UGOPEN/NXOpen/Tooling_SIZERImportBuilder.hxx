        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SIZERImportBuilder : public NXOpen::Builder
        {
            ...
            /** Creates logical node in system navigator.  @return  Logical Object Tag 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Mechatronics::ImportSelectedMotorsBuilder::CreateMcdLogical NXOpen::Mechatronics::ImportSelectedMotorsBuilder::CreateMcdLogical@endlink  instead. Please remember to remove Mechatronics including header files when deleting this method. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Mechatronics::ImportSelectedMotorsBuilder::CreateMcdLogical instead. Please remember to remove Mechatronics including header files when deleting this method.") NXOpen::Mechatronics::LogicObject * CreateMcdLogical
            (
            ...
            /** Edits logical node in system navigator. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Mechatronics::ImportSelectedMotorsBuilder::EditMcdLogical NXOpen::Mechatronics::ImportSelectedMotorsBuilder::EditMcdLogical@endlink  instead. Please remember to remove Mechatronics including header files when deleting this method. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Mechatronics::ImportSelectedMotorsBuilder::EditMcdLogical instead. Please remember to remove Mechatronics including header files when deleting this method.") void EditMcdLogical
            (
