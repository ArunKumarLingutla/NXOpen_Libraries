...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  FENode : public NXOpen::TaggedObject, public virtual NXOpen::IFitTo, public virtual NXOpen::CAE::IExportableFEEntity
        {
            private: FENodeImpl * m_fenode_impl;
            private: friend class  _FENodeBuilder;
            protected: FENode();
            public: ~FENode();
            /** Indicate whether this node is a Scalar Point (spoint). 
                        This type of node only has a node label. It does not have a position or coordinate system information 
