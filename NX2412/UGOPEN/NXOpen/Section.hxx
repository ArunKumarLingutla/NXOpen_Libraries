...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Section : public NXOpen::DisplayableObject
    {
        ...
        /** Allow degenerate curves in section or not. By default, the section does not allow it. 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: void AllowDegenerateCurves
        (
            bool allowDegenerateCurves /** True if degenerate curves is allowed in section else false*/
        );
        ...
        public: void GetSectionData
        (
            bool withOccurrenceInfo /** True to get occurrence instead of proto information */,
            std::vector<NXOpen::SectionData *> & sectionData /** Section data consists of selection intent rules,
                                                                                                                  section elements, start and end connector. */
        );
        /** Returns the section rules and entities collected by rules 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::TaggedObject *> AskRulesAndCollectedEntities
        (
            std::vector<NXOpen::SelectionIntentRule *> & rules /** Selection intent rules. */,
            std::vector<int> & ruleObjectArrayCount /** ruleobjectarraycount */ 
        );
        /** Returns the number of set of connecting curves  @return  number of set of connecting curves
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
