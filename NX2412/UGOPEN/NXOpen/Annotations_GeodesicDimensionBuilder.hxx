...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link NXOpen::Annotations::Dimension NXOpen::Annotations::Dimension@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Annotations::DimensionCollection::CreateGeodesicDimensionBuilder  NXOpen::Annotations::DimensionCollection::CreateGeodesicDimensionBuilder @endlink  <br> 
