...
namespace NXOpen
{
    ...
    */
    class NXOPENDEBUGSESSIONCPPEXPORT  ModelingAutotestPrint
    {
        ...
        (
            NXOpen::Face * face /** face */,
            bool printFullSid /** printfullsid */ ,
            bool printFaceType /** printfacetype */ ,
            bool printNumEdges /** printnumedges */ ,
            bool printFaceGeometryDetails /** printfacegeometrydetails */ ,
            bool printMinimumCurvature /** printminimumcurvature */ ,
            bool printCentroid /** printcentroid */ ,
            bool printMassProps /** printmassprops */ ,
            bool printUserAttributes /** printuserattributes */ ,
            const std::vector<double> & tolerances /** four tolerances expected */
        );
        ...
        (
            ...
            bool printFullSid /** printfullsid */ ,
            bool printEdgeType /** printedgetype */ ,
            bool printEdgeGeometryDetails /** printedgegeometrydetails */ ,
            bool printUserAttributes /** printuserattributes */ ,
            const std::vector<double> & tolerances /** at least one tolerance expected */
        );
        ...
        (
            NXOpen::Body * body /** body */,
            bool printBodyFaults /** printbodyfaults */ ,
            bool printTopolCounts /** printtopolcounts */ ,
            bool printCentroid /** printcentroid */ ,
            bool printMassProps /** printmassprops */ ,
            bool exportParasolid /** exportparasolid */ ,
            bool exportNewModFacesOnly /** exportnewmodfacesonly */ ,
            bool printUserAttributes /** printuserattributes */ ,
            const std::vector<double> & tolerances /** five tolerances expected */
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: void PrintWireframe
        (
            NXOpen::NXObject * curve /** curve or point */,
            bool printCurveType /** printcurvetype */ ,
            bool printIsDumb /** printisdumb */ ,
            bool printUpdateOption /** printupdateoption */ ,
            bool printIsReference /** printisreference */ ,
            bool printFeatureOwner /** printfeatureowner */ ,
            bool printCurveLength /** printcurvelength */ ,
            bool printCurveGeometryDetails /** printcurvegeometrydetails */ ,
            bool printUserAttributes /** printuserattributes */ ,
            double distanceTolerance /** validation distance tolerance */
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: void PrintFeatureValidation
        (
            NXOpen::Features::Feature * feature /** the feature */,
            bool printSuppressState /** printsuppressstate */ ,
            bool printUpToDateState /** printuptodatestate */ ,
            bool printWaveStats /** printwavestats */ ,
            bool printErrorWarningCount /** printerrorwarningcount */ ,
            bool printIsLatest /** printislatest */ ,
            bool printFullVersion /** printfullversion */ ,
            bool printExpressions /** printexpressions */ ,
            bool detailedExpressionValidation /** detailedexpressionvalidation */ ,
            bool printInternalFeatureCount /** printinternalfeaturecount */ ,
            bool printInternalFeatureList /** printinternalfeaturelist */ ,
            bool printOwningFeature /** printowningfeature */ ,
            bool printBodyCounts /** printbodycounts */ ,
            bool printSectionCollectorCounts /** printsectioncollectorcounts */ ,
            bool printFaceCount /** printfacecount */ ,
            bool printEdgeCount /** printedgecount */ ,
            bool printCurveAndPointCounts /** printcurveandpointcounts */ ,
            bool printParentFeatures /** printparentfeatures */ ,
            bool printChildFeatures /** printchildfeatures */ ,
            bool printCustomAPI /** printcustomapi */ ,
            bool printUserAttributes /** printuserattributes */ 
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void PrintMultifaceContinuity
        (
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void PrintEdgefaceContinuity
        (
            int type /** type */ ,
            NXOpen::Edge * edge1 /** first edge */,
            NXOpen::Face * face1 /** first face */,
            NXOpen::Edge * edge2 /** second edge */,
            NXOpen::Face * face2 /** second face */,
            double sampleDistance /** sampledistance */ ,
            const std::vector<double> & tolerances /** tolerances */
        );
