...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        InterSolid </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        MapFaceColor </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        SameParent </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        TouchArea </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TouchAreaTolerance.Value </term> <description> 
         
        0.01 (millimeters part), 0.001 (inches part) </description> </item> 

        <item><term> 
         
        TouchBody </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ElectrodeCheckingBuilder : public NXOpen::Builder
        {
            ...
            public: NXOpen::SelectNXObjectList * Workpiece
            (
            );
            ...
            /**Returns  the electrode part to be checked with the workpiece part. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * Electrode
            (
            );
            ...
            /**Returns  the parent part occurrence of the part where the intersecting solid bodies are created. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * SelectParentPartOcc
            (
            );
            ...
            /**Returns  the precision of calculating touch area. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * TouchAreaTolerance
            (
            );
            /**Returns  the precision of checking electrode. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: double Tolerance
            (
            );
            /**Sets  the precision of checking electrode. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_electrode_wizard ("NX Electrode Wizard") */
