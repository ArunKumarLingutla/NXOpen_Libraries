    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ToolBuilder : public NXOpen::CAM::NCGroupBuilder
        {
            ...
            /**Returns  the index notch builder 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * IndexNotchBuilder
            (
            );
            /**Returns  the incremental turret rotation builder 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * IncrementalTurretRotationBuilder
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXString ToolAssemblyPartName
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetToolAssemblyPartName
            (
                const NXString & name /** The tool assembly part name including the full path */
            );
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetToolAssemblyPartName
            (
                const char * name /** The tool assembly part name including the full path */
            );
            ...
            /**Returns  the manage tool part builder 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::ManageToolPartBuilder * ManageToolPart
            (
            );
            /**Returns  the color picker builder 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableColorPickerBuilder * ColorPickerBuilder
            (
            );
        };
    }
