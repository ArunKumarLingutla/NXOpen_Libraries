...
#include <NXOpen/CAE_AeroStructures_Author_InputLoad.hxx>
                ...
                class NXOPENCPP_CAEEXPORT  ABB
                {
                    ...
                    */
                    ...
                    (
                        ...
                        double b /** The shorter panel dimension */,
                    ...
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** The ABB context */,
                        double a /** First plate dimension */,
                        double b /** Second plate dimension */,
                        NXOpen::CAE::AeroStructures::Author::ABB::EdgeSupportType bc /** Support along the edges */,
                    ...
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** The ABB context */,
                        double b /** First edge length */,
                        double a /** Second edge length */,
                        NXOpen::CAE::AeroStructures::Author::ABB::EdgeSupportType bc /** Support along the edges */,
                        double t /** Panel thickness */,
                        NXOpen::CAE::AeroStructures::Author::ABB::MaterialBehaviour behaviour /** Material behaviour */,
                        double e /** Young's modulus */,
                    ...
                    /** 
                     ...
                     <br> License requirements : None */
                    public: NXOpen::CAE::AeroStructures::Author::ABB::Status LcfFilterLoadsBySupport
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** the ABB context */,
                        const std::vector<NXOpen::CAE::AeroStructures::Author::InputLoad *> & inputLoads /** an array of non-aggregated InputLoadParameters */,
                        std::vector<NXOpen::GeneralScalarTable *> & tables /** filtered GeneralScalarTables */
                    );
                    /** 
                                        Convex hull Method
                     ...
                     <br>  Created in NX1926.0.0.  <br>  
                     <br> License requirements : None */
                    public: NXOpen::CAE::AeroStructures::Author::ABB::Status LcfConvexHull
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** the ABB context */,
                        NXOpen::GeneralScalarTable * load1 /** The first load extraction result*/,
                        NXOpen::GeneralScalarTable * load2 /** The second load extraction result*/,
                        double tolerance /** Tolerance*/,
                        int nbLoadcases /** nb loadcases */ ,
                        std::vector<double> & centrality /** Centralities*/,
                        std::vector<bool> & lcSelected /** True if the load case is selected, false otherwise*/,
                        NXOpen::GeneralScalarTable ** pointCentrality /** point centrality */ ,
                        NXOpen::GeneralScalarTable ** boundaryEnvelope /** Boundary Envelope */,
                        NXOpen::GeneralScalarTable ** boundaryTolerance /** Boundary Tolerance */,
                        double* load1Min /** Load 1 min*/,
                        double* load1Max /** Load 1 max*/,
                        double* load2Min /** Load 2 min*/,
                        double* load2Max /** Load 2 max*/
                    );
                    /** 
                     ...
                     <br>  Created in NX1926.0.0.  <br>  
                     <br> License requirements : None */
                    public: NXOpen::CAE::AeroStructures::Author::ABB::Status LcfMinMaxBoundingBox
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** the ABB context */,
                        NXOpen::GeneralScalarTable * load1 /** load1 */ ,
                        NXOpen::GeneralScalarTable * load2 /** load2 */ ,
                        double tolerance1 /** tolerance 1 */ ,
                        double tolerance2 /** tolerance 2 */ ,
                        int nbLoadcases /** nb loadcases */ ,
                        double* load1Max /** load1 max */ ,
                        double* load1Min /** load1 min */ ,
                        double* load2Max /** load2 max */ ,
                        double* load2Min /** load2 min */ ,
                        std::vector<double> & centrality1 /** centrality 1 */ ,
                        std::vector<double> & centrality2 /** centrality 2 */ ,
                        std::vector<double> & centrality /** centrality */ ,
                        std::vector<bool> & lcSelected /** lc selected */ ,
                        NXOpen::GeneralScalarTable ** pointCentrality1 /** point centrality 1 */ ,
                        NXOpen::GeneralScalarTable ** pointCentrality2 /** point centrality 2 */ ,
                        NXOpen::GeneralScalarTable ** boundaryEnvelope /** Boundary Envelope */,
                        NXOpen::GeneralScalarTable ** boundaryTolerance /** Boundary Tolerance */
                    );
                    /** 
                     ...
                     <br> License requirements : None */
                    public: NXOpen::CAE::AeroStructures::Author::ABB::Status Lcf1dMinMax
                    (
                        NXOpen::CAE::AeroStructures::Author::AbbContext * abbContext /** the ABB context */,
                        NXOpen::GeneralScalarTable * load /** load */ ,
                        double tolerance /** tolerance */ ,
                        int nbLoadcases /** nb loadcases */ ,
                        std::vector<double> & centrality /** centrality */ ,
                        std::vector<bool> & lcSelected /** lc selected */ ,
                        NXOpen::GeneralScalarTable ** pointCentrality /** point centrality */ ,
                        double* boundaryMin /** boundary min */ ,
                        double* boundaryMax /** boundary max */ ,
                        double* toleranceMin /** tolerance min */ ,
                        double* toleranceMax /** tolerance max */ 
                    );
