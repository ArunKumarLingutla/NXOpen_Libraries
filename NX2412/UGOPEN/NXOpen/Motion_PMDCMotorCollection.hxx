...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a collection of motion pmdc motor  <br> To obtain an instance of this class, refer to @link NXOpen::Motion::MotionManager  NXOpen::Motion::MotionManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  PMDCMotorCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            //lint -sem(NXOpen::Motion::PMDCMotorCollection::iterator::copy,initializer)
            class iterator
            {
            public:
                using value_type = NXOpen::Motion::PMDCMotor *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Motion::PMDCMotor **;
                using reference = NXOpen::Motion::PMDCMotor *&;
            ...
            /**   Return  @link  NXOpen::Motion::PMDCMotorBuilder   NXOpen::Motion::PMDCMotorBuilder @endlink  object   @return  PMDCMotorBuilder object 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_motion_motor ("NX Motion Motor") */
            public: NXOpen::Motion::PMDCMotorBuilder * CreatePmdcMotorBuilder
            (
                NXOpen::Motion::PMDCMotor * pmdcMotor /** @link  NXOpen::Motion::PMDCMotor   NXOpen::Motion::PMDCMotor @endlink  to be edited, 
                                                                                     if NULL then create a new one */
            );
            /** Finds the @link  NXOpen::Motion::PMDCMotor   NXOpen::Motion::PMDCMotor @endlink  with the given name.
            ...
            /** Finds the @link  NXOpen::Motion::PMDCMotor   NXOpen::Motion::PMDCMotor @endlink  with the given name.
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_motion_motor ("NX Motion Motor") */
            NXOpen::Motion::PMDCMotor * FindObject
            (
