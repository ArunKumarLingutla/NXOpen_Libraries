...
//
//  Source File:
//     Tooling_MoldCostCustomerDataProvider.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class _MoldCostCustomerDataProviderBuilder;
        class MoldCostCustomerDataProviderImpl;
        /**
            Provides basic data for mold cost.
            When @link Builder::Commit Builder::Commit@endlink  is called NULL will be returned.
             <br> To create a new instance of this class, use @link NXOpen::Tooling::MoldwizardManager::CreateMoldCostCustomerDataProvider  NXOpen::Tooling::MoldwizardManager::CreateMoldCostCustomerDataProvider @endlink  <br> 
         <br>  Created in NX2206.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  MoldCostCustomerDataProvider : public NXOpen::TaggedObject, public virtual NXOpen::ITableEditorDataProvider
        {
            private: MoldCostCustomerDataProviderImpl * m_moldcostcustomerdataprovider_impl;
            private: friend class  _MoldCostCustomerDataProviderBuilder;
            protected: MoldCostCustomerDataProvider();
            public: ~MoldCostCustomerDataProvider();
            /** Sets boolean data at the specified cell
            ...
            /** Sets the cell to store string type data, whose value doesn't need to convert decimal symbol
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetStringCell
            (
                int row /** row */ ,
                int column /** column */ 
            );
