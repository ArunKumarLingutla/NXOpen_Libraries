...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        CutbackOption </term> <description> 
         
        FromCharacteristic </description> </item> 

        <item><term> 
         
        ExtensionOption </term> <description> 
         
        FromCharacteristic </description> </item> 

        <item><term> 
         
        PreviewToggle </term> <description> 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  ModelTerminalsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the @link NXOpen::Routing::MultiPort NXOpen::Routing::MultiPort@endlink  of the selected object
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
            public: NXOpen::NXObject * MultiPort
            (
            );
            /**Sets  the @link NXOpen::Routing::MultiPort NXOpen::Routing::MultiPort@endlink  of the selected object
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_harness ("Routing Harness") */
