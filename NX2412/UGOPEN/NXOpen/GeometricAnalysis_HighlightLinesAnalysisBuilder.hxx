        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  HighlightLinesAnalysisBuilder : public NXOpen::Builder
        {
            ...
            */
            ...
            {
                OutputOptionAnalysisObject/** Analysis Object */,
                OutputOptionHighlightCurves/** Highlight Curves */,
                OutputOptionBoth/** Both Analysis Object and Highlight Curves */
            };

            /** analysis display options */
            public: enum DisplayModes
            {
                DisplayModesPolyline/** Polyline */,
                DisplayModesZebraMap/** Zebra Map */
            };

            /** reference direction options */
            public: enum IsoclineDirection
            {
                IsoclineDirectionVector/** vector; */,
                IsoclineDirectionOrientation/** orientation; */
            };
            ...
            /**Returns  the display method 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::Type2 instead.") NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::DisplayMethods DisplayMethod
            (
            );
            /**Sets  the display method 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::SetType2 instead.") void SetDisplayMethod
            (
            ...
            /**Returns  the type 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::LightPlacement instead.") NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::Types Type
            (
            );
            /**Sets  the type 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::SetLightPlacement instead.") void SetType
            (
            ...
            /**Returns  the output 
             ...
             <br> License requirements : None */
            public: NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::OutputOption Output
            (
            );
            /**Sets  the output 
             <br>  Created in NX2206.0.0.  <br>  
            ...
            (
                NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::OutputOption output /** output */ 
            );
            /**Returns  the analysis display 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::DisplayModes DisplayMode
            (
            );
            /**Sets  the analysis display 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: void SetDisplayMode
            (
                NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::DisplayModes display /** display */ 
            );
            /**Returns  the isocline reference direction 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::IsoclineDirection IsoclineOption
            (
            );
            /**Sets  the isocline reference direction 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: void SetIsoclineOption
            (
                NXOpen::GeometricAnalysis::HighlightLinesAnalysisBuilder::IsoclineDirection option /** option */ 
            );
            /**Returns  the isocline origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point3d IsoclineOrigin
            (
            );
            /**Sets  the isocline origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: void SetIsoclineOrigin
            (
                const NXOpen::Point3d & isoclineOrigin /** isoclineorigin */ 
            );
            /**Returns  the isocline orirentation 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Matrix3x3 IsoclineOrientation
            (
            );
            /**Sets  the isocline orirentation 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : studio_analyze ("STUDIO ANALYZE") */
            public: void SetIsoclineOrientation
            (
                const NXOpen::Matrix3x3 & isoclineOrientation /** isoclineorientation */ 
            );
        };
    }
}
