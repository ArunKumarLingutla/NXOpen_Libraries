...
#include <NXOpen/Features_SheetMetal_BulgeReliefBuilder.hxx>
#include <NXOpen/Features_SheetMetal_ExportFlatPatternBuilder.hxx>
#include <NXOpen/Features_SheetMetal_NestingBuilder.hxx>
#include <NXOpen/Features_SheetMetal_VariationalFlangeBuilder.hxx>
        ...
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SheetmetalManager
            {
                ...
                /** Creates a @link NXOpen::Features::SheetMetal::BulgeReliefBuilder NXOpen::Features::SheetMetal::BulgeReliefBuilder@endlink  
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: NXOpen::Features::SheetMetal::BulgeReliefBuilder * CreateBulgeReliefBuilder
                (
                    NXOpen::Features::Feature * bulgeRelief /** bulgerelief */ 
                );
                /** Creates a @link NXOpen::Features::SheetMetal::VariationalFlangeBuilder NXOpen::Features::SheetMetal::VariationalFlangeBuilder@endlink  
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : adv_sheet_metal_dsgn ("ADVANCED SHEET METAL DESIGN") */
                public: NXOpen::Features::SheetMetal::VariationalFlangeBuilder * CreateVariationalFlangeBuilder
                (
                    NXOpen::Features::Feature * variationalFlange /** variationalflange */ 
                );
