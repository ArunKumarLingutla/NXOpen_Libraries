...
namespace NXOpen
{
    ...
    namespace UserDefinedObjects
    {
        ...
        */
        class NXOPENCPP_USERDEFINEDOBJECTSEXPORT  UserDefinedObjectDisplayContext : public NXOpen::TransientObject
        {
            ...
            {
                ViewModeNotShaded/** The view is not shaded */ = 1,
            ...
            {
                DisplayModeWireframe/** Wireframe mode display */ = 1,
                DisplayModeShaded/** Shaded mode display */,
                DisplayModeStudio/** Studio mode display */,
                DisplayModeAnalysis/** Analysis mode display */
            };

            public: /** Prototype for user defined primitive display callback.
            ...
            typedef NXOpen::Callback2<int, NXOpen::UserDefinedObjects::UserDefinedObjectGraphicsContext *, NXOpen::UserDefinedObjects::UserDefinedObject *> PrimitiveRenderCallback;
            ...
            (
                const NXString & text /**  Text string to display */,
            ...
            /** Displays a user defined primitive in a specified display mode. A user defined primitive defined with
             ...
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void DisplayUserDefinedPrimitive
            (
                NXOpen::UserDefinedObjects::UserDefinedObjectDisplayContext::DisplayMode displayMode /** primitive display mode */,
                const NXOpen::UserDefinedObjects::UserDefinedObjectDisplayContext::PrimitiveRenderCallback&  displayCallbackFn /** Callbacks for primitive rendering */
            );
