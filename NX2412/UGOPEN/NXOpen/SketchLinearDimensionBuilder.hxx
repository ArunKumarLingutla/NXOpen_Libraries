...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchLinearDimensionBuilder : public NXOpen::Annotations::BaseLinearDimensionBuilder
    {
        ...
        /** Converts a perpendicular dimension to a half diameter or cylindrical dimension 
                The dimension's value will become double the original value.
                The dimension will display as single-sided if updateStyle is true.
        ...
        public: void ConvertToHalfDiameter
        (
            bool updateStyle /** updatestyle */ 
        );
        /** Converts a half diameter or cylindrical dimension to a perpendicular dimension 
                The dimension's value will become half the original value.
                The dimension will display as double-sided if updateStyle is true. 
                This method should be followed by a subsequent call to @link NXOpen::Update::DoUpdate NXOpen::Update::DoUpdate@endlink .
                
         <br>  Created in NX2007.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") */
        public: void ConvertFromHalfDiameter
        (
            bool updateStyle /** updatestyle */ 
        );
    };
