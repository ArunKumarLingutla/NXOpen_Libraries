...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  DirectionCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::Direction *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Direction **;
            using reference = NXOpen::Direction *&;
        ...
        /** Creates a @link NXOpen::Direction NXOpen::Direction@endlink  normal to a @link NXOpen::Face NXOpen::Face@endlink  at a
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : nx_atlas_testlab_api ("Testlab worker - STS") OR solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDirection
        (
        ...
        /** Creates a @link NXOpen::Direction NXOpen::Direction@endlink  whose direction is given by the cross product of 
               the first input @link NXOpen::Direction NXOpen::Direction@endlink  with the second input 
               @link NXOpen::Direction NXOpen::Direction@endlink .  @return   
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDirection
        ...
        /** Creates a @link NXOpen::Direction NXOpen::Direction@endlink  using the normal of a closest face from
               @link NXOpen::ScCollector NXOpen::ScCollector@endlink  having @link NXOpen::Face NXOpen::Face@endlink  at a @link NXOpen::Point NXOpen::Point@endlink .
        ...
        public: NXOpen::Direction * CreateDirection
        (
            NXOpen::ScCollector * faces /** The collector will contain the faces or a datum plane.*/,
            NXOpen::Point * point /** The point will be used to calculate closest face and direction will be shown at this point.*/,
            NXOpen::Sense sense /** sense */ ,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a dumb @link NXOpen::Direction NXOpen::Direction@endlink  using the normal of planar
               or axis of conic @link NXOpen::Face NXOpen::Face@endlink   @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDumbDirectionFace
        (
            NXOpen::IParameterizedSurface * face /** face */ ,
            NXOpen::Sense sense /** sense */ ,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a dumb @link NXOpen::Direction NXOpen::Direction@endlink  using the normal of non-planar
               @link NXOpen::Face NXOpen::Face@endlink  at a @link NXOpen::Point NXOpen::Point@endlink   @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDumbDirectionFaceAtPoint
        (
            NXOpen::IParameterizedSurface * face /** face */ ,
            NXOpen::Point * point /** point */ ,
            NXOpen::Sense sense /** sense */ ,
        ...
        /** Creates a dumb @link NXOpen::Direction NXOpen::Direction@endlink  on a @link NXOpen::ICurve NXOpen::ICurve@endlink  
               at a @link NXOpen::Point NXOpen::Point@endlink .  @return   
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDumbDirectionOnCurveAtPoint
        (
            NXOpen::IBaseCurve * icurve /** icurve */ ,
            NXOpen::Point * point /** point */ ,
            NXOpen::Direction::OnCurveOption option /** option */ ,
        ...
        /** Creates a dumb @link NXOpen::Direction NXOpen::Direction@endlink  using the axis of a conic (@link NXOpen::Edge NXOpen::Edge@endlink ).   @return   
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDumbDirectionAxisOfConic
        (
            NXOpen::IBaseCurve * conic /** conic */ ,
            NXOpen::Sense sense /** sense */ ,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a dumb @link NXOpen::Direction NXOpen::Direction@endlink  using the normal of a closest face from
               @link NXOpen::ScCollector NXOpen::ScCollector@endlink  having @link NXOpen::Face NXOpen::Face@endlink  at a @link NXOpen::Point NXOpen::Point@endlink .
               The normal direction will be calculated on the closest face to the given input point out of the given input  
               faces in the collector. The direction will be shown at the specified input point, normal to the location on  
               this face that is nearest to the input point. The input collector must not contain mixed selection of faces
               and datum plane. Multiple datum planes are not allowed and the faces in collector must be contiguous. 
               Note: This API should be used only when creating a dumb direction in modeling application.  
            @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") */
        public: NXOpen::Direction * CreateDumbDirectionFacesAtPoint
        (
            NXOpen::ScCollector * faces /** The collector will contain the faces or a datum plane.*/,
            NXOpen::Point * point /** The point will be used to calculate closest face and direction will be shown at this point.*/,
            NXOpen::Sense sense /** sense */ ,
