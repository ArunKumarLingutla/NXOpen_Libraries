        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  Explosion : public NXOpen::NXObject
        {
            ...
            /** Attempts to auto explode the given array of @link NXOpen::Assemblies::ExplodedComponent  NXOpen::Assemblies::ExplodedComponent @endlink  to given distance in @link NXOpen::Assemblies::Explosion NXOpen::Assemblies::Explosion@endlink .
             ...
             <br>  @deprecated Deprecated in NX2412.0.0.  auto_explode_selected_components <br>  

             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  auto_explode_selected_components") int AutoExplodeComponents
            (
            ...
            /** Attempts to auto explode all @link NXOpen::Assemblies::ExplodedComponent NXOpen::Assemblies::ExplodedComponent@endlink  to given distance in @link NXOpen::Assemblies::Explosion NXOpen::Assemblies::Explosion@endlink .
             ...
             <br>  @deprecated Deprecated in NX2412.0.0.  auto_explode_all_components <br>  

             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  auto_explode_all_components") int AutoExplodeAssembly
            (
                double autoExplodeDistance /** autoexplodedistance */ 
            );
            ...
            /** Attempts to auto explode the given array of @link NXOpen::Assemblies::ExplodedComponent  NXOpen::Assemblies::ExplodedComponent @endlink  in @link NXOpen::Assemblies::Explosion NXOpen::Assemblies::Explosion@endlink  
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: int AutoExplodeSelectedComponents
            (
                bool useAdditionalDirections /** useadditionaldirections */ ,
                const std::vector<NXOpen::Assemblies::ExplodedComponent *> & selectedComponents /** selectedcomponents */ 
            );
            /** Attempts to auto explode all leaf components of assembly which is not hidden or suppressed in @link NXOpen::Assemblies::Explosion NXOpen::Assemblies::Explosion@endlink  
                        with or without using additional directions from components local CSYS and constraints.
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: int AutoExplodeAllComponents
            (
                bool useAdditionalDirections /** useadditionaldirections */ 
            );
        };
