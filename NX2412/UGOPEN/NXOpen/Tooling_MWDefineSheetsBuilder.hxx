    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MWDefineSheetsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns   the solid bodies as product 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectBodyList * SelectProductBodies
            (
            );
            /**Returns   the solid body as workpiece
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectBody * SelectWorkpieceBody
            (
            );
            /** Method to remove cut solid attribute after suppress parting 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void RemoveCutSolidAttributeAfterSuppressParting
            (
            );
        };
    }
