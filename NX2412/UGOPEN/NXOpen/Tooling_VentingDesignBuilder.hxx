    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  VentingDesignBuilder : public NXOpen::Builder
        {
            ...
            public: enum Action
            {
                ActionStandardVent/** Standard Vent. */,
                ActionSimpleVent/** simple line Vent. */,
                ActionPinInsertVent/** Vent used for ejector pin or insert. */,
            ...
            public: enum ResultType
            {
                ...
                ResultTypeSubtractFace/** Create vent face. */
            };
            ...
            /**Returns  the end faces of ejector pin or insert 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * EndFace
            (
            );
            /**Returns  the value which specifies the reference plane for venting curves layout.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Plane * PlaneOnTheFly
            (
            );
            /**Sets  the value which specifies the reference plane for venting curves layout.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetPlaneOnTheFly
            (
            ...
            /**Returns  the option which specifies the orient work view.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: int OrientWorkView
            (
            );
            /**Sets  the option which specifies the orient work view.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetOrientWorkView
            (
                int allowflag /** allowflag */ 
            );
            ...
            /** Restruct one guide loops when it's vent curve was selected to edit. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void UpdateAGuideLoop
            (
                NXOpen::NXObject * editedCurve /** editedcurve */ 
            );
            /** Update the base reference plane location after a datum plane is specified. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            ...
            /** Updates the end face and return the outer face edge. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void UpdateEndFace
            (
                std::vector<NXOpen::TaggedObject *> & referEdges /** referedges */ 
            );
            /** Set reference ceter location flag. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetIsReferCenter
            (
                bool isReferCenter /** isrefercenter */ 
            );
            /** Create the normal curve of the edited second level loop. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Curve * CreateSecondNormalCurve
            (
                NXOpen::Curve * secondLoopCurve /** secondloopcurve */ ,
                const NXOpen::Point3d & middlePt /** middlept */ ,
