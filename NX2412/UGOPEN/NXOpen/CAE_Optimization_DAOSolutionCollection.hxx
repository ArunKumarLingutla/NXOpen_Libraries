        ...
        namespace Optimization
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  DAOSolutionCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::Optimization::DAOSolution *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::Optimization::DAOSolution **;
                    using reference = NXOpen::CAE::Optimization::DAOSolution *&;
