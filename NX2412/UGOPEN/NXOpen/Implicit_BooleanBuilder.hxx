...
namespace NXOpen
{
    ...
    namespace Implicit
    {
        ...
        */
        ...
        {
            /** Blend Methods*/
            public: enum BlendMethodType
            {
                BlendMethodTypeContinuous/** Creates a nearly curvature continuous blend. */,
                BlendMethodTypeRound/** Creates a rolling ball like blend. */,
                BlendMethodTypeChamfer/** chamfer */ 
            };
            ...
            /**Returns  the blend method 
             ...
             <br> License requirements : None */
            public: NXOpen::Implicit::BooleanBuilder::BlendMethodType BlendMethod
            (
            );
            /**Sets  the blend method 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_implicit (" NX Implicit Modeling") */
            public: void SetBlendMethod
            (
                NXOpen::Implicit::BooleanBuilder::BlendMethodType blendMethod /** blendmethod */ 
            );
            ...
            /** The blend region
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: double ComputeBlendRegion
            (
            );
        };
    }
