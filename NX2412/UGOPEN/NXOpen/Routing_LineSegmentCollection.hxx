...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a collection of @link NXOpen::Routing::LineSegment NXOpen::Routing::LineSegment@endlink  objects.  <br> To obtain an instance of this class, refer to @link NXOpen::Routing::SegmentManager  NXOpen::Routing::SegmentManager @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  LineSegmentCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Routing::LineSegment *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Routing::LineSegment **;
                using reference = NXOpen::Routing::LineSegment *&;
