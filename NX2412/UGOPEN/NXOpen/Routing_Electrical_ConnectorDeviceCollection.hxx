        ...
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ConnectorDeviceCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::Routing::Electrical::ConnectorDevice *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::Routing::Electrical::ConnectorDevice **;
                    using reference = NXOpen::Routing::Electrical::ConnectorDevice *&;
                ...
                /** Returns Splice @link NXOpen::Routing::Electrical::ConnectorDevice NXOpen::Routing::Electrical::ConnectorDevice@endlink , based on the name provided.  @return  
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced") */
                public: NXOpen::Routing::Electrical::ConnectorDevice * GetSpliceConnectorDevice
                (
                ...
                /** Returns Splice @link NXOpen::Routing::Electrical::ConnectorDevice NXOpen::Routing::Electrical::ConnectorDevice@endlink , based on the name provided.  @return  
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced") */
                NXOpen::Routing::Electrical::ConnectorDevice * GetSpliceConnectorDevice
                (
