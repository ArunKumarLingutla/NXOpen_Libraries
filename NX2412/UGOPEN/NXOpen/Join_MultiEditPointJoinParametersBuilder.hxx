    ...
    namespace Join
    {
        ...
        */
        class JOINOPENCPPEXPORT  MultiEditPointJoinParametersBuilder : public NXOpen::Builder
        {
            ...
            /** Creates linked curve feature in work part. Linked curve feature is reorded before input feature  @return  newly created linked curve 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") */
            public: NXOpen::ICurve * CreateLinkedCurve
            (
                NXOpen::ICurve * object /** curve or edge used to create linked curve feature */,
                NXOpen::Features::Feature * feature /** feature used to reorder linked curve feature */
            );
        };
    }
}
