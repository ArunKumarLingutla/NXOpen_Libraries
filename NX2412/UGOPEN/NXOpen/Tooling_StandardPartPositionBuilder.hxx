    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  StandardPartPositionBuilder : public NXOpen::Builder
        {
            ...
            /** Reads data from concept object and set it in builder . 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void PopulateDataFromConceptObject
            (
            );
            /** Sets the current orientation of the standard part . 
            ...
            /** Asks position from the current standard part 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void AskStandardPartPosition
            (
                NXOpen::Point3d* originalPoint /** originalpoint */ ,
