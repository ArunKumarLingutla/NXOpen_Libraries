    ...
    */
    class NXOPENCPPEXPORT  SmartObject : public NXOpen::DisplayableObject
    {
        ...
        /** Removes the smart object parameters. 
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR studio_free_form ("STUDIO FREE FORM") */
        ...
        /** Copies the smart object. 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::SmartObject * Copy
        (
        );
    };
}
