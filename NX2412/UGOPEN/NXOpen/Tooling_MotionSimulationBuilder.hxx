...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AvoidMountChildren </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CamDefinitionMethod (deprecated) </term> <description> 
         
        AutomaticalDefinedCam </description> </item> 

        <item><term> 
         
        CrankRadius.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CsysVisibility </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DiePitch.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DiePitch02.Value </term> <description> 
         
        10.0 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        EjectionMotionStartAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        EjectionMotionStopAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        EjectionStartAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        EjectorMoveOption </term> <description> 
         
        After </description> </item> 

        <item><term> 
         
        HideMotionItem </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        IncludeBlank </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        IsDataFileValid </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        IsRemoveCurrentKinematicModel </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LiftHeight.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LiftHeight02.Value </term> <description> 
         
        10.0 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        MachineStroke.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        MoldOpenAngle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        MountingTolerance.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ProductMoveUpDistance.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        RelativeMotion </term> <description> 
        ...
        SafeDistance </term> <description> 
         
        2 </description> </item> 

        <item><term> 
         
        StripTravel.Value </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        StrokeAngleStep.Value </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        StrokePerMinute </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TransferEndAngle.Value </term> <description> 
         
        250 </description> </item> 

        <item><term> 
         
        TransferStartAngle.Value </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MotionSimulationBuilder : public NXOpen::Builder
        {
            ...
            public: enum Types
            {
                ...
                TypesSafeDistanceConfig/** Adds components to check safe distance*/
            };
            ...
            /**Returns  the ejection start angle 
             ...
             <br> License requirements : None */
            public: double EjectionMotionStartAngle
            (
            );
            /**Sets  the ejection start angle 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void SetEjectionMotionStartAngle
            (
                double ejectionMotionStartAngle /** ejectionmotionstartangle */ 
            );
            /**Returns  the ejection stop angle 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double EjectionMotionStopAngle
            (
            );
            /**Sets  the ejection stop angle 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void SetEjectionMotionStopAngle
            (
                double ejectionMotionStopAngle /** ejectionmotionstopangle */ 
            );
            /**Returns  the mold product move up distance 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ProductMoveUpDistance
            (
            );
            /**Returns  the tolerance to control the accuracy of facet bodies created when mounting 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MountingTolerance
            (
            );
            ...
            /**Returns  the attribute value, which specifies whether to reread configure data or not 
             ...
             <br> License requirements : None */
            public: bool ReReadConfigData
            (
            );
            /**Sets  the attribute value, which specifies whether to reread configure data or not 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void SetReReadConfigData
            (
                bool reReadConfigData /** rereadconfigdata */ 
            );
            /**Returns  the targets components to assign safe distance. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectBodyList * SafeDisComponent
            (
            );
            /**Returns  the tool component to assign safe distance. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectBodyList * SafeDisTargetComponent
            (
            );
            ...
            (
                double safeDistance /** safedistance */ 
            );
            /** Add safe distance attribute 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void AddSafeDistanceAttribute
            (
                bool editEixstChecker /** editeixstchecker */ 
            );
            /** Remove safe distance attribute 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void RemoveSafeDistanceAttibute
            (
            ...
            /** Edit safe value of special distance checker item 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void EditTargetSafeDistance
            (
                const NXString & selectedLabel /** selectedlabel */ ,
                double safeValue /** safevalue */ 
            );
            /** Edit safe value of special distance checker item 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            void EditTargetSafeDistance
            (
                const char * selectedLabel /** selectedlabel */ ,
                double safeValue /** safevalue */ 
            );
            /** Delet safe distance item 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: void DeleteTargetSafeDistanceItem
            (
            ...
            /** Delet safe distance item 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            void DeleteTargetSafeDistanceItem
            (
