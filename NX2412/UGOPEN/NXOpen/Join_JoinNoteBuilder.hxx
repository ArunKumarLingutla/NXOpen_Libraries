...
namespace NXOpen
{
    ...
    namespace Join
    {
        ...
        */
        ...
        {
            /** The precision used for real number attributes. */
            public: enum AttrPrecision
            {
                AttrPrecisionZero/** Numeric attribute will have 0 digits after the decimal. */,
                AttrPrecisionOne/** Numeric attribute will have 1 digit after the decimal. */,
                AttrPrecisionTwo/** Numeric attribute will have 2 digits after the decimal. */,
                AttrPrecisionThree/** Numeric attribute will have 3 digits after the decimal. */,
                AttrPrecisionFour/** Numeric attribute will have 4 digits after the decimal. */,
                AttrPrecisionFive/** Numeric attribute will have 5 digits after the decimal. */,
                AttrPrecisionSix/** Numeric attribute will have 6 digits after the decimal. */
            };
            ...
            /**Returns  the numeric precision used for numbers in PMI 
             ...
             <br> License requirements : None */
            public: NXOpen::Join::JoinNoteBuilder::AttrPrecision Precision
            (
            );
            /**Sets  the numeric precision used for numbers in PMI 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") OR nx_join_structures (" Automated Structure Join") */
            public: void SetPrecision
            (
                NXOpen::Join::JoinNoteBuilder::AttrPrecision leader /** leader */ 
            );
        };
    }
}
