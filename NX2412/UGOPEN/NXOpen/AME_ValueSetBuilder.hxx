    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  ValueSetBuilder : public NXOpen::Builder
        {
            ...
            public: NXOpen::NXObject * AddEplanPropertyToValueSet
            (
                NXOpen::NXObject * valueSet /** valueset */ ,
                NXOpen::NXObject * propertyOwner /** propertyowner */ ,
                const NXString & propertyName /** propertyname */ ,
                const NXString & propertyCategory /** propertycategory */ ,
                NXOpen::NXObject * eplanValueSet /** eplanvalueset */ ,
                const NXString & placeHolderName /** placeholdername */ ,
                bool isNewPlaceHolder /** isnewplaceholder */ 
            );
            /**  The method  to allow a new property to be added to the eplan value set 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_eplan_addon ("AUTOMATION DESIGNER EPLAN ADDON") */
            NXOpen::NXObject * AddEplanPropertyToValueSet
            (
                NXOpen::NXObject * valueSet /** valueset */ ,
                NXOpen::NXObject * propertyOwner /** propertyowner */ ,
                const char * propertyName /** propertyname */ ,
                const char * propertyCategory /** propertycategory */ ,
                NXOpen::NXObject * eplanValueSet /** eplanvalueset */ ,
                const char * placeHolderName /** placeholdername */ ,
                bool isNewPlaceHolder /** isnewplaceholder */ 
            );
        };
    }
