        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates a @link NXOpen::Features::SweptBuilder NXOpen::Features::SweptBuilder@endlink   @return  
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::Features::FreeformSurfaceCollection::CreateSweptBuilder1 NXOpen::Features::FreeformSurfaceCollection::CreateSweptBuilder1@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::Features::FreeformSurfaceCollection::CreateSweptBuilder1 instead.") NXOpen::Features::SweptBuilder * CreateSweptBuilder
            (
            ...
            /** Creates a @link NXOpen::Features::ThroughCurvesBuilder NXOpen::Features::ThroughCurvesBuilder@endlink   @return  ThroughCurvesBuilder object
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::Features::FreeformSurfaceCollection::CreateThroughCurvesBuilder1 NXOpen::Features::FreeformSurfaceCollection::CreateThroughCurvesBuilder1@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::Features::FreeformSurfaceCollection::CreateThroughCurvesBuilder1 instead.") NXOpen::Features::ThroughCurvesBuilder * CreateThroughCurvesBuilder
            (
            ...
            /** Creates a Studio Surface Builder  @return  StudioSurfaceBuilder
                object 
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::Features::FreeformSurfaceCollection::CreateStudioSurfaceBuilder1 NXOpen::Features::FreeformSurfaceCollection::CreateStudioSurfaceBuilder1@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::Features::FreeformSurfaceCollection::CreateStudioSurfaceBuilder1 instead.") NXOpen::Features::StudioSurfaceBuilder * CreateStudioSurfaceBuilder
            (
            ...
            /** Creates a delete face builder, don't use it until nx502  @return  Features.DeleteFaceBuilder object 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_synchronous ("NX Synchronous"), solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a Ruled Surface builder  @return  
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::Features::FreeformSurfaceCollection::CreateRuledBuilder1 NXOpen::Features::FreeformSurfaceCollection::CreateRuledBuilder1@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::Features::FreeformSurfaceCollection::CreateRuledBuilder1 instead.") NXOpen::Features::RuledBuilder * CreateRuledBuilder
            (
            ...
            /** Creates a @link NXOpen::Features::SectionEditBuilder NXOpen::Features::SectionEditBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_synchronous ("NX Synchronous"), solid_modeling ("SOLIDS MODELING") */
            ...
            /** Creates a @link NXOpen::Features::MidSurfaceBuilder NXOpen::Features::MidSurfaceBuilder@endlink   @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::MidSurfaceBuilder * CreateMidSurfaceBuilder
            (
                NXOpen::Features::Feature * midSurface /** @link NXOpen::Features::MidSurface NXOpen::Features::MidSurface@endlink  to be edited or a @link NXOpen::Features::MidSurface NXOpen::Features::MidSurface@endlink  */
            );
            /** Creates a @link NXOpen::Features::MidSurfaceByTwoSheetsBuilder NXOpen::Features::MidSurfaceByTwoSheetsBuilder@endlink   @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::MidSurfaceByTwoSheetsBuilder * CreateMidSurfaceByTwoSheetsBuilder
            (
                NXOpen::Features::Feature * midSurfaceByTwoSheets /** @link NXOpen::Features::MidSurfaceByTwoSheets NXOpen::Features::MidSurfaceByTwoSheets@endlink  to be edited or a @link NXOpen::Features::MidSurfaceByTwoSheets NXOpen::Features::MidSurfaceByTwoSheets@endlink  */
            );
            ...
            /** Creates a @link Features::ThreadBuilder Features::ThreadBuilder@endlink   @return  
             ...
             <br> License requirements : features_modeling ("FEATURES MODELING") OR solid_modeling ("SOLIDS MODELING") */
            ...
            /** Convert all features in the part to use the latest split algorithm. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void ConvertToLatestSplitAlgorithm
            (
            );
            /** Creates a @link Features::ContourRibBuilder Features::ContourRibBuilder@endlink   @return  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ContourRibBuilder * CreateContourRibBuilder
            (
                NXOpen::Features::ContourRib * contourRib /** @link Features::ContourRib Features::ContourRib@endlink  to be edited */
            );
            /** Creates a @link Features::CombinePatternBuilder Features::CombinePatternBuilder@endlink   @return  
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::Features::FeatureCollection::CreatePatternBodyBuilder NXOpen::Features::FeatureCollection::CreatePatternBodyBuilder@endlink  instead. <br>  

             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Features::FeatureCollection::CreatePatternBodyBuilder instead.") NXOpen::Features::CombinePatternBuilder * CreateCombinePatternBuilder
            (
                NXOpen::Features::CombinePattern * combinePattern /** @link Features::CombinePattern Features::CombinePattern@endlink  to be edited */
            );
            /** Creates a @link Features::CenterlineBuilder Features::CenterlineBuilder@endlink   @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::CenterlineBuilder * CreateCenterlineBuilder
            (
                NXOpen::Features::Centerline * centerlineFeature /** @link Features::Centerline Features::Centerline@endlink  to be edited */
            );
            /** Creates a @link Features::ChangeFaceBuilder Features::ChangeFaceBuilder@endlink   @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ChangeFaceBuilder * CreateChangeFaceBuilder
            (
                NXOpen::Features::ChangeFace * changeFace /** @link Features::ChangeFace Features::ChangeFace@endlink  to be edited */
            );
            /** Creates a @link Features::PatternBodyBuilder Features::PatternBodyBuilder@endlink   @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::PatternBodyBuilder * CreatePatternBodyBuilder
            (
                NXOpen::Features::PatternBody * combinePattern /** @link Features::PatternBody Features::PatternBody@endlink  to be edited */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: void DoLoggingToMakeFeaturesUpToDate
            (
                const std::vector<NXOpen::Features::Feature *> & features /** @link NXOpen::Features::Feature NXOpen::Features::Feature@endlink  to be made up to date.*/
            );

            /// \endcond 
            /** Creates a @link Features::GroupEdgeBuilder Features::GroupEdgeBuilder@endlink   @return  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::GroupEdgeBuilder * CreateGroupEdgeBuilder
            (
                NXOpen::Features::GroupEdge * groupEdge /** @link Features::GroupEdge Features::GroupEdge@endlink  to be edited */
            );
            /** Creates a @link Features::GroupBodyBuilder Features::GroupBodyBuilder@endlink   @return  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::GroupBodyBuilder * CreateGroupBodyBuilder
            (
                NXOpen::Features::GroupBody * groupBody /** @link Features::GroupBody Features::GroupBody@endlink  to be edited */
            );
            /** Creates a @link Features::ImprintObjectBuilder Features::ImprintObjectBuilder@endlink   @return  
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ImprintObjectBuilder * CreateImprintObjectBuilder
            (
                NXOpen::Features::ImprintObject * imprintObject /** @link Features::ImprintObject Features::ImprintObject@endlink  to be edited */
            );
            /** Creates a @link Features::StepExpressionBuilder Features::StepExpressionBuilder@endlink   @return  
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::StepExpressionBuilder * CreateStepExpressionBuilder
            (
                NXOpen::Expression * stepExpression /** @link Expression Expression@endlink  to be edited */,
                NXOpen::Features::Feature * owningFeature /** @link Features::Feature Features::Feature@endlink  */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::CMODTestFeatureBuilder * CreateCmodtestFeatureBuilder
            (
                NXOpen::Features::CMODTestFeature * cmodtestFeature /** @link Features::CMODTestFeature Features::CMODTestFeature@endlink  to be edited */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::LinkLargeScaleGeometryBuilder * CreateLinkLargeScaleGeometryBuilder
            (
                NXOpen::Features::LinkLargeScaleGeometry * linkLargeScaleGeometry /** @link Features::LinkLargeScaleGeometry Features::LinkLargeScaleGeometry@endlink  Feature to be edited */
            );
            ...
            */
            ...
            /** Returns the AECDesignCollection instance belonging to this part 
             <br>  Created in NX2007.0.0.  <br>  
            */
            public: NXOpen::Features::AECDesignCollection *AECDesignCollection();
            /** Returns the GCToolsFeatureCollection instance belonging to this part 
             <br>  Created in NX2312.0.0.  <br>  
            */
            public: NXOpen::Features::GCToolsFeatureCollection *GCToolsFeatureCollection();
