    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  Dimension : public NXOpen::Annotations::Annotation, public virtual NXOpen::Annotations::IAppendedText
        {
            ...
            /** 
             <br>  @deprecated Deprecated in NX8.0.0.  Use @link NXOpen::Annotations::Dimension::SetDimensionText NXOpen::Annotations::Dimension::SetDimensionText@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX8.0.0.  Use NXOpen::Annotations::Dimension::SetDimensionText instead.") void SetComputedSize
            (
            ...
            /**Returns  a setting to control the shaft upper tolerance value of a dimension. 
             ...
             <br> License requirements : None */
            public: double ShaftUpperToleranceValue
            (
            );
            /**Returns  a setting to control the shaft lower tolerance value of a dimension. 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : None */
            public: double ShaftLowerToleranceValue
            (
            );
            ...
            /** Unretain the dimension if it no longer has an inconsistent silhouette as the indexed associativity 
             ...
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void UnretainForInconsistentSilhouette
            (
                int index /** index */
            );
