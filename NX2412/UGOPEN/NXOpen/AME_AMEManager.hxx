...
#include <NXOpen/AME_AddEplanPropertyBuilder.hxx>
#include <NXOpen/AME_AddEplanValueSetBuilder.hxx>
#include <NXOpen/AME_AddPlaceholderBuilder.hxx>
#include <NXOpen/AME_AddPlcOperatorBuilder.hxx>
...
#include <NXOpen/AME_AspectBox.hxx>
#include <NXOpen/AME_AspectBoxBuilder.hxx>
...
#include <NXOpen/AME_BulkEditAnnotationBuilder.hxx>
...
#include <NXOpen/AME_ChangeProductTypeBuilder.hxx>
#include <NXOpen/AME_ChangeSymbolVariantBuilder.hxx>
...
#include <NXOpen/AME_CreateEplanNodeBuilder.hxx>
...
#include <NXOpen/AME_CreateReportBuilder.hxx>
#include <NXOpen/AME_CreateRuleSetBuilder.hxx>
#include <NXOpen/AME_CreateSystemIDBBuilder.hxx>
...
#include <NXOpen/AME_DrawingStandardSettingsBuilder.hxx>
#include <NXOpen/AME_DxfdwgExportBuilder.hxx>
#include <NXOpen/AME_EditAnnotationBuilder.hxx>
#include <NXOpen/AME_EditClauseBuilder.hxx>
#include <NXOpen/AME_EditDisplaySettingsBuilder.hxx>
...
#include <NXOpen/AME_ImportEplanMappingBuilder.hxx>
#include <NXOpen/AME_ImportEplanPageMacroBuilder.hxx>
#include <NXOpen/AME_ImportEplanProductBuilder.hxx>
#include <NXOpen/AME_ImportEplanProductListBuilder.hxx>
...
#include <NXOpen/AME_InterfaceMemberBuilder.hxx>
...
#include <NXOpen/AME_ManageDimensionPointsBuilder.hxx>
#include <NXOpen/AME_ManageEclassMappingBuilder.hxx>
#include <NXOpen/AME_ManageEplanGlobalMappingBuilder.hxx>
#include <NXOpen/AME_ManageEplanMappingBuilder.hxx>
...
#include <NXOpen/AME_PlcEditStateNoteBuilder.hxx>
#include <NXOpen/AME_PlcFlowChartConstantTextBuilder.hxx>
#include <NXOpen/AME_PlcFlowChartOperatorBuilder.hxx>
#include <NXOpen/AME_PlcFunctionBlockBuilder.hxx>
#include <NXOpen/AME_PlcInterfaceVariable.hxx>
...
#include <NXOpen/AME_PlcStateChartActionBuilder.hxx>
#include <NXOpen/AME_PlcStateChartCreateElementBuilder.hxx>
#include <NXOpen/AME_PlcStateChartDefineCallBuilder.hxx>
#include <NXOpen/AME_PlcStateChartFunctionBlockBuilder.hxx>
#include <NXOpen/AME_PlcStateChartItemValueBuilder.hxx>
#include <NXOpen/AME_PlcStateChartStateBuilder.hxx>
#include <NXOpen/AME_PlcStateChartTransitionBuilder.hxx>
#include <NXOpen/AME_PlcStateChartTransitionPrioritiesBuilder.hxx>
...
#include <NXOpen/AME_PlcTelegramDefinition.hxx>
...
#include <NXOpen/AME_PrimitiveSheetElementBuilder.hxx>
...
#include <NXOpen/AME_ProductPropertyRulesBuilder.hxx>
...
#include <NXOpen/AME_SmartPDFPrintPagesBuilder.hxx>
...
#include <NXOpen/AME_UpdateLibraryObjectsBuilder.hxx>
#include <NXOpen/AME_UpdateObjectsBuilder.hxx>
#include <NXOpen/AME_ValueSetBuilder.hxx>
#include <NXOpen/AME_VariableInterfaceMemberPort.hxx>
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class VariableInterfaceMemberPort;
    }
    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  AMEManager
        {
            ...
            /** Represents the type of a native library*/
            public: enum JaNativeLibType
            {
                JaNativeLibTypeAll/** enables a lookup call to iterate through every known library type */,
                JaNativeLibTypeType/** type objects from type library */,
                JaNativeLibTypeProduct/** product objects from product library */,
                JaNativeLibTypeSymbol/** symbol objects from symbol library */,
                JaNativeLibTypeTemplate/** template objects from template library */,
                JaNativeLibTypeSetting/** setting objects from settings library */,
                JaNativeLibTypeConnection/** connection objects from connection library */,
                JaNativeLibTypePort/** port objects from port library */,
                JaNativeLibTypeFormSheet/** form sheet objects from form sheet library */,
                JaNativeLibTypeSystem/** system objects from system library*/,
                JaNativeLibTypeReportTemplate/** report template objects from report templates library */,
                JaNativeLibTypeReportDefinition/** report definition objects from report templates definition */
            };
            ...
            */
            ...
            /** Load external objects 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_mechanical_collab ("AUTOMATION DESIGNER MECH COLLABORATION ADDON") */
            ...
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::ExtractAttribute * extractAttribute /** extractattribute */ 
            );
            ...
            /** Creates a @link NXOpen::AME::ManageEplanMappingBuilder NXOpen::AME::ManageEplanMappingBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ManageEplanMappingBuilder * CreateManageEplanmappingBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            ...
            /** Creates a @link NXOpen::AME::CabinetDesignBuilder NXOpen::AME::CabinetDesignBuilder@endlink  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_cabinet_addon ("AUTOMATION DESIGNER CABINET ADDON") */
            ...
            /** Creates a @link AME::UpdateLibraryObjectsBuilder AME::UpdateLibraryObjectsBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::UpdateLibraryObjectsBuilder * CreateUpdateLibraryObjectsBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            ...
            /** Capture a symbol's preview image and assign it to currently active symbol variant 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void CaptureSymbolImage
            (
                NXOpen::Part * part /** smybol part we want to capture an image from, it needs to contain symbol information otherwise it will be rejected */,
                double margin /** distance between the symbol's bounding box to the border of the screen shoted area, a margin bellow 0 is not valid */,
                int scaledPixelHeight /** targeted height of pixels the caputed image gets rescaled to, on 0 rescaling is turned off */,
                double zoomFactor /** value 1.0 causes to captute symbol's bounding box + margin only, any higher factor will cause the image to reduce in resolution, a factor bellow 1 is not valid */
            );
            /** Return a Symbol's drawing's heights in pixels
                     @return  sheet height in pixels 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: int GetCurrentDrawingsHeight
            (
                NXOpen::Part * part /** smybol part we want to get the drawings height from */
            );
            /** Find a partfile's absolute path   @return  returns absolute file path of mypart.prt, will be an empty string if no *.prt was found 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString FindPartfile
            (
                const NXString & prtFileName /** i.e. mypart.prt  */,
                NXOpen::AME::AMEManager::JaNativeLibType libType /** 0 will enable iterating through all available library types */
            );
            /** Find a partfile's absolute path   @return  returns absolute file path of mypart.prt, will be an empty string if no *.prt was found 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXString FindPartfile
            (
                const char * prtFileName /** i.e. mypart.prt  */,
                NXOpen::AME::AMEManager::JaNativeLibType libType /** 0 will enable iterating through all available library types */
            );
            /** Find a partfile's absolute path and load it if not loaded already 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Part * LoadPartfile
            (
                const NXString & prtFileName /** i.e. mypart.prt  */,
                NXOpen::AME::AMEManager::JaNativeLibType libType /** 0 will enable iterating through all available library types */
            );
            /** Find a partfile's absolute path and load it if not loaded already 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXOpen::Part * LoadPartfile
            (
                const char * prtFileName /** i.e. mypart.prt  */,
                NXOpen::AME::AMEManager::JaNativeLibType libType /** 0 will enable iterating through all available library types */
            );
            /** Find a partfile's absolute path in a given list of directory paths @return  returns absolute file path of mypart.prt, will be an empty string if no *.prt was found 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString FindPartfileInDirs
            (
                const NXString & prtFileName /** i.e. mypart.prt  */,
                const std::vector<NXString> & dirs /** directory paths to search part files in*/
            );
            /** Find a partfile's absolute path in a given list of directory paths @return  returns absolute file path of mypart.prt, will be an empty string if no *.prt was found 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXString FindPartfileInDirs
            (
                const char * prtFileName /** i.e. mypart.prt  */,
                const std::vector<NXString> & dirs /** directory paths to search part files in*/
            );
            /** Find an item id's recent available revision @return  returns latest revision or empty string if itemId could not be found 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString GetLatestItemRevision
            (
                const NXString & itemId /** i.e. part id or part number as string  */
            );
            /** Find an item id's recent available revision @return  returns latest revision or empty string if itemId could not be found 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXString GetLatestItemRevision
            (
                const char * itemId /** i.e. part id or part number as string  */
            );
            /** Set cut Length 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /**  Gets all the solution templates in the input template part 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: std::vector<NXOpen::NXObject *> GetAllTemplateSolutions
            (
                NXOpen::Part * part /** part */ 
            );
            /**  Gets all the variants and variant selections in the input template part 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: std::vector<NXOpen::NXObject *> GetAllTemplateVariantObjects
            (
                NXOpen::Part * part /** part */ 
            );
            ...
            /** Creates a @link AME::PlcFunctionBlockBuilder AME::PlcFunctionBlockBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcFunctionBlockBuilder * CreatePlcFunctionBlockBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::PlcBlock * block /** block */ 
            );
            /** Creates a @link AME::PlcStateChartStateBuilder AME::PlcStateChartStateBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartStateBuilder * CreatePlcStateChartStateBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * plcStateObject /** plcstateobject */ 
            );
            /** Creates a @link AME::PlcStateChartTransitionBuilder AME::PlcStateChartTransitionBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartTransitionBuilder * CreatePlcStateChartTransitionBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * transitionObject /** transitionobject */ 
            );
            ...
            /** Creates a @link AME::PlcStateChartTransitionPrioritiesBuilder AME::PlcStateChartTransitionPrioritiesBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartTransitionPrioritiesBuilder * CreatePlcStateChartTransitionPrioritiesBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * plcStateObject /** plcstateobject */ 
            );
            /** Creates a @link AME::PlcStateChartActionBuilder AME::PlcStateChartActionBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartActionBuilder * CreatePlcStateChartActionBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * stateObject /** stateobject */ ,
                NXOpen::AME::PlcStateChartActionBuilder::ActionType actionType /** actiontype */ 
            );
            /** Creates a @link NXOpen::AME::PlcStateChartItemValueBuilder NXOpen::AME::PlcStateChartItemValueBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartItemValueBuilder * CreatePlcStateChartItemValueBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * plcStateChartBeseConditionItem /** plcstatechartbeseconditionitem */ ,
                NXOpen::AME::PlcRule::Type ruleType /** ruletype */ 
            );
            /** Creates a @link NXOpen::AME::InterfaceMemberBuilder NXOpen::AME::InterfaceMemberBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::InterfaceMemberBuilder * CreateInterfaceMemberBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * parentSection /** parentsection */ ,
                NXOpen::AME::AMEExtendedObject * editInterfaceMember /** editinterfacemember */ 
            );
            /** Creates a @link NXOpen::AME::PlcStateChartDefineCallBuilder NXOpen::AME::PlcStateChartDefineCallBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartDefineCallBuilder * CreatePlcStateChartDefineCallBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * actionValue /** actionvalue */ 
            );
            /** Assign all eplan macros 
             <br>  @deprecated Deprecated in NX2306.4000.0.  Use @link NXOpen::AME::AMEManager::AssignMacros NXOpen::AME::AMEManager::AssignMacros@endlink  instead. <br>  

             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_eplan_addon ("AUTOMATION DESIGNER EPLAN ADDON") */
            public: NX_DEPRECATED("Deprecated in NX2306.4000.0.  Use NXOpen::AME::AMEManager::AssignMacros instead.") void AssignEplanMacros
            (
            );
            /** Unassign all eplan macros 
             <br>  @deprecated Deprecated in NX2306.4000.0.  Use @link NXOpen::AME::AMEManager::UnassignMacros NXOpen::AME::AMEManager::UnassignMacros@endlink  instead. <br>  

             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_eplan_addon ("AUTOMATION DESIGNER EPLAN ADDON") */
            public: NX_DEPRECATED("Deprecated in NX2306.4000.0.  Use NXOpen::AME::AMEManager::UnassignMacros instead.") void UnassignEplanMacros
            (
                bool isUnassignedAll /** isunassignedall */ 
            );
            /** Assign all eplan macros 
             <br>  Created in NX2306.4000.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_eplan_addon ("AUTOMATION DESIGNER EPLAN ADDON") */
            public: void AssignMacros
            (
                int* numPlacedObjs /** numplacedobjs */ ,
                int* numUnAssignedObjs /** numunassignedobjs */ 
            );
            /** Unassign all eplan macros 
             <br>  Created in NX2306.4000.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_eplan_addon ("AUTOMATION DESIGNER EPLAN ADDON") */
            public: int UnassignMacros
            (
                bool isUnassignedAll /** isunassignedall */ 
            );
            ...
            (
                NXOpen::NXObject * attributeExpression /** attributeexpression */ 
            );
            ...
            /** Creates a @link AME::PrimitiveSheetElementBuilder AME::PrimitiveSheetElementBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::PrimitiveSheetElementBuilder * CreatePrimitiveSheetElementBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::PlcFlowChartOperatorBuilder NXOpen::AME::PlcFlowChartOperatorBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcFlowChartOperatorBuilder * CreatePlcFlowChartOperatorBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * extObject /** extobject */ 
            );
            /** Creates a @link NXOpen::AME::PlcFlowChartConstantTextBuilder NXOpen::AME::PlcFlowChartConstantTextBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcFlowChartConstantTextBuilder * CreatePlcFlowChartConstantTextBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * plcFlowChartOperandNodeObj /** plcflowchartoperandnodeobj */ ,
                NXOpen::AME::PlcRule::Type ruleType /** ruletype */ 
            );
            /** Creates a @link NXOpen::AME::PlcTelegramBuilder NXOpen::AME::PlcTelegramBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::PlcTelegramBuilder * CreatePlcTelegramBuilderFromTelegramdef
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::PlcTelegramDefinition * telegramDef /** telegramdef */ 
            );
            /** Reevaluate given evaluators
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ReevaluateEvaluators
            (
                const std::vector<NXOpen::AME::ExpressionEvaluator *> & objects /** objects */ 
            );
            /** Creates a @link NXOpen::AME::FluidicAnnotationSettingsBuilder NXOpen::AME::FluidicAnnotationSettingsBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::FluidicAnnotationSettingsBuilder * CreateFluidicAnnotationSettingsBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::LadderDataBuilder AME::LadderDataBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::LadderDataBuilder * LadderDataBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::EditDisplaySettingsBuilder AME::EditDisplaySettingsBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::EditDisplaySettingsBuilder * CreateEditDisplaySettingsBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::ChangeSymbolVariantBuilder NXOpen::AME::ChangeSymbolVariantBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ChangeSymbolVariantBuilder * CreateChangeSymbolVariantBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::AspectBoxBuilder AME::AspectBoxBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::AspectBoxBuilder * CreateAspectBoxBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AspectBox * aspectBox /** aspectbox */ 
            );
            /** Creates a @link AME::ProductPropertyRulesBuilder AME::ProductPropertyRulesBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ProductPropertyRulesBuilder * CreateProductPropertyRulesBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::FluidicConnectionSettingsBuilder NXOpen::AME::FluidicConnectionSettingsBuilder@endlink  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::FluidicConnectionSettingsBuilder * CreateFluidicConnectionSettingsBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates an DrawingStandardSettingsBuilder 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::DrawingStandardSettingsBuilder * CreateDrawingStandardSettingsBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Connect Global Symbols for given objects to available objects under the same PLC 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ConnectGlobalSymbols
            (
                NXOpen::AME::AMEBaseNode * plcStationNode /** plcstationnode */ ,
                const std::vector<NXOpen::AME::AMEBaseNode *> & softwareObjects /** softwareobjects */ 
            );
            /** Load objects related to tag tables
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void LoadStationSymbols
            (
                NXOpen::AME::AMEBaseNode * plcStationNode /** plcstationnode */ 
            );
            /** Get the selected query from Reuse Library 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::AMEQuery * GetSelectedQueryFromLibrary
            (
            );
            /** Get the selected report definition from Reuse Library  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ReportDefinition * GetSelectedReportdefinitionFromLibrary
            (
            );
            /** Creates a @link AME::PlcStateChartFunctionBlockBuilder AME::PlcStateChartFunctionBlockBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartFunctionBlockBuilder * CreatePlcStateChartFunctionBlockBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::PlcBlock * block /** block */ 
            );
            /** Creates a @link AME::PlcEditStateNoteBuilder AME::PlcEditStateNoteBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcEditStateNoteBuilder * CreatePlcEditStateNoteBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::AME::AMEExtendedObject * plcStateChartBaseElement /** plcstatechartbaseelement */ 
            );
            /** Creates a @link NXOpen::AME::ManageDimensionPointsBuilder NXOpen::AME::ManageDimensionPointsBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_electrical_design ("AUTOMATION DESIGNER ELECTRICAL DESIGN") */
            public: NXOpen::AME::ManageDimensionPointsBuilder * CreateManageDimensionPointsBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::CreateReportBuilder NXOpen::AME::CreateReportBuilder@endlink . This is only for native mode.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::CreateReportBuilder * CreateReportBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::LinearDimensionBuilder AME::LinearDimensionBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_electrical_design ("AUTOMATION DESIGNER ELECTRICAL DESIGN") */
            public: NXOpen::AME::LinearDimensionBuilder * CreateLinearDimensionBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::SmartPDFPrintPagesBuilder AME::SmartPDFPrintPagesBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::SmartPDFPrintPagesBuilder * CreateSmartPdfPrintPagesBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::AddPlcOperatorBuilder AME::AddPlcOperatorBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::AddPlcOperatorBuilder * CreateAddPlcOperatorBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::PlcStateChartCreateElementBuilder NXOpen::AME::PlcStateChartCreateElementBuilder@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::PlcStateChartCreateElementBuilder * CreatePlcStateChartCreateElementBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Changes the default directory with the given path and returns an SM_alloc'd old directory path 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString ChangeNativeDirectory
            (
                const NXString & newDir /** newdir */ 
            );
            /** Changes the default directory with the given path and returns an SM_alloc'd old directory path 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            NXString ChangeNativeDirectory
            (
                const char * newDir /** newdir */ 
            );
            /** Creates a @link NXOpen::AME::DxfdwgExportBuilder NXOpen::AME::DxfdwgExportBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::DxfdwgExportBuilder * CreateDxfdwgExportBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** JA class to create system idb builder 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::CreateSystemIDBBuilder * CreateCreateSystemIdbBuilder
            (
                NXOpen::Part * part /** part */ ,
                const NXString & idbName /** idbname */ ,
                const NXString & typeFB /** typefb */ ,
                NXOpen::AME::InstanceDataBlockBuilder::ActionType idbScope /** idbscope */ ,
                bool failSafe /** failsafe */ 
            );
            /** JA class to create system idb builder 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            NXOpen::AME::CreateSystemIDBBuilder * CreateCreateSystemIdbBuilder
            (
                NXOpen::Part * part /** part */ ,
                const char * idbName /** idbname */ ,
                const char * typeFB /** typefb */ ,
                NXOpen::AME::InstanceDataBlockBuilder::ActionType idbScope /** idbscope */ ,
                bool failSafe /** failsafe */ 
            );
            /** Creates a @link NXOpen::AME::AddEplanValueSetBuilder NXOpen::AME::AddEplanValueSetBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_eplan_addon ("AUTOMATION DESIGNER EPLAN ADDON") */
            public: NXOpen::AME::AddEplanValueSetBuilder * CreateAddEplanValueSetBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Add the given part as child componet to project 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void AddAsComponentToCurrentProject
            (
            ...
            /** Add the given part as child componet to project 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            void AddAsComponentToCurrentProject
            (
                const char * partName /** partname */ 
            );
            /** Adds the object(@link NXOpen::Diagramming::Annotation NXOpen::Diagramming::Annotation@endlink  or @link NXOpen::Diagramming::Tables::CellBuilder NXOpen::Diagramming::Tables::CellBuilder@endlink )
                        holding free text to FreeTextContainer object for translation 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void AddFreeTextObjectToContainer
            (
                NXOpen::TaggedObject * objectTag /** objecttag */ 
            );
            /** Removes the object(@link NXOpen::Diagramming::Annotation NXOpen::Diagramming::Annotation@endlink  or @link NXOpen::Diagramming::Tables::CellBuilder NXOpen::Diagramming::Tables::CellBuilder@endlink )
                        holding free text from FreeTextContainer object 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void RemoveFreeTextObjectFromContainer
            (
                NXOpen::TaggedObject * objectTag /** objecttag */ 
            );
            /** Entering an Eplan environment 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::Part * EnterEplanEnv
            (
            );
            /** Creates a @link NXOpen::AME::ImportEplanProductBuilder NXOpen::AME::ImportEplanProductBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ImportEplanProductBuilder * CreateImportEplanProductBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::ImportEplanProductListBuilder NXOpen::AME::ImportEplanProductListBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ImportEplanProductListBuilder * CreateImportEplanProductListBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link AME::ManageEplanGlobalMappingBuilder AME::ManageEplanGlobalMappingBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ManageEplanGlobalMappingBuilder * CreateManageEplanGlobalMappingBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::ImportEplanMappingBuilder NXOpen::AME::ImportEplanMappingBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ImportEplanMappingBuilder * CreateImportEplanMappingBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::ExportEplanMappingBuilder NXOpen::AME::ExportEplanMappingBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ExportEplanMappingBuilder * CreateExportEplanMappingBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::CreateEplanNodeBuilder NXOpen::AME::CreateEplanNodeBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::CreateEplanNodeBuilder * CreateCreateEplanNodeBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates a @link NXOpen::AME::AddEplanPropertyBuilder NXOpen::AME::AddEplanPropertyBuilder@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::AddEplanPropertyBuilder * CreateAddEplanPropertyBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** JA class to create variable interface member 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            public: NXOpen::AME::VariableInterfaceMemberPort * CreateVariableInterfaceMember
            (
                NXOpen::AME::PlcInterfaceVariable * parentVariable /** parentvariable */ ,
                NXOpen::AME::InterfaceMemberPort * sourceIMP /** sourceimp */ ,
                const NXString & sourceImpPath /** sourceimppath */ 
            );
            /** JA class to create variable interface member 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_tia_addon ("AUTOMATION DESIGNER TIA ADDON") */
            NXOpen::AME::VariableInterfaceMemberPort * CreateVariableInterfaceMember
            (
                NXOpen::AME::PlcInterfaceVariable * parentVariable /** parentvariable */ ,
                NXOpen::AME::InterfaceMemberPort * sourceIMP /** sourceimp */ ,
                const char * sourceImpPath /** sourceimppath */ 
            );
            /** Reset Eplan Data Mapping
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ResetEplanDataMapping
            (
            );
            /** Reset Eplan Data Mapping
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ResetEclassDataMapping
            (
                NXOpen::AME::AMEBaseNode * versionNode /** versionnode */ 
            );
            /** Removes component from given assembly 
             <br>  Created in NX2015.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            ...
            /** Update the product data mapping
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void UpdateEclassProductDataMapping
            (
                NXOpen::AME::AMEBaseNode * versionNode /** versionnode */ ,
                bool overrideMapping /** overridemapping */ 
            );
            /** Get owning cable from given Physical Connection
             <br>  Created in NX2206.8000.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::IEngObject * GetOwningCable
            (
                NXOpen::AME::AMEExtendedObject * physicalConnection /** physicalconnection */ 
            );
            /** Creates a @link NXOpen::AME::ChangeProductTypeBuilder NXOpen::AME::ChangeProductTypeBuilder@endlink  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ChangeProductTypeBuilder * CreateChangeProductTypeBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Populates mapped Engineering properties on linked BOM line 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ad_mechanical_collab ("AUTOMATION DESIGNER MECH COLLABORATION ADDON") */
            public: void PopulateEoPropertiesOnBomline
            (
                NXOpen::AME::Project * project /** ELD project.*/
            );
            /** Creates @link NXOpen::AME::BulkEditAnnotationBuilder NXOpen::AME::BulkEditAnnotationBuilder@endlink  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::BulkEditAnnotationBuilder * CreateBulkEditAnnotationBuilder
            (
                NXOpen::Part * part /** part */ 
            );
