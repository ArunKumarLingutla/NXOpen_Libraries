    ...
    namespace Diagramming
    {
        ...
        */
        class NXOPENCPP_DIAGRAMMINGEXPORT  DiagrammingManager
        {
            ...
            /** Copy the sheet elements.  @return  The copies of sheet elements 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::NXObject *> CopySheetElements
            (
                const std::vector<NXOpen::NXObject *> & inputObjects /** The sheet elements to be copied */
            );
            ...
            */
            public: NXOpen::Diagramming::FillCollection *Fills();
