            ...
            */
            class NXOPENCPP_FEATURESEXPORT  EdgeCutBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                public: enum VersionID
                {
                    ...
                    VersionIDIgnoreEndCuts/**Endcuts added to stiffeners will not affect cutout placement. */,
                    VersionIDCheckSplit/**Split added to stiffeners will affect edge cut placement. */
                };
                ...
                /**Returns  the offset direction reference.  The offset direction reference is optional.
                        It is used to locate the cuts. 
                        If null, the guide curve normal is used for the offset direction at each cut.  
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Direction * OffsetDirectionReference
                (
                );
                /**Sets  the offset direction reference.  The offset direction reference is optional.
                        It is used to locate the cuts. 
                        If null, the guide curve normal is used for the offset direction at each cut.  
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: void SetOffsetDirectionReference
                (
                    NXOpen::Direction * offsetDirectionReference /** offsetdirectionreference */ 
                );
