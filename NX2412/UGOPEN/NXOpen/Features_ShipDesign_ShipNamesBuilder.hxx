    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            enum ShipnamesBuilderType
            {
                ...
                ShipnamesBuilderTypeStructuredesignConsolidatecontainer/** structuredesign consolidatecontainer */ ,
                ShipnamesBuilderTypeCompartment/** compartment */ ,
                ShipnamesBuilderTypeStructuralElement/** structural element */ ,
                ShipnamesBuilderTypeStructuralElementIntersectionLine/** structural element intersection line */ ,
                ShipnamesBuilderTypeFacePlate/** face plate */ 
            };
        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ShipNamesBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                ...
                /**Returns 
                            the Context Attribute2 value. This is the value of the SAW_SUB_NAME_2 part
                            attribute added to the newly created / named Ship objects.
                            
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString ContextAttribute2
                (
                );
                /**Sets 
                            the Context Attribute2 value. This is the value of the SAW_SUB_NAME_2 part
                 ...
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") */
                public: void SetContextAttribute2
                (
                    const NXString & newValue /** newvalue */ 
                );
                /**Sets 
