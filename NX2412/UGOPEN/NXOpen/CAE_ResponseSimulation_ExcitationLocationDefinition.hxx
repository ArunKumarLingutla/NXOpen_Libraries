        ...
        namespace ResponseSimulation
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  ExcitationLocationDefinition : public NXOpen::TaggedObject
            {
                ...
                /**Returns  the excitation location list on which the excitation will be applied. The excitation location
                        type could be force location, enforced motion location or dynamic load defined in response 
                        dynamic solution 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXOpen::SelectTaggedObjectList * ExcitationLocationlist
                (
                );
