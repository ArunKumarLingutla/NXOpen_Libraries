...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link NXOpen::Annotations::CompoundDatumReferenceBuilder NXOpen::Annotations::CompoundDatumReferenceBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::Annotations::AnnotationManager::CreateCompoundDatumReferenceBuilder  NXOpen::Annotations::AnnotationManager::CreateCompoundDatumReferenceBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  CompoundDatumReferenceBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: NXOpen::Annotations::DatumReferenceBuilderList * DatumReferenceList
            (
            );
            /**Returns  the compound datum reference extended text builder 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::TextWithSymbolsBuilder * ExtendedText
            (
            );
