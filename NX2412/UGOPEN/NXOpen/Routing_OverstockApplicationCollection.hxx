    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  OverstockApplicationCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Routing::OverstockApplication *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Routing::OverstockApplication **;
                using reference = NXOpen::Routing::OverstockApplication *&;
