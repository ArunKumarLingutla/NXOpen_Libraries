...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a Tooling::StockSizeBuilder builder.  <br> To create a new instance of this class, use @link NXOpen::Tooling::StockSizeCollection::CreateStocksizeFeatureBuilder  NXOpen::Tooling::StockSizeCollection::CreateStocksizeFeatureBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  StockSizeBuilder : public NXOpen::Builder
        {
            ...
            /** the aligned orientation type of the block type stock size */
            public: enum AlignedBlockType
            {
                AlignedBlockTypeCsys/** aligned with one CSYS*/,
                AlignedBlockTypeVector/** aligned with one vector*/,
                AlignedBlockTypeNonAligned/** non-aligned*/
            };
            ...
            /**Returns  the value to determine whether can input symmetric tolerance value or not 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: bool InputSymmetricValue
            (
            );
            /**Sets  the value to determine whether can input symmetric tolerance value or not 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetInputSymmetricValue
            (
                bool inputSymmetricValue /** inputsymmetricvalue */ 
            );
            ...
            /**Sets  the attribute which determines whether the diameter symbol is shown or not when stock type is cylinder
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetShowDiameterSymbol
            (
                bool showDiameterSymbol /** showdiametersymbol */ 
            );
            /**Returns  the attribute which determines whether to create a stock size feature
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateFeature
            (
            );
            /**Sets  the attribute which determines whether to create a stock size feature
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCreateFeature
            (
                bool bCreateFeature /** bcreatefeature */ 
            );
            /**Returns  the attribute which determines whether to create a solid body for the stock size feature
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateFeatureBody
            (
            );
            /**Sets  the attribute which determines whether to create a solid body for the stock size feature
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCreateFeatureBody
            (
                bool bCreateFeatureBody /** bcreatefeaturebody */ 
            );
            /**Returns  the block align type 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::StockSizeBuilder::AlignedBlockType AlignType
            (
            );
            /**Sets  the block align type 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetAlignType
            (
                NXOpen::Tooling::StockSizeBuilder::AlignedBlockType alignType /** aligntype */ 
            );
            /** Make the stock size feature the current feature before starting to edit. 
             <br>  Created in NX2412.5000.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void MakeStockCurrentFeatureForEdit
            (
                NXOpen::Features::Feature * stockFeature /** stockfeature */ 
            );
            /** Changes work part, and resets the status changed by the last work part change during selecting. 
             <br>  Created in NX2412.5000.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ChangeWorkPartOnSelecting
            (
                NXOpen::Body * selBodyOcc /** selbodyocc */ 
            );
        };
    }
}
