...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        ...
        {
            /** the parameter toggle state */
            public: enum ParameterToggleState
            {
                ParameterToggleStateOff/** off */ ,
                ParameterToggleStateOn/** on */ 
            };

            /** the parameter lock state */
            public: enum ParameterLockState
            {
                ParameterLockStateLock/** lock */ ,
                ParameterLockStateUnlock/** unlock */ 
            };

            /** the parameter check box state */
            public: enum ParameterCheckbox
            {
                ParameterCheckboxHide/** hide */ ,
                ParameterCheckboxUnchecked/** unchecked */ ,
                ParameterCheckboxChecked/** checked */ 
            };
            ...
            /** the tool axis type */
            public: enum ToolAxisType
            {
                ToolAxisTypePlusMZAxis/** plus mzaxis */ ,
                ToolAxisTypeSpecifyVector/** specify vector */ ,
                ToolAxisTypeDynamic/** dynamic */ 
            };
            ...
            /**Returns  the motion output type builder 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ArcOutputTypeCiBuilder * MotionOutputTypeBuilder
            (
            );
            /** Initialize probing geometry 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void InitializeProbingGeometry
            (
            );
            /** Append probing geometry 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void AppendProbingGeometry
            (
                NXOpen::DisplayableObject * geomTag /** probing geometry entity for appending. */
            );
            /**Returns  the part stock builder 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * PartStockBuilder
            (
            );
            /** Reset the cycle parameters 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void ResetCycleParameters
            (
                const NXString & cycleName /** Cycle Name */
            );
            /** Reset the cycle parameters 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void ResetCycleParameters
            (
                const char * cycleName /** Cycle Name */
            );
            /** Set the parameter string value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterStringValue
            (
            ...
            /** Set the parameter string value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterStringValue
            (
                const char * parameterName /** Parameter Name */,
                const char * stringValue /** String Value */
            );
            /** Set the parameter integer value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterIntegerValue
            (
                const NXString & parameterName /** Parameter Name */,
            ...
            /** Set the parameter integer value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterIntegerValue
            (
                const char * parameterName /** Parameter Name */,
                int integerValue /** Integer Value */
            );
            /** Set the parameter enum value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterEnumValue
            (
                const NXString & parameterName /** Parameter Name */,
            ...
            /** Set the parameter enum value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterEnumValue
            (
                const char * parameterName /** Parameter Name */,
                int enumValue /** Enum Value */
            );
            /** Set the parameter double value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterDoubleValue
            (
                const NXString & parameterName /** Parameter Name */,
            ...
            /** Set the parameter double value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterDoubleValue
            (
                const char * parameterName /** Parameter Name */,
                double doubleValue /** Double Value */
            );
            /** Set the parameter logical value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterLogicalValue
            (
                const NXString & parameterName /** Parameter Name */,
            ...
            /** Set the parameter logical value 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterLogicalValue
            (
                const char * parameterName /** Parameter Name */,
                bool logicalValue /** Logical Value */
            );
            /** Set the parameter toggle state 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterToggleState
            (
                const NXString & parameterName /** Parameter Name */,
                NXOpen::CAM::OnMachineProbingBuilder::ParameterToggleState toggleState /** Toggle State */
            );
            /** Set the parameter toggle state 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterToggleState
            (
                const char * parameterName /** Parameter Name */,
                NXOpen::CAM::OnMachineProbingBuilder::ParameterToggleState toggleState /** Toggle State */
            );
            /** Push the parameter button 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void PushParameterButton
            (
                const NXString & parameterName /** Parameter Name */
            );
            /** Push the parameter button 
            ...
            /** Set the parameter selection 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterSelection
            (
                const NXString & parameterName /** Parameter Name */,
                const std::vector<NXOpen::TaggedObject *> & objects /** the list of objects */
            );
            /** Set the parameter selection 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterSelection
            (
                const char * parameterName /** Parameter Name */,
                const std::vector<NXOpen::TaggedObject *> & objects /** the list of objects */
            );
            /** Set the parameter lock state 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterLockState
            (
                const NXString & parameterName /** Parameter Name */,
                NXOpen::CAM::OnMachineProbingBuilder::ParameterLockState lockState /** Lock State */
            );
            /** Set the parameter lock state 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterLockState
            (
                const char * parameterName /** Parameter Name */,
                NXOpen::CAM::OnMachineProbingBuilder::ParameterLockState lockState /** Lock State */
            );
            /** Set the parameter check box state 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetParameterCheckboxState
            (
                const NXString & parameterName /** Parameter Name */,
                NXOpen::CAM::OnMachineProbingBuilder::ParameterCheckbox checkboxState /** Check box State */
            );
            /** Set the parameter check box state 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetParameterCheckboxState
            (
                const char * parameterName /** Parameter Name */,
                NXOpen::CAM::OnMachineProbingBuilder::ParameterCheckbox checkboxState /** Check box State */
            );
            /**Returns  the tracking point name 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXString TrackingPointName
            (
            );
            /** Set the tracking point name 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetTrackingPointName
            (
                const NXString & trackingPointName /** Tracking Point Name */
            );
            /** Set the tracking point name 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetTrackingPointName
            (
                const char * trackingPointName /** Tracking Point Name */
            );
        };
    }
}
