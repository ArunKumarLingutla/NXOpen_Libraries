        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  AddComponentBuilder : public NXOpen::Builder, public virtual NXOpen::IAttributeSourceObjectBuilder
        {
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::ConfiguredPart * LoadSecondaryConfiguration
            (
                const NXString & partSpec /** partspec */ ,
                NXOpen::PDM::ConfigurationContext * configContext /** configcontext */ ,
                NXOpen::PartLoadStatus ** loadStatus /** loadstatus */ 
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            NXOpen::ConfiguredPart * LoadSecondaryConfiguration
            (
            ...
            /**Enables the use of the CSYS transform associated with a reference set in a legacy part and applies it to the position of added component
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetUseReferenceSetAndApplyInitialLocation
            (
                bool useRefSetCSYS /** userefsetcsys */ 
            );
