...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        DisplayReferenceGeometry </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  WaveSketchBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Sets  the setting that controls whether or not the reference geometry in the linked sketch are displayed 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the source part type 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::WaveSketchBuilder::ParentPartType ParentPart
            (
            );
            ...
            (
                NXOpen::Features::WaveSketchBuilder::ParentPartType parentPart /** parentpart */ 
            );
            /** Returns the wave linked sketch parent information 
