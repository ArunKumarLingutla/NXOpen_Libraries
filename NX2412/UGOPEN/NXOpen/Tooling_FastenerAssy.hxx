...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        ComponentPatternBuilder.PatternService.AxialDefinition.AngularSpacing.NCopies.Value </term> <description> 
         
        12 </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.AngularSpacing.PitchAngle.Value </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.AngularSpacing.PitchDistance.Value </term> <description> 
         
        10 (millimeters part), 1 (inches part) </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.AngularSpacing.SpaceType </term> <description> 
         
        Offset </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.AngularSpacing.SpanAngle.Value </term> <description> 
         
        360 (millimeters part), 360 (inches part) </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.AngularSpacing.UsePitchOption </term> <description> 
         
        Angle </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.AxialSpacing.NCopies.Value </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.CreateLastStaggered </term> <description> 
         
        true </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.HorizontalRef.RotationAngle.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.MeasureDistanceType </term> <description> 
         
        AlongAxis </description> </item> 

        <item><term> 
         
        ComponentPatternBuilder.PatternService.AxialDefinition.StaggerType </term> <description> 
        ...
        ComponentPatternBuilder.PatternService.PatternOrientation.AxialOrientationOption </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  FastenerAssy : public NXOpen::Builder
        {
            ...
            public: enum StackTypeMethod
            {
                ...
                StackTypeMethodExtendNode/** Minimum extend node type */,
                StackTypeMethodExtendSubNode/** Minimum extend sub node type */
            };
            ...
            /**Sets the hole standard for the hole in the fastener assembly
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetHoleStandard
            (
                const NXString & holeStandard /** The hole standard of the hole data */,
                int index /** The hole index in the fastener assembly */
            );
            /**Sets the hole standard for the hole in the fastener assembly
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            void SetHoleStandard
            (
                const char * holeStandard /** The hole standard of the hole data */,
                int index /** The hole index in the fastener assembly */
            );
            /**Sets the hole type for the hole in the fastener assembly
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetHoleType
            (
                const NXString & holeType /** The hole type of the hole data */,
                int index /** The hole index in the fastener assembly */
            );
            /**Sets the hole type for the hole in the fastener assembly
             <br>  Created in NX2406.0.0.  <br>  
            ...
            void SetHoleType
            (
                const char * holeType /** The hole type of the hole data */,
                int index /** The hole index in the fastener assembly */
            );
            /**Sets the hole form for the hole in the fastener assembly
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetHoleForm
            (
                const NXString & holeForm /** The hole form of the hole data */,
                int index /** The hole index in the fastener assembly */
            );
            /**Sets the hole form for the hole in the fastener assembly
             <br>  Created in NX2406.0.0.  <br>  
            ...
            void SetHoleForm
            (
                const char * holeForm /** The hole form of the hole data */,
                int index /** The hole index in the fastener assembly */
            );
            ...
            /**Sets the extent length expression for the hole in the fastener assembly
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetFastenerExtentLengthFormula
            (
                int index /**hole index in fastener assembly*/,
                const NXString & extentLengthFormula /** The extent Length of the fastener assembly */
            );
            /**Sets the extent length expression for the hole in the fastener assembly
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            void SetFastenerExtentLengthFormula
            (
                int index /**hole index in fastener assembly*/,
                const char * extentLengthFormula /** The extent Length of the fastener assembly */
            );
            ...
            /** Sets the datum CSYS for the hole in the fastener assembly
             ...
             <br> License requirements : None */
            public: void SetHoleDatumCsys
            (
                NXOpen::NXObject * datumCsys /** The datum csys of the hole data */,
                int index /** The hole index in the fastener assembly, datumCsys type should be Axis */
            );
            ...
            /**Sets the extent length expression for the fastener assembly data
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAssemblyExtentLengthFormula
            (
                int index /**hole index in fastener assembly*/,
                const NXString & extentLengthFormula /** The extent Length of the fastener assembly */
            );
            /**Sets the extent length expression for the fastener assembly data
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            void SetAssemblyExtentLengthFormula
            (
                int index /**hole index in fastener assembly*/,
                const char * extentLengthFormula /** The extent Length of the fastener assembly */
            );
            ...
            /** Get reusable builder work part @return  the new @link NXOpen::Tooling::AddReusablePart NXOpen::Tooling::AddReusablePart@endlink  instance 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * GetReusableBuilderWorkPart
            (
            );
            /** Create positioning feature on the given position
             <br>  Created in NX1847.0.0.  <br>  
            ...
            /** Set fastener identifier properties
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetFastenerIdentifierProperties
            (
                int inx /** inx */ ,
                NXOpen::Tooling::FastenerAssyObject * fastenerObject /** fastenerobject */ 
            );
            /** Set fastener identifier properties
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: int CreateFastenerIdentifiers
            (
            );
            /** Find the patterned assembly instances
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void FindAssemblyInstances
            (
            );
        };
    }
