        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  Component : public NXOpen::DisplayableObject, public virtual NXOpen::Routing::ICharacteristic
        {
            ...
            /** Given a prototype object, returns the corresponding occurrence
                  ...
                  UF Objects chapter in the Open C Programmers Guide  @return  the occurrence of the prototype in this component 
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Outputs the @link NXOpen::Assemblies::Arrangement NXOpen::Assemblies::Arrangement@endlink  objects within the @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink .
            ...
            /**Returns 
                    ...
                    (See @link NXOpen::Assemblies::Component::IsComponentOrAncestorSuppressed NXOpen::Assemblies::Component::IsComponentOrAncestorSuppressed@endlink .)
            ...
            /**Returns 
                    ...
                    (See @link NXOpen::Assemblies::Component::IsSuppressed NXOpen::Assemblies::Component::IsSuppressed@endlink .)
                
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: bool IsComponentOrAncestorSuppressed
            (
            );
            /**
            ...
            /**Returns  the displayable name of the prototype part.
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : nx_atlas_testlab_api ("Testlab worker - STS") OR assemblies ("ASSEMBLIES MODULE") */
            ...
            /** Creates an empty @link NXOpen::PartFamily::InstanceSelectionCriteria NXOpen::PartFamily::InstanceSelectionCriteria@endlink  
            ...
            /** Obtains the@link NXOpen::PartFamily::InstanceSelectionCriteria NXOpen::PartFamily::InstanceSelectionCriteria@endlink , if it exists.
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /**Returns  the @link NXOpen::Assemblies::PartitionSchemeInstance NXOpen::Assemblies::PartitionSchemeInstance@endlink  associated with this component, if it exists.                
                 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::Assemblies::PartitionSchemeInstance * PartitionSchemeInstance
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUserNameOfConfiguration
            (
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            void SetUserNameOfConfiguration
            (
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetUserNameOfConfiguration
            (
            );

            /// \endcond 
            /** Evaluate the @link NXOpen::PartFamily::InstanceSelectionCriteria NXOpen::PartFamily::InstanceSelectionCriteria@endlink  associated with this component, and update the part family member 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void EvaluatePartFamilyInstanceSelectionCriteria
            (
                bool* componentChanged /** A flag indicating whether the part family member has changed */,
                NXOpen::Part ** newPartFamilyMember /** New part family member if the component is changed */,
                NXString* errorinfo /** error information */
            );
            /** Add partitions for the selected @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink s across all possible 
                    @link NXOpen::Assemblies::Partition NXOpen::Assemblies::Partition@endlink s.
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void AddToPartitions
            (
                const std::vector<NXOpen::Assemblies::Component *> & components /** The components whose partition membership will be altered. */,
                const std::vector<NXOpen::Assemblies::Partition *> & partitions /** partitions */ 
            );
            /** Remove partitions for the selected @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink s across all possible 
                    @link NXOpen::Assemblies::Partition NXOpen::Assemblies::Partition@endlink s.
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: void MakePrimaryConfiguration
            (
            );

            /// \endcond 
            /** Validates and returns results for IsPartitionable for all input @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink  across all possible 
                    @link NXOpen::Assemblies::Partition NXOpen::Assemblies::Partition@endlink .
                    All the components and partitions inputs should be unique and belong to same product assembly.
                
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: std::vector<NXOpen::Assemblies::IsPartitionableResult *> IsPartitionable
            (
