...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Optimization
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  DAOConstraintCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::Optimization::DAOConstraint *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::Optimization::DAOConstraint **;
                    using reference = NXOpen::CAE::Optimization::DAOConstraint *&;
