    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SpeedControlBuilder : public NXOpen::Mechatronics::PhysicsConstraintBuilder
        {
            ...
            /**Returns  the dynamic material parameter type, which works only when the speed control is used to
            ...
            /**Sets  the dynamic material parameter type, which works only when the speed control is used to
                        drive @link NXOpen::Mechatronics::DynamicMaterial NXOpen::Mechatronics::DynamicMaterial@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
