...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        enum CorrelShapemetrictype
        {
            ...
            CorrelShapemetrictypeFreq/** Shape metric type is Frequency Error*/,
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CorrelSolution : public NXOpen::CAE::CorrelBaseSolution
        {
            ...
            /** Export shape metric data to CSV file 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void ExportShapeMetricCsvFile
            (
                NXOpen::CAE::CorrelShapemetrictype metricCode /** metriccode */ ,
                const NXString & filename /** CSV file name. */,
                const NXOpen::CAE::CorrelPlotDisplayOptions & displayOptions /** displayoptions */ 
            ...
            /** Show frequency plot 
             ...
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void ShowFrequencyPlot
            (
                const NXOpen::CAE::CorrelFrequencyOptions & displayOptions /** displayoptions */ 
            );
            /** Export frequency data to CSV file 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void ExportFrequencyCsvFile
            (
                const NXString & filename /** CSV file name. */,
                const NXOpen::CAE::CorrelFrequencyOptions & displayOptions /** displayoptions */ 
            );
