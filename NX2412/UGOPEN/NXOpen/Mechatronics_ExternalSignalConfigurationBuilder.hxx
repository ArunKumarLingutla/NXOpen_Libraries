...
#include <NXOpen/Mechatronics_EtherNetIPClientBuilder.hxx>
...
#include <NXOpen/Mechatronics_SinumerikClientBuilder.hxx>
    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ExternalSignalConfigurationBuilder : public NXOpen::Builder
        {
            ...
            /**Returns   @brief  the Sinumerik builder that holds the configuration for Sinumerik clients.  

              
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: NXOpen::Mechatronics::SinumerikClientBuilder * SinumerikClient
            (
            );
            /**Returns   @brief  the EtherNetIP builder that holds the configuration for EtherNetIP clients.  

              
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NXOpen::Mechatronics::EtherNetIPClientBuilder * EtherNetIPClient
            (
            );
        };
    }
