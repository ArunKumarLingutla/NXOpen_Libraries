    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  SpringDamperBuilder : public NXOpen::Motion::EntityPropTableBuilder
        {
            ...
            /** Free length definition types */
            public: enum FreeLengthDefinition
            {
                FreeLengthDefinitionPreloadedAndActuator/** preloaded and actuator */ ,
                FreeLengthDefinitionFreeLengthDirectly/** free length directly */ 
            };
