        ...
        */
        class NXOPENCPP_CAEEXPORT  CAEConnectionBuilder : public NXOpen::Builder
        {
            ...
            public: enum MethodTypeEnum
            {
                ...
                MethodTypeEnumRbe3ToTargetFace/** RBE3 to Target Face */
            };
            ...
            /** the method for rbe3 weight distribution to be used */
            public: enum Rbe3WeightMethodTypeEnum
            {
                Rbe3WeightMethodTypeEnumNone/** Create RBE3 Elements without weights */,
                Rbe3WeightMethodTypeEnumDistance/** Compute RBE3 weights based on inverse distance */,
                Rbe3WeightMethodTypeEnumElementEdgeLength/** Compute RBE3 weights based on element edge length */,
                Rbe3WeightMethodTypeEnumElementArea/** Compute RBE3 weights based on element area */
            };
            ...
            /**Sets  the  proximity between node and face in the case of 1d mesh to face connection
             <br>  @deprecated Deprecated in NX2412.0.0.  There is no replacement. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  There is no replacement.") void SetNodeFaceProximity
            (
            ...
            /**Returns  the  proximity between node and face in the case of 1d mesh to face connection
             <br>  @deprecated Deprecated in NX2412.0.0.  Use Get Node Face Proximity Expression <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use Get Node Face Proximity Expression") double NodeFaceProximity
            (
            );
            ...
            /**Sets  the search distance to create spider connections in node to node connections within search distance
             ...
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  There is no replacement.") void SetSearchDistance
            (
            ...
            /**Returns  the search distance to create spider connections in node to node connections within search distance
             <br>  @deprecated Deprecated in NX2412.0.0.  Use Get Search Distance Expression <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use Get Search Distance Expression") double SearchDistance
            (
            );
            /**Returns  the method type for point-to-edge connection 
             <br>  Created in NX1872.0.0.  <br>  
            ...
            /**Returns  the method type for face-to-face connection to enable limiting the connections made 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: bool LimitConnectionToggle
            (
            );
            /**Sets  the method type for face-to-face connection to enable limiting the connections made 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetLimitConnectionToggle
            (
                bool limitConnection /** limitconnection */ 
            );
            /**Returns  the method type for face-to-face connection for defining the distance tollerance between faces for creating connections 
             <br>  @deprecated Deprecated in NX2412.0.0.  Use Get Source Target Distance Expression <br>  

             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use Get Source Target Distance Expression") double SourceTargetDistance
            (
            );
            /**Sets  the method type for face-to-face connection for defining the distance tollerance between faces for creating connections 
             <br>  @deprecated Deprecated in NX2412.0.0.  There is no replacement. <br>  

             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  There is no replacement.") void SetSourceTargetDistance
            (
                double distanceTol /** distancetol */ 
            );
            /**Returns  the source Node(s) or selection recipe 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectTaggedObjectList * SourceNodesSelection
            (
            );
            /**Returns  the target Node(s) or selection recipe 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectTaggedObjectList * TargetNodesSelection
            (
            );
            /**Returns  the option to create editable node to node connection 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool EditableNodeToNodeConnection
            (
            );
            /**Sets  the option to create editable node to node connection 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetEditableNodeToNodeConnection
            (
                bool bEditableNodeToNodeConnection /** beditablenodetonodeconnection */ 
            );
            /**Returns  the option to calculate weights for RBE3 spider elements 
             <br>  @deprecated Deprecated in NX2312.0.0.  Call @link NXOpen::BasePropertyTable::GetIntegerPropertyValue NXOpen::BasePropertyTable::GetIntegerPropertyValue@endlink  to get the weight method property value from Mesh Associated Data <br>  

             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Call NXOpen::BasePropertyTable::GetIntegerPropertyValue to get the weight method property value from Mesh Associated Data") NXOpen::CAE::CAEConnectionBuilder::Rbe3WeightMethodTypeEnum ApplyWeightsRbe3Enum
            (
            );
            /**Sets  the option to calculate weights for RBE3 spider elements 
             <br>  @deprecated Deprecated in NX2312.0.0.  Call @link NXOpen::BasePropertyTable::SetIntegerPropertyValue NXOpen::BasePropertyTable::SetIntegerPropertyValue@endlink  to set the weight method property in Mesh Associated Data <br>  

             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Call NXOpen::BasePropertyTable::SetIntegerPropertyValue to set the weight method property in Mesh Associated Data") void SetApplyWeightsRbe3Enum
            (
                NXOpen::CAE::CAEConnectionBuilder::Rbe3WeightMethodTypeEnum doApplyWeights /** doapplyweights */ 
            );
            /**Returns  the search distance 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * SearchDistanceExpression
            (
            );
            /**Returns  the method type for face-to-face connection for defining the distance tolerance between faces for creating connections 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * SourceTargetDistanceExpression
            (
            );
            /**Returns  the  proximity between node and face in the case of 1d mesh to face connection
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * NodeFaceProximityExpression
            (
            );
        };
    }
