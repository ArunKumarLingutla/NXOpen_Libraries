        ...
        namespace ModelCheck
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  ElementQualitySettingCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::ModelCheck::ElementQualitySetting *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::ModelCheck::ElementQualitySetting **;
                    using reference = NXOpen::CAE::ModelCheck::ElementQualitySetting *&;
