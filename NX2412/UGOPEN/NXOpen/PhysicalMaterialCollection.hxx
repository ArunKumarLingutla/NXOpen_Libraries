...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PhysicalMaterialCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::Material *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Material **;
            using reference = NXOpen::Material *&;
        ...
        /** Creates a non-editable material in the part from the legacy (phys_material.dat) material library definition.   The material is identified by the unique material identifier in the phys_material.dat file.
             @return  the loaded material  
         <br>  @deprecated Deprecated in NX2212.0.0.  Legacy library formats are no longer supported.  Please use a MatML file instead. <br>  

         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Legacy library formats are no longer supported.  Please use a MatML file instead.") NXOpen::PhysicalMaterial * LoadFromLegacynxlibrary
        (
            const NXString & libraryReference /** the unique library reference for a material in this Library */
        );
        /** Creates a non-editable material in the part from the legacy (phys_material.dat) material library definition.   The material is identified by the unique material identifier in the phys_material.dat file.
