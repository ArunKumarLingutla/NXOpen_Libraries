...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ConeAngle.Value </term> <description> 
        ...
        20000.00 (millimeters part), 787.4015 (inches part) </description> </item> 

        <item><term> 
         
        MinimumRange.Value </term> <description> 
         
        0.00 (millimeters part), 0.00 (inches part) </description> </item> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  VDVCameraBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Used to indicate the type of method to create camera */
            public: enum CameraCreationTypes
            {
                CameraCreationTypesRadial/** Radial */,
                CameraCreationTypesDynamic/** Manip */
            };

            /**Used to indicate the type of camera */
            public: enum CameraTypes
            {
                CameraTypesRectangular/** rectangular */ ,
                CameraTypesConical/** conical */ ,
                CameraTypesFishEye/** fish eye */ 
            };
            ...
            /**Returns  the distance between top from apex of pyramid 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MinimumRange
            (
            );
            /**Returns  the distance between base and apex of pyramid 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MaximumRange
            (
            );
            /**Returns  the type of method to create camera 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::VDVCameraBuilder::CameraCreationTypes CameraCreationType
            (
            );
            /**Sets  the type of method to create camera 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : vehicle_des_val (" Vehicle Design and Validation") */
            public: void SetCameraCreationType
            (
                NXOpen::Features::VDVCameraBuilder::CameraCreationTypes cameraCreationType /** cameracreationtype */ 
            );
            /**Returns  the type of camera 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::VDVCameraBuilder::CameraTypes CameraType
            (
            );
            ...
            (
                NXOpen::Features::VDVCameraBuilder::CameraTypes cameraType /** cameratype */ 
            );
            /**Returns  the cone angle 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ConeAngle
            (
            );
        };
    }
