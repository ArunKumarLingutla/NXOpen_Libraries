    ...
    namespace PcbExchange
    {
        ...
        */
        class NXOPENCPP_PCBEXCHANGEEXPORT  BoardPropertiesBuilder : public NXOpen::Builder
        {
            ...
            {
                GeneratorOptionBoardProperties/** board properties */ ,
                GeneratorOptionEDABridge/** edabridge */ 
            };
            ...
            public: enum BoardStackupOption
            {
                ...
                BoardStackupOptionFromTeamcenter/** from teamcenter */ 
            };
            ...
            /**Returns  the generator. 
             ...
             <br> License requirements : None */
            public: NXOpen::PcbExchange::BoardPropertiesBuilder::GeneratorOption Generator
            (
            );
            /**Sets  the generator. 
             <br>  Created in NX2406.0.0.  <br>  
            ...
            (
                NXOpen::PcbExchange::BoardPropertiesBuilder::GeneratorOption option /** option */ 
            );
            ...
            /**Returns  the board stackup number. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXString BoardStackupNumber
            (
            );
            /**Sets  the board stackup number. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetBoardStackupNumber
            (
                const NXString & stackupNumber /** stackupnumber */ 
            );
            /**Sets  the board stackup number. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            void SetBoardStackupNumber
            (
                const char * stackupNumber /** stackupnumber */ 
            );
            /**Returns  the board stackup revision. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXString BoardStackupRevision
            (
            );
            /**Sets  the board stackup revision. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetBoardStackupRevision
            (
                const NXString & stackupRevision /** stackuprevision */ 
            );
            /**Sets  the board stackup revision. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            void SetBoardStackupRevision
            (
                const char * stackupRevision /** stackuprevision */ 
            );
        };
    }
}
