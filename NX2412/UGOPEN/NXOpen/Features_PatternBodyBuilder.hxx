...
//
//  Source File:
//     Features_PatternBodyBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class PatternBodyBuilderImpl;
        /**
            Represents a @link Features::PatternBody Features::PatternBody@endlink  builder
             <br> To create a new instance of this class, use @link NXOpen::Features::FeatureCollection::CreatePatternBodyBuilder  NXOpen::Features::FeatureCollection::CreatePatternBodyBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        PatternDefinition.AxialDefinition.AngularSpacing.NCopies.Value </term> <description> 
         
        12 </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.AngularSpacing.PitchAngle.Value </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.AngularSpacing.PitchDistance.Value </term> <description> 
         
        10 (millimeters part), 1 (inches part) </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.AngularSpacing.SpaceType </term> <description> 
         
        Offset </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.AngularSpacing.SpanAngle.Value </term> <description> 
         
        360 (millimeters part), 360 (inches part) </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.AngularSpacing.UsePitchOption </term> <description> 
         
        Angle </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.AxialSpacing.NCopies.Value </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.CreateLastStaggered </term> <description> 
         
        true </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.HorizontalRef.RotationAngle.Value </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.MeasureDistanceType </term> <description> 
         
        AlongAxis </description> </item> 

        <item><term> 
         
        PatternDefinition.AxialDefinition.StaggerType </term> <description> 
        ...
        PatternDefinition.PatternOrientation.AxialOrientationOption </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  PatternBodyBuilder : public NXOpen::Features::FeatureBuilder
        {
            private: PatternBodyBuilderImpl * m_patternbodybuilder_impl;
            private: friend class  _PatternBodyBuilderBuilder;
            protected: PatternBodyBuilder();
            public: ~PatternBodyBuilder();
