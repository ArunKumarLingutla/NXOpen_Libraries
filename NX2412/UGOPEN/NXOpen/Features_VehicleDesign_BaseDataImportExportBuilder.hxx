...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            CheckDependentExpressions </term> <description> 
             
            0 </description> </item> 

            <item><term> 
             
            ExportOption </term> <description> 
             
            NewItem </description> </item> 

            <item><term> 
             
            OperateOption </term> <description> 
             
            Import </description> </item> 

            <item><term> 
             
            OverrideExistingExpressions </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  BaseDataImportExportBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the value which indicates whether to check dependent expressions and sort them when importing from excel file. 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: bool CheckDependentExpressions
                (
                );
                /**Sets  the value which indicates whether to check dependent expressions and sort them when importing from excel file. 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : gateway ("UG GATEWAY") */
                public: void SetCheckDependentExpressions
                (
                    bool checkDependentExpressions /** checkdependentexpressions */ 
                );
            };
        }
    }
