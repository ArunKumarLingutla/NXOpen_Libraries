...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ExpressionGroupCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::ExpressionGroup *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::ExpressionGroup **;
            using reference = NXOpen::ExpressionGroup *&;
        ...
        /** Create an expression group.  @return  the new expression group 
         <br>  Created in NX10.0.0.  <br>  
        ...
        /** Change the name of the expression group. 
        ...
        /** Deletes an array of one or more expression groups. This method should be used when deleting an
                Expression group. DO NOT use the delete methods in @link NXOpen::Update NXOpen::Update@endlink  to delete expression groups 
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
        public: void Delete
        (
        ...
        /** Make all expression groups visible. 
         ...
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX2406.0.0.  This functionality is no longer supported.") void SetAllGroupsVisible
        (
        );
