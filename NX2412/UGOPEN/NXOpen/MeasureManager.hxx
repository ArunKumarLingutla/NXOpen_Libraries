...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  MeasureManager
    {
        ...
        {
            SectionTypeSolid/** solid */ ,
            SectionTypeHollow/** hollow */ 
        };

        /** Indicates the delta value type of distance or projected measurement */
        public: enum DistanceDeltaValue
        {
            DistanceDeltaValueX/** x */ ,
            DistanceDeltaValueY/** y */ ,
            DistanceDeltaValueZ/** z */ 
        };

        /** the alternative solution of extreme area measurement */
        public: enum ExtremeAreaType
        {
            ExtremeAreaTypeInscribedRadius/** inscribed radius */ ,
            ExtremeAreaTypeInscribedDiameter/** inscribed diameter */ ,
            ExtremeAreaTypeCircumscribedRadius/** circumscribed radius */ ,
            ExtremeAreaTypeCircumscribedDiameter/** circumscribed diameter */ 
        };
        ...
        /** Create a distance measurement element (with the given two units) between selection intent collections under a master measurement.
             <br> Allowed input objects include - Point, Curve, Edge, Face, Body, 
            Datum Plane, Datum Axis and Facet Body.  <br> 
             @return  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement * DistanceElementWithUnits
        (
            NXOpen::MeasureMaster * masterMeasurement /** parent master measurement */,
            NXOpen::Unit * lengthUnit /** unit of distance measure */,
            NXOpen::Unit * pointUnit /** unit of end points */,
            int alternateSolution /** chooses the algorithm type such as min max */,
            bool requireExact /** determines the type of geometry to use */,
            NXOpen::ScCollector * collection1 /** First set of objects */,
            NXOpen::ScCollector * collection2 /** Second set of objects */,
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: NXOpen::Scalar * EmbeddedDistanceDelta
        (
            NXOpen::Unit * lengthUnit /** Measurement units */,
            int alternateSolution /** chooses the algorithm type such as min max */,
            bool requireExact /** determines the type of geometry to use */,
            NXOpen::MeasureManager::DistanceDeltaValue deltaValue /** delta value type */,
            NXOpen::ScCollector * collection1 /** First set of objects */,
            NXOpen::ScCollector * collection2 /** Second set of objects */,
            const std::vector<NXOpen::DisplayableObject *> & objects1 /** Array of extra objects for the first set that can't be in a collector */,
            const std::vector<NXOpen::DisplayableObject *> & objects2 /** Array of extra objects for the second set that can't be in a collector */,
        ...
        /** Edit a distance measurement element (with given two units).
             <br> Allowed input objects include - Point, Curve, Edge, Face, Body, 
            Datum Plane, Datum Axis and Facet Body.  <br> 
            
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void EditDistanceElementWithUnits
        (
            NXOpen::MeasureElement * data /** measure element */,
            NXOpen::Unit * lengthUnit /** unit of distance measure */,
            NXOpen::Unit * pointUnit /** unit of end points */,
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void EditEmbeddedDistanceDelta
        (
            NXOpen::Scalar * measurement /** the measurement */,
            NXOpen::Unit * lengthUnit /** Measurement units */,
            int alternateSolution /** chooses the algorithm type such as min max */,
        ...
        /** Create an embedded point measurement between a point and either the absolute csys, or a 
         ...
         <br>  Created in NX12.0.1.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedPoint
        (
            NXOpen::Point * point /** point to measure */,
            NXOpen::CartesianCoordinateSystem * csys /** optional reference coordinate system */,
            NXString* name /** the name of the measurement */
        );
        /** Create an embedded point measurement (with the given unit) between a point and either the absolute csys, or a 
            specified coordinate system.
             <br> If the csys is a null tag, then the measurement is to the absolute coordinate system. <br>   @return  the measurement 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedPointWithUnit
        (
            NXOpen::Point * point /** point to measure */,
            NXOpen::CartesianCoordinateSystem * csys /** optional reference coordinate system */,
            NXOpen::Unit * unit /** Point unit */,
            NXString* name /** the name of the measurement */
        );
        ...
        /** Creates an embedded face properties measurement from a selection intent collector.
         ...
         <br>  Created in NX12.0.1.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedFaceProperties
        (
        ...
        (
            NXOpen::NXObject * measurement /** the measurement */,
            int outputField /** selects which output will be returned */,
            const std::vector<NXOpen::Unit *> & faceUnits /** An array of input units: 
                                Area unit, Length unit, Diameter or Radius unit, unit for center of gravity , unit for mini radius of curvature */,
            int alternateSolution /** chooses the calculation of radius or diameter */,
        ...
        /** Create a projected distance measurement element (with given two units) between selection intent collections under a master measurement.
             <br> Allowed input objects include - Point, Curve, Edge, Face, Body, 
            Datum Plane, Datum Axis and Facet Body.  <br> 
             @return  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement * ProjectedDistanceElementWithUnits
        (
            NXOpen::MeasureMaster * masterMeasurement /** parent master measurement */,
            NXOpen::Unit * lengthUnit /** unit of projected distance */,
            NXOpen::Unit * pointUnit /** unit of end points */,
            int alternateSolution /** chooses the algorithm type such as min max */,
            bool requireExact /** determines the type of geometry to use */,
            NXOpen::ScCollector * collection1 /** First set of objects */,
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Scalar * EmbeddedProjectedDistanceDelta
        (
            NXOpen::Unit * lengthUnit /** Measurement units */,
            int alternateSolution /** chooses the algorithm type such as min max */,
            bool requireExact /** determines the type of geometry to use */,
        ...
        /** Edit a projected distance measurement element (with given two units).
             <br> Allowed input objects include - Point, Curve, Edge, Face, Body, 
            Datum Plane, Datum Axis and Facet Body.  <br> 
            
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void EditProjectedDistanceElementWithUnits
        (
            NXOpen::MeasureElement * data /** measure element */,
            NXOpen::Unit * lengthUnit /** unit of projected distance */,
            NXOpen::Unit * pointUnit /** unit of end points */,
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void EditEmbeddedProjectedDistanceDelta
        (
            NXOpen::Scalar * measurement /** the measurement */,
            NXOpen::Unit * lengthUnit /** Measurement units */,
            int alternateSolution /** chooses the algorithm type such as min max */,
        ...
        (
            NXOpen::MeasureMaster * masterMeasurement /** parent master measurement */,
            const std::vector<NXOpen::Unit *> & massUnits /** An array of input units:
                      Length unit, Area unit, Volume unit, Density unit, Mass unit, Moment of inertia unit, Mass length unit, 
                      Force unit */,
            double accuracy /** The accuracy of the calculation (between 0.0 and 1.0) */,
        ...
        /** Create a point measurement element (with the given unit) between a point and either the absolute csys, or a 
            specified coordinate system.
             <br> If the csys is a null tag, then the measurement is to the absolute coordinate system. <br>   @return  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement * PointElementWithUnit
        (
            NXOpen::MeasureMaster * masterMeasurement /** parent master measurement */,
            NXOpen::Point * point /** point to measure */,
            NXOpen::CartesianCoordinateSystem * csys /** optional reference coordinate system */,
        ...
        /** Edit a point measurement element (with the given unit) between a point and either the absolute csys, or a 
            specified coordinate system.
             <br> If the csys is a null tag, then the measurement is to the absolute coordinate system. <br>  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void EditPointElementWithUnit
        (
            NXOpen::MeasureElement * data /** data */ ,
            NXOpen::Point * point /** point to measure */,
            NXOpen::CartesianCoordinateSystem * csys /** optional reference coordinate system */,
        ...
        /** Edit an embedded point measurement (with the given unit) between a point and either the absolute csys, or a 
            specified coordinate system.
             <br> If the csys is a null tag, then the measurement is to the absolute coordinate system. <br>  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void EditEmbeddedPointWithUnit
        (
            NXOpen::NXObject * measurement /** the measurement */,
            NXOpen::Point * point /** point to measure */,
            NXOpen::CartesianCoordinateSystem * csys /** optional reference coordinate system */,
        ...
        /** Creates a non-associative dimension annotation on specified position.  @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Annotations::Annotation * CreateDimensionAnnotationOnPosition
        (
            const NXOpen::Point3d & startPoint /** the start point */,
            const NXOpen::Point3d & endPoint /** the end point */,
            const NXOpen::Point3d & position /** the position of annotation */,
            const NXString & annotationText /** the formatted display string*/
        );
        /** Creates a non-associative dimension annotation on specified position.  @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Annotations::Annotation * CreateDimensionAnnotationOnPosition
        (
            const NXOpen::Point3d & startPoint /** the start point */,
            const NXOpen::Point3d & endPoint /** the end point */,
            const NXOpen::Point3d & position /** the position of annotation */,
        ...
        /** Creates a non-associative note annotation on specified position.  @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Annotations::Annotation * CreateNoteAnnotationOnPosition
        (
            const NXOpen::Point3d & anchorPoint /** the anchor point */,
            const NXOpen::Point3d & position /** the position of annotation */,
            const std::vector<NXString> & annotationText /** Array of text strings for the label */
        ...
        /** Creates a non-associative angle annotation on specified position.  @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Annotations::Annotation * CreateAngleAnnotationOnPosition
        (
            const NXOpen::Point3d & basePoint /** the base point */,
            const NXOpen::Point3d & endPoint1 /** the first end point */,
            const NXOpen::Point3d & endPoint2 /** the second end point */,
        ...
        /** Creates a non-associative angle annotation on specified position.  @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Annotations::Annotation * CreateAngleAnnotationOnPosition
        (
            const NXOpen::Point3d & basePoint /** the base point */,
            const NXOpen::Point3d & endPoint1 /** the first end point */,
            const NXOpen::Point3d & endPoint2 /** the second end point */,
        ...
        /** 
         ...
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedCenterlineProperties
        (
            int outputField /** selects which output will be returned */,
        ...
        /** 
         ...
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedBboxProperties
        (
            int outputField /** selects which output will be returned */,
            const std::vector<NXOpen::Unit *> & centerlineUnits /** An array of input units: Length Units */,
            NXOpen::ScCollector * objects /** Collection of components */,
        ...
        /** Create an exteme_point embedded measurement  @return  the measurement 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedExtremePoint
        (
            NXOpen::Unit * units /** Measurement units */,
            bool requireExact /** determines the type of geometry to use */,
            NXOpen::ScCollector * objects /** Bodies, faces, curves and edges */,
        ...
        /** Verify if the given annotation is a measure annotation  @return  
         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: bool GetIsMeasureAnnotation
        (
            NXOpen::NXObject * annotation /** the annotation */
        );
        /** Set the measurement owning part as transient status 
         <br>  Created in NX1903.0.0.  <br>  
         <br> License requirements : None */
        public: void SetPartTransientModification
        (
        );
        /** Remove transient status of the measurement owning part 
         <br>  Created in NX1903.0.0.  <br>  
         <br> License requirements : None */
        public: void ClearPartTransientModification
        (
        );
        /** Set the selection intent methods for objects in measure. 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: void SetSelectionIntent
        (
            NXOpen::Scalar * measurement /** the measurement */,
            int selectionIntent1 /** the selection intent method of first object or object set */,
            int selectionIntent2 /** the selection intent method of second object or object set */
        );
        /** Get the selection intent methods from objects in measure 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: void GetSelectionIntent
        (
            NXOpen::Scalar * measurement /** the measurement */,
            int* selectionIntent1 /** the selection intent method of first object or object set */,
            int* selectionIntent2 /** the selection intent method of second object or object set */
        );
        /** Creates a @link NXOpen::MeasurePrefsBuilder NXOpen::MeasurePrefsBuilder@endlink   @return  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasurePrefsBuilder * CreateMeasurePrefsBuilder
        (
        );
        /** Create a section inertia measurement element for a selection intent collection under a master measurement.  @return  
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement * SectionInertiaElement
        (
            NXOpen::MeasureMaster * masterMeasurement /** parent master measurement */,
            const std::vector<NXOpen::Unit *> & sectionUnits /** An array of input units:
                                                                                            Point unit, Moment of inertia area unit, Length unit, Area unit*/,
            NXOpen::ScCollector * objects /** section curves to measure */,
            NXOpen::MeasureManager::SectionType sectionType /** section type, solid or hollow */,
            double thickness /** thickness used for to compute a hollow section inertia */
        );
        /** Edit a section measurement element. 
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: void EditSectionInertiaElement
        (
            NXOpen::MeasureElement * data /** measure element */,
            const std::vector<NXOpen::Unit *> & sectionUnits /** An array of input units:
                                                                                            Point unit, Moment of inertia area unit, Length unit, Area unit*/,
        ...
        /** Create a circle measurement element between three non-collinear points.  @return  
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement * Circle3ptElement
        (
            NXOpen::MeasureMaster * masterMeasurement /** the parent master measurement */,
            NXOpen::Unit * lengthUnit /** unit used for calculate radius and diameter, 
                                                                                 will use work part base unit if input a null */,
            NXOpen::Unit * pointUnit /** unit used for represent centroid of circle,
                                                                                 will use work part base unit if input a null */,
            int alternateSolution /** chooses the calculation of radius or diameter */,
            NXOpen::Point * point1 /** point1 on circle */,
            NXOpen::Point * point2 /** point2 on circle */,
            NXOpen::Point * point3 /** point3 on circle */
        );
        /** Create an embedded circle measurement between three non-collinear points.  @return  the measurement 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedCircle3pt
        (
            int outputField /** selects which output will be returned */,
            NXOpen::Unit * lengthUnit /** unit used for calculate radius and diameter, 
                                                                                 will use work part base unit if input a null */,
        ...
        /** Edit a circle measurement element between three non-collinear points. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void EditCircle3ptElement
        (
            NXOpen::MeasureElement * data /** data */ ,
            NXOpen::Unit * lengthUnit /** unit used for calculate radius and diameter, 
                                                                                 will use work part base unit if input a null */,
        ...
        /** Edit an embedded circle measurement between three non-collinear points. 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void EditEmbeddedCircle3pt
        (
            NXOpen::Scalar * measurement /** the measurement */,
            int outputField /** selects which output will be returned */,
            NXOpen::Unit * lengthUnit /** unit used for calculate radius and diameter, 
        ...
        /** Creates an extreme area measurement from the collection of input points, curves or sheet body.
                 <br> Extreme circle allow for measurement the inscribed circle or circumscribed circle for a set of planar objects. <br>     
             @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::MeasureElement * ExtremeAreaElement
        (
            NXOpen::MeasureMaster * masterMeasurement /** the parent master measurement */,
            NXOpen::Unit * lengthUnit /** unit used for calculate radius or diameter of the inscribed circle or cicumscribed circle, 
                                                                                 will use work part base unit if input a null */,
            NXOpen::Unit * pointUnit /** unit used for represent centroid of circle,
                                                                                 will use work part base unit if input a null */,
            NXOpen::MeasureManager::ExtremeAreaType alternateSolution /** chooses the calculation of inscribed circle or cicumscribed circle */,
            NXOpen::ScCollector * objects /** Collection of coplanar points, curves or sheet body */
        );
        /** Create an embedded extreme area measurement from the collection of input points, curves or sheet body.  @return  the measurement 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * EmbeddedExtremeArea
        (
            int outputField /** selects which output will be returned
                                                                                 0: radius/diameter of the inscribed circle or cicumscribed circle
                                                                                 1: centroid point of this circle base what alternate_solution inputs. */,
            NXOpen::Unit * unitTag /** unit used for calculate the measure results */,
            NXOpen::MeasureManager::ExtremeAreaType alternateSolution /** chooses the calculation of inscribed circle or cicumscribed circle */,
            NXOpen::ScCollector * objects /** Collection of coplanar points, curves or sheet body */,
            NXString* name /** the name of the measurement */
        );
        /** Edit an extreme area measurement element from the collection of input points, curves or sheet body. 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void EditExtremeAreaElement
        (
            NXOpen::MeasureElement * data /** data */ ,
            NXOpen::Unit * lengthUnit /** unit used for calculate radius or diameter of the inscribed circle or cicumscribed circle,
                                                                                 will use work part base unit if input a null */,
        ...
        /** Edit an embedded extreme area measurement from the collection of input points, curves or sheet body. 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: void EditEmbeddedExtremeArea
        (
            NXOpen::Scalar * measurement /** the measurement */,
            int outputField /** selects which output will be returned.
                                                                                 0: radius/diameter of the inscribed circle or cicumscribed circle
