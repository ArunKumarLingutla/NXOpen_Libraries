    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  MachinePocketGroupBuilder : public NXOpen::CAM::NCGroupBuilder
        {
            ...
            */
            public: enum NX_DEPRECATED("Deprecated in NX8.5.0.  This NXOpen::CAM::MachinePocketGroupBuilder::RegisterType is no longer supported.") RegisterType
            {
            ...
            /**Returns  the adjust register type 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAM::MachinePocketGroupBuilder::AdjustIdBuilder CAM::MachinePocketGroupBuilder::AdjustIdBuilder@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::MachinePocketGroupBuilder::AdjustIdBuilder instead.") NXOpen::CAM::MachinePocketGroupBuilder::RegisterType AdjustRegisterType
            (
            );
            ...
            public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::MachinePocketGroupBuilder::AdjustIdBuilder instead.") void SetAdjustRegisterType
            (
            ...
            /**Returns  the cutcom register type 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAM::MachinePocketGroupBuilder::CutcomIdBuilder CAM::MachinePocketGroupBuilder::CutcomIdBuilder@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::MachinePocketGroupBuilder::CutcomIdBuilder instead.") NXOpen::CAM::MachinePocketGroupBuilder::RegisterType CutcomRegisterType
            (
            );
            /**Sets  the cutcom register type 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::MachinePocketGroupBuilder::CutcomIdBuilder instead.") void SetCutcomRegisterType
            (
                NXOpen::CAM::MachinePocketGroupBuilder::RegisterType type /** type */ 
            );
            ...
            (
                ...
                const NXString & name /** Holding system name */
            );
            /** Creates a new holding system builder  @return  holding system builder
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                int position /** position */,
                const char * name /** Holding system name */
            );
