...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AngularBlanking </description> </item> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ForceCalculationBuilder : public NXOpen::Builder
        {
            ...
            public: std::vector<NXString> CalculateForce
            (
                std::vector<NXString> & strings /** strings */ ,
                int radPattern /** radpattern */ 
            );
            ...
            (
                ...
                const NXString & attrName /** attr name */ ,
                const NXString & attrValue /** attr value */ 
            );
            /** Assign the attributes. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
