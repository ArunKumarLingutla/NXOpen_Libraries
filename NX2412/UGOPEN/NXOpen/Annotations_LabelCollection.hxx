...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LabelCollection : public NXOpen::TaggedObjectCollection
        {
            private: LabelCollectionImpl * m_labelcollection_impl;
            private: NXOpen::Part* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit LabelCollection(NXOpen::Part *owner);
            ...
            //lint -sem(NXOpen::Annotations::LabelCollection::iterator::copy,initializer)
            class iterator
            {
            public:
                using value_type = NXOpen::Annotations::Label *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::Label **;
                using reference = NXOpen::Annotations::Label *&;
