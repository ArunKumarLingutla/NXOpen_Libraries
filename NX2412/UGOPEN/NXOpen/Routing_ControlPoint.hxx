...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** 
             ...
             <br> To create an instance of this object use @link Routing::ControlPointCollection::CreateControlPoint Routing::ControlPointCollection::CreateControlPoint@endlink   <br> 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  ControlPoint : public NXOpen::SmartObject, public virtual NXOpen::Routing::IRoutePosition
        {
            ...
            /**  Removes the touch constraint that exists between the 
                         ...
                         Call @link NXOpen::Update::DoUpdate NXOpen::Update::DoUpdate@endlink  afterward to ensure that
            ...
            /** Returns all the control points from different stock components that are connected to the given control point.  @return  The equivalent control points from other stock components. 
             <br>  Created in NX2506.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::ControlPoint *> FindConnectedControlPoints
            (
            );
