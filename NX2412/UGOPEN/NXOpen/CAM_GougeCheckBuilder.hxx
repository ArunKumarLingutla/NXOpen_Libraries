        ...
        class NXOPENCPP_CAMEXPORT  GougeCheckBuilder : public NXOpen::Builder
        {
            ...
            */
            ...
            /**Returns  the tool shape. 
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use the Session Customer Default Tool Shape for IPW instead.") NXOpen::CAM::GougeCheckBuilder::ToolShapeType ToolShape
            (
            );
            /**Sets  the tool shape. 
                        This is the setting for which tool shape type is used for the gouge checking.
