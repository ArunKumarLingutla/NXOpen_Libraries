        ...
        */
        class NXOPENCPP_FACETEXPORT  DecimateFacetBodyBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the facet bodies to be decimated. Inputs to this command can be convergent objects.
             ...
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Facet::SubdivideFacetBodyBuilder::FacetCollector instead.") NXOpen::SelectDisplayableObjectList * Bodies
            (
            );
            /**Returns  an optional list of regions on the facet bodies to be decimated. 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Facet::SubdivideFacetBodyBuilder::FacetCollector instead.") NXOpen::GeometricUtilities::BoundaryDefinitionBuilderList * RegionList
            (
            );
