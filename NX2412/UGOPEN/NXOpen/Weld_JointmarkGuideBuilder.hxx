    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  JointmarkGuideBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the option to control whether new points should be added when the feature is edited.  If true new points can to be added, otherwise no new points will be added. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: bool RespacePoints
            (
            );
            /**Sets  the option to control whether new points should be added when the feature is edited.  If true new points can to be added, otherwise no new points will be added. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ugweld ("UG WELD") */
            public: void SetRespacePoints
            (
                bool respacePoints /** respacepoints */ 
            );
