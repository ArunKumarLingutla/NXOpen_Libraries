    ...
    namespace AnimationDesigner
    {
        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  MechanicalCamBuilder : public NXOpen::Builder
        {
            ...
            {
                ColorOptionsSpecifyColor/** Assigns a color to the mechanical cam */,
                ColorOptionsNoColor/** Assigns no color to the mechanical cam */
            };
            ...
            /**Returns  the color option. 
             ...
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: NXOpen::AnimationDesigner::MechanicalCamBuilder::ColorOptions ColorOption
            (
            );
            ...
            (
                NXOpen::AnimationDesigner::MechanicalCamBuilder::ColorOptions colorOption /** coloroption */ 
            );
            /**Returns  the color. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
