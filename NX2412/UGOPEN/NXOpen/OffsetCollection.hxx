...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  OffsetCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::Offset *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Offset **;
            using reference = NXOpen::Offset *&;
        ...
        /** 
           Create an @link NXOpen::Offset NXOpen::Offset@endlink  without parameters.
            @return   
         <br>  Created in NX3.0.0.  <br>  
        ...
        /**
           Create an @link NXOpen::Offset NXOpen::Offset@endlink  using X, Y and Z deltas.
            @return   
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        ...
        /** 
           Creates a smart cylindrical @link NXOpen::Offset NXOpen::Offset@endlink . 
        ...
        /**
           Creates a smart spherical @link NXOpen::Offset NXOpen::Offset@endlink .
        ...
        /**
           Creates an @link NXOpen::Offset NXOpen::Offset@endlink  using a Smart @link NXOpen::Direction NXOpen::Direction@endlink  and distance.
            @return   
        ...
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::ICurve NXOpen::ICurve@endlink  using a
               @link NXOpen::Scalar NXOpen::Scalar@endlink  representing the t parameter. The Offset created
               represents curvature of the curve at parameter t.  @return   
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::Offset * CreateCurvature
        (
            NXOpen::ICurve * icurve /** @link NXOpen::Curve NXOpen::Curve@endlink  or @link NXOpen::Edge NXOpen::Edge@endlink  */,
            NXOpen::Scalar * t /** t */ ,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::ICurve NXOpen::ICurve@endlink  using a
               @link NXOpen::Point NXOpen::Point@endlink . The Offset created represents curvature of the curve at a point. 
        ...
        (
            ...
            NXOpen::ICurve * icurve /** Optional @link NXOpen::Curve NXOpen::Curve@endlink  or @link NXOpen::Edge NXOpen::Edge@endlink  input */,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::ICurve NXOpen::ICurve@endlink  using a
               @link NXOpen::Scalar NXOpen::Scalar@endlink  representing the t parameter. The Offset created
        ...
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::ICurve NXOpen::ICurve@endlink  using a
               @link NXOpen::Point NXOpen::Point@endlink . The Offset created represents curvature derivative of the curve at a point.
               The input point could be an extract point whose parent point is a point on curve.
               User can optionally supply a curve in which case it is honored instead of looking for the parent
               curve of the input point. In that case input point is projected on the curve to find the curvature
        ...
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::Face NXOpen::Face@endlink  using two 
               @link NXOpen::Scalar NXOpen::Scalar@endlink s representing the u and v parameters with option of
        ...
        (
            ...
            NXOpen::Direction * sectionDirection /** necessary when option is @link NXOpen::Offset::OnFaceOptionSection NXOpen::Offset::OnFaceOptionSection@endlink  */,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::Face NXOpen::Face@endlink  using two 
               @link NXOpen::Scalar NXOpen::Scalar@endlink s representing the u and v parameters with option of
        ...
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::Face NXOpen::Face@endlink  using a 
               @link NXOpen::Point NXOpen::Point@endlink . The Offset created represents the curvature of the face 
        ...
        (
            ...
            NXOpen::Offset::OnFaceOption option /** option */ ,
            NXOpen::SmartObject * sectionDirection /** An object of type @link NXOpen::Direction NXOpen::Direction@endlink  or @link NXOpen::Scalar NXOpen::Scalar@endlink  and is necessary when option is @link NXOpen::Offset::OnFaceOptionSection NXOpen::Offset::OnFaceOptionSection@endlink  */,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ 
        );
        /** Creates a @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::Face NXOpen::Face@endlink  using a 
               @link NXOpen::Point NXOpen::Point@endlink . The Offset created represents the curvature derivative
        ...
        /** Creates a sectional @link NXOpen::Offset NXOpen::Offset@endlink  on a @link NXOpen::Face NXOpen::Face@endlink  using two 
               @link NXOpen::Scalar NXOpen::Scalar@endlink s representing the u and v parameters and a 
        ...
        /**
           Creates a @link NXOpen::Offset NXOpen::Offset@endlink  via an extract @link NXOpen::Offset NXOpen::Offset@endlink  with optional transformation.
            @return   
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::Offset * CreateOffset
