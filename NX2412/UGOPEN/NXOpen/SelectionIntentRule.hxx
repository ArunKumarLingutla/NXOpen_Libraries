    ...
    */
    class NXOPENCPPEXPORT  SelectionIntentRule : public NXOpen::TransientObject
    {
        ...
        public: enum RuleType
        {
            ...
            RuleTypeFaceHole/** See documentation for  @link  NXOpen::FaceHoleFacesRule   NXOpen::FaceHoleFacesRule @endlink  for more details*/,
            RuleTypeTangentSheetBodies/** See documentation for  @link  NXOpen::TangentSheetBodiesRule   NXOpen::TangentSheetBodiesRule @endlink  for more details*/,
            RuleTypeAdjacentSheetBodies/** See documentation for  @link  NXOpen::AdjacentSheetBodiesRule   NXOpen::AdjacentSheetBodiesRule @endlink  for more details*/,
            RuleTypeConnectedSheetBodies/** See documentation for  @link  NXOpen::ConnectedSheetBodiesRule   NXOpen::ConnectedSheetBodiesRule @endlink  for more details*/,
            RuleTypeSheetAndAdjacentSheetBodies/** See documentation for  @link  NXOpen::SheetAndAdjacentSheetBodiesRule   NXOpen::SheetAndAdjacentSheetBodiesRule @endlink  for more details*/,
            RuleTypeFaceCurvatureCrossSectionFaces/** See documentation for  @link  NXOpen::FaceCurvatureCrossSectionFacesRule   NXOpen::FaceCurvatureCrossSectionFacesRule @endlink  for more details*/,
            RuleTypeEdgeGroupFaceBoundaryEdges/** See documentation for  @link  NXOpen::EdgeGroupFaceBoundaryEdgesRule   NXOpen::EdgeGroupFaceBoundaryEdgesRule @endlink  for more details*/,
