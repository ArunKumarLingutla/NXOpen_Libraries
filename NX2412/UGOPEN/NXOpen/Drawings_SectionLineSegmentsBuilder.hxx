        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  SectionLineSegmentsBuilder : public NXOpen::TaggedObject
        {
            ...
            /** Sets spline curve data for longitudinal section. 
                        ...
                        If curve is NULL then the existing curve will be used. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetLongitudinalSectionData
            (
                NXOpen::ICurve * curve /** curve */ ,
                double startParam /** startparam */ ,
                double endParam /** endparam */ 
            );
            /** Gets spline curve data for longitudinal section. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void GetLongitudinalSectionData
            (
                NXOpen::ICurve ** curve /** curve */ ,
                double* startParam /** startparam */ ,
                double* endParam /** endparam */ 
