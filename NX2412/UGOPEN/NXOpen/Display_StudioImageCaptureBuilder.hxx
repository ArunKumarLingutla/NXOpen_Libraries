...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /** Represents a @link NXOpen::Display::StudioImageCaptureBuilder NXOpen::Display::StudioImageCaptureBuilder@endlink   
             <br> This class is available in an interactive as well as in non-interactive session supporting headless graphics. 
            NULL. <br>  <br> To create a new instance of this class, use @link NXOpen::ViewCollection::CreateStudioImageCaptureBuilder  NXOpen::ViewCollection::CreateStudioImageCaptureBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  StudioImageCaptureBuilder : public NXOpen::Builder
        {
            ...
            /** Provide the following background style of the captured image. */
            public: enum BackgroundOptions
            {
                BackgroundOptionsOriginal/** Use the currently displayed background */,
                BackgroundOptionsCustomColor/** Use the solid color set by @link Display::StudioImageCaptureBuilder::SetCustomBackgroundColor Display::StudioImageCaptureBuilder::SetCustomBackgroundColor@endlink  */,
            ...
            {
                SourceTypeWorkView/** Create image from work view */,
                SourceTypeWindow/** Create image from window of work view */
            };
            ...
            /**Returns  the background option of capture image 
             ...
             <br> License requirements : None */
            public: NXOpen::Display::StudioImageCaptureBuilder::BackgroundOptions BackgroundOption
            (
            );
            /**Sets  the background option of capture image 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetBackgroundOption
            (
                NXOpen::Display::StudioImageCaptureBuilder::BackgroundOptions backgroundOption /** backgroundoption */ 
            );
            /** Gets the custom background color of capture image  @return  Array of 3 RGB values, each between 0 and 1 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Sets  the enhance edges of capture image 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the source of image capture 
             ...
             <br> License requirements : None */
            public: NXOpen::Display::StudioImageCaptureBuilder::SourceType Source
            (
            );
            /**Sets  the source of image capture 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetSource
            (
                NXOpen::Display::StudioImageCaptureBuilder::SourceType source /** source */ 
            );
        };
    }
}
