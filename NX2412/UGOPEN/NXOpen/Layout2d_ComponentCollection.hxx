...
#include <NXOpen/Layout2d_ComponentActiveSetBuilder.hxx>
    ...
    namespace Layout2d
    {
        ...
        */
        class NXOPENCPP_LAYOUT2DEXPORT  ComponentCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Layout2d::Component *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Layout2d::Component **;
                using reference = NXOpen::Layout2d::Component *&;
            ...
            (
                NXOpen::Layout2d::Component * component /** Reserved for future use.  Use NULL. */
            );
            ...
            /** Creates a @link NXOpen::Layout2d::ComponentActiveSetBuilder NXOpen::Layout2d::ComponentActiveSetBuilder@endlink  
             ...
             <br> License requirements : nx_layout ("NX Layout") */
            public: NXOpen::Layout2d::ComponentActiveSetBuilder * CreateComponentActiveSetBuilder
            (
            );
