    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimBC : public NXOpen::DisplayableObject, public virtual NXOpen::CAE::IExportableFEEntity
        {
            ...
            /**Returns  the family name of a BC
                     
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXString FamilyName
            (
            );
            /** Create a compatible BC of the specified type
                      @return  created bc 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SimBC * CreateCompatibleBc
            (
            ...
            /** Create a compatible BC of the specified type
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            NXOpen::CAE::SimBC * CreateCompatibleBc
            (
