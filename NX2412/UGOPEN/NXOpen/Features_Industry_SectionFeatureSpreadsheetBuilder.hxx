...
//
//  Source File:
//     Features_Industry_SectionFeatureSpreadsheetBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Industry
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  SectionFeatureSpreadsheetBuilder : public NXOpen::Builder
            {
                ...
                /**Sets  the section type 
                 ...
                 <br>  Created in NX8.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use NXOpen::Features::Industry::SectionFeatureSpreadsheetBuilder.SetSectionType()") void SetSectionType
                (
                ...
                /** 
                 ...
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetSpreadsheetDataStatus
                (
                    std::vector<NXString> & paramNames /** paramnames */ ,
                    const std::vector<int> & paramStatus /** paramstatus */ 
                );
                /** 
                ...
                /** This is an internal API and can be changed at any time 
                 ...
                 <br> License requirements : None */
                public: NXString CreateVirtualSectionType
                (
                    const NXString & keyParameterName /** the parameter name */
                );
                /** This is an internal API and can be changed at any time 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : None */
                NXString CreateVirtualSectionType
                (
                    const char * keyParameterName /** the parameter name */
                );
