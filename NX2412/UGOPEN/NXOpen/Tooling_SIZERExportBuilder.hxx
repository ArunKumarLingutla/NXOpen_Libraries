        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SIZERExportBuilder : public NXOpen::Builder
        {
            /** Represents the run mode. 
             <br>  @deprecated Deprecated in NX1926.0.0.  This enum has no replacement. It is no longer supported anymore. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX1926.0.0.  This enum has no replacement. It is no longer supported anymore.") RunMode
            {
            ...
            struct MechanicalData
            {
             ...
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Mechatronics::ExportLoadCurveBuilder::MCDMechanicalData NXOpen::Mechatronics::ExportLoadCurveBuilder::MCDMechanicalData@endlink  instead <br>  
            */
            public:
            struct NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Mechatronics::ExportLoadCurveBuilder::MCDMechanicalData instead") MCDMechanicalData
            {
                public: /** Unique ID                    */int Id;
                public: /** Mechanical Name              */NXString Name;
            ...
            /** Gets the run mode.  @return  Run mode 
             <br>  @deprecated Deprecated in NX1926.0.0.  This method has no replacement. It is no longer supported anymore. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  This method has no replacement. It is no longer supported anymore.") NXOpen::Tooling::SIZERExportBuilder::RunMode GetRunMode
            (
            );
            /** Sets the run mode. 
             <br>  @deprecated Deprecated in NX1926.0.0.  This method has no replacement. It is no longer supported anymore. <br>  
            ...
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  This method has no replacement. It is no longer supported anymore.") void SetRunMode
            (
            ...
            /** Gets all groups of mechanical data in MCD mode. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Mechatronics::ExportLoadCurveBuilder::GetMcdMechanicalData NXOpen::Mechatronics::ExportLoadCurveBuilder::GetMcdMechanicalData@endlink  instead <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Mechatronics::ExportLoadCurveBuilder::GetMcdMechanicalData instead") void GetMcdMechanicalData
            (
            ...
            /** Sets all groups of mechanical data in MCD mode. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Mechatronics::ExportLoadCurveBuilder::SetSetMcdMechanicalData NXOpen::Mechatronics::ExportLoadCurveBuilder::SetSetMcdMechanicalData@endlink  instead <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Mechatronics::ExportLoadCurveBuilder::SetSetMcdMechanicalData instead") void SetMcdMechanicalData
            (
            ...
            /** Processes the simulation data in MCD mode. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Mechatronics::ExportLoadCurveBuilder::ProcessMcdSimulationData NXOpen::Mechatronics::ExportLoadCurveBuilder::ProcessMcdSimulationData@endlink  instead <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Mechatronics::ExportLoadCurveBuilder::ProcessMcdSimulationData instead") void ProcessMcdSimulationData
            (
