    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SelectionRecipeCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::SelectionRecipe *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::SelectionRecipe **;
                using reference = NXOpen::CAE::SelectionRecipe *&;
            ...
            /** Get all selection recipes, includes selection recipe occurrences from all descendents, not just immediate. 
             <br>  Created in NX2412.9000.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void GetAllSelectionRecipes
            (
                std::vector<NXOpen::CAE::SelectionRecipe *> & selectionRecipes /** selectionrecipes */ 
            );
