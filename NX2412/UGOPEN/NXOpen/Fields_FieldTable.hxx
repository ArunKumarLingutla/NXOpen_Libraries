        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldTable : public NXOpen::Fields::Field
        {
            ...
            /**Returns  
             ...
             <br> License requirements : None */
            public: bool FallbackToDefaultInterpolator
            (
            );
            /**Sets  
                    a flag specifying if interpolator can fallback to a default interpolator, 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetFallbackToDefaultInterpolator
            (
                bool shouldFallbackToDefaultInterpolator /** fall back to default interpolator indicatorr  */
            );
            /**Returns  
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateInterpolatorOnCommit
            (
            );
            /**Sets  
                    a flag specifying if interpolator needs to be created on commit
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCreateInterpolatorOnCommit
            (
                bool shouldCreateInterpolOnCommit /** Create table interpolator on commit */
            );
            ...
            (
                ...
                double* maximumRadius /** maximum radius */,
                int* numberOfPoints /** number of points */,
                NXOpen::Fields::FieldEvaluator::InverseDistanceWeightingPowerOfDistanceEnum* powerOfDistance /** power of distance */ 
            );
            /** Set the inverse distance weighting (IDW) interpolation options 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Fields::FieldTable::SetIdwOptionsWithUnits call") void SetIdwOptions
            (
                NXOpen::Fields::FieldEvaluator::InverseDistanceWeightingEnum nearestOption /** nearest option   */,
                double nearestFraction /** fraction         */,
                double maximumRadius /** maximum radius   */,
            ...
            /** The idw options are set with units 
             ...
             <br> License requirements : None */
            public: void SetIdwOptionsWithUnits
            (
                NXOpen::Fields::FieldEvaluator::InverseDistanceWeightingEnum nearestOption /** nearest option   */,
                double nearestFraction /** fraction         */,
                double maximumRadius /** maximum radius   */,
                NXOpen::Unit * maximumRadiusUnit /** maximum radius unit */,
                int numberOfPoints /** number of points */,
                NXOpen::Fields::FieldEvaluator::InverseDistanceWeightingPowerOfDistanceEnum powerOfDistance /** power of distance */ 
            );
            /**Returns 
            ...
            /**Returns   
             ...
             <br> License requirements : None */
            public: NXOpen::Fields::FieldEvaluator::SplineDegreeOptionEnum SplineDegreeOption
            (
            );
            /**Sets   
                    the degree option used when this table data is evaluated using the spline 1d interpolator.
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetSplineDegreeOption
            (
                NXOpen::Fields::FieldEvaluator::SplineDegreeOptionEnum degreeOption /** the degree option  */
            );
            ...
            /**Sets  the delayed update flag on the table is returned
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDelayedUpdate
            (
                bool delayedUpdate /** delayedupdate */ 
            );
            ...
            /**Returns  the user defined value to return when lookup value is outside. For 1-D domains, this is the value to return when the the lookup value is below the minimum value.  For 2-D and higher domains, this is the only value that can be specified. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: double ValuesOutsideTableUserdefinedValue
            (
            );
            /**Sets  the user defined value to return when lookup value is outside. For 1-D domains, this is the value to return when the the lookup value is below the minimum value.  For 2-D and higher domains, this is the only value that can be specified. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetValuesOutsideTableUserdefinedValue
            (
                double userDefinedValue /** the value to return when look up value(s) are outside the domain (2-D and higher) or below the minimum value for the independent variable (1-D) */
            );
            /**Returns  the user defined value to return when the lookup value is greater than the highest value for the independent variable.  For 1-D independent domains only; 2-D and higher domains, this value is not used and will error out if accessed. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: double ValuesOutsideHighTableUserdefinedValue
            (
            );
            /**Sets  the user defined value to return when the lookup value is greater than the highest value for the independent variable.  For 1-D independent domains only; 2-D and higher domains, this value is not used and will error out if accessed. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetValuesOutsideHighTableUserdefinedValue
            (
                double userDefinedValueHi /** the value to return when look up value is above the maximum value for the independent variable */
            );
            /** Get point objects associated with table rows. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void GetTablePoints
            (
                std::vector<int> & pointObjectRowIds /** 0 based row ID of rows that have associated point objects, in ascending order */,
                std::vector<NXOpen::Point *> & pointObjects /** array of num_point_objects point objects associated to rows */
            );
            /** Edit the table field with point objects. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void EditFieldTableWithPoints
            (
                const std::vector<NXOpen::Fields::FieldVariable *> & indepVarArray /** independent variables to be associated with the field */,
                const std::vector<NXOpen::Fields::FieldVariable *> & depVarArray /** dependent expression fields to be associated with the formula field */,
                const std::vector<double> & datapoints /** row based array of double values representing the table; then number of points should equal the number of independent variables * the number of dependent variables * the number of rows. */,
            ...
            /** Edit the table field with expressions. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void EditFieldTableWithExpressions
            (
                const std::vector<NXOpen::Fields::FieldVariable *> & indepVarArray /** independent variables to be associated with the field */,
                const std::vector<NXOpen::Fields::FieldVariable *> & depVarArray /** dependent expression fields to be associated with the formula field */,
                const std::vector<double> & datapoints /** row based array of double values representing the table */,
                const std::vector<int> & expCellIds /** 0 array of expression strings associated to specified cells */,
                std::vector<NXString> & valueStrings /** array of num_exp_strings associated to table cells */
            );
            /** Edit the table field with expressions. 
            ...
            /** Plots or overlays graphs of the Field's structured data versus the Field's specified y-axis dependent variable ; returns newly created plot object.
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::Xyplot::Plot * XYGraph3DStructuredData
            (
                ...
                int structuredDataPlaneIndex /** index to which structured data plane to plot for 3 dimensional independent domains with structured data */,
            ...
            /** Set the conservative interpolation options 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Fields::FieldTable::SetConservativeOptionsWithUnits call") void SetConservativeOptions
            (
                double annTolerance /** approximate nearest neighbor (ANN) interpolation tolerance */,
                double maximumRadius /** maximum radius   */,
                int numberOfPoints /** number of points */
            ...
            /** Set the conservative interpolation options 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetConservativeOptionsWithUnits
            (
                double annTolerance /** approximate nearest neighbor (ANN) interpolation tolerance */,
                double maximumRadius /** maximum radius   */,
                NXOpen::Unit * maximumRadiusUnit /** maximum radius unit */,
            ...
            /**Returns  the option to delete sliver triangles from the resulting 2D Delaunay interpolation mesh.  Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool DelaunayDeleteSlivers
            (
            );
            /**Sets  the option to delete sliver triangles from the resulting 2D Delaunay interpolation mesh.  Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDelaunayDeleteSlivers
            (
                bool delaunayDeleteSlivers /** delaunaydeleteslivers */ 
            );
            /**Returns  the option to snap vertices from deleted sliver triangles to the convex hull of the 2D Delaunay interpolation mesh.  Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool DelaunaySnapVertices
            (
            );
            /**Sets  the option to snap vertices from deleted sliver triangles to the convex hull of the 2D Delaunay interpolation mesh.  Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDelaunaySnapVertices
            (
                bool delaunaySnapVertices /** delaunaysnapvertices */ 
            );
            /**Returns  the option specifyng the method used to determine if a triangle is a sliver of the 2D Delaunay interpolation mesh.  Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Fields::FieldEvaluator::DelaunaySliverDetectionMethodEnum DelaunaySliverDetectionMethod
            (
            );
            /**Sets  the option specifyng the method used to determine if a triangle is a sliver of the 2D Delaunay interpolation mesh.  Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDelaunaySliverDetectionMethod
            (
                NXOpen::Fields::FieldEvaluator::DelaunaySliverDetectionMethodEnum delaunaySliverDetectionMethod /** delaunaysliverdetectionmethod */ 
            );
            /**Returns  the option for ratio tolerance. Edge Length Tolerance > 1-edgelength(0)/(edgelength(1)+edgelength(2)). Aspect Ratio Tolerance > (height from free edge to opposite vertex)/(length of free edge). Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: double DelaunayRatioTolerance
            (
            );
            /**Sets  the option for ratio tolerance. Edge Length Tolerance > 1-edgelength(0)/(edgelength(1)+edgelength(2)). Aspect Ratio Tolerance > (height from free edge to opposite vertex)/(length of free edge). Applies to Delaunay interpolation only. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDelaunayRatioTolerance
            (
                double delaunayRatioTolerance /** delaunayratiotolerance */ 
            );
            /** Get the scale factor for the variable  @return  the scale factor for the variable 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * GetVariableScaleFactor
            (
                NXOpen::Fields::FieldVariable::Type varType /** vartype */ 
            );
            /** Set the scale factor for the variable 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetVariableScaleFactor
            (
                NXOpen::Fields::FieldVariable::Type varType /** vartype */ ,
                NXOpen::Expression * scaleFactor /** the scale factor for the variable */
            );
            /** Get the offset value for the variable  @return  the offset for the variable 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * GetVariableOffset
            (
                NXOpen::Fields::FieldVariable::Type varType /** vartype */ 
            );
            /** Set the offset value for the variable 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetVariableOffset
            (
                NXOpen::Fields::FieldVariable::Type varType /** vartype */ ,
                NXOpen::Expression * offset /** the offset for the variable */
            );
        };
    }
}
