    ...
    */
    class NXOPENCPPEXPORT  UnitCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        public: enum UnitDefaults
        {
            ...
            UnitDefaultsKgMNDegK/** SI with degrees instead of radians */
        };
        ...
        /** Find the data entry unit type for a given measure.  @return  data entry unit 
         <br>  Created in NX1899.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Unit * GetDataEntryUnit
        (
            const NXString & measureName /** the type of measure */
        );
        /** Find the data entry unit type for a given measure.  @return  data entry unit 
         <br>  Created in NX1899.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Unit * GetDataEntryUnit
        (
            const char * measureName /** the type of measure */
        );
        /** Find the object information unit type for a given measure.  @return  information unit 
         <br>  Created in NX1899.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Unit * GetObjectInformationUnit
        (
            const NXString & measureName /** the type of measure */
        );
        /** Find the object information unit type for a given measure.  @return  information unit 
         <br>  Created in NX1899.0.0.  <br>  
         <br> License requirements : None */
        NXOpen::Unit * GetObjectInformationUnit
        (
            const char * measureName /** the type of measure */
        );
