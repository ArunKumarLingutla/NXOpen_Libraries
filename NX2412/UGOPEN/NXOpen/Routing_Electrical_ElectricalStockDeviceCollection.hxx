        ...
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  ElectricalStockDeviceCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::Routing::Electrical::ElectricalStockDevice *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::Routing::Electrical::ElectricalStockDevice **;
                    using reference = NXOpen::Routing::Electrical::ElectricalStockDevice *&;
