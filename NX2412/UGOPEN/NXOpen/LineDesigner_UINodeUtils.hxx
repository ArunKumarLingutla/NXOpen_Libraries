        ...
        class LINEDESIGNEROPENCPPEXPORT  UINodeUtils
        {
            ...
            */
            ...
            /** To DragAndDrop Station
             ...
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void DragAndDropStation
            (
                NXOpen::NXObject * stationProcessTag /** stationprocesstag */ 
            );
            /** To Delete DragAndDrop Undo Mark
             <br>  Created in NX1938.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void DeleteDragAndDropUndoMark
            (
                const NXString & undoMarkName /** undomarkname */ 
            );
            /** To Delete DragAndDrop Undo Mark
             <br>  Created in NX1938.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            void DeleteDragAndDropUndoMark
            (
                const char * undoMarkName /** undomarkname */ 
            );
            /** To enable assembly PMI 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void ShowAssemblyPMI
            (
            );
            /** To display Assembly PMI Through Shaded Model 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void DisplayPMIThroughShadedModel
            (
            );
            /** To resize the Connectors per the Zoom Level 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void ResizeConnectors
            (
                const std::vector<NXOpen::NXObject *> & connectors /** connectors */ ,
            ...
            /** To partially load the children with LD connectors 
             ...
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: bool LoadChildrenParts
            (
                NXOpen::NXObject * owningPartOccurrence /** owningpartoccurrence */ 
            );
            ...
            public: void BVRModelIgnoreCallbacks
            (
                bool ignore /** If true, BVR Model callbacks are ignored to execute*/
            );
            /** Set column occurrence type For Edit In Cell 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void DeleteConnectionInfoNode
            (
                NXOpen::NXObject * sourcePartOcc /** sourcepartocc */ ,
                NXOpen::NXObject * targetPartOcc /** targetpartocc */ 
            );
            /** To delete connection between two objects 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ld_line_designer ("FULL LINE DESIGNER") */
            public: void DisconnectNXConnection
            (
                NXOpen::NXObject * sourcePartOcc /** sourcepartocc */ ,
                NXOpen::NXObject * targetPartOcc /** targetpartocc */ 
            );
