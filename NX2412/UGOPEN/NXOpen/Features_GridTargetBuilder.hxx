...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        RailHeadWidth.Value </term> <description> 
         
        73 (millimeters part), 2.874 (inches part) </description> </item> 
        ...
        TargetHeightFar.Value </term> <description> 
         
        6000 (millimeters part), 236.220 (inches part) </description> </item> 

        <item><term> 
         
        TargetHeightNear.Value </term> <description> 
         
        6300 (millimeters part), 248.031 (inches part) </description> </item> 
        ...
        TrackGauge.Value </term> <description> 
         
        1435 (millimeters part), 56.496 (inches part) </description> </item> 

        <item><term> 
         
        TrackWidth.Value </term> <description> 
         
        1581 (millimeters part), 62.244 (inches part) </description> </item> 
        ...
        WheelFlangeDistance.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  GridTargetBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum GridStandards
            {
                ...
                GridStandardsMLIT44Truck1mHighLT8t/** mlit44truck1m high lt8t */ ,
                GridStandardsMLIT44Truck1mHighGE8t/** mlit44truck1m high ge8t */ ,
                GridStandardsEn161861/** en161861 */ ,
                GridStandardsGMRT2161a/** gmrt2161a */ ,
                GridStandardsGMRT2161b/** gmrt2161b */ ,
                GridStandardsGMRT2161cShort/** gmrt2161c short */ 
            };
            ...
            /**Returns  the target height near 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * TargetHeightNear
            (
            );
            /**Returns  the target height far 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * TargetHeightFar
            (
            );
            /**Returns  the track width 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * TrackWidth
            (
            );
            /**Returns  the track gauge 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * TrackGauge
            (
            );
            /**Returns  the rail head width 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * RailHeadWidth
            (
            );
            /**Returns  the wheel flange distance 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * WheelFlangeDistance
            (
            );
            /** Create wheel flange distance 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: double GetFromBaseDataWheelFlangeDistance
            (
            );
            /**Returns  the wheel run surface width 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * WheelRunSurfaceWidth
            (
            );
            /** Create wheel run surface width 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: double GetFromBaseDataWheelRunSurfaceWidth
            (
            );
        };
    }
