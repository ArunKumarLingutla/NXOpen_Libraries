    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  CamProfileBuilder : public NXOpen::Builder
        {
            ...
            /** The slave value unit indicates which type slave joint is. */
            ...
            /** Interpolation type */
            public: enum ProfileInterpolationType
            {
                ProfileInterpolationTypeCubicSpline/** cubic spline */ ,
                ProfileInterpolationTypeLinear/** linear */ ,
                ProfileInterpolationTypeBezierSpline/** bezier spline */ 
            };
            ...
            /**Returns  the interpolation type of a cam profile
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: NXOpen::Mechatronics::CamProfileBuilder::ProfileInterpolationType InterpolationType
            (
            );
            /**Sets  the interpolation type of a cam profile
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetInterpolationType
            (
                NXOpen::Mechatronics::CamProfileBuilder::ProfileInterpolationType interpolationType /** interpolationtype */ 
            );
            ...
            /** Add bezier element to builder with JA_UGMATH_point2d. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void AddElement
            (
                NXOpen::NXObject * part /** part */ ,
                const NXOpen::Mechatronics::CamProfileBuilder::Element & element /** element */ ,
                const std::vector<NXOpen::Point2d> & interPoints /** interpoints */ 
            );
