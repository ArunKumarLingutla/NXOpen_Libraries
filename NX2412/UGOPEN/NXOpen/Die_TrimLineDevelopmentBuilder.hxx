    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  TrimLineDevelopmentBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** The trim line creation method. */
            public: enum CalculateType
            {
                CalculateTypeGeometryMethod/**geometry method*/,
                CalculateTypeOneStepTrimLine/**Onestep trim line method */
            };
            ...
            /**Returns  the calculate method type. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Die::TrimLineDevelopmentBuilder::CalculateType Type
            (
            );
            /**Sets  the calculate method type. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetType
            (
                NXOpen::Die::TrimLineDevelopmentBuilder::CalculateType type /** type */ 
            );
        };
    }
}
