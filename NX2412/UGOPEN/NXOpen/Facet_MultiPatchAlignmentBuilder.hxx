    ...
    namespace Facet
    {
        ...
        */
        class NXOPENCPP_FACETEXPORT  MultiPatchAlignmentBuilder : public NXOpen::Builder
        {
            ...
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Facet::MultiPatchAlignmentBuilder::AlignFacetPatches instead.") NXOpen::Facet::SelectFacetedBodyList * AlignmentBodies
            (
            );
            /**Returns  the facet bodies to be aligned. Inputs to this command can be convergent objects. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * AlignFacetPatches
            (
            );
            /**Returns  an optional reference facet body with a location and orientation that will 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Facet::MultiPatchAlignmentBuilder::ReferenceFacetPatches instead.") NXOpen::Facet::SelectFacetedBodyList * ReferencePatches
            (
            );
            /**Returns  an optional reference facet body. Inputs to this command can be convergent objects. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * ReferenceFacetPatches
            (
            );
