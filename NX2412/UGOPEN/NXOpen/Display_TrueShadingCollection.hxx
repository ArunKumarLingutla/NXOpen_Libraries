    ...
    namespace Display
    {
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  TrueShadingCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Display::TrueShading *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Display::TrueShading **;
                using reference = NXOpen::Display::TrueShading *&;
            ...
            /** Gets the True Shading flag from the input part.
                  @return  Indicates if it is True Shading display style 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: bool IsTrueShadeEnabled
            (
            );
