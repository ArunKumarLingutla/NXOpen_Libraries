        ...
        */
        class AMEOPENCPPEXPORT  PlcVendorSymbolBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the AddressPostFix 
             ...
             <br> License requirements : None */
            public: NXString AddressPostFix
            (
            );
            /**Sets  the AddressPostFix 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetAddressPostFix
            (
                const NXString & postfix /** postfix */ 
            );
            /**Sets  the AddressPostFix 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            void SetAddressPostFix
            (
            ...
            /**Sets  the showDataType 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetShowDataType
            (
                bool showDataType /** showdatatype */ 
            );
        };
    }
}
