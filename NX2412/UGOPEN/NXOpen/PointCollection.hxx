...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PointCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        public: enum ShipCoordinatesXdirectiontype
        {
            ShipCoordinatesXdirectiontypeForward/** forward */ ,
            ShipCoordinatesXdirectiontypeAft/** aft */ 
        };

        /** Represents Y-frame direction. */
        public: enum ShipCoordinatesYdirectiontype
        {
            ShipCoordinatesYdirectiontypePort/** port */ ,
            ShipCoordinatesYdirectiontypeStarboard/** starboard */ 
        };

        /** Represents Z-frame direction. */
        public: enum ShipCoordinatesZdirectiontype
        {
            ShipCoordinatesZdirectiontypeAbove/** above */ ,
            ShipCoordinatesZdirectiontypeBelow/** below */ 
        };
        ...
        {
        public:
            using value_type = NXOpen::Point *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Point **;
            using reference = NXOpen::Point *&;
        ...
        /**
             ...
             Use @link Routing::PortCollection::FindPortFromPoint Routing::PortCollection::FindPortFromPoint@endlink  to find the port used to
             create this point.
        ...
        /**
         ...
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR cam_base ("CAM BASE") OR studio_analyze ("STUDIO ANALYZE") */
        ...
        /** Creates a Point at origin of given CSYS.  @return  The created Point 
         <br>  Created in NX1899.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Point * CreatePointAtCoordinateSystemOrigin
        (
            NXOpen::SmartObject::UpdateOption updateOption /**  update option */,
            NXOpen::CoordinateSystem * smartCsys /** The CoordinateSystem */
        );
        /**
            Creates a @link NXOpen::Point NXOpen::Point@endlink  at a b-surface pole.
             @return  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::Point * CreatePointBSurfacePole
        (
            NXOpen::IParameterizedSurface * face /** Bsurface type face */,
            int uIndex /** U index of bsurface pole */,
            int vIndex /** V index of bsurface pole */,
            NXOpen::SmartObject::UpdateOption updateOption /** updateoption */ 
        );
        /**
            Creates a @link NXOpen::Point NXOpen::Point@endlink  on Curve at 50% curve length.
             @return  
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR nx_masterfem ("Finite Element Modeling") OR geometric_tol ("GDT") OR cam_base ("CAM BASE") */
        public: NXOpen::Point * CreateCurveMidPoint
        (
            NXOpen::IBaseCurve * curve /** curve */ ,
            NXOpen::SmartObject::UpdateOption updateOption /** updateoption */ 
        );
        /**
            Creates a @link NXOpen::Point NXOpen::Point@endlink  from Ship Coordinates.
             @return  
         <br>  Created in NX2212.0.0.  <br>  
        ...
        public: NXOpen::Point * CreatePointFromShipCoordinates
        (
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ ,
            NXOpen::IBasePlane * xPlane /** X plane */,
            NXOpen::IBasePlane * yPlane /** Y plane */,
            NXOpen::IBasePlane * zPlane /** Z plane */,
            NXOpen::PointCollection::ShipCoordinatesXdirectiontype xDirection /** X direction */,
            NXOpen::PointCollection::ShipCoordinatesYdirectiontype yDirection /** Y direction */,
            NXOpen::PointCollection::ShipCoordinatesZdirectiontype zDirection /** Z direction */,
            NXOpen::Scalar * xDistance /** X distance */,
            NXOpen::Scalar * yDistance /** Y distance */,
            NXOpen::Scalar * zDistance /** Z distance */
        );
