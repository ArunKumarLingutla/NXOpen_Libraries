...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a studio surface feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::StudioSurfaceBuilder1  NXOpen::Features::StudioSurfaceBuilder1 @endlink  <br> 
