        ...
        */
        class NXOPENCPP_IMPLICITEXPORT  OperationBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the size of voxels in percentage of body size 
             ...
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::Implicit::OperationBuilder::VoxelSizeAbsolute instead.") NXOpen::Expression * VoxelSizePercent
            (
            );
            /**Returns  the voxel display toggle.
             ...
             <br> License requirements : None */
            public: bool DisplayVoxel
            (
            );
            /**Sets  the voxel display toggle.
                    This toggle is used only for graphics display of voxel visualization scale
                    and has no impact on operation output.
                    
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_implicit (" NX Implicit Modeling") */
            public: void SetDisplayVoxel
            (
                bool displayVoxelFlag /** displayvoxelflag */ 
            );
            ...
            /**Returns  the absolute size of voxels
             ...
             <br> License requirements : None */
            public: NXOpen::Expression * VoxelSizeAbsolute
            (
            );
        };
    }
