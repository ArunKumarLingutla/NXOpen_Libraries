        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  AssociativeText : public NXOpen::TransientObject
        {
            ...
            /** Returns the associative text for the input object and its property. 
                     <br>   
                    For example, to obtain a reference to a drawing name, the object is the @link NXOpen::Drawings::DraftingView NXOpen::Drawings::DraftingView@endlink  of the @link NXOpen::Drawings::DrawingSheet NXOpen::Drawings::DrawingSheet@endlink .
                    It is not the @link NXOpen::Drawings::DrawingSheet NXOpen::Drawings::DrawingSheet@endlink  itself, but rather the type is @link NXOpen::Annotations::AssociativeText::PropertyTypeDrawingSheetName NXOpen::Annotations::AssociativeText::PropertyTypeDrawingSheetName@endlink . <br> 
            ...
            /** Returns the formatted associative text for the input object and attribute title.  @return  the associative text 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetObjectAttributeTextFormatted
            (
                NXOpen::NXObject * object /** the object */,
                const NXString & attributeTitle /** the object attribute title */,
                int decimalPlaces /** the decimal places for decimal format */
            );
            /** Returns the formatted associative text for the input object and attribute title.  @return  the associative text 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            NXString GetObjectAttributeTextFormatted
            (
                NXOpen::NXObject * object /** the object */,
                const char * attributeTitle /** the object attribute title */,
                int decimalPlaces /** the decimal places for decimal format */
            ...
            /** Returns the title and owning object of the object attribute referenced in the associative text.
                        ...
                        An error will be returned for attribute references that do not exist.
                         ...
                         <br> <b>Example 4:</b>  "\<WRef10*0@AttTitle\>" where "Ref10*0" reference does not exist will be considered an invalid attribute reference.
                                    An error will be returned.  Note that the existance of "Ref10*0" is
            ...
            /** Returns the formatted associative text for the part attribute title.  @return  the associative text 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetPartAttributeTextFormatted
            (
                const NXString & attributeTitle /** the part attribute title */,
                int decimalPlaces /** the decimal places for decimal format */
            );
            /** Returns the formatted associative text for the part attribute title.  @return  the associative text 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            NXString GetPartAttributeTextFormatted
            (
                const char * attributeTitle /** the part attribute title */,
                int decimalPlaces /** the decimal places for decimal format */
            );
            ...
            (
                NXOpen::Annotations::Annotation * embeddedAnnotation /** Embedded Annotation object */
            );
