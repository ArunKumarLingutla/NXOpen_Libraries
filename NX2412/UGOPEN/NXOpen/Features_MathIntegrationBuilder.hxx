...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        AssociativityType </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        EmbedWorksheet </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  MathIntegrationBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the associativity of the expression in the feature to the Maple worksheet 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: bool Associative
            (
            );
            /**Sets  the associativity of the expression in the feature to the Maple worksheet 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
