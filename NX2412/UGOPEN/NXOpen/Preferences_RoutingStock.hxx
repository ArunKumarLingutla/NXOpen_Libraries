        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  RoutingStock
        {
            ...
            /**Returns  the current routing level/tile 
             <br>  @deprecated Deprecated in NX2312.0.0.  This call can be safely removed as this is now a no-op. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  This call can be safely removed as this is now a no-op.") NXString CurrentTile
            (
            );
            /**Sets  the current routing level/tile 
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  This call can be safely removed as this is now a no-op.") void SetCurrentTile
            (
