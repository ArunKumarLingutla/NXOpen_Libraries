...
#include <NXOpen/PDM_CreateSessionBuilder.hxx>
...
#include <NXOpen/PDM_SaveAsNewItemTypeBuilder.hxx>
    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PdmSession
        {
              ...
              */
            public:
            struct GetConfiguredRevisionInput
            {
                public: /** item id */NXString ItemId;
                public: /** revision rule */NXString RevisionRuleName;
                public: GetConfiguredRevisionInput() :
                    ItemId(),
                    RevisionRuleName()
                {
                }
                /** Constructor for the GetConfiguredRevisionInput struct. */ 
                public: GetConfiguredRevisionInput(const NXString &itemIdInitial /** item id */, 
                        const NXString &revisionRuleNameInitial /** revision rule */) :
                    ItemId(itemIdInitial),
                    RevisionRuleName(revisionRuleNameInitial)
                {
                }
            };
              ...
              */
            public:
            struct GetConfiguredRevisionResult
            {
                public: /** item id */NXString ItemId;
                public: /** revision rule */NXString RevisionRuleName;
                public: /** configured item revision cli spec */NXString ItemRevisionCliSpec;
                public: /** failed to fetch item revision using given revision rule*/bool HasFailed;
                public: GetConfiguredRevisionResult() :
                    ItemId(),
                    RevisionRuleName(),
                    ItemRevisionCliSpec(),
                    HasFailed()
                ...
                /** Constructor for the GetConfiguredRevisionResult struct. */ 
                public: GetConfiguredRevisionResult(const NXString &itemIdInitial /** item id */, 
                        const NXString &revisionRuleNameInitial /** revision rule */, 
                        const NXString &itemRevisionCliSpecInitial /** configured item revision cli spec */, 
                        bool hasFailedInitial /** failed to fetch item revision using given revision rule*/) :
                    ItemId(itemIdInitial),
                    RevisionRuleName(revisionRuleNameInitial),
                    ItemRevisionCliSpec(itemRevisionCliSpecInitial),
                    HasFailed(hasFailedInitial)
                {
                }
            };
            ...
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreateMakeUniqueOperationBuilder instead") NXOpen::PDM::PartOperationMakeUniqueBuilder * CreateMakeUniqueOperationBuilder
            (
            ...
            /** Creates a new @link NXOpen::PDM::PartOperationAttributePropertiesBuilder NXOpen::PDM::PartOperationAttributePropertiesBuilder@endlink  object. 
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreatePartOperationAttributePropertiesBuilder instead") NXOpen::PDM::PartOperationAttributePropertiesBuilder * CreatePartOperationAttributePropertiesBuilder
            (
            ...
            /** Creates a new @link AttributePropertiesBuilder AttributePropertiesBuilder@endlink  object. 
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreatePartOperationValidationPropertiesBuilder instead") NXOpen::AttributePropertiesBuilder * CreatePartOperationValidationPropertiesBuilder
            (
                const std::vector<NXOpen::NXObject *> & objects /** the array of objects */
            );
            ...
            /** Creates a new @link SmartSaveContext SmartSaveContext@endlink  object. 
             ...
             <br> License requirements : None */
            public: NXOpen::PDM::SmartSaveContext * CreateSmartSaveContextWithDialogType
            (
                NXOpen::PDM::SmartSaveBuilder::DialogType dialogType /** dialogtype */ ,
                NXOpen::PDM::SmartSaveBuilder::SaveType saveType /** savetype */ 
            );
            /** Creates a new @link SmartSaveBuilder SmartSaveBuilder@endlink  object. 
             <br>  Created in NX11.0.1.  <br>  
            ...
            /** Creates a new @link NXOpen::PDM::ExportWorksetForReferenceBuilder NXOpen::PDM::ExportWorksetForReferenceBuilder@endlink  object used for
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreateExportWorksetForReferenceBuilder instead") NXOpen::PDM::ExportWorksetForReferenceBuilder * CreateExportWorksetForReferenceBuilder
            (
            ...
            /**Returns a new @link NXOpen::PDM::PdmCopyOrEditOperationBuilder NXOpen::PDM::PdmCopyOrEditOperationBuilder@endlink  object
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::PdmCopyOrEditOperationBuilder * CreatePdmCopyOrEditOperationBuilder
            (
            );
            /** Creates a new @link AttributePropertiesBuilder AttributePropertiesBuilder@endlink  object. 
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreatePdmCopyOrEditOperationAttributePropertiesBuilder instead") NXOpen::AttributePropertiesBuilder * CreatePdmCopyOrEditOperationAttributePropertiesBuilder
            (
                const std::vector<NXOpen::NXObject *> & objects /** the array of objects */
            );
            /** Get the configured item revisions on the provided item using given revision rule.  @return  Errors encountered 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::OperationErrors * GetConfiguredRevisionOfItems
            (
                const std::vector<NXOpen::PDM::PdmSession::GetConfiguredRevisionInput> & itemInputs /** The parts to be imported */,
                std::vector<NXOpen::PDM::PdmSession::GetConfiguredRevisionResult> & configuredItemRevisionResult /** Item Revision clis */
            );
            /**Returns a new @link NXOpen::PDM::ExportFromTeamcenter NXOpen::PDM::ExportFromTeamcenter@endlink  object
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::ExportFromTeamcenter * CreateExportFromTeamcenterBuilderForPartFamily
            (
                NXOpen::TaggedObject * part /** part */ 
            );
            /**Returns a new @link NXOpen::PDM::ExportFromTeamcenter NXOpen::PDM::ExportFromTeamcenter@endlink  object which supports Selective Export of Configured Assembly.
             ...
             <br> License requirements : None */
            public: NXOpen::PDM::ExportFromTeamcenter * CreateExportFromTeamcenterBuilderForConfiguredAssembly
            (
                NXOpen::TaggedObject * part /** part */ 
            );
            /**Returns a new @link NXOpen::PDM::ExportFromTeamcenter NXOpen::PDM::ExportFromTeamcenter@endlink  object which supports Selective Export of Design Workset.
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::ExportFromTeamcenter * CreateExportFromTeamcenterBuilderForDesignWorkset
            (
                NXOpen::TaggedObject * part /** part */ 
            );
            ...
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::PDM::PdmManager::CreateSearchRecipeFilterBuilder instead") NXOpen::PDM::SearchRecipeFilterBuilder * CreateSearchRecipeFilterBuilder
            (
            ...
            /**Returns a new @link NXOpen::PDM::CreateSessionBuilder NXOpen::PDM::CreateSessionBuilder@endlink  object
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::CreateSessionBuilder * CreateCreateSessionBuilder
            (
                NXOpen::PDM::PartOperationBuilder::OperationType operation /** operation */ 
            );
            /**Returns a new @link NXOpen::PDM::SaveAsNewItemTypeBuilder NXOpen::PDM::SaveAsNewItemTypeBuilder@endlink  object
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::SaveAsNewItemTypeBuilder * CreateSaveAsNewItemTypeBuilder
            (
            );
            /** Get the NX workflows from Teamcenter for the given list of parts  @return  Errors encountered 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::OperationErrors * GetNXWorkflows
            (
                const std::vector<NXOpen::TaggedObject *> & parts /** the array of parts */,
                std::vector<NXString> & workflowNames /** the array of workflow names */
            );
            /** Apply the given workflow on the given list of parts  @return  Errors encountered 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::OperationErrors * AssignReleaseStatus
            (
                const std::vector<NXOpen::TaggedObject *> & parts /** the array of parts */,
                const NXString & workflowName /** workflowname */ 
            );
            /** Apply the given workflow on the given list of parts  @return  Errors encountered 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::PDM::OperationErrors * AssignReleaseStatus
            (
                const std::vector<NXOpen::TaggedObject *> & parts /** the array of parts */,
                const char * workflowName /** workflowname */ 
            );
            ...
            (
                ...
                const NXString & revisionRule /** The revision rule to be set */
            );
            /** Set the revision rule 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                bool setDefault /** setdefault */ ,
                const char * revisionRule /** The revision rule to be set */
            );

            /// \cond NX_NO_DOC 
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.5000.0.  <br>  
             <br> License requirements : None */
            public: void OpenEbomAlignedDesign
            (
                const NXString & ebomPartFilename /** Engineering BOM Part file name. */
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.5000.0.  <br>  
             <br> License requirements : None */
            void OpenEbomAlignedDesign
            (
                const char * ebomPartFilename /** Engineering BOM Part file name. */
            );
            ...
            */
            public: NXOpen::PDM::PartAttributeAssignmentObserver *PartAttributeAssignmentObserver();
            /** Returns the @link NXOpen::PDM::PdmCopyOrEditOperationObserver NXOpen::PDM::PdmCopyOrEditOperationObserver@endlink  belonging to this session 
             <br>  Created in NX1980.0.0.  <br>  
            */
            public: NXOpen::PDM::PdmCopyOrEditOperationObserver *PdmCopyOrEditOperationObserver();
