...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  WavefrontObjImporter : public NXOpen::BaseImporter
    {
        ...
        /**Returns  the flag indicating if Subdivision Body face count should be reduced. When turned on, smoothly
        ...
        /**Sets  the flag indicating if Subdivision Body face count should be reduced. When turned on, smoothly
                    connected face regions of Subdivision Body may be merged while maintaining an accurate representation
                    of the initial body.
