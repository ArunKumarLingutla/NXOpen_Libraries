        ...
        namespace VehicleDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  BaseDataDriverBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the status of driver's edit. If true, some changes made in driver UI. 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: bool DriverTabIsEdit
                (
                );
                /**Sets  the status of driver's edit. If true, some changes made in driver UI. 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetDriverTabIsEdit
                (
                    bool driverTabIsEdit /** drivertabisedit */ 
                );
                /**Returns  the status to indicate whether the gear lever center point is active or not. If it is true, the gear lever center point is active. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: bool GearLeverCenterPointActive
                (
                );
                /**Sets  the status to indicate whether the gear lever center point is active or not. If it is true, the gear lever center point is active. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetGearLeverCenterPointActive
                (
                    bool activeStatus /** activestatus */ 
                );
                /**Returns  the center point of the driver gear lever. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Point * GearLeverCenterPoint
                (
                );
                /**Sets  the center point of the driver gear lever. 
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetGearLeverCenterPoint
                (
                    NXOpen::Point * refPoint /** refpoint */ 
                );
                /**Returns  the steering wheel rim thickness.
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * SteeringWheelRimDiameter
                (
                );
                /**Returns  the status to indicate whether the articulation point is active or not. If it is true, the articulation point is active. 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : None */
                public: bool ArticulationPointActive
                (
                );
                /**Sets  the status to indicate whether the articulation point is active or not. If it is true, the articulation point is active. 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetArticulationPointActive
                (
                    bool activeStatus /** activestatus */ 
                );
                /**Returns  the point of the articulation. 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Point * ArticulationPoint
                (
                );
                /**Sets  the point of the articulation. 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
