...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a collection of motion scalar torque  <br> To obtain an instance of this class, refer to @link NXOpen::Motion::MotionManager  NXOpen::Motion::MotionManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  ScalarTorqueCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Motion::ScalarTorque *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Motion::ScalarTorque **;
                using reference = NXOpen::Motion::ScalarTorque *&;
            ...
            /**   Return  @link  NXOpen::Motion::ScalarTorqueBuilder   NXOpen::Motion::ScalarTorqueBuilder @endlink  object   @return  ScalarTorqueBuilder object 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::ScalarTorqueBuilder * CreateScalarTorqueBuilder
            (
                NXOpen::Motion::ScalarTorque * scalarTorque /** @link NXOpen::Motion::ScalarTorque NXOpen::Motion::ScalarTorque@endlink  to be edited, 
                                                                                              if NULL then create a new one */
            );
            /** Finds the @link  NXOpen::Motion::ScalarTorque   NXOpen::Motion::ScalarTorque @endlink  with the given name.
