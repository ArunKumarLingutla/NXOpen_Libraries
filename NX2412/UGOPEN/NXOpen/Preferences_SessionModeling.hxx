        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SessionModeling
        {
            ...
            */
            ...
            /** Model Delay Update Granularity option */
            public: enum ModelDelayUpdateGranilarityType
            {
                ModelDelayUpdateGranilarityTypeGroup/** Delay dependents from other group, group includes design group and part modules */,
                ModelDelayUpdateGranilarityTypeFeature/** Delay immediate dependents */
            };
            ...
            public: enum PolylineStyleType
            {
                ...
                PolylineStyleTypeEight/** Long Dashed Double Dotted */ = 11,
                PolylineStyleTypeNine/** Long Dashed Dotted for OOTB fonts and Undulating for shipbuilding fonts */,
                PolylineStyleTypeTen/** Long Dashed Triplicate Dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
                PolylineStyleTypeEleven/** Long Dashed Double Short Dashed for OOTB fonts and Railway for shipbuilding fonts */
            };
            ...
            public: enum EndpointDisplayStyleType
            {
                ...
                EndpointDisplayStyleTypePoint/** point */ ,
                EndpointDisplayStyleTypeAsterisk/** asterisk */ ,
                EndpointDisplayStyleTypePoundSign/** pound sign */ ,
                EndpointDisplayStyleTypeFilledSquare/** filled square */ ,
                EndpointDisplayStyleTypeFilledTriangle/** filled triangle */ ,
                EndpointDisplayStyleTypeFilledDiamond/** filled diamond */ ,
                EndpointDisplayStyleTypeCenterline/** centerline */ 
            };
            ...
            /**Returns  the update delayed option.  If the option is true, then an edited
             ...
             <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::Preferences::SessionModeling::DelayModelUpdates NXOpen::Preferences::SessionModeling::DelayModelUpdates@endlink  instead. <br>  

             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionModeling::DelayModelUpdates instead.") bool UpdateDelayed
            (
            );
            /**Sets  the update delayed option.  If the option is true, then an edited
                ...
                explicitly called.  If the option is false, then the edited feature
                updates immediately.  The default is false. 
             <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity@endlink  instead. <br>  

             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity instead.") void SetUpdateDelayed
            (
                bool option /** option */ 
            );
            /**Returns  the update pending option. This option only works when the NXOpen::Preferences::SessionModeling::UpdateDelayed option is true.
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionModeling::DelayModelUpdates instead.") bool UpdatePending
            (
            );
            /**Sets  the update pending option. This option only works when the NXOpen::Preferences::SessionModeling::UpdateDelayed option is true.
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity instead.") void SetUpdatePending
            (
                bool option /** option */ 
            );
            ...
            /**Returns  the option that determines whether or not task environment is used to edit the sketch 
             <br>  @deprecated Deprecated in NX1847.0.0.  There is no replacement for this function. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  There is no replacement for this function.") NXOpen::Preferences::SessionModeling::SketchEditType SketchEditOption
            (
            );
            /**Sets  the option that determines whether or not task environment is used to edit the sketch 
             ...
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  There is no replacement for this function.") void SetSketchEditOption
            (
            ...
            /**Returns  the delay model updates option.
             ...
             <br> License requirements : None */
            public: bool DelayModelUpdates
            (
            );
            /** 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDelayModelUpdatesAndGranularity
            (
                bool delayModelUpdates /** preference to delay model updates */,
                NXOpen::Preferences::SessionModeling::ModelDelayUpdateGranilarityType modelDelayUpdateGranularityOption /** model delay update granularity */,
                NXOpen::Session::UndoMarkId undoMarkId /** If any update error occurs, the system will roll back to this undo mark. */
            );
            /**Returns  the option that determines granularity if model delay 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::SessionModeling::ModelDelayUpdateGranilarityType ModelDelayUpdateGranilarity
            (
            );
            /** Get the flag to show symbolic thread decal sticker  @return   
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: bool GetShowSymbolicThreadDecalSticker
            (
            );
            /** Set the flag to show symbolic thread decal sticker 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void SetShowSymbolicThreadDecalSticker
            (
                bool showSymbolicThreadDecalSticker /** showsymbolicthreaddecalsticker */ 
            );
