    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeDOFSetCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::CaeDOFSet *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::CaeDOFSet **;
                using reference = NXOpen::CAE::CaeDOFSet *&;
            ...
            /** Create a DOFSet from Nodes and Selection Recipes
                    A true for a dof logical entry would mean that the dof is included for that corresponding node or Selection Recipe.
                    A false would mean that the dof is not included for that node or Selection Recipe.  @return  The created DOFSet object 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::CaeDOFSet * CreateDofsetFromNodesAndSelectionRecipes
            (
                const NXString & dofsetName /**  Name of a DOFSet */,
                const std::vector<NXOpen::CAE::FENode *> & nodes /** Array of nodes in the DOFSet @link NXOpen::CAE::FENode NXOpen::CAE::FENode@endlink  */,
                const std::vector<bool> & nodeDof1 /** Array of Node DOF1 values  */,
                const std::vector<bool> & nodeDof2 /** Array of Node DOF2 values  */,
                const std::vector<bool> & nodeDof3 /** Array of Node DOF3 values  */,
                const std::vector<bool> & nodeDof4 /** Array of Node DOF4 values  */,
                const std::vector<bool> & nodeDof5 /** Array of Node DOF5 values  */,
                const std::vector<bool> & nodeDof6 /** Array of Node DOF6 values  */,
                const std::vector<NXOpen::CAE::SelectionRecipe *> & selectionRecipes /** Array of Selection Recipes in the DOFSet @link NXOpen::CAE::SelectionRecipe NXOpen::CAE::SelectionRecipe@endlink  */,
                const std::vector<bool> & selRepDof1 /** Array of Selection Recipe DOF1 values  */,
                const std::vector<bool> & selRepDof2 /** Array of Selection Recipe DOF2 values  */,
                const std::vector<bool> & selRepDof3 /** Array of Selection Recipe DOF3 values  */,
                const std::vector<bool> & selRepDof4 /** Array of Selection Recipe DOF4 values  */,
                const std::vector<bool> & selRepDof5 /** Array of Selection Recipe DOF5 values  */,
                const std::vector<bool> & selRepDof6 /** Array of Selection Recipe DOF6 values  */
            );
            /** Create a DOFSet from Nodes and Selection Recipes
                    A true for a dof logical entry would mean that the dof is included for that corresponding node or Selection Recipe.
                    A false would mean that the dof is not included for that node or Selection Recipe.  @return  The created DOFSet object 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            NXOpen::CAE::CaeDOFSet * CreateDofsetFromNodesAndSelectionRecipes
            (
                const char * dofsetName /**  Name of a DOFSet */,
                const std::vector<NXOpen::CAE::FENode *> & nodes /** Array of nodes in the DOFSet @link NXOpen::CAE::FENode NXOpen::CAE::FENode@endlink  */,
                const std::vector<bool> & nodeDof1 /** Array of Node DOF1 values  */,
