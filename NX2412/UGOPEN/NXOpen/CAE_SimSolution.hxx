...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class LoadcaseIterationCollection;
    }
    namespace CAE
    {
    ...
    namespace CAE
    {
        class StressLinearizationCollection;
    }
    class INXObject;
    class ReferenceSet;
    namespace Report
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimSolution : public NXOpen::CAE::SimGroupContainer, public virtual NXOpen::Report::IReportCollection
        {
            ...
            public: enum SetupCheckOption
            {
                ...
                SetupCheckOptionDeepCheckAndStopAtFirstError/** perform set up checks with deep label checking but stop at first error */,
                SetupCheckOptionCompleteDeepCheckAndOutputErrors/** perform all set up checks with deep label checking and report all errors */
            };
            ...
            /** Creates the @link CAE::StressLinearizationBuilder CAE::StressLinearizationBuilder@endlink  
                        to create and edit @link CAE::StressLinearization CAE::StressLinearization@endlink  
                        object 
                         @return   
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::StressLinearizationBuilder * CreateStressLinearizationBuilder
            (
                NXOpen::CAE::StressLinearization * stressLin /** stresslin */ 
            );
            /** Creates the builder to create and edit SMT Diagrams object  @return   
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SMTDiagramsBuilder * CreateSmtDiagramsBuilder
            (
            );
            /** Creates the builder to create SMT output graph objects  @return   
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::SMTOutputBuilder * CreateSmtOutputBuilder
            (
            );
            ...
            /** Get the reference set 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::ReferenceSet * GetReferenceSet
            (
            );
            ...
            (
                NXOpen::ReferenceSet * refset /** refset */ 
            );
            /** Creates a @link CAE::OptimizeLatticeBuilder CAE::OptimizeLatticeBuilder@endlink  on a SOL 200 Design Optimization solution type
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::OptimizeLatticeBuilder * CreateOptimizeLatticeBuilder
            (
            );
            /** Creates a @link CAE::ExportLatticeDiameterFieldBuilder CAE::ExportLatticeDiameterFieldBuilder@endlink  on a SOL 200 Design Optimization solution type
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::ExportLatticeDiameterFieldBuilder * CreateExportLatticeDiameterFieldBuilder
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void GetResultMetadata
            (
                std::vector<NXOpen::CAE::ResultMetadata *> & resultMetadata /** resultmetadata */ 
            );

            /// \endcond 
            /** Get all nodal force reports in solution
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void GetAllNodalForceReports
            (
                std::vector<NXOpen::CAE::NodalForceReport *> & freeBodys /** freebodys */ 
            );
            /** Add the solution specific override to the solution
                     
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void AddSolutionSpecificOverride
            (
                NXOpen::CAE::Override * solutionSpecificOverride /** the solution specific override to be added */
            );
            /** Add the solution specific overrides to the solution
                     
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void AddSolutionSpecificOverrides
            (
                const std::vector<NXOpen::CAE::Override *> & solutionSpecificOverrides /** the solution specific overrides to be added */
            );
            /** Remove the solution specific override from the solution
                     
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void RemoveSolutionSpecificOverride
            (
                NXOpen::CAE::Override * solutionSpecificOverride /** the solution specific override to be removed */
            );
            /** Remove the solution specific overrides from the solution
                     
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void RemoveSolutionSpecificOverrides
            (
                const std::vector<NXOpen::CAE::Override *> & solutionSpecificOverrides /** the solution specific overrides to be removed */
            );
            ...
            /** Returns the @link NXOpen::CAE::StressLinearizationCollection NXOpen::CAE::StressLinearizationCollection@endlink  belonging to this solution. 
             <br>  Created in NX1953.0.0.  <br>  
            */
            public: NXOpen::CAE::StressLinearizationCollection *StressLinearizations();
            /** Returns the @link NXOpen::CAE::LoadcaseIterationSetCollection NXOpen::CAE::LoadcaseIterationSetCollection@endlink  belonging to this solution. 
             <br>  Created in NX2406.0.0.  <br>  
            */
            public: NXOpen::CAE::LoadcaseIterationSetCollection *LoadcaseIterationSets();
            /** Returns the @link NXOpen::CAE::LoadcaseIterationCollection NXOpen::CAE::LoadcaseIterationCollection@endlink  belonging to this solution. 
             <br>  Created in NX2406.0.0.  <br>  
            */
            public: NXOpen::CAE::LoadcaseIterationCollection *LoadcaseIterations();
        };
    }
}
