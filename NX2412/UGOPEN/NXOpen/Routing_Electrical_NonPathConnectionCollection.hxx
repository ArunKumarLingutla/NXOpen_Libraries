...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  NonPathConnectionCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                //lint -sem(NXOpen::Routing::Electrical::NonPathConnectionCollection::iterator::copy,initializer)
                class iterator
                {
                public:
                    using value_type = NXOpen::Routing::Electrical::NonPathConnection *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::Routing::Electrical::NonPathConnection **;
                    using reference = NXOpen::Routing::Electrical::NonPathConnection *&;
                ...
                /** Creates a @link NXOpen::Routing::Electrical::NonPathConnection NXOpen::Routing::Electrical::NonPathConnection@endlink  object.  @return  A @link NXOpen::Routing::Electrical::NonPathConnection NXOpen::Routing::Electrical::NonPathConnection@endlink   
                 <br>  Created in NX4.0.2.  <br>  
