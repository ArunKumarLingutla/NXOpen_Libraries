        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ReliefDesignBuilder : public NXOpen::Builder
        {
            ...
            public: enum Method
            {
                ...
                MethodBoundCylinder/** Bound Cylinder method */,
            ...
            /**Returns  the Use NonAligned Minimum Box create relief, true: create relief by using NonAligned Minimum Box 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool UseNonAlignedMinimumBox
            (
            );
            /**Sets  the Use NonAligned Minimum Box create relief, true: create relief by using NonAligned Minimum Box 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUseNonAlignedMinimumBox
            (
                bool useNonAlignedMinimumBox /** usenonalignedminimumbox */ 
            );
            ...
            /**Returns  the User Defined Offset Value. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: double UdfOffset
            (
            );
            /**Sets  the User Defined Offset Value. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUdfOffset
            (
                double udfOffset /** udfoffset */ 
            );
            /**Returns  the seventh clearance to create handle to control radial direction clearance. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * Clearance7
            (
            );
        };
    }
