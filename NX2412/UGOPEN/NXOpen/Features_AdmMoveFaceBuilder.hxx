...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        FaceToMove.CloneEnabled </term> <description> 
        ...
        FaceToMove.PatternEnabled </term> <description> 
        ...
        FaceToMove.RigidBodyFaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToMove.SameEntryEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToMove.SameEntrySurfaceEnabled </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  AdmMoveFaceBuilder : public NXOpen::Features::AdmBaseBuilder
        {
            ...
            /**Returns  the component to move.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObjectList * ComponentToMove
            (
            );
