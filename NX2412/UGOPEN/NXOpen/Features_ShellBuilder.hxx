        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ShellBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the list of faces and corresponding alternate thickness for each.
             ...
             <br>  @deprecated Deprecated in NX5.0.0.  Use @link NXOpen::Features::ShellBuilder::FaceThicknesses NXOpen::Features::ShellBuilder::FaceThicknesses@endlink  instead. <br>  

             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX5.0.0.  Use NXOpen::Features::ShellBuilder::FaceThicknesses instead.") NXOpen::ObjectList * FaceThicknessList
            (
            );
            /**Sets  the list of faces and corresponding alternate thickness for each.
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX5.0.0.  Use NXOpen::Features::ShellBuilder::FaceThicknesses instead.") void SetFaceThicknessList
            (
