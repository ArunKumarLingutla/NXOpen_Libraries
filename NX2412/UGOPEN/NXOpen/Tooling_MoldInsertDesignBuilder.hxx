    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MoldInsertDesignBuilder : public NXOpen::Tooling::StandardPartBuilder
        {
            ...
            /** Previews extrude body.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void PreviewExtrudeBody
            (
                int* nBodies /** The the number of preview bodies */,
                bool* bSolidBody /** The preview body is a solid body or not */
            );
            /** Reads flange data from the insert component.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void ReadInsertFlangeData
            (
                NXOpen::Assemblies::Component * insertComponent /** The component to be edit */
            );
            /** Deletes the extrude preview body.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void DeletePreviewBody
            (
            );
            /** Validates the extrude section. @return  The status of extrude section, 0 is ok for preview 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: int ValidateExtrudeSection
            (
            );
            /**Returns  the sketch feature of extrude section 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::SketchFeature * SketchFeature
            (
            );
            /**Sets  the sketch feature of extrude section 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetSketchFeature
            (
                NXOpen::Features::SketchFeature * sketchFeature /** sketchfeature */ 
            );
            /** Action for the first selection of extrude section, if in assembley context, it will change work part and recreate the section.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Section * OnFirstSelectionForExtrudeSection
            (
                NXOpen::NXObject * selObject /** selobject */ 
            );
            /**Returns  the first selection status of the extrude section 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: bool FirstSelectionStatus
            (
            );
            /**Sets  the first selection status of the extrude section 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetFirstSelectionStatus
            (
                bool isFirstSelection /** isfirstselection */ 
            );
            /** Checks whether the current work part is the section's owning part, if not, then create a new section in work part,and replace the old one.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void CheckSectionOwningPart
            (
            );
            /** Recommends the position Z direction of the insert based on the selected body
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void RecommendInsertPositionZDirection
            (
                NXOpen::NXObject * selectedBody /** selectedbody */ 
            );
        };
    }
}
