    ...
    namespace Facet
    {
        ...
        struct FacetingParameters
        {
            ...
            public: /** This is the maximum distance from
                                                           the surface to the facet. The tolerance is to 
                                                           be specified in part units.
            ...
            public: /** This is the maximum angular variation
                                                           ...
                                                           indicates no constraint. The tolerance is to
            ...
            public: /** This is the maximum distance between
                                                           ...
                                                           along solid edges. The tolerance is to 
                                                           be specified in part units.
            ...
            public: /** This is the maximum angular variation
                                                           ...
                                                           The tolerance is to be specified in radians.
                                                        */double CurveAngularTolerance;
            public: /** The maximum length of a curve, default is 1000.0
                                                            This is to be specified in part units */double CurveMaximumLength;
            ...
            public: /** This is the maximum width of a facet.
                                                           ...
                                                           This is to be specified in part units.
            ...
            public: /** If specifyViewDirection is specified
                                                           ...
                                                           The tolerance is to be specified in part units.
    ...
    namespace Facet
    {
        ...
        */
        class NXOPENCPP_FACETEXPORT  FacetedBodyCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Facet::FacetedBody *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Facet::FacetedBody **;
                using reference = NXOpen::Facet::FacetedBody *&;
                ...
                NXOPENCPP_FACETEXPORT  value_type operator * () const;
            ...
            /** Creates a @link NXOpen::Facet::ExtrudeFacetBodyBuilder NXOpen::Facet::ExtrudeFacetBodyBuilder@endlink  
             ...
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR die_engineering ("DIE ENGINEERING") OR nx_polygon_modeling (" NX Polygon Modeling") */
            ...
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  This functionality is no longer supported.") NXOpen::Facet::MergeFacetBodyBuilder * CreateMergeFacetBodyBuilder
            (
            );
