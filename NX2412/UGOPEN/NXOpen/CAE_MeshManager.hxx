    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshManager : public NXOpen::CAE::IMeshManager
        {
            ...
            /** Creates a Hex Dominant mesh builder
                      @return  Hex Dominant Mesh Builder is created 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::HexDominantMeshBuilder * CreateHexDominantMeshBuilder
            (
                NXOpen::CAE::RecipeHexDominantMesh * mesh /** 3d Mesh entity to be edited, if NULL then create a new one */
            );
            ...
            /** Creates a Automatic Acoustic mesh builder
                      @return  Acoustic Mesh Automation Builder is created 
            ...
            public: NXOpen::CAE::AcousticMeshAutomationBuilder * CreateAcousticMeshAutomationBuilder
            (
                NXOpen::CAE::RecipeAcousticMeshAutomation * mesh /** Acoustic Mesh entity to be edited, if NULL then create a new one */
            );
            /** Creates a @link CAE::FemPatternCopyAttributeBuilder CAE::FemPatternCopyAttributeBuilder@endlink    @return  Pattern Copy Attribute Builder is created 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::FemPatternCopyAttributeBuilder * CreatePatternCopyAttributeBuilder
            (
            );
            /** Creates a touch point remesh builder  @return  Mesh Builder is created 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::TouchPointRemeshBuilder * CreateTouchPointRemeshBuilder
            (
            );
        };
    }
