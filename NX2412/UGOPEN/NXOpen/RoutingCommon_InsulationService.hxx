    ...
    namespace RoutingCommon
    {
        ...
        */
        class NXOPENCPP_ROUTINGCOMMONEXPORT  InsulationService
        {
            ...
            /** Get all insulation occurrences in current container 
             <br>  Created in NX1847.0.0.  <br>  
            ...
            /** Gets the associated insulation components for the passed in component 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : routing_pipetube ("Routing Piping and Tubing") */
            public: std::vector<NXOpen::Assemblies::Component *> GetAssociatedInsulationComponents
            (
                NXOpen::Assemblies::Component * coveredComponent /** coveredcomponent */ 
            );
