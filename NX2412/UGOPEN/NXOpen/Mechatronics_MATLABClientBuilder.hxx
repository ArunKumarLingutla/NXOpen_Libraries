    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  MATLABClientBuilder : public NXOpen::Builder
        {
            ...
            /** Represents the Co-sim type. */
            public: enum CoSimType
            {
                CoSimTypeC/** COM server*/,
                CoSimTypeS/** S Function*/
            };
            ...
            /**Returns  the MATLAB Co-Sim type. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::MATLABClientBuilder::CoSimType MATLABCoSimType
            (
            );
            /**Sets  the MATLAB Co-Sim type. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") */
            public: void SetMATLABCoSimType
            (
                NXOpen::Mechatronics::MATLABClientBuilder::CoSimType coSimType /** cosimtype */ 
            );
            ...
            /** Get the object information into MATLAB DataEx 
             <br>  @deprecated Deprecated in NX2206.0.0.  Please use @link NXOpen::Mechatronics::MATLABClientBuilder::GetMATLABInformationExV2 NXOpen::Mechatronics::MATLABClientBuilder::GetMATLABInformationExV2@endlink  instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Please use NXOpen::Mechatronics::MATLABClientBuilder::GetMATLABInformationExV2 instead.") void GetMATLABInformationEx
            (
                const NXString & instanceName /** instancename */ ,
            ...
            /**  @brief  Set the object information into MATLAB DataEx  
             ...
             <br>  @deprecated Deprecated in NX2206.0.0.  Please use @link NXOpen::Mechatronics::MATLABClientBuilder::SetMATLABInformationExV2 NXOpen::Mechatronics::MATLABClientBuilder::SetMATLABInformationExV2@endlink  instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Please use NXOpen::Mechatronics::MATLABClientBuilder::SetMATLABInformationExV2 instead.") void SetMATLABInformationEx
            (
                const NXString & instanceName /** instancename */ ,
            ...
            /** Get the MATLAB server name. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: NXString GetMATLABServerName
            (
                NXOpen::Part * ownerPart /** ownerpart */ 
            );
            /**  @brief  Set Matlab server name  

              
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetMATLABServerName
            (
                NXOpen::Part * ownerPart /** ownerpart */ ,
                const NXString & matlabServerProgID /** matlabserverprogid */ 
            );
            /**  @brief  Set Matlab server name  
             ...
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            void SetMATLABServerName
            (
                NXOpen::Part * ownerPart /** ownerpart */ ,
                const char * matlabServerProgID /** matlabserverprogid */ 
            );
            /** Get the object information into MATLAB DataEx V2 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void GetMATLABInformationExV2
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                std::vector<NXOpen::Mechatronics::MATLABClientBuilder::TagInfoEx> & tagInfos /** Array of TagInfos */
            ...
            /** Get the object information into MATLAB DataEx V2 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            void GetMATLABInformationExV2
            (
                const char * instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                std::vector<NXOpen::Mechatronics::MATLABClientBuilder::TagInfoEx> & tagInfos /** Array of TagInfos */
            );
            /**  @brief  Set the object information into MATLAB DataEx V2 

              
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_player ("Mechatronics Concept Designer Player") */
            public: void SetMATLABInformationExV2
            (
                const NXString & instanceName /** instancename */ ,
                NXOpen::Part * ownerPart /** ownerpart */ ,
                const std::vector<NXOpen::Mechatronics::MATLABClientBuilder::TagInfoEx> & tagInfos /** Array of TagInfos */
