    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  EdgeBlendBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Add a point on edge chain data to the edge blend, expression data are using TEXT_pc_t 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void AddPointOnEdgeChainData
            (
                const std::vector<NXOpen::Edge *> & edgeArray /** Array of edges that are used by the edge chain */,
                const NXString & parameterOnChainExp /** The variable radius point parameter expression along the chain. If isArcLength is false, this value is a percentage value */,
                bool isArclength /** Flag indicating whether parameter is arclength or percentage arclength */,
                const NXString & radiusExp /**  The radius expression at this point on the edge. */,
                const NXString & centerValueExp /**  The conic center value expression at this point on the edge. */,
                const NXString & rhoValueExp /**  The conic rho value expression at this point on the edge. */,
                NXOpen::Point * smartPoint /** Smart Point defining the location of this variable radius */,
                bool isExternal /** Flag indicating whether this point is external to blend */
            );
            /** Add a point on edge chain data to the edge blend, expression data are using TEXT_pc_t 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            void AddPointOnEdgeChainData
            (
                const std::vector<NXOpen::Edge *> & edgeArray /** Array of edges that are used by the edge chain */,
                const char * parameterOnChainExp /** The variable radius point parameter expression along the chain. If isArcLength is false, this value is a percentage value */,
                bool isArclength /** Flag indicating whether parameter is arclength or percentage arclength */,
                const char * radiusExp /**  The radius expression at this point on the edge. */,
                const char * centerValueExp /**  The conic center value expression at this point on the edge. */,
                const char * rhoValueExp /**  The conic rho value expression at this point on the edge. */,
                NXOpen::Point * smartPoint /** Smart Point defining the location of this variable radius */,
                bool isExternal /** Flag indicating whether this point is external to blend */
            );
            /** Get conic expressions for an edge blend chainset given the index of the chainset 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void GetConicExpressions
            (
                int csIndex /** Index of chainset, indicating which chainset we are dealing with */,
                NXOpen::ScCollector ** collector /**The collector for this edge blend chainset */,
                NXOpen::Expression ** primaryExpressionTag /**  The primary expression of this chain set collector */,
                NXOpen::Expression ** secondaryExpressionTag /**  The secondary expression of this chain set collector */
            );
            /** Get circular section variable radius point expression for an edge blend for the given list of edges  @return   The primary expression of this variable radius point 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * GetCircularVariableRadiusExpression
            (
                const std::vector<NXOpen::Edge *> & edgeArray /** Array of edges that are used by the edge chain */,
                double parameterOnChain /** The variable radius point parameter along the chain. If isArcLength is false, this value is a percentage value */,
                bool isArclength /** Flag indicating whether parameter is arclength or percentage arclength */,
            ...
            /** Get conic variable radius point expressions for an edge blend for the given list of edges 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void GetConicVariableRadiusExpressions
            (
                const std::vector<NXOpen::Edge *> & edgeArray /** Array of edges that are used by the edge chain */,
                double parameterOnChain /** The variable radius point parameter along the chain. If isArcLength is false, this value is a percentage value */,
                bool isArclength /** Flag indicating whether parameter is arclength or percentage arclength */,
                NXOpen::Point * smartPoint /** Smart Point defining the location of this variable radius */,
                bool isExternal /** Flag indicating whether this point is external to blend */,
                NXOpen::Expression ** primaryExpressionTag /**  The primary expression of this variable radius point */,
                NXOpen::Expression ** secondaryExpressionTag /**  The secondary expression of this variable radius point */
            );
            /** Get variable radius point parameter expression for an edge blend for the given list of edges  @return   The parameter expression of variable radius point location 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * GetVariableRadiusParameterExpression
            (
                const std::vector<NXOpen::Edge *> & edgeArray /** Array of edges that are used by the edge chain */,
                double parameterOnChain /** The variable radius point parameter along the chain. If isArcLength is false, this value is a percentage value */,
                bool isArclength /** Flag indicating whether parameter is arclength or percentage arclength */,
            ...
            /** Get setback distance expression for an edge blend  @return   The distance expression of this queried setback 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * GetSetbackDistanceExpression
            (
                int sbIndex /** sbindex */ ,
                int ithDistance /** ithdistance */ 
            );
        };
    }
}
