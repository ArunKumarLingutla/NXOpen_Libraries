...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        */
        ...
        {
            /**  @brief 
                            the free length definition type for Motion Body Spring.
                         

             
                        
                            Each free length definition type has a specific definition associated.
                            A Motion Body Spring is invalid without a free length definition associated.
                        
                    */
            public: enum FreeLengthDefinition
            {
                FreeLengthDefinitionPreloadedAndActuator/** for preloaded and actuator type        */,
                FreeLengthDefinitionFreeLengthDirectly/** for free length directly type             */
            };
            ...
            /**Returns  the free length of spring. This Api works only for motion body spring 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * FreeLengthExpression
            (
            );
            /**Returns  the free length definition type of spring. This Api works only for motion body spring 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SpringBuilder::FreeLengthDefinition FreeLengthDefinitionType
            (
            );
            /**Sets  the free length definition type of spring. This Api works only for motion body spring 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetFreeLengthDefinitionType
            (
                NXOpen::Motion::SpringBuilder::FreeLengthDefinition type /** type */ 
            );
        };
    }
}
