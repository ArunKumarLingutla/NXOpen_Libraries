        ...
        */
        class NXOPENCPP_VSAEXPORT  MeasurementOperationBuilder : public NXOpen::Builder
        {
            ...
            public: enum APIEnumMeasurementType
            {
                ...
                APIEnumMeasurementTypePoint/** point */ ,
                APIEnumMeasurementTypeMinimumVirtualClearance/** minimum virtual clearance */ ,
                APIEnumMeasurementTypeMinimumFeatureClearance/** minimum feature clearance */ ,
                APIEnumMeasurementTypeVirtualHoleDiameter/** virtual hole diameter */ 
            };
            ...
            /** The Virtual Hole Diameter Features 
             ...
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetVirtualHoleDiameterFeatureObjectListItem
            (
                int index /** index */ ,
            ...
            /** The Virtual Hole Diameter Features 
             ...
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: NXOpen::NXObject * GetVirtualHoleDiameterFeatureObjectListItem
            (
                int index /** index */ 
            );
            /** The Remove Virtual Hole Diameter Feature 
             ...
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void RemoveVirtualHoleDiameterFeatureObjectListItem
            (
                int index /** index */ 
            );
            /** The Swap Virtual Hole Diameter Features 
             ...
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SwapVirtualHoleDiameterFeatureObjectListItem
            (
                int nIndex1 /** nindex1 */ ,
                int nIndex2 /** nindex2 */ 
            );
