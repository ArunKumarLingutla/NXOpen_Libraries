    ...
    namespace RoutingCommon
    {
        ...
        */
        class NXOPENCPP_ROUTINGCOMMONEXPORT  RoutingManager
        {
            ...
            {
                ConnectionTypeUnknown/** Connection type is unknown. */,
                ConnectionTypeButt/** Butt weld  */,
                ConnectionTypeFillet/** Fillet weld  */,
                ConnectionTypeThreaded/** Threaded  */
            };
            ...
            */
            ...
            (
                ...
                const NXString & attributeDisplayName /** The display name of the attribute being set, it should be unique in the system */,
            ...
            (
                NXOpen::Part * part /** part */ ,
                const char * attributeDisplayName /** The display name of the attribute being set, it should be unique in the system */,
            ...
            /// \endcond 
            /**  Returns the ports connected to two part occurrences, if any, the engagement value of the ports or zero if no engagement and connection type 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void GetPortsConnectingPartOccurrencesForPipeJoin
            (
                NXOpen::Assemblies::Component * partOccurrence1 /** partoccurrence1 */ ,
                NXOpen::Assemblies::Component * partOccurrence2 /** partoccurrence2 */ ,
                std::vector<NXOpen::Routing::Port *> & ports /** ports */ ,
                double* engagement /** engagement */ ,
                NXOpen::RoutingCommon::RoutingManager::ConnectionType* connectionType /** connectiontype */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void InvokeSelectionValidator
            (
                NXOpen::Part * part /** The work part */,
                NXOpen::TaggedObject * selectedObject /** selected object */,
                NXOpen::Builder * builder /** The builder on which selection needs to be done */,
                int* messageType /** 1 - Information, 2 - Warning, 3 - Error and -1 if no error */,
                int* error /** error */
            );
