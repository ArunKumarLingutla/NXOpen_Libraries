...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  FilletFaceMethod : public NXOpen::SelectionMethod
        {
            private: FilletFaceMethodImpl * m_filletfacemethod_impl;
            /// \cond NX_NO_DOC 
