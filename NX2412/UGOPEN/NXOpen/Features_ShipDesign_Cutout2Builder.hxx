        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  Cutout2Builder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /** Creates a NXOpen.Features.ShipDesign.PointDimBuilder with the given point, expression and index.  
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") */
                public: NXOpen::Features::ShipDesign::PointDimBuilder * CreatePointDimBuilderWithPoint
                (
                    const NXOpen::Point3d & point /** point */ ,
                    NXOpen::Expression * dimension /** dimension */ ,
                    int index /** index */ 
                );
                /**Returns  the option to add the Y-mirror cutout too 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : None */
                public: bool AddSymmetricalCutout
                (
                );
                /**Sets  the option to add the Y-mirror cutout too 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") */
                public: void SetAddSymmetricalCutout
                (
                    bool addSymmetricalCutout /** addsymmetricalcutout */ 
                );
                /**Returns  the option to use display octree 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : None */
                public: bool UseDisplayOctree
                (
                );
                /**Sets  the option to use display octree 
                 <br>  Created in NX2412.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") OR nx_ship_basic ("Ship Basic Design") */
                public: void SetUseDisplayOctree
                (
                    bool addUseDisplayOctree /** addusedisplayoctree */ 
                );
            };
        }
    }
