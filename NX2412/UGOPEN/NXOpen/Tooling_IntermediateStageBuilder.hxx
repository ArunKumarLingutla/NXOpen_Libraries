...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        PartToBlank </description> </item> 

        <item><term> 
         
        EditOption </term> <description> 
         
        Insert </description> </item> 

        <item><term> 
         
        IntermediateRename </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LinkSheetBody </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        NumberIntermediate </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  IntermediateStageBuilder : public NXOpen::Builder
        {
            ...
            /** Insert intermediate stages 
             ...
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ReorderIntermediateStages
            (
                NXOpen::NXObject * newInstance /** newinstance */ ,
                NXOpen::NXObject * curPart /** curpart */ ,
                const NXString & refFullName /** reffullname */ 
            );
            /** Insert intermediate stages 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            void ReorderIntermediateStages
            (
                NXOpen::NXObject * newInstance /** newinstance */ ,
                NXOpen::NXObject * curPart /** curpart */ ,
                const char * refFullName /** reffullname */ 
            );
            /** Specifies an array of names for the rename parts 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetRenameParts
            (
                const std::vector<NXString> & renameParts /** A list of renamed part names */
            );
            /** Gets the names of rename parts  @return  A list of renamed part names 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: std::vector<NXString> GetRenameParts
            (
            );
            /** Specifies an array of names for the die parts 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetDbPartNames
            (
                const std::vector<NXString> & dbPartNames /** A list of die part names */
            );
            /** Gets the names of die parts  @return  A list of die part names 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: std::vector<NXString> GetDbPartNames
            (
            );
            /** Specifies an array of names for the part types 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetPartTypes
            (
                const std::vector<NXString> & partTypes /** A list of part types */
            );
            /** Gets the names of part types  @return  A list of part types 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: std::vector<NXString> GetPartTypes
            (
            );
        };
    }
