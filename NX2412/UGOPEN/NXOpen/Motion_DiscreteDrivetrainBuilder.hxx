    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  DiscreteDrivetrainBuilder : public NXOpen::Motion::MotionBuilder
        {
            ...
            /**Returns  the layout plane coordinate system. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::CoordinateSystem * LayoutPlaneCsys
            (
            );
            /**Sets  the layout plane coordinate system. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetLayoutPlaneCsys
            (
                NXOpen::CoordinateSystem * layoutPlaneCsys /** layoutplanecsys */ 
            );
            ...
            /**Returns  the discrete drivetrain reverse pattern instances direction. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool ReversePatternInstancingDirection
            (
            );
            /**Sets  the discrete drivetrain reverse pattern instances direction. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReversePatternInstancingDirection
            (
                bool reversePatternInstancingDirection /** reversepatterninstancingdirection */ 
            );
            ...
            /**Returns  the outside height defined for the discrete drivetrain. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * OutsideHeight
            (
            );
            /**Returns  the inside height defined for the discrete drivetrain. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Expression * InsideHeight
            (
            );
            ...
            /**Returns  the status to indicate whether this is a double-pin track. If it is true, then adjust sprocket tooth alignment to account for double-pin. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool DoublePinTrack
            (
            );
            /**Sets  the status to indicate whether this is a double-pin track. If it is true, then adjust sprocket tooth alignment to account for double-pin. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetDoublePinTrack
            (
                bool doublePinTrack /** doublepintrack */ 
            );
            /**Returns  the status to indicate whether the adjust pattern instances evenly is active or not. If it is true, then adjust pattern instances evenly is active. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool PositionPatternInstancesEvenly
            (
            );
            /**Sets  the status to indicate whether the adjust pattern instances evenly is active or not. If it is true, then adjust pattern instances evenly is active. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetPositionPatternInstancesEvenly
            (
                bool positionPatternInstancesEvenly /** positionpatterninstancesevenly */ 
            );
            ...
            /**Returns  the path length in part units, as computed by BuildPatternInstances method. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: double PathLength
            (
            );
            /**Returns  the instances length in part units, as computed by BuildPatternInstances method. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: double InstancesLength
            (
            );
            /**Returns  the total gap in part units, as computed by BuildPatternInstances method. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: double TotalGap
            (
            );
            /**Returns  the average gap in part units, as computed by BuildPatternInstances method. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
