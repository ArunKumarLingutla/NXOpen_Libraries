    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSimulation
        {
            ...
            /** Adds a new @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink  in this motion simulation assembly as CAD source part 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void AddCADSourcePart
            (
                NXOpen::Part * motionPart /** the motion part to add CAD source part into it*/,
                NXOpen::NXObject * sourcePart /** the CAD source part to be added, it can be a part occurrence tag or part tag */
            );
            /** Removes existing CAD source part from this motion simulation assembly 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void RemoveCADSourcePart
            (
                NXOpen::Part * motionPart /** the motion part to remove CAD source part from it */,
                bool deleteMotionObjects /** the tag whether to keep or delete motion objects referencing CAD source part */
            );
            /** Gets the loaded CAD source part in this motion simulation assembly.  @return  the loaded CAD source part 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Part * GetCADSourcePart
            (
                NXOpen::Part * motionPart /** the motion part to remove CAD source part from it */
            );
            /** Gets the solution manager of this motion simulation.  @return  the solution manager 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::SolutionManager * GetSolutionManager
            (
                NXOpen::Part * motionPart /** the motion part to retrieve the solution manager */
            );
            /** Create a csys by calculating the principal axes of inertia for a set of Motion Bodies
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::CoordinateSystem * CreateCsysOfPrincipalAxesOfInertia
            (
                const std::vector<NXOpen::Motion::Link *> & bodies /** bodies */ 
            );
