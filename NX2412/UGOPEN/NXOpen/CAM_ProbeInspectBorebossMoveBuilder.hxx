    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ProbeInspectBorebossMoveBuilder : public NXOpen::CAM::MoveBuilder
        {
            ...
            /**Returns  the boss dimension builder
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ExpressionDouble * BossDimensionBuilder
            (
            );
            /**Returns  the measurement depth builder
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ExpressionDouble * MeasurementDepthBuilder
            (
            );
            /**Returns  the diameter builder
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ExpressionDouble * DiameterBuilder
            (
            );
        };
    }
