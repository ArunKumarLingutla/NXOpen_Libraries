...
#include <NXOpen/Tooling_EjectorPinSectionCurveData.hxx>
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DesignEjectorPinBuilder : public NXOpen::Builder
        {
            ...
            public: enum DefineType
            {
                ...
                DefineTypeSelectCurve/** Adding ejecotr pin by selecting curve */
            };
            ...
            /**Returns  the curve section to position ejector pin
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * EjectorCurveSection
            (
            );
            /** Collects all ejector pin section data objects which are new or need to be modified. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void CollectNewEjectorSectionData
            (
                std::vector<NXOpen::Tooling::EjectorPinSectionCurveData *> & newSectionDataArray /** newsectiondataarray */ ,
                std::vector<NXOpen::Tooling::EjectorPinSectionCurveData *> & modifiedSectionDataArray /** modifiedsectiondataarray */ 
            );
            /** Updates the concept objects based on curve selection change. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void UpdateExistingConceptObjectsOnCurveSelection
            (
                const std::vector<NXOpen::Tooling::EjectorPinSectionCurveData *> & modifiedSectionDataArray /** modifiedsectiondataarray */ 
            );
            /** Updates curve section data and the concept objects while deselecting curves. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void OnSectoinCurveDeselected
            (
            );
            /** Finds matched value from database based on selected curves for the ejector pin section. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void AutoMatchEjectorPinSectionSize
            (
                NXOpen::Tooling::EjectorPinSectionCurveData * pCurrentSectionData /** pcurrentsectiondata */ ,
                bool mode /** mode */ 
            );
            /** Gets the active ejector section curve data object.   @return  A @link NXOpen::Tooling::EjectorPinSectionCurveData NXOpen::Tooling::EjectorPinSectionCurveData@endlink  instance 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::EjectorPinSectionCurveData * GetActiveSectionCurveData
            (
            );
            /** Sets the active ejector section curve data object.  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetActiveSectionCurveData
            (
                NXOpen::Tooling::EjectorPinSectionCurveData * currentSectionData /** A @link NXOpen::Tooling::EjectorPinSectionCurveData NXOpen::Tooling::EjectorPinSectionCurveData@endlink  instance */
            );
            /** Determines whether to add instance or new part based on the section curve size by comparing existing section curve data.  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: bool IsToAddInstance
            (
                NXOpen::NXObject * pointTag /** pointtag */ 
            );
            /** Updates the target curve to source curve map for the linked curve feature. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void UpdateLinkedCurveTargetToSourceEntityMap
            (
                const std::vector<NXOpen::NXObject *> & sourceEntities /** sourceentities */ 
            );
            /** Creates a new section to replace the old one if the owning part of the existing section is not the current work part. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: bool RecreateCurveSectionOnWorkPartChange
            (
            );
            /** Assigns an attribute to the ejector symbol or point which represents the snap value used to round the ejector position. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void AssignSnapValueToConceptEjector
            (
                NXOpen::NXObject * addedConceptObject /** addedconceptobject */ ,
