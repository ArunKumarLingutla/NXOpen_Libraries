...
//
//  Source File:
//     Mechatronics_WebListItemBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _WebListItemBuilderListBuilder;
        class WebListItemBuilderListImpl;
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  WebListItemBuilderList : public NXOpen::TaggedObject
        {
            private: WebListItemBuilderListImpl * m_weblistitembuilderlist_impl;
            private: friend class  _WebListItemBuilderListBuilder;
            protected: WebListItemBuilderList();
            public: ~WebListItemBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Mechatronics::WebListItemBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Mechatronics::WebListItemBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Mechatronics::WebListItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::WebListItemBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Mechatronics::WebListItemBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::WebListItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Mechatronics::WebListItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Mechatronics::WebListItemBuilder * object1 /** first item */,
                NXOpen::Mechatronics::WebListItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Mechatronics::WebListItemBuilder * object /** object to be inserted */
            );
