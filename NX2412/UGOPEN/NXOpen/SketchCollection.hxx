...
#include <NXOpen/SketchArcFromCenterBuilder.hxx>
...
#include <NXOpen/SketchCheckingSettingsBuilder.hxx>
...
#include <NXOpen/SketchDimensionPreviewer.hxx>
...
#include <NXOpen/SketchFilletBuilder.hxx>
#include <NXOpen/SketchFindIssuesBuilder.hxx>
...
#include <NXOpen/SketchRectangleThreePointsBuilder.hxx>
#include <NXOpen/SketchRelationBuilder.hxx>
#include <NXOpen/SketchRemoteFindingBuilder.hxx>
#include <NXOpen/SketchSilhouetteBuilder.hxx>
#include <NXOpen/SketchSlotBuilder.hxx>
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SketchCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::Sketch *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Sketch **;
            using reference = NXOpen::Sketch *&;
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchDimensionPreviewer * GetDimensionPreviewer
        (
        );
        ...
        /** Creates a @link NXOpen::SketchProjectBuilder NXOpen::SketchProjectBuilder@endlink   @return  Builder object
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchProjectBuilder * CreateProjectBuilder
        (
            NXOpen::Features::Feature * operation /** The feature to be edited by this builder, or NULL to create a new one. */
        );
        ...
        /** Creates a @link NXOpen::SketchQuickTrimBuilder NXOpen::SketchQuickTrimBuilder@endlink   @return  Builder object
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        ...
        /** Creates a @link NXOpen::SketchInPlaceBuilder NXOpen::SketchInPlaceBuilder@endlink   @return  SketchInPlaceBuilder object
         ...
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: NXOpen::SketchInPlaceBuilder * CreateSketchInPlaceBuilder2
        (
            NXOpen::Sketch * operation /** The @link NXOpen::Sketch NXOpen::Sketch@endlink  to reattach or NULL to create                                                          a new one */
        );
        /** Creates a @link NXOpen::SimpleSketchInPlaceBuilder NXOpen::SimpleSketchInPlaceBuilder@endlink   @return  SimpleSketchInPlaceBuilder object
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: NXOpen::SimpleSketchInPlaceBuilder * CreateSimpleSketchInPlaceBuilder
        (
        );
        ...
        /** Creates a @link NXOpen::SketchMakeSymmetricBuilder NXOpen::SketchMakeSymmetricBuilder@endlink   @return  Builder object
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        ...
        /** Creates a @link SketchIncludeGeometryBuilder SketchIncludeGeometryBuilder@endlink . The included object needs to be passed in to edit it.
                If the included object is not passed in, then new included objects can be created.
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        ...
        /** Creates a @link NXOpen::SketchDefineWorkRegionBuilder NXOpen::SketchDefineWorkRegionBuilder@endlink   @return  Define Work Region Builder object
         <br>  @deprecated Deprecated in NX1980.0.0.  Use @link NXOpen::SketchWorkRegionBuilder NXOpen::SketchWorkRegionBuilder@endlink  instead. <br>  

         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::SketchWorkRegionBuilder instead.") NXOpen::SketchDefineWorkRegionBuilder * CreateDefineWorkRegionBuilder
        (
        );
        /** Creates a @link NXOpen::SketchWorkRegionBuilder NXOpen::SketchWorkRegionBuilder@endlink   @return  Work Region Builder object
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: NXOpen::SketchWorkRegionBuilder * CreateWorkRegionBuilder
        (
        );
        ...
        /** Creates a @link NXOpen::SketchDragGeometryBuilder NXOpen::SketchDragGeometryBuilder@endlink .  @return  the drag geometry builder 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchDragGeometryBuilder * CreateDragGeometryBuilder
        (
        );
        /** Creates a @link NXOpen::SketchLineBuilder NXOpen::SketchLineBuilder@endlink .  @return  the line builder 
         <br>  Created in NX2007.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchLineBuilder * CreateLineBuilder
        (
        );
        /** Creates a @link NXOpen::SketchRelationBuilder NXOpen::SketchRelationBuilder@endlink .  @return  the relation builder 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchRelationBuilder * CreateRelationBuilder
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchArcBuilder * CreateArcBuilder
        (
        );

        /// \endcond 
        /** Creates a @link NXOpen::SketchRemoteFindingBuilder NXOpen::SketchRemoteFindingBuilder@endlink .  @return  the remote finding builder 
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchRemoteFindingBuilder * CreateRemoteFindingBuilder
        (
        );
        /** Creates a @link NXOpen::SketchSilhouetteBuilder NXOpen::SketchSilhouetteBuilder@endlink   @return  Builder object
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchSilhouetteBuilder * CreateSilhouetteBuilder
        (
            NXOpen::Features::Feature * silhouettefeature /** The feature to be edited by this builder, or NULL to create a new one. */
        );
        /** Creates a @link NXOpen::SketchSlotBuilder NXOpen::SketchSlotBuilder@endlink .  @return  the slot builder 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchSlotBuilder * CreateSlotBuilder
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchFilletBuilder * CreateFilletBuilder
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchRectangleThreePointsBuilder * CreateRectangleThreePointsBuilder
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: NXOpen::SketchArcFromCenterBuilder * CreateArcFromCenterBuilder
        (
        );

        /// \endcond 
        /** Creates a @link NXOpen::SketchCheckingSettingsBuilder NXOpen::SketchCheckingSettingsBuilder@endlink .  @return  the sketch checking settings builder 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: NXOpen::SketchCheckingSettingsBuilder * CreateCheckingSettingsBuilder
        (
        );
        /** Creates a @link NXOpen::SketchFindIssuesBuilder NXOpen::SketchFindIssuesBuilder@endlink .  @return  the sketch find issues builder 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: NXOpen::SketchFindIssuesBuilder * CreateFindIssuesBuilder
        (
        );
