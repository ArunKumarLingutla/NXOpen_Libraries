    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PreTestSolution : public NXOpen::NXObject
        {
            ...
            /** Display summary information about sensor configurations 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void SensorConfigsInformation
            (
            );
            /** Display summary information about exciter configurations 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void ExciterConfigsInformation
            (
            );
            /** Creates New High Displacement DOF Node Group and DofSet 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_correl_base ("FE Correlation") */
            public: void IdentifyHighDisplacementNodes
            (
                const std::vector<NXOpen::TaggedObject *> & nodes /** nodes */ ,
