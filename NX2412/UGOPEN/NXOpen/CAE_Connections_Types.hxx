...
namespace NXOpen
{
    namespace CAE
    {
        namespace Connections
        {
            ...
            enum DiameterType
            {
                DiameterTypeUndefined/** Undefined diameter type */ = -1,
            ...
            enum HeightType
            {
                ...
                HeightTypeSumOfFlangesThickness/** Sum of the Flange Thickness */
            };
            ...
            enum ModelizationResultType
            {
                ...
                ModelizationResultTypeContact/** Contact */,
                ModelizationResultTypeMass/** Mass */,
                ModelizationResultTypeNonlinearStiffness/** Nonlinear Stiffness */,
                ModelizationResultTypeNonlinearDamping/** Nonlinear Damping */,
                ModelizationResultTypeThickness/** Thickness */
            };
            ...
            enum NutDiameterType
            {
                NutDiameterTypeUser/** User defined diameter */,
                NutDiameterTypeFactorOfDiameter/** User defined relationship with bolt head diameter */
            };
            ...
            {
                SeamWeldSectionTypeUndefined/** undefined */  = -1,
            ...
            {
                SeamWeldShapeTypeUndefined/** undefined */  = -1,
            ...
            enum MassCenterType
            {
                MassCenterTypeManual/** CoG is picked by selection */,
                MassCenterTypeFromDefinedSpiderLegs/** Use the CoG from the definition legs */,
                MassCenterTypeFromComputedSpiderLegs/** Use the CoG from the computed legs */
            };
            ...
            enum NodalTargetCenterType
            {
                ...
                NodalTargetCenterTypeFromComputedSpiderLegs/** Use the CoG from the computed legs */,
                NodalTargetCenterTypeCoincident/** The CoG is coincident with the other target CoG */,
                NodalTargetCenterTypeFromDefinedSpiderLegs/** Use the CoG from the definition legs */
            };
            ...
            enum BushingType
            {
                BushingTypeRectangular/** Rectangular bushing type */,
                BushingTypeCylindrical/** Cylindrical bushing type */
            };

            /** Local Spider Center Types */
            enum LocalSpiderCenterType
            {
                LocalSpiderCenterTypeMeanOfSpiderLegs/** Local spider center is computed as the mean of its legs */,
                LocalSpiderCenterTypeInputLegDefinition/** Use the input leg definition coordinates as local spider center */
            };

            /** CAD Components Load Type */
            enum CadComponentsLoadType
            {
                CadComponentsLoadTypeAllParts/** Full loading of all CAD components */,
                CadComponentsLoadTypeMainAssociatedPartsOnly/** Full loading of the main associated CAD components */
            };
