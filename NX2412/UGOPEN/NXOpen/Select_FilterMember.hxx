...
namespace NXOpen
{
    namespace Select
    {
        ...
        enum FilterMember
        {
            ...
            FilterMemberDistanceAnalysis/** Distance Analysis */,
            FilterMemberRadiusAnalysis/** Radius Analysis */,
            FilterMemberReflectionAnalysis/** Reflection Analysis */,
            FilterMemberSlopeAnalysis/** Slope Analysis */,
            ...
            FilterMemberAnimationDesignerContainer/** The container of objects in navigator */,
            FilterMemberAnimationDesignerFlexibleObject/** The flexible objects for an animation */,
            ...
            FilterMemberCAEFaceMatchControl/** CAE Face Match Mesh Control */,
            FilterMemberCAEEdgeMatchControl/** CAE Edge Match Mesh Control */,
            ...
            FilterMemberCAEPostTransNode/** Post Node */,
            FilterMemberCAEPostTransElement/** Post Element */,
            FilterMemberCAEPostTransMesh/** Post Mesh */,
            FilterMemberCAEPostTransPolygonEdge/** Post Polygon Edge*/,
            FilterMemberCAEPostTransPolygonFace/** Post Polygon Face*/,
            FilterMemberCAEPostTransComponent/** Post Component*/,
            FilterMemberCAEFreeBody/** Nodal Force Report */,
            FilterMemberCAEResultProbe/** Result Probe */,
            FilterMemberCAEPostTransElementFace/** Post Element Face*/,
            FilterMemberCAEPostTransElementEdge/** Post Element Edge*/,
            FilterMemberCAEFreeBodyFolder/** CAE Nodal Force Report Folder*/,
            FilterMemberCAEStressLinearizationFolder/** CAE Stress Linearization Folder*/,
            FilterMemberCAENoteConnection/** CAE Note Connection */,
            FilterMemberCoatingLayer/** Coating Layer */ = 7000,
            FilterMemberCoatingStack/** Coating Stack */,
            FilterMemberLinearMaterial/** Linear Material */,
            ...
            FilterMemberEdgeConditionSymbol/** Edge Condition Symbol */,
            ...
            FilterMemberJoinHole/** Join Hole Feature */,
            ...
            FilterMemberAdditiveManufacturingPartOccurrence/** PartOccurrence in Additive Manufacturing */,
            FilterMemberAdditiveManufacturingSupport/** Support in Additive Manufacturing */,
            FilterMemberAdditiveManufacturingSupportOccurrence/** Support Occurrence in Additive Manufacturing */,
            FilterMemberAdditiveManufacturingPartRegion/** Part Region in Additive Manufacturing */,
            FilterMemberAdditiveManufacturingPartRegionOccurrence/** Part Region Occurrence in Additive Manufacturing */,
            ...
            FilterMemberMotionSimBushingProperty/** Bushing Property*/,
            ...
            FilterMemberMotionSimHydrodynamicBearing/** Hydrodynamic Bearing */,
            FilterMemberMotionSimSprungMass/** Sprung Mass*/,
            FilterMemberMotionSimDiscreteDrivetrainReport/** Discrete Drivetrain Report*/,
            FilterMemberMotionSimElectromagneticForce/** ElectromagneticForce*/,
            FilterMemberMotionSimGeneralSensor/** General Sensor*/,
            FilterMemberMotionSimContactPattern/** ContactPattern */,
            FilterMemberMotionSimFlexModalContent/** Flex Modal Content */,
            FilterMemberMotionSimFixedJointDriver/** Fixed Joint Driver */,
            FilterMemberMotionSimFrfInput/** Frf Input */,
            FilterMemberMotionSimFrfOutput/** Frf Output */,
            ...
            FilterMemberCompositesLaminate/** Composites Laminate */ = 36000,
            FilterMemberCompositesPly/** Composites Ply */,
            FilterMemberAllCompositesObjects/** All Composites Objects */ = 36999,
            FilterMemberAECGridLine/** AEC grid line */,
            FilterMemberAECLevelLine/** aeclevel line */ ,
            FilterMemberAECSymbol/** aecsymbol */ ,
            FilterMemberAECLineFormat/** aecline format */ ,
            FilterMemberDisplayInstance/** Display Instance*/ = 38000
        };
