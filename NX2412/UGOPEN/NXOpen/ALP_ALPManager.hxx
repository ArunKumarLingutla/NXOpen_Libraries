        ...
        */
        class ALPOPENCPPEXPORT  ALPManager
        {
            ...
            */
            ...
            /** Creates station takt time builder @return  
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : alp_planner ("Assembly Line Planner") */
            public: NXOpen::ALP::StationTaktTimeBuilder * CreateStationTaktTimeBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /** Creates flows manager builder @return  
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : alp_planner ("Assembly Line Planner") */
            public: NXOpen::ALP::FlowsManagerBuilder * CreateFlowsManagerBuilder
            (
                NXOpen::Part * part /** part */ 
            );
            /**  @brief  
            ...
            (
                const NXString & lineItemID /** line itemId */,
                const NXString & lineRevisionID /** line revision id */,
                const NXString & ccUUID /** collaborative context UUID*/,
                NXOpen::NXObject * variantObject /** variant configuration specification */
            );
            /**  @brief  
                    Opens ALP Application
            ...
            (
                const char * lineItemID /** line itemId */,
                const char * lineRevisionID /** line revision id */,
                const char * ccUUID /** collaborative context UUID*/,
                NXOpen::NXObject * variantObject /** variant configuration specification */
            );
            /** Creates material flow node @return  
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : alp_planner ("Assembly Line Planner") */
            public: NXOpen::ALP::MaterialFlowNode * CreateMaterialFlowNode
            (
                NXOpen::Part * part /** part */ 
            );
            /**  @brief  
