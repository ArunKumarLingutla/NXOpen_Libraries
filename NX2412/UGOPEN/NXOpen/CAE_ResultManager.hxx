...
#include <NXOpen/CAE_ImportResultParameters.hxx>
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        ...
        {
            /** nodal force report field independent domain enumeration type*/
            public: enum NodalForceReportIndependentDomain
            {
                NodalForceReportIndependentDomainGeneral/** general independent domain */,
                NodalForceReportIndependentDomainFrequency/** frequency independent domain */ = 4,
                NodalForceReportIndependentDomainTime/** time independent domain */,
                NodalForceReportIndependentDomainGeneral2d/** general 2D independent domain */ = 7
            };

            /** nodal force report field dependent domain enumeration type*/
            public: enum NodalForceReportDependentDomain
            {
                NodalForceReportDependentDomainForce/** force dependent domain */,
                NodalForceReportDependentDomainMoment/** moment dependent domain */
            };
            ...
            /** Creates a solution result object given a @link NXOpen::CAE::AeroStructures::GraphicalReport NXOpen::CAE::AeroStructures::GraphicalReport@endlink  
                        It is user's responsibility to destroy the result object once done
                        using @link NXOpen::CAE::ResultManager::DeleteResult NXOpen::CAE::ResultManager::DeleteResult@endlink , in order to free up system resources.
                        More than one @link NXOpen::CAE::SolutionResult NXOpen::CAE::SolutionResult@endlink  object can be created for same solution, it is 
                        user's responsibility to delete each one of them.
                     @return  Created solution result given the input margin graphical report 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::SolutionResult * CreateMarginGraphicalReportResult
            (
                NXOpen::CAE::AeroStructures::GraphicalReport * marginGraphicalReport /** The margin graphical report */
            );
            ...
            /** Creates a results envelope builder.
                        It is user's responsibility to destroy the builder object once done 
                     @return  
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link NXOpen::CAE::ResultManager::CreateResultsManipulationEnvelopeBuilder NXOpen::CAE::ResultManager::CreateResultsManipulationEnvelopeBuilder@endlink  <br>  

             <br>  Created in NX7.5.2.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::CAE::ResultManager::CreateResultsManipulationEnvelopeBuilder") NXOpen::CAE::ResultsEnvelopeBuilder * CreateResultsEnvelopeBuilder
            (
            );
            ...
            /** Creates a results extraction builder for extracting results into csv file. 
                        It is user's responsibility to detroy this builder object once done. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::ExtractingResultsToCsvBuilder * CreateExtractingResultsToCsvBuilder
            (
            );
            /** Creates a results extraction builder for extracting results into scd5 file. 
                        It is user's responsibility to detroy this builder object once done. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::ExtractingResultsToScd5Builder * CreateExtractingResultsToScd5Builder
            (
            );
            ...
            /** Creates a post csys object from coordinate system source.
                     ...
                     @return  
             <br>  @deprecated Deprecated in NX2212.0.0.  Use @link NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_post_coordinatesystem_from_model NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_post_coordinatesystem_from_model@endlink  for model csys and @link NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_post_coordinatesystem_from_result NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_post_coordinatesystem_from_result@endlink  for csys coming from result file instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_post_coordinatesystem_from_model for model csys and NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_post_coordinatesystem_from_result for csys coming from result file instead.") NXOpen::CAE::PostCoordinateSystem * CreatePostCoordinatesystem
            (
                NXOpen::CAE::Result * result /** result */ ,
            ...
            /** Creates a post csys object from coordinate system defined in model.
                        It is user's responsibility to destroy the csys object once done.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostCoordinateSystem * CreatePostCoordinatesystemFromModel
            (
                NXOpen::CoordinateSystem * csys /** csys */ 
            );
            /** Creates a post csys object from coordinate system defined in result file.
                        It is user's responsibility to destroy the csys object once done.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostCoordinateSystem * CreatePostCoordinatesystemFromResult
            (
                NXOpen::CAE::Result * result /** result */ ,
                int resultCsysId /** resultcsysid */ 
            );
            ...
            /** Exports Results from ResultProbe in UNV file format.
             ...
             <br>  @deprecated Deprecated in NX2306.0.0.  Use @link NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_export_unv_for_result_probes NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_export_unv_for_result_probes@endlink  <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_export_unv_for_result_probes") void ExportUnvFromProbe
            (
            ...
            /** Exports the field from the lists of independent variables along with a given NodalForceReport.
             ...
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_export_nodal_force_report_to_field_file_with_name NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_export_nodal_force_report_to_field_file_with_name@endlink  to create @link NXOpen::CAE::ResultTableFieldBuilder NXOpen::CAE::ResultTableFieldBuilder@endlink . <br>  

             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_export_nodal_force_report_to_field_file_with_name to create NXOpen::CAE::ResultTableFieldBuilder.") void ExportNodalForceReportToFieldFile
            (
                NXOpen::CAE::NodalForceReport * nodalForceReport /** nodal force report */ ,
            ...
            /** Exports the field from a @link NXOpen::CAE::NodalForceReport NXOpen::CAE::NodalForceReport@endlink  object with specified name and descriptions to a file.
                    
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void ExportNodalForceReportToFieldFileWithName
            (
                NXOpen::CAE::NodalForceReport * nodalForceReportTag /** nodalforcereporttag */ ,
                const NXString & fileName /** file name */,
                NXOpen::CAE::ResultManager::NodalForceReportIndependentDomain indepentDomainOption /** independent domain option */,
                NXOpen::CAE::ResultManager::NodalForceReportDependentDomain dependentDomainOption /** dependent domain option */,
                const NXString & fieldName /** field name */,
                std::vector<NXString> & descriptionLines /** field description */
            );
            /** Exports the field from a @link NXOpen::CAE::NodalForceReport NXOpen::CAE::NodalForceReport@endlink  object with specified name and descriptions to a file.
                    
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            void ExportNodalForceReportToFieldFileWithName
            (
                NXOpen::CAE::NodalForceReport * nodalForceReportTag /** nodalforcereporttag */ ,
                const char * fileName /** file name */,
                NXOpen::CAE::ResultManager::NodalForceReportIndependentDomain indepentDomainOption /** independent domain option */,
            ...
            /** Creates a table of sub fields for the model. A submodel could be used when creating the table. A 4d field is created. @return  The table of fields created
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_result_table_field_builder NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_result_table_field_builder@endlink  to create @link NXOpen::CAE::ResultTableFieldBuilder NXOpen::CAE::ResultTableFieldBuilder@endlink . <br>  

             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_result_table_field_builder to create NXOpen::CAE::ResultTableFieldBuilder.") NXOpen::Fields::FieldLinksTable * CreateTableOfFieldsForModel
            (
                const NXString & fieldName /** field name */,
            ...
            /** Creates a table of field for the model having duplicate value option as an argument. A submodel could be used when creating the table.  @return  The table of fields created
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::ResultManager::JA_RESULT_MANAGER_create_result_table_field_builder to create NXOpen::CAE::ResultTableFieldBuilder.") NXOpen::Fields::FieldTable * CreateTableFieldForModel
            (
                const NXString & fieldName /** field name */,
                const std::vector<NXOpen::Fields::FieldVariable *> & indepVarArray /** independent variables to be associated with the table field */,
                const std::vector<NXOpen::Fields::FieldVariable *> & depVarArray /** dependent variables to be associated with the table field */,
            ...
            /** Creates a @link NXOpen::CAE::ResultParametersMultiValue NXOpen::CAE::ResultParametersMultiValue@endlink  object.
                        It is user's responsibility to destroy the object once done
                        using @link NXOpen::CAE::ResultManager::DeleteResultParameters NXOpen::CAE::ResultManager::DeleteResultParameters@endlink , in order to free up system resources
                    
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::ResultParametersMultiValue * CreateResultParametersMultiValue
            (
            );
            /** Deletes a imported result parameters object. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void DeleteImportResultParameters
            (
                NXOpen::CAE::ImportResultParameters * importResultParameters /** import result parameters */ 
            );
            /** Deletes a result unit system. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void DeleteResultUnitSystem
            (
                NXOpen::CAE::ResultUnitSystem * resultUnitSystem /** result unit system */ 
            );
            /** Creates a result feild builder @link NXOpen::CAE::ResultTableFieldBuilder NXOpen::CAE::ResultTableFieldBuilder@endlink  which is used to create @link NXOpen::Fields::FieldTable NXOpen::Fields::FieldTable@endlink  or @link NXOpen::Fields::FieldLinksTable NXOpen::Fields::FieldLinksTable@endlink . @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::ResultTableFieldBuilder * CreateResultTableFieldBuilder
            (
            );
            /** Export multiple graphs to afu file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void ExportGraphs
            (
                const std::vector<NXOpen::CAE::PostGraph *> & graphs /** graphs */ ,
            ...
            /** Gets function result types. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<NXOpen::CAE::PostProc::FunctionResultType *> GetFunctionResultTypes
            (
                NXOpen::CAE::Result * result /** result */ 
            );
            /** Creates a function result parameter object.
                        It is user's responsibility to destroy the result parameters object once done 
                        using @link NXOpen::CAE::ResultManager::DeleteFunctionResultParameters NXOpen::CAE::ResultManager::DeleteFunctionResultParameters@endlink , in order to free up system resources
                     @return defines the function result parameters 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostProc::FunctionResultParameters * CreateFunctionResultParameters
            (
            );
            /** Creates a function result access object
                        It is user's responsibility to destroy the result access object once done
                        using @link NXOpen::CAE::ResultManager::DeleteFunctionResultAccess NXOpen::CAE::ResultManager::DeleteFunctionResultAccess@endlink , in order to free up system resources
                     @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostProc::FunctionResultAccess * CreateFunctionResultAccess
            (
                NXOpen::CAE::Result * result /** analysis results for which you want to access information */,
                NXOpen::CAE::PostProc::FunctionResultParameters * parameters /** defines the specific results state you wish to access */
            );
            /** Deletes a @link NXOpen::CAE::PostProc::FunctionResultParameters NXOpen::CAE::PostProc::FunctionResultParameters@endlink  object. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void DeleteFunctionResultParameters
            (
                NXOpen::CAE::PostProc::FunctionResultParameters * result /** result */ 
            );
            /** Deletes a @link NXOpen::CAE::PostProc::FunctionResultAccess NXOpen::CAE::PostProc::FunctionResultAccess@endlink  object. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void DeleteFunctionResultAccess
            (
                NXOpen::CAE::PostProc::FunctionResultAccess * resultAccess /** resultaccess */ 
            );
            /** Creates Result Variable object  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::ResultVariable * CreateResultVariableFromQuantityName
            (
                NXOpen::CAE::SimSimulation * sim /** Simulation */,
                const NXString & quantityName /** Name of a Quantity */,
                NXOpen::CAE::Result::Location loc /** loc */ ,
                NXOpen::CAE::Result::Component comp /** comp */ ,
                const NXString & restypename /** Result Type UserName, If not sure pass empty string*/,
                const NXString & name /** Result Variable name*/
            ...
            /** Creates Result Variable object  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            NXOpen::CAE::ResultVariable * CreateResultVariableFromQuantityName
            (
                NXOpen::CAE::SimSimulation * sim /** Simulation */,
                const char * quantityName /** Name of a Quantity */,
                NXOpen::CAE::Result::Location loc /** loc */ ,
                NXOpen::CAE::Result::Component comp /** comp */ ,
                const char * restypename /** Result Type UserName, If not sure pass empty string*/,
                const char * name /** Result Variable name*/
            ...
            /** Creates a imported result object. It can be used to create a  @link NXOpen::CAE::ImportedResult NXOpen::CAE::ImportedResult@endlink   object
             ...
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::ImportResultParameters * CreateImportedResultParameters
            (
            );
            /** Deletes a imported result parameters object. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void DeleteImportedResultParameters
            (
                NXOpen::CAE::ImportResultParameters * importResultParameters /** import result parameters */ 
            );
            /** Exports Results from ResultProbes in UNV file format.  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void ExportUnvForResultProbes
            (
                const NXString & fileName /** file name with full path */,
                const std::vector<NXOpen::CAE::ResultProbe *> & probeArray /** ResultProbes */,
                bool exportModel /** export model */ 
            );
            /** Exports Results from ResultProbes in UNV file format.  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            void ExportUnvForResultProbes
            (
                const char * fileName /** file name with full path */,
                const std::vector<NXOpen::CAE::ResultProbe *> & probeArray /** ResultProbes */,
                bool exportModel /** export model */ 
            );
            /** Unloads Result for Result Reference.  
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void UnloadReferenceResult
            (
                NXOpen::CAE::SimResultReference * refRes /** refres */ 
            );


            /** Returns the @link NXOpen::CAE::PostProc::FunctionResultService NXOpen::CAE::PostProc::FunctionResultService@endlink  belonging to this result manager 
             <br>  Created in NX2212.0.0.  <br>  
            */
            public: NXOpen::CAE::PostProc::FunctionResultService *FunctionResultService();
