    ...
    namespace Vsa
    {
        ...
        */
        class NXOPENCPP_VSAEXPORT  SimulationPreferencesBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the property represents Animation Delay. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetAnimationDelay
            (
                int animateDelay /** animatedelay */ 
            );
            ...
            /**Returns  the property represents  Sigma Range. 
             ...
             <br> License requirements : None */
            public: int SigmaRange
            (
            );
            /**Sets  the property represents  Sigma Range. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetSigmaRange
            (
                int sigmaRange /** sigmarange */ 
            );
            ...
            /**Returns  the property represents AcceptInterferenceBuild. 
             ...
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool AcceptInterferenceBuild
            (
            );
            /**Sets  the property represents AcceptInterferenceBuild. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetAcceptInterferenceBuild
            (
                bool acceptInterferenceBuild /** acceptinterferencebuild */ 
            );
            /**Returns  the property represents AlternativeToleranceValues. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool AlternativeToleranceValues
            (
            );
            /**Sets  the property represents AlternativeToleranceValues. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetAlternativeToleranceValues
            (
                bool alternativeToleranceValues /** alternativetolerancevalues */ 
            );
            /**Returns  the property represents InheritFaceNames. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool InheritFaceNames
            (
            );
            /**Sets  the property represents InheritFaceNames. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetInheritFaceNames
            (
                bool inheritFaceNames /** inheritfacenames */ 
            );
            /**Returns  the property represents runExtremeSimulation. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool RunExtremeSimulation
            (
            );
            /**Sets  the property represents runExtremeSimulation. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetRunExtremeSimulation
            (
                bool runExtremeSimulation /** runextremesimulation */ 
            );
            /**Returns  the property represents UseVariationTails. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool UseVariationTails
            (
            );
            /**Sets  the property represents UseVariationTails. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetUseVariationTails
            (
                bool useVariationTails /** usevariationtails */ 
            );
            /**Returns  the property represents  TolSigmaRange. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: int TolSigmaRange
            (
            );
            /**Sets  the property represents  TolSigmaRange. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetTolSigmaRange
            (
                int tolSigmaRange /** tolsigmarange */ 
            );
        };
    }
}
