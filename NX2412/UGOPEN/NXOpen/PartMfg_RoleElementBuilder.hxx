...
namespace NXOpen
{
    ...
    namespace PartMfg
    {
        ...
        */
        class PARTMFGOPENCPPEXPORT  RoleElementBuilder : public NXOpen::PartMfg::BaseBuilder, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            /**Sets  the role teamcenter occurrence type 
            ...
            /**Returns  the role teamcenter occurrence type 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
