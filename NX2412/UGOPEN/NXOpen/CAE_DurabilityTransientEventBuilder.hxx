    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurabilityTransientEventBuilder : public NXOpen::CAE::DurabilityEventBuilder
        {
            ...
            /** Gets the nth selected subcase index.
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: int GetNthSubcase
            (
                int index /** index */ 
            );
            /** Sets the nth selected subcase index. Ideally this function is used in a for loop starting from zero.
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_adv_durability ("NX Advanced Durability") */
            public: void SetNthSubcase
            (
                int index /** index */ ,
                int nthSubcase /** nthsubcase */ 
            );
