        ...
        */
        class NXOPENCPP_WELDEXPORT  DatumSurfaceBuilder : public NXOpen::Weld::DatumCommonBuilder
        {
            ...
            /**Returns  the inner length of the racetrack (extended hollow cylinder) solid created.   
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: double CustomHollowLength
            (
            );
            /**Sets  the inner length of the racetrack (extended hollow cylinder) solid created.   
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : tooling_locators ("Tooling Locators") */
            public: void SetCustomHollowLength
            (
                double customHollowLength /** customhollowlength */ 
            );
            /**Returns  the inner radius of the hollow cylinder solid created.   
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: double CustomHollowRadius
            (
            );
            /**Sets  the inner radius of the hollow cylinder solid created.   
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : tooling_locators ("Tooling Locators") */
            public: void SetCustomHollowRadius
            (
                double customHollowRadius /** customhollowradius */ 
            );
        };
    }
}
