    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  WeldImportBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to create Feature Group features to collect Weld Point features that have the same connected part combinations. Connected parts A-B-C and C-B-A will be in the same group. 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: bool CreateFeatureGroups
            (
            );
            /**Sets  the option to create Feature Group features to collect Weld Point features that have the same connected part combinations. Connected parts A-B-C and C-B-A will be in the same group. 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: void SetCreateFeatureGroups
            (
                bool createFeatureGroupos /** createfeaturegroupos */ 
            );
        };
    }
}
