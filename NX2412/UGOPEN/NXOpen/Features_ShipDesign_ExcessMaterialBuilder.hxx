        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ExcessMaterialBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**Returns the excess material label that specifies the manufacturing step for this feature.
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString ExcessType
                (
                );
                /**Sets the excess material label that specifies the manufacturing step for this feature.
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetExcessType
                (
                    const NXString & excessType /** excesstype */ 
                );
                /**Sets the excess material label that specifies the manufacturing step for this feature.
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                void SetExcessType
                (
                    const char * excessType /** excesstype */ 
                );
            };
        }
    }
