        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PlateChamferBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**Returns  the reference internal body 
                 <br>  Created in NX2312.8000.0.  <br>  
                 <br> License requirements : None */
                public: bool ReferenceInternalBody
                (
                );
                /**Sets  the reference internal body 
                 <br>  Created in NX2312.8000.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: void SetReferenceInternalBody
                (
                    bool referenceInternalBody /** referenceinternalbody */ 
                );
            };
        }
    }
