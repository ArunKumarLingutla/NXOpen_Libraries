...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace AeroStructures
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  MarginSolution : public NXOpen::CAE::AeroStructures::BaseSolution, public virtual NXOpen::Report::IReportCollection
            {
                ...
                /** Creates a @link NXOpen::CAE::AeroStructures::MarginResultTableDataProvider NXOpen::CAE::AeroStructures::MarginResultTableDataProvider@endlink  
                 ...
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") OR sc_aero_environment ("Simcenter AeroStructures Environment") */
                ...
                */
                public: NXOpen::CAE::AeroStructures::GraphicalReportCollection *GraphicalReportCollection();
            };
        }
    }
}
