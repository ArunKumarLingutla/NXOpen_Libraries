...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        AlignBreakPoints </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        OppositeSense </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        OppositeSide </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TransformCurvesContinuity </term> <description> 
         
        G0 </description> </item> 

        <item><term> 
         
        TransformCurvesMagnitude.Value </term> <description> 
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  FtmTransformCurvesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the magnitude controlled by continuity for the transformation curves 
             ...
             <br> License requirements : None */
            public: NXOpen::Expression * TransformCurvesMagnitude
            (
            );
