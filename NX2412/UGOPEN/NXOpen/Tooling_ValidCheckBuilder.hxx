...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AnalyMode </term> <description> 
         
        SolidBased </description> </item> 

        <item><term> 
         
        BlankBody </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        CheckType </term> <description> 
         
        TrueBody </description> </item> 

        <item><term> 
         
        ClrZone </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LifterProcessCheck </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ObjSelectType </term> <description> 
         
        Component </description> </item> 

        <item><term> 
         
        ScrewCheck </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SubAssembly </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ValidCheckBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the lifter process deisgn check 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: bool LifterProcessCheck
            (
            );
            /**Sets  the lifter process deisgn check 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetLifterProcessCheck
            (
                bool lifterProcessCheck /** Indicates if lifter process checking algorithm is used while doing checking */
            );
        };
    }
}
