    ...
    namespace Weld
    {
        ...
        */
        class NXOPENCPP_WELDEXPORT  DatumPinBuilder : public NXOpen::Weld::DatumCommonBuilder
        {
            ...
            /**Sets  the punch direction vector object. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : tooling_locators ("Tooling Locators") */
            ...
            /**Returns  the flag that indicates if a datum vector should be created for the punch direction. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreatePunchVector
            (
            );
            /**Sets  the flag that indicates if a datum vector should be created for the punch direction. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : tooling_locators ("Tooling Locators") */
            public: void SetCreatePunchVector
            (
                bool createPunchVector /** createpunchvector */ 
            );
            /**Returns  the length of the punch direction vector created. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: double PunchDirectionLength
            (
            );
            /**Sets  the length of the punch direction vector created. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : tooling_locators ("Tooling Locators") */
            public: void SetPunchDirectionLength
            (
                double punchDirectionLength /** punchdirectionlength */ 
            );
        };
    }
}
