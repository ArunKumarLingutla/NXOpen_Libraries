...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  XformCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        public: enum AxisAndPlaneType
        {
            AxisAndPlaneTypeXaxisXyPlane/** Q point is X-axis point and R point is XY-plane point */,
            AxisAndPlaneTypeXaxisXzPlane/** Q point is X-axis point and R point is XZ-plane point */,
            AxisAndPlaneTypeYaxisXyPlane/** Q point is Y-axis point and R point is XY-plane point */,
            AxisAndPlaneTypeYaxisYzPlane/** Q point is Y-axis point and R point is YZ-plane point */,
            AxisAndPlaneTypeZaxisXzPlane/** Q point is Z-axis point and R point is XZ-plane point */,
            AxisAndPlaneTypeZaxisYzPlane/** Q point is Z-axis point and R point is YZ-plane point */
        };

        /** Rotation sequences for Euler/Tait-Bryan Angles */
        public: enum RotationSequence
        {
            RotationSequenceZXZ/** Rotation along Z-axis followed by new X-axis followed by new Z-axis */,
            RotationSequenceXYX/** Rotation along X-axis followed by new Y-axis followed by new X-axis */,
            RotationSequenceYZY/** Rotation along Y-axis followed by new Z-axis followed by new Y-axis */,
            RotationSequenceZYZ/** Rotation along Z-axis followed by new Y-axis followed by new Z-axis */,
            RotationSequenceXZX/** Rotation along X-axis followed by new Z-axis followed by new X-axis */,
            RotationSequenceYXY/** Rotation along Y-axis followed by new X-axis followed by new Y-axis */,
            RotationSequenceXYZ/** Rotation along X-axis followed by new Y-axis followed by new Z-axis */,
            RotationSequenceYZX/** Rotation along Y-axis followed by new Z-axis followed by new X-axis */,
            RotationSequenceZXY/** Rotation along Z-axis followed by new X-axis followed by new Y-axis */,
            RotationSequenceXZY/** Rotation along X-axis followed by new Z-axis followed by new Y-axis */,
            RotationSequenceZYX/** Rotation along Z-axis followed by new Y-axis followed by new X-axis */,
            RotationSequenceYXZ/** Rotation along Y-axis followed by new X-axis followed by new Z-axis */
        };
        ...
        {
        public:
            using value_type = NXOpen::Xform *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::Xform **;
            using reference = NXOpen::Xform *&;
        ...
        /** Creates an Xform by three planes.  
            Defines an xform based on the input of three planes.  These can be either planar faces, datum planes
            or plane objects. The X-Axis is normal of the first plane, the Y-Axis is normal of the second plane, 
            the origin is the intersection of the three plane.  The plane can either be a planar  
            @link NXOpen::Face NXOpen::Face@endlink , a @link NXOpen::DatumPlane NXOpen::DatumPlane@endlink  or a
            a @link NXOpen::Plane NXOpen::Plane@endlink . If the xform is to be used to create a CSYS, then the planes 
            should be @link NXOpen::Plane NXOpen::Plane@endlink  objects. 
             @return   
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXform
        (
            NXOpen::IPlaneForXformByThreePlanes * plane1 /** plane1 */ ,
            NXOpen::IPlaneForXformByThreePlanes * plane2 /** plane2 */ ,
            NXOpen::IPlaneForXformByThreePlanes * plane3 /** plane3 */ ,
            NXOpen::SmartObject::UpdateOption updateOption /** update option */ ,
            double scale /** scale */ 
        );
        ...
        (
            NXOpen::CoordinateSystem * csys /** Existing coordinate system */,
            NXOpen::Offset * point0 /** Deprecated in NX1872.
                                                                         Suggested input is NULL.
                                                                     */,
            NXOpen::Offset * point1 /** Translation from input Coordinate System origin to output Xform origin */,
            NXOpen::Scalar * rotationScalarX /** Scalar of X rotation */,
            NXOpen::Scalar * rotationScalarY /** Scalar of Y rotation */,
            NXOpen::Scalar * rotationScalarZ /** Scalar of Z rotation */,
            int rotationOption /** Determine the sequence of applying rotation and translation.
        ...
        /** Creates an Xform based on two vectors. The X and Y Axes are vectors, with the
        ...
        X-Axis points in an arbitrary orientation and not towards the selected point. 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXform
        (
        ...
        /** 
            Creates an Xform in the context of the given @link NXOpen::Assemblies::Component NXOpen::Assemblies::Component@endlink .
        ...
        /**
            Creates an Xform from the Xform of a selected curve, plane, or drafting object.  If the
            selected curve is non-planar an error will be thrown.  If the curve is an arc, ellipse, hyperbola,
            parabola, or circle, the origin will be at the respective curve's center.  If the object
            is a planar face or a datum plane, the Z-axis is the normal vector of the plane.
             @return  
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXform
        ...
        /** Creates a Motion Xform based on two CSYS.
                 ...
                 <br>  CsysToCsys is a reposition between two coordinate systems such that the objects are moved until the first CSYS aligns with the second CSYS.  <br> 
                 <br>  [Motion Xform] = Invert( [Xform1] ) &#xD7; [Xform2]  <br> 
                 <br>  [Xform1] is the matrix of the first CSYS. [Xform2] is the matrix of the second CSYS. [Motion Xform] is the matrix of result Motion Xform.  <br> 
                 <br>  Note: the matrix is column oriented in NX. That is, Xform matrices look like:  <br> 
                 <br>  [ Xx Yx Zx 0  <br> 
                 <br>  &#xA0; Xy Yy Zy 0  <br> 
                 <br>  &#xA0; Xz Yz Zz 0  <br> 
                 <br>  &#xA0; X&#xA0; Y&#xA0; Z&#xA0; 1 ]  <br> 
                 <br>  (Xx, Xy, Xz) is X axis direction. (Yx, Yy, Yz) is Y axis direction. (Zx, Zy, Zz) is Z axis direction. (X, Y, Z) is origin position.  <br> 
                 <br>  You can get new position of moved object by following formula:  <br> 
                 <br>  [x_new, y_new, z_new, 1] = [x_old, z_old, y_old, 1] &#xD7; [Motion Xform]  <br> 
        ...
        /** Creates an Xform based on a planar face or datum plane, a Y-axis vector direction, and a point.
         ...
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXformByPlaneYDirPoint
        (
            NXOpen::DisplayableObject * plane /** planar face or datum plane */,
            NXOpen::Direction * yDirection /** y vector direction */,
            NXOpen::Point * point /** point */,
            NXOpen::SmartObject::UpdateOption updateOption /** Update option of smart object */,
            double scale /** Scale factor */,
            bool flipYDirection /** flag to flip the Y direction of CSYS */,
            bool flipZDirection /** flag to flip the Z direction of CSYS */
        );
        /** 
         ...
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXformExtract
        (
            NXOpen::SmartObject::UpdateOption updateOption /** Update option of smart object */,
            NXOpen::Xform * xform1 /** Extracted Xform */,
            NXOpen::Xform * xform2 /** Optional Xform, identity is used if NULL is input */
        );
        /** Creates a Motion Xform based on PQR
                P=Origin, Q=Q-axis(X,Y,Z) R=R-plane((XY,YZ),(XY,YZ),(ZX,YZ))
             @return  Created Xform 
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXformPqr
        (
            NXOpen::SmartObject::UpdateOption updateOption /** Update option of smart object */,
            NXOpen::Point * origin /** Origin point */,
            NXOpen::Point * pPoint /** P point */,
            NXOpen::Point * qPoint /** Q point*/,
            double scale /** Scale factor  */,
            NXOpen::XformCollection::AxisAndPlaneType axisAndPlaneType /** Axis and plane type */
        );
        /** Creates a Motion Xform based on the Euler/Tait-Bryan Angles.
             @return  Created Xform 
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Xform * CreateXformEulerTaitBryanAngles
        (
            NXOpen::CoordinateSystem * csys /** Existing coordinate system */,
            NXOpen::Point * originPoint /** Start point */,
            NXOpen::XformCollection::RotationSequence sequence /** Sequence of rotations */,
            NXOpen::Scalar * rotationScalarX /** Scalar of X rotation */,
            NXOpen::Scalar * rotationScalarY /** Scalar of Y rotation */,
            NXOpen::Scalar * rotationScalarZ /** Scalar of Z rotation */,
            double scale /** Scalar factor */,
            NXOpen::SmartObject::UpdateOption updateOption /** Update option of smart object  */
        );
