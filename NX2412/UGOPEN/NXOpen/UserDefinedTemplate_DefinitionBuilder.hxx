        ...
        */
        class NXOPENCPP_USERDEFINEDTEMPLATEEXPORT  DefinitionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the creating deformation of the User Defined Template Definition 
             ...
             <br> License requirements : usr_defined_features ("USER DEFINED FEATURES") OR assemblies ("ASSEMBLIES MODULE") */
            public: bool CreatingDeformation
            (
            );
            /**Sets  the creating deformation of the User Defined Template Definition 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : usr_defined_features ("USER DEFINED FEATURES") OR assemblies ("ASSEMBLIES MODULE") */
            public: void SetCreatingDeformation
            (
                bool isCreatingDeformation /** iscreatingdeformation */ 
            );
        };
    }
}
