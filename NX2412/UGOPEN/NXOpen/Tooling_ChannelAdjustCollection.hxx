...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Creates a ChannelAdjust Collection  <br> To obtain an instance of this class, refer to @link NXOpen::Tooling::ToolingManager  NXOpen::Tooling::ToolingManager @endlink  <br> 
         <br>  Created in NX7.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  ChannelAdjustCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Tooling::ChannelAdjustBuilder *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Tooling::ChannelAdjustBuilder **;
                using reference = NXOpen::Tooling::ChannelAdjustBuilder *&;
            ...
            /** Creates a Tooling.ChannelAdjustBuilder 
