        ...
        namespace ResponseSimulation
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  StrainGageCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::ResponseSimulation::StrainGage *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::ResponseSimulation::StrainGage **;
                    using reference = NXOpen::CAE::ResponseSimulation::StrainGage *&;
