        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  RequirementCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            public: enum SourceTypeOptions
            {
                ...
                SourceTypeOptionsMeasurableAttribute/** measurable attribute */ 
            };
            ...
            {
            public:
                using value_type = NXOpen::Validate::Requirement *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Validate::Requirement **;
                using reference = NXOpen::Validate::Requirement *&;
