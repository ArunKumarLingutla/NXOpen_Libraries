    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PdmCopyOrEditOperationObserver : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::PDM::PdmCopyOrEditOperationCallbackData *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::PDM::PdmCopyOrEditOperationCallbackData **;
                using reference = NXOpen::PDM::PdmCopyOrEditOperationCallbackData *&;
