        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  MarkAsTemplateBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the item type of the part.
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::Drawings::MarkAsTemplateBuilder::ItemTypeString NXOpen::Drawings::MarkAsTemplateBuilder::ItemTypeString@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Drawings::MarkAsTemplateBuilder::ItemTypeString instead.") NXOpen::Drawings::MarkAsTemplateBuilder::ItemTypeEnum ItemType
            (
            );
            /**Sets  the item type of the part.
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::Drawing::MarkAsTemplateBuilder::SetItemTypeString NXOpen::Drawing::MarkAsTemplateBuilder::SetItemTypeString@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Drawing::MarkAsTemplateBuilder::SetItemTypeString instead.") void SetItemType
            (
            ...
            /**Returns  the item type string of the part.
             ...
             <br> License requirements : None */
            public: NXString ItemTypeString
            (
            );
            /**Sets  the item type string of the part.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetItemTypeString
            (
