...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        CalPageSaveFaceResults </term> <description> 
        ...
        RegionSelectUndefinedFaces </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MWMoldedPartValidationBuilder : public NXOpen::Builder
        {
            ...
            /** Facet resolution for facet analysis */
            public: enum CalPageFacetAnalysisResolution
            {
                CalPageFacetAnalysisResolutionStandard/** Standard resolution   */,
                CalPageFacetAnalysisResolutionMedium/** Medium resolution     */,
                CalPageFacetAnalysisResolutionFine/** Fine resolution       */,
                CalPageFacetAnalysisResolutionExtraFine/** Extra fine resolution */,
                CalPageFacetAnalysisResolutionUltraFine/** Ultra fine resolution */
            };
            ...
            /**Returns  the option to perform facet analysis on the Calculate Tab Page 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: bool CalPageDoFacetAnalysis
            (
            );
            /**Sets  the option to perform facet analysis on the Calculate Tab Page 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetCalPageDoFacetAnalysis
            (
                bool calPageDoFacetAnalysis /** calpagedofacetanalysis */ 
            );
            /**Returns  the option to save face results 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CalPageSaveFaceResults
            (
            );
            /**Sets  the option to save face results 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCalPageSaveFaceResults
            (
                bool calPageSaveFaceResults /** calpagesavefaceresults */ 
            );
            /**Returns  the facet resolution for facet analysis 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: NXOpen::Tooling::MWMoldedPartValidationBuilder::CalPageFacetAnalysisResolution CalPageFacetResolution
            (
            );
            /**Sets  the facet resolution for facet analysis 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetCalPageFacetResolution
            (
                NXOpen::Tooling::MWMoldedPartValidationBuilder::CalPageFacetAnalysisResolution calPageFacetResolution /** calpagefacetresolution */ 
            );
            /**Returns  the option to show facet analysis results on the Face Tab Page 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: bool FacePageShowFacetAnalysisResults
            (
            );
            /**Sets  the option to show facet analysis results on the Face Tab Page 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetFacePageShowFacetAnalysisResults
            (
                bool facePageShowFacetAnalysisResults /** facepageshowfacetanalysisresults */ 
            );
            ...
            /**Returns  the region faces to be assigned the the cavity or core region 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: NXOpen::ScCollector * AssignToRegionFaces
            (
            );
            ...
            /**Returns  the option for including or removing the undefined faces in the selection on the Region Tab page. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: bool RegionSelectUndefinedFaces
            (
            );
            /**Sets  the option for including or removing the undefined faces in the selection on the Region Tab page. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetRegionSelectUndefinedFaces
            (
                bool regionSelectUndefinedFaces /** regionselectundefinedfaces */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void TurnOnOrOffMPVDraftAnalysisConvergentBodies
            (
                bool onOrOff /** Turn on or off */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void TurnOnOrOffMPVUndercutAnalysisConvergentBodies
            (
                bool onOrOff /** Turn on or off */
            );
            ...
            /// \endcond 
            /** Set the method used in the Check Regions command 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetCheckRegionsMethod
            (
                int method /** 0: new facet-based method; 1: legacy VHL-based method. */
            );
            /** Update the origin and vector for the draw direction 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void UpdateDrawDirection
            (
                const NXOpen::Vector3d & drawDirection /** I - Draw direction */,
                const NXOpen::Point3d & origin /** I - Vector origin */
            );
            /** Retrieve and update Face Draft and Regions Analysis results on dialog 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void RetrieveAndUpdateMPVFaceDraftAndRegionsAnalysisResults
            (
            );
            /** Set UDO properties or face attributes for the Face Region type used in the Check Regions command 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR ug_prod_des_advisor ("Product Design Advisor") OR prog_die_wizard ("UG/Progressive Die Wizard") OR die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") OR nx_electrode_wizard ("NX Electrode Wizard") */
            public: void SetCheckRegionsFaceRegionPropsType
            (
                int faceRegionPropsType /** 0: UDO properties and face attributes; 1: Face Attributes only (legacy). */
            );
        };
    }
}
