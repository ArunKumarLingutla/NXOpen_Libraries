    ...
    namespace Drawings
    {
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  DrawingSheetCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Drawings::DrawingSheet *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Drawings::DrawingSheet **;
                using reference = NXOpen::Drawings::DrawingSheet *&;
            ...
            /** Inserts a sheet into a part.  @return   
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::Drawings::DraftingDrawingSheetCollection::InsertSheet NXOpen::Drawings::DraftingDrawingSheetCollection::InsertSheet@endlink  instead. <br>  

             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Drawings::DraftingDrawingSheetCollection::InsertSheet instead.") NXOpen::Drawings::DrawingSheet * InsertSheet
            (
            ...
            /** Finds the @link  NXOpen::Drawings::DrawingSheet   NXOpen::Drawings::DrawingSheet @endlink  with the given identifier as recorded in a journal. 
             ...
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::Drawings::DraftingDrawingSheetCollection::FindObject NXOpen::Drawings::DraftingDrawingSheetCollection::FindObject@endlink  instead. <br>  

             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Drawings::DraftingDrawingSheetCollection::FindObject instead.") NXOpen::Drawings::DrawingSheet * FindObject
            (
            ...
            /** Create a drawing Sheet builder   @return  the drawing sheet Builder with this identifier 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::Drawings::DraftingDrawingSheetCollection::CreateDraftingDrawingSheetBuilder NXOpen::Drawings::DraftingDrawingSheetCollection::CreateDraftingDrawingSheetBuilder@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Drawings::DraftingDrawingSheetCollection::CreateDraftingDrawingSheetBuilder instead.") NXOpen::Drawings::DrawingSheetBuilder * DrawingSheetBuilder
            (
            ...
            /** Paste drawing sheets 
             ...
             <br> License requirements : drafting ("DRAFTING") */
            public: void PasteDrawingSheets
            (
                const std::vector<NXOpen::Drawings::DrawingSheet *> & dwgSheets /**old dwg sheets */,
                std::vector<NXOpen::Drawings::DrawingSheet *> & newPastedDwgSheets /**new dwgs sheets*/
            );
