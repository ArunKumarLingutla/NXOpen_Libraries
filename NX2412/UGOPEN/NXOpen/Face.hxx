...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Face : public NXOpen::DisplayableObject, public virtual NXOpen::ISurface, public virtual NXOpen::IReferenceAxis, public virtual NXOpen::IProfile, public virtual NXOpen::IOrientation, public virtual NXOpen::IParameterizedSurface, public virtual NXOpen::IPlaneForXformByThreePlanes
    {
        /** Solid face type. */
        ...
        public: enum ChamferType
        {
            ...
            ChamferTypeUndefined/** Not a chamfer or chamfer type undefined */
        };

        /** Blend virtual curve type */
        public: enum VirtualBlendCurveType
        {
            VirtualBlendCurveTypeLine/** Line curve type */,
            VirtualBlendCurveTypeCircle/** Circle curve type */,
            VirtualBlendCurveTypeArc/** Arc curve type */,
            VirtualBlendCurveTypeOther/** Other curve type */
        };
        ...
        /**Returns  the Parasolid type of the face 
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : nx_atlas_testlab_api ("Testlab worker - STS") OR solid_modeling ("SOLIDS MODELING") */
        ...
        /** Get Hole Data if the face is one of a face from a hole. 
         ...
         <br> License requirements : None */
        public: NXOpen::ResizeHoleData * GetHoleData
        (
            bool* isHoleFace /** isholeface */ 
        );
        /** The virtual blend curve data will be gotten for the input blend face. 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: void GetVirtualBlendCurveData
        (
            NXOpen::Face::VirtualBlendCurveType* curveType /** the virtual curve type on a blend face. */,
            std::vector<double> & curveValue /** Virtual blend curve values.
                                         For Line, numCurveValue is 6, there are 6 coordinate values of two end points.
                                         For Circle, numCurveValue is 7, there are 3 coordinate values of the center point,
                                                               3 coordinate values of axis and the radius value.
                                         For Arc, numCurveValue is 13, there are 3 coordinate values of the center point,
                                                  3 coordinate values of axis, the radius value and 6 coordinate values of two end points.
                                         For Other curves, numCurveValue is 6, there are 6 coordinate values of two end points. */
        );
    };
}
