    ...
    */
    class NXOPENCPPEXPORT  ObjectTypeSelector : public NXOpen::Builder
    {
        ...
        /**Returns  the convergent bodies - This should be set to true if convergent bodies are desired in the output file 
         <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::ObjectTypeSelector::Solids NXOpen::ObjectTypeSelector::Solids@endlink  instead. <br>  

         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::ObjectTypeSelector::Solids instead.") bool ConvergentBodies
        (
        );
        /**Sets  the convergent bodies - This should be set to true if convergent bodies are desired in the output file 
         <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::ObjectTypeSelector::SetSetSolids NXOpen::ObjectTypeSelector::SetSetSolids@endlink  instead. <br>  

         <br>  Created in NX12.0.2.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::ObjectTypeSelector::SetSetSolids instead.") void SetConvergentBodies
        (
        ...
        /**Returns  the kinematic data - This should be set to true if kinematics data are desired in the output file
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: bool Kinematic
        (
        );
        /**Sets  the kinematic data - This should be set to true if kinematics data are desired in the output file
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: void SetKinematic
        (
            bool kinematicData /** kinematicdata */ 
        );
        /**Returns  the attribute data - This should be set to true if attribute data are desired in the output file
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: bool Attributes
        (
        );
        /**Sets  the attribute data - This should be set to true if attribute data are desired in the output file
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: void SetAttributes
        (
            bool attributeData /** attributedata */ 
        );
        /**Returns  the Tessellation - This should be set to true if Tessellation information is to be written to STEP file
         <br>  @deprecated Deprecated in NX12.0.2.  Use @link NXOpen::StepCreator::ExportSolidsAndSurfacesAs NXOpen::StepCreator::ExportSolidsAndSurfacesAs@endlink  instead. <br>  

         <br>  Created in NX11.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX12.0.2.  Use NXOpen::StepCreator::ExportSolidsAndSurfacesAs instead.") bool Tessellation
        (
        );
        /**Sets  the Tessellation - This should be set to true if Tessellation information is to be written to STEP file
         <br>  @deprecated Deprecated in NX12.0.2.  Use @link NXOpen::StepCreator::SetSetExportSolidsAndSurfacesAs NXOpen::StepCreator::SetSetExportSolidsAndSurfacesAs@endlink  instead. <br>  

         <br>  Created in NX11.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX12.0.2.  Use NXOpen::StepCreator::SetSetExportSolidsAndSurfacesAs instead.") void SetTessellation
        (
