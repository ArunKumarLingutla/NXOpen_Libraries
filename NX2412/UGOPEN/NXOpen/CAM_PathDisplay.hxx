        ...
        */
        class NXOPENCPP_CAMEXPORT  PathDisplay
        {
            ...
            public: enum ColorByType
            {
                ...
                ColorByTypeOperationSelectionState/** operation selection state */ 
            };

            /** Choices for the tool display types  */
            public: enum ToolDisplayType
            {
                ToolDisplayTypePoint/** point */ ,
                ToolDisplayTypeAxis/** axis */ ,
                ToolDisplayTypeSolid/** solid */ ,
                ToolDisplayTypeSolidWithHolder/** solid with holder */ ,
                ToolDisplayTypeAssembly/** assembly */ 
            };

            /** Choices for the IPW resolution */
            public: enum IpwResolutionType
            {
                IpwResolutionTypeCoarse/** coarse */ ,
                IpwResolutionTypeMedium/** medium */ ,
                IpwResolutionTypeFine/** fine */ 
            };

            /** Choices for tool path display options */
            public: enum JaCamPathdisplayOption
            {
                JaCamPathdisplayOptionAll/** all */ ,
                JaCamPathdisplayOptionLevel/** level */ ,
                JaCamPathdisplayOptionFromStart/** from start */ ,
                JaCamPathdisplayOptionNextNMotions/** next nmotions */ ,
                JaCamPathdisplayOptionPlusMinusNMotions/** plus minus nmotions */ 
            };
            ...
            /**Returns  the indicator to display contact point path. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool ShowContactPoints
            (
            );
            /**Sets  the indicator to display contact point path. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetShowContactPoints
            (
                bool isOn /** ison */ 
            );
            /** Show tool path 
            ...
            (
                NXOpen::CAM::PathDisplay::IpwResolutionType resolution /** resolution */ 
            );
            ...
            (
                NXOpen::CAM::PathDisplay::ToolDisplayType type /** type */ 
            );
            /** Set display tool in machine mode 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDisplayToolInMachine
            (
                bool isToolDisplayedInMachine /** istooldisplayedinmachine */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetToolAxisTraceScale
            (
                int scaleFactor /** scalefactor */ 
            );

            /// \endcond 
            /**Returns  the indicator to display tool path. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayToolPath
            (
            );
            /**Sets  the indicator to display tool path. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetDisplayToolPath
            (
                bool isOn /** ison */ 
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::PathDisplay::JaCamPathdisplayOption Option
            (
            );
            ...
            (
                NXOpen::CAM::PathDisplay::JaCamPathdisplayOption displayOption /** displayoption */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void SetNumberOfMotions
            (
                int numMotions /** nummotions */ 
            );
