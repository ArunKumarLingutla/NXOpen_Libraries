...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        PitchLaw.Function </term> <description> 
         
        ft </description> </item> 

        <item><term> 
         
        PitchLaw.LawType </term> <description> 
         
        Constant </description> </item> 

        <item><term> 
         
        PitchLaw.Parameter </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  HelixBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the number of turns 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::Features::HelixBuilder::Turns NXOpen::Features::HelixBuilder::Turns@endlink  <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Features::HelixBuilder::Turns") NXString NumberOfTurns
            (
            );
            /**Sets  the number of turns 
             ...
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::Features::HelixBuilder::Turns") void SetNumberOfTurns
            (
            ...
            /**Returns  the number of turns 
             ...
             <br> License requirements : None */
            public: NXOpen::Expression * Turns
            (
            );
