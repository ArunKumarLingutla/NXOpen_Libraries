        ...
        class NXOPENCPP_CAMEXPORT  SimulationOptionsBuilder : public NXOpen::Builder
        {
            ...
            */
            ...
            /** The tool shape for checking options 
             <br>  @deprecated Deprecated in NX12.0.1.  It is not supported anymore. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX12.0.1.  It is not supported anymore.") ToolShapeColl
            {
            ...
            /** The tool shape for material removal options 
             <br>  @deprecated Deprecated in NX12.0.1.  It is not supported anymore. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX12.0.1.  It is not supported anymore.") ToolShapeMR
            {
            ...
            /** The tool shape for checking and material removal options 
             <br>  @deprecated Deprecated in NX2412.0.0.  Use the Session Customer Default Tool Shape for IPW instead. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX2412.0.0.  Use the Session Customer Default Tool Shape for IPW instead.") ToolShapeType
            {
            ...
            /**Returns  an option which specifies whether automatic feature refinement is applied to the IPW when simulation stops. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool IpwFeatureRefinement
            (
            );
            /**Sets  an option which specifies whether automatic feature refinement is applied to the IPW when simulation stops. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void SetIpwFeatureRefinement
            (
            ...
            /**Returns  the tool shape for collision 
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  It is not supported anymore.") NXOpen::CAM::SimulationOptionsBuilder::ToolShapeColl Collshape
            (
            );
            ...
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  It is not supported anymore.") void SetCollshape
            (
            ...
            /**Returns  the tool shape for material removal 
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  It is not supported anymore.") NXOpen::CAM::SimulationOptionsBuilder::ToolShapeMR Mrshape
            (
            );
            /**Sets  the tool shape for material removal 
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  It is not supported anymore.") void SetMrshape
            (
            ...
            /**Returns  the tool shape for collision checking and material removal 
             ...
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use the Session Customer Default Tool Shape for IPW instead.") NXOpen::CAM::SimulationOptionsBuilder::ToolShapeType ToolShape
            (
            );
            /**Sets  the tool shape for collision checking and material removal 
             ...
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use the Session Customer Default Tool Shape for IPW instead.") void SetToolShape
            (
            ...
            /**Returns  the gouge tolerance 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: double GougeTolerance
            (
            );
            /**Sets  the gouge tolerance 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: void SetGougeTolerance
            (
                double gougeTolerance /** gougetolerance */ 
            );
        };
    }
}
