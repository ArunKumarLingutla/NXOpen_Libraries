    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModelAndLoadPreProcessOperations : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::ModelAndLoadPreProcessOperation *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::ModelAndLoadPreProcessOperation **;
                using reference = NXOpen::CAE::ModelAndLoadPreProcessOperation *&;
