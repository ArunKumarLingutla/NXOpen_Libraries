...
namespace NXOpen
{
    ...
    namespace Routing
    {
        class _SelectPortListBuilder;
        class SelectPortListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  SelectPortList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectPortListImpl * m_selectportlist_impl;
            private: friend class  _SelectPortListBuilder;
            protected: SelectPortList();
            public: ~SelectPortList();
            ...
            public: bool Add
            (
                NXOpen::Routing::Port * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Routing::Port *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Routing::Port * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Routing::Port * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Routing::Port * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Routing::Port * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Routing::Port *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Routing::Port * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Routing::Port *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Routing::Port *> GetArray
            (
            );
