    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  StyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the sheet metal label settings builder 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::SheetMetalPMISettingsBuilder * SheetMetalPMISettingsBuilder
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::ProductGridStyleBuilder * ProductGridStyle
            (
            );

            /// \endcond 
            /**Returns  the Composites label settings builder 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::CompositesSettingsBuilder * CompositesSettingsBuilder
            (
            );
