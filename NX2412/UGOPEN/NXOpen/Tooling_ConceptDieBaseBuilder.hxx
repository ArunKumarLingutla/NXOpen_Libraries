...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        UseConceptDieBase </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ConceptDieBaseBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the use concept die base option 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool UseConceptDieBase
            (
            );
            /**Sets  the use concept die base option 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUseConceptDieBase
            (
                bool useConceptDieBase /** useconceptdiebase */ 
            );
        };
    }
}
