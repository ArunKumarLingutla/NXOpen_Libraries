        ...
        */
        class NXOPENUICPPEXPORT  SelectObject : public NXOpen::BlockStyler::UIBlock
        {
            ...
            /**
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void AddFilterMember
            (
                NXOpen::Select::FilterMember member /** Filter Member to add */
            );
            /**
                     @brief 
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void AddFilterMembers
            (
                const std::vector<NXOpen::Select::FilterMember> & members /** Filter Members to add */
            );
            /**
                     @brief 
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void RemoveFilterMember
            (
                NXOpen::Select::FilterMember member /** Filter Member to remove */
            );
            /**
                     @brief 
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void RemoveFilterMembers
            (
                const std::vector<NXOpen::Select::FilterMember> & members /** Filter Members to remove */
            );
