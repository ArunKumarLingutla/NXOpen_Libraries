        ...
        */
        class AMEOPENCPPEXPORT  EplanSettingsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the generation path 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString ProjectTargetPath
            (
            );
            /**Sets  the generation path 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetProjectTargetPath
            (
                const NXString & projectTargetPath /** projecttargetpath */ 
            );
            /**Sets  the generation path 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            void SetProjectTargetPath
            (
                const char * projectTargetPath /** projecttargetpath */ 
            );
