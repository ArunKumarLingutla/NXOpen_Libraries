        ...
        */
        class NXOPENCPP_PDMEXPORT  PartOperationCreateBuilder : public NXOpen::PDM::PartOperationBuilder
        {
            ...
            /** Creates @link PDM::LogicalObject PDM::LogicalObject@endlink  using the seed part provided. The part with provided name must exist in Teamcenter.
             ...
             <br> License requirements : None */
            public: void CreateLogicalObjectsUsingSeedPart
            (
                const NXString & seedPartName /** seedpartname */ ,
                int numOfPartsToCreate /** numofpartstocreate */ ,
                std::vector<NXOpen::PDM::LogicalObject *> & logicalObjects /** logicalobjects */ 
            );
            /** Creates @link PDM::LogicalObject PDM::LogicalObject@endlink  using the seed part provided. The part with provided name must exist in Teamcenter.
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            void CreateLogicalObjectsUsingSeedPart
            (
                const char * seedPartName /** seedpartname */ ,
                int numOfPartsToCreate /** numofpartstocreate */ ,
                std::vector<NXOpen::PDM::LogicalObject *> & logicalObjects /** logicalobjects */ 
            );
            /** Get Result Part Specifications.
             ...
             <br> License requirements : None */
            public: void GetResultPartSpecs
            (
                std::vector<NXString> & resultPartsSpecs /** resultpartsspecs */ 
            );
            ...
            public: NXOpen::PartCollection::DesignWorksetIntentType DesignWorksetIntent
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_designworkset (" Design Workset") */
            public: void SetDesignWorksetIntent
            (
                NXOpen::PartCollection::DesignWorksetIntentType designWorksetIntent /** designworksetintent */ 
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool UnmanagedPartsSaveOperation
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUnmanagedPartsSaveOperation
            (
                bool isUnmanagedSave /** isunmanagedsave */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PDM::SmartSaveContext * GetSmartSaveContext
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetSmartSaveContext
            (
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: bool MaintainFolderStructure
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void SetMaintainFolderStructure
            (
                bool maintainFolderStructure /** maintainfolderstructure */ 
            );
