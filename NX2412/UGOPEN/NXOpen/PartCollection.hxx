...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PartCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        /** Represents the intended use of a design workset
            */
        public: enum DesignWorksetIntentType
        {
            DesignWorksetIntentTypeMultipleProduct/** The workset can contain different products with the same or different configurations */,
            DesignWorksetIntentTypeMultipleConfiguration/** The workset can contain a primary configuration product and copies of secondary configuration products with the same or different used configurations */
        };
        ...
        public: /** User defined method that is called whenever a part is in the process of being closed. Do not create, open, save
                other parts or change active display part inside this callback. 
                This callback will not be invoked for the parts in session if user exits NX.  
         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        ...
        {
            SetProtectionOnDisplayedPart/** Part only */,
            SetProtectionOnDisplayedPartandComponents/** Part and all it's fully loaded components*/,
            SetProtectionOnAllParts/** All fully loaded parts in the session */
        };
        ...
        {
        public:
            using value_type = NXOpen::BasePart *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::BasePart **;
            using reference = NXOpen::BasePart *&;
        ...
        /** Finds the @link  NXOpen::BasePart   NXOpen::BasePart @endlink  with the given name. The part must have been loaded 
            in this session. This function accepts full path name or leaf name in case of native mode and would expect 
        ...
        /** Creates a new part.  @return  Newly created part 
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::BasePart * NewBase
        (
            const NXString & name /** Name of new part */,
            NXOpen::BasePart::Units units /** Units of new part */
        );
        ...
        /** 
                ...
                Depending on the input options this part may be displayed in addition to other, already displayed part.
                See also See @link NXOpen::DisplayPartOption NXOpen::DisplayPartOption@endlink .
                A call to this method may result in the undo mark list getting reset in order to prevent undo over the display or undisplay of a part.
        ...
        /** 
                ...
                In contrast to @link NXOpen::PartCollection::SetActiveDisplay NXOpen::PartCollection::SetActiveDisplay@endlink , this method will retain the undo mark list.
             @return  Returns OK if the work part could be maintained, or a status code
                                                                indicating the reason 
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::PartCollection::SdpsStatus SetActiveDisplayRetainUndoMarks
        (
            NXOpen::BasePart * part /** The new displayed part */,
            NXOpen::DisplayPartOption displayPartOption /** Controls whether or not the part will replace the existing active display part. */,
            NXOpen::PartDisplayPartWorkPartOption workPartOption /** Controls what the work part will be in the new active display part. */,
        ...
        /** Creates a @link NXOpen::FileNew NXOpen::FileNew@endlink  
        ...
        /** Creates a @link NXOpen::Gateway::GenericFileNewBuilder NXOpen::Gateway::GenericFileNewBuilder@endlink  
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: NXOpen::CloudDM::NewPartBuilder * CreateCloudDMNewPartBuilder
        (
        );
        ...
        public: NXOpen::PartCollection::DesignWorksetIntentType IntentForWorksetWithoutNxDataset
        (
        );
        ...
        /**Sets  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : nx_designworkset (" Design Workset") */
        public: void SetIntentForWorksetWithoutNxDataset
        (
            NXOpen::PartCollection::DesignWorksetIntentType intent /** intent */ 
        );
