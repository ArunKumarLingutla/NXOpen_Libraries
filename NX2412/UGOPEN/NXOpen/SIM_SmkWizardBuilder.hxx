        ...
        */
        class NXOPENCPP_SIMEXPORT  SmkWizardBuilder : public NXOpen::Builder
        {
            ...
            public: enum ComponentClassificationType
            {
                ...
                ComponentClassificationTypeToolTurret/** tool turret */ ,
                ComponentClassificationTypeMagazine/** magazine */ ,
                ComponentClassificationTypeToolSpindle/** tool spindle */ ,
                ComponentClassificationTypeLocationPocket/** location pocket */ ,
                ComponentClassificationTypeAssignablePocket/** assignable pocket */ ,
                ComponentClassificationTypeWorkHolder/** work holder */ ,
                ComponentClassificationTypeToolHolder/** tool holder */ ,
                ComponentClassificationTypeSetup/** setup */ 
            };
            ...
            public: enum RegisterType
            {
                ...
                RegisterTypeSameAsParent/** same as parent */ ,
            ...
            {
                WizardStepTemplateSelection/** template selection */ ,
                WizardStepGeometrySelection/** geometry selection */ ,
                WizardStepJunctionSelection/** junction selection */ ,
                WizardStepAxisDefinition/** axis definition */ ,
                WizardStepChainConfiguration/** chain configuration */ ,
                WizardStepChannelConfiguration/** channel configuration */ ,
                WizardStepMachineToolDataDefinition/** machine tool data definition */ ,
                WizardStepCsePostSelection/** cse post selection */ ,
                WizardStepOutputSelection/** output selection */ 
            };

            /** The kinematics version type */
            public: enum KinematicsVersionType
            {
                KinematicsVersionTypeClassic/** Classic kinematics model */ = 1,
                KinematicsVersionTypeMpp/** Machine Powered Programming kinematics model */
            };
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: double GetAxisMaximumSpindleSpeed
            (
                const NXString & axisName /** The axis name */
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            double GetAxisMaximumSpindleSpeed
            (
                const char * axisName /** The axis name */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void SetAxisMaximumSpindleSpeed
            (
                const NXString & axisName /** The axis name */,
                double value /** The maximum spindle speed value */
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void SetAxisMaximumSpindleSpeed
            (
                const char * axisName /** The axis name */,
                double value /** The maximum spindle speed value */
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: NXOpen::CartesianCoordinateSystem * MachineZeroCsys
            (
            );
            ...
            (
                NXOpen::CartesianCoordinateSystem * machZeroCsys /** the Machine Zero Csys */
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: bool ActivateMlPrediction
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void SetActivateMlPrediction
            (
                bool activateMlPrediction /** The flag of machine learning prediction */
            );
            ...
            (
                const NXString & chainName /** The chain name */,
                const NXString & chainAttributes /** The chain attributes */
            );
            /** Add the chain 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void AddChain
            (
                const char * chainName /** The chain name */,
                const char * chainAttributes /** The chain attributes */
            );
            /** Delete the chain 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            ...
            (
                const NXString & oldChainName /** The old chain name */,
                const NXString & newChainName /** The new chain name */
            );
            /** Rename the chain 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void RenameChain
            (
                const char * oldChainName /** The old chain name */,
                const char * newChainName /** The new chain name */
            );
            /** Update the chain 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            ...
            /** Get the wizard step  @return  The wizard step 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SIM::SmkWizardBuilder::WizardStep GetWizardStep
            (
            );
            /** Set the wizard step 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void SetWizardStep
            (
                NXOpen::SIM::SmkWizardBuilder::WizardStep wizardStep /** The wizard step */
            );
            /** Get the machine kit manufacturer  @return  The machine kit manufacturer 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXString GetMachineKitManufacturer
            (
            );
            /** Set the machine kit manufacturer 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void SetMachineKitManufacturer
            (
                const NXString & manufacturer /** The machine kit manufacturer */
            );
            /** Set the machine kit manufacturer 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            void SetMachineKitManufacturer
            (
                const char * manufacturer /** The machine kit manufacturer */
            );
            /** Get the kinematics version  @return  The kinematics version 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SIM::SmkWizardBuilder::KinematicsVersionType GetKinematicsVersion
            (
            );
            /** Set the kinematics version 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void SetKinematicsVersion
            (
                NXOpen::SIM::SmkWizardBuilder::KinematicsVersionType kimVersion /** The kinematics version */
            );
        };
    }
}
