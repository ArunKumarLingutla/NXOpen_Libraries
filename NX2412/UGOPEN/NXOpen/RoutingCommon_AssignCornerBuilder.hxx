...
namespace NXOpen
{
    ...
    namespace RoutingCommon
    {
        ...
        CornerSettings.BendCornerSettings.Radius.RightHandSide </term> <description> 
        ...
        CornerSettings.BendCornerSettings.RatioToAttributeValue.RightHandSide </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        CornerSettings.BendCornerSettings.RatioToDiameter.RightHandSide </term> <description> 
        ...
        */
        class NXOPENCPP_ROUTINGCOMMONEXPORT  AssignCornerBuilder : public NXOpen::Builder
        {
            ...
            /// \endcond 
            /** Reverse the direction which the overlap stock will be trimmed. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
