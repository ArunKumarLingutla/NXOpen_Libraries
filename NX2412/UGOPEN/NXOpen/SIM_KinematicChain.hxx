    ...
    namespace SIM
    {
        ...
        */
        class NXOPENCPP_SIMEXPORT  KinematicChain : public NXOpen::Builder
        {
            ...
            public: enum PreferredSolutionType
            {
                PreferredSolutionTypeInvalid/** Invalid solution */ = -1,
                PreferredSolutionTypeShortest/** Shortest distance solution */,
                PreferredSolutionTypeRangeOne/** Solution range one */,
                PreferredSolutionTypeRangeTwo/** Solution range two */
            };
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::SIM::KinematicChain::PreferredSolutionType GetPreferredSolution
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") */
            public: void SetPreferredSolution
            (
                NXOpen::SIM::KinematicChain::PreferredSolutionType preferredSolution /** The preferred solution */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double GetPreferredRangeMinimum
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double GetPreferredRangeMaximum
            (
            );
