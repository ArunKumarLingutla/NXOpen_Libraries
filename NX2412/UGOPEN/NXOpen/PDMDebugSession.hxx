    ...
    class NXOPENDEBUGSESSIONCPPEXPORT  PDMDebugSession
    {
        ...
        */
        ...
        struct NxPartInfoFlags
        {
            ...
            public: /** Dump the Attributes saved flag. This flag is wrongly named, but renaming it will require editing a large number of files which isn't worth it - <AdrianB> 13-Aug-2021 */bool PrintAreAttrModified;
            ...
            public: /** Dump the Attributes of Design Session */bool PrintDesignSessionAttributesInfo;
            public: NxPartInfoFlags() :
                ...
                PrintDesignSessionAttributesInfo()
            {
            }
            ...
            public: NxPartInfoFlags(bool printFileStringInitial /** File String Valid or not */, 
                    ...
                    bool printAreAttrModifiedInitial /** Dump the Attributes saved flag. This flag is wrongly named, but renaming it will require editing a large number of files which isn't worth it - <AdrianB> 13-Aug-2021 */, 
                    ...
                    bool printDesignSessionAttributesInfoInitial /** Dump the Attributes of Design Session */) :
                ...
                PrintDesignSessionAttributesInfo(printDesignSessionAttributesInfoInitial)
            {
            }
        };
        ...
        */
        ...
        struct TcPartInfoFlags
        {
            ...
            public: /** Print Locking Details (Check-out information) */bool PrintLockingDetails;
            public: /** DTSV Dataset */bool PrintDstv;
            public: /** Weight and Balance */bool PrintWeightAndBalance;
            public: /** Teamcenter Folder information for current work part */bool PrintFolder;
            public: /** Print UGPartBoundingBoxForm named reference */bool PrintUgpartBbox;
            public: /** Print UGPartMassPropsForm named reference */bool PrintUgpartMassprops;
            ...
            public: /** Print published SimplfiedFrom and SimplifiedUsing relations */bool PrintSimplifiedRelations;
            public: /** print reference component */ bool PrintReferenceComponent;
            public: TcPartInfoFlags() :
                ...
                PrintLockingDetails(),
                PrintDstv(),
                PrintWeightAndBalance(),
                PrintFolder(),
                PrintUgpartBbox(),
                PrintUgpartMassprops(),
                ZeroOutPublishFlags(),
                TurnOnPublishFlags(),
                ...
                RecordPartData(),
                RecordAltrepNotes(),
                PrintSimplifiedRelations(),
                PrintReferenceComponent()
            {
            }
            ...
            public: TcPartInfoFlags(bool printJtInitial /** JT Dataset */, 
                    ...
                    bool printLockingDetailsInitial /** Print Locking Details (Check-out information) */, 
                    bool printDstvInitial /** DTSV Dataset */, 
                    bool printWeightAndBalanceInitial /** Weight and Balance */, 
                    bool printFolderInitial /** Teamcenter Folder information for current work part */, 
                    bool printUgpartBboxInitial /** Print UGPartBoundingBoxForm named reference */, 
                    bool printUgpartMasspropsInitial /** Print UGPartMassPropsForm named reference */, 
                    ...
                    bool printSimplifiedRelationsInitial /** Print published SimplfiedFrom and SimplifiedUsing relations */, 
                    bool printReferenceComponentInitial /** print reference component */ ) :
                ...
                PrintLockingDetails(printLockingDetailsInitial),
                PrintDstv(printDstvInitial),
                PrintWeightAndBalance(printWeightAndBalanceInitial),
                PrintFolder(printFolderInitial),
                PrintUgpartBbox(printUgpartBboxInitial),
                PrintUgpartMassprops(printUgpartMasspropsInitial),
                ...
                PrintSimplifiedRelations(printSimplifiedRelationsInitial),
                PrintReferenceComponent(printReferenceComponentInitial)
            {
            }
        };
        ...
        */
        ...
        struct WorksetInformationFlags
        {
            ...
            public: /** Print Locking details (Check-out information) for the Workset/DE */bool PrintWorksetLockingDetails;
            ...
            public: WorksetInformationFlags(bool printSubsetCountInitial /** Number of subsets in the workset. */, 
                    ...
                    bool printWorksetLockingDetailsInitial /** Print Locking details (Check-out information) for the Workset/DE */, 
                ...
                PrintWorksetLockingDetails(printWorksetLockingDetailsInitial),
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: NXString DumpMinimumPropertyPolicyProperties
        (
        );
