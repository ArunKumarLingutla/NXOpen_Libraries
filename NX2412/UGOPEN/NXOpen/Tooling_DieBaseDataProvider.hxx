...
//
//  Source File:
//     Tooling_DieBaseDataProvider.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class _DieBaseDataProviderBuilder;
        class DieBaseDataProviderImpl;
        /**
            Provides basic data for die base complex splitting.
            When @link Builder::Commit Builder::Commit@endlink  is called NULL will be returned.
             <br> To create a new instance of this class, use @link NXOpen::Tooling::DieBaseCollection::CreateDieBaseDataProvider  NXOpen::Tooling::DieBaseCollection::CreateDieBaseDataProvider @endlink  <br> 
         <br>  Created in NX2406.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  DieBaseDataProvider : public NXOpen::TaggedObject, public virtual NXOpen::ITableEditorDataProvider
        {
            private: DieBaseDataProviderImpl * m_diebasedataprovider_impl;
            private: friend class  _DieBaseDataProviderBuilder;
            protected: DieBaseDataProvider();
            public: ~DieBaseDataProvider();
            ...
            (
                ...
                NXOpen::NXObject * solidBodyTag /** solidbodytag */ 
            );
            /** Asks row object with specified index value
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * AskRowObjectInMap
            (
                int rowIndex /** rowindex */ 
            );
