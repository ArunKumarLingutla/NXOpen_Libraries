...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Represents a collection of MWSearchRegion builder  <br> To obtain an instance of this class, refer to @link NXOpen::Tooling::ToolingManager  NXOpen::Tooling::ToolingManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  MWSearchRegionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            //lint -sem(NXOpen::Tooling::MWSearchRegionCollection::iterator::copy,initializer)
            class iterator
            {
            public:
                using value_type = NXOpen::Tooling::MWSearchRegionBuilder *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Tooling::MWSearchRegionBuilder **;
                using reference = NXOpen::Tooling::MWSearchRegionBuilder *&;
            ...
            /** Creates a MWSearchRegion builder  @return @link  MWSearchRegionBuilder   MWSearchRegionBuilder @endlink  object object 
             <br>  Created in NX6.0.0.  <br>  
