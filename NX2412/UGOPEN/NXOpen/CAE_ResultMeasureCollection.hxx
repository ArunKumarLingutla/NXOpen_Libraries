    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultMeasureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::ResultMeasure *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::ResultMeasure **;
                using reference = NXOpen::CAE::ResultMeasure *&;
            ...
            /** Finds the @link  NXOpen::CAE::ResultMeasure   NXOpen::CAE::ResultMeasure @endlink  with the given identifier as recorded in a journal.
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ResultMeasure * FindObject
            (
                const NXString & journalIdentifier /** Identifier of the ResultMeasure you want */
            );
            /** Finds the @link  NXOpen::CAE::ResultMeasure   NXOpen::CAE::ResultMeasure @endlink  with the given identifier as recorded in a journal.
             ...
             <br>  Created in NX2412.3000.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            NXOpen::CAE::ResultMeasure * FindObject
            (
                const char * journalIdentifier /** Identifier of the ResultMeasure you want */
            );
            ...
            /** Create a ResultMeasure  @return  The created result measure object 
             <br>  @deprecated Deprecated in NX2406.0.0.  Use @link NXOpen::CAE::ResultMeasureCollection::CreateBuilder NXOpen::CAE::ResultMeasureCollection::CreateBuilder@endlink  instead. <br>  

             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::CAE::ResultMeasureCollection::CreateBuilder instead.") NXOpen::CAE::ResultMeasure * CreateResultMeasureNew
            (
            ...
            /** Create a result options for result measure 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::CAE::ResultMeasureCollection::CreateBuilder instead.") NXOpen::CAE::ResultMeasureResultOptions * CreateNewResultOptions
            (
                NXOpen::CAE::SimSolution * tSol /** tsol */ ,
                NXOpen::CAE::SimResultReference * tResultReference /** tresultreference */ ,
            ...
            /** Creates the builder of a result measure.  @return   
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::SimResultMeasureBuilder * CreateBuilder
            (
            );
