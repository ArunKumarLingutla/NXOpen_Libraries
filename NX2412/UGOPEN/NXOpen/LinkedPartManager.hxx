...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  LinkedPartManager : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::LinkedMirrorPartEntityMapEvent *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::LinkedMirrorPartEntityMapEvent **;
            using reference = NXOpen::LinkedMirrorPartEntityMapEvent *&;
