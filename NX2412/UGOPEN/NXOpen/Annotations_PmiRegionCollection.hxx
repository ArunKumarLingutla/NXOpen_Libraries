...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a collection of @link NXOpen::Annotations::Region NXOpen::Annotations::Region@endlink  objects  <br> To obtain an instance of this class, refer to @link NXOpen::Annotations::PmiManager  NXOpen::Annotations::PmiManager @endlink  <br> 
         <br>  Created in NX6.0.2.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiRegionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Annotations::Region *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::Region **;
                using reference = NXOpen::Annotations::Region *&;
            ...
            /** Creates a @link NXOpen::Annotations::RegionBuilder NXOpen::Annotations::RegionBuilder@endlink  
