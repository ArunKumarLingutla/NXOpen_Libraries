        ...
        */
        class NXOPENCPP_CAMEXPORT  NcmTransferBuilder : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the approach vector 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * ApproachVector
            (
            );
            ...
            (
                NXOpen::Direction * newValue /** the approach vector */
            );
            ...
            /**Returns  the approach tool axis 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * ApproachToolAxis
            (
            );
            ...
            (
                NXOpen::Direction * newValue /** the approach tool axis */
            );
            ...
            /**Returns  the departure vector 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * DepartureVector
            (
            );
            ...
            (
                NXOpen::Direction * newValue /** the departure vector */
            );
            ...
            /**Returns  the departure tool axis 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Direction * DepartureToolAxis
            (
            );
            ...
            (
                NXOpen::Direction * newValue /** the departure tool axis */
            );
            ...
            /**Returns  the transfer using for within regions strategy 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NcmSubopBuilder::TransferUsing TransferUsing
            (
            );
            /**Sets  the transfer using for within regions strategy 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetTransferUsing
            (
                NXOpen::CAM::NcmSubopBuilder::TransferUsing newValue /** newvalue */ 
            );
            /**Returns  the transfer using max follow distance 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferUsingMaxFollowDistance
            (
            );
            /**Returns  the transfer using height 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * TransferUsingHeight
            (
            );
        };
    }
