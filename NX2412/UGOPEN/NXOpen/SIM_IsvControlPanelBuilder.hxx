    ...
    namespace SIM
    {
        ...
        */
        class NXOPENCPP_SIMEXPORT  IsvControlPanelBuilder : public NXOpen::Builder
        {
            ...
            {
                LanguageNc/** NC language */,
                LanguageAc/** AC language */,
                LanguageCse/** CSE language */
            };
            ...
            /** Evaluate expression in NC, CSE or AnyController language @return  Was the evaluation successful?
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            public: bool EvaluateExpression
            (
                const NXString & channelName /** The channel name*/,
                const NXString & expression /** The expression*/,
                NXOpen::SIM::IsvControlPanelBuilder::Language language /** The expression's language*/,
                NXString* value /** The expression value*/,
                NXString* valueType /** The expression value's type*/
            );
            /** Evaluate expression in NC, CSE or AnyController language @return  Was the evaluation successful?
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_isv_full ("Full functionality for Integrated Simulation and Verification") */
            ...
            (
                const char * channelName /** The channel name*/,
                const char * expression /** The expression*/,
                NXOpen::SIM::IsvControlPanelBuilder::Language language /** The expression's language*/,
                NXString* value /** The expression value*/,
                NXString* valueType /** The expression value's type*/
            );
