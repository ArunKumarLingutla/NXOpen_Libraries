...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimSimulationObject : public NXOpen::CAE::SimBC, public virtual NXOpen::CAE::IAncillaryDisplayableEntity, public virtual NXOpen::CAE::IPostScenarioDataSource
        {
