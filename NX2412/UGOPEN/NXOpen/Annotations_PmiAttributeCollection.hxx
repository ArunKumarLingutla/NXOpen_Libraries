    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiAttributeCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Annotations::PmiAttribute *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::PmiAttribute **;
                using reference = NXOpen::Annotations::PmiAttribute *&;
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeBuilder NXOpen::Annotations::PmiAttributeBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Creates a @link NXOpen::Annotations::PmiUserDefinedBuilder NXOpen::Annotations::PmiUserDefinedBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiIntegerBuilder NXOpen::Annotations::PmiIntegerBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiStringBuilder NXOpen::Annotations::PmiStringBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiNumberBuilder NXOpen::Annotations::PmiNumberBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiUrlNoteBuilder NXOpen::Annotations::PmiUrlNoteBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::GovernmentSecurityInformationBuilder NXOpen::Annotations::GovernmentSecurityInformationBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::CompanyProprietaryInformationBuilder NXOpen::Annotations::CompanyProprietaryInformationBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::GeneralNoteBuilder NXOpen::Annotations::GeneralNoteBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::SurfaceFinishBuilder NXOpen::Annotations::SurfaceFinishBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::SpecificNoteBuilder NXOpen::Annotations::SpecificNoteBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::CoordinateNoteBuilder NXOpen::Annotations::CoordinateNoteBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::EnterpriseIdentificationBuilder NXOpen::Annotations::EnterpriseIdentificationBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PartIdentificationBuilder NXOpen::Annotations::PartIdentificationBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::ProcessSpecificationBuilder NXOpen::Annotations::ProcessSpecificationBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::MaterialSpecificationBuilder NXOpen::Annotations::MaterialSpecificationBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::LocatorDesignatorBuilder NXOpen::Annotations::LocatorDesignatorBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::BalloonNoteBuilder NXOpen::Annotations::BalloonNoteBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeValueStringBuilder NXOpen::Annotations::PmiAttributeValueStringBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeValueMultipleStringBuilder NXOpen::Annotations::PmiAttributeValueMultipleStringBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeValueIntegerBuilder NXOpen::Annotations::PmiAttributeValueIntegerBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeValueListBuilder NXOpen::Annotations::PmiAttributeValueListBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeValueUrlBuilder NXOpen::Annotations::PmiAttributeValueUrlBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::PmiAttributeValueNumberBuilder NXOpen::Annotations::PmiAttributeValueNumberBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a @link NXOpen::Annotations::ExportControlBuilder NXOpen::Annotations::ExportControlBuilder@endlink  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
