        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LetteringStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the dimension text aspect ratio.
                        ...
                        This only defines the aspect ratio for text. @link LetteringStyleBuilder::DimensionTextSymbolAspectRatio LetteringStyleBuilder::DimensionTextSymbolAspectRatio@endlink  
            ...
            /**Returns  the dimension text line width.
                        ...
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::DimensionTextItalicized NXOpen::Annotations::LetteringStyleBuilder::DimensionTextItalicized@endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  
                        is equivalent to a value of "Bold" or "Bold Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::DimensionTextItalicized NXOpen::Annotations::LetteringStyleBuilder::DimensionTextItalicized@endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the appended text aspect ratio.
                        This specifies a ratio of length to height which represents the size of character text.
                        This only defines the aspect ratio for text. @link LetteringStyleBuilder::AppendedTextSymbolAspectRatio LetteringStyleBuilder::AppendedTextSymbolAspectRatio@endlink  
                        controls the aspect ratio of symbol text control sequences. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the appended text line width.
                        The values for @link NXOpen::Annotations::LineWidth NXOpen::Annotations::LineWidth@endlink  when using standard font : 
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::AppendedTextItalicized NXOpen::Annotations::LetteringStyleBuilder::AppendedTextItalicized@endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  
                            is equivalent to a value of "Bold" or "Bold Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::AppendedTextItalicized NXOpen::Annotations::LetteringStyleBuilder::AppendedTextItalicized@endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the tolerance text aspect ratio. 
                        This specifies a ratio of length to height which represents the size of character text.
                        This only defines the aspect ratio for text. @link LetteringStyleBuilder::ToleranceTextSymbolAspectRatio LetteringStyleBuilder::ToleranceTextSymbolAspectRatio@endlink  
                        controls the aspect ratio of symbol text control sequences. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the tolerance text line width.
                        The values for @link NXOpen::Annotations::LineWidth NXOpen::Annotations::LineWidth@endlink  when using standard font : 
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::ToleranceTextItalicized NXOpen::Annotations::LetteringStyleBuilder::ToleranceTextItalicized@endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  
                           is equivalent to a value of "Bold" or "Bold Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::ToleranceTextItalicized NXOpen::Annotations::LetteringStyleBuilder::ToleranceTextItalicized@endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the general text aspect ratio.
                        This specifies a ratio of length to height which represents the size of character text.
                        This only defines the aspect ratio for text. @link LetteringStyleBuilder::GeneralTextSymbolAspectRatio LetteringStyleBuilder::GeneralTextSymbolAspectRatio@endlink  
                        controls the aspect ratio of symbol text control sequences. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the general text line width.
                        The values for @link NXOpen::Annotations::LineWidth NXOpen::Annotations::LineWidth@endlink  when using standard font : 
                        A value of @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink  is equivalent to a value of "Regular" or "Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::GeneralTextItalicized NXOpen::Annotations::LetteringStyleBuilder::GeneralTextItalicized@endlink  is set).
                        Any value other than @link NXOpen::Annotations::LineWidthThin NXOpen::Annotations::LineWidthThin@endlink 
                        is equivalent to a value of "Bold" or "Bold Italic" (if @link NXOpen::Annotations::LetteringStyleBuilder::GeneralTextItalicized NXOpen::Annotations::LetteringStyleBuilder::GeneralTextItalicized@endlink  is set).
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the multiline vertical text display format 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: int MultilineVerticalTextDisplayFormat
            (
            );
            /**Sets  the multiline vertical text display format 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetMultilineVerticalTextDisplayFormat
            (
                int multilineVerticalTextDisplayFormat /** multilineverticaltextdisplayformat */ 
            );
