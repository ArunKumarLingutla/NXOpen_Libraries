...
namespace NXOpen
{
    ...
    ConvertInputToReference </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  SketchMirrorPatternBuilder : public NXOpen::Builder
    {
        ...
        /**Returns  the flag to indicate if the input needs to be converted to reference 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: bool ConvertInputToReference
        (
        );
        /**Sets  the flag to indicate if the input needs to be converted to reference 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void SetConvertInputToReference
        (
            bool inputreference /** inputreference */ 
        );
        ...
        /** This function updates the mirror constraint according to the data set in input section 
