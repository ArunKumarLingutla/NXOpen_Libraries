...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace SheetMetal
        {
            ...
            IndexMarkLength.Value </term> <description> 
             
            5 (millimeters part), 0.5 (inches part) </description> </item> 

            <item><term> 
             
            MaximumChordHeight.Value </term> <description> 
             
            6.5 (millimeters part), 0.25 (inches part) </description> </item> 

            <item><term> 
             
            MaximumSegmentAngle.Value </term> <description> 
             
            20 </description> </item> 

            <item><term> 
             
            MaximumSegmentLength.Value </term> <description> 
             
            6.5 (millimeters part), 0.25 (inches part) </description> </item> 

            <item><term> 
             
            NumberOfBendSegments </term> <description> 
             
            0 </description> </item> 

            <item><term> 
             
            UseSegmentedBends </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  LoftedFlangeBuilder : public NXOpen::Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                /** bending method.*/
                public: enum BendingMethods
                {
                    BendingMethodsFormed/** formed */ ,
                    BendingMethodsAdvanced/** advanced */ ,
                    BendingMethodsBends/** bends */ 
                };

                /** auto relief.*/
                public: enum AutoReliefTypes
                {
                    AutoReliefTypesLinear/** linear */ ,
                    AutoReliefTypesSpherical/** spherical */ 
                };

                /** bend divide parameter.*/
                public: enum BendDivideParameters
                {
                    BendDivideParametersNumberOfBendSegments/** number of bend segments */ ,
                    BendDivideParametersMaximumChordHeight/** maximum chord height */ ,
                    BendDivideParametersMaximumSegmentLength/** maximum segment length */ ,
                    BendDivideParametersMaximumSegmentAngle/** maximum segment angle */ 
                };
                ...
                /**Returns  the trim end plates.
                 ...
                 <br> License requirements : None */
                public: bool TrimEndPlates
                (
                );
                /**Sets  the trim end plates.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: void SetTrimEndPlates
                (
                    bool trimEndPlates /** trimendplates */ 
                );
                /**Returns  the bending method of lofted flange.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::LoftedFlangeBuilder::BendingMethods BendingMethod
                (
                );
                /**Sets  the bending method of lofted flange.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: void SetBendingMethod
                (
                    NXOpen::Features::SheetMetal::LoftedFlangeBuilder::BendingMethods bendingMethod /** bendingmethod */ 
                );
                /**Returns  the auto relief of lofted flange.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::LoftedFlangeBuilder::AutoReliefTypes AutoReliefType
                (
                );
                /**Sets  the auto relief of lofted flange.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: void SetAutoReliefType
                (
                    NXOpen::Features::SheetMetal::LoftedFlangeBuilder::AutoReliefTypes autoReliefType /** autorelieftype */ 
                );
                /**Returns  the maximum chord height.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * MaximumChordHeight
                (
                );
                /**Returns  the maximum segment length.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * MaximumSegmentLength
                (
                );
                /**Returns  the maximum segment angle.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * MaximumSegmentAngle
                (
                );
                /**Returns  the bend divide parameter.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::SheetMetal::LoftedFlangeBuilder::BendDivideParameters BendDivideParameter
                (
                );
                /**Sets  the bend divide parameter.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") */
                public: void SetBendDivideParameter
                (
                    NXOpen::Features::SheetMetal::LoftedFlangeBuilder::BendDivideParameters bendDivideParameter /** benddivideparameter */ 
                );
            };
        }
    }
