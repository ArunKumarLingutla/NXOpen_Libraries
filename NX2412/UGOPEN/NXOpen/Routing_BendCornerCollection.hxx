    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  BendCornerCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Routing::BendCorner *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Routing::BendCorner **;
                using reference = NXOpen::Routing::BendCorner *&;
            ...
            /** Create a bend corner object at a Control Point from specified attribute.  @return  The new bend corner. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::BendCorner * CreateCornerFromAttribute
            (
                NXOpen::Routing::ControlPoint * rcp /** Route control point to bend. */,
                NXOpen::Routing::CornerTypeBuilder::BendMethods bendMethod /** Enumerated bend method. */,
                double bendRatio /** Bend ratio is used only if bend method is set to
                ...
                double bendRadius /** Radius of bend corner arc, used only if bend method is set to
                                                                                    @link NXOpen::Routing::CornerTypeBuilder::BendMethodsRadius NXOpen::Routing::CornerTypeBuilder::BendMethodsRadius@endlink .
                                                                                    Must be greater than 0. */,
                double bendRatioToAttribute /** bend ratio to attribute */ ,
                const NXString & bendAttributeName /** bend attribute name */ 
            );
            /** Create a bend corner object at a Control Point from specified attribute.  @return  The new bend corner. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            NXOpen::Routing::BendCorner * CreateCornerFromAttribute
            (
                NXOpen::Routing::ControlPoint * rcp /** Route control point to bend. */,
                NXOpen::Routing::CornerTypeBuilder::BendMethods bendMethod /** Enumerated bend method. */,
                double bendRatio /** Bend ratio is used only if bend method is set to
                ...
                double bendRadius /** Radius of bend corner arc, used only if bend method is set to
                                                                                    ...
                                                                                    Must be greater than 0. */,
                double bendRatioToAttribute /** bend ratio to attribute */ ,
                const char * bendAttributeName /** bend attribute name */ 
            );
            ...
            /** This routine assigns a new bend corner to the given input bend corner object using
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::BendCorner * AssignCornerByBendRatioToAttribute
            (
                NXOpen::Routing::ControlPoint * bendCrn /** Input bend corner.  */,
                double bendRatioToAttribute /** Bend ratio must be greater than 0.5. */,
                const NXString & bendAttributeName /** bend attribute name */ 
            );
            /** This routine assigns a new bend corner to the given input bend corner object using
                        bend ratio. This "assignment" can involve the removal of an existing
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            NXOpen::Routing::BendCorner * AssignCornerByBendRatioToAttribute
            (
                NXOpen::Routing::ControlPoint * bendCrn /** Input bend corner.  */,
                double bendRatioToAttribute /** Bend ratio must be greater than 0.5. */,
                const char * bendAttributeName /** bend attribute name */ 
