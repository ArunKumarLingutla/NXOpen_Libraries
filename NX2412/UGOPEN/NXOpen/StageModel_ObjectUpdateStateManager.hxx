...
namespace NXOpen
{
    ...
    namespace StageModel
    {
        ...
        /** Provides interface for objtects up to date status.  <br> To obtain an instance of this class, refer to @link NXOpen::StageModel::Manager  NXOpen::StageModel::Manager @endlink  <br> 
         <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::StageModel::ObjectStateManager NXOpen::StageModel::ObjectStateManager@endlink  instead. <br>  

         <br>  Created in NX1953.0.0.  <br>  
        */
        class NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::StageModel::ObjectStateManager instead.") STAGEMODELOPENCPPEXPORT  ObjectUpdateStateManager
        {
            /** Defines allowed Up to date status. 
             ...
             <br>  Created in NX1953.0.0.  <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::StageModel::ObjectStateManager instead.") Status
            {
            ...
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::StageModel::ObjectStateManager instead.") NXOpen::StageModel::ObjectUpdateStateManager::Status GetStatus
            (
            ...
            /** Updates all given out-of-date objects to make them up to date 
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : stage_model (" Stage Model") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::StageModel::ObjectStateManager instead.") void MakeUpToDate
            (
