...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        HideOriginal (deprecated) </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  CompositeCurveBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Represents the input curves options */
            public: enum InputCurves
            {
                InputCurvesKeep/** Keeps the original input curve and creates the new output curve */,
                InputCurvesHide/** Hides the original input curve and creates the new output curve */,
                InputCurvesDelete/** Deletes the original input curve and creates the new output curve */,
                InputCurvesReplace/** Replaces the original input curve with the new output curve */
            };
            ...
            /**Returns  the hide original 
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::Features::CompositeCurveBuilder::InputCurvesOption NXOpen::Features::CompositeCurveBuilder::InputCurvesOption@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::Features::CompositeCurveBuilder::InputCurvesOption instead.") bool HideOriginal
            (
            );
            /**Sets  the hide original 
             <br>  @deprecated Deprecated in NX2412.0.0.  Use @link NXOpen::Features::CompositeCurveBuilder::SetInputCurvesOption NXOpen::Features::CompositeCurveBuilder::SetInputCurvesOption@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") OR insp_programming ("INSPECTION PROGRAMMING") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  Use NXOpen::Features::CompositeCurveBuilder::SetInputCurvesOption instead.") void SetHideOriginal
            (
            ...
            /** Gets source part occurrences. Source part occurrence will be NULL_TAG for Context-independent linked object 
            ...
            /**Returns  the input curve options 
             ...
             <br> License requirements : None */
            public: NXOpen::Features::CompositeCurveBuilder::InputCurves InputCurvesOption
            (
            );
            /**Sets  the input curve options 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") OR insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetInputCurvesOption
            (
                NXOpen::Features::CompositeCurveBuilder::InputCurves inputCurvesOption /** input curves option */ 
            );
            /** Returns the wave linked composite curve parent information 
             <br>  Created in NX2406.4000.0.  <br>  
             <br> License requirements : None */
            public: void GetParentInformation
            (
                NXOpen::TaggedObject * curveTag /** curvetag */ ,
                bool calcStatus /** calcstatus */ ,
                NXString* parentPartName /** parentpartname */ ,
                NXString* objectName /** objectname */ ,
                NXString* status /** status */ 
            );
        };
    }
}
