    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistDataSources : public NXOpen::TaggedObject
        {
            ...
            /**  @brief Replace data source with a file. 

              
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: void ReplaceDataSourceWithFile
            (
                int fileIndex /** starts with 0 */,
                const NXString & fileName /** name of the file to be used */
            );
            /**  @brief Replace data source with a file. 
             ...
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            void ReplaceDataSourceWithFile
            (
                int fileIndex /** starts with 0 */,
                const char * fileName /** name of the file to be used */
            );
            /**  @brief Plots the load histories with range and end treatment type  

              
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: void PlotLoadHistoriesWithOptions
            (
                int fileIndex /** Starts with 0 */,
                const std::vector<int> & loadHistoriesIndexes /** Load history indexes, starts with 0 */,
                int deviceIndex /** deviceindex */ ,
                ...
                double end /** End time */,
                NXOpen::CAE::DurSpecialistDataSources::HistoryEndTreatmentType endTreatmentType /** History end treatment type */
            );
        };
    }
}
