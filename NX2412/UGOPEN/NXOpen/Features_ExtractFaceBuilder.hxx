...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        DeleteHoles </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        FixAtCurrentTimestamp </term> <description> 
        ...
        IsPsmOutputBody </term> <description> 
         
        false </description> </item> 

        <item><term> 
         
        MakePositionIndependent </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        ReplacementAssistant.OneToOne </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ExtractFaceBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /** Returns the wave linked face parent information 
