...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::Drawings::SectionViewBuilder::SectionLineType") NXOPENCPP_DRAWINGSEXPORT  PointAndAngleSectionLine : public NXOpen::Drawings::SectionLine
        {
