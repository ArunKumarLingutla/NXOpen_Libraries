    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BusinessModifierCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Annotations::BusinessModifier *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::BusinessModifier **;
                using reference = NXOpen::Annotations::BusinessModifier *&;
