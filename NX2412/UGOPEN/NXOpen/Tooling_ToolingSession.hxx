...
#include <NXOpen/Tooling_ExcelManager.hxx>
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class LibraryInstallationCollection;
    }
    namespace Tooling
    {
    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ToolingSession
        {
            ...
            /** Sets the wizard type of tooling application. 1:Mold Wizard; 2:Pregressive Die; 3:Stamping Die; 
                        4:Electrode Design; 5:Engineering Die; 6:Pressure Die Casting; 7:Conformal Cooling; 8:vehicle design automation; 9:GC Toolkits
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : None */
            public: void SetWizardType
            (
                int type /** wizard type of current tooling application. 1:Mold Wizard; 2:Pregressive Die; 3:Stamping Die; 
                            4:Electrode Design; 5:Engineering Die; 6:Pressure Die Casting; 7:Conformal Cooling; 8:vehicle design automation; 9:GC Toolkits*/
            );
            ...
            /** Delete the tooling components. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") OR ug_die_design ("Die Design") */
            public: void DeleteToolingComponents
            (
                const std::vector<NXOpen::Assemblies::Component *> & reuseComponents /** reusecomponents */ 
            );
            /** Removes all shrinkage attributes. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void RemoveAllShrinkageAttributes
            (
                NXOpen::NXObject * objectTag /** the object tag whose all shrinkage attributes will be removed. */
            );
            ...
            (
                const NXString & category /** Library category, "5" => Custom symbol */,
                const NXString & appName /** Application environment, like "UG_APP_MODELING", "UG_APP_DRAFTING", "UG_APP_PMI" */,
                const NXString & runEnv /** "Native", "Teamcenter" */,
                std::vector<NXString> & libNames /** Library name */,
                std::vector<NXString> & libPaths /** Library path */
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            void GetLibraries
            (
                const char * category /** Library category, "5" => Custom symbol */,
                const char * appName /** Application environment, like "UG_APP_MODELING", "UG_APP_DRAFTING", "UG_APP_PMI" */,
                const char * runEnv /** "Native", "Teamcenter" */,
                std::vector<NXString> & libNames /** Library name */,
                std::vector<NXString> & libPaths /** Library path */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::ExcelManager * CreateExcelManager
            (
                const NXString & excelFile /** Excel File Name */
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Tooling::ExcelManager * CreateExcelManager
            (
                const char * excelFile /** Excel File Name */
            );

            /// \endcond 
            /** Deletes tooling thread when deleting points in positioning feature
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void DeleteToolingThread
            (
                const std::vector<NXOpen::NXObject *> & threads /** the thread feature tag */
            );
            /** Adds tooling thread when adding points in positioning feature
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void AddToolingThread
            (
                NXOpen::NXObject * featureGroup /** the positioning feature tag */
            );
            /** Re-assigns attributes of a cooling concept point. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void ReassignCoolingConceptPointAttributes
            (
                NXOpen::Point * point /** The concept point */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::FastenerAssyObject * CreateFastenerAssyObject
            (
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void RefreshFastenerNavigator
            (
            );

            /// \endcond 
            /** Asks all product part names of current mold assembly @return  original product part names 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> AskAllProductPartNames
            (
                bool isToLoadProdNodeAssembly /** istoloadprodnodeassembly */ 
            );
            /**Sets edit context for the concept object
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetEditContextForConceptObject
            (
                NXOpen::NXObject * conceptObject /** The concept object in edit, it can be a symbol or a point*/
            );


            /** Returns the @link Tooling::LibraryInstallationCollection Tooling::LibraryInstallationCollection@endlink  instance belonging to this session 
             <br>  Created in NX2212.0.0.  <br>  
            */
            public: NXOpen::Tooling::LibraryInstallationCollection *LibraryInstallation();

            /// \cond NX_NO_DOC 
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
            */
            public: NXOpen::Tooling::ReuseLibraryNavigatorCollection *ReuseLibraryNavigator();
