...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ContinuityTypeOption </term> <description> 
        ...
        MeshTopologyOption </term> <description> 
         
        Aligned </description> </item> 

        <item><term> 
         
        SCMeshOption </term> <description> 
        ...
        SmoothingOption </term> <description> 
         
        Normal </description> </item> 

        <item><term> 
         
        StepCount </term> <description> 
         
        Number8 </description> </item> 

        <item><term> 
         
        TransformFactor </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  MeshTransformerBuilder : public NXOpen::Builder
        {
            ...
            public: enum SmoothingType
            {
                ...
                SmoothingTypeSuperLow/** Smoothing super low */
            };
            ...
            /**Returns  the option used in the builder for Simcenter 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool SCMeshOption
            (
            );
            /**Sets  the option used in the builder for Simcenter 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : sc_omnimesh (" OmniCAD Mesh Transformer for CAE") OR omnimesh_for_nx (" OmniCAD Mesh Transformer") */
            public: void SetSCMeshOption
            (
                bool useSCMethod /** usescmethod */ 
            );
            /** Gets the features created in the builder for Simcenter 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void GetFeatures
            (
                std::vector<NXOpen::NXObject *> & transformedFeatures /** The transformed features. */
            );
        };
    }
}
