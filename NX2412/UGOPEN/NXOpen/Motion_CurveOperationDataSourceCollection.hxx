    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  CurveOperationDataSourceCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::CurveOperationDataSource *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::CurveOperationDataSource **;
                using reference = NXOpen::CAE::CurveOperationDataSource *&;
