...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        enum RoutingBulkReplacementBuilderReplacementMethodType
        {
            ...
            RoutingBulkReplacementBuilderReplacementMethodTypeNone/** Replacement method not set yet */
        };
        ...
        enum RoutingBulkReplacementBuilderRetainReasonType
        {
            ...
            RoutingBulkReplacementBuilderRetainReasonTypeUnloadedConnectedComponents/** Retain reason is the object is connected to unloaded components */,
            RoutingBulkReplacementBuilderRetainReasonTypeSpaceReservationNotSupported/** Retain reason is the object is a space reservation which is not supported yet */,
            RoutingBulkReplacementBuilderRetainReasonTypePtsPartNotSupported/** Retain reason is the object is a PTS part which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypeFtsStockNotSupported/** Retain reason is the object is a FTS stock which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypeConnectedToDerivedObject/** Retain reason is the object is connected to a derived object or component which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypeNonLibraryTemplatePartNotSupoorted/** Retain reason is the object is template part which doesnt have library representation */,
            RoutingBulkReplacementBuilderRetainReasonTypeModuleAssembly/** Retain reason is the object is a Module Assembly which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypePtsPartWithWaveLinksNotSupported/** Retain reason is the object is a PTS part having wave links which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypeFtsStockConnectedWithWaveLinksNotSupported/** Retain reason is the object is a FTS stock connected with wave links which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypePatternComponent/** Retain reason is the object is a Pattern component which is not supported */,
            RoutingBulkReplacementBuilderRetainReasonTypeFlexPart/** Retain reason is that the partOcc contains flex definition */
        };
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  BulkReplacementBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::NXObject * objectTag /** The object for which to set the replacement object */,
                const NXString & partNumber /** The part number of the object to to set as the replacement object */
            );
            /** The replacement object part number method setter 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            (
                NXOpen::NXObject * objectTag /** The object for which to set the replacement object */,
                const char * partNumber /** The part number of the object to to set as the replacement object */
            );
            ...
            /** The method gets the part library values for a given attribute for the specified object  @return  The values retrieved from all the part library for the attribute 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
