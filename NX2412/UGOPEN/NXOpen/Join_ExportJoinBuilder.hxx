        ...
        */
        class JOINOPENCPPEXPORT  ExportJoinBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to use the CSYS associated with @link NXOpen::Join::ExportJoinBuilder::ReferenceCsys NXOpen::Join::ExportJoinBuilder::ReferenceCsys@endlink   
             ...
             <br> License requirements : nx_join (" NX Join") OR nx_join_structures (" Automated Structure Join") */
            public: bool UseSelectedCsys
            (
            );
            /**Sets  the option to use the CSYS associated with @link NXOpen::Join::ExportJoinBuilder::ReferenceCsys NXOpen::Join::ExportJoinBuilder::ReferenceCsys@endlink   
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") OR nx_join_structures (" Automated Structure Join") */
            public: void SetUseSelectedCsys
            (
            ...
            /**Sets  the reference CSYS for exported data.    
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_join (" NX Join") OR nx_join_structures (" Automated Structure Join") */
