...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        FaceToGroup.CloneEnabled </term> <description> 
        ...
        FaceToGroup.PatternEnabled </term> <description> 
        ...
        FaceToGroup.RigidBodyFaceEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToGroup.SameEntryEnabled </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        FaceToGroup.SameEntrySurfaceEnabled </term> <description> 
