        ...
        */
        class NXOPENCPP_LAYOUT2DEXPORT  PublishComponentBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the type of object to pblish. Can be definition or folder 
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_layout ("NX Layout") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  This property is no longer used. The type of object (definition or folder) is now determined by parsing <ja_pproperty>NXOpen.Layout2d.PublishComponentBuilder.OriginPath</ja_pproperty>") bool IsFolder
            (
            );
            /**Sets  the type of object to pblish. Can be definition or folder 
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_layout ("NX Layout") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  This property is no longer used. The type of object (definition or folder) is now determined by parsing <ja_pproperty>NXOpen.Layout2d.PublishComponentBuilder.OriginPath</ja_pproperty>") void SetFolder
            (
