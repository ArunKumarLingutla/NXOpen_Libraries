        ...
        */
        class NXOPENCPP_DESIGNSIMULATIONEXPORT  AnalysisLoadBuilder : public NXOpen::Builder
        {
            ...
            public: enum AnalysisLoadType
            {
                ...
                AnalysisLoadTypeRemoteForce/** remote force */ ,
                AnalysisLoadTypeHeatFlux/** heat flux */ 
            };
            ...
            /** Remote Load Type */
            public: enum RemoteForceType
            {
                RemoteForceTypeForce/** force */ ,
                RemoteForceTypeMoment/** moment */ ,
                RemoteForceTypeForceAndMoment/** force and moment */ 
            };
            ...
            /**Sets  the remote load type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") OR nx_perf_predictor (" Performance Predictor") */
            public: void SetRemoteForceOption
            (
                NXOpen::DesignSimulation::AnalysisLoadBuilder::RemoteForceType remoteForceOption /** remoteforceoption */ 
            );
            /**Returns  the remote point selection 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point * RemoteForcePoint
            (
            );
            /**Sets  the remote point selection 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") OR nx_perf_predictor (" Performance Predictor") */
            public: void SetRemoteForcePoint
            (
                NXOpen::Point * remotePoint /** remotepoint */ 
            );
            /**Returns  the analysis remote force type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::DesignSimulation::AnalysisLoadBuilder::AnalysisLoadForceType AnalysisRemoteForceType
            (
            );
            /**Sets  the analysis remote force type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") OR nx_perf_predictor (" Performance Predictor") */
            public: void SetAnalysisRemoteForceType
            (
                NXOpen::DesignSimulation::AnalysisLoadBuilder::AnalysisLoadForceType typeOfForce /** typeofforce */ 
            );
            ...
            /**Sets  the remote moment vector 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") OR nx_perf_predictor (" Performance Predictor") */
            public: void SetRemoteMomentVector
            (
                NXOpen::Direction * remoteMomentVector /** remotemomentvector */ 
            );
            ...
            /**Sets  the component CSYS 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : des_top_opt ("Topology Optimization for Designers") OR sc_des_topol_opt (" Topology Optimization for Designers") OR nx_perf_predictor (" Performance Predictor") */
            public: void SetComponentCSYS
            (
                NXOpen::CoordinateSystem * componentCSYS /** componentcsys */ 
            );
