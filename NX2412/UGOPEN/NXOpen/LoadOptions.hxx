    ...
    class NXOPENCPPEXPORT  LoadOptions
    {
        ...
        */
        ...
        /** Option to control how much data is loaded from parts.  The first four settings are equivalent
                ...
                and @link NXOpen::LoadOptions::UseLightweightRepresentations NXOpen::LoadOptions::UseLightweightRepresentations@endlink .

                When NX is connected to a Teamcenter database, then the final setting, minimal loading, is only effective if the
                database supports minimal loading capabilities.  If the database does not, then this setting behaves identically to the
                second-to-last setting, partial loading with lightweight display.
               
                For minimal loading following properties are not supported and hence should not be set to true.  If they are
                set in combination with minimal loading, they will be ignored (minimal loading will take priority).
                @link NXOpen::LoadOptions::SetInterpartData NXOpen::LoadOptions::SetInterpartData@endlink 
                @link NXOpen::LoadOptions::SetAbortOnFailure NXOpen::LoadOptions::SetAbortOnFailure@endlink 
        ...
        */
        public: enum LoadOption
        {
            ...
            LoadOptionMinimallyLoadLightweightDisplay/** minimally load lightweight display */ 
        };
        ...
        /**Sets  the option that controls the partial loading of components. A value of
            ...
            WARNING: @link NXOpen::LoadOptions::UsePartialLoading NXOpen::LoadOptions::UsePartialLoading@endlink  cannot distinguish between partial
            loading and minimal loading.  As of NX 12.0.2, @link NXOpen::LoadOptions::PartLoadOption NXOpen::LoadOptions::PartLoadOption@endlink 
        ...
        /**Sets  the option that controls if components are displayed with a lightweight 
            ...
            As of NX 12.0.2, it is recommended to use @link NXOpen::LoadOptions::PartLoadOption NXOpen::LoadOptions::PartLoadOption@endlink  instead.
        ...
        /**Sets  the option that specifies if the default reference set list should be
            ...
            to as "Apply to All Assembly Levels" in the User Interface. 
         <br>  Created in NX3.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Sets  
         ...
         <br> License requirements : None */
        public: void SetReferenceOnlyComponentLoadOption
        (
            bool refCompLoadOption /** refcomploadoption */ 
        );
        /**Returns  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: bool ReferenceOnlyComponentLoadOption
        (
        );
        ...
        public: void SetSecondaryComponentsLoadOption
        (
            bool option /** option */ 
        );
        ...
        /**Returns  This is an internal API and can be changed at any time 
         <br>  Created in NX2312.8000.0.  <br>  
         <br> License requirements : None */
        public: bool SecondaryComponentsLoadOption
        (
        );
