        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  InsertTextBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the text length 
             ...
             <br> License requirements : None */
            public: NXOpen::Expression * TextLength
            (
            );
            /**Returns  the width scale 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: double TextWScale
            (
            );
            /**Sets  the width scale 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetTextWScale
            (
            ...
            /**Sets  a flag indicating if aspect ratio is locked 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the text shear 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * TextShear
            (
            );
            ...
            (
                int textLayer /** textlayer */ 
            );
            /**Returns  the embossed text 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateEmbossedText
            (
            );
            /**Sets  the embossed text 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCreateEmbossedText
            (
                bool createEmbossedText /** createembossedtext */ 
            );
            /**Returns  the V-Shape engraving text 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateVShapeText
            (
            );
            /**Sets  the V-Shape engraving text 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCreateVShapeText
            (
                bool createVShapeText /** createvshapetext */ 
            );
            /**Returns  the text for components 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateComponentText
            (
            );
            /**Sets  the text for components 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCreateComponentText
            (
                bool createComponentText /** createcomponenttext */ 
            );
            /**Returns  the component text height 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ComponentTextHeight
            (
            );
            ...
            /** Updates the text UDO client data by type 
             <br>  @deprecated Deprecated in NX2007.0.0.  Use @link JA_TOOLING_INSERT_TEXT_BUILDER_UpdateTextUDOClientData JA_TOOLING_INSERT_TEXT_BUILDER_UpdateTextUDOClientData@endlink  instead. <br>  

             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Use JA_TOOLING_INSERT_TEXT_BUILDER_UpdateTextUDOClientData instead.") void UpdateTextUDOClientUIData
            (
                NXOpen::NXObject * udoTag /** the UDO tag */,
            ...
            /** Updates the text UDO client data by type 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void UpdateTextUDOClientData
            (
                int index /** the update item index */,
                bool previewText /** preview text or not */
            );
            ...
            /** Clears the redundant data. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CleanUpRedundantData
            (
            );
            /** Deletes all useless text udos. 
