...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PartCleanup : public NXOpen::TransientObject
    {
        ...
        /**Sets  the option that specifies if corrupt assembly structure objects should be deleted.
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: void SetDeleteCorruptAssemblyStructure
        (
            bool cleanupOption /** cleanupoption */ 
        );
        /**Returns  the option that specifies if corrupt assembly structure objects should be deleted.
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: bool DeleteCorruptAssemblyStructure
        (
        );
        /**Sets  the option that specifies whether to cleanup assembly component patterns.
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void SetCleanupAssemblyComponentPatterns
        (
            bool cleanupOption /** cleanupoption */ 
        );
        /**Returns  the option that specifies whether to cleanup assembly component patterns.
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: bool CleanupAssemblyComponentPatterns
        (
        );
        /**Sets  the option that specifies whether to delete mass properties.
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: void SetDeleteMassProperties
        (
            bool cleanupOption /** cleanupoption */ 
        );
        /**Returns  the option that specifies whether to delete mass properties.
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : None */
        public: bool DeleteMassProperties
        (
        );
