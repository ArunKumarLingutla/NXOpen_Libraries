    ...
    namespace BlockStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  ExpressionBlock : public NXOpen::BlockStyler::UIBlock
        {
            ...
            /**Returns  the RetainUnits. If true, indicates that the units in the block would be stored in dialog memory upon OK, Apply or Close. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool RetainUnits
            (
            );
            /**Sets  the RetainUnits. If true, indicates that the units in the block would be stored in dialog memory upon OK, Apply or Close. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: void SetRetainUnits
            (
                bool retain /** retain */ 
            );
