...
namespace NXOpen
{
    namespace CAM
    {
        ...
        /** Available types for trim behavior */

        /// \cond NX_NO_DOC 
        enum CutParametersTrimBehaviorTypes
        {
            CutParametersTrimBehaviorTypesDefault/** default behavior */,
            CutParametersTrimBehaviorTypesNcmTrimmed/** ncm trimmed */,
            CutParametersTrimBehaviorTypesFollowBoundary/** follow boundary*/
        };
        ...
        */
        enum CutParametersCornerFindingTypes
        {
            ...
            CutParametersCornerFindingTypesIncludeAdjacentPart/** Include Adjacent Part */,
            CutParametersCornerFindingTypesExtendOntoAdjacentPart/** Extend onto Adjacent Part */
        };
