    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  Post
        {
            ...
            {
                MarkComponentCombinationTypeNormal/** {XX, YY, ZZ} */,
                MarkComponentCombinationTypePrincipal/** {Min Principal, Mid Principal, Maximum Principal} */,
                MarkComponentCombinationTypeShear/** {XY, YZ, ZX, Maximum Shear, Maximum Shear 2D} */,
                MarkComponentCombinationTypeForce/** {Axial, ShearS, ShearT} */,
                MarkComponentCombinationTypeMoment/** {Torsion, BendingS, BendingT} */,
                MarkComponentCombinationTypePrincipal2D/** {Minimum Principal 2D, Maximum Principal 2D} */
            };
            ...
            struct Mark
            {
                ...
                public: /** Max Shear  */bool ShowTensorComponent4;
                public: /** Max Shear 2D*/bool ShowTensorComponent5;
                public: /** display component label with arrow */ bool DisplayComponentLabelWithArrow;
                public: /** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants.*/bool ShowArrowResultant;
                public: /** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants.*/NXOpen::CAE::Post::MarkResultantCompCombinationType MarkResultantCompCombinationType;
                public: Mark() :
                    ShowArrowXComponent(),
                    ShowArrowYComponent(),
                    ShowArrowZComponent(),
                ...
                public: Mark(bool showArrowXComponentInitial /** show arrow x component */ , 
                        ...
                        bool showTensorComponent4Initial /** Max Shear  */, 
                        bool showTensorComponent5Initial /** Max Shear 2D*/, 
                        bool displayComponentLabelWithArrowInitial /** display component label with arrow */ , 
                        bool showArrowResultantInitial /** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants.*/, 
                        NXOpen::CAE::Post::MarkResultantCompCombinationType markResultantCompCombinationTypeInitial /** The vector resultant components are restricted for use. Kindly turn on the customer EAF - EnableVectorResultantComponents for using vector resultants.*/) :
                    ...
                    ShowTensorComponent5(showTensorComponent5Initial),
            ...
            struct AnimationParameters
            {
                ...
                public: /** Animate deformation */bool Deformation;
                public: /** Save Frames In Memory */bool SaveFramesInMemory;
                public: /** Phase angle from user in case of complex option phase angle */double StartPhaseAngle;
                public: /** end phase angle */ double EndPhaseAngle;
                ...
                public: AnimationParameters(NXOpen::CAE::Post::AnimationType animationTypeInitial /** animation type */ , 
                        ...
                        bool deformationInitial /** Animate deformation */, 
                        bool saveFramesInMemoryInitial /** Save Frames In Memory */, 
                        double startPhaseAngleInitial /** Phase angle from user in case of complex option phase angle */, 
                        double endPhaseAngleInitial /** end phase angle */ ) :
                    AnimationType(animationTypeInitial),
                    AnimationStyle(animationStyleInitial),
                    NumberOfFrames(numberOfFramesInitial),
                    ...
                    Deformation(deformationInitial),
                    SaveFramesInMemory(saveFramesInMemoryInitial),
                    StartPhaseAngle(startPhaseAngleInitial),
                    EndPhaseAngle(endPhaseAngleInitial)
                {
                }
            };
            ...
            struct Spring
            {
             ...
             /** Nodal Force Report display settings */
            public:
            struct NodalForceReportDisplaySettings
            {
                public: /** display at centroid */ bool DisplayAtCentroid;
                public: NodalForceReportDisplaySettings() :
                    DisplayAtCentroid()
                {
                }
                /** Constructor for the NodalForceReportDisplaySettings struct. */ 
                public: NodalForceReportDisplaySettings(bool displayAtCentroidInitial /** display at centroid */ ) :
                    DisplayAtCentroid(displayAtCentroidInitial)
                {
                }
            };
            ...
            /** 
                       Gets the main post view id of active part in interactive mode.
                       <remark>
                       If there is no post view or only undisplayed post views, -1 is returned.
                       Post view id: It is same with the suffix number of the post view name in the post-processing navigator.
                       Main post view: The main post view is highlighed on the graphic window and 
                                       marked with prefix "(MAIN)" in the description in the post-processing navigator.
                       </remark> 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: int GetMainPostviewIdInActivePart
            (
            );
            /** Sets the main post view id of active part in interactive mode.
                        If the post view id doesn't exist or the post view is undisplayed, error is raised up.
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetMainPostviewIdInActivePart
            (
            ...
            /** Set the display at centroid option in the postview created from 'Nodal Force Report' force or moment summations. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void NodalForceReportSetDisplayAtCentroid
            (
                int postviewId /** postview id */ ,
                bool displayAtCentroid /**TRUE = centroid of nodes of 'Nodal Force Report'
                               FALSE = reference point of 'Nodal Force report' */
            );
            /** Get the display at centroid option in the postview created from 'Nodal Force Report' force or moment summations.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: bool NodalForceReportGetDisplayAtCentroid
            (
                int postviewId /** postview id */ 
            );
            /** Set the fringe style in the input postview id. Needs a PostviewUpdate call to take effect.
            ...
            /** Create a graph by extracting data from the input postview id, along an input path id 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  No replacement.") NXOpen::CAE::Post::GraphIds CreateSpatialGraph
            (
                int postviewId /** postview id */ ,
                const NXString & name /** name */ ,
            ...
            /** Create a graph by extracting data from the input postview id, at the input node label or point,
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  No replacement.") NXOpen::CAE::Post::GraphIds CreateHistoryGraph
            (
                int postviewId /** postview id */ ,
                const NXString & name /** name */ ,
                const NXOpen::CAE::Post::GraphParameters & graph /** graph */ ,
            ...
            /** Plot or Overlay the input graph specfied by graph_ids. 
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  No replacement.") void PlotGraph
            (
            ...
            /** Delete the input graph specfied by graph_ids.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2412.0.0.  No replacement.") void GraphDelete
            (
                const NXOpen::CAE::Post::GraphIds & graphIds /** graph ids */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXString CompareDisplayFilesSmart
            (
                const NXString & benchmarkFileName /** benchmark file name */ ,
                const NXString & testFileName /** test file name */ ,
                const NXOpen::CAE::Post::ASCIIDiffTolerances & tolerances /** tolerances */ 
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            NXString CompareDisplayFilesSmart
            (
                const char * benchmarkFileName /** benchmark file name */ ,
                const char * testFileName /** test file name */ ,
                const NXOpen::CAE::Post::ASCIIDiffTolerances & tolerances /** tolerances */ 
            ...
            /** Creates an Annotation builder object  @return  
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::PostAnnotationBuilder NXOpen::CAE::PostAnnotationBuilder@endlink  instead. <br>  

             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::PostAnnotationBuilder instead.") NXOpen::CAE::PostAnnotationBuilder * CreateAnnotationBuilder
            (
                int pvid /** pvid */ 
            );
            /** Creates an Annotation builder object  @return  
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostAnnotationBuilder * CreatePostAnnotationBuilder
            (
                int pvid /** pvid */ ,
                NXOpen::CAE::PostAnnotation * annotation /** annotation */ 
            );
            ...
            /** Inverts the display of elements for the given postview. 
                    
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void PostviewInvertDisplay
            (
                int pvid /** pvid */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: void ExportDisplayInAscii
            (
                int postviewId /** postview id */ ,
                const NXString & fileName /** file name */ ,
                bool ignoreClipping /** ignore clipping */ ,
                bool ignoreVisibility /** ignore visibility */ ,
                bool useDirectModelDisplay /** use direct model display */ 
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            void ExportDisplayInAscii
            (
                int postviewId /** postview id */ ,
                const char * fileName /** file name */ ,
                bool ignoreClipping /** ignore clipping */ ,
            ...
            /** Creates a builder to create a group. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostGroupBuilder * CreatePostGroupBuilder
            (
                int postViewId /** postviewid */ 
            );
            /** Creates @link NXOpen::CAE::ShowHideEntitiesBuilder NXOpen::CAE::ShowHideEntitiesBuilder@endlink  object. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::ShowHideEntitiesBuilder * CreateShowHideEntitiesBuilder
            (
                int postViewId /** postviewid */ 
            );
            /** Hides meshes in specified post views immediately. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void HidePostMeshes
            (
                const std::vector<int> & postviewIds /** postviewids */ ,
                const std::vector<NXOpen::CAE::PostMesh *> & meshes /** meshes */ 
            );
            /** Get post view ids which has same result ID as that of base postview ID. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<int> GetApplicablePostviewIds
            (
                int basePostviewId /** basepostviewid */ 
            );
            /** Creates @link NXOpen::CAE::MeshTranslucencyBuilder NXOpen::CAE::MeshTranslucencyBuilder@endlink  object. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::MeshTranslucencyBuilder * CreateMeshTranslucencyBuilder
            (
                int postviewId /** postviewid */ 
            );
            /** Ask @link NXOpen::CAE::PostPointManager NXOpen::CAE::PostPointManager@endlink  object. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostPointManager * AskPostPointManager
            (
            );
            /** Creates a builder to select post entities 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostSelectionBuilder * CreatePostSelectionBuilder
            (
            );
            /** Get post view IDs with the same result ID as the base post view ID from the selected post views. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: std::vector<int> GetPostViewsWithSameResult
            (
                int basePostViewId /** basepostviewid */ ,
                const std::vector<int> & selectedPvids /** selectedpvids */ 
            );
            ...
            */
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1980.0.0.  <br>  
            */
            public: NXOpen::CAE::PostDisplayManager *DisplayManager();

            /// \endcond 
            /** Returns the @link NXOpen::CAE::PostSmartSelectionManager NXOpen::CAE::PostSmartSelectionManager@endlink  belonging to this session 
             <br>  Created in NX2007.0.0.  <br>  
            */
            public: NXOpen::CAE::PostSmartSelectionManager *SmartSelectionManager();
