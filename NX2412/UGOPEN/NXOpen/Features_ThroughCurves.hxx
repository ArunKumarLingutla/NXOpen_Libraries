...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a Through Curves feature.  <br> To create or edit an instance of this class, use @link NXOpen::Features::ThroughCurvesBuilder1  NXOpen::Features::ThroughCurvesBuilder1 @endlink  <br> 
