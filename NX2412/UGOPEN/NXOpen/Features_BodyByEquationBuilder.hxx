    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  BodyByEquationBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the Maple plot3D variable index to export that defines the surface to be used in this feature. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: int PlotVariableName
            (
            );
            /**Sets  the Maple plot3D variable index to export that defines the surface to be used in this feature. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
