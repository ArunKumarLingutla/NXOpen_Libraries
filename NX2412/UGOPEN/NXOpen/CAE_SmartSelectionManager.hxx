...
#include <NXOpen/CAE_NonManifoldFaceMethod.hxx>
...
#include <NXOpen/CAE_RelatedMeshMatingMethod.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SmartSelectionManager
        {
            ...
            /** Creates a related mesh mating method 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::RelatedMeshMatingMethod * CreateRelatedMeshMatingMethodFromMethod
            (
                NXOpen::SelectionMethod * inputMethod /** input selection method */,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */
            );
            /** Creates a related mesh mating method 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::RelatedMeshMatingMethod * CreateRelatedMeshMatingMethodFromBodies
            (
                const std::vector<NXOpen::CAE::CAEBody *> & seeds /** seed bodies*/,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */
            );
            /** Creates a related mesh mating method 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::RelatedMeshMatingMethod * CreateRelatedMeshMatingMethodFromFaces
            (
                const std::vector<NXOpen::CAE::CAEFace *> & seeds /** seed faces*/,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */
            );
            /** Creates a non manifold face method 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::NonManifoldFaceMethod * CreateNonManifoldFaceMethodFromMethod
            (
                NXOpen::SelectionMethod * inputMethod /** input selection method */,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */
            );
            /** Creates a non manifold face method 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::NonManifoldFaceMethod * CreateNonManifoldFaceMethodFromBodies
            (
                const std::vector<NXOpen::CAE::CAEBody *> & seeds /** seed bodies*/,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */
            );
            /** Creates a non manifold face method 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::NonManifoldFaceMethod * CreateNonManifoldFaceMethodFromFaces
            (
                const std::vector<NXOpen::CAE::CAEFace *> & seeds /** seed faces*/,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */
            );
            ...
            /** Creates a filter body method 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::FilterBodyMethod * CreateFilterBodyMethodWithExpression
            (
                const std::vector<NXOpen::CAE::CAEBody *> & seeds /** seed bodies*/,
                NXOpen::PhysicalMaterial * material /** material*/,
                bool filterbyVolume /** filter by volume */,
                double minVolume /** minimum volume*/,
                NXOpen::Expression * minVolExp /** minimum volume expression*/,
                double maxVolume /** maximum volume*/,
                NXOpen::Expression * maxVolExp /** maximum volume expression*/,
                NXOpen::CAE::BodyType bodyType /** type of body*/
            );
            ...
            /** Creates a related node method 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::RelatedNodeMethod * CreateNewRelatedNodeMethodFromCsys
            (
                const std::vector<NXOpen::CoordinateSystem *> & seedTags /** seed csys*/,
                bool doEntityVisibilityCheck /** if true, visible entities will be returned */,
                bool selectOnlyCornerNodes /** if true, only corner nodes will be returned */
            );
