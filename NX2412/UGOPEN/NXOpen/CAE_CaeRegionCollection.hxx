...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeRegionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::CaeRegion *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::CaeRegion **;
                using reference = NXOpen::CAE::CaeRegion *&;
            ...
            (
                const NXString & descriptorName /** Name of the region descriptor */,
                const NXString & name /** Name of the region  */,
            ...
            (
                const char * descriptorName /** Name of the region descriptor */,
