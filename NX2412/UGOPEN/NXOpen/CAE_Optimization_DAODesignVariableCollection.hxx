        ...
        namespace Optimization
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  DAODesignVariableCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::Optimization::DAODesignVariable *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::Optimization::DAODesignVariable **;
                    using reference = NXOpen::CAE::Optimization::DAODesignVariable *&;
