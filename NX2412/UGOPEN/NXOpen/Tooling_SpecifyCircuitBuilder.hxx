...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        SearchBoundaryBodies </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SpecifyCircuitBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the standard part component which is selected to be edited. 
             ...
             <br> License requirements : None */
            public: NXOpen::SelectNXObject * CoolingStandardPart
            (
            );
            ...
            /**Removes all temporary solids and lines and removes the attribute on the channels
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link RemoveTemporaryData RemoveTemporaryData@endlink  instead. <br>  

             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use RemoveTemporaryData instead.") void RemoveAttributesAndTemporaryData
            (
            ...
            (
                NXOpen::Assemblies::Component * coolingPart /**cooling component tag */,
                NXOpen::Point * fittingPoint /**point tag */
            );
            /** Records all the solid bodies in current display part 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void SetAllBodies
            (
                const std::vector<NXOpen::Body *> & bodies /** bodies */ 
            );
            /** Create fitting points by intersection with boundary bodies 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void CreatePointsWithBoundary
            (
            );
            /** Updates the parameters of the concept point
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void UpdateConceptPointParameters
            (
                NXOpen::Point * point /** The concept point */,
                NXOpen::Tooling::SpreadsheetData * templateData /** Spreadsheet data */
            );
            /** Inserts a concept symbol
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void InsertConceptSymbol
            (
                NXOpen::Point * point /** The concept point */
            );
        };
