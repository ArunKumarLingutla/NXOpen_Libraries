    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  AnalyticalContactCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Motion::AnalyticalContact *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Motion::AnalyticalContact **;
                using reference = NXOpen::Motion::AnalyticalContact *&;
            ...
            /**  @brief 
                            Creates an @link NXOpen::Motion::AnalyticalContactBuilder NXOpen::Motion::AnalyticalContactBuilder@endlink  for multi editing
             ...
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::AnalyticalContactBuilder * CreateMultiEditAnalyticalContactBuilder
            (
                const std::vector<NXOpen::Motion::AnalyticalContact *> & analyticalContacts /** analyticalcontacts */ 
            );
