...
namespace NXOpen
{
    ...
    namespace Issue
    {
        ...
        */
        class NXOPENCPP_ISSUEEXPORT  IssueListCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Issue::IssueList *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Issue::IssueList **;
                using reference = NXOpen::Issue::IssueList *&;
                ...
                NXOPENCPP_ISSUEEXPORT  value_type operator * () const;
            ...
            /** Finds the @link NXOpen::Issue::IssueList NXOpen::Issue::IssueList@endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link NXOpen::Issue::IssueList NXOpen::Issue::IssueList@endlink  with this name. 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_issue_mgmt ("NX Issue Tracking") */
            public: NXOpen::Issue::IssueList * FindObject
            (
                const NXString & name /** The name of the @link NXOpen::Issue::IssueList NXOpen::Issue::IssueList@endlink . */
            );
            /** Finds the @link NXOpen::Issue::IssueList NXOpen::Issue::IssueList@endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link NXOpen::Issue::IssueList NXOpen::Issue::IssueList@endlink  with this name. 
             <br>  Created in NX8.5.0.  <br>  
            ...
            (
                const char * name /** The name of the @link NXOpen::Issue::IssueList NXOpen::Issue::IssueList@endlink . */
            );
