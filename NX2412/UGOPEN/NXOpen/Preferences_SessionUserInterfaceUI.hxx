...
namespace NXOpen
{
    ...
    namespace Preferences
    {
        ...
        */
        ...
        {
            /** Describes the NX user interface theme */
            public: enum NxThemeTypes
            {
                NxThemeTypesLight/** light */ ,
                NxThemeTypesLightGray/** light gray */ ,
                NxThemeTypesDark/** dark */ ,
                NxThemeTypesClassic/** classic */ 
            };
            ...
            /**Returns  the nx theme option 
             ...
             <br> License requirements : None */
            public: NXOpen::Preferences::SessionUserInterfaceUI::NxThemeTypes NxTheme
            (
            );
