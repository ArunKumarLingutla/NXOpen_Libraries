...
namespace NXOpen
{
    namespace AME
    {
        ...
        enum PlcDataTypeSource
        {
            ...
            PlcDataTypeSourceUnknown/** unknown */ ,
            PlcDataTypeSourceArray/** array */ 
        };
        ...
        /**
                Definition of type of Interface Section
            */
        enum PlcInterfaceSectionType
        {
            PlcInterfaceSectionTypeInput/** input */ ,
            PlcInterfaceSectionTypeOutput/** output */ ,
            PlcInterfaceSectionTypeInout/** inout */ ,
            PlcInterfaceSectionTypeStatic/** static */ ,
            PlcInterfaceSectionTypeTemp/** temp */ ,
            PlcInterfaceSectionTypeConst/** const */ ,
            PlcInterfaceSectionTypeReturn/** return */ ,
            PlcInterfaceSectionTypeNone/** none */ ,
            PlcInterfaceSectionTypeUnknown/** unknown */ 
        };

        /**
                Definition of PLC Flow Chart Node type.
            */
        enum PlcFlowChartNodeType
        {
            PlcFlowChartNodeTypeInvalid/** invalid */ ,
            PlcFlowChartNodeTypeIdb/** idb */ ,
            PlcFlowChartNodeTypeFc/** fc */ ,
            PlcFlowChartNodeTypeFci/** fci */ ,
            PlcFlowChartNodeTypeAnd/** and */ ,
            PlcFlowChartNodeTypeOr/** or */ ,
            PlcFlowChartNodeTypeNot/** not */ ,
            PlcFlowChartNodeTypeEqual/** equal */ ,
            PlcFlowChartNodeTypeLessthan/** lessthan */ ,
            PlcFlowChartNodeTypeGreaterthan/** greaterthan */ ,
            PlcFlowChartNodeTypeLessthanequal/** lessthanequal */ ,
            PlcFlowChartNodeTypeGreaterthanequal/** greaterthanequal */ ,
            PlcFlowChartNodeTypeAdd/** add */ ,
            PlcFlowChartNodeTypeSub/** sub */ ,
            PlcFlowChartNodeTypeRead/** read */ ,
            PlcFlowChartNodeTypeWrite/** write */ ,
            PlcFlowChartNodeTypeReadwrite/** readwrite */ 
        };

        /**
                Definition of PLC Logic Block Node type.
            */
        enum PlcLogicBlockNodeType
        {
            PlcLogicBlockNodeTypeInvalid/** invalid */ ,
            PlcLogicBlockNodeTypeAnd/** and */ ,
            PlcLogicBlockNodeTypeOr/** or */ ,
            PlcLogicBlockNodeTypeRead/** read */ ,
            PlcLogicBlockNodeTypeWrite/** write */ 
        };
