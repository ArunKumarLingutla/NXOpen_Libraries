        ...
        */
        class AMEOPENCPPEXPORT  ImportEClassMappingBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the eClass version
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString EclassVersion
            (
            );
            /**Sets  the eClass version
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetEclassVersion
            (
                const NXString & eclassVersion /** eclassversion */ 
            );
            /**Sets  the eClass version
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            void SetEclassVersion
            (
                const char * eclassVersion /** eclassversion */ 
            );
        };
    }
}
