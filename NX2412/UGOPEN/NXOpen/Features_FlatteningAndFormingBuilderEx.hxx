        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FlatteningAndFormingBuilderEx : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum Constraints
            {
                ...
                ConstraintsFixedArcLength/** fixed arc length */ 
            };

            /** The accuracy options */
            public: enum AccuracyOptions
            {
                AccuracyOptionsCoarse/** coarse */ ,
                AccuracyOptionsStandard/** standard */ ,
                AccuracyOptionsFine/** fine */ ,
                AccuracyOptionsExtraFine/** extra fine */ 
            };
            ...
            /**Returns  the accuracy 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::FlatteningAndFormingBuilderEx::AccuracyOptions Accuracy
            (
            );
            /**Sets  the accuracy 
             <br>  Created in NX2206.0.0.  <br>  
            ...
            (
                NXOpen::Features::FlatteningAndFormingBuilderEx::AccuracyOptions accuracy /** accuracy */ 
            );
        };
    }
}
