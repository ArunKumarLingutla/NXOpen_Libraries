    ...
    namespace RoutingCommon
    {
        ...
        */
        class NXOPENCPP_ROUTINGCOMMONEXPORT  CustomManager
        {
            ...
            public: /** This defines the prototype for the Spool name plugin.
                        It is this plugin's responsibility to ensure spool name uniqueness.
            ...
            public: /** This defines the prototype for the spool assembly name plugin.
                        It is this plugin's responsibility to ensure spool assembly name uniqueness.
            ...
            /** Removes all the registered design rules, except those configured in the Application View file. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            /** Removes any registered wiring component name plugin, except one configured in the Application View file. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void RemoveWiringComponentNamePlugin
            (
            );
            /** Sets the spool name plugin.
                        Will throw an error if one is already registered.
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetSpoolNamePlugin
            (
                const NXOpen::RoutingCommon::CustomManager::SpoolNamePlugin&  spoolNamePlugin /** The method you want Routing to call to get the spool name. */
            );
            /** Removes any registered spool name plugin. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void RemoveSpoolNamePlugin
            (
            );
            /** Sets the spool assembly name plugin.
                        Will throw an error if one is already registered.
                    
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetSpoolAssemblyNamePlugin
            (
                const NXOpen::RoutingCommon::CustomManager::SpoolAssemblyNamePlugin&  assemblyNamePlugin /** The method you want Routing to call to get the spool assembly name. */
            );
            /** Removes any registered spool assembly name plugin. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void RemoveSpoolAssemblyNamePlugin
            (
            );
