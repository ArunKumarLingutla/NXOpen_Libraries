    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DataSourceCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::DataSource *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::DataSource **;
                using reference = NXOpen::CAE::DataSource *&;
            ...
            /** Finds a @link NXOpen::CAE::DataSource NXOpen::CAE::DataSource@endlink  with the specified name. 
             <br>  Created in NX12.0.0.  <br>  
            ...
            /**Creates a @link NXOpen::CAE::DataSourceBuilder NXOpen::CAE::DataSourceBuilder@endlink  that will be used to create a data source
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::DataSourceBuilder * CreateDataSourceBuilder
            (
            );
            /**Creates a @link NXOpen::CAE::DataSourceBuilder NXOpen::CAE::DataSourceBuilder@endlink  that will be used to edit a data source
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /**Clears any cache held by Application Specific Post Processing with regards to the managed Data Sources.
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::DataSource * CreateDemoDataSource
            (
                std::vector<NXString> & dataDefinitions /** datadefinitions */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::DataSource * CreateMisbehavingDataSource
            (
                int flags /** flags */ 
            );
