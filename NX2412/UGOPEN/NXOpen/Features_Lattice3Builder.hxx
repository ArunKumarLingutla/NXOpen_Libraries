...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        AveragePoreSize.Value </term> <description> 
         
        10 (millimeters part), 0.40 (inches part) </description> </item> 
        ...
        MaximumPoreSize.Value </term> <description> 
         
        14 (millimeters part), 0.56 (inches part) </description> </item> 

        <item><term> 
         
        MaximumSpikeAngle.Value </term> <description> 
         
        45 </description> </item> 

        <item><term> 
         
        MinimumPoreSize.Value </term> <description> 
         
        6 (millimeters part), 0.24 (inches part) </description> </item> 
        ...
        PoreSizeDistribution </term> <description> 
        ...
        SpikeLength.Value </term> <description> 
         
        5 (millimeters part), 0.2 (inches part) </description> </item> 

        <item><term> 
         
        StandardDeviation.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  Lattice3Builder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum BlendsOptions
            {
                ...
                BlendsOptionsAbsoluteSize/** absolute size */ ,
                BlendsOptionsOrganic/** As of NX2412, the Organic blend specifier has been deprecated. Please use the Relative blend specifier instead.*/,
                BlendsOptionsRelativeSize/** relative size */  = 2
            };

            /** @brief  This enum represents the options to specify the distribution used for generating the sizes of the Voronoi pores 

              */
            public: enum PoreSizeDistributionType
            {
                PoreSizeDistributionTypeUniform/** uniform */ ,
                PoreSizeDistributionTypeVariable/** variable */ ,
                PoreSizeDistributionTypeGaussian/** gaussian */ 
            };
            ...
            /**Returns   @brief the factor of relative blending to rod diameter 

             
                        
                        The factor will be multiplied with the rod diameter to define the organic/relative blending for creating the lattice body, unless a ball diameter is provided,
                        ...
                        @link NXOpen::Features::Lattice3Builder::BlendsOptionsOrganic NXOpen::Features::Lattice3Builder::BlendsOptionsOrganic@endlink  or 
                        @link NXOpen::Features::Lattice3Builder::BlendsOptionsRelativeSize NXOpen::Features::Lattice3Builder::BlendsOptionsRelativeSize@endlink .
            ...
            /**Returns   @brief the blend radius for the absolute blends 

             
                        
                        The expression supports the usage of variable fields same as for rod diameter and absolute ball diameter and is used when
                        (@link Features::Lattice3Builder::BlendsOption Features::Lattice3Builder::BlendsOption@endlink ) is set to 
                        @link NXOpen::Features::Lattice3Builder::BlendsOptionsAbsoluteSize NXOpen::Features::Lattice3Builder::BlendsOptionsAbsoluteSize@endlink .
                         
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Fields::ScalarFieldWrapper * BlendRadiusField
            (
            );
            ...
            /**Returns  the Voronoi pore size distribution 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::Lattice3Builder::PoreSizeDistributionType PoreSizeDistribution
            (
            );
            /**Sets  the Voronoi pore size distribution 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_lattice_designer (" NX Lattice Designer") */
            public: void SetPoreSizeDistribution
            (
                NXOpen::Features::Lattice3Builder::PoreSizeDistributionType poreSizeDistribution /** poresizedistribution */ 
            );
            /**Returns  the average Voronoi pore size 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * AveragePoreSize
            (
            );
            /**Returns  the standard deviation for Voronoi pore sizes 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * StandardDeviation
            (
            );
            /**Returns  the minimum pore size for Voronoi features 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MinimumPoreSize
            (
            );
            /**Returns  the maximum pore size for Voronoi features 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MaximumPoreSize
            (
            );
            /**Returns  @brief  The CreateSpikes determines whether spikes will be created at the selected faces.  

             
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateSpikes
            (
            );
            /**Sets  @brief  The CreateSpikes determines whether spikes will be created at the selected faces.  

             
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_lattice_designer (" NX Lattice Designer") */
            public: void SetCreateSpikes
            (
                bool createSpikes /** createspikes */ 
            );
            /**Returns  the faces to create spikes 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * SpikeFaces
            (
            );
            /**Returns  the length of spikes 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * SpikeLength
            (
            );
            /**Returns  the maximum angle of spikes with local face normal 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * MaximumSpikeAngle
            (
            );
        };
    }
