    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CfdLocalResolutionConstraintCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::CfdLocalResolutionConstraint *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::CfdLocalResolutionConstraint **;
                using reference = NXOpen::CAE::CfdLocalResolutionConstraint *&;
