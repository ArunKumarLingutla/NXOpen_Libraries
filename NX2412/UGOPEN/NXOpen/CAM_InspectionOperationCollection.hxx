...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents the CMM Inspection operation collection  <br> To obtain an instance of this class, refer to @link NXOpen::CAM::InspectionSetup  NXOpen::CAM::InspectionSetup @endlink  <br> 
         <br>  Created in NX7.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  InspectionOperationCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAM::InspectionOperation *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAM::InspectionOperation **;
                using reference = NXOpen::CAM::InspectionOperation *&;
            ...
            (
                ...
                const NXString & featureName /** Feature name */
            );
            /** Sets the Inspection Feature referenced in an Inspection Path. 
             <br>  Created in NX7.5.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            ...
            /** Creates a CMM Inspection Analyze Save To Layer dialog builder  @return  Save To Layer Dialog builder created 
             <br>  Created in NX9.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionSaveToLayerBuilder * CreateInspectionSaveToLayerBuilder
            (
                NXOpen::CAM::CAMObject * param /** not used */
            );
            /** Creates a CMM Inspection Analyze Save To Layer dialog builder with selected operations  @return  Save To Layer Dialog builder created 
             <br>  Created in NX9.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionSaveToLayerBuilder * CreateInspectionSaveToLayerBuilderSel
            (
                const std::vector<NXOpen::CAM::CAMObject *> & selOps /** array of selected operations */
            );
            /** Creates a CMM Inspection Delete Analyze Points dialog builder with selected operations  @return  Delete Analyze Points Dialog builder created 
             <br>  Created in NX9.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionDeleteMeaPtsBuilder * CreateInspectionDeleteMeaPtsBuilderSel
            (
                const std::vector<NXOpen::CAM::CAMObject *> & selOps /** array of selected operations */
            );
            /** Creates a CMM Inspection Operation Transform dialog builder  @return  created Transform Builder 
             <br>  Created in NX9.0.3.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionOperationTransformBuilder * CreateInspectionOperationTransformBuilder
            (
                const std::vector<NXOpen::CAM::CAMObject *> & objectsToTransform /** array of objects to transform */
            );
            /** Creates a CMM Inspection Operation Alignment Assistant builder @return  Alignment Assistant Dialog builder created 
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionAlignmentAssistantBuilder * CreateInspectionAlignmentAssistantBuilder
            (
                NXOpen::CAM::CAMObject * param /** Object to be edited */
            );
            /** Creates a CMM Inspection Graphical Report operation builder  @return  Graphical report builder created 
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionGraphicalReportBuilder * CreateGraphicalReportBuilder
            (
                NXOpen::CAM::CAMObject * param /** Graphical Report operation to be edited */
            );
            /** Creates a CMM Inspection Output Graphical Report builder  @return  Graphical report output builder created 
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionGraphicalReportOutputBuilder * CreateGraphicalReportOutputBuilder
            (
                const std::vector<NXOpen::CAM::CAMObject *> & objectsToOutput /** array of report objects to output */
            );
            /** Creates a CMM Inspection Graphical Report Variable builder  @return  Graphical variable builder created 
             <br>  Created in NX11.0.2.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionGraphicalVariableBuilder * CreateGraphicalVariableBuilder
            (
            );
            /** Creates a CMM Inspection Import Dmis builder @return  Import Dmis Dialog builder created 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionImportDmisBuilder * CreateImportDmisBuilder
            (
                NXOpen::CAM::InspectionGroup * programGroup /** the program group to place newly created operations */
            );
            /** Creates a CMM Inspection Verify Program builder @return  Verify Program Dialog builder created 
             <br>  Created in NX1880.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionVerifyProgramBuilder * CreateVerifyProgramBuilder
            (
            );
            /** Creates a CMM Inspection Resequence Paths builder @return  Resequence Paths Dialog builder created 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionResequencePathsBuilder * CreateResequencePathsBuilder
            (
            );
            /** Creates a CMM Inspection Mass Edit builder @return  Mass Edit Dialog builder created 
             <br>  Created in NX1984.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionMassEditBuilder * CreateMassEditBuilder
            (
            );
            /** Creates a Inspection Operation path builder  @return  operation builder created 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: NXOpen::CAM::InspectionOperationBuilder * CreateInspectionOperationBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
