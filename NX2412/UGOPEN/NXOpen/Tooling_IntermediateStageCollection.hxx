    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  IntermediateStageCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Tooling::IntermediateStageBuilder *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Tooling::IntermediateStageBuilder **;
                using reference = NXOpen::Tooling::IntermediateStageBuilder *&;
