...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        ...
        {
            /** the display symbol type for global edge density */
            public: enum DisplayType
            {
                DisplayTypeStandard/** standard */ ,
                DisplayTypeNodeLocationsWithFilledCircle/** node locations with filled circle */ 
            };
            ...
            /**Returns  the crack face separation condition size 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: int CrackFaceConditionSize
            (
            );
            /**Sets  the crack face separation condition size 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetCrackFaceConditionSize
            (
                int crackFaceConditionSize /** crackfaceconditionsize */ 
            );
            /**Returns  the edge density display type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::MeshControlDisplayOptionsBuilder::DisplayType EdgeDensityDisplayType
            (
            );
            /**Sets  the edge density display type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetEdgeDensityDisplayType
            (
                NXOpen::CAE::MeshControlDisplayOptionsBuilder::DisplayType eEdgeDensityDisplayType /** eedgedensitydisplaytype */ 
            );
            /**Returns  the global symbol size factor 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: double GlobalSymbolSizeFactor
            (
            );
            /**Sets  the global symbol size factor 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void SetGlobalSymbolSizeFactor
            (
                double globalSizeFactor /** globalsizefactor */ 
            );
        };
    }
}
