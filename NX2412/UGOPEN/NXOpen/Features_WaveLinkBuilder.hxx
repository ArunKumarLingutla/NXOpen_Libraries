...
#include <NXOpen/Features_LinkLargeScaleGeometryBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        CompositeCurveBuilder.HideOriginal (deprecated) </term> <description> 
        ...
        ExtractFaceBuilder.CopyGroups </term> <description> 
        ...
        LinkLargeScaleGeometryBuilder.Associative </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        LinkLargeScaleGeometryBuilder.ContextIndependent </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LinkLargeScaleGeometryBuilder.Type </term> <description> 
        ...
        MirrorBodyBuilder.CopyGroups </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  WaveLinkBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum Types
            {
                ...
                TypesLargeScaleBodyLink/** large scale body link */ ,
                TypesLargeScaleFaceLink/** large scale face link */ 
            };
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::LinkLargeScaleGeometryBuilder * LinkLargeScaleGeometryBuilder
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetLinkLargeScaleGeometryBuilder
            (
                NXOpen::Features::LinkLargeScaleGeometryBuilder * linkLargeScaleGeometryBuilder /** linklargescalegeometrybuilder */ 
            );
            ...
            /**Returns  the copy face groups option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool CopyGroups
            (
            );
            /**Sets  the copy face groups option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetCopyGroups
            (
                bool copyGroups /** copygroups */ 
            );
            /**Returns  the inherit material from source option 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool InheritMaterial
            (
            );
            /**Sets  the inherit material from source option 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetInheritMaterial
            (
                bool inheritMaterial /** inheritmaterial */ 
            );
        };
    }
}
