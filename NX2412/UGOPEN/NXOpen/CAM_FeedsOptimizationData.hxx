...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        ...
        {
            /** The feed rate optimization method */
            public: enum OptimizationMethods
            {
                OptimizationMethodsMaterialRemovalRate/** Based on the material removal rate */,
                OptimizationMethodsForce/** Based on the cutting force */,
                OptimizationMethodsTorque/** Based on the cutting torque */
            };
            ...
            /**Returns  the optimization method used during feed rate optimization 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::FeedsOptimizationData::OptimizationMethods OptimizationMethod
            (
            );
            /**Sets  the optimization method used during feed rate optimization 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetOptimizationMethod
            (
                NXOpen::CAM::FeedsOptimizationData::OptimizationMethods optimizationMethod /** optimizationmethod */ 
            );
            ...
            /**Returns  the optimized non-cutting feed rate switch 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool OptimizeNonCuttingFeedRate
            (
            );
            /**Sets  the optimized non-cutting feed rate switch 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetOptimizeNonCuttingFeedRate
            (
                bool optNonCuttingFeedRate /** optnoncuttingfeedrate */ 
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: double NominalChipThickness
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetNominalChipThickness
            (
                double nominalChipThickness /** nominalchipthickness */ 
            );
