    ...
    namespace Die
    {
        ...
        */
        class NXOPENCPP_DIEEXPORT  DieCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** Creates a trim steel parameters builder @link NXOpen::Die::TrimSteelParametersBuilder NXOpen::Die::TrimSteelParametersBuilder@endlink . 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") OR ug_die_design ("Die Design") */
            public: NXOpen::Die::TrimSteelParametersBuilder * CreateTrimSteelParametersBuilder
            (
            );
