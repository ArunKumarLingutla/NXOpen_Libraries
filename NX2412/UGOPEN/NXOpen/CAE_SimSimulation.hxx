...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class ResultVariableCollection;
    }
    namespace CAE
    {
        class SimBC;
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimSimulation : public NXOpen::NXObject
        {
            ...
            */
            ...
            /** Returns the Result Variable collection belonging to this sim part 
             <br>  Created in NX2406.0.0.  <br>  
            */
            public: NXOpen::CAE::ResultVariableCollection *ResultVariables();
