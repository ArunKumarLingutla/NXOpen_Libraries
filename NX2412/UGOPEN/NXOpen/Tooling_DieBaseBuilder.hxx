...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AlongXDirection </description> </item> 

        <item><term> 
         
        Catalog </term> <description> 
         
        Dme </description> </item> 
        ...
        DbEdgeDistance </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DbRefPointX </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DbRefPointY </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DesignToolOpt </term> <description> 
         
        Split </description> </item> 

        <item><term> 
         
        DieBaseType </term> <description> 
         
        Pdw </description> </item> 

        <item><term> 
         
        FirstLength </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        GapFirst </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        GapSecond </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LoadDBOnly </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        OpenDist </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ParentNode </term> <description> 
         
        Control </description> </item> 

        <item><term> 
         
        PlateLength </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PlateWidth </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PlatesNumber </term> <description> 
         
        PlateNine </description> </item> 
        ...
        SecondLength </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SplitGap </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SplitSubSingle </term> <description> 
         
        WholeSubDiebase </description> </item> 
        ...
        StripTravelDistance </term> <description> 
        ...
        StandardDieBase </description> </item> 

        <item><term> 
         
        UpdateDieBasePosition </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        XDistanceFirst </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        XDistanceSecond </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DieBaseBuilder : public NXOpen::Builder
        {
            ...
            public: enum DesignToolOption
            {
                ...
                DesignToolOptionComplexSplitting/** complex split sub die base */,
            ...
            {
                SplitOptionStandard/** standard */ ,
                SplitOptionUserDefined/** user defined */ 
            };
            ...
            /**Returns  the selected die base or sub die base. 
             ...
             <br> License requirements : None */
            public: NXOpen::SelectBodyList * DieBaseOrSubDieBase
            (
            );
            /**Returns  the select sub-die base sketch 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectSketchList * SelectSubDieBaseSketch
            (
            );
            ...
            /**Returns  the option whether update die base position or not. 
             ...
             <br> License requirements : None */
            public: bool UpdateDieBasePosition
            (
            );
            /**Sets  the option whether update die base position or not. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            public: void SetUpdateDieBasePosition
            (
                bool updateDieBasePosition /** updatediebaseposition */ 
            );
            ...
            /**Returns  the selected die plates. 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectPartList * SelectPlateToSplit
            (
            );
            ...
            /**Returns  the standard or user defined split option 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::DieBaseBuilder::SplitOption StandardOrUserDefined
            (
            );
            ...
            (
                NXOpen::Tooling::DieBaseBuilder::SplitOption standardOrUserDefined /** standardoruserdefined */ 
            );
            /**Returns  the create splitting curves 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * CreateSplittingCurves
            (
            );
            ...
            (
                const NXString & catalogName /** Specifies the catalog name */
            );
            /**Sets  the catalog name. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            void SetCatalogName
            (
                const char * catalogName /** Specifies the catalog name */
            );
            /**Returns  the new die base part name. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXString PlateTypeName
            (
            );
            /**Sets  the new die base part name. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            public: void SetPlateTypeName
            (
                const NXString & plateTypeName /** Specifies the plate type name */
            );
            /**Sets  the new die base part name. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            void SetPlateTypeName
            (
                const char * plateTypeName /** Specifies the plate type name */
            );
            /**Returns  the value to determine whether the UI is launched from reuse library. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsLaunchFromReuseLibrary
            (
            );
            /**Sets  the value to determine whether the UI is launched from reuse library. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            public: void SetLaunchFromReuseLibrary
            (
                bool isLaunchFromReuseLibrary /** islaunchfromreuselibrary */ 
            );
            /** Gets the data provider for plate table 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::DieBaseDataProvider * GetDieBaseDataProvider
            (
            );
            /**Returns  the die plate to edit. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectPart * SelectPlateToEdit
            (
            );
            /**Returns  the name rule of complex splitting. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXString NameRule
            (
            );
            /**Sets  the name rule of complex splitting. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            public: void SetNameRule
            (
                const NXString & nameRule /** Specifies the name rule for complex splitting */
            );
            /**Sets  the name rule of complex splitting. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") OR nx_engineering_die_wizard ("NX Engineering Die Wizard") */
            void SetNameRule
            (
                const char * nameRule /** Specifies the name rule for complex splitting */
            );
            ...
            /** The action to extrude sketchs to sheet body. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * ExtrudeSketchCurvesToSheetBody
            (
                NXOpen::NXObject * platePart /** platepart */ 
            );
            /** The action to edit extrude sheet body feature. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void EditExtrudeSheetBodyFeature
            (
                NXOpen::NXObject * platePart /** platepart */ ,
                NXOpen::NXObject * extrudeSheetBody /** extrudesheetbody */ 
            );
            /** The action to split solid body by sheet body in plate part. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SplitSolidBodyBySheetBody
            (
                NXOpen::NXObject * platePart /** platepart */ ,
            ...
            /** The action to edit split body feature. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void EditSplitSolidBodyFeature
            (
                NXOpen::NXObject * platePart /** platepart */ ,
                NXOpen::NXObject * featureTag /** featuretag */ 
            );
            /** The action to wave link common parent sketch to individual part. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * WaveLinkSketchToIndividualPlate
            (
                NXOpen::NXObject * platePart /** platepart */ ,
            ...
            /** The action to edit linked sketch in part. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void EditLinkedSketchInIndividualPlate
            (
                NXOpen::NXObject * platePart /** platepart */ ,
                NXOpen::NXObject * sketchFeatureTag /** sketchfeaturetag */ ,
                NXOpen::NXObject * linkedSketchFeat /** linkedsketchfeat */ 
            );
            /** The action to wave split sheet body in multiple plates common parent part to invividual plate. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void WaveSplitSheetBodyToIndividualPlate
            (
                NXOpen::NXObject * parentPart /** parentpart */ ,
                NXOpen::NXObject * platePart /** platepart */ ,
                bool originalSubDieBaseOrPlate /** originalsubdiebaseorplate */ 
            );
            /** The action to replace select curves. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * CopySelectCurvesToWorkPart
            (
            );
            /** The action to ask common parent part of individual plates. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * AskParentPartOfSelectedObjects
            (
            );
            /** The action to extrude sketch curves for preview. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * ExtrudeSketchCurvesToPreview
            (
                NXOpen::NXObject * platePart /** platepart */ 
            );
            /** The action to edit extrude feature for preview. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void EditExtrudePreviewSheetBodyFeature
            (
                NXOpen::NXObject * platePart /** platepart */ ,
                NXOpen::NXObject * extrudeFeat /** extrudefeat */ 
            );
            /** The action to create sketch in common parent part. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * CreateSketchInCommonParentPart
            (
                NXOpen::NXObject * parentPart /** parentpart */ 
            );
        };
