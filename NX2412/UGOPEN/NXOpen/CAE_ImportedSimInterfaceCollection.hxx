    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ImportedSimInterfaceCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::ImportedSimInterface *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::ImportedSimInterface **;
                using reference = NXOpen::CAE::ImportedSimInterface *&;
            ...
            /** Delete imported simulation interface, The flag deleteImportedEntities determines whether the imported entities need to be deleted.
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void DeleteSimInterfaceAndImportedEntities
            (
                NXOpen::CAE::ImportedSimInterface * importedSimIF /** Simulation Interface*/,
                bool deleteImportedEntities /** Deletes imported entities when set */
            );
            ...
            /** Abort sim interface import 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void AbortImportSimInterface
            (
                const std::vector<NXOpen::CAE::SimBC *> & objects /** objects */ ,
                bool isnxinteractiverun /** isnxinteractiverun */ 
            );
            /** Show LBC objects in these interfaces 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void ShowSimInterfaces
            (
                const std::vector<NXOpen::CAE::ImportedSimInterface *> & simInterfaces /** The sim interfaces to show  */
            );
            /** Hide LBC objects in these interfaces 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void HideSimInterfaces
            (
                const std::vector<NXOpen::CAE::ImportedSimInterface *> & simInterfaces /** The sim interfaces to hide  */
            );
            /** Show LBC objects and their target sets in these interfaces, and hide everything else 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void ShowOnlySimInterfaces
            (
                const std::vector<NXOpen::CAE::ImportedSimInterface *> & simInterfaces /** The sim interfaces to show only  */
            );
            /** Updates the sim interfaces in the given part, if one has a valid loaded source with a pending update 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: std::vector<int> UpdateSimInterfaces
            (
                std::vector<NXOpen::CAE::ImportedSimInterface *> & interfaces /** interfaces */ 
            );
