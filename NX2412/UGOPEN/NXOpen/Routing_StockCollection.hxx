    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  StockCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Routing::Stock *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Routing::Stock **;
                using reference = NXOpen::Routing::Stock *&;
            ...
            (
                ...
                const NXString & routeLevel /** Unused */
            );
            /** Creates stock on the given segments. The segments do not need to be in order, and don't
                    necessarily have to form a single path. 
             <br>  Created in NX5.0.0.  <br>  
            ...
            /** Returns the stock assigned to the Segment or attached to the
                        ...
                        stock is assigned to the segment, returns NULL.
                    
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::Stock * GetStockFromObject
            (
                NXOpen::NXObject * object /** object */ 
            );
