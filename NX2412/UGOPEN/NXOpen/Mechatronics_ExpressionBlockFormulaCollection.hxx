    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ExpressionBlockFormulaCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Mechatronics::ExpressionBlockFormula *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Mechatronics::ExpressionBlockFormula **;
                using reference = NXOpen::Mechatronics::ExpressionBlockFormula *&;
