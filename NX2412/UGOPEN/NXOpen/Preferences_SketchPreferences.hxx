    ...
    namespace Preferences
    {
        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SketchPreferences
        {
            ...
            /** Describes the different options for dimension text size mode. */
            public: enum DimensionTextSizeMode
            {
                DimensionTextSizeModeDraftingStandard/** The size is determined by the current Drafting Standard */,
                DimensionTextSizeModeFixedOnScreen/** The size is adjusted opposite of zoom scale so that the size on screen remains fixed */,
                DimensionTextSizeModeVariable/** The size is computed for the current zoom scale when first dimension is created in given sketch */
            };
            ...
            /** Applies sketch preferences set by user. The dimDisplayFlag is the API version of the UI setting of 
                    ...
                    in an active sketch or @link NXOpen::Features::EditDimensionBuilder::DisplayAsPmi NXOpen::Features::EditDimensionBuilder::DisplayAsPmi@endlink  when not in an active sketch.
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the setting that controls whether or not the dimension text size should be fixed. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Preferences::SketchPreferences::TextSizeMode NXOpen::Preferences::SketchPreferences::TextSizeMode@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Preferences::SketchPreferences::TextSizeMode instead.") bool TextSizeFixed
            (
            );
            /**Sets  the setting that controls whether or not the dimension text size should be fixed. 
             <br>  @deprecated Deprecated in NX1926.0.0.  Use @link NXOpen::Preferences::SketchPreferences::SetTextSizeMode NXOpen::Preferences::SketchPreferences::SetTextSizeMode@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::Preferences::SketchPreferences::SetTextSizeMode instead.") void SetTextSizeFixed
            (
            ...
            /**Sets  the setting that controls dimension text size mode. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: void SetTextSizeMode
            (
            ...
            /**Returns  the setting that controls dimension text size mode. 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Preferences::SketchPreferences::DimensionTextSizeMode TextSizeMode
            (
            );
