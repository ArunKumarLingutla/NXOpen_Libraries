    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  CurveOperationExpressionRecord : public NXOpen::NXObject
        {
            ...
            /** Sets X units of expression record.
                        
                        <ol>
                        <li>
                        X formula must be set with @link NXOpen::CAE::CurveOperationExpressionRecord::SetFormulas NXOpen::CAE::CurveOperationExpressionRecord::SetFormulas@endlink  before calling this method.
                        </li>
                        <li>
                        The specified units must be matched to the calculated units of X formula.
                        </li>
                        </ol>
            ...
            (
                ...
                const NXString & xUnitName /** xunitname */ 
            );
            /** Sets X units of expression record.
            ...
            (
                ...
                const char * xUnitName /** xunitname */ 
            );
            /** Gets X units of expression record. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void GetXUnit
            (
                NXString* measureOrQuantityName /** measureorquantityname */ ,
                NXString* unitName /** unitname */ 
            );
            /** Sets Y units of expression record. 
                        
                        <ol>
                        <li>
                        Y formula must be set with @link NXOpen::CAE::CurveOperationExpressionRecord::SetFormulas NXOpen::CAE::CurveOperationExpressionRecord::SetFormulas@endlink  before calling this method.
                        </li>
                        <li>
                        The specified units must be matched to the calculated units of Y formula.
                        </li>
                        </ol>
            ...
            (
                ...
                const NXString & yMnitName /** ymnitname */ 
            );
            /** Sets Y units of expression record. 
            ...
            (
                ...
                const char * yMnitName /** ymnitname */ 
            );
            /** Gets Y units of expression record. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void GetYUnit
            (
                NXString* measureOrQuantityName /** measureorquantityname */ ,
                NXString* unitName /** unitname */ 
            );
