...
#include <NXOpen/Features_ThroughCurvesBuilder1.hxx>
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FreeformSurfaceCollection
        {
            ...
            /** Creates a @link NXOpen::Features::TextureBuilder NXOpen::Features::TextureBuilder@endlink   @return  TextureBuilder object 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::TextureBuilder * CreateTextureBuilder
            (
                NXOpen::Display::ImageBase * textureImage /** the selected texture image object to be edited */
            );
            /** Creates a @link NXOpen::Features::DeleteTextureObjectsData NXOpen::Features::DeleteTextureObjectsData@endlink   @return  Delete texture object data 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::DeleteTextureObjectsData * CreateDeleteTextureObjectsData
            (
            );
            /** Creates a @link NXOpen::Features::PunchThroughBuilder NXOpen::Features::PunchThroughBuilder@endlink   @return  PunchThroughBuilder object 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::PunchThroughBuilder * CreatePunchThroughBuilder
            (
                NXOpen::Display::ImageBase * textureImage /** the selected texture image object to be edited */
            );
            /** Creates a @link NXOpen::Features::SweptBuilder1 NXOpen::Features::SweptBuilder1@endlink   @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Features::SweptBuilder1 * CreateSweptBuilder1
            (
                NXOpen::Features::Swept * swept /** @link NXOpen::Features::Swept NXOpen::Features::Swept@endlink  to be edited */
            );
            /** Creates a @link NXOpen::Features::ThroughCurvesBuilder1 NXOpen::Features::ThroughCurvesBuilder1@endlink   @return  ThroughCurvesBuilder1 object
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: NXOpen::Features::ThroughCurvesBuilder1 * CreateThroughCurvesBuilder1
            (
            ...
            /** Creates a @link NXOpen::Features::StudioSurfaceBuilder1 NXOpen::Features::StudioSurfaceBuilder1@endlink   @return  StudioSurfaceBuilder1 object 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NXOpen::Features::StudioSurfaceBuilder1 * CreateStudioSurfaceBuilder1
            (
            ...
            /** Creates a @link NXOpen::Features::RuledBuilder1 NXOpen::Features::RuledBuilder1@endlink   @return  
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_freeform_1 ("basic freeform modeling") */
            public: NXOpen::Features::RuledBuilder1 * CreateRuledBuilder1
            (
