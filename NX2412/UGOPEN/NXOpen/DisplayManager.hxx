    ...
    */
    class NXOPENCPPEXPORT  DisplayManager
    {
        ...
        public: enum ShowHideType
        {
            ...
            ShowHideTypeMesh1dBearing2/** Show or hide all 1d bearing2 mesh types  */,
            ...
            ShowHideTypeMesh1dMpc/** Show or hide all mpc mesh types */,
            ShowHideTypeMesh1dJoint/** Show or hide all joint mesh types */,
            ShowHideTypeMesh1dFou3/** Show or hide all 1d Fourier mesh types  */,
            ShowHideTypeMesh1dBush2/** Show or hide all 1d Bush2 mesh types  */,
            ...
            ShowHideTypePmiTables/** Show or hide all pmi tables. */,
            ...
            ShowHideTypeAoWallThickness/** Show or hide wall thickness analysis objects. */,
            ShowHideTypeAoSheetBoundary/** Show or hide sheet boundary analysis objects. */,
            ...
            ShowHideTypeMatchFaceMeshControl/** Show or hide all mesh controls - face depedency control */,
            ShowHideTypeMatchEdgeMeshControl/** Show or hide all mesh controls - edge match mesh control */,
            ...
            ShowHideTypeMeshControlsPointDensity/** Show or hide all mesh controls - point density. */,
            ShowHideTypeMeshControlsBoundingVolumeDensity/** Show or hide all mesh controls - bounding volume density. */,
            ShowHideTypeEdgeSeparationCondition/** Show or hide all edge separation conditions. */,
            ShowHideTypeSelectionRecipes/** Show or hide all selection recipes. */,
            ShowHideTypeSelectionRecipesBoundingVolume/** Show or hide all bounding volume selection recipes. */,
            ShowHideTypeSelectionRecipesSingleNode/** Show or hide all single node selection recipes. */,
            ShowHideTypeLbc/** Show or hide all LBCs */,
            ShowHideTypeLbcLoad/** Show or hide all LBC Load */,
            ShowHideTypeLbcConstraint/** Show or hide all LBC Constraint */,
            ShowHideTypeLbcSimulationObject/** Show or hide all LBC Simulation Object*/,
            ShowHideTypeMesh1dClink/** Show or hide all 1d CLink mesh types  */,
            ShowHideTypeMesh1dBeam3/** Show or hide all 1d parabolic beam mesh types  */,
            ShowHideTypeMesh1dBendPipe/** Show or hide all 1d bend pipe mesh types  */,
            ShowHideTypeMesh1dRspline/** Show or hide all 1d rspline mesh types  */,
            ShowHideTypeCompositesAll/** Show or hide all Composites */,
            ShowHideTypeCompositesLaminates/** Show or hide all Composites laminates */,
            ShowHideTypeCompositesPlies/** Show or hide all Composites plies */,
            ShowHideTypeCompositesRosettes/** Show or hide all Composites rosettes */,
            ShowHideTypeCompositesProducibilities/** Show or hide all Composites producibilities */,
            ShowHideTypeCompositesFlatPatterns/** Show or hide all Composites flat patterns*/,
            ShowHideTypeCompositesDesignStations/** Show or hide all Composites design stations */,
            ShowHideTypeCompositesCrossSections/** Show or hide all Composites cross sections */,
            ShowHideTypeCompositesPlyPieces/** Show or hide all Composites ply pieces */,
            ShowHideTypeCompositesSolidCores/** Show or hide all Composites solid cores */,
            ShowHideTypeAoDistanceAnalysis/** Show or hide distance analysis objects. */,
            ShowHideTypeAoRadiusAnalysis/** Show or hide radius analysis objects. */,
            ShowHideTypeAoReflectionAnalysis/** Show or hide reflection analysis objects. */,
            ShowHideTypeAoSlopeAnalysis/** Show or hide slope analysis objects. */,
            ShowHideTypeDisplayInstance/** Show or hide display instance objects. */
        };
        ...
        /** Shows a set of objects by type.  You may want to use @link NXOpen::View::FitAfterShowOrHide NXOpen::View::FitAfterShowOrHide@endlink 
         ...
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::DisplayManager::ShowByType NXOpen::DisplayManager::ShowByType@endlink  that takes a string type instead. To find all registered ShowHideType strings use @link NXOpen::DisplayManager::GetShowableHideableTypes NXOpen::DisplayManager::GetShowableHideableTypes@endlink  <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::DisplayManager::ShowByType that takes a string type instead. To find all registered ShowHideType strings use NXOpen::DisplayManager::GetShowableHideableTypes") int ShowByType
        (
        ...
        /** Hides a set of objects by type.  You may want to use @link NXOpen::View::FitAfterShowOrHide NXOpen::View::FitAfterShowOrHide@endlink 
         ...
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::DisplayManager::HideByType NXOpen::DisplayManager::HideByType@endlink  that takes a string type instead. To find all registered ShowHideType strings use @link NXOpen::DisplayManager::GetShowableHideableTypes NXOpen::DisplayManager::GetShowableHideableTypes@endlink  <br>  

         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::DisplayManager::HideByType that takes a string type instead. To find all registered ShowHideType strings use NXOpen::DisplayManager::GetShowableHideableTypes") int HideByType
        (
        ...
        /** Return the associated window with the given view. 
                The associated window will be created only when the view is being activated and displayed. 
             @return  The window associated with the given view 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::WindowHandle * GetWindowHandle
        (
            NXOpen::View * view /** view to which window associated */
        );
