...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /** This class contains the factory methods for creating an FacePlaneSelectionBuilder.  <br> To obtain an instance of this class, refer to @link NXOpen::Part  NXOpen::Part @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  FacePlaneSelectionBuilderCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::GeometricUtilities::FacePlaneSelectionBuilder *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::GeometricUtilities::FacePlaneSelectionBuilder **;
                using reference = NXOpen::GeometricUtilities::FacePlaneSelectionBuilder *&;
