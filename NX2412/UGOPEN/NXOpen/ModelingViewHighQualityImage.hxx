...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ModelingViewHighQualityImage
    {
        ...
        /** Saves the currently displayed high quality image of a view
                to a file.
                Currently the given view must be the work view.
                This function only works in interactive mode, not in batch mode.
                 <br>  Refer to Class @link NXOpen::Gateway::ImageCaptureBuilder NXOpen::Gateway::ImageCaptureBuilder@endlink  for batch mode support.  <br> 
