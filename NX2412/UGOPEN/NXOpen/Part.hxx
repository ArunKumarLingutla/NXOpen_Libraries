...
#include <NXOpen/ModlUtils_ImportTemplatePart.hxx>
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Part : public NXOpen::BasePart
    {
        ...
        */
        ...
        /** The part family attribute types. 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::PartFamily::FamilyAttribute::AttrType NXOpen::PartFamily::FamilyAttribute::AttrType@endlink  instead <br>  

         <br>  Created in NX6.0.0.  <br>  
        */
        public: enum NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::PartFamily::FamilyAttribute::AttrType instead") PartFamilyAttrType
        {
            PartFamilyAttrTypeTextType/** text attribute */ = 1,
         ...
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::PartFamily::TemplateManager::AddToChosenAttributes NXOpen::PartFamily::TemplateManager::AddToChosenAttributes@endlink  or @link NXOpen::PartFamily::TemplateManager::GetPartFamilyAttribute NXOpen::PartFamily::TemplateManager::GetPartFamilyAttribute@endlink  instead <br>  

         <br>  Created in NX6.0.0.  <br>  
        */
        public:
        struct NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::PartFamily::TemplateManager::AddToChosenAttributes or NXOpen::PartFamily::TemplateManager::GetPartFamilyAttribute instead") PartFamilyAttributeData
        {
        ...
        /** Allows user to specify options for updating JT derived part from JT file.
            
         <br>  Created in NX2306.0.0.  <br>  
        */

        /// \cond NX_NO_DOC 
        public: enum UpdateFromJtFileOptions
        {
            UpdateFromJtFileOptionsDefault/** update geometry in JT Derived part from input JT file.*/
        };
        ...
        /** Creates an ExpressionSectionSet item that contains a @link NXOpen::Section NXOpen::Section@endlink  collection
        ...
        (
            ...
            int index /** This parameter has no effect, and is ignored */
        );
        /** Creates an ExpressionSectionSet item that contains a @link NXOpen::Section NXOpen::Section@endlink  collection
                and a corresponding expression  @return  New ExpressionSectionSet object 
         <br>  Created in NX5.0.0.  <br>  
        ...
        /** Creates an TwoExpressionsSectionSet item that contains 
                a @link NXOpen::Section NXOpen::Section@endlink  section 
        ...
        /** Creates an empty TwoExpressionsSectionSet item that contains 
                a @link NXOpen::Section NXOpen::Section@endlink  section
                and two corresponding expressions  @return  New TwoExpressionsSectionSet object 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Creates an ExpressionCollectorSet item that contains a @link NXOpen::ScCollector NXOpen::ScCollector@endlink  collection
        ...
        /** Creates an TwoExpressionsCollectorSet item that contains 
            a @link NXOpen::ScCollector NXOpen::ScCollector@endlink  collection 
        ...
        /** Creates an empty TwoExpressionsCollectorSet item that contains 
            a @link NXOpen::ScCollector NXOpen::ScCollector@endlink  collection 
            and two corresponding expressions  @return  New TwoExpressionsCollectorSet object 
         <br>  Created in NX8.5.0.  <br>  
         <br> License requirements : None */
        ...
        (
            const NXString & templateName /** the name of the template type */
        );
        /** Creates CAM setup  @return  the created cam setup 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : cam_base ("CAM BASE") */
        ...
        (
            const char * templateName /** the name of the template type */
        );
        /** Delete CAM setup 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : cam_base ("CAM BASE") */
        ...
        /** Create a part family of the part.  @return  the new @link NXOpen::PartFamilyManager NXOpen::PartFamilyManager@endlink  instance 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::PartFamily::TemplateManager::CreatePartFamily NXOpen::PartFamily::TemplateManager::CreatePartFamily@endlink  instead <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::PartFamily::TemplateManager::CreatePartFamily instead") NXOpen::PartFamilyManager * CreatePartFamily
        (
        ...
        /** Create an instance of a @link NXOpen::PartFamilyManager NXOpen::PartFamilyManager@endlink 
                class that will be used to edit part family of the part.  @return  the new @link NXOpen::PartFamilyManager NXOpen::PartFamilyManager@endlink  instance 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::Part::NewPartFamilyTemplateManager NXOpen::Part::NewPartFamilyTemplateManager@endlink  instead <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::Part::NewPartFamilyTemplateManager instead") NXOpen::PartFamilyManager * GetPartFamilyManager
        (
        );
        /** Create an instance of a @link NXOpen::PartFamilyMemberData NXOpen::PartFamilyMemberData@endlink 
                class that will be used to store the member count and member values
                of each member.  @return  the new @link NXOpen::PartFamilyMemberData NXOpen::PartFamilyMemberData@endlink  instance 
         <br>  @deprecated Deprecated in NX9.0.0.  Create and use @link NXOpen::PartFamily::InstanceDefinition NXOpen::PartFamily::InstanceDefinition@endlink  objects using @link NXOpen::PartFamily::TemplateManager::AddInstanceDefinition NXOpen::PartFamily::TemplateManager::AddInstanceDefinition@endlink  <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX9.0.0.  Create and use NXOpen::PartFamily::InstanceDefinition objects using NXOpen::PartFamily::TemplateManager::AddInstanceDefinition") NXOpen::PartFamilyMemberData * NewPartFamilyMemberData
        (
        );
        /** Create an instance of a @link NXOpen::PartFamilyMemberValues NXOpen::PartFamilyMemberValues@endlink 
                class that will be used to store the attribute values of a member.  @return  the new @link NXOpen::PartFamilyMemberValues NXOpen::PartFamilyMemberValues@endlink  instance 
         <br>  @deprecated Deprecated in NX9.0.0.  Use @link NXOpen::PartFamily::InstanceDefinition NXOpen::PartFamily::InstanceDefinition@endlink  and @link NXOpen::PartFamily::InstanceDefinition::SetValueOfAttribute NXOpen::PartFamily::InstanceDefinition::SetValueOfAttribute@endlink  <br>  

         <br>  Created in NX6.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::PartFamily::InstanceDefinition and NXOpen::PartFamily::InstanceDefinition::SetValueOfAttribute") NXOpen::PartFamilyMemberValues * NewPartFamilyMemberValues
        (
        );
        ...
        /** Creates boundary definition builder object 
         ...
         <br> License requirements : studio_free_form ("STUDIO FREE FORM") OR nx_polygon_modeling (" NX Polygon Modeling") */
        ...
        /** Create an instance of @link NXOpen::SIM::KinematicConfigurator NXOpen::SIM::KinematicConfigurator@endlink 
                class that will be used to manage the kinematic model and its components  @return  The Kinematic Configurator 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : cam_base ("CAM BASE") OR ug_isv_full ("Full functionality for Integrated Simulation and Verification") OR nx_isv_mtb ("Machine Tool Builder") OR resource_manager_nx ("Teamcenter Resource Manager") */
        public: NXOpen::SIM::KinematicConfigurator * CreateKinematicConfigurator
        (
        );
        /**Returns  the @link NXOpen::SIM::KinematicConfigurator NXOpen::SIM::KinematicConfigurator@endlink  instance of the part 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::SIM::KinematicConfigurator * KinematicConfigurator
        (
        );
        /** Creates an @link NXOpen::GeometricUtilities::BoundingObjectBuilder NXOpen::GeometricUtilities::BoundingObjectBuilder@endlink  object. 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::GeometricUtilities::BoundingObjectBuilder * CreateBoundingObjectBuilder
        (
        );
        /**Returns  the status on whether input part is Booklet Part or not. 
         <br>  Created in NX8.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Creates a @link NXOpen::GeometricUtilities::SelectionList NXOpen::GeometricUtilities::SelectionList@endlink  object with embedded @link NXOpen::Section NXOpen::Section@endlink . 
        ...
        /** Creates empty @link NXOpen::GeometricUtilities::SelectionList NXOpen::GeometricUtilities::SelectionList@endlink  object. 
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::GeometricUtilities::SelectionList * CreateEmptySelectionList
        (
        );
        /** Creates a @link NXOpen::GeometricUtilities::PointsFromFileBuilder NXOpen::GeometricUtilities::PointsFromFileBuilder@endlink  object  @return  New empty object 
         <br>  Created in NX8.5.0.  <br>  
         <br> License requirements : None */
        ...
        /** Removes missing parent edges from all edge blend features in the part  @return  the edge blend features with missing parents 
         <br>  Created in NX11.0.1.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: std::vector<NXOpen::Features::EdgeBlend *> RemoveMissingParentsFromEdgeBlend
        (
            std::vector<int> & removedEdgeCounts /** the count of removed edges for each of the edge blend features with missing parents */
        );
        /** Creates an instance of a @link NXOpen::PartFamily::TemplateManager NXOpen::PartFamily::TemplateManager@endlink 
        ...
        /** Obtains the @link NXOpen::PartFamily::Instance NXOpen::PartFamily::Instance@endlink  from part. 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: NXOpen::PartFamily::Instance * GetFamilyInstance
        (
        );
        /** Creates a @link NXOpen::GeometricUtilities::BlendSetbackBuilder NXOpen::GeometricUtilities::BlendSetbackBuilder@endlink  object  @return  New empty object 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::GeometricUtilities::BlendSetbackBuilder * CreateEmptyBlendSetbackBuilder
        (
        );
        /** Creates a @link NXOpen::GeometricUtilities::TransitionCurveBuilder NXOpen::GeometricUtilities::TransitionCurveBuilder@endlink  object  @return  New empty object 
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        ...
        /** Creates spine plane builder object 
         ...
         <br> License requirements : None */
        public: NXOpen::GeometricUtilities::SpinePlaneBuilder * CreateEmptySpinePlaneBuilder
        (
        );
        /** Given a fully loaded part, this API will traverse over WAVE link features belonging to the part and 
                will fully load its parent parts if its unloaded.
                In case if WAVE parent part is an assembly then only assembly part will be loaded. 
                If a given part is not fully loaded, then API will return an error.  @return  Any errors found while loading the WAVE parent parts. 
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::PartLoadStatus * LoadWaveLinkFeatureParents
        (
        );
        /** Creates import template part builder object 
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ModlUtils::ImportTemplatePartBuilder * CreateImportTemplatePartBuilder
        (
            NXOpen::ModlUtils::ImportTemplatePart * importtemplatePart /** importtemplatepart */ 
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        public: void UpdateFromJtFile
        (
            const NXString & jtFilePath /** jtfilepath */ ,
            NXOpen::Part::UpdateFromJtFileOptions updateOption /** updateoption */ 
        );
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : None */
        ...
        (
            const char * jtFilePath /** jtfilepath */ ,
            NXOpen::Part::UpdateFromJtFileOptions updateOption /** updateoption */ 
        );

        /// \endcond 
        /** Retrieve or refresh associated BVR @link NXOpen::Assemblies::PartitionScheme NXOpen::Assemblies::PartitionScheme@endlink  and 
                BVR @link NXOpen::Assemblies::Partition NXOpen::Assemblies::Partition@endlink  information from Teamcenter if it exists.
                This method will only have effect for parts that are managed in Teamcenter. 
                Note that if partitions data is already loaded, in-session modifications to partitions will be discarded.
            
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : nx_partitions (" TcUnified Partitions") */
        public: void RefreshPartitionData
        (
        );
        ...
        */
        ...
        /** Returns the DraftingDrawingSheetCollection instance belonging to this part 
         <br>  Created in NX12.0.0.  <br>  
        */
        public: NXOpen::Drawings::DraftingDrawingSheetCollection *DraftingDrawingSheets();
        ...
        */
        ...
        /** Returns the Routing Mechanical Collections Manager for this part
         <br>  Created in NX1980.0.0.  <br>  
        */
        public: NXOpen::MechanicalRouting::CollectionsManager *MechanicalRoutingCollectionsManager();
        /** Returns the Routing Electrical Collections Manager for this part
         <br>  Created in NX2306.0.0.  <br>  
        */
        public: NXOpen::ElectricalRouting::CollectionsManager *ElectricalRoutingCollectionsManager();
        ...
        */
        ...
        /** Returns the ClipboardOperationsManager for this part 
         <br>  Created in NX5.0.0.  <br>  
        */
        ...
        */
        ...
        /** Returns the FaceSetDataCollection instance belonging to this part 
         <br>  @deprecated Deprecated in NX8.5.0.  This class is never used and can be safely removed <br>  
        ...
        */
        public: NXOpen::Mechatronics::GanttLinkerCollection *GanttLinkerCollection();
        ...
        */
        public: NXOpen::Annotations::PmiSettingsManager *PmiSettingsManager();
        ...
        */
        ...
        /** Returns the LayoutDrawingSheetCollection instance belonging to this part 
         <br>  Created in NX12.0.0.  <br>  
        */
        public: NXOpen::Layout2d::LayoutDrawingSheetCollection *LayoutDrawingSheets();
        ...
        */
        ...
        /** Returns the DiagrammingManager instance belonging to this part 
         <br>  Created in NX10.0.0.  <br>  
        */
        public: NXOpen::Diagramming::DiagrammingManager *DiagrammingManager();
        /** Returns the SmartDiagrammingManager instance belonging to this part 
         <br>  Created in NX1847.0.0.  <br>  
        */
        public: NXOpen::Diagramming::SmartDiagrammingManager *SmartDiagrammingManager();

        /// \cond NX_NO_DOC 
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX1899.0.0.  <br>  
        */
        public: NXOpen::Appearance::AppearanceManager *AppearanceManager();

        /// \endcond 
        /** Returns the PlasManager instance belonging to this part 
         <br>  Created in NX11.0.0.  <br>  
        */
        public: NXOpen::PLAS::PlasManager *PlasManager();
        /** Returns the UserDefinedTemplate.Collection instance belonging to this part 
         <br>  Created in NX10.0.0.  <br>  
        */
        public: NXOpen::UserDefinedTemplate::Collection *UserDefinedTemplates();
        /** Returns the DBEntityProxyCollection instance belonging to this part 
         <br>  Created in NX11.0.1.  <br>  
        */
        public: NXOpen::PDM::DBEntityProxyCollection *DBEntityProxies();
        /** Returns the FacetSelectionRuleFactory instance belonging to this part 
         <br>  Created in NX12.0.0.  <br>  
        */
        public: NXOpen::FacetSelectionRuleFactory *FacetSelectionRuleFactory();
        /** Returns the FacetCollectorCollection instance belonging to this part 
         <br>  Created in NX12.0.0.  <br>  
        */
        public: NXOpen::FacetCollectorCollection *FacetCollectorCollection();
        /** Returns the UVMappingCollection instance belonging to this part 
         <br>  Created in NX1847.0.0.  <br>  
        */
        public: NXOpen::GeometricUtilities::UVMapping::UVMappingCollection *UVMappingCollection();
        /** Returns the IdealizedBeamManager belonging to this part 
         <br>  Created in NX1953.0.0.  <br>  
        */
        public: NXOpen::CADCAEPrep::IdealizedBeamManager *IdealizedBeamManager();
        /** Returns the SchematicManager instance belonging to this part 
         <br>  Created in NX1980.0.0.  <br>  
        */
        public: NXOpen::Schematic::SchematicManager *SchematicManager();
        /** Returns the Schematic.Mechanical.RunCollection instance belonging to this part 
         <br>  @deprecated Deprecated in NX2312.0.0.  This class is never used and can be safely removed since run can be loaded without part. <br>  

         <br>  Created in NX1980.0.0.  <br>  
        */
        public: NXOpen::Schematic::Mechanical::RunCollection *RunCollection();

        /// \cond NX_NO_DOC 
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2206.0.0.  <br>  
        */
        public: NXOpen::CollaborationApplication::CollaborationZoneCollection *CollaborationZones();

        /// \endcond 
        /** Returns the Sustainability.SustainabilityManager instance belonging to this part 
         <br>  Created in NX2312.0.0.  <br>  
        */
        public: NXOpen::Sustainability::SustainabilityManager *SustainabilityManager();
        /** Returns the GCToolsManager instance belonging to this part 
         <br>  Created in NX2312.0.0.  <br>  
        */
        public: NXOpen::GCTools::GCToolsManager *GCToolsManager();

        /// \cond NX_NO_DOC 
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
        */
        public: NXOpen::CableRouter::ObjectManager *ObjectManager();
        ...
        */
        ...
        /** Obtains the OmnicadManager instance belonging to this part 
         <br>  Created in NX10.0.0.  <br>  
        */
        public: NXOpen::GeometricUtilities::OmnicadManager *OmnicadManager();
    };
}
