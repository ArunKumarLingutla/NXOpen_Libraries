...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _SweptBuilder1Builder;
        class SweptBuilder1Impl;
        /**
            Represents a @link NXOpen::Features::Swept NXOpen::Features::Swept@endlink  builder
             <br> To create a new instance of this class, use @link NXOpen::Features::FreeformSurfaceCollection::CreateSweptBuilder1  NXOpen::Features::FreeformSurfaceCollection::CreateSweptBuilder1 @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        ScalingMethod.EndBlendScaleFactor </term> <description> 
         
        1.0 </description> </item> 

        <item><term> 
         
        ScalingMethod.PerimeterLaw.EndValue.Value </term> <description> 
         
        1.0 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        ScalingMethod.PerimeterLaw.StartValue.Value </term> <description> 
         
        1.0 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        ScalingMethod.PerimeterLaw.Value.Value </term> <description> 
         
        1.0 (millimeters part), 1.0 (inches part) </description> </item> 

        <item><term> 
         
        ScalingMethod.ScaleFactor </term> <description> 
         
        1.0 </description> </item> 

        <item><term> 
         
        ScalingMethod.ScalingOption </term> <description> 
         
        Constant </description> </item> 

        <item><term> 
         
        ScalingMethod.StartBlendScaleFactor </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  SweptBuilder1 : public NXOpen::Features::FeatureBuilder
        {
            ...
            private: SweptBuilder1Impl * m_sweptbuilder1_impl;
            private: friend class  _SweptBuilder1Builder;
            protected: SweptBuilder1();
            public: ~SweptBuilder1();
            ...
            /**Returns  the section location option. This option governs the location of the input section with respect to the
             ...
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::SweptBuilder1::SectionLocationTypes SectionLocation
            (
            );
            ...
            (
                NXOpen::Features::SweptBuilder1::SectionLocationTypes sectionLocation /** sectionlocation */ 
            );
            /**Returns  the interpolation option. This option governs the method by which to interpolate between sections, if the
             ...
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::SweptBuilder1::InterpolationOptions InterpolationOption
            (
            );
            ...
            (
                NXOpen::Features::SweptBuilder1::InterpolationOptions interpolationOption /** interpolationoption */ 
            );
            /**Returns  the alignment method. The Alignment Method Builder sub-object, governs the alignment of the
                        ...
                        Refer to GeometricUtilities.AlignmentMethodBuilder1 documentation. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
