        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  Logger : public NXOpen::TransientObject
        {
            ...
            (
                ...
                const std::vector<NXOpen::Point3d> & referencePoints /** The reference points for the object. Each reference point is used as the location of a reference vector.*/,
                const std::vector<NXOpen::Vector3d> & referenceVectors /** The reference vectors for the object. Each reference vector is set by a @link NXOpen::Point3d NXOpen::Point3d@endlink  location (defined in referencePoints) and a @link NXOpen::Vector3d NXOpen::Vector3d@endlink  direction.*/
            );
            /** Logs a validation outcome and a @link NXObject NXObject@endlink  as validation outcome detail.
            ...
            /** Logs reference points for a @link NXObject NXObject@endlink  as validation outcome detail.
             ...
             <br> License requirements : ug_checkmate ("UG Check Mate") */
            public: void LogReferencePoints
            (
                const std::vector<NXOpen::Point3d> & referencePoints /** The reference points for the object.*/
            );
            /** Logs reference vectors for a @link NXObject NXObject@endlink  as validation outcome detail. Each reference vector is set by a @link NXOpen::Point3d NXOpen::Point3d@endlink  location and a @link NXOpen::Vector3d NXOpen::Vector3d@endlink  direction.
             ...
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_checkmate ("UG Check Mate") */
            public: void LogReferenceVectors
            (
                const std::vector<NXOpen::Point3d> & locations /** The locations of the reference vectors for the object.*/,
                const std::vector<NXOpen::Vector3d> & directions /** The directions of the reference vectors for the object.*/
            );
