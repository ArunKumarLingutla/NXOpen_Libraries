...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AsPatchSurface </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  TrimRegionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to convert to have copies or no copies for all selected sheets. 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::TrimRegionBuilder::ConvertTypeOption ConvertType
            (
            );
            ...
            (
                NXOpen::Tooling::TrimRegionBuilder::ConvertTypeOption convertType /** converttype */ 
            );
