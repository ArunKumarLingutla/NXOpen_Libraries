...
#include <NXOpen/Display_BoxShipGridBuilder.hxx>
    ...
    namespace Display
    {
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  GridCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Display::Grid *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Display::Grid **;
                using reference = NXOpen::Display::Grid *&;
            ...
            /** Creates a @link NXOpen::Display::BoxShipGridBuilder NXOpen::Display::BoxShipGridBuilder@endlink  object
                        used to build a box grid on a plane.
                      @return  ship box grid builder 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_ship_concept ("Ship Concept") */
            public: NXOpen::Display::BoxShipGridBuilder * CreateBoxShipGridBuilder
            (
            );
