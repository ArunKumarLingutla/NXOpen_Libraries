    ...
    namespace DMU
    {
        ...
        */
        class DMUOPENCPPEXPORT  SnapshotCollection : public NXOpen::NXObject
        {
            ...
            {
            public:
                using value_type = NXOpen::DMU::ISnapshot *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::DMU::ISnapshot **;
                using reference = NXOpen::DMU::ISnapshot *&;
            ...
            /** Creates and inserts a @link NXOpen::DMU::ISnapshot NXOpen::DMU::ISnapshot@endlink  in the collection before the target @link NXOpen::DMU::ISnapshot NXOpen::DMU::ISnapshot@endlink .
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : dmu_markup ("License to expose DMU functionality in NX desktop") */
            public: NX_DEPRECATED("Deprecated in NX1926.0.0.  Use NXOpen::DMU::SnapshotCollection::CreateSnapshot and NXOpen::DMU::SnapshotCollection::MoveSnapshotsBefore.") NXOpen::DMU::ISnapshot * InsertSnapshot
            (
