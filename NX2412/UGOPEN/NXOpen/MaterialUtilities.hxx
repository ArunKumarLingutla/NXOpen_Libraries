    ...
    */
    class NXOPENCPPEXPORT  MaterialUtilities
    {
        ...
        /**Convert stress strain data between the four types EngineeringStressEngineeringStrain,
               ...
               If the input type is EngineeringStressEngineeringStrain or TrueStressLogStrain, the first point
               of the stress-strain curve should be (0, 0). EngineeringStressEngineeringPlasticStrain and 
               TrueStressLogPlasticStrain should not have a (0, 0) point.
        ...
        /**Convert %IACS to Electrical Conductivity Values
                Converts values from %IACS at 20 degrees C to Electrical Conductivity in S/m
              
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: void ConvertIacspercentToElectricalConductivity
        (
            const std::vector<double> & iacsData /** the %IACS values - these are percentage values not decimal values */,
            std::vector<double> & electricalConductivityData /** the calculated electrical conductivity values in S/m */
        );
        /**Convert %IACS to Electrical Conductivity Values
                Converts values from %IACS at 20 degrees C to Electrical Conductivity in S/m
         ...
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: void ConvertElectricalConductivityToIacspercent
        (
            const std::vector<double> & electricalConductivityData /** electrical conductivity values in S/m */,
            std::vector<double> & iacsData /** the calculated %IACS values - these are percentage values not decimal values */
        );
