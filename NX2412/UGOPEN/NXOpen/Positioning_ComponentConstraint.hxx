        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  ComponentConstraint : public NXOpen::Positioning::Constraint
        {
            ...
            /**Returns 
                    ...
                    @link NXOpen::Positioning::ComponentPositioner::PrimaryArrangement NXOpen::Positioning::ComponentPositioner::PrimaryArrangement@endlink .  Constraints can
            ...
            /**
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use ComponentConstraint::CopyInheritedToOverride instead.") void CopyToOverride
            (
            );
            /**
                    Given an inherited @link NXOpen::Positioning::ComponentConstraint NXOpen::Positioning::ComponentConstraint@endlink  created because of Positioning Overrides, create a new constraint copied
                    ...
                    If the constraint is not an inherited constraint, an error is raised.
                 @return  The new @link NXOpen::Positioning::ComponentConstraint NXOpen::Positioning::ComponentConstraint@endlink  copied from the inherited @link NXOpen::Positioning::ComponentConstraint NXOpen::Positioning::ComponentConstraint@endlink  in the same part. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::Positioning::ComponentConstraint * CopyInheritedToOverride
            (
            );
            /**
                 ...
                 @return  The separate suppression state of this @link NXOpen::Positioning::ComponentConstraint NXOpen::Positioning::ComponentConstraint@endlink  
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            ...
            /**
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetSeparateSuppression
            (
                bool separateSuppression /** separate suppression */ 
            );
        };
    }
}
