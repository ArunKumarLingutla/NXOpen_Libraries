        ...
        */
        class NXOPENDEBUGSESSIONCPPEXPORT  Debug
        {
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Curve *> MakeConvertedTypedToolPartOutlines
            (
                NXOpen::CAM::Tool * tool /** tool */ ,
                double polygonizationTol /** polygonizationtol */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Curve *> MakeConvertedGenericToolPartOutlines
            (
                NXOpen::CAM::Tool * tool /** tool */ ,
                double polygonizationTol /** polygonizationtol */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: std::vector<NXOpen::Curve *> MakeCutterShapeManagerToolPartOutlines
            (
                NXOpen::CAM::Tool * tool /** tool */ ,
                double polygonizationTol /** polygonizationtol */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void WaitForNumberOfBackgroundTasksToFinishInPart
            (
                NXOpen::CAM::CAMSetup * setupTag /** setuptag */ ,
                int count /** count */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void StopBackgroundToolPathGenerate
            (
                NXOpen::CAM::CAMSetup * setupTag /** setuptag */ 
            );
