    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  DisplayChangerBuilder : public NXOpen::Builder
        {
            ...
            public: NXOpen::SelectNXObject * CollisionSensor
            (
            );
            /**Returns   @brief  Get the object select list. This can be a @link NXOpen::NXObject NXOpen::NXObject@endlink .  

              
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: NXOpen::SelectNXObjectList * ObjectList
            (
            );
            /**  @brief  Set the object select list. This can be a @link NXOpen::NXObject NXOpen::NXObject@endlink .  
            ...
            (
                const std::vector<NXOpen::NXObject *> & objectTags /** Input object tags*/
            );
            ...
            /**Returns  the change color display property. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool ChangeColor
            (
            );
            /**Sets  the change color display property. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetChangeColor
            (
                bool changecolor /** changecolor */ 
            );
            ...
            /**Returns  the change translucency display property. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool ChangeTranslucency
            (
            );
            /**Sets  the change translucency display property. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetChangeTranslucency
            (
                bool changetranslucency /** changetranslucency */ 
            );
            ...
            /**Returns  the change visibility display property. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool ChangeVisibility
            (
            );
            /**Sets  the change visibility display property. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetChangeVisibility
            (
                bool changevisibility /** changevisibility */ 
            );
