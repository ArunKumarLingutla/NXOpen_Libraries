...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class GenericMotionTurningBuilder;
    }
    namespace CAM
    {
        class GmcOpBuilder;
    ...
    namespace CAM
    {
        class PlanarAdditiveSparseShellsBuilder;
    }
    namespace CAM
    {
        class PlanarAdditiveSpiralBuilder;
    }
    namespace CAM
    {
    ...
    namespace CAM
    {
        class TubeThinwallAdditiveBuilder;
    }
    namespace CAM
    {
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  OperationCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAM::Operation *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAM::Operation **;
                using reference = NXOpen::CAM::Operation *&;
            ...
            (
                ...
                const NXString & newOperationName /** the name of the created operation,
                                                                                               only used when use_default_name == false */
            );
            /** Create an operation of the specified type and subtype under the parent groups. If the value of
                    use_default_name is true, default name will be used for the created operation; otherwise, the
                    specified name will be used. @return  the created operation 
            ...
            /** Create an operation of the specified type and subtype under the parent groups. If the value of
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::Operation * CreateWithUserName
            (
                NXOpen::CAM::NCGroup * parentProgramGroup /** the parent program group */,
                NXOpen::CAM::NCGroup * parentMethodGroup /** the parent method group */,
                NXOpen::CAM::NCGroup * parentToolGroup /** the parent tool group */,
                ...
                const NXString & newOperationName /** the name of the created operation,
                                                                                                    only used when use_default_name == false */,
                const NXString & newOperationUserName /** the user friendly name of the created operation,
                                                                                                    only used when use_default_name == false */
            );
            /** Create an operation of the specified type and subtype under the parent groups. If the value of
                    use_default_name is true, default name will be used for the created operation; otherwise, the
             ...
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            NXOpen::CAM::Operation * CreateWithUserName
            (
                NXOpen::CAM::NCGroup * parentProgramGroup /** the parent program group */,
                NXOpen::CAM::NCGroup * parentMethodGroup /** the parent method group */,
                NXOpen::CAM::NCGroup * parentToolGroup /** the parent tool group */,
                ...
                const char * newOperationName /** the name of the created operation,
                                                                                                    only used when use_default_name == false */,
                const char * newOperationUserName /** the user friendly name of the created operation,
                                                                                                    only used when use_default_name == false */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarRoughingBuilder * CreatePlanarRoughingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::FacingBuilder * CreateFacingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::FacingZigZagBuilder * CreateFacingZigZagBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::WallMillingBuilder * CreateWallMillingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarAdditiveSpiralBuilder * CreatePlanarAdditiveSpiralBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarAdditiveThinwallBuilder * CreatePlanarAdditiveThinwallBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarAdditiveSparseBuildupBuilder * CreatePlanarAdditiveSparseBuildupBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::RotaryConicalBuildupAdditiveBuilder * CreateRotaryConicalBuildupAdditiveBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::ScannerBuilder * CreateScannerBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::RotaryBuildupAdditiveBuilder * CreateRotaryBuildupAdditiveBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarDeckingBuilder * CreatePlanarDeckingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarAdditiveFollowBuilder * CreatePlanarAdditiveFollowBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::TubeBuildupAdditiveBuilder * CreateTubeBuildupAdditiveBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::TubeThinwallAdditiveBuilder * CreateTubeThinwallAdditiveBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PreheatAdditiveBuilder * CreatePreheatAdditiveBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PreheatAdditiveFixedAxisBuilder * CreatePreheatAdditiveFixedAxisBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::PlanarAdditiveSparseShellsBuilder * CreatePlanarAdditiveSparseShellsBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::MultiAxisDeburringBuilder * CreateMultiAxisDeburringBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::WallProfilingBuilder * CreateWallProfilingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::MultiAxisWallFinishingBuilder * CreateMultiAxisWallFinishingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::MultiAxisTurnMillingBuilder * CreateMultiAxisTurnMillingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited - may be NULL if creating a new operation */
            );

            /// \endcond 
            /** Creates an on machine probing builder  @return  operation builder created 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::OnMachineProbingBuilder * CreateOnMachineProbingBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::GenericMotionTurningBuilder * CreateGenericMotionTurningBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );

            /// \endcond 
            /** Creates a machine cycle manager builder  @return  builder created 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::MachineCycleManagerBuilder * CreateMachineCycleManagerBuilder
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::FacingSpiralBuilder * CreateFacingSpiralBuilder
            (
                NXOpen::CAM::CAMObject * param /** operation to be edited */
            );
