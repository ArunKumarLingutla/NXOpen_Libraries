...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        IsValidExportPath </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ProcessSimulationBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the collision check type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool CheckRoughly
            (
            );
            /**Sets  the collision check type 
             <br>  Created in NX2306.0.0.  <br>  
            ...
            public: void SetCheckRoughly
            (
                bool isCheckRoughly /** ischeckroughly */ 
            );
            ...
            /**Returns  the option to stop check collision
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool StopCheckCollision
            (
            );
            /**Sets  the option to stop check collision
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the option to highlight the collision
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool HighlightCollision
            (
            );
            /**Sets  the option to highlight the collision
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            (
                const std::vector<int> & selectedPairIds /** selectedpairids */ 
            );
            /** The highlight collision button 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /** The JA api of export simulation control data method
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ExportSimControlData
            (
            );
            /**Returns  the collision check initial is done or not 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsInitCheck
            (
            );
            /**Sets  the collision check initial is done or not 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetInitCheck
            (
                bool isInitCheck /** isinitcheck */ 
            );
            /**Returns  the collision check initial is done or not 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Sets  the collision check initial is done or not 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetValidExportPath
            (
                bool isValidExportPath /** isvalidexportpath */ 
            );
        };
    }
}
