        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  ModelingPreferencesBuilder : public NXOpen::Builder
        {
            ...
            public: enum EndPointStyle
            {
                ...
                EndPointStylePoint/** point */ ,
                EndPointStyleAsterisk/** asterisk */ ,
                EndPointStylePoundSign/** pound sign */ ,
                EndPointStyleFilledSquare/** filled square */ ,
                EndPointStyleFilledTriangle/** filled triangle */ ,
                EndPointStyleFilledDiamond/** filled diamond */ ,
                EndPointStyleCenterline/** centerline */ 
            };
            ...
            /**Returns  the copy attributes to faces and edges on split value 
             ...
             <br> License requirements : None */
            public: bool CopyAttributesOnSplit
            (
            );
            /**Sets  the copy attributes to faces and edges on split value 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCopyAttributesOnSplit
            (
                bool copyAttributesOnSplit /** copy attributes on split */ 
            );
            ...
            /**Returns  the symbolic thread decal sticker 
             ...
             <br> License requirements : None */
            public: bool ShowSymbolicThreadDecalSticker
            (
            );
            /**Sets  the symbolic thread decal sticker 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
