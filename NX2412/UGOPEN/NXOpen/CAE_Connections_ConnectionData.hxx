            ...
            */
            class NXOPENCPP_CAEEXPORT  ConnectionData : public NXOpen::TaggedObject
            {
                ...
                /** Get pID1s 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<int> GetPID1s
                (
                );
                /** Set pID1s 
                 <br>  Created in NX12.0.0.  <br>  
                ...
                (
                    const std::vector<int> & pID1s /** pid1s */ 
                );
                /** Get pID2s 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<int> GetPID2s
                (
                );
                /** Set pID2s 
                 <br>  Created in NX12.0.0.  <br>  
                ...
                (
                    const std::vector<int> & pID2s /** pid2s */ 
                );
                /** Get pID3s 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<int> GetPID3s
                (
                );
                /** Set pID3s 
                 <br>  Created in NX12.0.0.  <br>  
                ...
                (
                    const std::vector<int> & pID3s /** pid3s */ 
                );
                ...
                /** Invalid dof 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<int> GetInvalidDOF
                (
                );
                ...
                /**Returns  the WCD File  
                 ...
                 <br> License requirements : None */
                public: NXString WCDFile
                (
                );
                /**Sets  the WCD File  
                 <br>  Created in NX1899.0.0.  <br>  
                 <br> License requirements : sc_gso_10 (" Simcenter NVH Composer") */
                public: void SetWCDFile
                (
                    const NXString & wcdFile /** wcdfile */ 
                );
                /**Sets  the WCD File  
                 <br>  Created in NX1899.0.0.  <br>  
                 <br> License requirements : sc_gso_10 (" Simcenter NVH Composer") */
                void SetWCDFile
                (
                    const char * wcdFile /** wcdfile */ 
                );
                /** Get Components1  
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::CAE::Connections::ComponentData *> GetComponents1
                (
                );
                /** Set Components1  
                 <br>  Created in NX2312.0.0.  <br>  
                ...
                (
                    const std::vector<NXOpen::CAE::Connections::ComponentData *> & comps /** comps */ 
                );
                /** Get Components2  
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::CAE::Connections::ComponentData *> GetComponents2
                (
                );
                /** Set Components2  
                 <br>  Created in NX2312.0.0.  <br>  
