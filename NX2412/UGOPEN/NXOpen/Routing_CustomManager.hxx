        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  CustomManager
        {
            ...
            public: enum CallbackReason
            {
                ...
                CallbackReasonStockComponentCreated/** Called after a stock component is created. */,
            ...
            public: enum DesignRuleReason
            {
                ...
                DesignRuleReasonBulkReplacement/** Called after the Bulk Replacement command. */,
                DesignRuleReasonReparentParts/** Called after the Reparent Parts command. */,
                DesignRuleReasonCablewayValidation/** Called before the Cableway Export command. */,
                DesignRuleReasonEditTemplateParameters/** Called before the Edit Template Parameters command. */,
                DesignRuleReasonSpline/** Called after the Spline command. */,
                DesignRuleReasonEditPoint/** Called after the Edit Point command. */,
                DesignRuleReasonEndform/** Called after the Place, edit and delete command. */,
                DesignRuleReasonPlaceElbows/** Called after the Place elbows command. */,
                DesignRuleReasonEditCutElbow/** Called after the Edit Cut Elbow command. */,
                DesignRuleReasonInsulation/** Called after the Insulation command. */,
                DesignRuleReasonConnectComponents/** Called after the Connect Components command. */,
                DesignRuleReasonDisconnectComponents/** Called after the Disconnect Components command. */,
                DesignRuleReasonDerivedPath/** Called after the Derived Path command. */,
                DesignRuleReasonSplitStock/** Called after the Split Stock command. */,
                DesignRuleReasonMergeStock/** Called after the Merge Stock command. */,
                DesignRuleReasonEditPosition/** Called after the Edit Position Method command. */,
                DesignRuleReasonPlaceSplice/** Called after the Place Splice command. */,
                DesignRuleReasonConnectionCompatibility/** Connection compatibility design rule reason. */,
                DesignRuleReasonSlopePath/** Called after the Slope Path command. */,
            ...
            public: /** This defines the prototype for the plugin called when entering a
                        Routing application. The plugin is given the application being entered, either
                        @link NXOpen::Routing::CustomManager::Application::Electrical NXOpen::Routing::CustomManager::Application::Electrical@endlink  or
                        @link NXOpen::Routing::CustomManager::Application::Mechanical NXOpen::Routing::CustomManager::Application::Mechanical@endlink . 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            typedef NXOpen::Callback1<void, NXOpen::Routing::CustomManager::Application> ApplicationEnterPlugin;
            public: /** This defines the prototype for the plugin called when exiting a
                        Routing application. The plugin is given the application being exited, either
                        @link NXOpen::Routing::CustomManager::Application::Electrical NXOpen::Routing::CustomManager::Application::Electrical@endlink  or
                        @link NXOpen::Routing::CustomManager::Application::Mechanical NXOpen::Routing::CustomManager::Application::Mechanical@endlink . 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            typedef NXOpen::Callback1<void, NXOpen::Routing::CustomManager::Application> ApplicationExitPlugin;
            ...
            public: /** This defines the prototype for the component name plugins used when Routing
                        needs to create a new component. You can use this plugin to create a name
                        for the new stock component. You plugin should fill out the information on the
            ...
            public: /** This defines the prototype for a plugin that will
                        generate a stock name, based on input stock,
                        that will be used by Routed System Design
                        for creating new stock part during Advance.
                    
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            typedef NXOpen::Callback1<NXString, NXOpen::Routing::Stock *> GenerateStockComponentNameplugin;
            public: /** This defines the prototype for a plugin that will generate the PLMXML filename
                        when the option Export Route List in Bulk is toggled ON.
                     
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            typedef NXOpen::Callback3<NXString, NXString, NXString, NXString> GeneratePLMXMLFileNamePluginForBulkExport;
            ...
            (
                ...
                std::vector<int> & registeredCallbackIds /** The callback identifiers, if any, registered with this reason. */
            );
            ...
            /** Sets the plugin Routing will call when entering a Routing application.
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetApplicationEnterPlugin
            (
                const NXOpen::Routing::CustomManager::ApplicationEnterPlugin&  applicationEnterPlugin /** The method you want Routing to call when entering the application. */
            );
            ...
            /** Sets the plugin Routing will call when exiting a Routing application.
             ...
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetApplicationExitPlugin
            (
                const NXOpen::Routing::CustomManager::ApplicationExitPlugin&  applicationExitPlugin /** The method you want Routing to call when exiting the application. */
            );
            ...
            /** Sets the stock component name plugin.
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetStockComponentNamePlugin
            (
                const NXOpen::Routing::CustomManager::ComponentNamePlugin&  stockComponentNamePlugin /** The method you want Routing to call to get the stock component name. */
            );
            ...
            /** Sets the temporary stock component name plugin.
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetTemporaryStockComponentNamePlugin
            (
                const NXOpen::Routing::CustomManager::ComponentNamePlugin&  stockComponentNamePlugin /** The method you want Routing to call to get a temporary stock component name. */
            );
            /** Removes any registered stock component name plugin, except one configured in the Application View (APV) file. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Sets the cut elbow component name plugin.
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetCutElbowComponentNamePlugin
            (
                const NXOpen::Routing::CustomManager::ComponentNamePlugin&  cutElbowComponentNamePlugin /** The method you want Routing to call to get the cut elbow component name. */
            );
            ...
            /** Sets the plugin Routing will call to get the name for stock
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetGenerateStockComponentNamePlugin
            (
                const NXOpen::Routing::CustomManager::GenerateStockComponentNameplugin&  generateStockComponentNamePlugin /** The method you want Routing to call to get the name of stock component based on given stock. */
            );
            ...
            /** Sets the plugin Routing will call to get the name for PLMXML file
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: void SetGeneratePLMXMLFileNamePluginForBulkExport
            (
                const NXOpen::Routing::CustomManager::GeneratePLMXMLFileNamePluginForBulkExport&  partName /** The  method you want to call to generate the PLMXML file name for bulk export */
            );
