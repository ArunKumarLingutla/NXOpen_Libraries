    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AcousticsAndVibrationPotentialFlowSolutionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::AcousticsAndVibrationPotentialFlowSolution *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::AcousticsAndVibrationPotentialFlowSolution **;
                using reference = NXOpen::CAE::AcousticsAndVibrationPotentialFlowSolution *&;
