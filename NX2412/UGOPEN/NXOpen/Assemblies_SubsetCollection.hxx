    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  SubsetCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Assemblies::Subset *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Assemblies::Subset **;
                using reference = NXOpen::Assemblies::Subset *&;
            ...
            /** Creates an @link NXOpen::Assemblies::SubsetBuilder NXOpen::Assemblies::SubsetBuilder@endlink  
             <br>  Created in NX8.5.0.  <br>  
            ...
            /** Creates a @link NXOpen::Assemblies::RunContentProximitySearchTermBuilder NXOpen::Assemblies::RunContentProximitySearchTermBuilder@endlink .
                    
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            public: NXOpen::Assemblies::RunContentProximitySearchTermBuilder * CreateRunContentProximitySearchTermBuilder
            (
                NXOpen::Assemblies::RunContentProximitySearchTerm * runContentProximitySearchTerm /** @link NXOpen::Assemblies::RunContentProximitySearchTerm NXOpen::Assemblies::RunContentProximitySearchTerm@endlink  to be edited, if NULL then create a new one */
            );
            ...
            /** Creates an @link NXOpen::Assemblies::MechanicalRoutingSubsetBuilder NXOpen::Assemblies::MechanicalRoutingSubsetBuilder@endlink .
                        The SubsetBuilder parameter is for editing of the existing routing subset.
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            public: NXOpen::Assemblies::MechanicalRoutingSubsetBuilder * CreateMechanicalRoutingSubsetBuilder
            (
                NXOpen::Assemblies::SubsetBuilder * subsetBuilderTag /** subsetbuildertag */ 
            );
            /** Creates an @link NXOpen::Assemblies::MechanicalRoutingSubsetBuilder NXOpen::Assemblies::MechanicalRoutingSubsetBuilder@endlink .
                        The SubsetBuilder parameter is for editing of the existing surrounding subset's recipe.
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_4gd_integration ("4th Generation Design") */
            public: NXOpen::Assemblies::MechanicalRoutingSubsetBuilder * CreateMechanicalRoutingSubsetBuilderForSurroundingEdit
            (
                NXOpen::Assemblies::SubsetBuilder * subsetBuilderTag /** subsetbuildertag */ 
            );
