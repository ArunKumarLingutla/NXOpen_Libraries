...
#include <NXOpen/Display_DownloadOfflineRenderingBuilder.hxx>
...
#include <NXOpen/Display_IRayPlusStudioPreferencesBuilder.hxx>
...
#include <NXOpen/Display_IrayPlusStudioAnimationBuilder.hxx>
...
#include <NXOpen/Display_RayTracedStudioPreferencesBuilder.hxx>
...
#include <NXOpen/Display_VisualMaterialEditorBaseBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorCoatingBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorEmissionBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorFinishBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorSettingsBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorTextureSpaceBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorTexturesBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorTransmissionBuilder.hxx>
#include <NXOpen/Display_VisualMaterialEditorUtilitiesBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Display
    {
        class RayTracedStudioPreferencesBuilder;
    }
    namespace Display
    {
        class Reflection;
    ...
    */
    class NXOPENCPPEXPORT  ViewCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::View *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::View **;
            using reference = NXOpen::View *&;
        ...
        /** Creates a @link NXOpen::Display::Shadows NXOpen::Display::Shadows@endlink  
         <br>  @deprecated Deprecated in NX2406.0.0.  Use @link NXOpen::ViewCollection::CreateShadowsForDisplayStyle NXOpen::ViewCollection::CreateShadowsForDisplayStyle@endlink  overload instead. <br>  

         <br>  Created in NX7.5.3.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use NXOpen::ViewCollection::CreateShadowsForDisplayStyle overload instead.") NXOpen::Display::Shadows * CreateShadows
        (
        ...
        /** Creates a @link NXOpen::Display::Shadows NXOpen::Display::Shadows@endlink  
         ...
         <br> License requirements : None */
        public: NXOpen::Display::Shadows * CreateShadowsForDisplayStyle
        (
            NXOpen::View * view /** view to which shadows data will be associated */,
            NXOpen::View::DisplayStyleType displayStyle /** Display style (Shaded vs. Studio)  */
        );
        ...
        /** Saves specified view in the owning part.
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: void SaveView
        (
            NXOpen::View * view /** View to save */
        );
        /** Copies view from specified part. The input part must be a displayed part and view to copy is from the part. 
            The new copied view is always created in the current display part, which can be different from the input part.  @return  New copied view 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::View * CopyViewInPart
        (
            NXOpen::View * view /** View to copy */
        );
        ...
        /** Creates a @link NXOpen::Display::RayTracedStudioPreferencesBuilder NXOpen::Display::RayTracedStudioPreferencesBuilder@endlink  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Display::RayTracedStudioPreferencesBuilder * CreateRayTracedStudioPreferencesBuilder
        (
        );
        /** Creates a @link NXOpen::Display::RayTracedStudioEditorBuilder NXOpen::Display::RayTracedStudioEditorBuilder@endlink  
         ...
         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::Display::RayTracedStudioPreferencesBuilder instead.") NXOpen::Display::RayTracedStudioEditorBuilder * CreateRayTracedStudioEditorBuilder
        (
        );
        ...
        public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use NXOpen::Display::IRayPlusStudioPreferencesBuilder instead.") NXOpen::Display::IRayPlusStudioEditorBuilder * CreateIrayPlusStudioEditorBuilder
        (
        );
        /** Creates a @link NXOpen::Display::EnvironmentBuilder NXOpen::Display::EnvironmentBuilder@endlink  
         <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::ViewCollection::CreateEnvironmentBuilderForDisplayStyle NXOpen::ViewCollection::CreateEnvironmentBuilderForDisplayStyle@endlink  overload instead. <br>  

         <br>  Created in NX10.0.2.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::ViewCollection::CreateEnvironmentBuilderForDisplayStyle overload instead.") NXOpen::Display::EnvironmentBuilder * CreateEnvironmentBuilder
        (
            NXOpen::View * view /** view to which image-based lighting data will be associated */,
            bool makeReferencedObjects /** true if referenced image object is to be created */
        );
        /** Creates a @link NXOpen::Display::EnvironmentBuilder NXOpen::Display::EnvironmentBuilder@endlink  
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::Display::EnvironmentBuilder * CreateEnvironmentBuilderForDisplayStyle
        (
            NXOpen::View * view /** view to which image-based lighting data will be associated */,
            NXOpen::View::DisplayStyleType displayStyle /** Display style (Shaded vs. Studio)  */,
            bool makeReferencedObjects /** true if referenced image object is to be created */
        );
        /** Creates a @link NXOpen::Display::IRayPlusStudioPreferencesBuilder NXOpen::Display::IRayPlusStudioPreferencesBuilder@endlink  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::IRayPlusStudioPreferencesBuilder * CreateIrayPlusStudioPreferencesBuilder
        (
        );
        /** Creates a @link NXOpen::Display::DownloadOfflineRenderingBuilder NXOpen::Display::DownloadOfflineRenderingBuilder@endlink  
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::DownloadOfflineRenderingBuilder * CreateDownloadOfflineRenderingBuilder
        (
        );
        /** Creates a @link NXOpen::Display::IrayPlusStudioAnimationBuilder NXOpen::Display::IrayPlusStudioAnimationBuilder@endlink  
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::IrayPlusStudioAnimationBuilder * CreateIrayPlusStudioAnimationBuilder
        (
        );
        ...
        /** Creates a @link NXOpen::Display::VisualMaterialEditorBuilder NXOpen::Display::VisualMaterialEditorBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorBuilder * CreateVisualMaterialEditorBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorBuilder NXOpen::Display::VisualMaterialEditorBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorBuilder * CreateVisualMaterialEditorBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorBaseBuilder NXOpen::Display::VisualMaterialEditorBaseBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorBaseBuilder * CreateVisualMaterialEditorBaseBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorBaseBuilder NXOpen::Display::VisualMaterialEditorBaseBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorBaseBuilder * CreateVisualMaterialEditorBaseBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorCoatingBuilder NXOpen::Display::VisualMaterialEditorCoatingBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorCoatingBuilder * CreateVisualMaterialEditorCoatingBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorCoatingBuilder NXOpen::Display::VisualMaterialEditorCoatingBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorCoatingBuilder * CreateVisualMaterialEditorCoatingBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorEmissionBuilder NXOpen::Display::VisualMaterialEditorEmissionBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorEmissionBuilder * CreateVisualMaterialEditorEmissionBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorEmissionBuilder NXOpen::Display::VisualMaterialEditorEmissionBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorEmissionBuilder * CreateVisualMaterialEditorEmissionBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorFinishBuilder NXOpen::Display::VisualMaterialEditorFinishBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorFinishBuilder * CreateVisualMaterialEditorFinishBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorFinishBuilder NXOpen::Display::VisualMaterialEditorFinishBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorFinishBuilder * CreateVisualMaterialEditorFinishBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorSettingsBuilder NXOpen::Display::VisualMaterialEditorSettingsBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorSettingsBuilder * CreateVisualMaterialEditorSettingsBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorSettingsBuilder NXOpen::Display::VisualMaterialEditorSettingsBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorSettingsBuilder * CreateVisualMaterialEditorSettingsBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorTextureSpaceBuilder NXOpen::Display::VisualMaterialEditorTextureSpaceBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorTextureSpaceBuilder * CreateVisualMaterialEditorTextureSpaceBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorTextureSpaceBuilder NXOpen::Display::VisualMaterialEditorTextureSpaceBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorTextureSpaceBuilder * CreateVisualMaterialEditorTextureSpaceBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorTexturesBuilder NXOpen::Display::VisualMaterialEditorTexturesBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorTexturesBuilder * CreateVisualMaterialEditorTexturesBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorTexturesBuilder NXOpen::Display::VisualMaterialEditorTexturesBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorTexturesBuilder * CreateVisualMaterialEditorTexturesBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorTransmissionBuilder NXOpen::Display::VisualMaterialEditorTransmissionBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorTransmissionBuilder * CreateVisualMaterialEditorTransmissionBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorTransmissionBuilder NXOpen::Display::VisualMaterialEditorTransmissionBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorTransmissionBuilder * CreateVisualMaterialEditorTransmissionBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorUtilitiesBuilder NXOpen::Display::VisualMaterialEditorUtilitiesBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        public: NXOpen::Display::VisualMaterialEditorUtilitiesBuilder * CreateVisualMaterialEditorUtilitiesBuilder
        (
            const NXString & materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Display::VisualMaterialEditorUtilitiesBuilder NXOpen::Display::VisualMaterialEditorUtilitiesBuilder@endlink  
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : studio_render ("UG STUDIO RENDER") */
        NXOpen::Display::VisualMaterialEditorUtilitiesBuilder * CreateVisualMaterialEditorUtilitiesBuilder
        (
            const char * materialName /** materialname */ 
        );
        /** Creates a @link NXOpen::Gateway::ImageExportBuilder NXOpen::Gateway::ImageExportBuilder@endlink . 
            Image creation is supported in the session when graphics is enabled. This is available in an interactive as well as in non-interactive 
            session supporting headless graphics.  
