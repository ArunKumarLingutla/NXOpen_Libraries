    ...
    namespace PDM
    {
        ...
        */
        class NXOPENCPP_PDMEXPORT  PartAttributeAssignmentObserver
        {
            ...
            /** This function registers the user-defined function  @return  The identifier of the method being registered. This can be used to unregister (using UnRegisterUserDefinedFunction()) if needed  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
