        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  SubdivisionModelingPreferences
        {
            ...
            /**Returns  the sharp edge line color. 
             ...
             <br> License requirements : None */
            public: int SharpEdgeLineColor
            (
            );
            /**Sets  the sharp edge line color. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_subdivision (" NX SUBDIVISION") OR nx_polygon_modeling (" NX Polygon Modeling") */
            public: void SetSharpEdgeLineColor
            (
                int lineColor /** linecolor */ 
            );
            ...
            /**Returns  the flag indicating if external faces will be made translucent in preview of some commands if vertices have been selected on these faces.
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool MakeExternalFaceTranslucent
            (
            );
            /**Sets  the flag indicating if external faces will be made translucent in preview of some commands if vertices have been selected on these faces.
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_subdivision (" NX SUBDIVISION") */
            public: void SetMakeExternalFaceTranslucent
            (
                bool makeTranslucent /** maketranslucent */ 
            );
            /**Returns  the flag indicating if Subdivision Body faces should be merged. When turned on, smoothly
             ...
             <br> License requirements : None */
            public: bool MergeSubdivisionBodyFacesIfPossible
            (
            );
            /**Sets  the flag indicating if Subdivision Body faces should be merged. When turned on, smoothly
                        connected face regions of Subdivision Body may be merged while maintaining an accurate representation
                        of the initial body.
                    
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_subdivision (" NX SUBDIVISION") */
            public: void SetMergeSubdivisionBodyFacesIfPossible
            (
                bool merge /** merge */ 
            );
