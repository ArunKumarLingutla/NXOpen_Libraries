...
namespace NXOpen
{
    ...
    /** Represents a collection of infinite lines.  <br> To obtain an instance of this class, refer to @link NXOpen::BasePart  NXOpen::BasePart @endlink  <br> 
     <br>  Created in NX7.5.0.  <br>  
    */
    class NXOPENCPPEXPORT  InfiniteLineCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        //lint -sem(NXOpen::InfiniteLineCollection::iterator::copy,initializer)
        class iterator
        {
        public:
            using value_type = NXOpen::InfiniteLine *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::InfiniteLine **;
            using reference = NXOpen::InfiniteLine *&;
        ...
        /** Finds the @link  NXOpen::InfiniteLine   NXOpen::InfiniteLine @endlink  with the given identifier as recorded in a journal. 
        ...
        /** Finds the @link  NXOpen::InfiniteLine   NXOpen::InfiniteLine @endlink  with the given identifier as recorded in a journal. 
         ...
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        NXOpen::InfiniteLine * FindObject
        (
