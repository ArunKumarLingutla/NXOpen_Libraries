...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** This class contains the factory method for creating Coatings feature builder.  <br> To obtain an instance of this class, refer to @link NXOpen::Coatings::CoatingManager  NXOpen::Coatings::CoatingManager @endlink  <br> 
         <br>  Created in NX1926.0.0.  <br>  
        */
        class COATINGSOPENCPPEXPORT  CoatingsCollection : public NXOpen::TaggedObjectCollection
        {
            private: CoatingsCollectionImpl * m_coatingscollection_impl;
            private: NXOpen::Coatings::CoatingManager* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit CoatingsCollection(NXOpen::Coatings::CoatingManager *owner);
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_coatings (" Coatings") */
            public: NXOpen::Features::Coatings::CoatingThickenBodyBuilder * CreateCoatingsCoatingThickenBodyBuilder
            (
                NXOpen::Part * part /** part */ ,
                NXOpen::Features::Coatings::CoatingThickenBody * coatingThickenBody /** @link NXOpen::Features::Coatings::CoatingThickenBody NXOpen::Features::Coatings::CoatingThickenBody@endlink  to be edited */
            );
