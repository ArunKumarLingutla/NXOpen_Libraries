        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  SelPref : public NXOpen::Builder
        {
            ...
            /**Returns  the quick pick see thru toggle 
             ...
             <br> License requirements : None */
            public: bool QuickPickSeeThruToggle
            (
            );
            /**Sets  the quick pick see thru toggle 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetQuickPickSeeThruToggle
            (
                bool quickPickSeeThruToggle /** quickpickseethrutoggle */ 
            );
