...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        PrintMarkThickness.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  TextBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the flag indicating if this text feature is a Print Mark 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: bool IsPrintMark
            (
            );
            /**Sets  the flag indicating if this text feature is a Print Mark 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetPrintMark
            (
                bool isPrintMark /** isprintmark */ 
            );
            /**Returns  the print mark thickness 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * PrintMarkThickness
            (
            );
            /**Returns  the print mark usage label 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXString PrintMarkUsageLabel
            (
            );
            /**Sets  the print mark usage label 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: void SetPrintMarkUsageLabel
            (
                const NXString & printMarkUsageLabel /** printmarkusagelabel */ 
            );
            /**Sets  the print mark usage label 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            void SetPrintMarkUsageLabel
            (
                const char * printMarkUsageLabel /** printmarkusagelabel */ 
            );
            /**Returns  the flag indicating if character spacing is enabled 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool EnableCharacterSpacing
            (
            );
            /**Sets  the flag indicating if character spacing is enabled 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetEnableCharacterSpacing
            (
                bool enable /** enable */ 
            );
            /**Returns  the font gap factor. Font gap factor decides number of pixels to be used
                        to space the characters. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double FontGapFactor
            (
            );
            /**Sets  the font gap factor. Font gap factor decides number of pixels to be used
                        to space the characters. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetFontGapFactor
            (
                double gapFactor /** gapfactor */ 
            );
            /**Returns  the flag indicating if caret positioning should be enabled 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool EnableCaretPositioning
            (
            );
            /**Sets  the flag indicating if caret positioning should be enabled 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetEnableCaretPositioning
            (
                bool enable /** enable */ 
            );
