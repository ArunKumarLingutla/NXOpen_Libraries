    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  IntersectionSymbolCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Annotations::IntersectionSymbol *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::IntersectionSymbol **;
                using reference = NXOpen::Annotations::IntersectionSymbol *&;
