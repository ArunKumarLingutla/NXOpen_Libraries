...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AttributeTemplate </term> <description> 
         
        Template1 </description> </item> 

        <item><term> 
         
        InputName </term> <description> 
         
        Template1 </description> </item> 

        <item><term> 
         
        MultipleFile </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ReplaceOption </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ElectrodeEDMOutputBuilder : public NXOpen::Builder
        {
            ...
            public: enum FileType
            {
                ...
                FileTypeIng/** ING document */,
                FileTypeDoc/** DOC document */,
                FileTypeDocx/** DOCX document */,
                FileTypePdf/** PDF document */,
                FileTypeDat/** DAT document */,
                FileTypeExcel/** EXCEL document */,
                FileTypeNone/** None of document type*/
            };
