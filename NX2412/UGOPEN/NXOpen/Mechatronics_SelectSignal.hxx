...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectSignalBuilder;
        class SelectSignalImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectSignal : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSignalImpl * m_selectsignal_impl;
            private: friend class  _SelectSignalBuilder;
            protected: SelectSignal();
            public: ~SelectSignal();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::Signal * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Mechatronics::Signal * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
