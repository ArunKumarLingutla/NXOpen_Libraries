...
#include <NXOpen/Routing_AssignTerminalsBuilder.hxx>
#include <NXOpen/Routing_AssignTerminalsItemBuilder.hxx>
...
#include <NXOpen/Routing_Electrical_PathArrangementBuilder.hxx>
#include <NXOpen/Routing_Electrical_SplicePositionBuilder.hxx>
...
#include <NXOpen/Routing_PortArrayListItemBuilder.hxx>
#include <NXOpen/Routing_PortArraysBuilder.hxx>
#include <NXOpen/Routing_QualifyPortBuilder.hxx>
#include <NXOpen/Routing_ReuseLibrary.hxx>
#include <NXOpen/Routing_Run.hxx>
#include <NXOpen/Routing_RunItem.hxx>
#include <NXOpen/Routing_SpecificationBranchCompatibilityTable.hxx>
#include <NXOpen/Routing_SpecificationConnectionCompatibilityTable.hxx>
#include <NXOpen/Routing_StockDataRefreshBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        class CablewayNetworkCollection;
    }
    namespace Routing
    {
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RouteManager
        {
            ...
            public: enum JsonInformation
            {
                JsonInformationSplice/** splice */ ,
                JsonInformationClocking/** clocking */ ,
                JsonInformationTwist/** twist */ ,
                JsonInformationAll/** all */ 
            };
            ...
            /** Route List import modes
                    ...
                    +------------+------------++--------------+---------------+-----------------+
                    | Derivative | Derivative || No           | No            | Yes             |
                    +------------+------------++--------------+---------------+-----------------+
                    ...
                    +------------+------------++--------------+---------------+-----------------+------------------+
                    | Derivative | Derivative || No           | No            | No              | No               |
                    +------------+------------++--------------+---------------+-----------------+------------------+
                    ...
                    +------------+------------++--------------+---------------+-----------------+
                    | Derivative | Derivative || Yes          | Yes           | GUID            |
                    +------------+------------++--------------+---------------+-----------------+
                       @endcode 
            ...
            {
                ImportModeUpdate/** Update existing objects with data from the imported objects. */ = 700,
                ...
                ImportModeDerivative/** Create the imported harnesses as derivatives harnesses */
            };
            ...
            {
                FindObjectTypeHarness/** harness */ ,
                FindObjectTypeCable/** cable */ ,
                FindObjectTypeShield/** shield */ ,
                FindObjectTypeConnector/** connector */ ,
                FindObjectTypeDevice/** device */ ,
                FindObjectTypeConnection/** connection */ ,
                FindObjectTypeWire/** wire */ ,
                FindObjectTypeUnknown/** unknown */  = -1
            };
            ...
            {
                public: /** Required. The type of object to find. */NXOpen::Routing::RouteManager::FindObjectType ObjectType;
                public: /** Optional. The harness that owns the object. Not required, but it does speed up the process of finding the object. */NXOpen::Routing::Electrical::HarnessDevice * OwningHarness;
                public: /** Optional. The name of the application name that created a application reference with the unique ID. */NXString ApplicationName;
                public: /** Optional. The unique ID either created by NX (if applicationName is blank) or by another application. */NXString UniqueID;
                public: SearchCriteria() :
                    ObjectType((NXOpen::Routing::RouteManager::FindObjectType)0),
                    OwningHarness(),
                    ApplicationName(),
                    UniqueID()
                {
                ...
                public: SearchCriteria(NXOpen::Routing::RouteManager::FindObjectType objectTypeInitial /** Required. The type of object to find. */, 
                        NXOpen::Routing::Electrical::HarnessDevice * owningHarnessInitial /** Optional. The harness that owns the object. Not required, but it does speed up the process of finding the object. */, 
                        const NXString &applicationNameInitial /** Optional. The name of the application name that created a application reference with the unique ID. */, 
                        const NXString &uniqueIDInitial /** Optional. The unique ID either created by NX (if applicationName is blank) or by another application. */) :
                    ObjectType(objectTypeInitial),
                    OwningHarness(owningHarnessInitial),
                    ApplicationName(applicationNameInitial),
                    UniqueID(uniqueIDInitial)
                {
                }
            };
            ...
            /** Creates a new down direction object based on the direction for the part used by Routing.  @return  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Direction * CreateNewDownDirection
            (
            );
            ...
            public: void ExportHx2ml
            (
                const NXString & hx2mlFilename /** The name of the file into which this method will write
                                    the NX Routing HX2ML data. */
            );
            /** Exports all of the NX Routing electrical information from the currently open part
                        to the given file.
            ...
            void ExportHx2ml
            (
                const char * hx2mlFilename /** The name of the file into which this method will write
                                    the NX Routing HX2ML data. */
            );
            /** Exports all of the NX Routing electrical information from the currently open part
                        to the given file.
            ...
            /** Imports NX Routing electrical information from the given HX2ML file
                        ...
                        <ul>
                            ...
                            <li>There is no part file open</li>
                            <li>An import mode other than Upate or derivative is used.</li>
                        </ul>
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: void ImportHx2ml
            (
                const NXString & hx2mlFilename /** The name of the file from which this method will read
                                    the NX Routing electrical information. */,
                NXOpen::Routing::RouteManager::ImportMode importOperation /** The import mode: update or derivative; merge andppend are invalid
            ...
            void ImportHx2ml
            (
                const char * hx2mlFilename /** The name of the file from which this method will read
                                    the NX Routing electrical information. */,
                NXOpen::Routing::RouteManager::ImportMode importOperation /** The import mode: update or derivative; merge andppend are invalid
                                    See @link NXOpen::Routing::RouteManager::ImportMode NXOpen::Routing::RouteManager::ImportMode@endlink  for more information. */
            );
            ...
            (
                const NXString & plmxmlFilename /** The name of the file from which this method will read
                                    the NX Routing electrical information. */,
                NXOpen::Routing::RouteManager::ImportMode importOperation /** The import mode: update, merge, append, or derivative.
                                    See @link NXOpen::Routing::RouteManager::ImportMode NXOpen::Routing::RouteManager::ImportMode@endlink  for more information. */
            );
            /** Imports NX Routing electrical information from the given PLM XML file
                        into the current work part.
            ...
            (
                ...
                const NXString & importFormatName /** The name of the format from the Routing List (RLIST) configuration file
                                    ...
                                    section of the Routing Quick Reference Guide. */
            );
            /** Imports NX Routing electrical information from the given
                        XML or legacy component file into the current work part.
            ...
            /** Executes the Routing Design Rules against the work part 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::Routing::RouteManager::CheckDesignRules NXOpen::Routing::RouteManager::CheckDesignRules@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Routing::RouteManager::CheckDesignRules instead.") void CheckDesignRules
            (
            ...
            (
                NXOpen::Routing::DesignRuleViolationCollection::Mode mode /** Either @link NXOpen::Routing::DesignRuleViolationCollection::Mode::Interactive NXOpen::Routing::DesignRuleViolationCollection::Mode::Interactive@endlink  or
                                       @link NXOpen::Routing::DesignRuleViolationCollection::Mode::Concurrent NXOpen::Routing::DesignRuleViolationCollection::Mode::Concurrent@endlink  */,
                NXOpen::Routing::CustomManager::DesignRuleReason reason /** Either @link NXOpen::Routing::CustomManager::DesignRuleReason::Interactive NXOpen::Routing::CustomManager::DesignRuleReason::Interactive@endlink  or 
                                one of the other reasons indicating which dialog is asking for design rules to be checked. */,
                const std::vector<NXOpen::NXObject *> & objects /** The objects to check.  May be empty. */,
                std::vector<NXOpen::Routing::DesignRuleViolation *> & violations /** The violations generated by the check.  May be empty. */
            );
            ...
            (
                ...
                const NXString & compName /** comp name */ ,
            ...
            (
                ...
                const NXString & refsetName /** refset name */ 
            );
            /** Replaces old component with new component, and relinks ports if possible. Copies the characteristics on the old component
                        onto the new component. 
             <br>  Created in NX5.0.0.  <br>  
            ...
            (
                NXOpen::Assemblies::Component * oldOcc /** old occ */ ,
                NXOpen::Assemblies::Component * newOcc /** new occ */ ,
                const char * refsetName /** refset name */ 
            );
            /** Replaces old component with new component, and relinks ports if possible. Copies the characteristics on the old component
            ...
            public: void ReplaceComponents
            (
                NXOpen::Assemblies::Component * oldOcc /** The old part occurrence being replaced  */,
                NXOpen::Assemblies::Component * newOcc /** The new part occurrence replacement */,
                const NXString & refsetName /** The name of the reference set */,
                NXOpen::Routing::RouteManager::FixPosition fixPosition /** Determines whether a temp constraint will be applied to the replacing component */
            );
            /** Replaces old component with new component, and relinks ports if possible. Copies the characteristics on the old component
                        onto the new component. The parameter fixPosition can allow a fix constraint to be applied to the new component
                        in order to prevent it from moving during the replace component operation. 
            ...
            (
                NXOpen::Assemblies::Component * oldOcc /** The old part occurrence being replaced  */,
                NXOpen::Assemblies::Component * newOcc /** The new part occurrence replacement */,
                const char * refsetName /** The name of the reference set */,
                NXOpen::Routing::RouteManager::FixPosition fixPosition /** Determines whether a temp constraint will be applied to the replacing component */
            );
            ...
            (
                const NXString & filename /** The name of the file where newly created fabrication component would be saved*/,
            ...
            (
                const char * filename /** The name of the file where newly created fabrication component would be saved*/,
                const std::vector<NXOpen::NXObject *> & objects /** Routing objects to be fabricated */,
                NXOpen::Routing::CharacteristicList * charxData /** attributes to apply to the fabricated component. */
            );
            /** Creates a Routing fabrication, a sub-assembly made of
                        ...
                        @link NXOpen::Routing::Stock NXOpen::Routing::Stock@endlink  from the assembly in which
                        the Routing Fabrication is created.
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::Routing::RouteManager::BuildFabricationWithFileNewBuilder NXOpen::Routing::RouteManager::BuildFabricationWithFileNewBuilder@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Routing::RouteManager::BuildFabricationWithFileNewBuilder instead.") NXOpen::Part * BuildFabrication
            (
                const NXString & filename /** The name of the file where newly created fabrication component would be saved*/,
                const std::vector<NXOpen::NXObject *> & objects /** Routing objects to be fabricated */,
            ...
            /**Create a Routing fabrication sub-assembly made of
             ...
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NXOpen::Part * BuildFabricationWithFileNewBuilder
            (
                NXOpen::FileNew * builder /** builder */ ,
                const std::vector<NXOpen::NXObject *> & objects /** Routing objects to be fabricated */,
                NXOpen::Routing::CharacteristicList * optionalCharxData /** Required attributes to apply to the fabricated component. */,
                NXOpen::Routing::CharacteristicList * requiredCharxData /** Optional attributes to apply to the fabricated component.*/
            );
            ...
            (
                const NXString & fileName /** File name to load. */
            );
            /** Loads the part list format (template) file. Part list is based on this
                        format and using this Bill of Material (BOM) is generated.  @return  Template part. 
             <br>  Created in NX5.0.0.  <br>  
            ...
            /** Creates a  @link NXOpen::Routing::SimplifyPathBuilder NXOpen::Routing::SimplifyPathBuilder@endlink  that combines the
                        collinear segments by merging RCPs in the Routed System Designer applications.  @return  
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::SimplifyPathBuilder * CreateSimplifyPathBuilder2
            (
            ...
            /** Creates a @link NXOpen::Routing::SplinePathBuilder NXOpen::Routing::SplinePathBuilder@endlink  which creates
                        D-Cubed constrained splines.  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Creates a builder that can transform a path.  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Copy the overstock from subassembly to parent assembly.
                        ...
                        and recreate them over WAVE-linked segment at the parent assembly level.  @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            /** Creates @link NXOpen::Routing::Electrical::CablewaysBuilder NXOpen::Routing::Electrical::CablewaysBuilder@endlink .  @return  
             ...
             <br> License requirements : routing_cabling ("Routing Cabling") */
            public: NXOpen::Routing::Electrical::CablewaysBuilder * CreateCablewaysBuilderWithObjects
            (
            ...
            (
                const NXString & nodeIdentifier /** The identifier of the reuse node that contains the part being placed. */,
                NXOpen::Routing::CharacteristicList * fileSelectCharx /** The characteristics for the file select part. */,
                const NXOpen::Point3d & placementPos /** The location in 3D space where the part was dropped. */,
                NXOpen::TaggedObject * placementObj /** The object the part was dropped on. Can be NULL */,
            ...
            /** Creates a @link NXOpen::Routing::StockTransitionBuilder NXOpen::Routing::StockTransitionBuilder@endlink  that can create or edit stock transition. @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NXOpen::Routing::StockTransitionBuilder * CreateStockTransitionBuilder
            (
                const std::vector<NXOpen::NXObject *> & objects /** Routing segments to assign
                                                                                       stock transition to or stock transition to be edited */
            );
            ...
            /** Creates a @link NXOpen::Routing::ManualRouteBuilder NXOpen::Routing::ManualRouteBuilder@endlink  that can create or edit stock transition. @return  
             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            (
                NXOpen::Assemblies::Component * bipComponent /** Built-In Path Component */
            );
            ...
            /** Creates a @link NXOpen::Routing::CreateFabricationBuilder NXOpen::Routing::CreateFabricationBuilder@endlink  which fabricate subassembly from standard parts, path segments, stock, and other routing objects within the current routing assembly 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            /** Creates a new @link NXOpen::Routing::RunItem NXOpen::Routing::RunItem@endlink .
                        ...
                        Use @link NXOpen::Routing::Run::Edit NXOpen::Routing::Run::Edit@endlink  to add this new item to an existing run. 
            ...
            /** Creates a @link NXOpen::Routing::FindByAttributesBuilder NXOpen::Routing::FindByAttributesBuilder@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            ...
            /** Creates an HVAC Duct Reinforcement Builder. See the documentation in the
                        @link NXOpen::Routing::DuctReinforcementBuilder NXOpen::Routing::DuctReinforcementBuilder@endlink  class for a description of the builder. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            public: NXOpen::Routing::DuctReinforcementBuilder * CreateDuctReinforcementBuilderForStock
            (
                NXOpen::NXObject * ductReinforcement /** ductreinforcement */ 
            );
            /** Creates an HVAC Wind Catcher builder. See the documentation in the
                        @link NXOpen::Routing::WindCatcherBuilder NXOpen::Routing::WindCatcherBuilder@endlink  class for a description of the builder. 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : routing_hvac ("Routing HVAC") */
            ...
            /** Creates an Platform builder. See the documentation in the
                        @link NXOpen::Routing::PlatformCreatorBuilder NXOpen::Routing::PlatformCreatorBuilder@endlink  class for a description of the builder. 
            ...
            /** Creates a @link NXOpen::Routing::AssignPathBuilder NXOpen::Routing::AssignPathBuilder@endlink  
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            (
                const NXString & itemPartNumber /** itempartnumber */ ,
            ...
            (
                const char * itemPartNumber /** itempartnumber */ ,
            ...
            /** Creates a @link NXOpen::Routing::StockDataRefreshBuilder NXOpen::Routing::StockDataRefreshBuilder@endlink  for refreshing Routing Stock Data definitions. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::StockDataRefreshBuilder * CreateStockDataRefreshBuilder
            (
            );
            /** Creates a @link NXOpen::Routing::StockPartConverterBuilder NXOpen::Routing::StockPartConverterBuilder@endlink  
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            ...
            /** Places a gasket part based on the gasketCharx @link NXOpen::Routing::CharacteristicList NXOpen::Routing::CharacteristicList@endlink  .
             ...
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: void ModelConnectionPostPlacementGasketBetweenFlanges
            (
                NXOpen::Assemblies::Component * placedPart /** The newly placed flange which will be shifted to accommodate the gasket */,
                NXOpen::Routing::PortConnection * connection /** The original flange flange connection  */,
                NXOpen::Routing::ReuseLibrary::ReportInBom reportInBOM /** Is the gasket to be reported in the bill of materials? */,
                ...
                NXOpen::Routing::PortConnection ** connectionOne /** One of the new gasket flange connections */,
                NXOpen::Routing::PortConnection ** connectionTwo /** The other new gasket flange connection */,
                NXOpen::Assemblies::Component ** modeledGasket /** The gasket created */
            );
            ...
            /** Creates a @link NXOpen::Routing::AlignStockBuilder NXOpen::Routing::AlignStockBuilder@endlink  for aligning Routing Stocks.
                    Provide a tool to align non-circular stocks to routing objects.
             <br>  Created in NX9.0.3.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::AlignStockBuilder * CreateAlignStockBuilder
            (
            );
            /** Designates the passed in Coordinate System as a Formboard Placement Coordinate System for the part 
             ...
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: void DesignateFormboardPlacementCSys
            (
            ...
            /** Creates a @link Routing::Electrical::PathArrangementBuilder Routing::Electrical::PathArrangementBuilder@endlink  
             <br>  Created in NX10.0.3.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::Electrical::PathArrangementBuilder * CreatePathArrangementBuilder
            (
            );
            ...
            public: bool IsStockComponent
            (
                NXOpen::Assemblies::Component * inputComponent /** inputcomponent */ 
            );
            /** Returns the Routing object, if any, that matches the given search criteria. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: NXOpen::Routing::RootObject * FindRoutingObject
            (
                const NXOpen::Routing::RouteManager::SearchCriteria & searchCriteria /** searchcriteria */ 
            );
            /** Returns the @link Routing::ISegment Routing::ISegment@endlink s, if any, that match the given globally unique identifier (GUID). 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: std::vector<NXOpen::Routing::ISegment *> FindRoutingSegments
            (
            ...
            /** Returns the @link Routing::ISegment Routing::ISegment@endlink s, if any, that match the given globally unique identifier (GUID). 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            std::vector<NXOpen::Routing::ISegment *> FindRoutingSegments
            (
                const char * guid /** guid */ 
            );
            /** Returns the @link Routing::ControlPoint Routing::ControlPoint@endlink , if any, that matches the given globally unique identifier (GUID). 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: NXOpen::Routing::ControlPoint * FindRoutingControlPoint
            (
                const NXString & guid /** guid */ 
            );
            /** Returns the @link Routing::ControlPoint Routing::ControlPoint@endlink , if any, that matches the given globally unique identifier (GUID). 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            NXOpen::Routing::ControlPoint * FindRoutingControlPoint
            (
                const char * guid /** guid */ 
            );
            ...
            /** Highlights the given object in the Component or Connection Navigator.
             ...
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: void SelectObjectInNavigator
            (
                NXOpen::Routing::RootObject * objectToSelect /** objecttoselect */ 
            );
            /** Highlights the given objects in the Component or Connection Navigator.
             ...
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: void SelectObjectsInNavigator
            (
                const std::vector<NXOpen::Routing::RootObject *> & objectsToSelect /** objectstoselect */ 
            );
            /** Returns all of the objects selected in the Component and Connection Navigators. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: void GetSelectedObjectsInNavigators
            (
                std::vector<NXOpen::Routing::RootObject *> & selectedObjects /** selectedobjects */ 
            );
            /** Returns the @link Routing::Stock Routing::Stock@endlink , if any, that was used to create the given solid body. 
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: NXOpen::Routing::Stock * GetStockFromBody
            (
            ...
            /** Creates a @link NXOpen::Routing::PlaceElbowsBuilder NXOpen::Routing::PlaceElbowsBuilder@endlink  that is used to place multiple elbows. 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : routing_pipetube ("Routing Piping and Tubing") */
            public: NXOpen::Routing::PlaceElbowsBuilder * CreateRoutingPlaceElbowsBuilder
            (
            );
            /** Creates a @link NXOpen::Routing::BuiltInPathBuilder NXOpen::Routing::BuiltInPathBuilder@endlink  that is used to qualify Built-in Path. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::BuiltInPathBuilder * CreateBuiltInPathBuilder
            (
                NXOpen::Routing::BuiltInPath * bipObject /** bipobject */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::CablewayNetworkBuilder * CreateCablewayNetworkBuilder
            (
                NXOpen::Routing::CablewayNetwork * cablewayObject /** cablewayobject */ 
            );

            /// \endcond 
            /** Creates a @link NXOpen::Routing::AnchorBuilder NXOpen::Routing::AnchorBuilder@endlink  that is used to qualify Anchor. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::AnchorBuilder * CreateAnchorBuilder
            (
                NXOpen::Routing::Anchor * anchorObject /** anchorobject */ 
            );
            /** Creates a @link NXOpen::Routing::CrossSectionBuilder NXOpen::Routing::CrossSectionBuilder@endlink  that is used to qualify Cross Section. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::CrossSectionBuilder * CreateCrossSectionBuilder
            (
                NXOpen::Routing::CrossSection * crossSectionObject /** crosssectionobject */ 
            );
            /** Creates a @link NXOpen::Routing::FormboardPlacementCoordinateSystemBuilder NXOpen::Routing::FormboardPlacementCoordinateSystemBuilder@endlink  that is used to qualify Formboard Placements. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::FormboardPlacementCoordinateSystemBuilder * CreateFormboardPlacementCoordinateSystemBuilder
            (
                NXOpen::CoordinateSystem * csysObject /** csysobject */ 
            );
            /** Creates a @link NXOpen::Routing::EndFormBuilder NXOpen::Routing::EndFormBuilder@endlink  that is used to place End Form. 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: NXOpen::Routing::EndFormBuilder * CreateRoutingEndFormBuilder
            (
            );
            /** Creates a @link NXOpen::Routing::QualifyPortBuilder NXOpen::Routing::QualifyPortBuilder@endlink  that is used to create ports. 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::QualifyPortBuilder * CreateQualifyPortBuilder
            (
                NXOpen::Routing::Port * port /** Port to edit */
            );
            /** Creates a @link NXOpen::Routing::AssignTerminalsBuilder NXOpen::Routing::AssignTerminalsBuilder@endlink  that is used to assign terminals to multiports
                    
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::AssignTerminalsBuilder * CreateAssignTerminalsBuilder
            (
                NXOpen::Routing::Port * port /** MultiPort to edit */
            );
            /** Creates a @link NXOpen::Routing::AssignTerminalsItemBuilder NXOpen::Routing::AssignTerminalsItemBuilder@endlink  that is used to specify attributes 
                    of a terminal ports like terminal name, terminal direction and terminal origin.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::AssignTerminalsItemBuilder * CreateAssignTerminalsItemBuilder
            (
                NXOpen::Routing::Port * port /** MultiPort to edit */
            );
            /** Creates a @link NXOpen::Routing::NamingPatternBuilder NXOpen::Routing::NamingPatternBuilder@endlink  that is used to create a sequence of port names 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::NamingPatternBuilder * CreateNamingPatternBuilder
            (
            );
            /** Creates a @link NXOpen::Routing::PortArraysBuilder NXOpen::Routing::PortArraysBuilder@endlink 
                    This class allows to create terminal port arrays for circular or rectangular pattern for multi-ports.
                    
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::PortArraysBuilder * CreatePortArraysBuilder
            (
                NXOpen::Routing::Port * port /** MultiPort to edit */
            );
            /** Creates a @link NXOpen::Routing::PortArrayListItemBuilder NXOpen::Routing::PortArrayListItemBuilder@endlink  
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::PortArrayListItemBuilder * CreatePortArrayListItemBuilder
            (
            );
            /** 
            ...
            /** Creates a @link NXOpen::Routing::Electrical::SplicePositionBuilder NXOpen::Routing::Electrical::SplicePositionBuilder@endlink  
                    This class allows to create or reposition the splices in NX.
                    
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: NXOpen::Routing::Electrical::SplicePositionBuilder * CreateSplicePositionBuilder
            (
                NXOpen::Point * splicePoint /** splicepoint */ 
            );
            /** 
            ...
            /**
             ...
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            void HighLightPathandBundleSolids
            (
                NXOpen::Routing::ControlPoint * controlPoint1 /** controlpoint1 */ ,
                NXOpen::Routing::ControlPoint * controlPoint2 /** controlpoint2 */ ,
            ...
            /** Exports the splice objects in part to a JSON file if customer default 'Export PLMXML Unused Topology' is turned on.
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: void ExportSpliceObjects
            (
                const NXString & jsonFilename /** jsonfilename */ 
            );
            /** Exports the splice objects in part to a JSON file if customer default 'Export PLMXML Unused Topology' is turned on.
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            void ExportSpliceObjects
            (
                const char * jsonFilename /** jsonfilename */ 
            );
            ...
            (
                NXOpen::Routing::RouteManager::JsonInformation infoType /** infotype */ ,
                const NXString & jsonFileName /** jsonfilename */ 
            );
            /** Exports NX Routing electrical information related to specified input 
                        from the currently open part to the JSON file.
            ...
            (
                const NXString & zipFilename /** zipfilename */ 
            );
            /** Exports NX Routing electrical information through Zip file created by PLMXML and JSON File (if generated). 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            ...
            (
                const NXString & zipFilename /** zipfilename */ ,
                NXOpen::Routing::RouteManager::ImportMode importOperation /** importoperation */ 
            );
            /** Imports the Routing electrical information from Zip file.
                        Zip file must contain plmxml file. JSON file is optional. No other file should be present in Zip file.
             <br>  Created in NX1926.0.0.  <br>  
            ...
            /** Exports NX Routing electrical information from input harness device to the JSON file.
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            public: void ExportJsonFromHarnessDevice
            (
                NXOpen::Routing::Electrical::HarnessDevice * harnessDeviceTag /** harnessdevicetag */ ,
                NXOpen::Routing::RouteManager::JsonInformation infoType /** infotype */ ,
                const NXString & jsonFileName /** jsonfilename */ 
            );
            /** Exports NX Routing electrical information from input harness device to the JSON file.
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced") */
            void ExportJsonFromHarnessDevice
            (
                NXOpen::Routing::Electrical::HarnessDevice * harnessDeviceTag /** harnessdevicetag */ ,
                NXOpen::Routing::RouteManager::JsonInformation infoType /** infotype */ ,
                const char * jsonFileName /** jsonfilename */ 
            ...
            /** Creates a AdvanceToRsd builder.  See the documentation in the
                        @link NXOpen::Routing::AdvanceToRsdBuilder NXOpen::Routing::AdvanceToRsdBuilder@endlink  class for a description of the builder.  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::AdvanceToRsdBuilder * CreateAdvanceToRsdBuilder
            (
            );
            /** Qualifies a module assembly part
             <br>  Created in NX2306.4000.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void QualifyModuleAssemblyPart
            (
            );
            /** Removes Qualification from module assembly part
             <br>  Created in NX2306.4000.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void DisQualifyModuleAssemblyPart
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::SpecificationBranchCompatibilityTable *> GetSpecificationBranchCompatibilityTables
            (
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: std::vector<NXOpen::Routing::SpecificationConnectionCompatibilityTable *> GetSpecificationConnectionCompatibilityTables
            (
            );
            ...
            */
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
            */
            public: NXOpen::Routing::CablewayNetworkCollection *CablewayNetworks();
            ...
            */
            public: NXOpen::Routing::Electrical::DerivativeDeviceCollection *DerivativeDevices();
            ...
            */
            ...
            /** Splice Point Collection 
             <br>  Created in NX2306.0.0.  <br>  
            */
            public: NXOpen::Routing::Electrical::SplicePointCollection *SplicePoints();
            ...
            */
            ...
            /** Bend Report Manager 
             <br>  Created in NX11.0.1.  <br>  
            */
            public: NXOpen::Routing::BendReportManager *BendReportManager();
