...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        /** Creates a Workpiece Collection  <br> To obtain an instance of this class, refer to @link NXOpen::Tooling::ToolingManager  NXOpen::Tooling::ToolingManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  WorkpieceCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Tooling::WorkpieceBuilder *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Tooling::WorkpieceBuilder **;
                using reference = NXOpen::Tooling::WorkpieceBuilder *&;
