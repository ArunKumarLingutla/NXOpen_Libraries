...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a collection of Point on Surface objects  <br> To obtain an instance of this class, refer to @link NXOpen::Motion::MotionManager  NXOpen::Motion::MotionManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  PointOnSurfaceCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Motion::PointOnSurface *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Motion::PointOnSurface **;
                using reference = NXOpen::Motion::PointOnSurface *&;
            ...
            /** Creates a @link NXOpen::Motion::PointOnSurfaceBuilder NXOpen::Motion::PointOnSurfaceBuilder@endlink   @return  
             <br>  Created in NX6.0.0.  <br>  
            ...
            /** Finds the @link  NXOpen::Motion::PointOnSurface   NXOpen::Motion::PointOnSurface @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  NXOpen::Motion::PointOnSurface   NXOpen::Motion::PointOnSurface @endlink  with this name. 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::PointOnSurface * FindObject
            (
                const NXString & name /** The name of the @link  NXOpen::Motion::PointOnSurface   NXOpen::Motion::PointOnSurface @endlink . */
            );
            /** Finds the @link  NXOpen::Motion::PointOnSurface   NXOpen::Motion::PointOnSurface @endlink  with the given name.
                        An exception will be thrown if no object can be found with given name.  @return  @link  NXOpen::Motion::PointOnSurface   NXOpen::Motion::PointOnSurface @endlink  with this name. 
             <br>  Created in NX6.0.0.  <br>  
            ...
            (
                const char * name /** The name of the @link  NXOpen::Motion::PointOnSurface   NXOpen::Motion::PointOnSurface @endlink . */
            );
