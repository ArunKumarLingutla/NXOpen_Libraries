    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSession
        {
            ...
            /** Gets all scenario names from master part.
                        In non-managed mode, the scenarios are from motion subfolder of master part.
                        In managed mode, the scenarios are the motion part names from master part. @return  scenario simple names 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: std::vector<NXString> GetMotionScenarios
            (
                NXOpen::NXObject * masterPart /** the master part object */,
                std::vector<NXString> & scenariosFullName /** scenario full names */
            );
            ...
            /** Calculate DOF   @return  The DOF count 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: int CalculateDof
            (
                NXOpen::NXObject * simPart /** simpart */ ,
                NXOpen::Motion::MotionSolution * solution /** solution */ 
            );
            /** Expand all navigator nodes 
            ...
            /** Check if the given part is a Motion Part. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool IsMotionPart
            (
                NXOpen::BasePart * part /** A part object*/
            );
            /** Check if the given assembly component is Motion Submechanism. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool IsSubmechanism
            (
                NXOpen::Assemblies::Component * component /** An assembly component*/
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: bool IsFeatureToggleEnabled
            (
                const NXString & featureToggleName /** featuretogglename */ 
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            bool IsFeatureToggleEnabled
            (
                const char * featureToggleName /** featuretogglename */ 
            );
