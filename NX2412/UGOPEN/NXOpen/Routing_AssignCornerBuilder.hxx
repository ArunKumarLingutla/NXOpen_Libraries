...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        RouteAssignCornerCornerBlock.RouteCornerBendMethods </term> <description> 
         
        Radius </description> </item> 

        <item><term> 
         
        RouteAssignCornerCornerBlock.RouteCornerRadius.RightHandSide </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        RouteAssignCornerCornerBlock.RouteCornerRatioToDiameter.RightHandSide </term> <description> 
         
        0 (millimeters part), 0 (inches part) </description> </item> 

        <item><term> 
         
        RouteAssignCornerCornerBlock.RouteCornerRequireLinearSolution </term> <description> 
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  AssignCornerBuilder : public NXOpen::Builder
        {
            ...
            /** Corner Attributes 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::CharacteristicList * GetBendCornerAttributes
            (
            );
            /** Corner Attributes 
             <br>  Created in NX12.0.0.  <br>  
            ...
            (
                NXOpen::Routing::CharacteristicList * selectedRowAttributesCharxList /** selectedrowattributescharxlist */ 
            );
