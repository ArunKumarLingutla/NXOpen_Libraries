...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a WedmMoveControl Builder  <br> To create a new instance of this class, use @link NXOpen::CAM::NCGroupCollection::CreateWedmMoveControlBuilder  NXOpen::CAM::NCGroupCollection::CreateWedmMoveControlBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  WedmMoveControlBuilder : public NXOpen::CAM::ParamBuilder
        {
