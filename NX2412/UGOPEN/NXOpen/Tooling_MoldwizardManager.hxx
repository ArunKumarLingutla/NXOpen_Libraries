    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  MoldwizardManager
        {
            ...
            /** Creates Mold Cost builder. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::MoldCostBuilder * CreateMoldCostBuilder
            (
            );
            /** Creates a data provider for Mold Cost.  @return @link  Tooling::MoldCostCustomerDataProvider  Tooling::MoldCostCustomerDataProvider@endlink  object 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::MoldCostCustomerDataProvider * CreateMoldCostCustomerDataProvider
            (
            );
            ...
            /** Creates RenameAndExportComponentTeamcenter builder  @return @link  RenameAndExportComponentTeamcenterBuilder   RenameAndExportComponentTeamcenterBuilder @endlink  object object 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Tooling::RenameAndExportComponentTeamcenterBuilder * CreateRenameAndExportComponentTeamcenterBuilder
            (
            );
            /** Creates MoldDirection builder 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::MoldDirectionBuilder * CreateMoldDirectionBuilder
            (
            );
            /** Creates assign material builder 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR nx_electrode_wizard ("NX Electrode Wizard") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Tooling::AssignMaterialBuilder * CreateAssignMaterialBuilder
            (
            );
            /** Creates LocalExtension builder. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::LocalExtensionBuilder * CreateLocalExtensionBuilder
            (
            );
            /** Creates ManageAssemblyReadonlyStatusBuilder builder. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Tooling::ManageAssemblyReadonlyStatusBuilder * CreateManageAssemblyReadonlyStatusBuilder
            (
            );
            /** Creates rapid channel builder 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::RapidChannelBuilder * CreateRapidChannelBuilder
            (
            );
            /** Creates a data provider for Mold Cost concept object.  @return @link  Tooling::MoldCostConceptObjectDataProvider  Tooling::MoldCostConceptObjectDataProvider@endlink  object 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::MoldCostConceptObjectDataProvider * CreateMoldCostConceptObjectDataProvider
            (
            );
            /** Creates AddMoldCostAssemblyBuilder 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::AddMoldCostAssemblyBuilder * CreateAddMoldCostAssemblyBuilder
            (
            );
            /** Creates plunger design builder 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: NXOpen::Tooling::PlungerDesignBuilder * CreatePlungerDesignBuilder
            (
            );
