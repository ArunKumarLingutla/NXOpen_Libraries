...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        /** Represents a collection of @link NXOpen::Routing::DesignRuleViolationLocation NXOpen::Routing::DesignRuleViolationLocation@endlink  objects.  <br> To obtain an instance of this class, refer to @link NXOpen::Routing::RouteManager  NXOpen::Routing::RouteManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  DesignRuleViolationLocationCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Routing::DesignRuleViolationLocation *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Routing::DesignRuleViolationLocation **;
                using reference = NXOpen::Routing::DesignRuleViolationLocation *&;
            ...
            /** Creates a @link NXOpen::Routing::DesignRuleViolationLocation NXOpen::Routing::DesignRuleViolationLocation@endlink  object.  @return  
             <br>  Created in NX6.0.0.  <br>  
