    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  FeedsBuilder : public NXOpen::TaggedObject
        {
            ...
            */
            public: enum RecalculateBasedOn
            {
                RecalculateBasedOnSurfaceSpeed/** surface speed*/,
                RecalculateBasedOnSpindleSpeed/** spindle speed*/,
                RecalculateBasedOnFeedPerTooth/** feed per tooth*/,
                RecalculateBasedOnCutFeedRate/** cut feed rate*/
            };
            ...
            (
                const NXString & selection /** the selected preset name */
            );
            /** Set preset selection 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetPresetSelection
            (
                const char * selection /** the selected preset name */
            );
            ...
            (
                NXOpen::CAM::FeedsBuilder::RecalculateBasedOn type /** the recalculation based on attribute */
            );
