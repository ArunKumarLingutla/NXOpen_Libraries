...
namespace NXOpen
{
    ...
    namespace Composites
    {
        class _SelectIPlyListBuilder;
        class SelectIPlyListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class COMPOSITESOPENCPPEXPORT  SelectIPlyList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectIPlyListImpl * m_selectiplylist_impl;
            private: friend class  _SelectIPlyListBuilder;
            protected: SelectIPlyList();
            public: ~SelectIPlyList();
            ...
            public: bool Add
            (
                NXOpen::Composites::IPly * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Composites::IPly *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Composites::IPly * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Composites::IPly * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Composites::IPly * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Composites::IPly * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Composites::IPly *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Composites::IPly * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Composites::IPly *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Composites::IPly *> GetArray
            (
            );
