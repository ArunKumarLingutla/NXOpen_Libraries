        ...
        */
        class NXOPENCPP_IMPLICITEXPORT  EquationOperationBuilder : public NXOpen::Implicit::OperationBuilder
        {
            ...
            public: enum BoundaryConditionOptionType
            {
                ...
                BoundaryConditionOptionTypeSolidVolumeAndUnite/** Solid region and unite */
            };
            ...
            public: enum ThicknessMethodType
            {
                ...
                ThicknessMethodTypeApproximate/** approximate */ 
            };
            ...
            /**Returns  the flag indiciating if operation represents a unit cell. A unit cell is a triply periodic body with one period. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsUnitCell
            (
            );
            /**Sets  the flag indiciating if operation represents a unit cell. A unit cell is a triply periodic body with one period. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : nx_implicit (" NX Implicit Modeling") */
            public: void SetUnitCell
            (
                bool isUnitCell /** isunitcell */ 
            );
            /** Returns the range of K Factor 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void GetKFactorRange
            (
                double* minKFactor /** minkfactor */ ,
                double* maxKFactor /** maxkfactor */ 
            );
        };
    }
}
