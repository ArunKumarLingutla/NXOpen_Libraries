...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX8.0.0.  This functionality is no longer supported.") NXOPENCPP_GEOMETRICUTILITIESEXPORT  PatternClocking : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: enum ClockingType
            {
                ...
                ClockingTypeWithinPatternDefinitionAxial/** within pattern definition axial */ 
            };
