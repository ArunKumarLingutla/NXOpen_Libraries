...
namespace NXOpen
{
    ...
    /** This class contains the factory methods for creating selection intent rules  <br> To obtain an instance of this class, refer to @link NXOpen::BasePart  NXOpen::BasePart @endlink  <br> 
    ...
    */
    class NXOPENCPPEXPORT  ScRuleFactory
    {
        ...
        /// \cond NX_NO_DOC 
        public: explicit ScRuleFactory(NXOpen::BasePart *owner);
        ...
        public: NXOpen::SelectionIntentRuleOptions * CreateRuleOptions
        (
        );
        ...
        (
            const std::vector<NXOpen::Edge *> & edges /** Edges which creates this rule.*/,
            NXOpen::SelectionIntentRuleOptions * options /** Additional options used to create this rule. */
        );
        ...
        public: NXOpen::FaceDumbRule * CreateRuleFaceDumb
        (
            const std::vector<NXOpen::Face *> & faces /** Faces which create this rule. */,
            NXOpen::SelectionIntentRuleOptions * options /** Additional options used to create this rule. */
        );
        /** Creates selection intent rule: @link  NXOpen::FaceDumbRule   NXOpen::FaceDumbRule @endlink   @return  
         <br>  Created in NX4.0.0.  <br>  
        ...
        (
            const std::vector<NXOpen::DatumPlane *> & faces /** Datum Planes which create this rule. */
        );
        /** Creates selection intent rule: @link  NXOpen::FaceDumbRule   NXOpen::FaceDumbRule @endlink   @return  
         <br>  Created in NX1953.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        ...
        (
            NXOpen::Face * seedFace /** Seed face used to create this rule. */,
            const std::vector<NXOpen::Face *> & boundaryFaces /** Faces defining the boundaries of this rule. */
        );
        ...
        /** Creates selection intent rule: @link  NXOpen::FaceHoleFacesRule   NXOpen::FaceHoleFacesRule @endlink   @return  
         <br>  Created in NX1980.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::FaceHoleFacesRule * CreateRuleFaceHole
        (
            NXOpen::Face * seed /** Seed face used to create this rule. */,
            NXOpen::SelectionIntentRuleOptions * options /** Additional options used to create this rule. */
        );
        /** Creates selection intent rule: @link  NXOpen::TangentSheetBodiesRule   NXOpen::TangentSheetBodiesRule @endlink   @return  
         <br>  @deprecated Deprecated in NX2312.0.0.  Use CreateRuleTangentSheetBodies_1 instead. <br>  

         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use CreateRuleTangentSheetBodies_1 instead.") NXOpen::TangentSheetBodiesRule * CreateRuleTangentSheetBodies
        (
        ...
        /** Creates selection intent rule: @link  NXOpen::TangentSheetBodiesRule   NXOpen::TangentSheetBodiesRule @endlink   @return  
         ...
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::TangentSheetBodiesRule * CreateRuleTangentSheetBodies1
        (
            NXOpen::Body * seedBody /** Seed body used to create this rule. */,
            const std::vector<NXOpen::Body *> & negatedDomainEntities /** Array of bodies to be negated from the output of supplied domain features. */,
            const std::vector<NXOpen::NXObject *> & domainFeatures /** Array of domain features to be considered for chaining. */,
            NXOpen::SelectionIntentRuleOptions * options /** Additional options used to create this rule. */
        );
        /** Creates selection intent rule: @link  NXOpen::AdjacentSheetBodiesRule   NXOpen::AdjacentSheetBodiesRule @endlink   @return  
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::AdjacentSheetBodiesRule * CreateRuleAdjacentSheetBodies
        (
            NXOpen::Body * seedBody /** Seed body used to create this rule. */,
            const std::vector<NXOpen::Body *> & negatedDomainEntities /** Array of bodies to be negated from the output of supplied domain features.*/,
            const std::vector<NXOpen::NXObject *> & domainFeatures /** Array of domain features to be considered for chaining.*/,
        ...
        /** Creates selection intent rule: @link  NXOpen::ConnectedSheetBodiesRule   NXOpen::ConnectedSheetBodiesRule @endlink   @return  
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::ConnectedSheetBodiesRule * CreateRuleConnectedSheetBodies
        (
            NXOpen::Body * seedBody /** Seed body used to create this rule. */,
            const std::vector<NXOpen::Body *> & negatedDomainEntities /** Array of bodies to be negated from the output of supplied domain features.*/,
            const std::vector<NXOpen::NXObject *> & domainFeatures /** Array of domain features to be considered for chaining.*/,
        ...
        /** Creates selection intent rule: @link  NXOpen::SheetAndAdjacentSheetBodiesRule   NXOpen::SheetAndAdjacentSheetBodiesRule @endlink   @return  
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::SheetAndAdjacentSheetBodiesRule * CreateRuleSheetAndAdjacentSheetBodies
        (
            NXOpen::Body * seedBody /** Seed body used to create this rule. */,
            const std::vector<NXOpen::Body *> & negatedDomainEntities /** Array of bodies to be negated from the output of supplied domain features.*/,
            const std::vector<NXOpen::NXObject *> & domainFeatures /** Array of domain features to be considered for chaining.*/,
        ...
        /** Creates selection intent rule: @link  NXOpen::FaceCurvatureCrossSectionFacesRule   NXOpen::FaceCurvatureCrossSectionFacesRule @endlink   @return  
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::FaceCurvatureCrossSectionFacesRule * CreateRuleFaceCurvatureCrossSectionFaces
        (
            NXOpen::Face * seed /** Seed face used to create this rule. */,
            NXOpen::Edge * propagationEdge1 /** First propagation edge to propagate face chain. */,
            NXOpen::Edge * propagationEdge2 /** Second propagation edge to propagate face chain. */,
            NXOpen::Face * limitFace1 /** First limit face to select portion of face chain. */,
            NXOpen::Face * limitFace2 /** Second limit face to select portion of face chain. */,
            NXOpen::SelectionIntentRuleOptions * options /** Additional options used to create this rule. */
        );
        ...
        /** This is an internal API and can be changed at any time 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : gateway ("UG GATEWAY") */
        public: NXOpen::EdgeGroupFaceBoundaryEdgesRule * CreateRuleEdgeGroupFaceBoundaryEdges
        (
            NXOpen::Edge * startEdge /** Start edge used to create this rule. */,
            NXOpen::Edge * endEdge /** End edge used to create this rule. */,
            NXOpen::Features::Feature * faceGroupFeature /** Face Group For Collection */,
