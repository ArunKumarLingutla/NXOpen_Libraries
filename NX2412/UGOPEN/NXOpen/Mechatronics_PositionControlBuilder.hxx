    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  PositionControlBuilder : public NXOpen::Mechatronics::PhysicsConstraintBuilder
        {
            ...
            /** the closed curve path options for point on curve. */
            public: enum ClosedCurvePathOptions
            {
                ClosedCurvePathOptionsTrackMultipleTurns/** follow shortest path */,
                ClosedCurvePathOptionsFollowShortestPath/** track multiple turns */
            };
            ...
            /**Returns  the use external data flag, which is used to control if the position control data is from external. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: bool UseExternalData
            (
            );
            /**Sets  the use external data flag, which is used to control if the position control data is from external. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetUseExternalData
            (
                bool useExternalData /** useexternaldata */ 
            );
            /**Returns  the closed curve path option. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: NXOpen::Mechatronics::PositionControlBuilder::ClosedCurvePathOptions ClosedCurvePath
            (
            );
            /**Sets  the closed curve path option. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetClosedCurvePath
            (
                NXOpen::Mechatronics::PositionControlBuilder::ClosedCurvePathOptions closedCurvePath /** closedcurvepath */ 
            );
            /**Returns  the dynamic material parameter type, which works only when the position control is used to
                        drive @link NXOpen::Mechatronics::DynamicMaterial NXOpen::Mechatronics::DynamicMaterial@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: NXOpen::Mechatronics::SpeedPositionControlBuilderTargetparameter ParameterType
            (
            );
            /**Sets  the dynamic material parameter type, which works only when the position control is used to
                        drive @link NXOpen::Mechatronics::DynamicMaterial NXOpen::Mechatronics::DynamicMaterial@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetParameterType
            (
                NXOpen::Mechatronics::SpeedPositionControlBuilderTargetparameter parameterType /** parametertype */ 
            );
            /** Set the target expression to control. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: void SetTarget
            (
                NXOpen::Expression * targetExp /** targetexp */ 
            );
        };
    }
}
