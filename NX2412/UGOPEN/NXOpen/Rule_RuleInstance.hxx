...
namespace NXOpen
{
    ...
    namespace Rule
    {
        ...
        */
        ...
        {
            /** Scope types for rule execution  */
            ...
            /** Create a attribute node output for rule instance 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Rule::NodeOutput * CreateAttributesNodeOutput
            (
                NXOpen::Rule::Node * node /** node */ ,
            ...
            /// \cond NX_NO_DOC 
            /** This is an internal API and can be changed at any time 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use @link JA_RuleInstance_CreatePmiDataNodeOutput JA_RuleInstance_CreatePmiDataNodeOutput@endlink  instead. <br>  

             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use JA_RuleInstance_CreatePmiDataNodeOutput instead.") NXOpen::Rule::NodeOutput * CreateSelectPmiDataNodeOutput
            (
                NXOpen::Rule::Node * node /** node */ ,
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::Rule::NodeOutput * CreatePmiDataNodeOutput
            (
                NXOpen::Rule::Node * node /** node */ ,
                const std::vector<NXOpen::NXObject *> & objectTags /** objecttags */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: NXOpen::Rule::NodeOutput * CreateColumnConfigurationNodeOutput
            (
                NXOpen::Rule::Node * node /** node */ ,
                std::vector<NXString> & columnAttributeDetails /** columnattributedetails */ ,
                std::vector<NXString> & columnNames /** columnnames */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Rule::NodeOutput * CreateElementTableColumnConfigurationNodeOutput
            (
                NXOpen::Rule::Node * node /** node */ ,
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::Rule::NodeOutput * CreateElementTableColumnConfigurationNodeOutput
            (
                NXOpen::Rule::Node * node /** node */ ,
