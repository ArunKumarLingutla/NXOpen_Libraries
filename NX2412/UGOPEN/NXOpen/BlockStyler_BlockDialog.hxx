    ...
    namespace BlockStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  BlockDialog : public NXOpen::TransientObject
        {
            ...
            {
                DialogResponseInvalid/** Invalid response. */,
                DialogResponseOk/** OK button was pressed. */,
                DialogResponseCancel/** Cancel button was pressed. */,
                DialogResponseBack/** Back button was pressed. */,
                DialogResponseApply/** Apply button was pressed. */
            };
            ...
            /** Shows the dialog in @link BlockStyler::BlockDialog::DialogModeCreate BlockStyler::BlockDialog::DialogModeCreate@endlink  mode.  This method will not return until the dialog is closed, 
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use BlockStyler::BlockDialog::Launch instead") NXOpen::Selection::Response Show
            (
            );
            /** Shows the dialog based upon the mode specified in 
                ...
                This method will not return until the dialog is closed, which typically is when the dialog's OK or Cancel button is pressed.  @return Returns 1: When Back is pressed. 2: When Cancel is pressed. 3: When Ok or Apply is pressed.
             ...
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use BlockStyler::BlockDialog::LaunchInDialogMode instead") NXOpen::Selection::Response Show
            (
            ...
            /** Shows the dialog based upon the mode specified in 
                @link BlockStyler::BlockDialog::DialogMode BlockStyler::BlockDialog::DialogMode@endlink .
                This method will not return until the dialog is closed, which typically is when the dialog's navigation buttons are pressed.  @return Returns 1: When Ok is pressed. 2: When Cancel is pressed. 3: When Back is pressed. 4: When Apply is pressed.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::BlockStyler::BlockDialog::DialogResponse LaunchInDialogMode
            (
                NXOpen::BlockStyler::BlockDialog::DialogMode dialogMode /**Dialog mode as Create or Edit. @link BlockStyler::BlockDialog::DialogMode  BlockStyler::BlockDialog::DialogMode @endlink  */
            );
