        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ReusableObjectPasteBuilder : public NXOpen::Builder
        {
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: void LoadReusableObject
            (
                const NXString & partFileName /** Part file name */,
            ...
            /// \endcond 
            /** Updates pull face feature for pattern geometory in reusable object group 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdatePullFace
            (
            );
            /** Gets the imported features of reusable part 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: void GetImportedFeatures
            (
                std::vector<NXOpen::Features::Feature *> & featureTags /** featuretags */ 
            );
        };
    }
}
