        ...
        */
        class NXOPENCPP_CAMEXPORT  LaserTool : public NXOpen::CAM::SoftTool
        {
            ...
            /**Returns  the standoff distance 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * StandoffDistance
            (
            );
            /**Returns  the working diameter 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * WorkingDiameter
            (
            );
            /**Returns  the working range 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableDoubleBuilder * WorkingRange
            (
            );
        };
    }
