    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TitleBlockCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Annotations::TitleBlock *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::TitleBlock **;
                using reference = NXOpen::Annotations::TitleBlock *&;
            ...
            /** Creates a @link NXOpen::Annotations::EditTitleBlockBuilder NXOpen::Annotations::EditTitleBlockBuilder@endlink .
                        ...
                        @link NXOpen::Annotations::DefineTitleBlockBuilder NXOpen::Annotations::DefineTitleBlockBuilder@endlink . 
             <br>  Created in NX8.0.0.  <br>  
            ...
            /** Creates a @link NXOpen::Annotations::DefineTitleBlockBuilder NXOpen::Annotations::DefineTitleBlockBuilder@endlink .
                        ...
                        title block, please use @link NXOpen::Annotations::EditTitleBlockBuilder NXOpen::Annotations::EditTitleBlockBuilder@endlink . 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a cell builder 
             <br>  @deprecated Deprecated in NX12.0.1.  Use overloaded @link NXOpen::Annotations::TitleBlockCollection::CreateCellBuilder NXOpen::Annotations::TitleBlockCollection::CreateCellBuilder@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Use overloaded NXOpen::Annotations::TitleBlockCollection::CreateCellBuilder instead.") NXOpen::Annotations::TitleBlockCellBuilder * CreateCellBuilder
            (
            ...
            /** Creates a cell builder  @return  Title block cell builder 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::TitleBlockCellBuilder * CreateCellBuilder
            (
                NXOpen::DisplayableObject * tableCell /** Tabnot cell for which title block cell builder is to be created. */,
                bool lockStatus /** Lock status for the title block cell; True or False. */,
                const NXString & label /** Label for the title block cell. */
            );
            /** Creates a cell builder  @return  Title block cell builder 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            ...
            (
                NXOpen::DisplayableObject * tableCell /** Tabnot cell for which title block cell builder is to be created. */,
                bool lockStatus /** Lock status for the title block cell; True or False. */,
                const char * label /** Label for the title block cell. */
            );
