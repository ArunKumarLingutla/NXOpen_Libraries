        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  StandardPartBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the positioning feature used to control how to add standard parts. 
             ...
             <br> License requirements : None */
            public: NXOpen::SelectNXObject * PositioningFeature
            (
            );
            /**Returns  the CSYS used to orient the added standard part. 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObject * PositioningCsys
            (
            );
            /** Mate for PDW punch insert 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void MateForPDWPunchInsert
            (
                int positionType /** positiontype */ 
            );
            /** Reposition standard part set for EDW 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void RepositionStandardPartSetForEDW
            (
            );
            /** Restores the standard part data from concept point or symbol. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ReadStandardPartDataFromConceptObject
            (
                NXOpen::NXObject * conceptObject /** conceptobject */ 
            );
            /** Finds out all symbols/points with same part name in the parent part of the input concept object. 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void GetAllConceptObjectInstances
            (
                NXOpen::NXObject * conceptObject /** conceptobject */ ,
                std::vector<NXOpen::NXObject *> & pInstanceObjects /** pinstanceobjects */ 
            );
            /** Creates the clone object  @return  A @link NXOpen::Tooling::CloneObject NXOpen::Tooling::CloneObject@endlink  instance 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Tooling::CloneObject * BuildCloneObject
            (
            ...
            /** Creates the clone object  @return  A @link NXOpen::Tooling::CloneObject NXOpen::Tooling::CloneObject@endlink  instance 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            NXOpen::Tooling::CloneObject * BuildCloneObject
            (
                int installationType /** installationtype */ ,
                const char * clonePartName /** clonepartname */ 
            );
            /** Initializes the data structure for plane position 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void InitializePositionData
            (
                int actionType /** actiontype */ 
            );
            /** Free the data structure for plane position 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /** Remove selected concept object 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void RemoveConceptObject
            (
                NXOpen::NXObject * conceptObject /** conceptobject */ 
            );
            /** Analyze the position type 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: int AnalyzePostionType
            (
                const NXString & positionType /** positiontype */ ,
                bool isReorientView /** isreorientview */ ,
                NXOpen::NXObject * positionPlane /** positionplane */ ,
                NXOpen::Point3d* positionPoint /** positionpoint */ ,
                NXOpen::Matrix3x3* positionMatrix /** positionmatrix */ 
            );
            /** Analyze the position type 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            int AnalyzePostionType
            (
                const char * positionType /** positiontype */ ,
                bool isReorientView /** isreorientview */ ,
                NXOpen::NXObject * positionPlane /** positionplane */ ,
                NXOpen::Point3d* positionPoint /** positionpoint */ ,
                NXOpen::Matrix3x3* positionMatrix /** positionmatrix */ 
            ...
            /** Prepare position data for associative plane position 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: int PreparePositionDataForSmartPosition
            (
                int acttionType /** acttiontype */ 
            );
            /** Asks the position face from selected standard part occurrence or selected concept standard part
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::NXObject * AskPositionFace
            (
            );
            /**Returns  the flag to indicate whether to use the associative point position method. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool AssociativePointPosition
            (
            );
            /**Sets  the flag to indicate whether to use the associative point position method. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetAssociativePointPosition
            (
                bool associativePointPosition /** associativepointposition */ 
            );
            /** Converts specified concept object and its instances to real standard part components 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ConvertConceptObjectToRealStandardPart
            (
                const std::vector<NXOpen::NXObject *> & pConceptObjects /** concept objects,can be symbols or points */
            );
            /** Updates the dimensions of standard part by specified condition 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void UpdateDimensionsByCondition
            (
                NXOpen::Assemblies::Component * partOccurrence /** partoccurrence */ ,
                std::vector<NXString> & conditions /** Search conditions*/
            );
            /**Returns  the flag to indicate whether to use standard part position dialog to add standard part for point position type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool UsePositionDialogForPointType
            (
            );
            /**Sets  the flag to indicate whether to use standard part position dialog to add standard part for point position type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUsePositionDialogForPointType
            (
                bool bUsePointPositionDialog /** busepointpositiondialog */ 
            );
            /**Returns  the flag to indicate whether to use standard part position dialog to add standard part for plane position type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool UsePositionDialogForPlaneType
            (
            );
            /**Sets  the flag to indicate whether to use standard part position dialog to add standard part for plane position type 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUsePositionDialogForPlaneType
            (
                bool bUsePlanePositionDialog /** buseplanepositiondialog */ 
            );
            /**Returns  the flag to indicate whether to make the standard part read-only after edit 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool MakeReadOnlyAfterEdit
            (
            );
            /**Sets  the flag to indicate whether to make the standard part read-only after edit 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetMakeReadOnlyAfterEdit
            (
                bool bMakeReadonlyAfterEdit /** bmakereadonlyafteredit */ 
            );
            /** Gets the feature tag by name  @return  the tag of the found feature 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * FindComponentFeatureByName
            (
                const NXString & featureName /** the name of the feature to find */,
                const NXString & partName /** the name of the part which owns the feature */,
                int featureType /** the type of the feature to find */,
                NXOpen::Part ** owningPart /** the tag of part which owns the found feature */
            );
            /** Gets the feature tag by name  @return  the tag of the found feature 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::NXObject * FindComponentFeatureByName
            (
                const char * featureName /** the name of the feature to find */,
                const char * partName /** the name of the part which owns the feature */,
                int featureType /** the type of the feature to find */,
                NXOpen::Part ** owningPart /** the tag of part which owns the found feature */
            );
            /** Finds all of the named features in the components of the given standard part assembly 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void FindComponentNamedFeatures
            (
                NXOpen::Assemblies::Component * partOccurrence /** the occurrence of the part where named features to be found */
            );
            /** Repositions the standard part with a selected Datum CSYS 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void RepositionStandardPartBySelectedCsys
            (
                int positionType /** the positioning type */
            );
            /** Repositions the standard part with a specified point 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void RepositionStandardPartBySpecifiedPoint
            (
                int positionType /** the positioning type */,
                NXOpen::NXObject * locatingPoint /** the point used as new source entity to relink the Linked Point feature */
            );
            /** Creates constraint between the standard part component and the selected CSYS 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CreateConstraintBetweenComponentAndCSYS
            (
                NXOpen::Assemblies::Component * partOccurrence /** the occurrence of the standard part to edit */,
                NXOpen::NXObject * selectedCSYS /** the selected CSYS to create constraint */
            );
            /** Sets whether the linked feature fix at current timestamp 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetLinkFeatureFixAtCurrentTimestamp
            (
                NXOpen::NXObject * linkedFeature /** the linked feature to edit timestamp */,
                int featureType /** the feature type */,
                bool fixAtTimestamp /** the value of Fix at Current Timestamp to set for the feature  */
            );
            /** Checks whether the position of the selected standard part is changed 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: bool CheckStandardPartPosition
            (
                NXOpen::Assemblies::Component * partOccurrence /** the occurrence of the standard part to edit */
            );
            /** Manages the read-only status of the standard part being edited 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ManageStandardPartReadOnlyStatus
            (
                bool makeReadOnly /** Whether to make read-only or modifiable  */
            );
            /** Creates component pattern to pattern CSYS 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CreateComponentPatternToPatternCsys
            (
                NXOpen::NXObject * partInstance /** The part instance tag to add component pattern */,
                NXOpen::NXObject * selectedCSYS /** The selected CSYS to add component pattern */
            );
            /** Creates reference component pattern 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CreateReferenceComponentPattern
            (
                NXOpen::NXObject * sketch /** The selected positioning feature's sketch to add component pattern */,
                NXOpen::NXObject * point /** The point tag to add component pattern */,
                const std::vector<NXOpen::NXObject *> & instances /** The part instance tags to add component pattern */
            );
        };
    }
}
