...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AngleLimit.Value </term> <description> 
        ...
        HeightLimit.Value </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  PiercingInsertDesignBuilder : public NXOpen::Builder
        {
            ...
            /** piercing insert design page type. */
            public: enum PageTypes
            {
                PageTypesDie/** die */ ,
                PageTypesPunch/** punch */ ,
                PageTypesCavityAndSlugHole/** cavity and slug hole */ 
            };
            ...
            /**Returns  the slug in pb height linear dim 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * HeightLimit
            (
            );
            /**Returns  the slug in pb angular dim 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * AngleLimit
            (
            );
            /**Returns  the direction of slug in pb 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool ReverseDirection
            (
            );
            /**Sets  the direction of slug in pb 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            ...
            /**Returns  the suppress of pb component
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool SuppressPBComponent
            (
            );
            /**Sets  the suppress of pb component
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetSuppressPBComponent
            (
                bool suppressPBComponent /** suppresspbcomponent */ 
            );
            /**Returns  the page type 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::PiercingInsertDesignBuilder::PageTypes PageType
            (
            );
            /**Sets  the page type 
             <br>  Created in NX2406.0.0.  <br>  
            ...
            (
                NXOpen::Tooling::PiercingInsertDesignBuilder::PageTypes type /** type */ 
            );
            /**Returns  the punch shim distance 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: double PunchShimDistance
            (
            );
            /**Sets  the punch shim distance 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetPunchShimDistance
            (
                double punchShimDistance /** Indicates the shim distance value of user defined punch */
            );
            ...
            /** The action to update standard punch. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateStandardPunch
            (
                NXOpen::NXObject * newCreatedInstance /** newcreatedinstance */ 
            );
            /** The action to assign clearance string to part. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetBlankClearance
            (
                const NXString & clearanceStr /** clearancestr */ ,
                NXOpen::NXObject * partTag /** parttag */ 
            );
            /** The action to assign clearance string to part. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            void SetBlankClearance
            (
                const char * clearanceStr /** clearancestr */ ,
                NXOpen::NXObject * partTag /** parttag */ 
            );
        };
    }
