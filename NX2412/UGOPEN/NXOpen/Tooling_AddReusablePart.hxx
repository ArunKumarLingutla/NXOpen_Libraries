        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  AddReusablePart : public NXOpen::Builder
        {
            ...
            /** Creates criteria 
             ...
             <br> License requirements : None */
            public: NXOpen::PartFamily::InstanceSelectionCriteria * CreateCriteria
            (
                const NXString & expStr /** expstr */ ,
                const NXString & addValue /** addvalue */ 
            );
            /** Creates criteria 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            NXOpen::PartFamily::InstanceSelectionCriteria * CreateCriteria
            (
                const char * expStr /** expstr */ ,
                const char * addValue /** addvalue */ 
            );
            ...
            /**Sets the inter-part undelay status on the component.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void UndelayComponentToUpdate
            (
                NXOpen::Part * obj /** obj */ 
            );
            /**Sets the inter-part delay status on the components.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void DelayComponents
            (
                const std::vector<NXOpen::TaggedObject *> & objs /** objs */ 
            );
            /** 
            ...
            /** 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateMountingFeetInfo
            (
                NXOpen::Assemblies::Component * partOcc /** partocc */ 
            );
            /**Adds the added reuseable part to the related pattern definition 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void AddReuseablePartToPattern
            (
            );
            /**Returns  the seed CSYS of Positioning feature
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CoordinateSystem * PositioningFeatureSeedCsys
            (
            );
            /**Sets  the seed CSYS of Positioning feature
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetPositioningFeatureSeedCsys
            (
                NXOpen::CoordinateSystem * seedCsys /** Seed CSYS tag */
            );
            /**Returns  the flag of reselecting object
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool ReselectObject
            (
            );
            /**Sets  the flag of reselecting object
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetReselectObject
            (
                bool isReselectObject /**the flag of reselecting object */
            );
        };
    }
}
