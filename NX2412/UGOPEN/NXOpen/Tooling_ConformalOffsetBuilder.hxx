    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ConformalOffsetBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the facet faces to offset 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetFacetFaces
            (
                NXOpen::FacetCollector * collector /** collector */ 
            );
            /**Returns  the facet faces to offset 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::FacetCollector * FacetFaces
            (
            );
            ...
            /** Update the body method flag. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: void SetBodyCreationMethodChanged
            (
                bool updateBodyMethod /** updatebodymethod */ 
            );
            ...
            /** Set color for the conformal cooling channel. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SetChannelsColor
            (
            );
            /** Get the feature group of conformal curve feature 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * GetEditFeatureGroup
            (
            );
            /**Set the feature group of conformal curve feature
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Update the conformal cooling curve objects from UDO. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateConformalObjectsFromUDO
            (
                NXOpen::NXObject * featureGroup /** featuregroup */ ,
                NXOpen::NXObject * conformalUdo /** conformaludo */ 
            );
        };
    }
}
