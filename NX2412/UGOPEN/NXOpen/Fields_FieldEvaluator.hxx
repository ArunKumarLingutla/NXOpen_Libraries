        ...
        */
        class NXOPENCPP_FIELDSEXPORT  FieldEvaluator : public NXOpen::TaggedObject
        {
            ...
            public: enum InterpolationEnum
            {
                ...
                InterpolationEnumConservative3d/** conservative interpolation reserved for load mapping workflows */,
                InterpolationEnumLookupvalues1d/** Lookup values interpolator for 1d integer based id table mapping workflows */,
                InterpolationEnumLookupvalues2d/** Lookup values interpolator for 2d integer based id table mapping workflows */,
                InterpolationEnumLookupvalues3d/** Lookup values interpolator for 3d integer based id table mapping workflows */,
                InterpolationEnumLeastSquares1d/** Weighted Least Squares Interpolation for 1d domain */,
                InterpolationEnumLeastSquares2d/** Weighted Least Squares Interpolation for 2d domain */,
                InterpolationEnumLeastSquares3d/** Weighted Least Squares Interpolation for 3d domain */,
                InterpolationEnumBspline1d/** BSpline Interpolation for 1d domain */,
                InterpolationEnumBspline2d/** BSpline Interpolation for 2d domain */,
                InterpolationEnumBspline3d/** BSpline Interpolation for 3d domain */,
                InterpolationEnumLinearLeastSquares1d/** Linear Least Squares Interpolation for 1d domain */,
                InterpolationEnumSpline1d/** Spline Interpolation for 1d domain */
            };
            ...
            public: enum LinearLogOptionEnum
            {
                ...
                LinearLogOptionEnumScaleOffset/** Scale/Offset enum selection option under linear interpolation scheme */
            };
            ...
            public: enum InverseDistanceWeightingEnum
            {
                ...
                InverseDistanceWeightingEnumNumNearestPoints/** Sum of the weighted value of N nearest points, based on the inverse of the distance[This option is not supported] */,
                InverseDistanceWeightingEnumMaximumRadiusAndPoints/** Sum of the weighted value of N nearest points and points within a radius, based on the inverse of the distance  */
            };

            /** Options for IDW (inverse weighted distance) interpolator power of the distance */
            public: enum InverseDistanceWeightingPowerOfDistanceEnum
            {
                InverseDistanceWeightingPowerOfDistanceEnumOne/** IDW algorithm will use the distance for its calculation */ = 1,
                InverseDistanceWeightingPowerOfDistanceEnumTwo/** IDW algorithm will use the squared distance for calculation */,
                InverseDistanceWeightingPowerOfDistanceEnumThree/** IDW algorithm will use the cubed distance for calculation */
            };
            ...
            public: enum DelaunaySliverDetectionMethodEnum
            {
                DelaunaySliverDetectionMethodEnumEdgelengthratio/** Default method if not specified, compares ratio of each edge length to the sum of the lengths of the other two sides */,
                DelaunaySliverDetectionMethodEnumAspectratio/** Compares the height from the free edge to the opposite vertex to the length of the free edge */
            };

            /** Degree Options for Spline interpolator */
            public: enum SplineDegreeOptionEnum
            {
                SplineDegreeOptionEnumThirdOrder/** Spline interpolation using third degree polynomial */,
                SplineDegreeOptionEnumFifthOrder/** Spline interpolation using fifth degree polynomial */
            };
