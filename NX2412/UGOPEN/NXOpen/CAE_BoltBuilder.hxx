        ...
        */
        class NXOPENCPP_CAEEXPORT  BoltBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to calculate weights for RBE3 spider elements 
             ...
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Call NXOpen::BasePropertyTable::GetIntegerPropertyValue to get the weight method property value from Mesh Associated Data") bool ApplyWeightsRbe3
            (
            );
            /**Sets  the option to calculate weights for RBE3 spider elements 
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Call NXOpen::BasePropertyTable::SetIntegerPropertyValue to set the weight method property in Mesh Associated Data") void SetApplyWeightsRbe3
            (
