    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistSolution : public NXOpen::NXObject
        {
            ...
            /** Rename the Solution. 
             <br>  @deprecated Deprecated in NX2406.0.0.  Use @link CAE::DurSpecialistSolution::RenameSolution CAE::DurSpecialistSolution::RenameSolution@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: NX_DEPRECATED("Deprecated in NX2406.0.0.  Use CAE::DurSpecialistSolution::RenameSolution instead.") void Rename
            (
            ...
            /** Solve the Solution. This function is deprecated. Use method Commit of @link NXOpen::CAE::DurSpecialistSolveBuilder NXOpen::CAE::DurSpecialistSolveBuilder@endlink  instead. 
             <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::CAE::DurSpecialistSolveBuilder NXOpen::CAE::DurSpecialistSolveBuilder@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::CAE::DurSpecialistSolveBuilder instead.") void Solve
            (
            ...
            /** Export the result table to Excel 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use @link CAE::DurSpecialistSolution::ExportResultsCsv CAE::DurSpecialistSolution::ExportResultsCsv@endlink  instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use CAE::DurSpecialistSolution::ExportResultsCsv instead.") void ExportCsv
            (
                const NXString & resultFileName /** resultfilename */ ,
                const NXString & exportFileName /** exportfilename */ ,
            ...
            (
                ...
                bool renameResultFile /** if true, rename the result file */
            );
            /** Renames the Solution. 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : sc_dur_specialist ("Simcenter Specialist Durability") */
