        ...
        */
        class NXOPENCPP_CAEEXPORT  DurSpecialistResultTableSetup : public NXOpen::TransientObject
        {
            ...
            public: enum ResultType
            {
                ...
                ResultTypeStaticDegreeOfUtilization/** Static Degree of Utilization */,
                ResultTypeFatigueDegreeOfUtilization/** Fatigue Degree Of Utilization */,
                ResultTypeCombinedDegreeOfUtilization/** Combined Degree Of Utilization */,
                ResultTypeCombinedDegreeOfUtilizationCalculated/** Combined Degree Of Utilization Calculated */,
                ResultTypeMaxStrainAmplitude/** Max Strain Amplitude */,
                ResultTypeMaxStrain/** Max Strain */,
                ResultTypeMinStrain/** Min Strain */,
                ResultTypeMeanStrain/** Mean Strain */,
                ResultTypeCreepDamage/** Creep Damage (introduced in NX/SC 2412) */,
                ResultTypeCombinedFatigueCreepDamage/** Combined Fatigue Creep Damage (introduced in NX/SC 2412) */,
                ResultTypeRMSStress/** RMS Stress (introduced in NX/SC 2412) */,
                ResultTypeRemainingFatigueLifetime/** Remaining Fatigue Lifetime (introduced in NX/SC 2412) */
            };
