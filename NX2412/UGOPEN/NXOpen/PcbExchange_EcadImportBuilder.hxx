    ...
    namespace PcbExchange
    {
        ...
        */
        class NXOPENCPP_PCBEXCHANGEEXPORT  EcadImportBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the ECAD file location option. 
             <br>  Created in NX1899.0.0.  <br>  
            ...
            /**Sets  the flag indicating whether the input is from an ODB folder. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            ...
            /**Returns  the ECAD dataset name. 
             ...
             <br> License requirements : None */
            public: NXString EcadDatasetName
            (
            );
            /**Sets  the ECAD dataset name. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            public: void SetEcadDatasetName
            (
                const NXString & ecadDataset /** ecaddataset */ 
            );
            /**Sets  the ECAD dataset name. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_pcbx_xpedition ("PCB Exchange for Xpedition") OR ug_pcb_modeler ("PCB Modeler") OR ug_pcbx_zuken ("PCB Exchange for Zuken") */
            void SetEcadDatasetName
            (
                const char * ecadDataset /** ecaddataset */ 
            );
