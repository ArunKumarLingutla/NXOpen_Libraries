...
#include <NXOpen/Mechatronics_OPCUAServerBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        enum McdSignalServerConfigurationtype
        {
            ...
            McdSignalServerConfigurationtypeUa/** ua */ 
        };
    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  MCDSignalServerConfigurationBuilder : public NXOpen::Builder
        {
            ...
            /**Returns   @brief  the OPCUAServer builder that holds the configuration for OPCUAServer.  

              
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::OPCUAServerBuilder * OPCUAServer
            (
            );
        };
    }
