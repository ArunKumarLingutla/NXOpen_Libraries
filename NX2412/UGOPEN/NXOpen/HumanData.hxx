    ...
    */
    class NXOPENCPPEXPORT  HumanData : public NXOpen::TransientObject
    {
        ...
        public: enum JointType
        {
            ...
            JointTypeLthumbAxis/** Indicate joint named lthumb_axis     */,
            ...
            JointTypeRthumbAxis/** Indicate joint named rthumb_axis     */,
        ...
        /** This enum represents the types of inverse kinematics; commit multiple times to allow solver to reach goal  */
        public: enum InverseKinematicsType
        {
            InverseKinematicsTypeDynamicDrag/** Dynamic drag uses the IK system to move the specified body part to the target as it is manipulated in real time; commit multiple times to allow solver to reach goal */,
            InverseKinematicsTypeActiveReach/** Active reach uses an empirical prediction algorithm to posture the entire body. Note that hand goals may not be met if they are out of reach or beyond range of motion. */
        };
        ...
        /** This enum represents the body parts of HCP */
        public: enum HcpBodyPart
        {
            HcpBodyPartHead/** Indicates hcp body part named head           */,
            HcpBodyPartLeftHand/** Indicates hcp body part named left hand      */,
            HcpBodyPartRightHand/** Indicates hcp body part named right hand     */,
            HcpBodyPartLeftElbow/** Indicates hcp body part named left elbow     */,
            HcpBodyPartRightElbow/** Indicates hcp body part named right elbow    */,
            HcpBodyPartPelvis/** Indicates hcp body part named pelvis         */,
            HcpBodyPartLeftFoot/** Indicates hcp body part named left foot      */,
            HcpBodyPartRightFoot/** Indicates hcp body part named right foot     */,
            HcpBodyPartLeftKnee/** Indicates hcp body part named left knee      */,
            HcpBodyPartRightKnee/** Indicates hcp body part named right knee     */,
            HcpBodyPartTorso/** Indicates hcp body part named torso          */
        };

        /** This enum represents the posture solve type in HCP */
        public: enum HcpPostureSolveType
        {
            HcpPostureSolveTypeStanding/** Indicates hcp solve for standing posture    */,
            HcpPostureSolveTypeSeated/** Indicates hcp solve for seated posture      */
        };

        /** This enum represents the mirror option type in HCP */
        public: enum HcpMirrorOptionType
        {
            HcpMirrorOptionTypeNone/** Indicates no mirroring       */,
            HcpMirrorOptionTypeLeftMirrorsRight/** Indicates left mirrors right */,
            HcpMirrorOptionTypeRightMirrorsLeft/** Indicates right mirrors left */
        };

        /** This enum represents the hand goal option in HCP */
        public: enum HcpHandGoalOption
        {
            HcpHandGoalOptionPalmcenter/** Indicate the palm center hand goal option in HCP */,
            HcpHandGoalOptionThumbTip/** Indicate the thumb tip hand goal option in HCP */,
            HcpHandGoalOptionIndexFingerTip/** Indicate the index finger tip hand goal option in HCP */,
            HcpHandGoalOptionMiddleFingerTip/** Indicate the middle finger tip option in HCP */
        };

        /** This enum represents the foot goal option in HCP */
        public: enum HcpFootGoalOption
        {
            HcpFootGoalOptionAnkle/** Indicate the ankle foot goal option in HCP */,
            HcpFootGoalOptionHeel/** Indicate the heel foot goal option in HCP */
        };

        /** This enum represents the types of the advanced anthro measure names */
        public: enum AdvancedAnthroMeasure
        {
            AdvancedAnthroMeasureStature/** Indicates stature anthro measurement */,
            AdvancedAnthroMeasureWeight/** Indicates weight */,
            AdvancedAnthroMeasureHeadCirc/** THIS IS NOT USED, instead use head breadth and head length */,
            AdvancedAnthroMeasureChestCirc/** Indicates chestCirc anthro measurement */,
            AdvancedAnthroMeasureWaistCirc/** Indicates waistCirc anthro measurement */,
            AdvancedAnthroMeasureHipCirc/** Indicates hipCirc anthro measurement */,
            AdvancedAnthroMeasureHipBdt/** Indicates hipBdt anthro measurement */,
            AdvancedAnthroMeasureSittingHgt/** Indicates sittingHgt anthro measurement */,
            AdvancedAnthroMeasureElbowWristLen/** Indicates elbowWrist anthro measurement */,
            AdvancedAnthroMeasureBiacromialBdt/** Indicates biacromialBdt anthro measurement */,
            AdvancedAnthroMeasureBideltoidBdt/** Indicates bideltoidBdt anthro measurement */,
            AdvancedAnthroMeasureKneeHgt/** Indicates kneeHgt anthro measurement */,
            AdvancedAnthroMeasureAgeYears/** Indicates age */,
            AdvancedAnthroMeasureHandLen/** Indicates handLen anthro measurement */,
            AdvancedAnthroMeasureHandBdt/** Indicates handBdt anthro measurement */,
            AdvancedAnthroMeasureHandDpt/** Indicates handDpt anthro measurement */,
            AdvancedAnthroMeasureFootLen/** Indicates footLen anthro measurement */,
            AdvancedAnthroMeasureFootBdt/** Indicates footBdt anthro measurement */,
            AdvancedAnthroMeasureShoeSoleHgt/** Indicates shoeSoleHgt measurement */,
            AdvancedAnthroMeasureHeadBdt/** Indicates headBdt anthro measurement */,
            AdvancedAnthroMeasureHeadLen/** Indicates headLen anthro measurement */,
            AdvancedAnthroMeasureAcromialHgt/** Indicates acromialHgt anthro measurement */,
            AdvancedAnthroMeasureSittingAcromialHgt/** Indicates sittingAcromialHgt anthro measurement */,
            AdvancedAnthroMeasureSittingEyeHgt/** Indicates sittingEyeHgt anthro measurement */,
            AdvancedAnthroMeasureButtockKneeLen/** Indicates buttockKneeLen anthro measurement */,
            AdvancedAnthroMeasureArmLen/** Indicates armLen anthro measurement */,
            AdvancedAnthroMeasureThumbTipReach/** Indicates thumbTipReach anthro measurement */,
            AdvancedAnthroMeasureShoulderElbowLen/** Indicates shoulderElbowLen anthro measurement */,
            AdvancedAnthroMeasureElbowFingerTipLen/** Indicates elbowFingerTip anthro measurement */,
            AdvancedAnthroMeasureAbdominalDpt/** Indicates abdominalDpt anthro measurement (read-only) */,
            AdvancedAnthroMeasureChestDpt/** Indicates chestDpt anthro measurement (read_only) */,
            AdvancedAnthroMeasureThighClearance/** Indicates thighClearance anthro measurement (read_only) */,
            AdvancedAnthroMeasureAnkleHgt/** Indicates ankleHgt anthro measurement */,
            AdvancedAnthroMeasureHeadHgt/** Indicates headHgt anthro measurement */,
            AdvancedAnthroMeasureFunctionalLegLen/** Indicates functionalLegLen anthro measurement */,
            AdvancedAnthroMeasureFingerTipReach/** Indicates fingertipReach anthro measurement */,
            AdvancedAnthroMeasureGripReach/** Indicates gripReach anthro measurement */,
            AdvancedAnthroMeasureCount/** Indicates number of anthro measurements */
        };
