        ...
        namespace StructureDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  GussetBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                {
                    AlignmentTypesGussetPlate/** gusset plate */ ,
                    AlignmentTypesLappedPlate/** lapped plate */ 
                };
                ...
                /**Sets  the alignment type to be used to locate gusset 
                 <br>  Created in NX1980.0.0.  <br>  
                ...
                /**Sets  the flag to indicate whether to use alignment object to position the gussets or not.
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : nx_structure_design ("Structure Designer") */
                public: void SetAddAlignment
                (
                    bool addAlignment /** addalignment */ 
                );
                /**Returns  the alignment object used for positioning multiple gussets. 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::ScCollector * Alignment
                (
                );
                ...
                /**Sets  the flag to specify whether the gusset align edge direction is reversed or not. 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_structure_design ("Structure Designer") */
                ...
                /**Returns   the lapped offset distance in the reinforcement face.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * ReinforcementOffset
                (
                );
                /**Returns   the lapped offset distance in the attachment face.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * AttachmentOffset
                (
                );
                ...
                /**Returns  the flag to indicate whether the lapped offset direction in reinforcement face is reversed or not. 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: bool ReverseReinforcementOffsetFlange
                (
                );
                /**Sets  the flag to indicate whether the lapped offset direction in reinforcement face is reversed or not. 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_structure_design ("Structure Designer") */
                public: void SetReverseReinforcementOffsetFlange
                (
                    bool reverseReinforcementOffsetFlange /** reversereinforcementoffsetflange */ 
                );
                /**Returns  the flag to indicate whether the lapped offset direction in attachment face is reversed or not. 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : None */
                public: bool ReverseAttachmentOffsetFlange
                (
                );
                /**Sets  the flag to indicate whether the lapped offset direction in attachment face is reversed or not. 
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_structure_design ("Structure Designer") */
                public: void SetReverseAttachmentOffsetFlange
                (
                    bool reverseAttachmentOffsetFlange /** reverseattachmentoffsetflange */ 
                );
                ...
                /**Returns  the number of gussets created 
                 <br>  Created in NX2312.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * Counts
                (
                );
                /**Returns  the angle 
                 <br>  Created in NX2312.0.0.  <br>  
