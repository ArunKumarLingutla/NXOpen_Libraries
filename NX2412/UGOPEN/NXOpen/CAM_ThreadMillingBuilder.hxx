        ...
        class NXOPENCPP_CAMEXPORT  ThreadMillingBuilder : public NXOpen::CAM::CylindricalMillingBuilder
        {
            ...
            */
            ...
            /**Returns  the motion output  
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ThreadMillingBuilder::MotionOutputTypes MotionOutput
            (
            );
            ...
            (
                NXOpen::CAM::ThreadMillingBuilder::MotionOutputTypes newValue /** the motion output type */
            );
            ...
            /**Returns  the opposite direction builder 
             ...
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAM::FBM::Feature::FlipDirection to change the Z-axis on the in-process feature instead.") NXOpen::CAM::OppositeDirection * OppositeDirectionBuilder
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ThreadMillingBuilder::RetractOutputModeType RetractOutputMode
            (
            );
            ...
            (
                NXOpen::CAM::ThreadMillingBuilder::RetractOutputModeType currentValue /** currentvalue */ 
            );
