        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  PartSketch
        {
            ...
            /**Returns  the sketch work region boundary color 
             ...
             <br> License requirements : None */
            public: NXOpen::NXColor * WorkRegionBoundaryColor
            (
            );
            /**Sets  the sketch work region boundary color 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetWorkRegionBoundaryColor
            (
                NXOpen::NXColor * sketchWorkRegionBoundaryColor /** sketchworkregionboundarycolor */ 
            );
