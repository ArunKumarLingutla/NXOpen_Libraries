            ...
            */
            class NXOPENCPP_CAEEXPORT  BaseCalculation : public NXOpen::NXObject
            {
                ...
                public: enum CalculationStatus
                {
                    ...
                    CalculationStatusPreparationFailed/** inputs are/were not coherent */
                };
                ...
                (
                    const NXString & filePath /** The file path to save template as */
                );
                /** Create a template from the calculation 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                void CreateTemplate
                (
                    const char * filePath /** The file path to save template as */
                );
            };
        }
    }
