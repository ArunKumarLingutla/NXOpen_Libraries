    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  Mesh3dHexBuilder : public NXOpen::Builder
        {
            ...
            public: enum Type
            {
                TypeAutomaticMultipleBody/** Infer both source and targets from selected bodies*/,
                TypeAutomatic/** Infer targets from selected source faces*/,
                TypeManual/** User specified source and target faces*/,
                TypeBetweenAutomatic/** Automatic loop directions between source and target face to fill gaps with swept mesh*/,
                TypeBetweenManual/** User specified loop directions between source and target faces to fill gaps with swept mesh, also supports wall face selection*/
            };
            ...
            /**Returns  the optional source faces for JA_CAE_MESH3D_HEX_BUILDER_type_automatic_multiple_body 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::SelectDisplayableObjectList * OptionalSourceFaceSelection
            (
            );
            /**Returns  the optional target faces for JA_CAE_MESH3D_HEX_BUILDER_type_automatic_multiple_body 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::SelectDisplayableObjectList * OptionalTargetFaceSelection
            (
            );
        };
    }
