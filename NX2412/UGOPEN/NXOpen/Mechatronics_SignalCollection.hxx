    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SignalCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Mechatronics::Signal *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Mechatronics::Signal **;
                using reference = NXOpen::Mechatronics::Signal *&;
            ...
            /** Creates a @link NXOpen::Mechatronics::SignalBuilder NXOpen::Mechatronics::SignalBuilder@endlink . 
             <br>  Created in NX11.0.0.  <br>  
