...
#include <NXOpen/CAE_CaeGroupBuilder.hxx>
        ...
        */
        class NXOPENCPP_CAEEXPORT  CaeGroupCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            public: enum EntityType
            {
             ...
             /** Contains options for pasting groups */
            public:
            struct PasteOptions
            {
                public: /** Prefix seed name pasted groups. If nullptr, default prefix sill be used. */NXString Prefix;
                public: /** Starting group label. If less than zero, default will be used. */int Label;
                public: PasteOptions() :
                    Prefix(),
                    Label()
                {
                }
                /** Constructor for the PasteOptions struct. */ 
                public: PasteOptions(const NXString &prefixInitial /** Prefix seed name pasted groups. If nullptr, default prefix sill be used. */, 
                        int labelInitial /** Starting group label. If less than zero, default will be used. */) :
            ...
            {
            public:
                using value_type = NXOpen::CAE::CaeGroup *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::CaeGroup **;
                using reference = NXOpen::CAE::CaeGroup *&;
            ...
            /** Clones the input group into the same collection. @return  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            ...
            /** Copies the input group to the clipboard.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void CopyToClipboard
            (
                const std::vector<NXOpen::CAE::CaeGroup *> & sourceGroups /** must come from the same part as the collection */
            );
            /** Paste group from the clipboard.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void PasteFromClipboard
            (
                const NXOpen::CAE::CaeGroupCollection::PasteOptions & pasteOptions /** options for pasting groups */
            );
            ...
            /** Creates a builder to create a group  @return   
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::CaeGroupBuilder * CreateGroupBuilder
            (
                NXOpen::CAE::CaeGroup * group /** The @link NXOpen::CAE::CaeGroup NXOpen::CAE::CaeGroup@endlink  to be edited, if NULL then create a new one */
            );
