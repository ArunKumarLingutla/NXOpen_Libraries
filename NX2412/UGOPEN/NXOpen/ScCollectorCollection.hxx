...
namespace NXOpen
{
    ...
    /** This class contains the factory methods for creating a sc collector.  <br> To obtain an instance of this class, refer to @link NXOpen::BasePart  NXOpen::BasePart @endlink  <br> 
     <br>  Created in NX4.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  ScCollectorCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::ScCollector *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::ScCollector **;
            using reference = NXOpen::ScCollector *&;
