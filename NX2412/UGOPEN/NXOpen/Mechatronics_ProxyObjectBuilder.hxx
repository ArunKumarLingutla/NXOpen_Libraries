    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  ProxyObjectBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the use type used in the proxy object. Use @link NXOpen::Mechatronics::ProxyObjectBuilder::BuilderType NXOpen::Mechatronics::ProxyObjectBuilder::BuilderType@endlink  instead. 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
            public: int UseType
            (
            );
            /**Sets  the use type used in the proxy object. Use @link NXOpen::Mechatronics::ProxyObjectBuilder::BuilderType NXOpen::Mechatronics::ProxyObjectBuilder::BuilderType@endlink  instead. 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : nx_mcd_core ("Mechatronics Concept Designer") OR nx_mcd_essential ("Mechatronics Concept Designer Essential") */
