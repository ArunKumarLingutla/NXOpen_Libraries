        ...
        */
        class NXOPENCPP_CAEEXPORT  ElementConnectivityBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the out node which will be replaced
             <br>  @deprecated Deprecated in NX2306.0.0.  Use Get Nodes to Replace Method <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use Get Nodes to Replace Method") NXOpen::CAE::SelectFENode * OutNode
            (
            );
            /**Returns  the in node which will replace 
             <br>  @deprecated Deprecated in NX2306.0.0.  Use Get Replacement Nodes Method <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2306.0.0.  Use Get Replacement Nodes Method") NXOpen::CAE::SelectFENode * InNode
            (
            );
            ...
            /**Returns  the nodes to replace
             ...
             <br> License requirements : None */
            public: NXOpen::CAE::SelectFENodeList * NodesToReplace
            (
            );
            /**Returns  the nodes which will be replaced 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::SelectFENodeList * ReplacementNodes
            (
            );
            /**Returns  the create at mid flag, telling whether replacement node will be moved 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : None */
            public: bool MoveReplacementNodeAtMidway
            (
            );
            /**Sets  the create at mid flag, telling whether replacement node will be moved 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetMoveReplacementNodeAtMidway
            (
                bool moveAtMid /** moveatmid */ 
            );
        };
    }
}
