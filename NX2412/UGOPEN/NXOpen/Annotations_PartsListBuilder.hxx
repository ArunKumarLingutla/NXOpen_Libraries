        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PartsListBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: enum PartsListSymbolType
            {
                ...
                PartsListSymbolTypeNoSymbol/** no symbol */ ,
            ...
            /**Returns  the flag to enable cross highlighting 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool EnableCrossHighlighting
            (
            );
            /**Sets  the flag to enable cross highlighting 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SetEnableCrossHighlighting
            (
                bool enableCrossHighlighting /** enablecrosshighlighting */ 
            );
            ...
            /**Returns  the flag indicating whether packing routed stock and insulation components is enabled. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: bool PackRoutedStockComponents
            (
            );
            /**Sets  the flag indicating whether packing routed stock and insulation components is enabled. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetPackRoutedStockComponents
            (
                bool packRoutedStockComponents /** packroutedstockcomponents */ 
            );
