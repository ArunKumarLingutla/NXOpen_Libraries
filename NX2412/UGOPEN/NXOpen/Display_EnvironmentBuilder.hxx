...
namespace NXOpen
{
    ...
    namespace Display
    {
        ...
        /**
            ...
            return NULL. <br> 
             <br> To create a new instance of this class, use @link NXOpen::ViewCollection::CreateEnvironmentBuilderForDisplayStyle  NXOpen::ViewCollection::CreateEnvironmentBuilderForDisplayStyle @endlink  <br> 
        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  EnvironmentBuilder : public NXOpen::Builder
        {
            ...
            /** Represents pre-defined High Dynamic Range (HDR) lights */
            public: enum HdrTypes
            {
                HdrTypesNone/** No image based lighting */,
                HdrTypesLighting1/** lighting1 */ ,
                HdrTypesLighting2/** lighting2 */ ,
                HdrTypesLighting3/** lighting3 */ 
            };

            /** Represents global finish types for shaded views 
             <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::Preferences::SessionVisualizationVisual::GlobalFinishType NXOpen::Preferences::SessionVisualizationVisual::GlobalFinishType@endlink  instead. <br>  
            */
            public: enum NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionVisualizationVisual::GlobalFinishType instead.") GlobalFinishType
            {
            ...
            /**Returns  the global finish in shaded mode 
             <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::Preferences::SessionVisualizationVisual::GlobalFinish NXOpen::Preferences::SessionVisualizationVisual::GlobalFinish@endlink  instead. <br>  

             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionVisualizationVisual::GlobalFinish instead.") int EnvironmentShadedViewsGlobalFinish
            (
            );
            /**Sets  the global finish in shaded mode 
             <br>  @deprecated Deprecated in NX2312.0.0.  Use @link NXOpen::Preferences::SessionVisualizationVisual::SetGlobalFinish NXOpen::Preferences::SessionVisualizationVisual::SetGlobalFinish@endlink  instead. <br>  

             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2312.0.0.  Use NXOpen::Preferences::SessionVisualizationVisual::SetGlobalFinish instead.") void SetEnvironmentShadedViewsGlobalFinish
            (
            ...
            /**Returns  the image up vector coordinate, relative to the absolute coordinate system 
             ...
             <br> License requirements : None */
            public: NXOpen::Vector3d ImageUpVectorCoordinate
            (
            );
            /**Sets  the image up vector coordinate, relative to the absolute coordinate system 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetImageUpVectorCoordinate
            (
                const NXOpen::Vector3d & imageUpVector /** imageupvector */ 
            );
            /**Returns  the display style whose environment is being modified. Shaded and Studio styles have independent environment settings.
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Returns  the pre-defined HDR used for Shaded display style only.
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Display::EnvironmentBuilder::HdrTypes Hdr
            (
            );
            /**Sets  the pre-defined HDR used for Shaded display style only.
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: void SetHdr
            (
                NXOpen::Display::EnvironmentBuilder::HdrTypes hdrType /** hdrtype */ 
            );
        };
    }
}
