        ...
        namespace ResponseSimulation
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  SensorCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::ResponseSimulation::Sensor *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::ResponseSimulation::Sensor **;
                    using reference = NXOpen::CAE::ResponseSimulation::Sensor *&;
