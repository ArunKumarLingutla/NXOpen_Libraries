...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        DisplayONOFFtoggle </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        DisplayOptionsEnum </term> <description> 
         
        LinearFacets </description> </item> 

        <item><term> 
         
        FacetCheckTolerance.Value </term> <description> 
         
        0.01 (millimeters part), 0.003937 (inches part) </description> </item> 

        <item><term> 
         
        ListOptionsEnum </term> <description> 
