        ...
        */
        class AMEOPENCPPEXPORT  CabinetRoot : public NXOpen::AME::AMEBaseNode
        {
            ...
            /** Places the selection of products in active cabinet 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER"), ad_cabinet_addon ("AUTOMATION DESIGNER CABINET ADDON") */
            public: void PlaceProductsInActiveCabinet
            (
                const NXOpen::Point3d & location /** location */ ,
                const std::vector<NXOpen::AME::AMEEngObject *> & engObjects /** engobjects */ ,
                NXOpen::NXObject * receptacleObject /** receptacleobject */ ,
                double distance /** distance */ ,
                NXOpen::AME::Bulk3DPlacementBuilder::PlacementTypePolicy placementType /** placementtype */ ,
