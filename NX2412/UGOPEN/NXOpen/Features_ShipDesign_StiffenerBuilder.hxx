...
#include <NXOpen/Features_ShipDesign_CarlingPathBuilder.hxx>
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            CarlingPathData.SearchRadius.Value </term> <description> 
            ...
            MeasureAlongMode </term> <description> 
             
            AlongSurfaceLength </description> </item> 
            ...
            OffsetDistanceEnd.Value </term> <description> 
             
            0 (millimeters part), 0 (inches part) </description> </item> 

            <item><term> 
             
            OffsetDistanceStart.Value </term> <description> 
             
            0 (millimeters part), 0 (inches part) </description> </item> 

            <item><term> 
             
            OffsetNumber </term> <description> 
             
            0 </description> </item> 

            <item><term> 
             
            OffsetSpacing.Value </term> <description> 
             
            0 (millimeters part), 0 (inches part) </description> </item> 

            <item><term> 
             
            OffsetSpacingEnd.Value </term> <description> 
             
            0 (millimeters part), 0 (inches part) </description> </item> 

            <item><term> 
             
            OffsetSpacingMode </term> <description> 
             
            Single </description> </item> 

            <item><term> 
             
            OffsetSpacingStart.Value </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  StiffenerBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                public: enum Types
                {
                    ...
                    TypesStiffenerByPoints/** Stiffener By Points type */,
                    TypesStiffenerByOffsetPlane/** Stiffener By Offset Plane type */,
                    TypesCarlingStiffener/** Stiffener type */
                };
                ...
                public: enum MeasureAlongModes
                {
                    ...
                    MeasureAlongModesNormalToPlane/** normal to plane */ ,
                ...
                /**Returns  the method to define the points of the stiffener path.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::StiffenerBuilder::PointMethods PointMethod
                (
                );
                /**Sets  the method to define the points of the stiffener path.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: void SetPointMethod
                (
                    NXOpen::Features::ShipDesign::StiffenerBuilder::PointMethods method /** method */ 
                );
                ...
                /**Returns  the list of points that define the path of the stiffener.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::NXObjectList * PointList
                (
                );
                /**Returns  the list of plane pairs that define the path of the stiffener.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::NXObjectList * PlanePairList
                (
                );
                /** Creates a @link NXOpen::Features::ShipDesign::PlanePairBuilder NXOpen::Features::ShipDesign::PlanePairBuilder@endlink  to add a new pair of planes to the list.
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: NXOpen::Features::ShipDesign::PlanePairBuilder * CreatePlanePairBuilder
                (
                );
                /**Returns  the defined plane for the offset and spacing calculations for the stiffeners. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Plane * OffsetPlane
                (
                );
                /**Sets  the defined plane for the offset and spacing calculations for the stiffeners. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                ...
                /**Returns  the number of stiffeners to generate. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: int OffsetNumber
                (
                );
                /**Sets  the number of stiffeners to generate. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                ...
                /**Returns  the indication whether the spacing of the stiffeners is defined at the starting and ending points
                            of the stiffeners or if a constant spacing is desired. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModes OffsetSpacingMode
                (
                );
                /**Sets  the indication whether the spacing of the stiffeners is defined at the starting and ending points
                            of the stiffeners or if a constant spacing is desired. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: void SetOffsetSpacingMode
                (
                    NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModes offsetSpacingMode /** offsetspacingmode */ 
                );
                /**Returns  the distance between the OffsetPlane and the first stiffener. Only used if OffsetSpacing is
                            @link NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesSingle NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesSingle@endlink . 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * OffsetDistance
                (
                );
                /**Returns  the distance between generated stiffeners. Only used if OffsetSpacing is
                            @link NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesSingle NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesSingle@endlink  
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the distance between the OffsetPlane and the starting point of the first stiffener.
                            Only used if OffsetSpacing is
                            @link NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble@endlink .
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * OffsetDistanceStart
                (
                );
                /**Returns  the distance between the starting points of the stiffeners. Only used if OffsetSpacing is
                            @link NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble@endlink .
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the distance between the OffsetPlane and the end point of the first stiffener.
                            Only used if OffsetSpacing is
                            @link NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble@endlink .
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the distance between the ending points of the stiffeners. Only used if OffsetSpacing is
                            @link NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble NXOpen::Features::ShipDesign::StiffenerBuilder::OffsetSpacingModesDouble@endlink .
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the method used to measure distances between the OffsetPlane and the stiffeners. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::StiffenerBuilder::MeasureAlongModes MeasureAlongMode
                (
                );
                /**Sets  the method used to measure distances between the OffsetPlane and the stiffeners. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: void SetMeasureAlongMode
                (
                    NXOpen::Features::ShipDesign::StiffenerBuilder::MeasureAlongModes measureAlongMode /** measurealongmode */ 
                );
                ...
                /** Get EndCut data to modify the value 
                 <br>  Created in NX2406.0.0.  <br>  
                 <br> License requirements : nx_ship_detail ("Ship Detail Design") */
                public: NXOpen::Features::ShipDesign::StiffenerBuilder * InheritEndCutProperties
                (
                ...
                /**Returns  the path data used to define the support information of the stiffener.
                 ...
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::CarlingPathBuilder * CarlingPathData
                (
                );
            };
        }
