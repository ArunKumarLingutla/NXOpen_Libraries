    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  LayoutStateCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /// \cond NX_NO_DOC 
            public: explicit LayoutStateCollection(NXOpen::BasePart *owner);
            ...
            {
            public:
                using value_type = NXOpen::CAE::LayoutState *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::LayoutState **;
                using reference = NXOpen::CAE::LayoutState *&;
            ...
            /** Clones the specified @link NXOpen::CAE::LayoutState NXOpen::CAE::LayoutState@endlink  to Archieved layout states @return  resulting layout state  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::CAE::LayoutState * CopyLayoutStateToArchived
            (
                NXOpen::CAE::LayoutState * fromLayoutState /** cloned layout state  */,
                const NXString & newName /** name of the new layout state  */
            );
            /** Clones the specified @link NXOpen::CAE::LayoutState NXOpen::CAE::LayoutState@endlink  to Archieved layout states @return  resulting layout state  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            NXOpen::CAE::LayoutState * CopyLayoutStateToArchived
            (
                NXOpen::CAE::LayoutState * fromLayoutState /** cloned layout state  */,
                const char * newName /** name of the new layout state  */
            );
