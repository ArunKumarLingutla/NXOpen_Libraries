...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a collection of @link NXOpen::Annotations::FrameBar NXOpen::Annotations::FrameBar@endlink  objects  <br> To obtain an instance of this class, refer to @link NXOpen::Annotations::AnnotationManager  NXOpen::Annotations::AnnotationManager @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  FrameBarCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Annotations::FrameBar *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Annotations::FrameBar **;
                using reference = NXOpen::Annotations::FrameBar *&;
            ...
            (
                NXOpen::Annotations::BaseFrameBar * framebar /** frame bar*/
            );
            /** Creates a @link NXOpen::Annotations::AddTicBuilder NXOpen::Annotations::AddTicBuilder@endlink  
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") */
