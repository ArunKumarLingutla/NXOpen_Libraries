...
#include <NXOpen/PID_PreferencesInstrumentationBuilder.hxx>
    ...
    namespace PID
    {
        ...
        */
        class PIDOPENCPPEXPORT  PreferencesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns the preferences instrumentation builder 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PID::PreferencesInstrumentationBuilder * Instrumentation
            (
            );
        };
    }
