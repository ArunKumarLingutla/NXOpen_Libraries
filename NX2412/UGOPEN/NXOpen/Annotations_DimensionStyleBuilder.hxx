...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /**
            Represents a @link NXOpen::Annotations::DimensionStyleBuilder NXOpen::Annotations::DimensionStyleBuilder@endlink .
            This class queries and sets dimension preferences when creating or editing a dimension.
            
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the dimension text position representing above or after stub 
             ...
             <br> License requirements : None */
            public: NXOpen::Annotations::TextPosition TextPosition
            (
            );
            ...
            (
                NXOpen::Annotations::TextPosition position /** position */ 
            );
            ...
            /**Returns  the upper english tolerance.
                    This value should be interpreted with the tolerance type from @link NXOpen::Annotations::DimensionStyleBuilder::ToleranceType NXOpen::Annotations::DimensionStyleBuilder::ToleranceType@endlink .
            ...
            /**Returns  the reference dimension flag 
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Annotations::DimensionStyleBuilder::DimensionReferenceIncludeType NXOpen::Annotations::DimensionStyleBuilder::DimensionReferenceIncludeType@endlink  and @link NXOpen::Annotations::DimensionStyleBuilder::ShowAsReferenceDimension NXOpen::Annotations::DimensionStyleBuilder::ShowAsReferenceDimension@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Annotations::DimensionStyleBuilder::DimensionReferenceIncludeType and NXOpen::Annotations::DimensionStyleBuilder::ShowAsReferenceDimension instead.") bool ReferenceDimension
            (
            );
            /**Sets  the reference dimension flag 
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::Annotations::DimensionStyleBuilder::SetDimensionReferenceIncludeType NXOpen::Annotations::DimensionStyleBuilder::SetDimensionReferenceIncludeType@endlink  and @link NXOpen::Annotations::DimensionStyleBuilder::SetShowAsReferenceDimension NXOpen::Annotations::DimensionStyleBuilder::SetShowAsReferenceDimension@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::Annotations::DimensionStyleBuilder::SetDimensionReferenceIncludeType and NXOpen::Annotations::DimensionStyleBuilder::SetShowAsReferenceDimension instead.") void SetReferenceDimension
            (
                bool referenceDimension /** referencedimension */ 
            );
            /**Returns  the separate brackets with show as reference 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool SeparateBrackets
            (
            );
            /**Sets  the separate brackets with show as reference 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSeparateBrackets
            (
                bool separateBrackets /** separatebrackets */ 
            );
            ...
            (
                const NXString & fitShaftDeviation /** fitshaftdeviation */ 
            );
            /**Sets  the shaft deviation for fit tolerance of a dimension 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            ...
            (
                const char * fitShaftDeviation /** fitshaftdeviation */ 
            );
            ...
            (
                int fitShaftGrade /** fitshaftgrade */ 
            );
            ...
            /**Returns  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
             ...
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Annotations::DimensionStyleBuilder::LimitFitAssemblyNewDisplayStyle NXOpen::Annotations::DimensionStyleBuilder::LimitFitAssemblyNewDisplayStyle@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Annotations::DimensionStyleBuilder::LimitFitAssemblyNewDisplayStyle instead.") NXOpen::Annotations::FitAssemblyDisplayStyle LimitFitAssemblyDisplayStyle
            (
            );
            /**Sets  the display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
                        the display can be on a single line, or two lines centered with the dimension text or
                        two lines with the shaft text in line with the dimension text.
                        This property is obsolete.
                    
             <br>  @deprecated Deprecated in NX11.0.0.  Use @link NXOpen::Annotations::DimensionStyleBuilder::SetLimitFitAssemblyNewDisplayStyle NXOpen::Annotations::DimensionStyleBuilder::SetLimitFitAssemblyNewDisplayStyle@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Annotations::DimensionStyleBuilder::SetLimitFitAssemblyNewDisplayStyle instead.") void SetLimitFitAssemblyDisplayStyle
            (
                NXOpen::Annotations::FitAssemblyDisplayStyle fitAssemblyDisplayStyle /** fitassemblydisplaystyle */ 
            );
            /**Returns  the new display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
                        the display can be on a single line or double line 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::FitAssemblyNewDisplayStyle LimitFitAssemblyNewDisplayStyle
            (
            );
            /**Sets  the new display style of fit tolerance for assembly dimensions.  When the limit fit type is FIT,
                        the display can be on a single line or double line 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitAssemblyNewDisplayStyle
            (
                NXOpen::Annotations::FitAssemblyNewDisplayStyle fitAssemblyDisplayStyle /** fitassemblydisplaystyle */ 
            );
            /**Returns  the dimension limit fit assembly display when split by dimension line.
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::FitDisplaySplitByDimline LimitFitDisplaySplitByDimline
            (
            );
            /**Sets  the dimension limit fit assembly display when split by dimension line.
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitDisplaySplitByDimline
            (
                NXOpen::Annotations::FitDisplaySplitByDimline fitDisplaySplitByDimline /** fitdisplaysplitbydimline */ 
            );
            /**Returns  the dimension limit fit display alignment.  When the limit fit type is FIT, the hole and shaft tolerances
                        can be aligned as centered value, centered value and fit or bottom
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::FitDisplayAlignment LimitFitDisplayAlignment
            (
            );
            /**Sets  the dimension limit fit display alignment.  When the limit fit type is FIT, the hole and shaft tolerances
                        can be aligned as centered value, centered value and fit or bottom
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetLimitFitDisplayAlignment
            (
                NXOpen::Annotations::FitDisplayAlignment fitDisplayAlignment /** fitdisplayalignment */ 
            );
            /**Returns  the fit tolerance parentheses option.  When the value is true, parentheses will be shown on 
                        the fit tolerance text.  Otherwise, a blank space will be used. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: bool FitToleranceParentheses
            (
            );
            /**Sets  the fit tolerance parentheses option.  When the value is true, parentheses will be shown on 
                        the fit tolerance text.  Otherwise, a blank space will be used. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFitToleranceParentheses
            (
                bool showFitParentheses /** showfitparentheses */ 
            );
            /**Returns  the fit tolerance separator option.  When the limit fit type is FIT and the value true,
                        a line will be drawn to separate the hole and shaft tolerance texts. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: bool FitToleranceSeparator
            (
            );
            /**Sets  the fit tolerance separator option.  When the limit fit type is FIT and the value true,
                        a line will be drawn to separate the hole and shaft tolerance texts. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetFitToleranceSeparator
            (
                bool showFitSeparator /** showfitseparator */ 
            );
            ...
            /**Sets  the true length text position 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            ...
            /**Returns  the chamfer separator type 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::ChamferSeparatorType ChamferSeparator
            (
            );
            /**Sets  the chamfer separator type 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetChamferSeparator
            (
            ...
            /**Returns  the override dimension text 
             ...
             <br> License requirements : None */
            public: bool OverrideDimensionText
            (
            );
            /**Sets  the override dimension text 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: void SetOverrideDimensionText
            (
                bool overrideDimensionText /** overridedimensiontext */ 
            );
            /** Returns the overridden dimension text value
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetOverriddenDimensionText
            (
            );
            /** Sets the overridden dimension text value 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: void SetOverriddenDimensionText
            (
            ...
            /**Returns  the inspection symbol around appended text option 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::InspectionSymbolAroundAppendedText InspectionSymbolAroundAppendedText
            (
            );
            /**Sets  the inspection symbol around appended text option 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetInspectionSymbolAroundAppendedText
            (
                NXOpen::Annotations::InspectionSymbolAroundAppendedText inspectionSymbolAroundAppendedText /** inspectionsymbolaroundappendedtext */ 
            );
            ...
            (
                bool textCentered /** textcentered */ 
            );
            /**Returns  the show as reference dimension flag 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool ShowAsReferenceDimension
            (
            );
            /**Sets  the show as reference dimension flag 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetShowAsReferenceDimension
            (
                bool showAsreference /** showasreference */ 
            );
            /**Returns  the dimension reference include type 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::ReferenceIncludeType DimensionReferenceIncludeType
            (
            );
            /**Sets  the dimension reference include type 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetDimensionReferenceIncludeType
            (
                NXOpen::Annotations::ReferenceIncludeType referenceIncludeType /** referenceincludetype */ 
            );
            /**Returns  the single limit offset option to add the value to or subtract the value from the size of the dimension. 
                    This value should be interpreted with the value from @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueEnglish NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueEnglish@endlink  
                    or @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueMetric NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueMetric@endlink .
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: bool SingleLimitOffsetIncludeFlag
            (
            );
            /**Sets  the single limit offset option to add the value to or subtract the value from the size of the dimension. 
                    This value should be interpreted with the value from @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueEnglish NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueEnglish@endlink  
                    or @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueMetric NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetValueMetric@endlink .
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSingleLimitOffsetIncludeFlag
            (
                bool isSingleLimitOffSetIncluded /** issinglelimitoffsetincluded */ 
            );
            /**Returns  the single limit offset english value to add to or subtract from the size of the dimension. 
                    This value should be interpreted with the option from @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag@endlink .
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double SingleLimitOffsetValueEnglish
            (
            );
            /**Sets  the single limit offset english value to add to or subtract from the size of the dimension. 
                    This value should be interpreted with the option from @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag@endlink .
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSingleLimitOffsetValueEnglish
            (
                double singleLimitOffSetValueEnglish /** singlelimitoffsetvalueenglish */ 
            );
            /**Returns  the single limit offset metric value to add to or subtract from the size of the dimension. 
                    This value should be interpreted with the option from @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag@endlink .
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : None */
            public: double SingleLimitOffsetValueMetric
            (
            );
            /**Sets  the single limit offset metric value to add to or subtract from the size of the dimension. 
                    This value should be interpreted with the option from @link NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag NXOpen::Annotations::DimensionStyleBuilder::SingleLimitOffsetIncludeFlag@endlink .
                    
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetSingleLimitOffsetValueMetric
            (
                double singleLimitOffSetValueMetric /** singlelimitoffsetvaluemetric */ 
            );
