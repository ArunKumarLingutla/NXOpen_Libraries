        ...
        */
        class NXOPENCPP_PDMEXPORT  FileManagement : public NXOpen::TransientObject
        {
            ...
            public: enum FileType
            {
                ...
                FileTypeRoutePipeSpecAttr/** route pipe spec attr */ ,
            ...
            /** Save Attached Files To Teamcenter.
                    Save attached files for given specifications.
                     ...
                     @return  Result codes. Success (0), failure (non-zero). Array size is total number of named references 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                ...
                std::vector<NXString> & datasetPropertyNames /** Dataset property names; to specify required properties when creating new dataset or for updating existing dataset properties */,
                std::vector<NXString> & datasetPropertyValues /** Dataset property values; need to match 1-1 with above datasetPropertyNames */,
                const std::vector<NXOpen::NXObject *> & ownershipToMatchForNewDataset /** Teamcenter object used to assign new dataset owner, default is current owner if set to NULL_TAG */,
                const std::vector<NXOpen::PDM::PdmFile *> & fileVolumeToStore /** Teamcenter volume for storing file, default is current session volume if set to NULL */,
                std::vector<NXString> & toolUsed /** Teamcenter toolUsed for new dataset */,
                std::vector<NXString> & datasetDescription /** Dataset description for new dataset */,
                ...
                std::vector<NXString> & namedReferenceName /** Named reference name. Array size is total number of named references */,
                const std::vector<bool> & isText /** Named reference isText flag. Array size is total number of named references */,
                std::vector<NXString> & filePath /** Named reference file path. Array size is total number of named references */,
                std::vector<NXString> & logicalFileName /** Named reference logical filename. Array size is total number of named references */,
                const std::vector<bool> & allowReplace /** True (default) - replace existing if present; False - always create new. Array size is total number of named references */,
                bool outputFiles /** False (default) - do not return files; True - return files */,
                std::vector<NXOpen::PDM::PdmFile *> & files /** Output - arry of PdmFiles. Array size is total number of named references */
            );
