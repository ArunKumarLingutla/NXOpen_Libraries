    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  InspectionPathBuilder : public NXOpen::CAM::OperationBuilder
        {
            ...
            /** the clearance mode */
            public: enum ClearanceModeType
            {
                ClearanceModeTypeSafePlane/** Safe Plane */,
                ClearanceModeTypeBoundingBox/** Bounding Box */
            };
            ...
            /**Returns  the clearance mode setting 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InspectionPathBuilder::ClearanceModeType ClearanceMode
            (
            );
            /**Sets  the clearance mode setting 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetClearanceMode
            (
                NXOpen::CAM::InspectionPathBuilder::ClearanceModeType clearanceMode /** clearancemode */ 
            );
            ...
            /**Returns  the safe bounding box block 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * SafeBoundingBox
            (
            );
            /**Sets  the safe bounding box block 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetSafeBoundingBox
            (
                NXOpen::NXObject * boundingBox /** boundingbox */ 
            );
