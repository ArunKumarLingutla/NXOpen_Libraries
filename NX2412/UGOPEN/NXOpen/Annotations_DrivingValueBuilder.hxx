        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DrivingValueBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: enum DrivingValueMethod
            {
                ...
                DrivingValueMethodConstant/** constant */ 
            };
            ...
            /**Returns  the driving method.  After changing the driving method, use @link NXOpen::Annotations::DrivingValueBuilder::ApplyDrivingMethod NXOpen::Annotations::DrivingValueBuilder::ApplyDrivingMethod@endlink  to update the dimension. 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::DrivingValueBuilder::DrivingValueMethod DrivingMethod
            (
            );
            /**Sets  the driving method.  After changing the driving method, use @link NXOpen::Annotations::DrivingValueBuilder::ApplyDrivingMethod NXOpen::Annotations::DrivingValueBuilder::ApplyDrivingMethod@endlink  to update the dimension. 
             <br>  Created in NX9.0.0.  <br>  
            ...
            /** After changing the driving method, update the dimension to that method.  It is particularly useful when editing a dimension
                        as it adds the expression, which can then be modified further. 
             <br>  Created in NX2412.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: void ApplyDrivingMethod
            (
            );
            ...
            /**Returns  the expression name 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::Annotations::DrivingValueBuilder::ExpressionValue NXOpen::Annotations::DrivingValueBuilder::ExpressionValue@endlink  to get the expression. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Annotations::DrivingValueBuilder::ExpressionValue to get the expression.") NXString ExpressionName
            (
            );
            /**Sets  the expression name 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::Annotations::DrivingValueBuilder::ExpressionValue NXOpen::Annotations::DrivingValueBuilder::ExpressionValue@endlink  to get the expression and @link NXOpen::ExpressionCollection::Rename NXOpen::ExpressionCollection::Rename@endlink . <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::Annotations::DrivingValueBuilder::ExpressionValue to get the expression and NXOpen::ExpressionCollection::Rename.") void SetExpressionName
            (
            ...
            /**Returns  the value of dimension without expression 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: double DimensionValue
            (
            );
            /**Sets  the value of dimension without expression 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
