        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  AnimatedColorBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option determines whether to set the repeat time. 
             ...
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: bool EnableRepeatTime
            (
            );
            /**Sets  the option determines whether to set the repeat time. 
             <br>  Created in NX2312.0.0.  <br>  
             <br> License requirements : nx_animationdesigner (" NX Animation Designer") */
            public: void SetEnableRepeatTime
            (
                bool enableRepeatTime /** enablerepeattime */ 
            );
