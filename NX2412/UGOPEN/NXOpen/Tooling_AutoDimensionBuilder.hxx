...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        DimensionCharacterSize </term> <description> 
         
        3.5 </description> </item> 

        <item><term> 
         
        InnerDimensionOffsetValue </term> <description> 
         
        20 </description> </item> 

        <item><term> 
         
        MaxDistanceToOuterMargin </term> <description> 
         
        60 </description> </item> 

        <item><term> 
         
        OffsetValueForMargin </term> <description> 
         
        20 </description> </item> 

        <item><term> 
         
        OvtData.AssociativeOrientation </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SelectHolesAutomatically </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TextAngle </term> <description> 
         
        0.0 </description> </item> 

        <item><term> 
         
        TextFont </term> <description> 
         
        First </description> </item> 

        <item><term> 
         
        TextOrientation </term> <description> 
        ...
        NoTolerance </description> </item> 

        <item><term> 
         
        ToleranceCharacterSize </term> <description> 
         
        3.5 </description> </item> 

        <item><term> 
         
        ToleranceLowerValue </term> <description> 
         
        -0.001 </description> </item> 

        <item><term> 
         
        ToleranceUpperValue </term> <description> 
         
        0.001 </description> </item> 

        <item><term> 
         
        ToleranceValue </term> <description> 
        ...
        CreateOrdinateDimension </description> </item> 

        <item><term> 
         
        ValuePrecision </term> <description> 
         
        NominalMinusX </description> </item> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  AutoDimensionBuilder : public NXOpen::Builder
        {
            ...
            {
                OriginPointTypeTopLeft/** top left */ ,
                OriginPointTypeTopRight/** top right */ ,
                OriginPointTypeCenter/** center */ ,
                OriginPointTypeBottomLeft/** bottom left */ ,
                OriginPointTypeBottomRight/** bottom right */ ,
                OriginPointTypeUserDefined/** user defined */ 
            };
            ...
            /**Returns  the position type to create ordinate origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::AutoDimensionBuilder::OriginPointType OriginPosition
            (
            );
            /**Sets  the position type to create ordinate origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetOriginPosition
            (
                NXOpen::Tooling::AutoDimensionBuilder::OriginPointType type /** type */ 
            );
            ...
            /**Returns  the option whether to create maximum distance dimensions 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : None */
            public: bool CreateMaxDistanceDimensions
            (
            );
            /**Sets  the option whether to create maximum distance dimensions 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetCreateMaxDistanceDimensions
            (
                bool createMaxDimensions /** createmaxdimensions */ 
            );
            ...
            /** The method to set whether to use view boundary point to create ordinate origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetUseViewBoundaryPoint
            (
                bool useBoundaryPoint /** useboundarypoint */ 
            );
            /**Returns  the view orientation definition 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Drawings::OvtBuilder * OvtData
            (
            );
            ...
            /** Get the temporary point created on the view 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::NXObject * GetTemporaryPointOnView
            (
                NXOpen::View * viewTag /** The view on which origin to created */,
                NXOpen::Tooling::AutoDimensionBuilder::OriginPointType pointType /** pointtype */ ,
                bool createPoint /** Whether to create a new point if no point of this type exists */
            );
            /** Delete all temporary points of recorded views 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void DeleteTemporaryPointsOnViews
            (
            );
            /** Get the the view oridnate origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: NXOpen::Annotations::OrdinateOriginDimension * GetViewOrdinateOrigin
            (
                NXOpen::View * viewTag /** The view on which origin to created */
            );
            /** Record the view oridnate origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetViewOrdinateOrigin
            (
                NXOpen::View * viewTag /** The view on which origin to created */,
                NXOpen::Annotations::OrdinateOriginDimension * originTag /** The ordinate origin */,
                bool isNewCreated /** isnewcreated */ 
            );
            /** Delete the oridnate origin 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void DeleteViewOrdinateOrigin
            (
                NXOpen::Annotations::OrdinateOriginDimension * originTag /** origintag */ 
            );
            /** Record the view object to dimension 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void AddViewObjectToDimension
            (
            ...
            /** Get all objects to be dimensioned from the view recorded data 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void GetViewObjectsToDimension
            (
                NXOpen::View * viewTag /** viewtag */ ,
            ...
            /** Remove the object to be dimensioned from the view recorded data 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void RemoveViewObjectToDimension
            (
                NXOpen::NXObject * objectTag /** objecttag */ 
            );
            ...
            /** Modify the view's matrix 
             <br>  Created in NX2406.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ModifyViewMatrix
            (
                NXOpen::View * viewTag /** viewtag */ ,
                const NXOpen::Matrix3x3 & newMatrix /** newmatrix */ 
            );
        };
    }
}
