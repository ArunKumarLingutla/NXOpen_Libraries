...
#include <NXOpen/Annotations_HoleCalloutDimensionBuilder.hxx>
...
#include <NXOpen/Annotations_PmiHoleCalloutDimensionBuilder.hxx>
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DimensionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Annotations::HoleCalloutDimensionBuilder * CreateHoleCalloutDimensionBuilder
            (
                NXOpen::Annotations::Dimension * holecalloutDimension /** the hole callout dimension to be edited,
                                                                                                                                                if NULL, then create a hole callout dimension */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") */
            public: NXOpen::Annotations::PmiHoleCalloutDimensionBuilder * CreatePmiHoleCalloutDimensionBuilder
            (
                NXOpen::Annotations::Dimension * measurementDimension /** the PMI hole callout dimension to be edited,
                                                                                                                                                 if NULL, then create a PMI hole callout dimension */
            );
            ...
            /** Creates a @link NXOpen::Annotations::AppendedTextEditorBuilder NXOpen::Annotations::AppendedTextEditorBuilder@endlink  
             <br>  Created in NX9.0.0.  <br>  
