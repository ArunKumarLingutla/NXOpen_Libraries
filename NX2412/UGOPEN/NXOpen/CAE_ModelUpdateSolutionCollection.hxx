...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        class NXOPENCPP_CAEEXPORT  ModelUpdateSolutionCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::CAE::ModelUpdateSolution *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::CAE::ModelUpdateSolution **;
                using reference = NXOpen::CAE::ModelUpdateSolution *&;
            ...
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAE::ModelUpdateSolution::PlotSensitivities instead.") NXOpen::CAE::ModelUpdateSensitivityViewerBuilder * CreateSensitivityViewerBuilder
            (
