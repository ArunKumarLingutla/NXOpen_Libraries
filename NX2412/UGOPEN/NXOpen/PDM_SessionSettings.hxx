        ...
        */
        class NXOPENCPP_PDMEXPORT  SessionSettings : public NXOpen::TransientObject
        {
            ...
            /** Gets the names of the Teamcenter local volumes which the user may use,
                     ...
                     @return  the names of the local volumes 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetLocalVolumes
            (
            );
            /** Gets the names of the Teamcenter location codes which the user may use, 
                        given the current group returned by @link PDM::SessionSettings::Group PDM::SessionSettings::Group@endlink .
                     @return  the names of the location codes 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetLocationCodes
            (
            );
            ...
            /**Sets  the Teamcenter local volume. Should be
            ...
            (
                const NXString & localvolume /** localvolume */ 
            );
            /**Sets  the Teamcenter local volume. Should be
                        one of those given by @link PDM::SessionSettings::GetLocalVolumes PDM::SessionSettings::GetLocalVolumes@endlink 
            ...
            void SetLocalVolume
            (
                const char * localvolume /** localvolume */ 
            );
            /**Returns  the Teamcenter local volume. Should be
                        one of those given by @link PDM::SessionSettings::GetLocalVolumes PDM::SessionSettings::GetLocalVolumes@endlink 
                     
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXString LocalVolume
            (
            );
            /**Sets  the Teamcenter location code. Should be
            ...
            (
                const NXString & locationCode /** locationcode */ 
            );
            /**Sets  the Teamcenter location code. Should be
                        one of those given by @link PDM::SessionSettings::GetLocationCodes PDM::SessionSettings::GetLocationCodes@endlink 
            ...
            (
                const char * locationCode /** locationcode */ 
            );
            /**Returns  the Teamcenter location code. Should be
                        one of those given by @link PDM::SessionSettings::GetLocationCodes PDM::SessionSettings::GetLocationCodes@endlink 
                     
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXString LocationCode
            (
            );
