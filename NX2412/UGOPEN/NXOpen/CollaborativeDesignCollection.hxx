...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  CollaborativeDesignCollection : public NXOpen::TaggedObjectCollection
    {
        ...
        {
        public:
            using value_type = NXOpen::CollaborativeDesign *;
            using iterator_category = std::forward_iterator_tag;
            using pointer = NXOpen::CollaborativeDesign **;
            using reference = NXOpen::CollaborativeDesign *&;
        ...
        /**Returns  the @link NXOpen::Assemblies::SubsetBuilder NXOpen::Assemblies::SubsetBuilder@endlink  used to edit the current subset in the
