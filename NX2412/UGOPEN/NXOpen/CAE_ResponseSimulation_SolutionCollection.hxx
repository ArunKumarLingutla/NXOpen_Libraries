        ...
        namespace ResponseSimulation
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  SolutionCollection : public NXOpen::TaggedObjectCollection
            {
                ...
                {
                public:
                    using value_type = NXOpen::CAE::ResponseSimulation::Solution *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::CAE::ResponseSimulation::Solution **;
                    using reference = NXOpen::CAE::ResponseSimulation::Solution *&;
