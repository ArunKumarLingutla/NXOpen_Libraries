...
namespace NXOpen
{
    ...
    namespace Motion
    {
        ...
        /** Represents a collection of motion damper  <br> To obtain an instance of this class, refer to @link NXOpen::Motion::MotionManager  NXOpen::Motion::MotionManager @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  DamperCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Motion::Damper *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Motion::Damper **;
                using reference = NXOpen::Motion::Damper *&;
            ...
            /**   Return  @link  NXOpen::Motion::DamperBuilder   NXOpen::Motion::DamperBuilder @endlink  object   @return  DamperBuilder object 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::DamperBuilder * CreateDamperBuilder
            (
                NXOpen::Motion::Damper * damper /** @link NXOpen::Motion::Damper NXOpen::Motion::Damper@endlink  to be edited, 
                                                                        if NULL then create a new one */
            );
            /** Finds the @link  NXOpen::Motion::Damper   NXOpen::Motion::Damper @endlink  with the given name.
