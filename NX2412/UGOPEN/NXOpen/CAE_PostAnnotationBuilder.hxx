    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostAnnotationBuilder : public NXOpen::TransientObject
        {
            ...
            /** Set the reference group name.  
                       The input ref_group_name is what was returned from 
                       @link NXOpen::CAE::Result::AskUserGroups NXOpen::CAE::Result::AskUserGroups@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetGroupRefrenceName
            (
                const NXString & refGroupName /** ref group name */ 
            );
            /** Set the reference group name.  
                       The input ref_group_name is what was returned from 
                       @link NXOpen::CAE::Result::AskUserGroups NXOpen::CAE::Result::AskUserGroups@endlink  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            void SetGroupRefrenceName
            (
                const char * refGroupName /** ref group name */ 
            );
            /** Get the combine option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostAnnotation::CombineOption GetCombineOption
            (
            );
            /** Set the combine option 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: void SetCombineOption
            (
                NXOpen::CAE::PostAnnotation::CombineOption combineOption /** combineoption */ 
            );
            /** Get the display style 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostAnnotation::Style GetDisplayStyle
            (
            );
            ...
            (
                NXOpen::CAE::PostAnnotation::Style displayStyle /** displaystyle */ 
            );
            /** Get the display value type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostAnnotation::ValueType GetDisplayValueType
            (
            );
            ...
            (
                NXOpen::CAE::PostAnnotation::ValueType displayValueType /** displayvaluetype */ 
            );
