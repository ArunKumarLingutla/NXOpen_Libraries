...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        ConstantFittingSectionCount </term> <description> 
         
        -1 </description> </item> 

        <item><term> 
         
        PlayButtons.CurrentStep </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PlayButtons.PlayModes </term> <description> 
         
        PlayOnce </description> </item> 

        <item><term> 
         
        PlayButtons.ScaleSpeed </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        PlayButtons.ScaleStep </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        PlayButtons.Speed </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        ReviewSection </term> <description> 
