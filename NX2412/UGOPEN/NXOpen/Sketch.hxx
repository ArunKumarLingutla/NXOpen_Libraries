    ...
    */
    class NXOPENCPPEXPORT  Sketch : public NXOpen::DisplayableObject, public virtual NXOpen::IProfile
    {
        ...
        /**Returns  the infinite horizontal axis of the sketch, if one exists. This axis is internal to the sketch and should not be edited or deleted. 
         <br>  Created in NX2306.3000.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::InfiniteLine * HorizontalAxis
        (
        );
        /**Returns  the infinite vertical axis of the sketch, if one exists. This axis is internal to the sketch and should not be edited or deleted. 
         <br>  Created in NX2306.3000.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::InfiniteLine * VerticalAxis
        (
        );
        ...
        /** Determine if the input constraint is owned by the sketch.  Returns true for the constraints returned by 
            @link NXOpen::Sketch::GetAllConstraintsOfType NXOpen::Sketch::GetAllConstraintsOfType@endlink .  @return  True if the constraint belongs to this sketch 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsSketchConstraint
        (
            NXOpen::SketchConstraint * constraint /** Candidate constraint */
        );
        /** Determine if the input dimension is owned by the sketch.  Returns true for a dimension whose associated constraint is returned by 
            @link NXOpen::Sketch::GetAllConstraintsOfType NXOpen::Sketch::GetAllConstraintsOfType@endlink .  @return  True if the dimension belongs to this sketch 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsSketchDimension
        (
            NXOpen::Annotations::Dimension * dimension /** Candidate dimension */
        );
        /** Get the constraint associated with the input sketch dimension.  The dimension must be owned by this sketch, which means that
            @link NXOpen::Sketch::IsSketchDimension NXOpen::Sketch::IsSketchDimension@endlink  returns true. To get the dimension from a constraint, use 
            @link NXOpen::SketchDimensionalConstraint::AssociatedDimension NXOpen::SketchDimensionalConstraint::AssociatedDimension@endlink   @return  The dimensional constraint 
         <br>  Created in NX2312.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::SketchDimensionalConstraint * GetConstraintFromDimension
        (
            NXOpen::Annotations::Dimension * dimension /** Sketch dimension */
        );
        ...
        /**Returns  a true value when the sketch is in mechanism mode, false otherwise
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: bool MechanismMode
        (
        );
        /**Sets  a true value when the sketch is in mechanism mode, false otherwise
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") */
        public: void SetMechanismMode
        (
            bool isMechanismMode /**  When true, the sketch is in mechanism mode. */
        );
        /** Returns true when the input geometry is an included curve or point.  @return  When true, geometry is an included curve or point 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: bool IsIncludedGeometry
        (
            NXOpen::SmartObject * geometry /** Must be a curve or point */
        );
        /** Returns the parent of the included geometry.  @return  The parent 
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::NXObject * GetParentOfIncludedGeometry
        (
            NXOpen::SmartObject * geometry /** Must be an included geometry */
        );
        /** Returns all the curves in a sketch that have remote finding enabled.  @return  All sketch curves with remote finding enabled 
         <br>  Created in NX2212.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::SmartObject *> GetRemoteFindingCurves
        (
        );
        /** Renew a drafting sketch to the latest solver version.  To renew a sketch feature use the @link NXOpen::GeometricUtilities::RenewFeatureBuilder NXOpen::GeometricUtilities::RenewFeatureBuilder@endlink . 
         <br>  Created in NX2306.0.0.  <br>  
         <br> License requirements : drafting ("DRAFTING") */
        public: void RenewDraftingSketch
        (
        );
        /** Updates the sketch navigator. If the input sketch is not the active sketch,
                the SKETCH_NOT_INITIALIZED error will be returned. 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: void UpdateNavigator
        (
        );
        /** Converts all input objects of type @link NXOpen::SketchFoundRelation NXOpen::SketchFoundRelation@endlink  to @link NXOpen::SketchConstraint NXOpen::SketchConstraint@endlink .
                Any active operation will be terminated during this process. Fillet, Slot, and Offset relations are not supported. Also gets the
                new persistent relations in no particular order. 
         <br>  Created in NX2406.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") */
        public: std::vector<NXOpen::SketchConstraint *> MakeRelationPersistent
        (
            const std::vector<NXOpen::NXObject *> & foundRelations /** foundrelations */ 
        );
        /** Get all checking issues from the input sketch. If the input sketch is not the active sketch,
                the SKETCH_NOT_INITIALIZED error will be returned.  
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: std::vector<NXOpen::SketchIssue *> GetIssues
        (
        );
        /** Deletes the input checking issues from the sketch. If the input sketch is not the active sketch,
                the SKETCH_NOT_INITIALIZED error will be returned. 
         <br>  Created in NX2412.0.0.  <br>  
         <br> License requirements : solid_modeling ("SOLIDS MODELING") OR drafting ("DRAFTING") OR geometric_tol ("GDT") OR nx_freeform_1 ("basic freeform modeling") */
        public: void DeleteIssues
        (
            const std::vector<NXOpen::SketchIssue *> & issues /** issues */ 
        );
