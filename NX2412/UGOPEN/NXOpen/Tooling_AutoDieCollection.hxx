    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  AutoDieCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            {
            public:
                using value_type = NXOpen::Tooling::AutoDieGroup *;
                using iterator_category = std::forward_iterator_tag;
                using pointer = NXOpen::Tooling::AutoDieGroup **;
                using reference = NXOpen::Tooling::AutoDieGroup *&;
            ...
            /** Creates the flange task feature builder.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : die_engineering ("DIE ENGINEERING") */
            public: NXOpen::Tooling::DieEngFlangeTaskBuilder * CreateDieEngFlangeTaskBuilder
            (
                NXOpen::Features::Feature * dieEngFlangeTask /** Flange Task to be edited. */
            );
            /** Creates a Die Design plane list builder 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Tooling::DieDesPlaneListBuilder * CreateDieDesPlaneListBuilder
            (
            );
            /** Creates Die Design Trim Steel Feature Builder 
             <br>  Created in NX2306.0.0.  <br>  
             <br> License requirements : ug_die_design ("Die Design") */
            public: NXOpen::Tooling::DieDesTrmStlFeatBuilder * CreateDieDesTrmstlFeatBuilder
            (
                NXOpen::Features::BodyFeature * frec /** @link Features::BodyFeature Features::BodyFeature@endlink  to be edited */
            );
            /** Creates a @link NXOpen::Tooling::DieEngTrimLineBuilder  NXOpen::Tooling::DieEngTrimLineBuilder @endlink .  @return  
            ...
            public: NXOpen::Tooling::DieEngTrimLineBuilder * CreateDieEngTrimLineBuilder
            (
                NXOpen::Features::Feature * trimLineFeat /** the TrimLineDevelopment feature to be edited, NULL if create. */
            );
