...
namespace NXOpen
{
    ...
    namespace Routing
    {
        namespace Electrical
        {
            class SystemDeviceCollectionImpl;
            ...
            */
            class NXOPENCPP_ROUTINGEXPORT  SystemDeviceCollection : public NXOpen::TaggedObjectCollection
            {
                private: SystemDeviceCollectionImpl * m_systemdevicecollection_impl;
                private: NXOpen::Routing::RouteManager* m_owner;
                /// \cond NX_NO_DOC 
                public: explicit SystemDeviceCollection(NXOpen::Routing::RouteManager *owner);
                ...
                tag_t Tag() const; 
                public: ~SystemDeviceCollection();
                /** Iterator for accessing the contents of the collection. */
                //lint -sem(NXOpen::Routing::Electrical::SystemDeviceCollection::iterator::copy,initializer)
                class iterator
                {
                public:
                    using value_type = NXOpen::Routing::Electrical::SystemDevice *;
                    using iterator_category = std::forward_iterator_tag;
                    using pointer = NXOpen::Routing::Electrical::SystemDevice **;
                    using reference = NXOpen::Routing::Electrical::SystemDevice *&;
                ...
                /** Creates @link NXOpen::Routing::Electrical::SystemDevice NXOpen::Routing::Electrical::SystemDevice@endlink .  @return  The new System Device. 
                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                public: NXOpen::Routing::Electrical::SystemDevice * CreateSystemDevice
                (
                );
                /** Creates @link NXOpen::Routing::Electrical::SystemDevice NXOpen::Routing::Electrical::SystemDevice@endlink  with given name.  @return  The new System Device. 
                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
                public: NXOpen::Routing::Electrical::SystemDevice * CreateSystemDevice
                (
                ...
                (
                    const char * systemName /** The name of the new system.
                                                                                 (NULL not allowed) */
                );
                /** Get System Devices.  @return  The array of System Devices in the given part. 
                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
