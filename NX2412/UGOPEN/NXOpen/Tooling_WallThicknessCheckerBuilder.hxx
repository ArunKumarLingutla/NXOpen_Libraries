...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        RangeAreasHighLimit </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        RangeAreasLowLimit </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TargetsFromFaceAttribute </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        TargetsFromFaceColorOnOff </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TargetsTargetFaceAttribute </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        TargetsTargetFaceColorOnOff </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TargetsThicknessHighRangeLimit </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        TargetsThicknessLowRangeLimit </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  WallThicknessCheckerBuilder : public NXOpen::Builder
        {
            ...
            /** The type of action to be performed for when reading from a Wall Thickness Check preference file. */
            public: enum CalculationPreferenceFileNumber
            {
                CalculationPreferenceFileNumberAuto/** auto */ ,
                CalculationPreferenceFileNumberRead/** read */ 
            };
            ...
            /** The type of PMI to be created. */
            public: enum PMIThicknessType
            {
                PMIThicknessTypeNone/** None */,
                PMIThicknessTypeMinimum/** Minimum thickness */,
                PMIThicknessTypeMaximum/** Maximum thickness */,
                PMIThicknessTypeMinimumAndMaximum/** Minimum and maximum thickness */
            };

            /** Enum value for user attributes in From Face selection. */
            public: enum TargetsFromFaceAttributes
            {
                TargetsFromFaceAttributesNone/** none */ 
            };

            /** Enum value for user attributes in Target Face selection. */
            public: enum TargetsTargetFaceAttributes
            {
                TargetsTargetFaceAttributesNone/** none */ 
            };
            ...
            /**Returns  the Wall Thickness Check preference file ID number 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: int CalculationPreferenceFileID
            (
            );
            /**Sets  the Wall Thickness Check preference file ID number 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCalculationPreferenceFileID
            (
                int calculationPreferenceFileID /** calculationpreferencefileid */ 
            );
            /**Returns  the unique name for the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXString CalculationPreferenceFileNameString
            (
            );
            /**Sets  the unique name for the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCalculationPreferenceFileNameString
            (
                const NXString & calculationPreferenceFileNameString /** calculationpreferencefilenamestring */ 
            );
            /**Sets  the unique name for the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            void SetCalculationPreferenceFileNameString
            (
                const char * calculationPreferenceFileNameString /** calculationpreferencefilenamestring */ 
            );
            ...
            /**Returns  the range areas low limit 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: double RangeAreasLowLimit
            (
            );
            /**Sets  the range areas low limit 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetRangeAreasLowLimit
            (
                double rangeAreasLowLimit /** rangeareaslowlimit */ 
            );
            /**Returns  the range areas high limit 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: double RangeAreasHighLimit
            (
            );
            /**Sets  the range areas high limit 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetRangeAreasHighLimit
            (
                double rangeAreasHighLimit /** rangeareashighlimit */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void GetOrCreateRangeAreasSetBodies
            (
                int areaNodeID /** Area ID in Easy Tree list, 1,2,3.......N. */,
                std::vector<NXOpen::Body *> & convergentBodies /** Convergent bodies associated with the range areas set */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetKeepRangeAreasSetBodies
            (
                int areaNodeID /** Area ID in Easy Tree list, 1,2,3.......N. */,
                bool keepBody /** the flag that indicates whether to keep the convergent bodies created */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void DeleteRangeAreasSetConvergentBodies
            (
            ...
            /** Create a PMI at a point showing the thickness information at that point 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void CreatePMIAtPoint
            (
                NXOpen::Tooling::WallThicknessCheckerBuilder::PMIThicknessType pmiType /** Type of PMI */,
                double minimumThickness /** Minimum thickness */,
                double maximumThickness /** Maximum thickness */,
                const NXOpen::Point3d & point /** Point at which PMI will be placed */
            );
            ...
            /// \endcond 
            /**Returns  the thickness low range limit on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: double TargetsThicknessLowRangeLimit
            (
            );
            /**Sets  the thickness low range limit on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsThicknessLowRangeLimit
            (
                double targetsThicknessLowRangeLimit /** targetsthicknesslowrangelimit */ 
            );
            /**Returns  the thickness high range limit on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: double TargetsThicknessHighRangeLimit
            (
            );
            /**Sets  the thickness high range limit on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsThicknessHighRangeLimit
            (
                double targetsThicknessHighRangeLimit /** targetsthicknesshighrangelimit */ 
            );
            /**Returns  the from face selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectFaceList * TargetsFromFaces
            (
            );
            /**Returns  the on or off option for using color as a filter for from faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool TargetsFromFaceColorOnOff
            (
            );
            /**Sets  the on or off option for using color as a filter for from faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsFromFaceColorOnOff
            (
                bool targetsFromFaceColorOnOff /** targetsfromfacecoloronoff */ 
            );
            /**Returns  the color used as a filter for from faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXColor * TargetsFromFaceColor
            (
            );
            /**Sets  the color used as a filter for from faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsFromFaceColor
            (
                NXOpen::NXColor * targetsFromFaceColor /** targetsfromfacecolor */ 
            );
            /**Returns  the user attribute used as a filter for from faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::WallThicknessCheckerBuilder::TargetsFromFaceAttributes TargetsFromFaceAttribute
            (
            );
            /**Sets  the user attribute used as a filter for from faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsFromFaceAttribute
            (
                NXOpen::Tooling::WallThicknessCheckerBuilder::TargetsFromFaceAttributes targetsFromFaceAttribute /** targetsfromfaceattribute */ 
            );
            /**Returns  the target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectFaceList * TargetsTargetFaces
            (
            );
            /**Returns  the on or off option for using color as a filter for target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool TargetsTargetFaceColorOnOff
            (
            );
            /**Sets  the on or off option for using color as a filter for target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsTargetFaceColorOnOff
            (
                bool targetsTargetFaceColorOnOff /** targetstargetfacecoloronoff */ 
            );
            /**Returns  the color used as a filter for target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXColor * TargetsTargetFaceColor
            (
            );
            /**Sets  the color used as a filter for target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsTargetFaceColor
            (
                NXOpen::NXColor * targetsTargetFaceColor /** targetstargetfacecolor */ 
            );
            /**Returns  the user attribute used as a filter for target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::WallThicknessCheckerBuilder::TargetsTargetFaceAttributes TargetsTargetFaceAttribute
            (
            );
            /**Sets  the user attribute used as a filter for target faces selection on the Targets Tab Page 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTargetsTargetFaceAttribute
            (
                NXOpen::Tooling::WallThicknessCheckerBuilder::TargetsTargetFaceAttributes targetsTargetFaceAttribute /** targetstargetfaceattribute */ 
            );
            /** Update the selected from faces on the Targets Tab Page. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateTargetsFromFaces
            (
            );
            /** Update the selected target faces on the Targets Tab Page. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdateTargetsTargetFaces
            (
            );
            /** Set the targets display flag. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetInTargetsDisplay
            (
                bool inTargetsDisplay /** the flag that indicates whether it is in targets display */
            );
            /** Save the active Wall Thickness Check preference file to a file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void SaveActiveWTCPreferenceFile
            (
            );
            /** Get the active Wall Thickness Check preference file ID 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: int GetActiveWTCPreferenceFileID
            (
            );
            /** Write dialog parameters in dialog memory to the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void DialogMemoryDataWriteToWTCPreferenceFile
            (
                const NXString & uniqueName /** Unique name for Wall Thickness Check preference file */
            );
            /** Write dialog parameters in dialog memory to the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            void DialogMemoryDataWriteToWTCPreferenceFile
            (
                const char * uniqueName /** Unique name for Wall Thickness Check preference file */
            );
            /** Read dialog parameters in dialog memory from the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void DialogMemoryDataReadFromWTCPreferenceFile
            (
            );
            /** Get the preference file ID given the Wall Thickness Check preference file  @return  The file ID of the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Get the preference file ID given the Wall Thickness Check preference file  @return  The file ID of the Wall Thickness Check preference file 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            int GetPreferenceFileID
            (
                const char * uniqueName /** Unique name for Wall Thickness Check preference file */
            );
            /** Initialize the active Wall Thickness Check preference file based on the thickness UDO 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void InitActivePreferenceFileByThicknessUDO
            (
            );
            /** Perform all the commit operations done in commit 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
