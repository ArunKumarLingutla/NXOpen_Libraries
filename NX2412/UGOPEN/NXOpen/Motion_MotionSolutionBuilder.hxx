    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MotionSolutionBuilder : public NXOpen::Motion::EntityPropTableBuilder
        {
            ...
            {
                ObjectiveIntegratedSolve/** Integrated solve */,
                ObjectiveExportToExternalPlatform/** Export to External Platform */
            };

            /** External Platform */
            public: enum Platform
            {
                PlatformAmesim/** Amesim */,
                PlatformSimulink/** Simulink */,
                PlatformFmi/** FMI */,
                PlatformProcyon/** Procyon */,
                PlatformConcurrent/** Concurrent */,
                PlatformDspace/** Old "dSPACE" becomes "DS1006" in UI, remains "dSPACE" everywhere else. */,
                PlatformScalexio/** dSPACE SCALEXIO */
            };
            ...
            /** Gravity Value Option */
            public: enum GravityValueOption
            {
                GravityValueOptionExpression/** expression option */,
                GravityValueOptionProfile2d/** profile2d option */
            };
            ...
            public: enum StepTypeOption
            {
                ...
                StepTypeOptionSpeedSweepDriver/** speed sweep driver option */
            };
            ...
            public: enum UnitLength
            {
                ...
                UnitLengthMicrometer/** micrometer unit */
            };
            ...
            public: enum UnitMass
            {
                ...
                UnitMassMilligram/** milligram unit */
            };
            ...
            public: enum OutputType
            {
                ...
                OutputTypeBinaryAfterRun/** binary after run type */
            };
            ...
            public: enum InverseDynamicMethod
            {
                InverseDynamicMethodSingleStep/** inverse dynamic method single step */,
                InverseDynamicMethodMultiStep/** inverse dynamic method multi step */
            };
            ...
            public: enum DynamicIntegrationMethod
            {
                ...
                DynamicIntegrationMethodRbdf/** dynamic integration method Real Time BDF (CCODE) */
            };

            /** Simulation Type */
            public: enum DynamicSimulationType
            {
                DynamicSimulationTypeCoSimulation/** dynamic simulation type Co-Simulation */,
                DynamicSimulationTypeModelExchange/** dynamic simulation type Model Exchange */
            };
            ...
            {
                RealTimeSystemTypeWindows/** Windows */,
                RealTimeSystemTypeLinux/** Linux */
            };

            /** Vehicle Road Height Adjustment */
            public: enum StaticSuspensionType
            {
                StaticSuspensionTypeDependent/** suspension type dependent*/,
                StaticSuspensionTypeIndependent/** suspension type independent*/
            };

            /** Motion Solver Type */
            public: enum MotionSolverType
            {
                MotionSolverTypeClassic/** Next Generation Solver off */,
                MotionSolverTypeNextGeneration/** Next Generation Solver on */
            };

            /** Next Gen Solver 3D Contact Evaluation Update */
            public: enum NextGenSolverEvaluationUpdate
            {
                NextGenSolverEvaluationUpdateContinuous/** Next Gen Evaluation Update = Continuous */,
                NextGenSolverEvaluationUpdateDelayed/** Next Gen Evaluation Update = Delayed */
            };

            /** Next Gen Solver Multiprocessor Mode */
            public: enum NextGenSolverMultiprocessorMode
            {
                NextGenSolverMultiprocessorModeSerial/** Next Gen Multiprocessor Mode = Serial */,
                NextGenSolverMultiprocessorModeThreaded/** Next Gen Multiprocessor Mode = Threaded */,
                NextGenSolverMultiprocessorModeSpecifiedThreads/** Next Gen Multiprocessor Mode = Specified Threads */
            };
