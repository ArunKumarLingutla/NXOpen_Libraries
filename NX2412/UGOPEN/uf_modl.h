...
UF_MODL_create_symb_thread function is now obsoleted in NX2007. 
...
/******************************************************************************
Sets the distance tolerance for the part, as found in the Modeling Preferences dialog box.
Environment: Internal  and  External
See Also:
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_MODL_set_distance_tolerance_of_part(
tag_t  object_in_part, /* <I>
                  Some object in the part for which the tolerance is to be set
               */
double * tolerance /* <I>
...
History:
 *****************************************************************************/
extern UFUNEXPORT int UF_MODL_set_angle_tolerance_of_part(
tag_t  object_in_part, /* <I>
                  Some object in the part for which the tolerance is to be set
               */
double * tolerance /* <I>
...
NOTE: When the ray hits an edge, this function will return both adjacent faces of the edge
as it does not know which is of the interest to the caller. In this case, the
intersection points on the adjacent faces returned by this function will be the same.
The caller may identify the case by comparing the intersection points and count one
intersection to the body only.
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_MODL_ask_distance_tolerance_of_part(
tag_t  object_in_part, /* <I>
                  Some object in the part from which the tolerance is to be read
               */
double * tolerance  /* <O>
                    Distance tolerance
                    */
...
History:
 ******************************************************************************/
extern UFUNEXPORT int UF_MODL_ask_angle_tolerance_of_part(
tag_t  object_in_part, /* <I>
                  Some object in the part from which the tolerance is to be read
               */
double * tolerance  /* <O>
...
Thread feature use thread standard file from environment variable UGII_THREADED_HOLE_STANDARD_DIR for features
created interactively or using thread NXOpen classes in NX1926 and later.
UF_MODL_edit_symb_thread() will edit pre-NX1926 thread feature or which are created using UF functions.
Otherwise it will return an error.
