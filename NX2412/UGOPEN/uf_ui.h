...
char file_name[MAX_FSPEC_BUFSIZE],/* <I/O>
                  ...
                  */
int *  units ,/* <I/O>
              On input part units to use for part creation dialog.  On
...
char file_name[MAX_FSPEC_BUFSIZE] ,/* <I/O>
                  ...
                  */
int *  units ,/* <I/O>
              On input the part units to use for part creation dialog,
...
int * units  /* <O>
             ...
             UF_UI_DEFAULT_UNITS (same as the default units for data entry)
             */
);
...
The call to UF_UI_set_force_unlock_flag must be followed with a call
...
/****************************************************************************
 ...
 This mode removes all user interface from around the graphics window and only 
 shows the 3D display. Ribbons, navigators, and menus are made invisible. 
 NX is still interactive, but many user interface elements are not reachable and thus 
 it is strongly recommended to use it in limited situations like automating screen 
 grab of the graphics window at a specific size resolution or in similar examples.
