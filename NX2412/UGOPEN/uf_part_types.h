...
/*****************************************************************************
*
* Type which describes the part load state.
******************************************************************************/
enum UF_PART_load_state_e
{
    UF_PART_not_loaded = 0,             /* Part is not loaded */
...
typedef enum UF_PART_load_state_e UF_PART_load_state_t, *UF_PART_load_state_p_t;
...
#define UF_PART_cleanup_unused_extract_refs       (1U <<  23)
#define UF_PART_cleanup_units                     (1U <<  24)
#define UF_PART_cleanup_motion                    (1U <<  25)
#define UF_PART_cleanup_part_family_data          (1U <<  26)
#define UF_PART_cleanup_delete_corrupt_assembly_structure (1U <<  27)
#define UF_PART_cleanup_component_patterns        (1U <<  28)
#define UF_PART_cleanup_delete_mass_properties    (1U <<  29)
