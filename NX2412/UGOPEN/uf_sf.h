...
before calling any user function defined in this header.
 ...
 End User Functions equivalent to Scenario dialogs:
   ...
   Scenario Meshers:
     ...
     UF_SF_get_auto_element_size --- CAE.MeshManager.GetAutoElementSize
   ...
   MISCELLANEOUS API:
     ...
     UF_SF_ask_element_type_names - CAE.ElementTypeBuilder.GetElementTypeNames
...
tag_t mesh_tag ,/* <I>
                The tag of the mesh
                */
UF_SF_mesh_visuals_t* mesh_vis /* <I>
                                Structure to mesh visual properties.
