/*****************************************************************************
             Copyright (c) 1998-2019 Unigraphics Solutions Inc.
...
This function supports retrieving Legacy Extrude parameters (pre-NX2 version Extrude feature).
To retrieve Extrude parameters post-NX2, please use UF_MODL_mswp_ask_extrude instead.
...
/****************************************************************************
Given an extruded, revolved or revolve feature, this function sets the new tolerances.
We recommend that after using the routine UF_MODL_set_sweep_tolerances,
you should update the database by calling routine UF_MODL_update.
Note: This function does not support sweep and extrude feature.
...
tag_t  feature_id,   /* <I>
                     The feature ID.
                     */
double tolerance[2]    /* <I>
                        The new chaining and distance tolerance.
                        The unit of tolerance is meter
                        tolerance[0] - Chaining tolerance.
                        tolerance[1] - Distance tolerance.
                     */
);
