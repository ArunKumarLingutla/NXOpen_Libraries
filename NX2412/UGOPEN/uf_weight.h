...
enum UF_WEIGHT_units_type_e
{
    ...
    UF_WEIGHT_units_Gghm,    /* Gigagrams and hectometers */
    UF_WEIGHT_units_microgmm /* Micrograms and millimeters */
};
...
enum UF_WEIGHT_state_type_e
{
    ...
    UF_WEIGHT_implied   = 6, /* The property has been derived from other
                             properties. */
    UF_WEIGHT_scaled    = 7, /* The property has been scaled from other
                             properties. */
    UF_WEIGHT_simplified = 8,  /* The property or properties are the result of the
                               simplified geometry. */
    UF_WEIGHT_composites = 9 /* The properties are a result of the Composites 
                                application*/
};
...
enum UF_WEIGHT_exception_reason_e
{
    ...
    UF_WEIGHT_has_self_intersecting_body = 21,  /* The part or component has self intersecting body. */
    UF_WEIGHT_ref_set_mismatch           = 22,  /* The part's properties were established on a reference set that currently doesn't match the reference set settings in customer default. */
    UF_WEIGHT_expression_absent          = 23,  /* The part was defined to create one or more expressions not currently created on the part. */
    UF_WEIGHT_attribute_absent           = 24,  /* The part was defined to create one or more part attributes not currently created on the part. */
    UF_WEIGHT_rollup_attr_out_of_date    = 25,  /* Root part has one or more mass rolled-up attributes which are out-of date */
    UF_WEIGHT_rollup_exp_out_of_date     = 26,  /* Root part has one or more mass rolled-up expressions which are out-of date */
    UF_WEIGHT_assertion_with_value_source_absent = 27, /* The part or component has asserted data on it and with value source absent. */
    UF_WEIGHT_reference_only_component_included = 28,  /* The component is a Reference-Only component and is included in the mass calculation. */
    UF_WEIGHT_has_simplified_geometry = 29,             /* The properties result include the simplified geometry. */
    UF_WEIGHT_has_composites = 30,                      /* The part has composites mass properties */
    UF_WEIGHT_deform_out_of_date = 31,                   /* Deform is out of date */
    UF_WEIGHT_has_budget = 32                           /* The part has budget value */
};
...
struct UF_WEIGHT_exceptions_s
{
    ...
    char **body_names;
                   /* <OF,len:n_exceptions>
                      Array of the names of the solid bodies generating each
                      exception.  Where a part or component generated the
                      exception, this is the empty string "". */
    logical *on_body;
                   /* <len:n_exceptions>
                      Array of logicals.  True if a solid body generated the
                      exception, false if it was a part or component. */
};
