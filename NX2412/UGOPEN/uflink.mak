...
# recommended minimum stack is 2Mb
!IFDEF UFEXTRA_LINK_OPTIONS
lflags  = $(lflags) /STACK:0x200000 /INCREMENTAL:NO /NOLOGO $(UFEXTRA_LINK_OPTIONS) /LIBPATH:"$(UGII_USERFCN)" 
!ELSE
lflags  = $(lflags) /STACK:0x200000 /INCREMENTAL:NO /NOLOGO /LIBPATH:"$(UGII_USERFCN)" 
!ENDIF
