...
static NXString createPathName       = "Create Path";
static NXString subdivideSegmentName = "Subdivide Segment";
static NXString modularConnectorName = "Modular Connector";
