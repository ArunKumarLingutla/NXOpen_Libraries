...
namespace NXOpen
{
    namespace Routing
    {
        ...
        class Callbacks
        {
            ...
            //------------------------------------------------------------------------------------------
            // Called whenever a stock component is created.
            //
            // \param[in]
            //      objects
            //          Contains the stock component or components that were just created (Assemblies::Component).
            public: void StockComponentCreatedCallback
            (
                StlNXObjectVector objects
            );
        };
