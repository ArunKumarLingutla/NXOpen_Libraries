...
#ifndef BlockAndCylinderUI_H_INCLUDED
#define BlockAndCylinderUI_H_INCLUDED
...
class DllExport BlockAndCylinderUI
{
    // class members
public:
    ...
    // of these prototypes is provided in the BlockAndCylinderUI.cpp file. 
    ...
    NXOpen::Expression* blockXC;
    NXOpen::Expression* blockYC;
    NXOpen::Expression* blockZC;

    //Cylinder Data
    NXOpen::Point* cylQriginPoint;
    NXOpen::Expression* cylHeight;
    NXOpen::Vector3d* cylVector;
...
private:
    ...
    NXOpen::BlockStyler::ExpressionBlock* expression03;// Block type: Expression
    NXOpen::BlockStyler::ExpressionBlock* expression04;// Block type: Expression
    NXOpen::BlockStyler::SpecifyVector* vector0;// Block type: Specify Vector

    //Cache Data
    double blockXCCache;
    bool   blockXCCached = false;
    double blockYCCache;
    bool   blockYCCached = false;
    double blockZCCache;
    bool   blockZCCached = false;

    double cylHeightCache;
    bool   cylHeightCached = false;
    double cylRadiusCache;
    bool   cylRadiusCached = false;
};
#endif //BlockAndCylinderUI_H_INCLUDED
