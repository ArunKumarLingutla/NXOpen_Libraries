...
SAMPLE FILES:
    ...
    Routing_Example_Bundle_Plugin.py
    Routing_Example_Cableway_GetSetGUIDs.py
    Routing_Example_Cableway_ImportDataset.py
    Routing_Example_Cableway_Plugins.py
    Routing_Example_Callbacks.py
    Routing_Example_DesignRules.py
    Routing_Example_Plugins.py
    Routing_Example_Run_Plugins.py
    Routing_Example_Spool_Plugins.py
    Routing_MaximumHeight_DesignRule.py

The above listed files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/Python/Routing.
...
The python script (e.g. the .py file) must be placed in one of the following locations:
...
applications. The following steps show how to execute the Create Path Design Rule in the DesignRules.py
file.
