...
public class CreateFillet
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        try
        {
            ...
            nxopen.Tag partData = ufPart.newPart("CreateFillet", 2);
            if(partData == null)
            {
                theSession.listingWindow().writeLine("null Tag");
            }
            ...
            arcCoords1.matrixTag = nxopen.Tag.NULL;
            ...
            arcCoords2.matrixTag = nxopen.Tag.NULL;
            ...
            nxopen.Tag line1,line2,arc1,arc2;
            nxopen.Tag[] curveObjs= new nxopen.Tag[3];
            nxopen.Tag fillet_obj1,fillet_obj2;

            
            /* create a line */
            nxopen.Tag lineData1 = ufCurve.createLine(lineCoords1);

            /* create 2 arcs */
            nxopen.Tag wcsData = theUFSession.csys().askWcs();
            nxopen.Tag matrixData = theUFSession.csys().askMatrixOfObject(wcsData);
            arcCoords1.matrixTag = matrixData;
            arcCoords2.matrixTag = matrixData;

            nxopen.Tag arcData1 = ufCurve.createArc(arcCoords1);
            nxopen.Tag arcData2 = ufCurve.createArc(arcCoords2);

            /*create fillet between "arc1" and "line1"*/
            curveObjs[0] = arcData1;
            curveObjs[1] = lineData1;
            curveObjs[2] = nxopen.Tag.NULL;
            center[0] = 0.0;
            center[1] = 2.1;
            center[2] = 0.0;
            radius = .25;
            ...
            nxopen.Tag filletData1 = ufCurve.createFillet(UF_CURVE_2_CURVE,curveObjs,
            ...
            nxopen.Tag filletDat2 = ufCurve.createFillet(UF_CURVE_2_CURVE,curveObjs,
            center, radius, trimOpts, arcOpts);
