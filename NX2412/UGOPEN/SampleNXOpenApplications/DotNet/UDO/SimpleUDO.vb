...
Module Module1
    ...
    Public Function myDisplayCB(ByVal displayEvent As UserDefinedObjects.UserDefinedDisplayEvent) As Integer
        ...
        Catch ex As NXException
            ...
            theSession.LogFile.WriteLine("Caught Exception in myDisplayCB: '" & ex.Message() & "'" & vbCrLf)
        End Try
    ...
    Public Function initUDO(ByVal alertUser As Boolean) As Integer
        ...
        Catch ex As NXException
            ...
            If theUFSession Is Nothing Then
                theUFSession = NXOpen.UF.UFSession.GetUFSession()
            End If
            theSession.LogFile.WriteLine("Caught Exception in initUDO: '" & ex.Message() & "'" & vbCrLf)
            Throw ex
        End Try
        initUDO = 0
    End Function
