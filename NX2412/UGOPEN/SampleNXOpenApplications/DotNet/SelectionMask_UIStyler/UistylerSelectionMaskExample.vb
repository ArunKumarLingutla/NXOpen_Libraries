...
#End If ' DISPLAY_FROM_CALLBACK
    ...
    Public Function LayerSettingInformationCallback(ByVal eventObject As NXOpen.UIStyler.StylerEvent) As NXOpen.UIStyler.DialogState
        Try
            ...
            theSession.listingWindow().writeLine("================================================================" & vbCrLf)
            theSession.listingWindow().writeLine("               ***** MOVE TO LAYER EXAMPLE *****                " & vbCrLf)
            theSession.listingWindow().writeLine("================================================================" & vbCrLf)
            theSession.listingWindow().writeLine("Sl.no.   Layer category     Layer   No of Objects" & vbCrLf)
            ...
            For Each categorylist As Layer.Category In layercategoryarray
                ...
                Else
                    ...
                    theSession.listingWindow().writeLine(counter & "." & vbTab & vbTab & listcategoryinfo.name & vbCrLf)
                    ...
                    For Each layer As Integer In memberlayers
                        ...
                        theSession.listingWindow().writeLine(vbTab & vbTab & vbTab & vbTab & vbTab & layer.ToString & vbTab)
                        theSession.listingWindow().writeLine(vbTab & noofobjectsonlayer.Length & vbCrLf)
                    Next
                    counter = counter + 1
                End If
            Next
