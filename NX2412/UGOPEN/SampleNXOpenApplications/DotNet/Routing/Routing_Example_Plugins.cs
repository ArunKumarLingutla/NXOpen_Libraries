...
namespace Routing
{
    public class Plugins
    {
        ...
        static NXOpen.Routing.CustomManager customManager = null;
        static NXOpen.RoutingCommon.CustomManager rsdCustomManager = null;
        ...
        private static void RegisterPlugins()
        {
            ...
            customManager.SetApplicationEnterPlugin( ApplicationEnterPlugin );
            customManager.SetApplicationExitPlugin( ApplicationExitPlugin );
            ...
            rsdCustomManager.SetWiringComponentNamePlugin( StockComponentNamePlugin );
        ...
        (
            NXOpen.Routing.CustomManager.NavigatorType navigatorType,
        ...
        public static void StockComponentNamePlugin
        (
        ...
        )
        {
            ...
            string stockName = "StockComponent_" + stockNumberCounter.ToString( "D4" );
            string homeFolder = "";

            UFSession ufSession = UFSession.GetUFSession();
            bool isManagedMode = false;
            ufSession.UF.IsUgmanagerActive( out isManagedMode );
            if (isManagedMode)
            {
        ...
        public static void ApplicationEnterPlugin
        (
            NXOpen.Routing.CustomManager.Application application
        )
        {
            String message = "Entering the Mechanical application";
            if (application == NXOpen.Routing.CustomManager.Application.Electrical)
        ...
        public static void ApplicationExitPlugin
        (
            NXOpen.Routing.CustomManager.Application application
        )
        {
            String message = "Exiting the Mechanical application";
            if (application == NXOpen.Routing.CustomManager.Application.Electrical)
