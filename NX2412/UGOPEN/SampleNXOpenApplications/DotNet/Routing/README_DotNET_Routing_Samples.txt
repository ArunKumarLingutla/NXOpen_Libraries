...
SAMPLE FILES:
    ...
    C#
    Routing_Example_Bundle_Plugin.cs
    Routing_Example_Cableway_DesignRules.cs
    Routing_Example_Cableway_GetSetGUIDs.cs
    Routing_Example_Cableway_ImportDataset.cs
    Routing_Example_Cableway_Plugins.cs
    Routing_Example_Callbacks.cs
    Routing_Example_DesignRules.cs
    Routing_Example_Plugins.cs
    Routing_MaximumHeight_DesignRule.cs
    Routing_Example_Spool_Plugins.cs
    
    Visual Basic
    Routing_Example_Bundle_Plugin.vb
    Routing_Example_Cableway_DesignRules.vb
    Routing_Example_Cableway_GetSetGUIDs.vb
    Routing_Example_Cableway_ImportDataset.vb
    Routing_Example_Cableway_Plugins.vb
    Routing_Example_Callbacks.vb
    Routing_Example_DesignRules.vb
    Routing_Example_Plugins.vb
    Routing_MaximumHeight_DesignRule.vb
	
The above listed files are located at $UGII_BASE_DIR/ugopen/SampleNXOpenApplications/DotNET/Routing.

Each of these files is a self-contained sample and does not require any other file.
...
The output file built (e.g. .dll) must be placed in one of the following locations:
...
applications. The following steps show how to execute the Create Path Design Rule in the DesignRules.cs
file.
