...
#define UF_CUTTER_SUBTYPE_MILL_DOVETAIL     7
#define UF_CUTTER_SUBTYPE_MILL_FRONT_BACK_CHAMFER 8
...
#define UF_CUTTER_SUBTYPE_DRILL_BACK_BORE   17
...
#define UF_CUTTER_SUBTYPE_TURN_PRIME        4
...
#define UF_CUTTER_SUBTYPE_THREAD_TRIANGULAR_STD 5
#define UF_CUTTER_SUBTYPE_THREAD_TRIANGULAR_TRAP 6

/*** Subtypes valid for type UF_CUTTER_TYPE_SOLID ****/
#define UF_CUTTER_SUBTYPE_GENERIC           0
#define UF_CUTTER_SUBTYPE_PROBE             1
#define UF_CUTTER_SUBTYPE_HARDENING_LASER   2
#define UF_CUTTER_SUBTYPE_STAMPING          3

/*** Subtypes valid for type UF_CUTTER_TYPE_SOFT ****/
#define UF_CUTTER_SUBTYPE_STD_LASER         0
#define UF_CUTTER_SUBTYPE_COAXIAL_LASER     1
#define UF_CUTTER_SUBTYPE_SCANNING_LASER    2
#define UF_CUTTER_SUBTYPE_LASER             UF_CUTTER_SUBTYPE_STD_LASER

/*** Subtypes valid for type UF_CUTTER_TYPE_BARREL ****/
#define UF_CUTTER_SUBTYPE_STANDARD_BARREL   0
#define UF_CUTTER_SUBTYPE_TANGENT_BARREL    1
#define UF_CUTTER_SUBTYPE_TAPER_BARREL      2
#define UF_CUTTER_SUBTYPE_LENS_BARREL       3
...
#define UF_TURN_INSERTTYPE_PRIME_A     18 /* User defined       */
#define UF_TURN_INSERTTYPE_PRIME_B     19 /* User defined       */
...
#define UF_TURN_INSERTTYPE_THREAD_TRIANGULAR_STANDARD    2 /* Triangular standard threading tool */
#define UF_TURN_INSERTTYPE_THREAD_TRIANGULAR_TRAPEZOIDAL 3 /* Triangular trapezoidal threading tool */
