...
// NX ellipse objects.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") OPENPPEXPORT UgEllipse : public UgConicObject,
                                    public Ellipse
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") static UgEllipse *create
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") const Matrix3 getMatrix ( ) const;

        // Edit the major radius of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") void setMajorRadius
        (
            double           major_radius   // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") void setMinorRadius
        (
            double           minor_radius   // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") void setStartAngle
        (
            double           start_angle    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") void setEndAngle
        (
            double           end_angle      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") void setCenterPoint
        (
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") UgEllipse *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") UgEllipse *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") const std::vector < UgEllipse * > askAllOccurrences ( ) const;
    ...
    public:
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") const Curve *askCurve ( ) const;
