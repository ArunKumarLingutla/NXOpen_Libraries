...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") VMATHPPEXPORT Vector3
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector3 operator+
        (
        ...
        // vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") Vector3 &operator+=
        (
            const Vector3 &vec3         // The second vector in the operation
                                        // ( Vector3 += Vector3 ).
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Point3 operator+
        (
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector3 operator- ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector3 cross
        (
            const Vector3 &vec3         // <I>
        ...
        // a magnitude of ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector3 askUnit
        (
        ...
        // the vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Point3 asPoint3 ( ) const;
        ...
        // of the 3D vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector2 asVector2 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector3 askPerpendicular ( ) const;
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") VMATHPPEXPORT const Vector3 operator*
(
    double          scale,           // The scale factor
