...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Features::UserDefinedObjectFeature.") OPENPPEXPORT UgUDOFeature : public UgFeatureObject {
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Features::UserDefinedObjectFeature.") void logForUpdate ( ) const;
