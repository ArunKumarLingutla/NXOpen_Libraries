...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") OPENPPEXPORT Ellipse : public Conic
{

    public:

        // Return the major radius of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") double getMajorRadius ( ) const;

        // Return the minor radius of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") double getMinorRadius ( ) const;

        // Return the start angle ( in radians ) of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") double getStartAngle ( ) const;

        // Return the end angle ( in radians ) of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Ellipse.") double getEndAngle ( ) const;
