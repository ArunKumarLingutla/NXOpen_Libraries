...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") VMATHPPEXPORT Vector2
{

    public:

        // Construct a vector with coordinates ( 0.0, 0.0 )
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") Vector2 ( );
        ...
        // Destruct a vector
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") virtual ~Vector2 ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") double &operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const double &operator[]
        (
            VectorMathCoordType index   // The specific vector coordinate to
                                        // return.  Valid values are: X or Y.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector2 operator+
        (
        ...
        // vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") Vector2 &operator+=
        (
            const Vector2 &vector       // The second vector in the operation
                                        // ( Vector2 += Vector2 ).
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Point2 operator+
        (
        ...
        // the new vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector2 operator- ( ) const;
        
        // Return the dot product of two vectors.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") double dot
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") double cross
        (
            const Vector2 &vector       // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") double askMagnitude ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") bool isEqual
        ( 
            const Vector2  &vector,     // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") bool operator==
        ( 
        ...
        // a magnitude of ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector2 askUnit
        (
        ...
        // the vector.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Point2 asPoint2 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector3 asVector3 ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") void asArray
        (
            double array [ 2 ]          // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") double askAngle
        (
            const Vector2 &vector,      // <I>
        ...
        // ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") bool isParallel
        (
            const Vector2 &vector,      // <I>
        ...
        // ( 0.0 ).
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") bool isPerpendicular
        (
            const Vector2 &vector,      // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector2 askPerpendicular ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") bool askComponents
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const Vector2 rotate
        (
            double ang              // <I>
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") VMATHPPEXPORT const Vector2 operator*
(
    double          scale,           // The scale factor
