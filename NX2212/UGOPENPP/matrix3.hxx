...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") VMATHPPEXPORT Matrix3 {
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") enum OneVectorInput
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") enum TwoVectorInput
        {
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") explicit Matrix3
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") const Vector3 operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") const Matrix3 operator*
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") Matrix3& operator*=
        (
            const Matrix3 &matrix       // The second matrix in the operation
                                        // ( Matrix3 =* Matrix3 ).
        );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") bool isEqual
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") bool operator==
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") void askRollPitchYaw
        (
            double *roll,               // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") const Matrix3 transpose ( ) const;
        
        // Convert the matrix to a 9 element double array
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") void asArray
        (
            double array [ 9 ]          // <O>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Matrix3x3.") double askDeterminant ( ) const;
