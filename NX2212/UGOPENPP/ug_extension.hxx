...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") OPENPPEXPORT UgExtensionObject : public virtual UgObject
{
 
    public:

        // Return a persistent integer from the extending UDO of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") int getInt
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") double getDouble
        (
            unsigned int offset         // <I>
                                        // The offset of the requested value.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") const std::string getString
        (
            unsigned int offset         // <I>
                                        // The offset of the requested value.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") double getLength
        (
            unsigned int offset         // <I>
                                        // The offset of the requested value.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") double getArea
        (
            unsigned int offset         // <I>
                                        // The offset of the requested value.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") double getVolume
        (
            unsigned int offset         // <I>
                                        // The offset of the requested value.
        ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") UgTypedObject *getLink
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setInt
        (
            unsigned int offset,        // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setDouble
        (
            unsigned int offset,        // <I>
                                        // The offset of the new value.  If the offset
                                        // is less than or equal to the number of
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setString
        (
            unsigned int       offset,  // <I>
                                        // The offset of the new value.  If the offset
                                        // is less than or equal to the number of
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setLength
        (
            unsigned int     offset,    // <I>
                                        // The offset of the new value.  If the offset
                                        // is less than or equal to the number of
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setArea
        (
            unsigned int     offset,    // <I>
                                        // The offset of the new value.  If the offset
                                        // is less than or equal to the number of
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setVolume
        (
            unsigned int     offset,    // <I>
                                        // The offset of the new value.  If the offset
                                        // is less than or equal to the number of
        ...
        // object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") void setLink
        (
            unsigned int          link_type,    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") virtual void infoObject ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") virtual void memberDeletion
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BlockStyler::PropertyList.") virtual void update
        (
