...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") VMATHPPEXPORT Point4
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") double &operator[]
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") const double &operator[]
        (
            VectorMathCoordType index   // The specific point coordinate to
                                        // return.  Valid values are: X, Y, Z,
                                        // or W.
        ...
        // tolerance.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") bool isEqual
        ( 
        ...
        // tolerance.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") bool operator==
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") const Point3 asPoint3 ( ) const;
        ...
        // point.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Point4d.") void asArray
        (
            double array [ 4 ]          // <O>
