...
template < class Leaf >         // The UgIterator class allows for the cycling
                                ...
                                // be cycled.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BodyCollection::iterator.") UgIterator
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BodyCollection::iterator.") UgIterator
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BodyCollection::iterator.") void findNext ( );

        // Return a pointer to the current object of class Leaf in the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BodyCollection::iterator.") Leaf *operator* ( ) const;

        // Determine if the invoking object has completed iterating over all objects of
        // class Leaf.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BodyCollection::iterator.") bool isFinished ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::BodyCollection::iterator.") void reinitialize
        (
            const UgObject *part_or_object = UgSession::getWorkPart ( )
                                            // <I>
                                            // This argument defines the part to
