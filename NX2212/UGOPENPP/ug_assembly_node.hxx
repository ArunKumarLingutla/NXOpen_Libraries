...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") OPENPPEXPORT UgAssemblyNode : public UgDisplayableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") void askData
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") const std::string getReferenceSetName ( ) const;

        // Return the related name of the invoking UgAssemblyNode object. 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") const std::string getRelatedName ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") const CoordSys getCoordSys ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") double askScale ( ) const;

        // Edit the name of the reference set used by the invoking UgAssemblyNode object
        // and all its related UgAssemblyNode objects.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") void setReferenceSetName
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") void setRelatedName
        (
        ...
        // related UgAssemblyNode objects.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") void setCoordSys
        (
        ...
        // current session.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") UgAssemblyNode *substitute
        (
        ...
        // objects.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") void remove ( );
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") const std::vector < UgAssemblyNode * > askChildren ( ) const ;

        // Return a std::vector object that contains all of the UgAssemblyNode objects that
        // are related to the invoking UgAssemblyNode object.  The returned std::vector
        // object will always include the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") const std::vector < UgAssemblyNode * > askRelated ( ) const;

        // Return the UgPart object that was added to when the invoking UgAssemblyNode
        // object was created.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") UgPart *askRelatedOwningPart ( ) const;
        ...
        // returned.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") UgPart *askPart ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") const std::string askPartName ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") void ensurePartLoaded
        (
             PartLoadStatus *status = 0  // <O>
                                         // Returned object that specifies the names and
                                         // error codes of the part files that failed to 
        ...
        // object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") int askOccurrenceCount ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") UgDisplayableObject *iterateFirst ( ) const;
        ...
        // return 0.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::CreateNewComponentBuilder.") UgDisplayableObject *iterateNext
        (
