...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") CLASS_DECL_CYCLE Cycle {
   
    public:

        // Construct a Cycle object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") Cycle ( );

        // Destroy a Cycle object
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") ~Cycle ( );

        // Prints the part report to the info window.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") static void askPartReport
        ( 
            const UgPart *part  // <I>
