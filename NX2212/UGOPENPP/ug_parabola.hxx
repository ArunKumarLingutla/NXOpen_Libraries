...
// NX parabola objects.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") OPENPPEXPORT UgParabola : public UgConicObject,
                                     public Parabola
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") static UgParabola *create
        ( 
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") void setFocalLength
        (
            double           focal_length   // <I>
        ...
        // not an occurrence
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") UgParabola *askPrototype ( ) const;
        ...
        // not be found.
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") UgParabola *askOccurrence
        (
        ...
        // 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Hyperbola.") const std::vector < UgParabola * > askAllOccurrences ( ) const;
