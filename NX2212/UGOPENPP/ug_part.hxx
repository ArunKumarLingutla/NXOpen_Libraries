...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") OPENPPEXPORT UgPart : public virtual UgObject,
                            public UgAttributableObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") bool isMillimeters ( ) const;

        // Return true if the default unit of the invoking UgPart object is
        // inches.  Return false otherwise.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") bool isInches ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") UgPart *askOwningPart ( ) const;

        // Return the full file name of the invoking UgPart object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") const std::string getFullName ( ) const;
 
        // Return the customer definable area of the invoking UgPart object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") const std::string getCustomerArea ( ) const;

        // Return the customer definable description of the invoking UgPart object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") const std::string getDescription ( ) const;

        // Return the customer definable status of the invoking UgPart object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") int getStatus ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") UgTypedObject *iterateFirst ( ) const;
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") UgTypedObject *iterateNext
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void setFullName
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void setCustomerArea
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void setDescription
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void setStatus
        (
            int status  // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") static UgPart *create
        (
            const std::string &file_name,    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") static UgPart *open
        (
            const std::string &file_name,    // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void close
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void save ( );

        // Save the invoking UgPart object to the disk, giving it a new file name. 
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") void saveAs
        (
            const std::string &file_name   // <I>
                                           // The new file name ( on disk ) for
                                           // the NX part.
        ...
        // its owner.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") UgAssemblyNode *addPart
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") const std::vector < UgAssemblyNode * > askAllAssemblyNodes
        (
            const UgPart *part // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") UgAssemblyNode *askAssemblyNode
        (
            const std::string &related_name   // <I> 
        ...
        // same.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Part.") bool isDescendant
        (
