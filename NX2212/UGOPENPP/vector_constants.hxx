...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const double    Pi                      = 3.14159265358979324;

//  The constant that represents the value ( 2.0 * Pi )
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const double    TwoPi                   = 2.0 * Pi;
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") const double    VectorMathZeroTolerance = 1.0e-10;

//  This function converts a measure in radians and returns
//  the corresponding measure in degrees.
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") inline double convertRadiansToDegrees
(
    double radians          // <I>
                            // The radian measure
);
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") inline double convertDegreesToRadians
(
    double degrees          // <I>
                            // The degree measure
);
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") enum VectorMathCoordType
{
...
UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") inline double convertRadiansToDegrees ( double radians )
{
    return ( ( radians * 180.0 ) / Pi );
}

UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Vector3d.") inline double convertDegreesToRadians ( double degrees )
{
