...
// NX reference sets.
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") OPENPPEXPORT UgReferenceSet : public UgTypedObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") static UgReferenceSet *create
        (
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") void addMembers
        (
            const std::vector < UgDisplayableObject * > &members // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") const std::vector < UgDisplayableObject * >  askMembers ( ) const;


        // Remove members from the invoking UgReferenceSet object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") void removeMembers
        (
            const std::vector < UgDisplayableObject * > &members  // <I>
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") const CoordSys getCoordSys ( ) const;

        // Edit the orientation of the invoking UgReferenceSet object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::ReferenceSet.") void setCoordSys
        (
            const CoordSys &orientation // <I>
