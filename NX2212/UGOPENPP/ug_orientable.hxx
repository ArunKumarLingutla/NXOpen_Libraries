...
class UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::Component.") OPENPPEXPORT UgOrientableObject : public virtual UgObject
{
    ...
    public:
        ...
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::Component.") virtual const Matrix3 getMatrix ( ) const;

        // Edit the orientation matrix of the invoking object.
        UGOPENCPP_DEPRECATED("Replacement functionality exists in NXOpen API. Consider replacing usage with NXOpen::Assemblies::Component.") virtual void setMatrix
        (
