...
Public Class OrthoLines2
    ...
    Private thinDashedButton As NXOpen.BlockStyler.Button' Block type: Button
    Private thickSolidButton As NXOpen.BlockStyler.Button' Block type: Button
...
#Region "Block Styler Dialog Designer generator code"
    ...
    Public Sub New()
        Try
            ...
            theUI = UI.GetUI()
            theDlxFileName = "OrthoLines2.dlx"
...
#End Region
    ...
    Public Shared Sub Main()
        Dim theOrthoLines2 As OrthoLines2 = Nothing
        Try
        
            theOrthoLines2 = New OrthoLines2()
            ' The following method shows the dialog immediately
            theOrthoLines2.Launch()
        ...
        Finally
            If theOrthoLines2 IsNot Nothing Then 
                theOrthoLines2.Dispose()
                theOrthoLines2 = Nothing
            End If
        End Try
    End Sub
    '------------------------------------------------------------------------------
    ...
    Public Sub initialize_cb()
        Try
            ...
            thinDashedButton = CType(theDialog.TopBlock.FindBlock("thinDashedButton"), NXOpen.BlockStyler.Button)
            thickSolidButton = CType(theDialog.TopBlock.FindBlock("thickSolidButton"), NXOpen.BlockStyler.Button)
    ...
    Public Function update_cb(ByVal block As NXOpen.BlockStyler.UIBlock) As Integer
        Try
            ...
            ElseIf block Is thinDashedButton Then
            '---- Enter your code here -----
                myLine = CreateLine()
            ...
            ElseIf block Is thickSolidButton Then
            '---- Enter your code here -----
                myLine = CreateLine()
    ...
    Private Function CreateLine() As NXOpen.Line
