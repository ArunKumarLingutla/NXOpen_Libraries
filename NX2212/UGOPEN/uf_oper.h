...
/*******************************************************************************
 This function returns in 'oper_id' the oper of the specified 'oper_tag'.

Environment: Internal  and  External

See Also:

History: Originally released in NX2206
*******************************************************************************/
extern UFUN_CAMEXPORT int UF_OPER_ask_oper_from_tag
(
    tag_t         oper_tag, /* <I> Operation Tag */
    UF_OPER_id_t* oper_id   /* <O> Operation Identifier */
);
