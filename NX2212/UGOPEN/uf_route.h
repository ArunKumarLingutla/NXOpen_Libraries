...
The following functions have been retired and replaced with newer NX Open classes and methods:
    ...
    UF_ROUTE_ask_stock_diameter                 Routing::CrossSection::GetMaximumRadius
    UF_ROUTE_ask_object_stock                   Routing::StockPort::GetStock, Routing::ISegment::GetSegmentStock
