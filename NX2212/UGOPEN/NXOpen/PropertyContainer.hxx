#ifndef NXOpen_PROPERTYCONTAINER_HXX_INCLUDED
#define NXOpen_PROPERTYCONTAINER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    /** Represents a list of properties. The properties can be accessed and modified, but no 
            new property can be added to existing list. Refer to @link NXOpen::DataContainer NXOpen::DataContainer@endlink 
            which allows to add new property to the list.
           
     <br>  Created in NX7.5.0.  <br>  
    */
    class NXOPENCPPEXPORT  PropertyContainer : public NXOpen::TransientObject
    {
        ...
        public: enum PropertyType
        {
            ...
            PropertyTypeTaggedObjectMatrix2d/**Tagged Object 2d-Matrix. Currently unused and would be removed in later releases. Please do not use this member.*/,
        ...
        private: PropertyContainerImpl * m_propertycontainer_impl;
        /// \cond NX_NO_DOC 
        public: explicit PropertyContainer(void *ptr);
        /// \endcond 
        ...
        public: virtual ~PropertyContainer();
        /**Returns  the mode of the list 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::PropertyContainer::ListMode Mode
        (
        );
        ...
        /** Returns the property type for given property name  @return Property type. 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::PropertyContainer::PropertyType GetPropertyType
        (
        ...
        /** Returns the property type for given property name  @return Property type. 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        NXOpen::PropertyContainer::PropertyType GetPropertyType
        (
        ...
        /**Gets the value for the given property name. Exception will be raised if invalid property name is used.  @return Value to get for given property name. 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::PropertyContainer * GetArray
        (
            const NXString & propertyName /**Name of the property */
        );
        /**Gets the value for the given property name. Exception will be raised if invalid property name is used.  @return Value to get for given property name. 
         <br>  Created in NX7.5.0.  <br>  
         <br> License requirements : None */
        NXOpen::PropertyContainer * GetArray
        (
            const char * propertyName /**Name of the property */
        );
        /**Gets the value for the given index. Exception will be raised if invalid index is used.  @return Value to get for given index. 
