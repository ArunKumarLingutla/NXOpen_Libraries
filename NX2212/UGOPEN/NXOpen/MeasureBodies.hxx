...
namespace NXOpen
{
    ...
    /** Represents the measurement specific mass properties for a set of bodies  <br> To create or edit an instance of this class, use @link NXOpen::MeasureBodyBuilder  NXOpen::MeasureBodyBuilder @endlink  <br> 
