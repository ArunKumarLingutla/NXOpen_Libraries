#ifndef NXOpen_CAE_XYPLOT_COLORMAPPLOT_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_COLORMAPPLOT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            class _ColorMapPlotBuilder;
            class ColorMapPlotImpl;
            /**  @brief 
            ...
            */
            class NXOPENCPP_CAEEXPORT  ColorMapPlot : public NXOpen::CAE::Xyplot::Plot, public virtual NXOpen::CAE::Xyplot::I3DDataPlot
            {
                private: ColorMapPlotImpl * m_colormapplot_impl;
                private: friend class  _ColorMapPlotBuilder;
                protected: ColorMapPlot();
                public: ~ColorMapPlot();
