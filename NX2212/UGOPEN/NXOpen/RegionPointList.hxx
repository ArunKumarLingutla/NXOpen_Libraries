#ifndef NXOpen_REGIONPOINTLIST_HXX_INCLUDED
#define NXOpen_REGIONPOINTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  RegionPointList : public NXOpen::TaggedObject
    {
        private: RegionPointListImpl * m_regionpointlist_impl;
        private: friend class  _RegionPointListBuilder;
        protected: RegionPointList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::RegionPoint *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::RegionPoint * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::RegionPoint * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::RegionPoint *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::RegionPoint *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::RegionPoint * object1 /** first item */,
            NXOpen::RegionPoint * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::RegionPoint * object /** object to be inserted */
        );
