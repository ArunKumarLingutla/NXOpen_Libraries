            ...
            */
            class NXOPENCPP_CAEEXPORT  GraphOptionsStyle2D : public NXOpen::CAE::Xyplot::BaseDisplayStyleSetting
            {
                ...
                /**Returns  a value specifies the frequency band summation band type mode 
                 ...
                 <br> License requirements : None */
                public: NXOpen::CAE::Xyplot::FrequencyBandSummationBandTypeMode FrequencyBandSummationBandTypeMode
                (
                );
                /**Sets  a value specifies the frequency band summation band type mode 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetFrequencyBandSummationBandTypeMode
                (
                    NXOpen::CAE::Xyplot::FrequencyBandSummationBandTypeMode freqBandSummationBandTypeMode /** freqbandsummationbandtypemode */ 
                );
                ...
                /**Returns  a value specifies the frequency band summation display mode 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::CAE::Xyplot::FrequencyBandSummationDisplayMode FrequencyBandSummationDisplayMode
                (
                );
                /**Sets  a value specifies the frequency band summation display mode 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetFrequencyBandSummationDisplayMode
                (
                    NXOpen::CAE::Xyplot::FrequencyBandSummationDisplayMode freqBandSummationDisplayMode /** freqbandsummationdisplaymode */ 
                );
