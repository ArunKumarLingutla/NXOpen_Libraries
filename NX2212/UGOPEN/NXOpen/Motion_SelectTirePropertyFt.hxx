#ifndef NXOpen_MOTION_SELECTTIREPROPERTYFT_HXX_INCLUDED
#define NXOpen_MOTION_SELECTTIREPROPERTYFT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Motion_SelectTirePropertyFt.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectTirePropertyFtBuilder;
        class SelectTirePropertyFtImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectTirePropertyFt : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectTirePropertyFtImpl * m_selecttirepropertyft_impl;
            private: friend class  _SelectTirePropertyFtBuilder;
            protected: SelectTirePropertyFt();
            public: ~SelectTirePropertyFt();
            ...
            (
                NXOpen::Motion::TirePropertyFt * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::TirePropertyFt * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::TirePropertyFt * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::TirePropertyFt * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::TirePropertyFt * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
