    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  MoveObjectBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the homogeneous transform matrix to be pre multiplied to the motion transforms in Commit method.
                        This function can be used if delta transforms between this transform and transforms specified by motion transforms is to be applied.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetPreMultiplicationTransform
            (
                const NXOpen::Matrix4x4 & preMultiplicationTransform /** premultiplicationtransform */ 
            );
            /**Returns  the homogeneous transform matrix to be pre multiplied to the motion transforms in Commit method.
                        This function can be used if delta transforms between this transform and transforms specified by motion transforms is to be applied.
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Matrix4x4 PreMultiplicationTransform
            (
            );
        };
    }
