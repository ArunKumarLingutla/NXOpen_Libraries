        ...
        */
        class NXOPENCPP_SIMEXPORT  KinematicJunctionBuilder : public NXOpen::Builder
        {
            ...
            public: enum SystemClass
            {
                ...
                SystemClassRobotBase/** the robot base junction */,
                SystemClassRobotFlange/** the robot flange junction */,
                SystemClassPositionerBase/** the positioner base junction */,
                SystemClassPositionerTool/** the positioner tool junction */
            };
