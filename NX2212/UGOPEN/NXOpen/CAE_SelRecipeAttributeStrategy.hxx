        ...
        */
        class NXOPENCPP_CAEEXPORT  SelRecipeAttributeStrategy : public NXOpen::CAE::SelRecipeStrategy
        {
            ...
            /**Returns  the name attribute. 
             <br>  @deprecated Deprecated in NX1872.0.0.  Use overloaded@link CAE::SelRecipeAttributeStrategy::GetNameAttribute CAE::SelRecipeAttributeStrategy::GetNameAttribute@endlink  that returns multiple strings instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use overloadedCAE::SelRecipeAttributeStrategy::GetNameAttribute that returns multiple strings instead.") NXString NameAttribute
            (
            );
            ...
            /** Sets or adds the name attribute. 
             <br>  @deprecated Deprecated in NX1872.0.0.  Use overloaded@link CAE::SelRecipeAttributeStrategy::SetNameAttribute CAE::SelRecipeAttributeStrategy::SetNameAttribute@endlink  that sets multiple strings instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use overloadedCAE::SelRecipeAttributeStrategy::SetNameAttribute that sets multiple strings instead.") void SetNameAttribute
            (
            ...
            /** Convenience method to set multiple attributes at once. The name and color are optional.
             ...
             <br>  @deprecated Deprecated in NX1872.0.0.  Use overloaded@link CAE::SelRecipeAttributeStrategy::SetUserAttributes CAE::SelRecipeAttributeStrategy::SetUserAttributes@endlink  that sets multiple name attribute values instead. <br>  

             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use overloadedCAE::SelRecipeAttributeStrategy::SetUserAttributes that sets multiple name attribute values instead.") void SetUserAttributes
            (
            ...
            (
                bool setNameAttribute /** setnameattribute */ ,
                std::vector<NXString> & nameAttribute /** nameattribute */ ,
                bool setColorAttribute /** setcolorattribute */ ,
                int colorAttribute /** colorattribute */ ,
                const std::vector<NXOpen::NXObject::AttributeInformation> & lowValueAttributes /** lowvalueattributes */ ,
                const std::vector<NXOpen::NXObject::AttributeInformation> & highValueAttributes /** highvalueattributes */ 
