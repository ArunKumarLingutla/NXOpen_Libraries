        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  GeneralViewPreferences: public virtual NXOpen::Preferences::IGeneralViewPreferences
        {
            ...
            /**Sets  the snapshot toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Preferences::GeneralViewPreferences::SetLockmethodView NXOpen::Preferences::GeneralViewPreferences::SetLockmethodView@endlink  instead(the value is NXOpen.Preferences.GeneralViewPreferences.GeneralViewLockmethodOptionSnapshot). <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Preferences::GeneralViewPreferences::SetLockmethodView instead(the value is NXOpen.Preferences.GeneralViewPreferences.GeneralViewLockmethodOptionSnapshot).") void SetSnapshotView
            (
            ...
            (
                NXOpen::Preferences::GeneralViewLockmethodOption lockmethodView /** Sets a lockmethod option on the general sub-builder */
            );
            ...
            /**Returns  the status of horizontal framebar. If true it automatically creates 
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Preferences::FrameBarPreferences::Horizontal Preferences::FrameBarPreferences::Horizontal@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Preferences::FrameBarPreferences::Horizontal instead.") bool FramebarHorizontal
            (
            );
            /**Sets  the status of horizontal framebar. If true it automatically creates 
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Preferences::FrameBarPreferences::SetHorizontal Preferences::FrameBarPreferences::SetHorizontal@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Preferences::FrameBarPreferences::SetHorizontal instead.") void SetFramebarHorizontal
            (
            ...
            /**Returns  the status of vertical framebar. If true it automatically creates 
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Preferences::FrameBarPreferences::Vertical Preferences::FrameBarPreferences::Vertical@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Preferences::FrameBarPreferences::Vertical instead.") bool FramebarVertical
            (
            );
            /**Sets  the status of vertical framebar. If true it automatically creates 
             ...
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Preferences::FrameBarPreferences::SetVertical Preferences::FrameBarPreferences::SetVertical@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Preferences::FrameBarPreferences::SetVertical instead.") void SetFramebarVertical
            (
            ...
            */
            public: NXOpen::Preferences::FrameBarPreferences *FrameBar();
