        ...
        */
        class NXOPENCPP_FACETEXPORT  CleanupFacetBodyBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the tolerance value use to detect the faults in facet body and fix the same.
             ...
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Please use CleanupFacetBodyBuilder::ToleranceFactor instead CleanupFacetBodyBuilder::DistanceTolerance") double DistanceTolerance
            (
            );
            /**Sets  the tolerance value use to detect the faults in facet body and fix the same.
             ...
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Please use CleanupFacetBodyBuilder::ToleranceFactor instead CleanupFacetBodyBuilder::DistanceTolerance") void SetDistanceTolerance
            (
            ...
            /**Sets  the tolerance factor use to detect the faults in facet body and fix the same 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetToleranceFactor
            (
                double tolFactor /** tolfactor */ 
            );
        };
    }
}
