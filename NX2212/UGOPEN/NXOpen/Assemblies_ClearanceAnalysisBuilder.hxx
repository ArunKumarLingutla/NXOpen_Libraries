    ...
    namespace Assemblies
    {
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ClearanceAnalysisBuilder : public NXOpen::Builder
        {
            ...
            /** This for future use */
            public: enum ClearanceComputation
            {
                ClearanceComputationLocal/** local */ ,
                ClearanceComputationDistributed/** distributed */ 
            };
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXOpen::Assemblies::ClearanceAnalysisBuilder::ClearanceComputation ClearanceComputationType
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetClearanceComputationType
            (
                NXOpen::Assemblies::ClearanceAnalysisBuilder::ClearanceComputation clearanceComputation /** clearancecomputation */ 
            );
