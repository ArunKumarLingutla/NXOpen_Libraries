#ifndef NXOpen_SELECTIPARAMETERIZEDSURFACELIST_HXX_INCLUDED
#define NXOpen_SELECTIPARAMETERIZEDSURFACELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     SelectIParameterizedSurfaceList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    class View;
    class _SelectIParameterizedSurfaceListBuilder;
    class SelectIParameterizedSurfaceListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectIParameterizedSurfaceList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectIParameterizedSurfaceListImpl * m_selectiparameterizedsurfacelist_impl;
        private: friend class  _SelectIParameterizedSurfaceListBuilder;
        protected: SelectIParameterizedSurfaceList();
        public: ~SelectIParameterizedSurfaceList();
        ...
        public: bool Add
        (
            NXOpen::IParameterizedSurface * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::IParameterizedSurface *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::IParameterizedSurface * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::IParameterizedSurface * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::IParameterizedSurface * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::IParameterizedSurface * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::IParameterizedSurface *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::IParameterizedSurface * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::IParameterizedSurface *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::IParameterizedSurface *> GetArray
        (
        );
