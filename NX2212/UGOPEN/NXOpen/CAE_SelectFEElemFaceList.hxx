#ifndef NXOpen_CAE_SELECTFEELEMFACELIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTFEELEMFACELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectFEElemFaceListBuilder;
        class SelectFEElemFaceListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SelectFEElemFaceList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectFEElemFaceListImpl * m_selectfeelemfacelist_impl;
            private: friend class  _SelectFEElemFaceListBuilder;
            protected: SelectFEElemFaceList();
            public: ~SelectFEElemFaceList();
            ...
            public: bool Add
            (
                NXOpen::CAE::FEElemFace * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::FEElemFace *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAE::FEElemFace * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAE::FEElemFace * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::CAE::FEElemFace * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::CAE::FEElemFace * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::CAE::FEElemFace *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::FEElemFace * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::FEElemFace *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::FEElemFace *> GetArray
            (
            );
