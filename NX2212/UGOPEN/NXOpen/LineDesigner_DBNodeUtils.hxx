#ifndef NXOpen_LINEDESIGNER_DBNODEUTILS_HXX_INCLUDED
#define NXOpen_LINEDESIGNER_DBNODEUTILS_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace LineDesigner
    {
        ...
        */
        class LINEDESIGNEROPENCPPEXPORT  DBNodeUtils
        {
            private: DBNodeUtilsImpl * m_dbnodeutils_impl;
            private: NXOpen::Session* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit DBNodeUtils(NXOpen::Session *owner);
            ...
            tag_t Tag() const; 
            private: static DBNodeUtils* theDBNodeUtils;
