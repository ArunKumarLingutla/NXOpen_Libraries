#ifndef NXOpen_ANNOTATIONS_LEADERDATALIST_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_LEADERDATALIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _LeaderDataListBuilder;
        class LeaderDataListImpl;
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LeaderDataList : public NXOpen::TaggedObject
        {
            private: LeaderDataListImpl * m_leaderdatalist_impl;
            private: friend class  _LeaderDataListBuilder;
            protected: LeaderDataList();
            public: ~LeaderDataList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Annotations::LeaderData *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Annotations::LeaderData * object /** item to append */
            );
            ...
            (
                NXOpen::Annotations::LeaderData * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::LeaderData * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Annotations::LeaderData * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::LeaderData *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Annotations::LeaderData *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Annotations::LeaderData * object1 /** first item */,
                NXOpen::Annotations::LeaderData * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Annotations::LeaderData * object /** object to be inserted */
            );
