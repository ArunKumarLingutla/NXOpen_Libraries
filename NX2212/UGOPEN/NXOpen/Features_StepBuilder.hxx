...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        BoundaryOffsetDim1.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        BoundaryOffsetDim2.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        ChamferMethod </term> <description> 
         
        RuledFace </description> </item> 

        <item><term> 
         
        ChangeWallThickness </term> <description> 
        ...
        OffsetFace </description> </item> 

        <item><term> 
         
        KeepWallThickness </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        RefObjectType1 </term> <description> 
         
        Edge </description> </item> 

        <item><term> 
         
        RefObjectType2 </term> <description> 
         
        Edge </description> </item> 

        <item><term> 
         
        ReverseDepthDirection </term> <description> 
         
        True </description> </item> 

        <item><term> 
         
        SpecifiedWallThicknessDim.Value </term> <description> 
         
        5 (millimeters part), 0.25 (inches part) </description> </item> 

        <item><term> 
         
        StepBlendRadiusDim1.Value </term> <description> 
         
        1 (millimeters part), 0.1 (inches part) </description> </item> 

        <item><term> 
         
        StepBlendRadiusDim2.Value </term> <description> 
         
        1 (millimeters part), 0.1 (inches part) </description> </item> 

        <item><term> 
         
        StepDepthDim.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        StepFaceMethod1 </term> <description> 
         
        Normal </description> </item> 

        <item><term> 
         
        StepFaceMethod2 </term> <description> 
         
        Normal </description> </item> 

        <item><term> 
         
        StepLocation </term> <description> 
         
        End </description> </item> 

        <item><term> 
         
        StepNewType (deprecated) </term> <description> 
         
        Thick </description> </item> 

        <item><term> 
         
        StepRampDim1.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        StepRampDim2.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        StepType </term> <description> 
         
        End </description> </item> 

        <item><term> 
         
        StepWallBlendRadiusDim1.Value </term> <description> 
         
        1 (millimeters part), 0.1 (inches part) </description> </item> 

        <item><term> 
         
        StepWallBlendRadiusDim2.Value </term> <description> 
         
        1 (millimeters part), 0.1 (inches part) </description> </item> 

        <item><term> 
         
        StepWallMethod1 </term> <description> 
         
        Normal </description> </item> 

        <item><term> 
         
        StepWallMethod2 </term> <description> 
         
        Normal </description> </item> 

        <item><term> 
         
        StepWallRampDim1.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        StepWallRampDim2.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        StepWallThickDim1.Value </term> <description> 
         
        10 (millimeters part), 0.5 (inches part) </description> </item> 

        <item><term> 
         
        StepWallThickDim2.Value </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StepBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum StepNewTypes
            {
                StepNewTypesThick/** Adds a step to thick a face.*/,
                StepNewTypesThin/** Adds a step to thin a face.*/,
                StepNewTypesJog/** Adds a step to thin a belt face and wall face.*/,
                StepNewTypesChamfer/** Adds a step at the edge of a face similar to a chamfer*/
            };

            /** Represents the step location */
            public: enum StepLocations
            {
                StepLocationsEnd/** Step is located on one side of a face.*/,
                StepLocationsMiddle/** Step is located on middle of two boudary curves*/
            };
            ...
            public: enum ReferenceBoundaryTypes
            {
                ...
                ReferenceBoundaryTypesShareFirst/** share first */ 
            };
            ...
            public: enum StepFaceMethods
            {
                ...
                StepFaceMethodsBlend/**Blends the step face with offset to the tangent edge of the blend*/,
                StepFaceMethodsCliffBlend/**Blends the step face with offset to the cliff edge of the blend*/
            };
            ...
            public: enum StepWallMethods
            {
                ...
                StepWallMethodsBlend/**Blends the step-wall face with offset to the tangent edge of the blend*/,
                StepWallMethodsCliffBlend/**Blends the step-wall face with offset to the cliff edge of the blend*/,
            ...
            public: enum ChamferMethods
            {
                ChamferMethodsRuledFace/**Chamfer with a ruled face*/,
                ChamferMethodsVariableOffsetFace/**Chamfer with a variable offset face*/
            };
            ...
            /**Returns  the step new type 
             <br>  @deprecated Deprecated in NX12.0.1.  This functionality is no longer supported. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  This functionality is no longer supported.") NXOpen::Features::StepBuilder::StepNewTypes StepNewType
            (
            );
            /**Sets  the step new type 
             <br>  @deprecated Deprecated in NX12.0.1.  This functionality is no longer supported. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_aero_design (" NX Aero Design") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  This functionality is no longer supported.") void SetStepNewType
            (
                NXOpen::Features::StepBuilder::StepNewTypes stepNewType /** stepnewtype */ 
            );
            /**Returns  the step flat type 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::StepBuilder::StepNewTypes Type
            (
            );
            /**Sets  the step flat type 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_aero_design (" NX Aero Design") */
            public: void SetType
            (
                NXOpen::Features::StepBuilder::StepNewTypes type /** type */ 
            );
            ...
            /**Returns  the step location 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_aero_design (" NX Aero Design") */
            public: NXOpen::Features::StepBuilder::StepLocations StepLocation
            (
            );
            /**Sets  the step location 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_aero_design (" NX Aero Design") */
            public: void SetStepLocation
            (
                NXOpen::Features::StepBuilder::StepLocations stepLocation /** steplocation */ 
            );
            ...
            /**Returns  the chamfer methods 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::StepBuilder::ChamferMethods ChamferMethod
            (
            );
            /**Sets  the chamfer methods 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_aero_design (" NX Aero Design") */
            public: void SetChamferMethod
            (
                NXOpen::Features::StepBuilder::ChamferMethods chamferMethod /** chamfermethod */ 
            );
