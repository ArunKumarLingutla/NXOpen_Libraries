    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  Laminate : public NXOpen::CAE::PhysicalPropertyTable
        {
            ...
            /** Output laminate stiffness matrices to an info window 
                        Corresponds to the "list stiffness matrices" button in the Validation section of the Laminate Modeler dialog.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void StiffnessMatrices
            (
                bool detailed /** detailed */ 
            );
            /** Output laminate compliance matrices to an info window 
                        Corresponds to the "list compliance matrices" button in the Validation section of the Laminate Modeler dialog.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void ComplianceMatrices
            (
                bool detailed /** detailed */ 
            );
            /** Output laminate equivalent properties to an info window 
                        Corresponds to the "list equivalent properties" button in the Validation section of the Laminate Modeler dialog.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void EquivalentProperties
            (
                bool detailed /** detailed */ 
            );
