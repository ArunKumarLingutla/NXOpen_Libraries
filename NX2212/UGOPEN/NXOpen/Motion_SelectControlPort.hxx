#ifndef NXOpen_MOTION_SELECTCONTROLPORT_HXX_INCLUDED
#define NXOpen_MOTION_SELECTCONTROLPORT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectControlPortBuilder;
        class SelectControlPortImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectControlPort : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectControlPortImpl * m_selectcontrolport_impl;
            private: friend class  _SelectControlPortBuilder;
            protected: SelectControlPort();
            public: ~SelectControlPort();
            ...
            (
                NXOpen::Motion::ControlPort * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ControlPort * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::ControlPort * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::ControlPort * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::ControlPort * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
