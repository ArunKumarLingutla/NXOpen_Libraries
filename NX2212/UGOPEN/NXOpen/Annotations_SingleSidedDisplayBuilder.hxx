    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SingleSidedDisplayBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the disable automatically display as single sided 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisableAutoSingleSided
            (
            );
            /**Sets  the disable automatically display as single sided 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetDisableAutoSingleSided
            (
                bool disableAutoSingleSided /** disableautosinglesided */ 
            );
