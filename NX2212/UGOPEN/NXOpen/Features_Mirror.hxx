...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class MirrorImpl;
        /** Represents a mirror feature. Inputs to this feature can be convergent objects.  <br> To create or edit an instance of this class, use @link NXOpen::Features::MirrorBuilder  NXOpen::Features::MirrorBuilder @endlink  <br> 
