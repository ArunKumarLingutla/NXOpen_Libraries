        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DraftingNoteBuilder : public NXOpen::Builder
        {
            ...
            /**Sets  the vertical text for text 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") OR cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") OR nx_2d_edit (" NX 2D Edit") */
            ...
            /**Returns  the text alignment 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") OR cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") OR nx_2d_edit (" NX 2D Edit") */
