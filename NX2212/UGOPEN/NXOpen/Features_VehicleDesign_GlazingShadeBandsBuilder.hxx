...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            ViewHeight (deprecated) </term> <description> 
             
            0 </description> </item> 

            <item><term> 
             
            ViewHeightExp.Value </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  GlazingShadeBandsBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**Returns  the value of the rear view height. 
                 <br>  @deprecated Deprecated in NX2212.0.0.  Use @link JA_GLAZING_SHADE_BANDS_BUILDER_get_ViewHeightExp JA_GLAZING_SHADE_BANDS_BUILDER_get_ViewHeightExp@endlink  instead. <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use JA_GLAZING_SHADE_BANDS_BUILDER_get_ViewHeightExp instead.") double ViewHeight
                (
                );
                /**Sets  the value of the rear view height. 
                 ...
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: NX_DEPRECATED("Deprecated in NX2212.0.0.  This functionality is no longer supported.") void SetViewHeight
                (
                    double viewHeight /** viewheight */ 
                );
                /**Returns  the expression of the rear view height. 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * ViewHeightExp
                (
                );
            };
        }
