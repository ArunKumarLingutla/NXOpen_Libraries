...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace VehicleDesign
        {
            ...
            HeadAndLegImpact </description> </item> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  PedestrianProtectionBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                /**Returns  the type of impact study to perform 
                 <br>  @deprecated Deprecated in NX2212.5000.0.  Use @link JA_PEDESTRIAN_PROTECTION_BUILDER_get_analysis_type JA_PEDESTRIAN_PROTECTION_BUILDER_get_analysis_type@endlink  instead. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2212.5000.0.  Use JA_PEDESTRIAN_PROTECTION_BUILDER_get_analysis_type instead.") NXOpen::Features::VehicleDesign::PedestrianProtectionBuilder::Types Type
                (
                );
                /**Sets  the type of impact study to perform 
                 <br>  @deprecated Deprecated in NX2212.5000.0.  Use @link JA_PEDESTRIAN_PROTECTION_BUILDER_set_analysis_type JA_PEDESTRIAN_PROTECTION_BUILDER_set_analysis_type@endlink  instead. <br>  

                 <br>  Created in NX6.0.0.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: NX_DEPRECATED("Deprecated in NX2212.5000.0.  Use JA_PEDESTRIAN_PROTECTION_BUILDER_set_analysis_type instead.") void SetType
                (
