#ifndef NXOpen_CONTACTLESSINSPECTION_SELECTPOINTMEASUREMENT_HXX_INCLUDED
#define NXOpen_CONTACTLESSINSPECTION_SELECTPOINTMEASUREMENT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     ContactlessInspection_SelectPointMeasurement.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace ContactlessInspection
    {
        class _SelectPointMeasurementBuilder;
        class SelectPointMeasurementImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class CONTACTLESSINSPECTIONOPENCPPEXPORT  SelectPointMeasurement : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectPointMeasurementImpl * m_selectpointmeasurement_impl;
            private: friend class  _SelectPointMeasurementBuilder;
            protected: SelectPointMeasurement();
            public: ~SelectPointMeasurement();
            ...
            (
                NXOpen::ContactlessInspection::PointMeasurement * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ContactlessInspection::PointMeasurement * Value
            (
            );
            ...
            (
                ...
                NXOpen::ContactlessInspection::PointMeasurement * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::ContactlessInspection::PointMeasurement * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::ContactlessInspection::PointMeasurement * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
