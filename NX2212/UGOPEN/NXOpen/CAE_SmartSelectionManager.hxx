    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SmartSelectionManager
        {
            ...
            /** Creates a filter body method 
             <br>  @deprecated Deprecated in NX2212.3000.0.  Use @link NXOpen::CAE::SmartSelectionManager::CreateFilterBodyMethodWithExpression NXOpen::CAE::SmartSelectionManager::CreateFilterBodyMethodWithExpression@endlink  instead. <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2212.3000.0.  Use NXOpen::CAE::SmartSelectionManager::CreateFilterBodyMethodWithExpression instead.") NXOpen::CAE::FilterBodyMethod * CreateFilterBodyMethod
            (
                const std::vector<NXOpen::CAE::CAEBody *> & seeds /** seed bodies*/,
                NXOpen::PhysicalMaterial * material /** material*/,
                bool filterbyVolume /** filter by volume */,
