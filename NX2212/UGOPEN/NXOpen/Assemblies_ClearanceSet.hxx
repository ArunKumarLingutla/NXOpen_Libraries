        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ClearanceSet : public NXOpen::NXObject
        {
            ...
            /** Deletes the excluded pair along with all data associated with it. Both objects
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void DeleteExcludedPair
            (
                NXOpen::DisplayableObject * object1 /** The first object in the pair */,
                NXOpen::DisplayableObject * object2 /** The second object in the pair */,
                bool markOutOfDate /** Whether to mark the dataset and other pairs containing either objects as out-of-date */
            );
            /** Inquires the text string associated with the excluded pair. Both objects
                    ...
                    refer to an existing excluded pair, an error is returned.  @return  The text associated with the excluded pair 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: NXString GetExcludedPairText
            (
                NXOpen::DisplayableObject * object1 /** The first object in the pair */,
                NXOpen::DisplayableObject * object2 /** The second object in the pair */
            );
            /** Associates a text string to an excluded pair. Both objects must be
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetExcludedPairText
            (
                NXOpen::DisplayableObject * object1 /** The first object in the pair */,
                NXOpen::DisplayableObject * object2 /** The second object in the pair */,
                const NXString & text /** The name of the new dataset */
            ...
            /** Marks the set of excluded pairs up-to-date if they are out-of-date. 
             ...
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void MarkExcludedPairsUpToDate
            (
                const std::vector<NXOpen::DisplayableObject *> & firstObjects /** The first object of each interference. Must be the same size as secondObjects. */,
                const std::vector<NXOpen::DisplayableObject *> & secondObjects /** The second object of each interference. Must be the same size as firstObjects. */
            );
