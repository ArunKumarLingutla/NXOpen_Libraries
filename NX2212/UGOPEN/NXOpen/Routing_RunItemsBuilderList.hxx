#ifndef NXOpen_ROUTING_RUNITEMSBUILDERLIST_HXX_INCLUDED
#define NXOpen_ROUTING_RUNITEMSBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Routing_RunItemsBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        class _RunItemsBuilderListBuilder;
        class RunItemsBuilderListImpl;
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RunItemsBuilderList : public NXOpen::TaggedObject
        {
            private: RunItemsBuilderListImpl * m_runitemsbuilderlist_impl;
            private: friend class  _RunItemsBuilderListBuilder;
            protected: RunItemsBuilderList();
            public: ~RunItemsBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Routing::RunItemsBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Routing::RunItemsBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Routing::RunItemsBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Routing::RunItemsBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Routing::RunItemsBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Routing::RunItemsBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Routing::RunItemsBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Routing::RunItemsBuilder * object1 /** first item */,
                NXOpen::Routing::RunItemsBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Routing::RunItemsBuilder * object /** object to be inserted */
            );
