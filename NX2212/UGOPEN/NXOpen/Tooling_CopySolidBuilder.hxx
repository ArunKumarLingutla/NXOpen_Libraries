    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CopySolidBuilder : public NXOpen::Builder
        {
            ...
            public: enum PartItemUpdateType
            {
            ...
            /** Sets the value of the attribute associated with the template name.
            ...
            /** Clears all part items of clone object.
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void ClearPartItems
            (
            );
            /** Sets whether the parent part is read from the template.
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetIsDefinedParent
            (
                bool isDefinedParent /** isdefinedparent */ 
            );
            /** Updates created part items.
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void UpdateClonePartItems
            (
                NXOpen::Tooling::CopySolidBuilder::PartItemUpdateType updateType /** updatetype */ 
            );
        };
    }
}
