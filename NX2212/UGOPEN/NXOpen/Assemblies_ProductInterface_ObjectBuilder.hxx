...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        namespace ProductInterface
        {
            ...
            */
            class NXOPENCPP_ASSEMBLIESEXPORT  ObjectBuilder : public NXOpen::Builder
            {
                ...
                public: enum BuilderVersion
                {
                    ...
                    BuilderVersionTwo/** product interface builder supports composite curve, composite face and body collector options */,
                    BuilderVersionThree/** Enables product interface types but used along with the 'Enable Product Interface Type' customer default */
                };
                ...
                (
                    ...
                    const NXString & name /** User defined name of selected object */,
                    const NXString & description /** User comments of selected object */,
                ...
                (
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const char * name /** User defined name of selected object */,
                    const char * description /** User comments of selected object */,
                    bool reverseDirection /** Flag to specify whether to reverse the direction of the source object */
                );
                /** Adds an object to the product interface; currently supported types are expressions and geometry. Interface Usage type can be set using this API.   @return  the product interface object created 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Assemblies::ProductInterface::InterfaceObject * AddProductInterfaceObject2
                (
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const NXString & name /** User defined name of selected object */,
                    const NXString & description /** User comments of selected object */,
                    bool reverseDirection /** Flag to specify whether to reverse the direction of the source object */,
                    NXOpen::Assemblies::ProductInterface::InterfaceObject::InterfaceUsageType interfaceUsageType /** Usage type of product interface object */
                );
                /** Adds an object to the product interface; currently supported types are expressions and geometry. Interface Usage type can be set using this API.   @return  the product interface object created 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                NXOpen::Assemblies::ProductInterface::InterfaceObject * AddProductInterfaceObject2
                (
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const char * name /** User defined name of selected object */,
                    const char * description /** User comments of selected object */,
                ...
                /** Adds an object to the product interface; currently supported types are expressions and geometry. Interface Usage type can be set and Group PI object can created using this API.  @return  the product interface object created 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Assemblies::ProductInterface::InterfaceObject * AddProductInterfaceObject3
                (
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const NXString & name /** User defined name of selected object */,
                    const NXString & description /** User comments of selected object */,
                    bool reverseDirection /** Flag to specify whether to reverse the direction of the source object */,
                    NXOpen::Assemblies::ProductInterface::InterfaceObject::InterfaceUsageType interfaceUsageType /** Usage type of product interface object */,
                    bool isGroupAsPIObject /**  whether to create Group PI object or use it in body collector. */
                );
                /** Adds an object to the product interface; currently supported types are expressions and geometry. Interface Usage type can be set and Group PI object can created using this API.  @return  the product interface object created 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                NXOpen::Assemblies::ProductInterface::InterfaceObject * AddProductInterfaceObject3
                (
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const char * name /** User defined name of selected object */,
                    const char * description /** User comments of selected object */,
                ...
                /** Edits a product interface object with interface object type . Interface Usage type can be set using this API. 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: void EditProductInterfaceObject1
                (
                    NXOpen::Assemblies::ProductInterface::InterfaceObject * productInterface /** Product interface object to be edited */,
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const NXString & name /** User defined name of selected object */,
                ...
                /** Edits a product interface object with interface object type . Interface Usage type can be set using this API. 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                void EditProductInterfaceObject1
                (
                    NXOpen::Assemblies::ProductInterface::InterfaceObject * productInterface /** Product interface object to be edited */,
                    NXOpen::NXObject * nxObject /** Selected object to add */,
                    const char * name /** User defined name of selected object */,
                ...
                (
                    ...
                    const NXString & userComments /** user comments to be set on specified product interface item */
                );
                /** Sets the user comments on the product interface item passed in  
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                ...
                (
                    NXOpen::Assemblies::ProductInterface::InterfaceObject * prodIntItem /** product interface item on which the user comments have to set */,
                    const char * userComments /** user comments to be set on specified product interface item */
                );
