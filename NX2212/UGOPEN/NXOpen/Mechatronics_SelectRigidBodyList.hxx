#ifndef NXOpen_MECHATRONICS_SELECTRIGIDBODYLIST_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTRIGIDBODYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectRigidBodyList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectRigidBodyListBuilder;
        class SelectRigidBodyListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectRigidBodyList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectRigidBodyListImpl * m_selectrigidbodylist_impl;
            private: friend class  _SelectRigidBodyListBuilder;
            protected: SelectRigidBodyList();
            public: ~SelectRigidBodyList();
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::RigidBody * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Mechatronics::RigidBody *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::RigidBody * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Mechatronics::RigidBody * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Mechatronics::RigidBody * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Mechatronics::RigidBody * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Mechatronics::RigidBody *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Mechatronics::RigidBody * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Mechatronics::RigidBody *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::RigidBody *> GetArray
            (
            );
