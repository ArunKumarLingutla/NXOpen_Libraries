...
namespace NXOpen
{
    ...
    class SketchHelpedDimensionalConstraintImpl;
    /** Represents a dimensional sketch constraint that has a help point or help parameter  <br>   <br> 
     <br>  Created in NX3.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SketchHelpedDimensionalConstraint : public NXOpen::SketchDimensionalConstraint, public virtual NXOpen::ISketchHelpedConstraint
    {
        private: SketchHelpedDimensionalConstraintImpl * m_sketchhelpeddimensionalconstraint_impl;
        private: friend class  _SketchHelpedDimensionalConstraintBuilder;
        protected: SketchHelpedDimensionalConstraint();
        public: ~SketchHelpedDimensionalConstraint();
