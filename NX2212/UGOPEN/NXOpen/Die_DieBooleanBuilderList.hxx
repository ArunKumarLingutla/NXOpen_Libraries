#ifndef NXOpen_DIE_DIEBOOLEANBUILDERLIST_HXX_INCLUDED
#define NXOpen_DIE_DIEBOOLEANBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Die
    {
        class _DieBooleanBuilderListBuilder;
        class DieBooleanBuilderListImpl;
        ...
        */
        class NXOPENCPP_DIEEXPORT  DieBooleanBuilderList : public NXOpen::TaggedObject
        {
            private: DieBooleanBuilderListImpl * m_diebooleanbuilderlist_impl;
            private: friend class  _DieBooleanBuilderListBuilder;
            protected: DieBooleanBuilderList();
            public: ~DieBooleanBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Die::DieBooleanBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Die::DieBooleanBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Die::DieBooleanBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Die::DieBooleanBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Die::DieBooleanBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Die::DieBooleanBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Die::DieBooleanBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Die::DieBooleanBuilder * object1 /** first item */,
                NXOpen::Die::DieBooleanBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Die::DieBooleanBuilder * object /** object to be inserted */
            );
