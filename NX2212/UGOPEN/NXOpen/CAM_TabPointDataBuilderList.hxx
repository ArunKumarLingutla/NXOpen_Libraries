#ifndef NXOpen_CAM_TABPOINTDATABUILDERLIST_HXX_INCLUDED
#define NXOpen_CAM_TABPOINTDATABUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     CAM_TabPointDataBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _TabPointDataBuilderListBuilder;
        class TabPointDataBuilderListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  TabPointDataBuilderList : public NXOpen::TaggedObject
        {
            private: TabPointDataBuilderListImpl * m_tabpointdatabuilderlist_impl;
            private: friend class  _TabPointDataBuilderListBuilder;
            protected: TabPointDataBuilderList();
            public: ~TabPointDataBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::TabPointDataBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::TabPointDataBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::TabPointDataBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::TabPointDataBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::TabPointDataBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::TabPointDataBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::TabPointDataBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::TabPointDataBuilder * object1 /** first item */,
                NXOpen::CAM::TabPointDataBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::TabPointDataBuilder * object /** object to be inserted */
            );
