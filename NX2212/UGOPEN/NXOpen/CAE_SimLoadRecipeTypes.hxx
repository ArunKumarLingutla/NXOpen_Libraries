    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadRecipeTypes
        {
            ...
            {
                MappingTypesUserDefined/** User Defined */,
                MappingTypesFileBased/** File Based */
            };

            /** This enum defines the Target Type options */
            public: enum TargetTypes
            {
                TargetTypesFiniteElementModel/** Applies loads on Finite Element Model entities (nodes, elements, etc) */,
                TargetTypesModeSet/** Applies Participation Factors on Modal Representation */
            };
