#ifndef NXOpen_SELECTCARTESIANCOORDINATESYSTEM_HXX_INCLUDED
#define NXOpen_SELECTCARTESIANCOORDINATESYSTEM_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     SelectCartesianCoordinateSystem.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    class View;
    class _SelectCartesianCoordinateSystemBuilder;
    class SelectCartesianCoordinateSystemImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectCartesianCoordinateSystem : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectCartesianCoordinateSystemImpl * m_selectcartesiancoordinatesystem_impl;
        private: friend class  _SelectCartesianCoordinateSystemBuilder;
        protected: SelectCartesianCoordinateSystem();
        public: ~SelectCartesianCoordinateSystem();
        ...
        (
            NXOpen::CartesianCoordinateSystem * selection /** selected object */
        );
        /**Returns  the object being selected
            
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::CartesianCoordinateSystem * Value
        (
        );
        ...
        (
            ...
            NXOpen::CartesianCoordinateSystem * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /** first selected object point*/,
            NXOpen::CartesianCoordinateSystem * selection2 /** second selected object */,
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::CartesianCoordinateSystem * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
