#ifndef NXOpen_FEATURES_STRUCTUREDESIGN_SELECTCORNER_HXX_INCLUDED
#define NXOpen_FEATURES_STRUCTUREDESIGN_SELECTCORNER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Features_StructureDesign_SelectCorner.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace StructureDesign
        {
            class _SelectCornerBuilder;
            class SelectCornerImpl;
            /** Represents a single object selection.

             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  SelectCorner : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                private: SelectCornerImpl * m_selectcorner_impl;
                private: friend class  _SelectCornerBuilder;
                protected: SelectCorner();
                public: ~SelectCorner();
                ...
                /**Returns  the object being selected
                 ...
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::StructureDesign::Corner * Value
                (
                );
                ...
                /** The object being selected with CAE set object information.
                 ...
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Features::StructureDesign::Corner * GetValue
                (
                    NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                    int* caeSubId /** CAE set object sub id*/
                );
