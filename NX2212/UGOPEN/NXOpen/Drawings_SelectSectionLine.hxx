#ifndef NXOpen_DRAWINGS_SELECTSECTIONLINE_HXX_INCLUDED
#define NXOpen_DRAWINGS_SELECTSECTIONLINE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class _SelectSectionLineBuilder;
        class SelectSectionLineImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  SelectSectionLine : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSectionLineImpl * m_selectsectionline_impl;
            private: friend class  _SelectSectionLineBuilder;
            protected: SelectSectionLine();
            public: ~SelectSectionLine();
            ...
            (
                NXOpen::Drawings::SectionLine * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::SectionLine * Value
            (
            );
            ...
            (
                ...
                NXOpen::Drawings::SectionLine * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Drawings::SectionLine * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Drawings::SectionLine * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
