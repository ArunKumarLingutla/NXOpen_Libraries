#ifndef NXOpen_CAE_SELECTMESHLIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTMESHLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectMeshListBuilder;
        class SelectMeshListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SelectMeshList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectMeshListImpl * m_selectmeshlist_impl;
            private: friend class  _SelectMeshListBuilder;
            protected: SelectMeshList();
            public: ~SelectMeshList();
            ...
            public: bool Add
            (
                NXOpen::CAE::Mesh * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::Mesh *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAE::Mesh * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAE::Mesh * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                const std::vector<NXOpen::CAE::Mesh *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::Mesh * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::Mesh *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::Mesh *> GetArray
            (
            );
