...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        RodsPerVertex (deprecated) </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ConnectLattices2Builder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the number of rods per vertex created by connecting.
             <br>  @deprecated Deprecated in NX2007.0.0.  For pre NX2007 usage only. Use @link NXOpen::Features::ConnectLattices2Builder::RodsPerVertexExpression NXOpen::Features::ConnectLattices2Builder::RodsPerVertexExpression@endlink  instead. <br>  

             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  For pre NX2007 usage only. Use NXOpen::Features::ConnectLattices2Builder::RodsPerVertexExpression instead.") int RodsPerVertex
            (
            );
            ...
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  For pre NX2007 usage only. Use NXOpen::Features::ConnectLattices2Builder::RodsPerVertexExpression instead.") void SetRodsPerVertex
            (
                int numRods /** numrods */ 
            );
