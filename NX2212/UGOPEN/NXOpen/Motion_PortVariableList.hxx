#ifndef NXOpen_MOTION_PORTVARIABLELIST_HXX_INCLUDED
#define NXOpen_MOTION_PORTVARIABLELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _PortVariableListBuilder;
        class PortVariableListImpl;
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  PortVariableList : public NXOpen::TaggedObject
        {
            private: PortVariableListImpl * m_portvariablelist_impl;
            private: friend class  _PortVariableListBuilder;
            protected: PortVariableList();
            public: ~PortVariableList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Motion::PortVariable *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Motion::PortVariable * object /** item to append */
            );
            ...
            (
                NXOpen::Motion::PortVariable * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::PortVariable * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Motion::PortVariable * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Motion::PortVariable *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Motion::PortVariable *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Motion::PortVariable * object1 /** first item */,
                NXOpen::Motion::PortVariable * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Motion::PortVariable * object /** object to be inserted */
            );
