    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ParamBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the target pocket 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::NCGroup * TargetPocket
            (
            );
            /**Sets  the target pocket 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetTargetPocket
            (
                NXOpen::CAM::NCGroup * targetPocket /** the tag of the target pocket */
            );
        };
    }
}
