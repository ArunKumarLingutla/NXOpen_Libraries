#ifndef NXOpen_FEATURES_SUBDIVISION_SELECTSUBDIVISIONBODYLIST_HXX_INCLUDED
#define NXOpen_FEATURES_SUBDIVISION_SELECTSUBDIVISIONBODYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Features_Subdivision_SelectSubdivisionBodyList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace Subdivision
        {
            class _SelectSubdivisionBodyListBuilder;
            class SelectSubdivisionBodyListImpl;
            /** Represents a list of objects on a selection list.

             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  SelectSubdivisionBodyList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                private: SelectSubdivisionBodyListImpl * m_selectsubdivisionbodylist_impl;
                private: friend class  _SelectSubdivisionBodyListBuilder;
                protected: SelectSubdivisionBodyList();
                public: ~SelectSubdivisionBodyList();
                ...
                public: bool Add
                (
                    NXOpen::Features::Subdivision::SubdivisionBody * object /** object to add */
                );
                ...
                public: bool Add
                (
                    const std::vector<NXOpen::Features::Subdivision::SubdivisionBody *> & objects /** objects to add */
                );
                ...
                public: bool Add
                (
                    NXOpen::Features::Subdivision::SubdivisionBody * selection /** selected object */,
                ...
                public: bool Remove
                (
                    NXOpen::Features::Subdivision::SubdivisionBody * object /** Object to remove */
                );
                /** Remove specified object from list.
                     @return  True if successfully removed from list;
                ...
                (
                    ...
                    NXOpen::Features::Subdivision::SubdivisionBody * selection1 /** first selected object */,
                    NXOpen::View * view1 /** first selected object view*/,
                    const NXOpen::Point3d & point1 /**first  selected object point*/,
                    NXOpen::Features::Subdivision::SubdivisionBody * selection2 /** second selected object */,
                ...
                (
                    const std::vector<NXOpen::Features::Subdivision::SubdivisionBody *> & objects /** Objects to remove */
                );
                ...
                (
                    NXOpen::Features::Subdivision::SubdivisionBody * object /** object to check */
                );
                ...
                (
                    const std::vector<NXOpen::Features::Subdivision::SubdivisionBody *> & objects /** items to put in the list*/
                );
                /** Returns the list of objects in the selection list.
                     @return  items in list 
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::Features::Subdivision::SubdivisionBody *> GetArray
                (
                );
