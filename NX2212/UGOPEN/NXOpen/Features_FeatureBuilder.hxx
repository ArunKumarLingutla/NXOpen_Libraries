        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureBuilder : public NXOpen::Builder
        {
            ...
            /** Commits the feature parameters and creates the feature  @return  
             <br>  Created in NX3.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") OR cam_base ("CAM BASE") OR geometric_tol ("GDT") OR insp_programming ("INSPECTION PROGRAMMING") OR studio_free_form ("STUDIO FREE FORM") */
