...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        AngleNoseIgnorableSize </term> <description> 
         
        0.5 </description> </item> 

        <item><term> 
         
        FaceTranslucency </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        HighlightSelectedFace </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        HoleTypeEnum </term> <description> 
         
        ThroughHoles </description> </item> 

        <item><term> 
         
        IsAutoSelectHoleByType </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        IsShowFaceWithSameColorAttributeToggle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        IsShowFaceWithoutColorAttributeToggle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        OnlyCheckHoleFace </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        SelectSubHoleFaceAutomatically </term> <description> 
