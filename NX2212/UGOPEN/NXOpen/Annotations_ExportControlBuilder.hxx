...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a @link NXOpen::Annotations::ExportControl NXOpen::Annotations::ExportControl@endlink  builder  <br> To create a new instance of this class, use @link NXOpen::Annotations::PmiAttributeCollection::CreateExportControlBuilder  NXOpen::Annotations::PmiAttributeCollection::CreateExportControlBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  ExportControlBuilder : public NXOpen::Annotations::PmiAttributeBuilder
        {
