    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  DatumTargetBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the draw x 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link NXOpen::Annotations::DatumTargetBuilder::TerminatorType NXOpen::Annotations::DatumTargetBuilder::TerminatorType@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::Annotations::DatumTargetBuilder::TerminatorType instead.") bool DrawX
            (
            );
            /**Sets  the draw x 
             <br>  @deprecated Deprecated in NX10.0.0.  Use @link NXOpen::Annotations::DatumTargetBuilder::SetTerminatorType NXOpen::Annotations::DatumTargetBuilder::SetTerminatorType@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") OR geometric_tol ("GDT") */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use NXOpen::Annotations::DatumTargetBuilder::SetTerminatorType instead.") void SetDrawX
            (
                bool flag /** flag */ 
            );
