        ...
        namespace Xyplot
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  DataExporter
            {
                ...
                /** Exports calculation legends which contain evaluation fucntion results to output files or listing window. 
                            
                             Exports to listing window if output is not specified in @link NXOpen::CAE::FTK::ExportFilesParameter NXOpen::CAE::FTK::ExportFilesParameter@endlink .
                            
                            
                 <br>  Created in NX2306.0.0.  <br>  
                 <br> License requirements : None */
                public: void ExportCalculationLegendsToFiles
                (
                    NXOpen::CAE::FTK::ExportFilesParameter * exportFilesParam /** exportfilesparam */ ,
                    const std::vector<NXOpen::CAE::Xyplot::LegendTable *> & calculationlegendTableModels /** calculationlegendtablemodels */ 
                );
