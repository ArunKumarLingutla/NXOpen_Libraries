#ifndef NXOpen_VSA_TAPEREDPINPATTERNFEATUREBUILDER_HXX_INCLUDED
#define NXOpen_VSA_TAPEREDPINPATTERNFEATUREBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Vsa_TaperedPinPatternFeatureBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Vsa
    {
        class _TaperedPinPatternFeatureBuilderBuilder;
        class TaperedPinPatternFeatureBuilderImpl;
        /**
        ...
        */
        class NXOPENCPP_VSAEXPORT  TaperedPinPatternFeatureBuilder : public NXOpen::Builder
        {
            /**
            ...
            private: TaperedPinPatternFeatureBuilderImpl * m_taperedpinpatternfeaturebuilder_impl;
            private: friend class  _TaperedPinPatternFeatureBuilderBuilder;
            protected: TaperedPinPatternFeatureBuilder();
            public: ~TaperedPinPatternFeatureBuilder();
            ...
            /**Returns  the enum size 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedPinPatternFeatureBuilder::APIEnumSize EnumSize
            (
            );
            /**Sets  the enum size 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedPinPatternFeatureBuilder::APIEnumSize enumSize /** enumsize */ 
            );
            ...
            /**Returns  the enum loc 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedPinPatternFeatureBuilder::APIEnumLoc EnumLoc
            (
            );
            /**Sets  the enum loc 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedPinPatternFeatureBuilder::APIEnumLoc enumLoc /** enumloc */ 
            );
            ...
            /**Returns  the enum form 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedPinPatternFeatureBuilder::APIEnumForm EnumForm
            (
            );
            /**Sets  the enum form 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedPinPatternFeatureBuilder::APIEnumForm enumForm /** enumform */ 
            );
