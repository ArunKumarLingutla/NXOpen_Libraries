        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateGraphicalReportBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the element filter 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::CAE::LaminateGraphicalReportBuilder::ReportObject NXOpen::CAE::LaminateGraphicalReportBuilder::ReportObject@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::LaminateGraphicalReportBuilder::ReportObject instead.") NXOpen::CAE::LaminateElementFilterBuilder * ElementFilter
            (
            );
            /**Returns  the ply filter 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::LaminateGraphicalReportBuilder::ReportObject instead.") NXOpen::CAE::LaminatePlyFilterBuilder * PlyFilter
            (
            );
