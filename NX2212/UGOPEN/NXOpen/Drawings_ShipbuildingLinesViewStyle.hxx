#ifndef NXOpen_DRAWINGS_SHIPBUILDINGLINESVIEWSTYLE_HXX_INCLUDED
#define NXOpen_DRAWINGS_SHIPBUILDINGLINESVIEWSTYLE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Drawings_ShipbuildingLinesViewStyle.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class ShipbuildingLinesViewStyleImpl;
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ShipbuildingLinesViewStyle
        {
            /** Line type */
            public: enum Lines
            {
            ...
            private: ShipbuildingLinesViewStyleImpl * m_shipbuildinglinesviewstyle_impl;
            private: NXOpen::Drawings::ViewStyle* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit ShipbuildingLinesViewStyle(NXOpen::Drawings::ViewStyle *owner);
            ...
            tag_t Tag() const; 
            public: ~ShipbuildingLinesViewStyle();
            ...
            (
                NXOpen::Drawings::ShipbuildingLinesViewStyle::ShipbuildingLines featureType /** feature type */,
            ...
            (
                const NXString & featureName /** feature name e.g. decks, bulkheads etc.*/,
                NXOpen::Drawings::ShipbuildingLinesViewStyle::Lines linesType /** visible or hidden line type */,
                int color /** Color */
            );
            /** The color of ship line. The value should be between UF_OBJ_MIN_COLOR and UF_OBJ_MAX_COLOR. 
             <br>  Created in NX8.0.0.  <br>  
