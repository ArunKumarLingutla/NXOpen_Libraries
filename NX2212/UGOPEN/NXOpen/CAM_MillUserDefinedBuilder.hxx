...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a MillUserDefined Builder  <br> To create a new instance of this class, use @link NXOpen::CAM::OperationCollection::CreateMillUserDefinedBuilder  NXOpen::CAM::OperationCollection::CreateMillUserDefinedBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  MillUserDefinedBuilder : public NXOpen::CAM::UserDefinedOprBuilder
        {
