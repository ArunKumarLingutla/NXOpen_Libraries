        ...
        namespace PenetrationCheck
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  AddSetBuilder : public NXOpen::Builder
            {
                ...
                public: enum ThicknessBoundaryType
                {
                    ThicknessBoundaryTypeSharp/** sharp */ ,
                    ThicknessBoundaryTypeRound/** round */ 
                };
                ...
                /**Returns  the interference option 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::CAE::PenetrationCheck::AddSetBuilder::ThicknessBoundaryType BoundaryType
                (
                );
                /**Sets  the interference option 
                 <br>  Created in NX1926.0.0.  <br>  
                ...
                (
                    NXOpen::CAE::PenetrationCheck::AddSetBuilder::ThicknessBoundaryType boundaryOption /** boundaryoption */ 
                );
                /**Returns  the self interference toggle 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: bool SelfInterferenceOption
                (
                );
                /**Sets  the self interference toggle 
                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetSelfInterferenceOption
                (
                    bool selfInterferenceOption /** selfinterferenceoption */ 
                );
            };
        }
    }
