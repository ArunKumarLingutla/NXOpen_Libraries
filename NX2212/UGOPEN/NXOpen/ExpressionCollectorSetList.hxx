#ifndef NXOpen_EXPRESSIONCOLLECTORSETLIST_HXX_INCLUDED
#define NXOpen_EXPRESSIONCOLLECTORSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class _ExpressionCollectorSetListBuilder;
    class ExpressionCollectorSetListImpl;
    ...
    */
    class NXOPENCPPEXPORT  ExpressionCollectorSetList : public NXOpen::TaggedObject
    {
        private: ExpressionCollectorSetListImpl * m_expressioncollectorsetlist_impl;
        private: friend class  _ExpressionCollectorSetListBuilder;
        protected: ExpressionCollectorSetList();
        public: ~ExpressionCollectorSetList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::ExpressionCollectorSet *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::ExpressionCollectorSet * object /** item to append */
        );
        ...
        (
            NXOpen::ExpressionCollectorSet * obj /** Object to find index for */
        );
        /** Returns the object at the input index.  May be NULL.
             @return  object found at input index 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ExpressionCollectorSet * FindItem
        (
        ...
        public: void Erase
        (
            NXOpen::ExpressionCollectorSet * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ExpressionCollectorSet *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::ExpressionCollectorSet *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::ExpressionCollectorSet * object1 /** first item */,
            NXOpen::ExpressionCollectorSet * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::ExpressionCollectorSet * object /** object to be inserted */
        );
