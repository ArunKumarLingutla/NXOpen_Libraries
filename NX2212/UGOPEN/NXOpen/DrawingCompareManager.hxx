...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  DrawingCompareManager
    {
        ...
        public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use NXOpen::Drawings::TrackDrawingChangesGeneralBuilder  for General Builder and NXOpen::Drawings::TrackDrawingChangesReportFilterBuilder for Report Filter Builder") NXOpen::Drawings::DrawingCompareSettingsBuilder * CreateDrawingCompareSettingsBuilder
        (
        );
