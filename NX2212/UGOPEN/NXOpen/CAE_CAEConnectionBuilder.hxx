        ...
        */
        class NXOPENCPP_CAEEXPORT  CAEConnectionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the source Node(s) 
             <br>  @deprecated Deprecated in NX2206.0.0.  Use Get Source Nodes Selection Method <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use Get Source Nodes Selection Method") NXOpen::CAE::SelectFENodeList * SourceNodes
            (
            );
            ...
            /**Returns  the target Node(s) 
             <br>  @deprecated Deprecated in NX2206.0.0.  Use Get Target Nodes Selection Method <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use Get Target Nodes Selection Method") NXOpen::CAE::SelectFENodeList * TargetNodes
            (
            );
            ...
            /**Returns  the option to calculate weights for RBE3 spider elements 
             <br>  @deprecated Deprecated in NX2212.0.0.  Use overloaded function with enum instead. <br>  

             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use overloaded function with enum instead.") bool ApplyWeightsRbe3
            (
            );
            /**Sets  the option to calculate weights for RBE3 spider elements 
             ...
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use overloaded function with enum instead.") void SetApplyWeightsRbe3
            (
                bool doApplyWeights /** doapplyweights */ 
            );
            ...
            /**Returns  the option to calculate weights for RBE3 spider elements 
             ...
             <br> License requirements : None */
            public: NXOpen::CAE::CAEConnectionBuilder::Rbe3WeightMethodTypeEnum ApplyWeightsRbe3Enum
            (
            );
            /**Sets  the option to calculate weights for RBE3 spider elements 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetApplyWeightsRbe3Enum
            (
