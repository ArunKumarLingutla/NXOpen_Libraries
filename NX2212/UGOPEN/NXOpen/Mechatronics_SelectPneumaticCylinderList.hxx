#ifndef NXOpen_MECHATRONICS_SELECTPNEUMATICCYLINDERLIST_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTPNEUMATICCYLINDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectPneumaticCylinderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectPneumaticCylinderListBuilder;
        class SelectPneumaticCylinderListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectPneumaticCylinderList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectPneumaticCylinderListImpl * m_selectpneumaticcylinderlist_impl;
            private: friend class  _SelectPneumaticCylinderListBuilder;
            protected: SelectPneumaticCylinderList();
            public: ~SelectPneumaticCylinderList();
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::PneumaticCylinder * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Mechatronics::PneumaticCylinder *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::PneumaticCylinder * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Mechatronics::PneumaticCylinder * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Mechatronics::PneumaticCylinder * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Mechatronics::PneumaticCylinder * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Mechatronics::PneumaticCylinder *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Mechatronics::PneumaticCylinder * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Mechatronics::PneumaticCylinder *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::PneumaticCylinder *> GetArray
            (
            );
