#ifndef NXOpen_FACET_SELECTFACETEDBODYLIST_HXX_INCLUDED
#define NXOpen_FACET_SELECTFACETEDBODYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Facet_SelectFacetedBodyList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Facet
    {
        class _SelectFacetedBodyListBuilder;
        class SelectFacetedBodyListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FACETEXPORT  SelectFacetedBodyList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectFacetedBodyListImpl * m_selectfacetedbodylist_impl;
            private: friend class  _SelectFacetedBodyListBuilder;
            protected: SelectFacetedBodyList();
            public: ~SelectFacetedBodyList();
            ...
            public: bool Add
            (
                NXOpen::Facet::FacetedBody * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Facet::FacetedBody *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Facet::FacetedBody * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Facet::FacetedBody * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Facet::FacetedBody * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Facet::FacetedBody * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Facet::FacetedBody *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Facet::FacetedBody * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Facet::FacetedBody *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Facet::FacetedBody *> GetArray
            (
            );
