            ...
            */
            class NXOPENCPP_ASSEMBLIESEXPORT  PropertyBuilder : public NXOpen::Builder
            {
                ...
                /**Returns  the interface type of a product interface provided by users 
                 ...
                 <br> License requirements : None */
                public: int InterfaceUsageType
                (
                );
                /**Sets  the interface type of a product interface provided by users 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : gateway ("UG GATEWAY") */
                public: void SetInterfaceUsageType
                (
                    int interfaceUsageType /** usage type to be set on the product interface object */
                );
            };
        }
    }
