#ifndef NXOpen_SECTIONLIST_HXX_INCLUDED
#define NXOpen_SECTIONLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SectionList : public NXOpen::TaggedObject
    {
        private: SectionListImpl * m_sectionlist_impl;
        private: friend class  _SectionListBuilder;
        ...
        public: void Append
        (
            const std::vector<NXOpen::Section *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::Section * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::Section * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Section *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::Section *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::Section * object1 /** first item */,
            NXOpen::Section * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::Section * object /** object to be inserted */
        );
