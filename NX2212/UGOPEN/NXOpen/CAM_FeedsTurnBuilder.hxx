        ...
        */
        class NXOPENCPP_CAMEXPORT  FeedsTurnBuilder : public NXOpen::TaggedObject
        {
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: bool AutomaticFeedRateComputationState
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetAutomaticFeedRateComputationState
            (
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableDoubleBuilder * ChipThickness
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableFeedBuilder * MaximumFeedRateFromChipThickness
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: bool CornerFeedRatesState
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetCornerFeedRatesState
            (
                bool isActive /** isactive */ 
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableFeedBuilder * FeedRateConvexCorner
            (
            );
            ...
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::InheritableFeedBuilder * FeedRateConcaveCorner
            (
            );
