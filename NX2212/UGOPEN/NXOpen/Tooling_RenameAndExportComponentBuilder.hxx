...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        DefineBy </term> <description> 
         
        Selection </description> </item> 

        <item><term> 
         
        DeleteOldComponentsToggle </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ExportDrawingFile </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ListChildrenComponents </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        LoadOption </term> <description> 
         
        FromFolder </description> </item> 

        <item><term> 
         
        NewNameRule </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        ToolingNameRule </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  RenameAndExportComponentBuilder : public NXOpen::Builder
        {
            ...
            public: enum NamingRuleType
            {
                ...
                NamingRuleTypeToolingNameRule/** tooling name rule */ 
            };

            /** tooling naming rule */
            public: enum NameRuleType
            {
                NameRuleTypeDefault/** default */ 
            };
            ...
            /**Returns  the tooling name rule 
             ...
             <br> License requirements : None */
            public: NXString ToolingNameRule
            (
            );
            /**Sets  the tooling name rule 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetToolingNameRule
            (
                const NXString & toolingNameRule /** toolingnamerule */ 
            );
            /**Sets  the tooling name rule 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            void SetToolingNameRule
            (
                const char * toolingNameRule /** toolingnamerule */ 
            );
            /**Returns  the next part name number 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: int NextPartNameNumber
            (
            );
            /**Sets  the next part name number 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetNextPartNameNumber
            (
                int nextPartNameNumber /** nextpartnamenumber */ 
            );
