#ifndef NXOpen_CAM_BOUNDARYMEMBERSETLIST_HXX_INCLUDED
#define NXOpen_CAM_BOUNDARYMEMBERSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _BoundaryMemberSetListBuilder;
        class BoundaryMemberSetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  BoundaryMemberSetList : public NXOpen::TaggedObject
        {
            private: BoundaryMemberSetListImpl * m_boundarymembersetlist_impl;
            private: friend class  _BoundaryMemberSetListBuilder;
            protected: BoundaryMemberSetList();
            public: ~BoundaryMemberSetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::BoundaryMemberSet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::BoundaryMemberSet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::BoundaryMemberSet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BoundaryMemberSet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::BoundaryMemberSet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::BoundaryMemberSet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::BoundaryMemberSet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::BoundaryMemberSet * object1 /** first item */,
                NXOpen::CAM::BoundaryMemberSet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::BoundaryMemberSet * object /** object to be inserted */
            );
