        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TitleBlockCellBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** Edits the title block cell attributes such as lock status, content type, value, label etc. 
             <br>  @deprecated Deprecated in NX12.0.1.  Instead use @link NXOpen::Annotations::TitleBlockCellBuilder::SetLock NXOpen::Annotations::TitleBlockCellBuilder::SetLock@endlink  for lock status, @link NXOpen::Annotations::TitleBlockCellBuilder::SetLabel NXOpen::Annotations::TitleBlockCellBuilder::SetLabel@endlink  for label and @link NXOpen::Annotations::EditTitleBlockBuilder::SetCellValueForLabel NXOpen::Annotations::EditTitleBlockBuilder::SetCellValueForLabel@endlink  for cell value. 'Content type' and 'Can change lock status' are automatically computed and need not be used by a user. <br>  

             <br>  Created in NX10.0.2.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX12.0.1.  Instead use NXOpen::Annotations::TitleBlockCellBuilder::SetLock for lock status, NXOpen::Annotations::TitleBlockCellBuilder::SetLabel for label and NXOpen::Annotations::EditTitleBlockBuilder::SetCellValueForLabel for cell value. 'Content type' and 'Can change lock status' are automatically computed and need not be used by a user.") void EditCell
            (
