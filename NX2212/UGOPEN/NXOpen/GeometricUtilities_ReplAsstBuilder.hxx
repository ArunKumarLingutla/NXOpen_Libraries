...
namespace NXOpen
{
    ...
    namespace GeometricUtilities
    {
        ...
        /**
            Represents a @link NXOpen::GeometricUtilities::ReplAsstBuilder NXOpen::GeometricUtilities::ReplAsstBuilder@endlink . This is the primary data container
        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  ReplAsstBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** Set the product interface tag for the Replacement Assistant.  
             ...
             <br> License requirements : None */
            public: void SetProdInt
            (
                NXOpen::TaggedObject * prodInt /** prodint */ 
            );
            /**Returns  the automatic matching preference to match objects with dependents only (if already searched separately) 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: bool MatchObjectsWithDependentsOnly
            (
            );
            /**Sets  the automatic matching preference to match objects with dependents only (if already searched separately) 
             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: void SetMatchObjectsWithDependentsOnly
            (
                bool matchObjectsWithDependentsOnly /** matchobjectswithdependentsonly */ 
            );
