        ...
        */
        class NXOPENCPP_MARKUPEXPORT  ElementBuilder : public NXOpen::Builder
        {
            ...
            public: enum Styles
            {
                ...
                StylesInsetImage/** Inset Image style, reserved for future use */
            };
            ...
            /**Returns  the leader line color index value of the markup object, whose range is from 1 to 216. 
             ...
             <br> License requirements : None */
            public: NXOpen::NXColor * LeaderLineColor
            (
            );
            /**Sets  the leader line color index value of the markup object, whose range is from 1 to 216. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : dmu_markup ("License to expose DMU functionality in NX desktop") */
            public: void SetLeaderLineColor
            (
                NXOpen::NXColor * colorIndex /** colorindex */ 
            );
            ...
            /**Returns  the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  underline setting. It applies to @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  only. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool Underline
            (
            );
            /**Sets  the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  underline setting. It applies to @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  only. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : dmu_markup ("License to expose DMU functionality in NX desktop") */
            ...
            /**Returns  the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  strikethrough setting. It applies to @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  only. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool Strikethrough
            (
            );
            /**Sets  the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  strikethrough setting. It applies to @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  only. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : dmu_markup ("License to expose DMU functionality in NX desktop") */
            ...
            /**Sets  the text color index value of the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  object, whose range is from 1 to 216. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : dmu_markup ("License to expose DMU functionality in NX desktop") */
            ...
            /**Returns  the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  show label setting. It applies to @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  only. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool IncludeLabels
            (
            );
            /**Sets  the @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  show label setting. It applies to @link NXOpen::Markup::Text NXOpen::Markup::Text@endlink  only. 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : dmu_markup ("License to expose DMU functionality in NX desktop") */
