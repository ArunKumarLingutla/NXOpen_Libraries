        ...
        */
        class AMEOPENCPPEXPORT  AMEManager
        {
            ...
            */
            ...
            /** Capture a symbol's preview image
                    part needs to contain symbol information
                    margin is the distance between the symbol's bounding box to the border of the screen shoted area, a margin bellow 0 is not valid
                    scaledPixelHeight targeted height of pixels the caputed image gets rescaled to, on 0 rescaling is turned off
                    zoomFactor = 1.0 causes to captute symbol's bounding box + margin only, any higher factor will cause the image to reduce in resolution, a factor bellow 1 is not valid
            ...
            (
                ...
                int scaledPixelHeight /** scaledpixelheight */ ,
