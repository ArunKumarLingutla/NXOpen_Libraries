    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  AeroRibBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  the reverse height offset direction flag. Indicates whether the heightOffset direction has been flipped from its initial inferred direction 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: bool ReverseHeightOffsetDirection
            (
            );
            /**Sets  the reverse height offset direction flag. Indicates whether the heightOffset direction has been flipped from its initial inferred direction 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_aero_design (" NX Aero Design") */
            public: void SetReverseHeightOffsetDirection
            (
                bool reverseHeightOffsetDirection /** reverseheightoffsetdirection */ 
            );
            ...
            /**Returns  the align ref type0 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::AeroRibBuilder::AlignReferenceType AlignRefType0
            (
            );
            ...
            (
                NXOpen::Features::AeroRibBuilder::AlignReferenceType alignRefType0 /** alignreftype0 */ 
            );
            /**Returns  the align ref type1 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::AeroRibBuilder::AlignReferenceType AlignRefType1
            (
            );
            ...
            (
                NXOpen::Features::AeroRibBuilder::AlignReferenceType alignRefType1 /** alignreftype1 */ 
            );
