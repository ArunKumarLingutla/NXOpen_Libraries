#ifndef NXOpen_MECHATRONICS_SELECTHYDRAULICCYLINDERLIST_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTHYDRAULICCYLINDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectHydraulicCylinderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectHydraulicCylinderListBuilder;
        class SelectHydraulicCylinderListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectHydraulicCylinderList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectHydraulicCylinderListImpl * m_selecthydrauliccylinderlist_impl;
            private: friend class  _SelectHydraulicCylinderListBuilder;
            protected: SelectHydraulicCylinderList();
            public: ~SelectHydraulicCylinderList();
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::HydraulicCylinder * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Mechatronics::HydraulicCylinder *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::HydraulicCylinder * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Mechatronics::HydraulicCylinder * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Mechatronics::HydraulicCylinder * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Mechatronics::HydraulicCylinder * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Mechatronics::HydraulicCylinder *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Mechatronics::HydraulicCylinder * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Mechatronics::HydraulicCylinder *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::HydraulicCylinder *> GetArray
            (
            );
