...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  RelationFinderSettingsBuilder : public NXOpen::Builder
    {
        ...
        /**Returns the setting specifies whether coincident locations between a midpoint and an endpoint, center point, or existing points are found by the relation finder
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: bool FindMidpoint
        (
        );
        /**Sets the setting specifies whether coincident locations between a midpoint and an endpoint, center point, or existing points are found by the relation finder
         <br>  Created in NX2206.0.0.  <br>  
         <br> License requirements : None */
        public: void SetFindMidpoint
        (
