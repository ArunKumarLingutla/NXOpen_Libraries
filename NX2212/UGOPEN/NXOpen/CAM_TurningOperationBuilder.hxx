    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  TurningOperationBuilder : public NXOpen::CAM::OperationBuilder
        {
            ...
            public: enum ReorientToolHolderModeOptions
            {
                ReorientToolHolderModeOptionsNone/** None */,
                ReorientToolHolderModeOptionsFixed/** Fixed */,
                ReorientToolHolderModeOptionsVariable/** Variable */
            };
            ...
            */
            ...
            /**Returns  the Reorient Tool Holder toggle. IMPORTANT: Parameter is obsolete from NX11.0 on and must not be used longer. 
             <br>  @deprecated Deprecated in NX11.0.0.  Use 'Reorient Tool Holder Mode' instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use 'Reorient Tool Holder Mode' instead.") bool ReorientToolHolder
            (
            );
            /**Sets  the Reorient Tool Holder toggle. IMPORTANT: Parameter is obsolete from NX11.0 on and must not be used longer. 
             <br>  @deprecated Deprecated in NX11.0.0.  Use 'Reorient Tool Holder Mode' instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX11.0.0.  Use 'Reorient Tool Holder Mode' instead.") void SetReorientToolHolder
            (
            ...
            /**Returns  the Reorient Tool Holder Mode 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::TurningOperationBuilder::ReorientToolHolderModeOptions ReorientToolHolderMode
            (
            );
            /**Sets  the Reorient Tool Holder Mode 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetReorientToolHolderMode
            (
                NXOpen::CAM::TurningOperationBuilder::ReorientToolHolderModeOptions reorientToolHolderMode /** Reorient Tool Holder Mode */
            );
            ...
            /**Returns  the Rotate Tracking Point toggle 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAM::TurningOperationBuilder::TrackingPointStatus CAM::TurningOperationBuilder::TrackingPointStatus@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::TurningOperationBuilder::TrackingPointStatus instead.") bool RotateTrackingPoint
            (
            );
            /**Sets  the Rotate Tracking Point toggle 
             <br>  @deprecated Deprecated in NX8.5.0.  Use @link CAM::TurningOperationBuilder::SetTrackingPointStatus CAM::TurningOperationBuilder::SetTrackingPointStatus@endlink  instead. <br>  

             <br>  Created in NX7.5.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX8.5.0.  Use CAM::TurningOperationBuilder::SetTrackingPointStatus instead.") void SetRotateTrackingPoint
            (
