#ifndef NXOpen_DRAWINGS_SELECTDRAFTINGVIEW_HXX_INCLUDED
#define NXOpen_DRAWINGS_SELECTDRAFTINGVIEW_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Drawings_SelectDraftingView.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class _SelectDraftingViewBuilder;
        class SelectDraftingViewImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  SelectDraftingView : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDraftingViewImpl * m_selectdraftingview_impl;
            private: friend class  _SelectDraftingViewBuilder;
            protected: SelectDraftingView();
            public: ~SelectDraftingView();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::DraftingView * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Drawings::DraftingView * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
