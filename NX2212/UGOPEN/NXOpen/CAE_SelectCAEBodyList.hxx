#ifndef NXOpen_CAE_SELECTCAEBODYLIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTCAEBODYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectCAEBodyListBuilder;
        class SelectCAEBodyListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SelectCAEBodyList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectCAEBodyListImpl * m_selectcaebodylist_impl;
            private: friend class  _SelectCAEBodyListBuilder;
            protected: SelectCAEBodyList();
            public: ~SelectCAEBodyList();
            ...
            public: bool Add
            (
                NXOpen::CAE::CAEBody * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::CAEBody *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAE::CAEBody * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAE::CAEBody * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::CAE::CAEBody * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::CAE::CAEBody * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::CAE::CAEBody *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::CAEBody * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::CAEBody *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::CAEBody *> GetArray
            (
            );
