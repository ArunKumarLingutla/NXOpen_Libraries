#ifndef NXOpen_MOTION_SELECTMARKER_HXX_INCLUDED
#define NXOpen_MOTION_SELECTMARKER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectMarkerBuilder;
        class SelectMarkerImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectMarker : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectMarkerImpl * m_selectmarker_impl;
            private: friend class  _SelectMarkerBuilder;
            protected: SelectMarker();
            public: ~SelectMarker();
            ...
            (
                NXOpen::Motion::Marker * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::Marker * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::Marker * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::Marker * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::Marker * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
