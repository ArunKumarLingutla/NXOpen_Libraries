#ifndef NXOpen_SELECTICURVELIST_HXX_INCLUDED
#define NXOpen_SELECTICURVELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class SelectICurveListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectICurveList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectICurveListImpl * m_selecticurvelist_impl;
        private: friend class  _SelectICurveListBuilder;
        protected: SelectICurveList();
        public: ~SelectICurveList();
        ...
        public: bool Add
        (
            NXOpen::ICurve * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::ICurve *> & objects /** objects to add */
        );
        ...
        public: bool Remove
        (
            NXOpen::ICurve * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::ICurve *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::ICurve * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::ICurve *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ICurve *> GetArray
        (
        );
