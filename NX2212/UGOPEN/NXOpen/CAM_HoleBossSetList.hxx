#ifndef NXOpen_CAM_HOLEBOSSSETLIST_HXX_INCLUDED
#define NXOpen_CAM_HOLEBOSSSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _HoleBossSetListBuilder;
        class HoleBossSetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  HoleBossSetList : public NXOpen::TaggedObject
        {
            private: HoleBossSetListImpl * m_holebosssetlist_impl;
            private: friend class  _HoleBossSetListBuilder;
            protected: HoleBossSetList();
            public: ~HoleBossSetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::HoleBossSet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::HoleBossSet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::HoleBossSet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::HoleBossSet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::HoleBossSet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::HoleBossSet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::HoleBossSet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::HoleBossSet * object1 /** first item */,
                NXOpen::CAM::HoleBossSet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::HoleBossSet * object /** object to be inserted */
            );
