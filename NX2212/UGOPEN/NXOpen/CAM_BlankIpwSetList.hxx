#ifndef NXOpen_CAM_BLANKIPWSETLIST_HXX_INCLUDED
#define NXOpen_CAM_BLANKIPWSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _BlankIpwSetListBuilder;
        class BlankIpwSetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  BlankIpwSetList : public NXOpen::TaggedObject
        {
            private: BlankIpwSetListImpl * m_blankipwsetlist_impl;
            private: friend class  _BlankIpwSetListBuilder;
            protected: BlankIpwSetList();
            public: ~BlankIpwSetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::BlankIpwSet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::BlankIpwSet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::BlankIpwSet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BlankIpwSet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::BlankIpwSet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::BlankIpwSet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::BlankIpwSet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::BlankIpwSet * object1 /** first item */,
                NXOpen::CAM::BlankIpwSet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::BlankIpwSet * object /** object to be inserted */
            );
