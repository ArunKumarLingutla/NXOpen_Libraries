    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  LineArrowStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the balloon arrow head type.
                    This property should not be used in object settings, instead use @link NXOpen::Annotations::LineArrowStyleBuilder::FirstArrowType NXOpen::Annotations::LineArrowStyleBuilder::FirstArrowType@endlink .
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::ArrowheadType BalloonLeaderArrowHeadType
            (
            );
            /**Sets  the balloon arrow head type.
                    This property should not be used in object settings, instead use @link NXOpen::Annotations::LineArrowStyleBuilder::FirstArrowType NXOpen::Annotations::LineArrowStyleBuilder::FirstArrowType@endlink .
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : geometric_tol ("GDT") OR drafting ("DRAFTING") */
            public: void SetBalloonLeaderArrowHeadType
            (
                NXOpen::Annotations::ArrowheadType balloonLeaderArrowheadType /** balloonleaderarrowheadtype */ 
            );
