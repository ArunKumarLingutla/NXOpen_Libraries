...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NX_DEPRECATED("Deprecated in NX9.0.0.  Use NXOpen::Features::PatchOpeningsBuilder instead.") NXOPENCPP_CAMEXPORT  CustomLoops : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
