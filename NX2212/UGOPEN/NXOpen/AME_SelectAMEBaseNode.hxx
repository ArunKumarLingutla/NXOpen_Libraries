#ifndef NXOpen_AME_SELECTAMEBASENODE_HXX_INCLUDED
#define NXOpen_AME_SELECTAMEBASENODE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _SelectAMEBaseNodeBuilder;
        class SelectAMEBaseNodeImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class AMEOPENCPPEXPORT  SelectAMEBaseNode : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAMEBaseNodeImpl * m_selectamebasenode_impl;
            private: friend class  _SelectAMEBaseNodeBuilder;
            protected: SelectAMEBaseNode();
            public: ~SelectAMEBaseNode();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::AME::AMEBaseNode * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::AME::AMEBaseNode * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
