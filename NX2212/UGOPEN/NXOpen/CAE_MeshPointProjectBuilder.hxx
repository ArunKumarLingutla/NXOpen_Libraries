    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshPointProjectBuilder : public NXOpen::CAE::MeshPointBaseBuilder
        {
            ...
            /**Returns  the toggle for project within a search distance
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool ProjectSearchDistanceOption
            (
            );
            /**Sets  the toggle for project within a search distance
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetProjectSearchDistanceOption
            (
                bool toggleSearchWithin /** toggle search within */ 
            );
            /**Returns  the value of project within a search distance
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
