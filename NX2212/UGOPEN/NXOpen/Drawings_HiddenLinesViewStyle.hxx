#ifndef NXOpen_DRAWINGS_HIDDENLINESVIEWSTYLE_HXX_INCLUDED
#define NXOpen_DRAWINGS_HIDDENLINESVIEWSTYLE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Drawings_HiddenLinesViewStyle.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class HiddenLinesViewStyleImpl;
        /** Represents set of Hidden Lines View Style Preferences applicable to drafting views.  <br> To obtain an instance of this class use @link Drawings::ViewStyle::HiddenLines Drawings::ViewStyle::HiddenLines@endlink   <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  HiddenLinesViewStyle: public virtual NXOpen::Preferences::IHiddenLinesViewPreferences
        {
            private: HiddenLinesViewStyleImpl * m_hiddenlinesviewstyle_impl;
            private: NXOpen::Drawings::ViewStyle* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit HiddenLinesViewStyle(NXOpen::Drawings::ViewStyle *owner);
            ...
            /**Sets  the color of hiddenline. The value should be between 1 and 216. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /**Returns  the color of hiddenline. The value should be between 1 and 216. 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            /**Sets  the status of interfering solids. This allows the correct rendering of hidden lines 
             ...
             <br>  @deprecated Deprecated in NX6.0.0.  Use @link Drawings::HiddenLinesViewStyle::SetInterferingSolidsOption Drawings::HiddenLinesViewStyle::SetInterferingSolidsOption@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX6.0.0.  Use Drawings::HiddenLinesViewStyle::SetInterferingSolidsOption instead.") void SetInterferingSolids
            (
            ...
            /**Returns  the status of interfering solids. This allows the correct rendering of hidden lines 
             ...
             <br>  @deprecated Deprecated in NX6.0.0.  Use @link Drawings::HiddenLinesViewStyle::InterferingSolidsOption Drawings::HiddenLinesViewStyle::InterferingSolidsOption@endlink  instead. <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX6.0.0.  Use Drawings::HiddenLinesViewStyle::InterferingSolidsOption instead.") bool InterferingSolids
            (
            );
            /**Returns  the status of interfering solids. This allows the correct rendering of hidden lines 
                        in a drawing member view with interfering solids.
