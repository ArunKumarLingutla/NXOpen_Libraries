#ifndef NXOpen_CAE_MESHDISPLAYSETTINGS2D_HXX_INCLUDED
#define NXOpen_CAE_MESHDISPLAYSETTINGS2D_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class MeshDisplaySettings2dImpl;
        /** Represents 2d Mesh Display Settings  <br> To obtain an instance of this class use CAE::Mesh, 
                                   CAE::MeshCollector, or CAE::MeshCollectorOccurrence classes  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  MeshDisplaySettings2d : public NXOpen::CAE::MeshDisplaySettings
        {
            private: MeshDisplaySettings2dImpl * m_meshdisplaysettings2d_impl;
            /// \cond NX_NO_DOC 
            public: explicit MeshDisplaySettings2d(void *ptr);
            /// \endcond 
            ...
            public: virtual ~MeshDisplaySettings2d();
            ...
            /**Returns  the plane stress bolt-hole centerline display setting. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: bool DisplayBoltHoleCenterline
            (
            );
            /**Sets  the plane stress bolt-hole centerline display setting. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetDisplayBoltHoleCenterline
            (
                bool visibility /** visibility */ 
            );
            /**Returns  the plane stress bolt-hole centerline color. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXOpen::NXColor * BoltHoleCenterlineColor
            (
            );
            /**Sets  the plane stress bolt-hole centerline color. 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetBoltHoleCenterlineColor
            (
                NXOpen::NXColor * color /** color */ 
            );
