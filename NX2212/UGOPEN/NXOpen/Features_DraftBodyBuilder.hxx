...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        DraftMethod </term> <description> 
         
        Isocline </description> </item> 

        <item><term> 
         
        ExtremeFacePointOverridesStationary </term> <description> 
         
        False </description> </item> 

        <item><term> 
         
        FilletRadius.Value </term> <description> 
         
        2.5 (millimeters part), 0.1 (inches part) </description> </item> 

        <item><term> 
         
        MatchScope </term> <description> 
         
        All </description> </item> 

        <item><term> 
         
        MatchType </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        RepairPartingEdge </term> <description> 
         
        None </description> </item> 

        <item><term> 
         
        RepairRadius.Value (deprecated) </term> <description> 
         
        2.5 (millimeters part), 0.1 (inches part) </description> </item> 

        <item><term> 
         
        RepairingOption (deprecated) </term> <description> 
        ...
        UseDraftedBodyAsPartingObject </term> <description> 
