#ifndef NXOpen_MOTION_SELECTTIREPROPERTYNONINERTIAL_HXX_INCLUDED
#define NXOpen_MOTION_SELECTTIREPROPERTYNONINERTIAL_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Motion_SelectTirePropertyNonInertial.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectTirePropertyNonInertialBuilder;
        class SelectTirePropertyNonInertialImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectTirePropertyNonInertial : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectTirePropertyNonInertialImpl * m_selecttirepropertynoninertial_impl;
            private: friend class  _SelectTirePropertyNonInertialBuilder;
            protected: SelectTirePropertyNonInertial();
            public: ~SelectTirePropertyNonInertial();
            ...
            (
                NXOpen::Motion::TirePropertyNonInertial * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::TirePropertyNonInertial * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::TirePropertyNonInertial * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::TirePropertyNonInertial * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::TirePropertyNonInertial * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
