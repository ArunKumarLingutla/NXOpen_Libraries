...
namespace NXOpen
{
    ...
    namespace AME
    {
        ...
        /** JA class for the reuse rule dialog <br> This is an abstract class, and cannot be instantiated.  <br> 
        ...
        */
        class AMEOPENCPPEXPORT  InstanceDataBlockBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the EngObject selection 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::SelectAMEBaseNode * SelectedEngObject
            (
            );
            ...
            /**Returns  the type 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::InstanceDataBlockBuilder::ActionType Type
            (
            );
            /**Sets  the type 
             <br>  Created in NX1847.0.0.  <br>  
            ...
            /**Returns  the create mode 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::InstanceDataBlockBuilder::CreateMode CreationMode
            (
            );
            ...
            (
                NXOpen::AME::InstanceDataBlockBuilder::CreateMode createMode /** createmode */ 
            );
        };
    }
}
