...
namespace NXOpen
{
    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  QueryBuilder : public NXOpen::AME::AMEBaseBuilder
        {
            /** the creation type of query */
            public: enum Types
            {
                TypesNewQuery/** new query */ ,
            ...
            public: NXOpen::AME::QueryBuilder::Types CreationType
            (
            );
            ...
            (
                NXOpen::AME::QueryBuilder::Types type /** type */ 
            );
            ...
            /** The selected public query name
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString GetPublicQueryName
            (
            );
            /** The selected public query description
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXString GetPublicQueryDescription
            (
            );
