#ifndef NXOpen_SELECTISURFACE_HXX_INCLUDED
#define NXOpen_SELECTISURFACE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class ISurface;
    class View;
    class _SelectISurfaceBuilder;
    class SelectISurfaceImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectISurface : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectISurfaceImpl * m_selectisurface_impl;
        private: friend class  _SelectISurfaceBuilder;
        protected: SelectISurface();
        public: ~SelectISurface();
        ...
        (
            NXOpen::ISurface * selection /** selected object */
        );
        /**Returns  the object being selected
            
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ISurface * Value
        (
        );
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::ISurface * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
