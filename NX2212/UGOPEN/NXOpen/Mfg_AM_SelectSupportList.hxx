#ifndef NXOpen_MFG_AM_SELECTSUPPORTLIST_HXX_INCLUDED
#define NXOpen_MFG_AM_SELECTSUPPORTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Mfg
    {
        namespace AM
        {
            class _SelectSupportListBuilder;
            class SelectSupportListImpl;
            /** Represents a list of objects on a selection list.

             <br>  Created in NX5.0.0.  <br>  
            */
            class MFGAMOPENCPPEXPORT  SelectSupportList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                private: SelectSupportListImpl * m_selectsupportlist_impl;
                private: friend class  _SelectSupportListBuilder;
                protected: SelectSupportList();
                ...
                public: bool Add
                (
                    NXOpen::Mfg::AM::Support * object /** object to add */
                );
                ...
                public: bool Add
                (
                    const std::vector<NXOpen::Mfg::AM::Support *> & objects /** objects to add */
                );
                ...
                public: bool Remove
                (
                    NXOpen::Mfg::AM::Support * object /** Object to remove */
                );
                /** Remove specified object from list.
                     @return  True if successfully removed from list;
                ...
                (
                    const std::vector<NXOpen::Mfg::AM::Support *> & objects /** Objects to remove */
                );
                ...
                (
                    NXOpen::Mfg::AM::Support * object /** object to check */
                );
                ...
                (
                    const std::vector<NXOpen::Mfg::AM::Support *> & objects /** items to put in the list*/
                );
                /** Returns the list of objects in the selection list.
                     @return  items in list 
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::Mfg::AM::Support *> GetArray
                (
                );
