#ifndef NXOpen_ROUTING_SELECTCONTROLPOINT_HXX_INCLUDED
#define NXOpen_ROUTING_SELECTCONTROLPOINT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class SelectControlPointImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  SelectControlPoint : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectControlPointImpl * m_selectcontrolpoint_impl;
            private: friend class  _SelectControlPointBuilder;
            protected: SelectControlPoint();
            public: ~SelectControlPoint();
            ...
            (
                NXOpen::Routing::ControlPoint * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Routing::ControlPoint * Value
            (
            );
            ...
            (
                ...
                NXOpen::Routing::ControlPoint * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Routing::ControlPoint * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Routing::ControlPoint * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
