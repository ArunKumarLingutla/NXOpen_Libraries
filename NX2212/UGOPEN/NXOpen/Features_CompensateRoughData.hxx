...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a compensate rough curve or compensate rough sheet feature  <br> To create or edit an instance of this class, use @link NXOpen::Die::CompensateRoughDataBuilder  NXOpen::Die::CompensateRoughDataBuilder @endlink  <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  CompensateRoughData : public NXOpen::Features::BodyFeature
        {
