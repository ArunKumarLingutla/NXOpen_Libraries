    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostGraphBuilder : public NXOpen::Builder
        {
            ...
            {
                DataErrorHandlingSkip/** The missing values are ignored; the graph will look like having less data points */,
                DataErrorHandlingUserValue/** User given value will be used for those entities which do not have result value associated with them */,
                DataErrorHandlingNoValue/** The mising values remains visible in the graph data as not defined values, marked as INF (infinite) values */
            };
            ...
            public: enum EntityType
            {
                ...
                EntityTypeSelectionRecipe/** selection recipe */ 
            };
            ...
            /**Returns   the nodal combination option for determining the nodal value for element and element-nodal results
                    This method has been deprecated. The nodal combination can be done by using 'Set Result'/'Set Postview' dialog and then Graph
                    can be plotted to have same behaviour 
             <br>  @deprecated Deprecated in NX1847.0.0.  None <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  None") NXOpen::CAE::PostGraphBuilder::NodalCombination NodalCombinationValue
            (
            );
            /**Sets   the nodal combination option for determining the nodal value for element and element-nodal results
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  None") void SetNodalCombinationValue
            (
            ...
            /** Gets the field which is created when user sets the 
                        @link NXOpen::CAE::PostGraphBuilder::CreateFieldOption NXOpen::CAE::PostGraphBuilder::CreateFieldOption@endlink  
