#ifndef NXOpen_CAE_SELECTFENODELIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTFENODELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectFENodeListBuilder;
        class SelectFENodeListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SelectFENodeList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectFENodeListImpl * m_selectfenodelist_impl;
            private: friend class  _SelectFENodeListBuilder;
            protected: SelectFENodeList();
            public: ~SelectFENodeList();
            ...
            public: bool Add
            (
                NXOpen::CAE::FENode * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::FENode *> & objects /** objects to add */
            );
            ...
            public: bool Remove
            (
                NXOpen::CAE::FENode * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                const std::vector<NXOpen::CAE::FENode *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::FENode * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::FENode *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::FENode *> GetArray
            (
            );
