#ifndef NXOpen_SELECTIBASECURVELIST_HXX_INCLUDED
#define NXOpen_SELECTIBASECURVELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectIBaseCurveListBuilder;
    class SelectIBaseCurveListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectIBaseCurveList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectIBaseCurveListImpl * m_selectibasecurvelist_impl;
        private: friend class  _SelectIBaseCurveListBuilder;
        protected: SelectIBaseCurveList();
        public: ~SelectIBaseCurveList();
        ...
        public: bool Add
        (
            NXOpen::IBaseCurve * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::IBaseCurve *> & objects /** objects to add */
        );
        ...
        public: bool Remove
        (
            NXOpen::IBaseCurve * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::IBaseCurve *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::IBaseCurve * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::IBaseCurve *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::IBaseCurve *> GetArray
        (
        );
