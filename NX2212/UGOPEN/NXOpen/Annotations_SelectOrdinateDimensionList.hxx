#ifndef NXOpen_ANNOTATIONS_SELECTORDINATEDIMENSIONLIST_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTORDINATEDIMENSIONLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_SelectOrdinateDimensionList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectOrdinateDimensionListBuilder;
        class SelectOrdinateDimensionListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectOrdinateDimensionList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectOrdinateDimensionListImpl * m_selectordinatedimensionlist_impl;
            private: friend class  _SelectOrdinateDimensionListBuilder;
            protected: SelectOrdinateDimensionList();
            public: ~SelectOrdinateDimensionList();
            ...
            public: bool Add
            (
                NXOpen::Annotations::OrdinateDimension * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Annotations::OrdinateDimension *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Annotations::OrdinateDimension * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Annotations::OrdinateDimension * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Annotations::OrdinateDimension * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Annotations::OrdinateDimension * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Annotations::OrdinateDimension *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Annotations::OrdinateDimension * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Annotations::OrdinateDimension *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::OrdinateDimension *> GetArray
            (
            );
