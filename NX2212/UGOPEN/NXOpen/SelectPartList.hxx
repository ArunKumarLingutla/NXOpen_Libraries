#ifndef NXOpen_SELECTPARTLIST_HXX_INCLUDED
#define NXOpen_SELECTPARTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  SelectPartList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        ...
        public: bool Add
        (
            NXOpen::Part * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Part *> & objects /** objects to add */
        );
        ...
        public: bool Remove
        (
            NXOpen::Part * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Part *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Part * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Part *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Part *> GetArray
        (
        );
