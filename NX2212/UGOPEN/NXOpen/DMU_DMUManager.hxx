        ...
        */
        class DMUOPENCPPEXPORT  DMUManager
        {
            ...
            */
            ...
            (
                NXOpen::Part * part /** part */ ,
                std::vector<NXString> & propertiesToBeEnabled /** the ids of the properties to be enabled */,
                std::vector<NXString> & propertiesToBeDisabled /** the ids of the properties to be disabled */
            );
