#ifndef NXOpen_LAYOUT2D_SELECTCOMPONENTLIST_HXX_INCLUDED
#define NXOpen_LAYOUT2D_SELECTCOMPONENTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Layout2d_SelectComponentList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Layout2d
    {
        ...
        */
        class NXOPENCPP_LAYOUT2DEXPORT  SelectComponentList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: bool Add
            (
                NXOpen::Layout2d::Component * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Layout2d::Component *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Layout2d::Component * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Layout2d::Component * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Layout2d::Component * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Layout2d::Component * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Layout2d::Component *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Layout2d::Component * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Layout2d::Component *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Layout2d::Component *> GetArray
            (
            );
