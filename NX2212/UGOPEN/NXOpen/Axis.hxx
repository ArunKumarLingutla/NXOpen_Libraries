...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Axis : public NXOpen::SmartObject
    {
        ...
        /** Sets the direction vector for a non-associative axis.  This method does nothing if the axis is associative. 
                 <br> When setting the direction vector, please make sure to use @link NXOpen::Point3d NXOpen::Point3d@endlink  
                and @link NXOpen::Vector3d NXOpen::Vector3d@endlink  to create an axis through @link NXOpen::AxisCollection::CreateAxis NXOpen::AxisCollection::CreateAxis@endlink  before.
                 <br> 
