#ifndef NXOpen_SELECTCOORDINATESYSTEMLIST_HXX_INCLUDED
#define NXOpen_SELECTCOORDINATESYSTEMLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectCoordinateSystemListBuilder;
    class SelectCoordinateSystemListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectCoordinateSystemList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectCoordinateSystemListImpl * m_selectcoordinatesystemlist_impl;
        private: friend class  _SelectCoordinateSystemListBuilder;
        protected: SelectCoordinateSystemList();
        public: ~SelectCoordinateSystemList();
        ...
        public: bool Add
        (
            NXOpen::CoordinateSystem * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::CoordinateSystem *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::CoordinateSystem * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::CoordinateSystem * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::CoordinateSystem * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::CoordinateSystem * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::CoordinateSystem *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::CoordinateSystem * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::CoordinateSystem *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::CoordinateSystem *> GetArray
        (
        );
