    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  FeatureGeomBuilder : public NXOpen::CAM::NCGroupBuilder
        {
            ...
            /**Returns  the physical workpiece state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool PhysicalWorkpieceState
            (
            );
            /**Sets  the physical workpiece state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetPhysicalWorkpieceState
            (
                bool state /** if true the geometry object represents a physical workpiece on the machine */
            );
            /**Returns  the machine component 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXString MachineComponent
            (
            );
            /**Sets  the machine component 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetMachineComponent
            (
                const NXString & component /** Machine component from KIM which is classfied as _PART */
            );
            /**Sets  the machine component 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            void SetMachineComponent
            (
                const char * component /** Machine component from KIM which is classfied as _PART */
            );
        };
    }
}
