        ...
        */
        class NXOPENCPP_CAMEXPORT  TurnEngageRetractBuilder : public NXOpen::TaggedObject
        {
            ...
            */
            ...
            /**Sets  the second angle 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetSecondAngle
            (
                double angle /** the angle value */
            );
            /**Returns  the Radius 
            ...
            /**Returns  the Direct engage to(retract from) trim point 
             <br>  @deprecated Deprecated in NX10.0.2.  Use @link CAM::TurnEngageRetractBuilder::DirectEngageRetractMode CAM::TurnEngageRetractBuilder::DirectEngageRetractMode@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.2.  Use CAM::TurnEngageRetractBuilder::DirectEngageRetractMode instead.") bool DirectTrimPoint
            (
            );
            /**Sets  the Direct engage to(retract from) trim point 
             <br>  @deprecated Deprecated in NX10.0.2.  Use @link CAM::TurnEngageRetractBuilder::SetDirectEngageRetractMode CAM::TurnEngageRetractBuilder::SetDirectEngageRetractMode@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: NX_DEPRECATED("Deprecated in NX10.0.2.  Use CAM::TurnEngageRetractBuilder::SetDirectEngageRetractMode instead.") void SetDirectTrimPoint
            (
