#ifndef NXOpen_SELECTTAGGEDOBJECT_HXX_INCLUDED
#define NXOpen_SELECTTAGGEDOBJECT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class TaggedObject;
    class View;
    class _SelectTaggedObjectBuilder;
    class SelectTaggedObjectImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectTaggedObject : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectTaggedObjectImpl * m_selecttaggedobject_impl;
        private: friend class  _SelectTaggedObjectBuilder;
        protected: SelectTaggedObject();
        public: ~SelectTaggedObject();
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::TaggedObject * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
