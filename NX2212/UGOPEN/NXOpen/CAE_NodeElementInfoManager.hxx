...
#include <NXOpen/CAE_ShowElemNodeLabelsBuilder.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  NodeElementInfoManager
        {
            ...
            /** Creates a builder for node element info command
             <br>  Created in NX5.0.0.  <br>  
            ...
            /** Creates a builder for assigning nodal cs
             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::AssignNodalCSBuilder * CreateAssignNodalCsBuilder
            (
            );
            /** Creates a builder for plotting thickness contours 
            ...
            /** Creates a builder for plotting thickness contours 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::PlotContoursBuilder * CreatePlotContoursBuilder
            (
            );
            /** Creates a builder for displaying nodal coordinate systems 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::DisplayNodalCsysBuilder * CreateDisplayNodalCsysBuilder
            (
            );
            /** Creates persistent element and node labels. 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::ShowElemNodeLabelsBuilder * CreateShowElemNodeLabelsBuilder
            (
            );
