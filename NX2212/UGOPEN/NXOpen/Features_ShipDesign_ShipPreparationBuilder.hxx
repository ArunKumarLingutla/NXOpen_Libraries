...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace ShipDesign
        {
            ...
            RemoveBlends </term> <description> 
             
            true </description> </item> 

            <item><term> 
             
            RemoveOpenings </term> <description> 
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ShipPreparationBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                public: NXOpen::SelectDisplayableObjectList * ShipComponents
                (
                );
                ...
                /**Returns  the option to remove blends. If true, blends with a radius less than or equal to
                            @link Features::ShipDesign::ShipPreparationBuilder::BlendRadius Features::ShipDesign::ShipPreparationBuilder::BlendRadius@endlink  will be removed from plate systems. 
                ...
                /**Returns  the blend radius. If @link Features::ShipDesign::ShipPreparationBuilder::RemoveBlends Features::ShipDesign::ShipPreparationBuilder::RemoveBlends@endlink  is true then blends that
                ...
                /**Sets  the blend radius. If @link Features::ShipDesign::ShipPreparationBuilder::RemoveBlends Features::ShipDesign::ShipPreparationBuilder::RemoveBlends@endlink  is true then blends that
                            that are less than or equal to this radius will be removed from plate systems. 
                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                ...
                /**Returns  the option to remove openings. If true, openings that fit inside a circle with diameter 
                            @link Features::ShipDesign::ShipPreparationBuilder::HoleDiameter Features::ShipDesign::ShipPreparationBuilder::HoleDiameter@endlink  will be removed from plate systems.
                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Returns  the hole diameter. If @link Features::ShipDesign::ShipPreparationBuilder::RemoveOpenings Features::ShipDesign::ShipPreparationBuilder::RemoveOpenings@endlink  is true then openings that
                ...
                /**Sets  the hole diameter. If @link Features::ShipDesign::ShipPreparationBuilder::RemoveOpenings Features::ShipDesign::ShipPreparationBuilder::RemoveOpenings@endlink  is true then openings that
                            fit inside a circle with this diameter will be removed from plate systems. 
                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                ...
                /** Creates wave links of CAE preparation boundary objects in the work part.
                 ...
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                public: void WaveLinkCaePrepareBoundary
                (
                    const std::vector<NXOpen::TaggedObject *> & boundarys /** boundarys */ 
                );
                ...
                /**Returns  the boundary objects. 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                public: NXOpen::SelectDisplayableObjectList * BoundaryObjects
                (
                );
                /** Assigns the mesh attributes to the plate system objects. 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                public: void AssignMeshAttributes
                (
                    NXOpen::Features::ShipDesign::ShipPreparationInfo * data /** The basic design data that was created. */
                );
                /** Caches component for CAE preparation. 
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : nx_ship_basic ("Ship Basic Design") */
                public: void CacheCaePrepareComponent
                (
