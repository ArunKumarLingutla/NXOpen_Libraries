    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PointSelectionRecipe : public NXOpen::CAE::SelectionRecipe
        {
            ...
            /**Returns  the point. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipePointStrategy::Point CAE::SelRecipePointStrategy::Point@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipePointStrategy::Point instead.") NXOpen::Point * Point
            (
            );
            /**Returns  the tolerance. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipePointStrategy::Tolerance CAE::SelRecipePointStrategy::Tolerance@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipePointStrategy::Tolerance instead.") double Tolerance
            (
            );
            ...
            /**Returns  the high label preference. False by default.If set to true, the node with the higher label will be picked, in case the recipe finds multiple nodes within tolerance 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipePointStrategy::ResolvePreference CAE::SelRecipePointStrategy::ResolvePreference@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipePointStrategy::ResolvePreference instead.") bool HighLabelPreference
            (
            );
