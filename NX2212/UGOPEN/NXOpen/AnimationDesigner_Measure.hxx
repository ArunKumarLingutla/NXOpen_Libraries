#ifndef NXOpen_ANIMATIONDESIGNER_MEASURE_HXX_INCLUDED
#define NXOpen_ANIMATIONDESIGNER_MEASURE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AnimationDesigner
    {
        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  Measure : public NXOpen::DisplayableObject
        {
