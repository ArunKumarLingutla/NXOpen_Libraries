#ifndef NXOpen_MECHATRONICS_SELECTADAPTERSIGNAL_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTADAPTERSIGNAL_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectAdapterSignal.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectAdapterSignalBuilder;
        class SelectAdapterSignalImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectAdapterSignal : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAdapterSignalImpl * m_selectadaptersignal_impl;
            private: friend class  _SelectAdapterSignalBuilder;
            protected: SelectAdapterSignal();
            public: ~SelectAdapterSignal();
            ...
            (
                NXOpen::Mechatronics::AdapterSignal * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::AdapterSignal * Value
            (
            );
            ...
            (
                ...
                NXOpen::Mechatronics::AdapterSignal * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Mechatronics::AdapterSignal * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Mechatronics::AdapterSignal * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
