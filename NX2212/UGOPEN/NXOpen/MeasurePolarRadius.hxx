#ifndef NXOpen_MEASUREPOLARRADIUS_HXX_INCLUDED
#define NXOpen_MEASUREPOLARRADIUS_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class Scalar;
    class SingleMeasure;
    class MeasurePolarRadiusImpl;
    /** Represents a single valued polar radius measurement 
     <br>  Created in NX8.5.0.  <br>  
    */
    class NXOPENCPPEXPORT  MeasurePolarRadius : public NXOpen::SingleMeasure
    {
        private: MeasurePolarRadiusImpl * m_measurepolarradius_impl;
        /// \cond NX_NO_DOC 
        public: explicit MeasurePolarRadius(void *ptr);
        /// \endcond 
