#ifndef NXOpen_CAE_XYPLOT_MATRIXGRAPH2D_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_MATRIXGRAPH2D_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            class _MatrixGraph2DBuilder;
            class MatrixGraph2DImpl;
            /** Manages the display matrix graph 2d.  <br> Not support KF.  <br> 
             <br>  Created in NX1847.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  MatrixGraph2D : public NXOpen::CAE::Xyplot::Graph, public virtual NXOpen::CAE::Xyplot::I3DDataGraph
            {
                private: MatrixGraph2DImpl * m_matrixgraph2d_impl;
                private: friend class  _MatrixGraph2DBuilder;
                protected: MatrixGraph2D();
                public: ~MatrixGraph2D();
