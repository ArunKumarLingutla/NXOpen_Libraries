#ifndef NXOpen_MECHATRONICS_SELECTSYSTEMOBJECT_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTSYSTEMOBJECT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectSystemObject.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        class SelectSystemObjectImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectSystemObject : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSystemObjectImpl * m_selectsystemobject_impl;
            private: friend class  _SelectSystemObjectBuilder;
            protected: SelectSystemObject();
            public: ~SelectSystemObject();
            ...
            (
                NXOpen::Mechatronics::SystemObject * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::SystemObject * Value
            (
            );
            ...
            (
                ...
                NXOpen::Mechatronics::SystemObject * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Mechatronics::SystemObject * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Mechatronics::SystemObject * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
