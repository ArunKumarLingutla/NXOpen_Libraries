#ifndef NXOpen_OPENXML_DOCUMENTDATAGROUP_HXX_INCLUDED
#define NXOpen_OPENXML_DOCUMENTDATAGROUP_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace OpenXml
    {
        class DocumentDataGroupImpl;
        /**  @brief  Contains methods for adding document data for CAE Report.  

          
         <br>  Created in NX11.0.0.  <br>  
        */
        class NXOPENCPP_OPENXMLEXPORT  DocumentDataGroup : public NXOpen::OpenXml::DocumentData
        {
            private: DocumentDataGroupImpl * m_documentdatagroup_impl;
            /// \cond NX_NO_DOC 
            public: explicit DocumentDataGroup(void *ptr);
            /// \endcond 
            ...
            public: virtual ~DocumentDataGroup();
            /** Creates a new @link NXOpen::OpenXml::TextDocumentData NXOpen::OpenXml::TextDocumentData@endlink  object.
                    ...
                    @link NXOpen::OpenXml::DocumentDataGroup NXOpen::OpenXml::DocumentDataGroup@endlink  object @return  the text data 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a new @link NXOpen::OpenXml::ImageGroupDocumentData NXOpen::OpenXml::ImageGroupDocumentData@endlink  object.
                    Does not to free this object, it will be free while deleting 
                    @link NXOpen::OpenXml::DocumentDataGroup NXOpen::OpenXml::DocumentDataGroup@endlink  object @return  the image group data 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            ...
            /** Creates a new @link NXOpen::OpenXml::TableDocumentData NXOpen::OpenXml::TableDocumentData@endlink  object.
                    Does not to free this object, it will be free while deleting 
                    @link NXOpen::OpenXml::DocumentDataGroup NXOpen::OpenXml::DocumentDataGroup@endlink  object @return  the table data 
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::OpenXml::TableDocumentData * AddTable
            (
                int columnCount /** the column size of the table*/,
                int rowCount /** the row size of the table*/
            );
            ...
            /** Gets the nth document data object.
                    Does not to free this object, it will be free while deleting 
                    @link NXOpen::OpenXml::DocumentDataGroup NXOpen::OpenXml::DocumentDataGroup@endlink  object @return  the data
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
