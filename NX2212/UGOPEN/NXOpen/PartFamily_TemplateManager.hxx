    ...
    namespace PartFamily
    {
        ...
        */
        class NXOPENCPP_PARTFAMILYEXPORT  TemplateManager : public NXOpen::TransientObject
        {
            ...
            /**Sets  the update mass properties flag value 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetUpdateMassProperties
            (
                bool isUpdateMassProperties /** isupdatemassproperties */ 
            );
            /**Returns  the update mass properties flag value 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: bool UpdateMassProperties
            (
            );
            ...
            /** Apply template release status to family members specified in input instDefsToApplyReleaseStatus. It returns success
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: std::vector<int> ApplyTemplateReleaseStatusToMembers
            (
                const std::vector<NXOpen::PartFamily::InstanceDefinition *> & instDefsToApplyReleaseStatus /** instdefstoapplyreleasestatus */ 
            );
            ...
            /**Sets  the function returns/sets the IdContext to be used while assigning alternate IDs 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetDefaultAlternateIdContext
            (
                const NXString & defaultContext /** defaultcontext */ 
            );
            /**Sets  the function returns/sets the IdContext to be used while assigning alternate IDs 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            (
                const char * defaultContext /** defaultcontext */ 
            );
            ...
            /**Sets  the function returns/sets the IdType to be used while assigning alternate IDs 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetDefaultAlternateIdType
            (
                const NXString & defaultType /** defaulttype */ 
            );
            /**Sets  the function returns/sets the IdType to be used while assigning alternate IDs 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            (
                const char * defaultType /** defaulttype */ 
            );
