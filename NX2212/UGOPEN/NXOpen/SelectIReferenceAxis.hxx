#ifndef NXOpen_SELECTIREFERENCEAXIS_HXX_INCLUDED
#define NXOpen_SELECTIREFERENCEAXIS_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectIReferenceAxisBuilder;
    class SelectIReferenceAxisImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectIReferenceAxis : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectIReferenceAxisImpl * m_selectireferenceaxis_impl;
        private: friend class  _SelectIReferenceAxisBuilder;
        protected: SelectIReferenceAxis();
        public: ~SelectIReferenceAxis();
        ...
        (
            NXOpen::IReferenceAxis * selection /** selected object */
        );
        /**Returns  the object being selected
            
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::IReferenceAxis * Value
        (
        );
        ...
        (
            ...
            NXOpen::IReferenceAxis * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /** first selected object point*/,
            NXOpen::IReferenceAxis * selection2 /** second selected object */,
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::IReferenceAxis * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
