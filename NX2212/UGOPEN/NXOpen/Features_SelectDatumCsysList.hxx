#ifndef NXOpen_FEATURES_SELECTDATUMCSYSLIST_HXX_INCLUDED
#define NXOpen_FEATURES_SELECTDATUMCSYSLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Features_SelectDatumCsysList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _SelectDatumCsysListBuilder;
        class SelectDatumCsysListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SelectDatumCsysList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDatumCsysListImpl * m_selectdatumcsyslist_impl;
            private: friend class  _SelectDatumCsysListBuilder;
            protected: SelectDatumCsysList();
            public: ~SelectDatumCsysList();
            ...
            public: bool Add
            (
                NXOpen::Features::DatumCsys * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Features::DatumCsys *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Features::DatumCsys * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Features::DatumCsys * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Features::DatumCsys * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Features::DatumCsys * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Features::DatumCsys *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Features::DatumCsys * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Features::DatumCsys *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::DatumCsys *> GetArray
            (
            );
