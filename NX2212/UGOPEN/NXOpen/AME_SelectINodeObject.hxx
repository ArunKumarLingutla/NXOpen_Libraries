#ifndef NXOpen_AME_SELECTINODEOBJECT_HXX_INCLUDED
#define NXOpen_AME_SELECTINODEOBJECT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _SelectINodeObjectBuilder;
        class SelectINodeObjectImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class AMEOPENCPPEXPORT  SelectINodeObject : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectINodeObjectImpl * m_selectinodeobject_impl;
            private: friend class  _SelectINodeObjectBuilder;
            protected: SelectINodeObject();
            public: ~SelectINodeObject();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::AME::INodeObject * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::AME::INodeObject * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
