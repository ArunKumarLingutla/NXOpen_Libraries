#ifndef NXOpen_FEATURES_SELECTDATUMCSYS_HXX_INCLUDED
#define NXOpen_FEATURES_SELECTDATUMCSYS_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _SelectDatumCsysBuilder;
        class SelectDatumCsysImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SelectDatumCsys : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDatumCsysImpl * m_selectdatumcsys_impl;
            private: friend class  _SelectDatumCsysBuilder;
            protected: SelectDatumCsys();
            public: ~SelectDatumCsys();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::DatumCsys * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Features::DatumCsys * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
