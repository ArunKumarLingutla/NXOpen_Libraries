        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleHiddenLinesBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the include model curves toggle on the HIDDEN LINES tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link Drawings::ViewStyleHiddenLinesBuilder::IncludeModelCurvesOption Drawings::ViewStyleHiddenLinesBuilder::IncludeModelCurvesOption@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use Drawings::ViewStyleHiddenLinesBuilder::IncludeModelCurvesOption instead.") bool IncludeModelCurves
            (
            );
            /**Sets  the include model curves toggle on the HIDDEN LINES tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link Drawings::ViewStyleHiddenLinesBuilder::SetIncludeModelCurvesOption Drawings::ViewStyleHiddenLinesBuilder::SetIncludeModelCurvesOption@endlink  instead. <br>  

             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use Drawings::ViewStyleHiddenLinesBuilder::SetIncludeModelCurvesOption instead.") void SetIncludeModelCurves
            (
            ...
            /**Returns  the include model curves option on the HIDDEN LINES tab of the View Style Dialog 
             ...
             <br> License requirements : None */
            public: NXOpen::Preferences::IncludeModelCurvesOption IncludeModelCurvesOption
            (
            );
            /**Sets  the include model curves option on the HIDDEN LINES tab of the View Style Dialog 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: void SetIncludeModelCurvesOption
            (
                NXOpen::Preferences::IncludeModelCurvesOption includeModelCurvesPointsOptionData /** Sets a new include model curves option on the hidden line sub-builder */
            );
