#ifndef NXOpen_DIE_PIERCEITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_DIE_PIERCEITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Die
    {
        class _PierceItemBuilderListBuilder;
        class PierceItemBuilderListImpl;
        ...
        */
        class NXOPENCPP_DIEEXPORT  PierceItemBuilderList : public NXOpen::TaggedObject
        {
            private: PierceItemBuilderListImpl * m_pierceitembuilderlist_impl;
            private: friend class  _PierceItemBuilderListBuilder;
            protected: PierceItemBuilderList();
            public: ~PierceItemBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Die::PierceItemBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Die::PierceItemBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Die::PierceItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Die::PierceItemBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Die::PierceItemBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Die::PierceItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Die::PierceItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Die::PierceItemBuilder * object1 /** first item */,
                NXOpen::Die::PierceItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Die::PierceItemBuilder * object /** object to be inserted */
            );
