...
namespace NXOpen
{
    ...
    class SelectFaceListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectFaceList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectFaceListImpl * m_selectfacelist_impl;
        private: friend class  _SelectFaceListBuilder;
        protected: SelectFaceList();
        public: ~SelectFaceList();
        ...
        (
            const std::vector<NXOpen::Face *> & objects /** Objects to remove */
        );
