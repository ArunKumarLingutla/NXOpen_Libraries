        ...
        */
        class NXOPENCPP_PDMEXPORT  TcinUtils
        {
            ...
            /** This is an internal API and can be changed at any time 
             <br>  @deprecated Deprecated in NX1872.0.0.  Use @link NXOpen::PDM::TcinUtils::CreatePCAExpressions NXOpen::PDM::TcinUtils::CreatePCAExpressions@endlink  instead <br>  

             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1872.0.0.  Use NXOpen::PDM::TcinUtils::CreatePCAExpressions instead") void CreateVariantExpressions
            (
                const std::vector<NXOpen::Part *> & parts /** parts to create expressions on */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : None */
            public: void CreatePCAExpressions
            (
                const std::vector<NXOpen::Part *> & parts /** parts to create expressions on */
            );
