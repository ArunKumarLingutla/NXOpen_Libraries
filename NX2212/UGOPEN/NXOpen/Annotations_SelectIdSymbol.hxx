#ifndef NXOpen_ANNOTATIONS_SELECTIDSYMBOL_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTIDSYMBOL_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectIdSymbolBuilder;
        class SelectIdSymbolImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectIdSymbol : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectIdSymbolImpl * m_selectidsymbol_impl;
            private: friend class  _SelectIdSymbolBuilder;
            protected: SelectIdSymbol();
            public: ~SelectIdSymbol();
            ...
            (
                NXOpen::Annotations::IdSymbol * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::IdSymbol * Value
            (
            );
            ...
            (
                ...
                NXOpen::Annotations::IdSymbol * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Annotations::IdSymbol * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Annotations::IdSymbol * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
