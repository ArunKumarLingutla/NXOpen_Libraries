...
namespace NXOpen
{
    ...
    namespace UIStyler
    {
        ...
        enum DialogResponse
        {
            DialogResponsePickResponse/** User response was a selection of objects.*/ = 1,
        ...
        enum DialogIndex
        {
            DialogIndexNoSubIndex/** All sub items are selected.*/ = -1
        };
    ...
    namespace UIStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  Dialog : public NXOpen::TransientObject
        {
            ...
            (
                const NXString & itemIdentifier /** Dialog name */
            );
            /** Gets the dialog item with specified item identifier  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                const char * itemIdentifier /** Dialog name */
            );
            /** Gets the dialog item with specified item identifier  @return  
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
