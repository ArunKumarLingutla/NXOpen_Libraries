#ifndef NXOpen_BODYLIST_HXX_INCLUDED
#define NXOpen_BODYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  BodyList : public NXOpen::TaggedObject
    {
        private: BodyListImpl * m_bodylist_impl;
        private: friend class  _BodyListBuilder;
        protected: BodyList();
        public: ~BodyList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::Body *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::Body * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::Body * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Body *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::Body *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::Body * object1 /** first item */,
            NXOpen::Body * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::Body * object /** object to be inserted */
        );
