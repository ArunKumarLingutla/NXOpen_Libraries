...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        90 (millimeters part), 90 (inches part) </description> </item> 

        <item><term> 
         
        OrbitSize.Value </term> <description> 
         
        0.05 (millimeters part), 0.002 (inches part) </description> </item> 

        <item><term> 
         
        OrbitType </term> <description> 
         
        Circular </description> </item> 

        <item><term> 
         
        SparkGap.Value </term> <description> 
