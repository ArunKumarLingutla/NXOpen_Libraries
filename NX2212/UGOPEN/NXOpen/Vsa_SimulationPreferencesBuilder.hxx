    ...
    namespace Vsa
    {
        ...
        */
        class NXOPENCPP_VSAEXPORT  SimulationPreferencesBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the property represents Animate Feature Simulation flag. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool AnimateFeatureSimulation
            (
            );
            /**Sets  the property represents Animate Feature Simulation flag. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetAnimateFeatureSimulation
            (
                bool animateFeatureSimulation /** animatefeaturesimulation */ 
            );
            /**Returns  the property represents Animate Part Simulation flag. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: bool AnimatePartSimulation
            (
            );
            /**Sets  the property represents Animate Part Simulation flag. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            public: void SetAnimatePartSimulation
            (
                bool animatPartSimulation /** animatpartsimulation */ 
            );
