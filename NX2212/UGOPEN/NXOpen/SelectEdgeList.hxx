#ifndef NXOpen_SELECTEDGELIST_HXX_INCLUDED
#define NXOpen_SELECTEDGELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectEdgeListBuilder;
    class SelectEdgeListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectEdgeList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectEdgeListImpl * m_selectedgelist_impl;
        private: friend class  _SelectEdgeListBuilder;
        protected: SelectEdgeList();
        public: ~SelectEdgeList();
        ...
        public: bool Add
        (
            NXOpen::Edge * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Edge *> & objects /** objects to add */
        );
        ...
        public: bool Remove
        (
            NXOpen::Edge * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Edge *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Edge * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Edge *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Edge *> GetArray
        (
        );
