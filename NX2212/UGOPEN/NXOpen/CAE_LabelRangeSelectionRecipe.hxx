        ...
        */
        class NXOPENCPP_CAEEXPORT  LabelRangeSelectionRecipe : public NXOpen::CAE::SelectionRecipe
        {
            ...
            /** Get the labels and label ranges. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeLabelRangeStrategy::GetLabelRanges CAE::SelRecipeLabelRangeStrategy::GetLabelRanges@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeLabelRangeStrategy::GetLabelRanges instead.") void GetLabelRanges
            (
            ...
            /** Set the labels and label ranges. 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link CAE::SelRecipeLabelRangeStrategy::SetLabelRanges CAE::SelRecipeLabelRangeStrategy::SetLabelRanges@endlink  instead. <br>  

             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use CAE::SelRecipeLabelRangeStrategy::SetLabelRanges instead.") void SetLabelRanges
            (
