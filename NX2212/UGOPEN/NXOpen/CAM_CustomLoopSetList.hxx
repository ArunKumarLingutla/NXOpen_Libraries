#ifndef NXOpen_CAM_CUSTOMLOOPSETLIST_HXX_INCLUDED
#define NXOpen_CAM_CUSTOMLOOPSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _CustomLoopSetListBuilder;
        class CustomLoopSetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  CustomLoopSetList : public NXOpen::TaggedObject
        {
            private: CustomLoopSetListImpl * m_customloopsetlist_impl;
            private: friend class  _CustomLoopSetListBuilder;
            protected: CustomLoopSetList();
            public: ~CustomLoopSetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::CustomLoopSet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::CustomLoopSet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::CustomLoopSet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CustomLoopSet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::CustomLoopSet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::CustomLoopSet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::CustomLoopSet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::CustomLoopSet * object1 /** first item */,
                NXOpen::CAM::CustomLoopSet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::CustomLoopSet * object /** object to be inserted */
            );
