...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ObjectList : public NXOpen::TaggedObject
    {
        /** Used to indicate whether to delete the object
                when removing it from the list.*/
        public: enum DeleteOption
        {
            DeleteOptionDelete/** Delete the object */,
            DeleteOptionNoDelete/** Remove the object without deleting it */
        };

        private: ObjectListImpl * m_objectlist_impl;
