...
#include <NXOpen/CAE_SimLoadRecipeFunctionAttributes.hxx>
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimLoadRecipeSource : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the default attributes (@link NXOpen::CAE::SimLoadRecipeFunctionAttributes NXOpen::CAE::SimLoadRecipeFunctionAttributes@endlink ) 
                        of a @link NXOpen::CAE::SimLoadRecipeSource NXOpen::CAE::SimLoadRecipeSource@endlink  which are used to indicate the attributes
                        of the functions in the data source. This might return null, which means that the format handler
                        takes care of managing those attributes on its own (this is the case for Test.Lab files).
                    
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::SimLoadRecipeFunctionAttributes * DefaultFunctionAttributes
            (
            );
        };
    }
