#ifndef NXOpen_SELECTIBASEPLANELIST_HXX_INCLUDED
#define NXOpen_SELECTIBASEPLANELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectIBasePlaneListBuilder;
    class SelectIBasePlaneListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectIBasePlaneList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectIBasePlaneListImpl * m_selectibaseplanelist_impl;
        private: friend class  _SelectIBasePlaneListBuilder;
        protected: SelectIBasePlaneList();
        public: ~SelectIBasePlaneList();
        ...
        public: bool Add
        (
            NXOpen::IBasePlane * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::IBasePlane *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::IBasePlane * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::IBasePlane * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::IBasePlane * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::IBasePlane * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::IBasePlane *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::IBasePlane * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::IBasePlane *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::IBasePlane *> GetArray
        (
        );
