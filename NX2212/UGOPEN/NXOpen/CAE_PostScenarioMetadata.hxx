    ...
    namespace CAE
    {
        ...
        /**  @brief  This class represents a @link NXOpen::CAE::PostScenarioQueryResults NXOpen::CAE::PostScenarioQueryResults@endlink .  
                ...
                <ul>
                    ...
                    <li>Converted -- Unicode String</li>
                    <li>ConvertedError -- Unicode String</li>
                </ul>
                 <br> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostScenarioMetadata : public NXOpen::TransientObject
        {
            ...
            (
                ...
                NXString* displayName /** The display name of the @link NXOpen::CAE::PostScenarioDefinition NXOpen::CAE::PostScenarioDefinition@endlink  used to perform the query. */
            );
            ...
            (
                ...
                const NXString & displayName /** The display name of the @link NXOpen::CAE::PostScenarioDefinition NXOpen::CAE::PostScenarioDefinition@endlink  used to perform the query. */
            );
            /** Sets the origin of a @link NXOpen::CAE::PostScenarioResultGroup NXOpen::CAE::PostScenarioResultGroup@endlink  in the context of a transformation function. 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                ...
                const char * displayName /** The display name of the @link NXOpen::CAE::PostScenarioDefinition NXOpen::CAE::PostScenarioDefinition@endlink  used to perform the query. */
            );
            ...
            /// \endcond 
            /**Returns  the conversion marker set by a coordinate system transformation.
                    This value is empty if no conversion took place. See @link CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation@endlink . 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXString Converted
            (
            );
            /**Sets  the conversion marker set by a coordinate system transformation.
                    This value is empty if no conversion took place. See @link CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation@endlink . 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetConverted
            (
                const NXString & displayName /** Sets the coordinate system conversion status */
            );
            /**Sets  the conversion marker set by a coordinate system transformation.
                    This value is empty if no conversion took place. See @link CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation@endlink . 
             <br>  Created in NX2007.0.0.  <br>  
            ...
            void SetConverted
            (
                const char * displayName /** Sets the coordinate system conversion status */
            );
            /**Returns  the coordinate system conversion error set by a coordinate system transformation.
                    This value being set may indicate why a coordinate system conversion failed. See @link CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation@endlink . 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXString ConvertedError
            (
            );
            /**Sets  the coordinate system conversion error set by a coordinate system transformation.
                    This value being set may indicate why a coordinate system conversion failed. See @link CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation CAE::PostScenarioQueryContext::NewCoordinateSystemTransformation@endlink . 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetConvertedError
            (
                const NXString & displayName /** Sets the coordinate system conversion status */
            );
            /**Sets  the coordinate system conversion error set by a coordinate system transformation.
