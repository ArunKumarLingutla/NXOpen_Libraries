#ifndef NXOpen_WELD_SELECTDATUMSURFACE_HXX_INCLUDED
#define NXOpen_WELD_SELECTDATUMSURFACE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Weld
    {
        class _SelectDatumSurfaceBuilder;
        class SelectDatumSurfaceImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  SelectDatumSurface : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDatumSurfaceImpl * m_selectdatumsurface_impl;
            private: friend class  _SelectDatumSurfaceBuilder;
            protected: SelectDatumSurface();
            public: ~SelectDatumSurface();
            ...
            (
                NXOpen::Weld::DatumSurface * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Weld::DatumSurface * Value
            (
            );
            ...
            (
                ...
                NXOpen::Weld::DatumSurface * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Weld::DatumSurface * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Weld::DatumSurface * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
