#ifndef NXOpen_MOTION_SEGMENTBUILDERLIST_HXX_INCLUDED
#define NXOpen_MOTION_SEGMENTBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SegmentBuilderListBuilder;
        class SegmentBuilderListImpl;
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  SegmentBuilderList : public NXOpen::TaggedObject
        {
            private: SegmentBuilderListImpl * m_segmentbuilderlist_impl;
            private: friend class  _SegmentBuilderListBuilder;
            protected: SegmentBuilderList();
            public: ~SegmentBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Motion::SegmentBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Motion::SegmentBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Motion::SegmentBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::SegmentBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Motion::SegmentBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Motion::SegmentBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Motion::SegmentBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Motion::SegmentBuilder * object1 /** first item */,
                NXOpen::Motion::SegmentBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Motion::SegmentBuilder * object /** object to be inserted */
            );
