#ifndef NXOpen_NXOBJECTLIST_HXX_INCLUDED
#define NXOpen_NXOBJECTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    class NXObjectList;
    class NXObject;
    class _NXObjectListBuilder;
    class NXObjectListImpl;
    ...
    */
    class NXOPENCPPEXPORT  NXObjectList : public NXOpen::TaggedObject
    {
        private: NXObjectListImpl * m_nxobjectlist_impl;
        private: friend class  _NXObjectListBuilder;
        protected: NXObjectList();
        public: ~NXObjectList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::NXObject *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::NXObject * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::NXObject * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::NXObject *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::NXObject *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::NXObject * object1 /** first item */,
            NXOpen::NXObject * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::NXObject * object /** object to be inserted */
        );
