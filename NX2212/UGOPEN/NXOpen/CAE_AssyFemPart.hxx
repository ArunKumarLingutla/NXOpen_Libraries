    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  AssyFemPart : public NXOpen::CAE::BaseFemPart
        {
            ...
            /** Creates a @link NXOpen::CAE::AssemblyLabelManagerBuilder NXOpen::CAE::AssemblyLabelManagerBuilder@endlink   @return  The AssemblyLabelManagerBuilder object 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::AssemblyLabelManagerBuilder * CreateAssemblyLabelManagerBuilder
            (
            );
        };
    }
