        ...
        */
        class AMEOPENCPPEXPORT  OpticalConnectionSettingsBuilder : public NXOpen::Builder
        {
            ...
            /** Validate matching rules for selected connection product 
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: bool ValidateMatchingRules
            (
                const NXString & potentialTypeValue /** potentialtypevalue */ ,
                const NXString & propertyToValidate /** propertytovalidate */ ,
                NXOpen::AME::ProductDefinition * prodDef /** proddef */ 
            );
            /** Validate matching rules for selected connection product 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            bool ValidateMatchingRules
            (
                const char * potentialTypeValue /** potentialtypevalue */ ,
                const char * propertyToValidate /** propertytovalidate */ ,
                NXOpen::AME::ProductDefinition * prodDef /** proddef */ 
            );
            /** Assign selected connection product 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetDefaultConnectionProduct
            (
                NXOpen::AME::AmeOpticalConnectionFiberType fiberType /** fibertype */ ,
                NXOpen::AME::ProductDefinition * prodDef /** proddef */ 
            );
            ...
            /** Get assigned connection product for provided connection subtype in Connection Project Settings
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: NXOpen::AME::ProductDefinition * GetDefaultConnectionProduct
            (
                NXOpen::AME::AmeOpticalConnectionFiberType fiberType /** fibertype */ 
            );
            /** Remove the assigned product from provided connection subtype 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void RemoveConnectionProductAssignment
            (
                NXOpen::AME::AmeOpticalConnectionFiberType fiberType /** fibertype */ 
            );
        };
