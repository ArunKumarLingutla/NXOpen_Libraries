#ifndef NXOpen_BLOCKSTYLER_SPECIFYPOINT_HXX_INCLUDED
#define NXOpen_BLOCKSTYLER_SPECIFYPOINT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        class _SpecifyPointBuilder;
        class SpecifyPointImpl;
        /** Represents a Specify Point block
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENUICPPEXPORT  SpecifyPoint : public NXOpen::BlockStyler::UIBlock
        {
            private: SpecifyPointImpl * m_specifypoint_impl;
            private: friend class  _SpecifyPointBuilder;
            ...
            /**Returns  the SelectionView
             ...
             <br> License requirements : None */
            public: NXOpen::View * SelectionView
            (
            );
            ...
            (
                NXOpen::TaggedObject * objectVector /**Value to set for the property*/
            );
            /** Tests the point specified for this block. The block must be in focus to call this API
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: void TestPointSpecified
            (
                const NXOpen::Point3d & point /** point */ 
            );
        };
