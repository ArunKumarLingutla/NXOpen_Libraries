    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  FamilyMoldBuilder : public NXOpen::Builder
        {
            ...
            /**Adds a deleted item name to delete item list 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            public: void AddItemToDeletedList
            (
                const NXString & detetedItem /** deteteditem */ 
            );
            /**Adds a deleted item name to delete item list 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") */
            void AddItemToDeletedList
            (
                const char * detetedItem /** deteteditem */ 
            );
        };
    }
}
