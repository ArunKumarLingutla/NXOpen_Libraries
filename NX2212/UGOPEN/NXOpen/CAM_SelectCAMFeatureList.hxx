#ifndef NXOpen_CAM_SELECTCAMFEATURELIST_HXX_INCLUDED
#define NXOpen_CAM_SELECTCAMFEATURELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _SelectCAMFeatureListBuilder;
        class SelectCAMFeatureListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  SelectCAMFeatureList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectCAMFeatureListImpl * m_selectcamfeaturelist_impl;
            private: friend class  _SelectCAMFeatureListBuilder;
            protected: SelectCAMFeatureList();
            public: ~SelectCAMFeatureList();
            ...
            public: bool Add
            (
                NXOpen::CAM::CAMFeature * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAM::CAMFeature *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAM::CAMFeature * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAM::CAMFeature * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::CAM::CAMFeature * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::CAM::CAMFeature * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::CAM::CAMFeature *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAM::CAMFeature * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAM::CAMFeature *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::CAMFeature *> GetArray
            (
            );
