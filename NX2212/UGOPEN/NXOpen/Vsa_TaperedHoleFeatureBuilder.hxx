#ifndef NXOpen_VSA_TAPEREDHOLEFEATUREBUILDER_HXX_INCLUDED
#define NXOpen_VSA_TAPEREDHOLEFEATUREBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Vsa_TaperedHoleFeatureBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Vsa
    {
        class _TaperedHoleFeatureBuilderBuilder;
        class TaperedHoleFeatureBuilderImpl;
        /**
        ...
        */
        class NXOPENCPP_VSAEXPORT  TaperedHoleFeatureBuilder : public NXOpen::Builder
        {
            /**
            ...
            private: TaperedHoleFeatureBuilderImpl * m_taperedholefeaturebuilder_impl;
            private: friend class  _TaperedHoleFeatureBuilderBuilder;
            protected: TaperedHoleFeatureBuilder();
            public: ~TaperedHoleFeatureBuilder();
            ...
            /**Returns  the enum size 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedHoleFeatureBuilder::APIEnumSize EnumSize
            (
            );
            /**Sets  the enum size 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedHoleFeatureBuilder::APIEnumSize enumSize /** enumsize */ 
            );
            ...
            /**Returns  the enum loc 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedHoleFeatureBuilder::APIEnumLoc EnumLoc
            (
            );
            /**Sets  the enum loc 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedHoleFeatureBuilder::APIEnumLoc enumLoc /** enumloc */ 
            );
            ...
            /**Returns  the enum form 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedHoleFeatureBuilder::APIEnumForm EnumForm
            (
            );
            /**Sets  the enum form 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedHoleFeatureBuilder::APIEnumForm enumForm /** enumform */ 
            );
