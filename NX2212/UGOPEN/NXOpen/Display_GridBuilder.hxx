        ...
        */
        class NXOPENCPP_DISPLAYEXPORT  GridBuilder : public NXOpen::Builder
        {
            ...
            public: enum LineStyleType
            {
                ...
                LineStyleTypeEight/** Long Dashed Double Dotted */,
                LineStyleTypeNine/** Long Dashed Dotted for OOTB fonts and Undulating for shipbuilding fonts */,
                LineStyleTypeTen/** Long Dashed Triplicate Dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
                LineStyleTypeEleven/** Long Dashed Double Short Dashed for OOTB fonts and Railway for shipbuilding fonts */
            };
