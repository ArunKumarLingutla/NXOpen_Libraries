#ifndef NXOpen_TOOLING_COUNTERBORINGINSERTBUILDER_HXX_INCLUDED
#define NXOpen_TOOLING_COUNTERBORINGINSERTBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Tooling_CounterboringInsertBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class _CounterboringInsertBuilderBuilder;
        class CounterboringInsertBuilderImpl;
        /** Represents counterboring insert builder.  <br> To create a new instance of this class, use @link NXOpen::Tooling::ProgressiveDieManager::CreateCounterboringInsertBuilder  NXOpen::Tooling::ProgressiveDieManager::CreateCounterboringInsertBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  CounterboringInsertBuilder : public NXOpen::Builder
        {
            ...
            {
                FaceEdgeTypeOptionCircle/** circle */ 
            };

            private: CounterboringInsertBuilderImpl * m_counterboringinsertbuilder_impl;
            private: friend class  _CounterboringInsertBuilderBuilder;
            protected: CounterboringInsertBuilder();
            public: ~CounterboringInsertBuilder();
            ...
            /**Returns  the parent part 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::CounterboringInsertBuilder::ParentPartNodeOption ParentPartNode
            (
            );
            ...
            (
                NXOpen::Tooling::CounterboringInsertBuilder::ParentPartNodeOption parentPartNode /** parentpartnode */ 
            );
            /**Returns  the face edge type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::CounterboringInsertBuilder::FaceEdgeTypeOption FaceEdgeType
            (
            );
            ...
            (
                NXOpen::Tooling::CounterboringInsertBuilder::FaceEdgeTypeOption faceEdgeType /** faceedgetype */ 
            );
            /**Returns  the insert type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::CounterboringInsertBuilder::InsertTypeOption InsertType
            (
            );
            ...
            (
                NXOpen::Tooling::CounterboringInsertBuilder::InsertTypeOption insertType /** inserttype */ 
            );
            /** Create counterboring insert by standard insert method. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
