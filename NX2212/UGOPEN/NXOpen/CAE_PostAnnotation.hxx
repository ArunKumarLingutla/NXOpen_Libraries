    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostAnnotation : public NXOpen::TransientObject
        {
            ...
            /** Annotation combine option */
            public: enum CombineOption
            {
                CombineOptionNone/** none */ ,
                CombineOptionAverage/** average */ ,
                CombineOptionMinimum/** minimum */ ,
                CombineOptionMaximum/** maximum */ ,
                CombineOptionSum/** sum */ ,
                CombineOptionAbsoluteMinimum/** absolute minimum */ ,
                CombineOptionAbsoluteMaximum/** absolute maximum */ ,
                CombineOptionSignedAbsoluteMinimum/** signed absolute minimum */ ,
                CombineOptionSignedAbsoluteMaximum/** signed absolute maximum */ ,
                CombineOptionRootMeanSquare/** root mean square */ ,
                CombineOptionRootSumSquare/** root sum square */ 
            };
            ...
            /** The annotation combine option @return   
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") OR sc_results_viewer (" Simcenter Results Viewer") */
            public: NXOpen::CAE::PostAnnotation::CombineOption GetCombineAcrossEntitiesOption
            (
            );
