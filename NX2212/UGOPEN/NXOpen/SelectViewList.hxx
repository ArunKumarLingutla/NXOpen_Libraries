#ifndef NXOpen_SELECTVIEWLIST_HXX_INCLUDED
#define NXOpen_SELECTVIEWLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectViewListBuilder;
    class SelectViewListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectViewList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectViewListImpl * m_selectviewlist_impl;
        private: friend class  _SelectViewListBuilder;
        protected: SelectViewList();
        ...
        public: bool Add
        (
            NXOpen::View * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::View *> & objects /** objects to add */
        );
        ...
        public: bool Remove
        (
            NXOpen::View * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::View *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::View * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::View *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::View *> GetArray
        (
        );
