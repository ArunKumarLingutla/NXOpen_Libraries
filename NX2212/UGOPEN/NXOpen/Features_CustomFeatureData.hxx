    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  CustomFeatureData : public NXOpen::TransientObject
        {
            ...
            /** Remove the custom feature attribute, note that attribute should not be refering to any other @link NXOpen::NXObject NXOpen::NXObject@endlink  at time of removal.
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void RemoveCustomAttribute
            (
                NXOpen::Features::CustomAttribute * attribute /** attribute */ 
            );
