...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  Path : public NXOpen::NXObject, public virtual NXOpen::Routing::IPath
        {
            private: PathImpl * m_path_impl;
            private: friend class  _PathBuilder;
            protected: Path();
            public: ~Path();
            /** Returns the combined length of all the segments in this path.  @return  The combined length of all the segments in this path. 
