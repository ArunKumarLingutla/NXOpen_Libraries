#ifndef NXOpen_CAM_SELECTCAMFEATURE_HXX_INCLUDED
#define NXOpen_CAM_SELECTCAMFEATURE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _SelectCAMFeatureBuilder;
        class SelectCAMFeatureImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  SelectCAMFeature : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectCAMFeatureImpl * m_selectcamfeature_impl;
            private: friend class  _SelectCAMFeatureBuilder;
            protected: SelectCAMFeature();
            public: ~SelectCAMFeature();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CAMFeature * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::CAM::CAMFeature * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
