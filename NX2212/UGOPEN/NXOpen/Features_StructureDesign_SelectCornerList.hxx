#ifndef NXOpen_FEATURES_STRUCTUREDESIGN_SELECTCORNERLIST_HXX_INCLUDED
#define NXOpen_FEATURES_STRUCTUREDESIGN_SELECTCORNERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Features_StructureDesign_SelectCornerList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        namespace StructureDesign
        {
            class _SelectCornerListBuilder;
            class SelectCornerListImpl;
            /** Represents a list of objects on a selection list.

             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_FEATURESEXPORT  SelectCornerList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                private: SelectCornerListImpl * m_selectcornerlist_impl;
                private: friend class  _SelectCornerListBuilder;
                protected: SelectCornerList();
                public: ~SelectCornerList();
                ...
                public: bool Add
                (
                    NXOpen::Features::StructureDesign::Corner * object /** object to add */
                );
                ...
                public: bool Add
                (
                    const std::vector<NXOpen::Features::StructureDesign::Corner *> & objects /** objects to add */
                );
                ...
                public: bool Add
                (
                    NXOpen::Features::StructureDesign::Corner * selection /** selected object */,
                ...
                public: bool Remove
                (
                    NXOpen::Features::StructureDesign::Corner * object /** Object to remove */
                );
                /** Remove specified object from list.
                     @return  True if successfully removed from list;
                ...
                (
                    ...
                    NXOpen::Features::StructureDesign::Corner * selection1 /** first selected object */,
                    NXOpen::View * view1 /** first selected object view*/,
                    const NXOpen::Point3d & point1 /**first  selected object point*/,
                    NXOpen::Features::StructureDesign::Corner * selection2 /** second selected object */,
                ...
                (
                    const std::vector<NXOpen::Features::StructureDesign::Corner *> & objects /** Objects to remove */
                );
                ...
                (
                    NXOpen::Features::StructureDesign::Corner * object /** object to check */
                );
                ...
                (
                    const std::vector<NXOpen::Features::StructureDesign::Corner *> & objects /** items to put in the list*/
                );
                /** Returns the list of objects in the selection list.
                     @return  items in list 
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::Features::StructureDesign::Corner *> GetArray
                (
                );
