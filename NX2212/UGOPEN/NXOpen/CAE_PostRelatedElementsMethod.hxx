#ifndef NXOpen_CAE_POSTRELATEDELEMENTSMETHOD_HXX_INCLUDED
#define NXOpen_CAE_POSTRELATEDELEMENTSMETHOD_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     CAE_PostRelatedElementsMethod.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class PostRelatedElementsMethodImpl;
        /** Represents a method object on post group.  <br> Not support KF.  <br> 
         <br>  Created in NX2007.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  PostRelatedElementsMethod : public NXOpen::CAE::PostISmartSelectorMethod
        {
            private: PostRelatedElementsMethodImpl * m_postrelatedelementsmethod_impl;
            /// \cond NX_NO_DOC 
            public: explicit PostRelatedElementsMethod(void *ptr);
            /// \endcond 
            /** Returns the resultant element entities.
