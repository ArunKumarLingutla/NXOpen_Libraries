#ifndef NXOpen_CAM_GEOMETRYSETLIST_HXX_INCLUDED
#define NXOpen_CAM_GEOMETRYSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _GeometrySetListBuilder;
        class GeometrySetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  GeometrySetList : public NXOpen::TaggedObject
        {
            private: GeometrySetListImpl * m_geometrysetlist_impl;
            private: friend class  _GeometrySetListBuilder;
            protected: GeometrySetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::GeometrySet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::GeometrySet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::GeometrySet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::GeometrySet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::GeometrySet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::GeometrySet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::GeometrySet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::GeometrySet * object1 /** first item */,
                NXOpen::CAM::GeometrySet * object2 /** second item */
            );
