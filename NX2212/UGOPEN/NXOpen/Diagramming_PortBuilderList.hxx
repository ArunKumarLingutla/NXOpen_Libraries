#ifndef NXOpen_DIAGRAMMING_PORTBUILDERLIST_HXX_INCLUDED
#define NXOpen_DIAGRAMMING_PORTBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Diagramming_PortBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Diagramming
    {
        class _PortBuilderListBuilder;
        class PortBuilderListImpl;
        ...
        */
        class NXOPENCPP_DIAGRAMMINGEXPORT  PortBuilderList : public NXOpen::TaggedObject
        {
            private: PortBuilderListImpl * m_portbuilderlist_impl;
            private: friend class  _PortBuilderListBuilder;
            protected: PortBuilderList();
            public: ~PortBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Diagramming::PortBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Diagramming::PortBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Diagramming::PortBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Diagramming::PortBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Diagramming::PortBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Diagramming::PortBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Diagramming::PortBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Diagramming::PortBuilder * object1 /** first item */,
                NXOpen::Diagramming::PortBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Diagramming::PortBuilder * object /** object to be inserted */
            );
