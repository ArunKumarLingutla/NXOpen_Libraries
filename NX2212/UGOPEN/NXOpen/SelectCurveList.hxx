#ifndef NXOpen_SELECTCURVELIST_HXX_INCLUDED
#define NXOpen_SELECTCURVELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectCurveListBuilder;
    class SelectCurveListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectCurveList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectCurveListImpl * m_selectcurvelist_impl;
        private: friend class  _SelectCurveListBuilder;
        protected: SelectCurveList();
        public: ~SelectCurveList();
        ...
        public: bool Add
        (
            NXOpen::Curve * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Curve *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::Curve * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::Curve * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Curve *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Curve * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Curve *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Curve *> GetArray
        (
        );
