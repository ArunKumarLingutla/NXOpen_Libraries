    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  BlankIpwMultipleSource : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the additional blank geometry collector 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * AdditionalGeometryCollector
            (
            );
            /** Get the blank IPW status  @return  the blank ipw status 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BlankIpwMultipleSource::StatusTypes GetStatus
            (
            );
        };
    }
