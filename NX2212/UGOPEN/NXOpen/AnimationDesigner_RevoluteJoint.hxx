#ifndef NXOpen_ANIMATIONDESIGNER_REVOLUTEJOINT_HXX_INCLUDED
#define NXOpen_ANIMATIONDESIGNER_REVOLUTEJOINT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     AnimationDesigner_RevoluteJoint.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace AnimationDesigner
    {
        ...
        */
        class ANIMATIONDESIGNEROPENCPPEXPORT  RevoluteJoint : public NXOpen::AnimationDesigner::PhysicsJoint
        {
            private: RevoluteJointImpl * m_revolutejoint_impl;
            private: friend class  _RevoluteJointBuilder;
