...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        ...
        */
        class NXOPENUICPPEXPORT  Tree : public NXOpen::BlockStyler::UIBlock
        {
            ...
            (
                ...
                NXOpen::BlockStyler::Node * parentNode /**Parent node under which new node is supposed to be placed. To add the first node, pass as NXOpen.BlockStyler.Node.Null */,
                NXOpen::BlockStyler::Node * afterNode /**New node placed after this node. If there is mismatch between parent-node and after-node then former is honoured. To add the first node, pass as NXOpen.BlockStyler.Node.Null*/,
            ...
            (
                ...
                int columnWidth /**Providing value less than zero will set the default width of 0 for the column.*/
            );
            /** Inserts a column.
            ...
            /**Returns  the CanStretchWidth. If true, width of TreeList block will change.
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: bool CanStretchWidth
            (
            );
            /**Sets  the CanStretchWidth. If true, width of TreeList block will change.
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: void SetCanStretchWidth
            (
                bool stretchWidth /** stretchwidth */ 
            );
            /**Returns  the Width
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            ...
            (
                NXOpen::BlockStyler::Node * newNode /** newnode */ ,
                NXOpen::BlockStyler::Node * parentNode /** parentnode */ ,
                NXOpen::BlockStyler::Node * afterNode /** afternode */ ,
                NXOpen::BlockStyler::Tree::NodeInsertOption nodeInsertOption /** nodeinsertoption */ 
            );
            ...
            (
                NXOpen::BlockStyler::Node * node /** node */ ,
                bool isSelect /** isselect */ ,
                bool isOtherNodeAffected /** isothernodeaffected */ 
            );
            ...
            (
                ...
                NXOpen::BlockStyler::Node * node1 /** node1 */ ,
                NXOpen::BlockStyler::Node * node2 /** node2 */ ,
                NXOpen::BlockStyler::Tree::ColumnSortOption sortOption /** sortoption */ 
            );
            ...
            (
                NXOpen::BlockStyler::Node * node /** node */ ,
                NXOpen::BlockStyler::Node::ExpandOption expandOption /** expandoption */ 
            );
            ...
            (
                NXOpen::BlockStyler::Node * node /** node */ ,
                int columnID /** columnid */ ,
                NXOpen::BlockStyler::Node * targetNode /** targetnode */ ,
                int targetColumnID /** targetcolumnid */ 
            );
            ...
            /**Test the action to insert the column. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: int TestColumnInserted
            (
                int columnID /** columnid */ ,
                const NXString & columnTitle /** columntitle */ ,
                int columnWidth /** columnwidth */ 
            );
            /**Test the action to insert the column. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            int TestColumnInserted
            (
                int columnID /** columnid */ ,
                const char * columnTitle /** columntitle */ ,
                int columnWidth /** columnwidth */ 
            );
            /**Test the action to preselect the node. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            public: void TestNodePreselection
            (
                NXOpen::BlockStyler::Node * node /** node */ ,
                int columnID /** columnid */ 
            );
            ...
            (
                NXOpen::BlockStyler::Node * node /** node */ ,
                int columnID /** columnid */ ,
                const NXString & editedText /** editedtext */ 
            );
            /**Test the action to edit the label of the node. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : nx_auto_test_studio (" NX Automated Testing Studio") */
            ...
            (
                NXOpen::BlockStyler::Node * node /** node */ ,
                int columnID /** columnid */ ,
                const char * editedText /** editedtext */ 
            );
        };
    }
}
