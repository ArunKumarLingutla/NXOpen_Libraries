#ifndef NXOpen_SELECTSKETCHLIST_HXX_INCLUDED
#define NXOpen_SELECTSKETCHLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class Sketch;
    class View;
    class _SelectSketchListBuilder;
    class SelectSketchListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectSketchList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectSketchListImpl * m_selectsketchlist_impl;
        private: friend class  _SelectSketchListBuilder;
        protected: SelectSketchList();
        public: ~SelectSketchList();
        ...
        public: bool Add
        (
            NXOpen::Sketch * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Sketch *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::Sketch * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::Sketch * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Sketch *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Sketch * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Sketch *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Sketch *> GetArray
        (
        );
