#ifndef NXOpen_CAE_CONNECTIONS_NODALTARGETSETOFPOINTS_HXX_INCLUDED
#define NXOpen_CAE_CONNECTIONS_NODALTARGETSETOFPOINTS_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     CAE_Connections_NodalTargetSetOfPoints.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Connections
        {
            class _NodalTargetSetOfPointsBuilder;
            class NodalTargetSetOfPointsImpl;
            /**  @brief  Set of Points Target. Use this interface to set/get parameters of the Set of Points Target type.  

              
             <br>  Created in NX12.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  NodalTargetSetOfPoints : public NXOpen::CAE::Connections::NodalTarget, public virtual NXOpen::CAE::Connections::INodalTargetLegs
            {
                private: NodalTargetSetOfPointsImpl * m_nodaltargetsetofpoints_impl;
                private: friend class  _NodalTargetSetOfPointsBuilder;
                protected: NodalTargetSetOfPoints();
                public: ~NodalTargetSetOfPoints();
