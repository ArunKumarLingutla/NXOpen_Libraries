#ifndef NXOpen_TOOLING_COSTTABLEDATAPROVIDER_HXX_INCLUDED
#define NXOpen_TOOLING_COSTTABLEDATAPROVIDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Tooling_CostTableDataProvider.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class _CostTableDataProviderBuilder;
        class CostTableDataProviderImpl;
        /**
            ...
            When @link Builder::Commit Builder::Commit@endlink  is called NULL will be returned.
             <br> To create a new instance of this class, use @link NXOpen::Tooling::MoldwizardManager::CreateCostFeatureDataProvider  NXOpen::Tooling::MoldwizardManager::CreateCostFeatureDataProvider @endlink  <br> 
         <br>  Created in NX11.0.1.  <br>  
        */
        class NXOPENCPP_TOOLINGEXPORT  CostTableDataProvider : public NXOpen::TaggedObject, public virtual NXOpen::ITableEditorDataProvider
        {
            private: CostTableDataProviderImpl * m_costtabledataprovider_impl;
            private: friend class  _CostTableDataProviderBuilder;
            protected: CostTableDataProvider();
            public: ~CostTableDataProvider();
            /** Sets row object in data provider map
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void SetRowObjectInMap
            (
                int rowIndex /** rowindex */ ,
                NXOpen::Tooling::CostDataObject * costObject /** costobject */ 
            );
            /** Asks row object with specified index value
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::CostDataObject * AskRowObjectInMap
            (
                int rowIndex /** rowindex */ 
            );
            /** Clear row object map in data provider
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: void ClearRowObjectMap
            (
            );
