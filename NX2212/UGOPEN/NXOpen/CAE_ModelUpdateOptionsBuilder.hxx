...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /** Represents a @link NXOpen::CAE::ModelUpdateOptionsBuilder NXOpen::CAE::ModelUpdateOptionsBuilder@endlink   <br> To create a new instance of this class, use @link NXOpen::CAE::ModelUpdateSolutionSet::CreateOptionsBuilder  NXOpen::CAE::ModelUpdateSolutionSet::CreateOptionsBuilder @endlink  <br> 
