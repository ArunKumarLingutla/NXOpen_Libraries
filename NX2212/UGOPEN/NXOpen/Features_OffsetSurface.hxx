...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a offset surface feature. Inputs to this feature can be convergent objects.
              <br> To create or edit an instance of this class, use @link NXOpen::Features::OffsetSurfaceBuilder  NXOpen::Features::OffsetSurfaceBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  OffsetSurface : public NXOpen::Features::BodyFeature
        {
