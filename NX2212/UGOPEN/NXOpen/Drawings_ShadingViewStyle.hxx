#ifndef NXOpen_DRAWINGS_SHADINGVIEWSTYLE_HXX_INCLUDED
#define NXOpen_DRAWINGS_SHADINGVIEWSTYLE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class ShadingViewStyleImpl;
        /** Represents set of Shading View style applicable to drafting views.  <br> To obtain an instance of this class use @link Drawings::ViewStyle::Shading Drawings::ViewStyle::Shading@endlink   <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ShadingViewStyle: public virtual NXOpen::Preferences::IShadingViewPreferences
        {
            private: ShadingViewStyleImpl * m_shadingviewstyle_impl;
            private: NXOpen::Drawings::ViewStyle* m_owner;
            /// \cond NX_NO_DOC 
            public: explicit ShadingViewStyle(NXOpen::Drawings::ViewStyle *owner);
