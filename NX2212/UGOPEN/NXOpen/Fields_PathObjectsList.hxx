#ifndef NXOpen_FIELDS_PATHOBJECTSLIST_HXX_INCLUDED
#define NXOpen_FIELDS_PATHOBJECTSLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Fields
    {
        class _PathObjectsListBuilder;
        class PathObjectsListImpl;
        ...
        */
        class NXOPENCPP_FIELDSEXPORT  PathObjectsList : public NXOpen::TaggedObject
        {
            private: PathObjectsListImpl * m_pathobjectslist_impl;
            private: friend class  _PathObjectsListBuilder;
            protected: PathObjectsList();
            public: ~PathObjectsList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Fields::PathObjects *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Fields::PathObjects * object /** item to append */
            );
            ...
            (
                NXOpen::Fields::PathObjects * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Fields::PathObjects * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Fields::PathObjects * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Fields::PathObjects *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Fields::PathObjects *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Fields::PathObjects * object1 /** first item */,
                NXOpen::Fields::PathObjects * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Fields::PathObjects * object /** object to be inserted */
            );
