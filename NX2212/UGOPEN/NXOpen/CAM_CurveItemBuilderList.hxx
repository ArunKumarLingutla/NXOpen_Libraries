#ifndef NXOpen_CAM_CURVEITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_CAM_CURVEITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _CurveItemBuilderListBuilder;
        class CurveItemBuilderListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  CurveItemBuilderList : public NXOpen::TaggedObject
        {
            private: CurveItemBuilderListImpl * m_curveitembuilderlist_impl;
            private: friend class  _CurveItemBuilderListBuilder;
            protected: CurveItemBuilderList();
            public: ~CurveItemBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::CurveItemBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::CurveItemBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::CurveItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CurveItemBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::CurveItemBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::CurveItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::CurveItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::CurveItemBuilder * object1 /** first item */,
                NXOpen::CAM::CurveItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::CurveItemBuilder * object /** object to be inserted */
            );
