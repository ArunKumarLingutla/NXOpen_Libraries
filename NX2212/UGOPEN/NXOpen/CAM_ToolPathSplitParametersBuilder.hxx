    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  ToolPathSplitParametersBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the use global clearance for initial and final 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: bool UseGlobalClearance
            (
            );
            /**Sets  the use global clearance for initial and final 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUseGlobalClearance
            (
                bool useGlobalClearance /** use global clearance */ 
            );
        };
    }
}
