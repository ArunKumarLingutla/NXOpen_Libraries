    ...
    namespace Validate
    {
        ...
        */
        class NXOPENCPP_VALIDATEEXPORT  Parameter : public NXOpen::TransientObject
        {
            ...
            /** Gets @link NXObject NXObject@endlink  type value from a single value parameter. @return  The NXObject type value.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * GetNXObjectValue
            (
            );
            /** Gets @link NXObject NXObject@endlink  values from a multi-value parameter. @return  The NXObject type values.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::NXObject *> GetNXObjectValues
            (
            );
            /** Sets @link NXObject NXObject@endlink  value to a single value parameter.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetNXObjectValue
            (
                NXOpen::NXObject * data /** The NXObject type value.*/
            );
            /** Sets @link NXObject NXObject@endlink  type values to a multi-value parameter.
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void SetNXObjectValues
            (
                const std::vector<NXOpen::NXObject *> & data /** The NXObject type values.*/
            );
