    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SheetMetalFeatureRecognitionBuilder : public NXOpen::Builder
        {
            ...
            /** Performs quick analysis to get the product body information and cutout feature data only 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void PerformQuickAnalysis
            (
            );
            /** Assigns cost feature color 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void AssignFeatureFaceColor
            (
                bool assignOrRestore /** assign temporary color or restore it with body face color */
            );
            /** Release all sheet metal cost feature data 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void ReleaseAllProductFeatureData
            (
            );
            /** Deletes all sheet metal UDO data 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void DeleteAllCostRelatedUDO
            (
            );
            /** Checks the product body faces number to determine whether giving a suggestion message to run quick analysis 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool CheckBodyFacesNumber
            (
                int* numberFaces /** numberfaces */ 
            );
            /**Returns  the value that indicates whether to run quick analysis or not. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool QuickAnalysis
            (
            );
            /**Sets  the value that indicates whether to run quick analysis or not. 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: void SetQuickAnalysis
            (
                bool status /** status */ 
            );
            /** Creat new stamping features and copy data from these selected features
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: void DuplicateStampingFeatureData
            (
                const std::vector<NXOpen::Tooling::CostDataObject *> & stampingFeatureList /** stampingfeaturelist */ ,
                std::vector<NXOpen::Tooling::CostDataObject *> & newStampingFeatureList /** newstampingfeaturelist */ 
            );
        };
    }
}
