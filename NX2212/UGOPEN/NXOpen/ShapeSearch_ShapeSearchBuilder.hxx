    ...
    namespace ShapeSearch
    {
        ...
        */
        class NXOPENCPP_SHAPESEARCHEXPORT  ShapeSearchBuilder : public NXOpen::Builder
        {
            ...
            {
                ShapeSimilarityGradient1/** search with identical condition    */,
                ShapeSimilarityGradient2/** gradient2 */ ,
                ShapeSimilarityGradient3/** gradient3 */ ,
                ShapeSimilarityGradient4/** gradient4 */ ,
                ShapeSimilarityGradient5/** gradient5 */ ,
                ShapeSimilarityGradient6/** search with very similar condition */,
                ShapeSimilarityGradient7/** gradient7 */ ,
                ShapeSimilarityGradient8/** gradient8 */ ,
                ShapeSimilarityGradient9/** gradient9 */ ,
                ShapeSimilarityGradient10/** search with similar condition      */
            };
