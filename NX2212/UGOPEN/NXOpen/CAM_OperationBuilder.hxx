...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        ToolPathEditor.DeltaXC </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ToolPathEditor.DeltaYC </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ToolPathEditor.DeltaZC </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        ToolPathEditor.ExtendMethod </term> <description> 
         
        Linear </description> </item> 

        <item><term> 
         
        ToolPathEditor.GougeCheckClearanceMethod </term> <description> 
         
        Specify </description> </item> 

        <item><term> 
         
        ToolPathEditor.HolderCheck </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        ToolPathEditor.MotionMethod </term> <description> 
         
        Delta </description> </item> 

        <item><term> 
         
        ToolPathEditor.MoveStartPoint </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        ToolPathEditor.TransformCircles </term> <description> 
