#ifndef NXOpen_SELECTSKETCHMAKEUNIFORMSCALEBUILDERLIST_HXX_INCLUDED
#define NXOpen_SELECTSKETCHMAKEUNIFORMSCALEBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     SelectSketchMakeUniformScaleBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    class View;
    class _SelectSketchMakeUniformScaleBuilderListBuilder;
    class SelectSketchMakeUniformScaleBuilderListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectSketchMakeUniformScaleBuilderList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectSketchMakeUniformScaleBuilderListImpl * m_selectsketchmakeuniformscalebuilderlist_impl;
        private: friend class  _SelectSketchMakeUniformScaleBuilderListBuilder;
        protected: SelectSketchMakeUniformScaleBuilderList();
        public: ~SelectSketchMakeUniformScaleBuilderList();
        ...
        public: bool Add
        (
            NXOpen::SketchMakeUniformScaleBuilder * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::SketchMakeUniformScaleBuilder *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::SketchMakeUniformScaleBuilder * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::SketchMakeUniformScaleBuilder * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::SketchMakeUniformScaleBuilder * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::SketchMakeUniformScaleBuilder * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::SketchMakeUniformScaleBuilder *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::SketchMakeUniformScaleBuilder * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::SketchMakeUniformScaleBuilder *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::SketchMakeUniformScaleBuilder *> GetArray
        (
        );
