...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a folded radius dimension  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::RadialDimensionBuilder  NXOpen::Annotations::RadialDimensionBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  FoldedRadiusDimension : public NXOpen::Annotations::BaseFoldedRadiusDimension
        {
