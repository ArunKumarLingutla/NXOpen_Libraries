            ...
            */
            class NXOPENCPP_CAEEXPORT  Plot : public NXOpen::CAE::Xyplot::BaseModel
            {
                ...
                /** Creates a note on the plot 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::Xyplot::Plot::CreateNoteWithTextBoxCorner NXOpen::CAE::Xyplot::Plot::CreateNoteWithTextBoxCorner@endlink  instead. <br>  

                 <br>  Created in NX11.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::Xyplot::Plot::CreateNoteWithTextBoxCorner instead.") NXOpen::CAE::Xyplot::NoteModel * CreateNote
                (
                ...
                /** Creates a note with the position of text box corner on the plot. 
                 ...
                 <br> License requirements : None */
                public: NXOpen::CAE::Xyplot::NoteModel * CreateNoteWithTextBoxCorner
                (
                    NXOpen::CAE::Xyplot::TextBoxCornerType textBoxConerType /** textboxconertype */ ,
                    std::vector<NXString> & lines /** lines */ ,
                    const NXOpen::Point2d & boxCornerPosition /** boxcornerposition */ 
                );
            };
        }
    }
