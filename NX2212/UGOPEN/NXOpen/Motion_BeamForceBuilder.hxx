    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  BeamForceBuilder : public NXOpen::Motion::MotionBuilder
        {
            ...
            /**Returns   @brief the override state of the action link 
            ...
            /**Sets   @brief the override state of the action link 
            ...
            /**Returns   @brief the override state of the Base link 
            ...
            /**Sets   @brief the override state of the Base link 
            ...
            /**Returns   @brief the override state of the base point 
            ...
            /**Sets   @brief the override state of the base point 
            ...
            /**Returns   @brief the override state of the VectorType 

             
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState VectorTypeOvrCtrl
            (
            );
            /**Sets   @brief the override state of the VectorType 

             
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetVectorTypeOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            ...
            /**Returns   @brief the override state of the direction 
            ...
            /**Sets   @brief the override state of the direction 
