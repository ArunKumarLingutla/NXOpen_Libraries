#ifndef NXOpen_MECHATRONICS_SELECTLOGICOBJECTLIST_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTLOGICOBJECTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectLogicObjectList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectLogicObjectListBuilder;
        class SelectLogicObjectListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectLogicObjectList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectLogicObjectListImpl * m_selectlogicobjectlist_impl;
            private: friend class  _SelectLogicObjectListBuilder;
            protected: SelectLogicObjectList();
            public: ~SelectLogicObjectList();
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::LogicObject * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Mechatronics::LogicObject *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Mechatronics::LogicObject * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Mechatronics::LogicObject * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Mechatronics::LogicObject * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Mechatronics::LogicObject * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Mechatronics::LogicObject *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Mechatronics::LogicObject * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Mechatronics::LogicObject *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::LogicObject *> GetArray
            (
            );
