...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        1.0 (millimeters part), 2.54 (inches part) </description> </item> 
        ...
        TubeRadius1.LawType </term> <description> 
         
        MultiTransition </description> </item> 

        <item><term> 
         
        TubeRadius2.LawType </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  StyledBlendBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Returns  a value indicating whether face segmentation is needed 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: bool SegmentBlend
            (
            );
            /**Sets  a value indicating whether face segmentation is needed 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : studio_free_form ("STUDIO FREE FORM") */
            public: void SetSegmentBlend
            (
                bool isSegmentBlend /** issegmentblend */ 
            );
