#ifndef NXOpen_CAE_PENETRATIONCHECK_RESULTLIST_HXX_INCLUDED
#define NXOpen_CAE_PENETRATIONCHECK_RESULTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     CAE_PenetrationCheck_ResultList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace PenetrationCheck
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  ResultList : public NXOpen::NXObject
            {
                private: ResultListImpl * m_resultlist_impl;
                private: friend class  _ResultListBuilder;
