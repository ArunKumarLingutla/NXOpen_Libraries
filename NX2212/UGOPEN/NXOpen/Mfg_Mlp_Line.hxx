            ...
            */
            class MFGMLPOPENCPPEXPORT  Line : public NXOpen::DisplayableObject
            {
                ...
                /** Finds the @link  Mfg::Mlp::ProcessSetup   Mfg::Mlp::ProcessSetup @endlink  with the given identifier as recorded in a journal. 
                            ...
                            An exception will be thrown if no object can be found with the given journal identifier.  @return  Setup found, or null if no such setup exists.
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::INXObject * FindObject
                (
                    const NXString & journalIdentifier /** Name of the setup to be found */
                );
                /** Finds the @link  Mfg::Mlp::ProcessSetup   Mfg::Mlp::ProcessSetup @endlink  with the given identifier as recorded in a journal. 
                            An object may not return the same value as its JournalIdentifier in different versions of 
                            the software. However newer versions of the software should find the same object when 
                ...
                (
                    const char * journalIdentifier /** Name of the setup to be found */
                );
            };
        }
    }
