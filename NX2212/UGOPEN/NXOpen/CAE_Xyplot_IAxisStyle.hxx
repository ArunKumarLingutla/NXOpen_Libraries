#ifndef NXOpen_CAE_XYPLOT_IAXISSTYLE_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_IAXISSTYLE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  IAxisStyle
            {
                virtual void EnsureVtableExists() {}
                public: virtual ~IAxisStyle() {}
