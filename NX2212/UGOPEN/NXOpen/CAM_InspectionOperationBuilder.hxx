#ifndef NXOpen_CAM_INSPECTIONOPERATIONBUILDER_HXX_INCLUDED
#define NXOpen_CAM_INSPECTIONOPERATIONBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     CAM_InspectionOperationBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _InspectionOperationBuilderBuilder;
        class InspectionOperationBuilderImpl;
        /** Represents the builder for a Inspection Operation path.  <br> To create a new instance of this class, use @link NXOpen::CAM::InspectionOperationCollection::CreateInspectionOperationBuilder  NXOpen::CAM::InspectionOperationCollection::CreateInspectionOperationBuilder @endlink  <br> 
         <br>  Created in NX2206.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  InspectionOperationBuilder : public NXOpen::CAM::OperationBuilder
        {
            /** the geometry selection method */
            public: enum SelectionMethodType
            {
                SelectionMethodTypeFaces/** faces */ ,
                SelectionMethodTypeEdges/** edges */ ,
            ...
            public: enum InspectionPathType
            {
                ...
                InspectionPathTypeFromMethod/** from method */ 
            };

            private: InspectionOperationBuilderImpl * m_inspectionoperationbuilder_impl;
            private: friend class  _InspectionOperationBuilderBuilder;
            protected: InspectionOperationBuilder();
            public: ~InspectionOperationBuilder();
            ...
            /**Returns  the inspection path type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InspectionOperationBuilder::InspectionPathType PathType
            (
            );
            /**Sets  the inspection path type 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetPathType
            (
                NXOpen::CAM::InspectionOperationBuilder::InspectionPathType pathType /** pathtype */ 
            );
            ...
            /**Returns  the selection method 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InspectionOperationBuilder::SelectionMethodType SelectionMethod
            (
            );
            ...
            (
                NXOpen::CAM::InspectionOperationBuilder::SelectionMethodType selectionMethod /** selectionmethod */ 
            );
            /** Creates inspection paths for the selected feature geometry 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void InspectFeatures
            (
            );
            /**Returns  the option to create an inspection feature using multiple geometry entities 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: bool InferMultiGeomFeature
            (
            );
            /**Sets  the option to create an inspection feature using multiple geometry entities 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetInferMultiGeomFeature
            (
                bool inferMultiGeometry /** infermultigeometry */ 
            );
        };
    }
}
