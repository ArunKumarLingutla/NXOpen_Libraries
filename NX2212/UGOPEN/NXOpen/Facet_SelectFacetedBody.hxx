#ifndef NXOpen_FACET_SELECTFACETEDBODY_HXX_INCLUDED
#define NXOpen_FACET_SELECTFACETEDBODY_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Facet
    {
        class _SelectFacetedBodyBuilder;
        class SelectFacetedBodyImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FACETEXPORT  SelectFacetedBody : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectFacetedBodyImpl * m_selectfacetedbody_impl;
            private: friend class  _SelectFacetedBodyBuilder;
            protected: SelectFacetedBody();
            public: ~SelectFacetedBody();
            ...
            /**Returns  the object being selected
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Facet::FacetedBody * Value
            (
            );
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Facet::FacetedBody * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
