...
#include <NXOpen/CAE_Connections_IMassType.hxx>
        ...
        namespace Connections
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  LumpedMass : public NXOpen::CAE::Connections::IConnection, public virtual NXOpen::CAE::Connections::ICsys, public virtual NXOpen::CAE::Connections::IMassConnectivity, public virtual NXOpen::CAE::Connections::IMassInertia, public virtual NXOpen::CAE::Connections::IMassTarget, public virtual NXOpen::CAE::Connections::IMassPhysicalParams, public virtual NXOpen::CAE::Connections::IMassType
            {
                ...
                /**Returns  the mass connection type 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link IMassTarget::MassCenterType IMassTarget::MassCenterType@endlink  instead. <br>  

                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use IMassTarget::MassCenterType instead.") virtual bool UseCenterOfSlaveNodes
                (
                );
                /**Sets  the mass connection type 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link IMassTarget::MassCenterType IMassTarget::MassCenterType@endlink  instead. <br>  
                 ...
                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use IMassTarget::MassCenterType instead.") virtual void SetUseCenterOfSlaveNodes
                (
                ...
                /**Returns  the mass center type 
                 ...
                 <br> License requirements : None */
                public: virtual NXOpen::CAE::Connections::MassCenterType MassCenterType
                (
                );
                /**Sets  the mass center type 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: virtual void SetMassCenterType
                (
                    NXOpen::CAE::Connections::MassCenterType massCenterType /** Mass center type */
                );
