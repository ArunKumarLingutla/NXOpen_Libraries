            ...
            */
            class NXOPENCPP_CAEEXPORT  LMIECenterDefinition : public NXOpen::CAE::Connections::LMIEError
            {
                ...
                /**Returns  the flag indicating to use Legs's Center of Gravity 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link LMIECenterDefinition::MassCenterType LMIECenterDefinition::MassCenterType@endlink  instead. <br>  

                 <br>  Created in NX1847.0.0.  <br>  
                 <br> License requirements : None */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use LMIECenterDefinition::MassCenterType instead.") bool UseCenterOfLegNodes
                (
                );
                ...
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use LMIECenterDefinition::MassCenterType instead.") void SetUseCenterOfLegNodes
                (
                    bool use /** use */ 
                );
                /**Returns  the mass center type 
                 ...
                 <br> License requirements : None */
                public: NXOpen::CAE::Connections::MassCenterType MassCenterType
                (
                );
                /**Sets  the mass center type 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void SetMassCenterType
                (
