        ...
        namespace PostConfigurator
        {
            ...
            */
            class NXOPENCPP_SIMEXPORT  PostConfiguratorBuilder : public NXOpen::Builder
            {
                ...
                public: enum DefWriterErrorType
                {
                    DefWriterErrorTypeNoError/** no error */ ,
                    DefWriterErrorTypeDirWriteprotectError/** dir writeprotect error */ ,
                    DefWriterErrorTypeNoCustomerError/** no customer error */ ,
                    DefWriterErrorTypeCustomFileExistError/** custom file exist error */ ,
                    DefWriterErrorTypeFileWriteprotectError/** file writeprotect error */ ,
                    DefWriterErrorTypeUnknownError/** unknown error */ 
                };
                ...
                public: void EncryptPostConfiguratorFile
                (
                    const NXString & sourceFile /**  source file to encrypt*/,
                    const NXString & destFile /** destination file to encrypt*/,
                    const NXString & soldToID /** the sold to id */,
                    const NXString & expirationDate /** the expiration date */
                );
                /** This is an internal API and can be changed at any time 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") */
                void EncryptPostConfiguratorFile
                (
                    const char * sourceFile /**  source file to encrypt*/,
                    const char * destFile /** destination file to encrypt*/,
                    const char * soldToID /** the sold to id */,
                    const char * expirationDate /** the expiration date */
                );
                ...
                /**Returns  the def editor builder. 
                 ...
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") OR nx_post_config_adv ("NX Post Configurator") */
                public: NXOpen::SIM::PostConfigurator::DefEditorBuilder * DefEditorBuilder
                (
                );
                /** Create custom def file. 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_post_config_full ("NX Post Configurator") OR nx_post_config_adv ("NX Post Configurator") */
                public: NXOpen::SIM::PostConfigurator::PostConfiguratorBuilder::DefWriterErrorType CreateCustomDefFile
                (
                );
            };
        }
