        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  RouteManager
        {
            ...
            /** Imports NX Routing electrical information from the given XML
             ...
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::Routing::RouteManager::ImportPlmxml NXOpen::Routing::RouteManager::ImportPlmxml@endlink  instead. <br>  

             <br>  Created in NX4.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Routing::RouteManager::ImportPlmxml instead.") void ImportXmlFile
            (
                const NXString & importFilename /** The name of the file from which this method will read
                                    the NX Routing electrical information. */,
                NXOpen::Routing::RouteManager::ImportMode importOperation /** The import mode: update, merge, or append.
            ...
            /** Exports all of the NX Routing electrical information from the currently open part
             ...
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::Routing::RouteManager::ExportPlmxml NXOpen::Routing::RouteManager::ExportPlmxml@endlink  instead. <br>  

             <br>  Created in NX4.0.1.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Routing::RouteManager::ExportPlmxml instead.") void ExportXmlFile
            (
                const NXString & exportFilename /** The name of the file into which this method will write
                                    the NX Routing electrical information. */
            );
