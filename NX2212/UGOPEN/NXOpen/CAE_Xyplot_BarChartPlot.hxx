#ifndef NXOpen_CAE_XYPLOT_BARCHARTPLOT_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_BARCHARTPLOT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            class _BarChartPlotBuilder;
            class BarChartPlotImpl;
            /**  @brief 
            ...
            */
            class NXOPENCPP_CAEEXPORT  BarChartPlot : public NXOpen::CAE::Xyplot::Plot, public virtual NXOpen::CAE::Xyplot::I2DDataPlot
            {
                private: BarChartPlotImpl * m_barchartplot_impl;
                private: friend class  _BarChartPlotBuilder;
                protected: BarChartPlot();
                public: ~BarChartPlot();
