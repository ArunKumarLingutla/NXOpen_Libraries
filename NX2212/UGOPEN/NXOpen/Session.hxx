...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  Session : public NXOpen::BaseSession
    {
        ...
        /**  @brief Invokes an entry point function in a managed library. 
        ...
        /**Returns  This is an internal API and can be changed at any time 
         <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::Session::ReleaseNumber NXOpen::Session::ReleaseNumber@endlink  instead <br>  

         <br>  Created in NX1926.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Session::ReleaseNumber instead") NXString ReleaseName
        (
        );
        ...
        */
        ...
        /** Returns the @link NXOpen::DesignSimulation::LiveSimulationManager NXOpen::DesignSimulation::LiveSimulationManager@endlink  belonging to this session 
         <br>  Created in NX2212.0.0.  <br>  
        */
        public: NXOpen::DesignSimulation::LiveSimulationManager *LiveSimulationManager();
