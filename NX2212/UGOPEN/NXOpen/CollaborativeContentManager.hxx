...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  CollaborativeContentManager
    {
        ...
        /** Creates a @link NXOpen::Assemblies::DesignElementBuilder NXOpen::Assemblies::DesignElementBuilder@endlink  for creating or revising design elements  
         <br>  Created in NX8.5.0.  <br>  
        ...
        /** Creates a @link NXOpen::Assemblies::CreateOverridePartBuilder NXOpen::Assemblies::CreateOverridePartBuilder@endlink  
        ...
        /** Creates a @link NXOpen::Assemblies::DeleteOverridePartBuilder NXOpen::Assemblies::DeleteOverridePartBuilder@endlink  
         <br>  Created in NX10.0.0.  <br>  
         <br> License requirements : nx_4gd_integration ("4th Generation Design") */
        ...
        /** Creates a @link NXOpen::Assemblies::CopyDesignElementBuilder NXOpen::Assemblies::CopyDesignElementBuilder@endlink 
            
         <br>  Created in NX12.0.0.  <br>  
         <br> License requirements : nx_4gd_integration ("4th Generation Design") */
        public: NXOpen::Assemblies::CopyDesignElementBuilder * CreateCopyDesignElementBuilder
        (
