#ifndef NXOpen_APPEARANCE_DESIGNATOR_HXX_INCLUDED
#define NXOpen_APPEARANCE_DESIGNATOR_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Appearance
    {
        ...
        */
        class NXOPENCPP_APPEARANCEEXPORT  Designator : public NXOpen::NXObject
        {
            private: DesignatorImpl * m_designator_impl;
            private: friend class  _DesignatorBuilder;
            ...
            public: void ClearGeometricEntites
            (
            );
        };
    }
