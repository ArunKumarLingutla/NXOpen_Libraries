    ...
    namespace CAE
    {
        ...
        /**
            ...
            or solids in the model whose distance is less than a specified tolerance. 
             <br> To create a new instance of this class, use @link NXOpen::CAE::SimSimulation::CreateAutoFacePairsBuilder  NXOpen::CAE::SimSimulation::CreateAutoFacePairsBuilder @endlink  <br> 
        ...
        */
        class NXOPENCPP_CAEEXPORT  AutoPairsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the geometry DisplayableObject selection 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectDisplayableObjectList * DisplayableobjectSelection
            (
            );
