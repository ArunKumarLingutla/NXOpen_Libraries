    ...
    namespace PressLineSimulation
    {
        ...
        */
        class PRESSLINESIMULOPENCPPEXPORT  StaticCheckerBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the activity of all collision pairs  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: bool AllCollisionPairsActivity
            (
            );
            /**Sets  the activity of all collision pairs  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_pls_die_checker (" NX Press Die Checker") OR nx_pls_line_setup (" NX Press Line Setup") */
            public: void SetAllCollisionPairsActivity
            (
                bool allCollisionPairsActivity /** allcollisionpairsactivity */ 
            );
        };
    }
}
