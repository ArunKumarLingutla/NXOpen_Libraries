#ifndef NXOpen_BLOCKSTYLER_SECTIONBUILDER_HXX_INCLUDED
#define NXOpen_BLOCKSTYLER_SECTIONBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        class _SectionBuilderBuilder;
        class SectionBuilderImpl;
        /** Represents a Section Builder
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENUICPPEXPORT  SectionBuilder : public NXOpen::BlockStyler::UIBlock
        {
            private: SectionBuilderImpl * m_sectionbuilder_impl;
            private: friend class  _SectionBuilderBuilder;
