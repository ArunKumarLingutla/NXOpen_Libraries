...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Collision Avoidance Dialog builder  <br> To create a new instance of this class, use @link NXOpen::CAM::InspectionOperationCollection::CreateInspectionCollisionAvoidanceBuilder  NXOpen::CAM::InspectionOperationCollection::CreateInspectionCollisionAvoidanceBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  InspectionCollisionAvoidanceBuilder : public NXOpen::Builder
        {
