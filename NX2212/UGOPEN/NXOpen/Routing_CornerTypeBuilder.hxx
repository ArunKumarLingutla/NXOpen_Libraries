        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  CornerTypeBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            public: enum BendMethods
            {
                ...
                BendMethodsRatioToAttribute/** ratio to attribute */ 
            };
            ...
            /**Returns  the route corner ratio to attribute 
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Expression * RouteCornerRatioToAttribute
            (
            );
            /**Returns  the route corner ratio to attribute 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXString RouteCornerRatioToAttributeName
            (
            );
            /**Sets  the route corner ratio to attribute 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetRouteCornerRatioToAttributeName
            (
                const NXString & routeCornerRatioToAttributeName /** routecornerratiotoattributename */ 
            );
            /**Sets  the route corner ratio to attribute 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            void SetRouteCornerRatioToAttributeName
            (
                const char * routeCornerRatioToAttributeName /** routecornerratiotoattributename */ 
            );
            /** Route specify elbow 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
