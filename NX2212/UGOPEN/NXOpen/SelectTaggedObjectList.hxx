#ifndef NXOpen_SELECTTAGGEDOBJECTLIST_HXX_INCLUDED
#define NXOpen_SELECTTAGGEDOBJECTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class TaggedObject;
    class View;
    class _SelectTaggedObjectListBuilder;
    class SelectTaggedObjectListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectTaggedObjectList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectTaggedObjectListImpl * m_selecttaggedobjectlist_impl;
        private: friend class  _SelectTaggedObjectListBuilder;
        protected: SelectTaggedObjectList();
        public: ~SelectTaggedObjectList();
        ...
        public: bool Add
        (
            NXOpen::TaggedObject * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::TaggedObject *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::TaggedObject * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::TaggedObject * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::TaggedObject * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::TaggedObject * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::TaggedObject *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::TaggedObject * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::TaggedObject *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::TaggedObject *> GetArray
        (
        );
