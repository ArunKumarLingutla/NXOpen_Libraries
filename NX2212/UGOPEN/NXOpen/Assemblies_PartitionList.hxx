#ifndef NXOpen_ASSEMBLIES_PARTITIONLIST_HXX_INCLUDED
#define NXOpen_ASSEMBLIES_PARTITIONLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        class _PartitionListBuilder;
        class PartitionListImpl;
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  PartitionList : public NXOpen::TaggedObject
        {
            private: PartitionListImpl * m_partitionlist_impl;
            private: friend class  _PartitionListBuilder;
            ...
            public: void Append
            (
                const std::vector<NXOpen::Assemblies::Partition *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Assemblies::Partition * object /** item to append */
            );
            ...
            (
                NXOpen::Assemblies::Partition * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Assemblies::Partition * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Assemblies::Partition * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Assemblies::Partition *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Assemblies::Partition *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Assemblies::Partition * object1 /** first item */,
                NXOpen::Assemblies::Partition * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Assemblies::Partition * object /** object to be inserted */
            );
