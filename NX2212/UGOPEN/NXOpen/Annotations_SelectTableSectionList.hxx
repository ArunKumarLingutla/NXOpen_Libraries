#ifndef NXOpen_ANNOTATIONS_SELECTTABLESECTIONLIST_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTTABLESECTIONLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_SelectTableSectionList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectTableSectionListBuilder;
        class SelectTableSectionListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectTableSectionList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectTableSectionListImpl * m_selecttablesectionlist_impl;
            private: friend class  _SelectTableSectionListBuilder;
            protected: SelectTableSectionList();
            public: ~SelectTableSectionList();
            ...
            public: bool Add
            (
                NXOpen::Annotations::TableSection * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Annotations::TableSection *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Annotations::TableSection * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Annotations::TableSection * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Annotations::TableSection * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Annotations::TableSection * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Annotations::TableSection *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Annotations::TableSection * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Annotations::TableSection *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::TableSection *> GetArray
            (
            );
