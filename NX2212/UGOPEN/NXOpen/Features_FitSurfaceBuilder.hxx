...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        Parameterization.VPatches </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        RadiusValue.Value </term> <description> 
         
        50 (millimeters part), 2 (inches part) </description> </item> 

        <item><term> 
         
        RejectionThresholdValue.Value </term> <description> 
        ...
        TargetOption </term> <description> 
         
        Object </description> </item> 

        <item><term> 
         
        TargetRegion.AllSameColor </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FitSurfaceBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum TargetType
            {
                ...
                TargetTypeColorRegion/**This option will select a color coded region */,
                TargetTypeFacetRegion/** facet region */ 
            };
            ...
            /**Returns  the creation of single surface feature
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: bool IsSingleSurface
            (
            );
            /**Sets  the creation of single surface feature
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_freeform_2 ("advanced freeform modeling") */
            public: void SetSingleSurface
            (
                bool isSingleSurface /** issinglesurface */ 
            );
            ...
            /**Returns  the body preference type. 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::FitSurfaceBuilder::BodyType BodyTypePreference
            (
            );
            ...
            (
                NXOpen::Features::FitSurfaceBuilder::BodyType type /** type */ 
            );
        };
    }
}
