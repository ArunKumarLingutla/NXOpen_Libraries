#ifndef NXOpen_SELECTSPLINELIST_HXX_INCLUDED
#define NXOpen_SELECTSPLINELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class SelectSplineListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectSplineList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectSplineListImpl * m_selectsplinelist_impl;
        private: friend class  _SelectSplineListBuilder;
        protected: SelectSplineList();
        public: ~SelectSplineList();
        ...
        public: bool Add
        (
            NXOpen::Spline * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Spline *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::Spline * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::Spline * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Spline *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Spline * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Spline *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Spline *> GetArray
        (
        );
