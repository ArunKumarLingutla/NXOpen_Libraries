...
#include <NXOpen/PressLineSimulation_TrackCurvesManager.hxx>
    ...
    namespace PressLineSimulation
    {
        ...
        */
        class PRESSLINESIMULOPENCPPEXPORT  SimulationSetup : public NXOpen::NXObject
        {
            ...
            /**Returns  an object of class @link NXOpen::PressLineSimulation::TrackCurvesManager NXOpen::PressLineSimulation::TrackCurvesManager@endlink  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::PressLineSimulation::TrackCurvesManager * TrackCurvesManager
            (
            );
        };
    }
