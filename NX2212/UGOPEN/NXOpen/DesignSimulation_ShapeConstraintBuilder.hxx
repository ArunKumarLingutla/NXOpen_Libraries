#ifndef NXOpen_DESIGNSIMULATION_SHAPECONSTRAINTBUILDER_HXX_INCLUDED
#define NXOpen_DESIGNSIMULATION_SHAPECONSTRAINTBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
        ...
        */
        class NXOPENCPP_DESIGNSIMULATIONEXPORT  ShapeConstraintBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the tool tip angle 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * ToolTipAngle
            (
            );
        };
    }
