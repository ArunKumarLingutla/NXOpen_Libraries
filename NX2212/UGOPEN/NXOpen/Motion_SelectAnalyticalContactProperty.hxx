#ifndef NXOpen_MOTION_SELECTANALYTICALCONTACTPROPERTY_HXX_INCLUDED
#define NXOpen_MOTION_SELECTANALYTICALCONTACTPROPERTY_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Motion_SelectAnalyticalContactProperty.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectAnalyticalContactPropertyBuilder;
        class SelectAnalyticalContactPropertyImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectAnalyticalContactProperty : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAnalyticalContactPropertyImpl * m_selectanalyticalcontactproperty_impl;
            private: friend class  _SelectAnalyticalContactPropertyBuilder;
            protected: SelectAnalyticalContactProperty();
            public: ~SelectAnalyticalContactProperty();
            ...
            (
                NXOpen::Motion::AnalyticalContactProperty * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::AnalyticalContactProperty * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::AnalyticalContactProperty * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::AnalyticalContactProperty * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::AnalyticalContactProperty * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
