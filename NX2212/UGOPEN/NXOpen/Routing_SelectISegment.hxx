#ifndef NXOpen_ROUTING_SELECTISEGMENT_HXX_INCLUDED
#define NXOpen_ROUTING_SELECTISEGMENT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        ...
        class SelectISegmentImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  SelectISegment : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectISegmentImpl * m_selectisegment_impl;
            private: friend class  _SelectISegmentBuilder;
            protected: SelectISegment();
            public: ~SelectISegment();
            ...
            (
                NXOpen::Routing::ISegment * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Routing::ISegment * Value
            (
            );
            ...
            (
                ...
                NXOpen::Routing::ISegment * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Routing::ISegment * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Routing::ISegment * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
