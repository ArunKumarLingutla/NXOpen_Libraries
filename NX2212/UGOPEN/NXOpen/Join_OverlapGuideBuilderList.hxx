#ifndef NXOpen_JOIN_OVERLAPGUIDEBUILDERLIST_HXX_INCLUDED
#define NXOpen_JOIN_OVERLAPGUIDEBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Join_OverlapGuideBuilderList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Join
    {
        class _OverlapGuideBuilderListBuilder;
        class OverlapGuideBuilderListImpl;
        ...
        */
        class JOINOPENCPPEXPORT  OverlapGuideBuilderList : public NXOpen::TaggedObject
        {
            private: OverlapGuideBuilderListImpl * m_overlapguidebuilderlist_impl;
            private: friend class  _OverlapGuideBuilderListBuilder;
            protected: OverlapGuideBuilderList();
            public: ~OverlapGuideBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Join::OverlapGuideBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Join::OverlapGuideBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Join::OverlapGuideBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Join::OverlapGuideBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Join::OverlapGuideBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Join::OverlapGuideBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Join::OverlapGuideBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Join::OverlapGuideBuilder * object1 /** first item */,
                NXOpen::Join::OverlapGuideBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Join::OverlapGuideBuilder * object /** object to be inserted */
            );
