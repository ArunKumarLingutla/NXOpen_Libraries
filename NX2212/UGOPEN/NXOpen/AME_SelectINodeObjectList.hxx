#ifndef NXOpen_AME_SELECTINODEOBJECTLIST_HXX_INCLUDED
#define NXOpen_AME_SELECTINODEOBJECTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _SelectINodeObjectListBuilder;
        class SelectINodeObjectListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class AMEOPENCPPEXPORT  SelectINodeObjectList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectINodeObjectListImpl * m_selectinodeobjectlist_impl;
            private: friend class  _SelectINodeObjectListBuilder;
            protected: SelectINodeObjectList();
            public: ~SelectINodeObjectList();
            ...
            public: bool Add
            (
                NXOpen::AME::INodeObject * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::AME::INodeObject *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::AME::INodeObject * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::AME::INodeObject * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::AME::INodeObject * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::AME::INodeObject * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::AME::INodeObject *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::AME::INodeObject * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::AME::INodeObject *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::AME::INodeObject *> GetArray
            (
            );
