...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        ...
        */
        class NXOPENCPP_MECHATRONICSEXPORT  MATLABSignalConnectionBuilderList : public NXOpen::TaggedObject
        {
            ...
            /** Returns the object at the input index.  May be NULL.
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::MATLABSignalConnectionBuilder * FindItem
            (
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Mechatronics::MATLABSignalConnectionBuilder *> GetContents
            (
            );
