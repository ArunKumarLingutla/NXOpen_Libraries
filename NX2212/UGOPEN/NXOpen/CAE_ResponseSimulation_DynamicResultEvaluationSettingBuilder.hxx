            ...
            */
            class NXOPENCPP_CAEEXPORT  DynamicResultEvaluationSettingBuilder : public NXOpen::Builder
            {
                ...
                /** Returns the response result name. 
                 ...
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: NXString GetResponseResultNameString
                (
                );
                /** Sets the response result name 
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                public: void SetResponseResultNameString
                (
                    const NXString & responseResultName /** responseresultname */ 
                );
                /** Sets the response result name 
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : nx_response_anlys ("NX Response Analysis") */
                void SetResponseResultNameString
                (
                    const char * responseResultName /** responseresultname */ 
                );
            };
        }
    }
