#ifndef NXOpen_SELECTIPARAMETERIZEDSURFACE_HXX_INCLUDED
#define NXOpen_SELECTIPARAMETERIZEDSURFACE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     SelectIParameterizedSurface.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    class View;
    class _SelectIParameterizedSurfaceBuilder;
    class SelectIParameterizedSurfaceImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectIParameterizedSurface : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectIParameterizedSurfaceImpl * m_selectiparameterizedsurface_impl;
        private: friend class  _SelectIParameterizedSurfaceBuilder;
        protected: SelectIParameterizedSurface();
        public: ~SelectIParameterizedSurface();
        ...
        /**Returns  the object being selected
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::IParameterizedSurface * Value
        (
        );
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::IParameterizedSurface * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
