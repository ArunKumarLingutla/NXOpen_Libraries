...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        /**
            Represents a @link NXOpen::CAE::MeshPointOnFaceBuilder NXOpen::CAE::MeshPointOnFaceBuilder@endlink 
             <br> To create a new instance of this class, use @link NXOpen::CAE::MeshPointCollection::CreateMeshpointOnFaceBuilder  NXOpen::CAE::MeshPointCollection::CreateMeshpointOnFaceBuilder @endlink  <br> 
         <br>  Created in NX5.0.2.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  MeshPointOnFaceBuilder : public NXOpen::CAE::MeshPointBaseBuilder
        {
