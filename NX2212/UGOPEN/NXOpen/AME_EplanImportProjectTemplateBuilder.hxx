    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  EplanImportProjectTemplateBuilder : public NXOpen::Builder
        {
            ...
            public: NXString ProjectTemplateFilePath
            (
            );
            /**Sets  the project template file path
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetProjectTemplateFilePath
            (
            ...
            /**Sets  the project template file path
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            void SetProjectTemplateFilePath
            (
            ...
            /** Read eplan project template settings 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ReadProjectTemplateSettings
            (
            );
            /** Import eplan project template 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void ImportProjectTemplateFile
            (
            );
        };
    }
