#ifndef NXOpen_SCCOLLECTORLIST_HXX_INCLUDED
#define NXOpen_SCCOLLECTORLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class ScCollector;
    class _ScCollectorListBuilder;
    class ScCollectorListImpl;
    ...
    */
    class NXOPENCPPEXPORT  ScCollectorList : public NXOpen::TaggedObject
    {
        private: ScCollectorListImpl * m_sccollectorlist_impl;
        private: friend class  _ScCollectorListBuilder;
        protected: ScCollectorList();
        public: ~ScCollectorList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::ScCollector *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::ScCollector * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::ScCollector * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ScCollector *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::ScCollector *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::ScCollector * object1 /** first item */,
            NXOpen::ScCollector * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::ScCollector * object /** object to be inserted */
        );
