#ifndef NXOpen_FEATURES_GEODESICFILLETBUILDER_HXX_INCLUDED
#define NXOpen_FEATURES_GEODESICFILLETBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class GeodesicFilletBuilderImpl;
        /** Represents a @link NXOpen::Features::GeodesicFillet NXOpen::Features::GeodesicFillet@endlink  builder for GeodesicFillet command.  <br> To create a new instance of this class, use @link NXOpen::Features::GeodesicSketchCollection::CreateGeodesicFilletBuilder  NXOpen::Features::GeodesicSketchCollection::CreateGeodesicFilletBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  GeodesicFilletBuilder : public NXOpen::Features::FeatureBuilder
        {
            private: GeodesicFilletBuilderImpl * m_geodesicfilletbuilder_impl;
            private: friend class  _GeodesicFilletBuilderBuilder;
            protected: GeodesicFilletBuilder();
            public: ~GeodesicFilletBuilder();
            /**Returns  the first section of curves to fillet 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * FirstSection
            (
            );
            /**Sets  the first section of curves to fillet 
             <br>  Created in NX10.0.0.  <br>  
            ...
            /**Returns  the second section of curves to fillet 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Section * SecondSection
            (
            );
            /**Sets  the second section of curves to fillet 
             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
