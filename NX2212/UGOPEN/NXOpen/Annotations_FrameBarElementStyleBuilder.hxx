    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  FrameBarElementStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the number of start farme  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXString NumberOfStartFrame
            (
            );
            /**Sets  the number of start farme  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            public: void SetNumberOfStartFrame
            (
                const NXString & strNumberOfStartFrame /** strnumberofstartframe */ 
            );
            /**Sets  the number of start farme  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            void SetNumberOfStartFrame
            (
                const char * strNumberOfStartFrame /** strnumberofstartframe */ 
            );
            /**Returns  the display thickness dirction  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool DisplayThicknessDirection
            (
            );
            /**Sets  the display thickness dirction  
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            public: void SetDisplayThicknessDirection
            (
                bool bShow /** bshow */ 
            );
            ...
            /**Sets  the label text height  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            public: void SetLabelTextHeight
            (
                double height /** height */ 
            );
            /**Returns  the label text font gap factor  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: double LabelTextFontGapFactor
            (
            );
            /**Sets  the label text font gap factor  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            public: void SetLabelTextFontGapFactor
            (
                double gapFactor /** gapfactor */ 
            );
            /**Returns  the label text aspect ratio  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: double LabelTextAspectRatio
            (
            );
            /**Sets  the label text aspect ratio  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            public: void SetLabelTextAspectRatio
            (
                double aspectRatio /** aspectratio */ 
            );
            /**Returns  the label text lettering angle  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: double LabelTextLetteringAngle
            (
            );
            /**Sets  the label text lettering angle  
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_ship_gen_arrange ("Ship General Arrangement") OR nx_ship_basic ("Ship Basic Design") OR nx_ship_detail ("Ship Detail Design") OR nx_ship_mfg_prep ("Ship Manufacturing") OR drafting ("DRAFTING") */
            public: void SetLabelTextLetteringAngle
            (
                double angle /** angle */ 
            );
