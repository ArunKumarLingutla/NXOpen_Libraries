#ifndef NXOpen_CAE_POSTRESULTRANGEMETHOD_HXX_INCLUDED
#define NXOpen_CAE_POSTRESULTRANGEMETHOD_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  PostResultRangeMethod : public NXOpen::CAE::PostISmartSelectorMethod
        {
