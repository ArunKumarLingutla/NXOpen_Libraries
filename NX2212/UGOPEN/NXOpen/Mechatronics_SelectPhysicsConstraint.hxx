#ifndef NXOpen_MECHATRONICS_SELECTPHYSICSCONSTRAINT_HXX_INCLUDED
#define NXOpen_MECHATRONICS_SELECTPHYSICSCONSTRAINT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Mechatronics_SelectPhysicsConstraint.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Mechatronics
    {
        class _SelectPhysicsConstraintBuilder;
        class SelectPhysicsConstraintImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MECHATRONICSEXPORT  SelectPhysicsConstraint : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectPhysicsConstraintImpl * m_selectphysicsconstraint_impl;
            private: friend class  _SelectPhysicsConstraintBuilder;
            protected: SelectPhysicsConstraint();
            public: ~SelectPhysicsConstraint();
            ...
            (
                NXOpen::Mechatronics::PhysicsConstraint * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Mechatronics::PhysicsConstraint * Value
            (
            );
            ...
            (
                ...
                NXOpen::Mechatronics::PhysicsConstraint * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Mechatronics::PhysicsConstraint * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Mechatronics::PhysicsConstraint * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
