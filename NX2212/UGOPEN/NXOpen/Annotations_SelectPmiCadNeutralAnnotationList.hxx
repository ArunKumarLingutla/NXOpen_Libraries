#ifndef NXOpen_ANNOTATIONS_SELECTPMICADNEUTRALANNOTATIONLIST_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTPMICADNEUTRALANNOTATIONLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_SelectPmiCadNeutralAnnotationList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectPmiCadNeutralAnnotationListBuilder;
        class SelectPmiCadNeutralAnnotationListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectPmiCadNeutralAnnotationList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectPmiCadNeutralAnnotationListImpl * m_selectpmicadneutralannotationlist_impl;
            private: friend class  _SelectPmiCadNeutralAnnotationListBuilder;
            protected: SelectPmiCadNeutralAnnotationList();
            public: ~SelectPmiCadNeutralAnnotationList();
            ...
            public: bool Add
            (
                NXOpen::Annotations::PmiCadNeutralAnnotation * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Annotations::PmiCadNeutralAnnotation *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Annotations::PmiCadNeutralAnnotation * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Annotations::PmiCadNeutralAnnotation * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Annotations::PmiCadNeutralAnnotation * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Annotations::PmiCadNeutralAnnotation * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Annotations::PmiCadNeutralAnnotation *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Annotations::PmiCadNeutralAnnotation * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Annotations::PmiCadNeutralAnnotation *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::PmiCadNeutralAnnotation *> GetArray
            (
            );
