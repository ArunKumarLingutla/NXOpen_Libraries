#ifndef NXOpen_CAM_WIREGUIDELIST_HXX_INCLUDED
#define NXOpen_CAM_WIREGUIDELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _WireGuideListBuilder;
        class WireGuideListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  WireGuideList : public NXOpen::TaggedObject
        {
            private: WireGuideListImpl * m_wireguidelist_impl;
            private: friend class  _WireGuideListBuilder;
            protected: WireGuideList();
            public: ~WireGuideList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::WireGuide *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::WireGuide * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::WireGuide * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::WireGuide * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::WireGuide * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::WireGuide *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::WireGuide *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::WireGuide * object1 /** first item */,
                NXOpen::CAM::WireGuide * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::WireGuide * object /** object to be inserted */
            );
