#ifndef NXOpen_EXPRESSIONSECTIONSETLIST_HXX_INCLUDED
#define NXOpen_EXPRESSIONSECTIONSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class ExpressionSectionSetListImpl;
    ...
    */
    class NXOPENCPPEXPORT  ExpressionSectionSetList : public NXOpen::TaggedObject
    {
        private: ExpressionSectionSetListImpl * m_expressionsectionsetlist_impl;
        private: friend class  _ExpressionSectionSetListBuilder;
        protected: ExpressionSectionSetList();
        public: ~ExpressionSectionSetList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::ExpressionSectionSet *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::ExpressionSectionSet * object /** item to append */
        );
        ...
        (
            NXOpen::ExpressionSectionSet * obj /** Object to find index for */
        );
        /** Returns the object at the input index.  May be NULL.
             @return  object found at input index 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ExpressionSectionSet * FindItem
        (
        ...
        public: void Erase
        (
            NXOpen::ExpressionSectionSet * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ExpressionSectionSet *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::ExpressionSectionSet *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::ExpressionSectionSet * object1 /** first item */,
            NXOpen::ExpressionSectionSet * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::ExpressionSectionSet * object /** object to be inserted */
        );
