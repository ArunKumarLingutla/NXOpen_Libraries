#ifndef NXOpen_AME_SELECTAMEPORT_HXX_INCLUDED
#define NXOpen_AME_SELECTAMEPORT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _SelectAMEPortBuilder;
        class SelectAMEPortImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class AMEOPENCPPEXPORT  SelectAMEPort : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAMEPortImpl * m_selectameport_impl;
            private: friend class  _SelectAMEPortBuilder;
            protected: SelectAMEPort();
            public: ~SelectAMEPort();
            ...
            (
                NXOpen::AME::AMEPort * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::AME::AMEPort * Value
            (
            );
            ...
            (
                ...
                NXOpen::AME::AMEPort * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::AME::AMEPort * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::AME::AMEPort * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
