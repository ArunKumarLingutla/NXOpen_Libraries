    ...
    namespace Tooling
    {
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ProcessSimulationBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the simulation play method
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: bool SimulationPlayMannally
            (
            );
            /**Sets  the simulation play method
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetSimulationPlayMannally
            (
                bool simulationPlayMannally /** simulationplaymannally */ 
            );
