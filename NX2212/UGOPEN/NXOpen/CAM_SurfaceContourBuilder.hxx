        ...
        */
        class NXOPENCPP_CAMEXPORT  SurfaceContourBuilder : public NXOpen::CAM::MillOperationBuilder
        {
            ...
            public: enum AccessVectorMethodType
            {
                ...
                AccessVectorMethodTypeAwayFromLine/**away from the vector defined*/,
                AccessVectorMethodTypeTowardLine/**toward the vector defined*/
            };
            ...
            /**Returns  the drive method 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::SurfaceContourBuilder::DriveMethodTypes DriveMethod
            (
            );
            /**Sets  the drive method 
             <br>  Created in NX5.0.0.  <br>  
            ...
            /**Returns  the Guided Curve Drive Method builder 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::GuidedCurveBuilder * GuidedCurveBuilder
            (
            );
            ...
            /**Returns  the blade depth step distance 
             ...
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * BladeDepthStepDistance
            (
            );
            ...
            /**Returns  the stepover lift 
             <br>  Created in NX9.0.2.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::InheritableToolDepBuilder * StepoverLift
            (
            );
            /**Returns  the streamline cut pattern 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CutPatternBuilder * StreamlineCutPattern
            (
            );
            /**Returns  the streamline stepover 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::StepoverBuilder * StreamlineStepover
            (
            );
            /**Returns  the streamline tool position 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::DmToolPosition * StreamlineToolPosition
            (
            );
            /**Returns  the streamline trim and extend 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::DmTrimExtend * StreamlineTrimAndExtend
            (
            );
            /**Returns  the streamline cut step 
             <br>  Created in NX10.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::DmStreamlineCutStep * StreamlineCutStep
            (
            );
            /**Returns  the cut direction 
             <br>  Created in NX10.0.2.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::SurfaceContourBuilder::CutDirectionTypes CutDirection
            (
            );
            ...
            (
                NXOpen::CAM::SurfaceContourBuilder::CutDirectionTypes cutDirType /** the cut direction */
            );
            /**Returns  the Avoidance Methods 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::AvoidanceMethodsBuilder * AvoidanceMethods
            (
            );
            ...
            /**Returns  the blade geometry type 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BladeGeometryType * BladeGeometryType
            (
            );
        };
    }
