#ifndef NXOpen_FEATURES_SELECTFLATPATTERN_HXX_INCLUDED
#define NXOpen_FEATURES_SELECTFLATPATTERN_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        class SelectFlatPatternImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  SelectFlatPattern : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectFlatPatternImpl * m_selectflatpattern_impl;
            private: friend class  _SelectFlatPatternBuilder;
            protected: SelectFlatPattern();
            public: ~SelectFlatPattern();
            ...
            (
                NXOpen::Features::FlatPattern * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::FlatPattern * Value
            (
            );
            ...
            (
                ...
                NXOpen::Features::FlatPattern * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Features::FlatPattern * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Features::FlatPattern * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
