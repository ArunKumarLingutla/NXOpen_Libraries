#ifndef NXOpen_ROUTING_SPLINESEGMENT_HXX_INCLUDED
#define NXOpen_ROUTING_SPLINESEGMENT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
#include <NXOpen/Routing_SplineData.hxx>
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        class _SplineSegmentBuilder;
        class SplineSegmentImpl;
        /** Represents a spline segment.  <br> To obtain an instance of this class use @link NXOpen::Routing::SplineSegmentCollection NXOpen::Routing::SplineSegmentCollection@endlink   <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  SplineSegment : public NXOpen::Spline, public virtual NXOpen::Routing::ISegment
        {
            private: SplineSegmentImpl * m_splinesegment_impl;
            private: friend class  _SplineSegmentBuilder;
            protected: SplineSegment();
            public: ~SplineSegment();
            /**Returns  the @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  object.
                     <br>  This class provides the ability to query and edit a Routing Spline Segment.  <br> 
                     <br>  The @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  provides access to the
                           @link NXOpen::Routing::DefiningPoint NXOpen::Routing::DefiningPoint@endlink  objects which represent the
                           positions and optional directions and forward/backward magnitudes for extensions.  <br>  
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::SplineData * SplineData
            (
            );
            /**Returns  a boolean value that indicates whether the spline has been
             ...
             <br> License requirements : routing_base ("Routing Basic") */
            public: bool IsFlexibleParametricSplineSegment
            (
            );
            ...
            /** Was this segment generated by placing a Built-In Path component?  @return  
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: virtual bool IsSegmentFromBuiltInPath
            (
            );
            /** Returns the electrical connections routed on this segment, if any.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: virtual std::vector<NXOpen::Routing::Electrical::Connection *> GetConnections
            (
            );
            /** Returns the electrical wires routed on this segment, if any.  @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: virtual std::vector<NXOpen::Routing::Wire *> GetWires
            (
            );
