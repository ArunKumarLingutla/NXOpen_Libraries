#ifndef NXOpen_ROUTING_GAPARCSEGMENT_HXX_INCLUDED
#define NXOpen_ROUTING_GAPARCSEGMENT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Routing
    {
        class _GapArcSegmentBuilder;
        class GapArcSegmentImpl;
        /** Represents a gap arc segment.  <br> To obtain an instance of this class use @link NXOpen::Routing::SegmentManager NXOpen::Routing::SegmentManager@endlink   <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_ROUTINGEXPORT  GapArcSegment : public NXOpen::Arc, public virtual NXOpen::Routing::ISegment
        {
            private: GapArcSegmentImpl * m_gaparcsegment_impl;
            private: friend class  _GapArcSegmentBuilder;
            protected: GapArcSegment();
            public: ~GapArcSegment();
            /**Returns  the arc orientation. If true, arc opens downwards false, arc opens upwards 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: bool IsArcOpensDown
            (
            );
            /**Sets  the arc orientation. If true, arc opens downwards false, arc opens upwards 
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: void SetArcOpensDown
            (
                bool arcOpensDown /** arcopensdown */ 
            );
