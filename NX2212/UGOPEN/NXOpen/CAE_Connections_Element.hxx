        ...
        namespace Connections
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  Element : public NXOpen::NXObject, public virtual NXOpen::CAE::IExportableFEEntity
            {
                ...
                /**Returns  the node selection method. To be used when connection element has been set up manually (@link NXOpen::CAE::Connections::Element::Manual NXOpen::CAE::Connections::Element::Manual@endlink  is true).
                ...
                /**Sets  the node selection method. To be used when connection element has been set up manually (@link NXOpen::CAE::Connections::Element::Manual NXOpen::CAE::Connections::Element::Manual@endlink  is true).
                ...
                /** Get the elements generated at a given location of a @link CAE::Connections::IConnection CAE::Connections::IConnection@endlink  meshed by this @link CAE::Connections::Element CAE::Connections::Element@endlink .
                 ...
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void GetGeneratedElementsOfConnectionAtLocation
                (
                    NXOpen::CAE::Connections::IConnection * connection /** connection */ ,
                    int indexOfLocation /** indexoflocation */ ,
                    int indexOfDefinitionInLocation /** indexofdefinitioninlocation */ ,
                    std::vector<NXOpen::CAE::FEElement *> & elems /** elems */ 
                );
                /** Get the elements generated for a given @link CAE::Connections::IConnection CAE::Connections::IConnection@endlink  meshed by this @link CAE::Connections::Element CAE::Connections::Element@endlink .
                 ...
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void GetGeneratedElementsOfConnection
                (
                    NXOpen::CAE::Connections::IConnection * connection /** connection */ ,
                    std::vector<NXOpen::CAE::FEElement *> & elems /** elems */ 
                );
                /** Get the nodes generated for a given @link CAE::Connections::IConnection CAE::Connections::IConnection@endlink  meshed by this @link CAE::Connections::Element CAE::Connections::Element@endlink .
                 ...
                 <br>  Created in NX1872.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void GetGeneratedNodesOfConnection
                (
                    NXOpen::CAE::Connections::IConnection * connection /** connection */ ,
                    std::vector<NXOpen::CAE::FENode *> & nodes /** nodes */ 
                );
                ...
                /**Returns  This is an internal API and can be changed at any time 
                 ...
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: bool EnableCompatibleRemesh
                (
                );
                ...
                /**Sets  This is an internal API and can be changed at any time 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_masterfem ("Finite Element Modeling") */
                public: void SetEnableCompatibleRemesh
                (
                    bool enableCompatibleRemesh /** enablecompatibleremesh */ 
                );
