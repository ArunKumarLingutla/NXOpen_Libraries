#ifndef NXOpen_ANNOTATIONS_PMICONTEXTSETTINGSBUILDER_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_PMICONTEXTSETTINGSBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_PmiContextSettingsBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _PmiContextSettingsBuilderBuilder;
        class PmiContextSettingsBuilderImpl;

        /// \cond NX_NO_DOC 
        /** Represents the Context Settings 
         <br>  Created in NX2212.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiContextSettingsBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: PmiContextSettingsBuilderImpl * m_pmicontextsettingsbuilder_impl;
            private: friend class  _PmiContextSettingsBuilderBuilder;
            protected: PmiContextSettingsBuilder();
            public: ~PmiContextSettingsBuilder();

            /// \cond NX_NO_DOC 
            /**Returns  This is an internal API and can be changed at any time 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::PmiContextGeneralBuilder * General
            (
            );
