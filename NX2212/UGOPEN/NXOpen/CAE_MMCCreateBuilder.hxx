    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MMCCreateBuilder : public NXOpen::Builder
        {
            ...
            /** Commits the creation of the @link NXOpen::CAE::MeshMate NXOpen::CAE::MeshMate@endlink  objects and returns false status if any face pair fails  @return  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: std::vector<NXOpen::CAE::MeshMate *> CommitMmcsAndReturnStatus
            (
                bool* noSkippedFacePairs /** noskippedfacepairs */ 
            );
