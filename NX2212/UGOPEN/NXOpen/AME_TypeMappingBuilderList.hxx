#ifndef NXOpen_AME_TYPEMAPPINGBUILDERLIST_HXX_INCLUDED
#define NXOpen_AME_TYPEMAPPINGBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _TypeMappingBuilderListBuilder;
        class TypeMappingBuilderListImpl;
        ...
        */
        class AMEOPENCPPEXPORT  TypeMappingBuilderList : public NXOpen::TaggedObject
        {
            private: TypeMappingBuilderListImpl * m_typemappingbuilderlist_impl;
            private: friend class  _TypeMappingBuilderListBuilder;
            protected: TypeMappingBuilderList();
            public: ~TypeMappingBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::AME::TypeMappingBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::AME::TypeMappingBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::AME::TypeMappingBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::AME::TypeMappingBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::AME::TypeMappingBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::AME::TypeMappingBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::AME::TypeMappingBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::AME::TypeMappingBuilder * object1 /** first item */,
                NXOpen::AME::TypeMappingBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::AME::TypeMappingBuilder * object /** object to be inserted */
            );
