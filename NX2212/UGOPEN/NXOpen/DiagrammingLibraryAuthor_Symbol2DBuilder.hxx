        ...
        */
        class NXOPENCPP_DIAGRAMMINGLIBRARYAUTHOREXPORT  Symbol2DBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the prefix 
             ...
             <br> License requirements : None */
            public: NXString PrefixLetters
            (
            );
            /**Sets  the prefix 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: void SetPrefixLetters
            (
                const NXString & prefixLetters /** prefixletters */ 
            );
            /**Sets  the prefix 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            void SetPrefixLetters
            (
                const char * prefixLetters /** prefixletters */ 
            );
            ...
            /**Returns  the 2D symbol sub-builder. 
             ...
             <br> License requirements : None */
            public: NXOpen::Tooling::SelectReuseLibraryItemBuilder * DraftingSymbol
            (
            );
