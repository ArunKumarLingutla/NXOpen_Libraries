#ifndef NXOpen_FEATURES_USERDEFINEDFEATURECOPYEVENT_HXX_INCLUDED
#define NXOpen_FEATURES_USERDEFINEDFEATURECOPYEVENT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Features_UserDefinedFeatureCopyEvent.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Features
    {
        class _UserDefinedFeatureCopyEventBuilder;
        class UserDefinedFeatureCopyEventImpl;
        /** JA interface for the UserDefinedFeatureCopyEvent object  <br> This calls cannot be created  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  UserDefinedFeatureCopyEvent : public NXOpen::TaggedObject
        {
            private: UserDefinedFeatureCopyEventImpl * m_userdefinedfeaturecopyevent_impl;
            private: friend class  _UserDefinedFeatureCopyEventBuilder;
            protected: UserDefinedFeatureCopyEvent();
            public: ~UserDefinedFeatureCopyEvent();
            /**Returns  the UDF definition 
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::Feature * OriginalInstantiation
            (
            );
