#ifndef NXOpen_DRAWINGS_VIEWLABELBUILDER_HXX_INCLUDED
#define NXOpen_DRAWINGS_VIEWLABELBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class _ViewLabelBuilderBuilder;
        class ViewLabelBuilderImpl;
        /**
            Represents a @link NXOpen::Drawings::ViewLabelBuilder NXOpen::Drawings::ViewLabelBuilder@endlink 
            
         <br>  Created in NX9.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewLabelBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: ViewLabelBuilderImpl * m_viewlabelbuilder_impl;
            private: friend class  _ViewLabelBuilderBuilder;
            protected: ViewLabelBuilder();
            public: ~ViewLabelBuilder();
            ...
            /**Returns  the include rotation symbol 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Drawings::ViewLabelBuilder::RotationSymbolType NXOpen::Drawings::ViewLabelBuilder::RotationSymbolType@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::ViewLabelBuilder::RotationSymbolType instead.") bool IncludeRotationSymbol
            (
            );
            /**Sets  the include rotation symbol 
             <br>  @deprecated Deprecated in NX11.0.1.  Use @link NXOpen::Drawings::ViewLabelBuilder::SetRotationSymbolType NXOpen::Drawings::ViewLabelBuilder::SetRotationSymbolType@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX11.0.1.  Use NXOpen::Drawings::ViewLabelBuilder::SetRotationSymbolType instead.") void SetIncludeRotationSymbol
            (
