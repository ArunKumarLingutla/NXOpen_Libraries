#ifndef NXOpen_DATEITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_DATEITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  DateItemBuilderList : public NXOpen::TaggedObject
    {
        private: DateItemBuilderListImpl * m_dateitembuilderlist_impl;
        private: friend class  _DateItemBuilderListBuilder;
        protected: DateItemBuilderList();
        public: ~DateItemBuilderList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::DateItemBuilder *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::DateItemBuilder * object /** item to append */
        );
        ...
        (
            NXOpen::DateItemBuilder * obj /** Object to find index for */
        );
        /** Returns the object at the input index.  May be NULL.
             @return  object found at input index 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::DateItemBuilder * FindItem
        (
        ...
        public: void Erase
        (
            NXOpen::DateItemBuilder * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::DateItemBuilder *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::DateItemBuilder *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::DateItemBuilder * object1 /** first item */,
            NXOpen::DateItemBuilder * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::DateItemBuilder * object /** object to be inserted */
        );
