        ...
        */
        class NXOPENCPP_POSITIONINGEXPORT  Network : public NXOpen::NXObject
        {
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void BeginLinearDrag
            (
                const NXOpen::Point3d & point /** Initial point */,
                const NXOpen::Vector3d & direction /** Translate direction */
            );
            ...
            (
                const NXOpen::Point3d & point /** Rotation point */,
                const NXOpen::Vector3d & direction /** Rotation axis */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void StepLinearDrag
            (
                double distance /** The translation to be applied in units of the owning part*/
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void StepRotateDrag
            (
                double angle /** The rotation to be applied in units of the owning part*/
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : assemblies ("ASSEMBLIES MODULE") */
            public: void SetMovingGroupWithGeometries
            (
                const std::vector<NXOpen::NXObject *> & movableObjects /** The @link NXObject NXObject@endlink s to be moved as movable objects*/,
                const std::vector<NXOpen::NXObject *> & draggableGeometries /** The @link NXObject NXObject@endlink s to be moved as draggable geometries */
            );
