        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultVariable : public NXOpen::Fields::NameVariable
        {
            ...
            /**Returns  This is an internal API and can be changed at any time 
             ...
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NXString QuantityIdentifier
            (
            );
            ...
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void SetQuantityIdentifier
            (
                const NXString & quantityIdentifier /** quantity identifier */ 
            );
            /**Sets  This is an internal API and can be changed at any time 
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            void SetQuantityIdentifier
            (
                const char * quantityIdentifier /** quantity identifier */ 
            );
