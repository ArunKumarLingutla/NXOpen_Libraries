    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureCollection : public NXOpen::TaggedObjectCollection
        {
            ...
            /// \endcond 
            /** Creates a @link Features::RackBuilder Features::RackBuilder@endlink   @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Creates a @link Features::CylinderGearBuilder Features::CylinderGearBuilder@endlink   @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Creates a @link Features::BevelGearBuilder Features::BevelGearBuilder@endlink   @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            ...
            /** Creates a @link Features::EngageGearBuilder Features::EngageGearBuilder@endlink   @return  
             <br>  Created in NX2212.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
