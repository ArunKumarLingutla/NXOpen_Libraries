#ifndef NXOpen_SELECTMODELINGVIEWLIST_HXX_INCLUDED
#define NXOpen_SELECTMODELINGVIEWLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectModelingViewListBuilder;
    class SelectModelingViewListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectModelingViewList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectModelingViewListImpl * m_selectmodelingviewlist_impl;
        private: friend class  _SelectModelingViewListBuilder;
        protected: SelectModelingViewList();
        public: ~SelectModelingViewList();
        ...
        public: bool Add
        (
            NXOpen::ModelingView * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::ModelingView *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::ModelingView * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::ModelingView * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::ModelingView * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::ModelingView * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::ModelingView *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::ModelingView * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::ModelingView *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ModelingView *> GetArray
        (
        );
