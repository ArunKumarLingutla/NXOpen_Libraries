...
namespace NXOpen
{
    ...
    */
    class NXOPENUICPPEXPORT  CustomPopupMenuHandler : public NXOpen::TransientObject
    {
        ...
        /** Returns a list of node(s) selected during a RMB click. Customer can call this query API
                 inside the implementation of @link NXOpen::CustomPopupMenuHandler::AddCustomPopupMenuCallback NXOpen::CustomPopupMenuHandler::AddCustomPopupMenuCallback@endlink  or 
                 @link NXOpen::CustomPopupMenuHandler::CustomPopupMenuInvokedCallback NXOpen::CustomPopupMenuHandler::CustomPopupMenuInvokedCallback@endlink  to obtain additional information 
         <br>  Created in NX6.0.4.  <br>  
         <br> License requirements : None */
