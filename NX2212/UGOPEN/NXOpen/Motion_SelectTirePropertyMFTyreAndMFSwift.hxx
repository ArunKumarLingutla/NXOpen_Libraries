#ifndef NXOpen_MOTION_SELECTTIREPROPERTYMFTYREANDMFSWIFT_HXX_INCLUDED
#define NXOpen_MOTION_SELECTTIREPROPERTYMFTYREANDMFSWIFT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Motion_SelectTirePropertyMFTyreAndMFSwift.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectTirePropertyMFTyreAndMFSwiftBuilder;
        class SelectTirePropertyMFTyreAndMFSwiftImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectTirePropertyMFTyreAndMFSwift : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectTirePropertyMFTyreAndMFSwiftImpl * m_selecttirepropertymftyreandmfswift_impl;
            private: friend class  _SelectTirePropertyMFTyreAndMFSwiftBuilder;
            protected: SelectTirePropertyMFTyreAndMFSwift();
            public: ~SelectTirePropertyMFTyreAndMFSwift();
            ...
            (
                NXOpen::Motion::TirePropertyMFTyreAndMFSwift * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::TirePropertyMFTyreAndMFSwift * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::TirePropertyMFTyreAndMFSwift * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::TirePropertyMFTyreAndMFSwift * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::TirePropertyMFTyreAndMFSwift * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
