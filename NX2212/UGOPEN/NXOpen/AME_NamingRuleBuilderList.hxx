#ifndef NXOpen_AME_NAMINGRULEBUILDERLIST_HXX_INCLUDED
#define NXOpen_AME_NAMINGRULEBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _NamingRuleBuilderListBuilder;
        class NamingRuleBuilderListImpl;
        ...
        */
        class AMEOPENCPPEXPORT  NamingRuleBuilderList : public NXOpen::TaggedObject
        {
            private: NamingRuleBuilderListImpl * m_namingrulebuilderlist_impl;
            private: friend class  _NamingRuleBuilderListBuilder;
            protected: NamingRuleBuilderList();
            public: ~NamingRuleBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::AME::NamingRuleBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::AME::NamingRuleBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::AME::NamingRuleBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::AME::NamingRuleBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::AME::NamingRuleBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::AME::NamingRuleBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::AME::NamingRuleBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::AME::NamingRuleBuilder * object1 /** first item */,
                NXOpen::AME::NamingRuleBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::AME::NamingRuleBuilder * object /** object to be inserted */
            );
