#ifndef NXOpen_SELECTDISPLAYABLEOBJECT_HXX_INCLUDED
#define NXOpen_SELECTDISPLAYABLEOBJECT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectDisplayableObjectBuilder;
    class SelectDisplayableObjectImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectDisplayableObject : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectDisplayableObjectImpl * m_selectdisplayableobject_impl;
        private: friend class  _SelectDisplayableObjectBuilder;
        protected: SelectDisplayableObject();
        public: ~SelectDisplayableObject();
        ...
        /**Returns  the object being selected
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::DisplayableObject * Value
        (
        );
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::DisplayableObject * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
