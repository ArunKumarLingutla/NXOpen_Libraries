#ifndef NXOpen_CAM_CUTVOLUMELIST_HXX_INCLUDED
#define NXOpen_CAM_CUTVOLUMELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _CutVolumeListBuilder;
        class CutVolumeListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  CutVolumeList : public NXOpen::TaggedObject
        {
            private: CutVolumeListImpl * m_cutvolumelist_impl;
            private: friend class  _CutVolumeListBuilder;
            protected: CutVolumeList();
            public: ~CutVolumeList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::CutVolume *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::CutVolume * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::CutVolume * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CutVolume * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::CutVolume * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::CutVolume *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::CutVolume *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::CutVolume * object1 /** first item */,
                NXOpen::CAM::CutVolume * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::CutVolume * object /** object to be inserted */
            );
