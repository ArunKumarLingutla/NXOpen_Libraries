...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a horizontal dimension  <br> To obtain an instance of this class use @link NXOpen::Annotations::DimensionCollection NXOpen::Annotations::DimensionCollection@endlink   <br> 
         <br>  Created in NX6.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  GeneralHorizontalDimension : public NXOpen::Annotations::BaseHorizontalDimension
        {
