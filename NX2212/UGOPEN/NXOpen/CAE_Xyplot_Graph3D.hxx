#ifndef NXOpen_CAE_XYPLOT_GRAPH3D_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_GRAPH3D_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            class _Graph3DBuilder;
            class Graph3DImpl;
            /** Manages the display graph 3d.  <br> Not support KF.  <br> 
             <br>  Created in NX12.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  Graph3D : public NXOpen::CAE::Xyplot::Graph, public virtual NXOpen::CAE::Xyplot::I3DDataGraph
            {
                private: Graph3DImpl * m_graph3d_impl;
                private: friend class  _Graph3DBuilder;
                protected: Graph3D();
                public: ~Graph3D();
