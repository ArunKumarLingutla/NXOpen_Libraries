        ...
        */
        class NXOPENCPP_MOTIONEXPORT  ControlInputPortBuilder : public NXOpen::Motion::MotionBuilder
        {
            ...
            public: enum MeasuredComponent
            {
                ...
                MeasuredComponentGravityExcludedLocalX/** Gravity Excluded Local X */,
                MeasuredComponentGravityExcludedLocalY/** Gravity Excluded Local Y */,
                MeasuredComponentGravityExcludedLocalZ/** Gravity Excluded Local Z */,
                MeasuredComponentTraveledDistanceLocalX/** Traveled Distance X */,
                MeasuredComponentTraveledDistanceLocalY/** Traveled Distance Y */,
                MeasuredComponentTraveledDistanceLocalZ/** Traveled Distance Z */
            };
            ...
            /** use relative */
            public: enum UseRelativeType
            {
                UseRelativeTypeNo/** Don not use relative */,
                UseRelativeTypeYes/** Use relative */
            };

            /** Measure within */
            public: enum MeasureWithinOption
            {
                MeasureWithinOptionAbsolute/** Absolute */,
                MeasureWithinOptionReference/** Reference */,
                MeasureWithinOptionCSysOfInertia/** CSYS of Inertia */
            };
            ...
            /**Returns  the measure on.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::ControlInputPortBuilder::UseRelativeType UseRelative
            (
            );
            /**Sets  the measure on.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetUseRelative
            (
                NXOpen::Motion::ControlInputPortBuilder::UseRelativeType useRelative /** userelative */ 
            );
            /**Returns  the measure within.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::ControlInputPortBuilder::MeasureWithinOption MeasureWithin
            (
            );
            /**Sets  the measure within.
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMeasureWithin
            (
                NXOpen::Motion::ControlInputPortBuilder::MeasureWithinOption measureWithin /** measurewithin */ 
            );
