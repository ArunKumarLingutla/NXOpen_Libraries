...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a waverouting feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::WaveRoutingBuilder  NXOpen::Features::WaveRoutingBuilder @endlink  <br> 
         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  WaveRouting : public NXOpen::Features::Feature
        {
