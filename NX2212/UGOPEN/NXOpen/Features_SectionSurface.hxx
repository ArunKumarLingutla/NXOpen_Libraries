...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a section surface feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::SectionSurfaceBuilderEx  NXOpen::Features::SectionSurfaceBuilderEx @endlink  <br> 
