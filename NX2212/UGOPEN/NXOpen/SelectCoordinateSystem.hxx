#ifndef NXOpen_SELECTCOORDINATESYSTEM_HXX_INCLUDED
#define NXOpen_SELECTCOORDINATESYSTEM_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectCoordinateSystemBuilder;
    class SelectCoordinateSystemImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectCoordinateSystem : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectCoordinateSystemImpl * m_selectcoordinatesystem_impl;
        private: friend class  _SelectCoordinateSystemBuilder;
        protected: SelectCoordinateSystem();
        ...
        /**Returns  the object being selected
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::CoordinateSystem * Value
        (
        );
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::CoordinateSystem * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
