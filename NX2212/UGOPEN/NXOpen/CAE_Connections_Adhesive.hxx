#ifndef NXOpen_CAE_CONNECTIONS_ADHESIVE_HXX_INCLUDED
#define NXOpen_CAE_CONNECTIONS_ADHESIVE_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Connections
        {
            class _AdhesiveBuilder;
            class AdhesiveImpl;
            /**  Adhesive connection. Use this interface to set/get properties and parameters of the spot weld connection.  
             <br>  Created in NX12.0.0.  <br>  
            */
            class NXOPENCPP_CAEEXPORT  Adhesive : public NXOpen::CAE::Connections::IConnection, public virtual NXOpen::CAE::Connections::IMaterial, public virtual NXOpen::CAE::Connections::ITolerance, public virtual NXOpen::CAE::Connections::IHeight, public virtual NXOpen::CAE::Connections::IFlangesContainer, public virtual NXOpen::CAE::Connections::ILocationsContainer, public virtual NXOpen::CAE::Connections::ILineOffset, public virtual NXOpen::CAE::Connections::ILineDiscretization, public virtual NXOpen::CAE::Connections::IWidth, public virtual NXOpen::CAE::Connections::ILocationsWithDiscretizationContainer, public virtual NXOpen::CAE::Connections::ILocationsMultiPointContainer
            {
                private: AdhesiveImpl * m_adhesive_impl;
                private: friend class  _AdhesiveBuilder;
                protected: Adhesive();
                public: ~Adhesive();
