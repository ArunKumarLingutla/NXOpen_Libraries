...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        Angle1 </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        Angle2 </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        Angle3 </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        Angle4 </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        Angle5 </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        Angle6 </term> <description> 
         
        30 </description> </item> 

        <item><term> 
         
        CurBodies </term> <description> 
        ...
        DesignSequence </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DevLength (deprecated) </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        InterRenameComp </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        Materials (deprecated) </term> <description> 
         
        Steel </description> </item> 

        <item><term> 
         
        NumBends </term> <description> 
         
        Two </description> </item> 

        <item><term> 
         
        NumInter </term> <description> 
         
        1 </description> </item> 

        <item><term> 
         
        OrientPitch </term> <description> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DirectUnfoldBuilder : public NXOpen::Builder
        {
            ...
            (
                NXOpen::NXObject * baseBody /** basebody */ 
            );
            /** Merge bends 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void MergeBends
            (
                const std::vector<NXOpen::NXObject *> & mergeBendsFaces /** an array of merge bends faces */
            );
            /** Define prebends 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void DefinePreBends
            (
                const std::vector<NXOpen::NXObject *> & selBends /** an array of selected faces */
            );
            /** Delete bends 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void DeleteBends
            (
                const std::vector<NXOpen::NXObject *> & bendFaces /** an array of bend faces */
            );
            /** Create Resize Neutral Factor according to k factor 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void CreateResizeNeutralFactorForBody
            (
                NXOpen::NXObject * baseBody /** basebody */ 
            );
            /** Edit Resize Neutral Factor accroding to bend's k factor 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void EditResizeNeutralFactorForBends
            (
                double newKFactor /** newkfactor */ ,
                const std::vector<NXOpen::NXObject *> & bendUDO /** an array of bend UDOs */
            );
            /** Get all bends udo  @return  an array of bend UDO 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : ug_mold_design ("UG MOLD") OR prog_die_wizard ("UG/Progressive Die Wizard") */
            public: std::vector<NXOpen::NXObject *> GetAllBendsUDO
            (
                NXOpen::NXObject * baseBody /** basebody */ 
            );
            /** Set current body 
            ...
            (
                NXOpen::NXObject * currentBody /** currentbody */ 
            );
            /**Returns  the selection list that stores start edges. 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectEdgeList * SelectStartEdge
            (
            );
        };
    }
