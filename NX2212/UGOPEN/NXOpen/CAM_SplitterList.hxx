#ifndef NXOpen_CAM_SPLITTERLIST_HXX_INCLUDED
#define NXOpen_CAM_SPLITTERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _SplitterListBuilder;
        class SplitterListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  SplitterList : public NXOpen::TaggedObject
        {
            private: SplitterListImpl * m_splitterlist_impl;
            private: friend class  _SplitterListBuilder;
            protected: SplitterList();
            public: ~SplitterList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::Splitter *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::Splitter * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::Splitter * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::Splitter * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::Splitter * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::Splitter *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::Splitter *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::Splitter * object1 /** first item */,
                NXOpen::CAM::Splitter * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::Splitter * object /** object to be inserted */
            );
