...
#include <NXOpen/Features_SheetMetal_ConvertInputListItemBuilder.hxx>
        ...
        namespace SheetMetal
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ConvertToSheetmetalBuilder : public NXOpen::Features::SheetMetal::SheetmetalBaseBuilder
            {
                ...
                /**Returns  the bend relief type. Not supported for multi-thickness type.
                ...
                /**Sets  the bend relief type. Not supported for multi-thickness type.
                ...
                /**Returns  the bend relief width. Not supported for multi-thickness type.
                ...
                /**Returns  the bend relief depth. Not supported for multi-thickness type.
                ...
                /**Returns  the base face of local convert from which the thickness of the part is determined.
                 ...
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Face * LocalBaseFace
                (
                );
                /**Sets  the base face of local convert from which the thickness of the part is determined.
                 ...
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetLocalBaseFace
                (
                    NXOpen::Face * localBaseFace /** local base face */ 
                );
                /**Returns  the faces for local convert. Not supported for multi-thickness type. 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::ScCollector * LocalRegionFaces
                (
                );
                /** Create a corner list item. Not supported for multi-thickness type. 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Features::SheetMetal::ConvertInputListItemBuilder * CreateConvertInputListItem
                (
                );
                /**Returns  the corner list. Not supported for multi-thickness type. 
                 <br>  Created in NX12.0.0.  <br>  
                 <br> License requirements : nx_sheet_metal ("NX Sheet Metal") OR nx_flexible_pcb ("NX Flexible PCB") */
                public: NXOpen::Features::SheetMetal::ConvertInputListItemBuilderList * CornerList
                (
                );
                /**Returns  the convert type. If true it means the conversion type is uniform thickness.
                ...
                public: bool IsUniformThickness
                (
                );
                /**Sets  the convert type. If true it means the conversion type is uniform thickness.
                            If false it means the conversion type is multi-thickness. It cannot be changed once set.
                 <br>  Created in NX1980.0.0.  <br>  
                 <br> License requirements : nx_flexible_pcb ("NX Flexible PCB") */
                public: void SetUniformThickness
                (
                    bool isUniform /** convert type */
                );
            };
        }
    }
