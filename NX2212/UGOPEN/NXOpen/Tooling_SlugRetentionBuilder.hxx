...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        ...
        CuttingClearance.Value </term> <description> 
         
        2 (millimeters part), 0.05 (inches part) </description> </item> 

        <item><term> 
         
        CuttingDistance.Value </term> <description> 
         
        10 (millimeters part), 0.25 (inches part) </description> </item> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  SlugRetentionBuilder : public NXOpen::Builder
        {
            ...
            public: enum Types
            {
                TypesTypeFirst/** type first */ ,
                TypesTypeSecond/** type second */ ,
                TypesEdit/** edit */ 
            };
            ...
            /**Returns  the slug retention edge 
             ...
             <br> License requirements : None */
            public: NXOpen::SelectEdge * SlugRetentionEdge
            (
            );
            ...
            /**Returns  the cutting clearance 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * CuttingClearance
            (
            );
            /**Returns  the cutting distance 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Expression * CuttingDistance
            (
            );
            ...
            /**Returns  the type 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Tooling::SlugRetentionBuilder::Types Type
            (
            );
            /**Sets  the type 
             <br>  Created in NX12.0.0.  <br>  
            ...
            public: void SetType
            (
                NXOpen::Tooling::SlugRetentionBuilder::Types type /** type */ 
            );
            /**Returns  the slug edge for type two 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Edge * SlugEdgeForTypeTwo
            (
            );
            /**Sets  the slug edge for type two 
             <br>  Created in NX12.0.0.  <br>  
             <br> License requirements : prog_die_wizard ("UG/Progressive Die Wizard") */
            public: void SetSlugEdgeForTypeTwo
            (
                NXOpen::Edge * slugEdgeForTypeTwo /** slugedgefortypetwo */ 
            );
        };
    }
}
