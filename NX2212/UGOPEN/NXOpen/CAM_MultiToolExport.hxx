#ifndef NXOpen_CAM_MULTITOOLEXPORT_HXX_INCLUDED
#define NXOpen_CAM_MULTITOOLEXPORT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _MultiToolExportBuilder;
        class MultiToolExportImpl;
        /** Represents Multi-Tool Export Builder 
         <br>  Created in NX12.0.1.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  MultiToolExport : public NXOpen::TaggedObject
        {
            ...
            private: MultiToolExportImpl * m_multitoolexport_impl;
            private: friend class  _MultiToolExportBuilder;
            protected: MultiToolExport();
            public: ~MultiToolExport();
            /**Returns  the export type 
             <br>  Created in NX12.0.1.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::MultiToolExport::SaveFlags SaveFlag
            (
            );
            ...
            (
                NXOpen::CAM::MultiToolExport::SaveFlags saveFlag /** The export type */
            );
            ...
            (
                NXOpen::CAM::MultiToolExport::SaveFlags saveFlag /** saveflag */ ,
