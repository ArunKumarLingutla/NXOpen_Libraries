#ifndef NXOpen_ANNOTATIONS_BASERAPIDDIMENSIONBUILDER_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_BASERAPIDDIMENSIONBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_BaseRapidDimensionBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _BaseRapidDimensionBuilderBuilder;
        class BaseRapidDimensionBuilderImpl;
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  BaseRapidDimensionBuilder : public NXOpen::Builder
        {
            private: BaseRapidDimensionBuilderImpl * m_baserapiddimensionbuilder_impl;
            private: friend class  _BaseRapidDimensionBuilderBuilder;
            protected: BaseRapidDimensionBuilder();
            public: ~BaseRapidDimensionBuilder();
