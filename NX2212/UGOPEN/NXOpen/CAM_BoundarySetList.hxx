#ifndef NXOpen_CAM_BOUNDARYSETLIST_HXX_INCLUDED
#define NXOpen_CAM_BOUNDARYSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _BoundarySetListBuilder;
        class BoundarySetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  BoundarySetList : public NXOpen::TaggedObject
        {
            private: BoundarySetListImpl * m_boundarysetlist_impl;
            private: friend class  _BoundarySetListBuilder;
            protected: BoundarySetList();
            public: ~BoundarySetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::BoundarySet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::BoundarySet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::BoundarySet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::BoundarySet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::BoundarySet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::BoundarySet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::BoundarySet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::BoundarySet * object1 /** first item */,
                NXOpen::CAM::BoundarySet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::BoundarySet * object /** object to be inserted */
            );
