...
#include <NXOpen/CAE_Scd5ExportOptionsSettings.hxx>
        ...
        */
        class NXOPENCPP_CAEEXPORT  ResultToSCD5Converter : public NXOpen::TransientObject
        {
            ...
            /**Returns  the output file unit system 
             ...
             <br> License requirements : None */
            public: NXOpen::CAE::ResultToSCD5Converter::UnitSystem UnitSystemOption
            (
            );
            /**Sets  the output file unit system 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : None */
            public: void SetUnitSystemOption
            (
            ...
            /**Returns  the export options settings 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::Scd5ExportOptionsSettings * ExportOptionsSettings
            (
            );
