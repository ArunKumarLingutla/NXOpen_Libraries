#ifndef NXOpen_SELECTINXOBJECTLIST_HXX_INCLUDED
#define NXOpen_SELECTINXOBJECTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectINXObjectListBuilder;
    class SelectINXObjectListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectINXObjectList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectINXObjectListImpl * m_selectinxobjectlist_impl;
        private: friend class  _SelectINXObjectListBuilder;
        protected: SelectINXObjectList();
        public: ~SelectINXObjectList();
        ...
        public: bool Add
        (
            NXOpen::INXObject * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::INXObject *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::INXObject * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::INXObject * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            ...
            NXOpen::INXObject * selection1 /** first selected object */,
            NXOpen::View * view1 /** first selected object view*/,
            const NXOpen::Point3d & point1 /**first  selected object point*/,
            NXOpen::INXObject * selection2 /** second selected object */,
        ...
        (
            const std::vector<NXOpen::INXObject *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::INXObject * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::INXObject *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::INXObject *> GetArray
        (
        );
