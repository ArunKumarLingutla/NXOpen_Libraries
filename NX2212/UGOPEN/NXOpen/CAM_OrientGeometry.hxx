...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        /** Represents a Orient Group <br> To create or edit an instance of this class, use @link NXOpen::CAM::OrientGeomBuilder  NXOpen::CAM::OrientGeomBuilder @endlink  <br> 
         <br>  Created in NX7.5.0.  <br>  
        */
        class NXOPENCPP_CAMEXPORT  OrientGeometry : public NXOpen::CAM::NCGroup
        {
