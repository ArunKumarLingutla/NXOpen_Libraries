#ifndef NXOpen_VSA_TAPEREDPINFEATUREBUILDER_HXX_INCLUDED
#define NXOpen_VSA_TAPEREDPINFEATUREBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Vsa_TaperedPinFeatureBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Vsa
    {
        class _TaperedPinFeatureBuilderBuilder;
        class TaperedPinFeatureBuilderImpl;
        /**
        ...
        */
        class NXOPENCPP_VSAEXPORT  TaperedPinFeatureBuilder : public NXOpen::Builder
        {
            /**
            ...
            private: TaperedPinFeatureBuilderImpl * m_taperedpinfeaturebuilder_impl;
            private: friend class  _TaperedPinFeatureBuilderBuilder;
            protected: TaperedPinFeatureBuilder();
            public: ~TaperedPinFeatureBuilder();
            ...
            /**Returns  the enum size 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedPinFeatureBuilder::APIEnumSize EnumSize
            (
            );
            /**Sets  the enum size 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedPinFeatureBuilder::APIEnumSize enumSize /** enumsize */ 
            );
            ...
            /**Returns  the enum loc 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedPinFeatureBuilder::APIEnumLoc EnumLoc
            (
            );
            /**Sets  the enum loc 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedPinFeatureBuilder::APIEnumLoc enumLoc /** enumloc */ 
            );
            ...
            /**Returns  the enum form 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedPinFeatureBuilder::APIEnumForm EnumForm
            (
            );
            /**Sets  the enum form 
             <br>  Usable only on Windows <br> 
            ...
            (
                NXOpen::Vsa::TaperedPinFeatureBuilder::APIEnumForm enumForm /** enumform */ 
            );
