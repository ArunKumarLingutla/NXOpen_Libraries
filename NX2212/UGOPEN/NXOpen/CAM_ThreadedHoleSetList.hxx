#ifndef NXOpen_CAM_THREADEDHOLESETLIST_HXX_INCLUDED
#define NXOpen_CAM_THREADEDHOLESETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _ThreadedHoleSetListBuilder;
        class ThreadedHoleSetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  ThreadedHoleSetList : public NXOpen::TaggedObject
        {
            private: ThreadedHoleSetListImpl * m_threadedholesetlist_impl;
            private: friend class  _ThreadedHoleSetListBuilder;
            protected: ThreadedHoleSetList();
            public: ~ThreadedHoleSetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::ThreadedHoleSet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::ThreadedHoleSet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::ThreadedHoleSet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ThreadedHoleSet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::ThreadedHoleSet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::ThreadedHoleSet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::ThreadedHoleSet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::ThreadedHoleSet * object1 /** first item */,
                NXOpen::CAM::ThreadedHoleSet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::ThreadedHoleSet * object /** object to be inserted */
            );
