        ...
        */
        class NXOPENCPP_DIEEXPORT  PressModel : public NXOpen::TransientObject
        {
            ...
            /** Set operation cushion values 
             ...
             <br> License requirements : ug_die_design ("Die Design") */
            public: void SetOperationCushionSettings2
            (
                int operation /** Operation of the cushion */,
                double ventilationLiftDistance /** Ventilation lift distance */,
                int ventilationLiftStay /** Ventilation lift stay duration in degrees */,
                double binderWayLiftDistance /** Binder way lift distance */,
                int binderWayLiftDuration /** Binder way lift duration in degrees */,
                double upperLimit /** Cushion range upper limit */,
                double lowerLimit /** Cushion range lowe limit */
            );
