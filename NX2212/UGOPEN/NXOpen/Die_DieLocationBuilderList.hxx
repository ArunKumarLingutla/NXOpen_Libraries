#ifndef NXOpen_DIE_DIELOCATIONBUILDERLIST_HXX_INCLUDED
#define NXOpen_DIE_DIELOCATIONBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Die
    {
        class _DieLocationBuilderListBuilder;
        class DieLocationBuilderListImpl;
        ...
        */
        class NXOPENCPP_DIEEXPORT  DieLocationBuilderList : public NXOpen::TaggedObject
        {
            private: DieLocationBuilderListImpl * m_dielocationbuilderlist_impl;
            private: friend class  _DieLocationBuilderListBuilder;
            protected: DieLocationBuilderList();
            public: ~DieLocationBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Die::DieLocationBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Die::DieLocationBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Die::DieLocationBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Die::DieLocationBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Die::DieLocationBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Die::DieLocationBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Die::DieLocationBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Die::DieLocationBuilder * object1 /** first item */,
                NXOpen::Die::DieLocationBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Die::DieLocationBuilder * object /** object to be inserted */
            );
