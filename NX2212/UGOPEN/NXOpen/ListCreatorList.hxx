#ifndef NXOpen_LISTCREATORLIST_HXX_INCLUDED
#define NXOpen_LISTCREATORLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ListCreatorList : public NXOpen::TaggedObject
    {
        private: ListCreatorListImpl * m_listcreatorlist_impl;
        private: friend class  _ListCreatorListBuilder;
        protected: ListCreatorList();
        public: ~ListCreatorList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::ListCreator *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::ListCreator * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::ListCreator * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ListCreator *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::ListCreator *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::ListCreator * object1 /** first item */,
            NXOpen::ListCreator * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::ListCreator * object /** object to be inserted */
        );
