...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        /** Represents a concentric circle dimension  <br> To obtain an instance of this class use @link NXOpen::Annotations::DimensionCollection NXOpen::Annotations::DimensionCollection@endlink   <br> 
