        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ManufacturingAssemblyNavigatorBuilder : public NXOpen::Builder
            {
                ...
                /** Get the super plate part. 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::NXObject * GetSuperPlate
                (
                );
                /** Create a super plate 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_super_plate ("Ship Super Plate") */
                public: void CreateSuperPlate
                (
                    const std::vector<NXOpen::NXObject *> & sourcePartOccs /** sourcepartoccs */ 
                );
                /** Get the part name of the super plate. 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString GetSuperPlateName
                (
                );
                /** Set the super plate part name
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_super_plate ("Ship Super Plate") */
                public: void SetSuperPlateName
                (
                    const NXString & superPlateName /** superplatename */ 
                );
                /** Set the super plate part name
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_super_plate ("Ship Super Plate") */
                void SetSuperPlateName
                (
                    const char * superPlateName /** superplatename */ 
                );
                /** Get the container name of the super plate. 
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString GetSuperPlateContainerName
                (
                );
                /** Set the super plate part container name
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_super_plate ("Ship Super Plate") */
                public: void SetSuperPlateContainerName
                (
                    const NXString & superPlateContainerName /** superplatecontainername */ 
                );
                /** Set the super plate part container name
                 <br>  Created in NX1953.0.0.  <br>  
                 <br> License requirements : nx_ship_super_plate ("Ship Super Plate") */
                void SetSuperPlateContainerName
                (
                    const char * superPlateContainerName /** superplatecontainername */ 
                );
                /** Set the super plate container part
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_super_plate ("Ship Super Plate") */
                public: void SetSuperPlateContainer
                (
                    NXOpen::NXObject * partTag /** parttag */ 
                );
                /** Get the super plate container part 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::NXObject * GetSuperPlateContainer
                (
                );
            };
        }
