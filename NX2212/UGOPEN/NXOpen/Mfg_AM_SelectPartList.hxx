#ifndef NXOpen_MFG_AM_SELECTPARTLIST_HXX_INCLUDED
#define NXOpen_MFG_AM_SELECTPARTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Mfg
    {
        namespace AM
        {
            ...
            class SelectPartListImpl;
            /** Represents a list of objects on a selection list.

             <br>  Created in NX5.0.0.  <br>  
            */
            class MFGAMOPENCPPEXPORT  SelectPartList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                private: SelectPartListImpl * m_selectpartlist_impl;
                private: friend class  _SelectPartListBuilder;
                protected: SelectPartList();
                public: ~SelectPartList();
                ...
                public: bool Add
                (
                    NXOpen::Mfg::AM::Part * object /** object to add */
                );
                ...
                public: bool Add
                (
                    const std::vector<NXOpen::Mfg::AM::Part *> & objects /** objects to add */
                );
                ...
                public: bool Add
                (
                    NXOpen::Mfg::AM::Part * selection /** selected object */,
                ...
                public: bool Remove
                (
                    NXOpen::Mfg::AM::Part * object /** Object to remove */
                );
                /** Remove specified object from list.
                     @return  True if successfully removed from list;
                ...
                (
                    ...
                    NXOpen::Mfg::AM::Part * selection1 /** first selected object */,
                    NXOpen::View * view1 /** first selected object view*/,
                    const NXOpen::Point3d & point1 /**first  selected object point*/,
                    NXOpen::Mfg::AM::Part * selection2 /** second selected object */,
                ...
                (
                    const std::vector<NXOpen::Mfg::AM::Part *> & objects /** Objects to remove */
                );
                ...
                (
                    NXOpen::Mfg::AM::Part * object /** object to check */
                );
                ...
                (
                    const std::vector<NXOpen::Mfg::AM::Part *> & objects /** items to put in the list*/
                );
                /** Returns the list of objects in the selection list.
                     @return  items in list 
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::Mfg::AM::Part *> GetArray
                (
                );
