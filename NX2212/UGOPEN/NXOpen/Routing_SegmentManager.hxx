    ...
    namespace Routing
    {
        ...
        */
        class NXOPENCPP_ROUTINGEXPORT  SegmentManager
        {
            ...
            /**  @brief  Creates a @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  object.  

             
                     <br>  This class provides the ability to query and edit Routing Spline Segments.  <br> 
                     <br>  The @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  provides access to an array of
                           @link NXOpen::Routing::DefiningPoint NXOpen::Routing::DefiningPoint@endlink  objects which identify the
                           positions and optional directions and forward/backward magnitudes for extensions.  <br>   @return  a new @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  object 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: NXOpen::Routing::SplineData * CreateSplineData
            (
                NXOpen::Routing::ISegment * splineSegment /** a @link NXOpen::Routing::ISegment NXOpen::Routing::ISegment@endlink  */
            );
            /**  @brief  Create a new @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  object.  

             
                     <br>  This class provides the ability to create, query and edit Routing Spline Segments from an array of positions.  <br> 
                     <br>  The @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  provides access to an array of
                           @link NXOpen::Routing::DefiningPoint NXOpen::Routing::DefiningPoint@endlink  objects which identify the
                           positions and optional directions and forward/backward magnitudes for extensions.  <br>   @return  a new @link NXOpen::Routing::SplineData NXOpen::Routing::SplineData@endlink  object 
             <br>  Created in NX1953.0.0.  <br>  
            ...
            public: NXOpen::Routing::SplineData * CreateSplineData
            (
                const std::vector<NXOpen::Point3d> & positions /** an input array of defining positions */
            );
            /** Tests whether two segments are tangent to one another where they both are connected at
                        the given Control Point.  @return  Are the two segments tangent? 
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : routing_base ("Routing Basic") */
            public: bool AreSegmentsTangent
            (
                NXOpen::Routing::ISegment * segment1 /** The first @link NXOpen::Routing::ISegment NXOpen::Routing::ISegment@endlink . */,
                NXOpen::Routing::ISegment * segment2 /** The second @link NXOpen::Routing::ISegment NXOpen::Routing::ISegment@endlink . */,
                NXOpen::Routing::ControlPoint * controlPoint /** The @link NXOpen::Routing::ControlPoint NXOpen::Routing::ControlPoint@endlink  common to both segments. */
            );
