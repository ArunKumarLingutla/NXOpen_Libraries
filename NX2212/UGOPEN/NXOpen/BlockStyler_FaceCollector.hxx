#ifndef NXOpen_BLOCKSTYLER_FACECOLLECTOR_HXX_INCLUDED
#define NXOpen_BLOCKSTYLER_FACECOLLECTOR_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        class _FaceCollectorBuilder;
        class FaceCollectorImpl;
        /** Represents a Face Collector
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENUICPPEXPORT  FaceCollector : public NXOpen::BlockStyler::UIBlock
        {
            private: FaceCollectorImpl * m_facecollector_impl;
            private: friend class  _FaceCollectorBuilder;
            protected: FaceCollector();
            public: ~FaceCollector();
            /**Returns  the AutomaticProgression. If true, focus automatically progresses to the next selection block.
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: bool AutomaticProgression
            (
            );
            /**Sets  the AutomaticProgression. If true, focus automatically progresses to the next selection block.
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            ...
            /**Sets  the FaceRules
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void SetFaceRules
            (
                int faceRules /** facerules */ 
            );
            ...
            /**Returns  the DefaultFaceRules as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXString DefaultFaceRulesAsString
            (
            );
            /**Sets  the DefaultFaceRules as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void SetDefaultFaceRulesAsString
            (
                const NXString & enumString /** enumstring */ 
            );
            /**Sets  the DefaultFaceRules as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            void SetDefaultFaceRulesAsString
            (
                const char * enumString /** enumstring */ 
            );
            /** Gets the DefaultFaceRules members @return Value to get from the property
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetDefaultFaceRulesMembers
            (
            );
            ...
            /**Returns  the AllowConvergentObjectWithMixedGeometries
             ...
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  This property is no longer relevant as hybrid selection is default ON now.") bool AllowConvergentObjectWithMixedGeometries
            (
            );
            /**Sets  the AllowConvergentObjectWithMixedGeometries
             ...
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  This property is no longer relevant as hybrid selection is default ON now.") void SetAllowConvergentObjectWithMixedGeometries
            (
            ...
            /** Set collector objects
             ...
             <br> License requirements : None */
            public: void SetCollectorObjectOfFaceCollector
            (
                NXOpen::ScCollector * collectorObject /** collectorobject */ 
            );
            /** Get collector objects
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * GetCollectorObjectOfFaceCollector
            (
            );
            ...
            (
                const std::vector<NXOpen::TaggedObject *> & objectVector /** objectvector */ 
            );
        };
    }
}
