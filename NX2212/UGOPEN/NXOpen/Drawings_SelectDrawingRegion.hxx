#ifndef NXOpen_DRAWINGS_SELECTDRAWINGREGION_HXX_INCLUDED
#define NXOpen_DRAWINGS_SELECTDRAWINGREGION_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Drawings_SelectDrawingRegion.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class _SelectDrawingRegionBuilder;
        class SelectDrawingRegionImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  SelectDrawingRegion : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDrawingRegionImpl * m_selectdrawingregion_impl;
            private: friend class  _SelectDrawingRegionBuilder;
            protected: SelectDrawingRegion();
            public: ~SelectDrawingRegion();
            ...
            (
                NXOpen::Drawings::DrawingRegion * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Drawings::DrawingRegion * Value
            (
            );
            ...
            (
                ...
                NXOpen::Drawings::DrawingRegion * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Drawings::DrawingRegion * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Drawings::DrawingRegion * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
