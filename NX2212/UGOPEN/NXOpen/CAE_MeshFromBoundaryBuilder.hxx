    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  MeshFromBoundaryBuilder : public NXOpen::Builder
        {
            ...
            /**  Type of closed loop */
            public: enum ClosedLoopMethod
            {
                ClosedLoopMethodEdge/** using element edge */,
                ClosedLoopMethodGroup/** using group reference */,
                ClosedLoopMethodMesh/** using mesh */
            };
            ...
            public: enum RailOption
            {
                ...
                RailOptionAutomatic/** automaticaly calculate layer */
            };
            ...
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  There is no replacement for this function.") void SetSourceElementEdgePathMethod
            (
            ...
            /** Set the target elemnt path of the selection 
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  There is no replacement for this function.") void SetTargetElementEdgePathMethod
            (
            ...
            /**Returns  the type of loop  
             <br>  @deprecated Deprecated in NX1953.0.0.  Use @link NXOpen::CAE::MeshFromBoundaryBuilder::Type NXOpen::CAE::MeshFromBoundaryBuilder::Type@endlink  instead. <br>  

             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::CAE::MeshFromBoundaryBuilder::Type instead.") NXOpen::CAE::MeshFromBoundaryBuilder::LoopOption LoopType
            (
            );
            /**Sets  the type of loop  
             ...
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NX_DEPRECATED("Deprecated in NX1953.0.0.  Use NXOpen::CAE::MeshFromBoundaryBuilder::Type instead.") void SetLoopType
            (
            ...
            /**Returns  the selected rail1 path 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::SelectTaggedObjectList * Rail1Selection
            (
            );
            /**Returns  the selected rail2 path 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::SelectTaggedObjectList * Rail2Selection
            (
            );
            /**Returns  the loop type 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::MeshFromBoundaryBuilder::LoopOption Type
            (
            );
            /**Sets  the loop type 
             <br>  Created in NX1953.0.0.  <br>  
            ...
            public: void SetType
            (
                NXOpen::CAE::MeshFromBoundaryBuilder::LoopOption loopType /** looptype */ 
            );
            /**Returns  the closed loop method 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: NXOpen::CAE::MeshFromBoundaryBuilder::ClosedLoopMethod ClosedLoopMethodType
            (
            );
            /**Sets  the closed loop method 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void SetClosedLoopMethodType
            (
                NXOpen::CAE::MeshFromBoundaryBuilder::ClosedLoopMethod loopMethod /** loopmethod */ 
            );
            /**Returns  the selected mesh for closed loop 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectTaggedObjectList * ClosedLoopSelectionMesh
            (
            );
        };
    }
