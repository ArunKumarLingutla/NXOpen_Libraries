#ifndef NXOpen_REPORT_COMMANDLIBRARY_HXX_INCLUDED
#define NXOpen_REPORT_COMMANDLIBRARY_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Report
    {
        ...
        class CommandLibraryImpl;
        /** Represents a command library in the command manager. <br> Not support KF.  <br> 
         <br>  Created in NX11.0.0.  <br>  
        */
        class NXOPENCPP_REPORTEXPORT  CommandLibrary : public NXOpen::TaggedObject, public virtual NXOpen::INXObject
        {
            /** Represents the moving command location. */
            public: enum MoveCommandLocation
            {
                MoveCommandLocationBefore/** Move commands ahead of a referenced command */,
                MoveCommandLocationAfter/** Move commands behind a referenced command */
            };

            private: CommandLibraryImpl * m_commandlibrary_impl;
            private: friend class  _CommandLibraryBuilder;
            ...
            (
                const std::vector<NXOpen::Report::Command *> & pCommand /** pcommand */ ,
                NXOpen::Report::CommandLibrary::MoveCommandLocation newLocation /** newlocation */ ,
                NXOpen::Report::Command * pReferenceCommand /** preferencecommand */ 
            );
