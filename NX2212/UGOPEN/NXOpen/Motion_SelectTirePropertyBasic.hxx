#ifndef NXOpen_MOTION_SELECTTIREPROPERTYBASIC_HXX_INCLUDED
#define NXOpen_MOTION_SELECTTIREPROPERTYBASIC_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Motion_SelectTirePropertyBasic.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectTirePropertyBasicBuilder;
        class SelectTirePropertyBasicImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectTirePropertyBasic : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectTirePropertyBasicImpl * m_selecttirepropertybasic_impl;
            private: friend class  _SelectTirePropertyBasicBuilder;
            protected: SelectTirePropertyBasic();
            public: ~SelectTirePropertyBasic();
            ...
            (
                NXOpen::Motion::TirePropertyBasic * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::TirePropertyBasic * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::TirePropertyBasic * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::TirePropertyBasic * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::TirePropertyBasic * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
