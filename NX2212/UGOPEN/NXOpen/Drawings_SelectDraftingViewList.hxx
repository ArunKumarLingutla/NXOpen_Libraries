#ifndef NXOpen_DRAWINGS_SELECTDRAFTINGVIEWLIST_HXX_INCLUDED
#define NXOpen_DRAWINGS_SELECTDRAFTINGVIEWLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Drawings_SelectDraftingViewList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class _SelectDraftingViewListBuilder;
        class SelectDraftingViewListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  SelectDraftingViewList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDraftingViewListImpl * m_selectdraftingviewlist_impl;
            private: friend class  _SelectDraftingViewListBuilder;
            protected: SelectDraftingViewList();
            public: ~SelectDraftingViewList();
            ...
            public: bool Add
            (
                NXOpen::Drawings::DraftingView * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Drawings::DraftingView *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Drawings::DraftingView * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Drawings::DraftingView * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Drawings::DraftingView * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Drawings::DraftingView * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Drawings::DraftingView *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Drawings::DraftingView * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Drawings::DraftingView *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Drawings::DraftingView *> GetArray
            (
            );
