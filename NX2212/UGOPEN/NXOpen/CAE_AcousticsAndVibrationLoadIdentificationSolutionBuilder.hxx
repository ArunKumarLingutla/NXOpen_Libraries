        ...
        */
        class NXOPENCPP_CAEEXPORT  AcousticsAndVibrationLoadIdentificationSolutionBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the vibration data accessor. 
             <br>  @deprecated Deprecated in NX2212.0.0.  Use <ja_property>NXOpen.CAE.AcousticsAndVibrationLoadIdentificationSolutionBuilder.InputQuantity</ja_property> instead. <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2212.0.0.  Use <ja_property>NXOpen.CAE.AcousticsAndVibrationLoadIdentificationSolutionBuilder.InputQuantity</ja_property> instead.") NXOpen::CAE::AcousticsAndVibrationVibrationDataComponentAccessor * VibrationData
            (
            );
