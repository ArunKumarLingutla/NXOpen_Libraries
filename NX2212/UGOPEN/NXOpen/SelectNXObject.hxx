#ifndef NXOpen_SELECTNXOBJECT_HXX_INCLUDED
#define NXOpen_SELECTNXOBJECT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class NXObject;
    class View;
    class _SelectNXObjectBuilder;
    class SelectNXObjectImpl;
    /** Represents a single object selection.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectNXObject : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectNXObjectImpl * m_selectnxobject_impl;
        private: friend class  _SelectNXObjectBuilder;
        protected: SelectNXObject();
        public: ~SelectNXObject();
        ...
        /** The object being selected with CAE set object information.
         ...
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::NXObject * GetValue
        (
            NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
            int* caeSubId /** CAE set object sub id*/
        );
