...
#include <NXOpen/CAE_LaminatePly.hxx>
#include <NXOpen/CAE_LaminatePlyFilterBuilder.hxx>
#include <NXOpen/CAE_LaminateReportObject.hxx>
        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateSpreadsheetReportBuilder : public NXOpen::Builder
        {
            ...
            public: enum FilteringType
            {
                ...
                FilteringTypeStressVonMises/** Filter values based on the von mises stress */,
                ...
                FilteringTypeStrainVonMises/** Filter values based on the von mises strain */,
            ...
            public: enum SortingType
            {
                ...
                SortingTypeStressVonMises/** Sort results using the VON MISES stress */,
                ...
                SortingTypeStrainVonMises/** Sort results using the von mises strain */,
            ...
            /**Returns  the element filter 
             <br>  @deprecated Deprecated in NX1847.0.0.  Use @link NXOpen::CAE::LaminateSpreadsheetReportBuilder::ReportObject NXOpen::CAE::LaminateSpreadsheetReportBuilder::ReportObject@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::LaminateSpreadsheetReportBuilder::ReportObject instead.") NXOpen::CAE::LaminateElementFilterBuilder * ElementFilter
            (
            );
            /**Returns  the ply filter 
             ...
             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1847.0.0.  Use NXOpen::CAE::LaminateSpreadsheetReportBuilder::ReportObject instead.") NXOpen::CAE::LaminatePlyFilterBuilder * PlyFilter
            (
            );
            /**Returns  the solver input 
            ...
            /**Returns  the report object 
             ...
             <br> License requirements : None */
            public: NXOpen::CAE::LaminateReportObject * ReportObject
            (
            );
            ...
            (
                NXOpen::CAE::LaminateReportObject * reportObj /** reportobj */ 
            );
            /**Returns  the ply fialure theory override 1 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool PlyFTOverride1State
            (
            );
            /**Sets  the ply fialure theory override 1 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetPlyFTOverride1State
            (
                bool plyFTState /** plyftstate */ 
            );
            /**Returns  the ply fialure theory override 1 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::LaminatePly::PlyFailureTheoryType PlyFTOverride1
            (
            );
            /**Sets  the ply fialure theory override 1 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetPlyFTOverride1
            (
                NXOpen::CAE::LaminatePly::PlyFailureTheoryType plyFT /** plyft */ 
            );
            /**Returns  the user defined ply failure theory override 1
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXString UserDefinedPlyFTOverride1
            (
            );
            /**Sets  the user defined ply failure theory override 1
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void SetUserDefinedPlyFTOverride1
            (
            ...
            /**Sets  the user defined ply failure theory override 1
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void SetUserDefinedPlyFTOverride1
            (
            ...
            /**Returns  the interlaminare fialure theory override 1 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool InterLamFTOverride1State
            (
            );
            /**Sets  the interlaminare fialure theory override 1 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetInterLamFTOverride1State
            (
                bool interlamFTState /** interlamftstate */ 
            );
            /**Returns  the Interlaminar fialure theory override 1 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::LaminatePly::InterLaminarFailureTheoryType InterLamFTOverride1
            (
            );
            /**Sets  the Interlaminar fialure theory override 1 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetInterLamFTOverride1
            (
                NXOpen::CAE::LaminatePly::InterLaminarFailureTheoryType interLamFT /** interlamft */ 
            );
            /**Returns  the user defined interLam failure theory override 1
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXString UserDefinedInterLamFTOverride1
            (
            );
            /**Sets  the user defined interLam failure theory override 1
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void SetUserDefinedInterLamFTOverride1
            (
                const NXString & name /** the user defined ply failure theory name */
            );
            /**Sets  the user defined interLam failure theory override 1
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void SetUserDefinedInterLamFTOverride1
            (
                const char * name /** the user defined ply failure theory name */
            );
            /**Returns  the ply fialure theory override 2 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool PlyFTOverride2State
            (
            );
            /**Sets  the ply fialure theory override 2 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetPlyFTOverride2State
            (
                bool plyFTState /** plyftstate */ 
            );
            /**Returns  the ply fialure theory override 2 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::LaminatePly::PlyFailureTheoryType PlyFTOverride2
            (
            );
            /**Sets  the ply fialure theory override 2 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetPlyFTOverride2
            (
                NXOpen::CAE::LaminatePly::PlyFailureTheoryType plyFT /** plyft */ 
            );
            /**Returns  the user defined ply failure theory override 2
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXString UserDefinedPlyFTOverride2
            (
            );
            /**Sets  the user defined ply failure theory override 2
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void SetUserDefinedPlyFTOverride2
            (
                const NXString & name /** the user defined ply failure theory name */
            );
            /**Sets  the user defined ply failure theory override 2
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void SetUserDefinedPlyFTOverride2
            (
                const char * name /** the user defined ply failure theory name */
            );
            /**Returns  the interlaminare fialure theory override 2 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: bool InterLamFTOverride2State
            (
            );
            /**Sets  the interlaminare fialure theory override 2 state 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetInterLamFTOverride2State
            (
                bool interlamFTState /** interlamftstate */ 
            );
            /**Returns  the Interlaminar fialure theory override 2 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAE::LaminatePly::InterLaminarFailureTheoryType InterLamFTOverride2
            (
            );
            /**Sets  the Interlaminar fialure theory override 2 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetInterLamFTOverride2
            (
                NXOpen::CAE::LaminatePly::InterLaminarFailureTheoryType interLamFT /** interlamft */ 
            );
            /**Returns  the user defined interLam failure theory override 2
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXString UserDefinedInterLamFTOverride2
            (
            );
            /**Sets  the user defined interLam failure theory override 2
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: void SetUserDefinedInterLamFTOverride2
            (
                const NXString & name /** the user defined ply failure theory name */
            );
            /**Sets  the user defined interLam failure theory override 2
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            void SetUserDefinedInterLamFTOverride2
            (
                const char * name /** the user defined ply failure theory name */
            );
            /**Returns  the ply Von Mises stress and/or strain 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : None */
            public: bool PlyVonMises
            (
            );
            /**Sets  the ply Von Mises stress and/or strain 
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_lam_composites ("Laminate Composites") */
            public: void SetPlyVonMises
            (
                bool plyVonMises /** plyvonmises */ 
            );
        };
    }
}
