#ifndef NXOpen_BLOCKSTYLER_BODYCOLLECTOR_HXX_INCLUDED
#define NXOpen_BLOCKSTYLER_BODYCOLLECTOR_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace BlockStyler
    {
        class _BodyCollectorBuilder;
        class BodyCollectorImpl;
        /** Represents a Body Collector block
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENUICPPEXPORT  BodyCollector : public NXOpen::BlockStyler::UIBlock
        {
            private: BodyCollectorImpl * m_bodycollector_impl;
            private: friend class  _BodyCollectorBuilder;
            ...
            /**Returns  the BodyRules
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: int BodyRules
            (
            );
            /**Sets  the BodyRules
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void SetBodyRules
            (
                int bodyRules /** bodyrules */ 
            );
            ...
            /**Returns  the DefaultBodyRules as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: NXString DefaultBodyRulesAsString
            (
            );
            /**Sets  the DefaultBodyRules as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: void SetDefaultBodyRulesAsString
            (
                const NXString & enumString /** enumstring */ 
            );
            /**Sets  the DefaultBodyRules as string
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            void SetDefaultBodyRulesAsString
            (
                const char * enumString /** enumstring */ 
            );
            /** Gets the DefaultBodyRules members @return Value to get from the property
             <br>  Created in NX8.5.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXString> GetDefaultBodyRulesMembers
            (
            );
            ...
            /**Returns  the IncludeSheetBodies
             ...
             <br> License requirements : None */
            public: bool IncludeSheetBodies
            (
            );
            /**Sets  the IncludeSheetBodies
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : None */
            public: void SetIncludeSheetBodies
            (
            ...
            /** Sets the collector object
             ...
             <br> License requirements : None */
            public: void SetCollectorObjectOfBodyCollector
            (
            ...
            /** Get the collector object
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * GetCollectorObjectOfBodyCollector
            (
            );
