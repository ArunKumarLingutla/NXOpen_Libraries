        ...
        */
        class NXOPENCPP_GEOMETRICUTILITIESEXPORT  OrientationMethodBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the normal face list. For orientation by Face Normals, the second axis of the local coordinate system is aligned with the resultant 
             ...
             <br>  @deprecated Deprecated in NX12.0.0.  Use @link NXOpen::GeometricUtilities::OrientationMethodBuilder::Faces NXOpen::GeometricUtilities::OrientationMethodBuilder::Faces@endlink  <br>  

             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use NXOpen::GeometricUtilities::OrientationMethodBuilder::Faces") NXOpen::SelectFaceList * NormalFaceList
            (
            );
