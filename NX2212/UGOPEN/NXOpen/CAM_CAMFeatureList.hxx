#ifndef NXOpen_CAM_CAMFEATURELIST_HXX_INCLUDED
#define NXOpen_CAM_CAMFEATURELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _CAMFeatureListBuilder;
        class CAMFeatureListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  CAMFeatureList : public NXOpen::TaggedObject
        {
            private: CAMFeatureListImpl * m_camfeaturelist_impl;
            private: friend class  _CAMFeatureListBuilder;
            protected: CAMFeatureList();
            public: ~CAMFeatureList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::CAMFeature *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::CAMFeature * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::CAMFeature * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::CAMFeature * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::CAMFeature * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::CAMFeature *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::CAMFeature *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::CAMFeature * object1 /** first item */,
                NXOpen::CAM::CAMFeature * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::CAMFeature * object /** object to be inserted */
            );
