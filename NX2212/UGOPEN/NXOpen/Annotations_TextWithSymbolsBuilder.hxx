    ...
    namespace Annotations
    {
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  TextWithSymbolsBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /** Adds a symbol 
             <br>  @deprecated Deprecated in NX2007.0.0.  Instead use @link NXOpen::Annotations::TextWithSymbolsBuilder::CreateEmbeddedAnnotationText NXOpen::Annotations::TextWithSymbolsBuilder::CreateEmbeddedAnnotationText@endlink  for creating embedded symbol text. <br>  

             <br>  Created in NX7.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Instead use NXOpen::Annotations::TextWithSymbolsBuilder::CreateEmbeddedAnnotationText for creating embedded symbol text.") void AddSymbol
            (
            ...
            /** Get the alignment of embedded symbol corresponding to symbol name @return  Symbol Alignment 
            ...
            /** Set the alignment on embedded symbol corresponding to symbol name
             <br>  Created in NX11.0.1.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            ...
            /** Adds embedded annotation  @return  Embedded Annotation Text 
             <br>  @deprecated Deprecated in NX2007.0.0.  Instead use @link NXOpen::Annotations::TextWithSymbolsBuilder::CreateEmbeddedAnnotationText NXOpen::Annotations::TextWithSymbolsBuilder::CreateEmbeddedAnnotationText@endlink  for creating embedded annotation text. <br>  

             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX2007.0.0.  Instead use NXOpen::Annotations::TextWithSymbolsBuilder::CreateEmbeddedAnnotationText for creating embedded annotation text.") NXString AddEmbeddedAnnotation
            (
                NXOpen::NXObject * embeddedAnnotation /** Embedded Annotation object */,
                int lineNo /** line number to insert token with index from 1 */,
                int cursorPos /** cursor position in the line with index from 1 */
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NXString CopyEmbeddedAnnotation
            (
                const NXString & inputText /** inputtext */ ,
                bool* isCopied /** iscopied */ 
            );
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            NXString CopyEmbeddedAnnotation
            (
            ...
            /// \endcond 
            /** Create text for embedding annotation, which can be used in
                      @link NXOpen::Annotations::TextWithSymbolsBuilder::SetText NXOpen::Annotations::TextWithSymbolsBuilder::SetText@endlink  to embed annotation in text. @return  Embedded Annotation Text 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NXString CreateEmbeddedAnnotationText
            (
                NXOpen::NXObject * embeddedAnnotation /** Embedded Annotation object */
            );
