    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  SimConditionSequence : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the condition sequence's name 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXString Name
            (
            );
            /**Sets  the condition sequence's name 
             <br>  Created in NX1926.0.0.  <br>  
            ...
            /** Returns the interpolated value of a @link NXOpen::CAE::SimConditionParam NXOpen::CAE::SimConditionParam@endlink  at
                        the specified time. Same units as specified @link NXOpen::CAE::SimConditionParam NXOpen::CAE::SimConditionParam@endlink .
                        Will behave as specified in @link NXOpen::CAE::SimConditionSequence::OutOfRangeBehavior NXOpen::CAE::SimConditionSequence::OutOfRangeBehavior@endlink . 
             <br>  Created in NX9.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: double GetValue
            (
            ...
            /** Returns the condition sequence's dependent solutions  @return  all @link NXOpen::CAE::SimSolution NXOpen::CAE::SimSolution@endlink  
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
