#ifndef NXOpen_MOTION_SELECTSPLINEBEAMPROPERTY_HXX_INCLUDED
#define NXOpen_MOTION_SELECTSPLINEBEAMPROPERTY_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Motion_SelectSplineBeamProperty.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Motion
    {
        class _SelectSplineBeamPropertyBuilder;
        class SelectSplineBeamPropertyImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_MOTIONEXPORT  SelectSplineBeamProperty : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSplineBeamPropertyImpl * m_selectsplinebeamproperty_impl;
            private: friend class  _SelectSplineBeamPropertyBuilder;
            protected: SelectSplineBeamProperty();
            public: ~SelectSplineBeamProperty();
            ...
            (
                NXOpen::Motion::SplineBeamProperty * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::SplineBeamProperty * Value
            (
            );
            ...
            (
                ...
                NXOpen::Motion::SplineBeamProperty * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Motion::SplineBeamProperty * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Motion::SplineBeamProperty * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
