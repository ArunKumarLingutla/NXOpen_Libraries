#ifndef NXOpen_SELECTPOINTLIST_HXX_INCLUDED
#define NXOpen_SELECTPOINTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectPointListBuilder;
    class SelectPointListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectPointList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectPointListImpl * m_selectpointlist_impl;
        private: friend class  _SelectPointListBuilder;
        protected: SelectPointList();
        public: ~SelectPointList();
        ...
        public: bool Add
        (
            NXOpen::Point * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Point *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::Point * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::Point * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Point *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Point * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Point *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Point *> GetArray
        (
        );
