...
namespace NXOpen
{
    ...
    EnableFeatureTree </term> <description> 
    ...
    IncludeNoShowEntity </term> <description> 
    ...
    SimplifyFacesandEdges </term> <description> 
     
    0 </description> </item> 

    <item><term> 
     
    TotalSearchDirectories </term> <description> 
    ...
    */
    class NXOPENCPPEXPORT  Catiav5Importer : public NXOpen::BaseImporter
    {
        /** Import To Option */
        ...
        /**Returns  the include reference geometry - if set to true the reference geometry from catia v5 will be imported to NX 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        public: bool IncludeRefGeom
        (
        );
        /**Sets  the include reference geometry - if set to true the reference geometry from catia v5 will be imported to NX 
         <br>  Created in NX1872.0.0.  <br>  
         <br> License requirements : None */
        ...
        /**Returns  the enable feature tree behavior - if set to true feature and feature group info from catia v5 will be imported to NX 
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: bool EnableFeatureTree
        (
        );
        /**Sets  the enable feature tree behavior - if set to true feature and feature group info from catia v5 will be imported to NX 
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: void SetEnableFeatureTree
        (
            bool enableFeatureTree /** enablefeaturetree */ 
        );
