#ifndef NXOpen_FEATURES_FEATURELIST_HXX_INCLUDED
#define NXOpen_FEATURES_FEATURELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FeatureList : public NXOpen::TaggedObject
        {
            private: FeatureListImpl * m_featurelist_impl;
            private: friend class  _FeatureListBuilder;
            ...
            public: void Append
            (
                const std::vector<NXOpen::Features::Feature *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Features::Feature * object /** item to append */
            );
            ...
            (
                NXOpen::Features::Feature * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Features::Feature * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Features::Feature * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Features::Feature *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Features::Feature *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Features::Feature * object1 /** first item */,
                NXOpen::Features::Feature * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Features::Feature * object /** object to be inserted */
            );
