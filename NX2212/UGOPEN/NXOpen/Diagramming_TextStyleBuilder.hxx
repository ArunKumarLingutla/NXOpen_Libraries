    ...
    namespace Diagramming
    {
        ...
        */
        class NXOPENCPP_DIAGRAMMINGEXPORT  TextStyleBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            */
            public: enum TruncationModes
            {
                TruncationModesNone/** none */ ,
                TruncationModesTrim/** trim */ ,
                TruncationModesSuffix/** suffix */ 
            };
            ...
            /**Returns  the text truncation mode 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Diagramming::TextStyleBuilder::TruncationModes TruncationMode
            (
            );
            /**Sets  the text truncation mode 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: void SetTruncationMode
            (
                NXOpen::Diagramming::TextStyleBuilder::TruncationModes truncation /** truncation */ 
            );
