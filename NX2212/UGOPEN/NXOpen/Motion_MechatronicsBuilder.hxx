    ...
    namespace Motion
    {
        ...
        */
        class NXOPENCPP_MOTIONEXPORT  MechatronicsBuilder : public NXOpen::Motion::MotionBuilder, public virtual NXOpen::IExternalFileReferencer
        {
            ...
            /** the mechatronics simulation type - possible values are ModelExchange and CoSimulation*/
            public: enum SolverSimulationType
            {
                SolverSimulationTypeCoSimulation/** co simulation */ ,
                SolverSimulationTypeModelExchange/** model exchange */ 
            };
            ...
            /** the element that defines if a Generic Co-Sim is main or not*/
            public: enum Main
            {
                MainNo/** no */ ,
                MainYes/** yes */ 
            ...
            /**Returns  the input ports list for Generic
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::InputPortAssociationList * InputPortsListGeneric
            (
            );
            /**Returns  the input ports list for FMI
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::InputPortAssociationList * InputPortsListFMI
            (
            );
            ...
            /**Returns  the output ports list for Generic
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::OutputPortAssociationList * OutputPortsListGeneric
            (
            );
            /**Returns  the output ports list for FMI
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::OutputPortAssociationList * OutputPortsListFMI
            (
            );
            /**Returns  the input ports list during export 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::InputPortAssociationList * InputPortsListExport
            (
            );
            /**Returns  the output ports list during export 
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::OutputPortAssociationList * OutputPortsListExport
            (
            );
            ...
            /**Returns  a value that represents if a Generic Co-Sim is master - possible values Yes or No
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::Motion::MechatronicsBuilder::IsMain NXOpen::Motion::MechatronicsBuilder::IsMain@endlink  instead. <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Motion::MechatronicsBuilder::IsMain instead.") NXOpen::Motion::MechatronicsBuilder::Master IsMaster
            (
            );
            /**Sets  a value that represents if a Generic Co-Sim is master - possible values Yes or No
             ...
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Motion::MechatronicsBuilder::IsMain instead.") void SetMaster
            (
                NXOpen::Motion::MechatronicsBuilder::Master isMaster /** ismaster */ 
            );
            /**Returns  a value that represents if a Generic Co-Sim is main - possible values Yes or No
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: NXOpen::Motion::MechatronicsBuilder::Main IsMain
            (
            );
            /**Sets  a value that represents if a Generic Co-Sim is main - possible values Yes or No
             <br>  Created in NX2206.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMain
            (
                NXOpen::Motion::MechatronicsBuilder::Main isMain /** ismain */ 
            );
