#ifndef NXOpen_SELECTOBJECTLIST_HXX_INCLUDED
#define NXOpen_SELECTOBJECTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class TaggedObject;
    class View;
    class _SelectObjectListBuilder;
    class SelectObjectListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectObjectList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectObjectListImpl * m_selectobjectlist_impl;
        private: friend class  _SelectObjectListBuilder;
        protected: SelectObjectList();
        public: ~SelectObjectList();
