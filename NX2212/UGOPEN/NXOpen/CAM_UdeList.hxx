#ifndef NXOpen_CAM_UDELIST_HXX_INCLUDED
#define NXOpen_CAM_UDELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        class NXOPENCPP_CAMEXPORT  UdeList : public NXOpen::TaggedObject
        {
            private: UdeListImpl * m_udelist_impl;
            private: friend class  _UdeListBuilder;
            protected: UdeList();
            public: ~UdeList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::Ude *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::Ude * object /** item to append */
            );
            ...
            public: void Erase
            (
                NXOpen::CAM::Ude * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::Ude *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::Ude *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::Ude * object1 /** first item */,
                NXOpen::CAM::Ude * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::Ude * object /** object to be inserted */
            );
