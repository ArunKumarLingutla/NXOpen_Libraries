#ifndef NXOpen_CAE_SELECTSIMBCLIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTSIMBCLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectSimBCListBuilder;
        class SelectSimBCListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SelectSimBCList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectSimBCListImpl * m_selectsimbclist_impl;
            private: friend class  _SelectSimBCListBuilder;
            protected: SelectSimBCList();
            public: ~SelectSimBCList();
            ...
            public: bool Add
            (
                NXOpen::CAE::SimBC * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::SimBC *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAE::SimBC * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAE::SimBC * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::CAE::SimBC * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::CAE::SimBC * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::CAE::SimBC *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::SimBC * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::SimBC *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::SimBC *> GetArray
            (
            );
