    ...
    namespace AME
    {
        ...
        */
        class AMEOPENCPPEXPORT  ShowHideObjectsBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the setting for showing/hiding connectors in aspect navigators
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: bool ShowConnectors
            (
            );
            /**Sets  the setting for showing/hiding connectors in aspect navigators
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void SetShowConnectors
            (
                bool showConnectors /** showconnectors */ 
            );
        };
    }
}
