#ifndef NXOpen_CAE_MESHCOLLECTORDISPLAYDEFAULTS3D_HXX_INCLUDED
#define NXOpen_CAE_MESHCOLLECTORDISPLAYDEFAULTS3D_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     CAE_MeshCollectorDisplayDefaults3d.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class MeshCollectorDisplayDefaults3dImpl;
        /** Represents 3d Mesh Display Settings  <br> To obtain an instance of this class use 
                                   CAE::MeshCollector, or CAE::MeshCollectorOccurrence classes  <br> 
         <br>  Created in NX8.5.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  MeshCollectorDisplayDefaults3d : public NXOpen::CAE::MeshCollectorDisplayDefaults
        {
            private: MeshCollectorDisplayDefaults3dImpl * m_meshcollectordisplaydefaults3d_impl;
            /// \cond NX_NO_DOC 
            public: explicit MeshCollectorDisplayDefaults3d(void *ptr);
            /// \endcond 
            ...
            public: virtual ~MeshCollectorDisplayDefaults3d();
