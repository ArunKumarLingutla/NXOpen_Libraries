        ...
        */
        class CLDKINOPENCPPEXPORT  JointJogBuilder : public NXOpen::Builder
        {
            ...
            /** Update m_jointValuePairVector 
             ...
             <br> License requirements : None */
            public: void UpdateJointValuePairVector
            (
                NXOpen::TaggedObject * nxkJoint /** nxkjoint */ ,
                double newValue /** newvalue */ 
            );
            /** Clear m_jointValuePairVector
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void ClearJointValuePairVector
            (
            );
            /** Dry apply pose for part occ
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void DryApplyPoseForPartOcc
            (
            ...
            /** Update m_partOccToJointVectorMapPtr
             <br>  Created in NX1953.0.0.  <br>  
             <br> License requirements : None */
            public: void UpdatePartOccToJointVectorMapPtr
            (
                NXOpen::TaggedObject * partOccTag /** partocctag */ ,
                NXOpen::TaggedObject * nxkJointTag /** nxkjointtag */ 
            );
            /** Get the last jogged device in case of multi devices jogging @return  
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::NXObject * GetLastJoggedDevice
            (
            );
            /** Set the last jogged device in case of multi devices jogging
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : None */
            public: void SetLastJoggedDevice
            (
                NXOpen::NXObject * lastDeviceJoggedDevice /** lastdevicejoggeddevice */ 
            );
        };
    }
}
