#ifndef NXOpen_ANNOTATIONS_SELECTBASECUSTOMSYMBOLLIST_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTBASECUSTOMSYMBOLLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_SelectBaseCustomSymbolList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectBaseCustomSymbolListBuilder;
        class SelectBaseCustomSymbolListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectBaseCustomSymbolList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectBaseCustomSymbolListImpl * m_selectbasecustomsymbollist_impl;
            private: friend class  _SelectBaseCustomSymbolListBuilder;
            protected: SelectBaseCustomSymbolList();
            public: ~SelectBaseCustomSymbolList();
            ...
            public: bool Add
            (
                NXOpen::Annotations::BaseCustomSymbol * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Annotations::BaseCustomSymbol *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::Annotations::BaseCustomSymbol * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::Annotations::BaseCustomSymbol * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::Annotations::BaseCustomSymbol * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::Annotations::BaseCustomSymbol * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::Annotations::BaseCustomSymbol *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Annotations::BaseCustomSymbol * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Annotations::BaseCustomSymbol *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::BaseCustomSymbol *> GetArray
            (
            );
