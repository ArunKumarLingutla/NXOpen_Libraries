#ifndef NXOpen_AME_SELECTAMEBASENODELIST_HXX_INCLUDED
#define NXOpen_AME_SELECTAMEBASENODELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace AME
    {
        class _SelectAMEBaseNodeListBuilder;
        class SelectAMEBaseNodeListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class AMEOPENCPPEXPORT  SelectAMEBaseNodeList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAMEBaseNodeListImpl * m_selectamebasenodelist_impl;
            private: friend class  _SelectAMEBaseNodeListBuilder;
            protected: SelectAMEBaseNodeList();
            public: ~SelectAMEBaseNodeList();
            ...
            public: bool Add
            (
                NXOpen::AME::AMEBaseNode * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::AME::AMEBaseNode *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::AME::AMEBaseNode * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::AME::AMEBaseNode * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::AME::AMEBaseNode * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::AME::AMEBaseNode * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::AME::AMEBaseNode *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::AME::AMEBaseNode * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::AME::AMEBaseNode *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::AME::AMEBaseNode *> GetArray
            (
            );
