        ...
        namespace ShipDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  ManufacturingOutBuilder : public NXOpen::Features::FeatureBuilder
            {
                ...
                {
                    OutputTypesPlate/** plate */ ,
                    OutputTypesProfile/** profile */ 
                };
                ...
                /**Returns  the output type: plate or profile 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Features::ShipDesign::ManufacturingOutBuilder::OutputTypes OutputType
                (
                );
                /**Sets  the output type: plate or profile 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetOutputType
                (
                    NXOpen::Features::ShipDesign::ManufacturingOutBuilder::OutputTypes outputType /** outputtype */ 
                );
                ...
                /**Returns  the output XML file for profiles 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                public: NXString ProfileXmlOutputFile
                (
                );
                /**Sets  the output XML file for profiles 
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetProfileXmlOutputFile
                (
                    const NXString & fileName /** filename */ 
                );
                /**Sets  the output XML file for profiles 
                ...
                /**Returns  the component whose sub-components will be processed for XML Output.
                 <br>  Created in NX2007.0.0.  <br>  
                 <br> License requirements : None */
                ...
                /**Sets  This is an internal API and can be changed at any time 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : nx_ship_concept ("Ship Concept") OR nx_ship_mfg_prep ("Ship Manufacturing") */
                public: void SetExportDXFFile
                (
                    bool exportDXFFile /** exportdxffile */ 
                );
