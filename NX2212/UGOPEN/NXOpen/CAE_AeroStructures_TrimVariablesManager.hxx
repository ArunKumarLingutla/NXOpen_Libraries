    ...
    namespace CAE
    {
        namespace AeroStructures
        {
            ...
            /** Represents a @link NXOpen::CAE::AeroStructures::TrimVariablesManager NXOpen::CAE::AeroStructures::TrimVariablesManager@endlink  object.  <br> To obtain an instance of this class, refer to @link NXOpen::Session  NXOpen::Session @endlink  <br> 
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager NXOpen::CAE::TrimVariablesManager@endlink  instead <br>  

             <br>  Created in NX1926.0.0.  <br>  
            */
            class NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager instead") NXOPENCPP_CAEEXPORT  TrimVariablesManager
            {
                ...
                */
                ...
                /**
                 ...
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager::EnsureVariablesConsistency NXOpen::CAE::TrimVariablesManager::EnsureVariablesConsistency@endlink  instead <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : sc_margin_safety ("Simcenter Margin Of Safety") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager::EnsureVariablesConsistency instead") void EnsureVariablesConsistency
                (
                    NXOpen::TaggedObject * solution /** solution */ 
                );
                /** Set the value of a numeric property of a subcase 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager::SetTrimPropertyValue NXOpen::CAE::TrimVariablesManager::SetTrimPropertyValue@endlink  instead <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : sc_margin_safety ("Simcenter Margin Of Safety") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager::SetTrimPropertyValue instead") void SetTrimPropertyValue
                (
                ...
                /** Add a variable definition to the solution aestat 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager::AddVariable NXOpen::CAE::TrimVariablesManager::AddVariable@endlink  instead <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : sc_margin_safety ("Simcenter Margin Of Safety") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager::AddVariable instead") void AddVariable
                (
                    NXOpen::TaggedObject * solution /** solution */ ,
                ...
                /** Delete the variable definition from the solution aestat or control surfaces container
                 ...
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager::DeleteVariable NXOpen::CAE::TrimVariablesManager::DeleteVariable@endlink  instead <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : sc_margin_safety ("Simcenter Margin Of Safety") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager::DeleteVariable instead") void DeleteVariable
                (
                    NXOpen::TaggedObject * solution /** solution */ ,
                    const NXString & variableName /** variablename */ 
                );
                ...
                /** Set the magnitude of the variable fixed constraint for a subcase. 
                 ...
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager::SetFixedVariableConstraint NXOpen::CAE::TrimVariablesManager::SetFixedVariableConstraint@endlink  instead <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : sc_margin_safety ("Simcenter Margin Of Safety") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager::SetFixedVariableConstraint instead") void SetFixedVariableConstraint
                (
                    NXOpen::TaggedObject * solution /** solution */ ,
                    NXOpen::TaggedObject * subcase /** subcase */ ,
                    const NXString & variableName /** variablename */ ,
                ...
                /** Create a linked modeling object, select the dependent variable and 
                             ...
                             If the subcase already has a fixed or linked constraint defined for that
                             variable, it is first removed. 
                 <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::CAE::TrimVariablesManager::SetLinkedVariableConstraint NXOpen::CAE::TrimVariablesManager::SetLinkedVariableConstraint@endlink  instead <br>  

                 <br>  Created in NX1926.0.0.  <br>  
                 <br> License requirements : sc_margin_safety ("Simcenter Margin Of Safety") */
                public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::CAE::TrimVariablesManager::SetLinkedVariableConstraint instead") NXOpen::TaggedObject * SetLinkedVariableConstraint
                (
                    NXOpen::TaggedObject * solution /** solution */ ,
                    NXOpen::TaggedObject * subcase /** subcase */ ,
                    const NXString & variableName /** variablename */ ,
