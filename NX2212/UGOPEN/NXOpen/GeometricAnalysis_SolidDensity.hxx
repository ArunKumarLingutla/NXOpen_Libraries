    ...
    namespace GeometricAnalysis
    {
        ...
        */
        class NXOPENCPP_GEOMETRICANALYSISEXPORT  SolidDensity : public NXOpen::Builder
        {
            ...
            {
                UnitsTypePoundsPerCubicInches/** lbm/in^3 */,
                UnitsTypePoundsPerCubicFeet/** lbm/ft^3 */,
                UnitsTypeGramsPerCubicCentimeters/** g/cm^3 */,
                UnitsTypeKilogramsPerCubicMeters/** kg/m^3 */
            };
