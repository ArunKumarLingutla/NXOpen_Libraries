#ifndef NXOpen_POINTLIST_HXX_INCLUDED
#define NXOpen_POINTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  PointList : public NXOpen::TaggedObject
    {
        private: PointListImpl * m_pointlist_impl;
        private: friend class  _PointListBuilder;
        protected: PointList();
        public: ~PointList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::Point *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::Point * object /** item to append */
        );
        ...
        public: void Erase
        (
            NXOpen::Point * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Point *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::Point *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::Point * object1 /** first item */,
            NXOpen::Point * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::Point * object /** object to be inserted */
        );
