#ifndef NXOpen_CAM_LASERCONTROLPOINTLIST_HXX_INCLUDED
#define NXOpen_CAM_LASERCONTROLPOINTLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _LaserControlPointListBuilder;
        class LaserControlPointListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  LaserControlPointList : public NXOpen::TaggedObject
        {
            private: LaserControlPointListImpl * m_lasercontrolpointlist_impl;
            private: friend class  _LaserControlPointListBuilder;
            protected: LaserControlPointList();
            public: ~LaserControlPointList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::LaserControlPoint *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::LaserControlPoint * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::LaserControlPoint * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::LaserControlPoint * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::LaserControlPoint * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::LaserControlPoint *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::LaserControlPoint *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::LaserControlPoint * object1 /** first item */,
                NXOpen::CAM::LaserControlPoint * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::LaserControlPoint * object /** object to be inserted */
            );
