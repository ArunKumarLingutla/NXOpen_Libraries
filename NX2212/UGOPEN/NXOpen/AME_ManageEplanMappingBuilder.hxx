        ...
        */
        class AMEOPENCPPEXPORT  ManageEplanMappingBuilder : public NXOpen::AME::AMEBaseBuilder
        {
            ...
            /** Delete selected Eplan property value and its mapping if present
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void DeleteEplanPropertyValue
            (
                NXOpen::NXObject * eplanPropertyObject /** eplanpropertyobject */ ,
                const NXString & selectedEplanPropId /** selectedeplanpropid */ ,
            ...
            /** Delete selected Eplan property and its mapping if present
             ...
             <br> License requirements : ad_automation_design ("FULL AUTOMATION DESIGNER") */
            public: void DeleteEplanProperty
            (
                const NXString & selectedEplanPropId /** selectedeplanpropid */ ,
                bool isPort /** isport */ 
            );
