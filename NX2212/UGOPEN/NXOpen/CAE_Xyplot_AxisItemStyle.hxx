        ...
        namespace Xyplot
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  AxisItemStyle : public NXOpen::CAE::Xyplot::TextStyleSetting
            {
                ...
                (
                    int maximumCharacterCount /** maximumcharactercount */ 
                );
                /**Returns  the truncation direction 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: NXOpen::CAE::Xyplot::AxisItemTruncationDirection TruncationDirection
                (
                );
                /**Sets  the truncation direction 
                 <br>  Created in NX2212.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetTruncationDirection
                (
                    NXOpen::CAE::Xyplot::AxisItemTruncationDirection truncationDirection /** truncationdirection */ 
                );
            };
        }
    }
