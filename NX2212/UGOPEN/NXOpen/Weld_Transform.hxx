#ifndef NXOpen_WELD_TRANSFORM_HXX_INCLUDED
#define NXOpen_WELD_TRANSFORM_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Weld
    {
        ...
        class TransformImpl;
        /** Represents a Weld Transform Feature.  <br> To create or edit an instance of this class, use @link NXOpen::Weld::TransformBuilder  NXOpen::Weld::TransformBuilder @endlink  <br> 
         <br>  Created in NX11.0.1.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  Transform : public NXOpen::Features::BodyFeature, public virtual NXOpen::Weld::IFeature
        {
            private: TransformImpl * m_transform_impl;
            private: friend class  _TransformBuilder;
            protected: Transform();
            public: ~Transform();
