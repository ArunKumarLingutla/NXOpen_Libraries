        ...
        */
        class NXOPENCPP_CAMEXPORT  InspectionToleranceOperationBuilder : public NXOpen::CAM::OperationBuilder
        {
            ...
            public: enum UnitBasisExtent
            {
                ...
                UnitBasisExtentVariableTolerance/** Variable Tolerance */
            };
            ...
            public: enum ParamTolDistbCalcMode
            {
                ...
                ParamTolDistbCalcModeDefault/** Default */
            };
            ...
            /**Returns  the variable tolerance outer boundary feature 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObject * SelectionVariableToleranceOuterBoundaryFeature
            (
            );
            /**Returns  the variable tolerance outer boundary feature name 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : None */
            public: NXString StringVariableToleranceOuterBoundaryFeatureName
            (
            );
            /**Sets  the variable tolerance outer boundary feature name 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetStringVariableToleranceOuterBoundaryFeatureName
            (
            ...
            /**Sets  the variable tolerance outer boundary feature name 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            void SetStringVariableToleranceOuterBoundaryFeatureName
            (
                const char * stringOriginFeatName /** stringoriginfeatname */ 
            );
            /**Returns  the variable tolerance inner boundary feature 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::SelectNXObject * SelectionVariableToleranceInnerBoundaryFeature
            (
            );
            /**Returns  the variable tolerance inner boundary feature name 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : None */
            public: NXString StringVariableToleranceInnerBoundaryFeatureName
            (
            );
            /**Sets  the variable tolerance inner boundary feature name 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            public: void SetStringVariableToleranceInnerBoundaryFeatureName
            (
                const NXString & stringOriginFeatName /** stringoriginfeatname */ 
            );
            /**Sets  the variable tolerance inner boundary feature name 
             <br>  Created in NX2019.0.0.  <br>  
             <br> License requirements : insp_programming ("INSPECTION PROGRAMMING") */
            void SetStringVariableToleranceInnerBoundaryFeatureName
            (
                const char * stringOriginFeatName /** stringoriginfeatname */ 
            );
