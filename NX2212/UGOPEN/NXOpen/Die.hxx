...
namespace NXOpen
{
    namespace Die
    {
        ...
        {
            DirectionOptionFromEnd/** Profile direction is aligned with the first curve from the end to start. */ = -1,
            DirectionOptionFromStart/** Profile direction is aligned with the first curve from the start to end. */ = 1
        };
