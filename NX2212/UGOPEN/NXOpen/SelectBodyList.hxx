#ifndef NXOpen_SELECTBODYLIST_HXX_INCLUDED
#define NXOpen_SELECTBODYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectBodyListBuilder;
    class SelectBodyListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectBodyList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectBodyListImpl * m_selectbodylist_impl;
        private: friend class  _SelectBodyListBuilder;
        protected: SelectBodyList();
        public: ~SelectBodyList();
        ...
        public: bool Add
        (
            NXOpen::Body * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Body *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::Body * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::Body * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Body *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Body * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Body *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Body *> GetArray
        (
        );
