#ifndef NXOpen_VSA_TAPEREDSLOTFEATUREBUILDER_HXX_INCLUDED
#define NXOpen_VSA_TAPEREDSLOTFEATUREBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Vsa_TaperedSlotFeatureBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Vsa
    {
        class _TaperedSlotFeatureBuilderBuilder;
        class TaperedSlotFeatureBuilderImpl;
        /**
        ...
        */
        class NXOPENCPP_VSAEXPORT  TaperedSlotFeatureBuilder : public NXOpen::Builder
        {
            /**
            ...
            private: TaperedSlotFeatureBuilderImpl * m_taperedslotfeaturebuilder_impl;
            private: friend class  _TaperedSlotFeatureBuilderBuilder;
            protected: TaperedSlotFeatureBuilder();
            public: ~TaperedSlotFeatureBuilder();
            ...
            /**Sets  the property represents  slot feature name. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
            ...
            /**Sets  the property represents  slot feature discription. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            ...
            /**Sets  the property represents  length of slot. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            ...
            /**Sets  the property represents  depth of slot. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            ...
            /**Sets  the property represents  width of slot. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            ...
            /**Sets  the property represents  width2 of slot. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            ...
            /**Sets  the property represents  Angle of slot. 
             <br>  Usable only on Windows <br> 
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : nx_vsa_build (" Building VSA model") */
            ...
            /**Returns  the property represents  Size distribution type. 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedSlotFeatureBuilder::APIEnumSize EnumSize
            (
            );
            ...
            (
                NXOpen::Vsa::TaperedSlotFeatureBuilder::APIEnumSize enumSize /** enumsize */ 
            );
            ...
            /**Returns  the property represents  Loc distribution type. 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedSlotFeatureBuilder::APIEnumLoc EnumLoc
            (
            );
            ...
            (
                NXOpen::Vsa::TaperedSlotFeatureBuilder::APIEnumLoc enumLoc /** enumloc */ 
            );
            ...
            /**Returns  the property represents  Form distribution type. 
             ...
             <br>  Created in NX1926.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Vsa::TaperedSlotFeatureBuilder::APIEnumForm EnumForm
            (
            );
            ...
            (
                NXOpen::Vsa::TaperedSlotFeatureBuilder::APIEnumForm enumForm /** enumform */ 
            );
