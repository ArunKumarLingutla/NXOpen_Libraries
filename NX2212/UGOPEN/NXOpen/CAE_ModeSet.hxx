    ...
    namespace CAE
    {
        ...
        */
        class NXOPENCPP_CAEEXPORT  ModeSet : public NXOpen::CAE::AlternateFemRepresentationSource, public virtual NXOpen::CAE::IPostScenarioDataSource
        {
            ...
            /** Get the infos of all modes. 
             <br>  Created in NX1980.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") */
            public: void GetAllModesInfos
            (
                std::vector<NXOpen::CAE::ModeSet::ModeInfo> & modesInfos /** the array of structures containing the infos of all modes */
            );
