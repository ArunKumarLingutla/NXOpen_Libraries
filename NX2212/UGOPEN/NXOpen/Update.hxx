    ...
    class NXOPENCPPEXPORT  Update
    {
        ...
        */
        ...
        /**Sets  the delay status for intrapart part modules delays
         <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity@endlink  instead. <br>  

         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity instead.") void SetIntrapartPartModuleDelay
        (
            bool delayed /** The new state of the interpart delay flag. */
        );
        /**Returns  the delay status for intrapart part modules delays
         <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::Preferences::SessionModeling::DelayModelUpdates NXOpen::Preferences::SessionModeling::DelayModelUpdates@endlink  and @link NXOpen::Preferences::SessionModeling::ModelDelayUpdateGranilarity NXOpen::Preferences::SessionModeling::ModelDelayUpdateGranilarity@endlink instead. <br>  

         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::Preferences::SessionModeling::DelayModelUpdates and NXOpen::Preferences::SessionModeling::ModelDelayUpdateGranilarityinstead.") bool IntrapartPartModuleDelay
        (
        );
        /** Updates all out-of-date intrapart part modules 
         <br>  @deprecated Deprecated in NX1899.0.0.  Use @link Update::UpdateModel Update::UpdateModel@endlink instead. <br>  

         <br>  Created in NX9.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use Update::UpdateModelinstead.") void UpdateAllIntrapartPartModulesInPart
        (
            NXOpen::Part * partTag /** parttag */ ,
            NXOpen::Session::UndoMarkId undoMarkId /** If any update error occurs, the system will roll back to this
                                                                  undo mark. */
        ...
        /**Sets  This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::Preferences::SessionModeling::SetDelayModelUpdateAndGranularity instead.") void SetModelUpdateDelay
        (
        ...
        /**Returns  This is an internal API and can be changed at any time 
         ...
         <br>  Created in NX1847.0.0.  <br>  
         <br> License requirements : None */
        public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::Preferences::SessionModeling::DelayModelUpdates and NXOpen::Preferences::SessionModeling::ModelDelayUpdateGranilarityinstead.") bool ModelUpdateDelay
        (
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void LogObjectsToMakeUpToDate
        (
            NXOpen::TaggedObject * objectTag /** The feature to be made UTD */
        );
        ...
        /** This is an internal API and can be changed at any time 
         ...
         <br> License requirements : None */
        public: void DoPhasedInterpartUpdate
        (
            NXOpen::Session::UndoMarkId undoMark /** If any update error occurs, the system will roll back to this
                                                                 undo mark. */
        );
