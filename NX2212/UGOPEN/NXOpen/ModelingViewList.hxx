#ifndef NXOpen_MODELINGVIEWLIST_HXX_INCLUDED
#define NXOpen_MODELINGVIEWLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    */
    class NXOPENCPPEXPORT  ModelingViewList : public NXOpen::TaggedObject
    {
        private: ModelingViewListImpl * m_modelingviewlist_impl;
        private: friend class  _ModelingViewListBuilder;
        protected: ModelingViewList();
        public: ~ModelingViewList();
        ...
        public: void Append
        (
            const std::vector<NXOpen::ModelingView *> & objects /** items to append */
        );
        ...
        public: void Append
        (
            NXOpen::ModelingView * object /** item to append */
        );
        ...
        (
            NXOpen::ModelingView * obj /** Object to find index for */
        );
        /** Returns the object at the input index.  May be NULL.
             @return  object found at input index 
         <br>  Created in NX4.0.0.  <br>  
         <br> License requirements : None */
        public: NXOpen::ModelingView * FindItem
        (
        ...
        public: void Erase
        (
            NXOpen::ModelingView * obj /** object to be removed from the list */
        );
        ...
        /** Gets the contents of the entire list  @return  The list contents 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::ModelingView *> GetContents
        (
        );
        ...
        (
            const std::vector<NXOpen::ModelingView *> & objects /** The list contents */
        );
        ...
        public: void Swap
        (
            NXOpen::ModelingView * object1 /** first item */,
            NXOpen::ModelingView * object2 /** second item */
        );
        ...
        (
            ...
            NXOpen::ModelingView * object /** object to be inserted */
        );
