        ...
        namespace Xyplot
        {
            ...
            */
            class NXOPENCPP_CAEEXPORT  Preference : public NXOpen::TaggedObject
            {
                ...
                public: enum DropActionOption
                {
                    DropActionOptionAuto/** Overlay on existing plot, create new plot on non-plot view */,
                    DropActionOptionPlot/** Always create new plot on the dropped view */,
                    DropActionOptionPlotOnNewWindow/** Always create plot on a new grpahics window for all selected data */,
                    DropActionOptionPlotOnMultipleNewWindows/** Create plot on multiple new graphics window, each plot contains a single data */,
                    DropActionOptionMetaKey/** Same to "Auto" if no meta key pressed, Press "ALT" is equivalent to "Plot", 
                ...
                /**Returns  the action when dropping data to a viewport 
                 ...
                 <br> License requirements : None */
                public: NXOpen::CAE::Xyplot::Preference::DropActionOption DropOnPlotViewAction
                (
                );
                /**Sets  the action when dropping data to a viewport 
                 <br>  Created in NX2206.0.0.  <br>  
                 <br> License requirements : None */
                public: void SetDropOnPlotViewAction
                (
                    NXOpen::CAE::Xyplot::Preference::DropActionOption dropAction /** dropaction */ 
                );
