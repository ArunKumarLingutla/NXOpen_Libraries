#ifndef NXOpen_DIAGRAMMING_GEOMETRY_SELECTBASEGEOMETRYLIST_HXX_INCLUDED
#define NXOpen_DIAGRAMMING_GEOMETRY_SELECTBASEGEOMETRYLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Diagramming_Geometry_SelectBaseGeometryList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Diagramming
    {
        namespace Geometry
        {
            class _SelectBaseGeometryListBuilder;
            class SelectBaseGeometryListImpl;
            /** Represents a list of objects on a selection list.

             <br>  Created in NX5.0.0.  <br>  
            */
            class NXOPENCPP_DIAGRAMMINGEXPORT  SelectBaseGeometryList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                private: SelectBaseGeometryListImpl * m_selectbasegeometrylist_impl;
                private: friend class  _SelectBaseGeometryListBuilder;
                protected: SelectBaseGeometryList();
                public: ~SelectBaseGeometryList();
                ...
                public: bool Add
                (
                    NXOpen::Diagramming::Geometry::BaseGeometry * object /** object to add */
                );
                ...
                public: bool Add
                (
                    const std::vector<NXOpen::Diagramming::Geometry::BaseGeometry *> & objects /** objects to add */
                );
                ...
                public: bool Add
                (
                    NXOpen::Diagramming::Geometry::BaseGeometry * selection /** selected object */,
                ...
                public: bool Remove
                (
                    NXOpen::Diagramming::Geometry::BaseGeometry * object /** Object to remove */
                );
                ...
                (
                    ...
                    NXOpen::Diagramming::Geometry::BaseGeometry * selection1 /** first selected object */,
                    NXOpen::View * view1 /** first selected object view*/,
                    const NXOpen::Point3d & point1 /**first  selected object point*/,
                    NXOpen::Diagramming::Geometry::BaseGeometry * selection2 /** second selected object */,
                ...
                (
                    const std::vector<NXOpen::Diagramming::Geometry::BaseGeometry *> & objects /** Objects to remove */
                );
                ...
                (
                    NXOpen::Diagramming::Geometry::BaseGeometry * object /** object to check */
                );
                ...
                (
                    const std::vector<NXOpen::Diagramming::Geometry::BaseGeometry *> & objects /** items to put in the list*/
                );
                ...
                /** This is an internal API and can be changed at any time 
                 <br>  Created in NX5.0.0.  <br>  
                 <br> License requirements : None */
                public: std::vector<NXOpen::Diagramming::Geometry::BaseGeometry *> GetArray
                (
                );
