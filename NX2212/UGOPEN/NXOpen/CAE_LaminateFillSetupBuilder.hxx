        ...
        */
        class NXOPENCPP_CAEEXPORT  LaminateFillSetupBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the option to use SAMCEF solid shells 
             <br>  @deprecated Deprecated in NX12.0.0.  Use method @link NXOpen::CAE::LaminateFillSetupBuilder::SamcefElementType NXOpen::CAE::LaminateFillSetupBuilder::SamcefElementType@endlink  <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use method NXOpen::CAE::LaminateFillSetupBuilder::SamcefElementType") bool SamcefSolidShells
            (
            );
            /**Sets  the option to use SAMCEF solid shells 
             <br>  @deprecated Deprecated in NX12.0.0.  Use method @link NXOpen::CAE::LaminateFillSetupBuilder::SetSamcefElementType NXOpen::CAE::LaminateFillSetupBuilder::SetSamcefElementType@endlink  <br>  

             <br>  Created in NX10.0.0.  <br>  
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NX_DEPRECATED("Deprecated in NX12.0.0.  Use method NXOpen::CAE::LaminateFillSetupBuilder::SetSamcefElementType") void SetSamcefSolidShells
            (
            ...
            /**Returns  the samcef element type 
             ...
             <br> License requirements : nx_lam_comp_adv ("Laminate Composites Advanced") */
            public: NXOpen::CAE::LaminateFillSetupBuilder::SamcefElementTypeEnum SamcefElementType
            (
            );
            ...
            (
                NXOpen::CAE::LaminateFillSetupBuilder::SamcefElementTypeEnum samcefElementType /** samcefelementtype */ 
            );
