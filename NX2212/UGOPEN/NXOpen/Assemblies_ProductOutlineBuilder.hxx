...
namespace NXOpen
{
    ...
    namespace Assemblies
    {
        ...
        OverrideColor </term> <description> 
        ...
        */
        class NXOPENCPP_ASSEMBLIESEXPORT  ProductOutlineBuilder : public NXOpen::Builder
        {
            ...
            public: enum LineFont
            {
                ...
                LineFontEight/** Long Dashed Double Dotted */,
                LineFontNine/** Long Dashed Dotted for OOTB fonts and Undulating for shipbuilding fonts */,
                LineFontTen/** Long Dashed Triplicate Dotted for OOTB fonts and Zigzag for shipbuilding fonts */,
                LineFontEleven/** Long Dashed Double Short Dashed for OOTB fonts and Railway for shipbuilding fonts */
            };
