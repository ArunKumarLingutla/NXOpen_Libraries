#ifndef NXOpen_CAE_XYPLOT_CAMPBELLPLOT_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_CAMPBELLPLOT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            class _CampbellPlotBuilder;
            class CampbellPlotImpl;
            ...
            */
            class NXOPENCPP_CAEEXPORT  CampbellPlot : public NXOpen::CAE::Xyplot::Plot, public virtual NXOpen::CAE::Xyplot::I3DDataPlot
            {
                private: CampbellPlotImpl * m_campbellplot_impl;
                private: friend class  _CampbellPlotBuilder;
                protected: CampbellPlot();
                public: ~CampbellPlot();
