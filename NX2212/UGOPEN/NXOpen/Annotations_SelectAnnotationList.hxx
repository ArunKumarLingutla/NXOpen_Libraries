#ifndef NXOpen_ANNOTATIONS_SELECTANNOTATIONLIST_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTANNOTATIONLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_SelectAnnotationList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectAnnotationListBuilder;
        class SelectAnnotationListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectAnnotationList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectAnnotationListImpl * m_selectannotationlist_impl;
            private: friend class  _SelectAnnotationListBuilder;
            protected: SelectAnnotationList();
            public: ~SelectAnnotationList();
            ...
            public: bool Add
            (
                NXOpen::Annotations::Annotation * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Annotations::Annotation *> & objects /** objects to add */
            );
            ...
            public: bool Remove
            (
                NXOpen::Annotations::Annotation * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                const std::vector<NXOpen::Annotations::Annotation *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Annotations::Annotation * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Annotations::Annotation *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Annotations::Annotation *> GetArray
            (
            );
