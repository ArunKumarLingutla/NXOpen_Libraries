    ...
    namespace Features
    {
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  ChamferBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            /**Sets  the save feature flag used for creating chamfer
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetSaveFeature
            (
                bool saveFeature /** savefeature */ 
            );
            /**Returns  the save feature flag used for creating chamfer
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
