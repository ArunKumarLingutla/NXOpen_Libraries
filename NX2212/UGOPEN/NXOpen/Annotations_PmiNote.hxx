...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        ...
        class PmiNoteImpl;
        /** Represents a PMI note  <br> To create or edit an instance of this class, use @link NXOpen::Annotations::PmiNoteBuilder  NXOpen::Annotations::PmiNoteBuilder @endlink  <br> 
         <br>  Created in NX4.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  PmiNote : public NXOpen::Annotations::BaseNote
        {
