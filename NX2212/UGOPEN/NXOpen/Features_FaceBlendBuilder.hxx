...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        CircularCrossSection.LawControl.Function </term> <description> 
         
        ft </description> </item> 

        <item><term> 
         
        CircularCrossSection.LawControl.LawType </term> <description> 
         
        Constant </description> </item> 

        <item><term> 
         
        CircularCrossSection.LawControl.Parameter </term> <description> 
        ...
        */
        class NXOPENCPP_FEATURESEXPORT  FaceBlendBuilder : public NXOpen::Features::FeatureBuilder
        {
            ...
            public: enum DefiningType
            {
                ...
                DefiningTypeBlendFromEdges/** blend from edges */ 
            };
            ...
            /**Sets  the edge chain collector
             ...
             <br> License requirements : solid_modeling ("SOLIDS MODELING") */
            public: void SetEdgeChainCollector
            (
                NXOpen::ScCollector * collector /** collector */ 
            );
            /**Returns  the edge chain collector
             ...
             <br>  Created in NX11.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::ScCollector * EdgeChainCollector
            (
            );
