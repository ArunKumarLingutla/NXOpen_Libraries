#ifndef NXOpen_ANNOTATIONS_CUTSHEETBUILDER_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_CUTSHEETBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_CutSheetBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _CutSheetBuilderBuilder;
        class CutSheetBuilderImpl;
        ...
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  CutSheetBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: CutSheetBuilderImpl * m_cutsheetbuilder_impl;
            private: friend class  _CutSheetBuilderBuilder;
            protected: CutSheetBuilder();
            public: ~CutSheetBuilder();
