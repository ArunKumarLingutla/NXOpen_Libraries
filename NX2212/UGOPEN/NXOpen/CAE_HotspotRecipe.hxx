        ...
        */
        class NXOPENCPP_CAEEXPORT  HotspotRecipe : public NXOpen::NXObject
        {
            ...
            /** Resolves recipe on context and returns the hotspot
             ...
             <br>  @deprecated Deprecated in NX1899.0.0.  Use @link NXOpen::CAE::HotspotRecipe::ResolveHotspotRecipeNew NXOpen::CAE::HotspotRecipe::ResolveHotspotRecipeNew@endlink  instead. <br>  

             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: NX_DEPRECATED("Deprecated in NX1899.0.0.  Use NXOpen::CAE::HotspotRecipe::ResolveHotspotRecipeNew instead.") void ResolveHotspotRecipe
            (
                int pvid /** pvid */ 
            );
            /**
            ...
            /** Resolves recipe on context and returns the hotspot
             ...
             <br>  Created in NX1899.0.0.  <br>  
             <br> License requirements : nx_masterfem ("Finite Element Modeling") OR nx_design_sim ("NX Design Simulation") */
            public: void ResolveHotspotRecipeNew
            (
                int pvid /** pvid */ ,
                std::vector<NXOpen::CAE::Hotspot *> & pHotspots /** resolved hotspots */
            );
        };
    }
}
