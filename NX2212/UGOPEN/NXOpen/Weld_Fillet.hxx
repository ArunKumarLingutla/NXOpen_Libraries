#ifndef NXOpen_WELD_FILLET_HXX_INCLUDED
#define NXOpen_WELD_FILLET_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Weld
    {
        class _FilletBuilder;
        class FilletImpl;
        /** Represents a Weld Fillet Feature. This is the new Fillet Dialog introduced in 8.0  <br> To create or edit an instance of this class, use @link NXOpen::Weld::FilletBuilder  NXOpen::Weld::FilletBuilder @endlink  <br> 
         <br>  Created in NX8.0.0.  <br>  
        */
        class NXOPENCPP_WELDEXPORT  Fillet : public NXOpen::Features::BodyFeature, public virtual NXOpen::Weld::IFeature
        {
            private: FilletImpl * m_fillet_impl;
            private: friend class  _FilletBuilder;
            protected: Fillet();
            public: ~Fillet();
