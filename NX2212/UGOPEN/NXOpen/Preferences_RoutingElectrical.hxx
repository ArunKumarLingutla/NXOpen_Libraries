        ...
        */
        class NXOPENCPP_PREFERENCESEXPORT  RoutingElectrical
        {
            ...
            /**Returns  the option to export the XML routelist data with the formats and
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Routing::RouteManager::ExportPlmxml instead.") bool StandaloneFilterFormatFile
            (
            );
            /**Sets  the option to export the XML routelist data with the formats and
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Routing::RouteManager::ExportPlmxml instead.") void SetStandaloneFilterFormatFile
            (
            ...
            /** Gets the file name for the stand alone XML filters and formats file.  @return  
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Routing::RouteManager::ExportPlmxml instead.") NXString GetFilterFormatFileName
            (
            );
            /** Sets the file name for the stand alone XML filters and formats file. 
             ...
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : routing_advanced ("Routing Advanced"), routing_base ("Routing Basic") */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Routing::RouteManager::ExportPlmxml instead.") void SetFilterFormatFileName
            (
