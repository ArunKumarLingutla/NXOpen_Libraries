#ifndef NXOpen_CAE_SELECTCAEFACELIST_HXX_INCLUDED
#define NXOpen_CAE_SELECTCAEFACELIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        class _SelectCAEFaceListBuilder;
        class SelectCAEFaceListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_CAEEXPORT  SelectCAEFaceList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectCAEFaceListImpl * m_selectcaefacelist_impl;
            private: friend class  _SelectCAEFaceListBuilder;
            protected: SelectCAEFaceList();
            public: ~SelectCAEFaceList();
            ...
            public: bool Add
            (
                NXOpen::CAE::CAEFace * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::CAE::CAEFace *> & objects /** objects to add */
            );
            ...
            public: bool Add
            (
                NXOpen::CAE::CAEFace * selection /** selected object */,
            ...
            public: bool Remove
            (
                NXOpen::CAE::CAEFace * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                ...
                NXOpen::CAE::CAEFace * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /**first  selected object point*/,
                NXOpen::CAE::CAEFace * selection2 /** second selected object */,
            ...
            (
                const std::vector<NXOpen::CAE::CAEFace *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::CAE::CAEFace * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::CAE::CAEFace *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAE::CAEFace *> GetArray
            (
            );
