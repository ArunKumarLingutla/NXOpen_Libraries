...
namespace NXOpen
{
    ...
    namespace CAM
    {
        ...
        */
        ...
        {
            /** The transition path types */
            public: enum TransitionPathTypes
            {
                TransitionPathTypesNone/** invalid transition path type*/,
                TransitionPathTypesBefore/** the transition path before the first operation in a program group*/,
                TransitionPathTypesBetween/** the transition path between two consecutive operations in a program group*/,
                TransitionPathTypesAfter/** the transition path after the last operation in a program group*/,
                TransitionPathTypesBeforeToolChange/** the transition path before tool change*/,
                TransitionPathTypesAfterToolChange/** the transition path after tool change*/
            };

            /** Defines the status for the can_generate_ipw */
            public: enum GenerateIpwStatus
            {
                GenerateIpwStatusPass/** pass */ ,
                GenerateIpwStatusNoSetup/** no setup */ ,
                GenerateIpwStatusNoBlank/** no blank */ ,
                GenerateIpwStatusHasRefpart/** has refpart */ ,
                GenerateIpwStatusNoPath/** no path */ 
            };
            ...
            /** Sets toolpath time in minutes  
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetToolpathTime
            (
                double time /** the toolpath time in minutes */
            );
            ...
            /** Returns toolpath cutting time in minutes  @return  the toolpath cutting time in minutes 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: double GetToolpathCuttingTime
            (
            );
            /** Sets toolpath cutting time in minutes 
             <br>  Created in NX6.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void SetToolpathCuttingTime
            (
                double time /** the toolpath cutting time in minutes */
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: void GenerateIpw
            (
                bool checkCollisions /** checkcollisions */ ,
                bool useHolder /** useholder */ 
            );
            ...
            (
                ...
                bool realCompare /** real/snake comparison */,
                bool tubeCompare /** tube comparison */,
                bool realCompareDetailed /** real/snake comparison with position and orientation diffs */,
                int stopAfterNDiffs /** stop marked comparision after n differences */,
                int* realCPosDiff /** number of positions different */,
                int* realCOrientDiff /** number of orientations different */
            );
            ...
            /** Get the transformation matrix  @return  is the operation transformed 
             <br>  Created in NX1872.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") OR insp_programming ("INSPECTION PROGRAMMING") */
            public: bool GetTransformationMatrix
            (
                NXOpen::Matrix3x3* rotationMatrix /** the rotation matrix */,
                NXOpen::Vector3d* translation /** the translation vector */,
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: NXOpen::CAM::GenericMotionControl * GetTransitionPathOperation
            (
                NXOpen::CAM::Operation::TransitionPathTypes transitionPathType /** transitionpathtype */ 
            );
            ...
            /** This is an internal API and can be changed at any time 
             <br>  Created in NX2007.0.0.  <br>  
             <br> License requirements : cam_base ("CAM BASE") */
            public: void GenerateAndSaveTransitionPath
            (
                NXOpen::CAM::Operation::TransitionPathTypes transitionPathType /** transitionpathtype */ ,
                NXOpen::CAM::GenericMotionControl * transitionPathOpr /** the transition path operation*/
            );
            ...
            /** This is an internal API and can be changed at any time 
             ...
             <br> License requirements : cam_base ("CAM BASE") */
            public: bool CanGenerateIpw
            (
                NXOpen::CAM::Operation::GenerateIpwStatus* status /** status */
            );
