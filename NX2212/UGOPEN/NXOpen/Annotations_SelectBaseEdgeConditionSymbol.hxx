#ifndef NXOpen_ANNOTATIONS_SELECTBASEEDGECONDITIONSYMBOL_HXX_INCLUDED
#define NXOpen_ANNOTATIONS_SELECTBASEEDGECONDITIONSYMBOL_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Annotations_SelectBaseEdgeConditionSymbol.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Annotations
    {
        class _SelectBaseEdgeConditionSymbolBuilder;
        class SelectBaseEdgeConditionSymbolImpl;
        /** Represents a single object selection.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_ANNOTATIONSEXPORT  SelectBaseEdgeConditionSymbol : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectBaseEdgeConditionSymbolImpl * m_selectbaseedgeconditionsymbol_impl;
            private: friend class  _SelectBaseEdgeConditionSymbolBuilder;
            protected: SelectBaseEdgeConditionSymbol();
            public: ~SelectBaseEdgeConditionSymbol();
            ...
            (
                NXOpen::Annotations::BaseEdgeConditionSymbol * selection /** selected object */
            );
            /**Returns  the object being selected
                
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Annotations::BaseEdgeConditionSymbol * Value
            (
            );
            ...
            (
                ...
                NXOpen::Annotations::BaseEdgeConditionSymbol * selection1 /** first selected object */,
                NXOpen::View * view1 /** first selected object view*/,
                const NXOpen::Point3d & point1 /** first selected object point*/,
                NXOpen::Annotations::BaseEdgeConditionSymbol * selection2 /** second selected object */,
            ...
            /** The object being selected with CAE set object information.
             ...
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX10.0.0.  Use other versions of NXOpen::SelectObject::GetValue.") NXOpen::Annotations::BaseEdgeConditionSymbol * GetValue
            (
                NXOpen::CaeObjectType::CaeSubType* caeSubType /** CAE set object sub type*/,
                int* caeSubId /** CAE set object sub id*/
            );
