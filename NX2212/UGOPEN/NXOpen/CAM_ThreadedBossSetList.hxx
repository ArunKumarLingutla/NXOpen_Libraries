#ifndef NXOpen_CAM_THREADEDBOSSSETLIST_HXX_INCLUDED
#define NXOpen_CAM_THREADEDBOSSSETLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAM
    {
        class _ThreadedBossSetListBuilder;
        class ThreadedBossSetListImpl;
        ...
        */
        class NXOPENCPP_CAMEXPORT  ThreadedBossSetList : public NXOpen::TaggedObject
        {
            private: ThreadedBossSetListImpl * m_threadedbosssetlist_impl;
            private: friend class  _ThreadedBossSetListBuilder;
            protected: ThreadedBossSetList();
            public: ~ThreadedBossSetList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::CAM::ThreadedBossSet *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::CAM::ThreadedBossSet * object /** item to append */
            );
            ...
            (
                NXOpen::CAM::ThreadedBossSet * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::CAM::ThreadedBossSet * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::CAM::ThreadedBossSet * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::CAM::ThreadedBossSet *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::CAM::ThreadedBossSet *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::CAM::ThreadedBossSet * object1 /** first item */,
                NXOpen::CAM::ThreadedBossSet * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::CAM::ThreadedBossSet * object /** object to be inserted */
            );
