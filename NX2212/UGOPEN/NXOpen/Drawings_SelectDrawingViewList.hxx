#ifndef NXOpen_DRAWINGS_SELECTDRAWINGVIEWLIST_HXX_INCLUDED
#define NXOpen_DRAWINGS_SELECTDRAWINGVIEWLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Drawings_SelectDrawingViewList.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Drawings
    {
        class _SelectDrawingViewListBuilder;
        class SelectDrawingViewListImpl;
        /** Represents a list of objects on a selection list.

         <br>  Created in NX5.0.0.  <br>  
        */
        class NXOPENCPP_DRAWINGSEXPORT  SelectDrawingViewList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            private: SelectDrawingViewListImpl * m_selectdrawingviewlist_impl;
            private: friend class  _SelectDrawingViewListBuilder;
            protected: SelectDrawingViewList();
            public: ~SelectDrawingViewList();
            ...
            public: bool Add
            (
                NXOpen::Drawings::DrawingView * object /** object to add */
            );
            ...
            public: bool Add
            (
                const std::vector<NXOpen::Drawings::DrawingView *> & objects /** objects to add */
            );
            ...
            public: bool Remove
            (
                NXOpen::Drawings::DrawingView * object /** Object to remove */
            );
            /** Remove specified object from list.
                 @return  True if successfully removed from list;
            ...
            (
                const std::vector<NXOpen::Drawings::DrawingView *> & objects /** Objects to remove */
            );
            ...
            (
                NXOpen::Drawings::DrawingView * object /** object to check */
            );
            ...
            (
                const std::vector<NXOpen::Drawings::DrawingView *> & objects /** items to put in the list*/
            );
            /** Returns the list of objects in the selection list.
                 @return  items in list 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Drawings::DrawingView *> GetArray
            (
            );
