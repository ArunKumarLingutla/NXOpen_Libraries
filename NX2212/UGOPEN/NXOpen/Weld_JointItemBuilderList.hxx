#ifndef NXOpen_WELD_JOINTITEMBUILDERLIST_HXX_INCLUDED
#define NXOpen_WELD_JOINTITEMBUILDERLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace Weld
    {
        class _JointItemBuilderListBuilder;
        class JointItemBuilderListImpl;
        ...
        */
        class NXOPENCPP_WELDEXPORT  JointItemBuilderList : public NXOpen::TaggedObject
        {
            private: JointItemBuilderListImpl * m_jointitembuilderlist_impl;
            private: friend class  _JointItemBuilderListBuilder;
            protected: JointItemBuilderList();
            public: ~JointItemBuilderList();
            ...
            public: void Append
            (
                const std::vector<NXOpen::Weld::JointItemBuilder *> & objects /** items to append */
            );
            ...
            public: void Append
            (
                NXOpen::Weld::JointItemBuilder * object /** item to append */
            );
            ...
            (
                NXOpen::Weld::JointItemBuilder * obj /** Object to find index for */
            );
            /** Returns the object at the input index.  May be NULL.
                 @return  object found at input index 
             <br>  Created in NX4.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Weld::JointItemBuilder * FindItem
            (
            ...
            public: void Erase
            (
                NXOpen::Weld::JointItemBuilder * obj /** object to be removed from the list */
            );
            ...
            /** Gets the contents of the entire list  @return  The list contents 
             <br>  Created in NX5.0.0.  <br>  
             <br> License requirements : None */
            public: std::vector<NXOpen::Weld::JointItemBuilder *> GetContents
            (
            );
            ...
            (
                const std::vector<NXOpen::Weld::JointItemBuilder *> & objects /** The list contents */
            );
            ...
            public: void Swap
            (
                NXOpen::Weld::JointItemBuilder * object1 /** first item */,
                NXOpen::Weld::JointItemBuilder * object2 /** second item */
            );
            ...
            (
                ...
                NXOpen::Weld::JointItemBuilder * object /** object to be inserted */
            );
