#ifndef NXOpen_TOOLING_DIEENGFLANGETASKBUILDER_HXX_INCLUDED
#define NXOpen_TOOLING_DIEENGFLANGETASKBUILDER_HXX_INCLUDED
//--------------------------------------------------------------------------
...
//
//  Source File:
//     Tooling_DieEngFlangeTaskBuilder.ja
//
//  Generated by:
//     apiwrap
//
...
namespace NXOpen
{
    ...
    namespace Tooling
    {
        class _DieEngFlangeTaskBuilderBuilder;
        class DieEngFlangeTaskBuilderImpl;
        /**
            Represents a Flange Task builder
             <br> To create a new instance of this class, use @link NXOpen::Tooling::AutoDieCollection::CreateDieEngFlangeTaskBuilder  NXOpen::Tooling::AutoDieCollection::CreateDieEngFlangeTaskBuilder @endlink  <br> 
        Default values.
        <list type="table"> 
        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  DieEngFlangeTaskBuilder : public NXOpen::Features::FeatureBuilder
        {
            private: DieEngFlangeTaskBuilderImpl * m_dieengflangetaskbuilder_impl;
            private: friend class  _DieEngFlangeTaskBuilderBuilder;
            protected: DieEngFlangeTaskBuilder();
            public: ~DieEngFlangeTaskBuilder();
