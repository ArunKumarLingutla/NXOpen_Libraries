        ...
        */
        class NXOPENCPP_TOOLINGEXPORT  ReferenceCopyBuilder : public NXOpen::Builder
        {
            ...
            /**Returns  the body to copy.
             <br>  @deprecated Deprecated in NX2206.0.0.  Use @link NXOpen::Tooling::ReferenceCopyBuilder::SelectedBodies NXOpen::Tooling::ReferenceCopyBuilder::SelectedBodies@endlink  instead <br>  

             <br>  Created in NX12.0.2.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX2206.0.0.  Use NXOpen::Tooling::ReferenceCopyBuilder::SelectedBodies instead") NXOpen::SelectBody * CopyBodySelection
            (
            );
            /**Returns  the selected bodies to copy.
