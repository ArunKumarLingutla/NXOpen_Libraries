        ...
        */
        class NXOPENCPP_MOTIONEXPORT  VObject : public NXOpen::TaggedObject
        {
            ...
            /**Returns  the reaction origin 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Point * ReactionOrigin
            (
            );
            /**Sets  the reaction origin 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReactionOrigin
            (
                NXOpen::Point * origin /** origin */ 
            );
            /**Returns   @brief the override state of the reaction point 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ReactionOriginOvrCtrl
            (
            );
            /**Sets   @brief the override state of the reaction point 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReactionOriginOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            ...
            /**Returns   @brief the override state of the reference motion body 

             
                        It should only be used for occurrences
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ReferenceLinkOvrCtrl
            (
            );
            /**Sets   @brief the override state of the reference motion body 

             
                        It should only be used for occurrences
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReferenceLinkOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            ...
            /**Returns   @brief the override state of the reference point 

             
                        It should only be used for occurrences
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ReferenceOriginOvrCtrl
            (
            );
            /**Sets   @brief the override state of the reference point 

             
                        It should only be used for occurrences
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReferenceOriginOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            ...
            /**Returns   @brief the override state of the coordinate system 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ReferenceDirectionOvrCtrl
            (
            );
            /**Sets   @brief the override state of the coordinate system 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReferenceDirectionOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            ...
            /**Returns   @brief the override state of the coordinate system 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ParamOverrideState ReferenceCsysOvrCtrl
            (
            );
            /**Sets   @brief the override state of the coordinate system 
             ...
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetReferenceCsysOvrCtrl
            (
                NXOpen::Motion::ParamOverrideState overrideState /** overridestate */ 
            );
            ...
            /**Returns  the magnitude value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ForceValueTypes MagnitudeValueType
            (
            );
            /**Sets  the magnitude value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetMagnitudeValueType
            (
                NXOpen::Motion::ForceValueTypes valueType /** valuetype */ 
            );
            /**Returns  the x value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ForceValueTypes XValueType
            (
            );
            /**Sets  the x value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetXValueType
            (
                NXOpen::Motion::ForceValueTypes valueType /** valuetype */ 
            );
            /**Returns  the y value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ForceValueTypes YValueType
            (
            );
            /**Sets  the y value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetYValueType
            (
                NXOpen::Motion::ForceValueTypes valueType /** valuetype */ 
            );
            /**Returns  the z value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : None */
            public: NXOpen::Motion::ForceValueTypes ZValueType
            (
            );
            /**Sets  the z value type 
             <br>  Created in NX1847.0.0.  <br>  
             <br> License requirements : mechanisms ("MECHANISMS") */
            public: void SetZValueType
            (
                NXOpen::Motion::ForceValueTypes valueType /** valuetype */ 
            );
