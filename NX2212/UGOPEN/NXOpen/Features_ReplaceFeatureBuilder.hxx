...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        CopyReplacementFeature </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        DeleteOriginalFeature </term> <description> 
         
        0 </description> </item> 

        <item><term> 
         
        MappingMethod </term> <description> 
         
        MapOnlyObjectsWithModelingDependencies </description> </item> 
