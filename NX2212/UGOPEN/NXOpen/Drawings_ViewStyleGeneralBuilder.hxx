...
#include <NXOpen/Drawings_ViewStyleFrameBarBuilder.hxx>
        ...
        */
        class NXOPENCPP_DRAWINGSEXPORT  ViewStyleGeneralBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
        {
            ...
            /**Returns  the horizontal framebar toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Drawings::ViewStyleFrameBarBuilder::Horizontal Drawings::ViewStyleFrameBarBuilder::Horizontal@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Drawings::ViewStyleFrameBarBuilder::Horizontal instead.") bool FramebarHorizontal
            (
            );
            /**Sets  the horizontal framebar toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Drawings::ViewStyleFrameBarBuilder::SetHorizontal Drawings::ViewStyleFrameBarBuilder::SetHorizontal@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Drawings::ViewStyleFrameBarBuilder::SetHorizontal instead.") void SetFramebarHorizontal
            (
            ...
            /**Returns  the vertical framebar toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Drawings::ViewStyleFrameBarBuilder::Vertical Drawings::ViewStyleFrameBarBuilder::Vertical@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : None */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Drawings::ViewStyleFrameBarBuilder::Vertical instead.") bool FramebarVertical
            (
            );
            /**Sets  the vertical framebar toggle on the GENERAL tab of the View Style Dialog 
             <br>  @deprecated Deprecated in NX1980.0.0.  Use @link Drawings::ViewStyleFrameBarBuilder::SetVertical Drawings::ViewStyleFrameBarBuilder::SetVertical@endlink  instead. <br>  

             <br>  Created in NX8.0.0.  <br>  
             <br> License requirements : drafting ("DRAFTING") */
            public: NX_DEPRECATED("Deprecated in NX1980.0.0.  Use Drawings::ViewStyleFrameBarBuilder::SetVertical instead.") void SetFramebarVertical
            (
            ...
            /**Returns  the frame bar builder 
             ...
             <br> License requirements : drafting ("DRAFTING") */
            public: NXOpen::Drawings::ViewStyleFrameBarBuilder * ViewStyleFrameBar
            (
            );
