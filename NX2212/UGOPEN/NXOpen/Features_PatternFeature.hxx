...
namespace NXOpen
{
    ...
    namespace Features
    {
        ...
        /** Represents a pattern feature  <br> To create or edit an instance of this class, use @link NXOpen::Features::PatternFeatureBuilder  NXOpen::Features::PatternFeatureBuilder @endlink  <br> 
         <br>  Created in NX7.0.0.  <br>  
        */
        class NXOPENCPP_FEATURESEXPORT  PatternFeature : public NXOpen::Features::Feature, public virtual NXOpen::Features::IContainerFeature
        {
