        ...
        namespace VehicleDesign
        {
            ...
            */
            class NXOPENCPP_FEATURESEXPORT  CloseRangeCameraListItemBuilder : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
            {
                ...
                /**Returns  the sheet body selections used to identify the camera field of view. Only valid when the camera type is field of view. 
                 <br>  Created in NX12.0.2.  <br>  
                 <br> License requirements : None */
                public: NXOpen::ScCollector * FovSheetBody
                (
                );
                ...
                /**Returns  the indication if the selected field of view sheet body should be reversed. Only valid when the camera type is field of view. 
                 <br>  Created in NX12.0.2.  <br>  
                 <br> License requirements : None */
                public: bool FovReverse
                (
                );
                /**Sets  the indication if the selected field of view sheet body should be reversed. Only valid when the camera type is field of view. 
                 <br>  Created in NX12.0.2.  <br>  
                 <br> License requirements : nx_general_packaging ("NX General Packaging") */
                public: void SetFovReverse
                (
                    bool fovReverse /** fovreverse */ 
                );
                ...
                /**Returns  the expression containing the value for the horizontal view angle. 
                 <br>  Created in NX12.0.2.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * HorizontalViewAngle
                (
                );
                /**Returns  the expression containing the value for the vertical view angle. 
                 <br>  Created in NX12.0.2.  <br>  
                 <br> License requirements : None */
                public: NXOpen::Expression * VerticalViewAngle
                (
                );
