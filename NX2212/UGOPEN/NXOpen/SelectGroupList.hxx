#ifndef NXOpen_SELECTGROUPLIST_HXX_INCLUDED
#define NXOpen_SELECTGROUPLIST_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    class View;
    class _SelectGroupListBuilder;
    class SelectGroupListImpl;
    /** Represents a list of objects on a selection list.

     <br>  Created in NX5.0.0.  <br>  
    */
    class NXOPENCPPEXPORT  SelectGroupList : public NXOpen::TaggedObject, public virtual NXOpen::GeometricUtilities::IComponentBuilder
    {
        private: SelectGroupListImpl * m_selectgrouplist_impl;
        private: friend class  _SelectGroupListBuilder;
        protected: SelectGroupList();
        public: ~SelectGroupList();
        ...
        public: bool Add
        (
            NXOpen::Group * object /** object to add */
        );
        ...
        public: bool Add
        (
            const std::vector<NXOpen::Group *> & objects /** objects to add */
        );
        ...
        public: bool Add
        (
            NXOpen::Group * selection /** selected object */,
        ...
        public: bool Remove
        (
            NXOpen::Group * object /** Object to remove */
        );
        /** Remove specified object from list.
             @return  True if successfully removed from list;
        ...
        (
            const std::vector<NXOpen::Group *> & objects /** Objects to remove */
        );
        ...
        (
            NXOpen::Group * object /** object to check */
        );
        ...
        (
            const std::vector<NXOpen::Group *> & objects /** items to put in the list*/
        );
        /** Returns the list of objects in the selection list.
             @return  items in list 
         <br>  Created in NX5.0.0.  <br>  
         <br> License requirements : None */
        public: std::vector<NXOpen::Group *> GetArray
        (
        );
