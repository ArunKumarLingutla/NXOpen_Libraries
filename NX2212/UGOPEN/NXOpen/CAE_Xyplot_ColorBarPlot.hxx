#ifndef NXOpen_CAE_XYPLOT_COLORBARPLOT_HXX_INCLUDED
#define NXOpen_CAE_XYPLOT_COLORBARPLOT_HXX_INCLUDED
//--------------------------------------------------------------------------
...
namespace NXOpen
{
    ...
    namespace CAE
    {
        namespace Xyplot
        {
            class _ColorBarPlotBuilder;
            class ColorBarPlotImpl;
            /**  @brief 
            ...
            */
            class NXOPENCPP_CAEEXPORT  ColorBarPlot : public NXOpen::CAE::Xyplot::Plot, public virtual NXOpen::CAE::Xyplot::I2DDataPlot
            {
                private: ColorBarPlotImpl * m_colorbarplot_impl;
                private: friend class  _ColorBarPlotBuilder;
                protected: ColorBarPlot();
                public: ~ColorBarPlot();
