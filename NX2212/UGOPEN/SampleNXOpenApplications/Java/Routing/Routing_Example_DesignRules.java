...
//------------------------------------------------------------------------------------------------
public class Routing_Example_DesignRules implements nxopen.routing.CustomManager.DesignRule
{
    static Routing_Example_DesignRules theDesignRules = null;
    static Session theSession = null;
    static ListingWindow listingWindow = null;
    static String designRuleName = "Create Path";
    ...
    public static void startup( String [] args ) throws NXException, java.rmi.RemoteException
    {
        ...
        theDesignRules = new Routing_Example_DesignRules();
    }

    //------------------------------------------------------------------------------------------
    // The constructor for this class.
    // Registers the Design Rules.
    public Routing_Example_DesignRules() throws RemoteException, NXException
    {        
        try
        {
            ...
            customManager.addDesignRule(DesignRuleReason. CREATE_PATH, designRuleName, description, this );
        }
