...
Module DeformMeshFromResultFile
    ...
    Function GetResults(ByRef file As String) As CAE.Result
        ...
        Dim importParameters As CAE.ImportResultParameters = Nothing
        Try
            importParameters = theResultManager.CreateImportResultParameters()
            importedResults = theResultManager.CreateResultFromImportParameters(importParameters)
