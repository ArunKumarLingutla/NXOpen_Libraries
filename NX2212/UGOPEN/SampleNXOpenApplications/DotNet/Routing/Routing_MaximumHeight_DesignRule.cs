...
namespace Routing
{
    public class MaxHeightDesignRules
    {
        ...
        static String designRuleName = "Maximum Height Violation";
        ...
        private static void RegisterMaxHeightDesignRules()
        {
            ...
            m_maxHeightRuleForCreatePath = customManager.AddDesignRule(CustomManager.DesignRuleReason.CreatePath, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForHealPath = customManager.AddDesignRule(CustomManager.DesignRuleReason.HealPath, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForAssignCorner = customManager.AddDesignRule(CustomManager.DesignRuleReason.AssignCorner, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForAssignStock = customManager.AddDesignRule(CustomManager.DesignRuleReason.AssignStock, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForRemovePart = customManager.AddDesignRule(CustomManager.DesignRuleReason.RemovePart, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForAutoRoutePinLevel = customManager.AddDesignRule(CustomManager.DesignRuleReason.AutoRoutePinLevel, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForManualRoutePinLevel = customManager.AddDesignRule(CustomManager.DesignRuleReason.ManualRoutePinLevel, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForAutoRouteComponentLevel = customManager.AddDesignRule(CustomManager.DesignRuleReason.AutoRouteComponentLevel, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForManualRouteComponentLevel = customManager.AddDesignRule(CustomManager.DesignRuleReason.ManualRouteComponentLevel, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForInteractive = customManager.AddDesignRule(CustomManager.DesignRuleReason.Interactive, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForTransformPath = customManager.AddDesignRule(CustomManager.DesignRuleReason.TransformPath, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
            m_maxHeightRuleForEditCharacteristic = customManager.AddDesignRule(CustomManager.DesignRuleReason.EditCharacteristic, designRuleName, maxHeightViolationDescription, CreateMaximumHeightDesignRule);
        }
