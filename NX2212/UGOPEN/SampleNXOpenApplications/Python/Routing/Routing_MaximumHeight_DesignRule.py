...
designRuleName = "Maximum Height Violation"
...
def registerMaxHeightDesignRules():
    ...
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.CreatePath,                designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.HealPath,                  designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.AssignCorner,              designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.AssignStock,               designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.RemovePart,                designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.AutoRoutePinLevel,         designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.ManualRoutePinLevel,       designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.AutoRouteComponentLevel,   designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.ManualRouteComponentLevel, designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.TransformPath,             designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
    customManager.AddDesignRule(NXOpen.Routing.CustomManager.DesignRuleReason.EditCharacteristic,        designRuleName, maxHeightViolationDescription, createMaximumHeightDesignRule )
