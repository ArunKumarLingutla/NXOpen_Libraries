...
//------------------------------------------------------------------------------
NXOpen::BlockStyler::BlockDialog::DialogResponse HoleCoordinates::Launch()
{
...
void HoleCoordinates::deletedatumaxis(std::vector<TaggedObject *> objects1)
{
    NXOpen::Session::UndoMarkId markId3 = 
        HoleCoordinates::theSession->SetUndoMark(NXOpen::Session::MarkVisibilityVisible, "Delete");

    int nErrs1 = HoleCoordinates::theSession->UpdateManager()->AddObjectsToDeleteList(objects1);
