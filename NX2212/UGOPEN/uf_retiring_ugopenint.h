...
/*-----------------------------------------------------------------------------
 * Function Name        :  UF_RLIST_UI_define_filter
 * Function Description :  This function creates the UI dialog for manipulation
 *                         and importation/exportation of rlist filters.
 * Input   :  list_tag    - tag of the connection or component list
 * Output  :  filter_tag  - tag of the selected/created/modified filter.
 *            filter_name - name of the selected/created/modified filter.
 * Returns :  None
 *
 -----------------------------------------------------------------------------*/
extern UGOPENINTEXPORT int UF_RLIST_UI_define_filter
(
    tag_t   list_tag,                         /* I  */
    tag_p_t filter_tag,                       /* O  */
    int* filter_id,                        /* O  */
    char** filter_name                       /* OF */
);/* <NON_NXOPEN> */

/*-----------------------------------------------------------------------------
 * Function Name        :  UF_RLIST_UI_define_format
 * Function Description :  This function creates the UI dialog for manipulation
 *                         and importation/exportation of rlist formats.
 *
 * Input   :  list_tag  - tag of the connection or component list
 * Output  :  format_tag   - tag of the selected/created/modified format.
 *            format_name  - name of the selected/created/modified format.
 * Returns :  None
 *
 -----------------------------------------------------------------------------*/
extern UGOPENINTEXPORT int UF_RLIST_UI_define_format
(
    tag_t   list_tag,                         /* I  */
    int     filter_id,                        /* I  */
    tag_p_t format_tag,                       /* O  */
    char** format_name                       /* OF */
);/* <NON_NXOPEN> */
...
History: Original release was in V14.0.
**********************************************************************/
extern UGOPENINTEXPORT int UF_ROUTE_enter_custom_app( void );/* <NON_NXOPEN> */
...
History: Original release was in V14.0.
 ***********************************************************************/
extern UGOPENINTEXPORT int UF_ROUTE_init_custom_app( void );/* <NON_NXOPEN> */
...
History: Original release was in V14.0.
 ***********************************************************************/
extern UGOPENINTEXPORT int UF_ROUTE_exit_custom_app( void );/* <NON_NXOPEN> */
